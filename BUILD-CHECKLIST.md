...
- **Decisions / to-dos for Alex:** **accounts in production** — add `VITE_SUPABASE_*` env to Vercel + redeploy + add the prod URL to Supabase redirect allow-list (Apple sign-in later, needs Apple Dev account). Native review of the kanji batch (U11, U13–U21) + Unit 4–10 thematic review.
- **Last updated:** 2026-06-28 (overnight session)
