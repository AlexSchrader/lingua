...
- **📚 A1 build-out (2026-06-30, curriculum CC — committed locally):** big push toward "A1 perfect":
  ...
  - State: **19 units · 83 lessons · 673 items** (175 kana / 392 vocab / 106 kanji). All gates green (lint 0 err, validate clean, 55 tests, build). Grammar unit number is now **U19** (consolidation renumbered it down from the old "#22" Ladder position).
