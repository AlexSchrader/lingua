...
- [ ] Unit 5 — カタカナ part 2 (h/m/y/r/w rows + remaining katakana) — next curriculum thread, authored in-repo by CC off the guide. (CC)
- [ ] Unit 5+ — katakana dakuten/combos, then kanji; vocab expansion, particles, basic grammar; scope per the Curriculum Authoring Guide build queue. (Claude/CC)
