  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u20l1-cuando", type: "vocab", front: "cuando", reading: "cuando", meaning: "when", example: { jp: "Cuando llueve, voy en autobús.", en: "When it rains, I take the bus." }, accept: ["whenever", "when"], hint: "No accent when it joins two ideas; with an accent, ¿cuándo?, it asks the question." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u20l3-cuando", type: "vocab", front: "cuándo", reading: "cuando", meaning: "when", example: { jp: "¿Cuándo llega el tren?", en: "When does the train arrive?" }, accept: ["what time", "when"] },
