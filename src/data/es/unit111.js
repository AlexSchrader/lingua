  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u111l1-inferir", type: "vocab", front: "inferir", reading: "inferir", meaning: "to infer", example: { jp: "De los datos podemos inferir muy poco.", en: "From the data we can infer very little." }, accept: ["to infer", "to conclude", "infer"], hint: "Drawing a conclusion the evidence supports but does not state. Deducir (u51) claims necessity; inferir only claims a reasonable step." },
        { id: "es-u111l1-corroborar", type: "vocab", front: "corroborar", reading: "corroborar", meaning: "to corroborate", example: { jp: "El otro informe corrobora lo que decía el primero.", en: "The other report corroborates what the first one said." }, accept: ["to corroborate", "to confirm", "to bear out", "corroborate"], hint: "A second, independent source saying the same thing. It is stronger than confirmar precisely because it comes from somewhere else." },
        { id: "es-u111l1-contrastar", type: "vocab", front: "contrastar", reading: "contrastar", meaning: "to cross-check / contrast", example: { jp: "Hay que contrastar los datos con otra fuente.", en: "The data has to be cross-checked against another source." }, accept: ["to cross-check", "to check", "to contrast", "to verify"], hint: "Two senses that share a logic: to set two things side by side, and to check one against the other. Información contrastada = checked information." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u111l2-respaldar", type: "vocab", front: "respaldar", reading: "respaldar", meaning: "to back / endorse", example: { jp: "Los profesores respaldaron la decisión del rector.", en: "The teachers backed the vice-chancellor's decision." }, accept: ["to back", "to endorse", "to support", "back"], hint: "From el respaldo, the back of a chair: you are standing behind someone. About people and decisions; avalar is about evidence and claims." },
        { id: "es-u111l2-sustentar", type: "vocab", front: "sustentar", reading: "sustentar", meaning: "to underpin / hold up", example: { jp: "Nada sustenta esa hipótesis.", en: "Nothing underpins that hypothesis." }, accept: ["to underpin", "to hold up", "to sustain", "to support"], hint: "What holds a claim up from below. Sustentarse en = to rest on. Physical enough that the metaphor stays visible." },
    ...
    },
    {
      ...
      items: [
        { id: "es-u111l3-refutar", type: "vocab", front: "refutar", reading: "refutar", meaning: "to refute / disprove", example: { jp: "Nadie ha podido refutar esa hipótesis.", en: "Nobody has been able to refute that hypothesis." }, accept: ["to refute", "to disprove", "to rebut", "refute"], hint: "To show a claim is false, not merely to disagree with it. Refutar succeeds or it does not — the word claims the argument was won." },
        { id: "es-u111l3-rebatir", type: "vocab", front: "rebatir", reading: "rebatir", meaning: "to counter / argue against", example: { jp: "Rebatió cada punto con mucha calma.", en: "She countered every point very calmly." }, accept: ["to counter", "to argue against", "to rebut", "to challenge"], hint: "Answering point by point. Softer than refutar: you rebates an argument by arguing back, whether or not you win." },
