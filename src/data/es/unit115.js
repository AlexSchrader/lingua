...
export const ES_UNIT115 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Talk about a person's underlying make-up: their composure, their restraint, their cast of mind and their standards.",
      items: [
        ...
        { id: "es-u115l4-laintegridad", type: "vocab", front: "la integridad", reading: "laintegridad", meaning: "the integrity", example: { jp: "Nadie ha puesto nunca en duda su integridad.", en: "Nobody has ever cast doubt on her integrity." }, accept: ["the integrity", "the honesty", "the uprightness"], hint: "Whole, undivided: the person is the same in public and in private." },
        { id: "es-u115l4-laindole", type: "vocab", front: "la índole", reading: "laindole", meaning: "the nature / kind", example: { jp: "Es una persona de índole tranquila, aunque no lo parezca.", en: "She is a person of quiet nature, though she does not look it." }, accept: ["the nature", "the disposition", "the kind"], hint: "The grain of a person or a thing. Also used of matters: problemas de índole económica." },
