  ...
  lessons: [
    {
      ...
      items: [
        { id: "es-u115l1-lafranqueza", type: "vocab", front: "la franqueza", reading: "lafranqueza", meaning: "the candour / frankness", example: { jp: "Habló con una franqueza que sorprendió a todos.", en: "He spoke with a candour that surprised everyone." }, drill: { jp: "La franqueza sorprendió a todos", en: "The frankness surprised everyone" }, accept: ["the candour", "the candor", "the frankness", "the openness"], hint: "Con franqueza = frankly. A virtue here, unlike its English cousin, which can sound blunt." },
        { id: "es-u115l1-retraido", type: "vocab", front: "retraído", reading: "retraido", meaning: "withdrawn", example: { jp: "Es una persona retraída, pero con sus amigos habla sin parar.", en: "She is a withdrawn person, but with her friends she talks non-stop." }, drill: { jp: "De niño era un chico muy retraído", en: "As a child he was a very withdrawn boy" }, accept: ["withdrawn", "shy", "retiring"], hint: "Pulled back from other people, by temperament rather than by mood." },
        { id: "es-u115l1-taciturno", type: "vocab", front: "taciturno", reading: "taciturno", meaning: "taciturn / silent by nature", example: { jp: "Su padre era un hombre taciturno que casi nunca contaba nada.", en: "His father was a taciturn man who almost never told you anything." }, drill: { jp: "Mi jefe está taciturno desde la reunión", en: "My boss has been silent since the meeting" }, accept: ["taciturn", "silent", "uncommunicative"], hint: "Silent as a permanent quality. A literary word — you meet it in novels more than in the street." },
        { id: "es-u115l1-locuaz", type: "vocab", front: "locuaz", reading: "locuaz", meaning: "talkative / voluble", example: { jp: "Después de dos vasos de vino se puso muy locuaz.", en: "After two glasses of wine he became very talkative." }, drill: { jp: "El testigo se mostró locuaz ante el tribunal", en: "The witness proved talkative before the court" }, accept: ["talkative", "voluble", "loquacious"], hint: "The formal opposite of taciturno. One ending for both genders: un hombre locuaz, una mujer locuaz." },
        { id: "es-u115l1-adusto", type: "vocab", front: "adusto", reading: "adusto", meaning: "stern / gruff", example: { jp: "Tiene un carácter adusto, aunque en el fondo es buena persona.", en: "He has a stern manner, though deep down he is a good person." }, drill: { jp: "Nos recibió con un gesto adusto", en: "He greeted us with a stern look" }, accept: ["stern", "gruff", "severe", "dour"], hint: "Severity you can see on the face. Not cruelty — an adusto person is simply not warm." },
        { id: "es-u115l1-afable", type: "vocab", front: "afable", reading: "afable", meaning: "affable / genial", example: { jp: "El nuevo director es afable con todo el mundo.", en: "The new director is affable with everybody." }, drill: { jp: "El director es muy afable", en: "The director is very affable" }, accept: ["affable", "genial", "warm", "amiable"], hint: "Easy to talk to, and pleased to be. The exact counterweight to adusto." },
      ],
    },
    {
      id: "es-u115l2",
    ...
    },
    {
      ...
      items: [
        { id: "es-u115l3-latenacidad", type: "vocab", front: "la tenacidad", reading: "latenacidad", meaning: "the tenacity", example: { jp: "Consiguió el puesto por su tenacidad, no por suerte.", en: "She got the post through her tenacity, not through luck." }, drill: { jp: "Admiro la tenacidad de esa abogada", en: "I admire that lawyer's tenacity" }, accept: ["the tenacity", "the persistence", "the doggedness"], hint: "Always positive: holding on because the aim is worth it." },
        { id: "es-u115l3-lafirmeza", type: "vocab", front: "la firmeza", reading: "lafirmeza", meaning: "the firmness / resolve", example: { jp: "Respondió con firmeza que no pensaba cambiar de opinión.", en: "He replied firmly that he did not intend to change his mind." }, drill: { jp: "La firmeza del juez evitó nuevos retrasos", en: "The judge's firmness avoided further delays" }, accept: ["the firmness", "the resolve", "the steadfastness"], hint: "Con firmeza = firmly. It describes how a position is held, not how long." },
        { id: "es-u115l3-laobstinacion", type: "vocab", front: "la obstinación", reading: "laobstinacion", meaning: "the obstinacy", example: { jp: "Su obstinación en seguir solo acabó con el proyecto.", en: "His obstinacy in going on alone finished off the project." }, drill: { jp: "La obstinación del jefe nos costó el contrato", en: "The boss's obstinacy cost us the contract" }, accept: ["the obstinacy", "the stubbornness"], hint: "Obstinación EN + infinitive. The same holding-on as tenacidad, but now judged a mistake." },
        { id: "es-u115l3-tozudo", type: "vocab", front: "tozudo", reading: "tozudo", meaning: "pig-headed", example: { jp: "Es tan tozudo que prefiere perder antes que seguir un consejo.", en: "He is so pig-headed that he would rather lose than follow advice." }, drill: { jp: "Mi hermano es muy tozudo", en: "My brother is very pig-headed" }, accept: ["pig-headed", "stubborn", "mulish"], hint: "Warmer and more familiar than testarudo (u80) — the word a family uses about its own." },
        { id: "es-u115l3-docil", type: "vocab", front: "dócil", reading: "docil", meaning: "docile / biddable", example: { jp: "Admitió todas las condiciones, dócil como siempre.", en: "He accepted every condition, docile as ever." }, drill: { jp: "Ese caballo se volvió muy dócil", en: "That horse became very docile" }, accept: ["docile", "biddable", "compliant", "meek"], hint: "The far end from tozudo. Neutral about an animal, faintly critical about an adult." },
        { id: "es-u115l3-laaudacia", type: "vocab", front: "la audacia", reading: "laaudacia", meaning: "the audacity / boldness", example: { jp: "Tuvo la audacia de presentarse sin avisar a nadie.", en: "He had the audacity to turn up without warning anybody." }, drill: { jp: "La audacia sorprendió a todos", en: "The audacity surprised everyone" }, accept: ["the audacity", "the boldness", "the daring", "the nerve"], hint: "Tener la audacia de + infinitive. Admiring or scandalised depending entirely on the tone." },
      ],
    },
    {
      id: "es-u115l4",
