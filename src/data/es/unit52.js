  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u52l3-conducira", type: "vocab", front: "conducir a", reading: "conducira", meaning: "to lead to", example: { jp: "Esa política condujo a una situación muy difícil.", en: "That policy led to a very difficult situation." }, accept: ["to lead to", "to result in"], hint: "Conducir on its own is to drive; conducir A is where a process ends up." },
        { id: "es-u52l3-desembocaren", type: "vocab", front: "desembocar en", reading: "desembocaren", meaning: "to end up in / lead to", example: { jp: "Todo esto desembocó en un problema para la empresa.", en: "All of this ended up in a problem for the company." }, accept: ["to end in", "to lead to", "to result in"], hint: "A river desemboca into the sea; a situation ends the same way, usually badly." },
      ],
    },
    {
      id: "es-u52l4",
