...
export const ES_UNIT49 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "es-u49l5-elrey", type: "vocab", front: "el rey", reading: "elrey", meaning: "the king", example: { jp: "El rey habló por televisión el martes.", en: "The king spoke on television on Tuesday." }, drill: { jp: "El rey visitó la ciudad ayer", en: "The king visited the city yesterday" }, accept: ["the king"], hint: "La reina is the queen; los reyes covers both, and also the Three Kings on 6 January." },
        { id: "es-u49l5-elalumno", type: "vocab", front: "el alumno", reading: "elalumno", meaning: "the pupil", example: { jp: "Cada alumno tiene su propio libro.", en: "Each pupil has his own book." }, drill: { jp: "El alumno nuevo llegó esta mañana", en: "The new pupil arrived this morning" }, accept: ["the pupil", "the student", "the learner"], hint: "A pupil of a particular teacher or school. El estudiante (u18) is anyone who studies, at any age." },
        ...
        { id: "es-u49l5-elexperto", type: "vocab", front: "el experto", reading: "elexperto", meaning: "the expert", example: { jp: "Los expertos no se ponen de acuerdo.", en: "The experts don't agree." }, drill: { jp: "El experto explicó todo dos veces", en: "The expert explained everything twice" }, accept: ["the expert", "the specialist"], hint: "Also an adjective: es muy experto en el tema. La experiencia (u46) is the experience behind it." },
        { id: "es-u49l5-lapolicia", type: "vocab", front: "la policía", reading: "lapolicia", meaning: "the police", example: { jp: "La policía llegó diez minutos después.", en: "The police arrived ten minutes later." }, drill: { jp: "La policía busca a dos hombres", en: "The police are looking for two men" }, accept: ["the police", "the police force", "the policewoman"], hint: "The force is singular and feminine: la policía llegó. Un policía is an individual officer." },
      ],
    },
    {
      id: "es-u49l6",
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Name some everyday things precisely: a language or tongue, a part or piece, a document, a signature, a stamp, and fruit in the general sense.",
      items: [
        { id: "es-u49l6-lalengua", type: "vocab", front: "la lengua", reading: "lalengua", meaning: "the language / tongue", example: { jp: "El español es su lengua materna.", en: "Spanish is his mother tongue." }, drill: { jp: "La lengua de este país es difícil", en: "The language of this country is hard" }, accept: ["the language", "the tongue", "the mother tongue"], hint: "Both the organ and the language. El idioma is a synonym for the language sense only." },
        { id: "es-u49l6-lapieza", type: "vocab", front: "la pieza", reading: "lapieza", meaning: "the piece / part", example: { jp: "Falta una pieza del motor.", en: "A part of the engine is missing." }, drill: { jp: "La pieza cuesta muy poco dinero", en: "The part costs very little money" }, accept: ["the piece", "the part", "the component"], hint: "A part of a machine, of a set, or a piece of music. La parte (u20) is a share or a portion of something." },
        { id: "es-u49l6-eldocumento", type: "vocab", front: "el documento", reading: "eldocumento", meaning: "the document", example: { jp: "Guarda el documento antes de cerrarlo.", en: "Save the document before closing it." }, drill: { jp: "El documento está en el ordenador", en: "The document is on the computer" }, accept: ["the document", "the file", "the paper"], hint: "On paper or on screen. Documentar (u89) is the verb; la documentación is your paperwork." },
        { id: "es-u49l6-lafirma", type: "vocab", front: "la firma", reading: "lafirma", meaning: "the signature / the firm", example: { jp: "Falta tu firma en la última página.", en: "Your signature is missing on the last page." }, drill: { jp: "La firma del jefe no aparece", en: "The boss's signature isn't there" }, accept: ["the signature", "the firm", "the signing"], hint: "From firmar. In business it also means the company itself: una firma alemana." },
        { id: "es-u49l6-elsello", type: "vocab", front: "el sello", reading: "elsello", meaning: "the stamp / the seal", example: { jp: "Falta el sello en el documento.", en: "The stamp is missing from the document." }, drill: { jp: "El sello está en el documento", en: "The stamp is on the document" }, accept: ["the stamp", "the seal", "stamp", "seal"], hint: "The rubber stamp on a form, the stamp on a letter, and the seal on a bottle. Sellar is the verb, and un sello is also a record label." },
        { id: "es-u49l6-elfruto", type: "vocab", front: "el fruto", reading: "elfruto", meaning: "the fruit (of something)", example: { jp: "Su éxito es el fruto de muchos años de trabajo.", en: "His success is the fruit of many years of work." }, drill: { jp: "El fruto de esa idea llegó tarde", en: "The fruit of that idea came late" }, accept: ["the fruit", "the result", "the product"], hint: "The result of effort, where la fruta (u6) is the thing you eat. Dar fruto = to bear fruit." },
      ],
    },
  ],
};
