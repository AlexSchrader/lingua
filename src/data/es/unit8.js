  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u8l1-azul", type: "vocab", front: "azul", reading: "azul", meaning: "blue", example: { jp: "El autobús azul está en la parada.", en: "The blue bus is at the stop." }, accept: ["blue colour", "blue color"], hint: "Ends in -l, not -o, so it doesn't change for gender: el coche azul, la puerta azul." },
    ...
    },
    {
      ...
      cefr: "A1",
      dominantMode: "recall",
      canDo: "Describe what's overhead: el tiempo, el cielo, el sol, la nube, la lluvia, el viento.",
      items: [
        { id: "es-u8l3-tiempo", type: "vocab", front: "el tiempo", reading: "eltiempo", meaning: "weather", example: { jp: "¿Qué tiempo hace hoy?", en: "What's the weather like today?" }, accept: ["the weather", "time"], hint: "El tiempo means both the weather and time. ¿Qué tiempo hace? is the standard \"what's it like out?\"" },
        ...
        { id: "es-u8l3-lluvia", type: "vocab", front: "la lluvia", reading: "lalluvia", meaning: "rain", example: { jp: "Hoy hay lluvia en Madrid.", en: "There's rain in Madrid today." }, accept: ["the rain", "rainfall"], hint: "Double l again: YU-via." },
    ...
    },
    {
      ...
      cefr: "A1",
      dominantMode: "recall",
      canDo: "Say what it's like out: hace calor, hace frío, hace sol, está nublado, llueve, la nieve.",
      items: [
        ...
        { id: "es-u8l4-hacefrio", type: "vocab", front: "hace frío", reading: "hacefrio", meaning: "it's cold", example: { jp: "Hoy hace frío en el pueblo.", en: "It's cold in the town today." }, accept: ["it is cold", "cold weather", "the weather is cold"] },
        ...
        { id: "es-u8l4-estanublado", type: "vocab", front: "está nublado", reading: "estanublado", meaning: "it's cloudy", example: { jp: "Hoy está nublado en Madrid.", en: "It's cloudy in Madrid today." }, accept: ["it is cloudy", "cloudy", "overcast"], hint: "Cloudy is the odd one out — it uses estar, not hacer. From la nube." },
        { id: "es-u8l4-llueve", type: "vocab", front: "llueve", reading: "llueve", meaning: "it's raining", example: { jp: "Hoy llueve en Barcelona.", en: "It's raining in Barcelona today." }, accept: ["it rains", "it is raining", "raining"], hint: "One word is the whole sentence — no \"it\" needed. Llueve is to la lluvia what \"rains\" is to \"rain\"." },
