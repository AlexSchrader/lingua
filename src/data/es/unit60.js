  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u60l2-solventar", type: "vocab", front: "solventar", reading: "solventar", meaning: "to resolve / settle", example: { jp: "Solventamos el problema en menos de una hora.", en: "We resolved the problem in under an hour." }, accept: ["to resolve", "to settle", "to sort out"], hint: "Formal, and used for problems and debts alike. Same family as la solución." },
        { id: "es-u60l2-abordar", type: "vocab", front: "abordar", reading: "abordar", meaning: "to tackle / address", example: { jp: "Hay que abordar el problema desde otro punto de vista.", en: "We have to tackle the problem from another point of view." }, accept: ["to tackle", "to address", "to deal with"], hint: "To take a problem on rather than go round it. It also means to board a plane or a ship." },
      ],
    },
    {
      id: "es-u60l3",
      ...
      items: [
        ...
        { id: "es-u60l3-agravarse", type: "vocab", front: "agravarse", reading: "agravarse", meaning: "to get worse", example: { jp: "La situación se agravó mucho durante el invierno.", en: "The situation got much worse during the winter." }, accept: ["to worsen", "to get worse", "to deteriorate"], hint: "Reflexive, from grave: something already bad becomes worse." },
        { id: "es-u60l3-deteriorarse", type: "vocab", front: "deteriorarse", reading: "deteriorarse", meaning: "to deteriorate", example: { jp: "Su salud se ha deteriorado en los últimos meses.", en: "His health has deteriorated over the last few months." }, accept: ["to deteriorate", "to get worse", "to decline"], hint: "A slow decline, not a sudden break — for health, buildings and relationships." },
      ],
    },
    {
      id: "es-u60l4",
      ...
      items: [
        ...
        { id: "es-u60l4-perseverar", type: "vocab", front: "perseverar", reading: "perseverar", meaning: "to persevere", example: { jp: "Perseveró hasta conseguir el trabajo que quería.", en: "He persevered until he got the job he wanted." }, accept: ["to persevere", "to persist", "to keep at it"], hint: "To keep going precisely when it is hard. The formal cousin of seguir intentándolo." },
      ],
    },
  ],
};
