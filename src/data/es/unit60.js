...
export const ES_UNIT60 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "es-u60l2-resolver", type: "vocab", front: "resolver", reading: "resolver", meaning: "to solve", example: { jp: "Conseguimos resolver el problema con ayuda de todos.", en: "We managed to solve the problem with everyone's help." }, accept: ["to resolve", "to work out"], hint: "To solve a problem or a doubt. The o becomes ue: resuelvo. From it comes la solución (A2)." },
    ...
    },
    {
      ...
      items: [
        { id: "es-u60l3-fallar", type: "vocab", front: "fallar", reading: "fallar", meaning: "to fail", example: { jp: "El plan falló por un pequeño error.", en: "The plan failed because of a small mistake." }, accept: ["to go wrong", "to let down"], hint: "For a plan or a machine to fail — or to let someone down: no me falles. From it comes el fallo (l1)." },
        ...
        { id: "es-u60l3-fracasar", type: "vocab", front: "fracasar", reading: "fracasar", meaning: "to fail", example: { jp: "El negocio fracasó después de dos años.", en: "The business failed after two years." }, accept: ["to flop", "to fall through"], hint: "For a project or business to fail completely. From el fracaso (A2). Stronger than fallar." },
