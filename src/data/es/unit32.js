  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u32l1-elvecino", type: "vocab", front: "el vecino", reading: "elvecino", meaning: "neighbour", example: { jp: "Mis vecinos son muy amables.", en: "My neighbours are very kind." }, accept: ["the neighbor", "neighbour", "neighbor"], hint: "From vecino you get el barrio's feel — the people next door. Feminine: la vecina." },
      ],
    },
    {
      id: "es-u32l2",
