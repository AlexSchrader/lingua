  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u31l1-honesto", type: "vocab", front: "honesto", reading: "honesto", meaning: "honest", example: { jp: "Es un hombre muy honesto.", en: "He's a very honest man." }, accept: ["truthful", "sincere"], hint: "The h is silent, as always in Spanish: \"o-NES-to\"." },
      ],
    },
    {
      id: "es-u31l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u31l3-lacualidad", type: "vocab", front: "la cualidad", reading: "lacualidad", meaning: "quality", example: { jp: "Es una buena cualidad, no un defecto.", en: "It's a good quality, not a flaw." }, accept: ["the quality", "virtue", "trait"], hint: "A good trait in a person — not the quality of a product (that's la calidad, one letter off)." },
