  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u74l2-alcanzar", type: "vocab", front: "alcanzar", reading: "alcanzar", meaning: "to reach", example: { jp: "No alcanzo el estante de arriba, así que necesito una silla.", en: "I can't reach the top shelf, so I need a chair." }, accept: ["to get to", "to attain", "to catch up with"], hint: "To reach a place or a goal, and to be enough: no me alcanza el dinero — I don't have enough money." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u74l3-quejarse", type: "vocab", front: "quejarse", reading: "quejarse", meaning: "to complain", example: { jp: "Se queja de todo, aunque en el fondo tiene bastante suerte.", en: "He complains about everything, although deep down he's quite lucky." }, accept: ["to moan", "to grumble"], hint: "quejarse DE algo. The noun is la queja, the complaint." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u74l4-advertir", type: "vocab", front: "advertir", reading: "advertir", meaning: "to warn", example: { jp: "Te advierto que el camino es largo, así que sal temprano.", en: "I warn you the way is long, so leave early." }, accept: ["to warn", "to notice", "to point out"], hint: "To warn, and also to notice: no advertí el error. La advertencia is the warning." },
