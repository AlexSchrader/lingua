  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u114l3-comparecer", type: "vocab", front: "comparecer", reading: "comparecer", meaning: "to appear (in court)", example: { jp: "Tuvo que comparecer ante el tribunal el lunes.", en: "He had to appear before the court on Monday." }, accept: ["to appear", "to appear in court", "to attend court"], hint: "Comparecer ANTE alguien. Not turning up — no comparecer — is itself an offence." },
        { id: "es-u114l3-declarar", type: "vocab", front: "declarar", reading: "declarar", meaning: "to give evidence / testify", example: { jp: "El testigo declaró durante más de dos horas.", en: "The witness gave evidence for more than two hours." }, accept: ["to testify", "to give evidence", "to make a statement"], hint: "The noun is la declaración. Outside the courtroom it simply means to state or declare." },
    ...
    },
    {
      ...
      unit: 114,
      lesson: 4,
      title: "La sentencia y el recurso",
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Report how a case ended: give the verdict, say someone was convicted or acquitted, and say the decision is being appealed.",
      items: [
        ...
        { id: "es-u114l4-laapelacion", type: "vocab", front: "la apelación", reading: "laapelacion", meaning: "the appeal", example: { jp: "Presentaron la apelación al día siguiente.", en: "They filed the appeal the next day." }, accept: ["the appeal", "the appeal to a higher court"], hint: "En apelación = on appeal. A higher tribunal looks again at what the first one decided." },
