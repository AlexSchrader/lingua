  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u83l2-lanegociacion", type: "vocab", front: "la negociación", reading: "lanegociacion", meaning: "the negotiation", example: { jp: "La negociación duró tres días y terminó sin acuerdo.", en: "The negotiation lasted three days and ended without agreement." }, accept: ["the negotiation", "the talks"], hint: "Usually plural in the news: las negociaciones. From negociar." },
        { id: "es-u83l2-eltratado", type: "vocab", front: "el tratado", reading: "eltratado", meaning: "the treaty", example: { jp: "Los dos países tienen un tratado de paz desde hace años.", en: "The two countries have had a peace treaty for years." }, accept: ["the treaty", "the pact"], hint: "A signed agreement between states: un tratado de paz, un tratado comercial." },
        { id: "es-u83l2-laviolencia", type: "vocab", front: "la violencia", reading: "laviolencia", meaning: "violence", example: { jp: "La violencia no resuelve ningún conflicto.", en: "Violence doesn't resolve any conflict." }, accept: ["violence"], hint: "Violento is the adjective. Sin violencia = peacefully." },
      ],
    },
    {
      id: "es-u83l3",
