  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u68l1-elafecto", type: "vocab", front: "el afecto", reading: "elafecto", meaning: "affection", example: { jp: "Habla de sus abuelos con mucho afecto.", en: "She speaks about her grandparents with great affection." }, accept: ["affection", "fondness", "warmth"], hint: "More formal than el cariño, the card before. Tomar afecto a alguien = to grow fond of someone." },
      ],
    },
    {
      id: "es-u68l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u68l4-laexclusion", type: "vocab", front: "la exclusión", reading: "laexclusion", meaning: "exclusion", example: { jp: "La exclusión social afecta sobre todo a los más pobres.", en: "Social exclusion affects the poorest most of all." }, accept: ["exclusion", "marginalization"], hint: "The noun of excluir, the card before it. La exclusión social is the fixed phrase." },
        { id: "es-u68l4-vulnerable", type: "vocab", front: "vulnerable", reading: "vulnerable", meaning: "vulnerable", example: { jp: "Los grupos más vulnerables necesitan más ayuda del estado.", en: "The most vulnerable groups need more help from the state." }, accept: ["vulnerable", "at risk"], hint: "Of the people a problem hits hardest: los colectivos vulnerables." },
      ],
    },
  ],
};
