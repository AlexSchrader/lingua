  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u68l1-elcarino", type: "vocab", front: "el cariño", reading: "elcarino", meaning: "fondness", example: { jp: "Se tratan con mucho cariño, aunque discutan de vez en cuando.", en: "They treat each other with great affection, although they argue now and then." }, drill: { jp: "El cariño de mi abuela es enorme", en: "My grandmother's affection is enormous" }, accept: ["fondness", "warmth", "love", "affection"], hint: "The warmth between people who care for each other. Con cariño closes a warm letter." },
