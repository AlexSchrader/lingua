...
export const ES_UNIT104 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "es-u104l3-viral", type: "vocab", front: "viral", reading: "viral", meaning: "viral", example: { jp: "Ese mensaje se hizo viral en pocas horas.", en: "That message went viral in a few hours." }, drill: { jp: "Su carta acabó siendo viral en la red", en: "Her letter ended up going viral on the network" }, accept: ["viral"], hint: "Hacerse viral is the fixed way to say it went viral. The medical sense came first, and the metaphor is the same: it spreads by contact." },
        { id: "es-u104l3-difusion", type: "vocab", front: "la difusión", reading: "ladifusion", meaning: "spread / circulation", example: { jp: "La difusión de la noticia fue muy grande en la red.", en: "The story's spread on the network was very wide." }, drill: { jp: "La difusión del informe fue muy lenta", en: "The report's circulation was very slow" }, accept: ["spread", "circulation", "dissemination", "reach"], hint: "How widely something travels. Un medio de gran difusión is a paper a lot of people actually see." },
        { id: "es-u104l3-difundir", type: "vocab", front: "difundir", reading: "difundir", meaning: "to spread / circulate", example: { jp: "No hay que difundir una noticia sin leerla.", en: "You should not spread a story without reading it." }, drill: { jp: "La radio empezó a difundir la noticia ayer", en: "The radio started spreading the story yesterday" }, accept: ["to spread", "to circulate", "to broadcast", "spread"], hint: "The verb behind la difusión. Difundir un bulo is what everyone does by accident; the reflexive difundirse is the story doing it by itself." },
        { id: "es-u104l3-altavoz", type: "vocab", front: "el altavoz", reading: "elaltavoz", meaning: "megaphone / amplifier (figurative)", example: { jp: "La red es un altavoz para cualquier opinión.", en: "The network is a megaphone for any opinion." }, drill: { jp: "Ese periódico es el altavoz del gobierno", en: "That paper is the government's megaphone" }, accept: ["megaphone", "loudspeaker", "amplifier", "platform"], hint: "Literally a loudspeaker; in media talk, whatever makes one voice louder than it was. Servir de altavoz a alguien is rarely a compliment." },
        { id: "es-u104l3-eco", type: "vocab", front: "el eco", reading: "eleco", meaning: "echo / pick-up (coverage)", example: { jp: "La noticia tuvo mucho eco en la prensa del país.", en: "The story got a lot of pick-up in the country's press." }, drill: { jp: "El eco de esas palabras duró meses", en: "The echo of those words lasted months" }, accept: ["echo", "pick-up", "resonance", "coverage"], hint: "Tener eco = to be picked up and repeated. Hacerse eco de algo is what a paper does when it reports someone else's story." },
        { id: "es-u104l3-primicia", type: "vocab", front: "la primicia", reading: "laprimicia", meaning: "scoop / exclusive", example: { jp: "El periodista tuvo la primicia y la publicó primero.", en: "The journalist had the scoop and published it first." }, drill: { jp: "Nadie quiso dar la primicia esa noche", en: "Nobody wanted to break the scoop that night" }, accept: ["scoop", "exclusive", "breaking story"], hint: "From primero: the story nobody else has yet. Dar la primicia is the whole competitive point of a newsroom." },
      ],
    },
    {
      id: "es-u104l4",
      ...
      items: [
        { id: "es-u104l4-censura", type: "vocab", front: "la censura", reading: "lacensura", meaning: "censorship", example: { jp: "Bajo la censura, ningún periódico podía contar eso.", en: "Under censorship, no newspaper could report that." }, drill: { jp: "La censura volvió con el gobierno nuevo", en: "Censorship came back with the new government" }, accept: ["censorship", "censure"], hint: "The state cutting what may be published. La autocensura is the more common modern problem: the paper cutting itself." },
        { id: "es-u104l4-polemica", type: "vocab", front: "la polémica", reading: "lapolemica", meaning: "controversy / row", example: { jp: "Sus palabras crearon una polémica que duró semanas.", en: "His words created a controversy that lasted weeks." }, drill: { jp: "La polémica creció después de esa entrevista", en: "The controversy grew after that interview" }, accept: ["controversy", "row", "furore", "dispute"], hint: "A public argument in the media. As an adjective, polémico describes the thing that started it: una decisión polémica." },
        { id: "es-u104l4-escandalo", type: "vocab", front: "el escándalo", reading: "elescandalo", meaning: "scandal", example: { jp: "El escándalo obligó al partido a cambiar de líder.", en: "The scandal forced the party to change leader." }, drill: { jp: "Todo el escándalo empezó con una carta", en: "The whole scandal began with a letter" }, accept: ["scandal", "outrage"], hint: "Wrongdoing made public, plus the noise around it. Un escándalo needs someone to have done something; una polémica only needs disagreement." },
        { id: "es-u104l4-tirada", type: "vocab", front: "la tirada", reading: "latirada", meaning: "print run / circulation", example: { jp: "La tirada del periódico bajó mucho en diez años.", en: "The paper's print run fell a lot in ten years." }, drill: { jp: "La tirada de hoy se vendió muy rápido", en: "Today's print run sold very quickly" }, accept: ["print run", "circulation", "readership"], hint: "How many copies are printed, and by extension how big a paper is. From tirar in its printing sense." },
        { id: "es-u104l4-morbo", type: "vocab", front: "el morbo", reading: "elmorbo", meaning: "morbid fascination", example: { jp: "Esa historia se vendió bien solo por el morbo.", en: "That story sold well purely on morbid fascination." }, drill: { jp: "El morbo vende muchos periódicos", en: "Morbid fascination sells many newspapers" }, accept: ["morbid fascination", "morbid curiosity", "ghoulish interest"], hint: "The pull of what we should not want to look at. Tener morbo = to be darkly fascinating; the adjective is morboso." },
        { id: "es-u104l4-ladifamacion", type: "vocab", front: "la difamación", reading: "ladifamacion", meaning: "defamation", example: { jp: "El periódico perdió un juicio por difamación.", en: "The newspaper lost a defamation case." }, drill: { jp: "La difamación puede costar mucho dinero", en: "Defamation can cost a lot of money" }, accept: ["defamation", "libel", "slander"], hint: "Difamar is the verb. The written form is libelo; spoken, calumnia." },
      ],
    },
  ],
};
