  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u104l4-ladifamacion", type: "vocab", front: "la difamación", reading: "ladifamacion", meaning: "defamation", example: { jp: "El periódico perdió un juicio por difamación.", en: "The newspaper lost a defamation case." }, accept: ["defamation", "libel", "slander"], hint: "Difamar is the verb. The written form is libelo; spoken, calumnia." },
      ],
    },
  ],
};
