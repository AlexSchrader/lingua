  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u100l1-lacupula", type: "vocab", front: "la cúpula", reading: "lacupula", meaning: "the leadership / top brass", example: { jp: "La cúpula del partido se reunió a puerta cerrada.", en: "The party leadership met behind closed doors." }, accept: ["the leadership", "the top brass", "the upper echelons", "the dome"], hint: "Literally a dome. Figuratively the small group at the very top of an institution." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u100l2-elgremio", type: "vocab", front: "el gremio", reading: "elgremio", meaning: "the trade / profession", example: { jp: "Todo el gremio se opuso a la nueva norma.", en: "The whole trade opposed the new rule." }, accept: ["the trade", "the profession", "the guild", "the industry"], hint: "Everyone who does the same job, seen as one body. Historically a medieval guild." },
      ],
    },
    {
      id: "es-u100l3",
      ...
      items: [
        ...
        { id: "es-u100l3-lavacante", type: "vocab", front: "la vacante", reading: "lavacante", meaning: "the vacancy", example: { jp: "La vacante lleva seis meses sin cubrirse.", en: "The vacancy has gone six months without being filled." }, accept: ["the vacancy", "the opening", "the vacant post"], hint: "Cubrir una vacante = to fill a vacancy. Also an adjective: un puesto vacante." },
        { id: "es-u100l3-elcese", type: "vocab", front: "el cese", reading: "elcese", meaning: "the removal from office", example: { jp: "Anunciaron su cese sin dar ninguna explicación.", en: "They announced his removal without giving any explanation." }, accept: ["the removal from office", "the dismissal", "the standing down", "the cessation"], hint: "Leaving a post, whether pushed or by agreement. Cesar a alguien is to remove them." },
    ...
    },
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Describe the shape of a working life: talk about a career path and a promotion, name a route and a change of field, and refer to a professional profile and a calling.",
      items: [
        { id: "es-u100l4-latrayectoria", type: "vocab", front: "la trayectoria", reading: "latrayectoria", meaning: "the career path", example: { jp: "Su trayectoria abarca cuatro países y tres idiomas.", en: "Her career spans four countries and three languages." }, accept: ["the career path", "the career", "the track record", "the trajectory"], hint: "The path a working life has traced, seen as a whole. Also the physical path of a moving object." },
        { id: "es-u100l4-lapromocion", type: "vocab", front: "la promoción", reading: "lapromocion", meaning: "the promotion", example: { jp: "Rechazó la promoción para no mudarse de ciudad.", en: "He turned down the promotion so as not to move city." }, accept: ["the promotion", "the advancement", "the year group"], hint: "Moving up a grade. It also means a graduating class: la promoción de 2019." },
        { id: "es-u100l4-elitinerario", type: "vocab", front: "el itinerario", reading: "elitinerario", meaning: "the route / pathway", example: { jp: "La empresa ofrece dos itinerarios distintos a sus técnicos.", en: "The company offers its technicians two different pathways." }, accept: ["the route", "the pathway", "the itinerary", "the track"], hint: "A planned sequence of steps, in a career or on a journey." },
        { id: "es-u100l4-lareconversion", type: "vocab", front: "la reconversión", reading: "lareconversion", meaning: "the retraining / conversion", example: { jp: "La reconversión del sector dejó a miles sin oficio.", en: "The conversion of the sector left thousands without a trade." }, accept: ["the retraining", "the conversion", "the restructuring", "the retooling"], hint: "Of a whole industry, and of a person changing field: la reconversión profesional." },
