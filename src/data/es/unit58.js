  ...
  lessons: [
    {
      ...
      items: [
        { id: "es-u58l1-elconcepto", type: "vocab", front: "el concepto", reading: "elconcepto", meaning: "concept", example: { jp: "Es un concepto difícil de entender al principio.", en: "It's a concept that's hard to understand at first." }, accept: ["the idea", "notion"], hint: "An abstract idea. Tener un buen concepto de alguien = to think well of someone." },
        { id: "es-u58l1-lateoria", type: "vocab", front: "la teoría", reading: "lateoria", meaning: "theory", example: { jp: "En teoría funciona, pero en la práctica no.", en: "In theory it works, but in practice it doesn't." }, accept: ["the theory"], hint: "En teoría = in theory, against en la práctica. la práctica is a clear cognate." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u58l2-elprincipio", type: "vocab", front: "el principio", reading: "elprincipio", meaning: "principle", example: { jp: "Es una persona de principios muy claros.", en: "He's a person of very clear principles." }, accept: ["the beginning", "start"], hint: "Both a moral principle and a beginning: al principio = at the start (u54). The plural, principios, is usually the moral sense." },
      ],
    },
    {
      id: "es-u58l3",
