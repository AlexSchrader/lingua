  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u98l1-propenso", type: "vocab", front: "propenso", reading: "propenso", meaning: "prone / liable to", example: { jp: "La zona es propensa a las inundaciones en otoño.", en: "The area is prone to flooding in autumn." }, accept: ["prone", "liable to", "susceptible", "given to"], hint: "propenso A algo. Of places, of materials and of people: propenso a enfadarse." },
      ],
    },
    {
      id: "es-u98l2",
      ...
      items: [
        ...
        { id: "es-u98l2-acechar", type: "vocab", front: "acechar", reading: "acechar", meaning: "to lurk / loom over", example: { jp: "La misma amenaza acecha a todos los puertos de la costa.", en: "The same threat looms over every port on the coast." }, accept: ["to lurk", "to loom over", "to stalk", "to lie in wait"], hint: "A danger waiting quietly for its moment. Al acecho = lying in wait." },
      ],
    },
    {
      id: "es-u98l3",
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Describe managing a danger: act with caution, take a precaution, plan for a contingency, and say a measure reduced or eased the damage.",
      items: [
        ...
        { id: "es-u98l3-cauteloso", type: "vocab", front: "cauteloso", reading: "cauteloso", meaning: "cautious", example: { jp: "El informe es cauteloso y no promete nada.", en: "The report is cautious and promises nothing." }, accept: ["cautious", "wary", "guarded"], hint: "Of people and of statements. A cautious document is one that avoids committing itself." },
        { id: "es-u98l3-laprecaucion", type: "vocab", front: "la precaución", reading: "laprecaucion", meaning: "the precaution", example: { jp: "Tomaron todas las precauciones antes de abrir el edificio.", en: "They took every precaution before opening the building." }, accept: ["the precaution", "the safeguard", "care"], hint: "Tomar precauciones = to take precautions. The concrete step; la cautela is the attitude." },
    ...
    },
    {
      ...
      items: [
        { id: "es-u98l4-lapoliza", type: "vocab", front: "la póliza", reading: "lapoliza", meaning: "the policy (insurance)", example: { jp: "La póliza no cubre los daños por inundación.", en: "The policy does not cover flood damage." }, accept: ["the policy", "the insurance policy"], hint: "The insurance contract itself. Not a political policy, which is la política." },
        { id: "es-u98l4-laindemnizacion", type: "vocab", front: "la indemnización", reading: "laindemnizacion", meaning: "the compensation / payout", example: { jp: "Recibieron una indemnización meses después del incendio.", en: "They received a payout months after the fire." }, accept: ["the compensation", "the payout", "the settlement", "damages"], hint: "Indemnizar is the verb. Also the payment on losing a job: la indemnización por despido." },
