  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u98l3-lasalvaguarda", type: "vocab", front: "la salvaguarda", reading: "lasalvaguarda", meaning: "the safeguard", example: { jp: "El contrato incluye una salvaguarda por si cambia la ley.", en: "The contract includes a safeguard in case the law changes." }, accept: ["the safeguard", "the protection", "the safety net"], hint: "A clause or measure put in place so a foreseeable harm cannot land. Salvaguardar is the verb." },
