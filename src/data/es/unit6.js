  ...
  lessons: [
    ...
    // Lesson 2: fruit and vegetables
    {
      ...
      items: [
        ...
        { id: "es-u6l2-lamanzana", type: "vocab", front: "la manzana", reading: "lamanzana", meaning: "apple", example: { jp: "Como una manzana.", en: "I'm eating an apple." }, accept: ["the apple"], hint: "man-SA-na. In many cities it also means a city block." },
