...
export const ES_UNIT75 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "es-u75l4-actual", type: "vocab", front: "actual", reading: "actual", meaning: "current", example: { jp: "La situación actual es difícil, aunque mejor que hace un año.", en: "The current situation is difficult, although better than a year ago." }, accept: ["present", "present-day"], hint: "False friend: actual means current, not 'actual'. actualmente = currently, not 'actually'." },
        { id: "es-u75l4-reciente", type: "vocab", front: "reciente", reading: "reciente", meaning: "recent", example: { jp: "Es una noticia reciente, así que todavía no la conoce mucha gente.", en: "It's recent news, so not many people know about it yet." }, accept: ["fresh", "new"], hint: "The adverb recientemente = recently, though hace poco is more common in speech." },
