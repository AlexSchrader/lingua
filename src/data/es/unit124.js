...
export const ES_UNIT124 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      unit: 124,
      lesson: 3,
      title: "El tejido y la fibra",
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Say what something is woven from: cloth, linen, cotton, silk, leather and fibre in general.",
      items: [
        { id: "es-u124l3-eltejido", type: "vocab", front: "el tejido", reading: "eltejido", meaning: "the fabric / textile", example: { jp: "Es un tejido muy resistente que dura años.", en: "It is a very hard-wearing fabric that lasts for years." }, accept: ["the fabric", "the textile", "the weave"], hint: "From tejer, to weave: the material as a type. In medicine it is also body tissue." },
        { id: "es-u124l3-latela", type: "vocab", front: "la tela", reading: "latela", meaning: "the cloth / piece of fabric", example: { jp: "Compró dos metros de tela para las cortinas.", en: "She bought two metres of cloth for the curtains." }, accept: ["the cloth", "the material", "the fabric"], hint: "The stuff you buy by the metre and cut. El tejido is the kind; la tela is the piece in your hands." },
    ...
    },
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Name the small parts that hold an object together and make it work: screw, nut, hinge, lever, handle and joint.",
      items: [
        ...
        { id: "es-u124l4-lajunta", type: "vocab", front: "la junta", reading: "lajunta", meaning: "the joint / seal", example: { jp: "Hay que cambiar la junta porque pierde agua.", en: "The seal has to be changed because it is leaking." }, accept: ["the joint", "the seal", "the gasket"], hint: "Where two parts meet, and the ring that keeps the meeting watertight. It also names a board of governors." },
      ],
    },
  ],
};
