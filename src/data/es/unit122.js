  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u122l1-divulgar", type: "vocab", front: "divulgar", reading: "divulgar", meaning: "to disclose / make public", example: { jp: "La ley prohíbe divulgar los nombres de los testigos.", en: "The law forbids disclosing the names of the witnesses." }, accept: ["to disclose", "to make public", "to divulge"], hint: "Formal and often legal. A second, friendlier sense is to popularise knowledge — la divulgación científica." },
        { id: "es-u122l1-difundir", type: "vocab", front: "difundir", reading: "difundir", meaning: "to spread / circulate", example: { jp: "El vídeo se difundió en pocas horas.", en: "The video spread within a few hours." }, accept: ["to spread", "to circulate", "to broadcast"], hint: "About reach rather than secrecy — the news was already known, now it is everywhere." },
      ],
    },
    {
      id: "es-u122l2",
      ...
      items: [
        { id: "es-u122l2-testificar", type: "vocab", front: "testificar", reading: "testificar", meaning: "to testify", example: { jp: "Decidió testificar contra su antiguo jefe.", en: "He decided to testify against his former boss." }, accept: ["to testify", "to give evidence", "to bear witness"], hint: "Testificar CONTRA or A FAVOR DE alguien. Built on el testigo, the witness (u83)." },
        ...
        { id: "es-u122l2-alegar", type: "vocab", front: "alegar", reading: "alegar", meaning: "to allege / plead", example: { jp: "Alegó que no sabía nada de aquel pago.", en: "He alleged that he knew nothing about that payment." }, accept: ["to allege", "to plead", "to claim"], hint: "Offering a reason in your own defence, whether or not it is true. Alegar que + indicative." },
    ...
    },
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Say something without saying it: hint at it, allude to it, pin it on someone, or brand them with a label.",
      items: [
        { id: "es-u122l3-insinuar", type: "vocab", front: "insinuar", reading: "insinuar", meaning: "to insinuate / hint at", example: { jp: "Insinuó que alguien de la propia empresa había filtrado el documento.", en: "He insinuated that someone from the company itself had leaked the document." }, accept: ["to insinuate", "to hint at", "to imply"], hint: "Saying it while keeping the option of not having said it. ¿Qué insinúas? is the standard challenge." },
        { id: "es-u122l3-aludir", type: "vocab", front: "aludir", reading: "aludir", meaning: "to allude / refer to", example: { jp: "En ningún momento aludió al informe anterior.", en: "At no point did he allude to the earlier report." }, accept: ["to allude to", "to refer to", "to mention indirectly"], hint: "Aludir A algo. Darse por aludido = to take a remark as being about you." },
        ...
        { id: "es-u122l3-censurar", type: "vocab", front: "censurar", reading: "censurar", meaning: "to condemn (publicly)", example: { jp: "Varios países censuraron la decisión el mismo día.", en: "Several countries condemned the decision the same day." }, accept: ["to condemn", "to censure", "to criticise publicly"], hint: "Public and official disapproval. The other sense — to censor a text — is the same verb." },
    ...
    },
    {
      ...
      unit: 122,
      lesson: 4,
      title: "Reprochar y reprender",
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Grade a telling-off: a private reproach, a boss's rebuke, an official warning, a public dressing-down, and a sharp reply.",
      items: [
        { id: "es-u122l4-reprochar", type: "vocab", front: "reprochar", reading: "reprochar", meaning: "to reproach", example: { jp: "Le reprochó que no hubiera dicho nada antes.", en: "She reproached him for not having said anything earlier." }, accept: ["to reproach", "to hold against", "to blame"], hint: "Reprochar algo A alguien, and often with the subjunctive after que. Between equals, and usually personal." },
        ...
        { id: "es-u122l4-replicar", type: "vocab", front: "replicar", reading: "replicar", meaning: "to retort / answer back", example: { jp: "Replicó que él tampoco había recibido ninguna carta.", en: "He retorted that he had not received any letter either." }, accept: ["to retort", "to answer back", "to reply sharply"], hint: "An answer that pushes back. Sin replicar = without a word of protest." },
      ],
    },
  ],
};
