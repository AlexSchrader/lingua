  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u12l1-este", type: "vocab", front: "este", reading: "este", meaning: "this (with a masculine word)", example: { jp: "Este pan es muy bueno.", en: "This bread is very good." }, accept: ["this"], hint: "este goes in front of a masculine noun: este pan, este día. The -e ending is the masculine one here." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u12l3-tu", type: "vocab", front: "tú", reading: "tu", meaning: "you", example: { jp: "Tú eres el médico, ¿no?", en: "You're the doctor, right?" }, accept: ["you (informal)"], hint: "tú with an accent is the person. tu without one means \"your\" (Unit 14). Same sound, different job." },
    ...
    },
    {
      ...
      cefr: "A1",
      dominantMode: "recall",
      canDo: "Say what exists and where it is: hay un parque en la ciudad, la escuela está en la calle.",
      items: [
        { id: "es-u12l4-hay", type: "vocab", front: "hay", reading: "hay", meaning: "there is", example: { jp: "Hay un parque en la ciudad.", en: "There's a park in the city." }, accept: ["there are", "there's"], hint: "One word for both \"there is\" and \"there are\" — it never changes: hay un café, hay dos cafés." },
        { id: "es-u12l4-nohay", type: "vocab", front: "no hay", reading: "nohay", meaning: "there isn't", example: { jp: "No hay pan en la casa.", en: "There isn't any bread in the house." }, accept: ["there aren't", "there is no"] },
        { id: "es-u12l4-en", type: "vocab", front: "en", reading: "en", meaning: "in", example: { jp: "El café está en la calle.", en: "The café is on the street." }, accept: ["on", "at"], hint: "en covers English in, on and at: en la casa, en la mesa, en la escuela." },
