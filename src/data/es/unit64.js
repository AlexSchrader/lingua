  ...
  lessons: [
    {
      ...
      items: [
        { id: "es-u64l1-laprensa", type: "vocab", front: "la prensa", reading: "laprensa", meaning: "the press", example: { jp: "La prensa es libre en este país, pero no siempre está de acuerdo con el gobierno.", en: "The press is free in this country, but it doesn't always agree with the government." }, accept: ["press", "the media", "newspapers"], hint: "The institution, not the paper you hold — el periódico (u32) is the object, la prensa is the whole trade." },
        { id: "es-u64l1-eltitular", type: "vocab", front: "el titular", reading: "eltitular", meaning: "the headline", example: { jp: "El titular era muy fuerte, aunque la noticia en realidad no decía tanto.", en: "The headline was very strong, although the story actually didn't say that much." }, accept: ["headline", "the header"], hint: "From título, title. As a verb, titular is also \"to hold\" a post — el titular del puesto." },
        { id: "es-u64l1-elreportaje", type: "vocab", front: "el reportaje", reading: "elreportaje", meaning: "the report", example: { jp: "Vi un reportaje sobre la vida en el campo, y me pareció muy interesante.", en: "I watched a report on country life, and I found it very interesting." }, accept: ["report", "feature", "coverage"], hint: "A journalist's piece from the field — not un informe, which is a written business report." },
        ...
        { id: "es-u64l1-lafuente", type: "vocab", front: "la fuente", reading: "lafuente", meaning: "the source", example: { jp: "El periodista no dio su fuente, porque no quería revelar quién se lo había contado.", en: "The journalist didn't give his source, because he didn't want to reveal who had told him." }, accept: ["source", "the origin", "fountain"], hint: "Also a fountain, and a serving dish — the same word covers all three." },
