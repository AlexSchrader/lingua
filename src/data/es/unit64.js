  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u64l1-laredaccion", type: "vocab", front: "la redacción", reading: "laredaccion", meaning: "the newsroom / editorial team", example: { jp: "En la redacción trabajan muchos periodistas.", en: "Many journalists work in the newsroom." }, accept: ["the newsroom", "the editorial team", "the writing"], hint: "Both the room and the people in it. At school it is also an essay." },
