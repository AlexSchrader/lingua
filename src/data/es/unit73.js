  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u73l3-faltariamas", type: "vocab", front: "faltaría más", reading: "faltariamas", meaning: "by all means", example: { jp: "Claro que te ayudo con la mudanza, ¡faltaría más!", en: "Of course I'll help you with the move, it goes without saying!" }, drill: { jp: "Faltaría más le ayudo enseguida", en: "Of course I'll help you right away" }, accept: ["by all means", "but of course", "don't mention it", "of course"], hint: "An emphatic, warm 'of course' — it would be unthinkable to refuse. ¡Faltaría más!" },
        ...
        { id: "es-u73l3-desdeluego", type: "vocab", front: "desde luego", reading: "desdeluego", meaning: "certainly", example: { jp: "Desde luego, tienes toda la razón en eso; no hay nada que discutir.", en: "Of course, you're completely right about that; there's nothing to argue about." }, drill: { jp: "Desde luego es la mejor solución", en: "Of course it's the best solution" }, accept: ["certainly", "definitely", "without doubt", "of course"], hint: "A firm 'of course / certainly'. Also reassuring agreement: desde luego que sí." },
      ],
    },
    {
      id: "es-u73l4",
