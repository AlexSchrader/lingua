  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u73l2-disculparse", type: "vocab", front: "disculparse", reading: "disculparse", meaning: "to apologize", example: { jp: "Se disculpó por llegar tarde a la reunión.", en: "He apologized for arriving late to the meeting." }, accept: ["to apologize", "to say sorry", "to excuse oneself"], hint: "Reflexive: disculparse POR algo, CON alguien. Disculpe is the polite form you already use." },
      ],
    },
    {
      id: "es-u73l3",
