...
export const ES_UNIT116 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Distinguish anger that explodes from anger that is stored: rage, wrath, hatred and long-held resentment.",
      items: [
        ...
        { id: "es-u116l3-elodio", type: "vocab", front: "el odio", reading: "elodio", meaning: "the hatred", example: { jp: "No hay odio en sus palabras, solo tristeza.", en: "There is no hatred in his words, only sadness." }, accept: ["the hatred", "the hate"], hint: "The settled feeling, not the outburst. The verb is odiar." },
