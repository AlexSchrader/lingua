...
export const ES_UNIT125 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Grant a point and then push back on it, or correct a wrong impression you have just given.",
      items: [
        ...
        { id: "es-u125l3-asiytodo", type: "vocab", front: "así y todo", reading: "asiytodo", meaning: "even so / all the same", example: { jp: "Es un texto difícil; así y todo, se lee en una tarde.", en: "It is a difficult text; all the same, you can read it in an afternoon." }, accept: ["even so", "all the same", "still"], hint: "Warmer and more spoken than con todo, and it usually opens the sentence." },
      ],
    },
    {
      id: "es-u125l4",
      ...
      items: [
        ...
        { id: "es-u125l4-ensuma", type: "vocab", front: "en suma", reading: "ensuma", meaning: "in short / in sum", example: { jp: "En suma, el proyecto no se sostiene con estos datos.", en: "In short, the project does not stand up with these figures." }, accept: ["in short", "in sum", "to sum up"], hint: "Gathers the argument into one line. En resumen (u87) summarises content; en suma draws the conclusion." },
