  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u125l2-dichodeotromodo", type: "vocab", front: "dicho de otro modo", reading: "dichodeotromodo", meaning: "put another way", example: { jp: "El plan no se aprobó; dicho de otro modo, hay que empezar de nuevo.", en: "The plan was not approved; put another way, we have to start again." }, drill: { jp: "Dicho de otro modo nadie quiere pagarlo", en: "Put another way nobody wants to pay for it" }, accept: ["put another way", "in other words", "to put it differently"], hint: "You are not correcting yourself, only turning the same idea round for a reader who did not follow." },
        { id: "es-u125l2-enotraspalabras", type: "vocab", front: "en otras palabras", reading: "enotraspalabras", meaning: "in other words", example: { jp: "No hubo pruebas claras; en otras palabras, lo absolvieron.", en: "There was no clear evidence; in other words, he was acquitted." }, drill: { jp: "En otras palabras nos quedamos sin dinero", en: "In other words we are left with no money" }, accept: ["in other words", "put simply", "to put it another way"], hint: "The most neutral of the family, and the one that works in speech as well as in writing." },
        { id: "es-u125l2-enconcreto", type: "vocab", front: "en concreto", reading: "enconcreto", meaning: "specifically", example: { jp: "Habló de varios problemas y, en concreto, del estado del edificio.", en: "He spoke about several problems and, specifically, about the state of the building." }, drill: { jp: "Quiero hablar de tu horario en concreto", en: "I want to talk about your schedule specifically" }, accept: ["specifically", "in particular", "to be precise"], hint: "Narrows from the general to the one case that matters. En particular is its close neighbour." },
        { id: "es-u125l2-valedecir", type: "vocab", front: "vale decir", reading: "valedecir", meaning: "which is to say", example: { jp: "Afecta a todos los casos abiertos, vale decir, también a los antiguos.", en: "It affects all open cases, which is to say, the old ones too." }, drill: { jp: "Vale decir que afecta a todos", en: "Which is to say it affects everyone" }, accept: ["which is to say", "that is to say", "in other words"], hint: "Standard across Latin America, less usual in Spain. It reads as slightly more formal than es decir." },
        { id: "es-u125l2-mejordicho", type: "vocab", front: "mejor dicho", reading: "mejordicho", meaning: "or rather", example: { jp: "Fue un error, mejor dicho, una torpeza.", en: "It was a mistake — or rather, a blunder." }, accept: ["or rather", "that is to say", "more precisely"], hint: "Corrects your own words mid-sentence, upgrading to the more exact one. Always between commas." },
      ],
    },
    {
      id: "es-u125l3",
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Grant a point and then push back on it, correct a wrong impression, or concede something in favour of the person you are criticising.",
      items: [
        ...
        { id: "es-u125l3-noporello", type: "vocab", front: "no por ello", reading: "noporello", meaning: "that does not make it / not for that reason", example: { jp: "El informe es largo; no por ello es difícil de leer.", en: "The report is long; that does not make it hard to read." }, drill: { jp: "Es caro y no por ello es mejor", en: "It is expensive and that does not make it better" }, accept: ["that does not make it", "not for that reason", "that is no reason to"], hint: "Denies the conclusion a reader was about to draw from what you just said. No por ello menos importante is the standard turn." },
        ...
        { id: "es-u125l3-ensudescargo", type: "vocab", front: "en su descargo", reading: "ensudescargo", meaning: "in mitigation / in his favour", example: { jp: "En su descargo hay que decir que nadie le avisó a tiempo.", en: "In his defence, it must be said that nobody warned him in time." }, drill: { jp: "En su descargo nadie le avisó", en: "In his defence nobody warned him" }, accept: ["in mitigation", "in his defence", "in her defence", "to be fair to him"], hint: "Concedes a point in favour of someone you have just criticised. Nothing to do with descargar, to download — this descargo is the older sense of unloading a charge." },
      ],
    },
    {
      id: "es-u125l4",
      ...
      items: [
        { id: "es-u125l4-deentrada", type: "vocab", front: "de entrada", reading: "deentrada", meaning: "to begin with / from the outset", example: { jp: "De entrada, hay que decir que el informe no estaba terminado.", en: "To begin with, it must be said that the report was not finished." }, drill: { jp: "De entrada hay que decir eso", en: "To begin with that must be said" }, accept: ["to begin with", "from the outset", "for a start"], hint: "Opens with the point that has to be settled before anything else. Also means at first sight." },
        { id: "es-u125l4-ensegundolugar", type: "vocab", front: "en segundo lugar", reading: "ensegundolugar", meaning: "secondly", example: { jp: "En segundo lugar, el precio ha subido mucho este año.", en: "Secondly, the price has risen a lot this year." }, drill: { jp: "En segundo lugar hablaremos del presupuesto anual", en: "Secondly we will talk about the annual budget" }, accept: ["secondly", "in the second place", "second"], hint: "The series runs en primer lugar, en segundo lugar, and closes with por último (u87)." },
        { id: "es-u125l4-acontinuacion", type: "vocab", front: "a continuación", reading: "acontinuacion", meaning: "next / below", example: { jp: "A continuación se explican los tres casos.", en: "The three cases are explained below." }, drill: { jp: "A continuación veremos las fotos del viaje", en: "Next we will look at the photos from the trip" }, accept: ["next", "below", "then", "following this"], hint: "In a document it means further down the page; in a talk, the next thing said." },
        { id: "es-u125l4-seguidamente", type: "vocab", front: "seguidamente", reading: "seguidamente", meaning: "thereafter / next", example: { jp: "Se leyó el informe y seguidamente se abrió el turno de preguntas.", en: "The report was read out and thereafter questions were invited." }, drill: { jp: "Seguidamente el juez leyó la lista completa", en: "Next the judge read out the complete list" }, accept: ["thereafter", "next", "immediately after"], hint: "For a sequence of actions in a written record, where a continuación can also point at a text." },
        { id: "es-u125l4-ensintesis", type: "vocab", front: "en síntesis", reading: "ensintesis", meaning: "in short / to sum up", example: { jp: "En síntesis, el proyecto no se sostiene con estos datos.", en: "In short, the project does not stand up with these figures." }, drill: { jp: "En síntesis el proyecto no funciona", en: "In short the project does not work" }, accept: ["in short", "to sum up", "in summary"], hint: "Gathers the whole argument into one line. En resumen (u87) restates the content; this one states what it all comes to." },
        { id: "es-u125l4-enultimainstancia", type: "vocab", front: "en última instancia", reading: "enultimainstancia", meaning: "ultimately / in the last resort", example: { jp: "En última instancia, la decisión es del tribunal.", en: "Ultimately, the decision is the court's." }, drill: { jp: "En última instancia todo depende del dinero", en: "Ultimately everything depends on money" }, accept: ["ultimately", "in the last resort", "in the final analysis"], hint: "Names who or what decides once everything else is exhausted. The courtroom sense of instancia is the same word." },
      ],
    },
  ],
};
