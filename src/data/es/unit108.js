  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u108l2-suavizar", type: "vocab", front: "suavizar", reading: "suavizar", meaning: "to soften (tone)", example: { jp: "Suavizó sus palabras cuando vio que nadie estaba contento.", en: "She softened her words when she saw nobody was happy." }, accept: ["to soften", "to tone down", "to smooth over", "soften"], hint: "About manner more than content — from suave. Atenuar weakens the claim; suavizar only changes how it lands." },
    ...
    },
    {
      ...
      items: [
        { id: "es-u108l3-recalcar", type: "vocab", front: "recalcar", reading: "recalcar", meaning: "to stress / emphasise", example: { jp: "Recalcó que la decisión no era de él.", en: "He stressed that the decision was not his." }, accept: ["to stress", "to emphasise", "to emphasize", "to underline"], hint: "Saying something with extra weight, often because it was missed the first time. Slightly insistent in tone." },
        ...
        { id: "es-u108l3-incidir", type: "vocab", front: "incidir", reading: "incidir", meaning: "to dwell on / bear on", example: { jp: "El autor incide en el mismo punto todo el rato.", en: "The author dwells on the same point the whole time." }, accept: ["to dwell on", "to focus on", "to bear on", "to affect"], hint: "Incidir en means to keep coming back to a point; with a different object it means to have an effect on something." },
