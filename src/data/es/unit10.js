  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u10l1-pequeno", type: "vocab", front: "pequeño", reading: "pequeno", meaning: "small", example: { jp: "El pueblo es pequeño.", en: "The town is small." }, accept: ["little", "tiny"], hint: "The ñ is the ny of \"canyon\": pe-QUE-nyo. And qu is just a k sound." },
        ...
        { id: "es-u10l1-corto", type: "vocab", front: "corto", reading: "corto", meaning: "short", example: { jp: "El día es corto en diciembre.", en: "The day is short in December." }, accept: ["brief"], hint: "Same root as \"curtail\" — corto is short in length or time, never short in height." },
        { id: "es-u10l1-alto", type: "vocab", front: "alto", reading: "alto", meaning: "tall", example: { jp: "El hotel es muy alto.", en: "The hotel is very tall." }, accept: ["high", "loud"], hint: "Tall or high — and for a voice or music, loud. Same root as \"altitude\"." },
        { id: "es-u10l1-bajo", type: "vocab", front: "bajo", reading: "bajo", meaning: "short (in height)", example: { jp: "Carlos es alto y María es baja.", en: "Carlos is tall and María is short." }, accept: ["low", "short", "small in height"], hint: "The opposite of alto. Note baja for María — an -o adjective takes -a for a feminine noun." },
      ],
    },
    {
      id: "es-u10l2",
      ...
      items: [
        ...
        { id: "es-u10l2-malo", type: "vocab", front: "malo", reading: "malo", meaning: "bad", example: { jp: "El tiempo es malo en noviembre.", en: "The weather is bad in November." }, accept: ["poor", "nasty"], hint: "Shortens the same way: un mal día." },
    ...
    },
    {
      ...
      cefr: "A1",
      dominantMode: "recall",
      canDo: "Say what something costs and how much of it there is: caro, barato, limpio, sucio, mucho, poco.",
      items: [
        ...
        { id: "es-u10l4-poco", type: "vocab", front: "poco", reading: "poco", meaning: "a little", example: { jp: "En diciembre hay poco sol.", en: "There's little sun in December." }, accept: ["few", "little", "not much", "a bit"], hint: "The opposite of mucho, and it agrees the same way: poco sol, poca nieve." },
      ],
    },
  ],
};
