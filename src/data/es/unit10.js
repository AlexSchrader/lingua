  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u10l2-malo", type: "vocab", front: "malo", reading: "malo", meaning: "bad", example: { jp: "El hotel es malo.", en: "The hotel is bad." }, accept: ["poor", "nasty"], hint: "Shortens the same way: un mal día. For weather, Spanish prefers a whole phrase — hace mal tiempo — which unit 13 picks up." },
