  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u63l1-elolvido", type: "vocab", front: "el olvido", reading: "elolvido", meaning: "forgetting / oblivion", example: { jp: "El olvido es normal cuando no repasas nada durante meses.", en: "Forgetting is normal when you don't revise anything for months." }, accept: ["forgetting", "oblivion", "the lapse"], hint: "The noun of olvidar. Caer en el olvido = to be forgotten completely." },
      ],
    },
    {
      id: "es-u63l2",
