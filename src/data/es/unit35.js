  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u35l1-laobra", type: "vocab", front: "la obra", reading: "laobra", meaning: "the work / the play", example: { jp: "Esta obra está en el museo desde hace años.", en: "This work has been in the museum for years." }, drill: { jp: "La obra es muy famosa en España", en: "The work is very famous in Spain" }, accept: ["the work", "the work of art", "the play"], hint: "Any made work: una obra de arte, una obra de teatro. En obras = under construction." },
      ],
    },
    {
      id: "es-u35l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u35l4-elpasatiempo", type: "vocab", front: "el pasatiempo", reading: "elpasatiempo", meaning: "the pastime", example: { jp: "Mi pasatiempo favorito es cocinar.", en: "My favourite hobby is cooking." }, drill: { jp: "El pasatiempo de mi hijo es la música", en: "My son's hobby is music" }, accept: ["the pastime", "hobby"], hint: "pasa + tiempo — literally \"pass-time\", exactly the English pastime." },
        ...
        { id: "es-u35l4-laaficion", type: "vocab", front: "la afición", reading: "laaficion", meaning: "the hobby", example: { jp: "Mi afición es la música.", en: "My hobby is music." }, drill: { jp: "La afición de mi padre es el cine", en: "My father's hobby is the cinema" }, accept: ["the hobby", "interest", "passion", "hobby"], hint: "A hobby you're keen on. Un aficionado is a fan — of a sport or a band." },
      ],
    },
  ],
};
