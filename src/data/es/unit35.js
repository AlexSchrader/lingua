  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u35l1-elarte", type: "vocab", front: "el arte", reading: "elarte", meaning: "art", example: { jp: "El museo tiene mucho arte moderno.", en: "The museum has a lot of modern art." }, accept: ["the art"], hint: "An odd one for gender: el arte in the singular, but las artes in the plural." },
    ...
    },
    {
      ...
      items: [
        { id: "es-u35l3-lahistoria", type: "vocab", front: "la historia", reading: "lahistoria", meaning: "story", example: { jp: "Me gusta la historia de España.", en: "I like the history of Spain." }, accept: ["the story", "history", "tale"], hint: "One word for a story and for History the subject. El cuento (this lesson) is specifically a made-up tale." },
