  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u99l1-eltejidosocial", type: "vocab", front: "el tejido social", reading: "eltejidosocial", meaning: "the social fabric", example: { jp: "La fábrica sostenía el tejido social de la comarca.", en: "The factory held up the social fabric of the district." }, accept: ["the social fabric", "the social fibre", "the community fabric"], hint: "Literally the social weave. The everyday web of ties that a crisis can tear." },
        ...
        { id: "es-u99l1-laetnia", type: "vocab", front: "la etnia", reading: "laetnia", meaning: "the ethnic group", example: { jp: "En el país conviven más de veinte etnias.", en: "More than twenty ethnic groups live side by side in the country." }, accept: ["the ethnic group", "the ethnicity", "the people"], hint: "Étnico is the adjective. Neutral where la raza is loaded and largely avoided." },
    ...
    },
    {
      ...
      items: [
        { id: "es-u99l2-elmestizaje", type: "vocab", front: "el mestizaje", reading: "elmestizaje", meaning: "cultural mixing", example: { jp: "La cocina del país es fruto de siglos de mestizaje.", en: "The country's cooking is the fruit of centuries of mixing." }, accept: ["cultural mixing", "the mixing", "blending", "miscegenation"], hint: "Of peoples and of cultures. In Latin America it carries a large historical weight." },
        ...
        { id: "es-u99l2-lacoexistencia", type: "vocab", front: "la coexistencia", reading: "lacoexistencia", meaning: "coexistence", example: { jp: "La coexistencia de las dos lenguas no siempre fue pacífica.", en: "The coexistence of the two languages was not always peaceful." }, accept: ["coexistence", "the coexistence", "living side by side"], hint: "Sharing the same space. La convivencia adds warmth: getting along, not merely coexisting." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u99l3-elestigma", type: "vocab", front: "el estigma", reading: "elestigma", meaning: "the stigma", example: { jp: "Todavía existe un fuerte estigma alrededor del tema.", en: "There is still a strong stigma around the subject." }, accept: ["the stigma", "the mark", "the shame"], hint: "Masculine despite the -a. Estigmatizar = to stigmatise." },
        { id: "es-u99l3-elrecelo", type: "vocab", front: "el recelo", reading: "elrecelo", meaning: "the wariness / mistrust", example: { jp: "Los recibieron con recelo, pero sin hostilidad.", en: "They received them warily, but without hostility." }, accept: ["the wariness", "the mistrust", "the suspicion", "misgiving"], hint: "Quiet, unspoken distrust of the unfamiliar. Recelar de alguien is the verb." },
      ],
    },
    {
      id: "es-u99l4",
      ...
      items: [
        ...
        { id: "es-u99l4-elgueto", type: "vocab", front: "el gueto", reading: "elgueto", meaning: "the ghetto", example: { jp: "Las políticas de vivienda crearon auténticos guetos.", en: "The housing policies created real ghettos." }, accept: ["the ghetto"], hint: "Spelled as it sounds in Spanish. Used of any quarter where one group is shut in." },
        { id: "es-u99l4-segregar", type: "vocab", front: "segregar", reading: "segregar", meaning: "to segregate", example: { jp: "Durante décadas se segregó a los alumnos por su origen.", en: "For decades pupils were segregated by their origin." }, accept: ["to segregate", "to separate out", "to set apart"], hint: "To separate a group and keep it apart. La segregación is the noun." },
