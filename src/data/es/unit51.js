  ...
  lessons: [
    ...
    // Lesson 2: agreeing and disagreeing
    {
      ...
      items: [
        ...
        { id: "es-u51l2-coincidir", type: "vocab", front: "coincidir", reading: "coincidir", meaning: "to concur", example: { jp: "Coincido con ella en este punto, pero no en todo lo demás.", en: "I agree with her on this point, but not on everything else." }, drill: { jp: "Coincidir con el jefe es raro", en: "Agreeing with the boss is rare" }, accept: ["to coincide", "to concur", "to agree"], hint: "coincidir con = to share a view; also to coincide in time or place — coincidimos en la fiesta." },
