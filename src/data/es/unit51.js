  ...
  lessons: [
    ...
    // Lesson 2: agreeing and disagreeing
    {
      ...
      items: [
        ...
        { id: "es-u51l2-oponerse", type: "vocab", front: "oponerse", reading: "oponerse", meaning: "to oppose / be against", example: { jp: "Muchos vecinos se oponen al nuevo plan del ayuntamiento.", en: "Many neighbours are opposed to the town hall's new plan." }, accept: ["to be against", "to object to", "to be opposed to"], hint: "Always reflexive and always with a: oponerse A algo. Me opongo, se opone." },
        { id: "es-u51l2-conforme", type: "vocab", front: "conforme", reading: "conforme", meaning: "in agreement / happy with", example: { jp: "No estoy conforme con el resultado de la reunión.", en: "I'm not happy with the outcome of the meeting." }, accept: ["satisfied", "in agreement", "agreed"], hint: "estar conforme CON algo = to accept it. Softer than estar de acuerdo: it is about accepting, not sharing the view." },
      ],
    },
    ...
    // Lesson 4: conceding and objecting
    {
      ...
      items: [
        ...
        { id: "es-u51l4-objetar", type: "vocab", front: "objetar", reading: "objetar", meaning: "to object", example: { jp: "Nadie objetó nada durante la reunión.", en: "Nobody objected to anything during the meeting." }, accept: ["to raise an objection", "to protest", "to argue against"], hint: "The verb behind la objeción in this lesson. Objetar que… = to object that…" },
        { id: "es-u51l4-ceder", type: "vocab", front: "ceder", reading: "ceder", meaning: "to give in / give way", example: { jp: "Al final cedió y aceptó la propuesta de su jefe.", en: "In the end he gave in and accepted his boss's proposal." }, accept: ["to give in", "to yield", "to back down"], hint: "To stop resisting: ceder ante la presión. On the road, ceder el paso = to give way." },
      ],
    },
  ],
};
