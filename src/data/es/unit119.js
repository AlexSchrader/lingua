...
export const ES_UNIT119 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      unit: 119,
      lesson: 4,
      title: "La trabazón y el acabado",
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Judge a work as a whole: say it holds together, that it is dependable, that the finish is good and that the result comes off.",
      items: [
        { id: "es-u119l4-latrabazon", type: "vocab", front: "la trabazón", reading: "latrabazon", meaning: "the cohesion / knitting-together", example: { jp: "Al relato le falta trabazón: cada capítulo va por su lado.", en: "The story lacks cohesion: each chapter goes its own way." }, accept: ["the cohesion", "the coherence", "the interlocking"], hint: "From trabar, to bind: the parts hold one another. A builder's word borrowed by critics." },
        ...
        { id: "es-u119l4-lasolvencia", type: "vocab", front: "la solvencia", reading: "lasolvencia", meaning: "the reliability / soundness", example: { jp: "Es un estudio de gran solvencia, aunque nadie lo cite.", en: "It is a study of great soundness, even if nobody cites it." }, accept: ["the reliability", "the soundness", "the dependability"], hint: "Started in banking and moved into criticism: work you can build on. Un profesional solvente is one you trust." },
        ...
        { id: "es-u119l4-logrado", type: "vocab", front: "logrado", reading: "logrado", meaning: "well-achieved / successful (as a work)", example: { jp: "El segundo acto es el más logrado de la obra.", en: "The second act is the most successful part of the play." }, accept: ["well-achieved", "successful", "accomplished"], hint: "From lograr: the thing came off as intended. Muy logrado is what a critic says instead of good." },
      ],
    },
  ],
};
