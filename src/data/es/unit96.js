  ...
  lessons: [
    {
      ...
      items: [
        { id: "es-u96l1-lacorriente", type: "vocab", front: "la corriente", reading: "lacorriente", meaning: "the movement / current", example: { jp: "Su pintura no encaja en ninguna corriente conocida.", en: "His painting does not fit into any known movement." }, accept: ["the movement", "the current", "the trend", "the school"], hint: "A current of thought or style. The word also means an electric current and a river current." },
    ...
    },
    {
      ...
      items: [
        { id: "es-u96l2-laresena", type: "vocab", front: "la reseña", reading: "laresena", meaning: "the review", example: { jp: "La reseña del periódico fue dura pero justa.", en: "The newspaper review was harsh but fair." }, accept: ["the review", "the write-up", "the notice"], hint: "A short published judgement of a book, film or show. Reseñar is the verb." },
        ...
        { id: "es-u96l2-elreferente", type: "vocab", front: "el referente", reading: "elreferente", meaning: "the point of reference", example: { jp: "Sus referentes están en la pintura del siglo pasado.", en: "His points of reference lie in the painting of the last century." }, accept: ["the point of reference", "the reference point", "the model", "the touchstone"], hint: "The earlier work an artist looks back to. Ser un referente = to be a benchmark for others." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u96l3-audaz", type: "vocab", front: "audaz", reading: "audaz", meaning: "bold / daring", example: { jp: "Es una novela audaz que incomoda al lector.", en: "It is a bold novel that makes the reader uncomfortable." }, accept: ["bold", "daring", "audacious"], hint: "Praise for taking a risk. Plural audaces. La audacia is the quality." },
        ...
        { id: "es-u96l3-aclamar", type: "vocab", front: "aclamar", reading: "aclamar", meaning: "to acclaim", example: { jp: "La crítica aclamó el disco desde el primer día.", en: "The critics acclaimed the record from day one." }, accept: ["to acclaim", "to hail", "to applaud"], hint: "Public, loud approval. Aclamado por la crítica = critically acclaimed." },
        { id: "es-u96l3-consagrar", type: "vocab", front: "consagrar", reading: "consagrar", meaning: "to establish / make a name", example: { jp: "Aquella exposición la consagró como escultora.", en: "That exhibition established her as a sculptor." }, accept: ["to establish", "to make a name for", "to confirm", "to consecrate"], hint: "Un artista consagrado is one whose reputation is settled. Also religious: to consecrate." },
    ...
    },
    {
      ...
      items: [
        { id: "es-u96l4-recargado", type: "vocab", front: "recargado", reading: "recargado", meaning: "overdone / fussy", example: { jp: "El decorado resulta recargado y distrae de los actores.", en: "The set is overdone and distracts from the actors." }, accept: ["overdone", "fussy", "cluttered", "overloaded"], hint: "Too much of everything. Its opposite in reviews is sobrio, understated." },
        { id: "es-u96l4-convencional", type: "vocab", front: "convencional", reading: "convencional", meaning: "conventional / safe", example: { jp: "Es un retrato correcto pero demasiado convencional.", en: "It is a competent portrait but too conventional." }, accept: ["conventional", "safe", "unadventurous", "orthodox"], hint: "In a review this is never a compliment: it means the artist took no risk." },
        ...
        { id: "es-u96l4-transgredir", type: "vocab", front: "transgredir", reading: "transgredir", meaning: "to break (a rule) / transgress", example: { jp: "Su teatro transgrede todas las normas del género.", en: "Her theatre breaks every rule of the genre." }, accept: ["to break", "to transgress", "to flout", "to violate"], hint: "In art criticism this is usually praise. La transgresión is the act." },
      ],
    },
  ],
};
