  ...
  lessons: [
    // Lesson 1: one to six
    {
      ...
      items: [
        ...
        { id: "es-u5l1-dos", type: "vocab", front: "dos", reading: "dos", meaning: "two", example: { jp: "Tengo dos hermanos.", en: "I have two brothers." }, accept: ["2"], hint: "Through twelve, uno is the only number that changes for gender — the rest stay put. Agreement comes back much later, in the hundreds: doscientas casas." },
        ...
        { id: "es-u5l1-cinco", type: "vocab", front: "cinco", reading: "cinco", meaning: "five", example: { jp: "Mi abuela tiene cinco hijos.", en: "My grandmother has five children." }, accept: ["5"], hint: "Both c's in one word, doing different jobs: soft before i, hard before o — SIN-ko in Latin America, THIN-ko in most of Spain." },
        { id: "es-u5l1-seis", type: "vocab", front: "seis", reading: "seis", meaning: "six", example: { jp: "Tengo seis libros.", en: "I have six books." }, accept: ["6"], hint: "One syllable: English \"say\" with an s stuck on the end — SAYSS. Not the \"sez\" of English says." },
      ],
    },
    // Lesson 2: seven to twelve
    {
      ...
      items: [
        { id: "es-u5l2-siete", type: "vocab", front: "siete", reading: "siete", meaning: "seven", example: { jp: "En mi casa hay siete sillas.", en: "There are seven chairs in my house." }, accept: ["7"], hint: "SYE-te. The ie is one glide, the same one you already met in cielo and will meet again in diez." },
        ...
        { id: "es-u5l2-once", type: "vocab", front: "once", reading: "once", meaning: "eleven", example: { jp: "Hay once sillas en la casa.", en: "There are eleven chairs in the house." }, accept: ["11"], hint: "Not \"one-ce\" — ON-se; ON-theh in most of Spain, with the th of thin. Eleven through fifteen each have their own word; from sixteen on they turn regular." },
        { id: "es-u5l2-doce", type: "vocab", front: "doce", reading: "doce", meaning: "twelve", example: { jp: "Hay doce personas en mi familia.", en: "There are twelve people in my family." }, accept: ["12"], hint: "DO-se; DO-theh in most of Spain, the same th as in thin. You can hear dos hiding inside it." },
      ],
    },
    // Lesson 3: telling the time
    {
      ...
      items: [
        ...
        { id: "es-u5l3-media", type: "vocab", front: "media", reading: "media", meaning: "half past", example: { jp: "Son las cuatro y media.", en: "It's half past four." }, accept: ["half", "thirty"], hint: "media on its own is \"half\"; y media is \"and a half\". It is feminine because it agrees with the hidden word hora." },
