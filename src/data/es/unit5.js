  ...
  lessons: [
    ...
    // Lesson 2: seven to twelve
    {
      ...
      items: [
        ...
        { id: "es-u5l2-once", type: "vocab", front: "once", reading: "once", meaning: "eleven", example: { jp: "Hay once sillas en la casa.", en: "There are eleven chairs in the house." }, accept: ["11"], hint: "Not \"one-ce\" — ON-se, or ON-the in most of Spain. Eleven through fifteen each have their own word; from sixteen on they turn regular." },
        { id: "es-u5l2-doce", type: "vocab", front: "doce", reading: "doce", meaning: "twelve", example: { jp: "Hay doce personas en mi familia.", en: "There are twelve people in my family." }, accept: ["12"], hint: "DO-se, or DO-the in most of Spain. You can hear dos hiding inside it." },
      ],
    },
