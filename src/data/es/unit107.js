  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u107l3-porloqueserefierea", type: "vocab", front: "por lo que se refiere a", reading: "porloqueserefierea", meaning: "as far as ... is concerned", example: { jp: "Por lo que se refiere al tiempo, no hay ningún problema.", en: "As far as time is concerned, there is no problem at all." }, accept: ["as far as is concerned", "as regards", "with regard to", "concerning"], hint: "The same move as en lo que respecta a, built on referirse. Alternating the two is what keeps a long report from sounding mechanical." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u107l4-radicar", type: "vocab", front: "radicar", reading: "radicar", meaning: "to lie (in) / consist in", example: { jp: "El problema radica en la falta de dinero.", en: "The problem lies in the lack of money." }, accept: ["to lie in", "to consist in", "to be rooted in", "lie"], hint: "Radicar en points at where something really comes from — the root, as la raíz suggests. Never used of physical location in this sense." },
