  ...
  lessons: [
    {
      ...
      items: [
        { id: "es-u107l1-cabe", type: "vocab", front: "cabe", reading: "cabe", meaning: "it is worth (doing) / one may", example: { jp: "Cabe señalar que el informe no dice nada de eso.", en: "It is worth noting that the report says nothing about that." }, drill: { jp: "Cabe recordar que el plazo termina hoy", en: "It is worth recalling that the deadline ends today" }, accept: ["it is worth", "one may", "it is possible to", "it should be"], hint: "Cabe + infinitive is the standard opener of a formal paragraph: cabe señalar, cabe recordar, cabe preguntarse. From caber, to fit." },
        { id: "es-u107l1-procede", type: "vocab", front: "procede", reading: "procede", meaning: "it is appropriate to", example: { jp: "No procede hablar de dinero en este punto.", en: "It is not appropriate to discuss money at this point." }, drill: { jp: "Procede abrir el caso de nuevo", en: "It is appropriate to reopen the case" }, accept: ["it is appropriate to", "it is fitting to", "it is in order to", "it is proper to"], hint: "The verb of official propriety: no procede is how a chair rules a question out of order. From proceder." },
        { id: "es-u107l1-baste", type: "vocab", front: "baste", reading: "baste", meaning: "suffice it (to say)", example: { jp: "Baste decir que nadie quedó contento.", en: "Suffice it to say that nobody was happy." }, drill: { jp: "Baste señalar que faltan dos firmas", en: "Suffice it to note that two signatures are missing" }, accept: ["suffice it to say", "let it be enough", "it is enough to say"], hint: "A subjunctive used on its own, from bastar. Baste decir que closes a subject by refusing to go into it." },
        { id: "es-u107l1-huelgadecir", type: "vocab", front: "huelga decir", reading: "huelgadecir", meaning: "needless to say", example: { jp: "Huelga decir que el problema sigue ahí.", en: "Needless to say, the problem is still there." }, drill: { jp: "Huelga decir que nadie quiso firmarlo", en: "Needless to say nobody wanted to sign it" }, accept: ["needless to say", "it goes without saying", "obviously"], hint: "From holgar, to be unnecessary — unrelated to la huelga, a strike, despite the identical form. Written register only." },
    ...
    },
    {
      ...
      items: [
        { id: "es-u107l2-dicho", type: "vocab", front: "dicho", reading: "dicho", meaning: "the said / aforementioned", example: { jp: "Dicho informe llegó una semana tarde.", en: "The said report arrived a week late." }, drill: { jp: "Dicho plan nunca llegó a la mesa", en: "The said plan never made it to the table" }, accept: ["the said", "aforementioned", "that", "the aforesaid"], hint: "Placed before the noun and with no article: dicho informe, dicha norma. It replaces a repeated name in formal prose." },
        { id: "es-u107l2-susodicho", type: "vocab", front: "el susodicho", reading: "elsusodicho", meaning: "the aforementioned (person)", example: { jp: "El susodicho no dijo nada en la reunión.", en: "The aforementioned person said nothing at the meeting." }, drill: { jp: "El susodicho firmó el papel sin leerlo", en: "The aforementioned man signed the paper without reading it" }, accept: ["the aforementioned", "the aforesaid", "the said person"], hint: "Used of people, and now nearly always with a touch of irony outside legal writing. Dicho covers things without that flavour." },
        { id: "es-u107l2-consabido", type: "vocab", front: "el consabido", reading: "elconsabido", meaning: "the usual / the well-known", example: { jp: "Llegó con el consabido informe de siempre.", en: "He turned up with the same old report as ever." }, drill: { jp: "Tuvimos el consabido discurso del director", en: "We had the usual speech from the director" }, accept: ["the usual", "the well-known", "the same old", "the familiar"], hint: "Points back at something the reader is assumed to know already, usually with a touch of weariness: el consabido problema. A lexicalised adjective, not a form of saber." },
        { id: "es-u107l2-sendos", type: "vocab", front: "sendos", reading: "sendos", meaning: "one each", example: { jp: "Los dos partidos presentaron sendos planes.", en: "The two parties each presented a plan of their own." }, drill: { jp: "Sus dos hijos recibieron sendos premios", en: "His two sons each received a prize" }, accept: ["one each", "each of them a", "respective", "their respective"], hint: "Not two, and not both: sendos means one apiece. Sendas cartas = a letter each. It is often misused by natives, which is why writing it correctly reads as careful." },
        { id: "es-u107l2-ello", type: "vocab", front: "ello", reading: "ello", meaning: "this / that (neuter pronoun)", example: { jp: "Nadie dijo nada, y ello creó más problemas.", en: "Nobody said anything, and this created more problems." }, drill: { jp: "Por ello cambiamos la fecha de la reunión", en: "For that reason we changed the meeting date" }, accept: ["this", "that", "it"], hint: "Refers to a whole idea rather than a noun, so it has no gender. Por ello = for that reason; todo ello = all of this." },
        { id: "es-u107l2-mediante", type: "vocab", front: "mediante", reading: "mediante", meaning: "by means of / through", example: { jp: "El cambio se hizo mediante una norma nueva.", en: "The change was made by means of a new rule." }, drill: { jp: "Consiguió el puesto mediante un examen público", en: "She got the post through a public exam" }, accept: ["by means of", "through", "via", "by way of"], hint: "A preposition, so no que and no article after it. It lets a formal sentence name a method without a verb: mediante el pago de una cantidad." },
      ],
    },
    {
      id: "es-u107l3",
      ...
      items: [
        { id: "es-u107l3-enloquerespectaa", type: "vocab", front: "en lo que respecta a", reading: "enloquerespectaa", meaning: "as regards / with respect to", example: { jp: "En lo que respecta al dinero, el informe no dice nada.", en: "As regards the money, the report says nothing." }, drill: { jp: "En lo que respecta a Ana nada cambia", en: "As regards Ana nothing changes" }, accept: ["as regards", "with respect to", "as far as", "regarding"], hint: "Opens a new topic in a long text. The heaviest of this group, and it earns its weight only at the start of a section." },
        ...
        { id: "es-u107l3-respectoa", type: "vocab", front: "respecto a", reading: "respectoa", meaning: "regarding", example: { jp: "Respecto a su carta, tenemos poco que decir.", en: "Regarding your letter, we have little to say." }, drill: { jp: "Respecto a los plazos aún no hay nada", en: "Regarding the deadlines there is still nothing" }, accept: ["regarding", "with regard to", "about", "concerning"], hint: "The short, usable one — con respecto a and respecto de are equally correct. Use this one in a letter and the longer forms in a report." },
        { id: "es-u107l3-encuantoa", type: "vocab", front: "en cuanto a", reading: "encuantoa", meaning: "as for", example: { jp: "En cuanto a los datos, hay que ver de dónde salen.", en: "As for the data, we need to see where it comes from." }, drill: { jp: "En cuanto a mi hermano prefiero no hablar", en: "As for my brother I'd rather not talk" }, accept: ["as for", "as to", "regarding", "when it comes to"], hint: "Lighter than the others and fine in speech. Do not confuse it with en cuanto on its own, which means as soon as." },
        { id: "es-u107l3-enlamedidaenque", type: "vocab", front: "en la medida en que", reading: "enlamedidaenque", meaning: "insofar as / to the extent that", example: { jp: "El plan sirve en la medida en que haya dinero.", en: "The plan works insofar as there is money." }, drill: { jp: "Ayudaremos en la medida en que sea posible", en: "We will help insofar as it is possible" }, accept: ["insofar as", "to the extent that", "inasmuch as", "in so far as"], hint: "Makes a claim true only as far as something else holds. Built on la medida (u65); the second en is part of the phrase." },
        { id: "es-u107l3-todavezque", type: "vocab", front: "toda vez que", reading: "todavezque", meaning: "given that / since", example: { jp: "No procede el pago, toda vez que falta un papel.", en: "The payment is not in order, given that a document is missing." }, drill: { jp: "Cerramos el caso toda vez que nadie protesta", en: "We are closing the case given that nobody objects" }, accept: ["given that", "since", "inasmuch as", "seeing that"], hint: "A legal-register because. It states a reason already established rather than arguing for one — which is why rulings are full of it." },
      ],
    },
    {
      id: "es-u107l4",
      ...
      items: [
        ...
        { id: "es-u107l4-estribar", type: "vocab", front: "estribar", reading: "estribar", meaning: "to rest on / hinge on", example: { jp: "La diferencia estriba en el modo de pagar.", en: "The difference rests on the method of payment." }, drill: { jp: "El problema puede estribar en el precio", en: "The problem may lie in the price" }, accept: ["to rest on", "to hinge on", "to lie in", "to consist in"], hint: "A near-twin of radicar en, and rarer, so it reads as deliberately literate. From el estribo, the stirrup you rest your weight on." },
        { id: "es-u107l4-obedecer", type: "vocab", front: "obedecer", reading: "obedecer", meaning: "to be due to (a cause)", example: { jp: "El cambio obedece a motivos que nadie quiso decir.", en: "The change is due to reasons nobody was willing to state." }, drill: { jp: "El retraso puede obedecer a un fallo técnico", en: "The delay may be due to a technical fault" }, accept: ["to be due to", "to stem from", "to respond to", "to obey"], hint: "With a, and a cause rather than a person, this is the formal way to say something has a reason. The plain sense — to obey an order — is the same verb." },
      ],
    },
  ],
};
