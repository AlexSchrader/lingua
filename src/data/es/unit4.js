  ...
  lessons: [
    // Lesson 1: the immediate family
    {
      ...
      items: [
        ...
        { id: "es-u4l1-lospadres", type: "vocab", front: "los padres", reading: "lospadres", meaning: "parents", example: { jp: "Mis padres son de España.", en: "My parents are from Spain." }, accept: ["the parents", "mom and dad", "folks"], hint: "The masculine plural covers a mixed pair — los padres is a mother and a father, not two fathers." },
      ],
    },
    ...
    // Lesson 4: the structural words the whole unit runs on
    {
      ...
      items: [
        ...
        { id: "es-u4l4-un", type: "vocab", front: "un", reading: "un", meaning: "a (masculine)", example: { jp: "Tengo un hermano.", en: "I have a brother." }, accept: ["an", "one"], hint: "Goes with the words that take el: un hermano, un gato, un museo." },
