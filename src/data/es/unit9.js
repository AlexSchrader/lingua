  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u9l3-septiembre", type: "vocab", front: "septiembre", reading: "septiembre", meaning: "September", example: { jp: "En septiembre hay clase en la universidad.", en: "In September there are classes at the university." }, accept: ["september", "in september"] },
        { id: "es-u9l3-octubre", type: "vocab", front: "octubre", reading: "octubre", meaning: "October", example: { jp: "En octubre el parque es amarillo.", en: "In October the park is yellow." }, accept: ["october", "in october"] },
    ...
    },
    {
      ...
      items: [
        { id: "es-u9l4-dia", type: "vocab", front: "el día", reading: "eldia", meaning: "day", example: { jp: "El domingo es un día tranquilo.", en: "Sunday is a quiet day." }, accept: ["the day"], hint: "Ends in -a but it's masculine: el día, not la día. A Greek loanword, like el problema." },
        ...
        { id: "es-u9l4-mes", type: "vocab", front: "el mes", reading: "elmes", meaning: "month", example: { jp: "Agosto es un mes de calor.", en: "August is a hot month." }, accept: ["the month"], hint: "Same root as \"menstrual\" and \"semester\" — and as la luna, whose cycle it measures." },
