  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u110l1-clausula", type: "vocab", front: "la cláusula", reading: "laclausula", meaning: "clause (of a contract)", example: { jp: "La cláusula tres cambia todo el sentido.", en: "Clause three changes the whole meaning." }, accept: ["clause", "provision", "term"], hint: "One numbered term of a contract. Una cláusula abusiva is one a court can strike out — the phrase every consumer story uses." },
