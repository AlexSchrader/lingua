  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u48l1-simplemente", type: "vocab", front: "simplemente", reading: "simplemente", meaning: "simply / just", example: { jp: "Simplemente no quiero ir.", en: "I simply don't want to go." }, accept: ["just", "merely"], hint: "From simple (u42). Simplemente = simply / just. Es simplemente perfecto = it's simply perfect." },
    ...
    },
    {
      ...
      items: [
        { id: "es-u48l2-posiblemente", type: "vocab", front: "posiblemente", reading: "posiblemente", meaning: "possibly", example: { jp: "Posiblemente es verdad.", en: "It's possibly true." }, accept: ["maybe", "perhaps"], hint: "From posible (u42). A close friend of a lo mejor (u48) and quizá." },
        ...
        { id: "es-u48l2-probablemente", type: "vocab", front: "probablemente", reading: "probablemente", meaning: "probably", example: { jp: "Probablemente va a llover mañana.", en: "It'll probably rain tomorrow." }, accept: ["likely", "most likely"], hint: "From probable. A touch more formal than seguramente." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u48l3-incluso", type: "vocab", front: "incluso", reading: "incluso", meaning: "even", example: { jp: "Incluso los niños lo entienden.", en: "Even the children understand it." }, accept: ["including", "even"], hint: "Adds a surprising case: incluso yo = even me. Stronger than también (u3)." },
        ...
        { id: "es-u48l3-aparte", type: "vocab", front: "aparte", reading: "aparte", meaning: "apart / aside / separately", example: { jp: "Eso es un problema aparte.", en: "That's a separate problem." }, accept: ["separate", "aside", "besides"], hint: "Aside or separate: eso es aparte. Aparte de = apart from / besides." },
      ],
    },
    {
      id: "es-u48l4",
      ...
      items: [
        { id: "es-u48l4-porsupuesto", type: "vocab", front: "por supuesto", reading: "porsupuesto", meaning: "of course", example: { jp: "Por supuesto que sí.", en: "Of course." }, accept: ["certainly", "naturally", "sure"], hint: "The emphatic \"of course\". Por supuesto que no = of course not." },
        { id: "es-u48l4-sinduda", type: "vocab", front: "sin duda", reading: "sinduda", meaning: "without a doubt", example: { jp: "Sin duda es el mejor.", en: "It's without a doubt the best." }, accept: ["no doubt", "definitely", "surely"], hint: "sin (u13) + duda (from dudar). The confident version of seguramente." },
        { id: "es-u48l4-enfin", type: "vocab", front: "en fin", reading: "enfin", meaning: "anyway / well", example: { jp: "En fin, no hay problema.", en: "Anyway, there's no problem." }, accept: ["in short", "oh well", "so"], hint: "A sigh-and-move-on filler: En fin… = Anyway… / Oh well… From el fin (end)." },
        { id: "es-u48l4-porcierto", type: "vocab", front: "por cierto", reading: "porcierto", meaning: "by the way", example: { jp: "Por cierto, ¿dónde está María?", en: "By the way, where's María?" }, accept: ["incidentally", "speaking of which"], hint: "cierto in a set phrase. Drops in a new topic: por cierto, … Not the same as \"of course\"." },
        { id: "es-u48l4-porahora", type: "vocab", front: "por ahora", reading: "porahora", meaning: "for now", example: { jp: "Por ahora estoy bien.", en: "For now I'm fine." }, accept: ["for the moment", "so far"], hint: "From ahora (now): por ahora = for the time being." },
        { id: "es-u48l4-alomejor", type: "vocab", front: "a lo mejor", reading: "alomejor", meaning: "maybe / perhaps", example: { jp: "A lo mejor llueve mañana.", en: "Maybe it'll rain tomorrow." }, accept: ["perhaps", "possibly"], hint: "An everyday \"maybe\", oddly built from mejor (better). Followed by the normal present: a lo mejor llueve." },
      ],
    },
  ],
};
