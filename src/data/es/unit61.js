  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u61l2-vetar", type: "vocab", front: "vetar", reading: "vetar", meaning: "to veto / block", example: { jp: "El jefe vetó la idea sin explicar por qué.", en: "The boss vetoed the idea without explaining why." }, accept: ["to veto", "to block", "to bar"], hint: "A formal no from someone with the power to stop it. El veto is the noun." },
        { id: "es-u61l2-tolerar", type: "vocab", front: "tolerar", reading: "tolerar", meaning: "to tolerate / allow", example: { jp: "No toleran el ruido después de las once de la noche.", en: "They don't tolerate noise after eleven at night." }, accept: ["to tolerate", "to put up with", "to allow"], hint: "Sits between permitir and prohibir: not approved, but not punished either." },
      ],
    },
    {
      id: "es-u61l3",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u61l4-eldeber", type: "vocab", front: "el deber", reading: "eldeber", meaning: "the duty", example: { jp: "Para él, cumplir con su deber es lo más importante.", en: "For him, doing his duty is the most important thing." }, accept: ["the duty", "the obligation"], hint: "As a noun: cumplir con su deber. In the plural, los deberes is homework." },
        { id: "es-u61l4-laexigencia", type: "vocab", front: "la exigencia", reading: "laexigencia", meaning: "the requirement / demand", example: { jp: "Las exigencias de este trabajo son muy altas.", en: "The demands of this job are very high." }, accept: ["the requirement", "the demand"], hint: "From exigir. Stronger than el requisito, the card before it: a requisito is on a list, an exigencia is pressed on you." },
      ],
    },
  ],
};
