...
export const ES_UNIT61 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "es-u61l2-prohibir", type: "vocab", front: "prohibir", reading: "prohibir", meaning: "to forbid", example: { jp: "La ley prohíbe tirar basura en la calle.", en: "The law forbids throwing rubbish in the street." }, accept: ["to ban", "to prohibit"], hint: "prohibir + infinitive. The i takes an accent: prohíbe, prohíbo. tirar (A2), la basura (u30)." },
        { id: "es-u61l2-obligar", type: "vocab", front: "obligar", reading: "obligar", meaning: "to force", example: { jp: "Nadie te obliga a ir si no quieres.", en: "Nobody's forcing you to go if you don't want to." }, accept: ["to compel", "to make"], hint: "obligar A alguien A + infinitive. From it come la obligación and obligatorio." },
    ...
    },
    {
      ...
      items: [
        { id: "es-u61l4-merecer", type: "vocab", front: "merecer", reading: "merecer", meaning: "to deserve", example: { jp: "Después de tanto trabajo, merece descansar.", en: "After so much work, he deserves to rest." }, accept: ["to be worth", "to earn"], hint: "Merezco in the yo form. Merecer la pena = to be worth it. Merezco, like conozco." },
        ...
        { id: "es-u61l4-imprescindible", type: "vocab", front: "imprescindible", reading: "imprescindible", meaning: "essential", example: { jp: "Es imprescindible llegar a tiempo a la entrevista.", en: "It's essential to arrive on time to the interview." }, accept: ["indispensable", "a must"], hint: "Absolutely necessary — you can't do without it. Stronger than importante. a tiempo is u28, la entrevista is A2." },
