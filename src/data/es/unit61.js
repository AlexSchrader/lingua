  ...
  lessons: [
    {
      ...
      items: [
        { id: "es-u61l1-lanorma", type: "vocab", front: "la norma", reading: "lanorma", meaning: "the norm", example: { jp: "Hay que respetar las normas de la casa.", en: "You have to respect the house rules." }, drill: { jp: "La norma del edificio es clara", en: "The building's rule is clear" }, accept: ["the norm", "standard", "rule"], hint: "A rule or standard of behaviour. Por norma general = as a general rule. respetar is l3." },
        { id: "es-u61l1-laregla", type: "vocab", front: "la regla", reading: "laregla", meaning: "the rule", example: { jp: "Las reglas del juego son muy claras.", en: "The rules of the game are very clear." }, drill: { jp: "La regla del juego es simple", en: "The rule of the game is simple" }, accept: ["the ruler", "regulation", "rule"], hint: "A rule of a game or a system — and also a ruler for drawing lines. el juego is A2." },
