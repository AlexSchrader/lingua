  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u18l2-elboligrafo", type: "vocab", front: "el bolígrafo", reading: "elboligrafo", meaning: "the pen", example: { jp: "Necesito un bolígrafo.", en: "I need a pen." }, accept: ["biro", "ballpoint", "pen"], hint: "In Spain everyone shortens it to el boli. Much of Latin America uses a different word altogether — el lapicero, la pluma, el birome." },
