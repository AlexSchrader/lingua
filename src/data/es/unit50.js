  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u50l1-tratar", type: "vocab", front: "tratar", reading: "tratar", meaning: "to be about / to try", example: { jp: "El libro trata de la vida en Madrid.", en: "The book is about life in Madrid." }, accept: ["to deal with", "to treat", "to try"], hint: "Two key uses: tratar de + a noun = to be about; tratar de + a plain verb = to try to." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u50l2-hacerse", type: "vocab", front: "hacerse", reading: "hacerse", meaning: "to become (through effort / over time)", example: { jp: "Se hizo médico.", en: "He became a doctor." }, accept: ["to become", "to get", "to grow"], hint: "hacerse = to become through one's own effort or over time: se hizo médico, se hizo rico. Built on hacer (u13)." },
        ...
        { id: "es-u50l2-mejorar", type: "vocab", front: "mejorar", reading: "mejorar", meaning: "to improve / get better", example: { jp: "El tiempo va a mejorar mañana.", en: "The weather is going to improve tomorrow." }, accept: ["to get better", "to make better"], hint: "From mejor (better). ¡Que te mejores! = get well soon!" },
        { id: "es-u50l2-empeorar", type: "vocab", front: "empeorar", reading: "empeorar", meaning: "to get worse", example: { jp: "La situación va a empeorar.", en: "The situation is going to get worse." }, accept: ["to worsen", "to make worse"], hint: "From peor (worse), the mirror of mejorar. Las cosas empeoran = things are getting worse." },
      ],
    },
    {
      id: "es-u50l3",
      ...
      items: [
        ...
        { id: "es-u50l3-parecido", type: "vocab", front: "parecido", reading: "parecido", meaning: "similar / alike", example: { jp: "Los dos coches son parecidos.", en: "The two cars are similar." }, accept: ["similar", "alike", "like"], hint: "From parecer (to seem). Parecido a = similar to. The opposite of distinto." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u50l4-elpaso", type: "vocab", front: "el paso", reading: "elpaso", meaning: "the step", example: { jp: "Vamos paso a paso.", en: "Let's go step by step." }, accept: ["step", "pace", "way through"], hint: "From pasar (to pass). Paso a paso = step by step. Also a way through: paso de peatones = pedestrian crossing." },
