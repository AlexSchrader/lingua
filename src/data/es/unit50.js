...
export const ES_UNIT50 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "es-u50l5-considerar", type: "vocab", front: "considerar", reading: "considerar", meaning: "to consider / regard as", example: { jp: "Considero que es la mejor opción.", en: "I consider it to be the best option." }, drill: { jp: "Hay que considerar todas las opciones", en: "We have to consider all the options" }, accept: ["to consider", "to regard as", "to think"], hint: "considerar QUE + indicative for an opinion, or considerar algo como algo. Heavier than pensar." },
        { id: "es-u50l5-valorar", type: "vocab", front: "valorar", reading: "valorar", meaning: "to value / rate", example: { jp: "Valoro mucho tu ayuda.", en: "I value your help a lot." }, drill: { jp: "Es difícil valorar su trabajo", en: "It's hard to value his work" }, accept: ["to value", "to rate", "to appreciate"], hint: "Two uses: to put a price on, and to think highly of. El valor (u58) is the noun." },
        { id: "es-u50l5-comprobar", type: "vocab", front: "comprobar", reading: "comprobar", meaning: "to check", example: { jp: "Comprueba la hora antes de salir.", en: "Check the time before you leave." }, drill: { jp: "Quiero comprobar los datos otra vez", en: "I want to check the data again" }, accept: ["to check", "to verify", "to make sure"], hint: "Stem-changing: compruebo, compruebas. To check by looking, where verificar (u64) is the formal confirmation." },
        { id: "es-u50l5-evaluar", type: "vocab", front: "evaluar", reading: "evaluar", meaning: "to assess / evaluate", example: { jp: "El profesor evalúa cada trabajo con cuidado.", en: "The teacher assesses each piece of work carefully." }, drill: { jp: "Van a evaluar a los alumnos", en: "They're going to assess the pupils" }, accept: ["to assess", "to evaluate", "to grade"], hint: "Note the accent in evalúo, evalúas. La evaluación (u103) is the noun." },
        { id: "es-u50l5-aplicar", type: "vocab", front: "aplicar", reading: "aplicar", meaning: "to apply", example: { jp: "La misma norma se aplica a todos.", en: "The same rule applies to everyone." }, drill: { jp: "Es difícil aplicar esa idea", en: "That idea is hard to apply" }, accept: ["to apply", "to enforce", "to put into practice"], hint: "Of rules, methods and creams alike. Aplicarse = to apply oneself, or (of a rule) to apply." },
        { id: "es-u50l5-registrar", type: "vocab", front: "registrar", reading: "registrar", meaning: "to record / register", example: { jp: "El médico registró todos los datos.", en: "The doctor recorded all the data." }, drill: { jp: "Hay que registrar cada cambio", en: "Every change has to be recorded" }, accept: ["to record", "to register", "to log"], hint: "To write something into a record. El registro also means a search of a place, which is why the police use the verb too." },
        { id: "es-u50l5-firmar", type: "vocab", front: "firmar", reading: "firmar", meaning: "to sign", example: { jp: "Firmó el contrato esa misma tarde.", en: "He signed the contract that same afternoon." }, drill: { jp: "Tienes que firmar el documento", en: "You have to sign the document" }, accept: ["to sign", "to sign off", "to put one's name to"], hint: "La firma is both the signature and, in business, the firm. Firme (u43) is a different word: steady." },
      ],
    },
    {
      id: "es-u50l6",
      ...
      items: [
        { id: "es-u50l6-defender", type: "vocab", front: "defender", reading: "defender", meaning: "to defend", example: { jp: "Defendió su idea delante de todos.", en: "He defended his idea in front of everyone." }, drill: { jp: "Nadie quiso defender esa idea", en: "Nobody wanted to defend that idea" }, accept: ["to defend", "to stand up for", "to argue for"], hint: "Stem-changing: defiendo, defiendes. La defensa (u114) is the noun." },
        { id: "es-u50l6-gobernar", type: "vocab", front: "gobernar", reading: "gobernar", meaning: "to govern", example: { jp: "El mismo partido gobierna desde hace años.", en: "The same party has governed for years." }, drill: { jp: "No es fácil gobernar un país", en: "It isn't easy to govern a country" }, accept: ["to govern", "to rule", "to run"], hint: "Stem-changing: gobierno, gobiernas — and el gobierno (u32) is also the noun." },
        { id: "es-u50l6-convivir", type: "vocab", front: "convivir", reading: "convivir", meaning: "to live together / coexist", example: { jp: "Es difícil convivir con tanta gente.", en: "It's hard to live with so many people." }, drill: { jp: "Aprender a convivir cuesta tiempo", en: "Learning to live together takes time" }, accept: ["to live together", "to coexist", "to share a life with"], hint: "vivir + con, made into one verb. La convivencia (u55) is the noun." },
        { id: "es-u50l6-reunir", type: "vocab", front: "reunir", reading: "reunir", meaning: "to bring together / gather", example: { jp: "Reunió a toda la familia en su casa.", en: "He gathered the whole family at his house." }, drill: { jp: "Quiere reunir a todos sus amigos", en: "He wants to bring all his friends together" }, accept: ["to bring together", "to gather", "to meet (the requirements)"], hint: "Also to meet a condition: reunir los requisitos. Reflexive reunirse = to meet up; la reunión (u18) is the meeting." },
        { id: "es-u50l6-repartir", type: "vocab", front: "repartir", reading: "repartir", meaning: "to hand out / share out", example: { jp: "Repartieron la comida entre todos.", en: "They shared the food out among everyone." }, drill: { jp: "Van a repartir el dinero mañana", en: "They're going to hand out the money tomorrow" }, accept: ["to hand out", "to share out", "to deliver"], hint: "repartir algo ENTRE varios. El reparto is both the sharing-out and, in theatre, the cast." },
        { id: "es-u50l6-dividir", type: "vocab", front: "dividir", reading: "dividir", meaning: "to divide", example: { jp: "Dividieron el trabajo en tres partes.", en: "They divided the work into three parts." }, drill: { jp: "Podemos dividir el trabajo entre dos", en: "We can divide the work between two" }, accept: ["to divide", "to split", "to share"], hint: "dividir EN partes. In arithmetic too: doce dividido entre tres." },
      ],
    },
    {
      id: "es-u50l7",
      ...
      items: [
        { id: "es-u50l7-actuar", type: "vocab", front: "actuar", reading: "actuar", meaning: "to act", example: { jp: "Hay que actuar antes de que sea tarde.", en: "We have to act before it's too late." }, drill: { jp: "Es el momento de actuar ya", en: "Now is the moment to act" }, accept: ["to act", "to take action", "to perform"], hint: "Note the accent: actúo, actúas. Also to act on stage or screen." },
        { id: "es-u50l7-financiar", type: "vocab", front: "financiar", reading: "financiar", meaning: "to fund / finance", example: { jp: "El proyecto lo financia una empresa privada.", en: "The project is funded by a private company." }, drill: { jp: "El banco quiere financiar la obra", en: "The bank wants to fund the works" }, accept: ["to fund", "to finance", "to pay for"], hint: "La financiación (u102) is the funding. Note financio without an accent, unlike actúo." },
        { id: "es-u50l7-frenar", type: "vocab", front: "frenar", reading: "frenar", meaning: "to slow down / put the brakes on", example: { jp: "Nada frenó la subida de los precios.", en: "Nothing slowed the rise in prices." }, drill: { jp: "Nadie pudo frenar el proyecto", en: "Nobody could slow the project down" }, accept: ["to slow down", "to curb", "to brake"], hint: "El freno is the brake. Of cars literally, of anything else figuratively." },
        { id: "es-u50l7-abarcar", type: "vocab", front: "abarcar", reading: "abarcar", meaning: "to cover / span", example: { jp: "El estudio abarca cinco países.", en: "The study covers five countries." }, drill: { jp: "El estudio va a abarcar todo", en: "The study is going to cover everything" }, accept: ["to cover", "to span", "to take in"], hint: "Reach across a range, where incluir (u79) puts things inside. Quien mucho abarca poco aprieta is the proverb." },
        { id: "es-u50l7-atraer", type: "vocab", front: "atraer", reading: "atraer", meaning: "to attract", example: { jp: "La ciudad atrae a mucha gente joven.", en: "The city attracts a lot of young people." }, drill: { jp: "La ciudad va a atraer gente", en: "The city is going to attract people" }, accept: ["to attract", "to draw", "to appeal to"], hint: "Built on traer, and conjugated like it: atraigo, atraes. Atractivo is the adjective." },
        { id: "es-u50l7-ofrecer", type: "vocab", front: "ofrecer", reading: "ofrecer", meaning: "to offer", example: { jp: "Le ofrecieron un trabajo mejor.", en: "They offered him a better job." }, drill: { jp: "Quiero ofrecer un trabajo", en: "I want to offer a job" }, accept: ["to offer", "to provide", "to give"], hint: "Irregular: ofrezco, ofreces. La oferta (u27) is the offer itself." },
        { id: "es-u50l7-oponer", type: "vocab", front: "oponer", reading: "oponer", meaning: "to put up (resistance) / set against", example: { jp: "No opuso ninguna resistencia.", en: "He put up no resistance at all." }, drill: { jp: "Prefiere no oponer resistencia al cambio", en: "He prefers not to put up resistance to the change" }, accept: ["to put up", "to set against", "to counter"], hint: "The plain verb is narrow — oponer resistencia, oponer un argumento a otro. For being against something, use oponerse a, taught in u51." },
      ],
    },
  ],
};
