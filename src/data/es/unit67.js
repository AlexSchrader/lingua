  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u67l1-elsintoma", type: "vocab", front: "el síntoma", reading: "elsintoma", meaning: "the symptom", example: { jp: "Le expliqué mis síntomas, y entonces el médico me hizo muchas preguntas.", en: "I explained my symptoms to him, and then the doctor asked me a lot of questions." }, accept: ["symptom", "the sign"], hint: "Masculine despite the -a: el síntoma, like el problema, el tema." },
        ...
        { id: "es-u67l1-lavacuna", type: "vocab", front: "la vacuna", reading: "lavacuna", meaning: "the vaccine", example: { jp: "La vacuna es gratis para todos, de modo que no hay razón para esperar.", en: "The vaccine is free for everyone, so there's no reason to wait." }, accept: ["vaccine", "the jab", "vaccination"], hint: "The verb is vacunar; vacunarse is to get vaccinated." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u67l2-elvirus", type: "vocab", front: "el virus", reading: "elvirus", meaning: "the virus", example: { jp: "Este virus va muy rápido, así que hay que lavarse las manos a menudo.", en: "This virus moves very fast, so you have to wash your hands often." }, accept: ["virus", "the bug"], hint: "Same in singular and plural: el virus, los virus." },
