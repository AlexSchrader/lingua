  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u89l1-lafiabilidad", type: "vocab", front: "la fiabilidad", reading: "lafiabilidad", meaning: "the reliability", example: { jp: "La fiabilidad de esa fuente es más que dudosa.", en: "The reliability of that source is more than doubtful." }, accept: ["the reliability", "the trustworthiness", "the dependability"], hint: "From fiable (reliable). Of sources, machines and people alike." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u89l3-rebatir", type: "vocab", front: "rebatir", reading: "rebatir", meaning: "to rebut / argue back", example: { jp: "Rebatió todos los argumentos uno por uno.", en: "He rebutted every argument one by one." }, accept: ["to rebut", "to counter", "to argue back against"], hint: "Aimed at an argument rather than at a fact. Refutar proves false; rebatir answers back." },
        ...
        { id: "es-u89l3-elsesgo", type: "vocab", front: "el sesgo", reading: "elsesgo", meaning: "the bias", example: { jp: "El estudio tiene un sesgo evidente a favor de la empresa.", en: "The study has an obvious bias in favour of the company." }, accept: ["the bias", "the slant", "the skew"], hint: "Sesgado = biased. It names a lean in the method, not a lie." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u89l4-sustentar", type: "vocab", front: "sustentar", reading: "sustentar", meaning: "to uphold / sustain (a claim)", example: { jp: "Nada en el informe sustenta esa afirmación.", en: "Nothing in the report supports that claim." }, accept: ["to uphold", "to sustain", "to support"], hint: "To hold a claim up, as a column holds a roof. Insostenible = untenable." },
