  ...
  lessons: [
    {
      ...
      items: [
        { id: "es-u89l1-laprocedencia", type: "vocab", front: "la procedencia", reading: "laprocedencia", meaning: "the origin / provenance", example: { jp: "Nadie preguntó por la procedencia de esos datos.", en: "Nobody asked about the origin of that data." }, drill: { jp: "Nadie explicó la procedencia de ese dinero", en: "Nobody explained where that money came from" }, accept: ["the origin", "the provenance", "the source"], hint: "Where something comes FROM, said formally. De procedencia desconocida = of unknown origin." },
        ...
        { id: "es-u89l1-laveracidad", type: "vocab", front: "la veracidad", reading: "laveracidad", meaning: "the truthfulness / accuracy", example: { jp: "Nadie ha comprobado la veracidad de la noticia.", en: "Nobody has checked the truthfulness of the story." }, drill: { jp: "El juez dudó de la veracidad del testigo", en: "The judge doubted the truthfulness of the witness" }, accept: ["the truthfulness", "the accuracy", "the veracity"], hint: "Whether a statement is TRUE, where fiabilidad is whether a source can be trusted in general." },
        { id: "es-u89l1-elrespaldo", type: "vocab", front: "el respaldo", reading: "elrespaldo", meaning: "the backing / support", example: { jp: "La teoría no tiene ningún respaldo científico.", en: "The theory has no scientific backing at all." }, drill: { jp: "Necesitamos el respaldo del gobierno para seguir", en: "We need the government backing to carry on" }, accept: ["the backing", "the support", "the endorsement"], hint: "From respaldar, to back. Con el respaldo de = backed by." },
        { id: "es-u89l1-documentar", type: "vocab", front: "documentar", reading: "documentar", meaning: "to document", example: { jp: "El informe documenta cada caso con fotografías.", en: "The report documents every case with photographs." }, drill: { jp: "Hay que documentar bien cada gasto", en: "Every expense has to be properly documented" }, accept: ["to document", "to evidence", "to record"], hint: "To prove with material, not argument. Bien documentado = well-researched." },
        { id: "es-u89l1-acreditar", type: "vocab", front: "acreditar", reading: "acreditar", meaning: "to prove / certify", example: { jp: "Tuvo que acreditar que vivía en la ciudad.", en: "He had to prove that he lived in the city." }, drill: { jp: "Tendrás que acreditar tres años de experiencia", en: "You will have to prove three years of experience" }, accept: ["to prove", "to certify", "to vouch for"], hint: "Official proof: acreditar la identidad. Un periodista acreditado is one with press credentials." },
      ],
    },
    {
      id: "es-u89l2",
      ...
      items: [
        { id: "es-u89l2-laevidencia", type: "vocab", front: "la evidencia", reading: "laevidencia", meaning: "the evidence", example: { jp: "No hay evidencia de que el cambio funcione.", en: "There is no evidence that the change works." }, drill: { jp: "La evidencia apunta a un fallo humano", en: "The evidence points to human error" }, accept: ["the evidence", "the proof"], hint: "Careful: la evidencia is also 'the obvious fact' — negar la evidencia = to deny the obvious." },
        { id: "es-u89l2-elindicio", type: "vocab", front: "el indicio", reading: "elindicio", meaning: "the sign / clue", example: { jp: "Hay indicios de que la situación mejora.", en: "There are signs that the situation is improving." }, drill: { jp: "Ese es el indicio más claro de todos", en: "That is the clearest clue of them all" }, accept: ["the sign", "the clue", "the indication"], hint: "Weaker than una prueba: it points, it does not prove. Common in police reporting." },
        { id: "es-u89l2-eltestimonio", type: "vocab", front: "el testimonio", reading: "eltestimonio", meaning: "the testimony / account", example: { jp: "Su testimonio cambió por completo el caso.", en: "His testimony completely changed the case." }, drill: { jp: "El testimonio del vecino no convenció a nadie", en: "The neighbour's testimony convinced nobody" }, accept: ["the testimony", "the account", "the statement"], hint: "In court or in journalism. Dar testimonio de = to bear witness to." },
        { id: "es-u89l2-lapremisa", type: "vocab", front: "la premisa", reading: "lapremisa", meaning: "the premise", example: { jp: "Si la premisa es falsa, la conclusión no vale.", en: "If the premise is false, the conclusion is worthless." }, drill: { jp: "Partimos de la premisa de que todos colaboran", en: "We start from the premise that everyone cooperates" }, accept: ["the premise", "the starting assumption"], hint: "What an argument starts from, before any reasoning. Partir de la premisa de que…" },
        ...
        { id: "es-u89l2-lainferencia", type: "vocab", front: "la inferencia", reading: "lainferencia", meaning: "the inference", example: { jp: "Esa inferencia no se sigue de los datos.", en: "That inference doesn't follow from the data." }, drill: { jp: "La inferencia me parece demasiado atrevida", en: "The inference strikes me as too bold" }, accept: ["the inference", "the conclusion drawn"], hint: "The step from evidence to conclusion. Inferir is the verb." },
      ],
    },
    {
      id: "es-u89l3",
      ...
      items: [
        { id: "es-u89l3-refutar", type: "vocab", front: "refutar", reading: "refutar", meaning: "to refute / disprove", example: { jp: "Nadie ha conseguido refutar esa teoría todavía.", en: "Nobody has managed to refute that theory yet." }, drill: { jp: "Le costó media hora refutar cada punto", en: "It took him half an hour to refute each point" }, accept: ["to refute", "to disprove", "to rebut"], hint: "To show something is false, with evidence. Weaker cousins: negar (deny), dudar (doubt)." },
        ...
        { id: "es-u89l3-desmentir", type: "vocab", front: "desmentir", reading: "desmentir", meaning: "to deny / rebut publicly", example: { jp: "El ministro desmintió la noticia esa misma tarde.", en: "The minister denied the story that same afternoon." }, drill: { jp: "La empresa tuvo que desmentir el rumor rápidamente", en: "The company had to deny the rumour quickly" }, accept: ["to deny", "to refute publicly", "to issue a denial"], hint: "Specifically of published claims: un desmentido is an official denial." },
        { id: "es-u89l3-contrastar", type: "vocab", front: "contrastar", reading: "contrastar", meaning: "to cross-check / set against", example: { jp: "Hay que contrastar la información con otra fuente.", en: "The information has to be cross-checked against another source." }, drill: { jp: "Los periodistas deben contrastar cada dato publicado", en: "Journalists must cross-check every figure they publish" }, accept: ["to cross-check", "to verify against", "to compare"], hint: "contrastar CON algo. Also the plain 'to contrast': los dos casos contrastan mucho." },
        ...
        { id: "es-u89l3-lasalvedad", type: "vocab", front: "la salvedad", reading: "lasalvedad", meaning: "the caveat / proviso", example: { jp: "Aceptó el informe con una salvedad importante.", en: "He accepted the report with one important caveat." }, drill: { jp: "Hizo la salvedad de que todo era provisional", en: "He made the caveat that everything was provisional" }, accept: ["the caveat", "the proviso", "the reservation"], hint: "Con la salvedad de que… = with the proviso that… . It saves you from over-claiming." },
      ],
    },
    {
      id: "es-u89l4",
      ...
      items: [
        { id: "es-u89l4-corroborar", type: "vocab", front: "corroborar", reading: "corroborar", meaning: "to corroborate", example: { jp: "Dos testigos corroboraron la misma versión.", en: "Two witnesses corroborated the same version." }, drill: { jp: "Faltan pruebas para corroborar esa idea", en: "There isn't enough evidence to corroborate that idea" }, accept: ["to corroborate", "to confirm", "to back up"], hint: "A second independent source agreeing. One source alone cannot corroborar anything." },
        { id: "es-u89l4-fundamentar", type: "vocab", front: "fundamentar", reading: "fundamentar", meaning: "to ground / substantiate", example: { jp: "El autor fundamenta cada conclusión en datos reales.", en: "The author grounds every conclusion in real data." }, drill: { jp: "Sin datos no puedes fundamentar esa conclusión", en: "Without data you cannot substantiate that conclusion" }, accept: ["to ground", "to substantiate", "to base"], hint: "fundamentar algo EN algo. Bien fundamentado = well-founded; sin fundamento = baseless." },
        ...
        { id: "es-u89l4-cotejar", type: "vocab", front: "cotejar", reading: "cotejar", meaning: "to collate / check one against another", example: { jp: "Cotejaron las dos versiones del documento.", en: "They collated the two versions of the document." }, drill: { jp: "Tardé toda la tarde en cotejar las listas", en: "It took me all afternoon to collate the lists" }, accept: ["to collate", "to cross-check", "to compare"], hint: "Two texts side by side, looking for differences. Narrower than comparar." },
        { id: "es-u89l4-elrigor", type: "vocab", front: "el rigor", reading: "elrigor", meaning: "rigour", example: { jp: "El trabajo está hecho con mucho rigor.", en: "The work is done with great rigour." }, drill: { jp: "El rigor del estudio impresionó a todos", en: "The rigour of the study impressed everyone" }, accept: ["rigour", "thoroughness", "strictness"], hint: "Riguroso is the adjective. En rigor = strictly speaking." },
        { id: "es-u89l4-lasolidez", type: "vocab", front: "la solidez", reading: "lasolidez", meaning: "the soundness / solidity", example: { jp: "Nadie duda de la solidez de sus argumentos.", en: "Nobody doubts the soundness of his arguments." }, drill: { jp: "La solidez del edificio nos tranquilizó a todos", en: "The solidity of the building reassured us all" }, accept: ["the soundness", "the solidity", "the strength"], hint: "From sólido. Of arguments, buildings and companies alike." },
      ],
    },
  ],
};
