  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u117l3-inducir", type: "vocab", front: "inducir", reading: "inducir", meaning: "to infer inductively", example: { jp: "De los hechos se induce una conclusión distinta.", en: "From the facts a different conclusion is inferred." }, accept: ["to infer inductively", "to induce", "to reason from cases"], hint: "Reasoning from particular cases to a general rule — the opposite direction from deducir. It also means to lead someone into: inducir a error." },
      ],
    },
    {
      id: "es-u117l4",
