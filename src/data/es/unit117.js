  ...
  lessons: [
    {
      ...
      items: [
        { id: "es-u117l1-percibir", type: "vocab", front: "percibir", reading: "percibir", meaning: "to perceive", example: { jp: "Percibí cierta tensión entre los dos desde el principio.", en: "I perceived a certain tension between the two of them from the start." }, accept: ["to perceive", "to sense", "to detect"], hint: "Wider than ver or oír: it covers anything the mind registers. In money contexts it also means to receive a salary." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u117l2-cavilar", type: "vocab", front: "cavilar", reading: "cavilar", meaning: "to brood / mull over", example: { jp: "Se pasó la noche cavilando sobre lo que había oído.", en: "He spent the night brooding over what he had heard." }, accept: ["to brood", "to mull over", "to turn over in ones mind"], hint: "Cavilar SOBRE algo. Thinking that goes round rather than forward — usually worried." },
    ...
    },
    {
      ...
      unit: 117,
      lesson: 3,
      title: "Inferir y conjeturar",
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Go from what you know to what follows: infer a conclusion, offer a conjecture, confirm a fact, and admit an assumption.",
      items: [
        { id: "es-u117l3-inferir", type: "vocab", front: "inferir", reading: "inferir", meaning: "to infer", example: { jp: "De sus palabras se infiere que no piensa volver.", en: "From his words it may be inferred that he does not intend to return." }, accept: ["to infer", "to conclude", "to gather"], hint: "Inferir algo DE algo. Se infiere que is the impersonal formula of reports and rulings." },
        { id: "es-u117l3-conjeturar", type: "vocab", front: "conjeturar", reading: "conjeturar", meaning: "to conjecture / surmise", example: { jp: "Solo podemos conjeturar qué pasó aquella noche.", en: "We can only conjecture what happened that night." }, accept: ["to conjecture", "to surmise", "to guess"], hint: "Reasoning without enough evidence, and saying so. The noun is la conjetura." },
        { id: "es-u117l3-presuponer", type: "vocab", front: "presuponer", reading: "presuponer", meaning: "to presuppose", example: { jp: "Tu pregunta presupone que ya hemos aprobado el plan.", en: "Your question presupposes that we have already approved the plan." }, accept: ["to presuppose", "to assume", "to take for granted"], hint: "The assumption hidden inside a statement. Conjugates like poner: presupongo, presupuso." },
        { id: "es-u117l3-constatar", type: "vocab", front: "constatar", reading: "constatar", meaning: "to verify / establish as fact", example: { jp: "El informe constata que el problema empezó mucho antes.", en: "The report establishes that the problem began much earlier." }, accept: ["to verify", "to establish", "to confirm", "to note"], hint: "Recording what you have checked. Cabe constatar que is standard in official prose." },
        { id: "es-u117l3-desentranar", type: "vocab", front: "desentrañar", reading: "desentranar", meaning: "to unravel / get to the bottom of", example: { jp: "Nadie ha conseguido desentrañar el sentido de ese capítulo.", en: "Nobody has managed to unravel the meaning of that chapter." }, accept: ["to unravel", "to get to the bottom of", "to work out"], hint: "Strong image: pulling out the entrails. Used of mysteries, texts and cases." },
    ...
    },
    {
      ...
      items: [
        { id: "es-u117l4-esclarecer", type: "vocab", front: "esclarecer", reading: "esclarecer", meaning: "to clear up / shed light on", example: { jp: "La policía no ha esclarecido todavía las causas del incendio.", en: "The police have not yet cleared up the causes of the fire." }, accept: ["to clear up", "to shed light on", "to elucidate"], hint: "Facts, not arguments: crimes, causes, events. Built on claro." },
        ...
        { id: "es-u117l4-interiorizar", type: "vocab", front: "interiorizar", reading: "interiorizar", meaning: "to internalise", example: { jp: "Ha interiorizado esas normas hasta el punto de no verlas.", en: "He has internalised those rules to the point of not seeing them." }, accept: ["to internalise", "to internalize", "to make ones own"], hint: "One step past asimilar: the idea is now yours and invisible to you." },
        { id: "es-u117l4-figurarse", type: "vocab", front: "figurarse", reading: "figurarse", meaning: "to imagine / suppose", example: { jp: "Ya me figuraba yo que iba a decir eso.", en: "I rather imagined he was going to say that." }, accept: ["to imagine", "to suppose", "to reckon"], hint: "Warm and conversational, and often about being right in advance. Figúrate is a whole reaction on its own." },
      ],
    },
  ],
};
