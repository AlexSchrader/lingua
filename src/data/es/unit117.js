  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u117l1-vislumbrar", type: "vocab", front: "vislumbrar", reading: "vislumbrar", meaning: "to glimpse / make out", example: { jp: "Empezamos a vislumbrar una salida al problema.", en: "We are beginning to glimpse a way out of the problem." }, drill: { jp: "Todavía no logro vislumbrar el final", en: "I still cannot glimpse the end" }, accept: ["to glimpse", "to make out", "to begin to see"], hint: "Half-light, literal or figurative. Very common with solutions and futures." },
        { id: "es-u117l1-entrever", type: "vocab", front: "entrever", reading: "entrever", meaning: "to catch a hint of", example: { jp: "En su respuesta se entreveía que ya lo había decidido.", en: "In his answer you could sense that he had already decided." }, drill: { jp: "Su cara dejaba entrever mucha rabia", en: "His face let a lot of anger show through" }, accept: ["to catch a hint of", "to glimpse", "to sense"], hint: "Ver with entre- : seeing between things. Dejar entrever = to let something show without saying it." },
        { id: "es-u117l1-repararen", type: "vocab", front: "reparar en", reading: "repararen", meaning: "to notice / take note of", example: { jp: "Nadie reparó en el detalle hasta el segundo día del juicio.", en: "Nobody noticed the detail until the second day of the trial." }, drill: { jp: "Debiste reparar en la fecha del documento", en: "You should have noticed the date on the document" }, accept: ["to notice", "to take note of", "to pay attention to"], hint: "Always with en in this sense — reparar alone means to repair. Sin reparar en gastos = sparing no expense." },
      ],
    },
    {
      id: "es-u117l2",
      ...
      items: [
        { id: "es-u117l2-meditar", type: "vocab", front: "meditar", reading: "meditar", meaning: "to ponder / think over", example: { jp: "Meditó la respuesta durante varios días.", en: "He pondered his answer for several days." }, drill: { jp: "Prefiero meditar la oferta antes de contestar", en: "I prefer to think the offer over before answering" }, accept: ["to ponder", "to think over", "to meditate on"], hint: "Takes a direct object: meditar una decisión. Broader than the sitting-still sense." },
        ...
        { id: "es-u117l2-ponderar", type: "vocab", front: "ponderar", reading: "ponderar", meaning: "to weigh up", example: { jp: "Hay que ponderar las ventajas y los riesgos antes de firmar.", en: "One must weigh up the advantages and the risks before signing." }, drill: { jp: "El juez debe ponderar las dos versiones", en: "The judge must weigh up the two versions" }, accept: ["to weigh up", "to weigh", "to consider carefully"], hint: "From peso, weight: putting two things on the scales. A second sense, to speak highly of, survives in formal prose." },
        { id: "es-u117l2-recapacitar", type: "vocab", front: "recapacitar", reading: "recapacitar", meaning: "to think again / reconsider", example: { jp: "Le pidieron que recapacitara antes de presentar la denuncia.", en: "They asked him to think again before filing the complaint." }, drill: { jp: "Necesita recapacitar antes de tomar esa decisión", en: "He needs to think again before taking that decision" }, accept: ["to think again", "to reconsider", "to have second thoughts"], hint: "Always about a decision already half taken. Often in the imperative: recapacita." },
        { id: "es-u117l2-ensimismarse", type: "vocab", front: "ensimismarse", reading: "ensimismarse", meaning: "to become lost in thought", example: { jp: "Se ensimismó con sus papeles y no oyó la pregunta.", en: "He became lost in thought over his papers and did not hear the question." }, drill: { jp: "Tiende a ensimismarse cuando está cansado", en: "He tends to become lost in thought when he is tired" }, accept: ["to become lost in thought", "to be absorbed in oneself", "to be miles away"], hint: "Literally en-sí-mismo: to go inside oneself. Always reflexive." },
        { id: "es-u117l2-rememorar", type: "vocab", front: "rememorar", reading: "rememorar", meaning: "to call to mind / recollect", example: { jp: "El libro rememora los años en que la familia vivía en el campo.", en: "The book recalls the years when the family lived in the countryside." }, drill: { jp: "Le gusta rememorar los veranos de su infancia", en: "He likes to recall the summers of his childhood" }, accept: ["to recollect", "to call to mind", "to look back on"], hint: "Deliberate, unhurried remembering, usually in writing. Plain recordar is what you do in conversation." },
      ],
    },
    {
      id: "es-u117l3",
      ...
      items: [
        { id: "es-u117l3-elucubrar", type: "vocab", front: "elucubrar", reading: "elucubrar", meaning: "to theorise / speculate at length", example: { jp: "Pasaron horas elucubrando sobre lo que pasó aquella noche.", en: "They spent hours theorising about what happened that night." }, drill: { jp: "No conviene elucubrar tanto", en: "It isn't wise to speculate so much" }, accept: ["to theorise", "to speculate", "to spin theories"], hint: "Elaborate reasoning built on very little, and the word says so: it is faintly mocking." },
        ...
        { id: "es-u117l3-concebir", type: "vocab", front: "concebir", reading: "concebir", meaning: "to conceive of / imagine", example: { jp: "No concibo que alguien pueda pensar así.", en: "I cannot conceive of anyone thinking that way." }, drill: { jp: "Cuesta concebir una salida mejor que esta", en: "It is hard to conceive of a better way out than this" }, accept: ["to conceive of", "to imagine", "to envisage"], hint: "No concibo que + subjunctive is the everyday use. It also means to conceive a child and to devise a plan." },
        { id: "es-u117l3-extrapolar", type: "vocab", front: "extrapolar", reading: "extrapolar", meaning: "to extrapolate", example: { jp: "No se puede extrapolar ese dato a todo el país.", en: "That figure cannot be extrapolated to the whole country." }, drill: { jp: "Conviene extrapolar los datos con mucha prudencia", en: "The data should be extrapolated with great caution" }, accept: ["to extrapolate", "to generalise from", "to project"], hint: "To carry a finding from one case to a wider one. The objection to it is that the cases differ." },
    ...
    },
    {
      ...
      items: [
        { id: "es-u117l4-esclarecer", type: "vocab", front: "esclarecer", reading: "esclarecer", meaning: "to clear up / shed light on", example: { jp: "La policía no ha esclarecido todavía lo que ocurrió.", en: "The police have not yet cleared up what happened." }, drill: { jp: "El juez quiere esclarecer el origen del dinero", en: "The judge wants to clear up the origin of the money" }, accept: ["to clear up", "to shed light on", "to elucidate"], hint: "Facts, not arguments: crimes, causes, events. Built on claro." },
        { id: "es-u117l4-dilucidar", type: "vocab", front: "dilucidar", reading: "dilucidar", meaning: "to elucidate / settle (a question)", example: { jp: "Queda por dilucidar quién decidió aquello.", en: "It remains to be settled who decided that." }, drill: { jp: "Toca dilucidar quién pagó aquella factura", en: "It is time to settle who paid that invoice" }, accept: ["to elucidate", "to settle", "to clarify"], hint: "Questions rather than facts — you dilucidas a doubt by reasoning it through. Queda por dilucidar is the set phrase." },
        { id: "es-u117l4-malinterpretar", type: "vocab", front: "malinterpretar", reading: "malinterpretar", meaning: "to misconstrue", example: { jp: "Malinterpretaron el informe y publicaron lo contrario.", en: "They misconstrued the report and published the opposite." }, drill: { jp: "Es fácil malinterpretar un mensaje tan corto", en: "It is easy to misconstrue such a short message" }, accept: ["to misconstrue", "to misinterpret", "to misread"], hint: "One word, no space. The reflexive puts the blame on the text: eso se puede malinterpretar." },
        { id: "es-u117l4-asimilar", type: "vocab", front: "asimilar", reading: "asimilar", meaning: "to take in / absorb", example: { jp: "Necesita tiempo para asimilar todo lo que ha pasado.", en: "She needs time to take in everything that has happened." }, drill: { jp: "Los niños tardan en asimilar estos cambios", en: "Children take time to take in these changes" }, accept: ["to take in", "to absorb", "to assimilate"], hint: "Both information and bad news. What the body does with food, the mind does with facts." },
