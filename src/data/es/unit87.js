  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u87l3-porconsiguiente", type: "vocab", front: "por consiguiente", reading: "porconsiguiente", meaning: "as a result", example: { jp: "Llueve; por consiguiente, no salimos.", en: "It's raining; consequently, we're not going out." }, drill: { jp: "Llueve por consiguiente no salimos", en: "It's raining consequently we're not going out" }, accept: ["therefore", "as a result", "consequently"], hint: "The most formal \"therefore\", for writing and speeches." },
