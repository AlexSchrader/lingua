  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u70l2-conseguirque", type: "vocab", front: "conseguir que", reading: "conseguirque", meaning: "to get someone to / manage to make", example: { jp: "Conseguí que me cambiaran la fecha de la reunión.", en: "I got them to change the date of the meeting." }, accept: ["to get someone to", "to manage to make", "to succeed in getting"], hint: "conseguir que + subjunctive. You did not do the thing yourself — you caused it, with effort." },
        { id: "es-u70l2-lograrque", type: "vocab", front: "lograr que", reading: "lograrque", meaning: "to manage to get (someone) to", example: { jp: "Logramos que el jefe aceptara la idea.", en: "We managed to get the boss to accept the idea." }, accept: ["to manage to get", "to succeed in getting", "to bring it about that"], hint: "Same shape as conseguir que + subjunctive; lograr sounds a shade more formal." },
        { id: "es-u70l2-permitirque", type: "vocab", front: "permitir que", reading: "permitirque", meaning: "to allow (someone) to", example: { jp: "No permiten que los niños entren solos.", en: "They don't allow children to go in on their own." }, accept: ["to allow to", "to let", "to permit"], hint: "permitir que + subjunctive. The mirror image of impedir que." },
      ],
    },
    {
      id: "es-u70l3",
