  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u19l4-decir", type: "vocab", front: "decir", reading: "decir", meaning: "to say", example: { jp: "Digo mi nombre.", en: "I say my name." }, accept: ["tell", "say", "says"], hint: "digo, dices, dice — the yo form loses the e entirely." },
