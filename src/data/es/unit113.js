  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u113l3-ladiscrepancia", type: "vocab", front: "la discrepancia", reading: "ladiscrepancia", meaning: "the discrepancy / disagreement", example: { jp: "Hay una discrepancia entre las dos versiones del informe.", en: "There is a discrepancy between the two versions of the report." }, accept: ["the discrepancy", "the disagreement", "the divergence"], hint: "Two senses: figures that do not match, and people who do not agree. Discrepar is the verb, taught in u111." },
      ],
    },
    {
      id: "es-u113l4",
