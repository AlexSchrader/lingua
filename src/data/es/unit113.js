  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u113l4-laderiva", type: "vocab", front: "la deriva", reading: "laderiva", meaning: "the drift", example: { jp: "Preocupa la deriva autoritaria del gobierno.", en: "The government's authoritarian drift is worrying." }, accept: ["the drift", "the slide", "the direction"], hint: "Movement with no one steering. A la deriva = adrift." },
      ],
    },
  ],
};
