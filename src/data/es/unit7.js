  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u7l1-parque", type: "vocab", front: "el parque", reading: "elparque", meaning: "park", example: { jp: "Hay un parque en la ciudad.", en: "There's a park in the city." }, accept: ["the park"], hint: "Spanish writes the k sound before e or i as qu — parque, not parke." },
        { id: "es-u7l1-calle", type: "vocab", front: "la calle", reading: "lacalle", meaning: "street", example: { jp: "En la calle Mayor hay un café.", en: "There's a café on Calle Mayor." }, accept: ["road", "the street"], hint: "The double l sounds like the y in \"yes\": CA-ye. Almost every Spanish town has a Calle Mayor — the main street." },
      ],
    },
    {
      id: "es-u7l2",
      ...
      items: [
        ...
        { id: "es-u7l2-mercado", type: "vocab", front: "el mercado", reading: "elmercado", meaning: "market", example: { jp: "En el centro hay un mercado.", en: "There's a market in the centre." }, accept: ["the market", "marketplace"] },
        ...
        { id: "es-u7l2-farmacia", type: "vocab", front: "la farmacia", reading: "lafarmacia", meaning: "pharmacy", example: { jp: "En la plaza hay una farmacia.", en: "There's a pharmacy in the square." }, accept: ["chemist", "drugstore", "the pharmacy"], hint: "Look for the green cross — that's a farmacia in every Spanish-speaking country." },
        ...
        { id: "es-u7l2-libreria", type: "vocab", front: "la librería", reading: "lalibreria", meaning: "bookshop", example: { jp: "En la calle Mayor hay una librería.", en: "There's a bookshop on Calle Mayor." }, accept: ["bookstore", "the bookshop", "book shop"], hint: "False friend: a librería SELLS books. A library is la biblioteca — next lesson." },
      ],
    },
    {
      id: "es-u7l3",
      ...
      items: [
        ...
        { id: "es-u7l3-universidad", type: "vocab", front: "la universidad", reading: "launiversidad", meaning: "university", example: { jp: "En la ciudad hay una universidad.", en: "There's a university in the city." }, accept: ["college", "the university"], hint: "Another -dad word, so another feminine one: la universidad." },
        ...
        { id: "es-u7l3-iglesia", type: "vocab", front: "la iglesia", reading: "laiglesia", meaning: "church", example: { jp: "Hay una iglesia en la plaza.", en: "There's a church in the square." }, accept: ["the church"], hint: "Same root as \"ecclesiastical\". The g is hard here, like in \"glue\" — Spanish g only turns throaty before e or i: i-GLE-sia." },
    ...
    },
    {
      ...
      items: [
        { id: "es-u7l4-estacion", type: "vocab", front: "la estación", reading: "laestacion", meaning: "station", example: { jp: "Hay una estación en el centro.", en: "There's a station in the centre." }, accept: ["the station", "train station"], hint: "Also means \"season\" — las cuatro estaciones are the four seasons of the year." },
        { id: "es-u7l4-tren", type: "vocab", front: "el tren", reading: "eltren", meaning: "train", example: { jp: "En la estación hay un tren.", en: "There's a train at the station." }, accept: ["the train"] },
        { id: "es-u7l4-autobus", type: "vocab", front: "el autobús", reading: "elautobus", meaning: "bus", example: { jp: "Hay un autobús en la plaza.", en: "There's a bus in the square." }, accept: ["the bus", "coach"], hint: "The stress lands on the last syllable, and that is what the accent marks: au-to-BÚS." },
