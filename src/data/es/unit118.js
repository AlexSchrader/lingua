  ...
  lessons: [
    {
      ...
      items: [
        { id: "es-u118l1-intensificar", type: "vocab", front: "intensificar", reading: "intensificar", meaning: "to intensify / step up", example: { jp: "La policía intensificó las pesquisas después de la denuncia.", en: "The police stepped up their inquiries after the complaint." }, drill: { jp: "Quieren intensificar los controles en la frontera", en: "They want to step up the checks at the border" }, accept: ["to intensify", "to step up", "to increase"], hint: "The neutral, official verb: more of the same, harder. Reflexive when nobody is doing it: la lluvia se intensificó." },
        { id: "es-u118l1-acentuar", type: "vocab", front: "acentuar", reading: "acentuar", meaning: "to accentuate / make more marked", example: { jp: "La crisis acentuó las diferencias entre las dos regiones.", en: "The crisis accentuated the differences between the two regions." }, drill: { jp: "La reforma puede acentuar la desigualdad", en: "The reform may accentuate inequality" }, accept: ["to accentuate", "to heighten", "to make more marked"], hint: "Makes a contrast more visible rather than a quantity larger. The same verb puts an accent on a letter." },
        { id: "es-u118l1-agudizar", type: "vocab", front: "agudizar", reading: "agudizar", meaning: "to sharpen / make more acute", example: { jp: "El calor agudiza el problema del agua cada verano.", en: "The heat makes the water problem more acute every summer." }, drill: { jp: "La sequía va a agudizar el conflicto", en: "The drought is going to sharpen the conflict" }, accept: ["to sharpen", "to make more acute", "to worsen"], hint: "From agudo, sharp. Almost always about problems, pain and shortages — never good news." },
        { id: "es-u118l1-avivar", type: "vocab", front: "avivar", reading: "avivar", meaning: "to rekindle / revive", example: { jp: "La noticia avivó el interés por el caso.", en: "The news rekindled interest in the case." }, drill: { jp: "El discurso sirvió para avivar el debate", en: "The speech served to rekindle the debate" }, accept: ["to rekindle", "to revive", "to fan"], hint: "A fire that was going out and is now burning again — used of interest, hope and debate." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u118l2-robustecer", type: "vocab", front: "robustecer", reading: "robustecer", meaning: "to fortify / make robust", example: { jp: "Los nuevos datos robustecen la defensa del acusado.", en: "The new data strengthen the defendant's case." }, drill: { jp: "Hay que robustecer el sistema de salud", en: "The health system needs to be strengthened" }, accept: ["to fortify", "to make robust", "to strengthen"], hint: "Formal and structural — arguments, institutions, economies. Not used of a wall you can touch." },
        { id: "es-u118l2-potenciar", type: "vocab", front: "potenciar", reading: "potenciar", meaning: "to boost / bring out the potential of", example: { jp: "El plan quiere potenciar el turismo rural de la región.", en: "The plan aims to boost rural tourism in the region." }, drill: { jp: "La empresa busca potenciar el talento joven", en: "The company is looking to bring out young talent" }, accept: ["to boost", "to promote", "to enhance"], hint: "The verb of policy documents. It develops something that was already there rather than adding to it." },
        { id: "es-u118l2-acrecentar", type: "vocab", front: "acrecentar", reading: "acrecentar", meaning: "to increase / augment", example: { jp: "Cada sentencia acrecentaba su fama de juez duro.", en: "Each ruling increased his reputation as a hard judge." }, drill: { jp: "No quieren acrecentar la deuda de la empresa", en: "They do not want to increase the company debt" }, accept: ["to increase", "to augment", "to swell"], hint: "Formal, and for things that grow rather than count: fame, wealth, mistrust." },
        { id: "es-u118l2-cimentar", type: "vocab", front: "cimentar", reading: "cimentar", meaning: "to cement / build on firm ground", example: { jp: "Cimentaron su éxito en años de trabajo callado.", en: "They built their success on years of quiet work." }, drill: { jp: "Ese viaje ayudó a cimentar nuestra amistad", en: "That trip helped cement our friendship" }, accept: ["to cement", "to build on", "to found"], hint: "From el cemento. cimentar algo EN algo: it says what the foundation is, not just that it is firm." },
      ],
    },
    {
      id: "es-u118l3",
      ...
      items: [
        ...
        { id: "es-u118l3-menguar", type: "vocab", front: "menguar", reading: "menguar", meaning: "to wane / dwindle", example: { jp: "Su influencia menguó en cuanto perdió el cargo.", en: "His influence waned as soon as he lost the post." }, drill: { jp: "El interés por el tema empezó a menguar", en: "Interest in the subject began to wane" }, accept: ["to wane", "to dwindle", "to shrink"], hint: "The verb of the waning moon — la luna menguante. Slow, natural decline rather than someone reducing it." },
        { id: "es-u118l3-erosionar", type: "vocab", front: "erosionar", reading: "erosionar", meaning: "to erode", example: { jp: "Cada escándalo erosiona un poco la confianza de la gente.", en: "Each scandal erodes people's trust a little." }, drill: { jp: "El ruido acabó por erosionar nuestra paciencia", en: "The noise ended up eroding our patience" }, accept: ["to erode", "to wear away", "to eat away at"], hint: "Rock and reputations alike. The damage is invisible day by day and obvious over years." },
        { id: "es-u118l3-desgastar", type: "vocab", front: "desgastar", reading: "desgastar", meaning: "to wear down", example: { jp: "Aquellos años en el poder lo desgastaron mucho.", en: "Those years in power wore him down badly." }, drill: { jp: "Este trabajo empieza a desgastar a cualquiera", en: "This job starts to wear anyone down" }, accept: ["to wear down", "to wear out", "to exhaust"], hint: "Use, not weather: shoes, machines and politicians. El desgaste is the resulting state." },
        ...
        { id: "es-u118l3-resquebrajar", type: "vocab", front: "resquebrajar", reading: "resquebrajar", meaning: "to crack / fracture", example: { jp: "La crisis resquebrajó la unidad del partido.", en: "The crisis cracked the party's unity." }, drill: { jp: "El calor puede resquebrajar el suelo seco", en: "The heat can crack the dry ground" }, accept: ["to crack", "to fracture", "to split"], hint: "Usually reflexive: se resquebraja. A crack that shows, short of breaking apart." },
      ],
    },
    {
      id: "es-u118l4",
      ...
      items: [
        ...
        { id: "es-u118l4-contrarrestar", type: "vocab", front: "contrarrestar", reading: "contrarrestar", meaning: "to counteract / offset", example: { jp: "Las nuevas ventas no contrarrestan las pérdidas del año pasado.", en: "The new sales do not offset last year's losses." }, drill: { jp: "Bebe mucha agua para contrarrestar el calor", en: "He drinks a lot of water to counteract the heat" }, accept: ["to counteract", "to offset", "to counterbalance"], hint: "Two forces meeting: one is set against the other. Note the double r." },
        { id: "es-u118l4-desatar", type: "vocab", front: "desatar", reading: "desatar", meaning: "to unleash / set off", example: { jp: "La sentencia desató una fuerte reacción en la prensa.", en: "The ruling set off a strong reaction in the press." }, drill: { jp: "Aquella decisión logró desatar la protesta de todos", en: "That decision set off a protest from everyone" }, accept: ["to unleash", "to set off", "to trigger", "to spark"], hint: "Literally to untie: something held back is now loose. Desatarse for what breaks out by itself." },
        ...
        { id: "es-u118l4-revertir", type: "vocab", front: "revertir", reading: "revertir", meaning: "to reverse / turn around", example: { jp: "Costará años revertir el daño hecho al terreno.", en: "It will take years to reverse the damage done to the land." }, drill: { jp: "El equipo consiguió revertir el resultado en casa", en: "The team managed to turn the result around at home" }, accept: ["to reverse", "to turn around", "to undo"], hint: "Sends a process back the way it came. Revertir EN algo means to result in something instead." },
        { id: "es-u118l4-neutralizar", type: "vocab", front: "neutralizar", reading: "neutralizar", meaning: "to neutralize / cancel out", example: { jp: "Las ayudas neutralizan el efecto de la subida.", en: "The subsidies neutralize the effect of the increase." }, drill: { jp: "Buscan la manera de neutralizar el riesgo", en: "They are looking for a way to neutralize the risk" }, accept: ["to neutralize", "to cancel out", "to offset"], hint: "Leaves nothing behind, where contrarrestar (the card above) only pushes the other way." },
      ],
    },
  ],
};
