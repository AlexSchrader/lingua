  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u118l1-atizar", type: "vocab", front: "atizar", reading: "atizar", meaning: "to stoke / stir up", example: { jp: "Sus declaraciones atizaron el conflicto en lugar de calmarlo.", en: "His statements stoked the conflict instead of calming it." }, accept: ["to stoke", "to stir up", "to fuel"], hint: "Avivar can be innocent; atizar rarely is — someone is feeding the fire on purpose." },
        { id: "es-u118l1-recrudecerse", type: "vocab", front: "recrudecerse", reading: "recrudecerse", meaning: "to flare up again", example: { jp: "El conflicto se recrudeció en cuanto terminó el acuerdo.", en: "The conflict flared up again as soon as the agreement ended." }, accept: ["to flare up again", "to intensify again", "to worsen"], hint: "Only for things already bad: wars, epidemics, cold weather. Always reflexive in this sense." },
      ],
    },
    {
      id: "es-u118l2",
      ...
      items: [
        ...
        { id: "es-u118l2-apuntalar", type: "vocab", front: "apuntalar", reading: "apuntalar", meaning: "to shore up / prop up", example: { jp: "El banco central apuntaló el sistema durante unos meses.", en: "The central bank shored up the system for a few months." }, accept: ["to shore up", "to prop up", "to underpin"], hint: "From el puntal, a prop: the thing would fall without you. It admits weakness in a way reforzar does not." },
    ...
    },
    {
      ...
      items: [
        { id: "es-u118l3-debilitar", type: "vocab", front: "debilitar", reading: "debilitar", meaning: "to weaken", example: { jp: "La falta de apoyo debilitó al gobierno mes a mes.", en: "The lack of support weakened the government month by month." }, accept: ["to weaken", "to sap", "to enfeeble"], hint: "The plain word of the family, from débil. Reflexive when it happens on its own: la moneda se debilitó." },
        { id: "es-u118l3-mermar", type: "vocab", front: "mermar", reading: "mermar", meaning: "to diminish / eat into", example: { jp: "Los gastos del juicio mermaron sus ahorros.", en: "The costs of the trial ate into his savings." }, accept: ["to diminish", "to eat into", "to reduce", "to deplete"], hint: "Quantities you can count: savings, harvests, staff. Works transitively and on its own." },
    ...
    },
    {
      ...
      items: [
        { id: "es-u118l4-atenuar", type: "vocab", front: "atenuar", reading: "atenuar", meaning: "to lessen / tone down", example: { jp: "El tribunal atenuó la condena por su estado de salud.", en: "The court reduced the sentence on account of his state of health." }, accept: ["to lessen", "to tone down", "to mitigate", "to soften"], hint: "Lowers the intensity of something that stays. Una circunstancia atenuante is the legal term built on it." },
        { id: "es-u118l4-mitigar", type: "vocab", front: "mitigar", reading: "mitigar", meaning: "to mitigate / alleviate", example: { jp: "Las ayudas mitigaron los efectos de la sequía, pero no los evitaron.", en: "The aid mitigated the effects of the drought, but did not prevent them." }, accept: ["to mitigate", "to alleviate", "to ease"], hint: "Aimed at harm and suffering — you mitigate consequences, you atenúas intensity." },
        ...
        { id: "es-u118l4-suscitar", type: "vocab", front: "suscitar", reading: "suscitar", meaning: "to give rise to / arouse", example: { jp: "La propuesta suscitó dudas incluso entre sus propios apoyos.", en: "The proposal gave rise to doubts even among its own supporters." }, accept: ["to give rise to", "to arouse", "to prompt", "to raise"], hint: "Quieter than desatar: it produces reactions, questions and interest, not storms." },
