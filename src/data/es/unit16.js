  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u16l1-elpantalon", type: "vocab", front: "el pantalón", reading: "elpantalon", meaning: "the trousers", example: { jp: "Compro un pantalón nuevo.", en: "I'm buying new trousers." }, accept: ["pants", "trousers", "pair of trousers"], hint: "One garment, singular in Spanish: un pantalón, not \"unos pantalones\" — though you'll hear both." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u16l4-probar", type: "vocab", front: "probar", reading: "probar", meaning: "to try", example: { jp: "¿Puedo probar la chaqueta?", en: "Can I try the jacket on?" }, accept: ["try on", "taste", "to try on"], hint: "Clothes or food, same verb: probar la chaqueta, probar el café." },
      ],
    },
  ],
};
