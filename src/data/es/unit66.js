  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u66l3-elconsumo", type: "vocab", front: "el consumo", reading: "elconsumo", meaning: "consumption", example: { jp: "El consumo de energía bajó bastante durante el verano.", en: "Energy consumption fell considerably over the summer." }, accept: ["consumption", "use", "spending"], hint: "Of energy, water or goods. El consumidor is the person doing it." },
        { id: "es-u66l3-laexportacion", type: "vocab", front: "la exportación", reading: "laexportacion", meaning: "the export(s)", example: { jp: "Las exportaciones crecieron mucho el año pasado.", en: "Exports grew a great deal last year." }, accept: ["the export", "the exports", "exporting"], hint: "Usually plural in the news: las exportaciones. Its opposite is la importación." },
      ],
    },
    {
      id: "es-u66l4",
