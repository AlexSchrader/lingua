  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u55l2-estaraltanto", type: "vocab", front: "estar al tanto", reading: "estaraltanto", meaning: "to be up to date / in the know", example: { jp: "Mi padre está al tanto de todo lo que pasa en la ciudad.", en: "My father is up to date on everything that happens in the city." }, accept: ["to be up to date", "to keep up", "to be aware"], hint: "estar al tanto DE algo. Poner a alguien al tanto = to fill someone in." },
      ],
    },
    {
      id: "es-u55l3",
