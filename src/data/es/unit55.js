  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u55l2-estaraltanto", type: "vocab", front: "estar al tanto", reading: "estaraltanto", meaning: "to be up to date / in the know", example: { jp: "Mi padre está al tanto de todo lo que pasa en el barrio.", en: "My father is up to date on everything that happens in the neighbourhood." }, accept: ["to be up to date", "to keep up", "to be aware"], hint: "estar al tanto DE algo. Poner a alguien al tanto = to fill someone in." },
      ],
    },
    {
      id: "es-u55l3",
      ...
      items: [
        ...
        { id: "es-u55l3-laconvivencia", type: "vocab", front: "la convivencia", reading: "laconvivencia", meaning: "living together / coexistence", example: { jp: "La convivencia entre los vecinos ha mejorado mucho este año.", en: "Coexistence between the neighbours has improved a lot this year." }, accept: ["coexistence", "living together", "community life"], hint: "From convivir (vivir + con). Used for how a whole society — or one flat — gets along." },
      ],
    },
    {
      id: "es-u55l4",
