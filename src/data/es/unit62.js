  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u62l2-arrepentirse", type: "vocab", front: "arrepentirse", reading: "arrepentirse", meaning: "to regret", example: { jp: "Ahora se arrepiente de su decisión.", en: "Now he regrets his decision." }, accept: ["to be sorry"], hint: "arrepentirse DE algo. The e becomes ie: me arrepiento. la decisión is A2." },
        { id: "es-u62l2-atreverse", type: "vocab", front: "atreverse", reading: "atreverse", meaning: "to dare", example: { jp: "No se atreve a decir lo que piensa.", en: "He doesn't dare to say what he thinks." }, accept: ["to have the nerve"], hint: "atreverse A + infinitive. ¿Te atreves? = Do you dare? Lo que piensa uses lo que (u29)." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u62l3-elcompromiso", type: "vocab", front: "el compromiso", reading: "elcompromiso", meaning: "commitment", example: { jp: "Es un compromiso serio, no una promesa vacía.", en: "It's a serious commitment, not an empty promise." }, accept: ["the obligation", "engagement"], hint: "The noun from comprometerse. Also an engagement, or a difficult spot: estar en un compromiso." },
        ...
        { id: "es-u62l3-dispuesto", type: "vocab", front: "dispuesto", reading: "dispuesto", meaning: "willing", example: { jp: "Estoy dispuesto a ayudar en todo lo posible.", en: "I'm willing to help in every way I can." }, accept: ["ready", "prepared"], hint: "estar dispuesto A + infinitive = to be willing to. From disponer (l1). todo lo posible = everything possible." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u62l4-enbreve", type: "vocab", front: "en breve", reading: "enbreve", meaning: "shortly", example: { jp: "El tren sale en breve, no llegues tarde.", en: "The train leaves shortly, don't be late." }, accept: ["soon", "in a moment"], hint: "A slightly formal \"very soon\". breve = brief. date prisa = hurry up is common." },
