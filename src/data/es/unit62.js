  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u62l2-sopesar", type: "vocab", front: "sopesar", reading: "sopesar", meaning: "to weigh up", example: { jp: "Sopesó todo con calma antes de decidirse por el otro plan.", en: "He weighed everything up calmly before deciding on the other plan." }, accept: ["to weigh up", "to consider carefully", "to weigh"], hint: "Literally to feel the weight of something. Sopesar los pros y los contras." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u62l3-responsabilizarse", type: "vocab", front: "responsabilizarse", reading: "responsabilizarse", meaning: "to take responsibility", example: { jp: "Se responsabilizó del error y habló con todo el equipo.", en: "He took responsibility for the mistake and spoke to the whole team." }, accept: ["to take responsibility", "to take charge", "to answer for"], hint: "responsabilizarse DE algo. Built on la responsabilidad." },
