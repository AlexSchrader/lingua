  ...
  lessons: [
    {
      ...
      items: [
        { id: "es-u95l1-ladinastia", type: "vocab", front: "la dinastía", reading: "ladinastia", meaning: "the dynasty", example: { jp: "La dinastía gobernó el país durante casi tres siglos.", en: "The dynasty ruled the country for almost three centuries." }, accept: ["the dynasty", "the ruling house", "the line"], hint: "A family that holds power across generations. Used of companies and sports teams too." },
        { id: "es-u95l1-elreinado", type: "vocab", front: "el reinado", reading: "elreinado", meaning: "the reign", example: { jp: "Durante su reinado se construyeron los grandes puertos.", en: "During his reign the great ports were built." }, accept: ["the reign", "the rule"], hint: "The period one monarch rules. El reino is the kingdom itself — one letter apart, very different words." },
        { id: "es-u95l1-elauge", type: "vocab", front: "el auge", reading: "elauge", meaning: "the height / boom", example: { jp: "La ciudad vivió su mayor auge en el siglo XVI.", en: "The city saw its greatest heyday in the sixteenth century." }, accept: ["the height", "the peak", "the boom", "the heyday"], hint: "Estar en auge = to be booming. Of economies, of empires, and of fashions." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u95l2-lacolonia", type: "vocab", front: "la colonia", reading: "lacolonia", meaning: "the colony", example: { jp: "Fue una colonia hasta bien entrado el siglo XIX.", en: "It was a colony until well into the nineteenth century." }, accept: ["the colony", "the settlement"], hint: "Colonial is the adjective, la colonización the process. In some countries it also means a neighbourhood." },
        { id: "es-u95l2-elsubdito", type: "vocab", front: "el súbdito", reading: "elsubdito", meaning: "the subject (of a ruler)", example: { jp: "Los súbditos debían pagar impuestos a la corona.", en: "The subjects had to pay taxes to the crown." }, accept: ["the subject", "the vassal"], hint: "A person under a monarch, never a school subject or the subject of a sentence." },
        { id: "es-u95l2-larevuelta", type: "vocab", front: "la revuelta", reading: "larevuelta", meaning: "the revolt", example: { jp: "Una revuelta campesina obligó al rey a ceder.", en: "A peasant revolt forced the king to give way." }, accept: ["the revolt", "the uprising", "the rebellion"], hint: "Smaller and more local than una revolución, and usually put down rather than won." },
        { id: "es-u95l2-laindependencia", type: "vocab", front: "la independencia", reading: "laindependencia", meaning: "independence", example: { jp: "El país celebró su independencia con un gran desfile.", en: "The country celebrated its independence with a great parade." }, accept: ["independence", "the independence"], hint: "Of nations here. Independiente covers both the political and the personal sense." },
      ],
    },
    {
      id: "es-u95l3",
      ...
      items: [
        { id: "es-u95l3-elpatrimonio", type: "vocab", front: "el patrimonio", reading: "elpatrimonio", meaning: "the heritage", example: { jp: "El casco antiguo es patrimonio de la humanidad.", en: "The old town is a world heritage site." }, accept: ["the heritage", "the legacy", "the assets"], hint: "Cultural heritage, and in law a person's whole estate. Patrimonio de la humanidad = world heritage." },
        { id: "es-u95l3-elvestigio", type: "vocab", front: "el vestigio", reading: "elvestigio", meaning: "the trace / remnant", example: { jp: "Apenas quedan vestigios de la muralla original.", en: "Barely any traces of the original wall remain." }, accept: ["the trace", "the remnant", "the vestige"], hint: "Usually plural: los vestigios. What little survives of something that was once whole." },
        ...
        { id: "es-u95l3-restaurar", type: "vocab", front: "restaurar", reading: "restaurar", meaning: "to restore", example: { jp: "Han restaurado la fachada tal como era en su origen.", en: "They have restored the façade just as it originally was." }, accept: ["to restore", "to repair", "to bring back"], hint: "Of buildings and paintings, and of order or a monarchy. La restauración is the work." },
      ],
    },
    {
      id: "es-u95l4",
      ...
      items: [
        { id: "es-u95l4-ellegado", type: "vocab", front: "el legado", reading: "ellegado", meaning: "the legacy", example: { jp: "Su legado sigue vivo en la lengua y en la cocina.", en: "Its legacy is still alive in the language and the cooking." }, accept: ["the legacy", "the bequest", "the inheritance"], hint: "What an age or a figure leaves to those who come after. Legar is the verb." },
        ...
        { id: "es-u95l4-elantepasado", type: "vocab", front: "el antepasado", reading: "elantepasado", meaning: "the ancestor", example: { jp: "Sus antepasados llegaron al valle hace cuatro siglos.", en: "Their ancestors reached the valley four centuries ago." }, accept: ["the ancestor", "the forebear", "the forefather"], hint: "Almost always plural. Los descendientes are those on the other end of the line." },
