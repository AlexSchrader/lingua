  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u54l1-lasensacion", type: "vocab", front: "la sensación", reading: "lasensacion", meaning: "feeling", example: { jp: "Da la sensación de que va a llover pronto.", en: "It gives the feeling that it's going to rain soon." }, accept: ["the sensation", "sense"], hint: "dar la sensación de que… = to seem like… A physical sensation too: una sensación de frío." },
        ...
        { id: "es-u54l1-enciertomodo", type: "vocab", front: "en cierto modo", reading: "enciertomodo", meaning: "in a way", example: { jp: "En cierto modo, tienes razón, pero no del todo.", en: "In a way, you're right, but not entirely." }, accept: ["in a sense", "sort of"], hint: "From cierto (A2) + el modo (A2). Concedes something partly — pairs naturally with del todo (u53)." },
        { id: "es-u54l1-hastaciertopunto", type: "vocab", front: "hasta cierto punto", reading: "hastaciertopunto", meaning: "up to a point", example: { jp: "Estoy de acuerdo hasta cierto punto, pero no en todo.", en: "I agree up to a point, but not on everything." }, accept: ["to some extent", "partly"], hint: "hasta (A2) + cierto punto. Agreement with a limit — the classic hedge before a \"but\"." },
      ],
    },
    {
      id: "es-u54l2",
      ...
      items: [
        ...
        { id: "es-u54l2-dudoso", type: "vocab", front: "dudoso", reading: "dudoso", meaning: "doubtful", example: { jp: "Es dudoso, pero no imposible del todo.", en: "It's doubtful, but not entirely impossible." }, accept: ["uncertain", "questionable"], hint: "From dudar (A2). Something you're not sure will happen." },
    ...
    },
    {
      ...
      items: [
        { id: "es-u54l3-sospechar", type: "vocab", front: "sospechar", reading: "sospechar", meaning: "to suspect", example: { jp: "Sospecho que no van a llegar a tiempo.", en: "I suspect they're not going to arrive on time." }, accept: ["to have a hunch"], hint: "To think something is true without proof. sospechar de alguien = to be suspicious of someone." },
