  ...
  lessons: [
    {
      ...
      items: [
        { id: "es-u54l1-alparecer", type: "vocab", front: "al parecer", reading: "alparecer", meaning: "it seems", example: { jp: "Al parecer, el tren llega tarde otra vez.", en: "Apparently, the train's late again." }, drill: { jp: "Al parecer el tren llega tarde", en: "Apparently the train arrives late" }, accept: ["it seems", "by the looks of it", "apparently"], hint: "From parecer (A2). Reports what seems to be the case — near por lo visto (u52)." },
        ...
        { id: "es-u54l1-enprincipio", type: "vocab", front: "en principio", reading: "enprincipio", meaning: "in principle", example: { jp: "En principio, el plan sigue igual, pero puede cambiar.", en: "In theory, the plan stays the same, but it could change." }, drill: { jp: "En principio voy mañana", en: "In theory I'm going tomorrow" }, accept: ["in principle", "supposedly", "in theory"], hint: "Marks a plan that holds \"for now\" but isn't guaranteed. NOT \"at the beginning\" — that's al principio." },
