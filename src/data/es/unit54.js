  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u54l2-laprobabilidad", type: "vocab", front: "la probabilidad", reading: "laprobabilidad", meaning: "the probability / likelihood", example: { jp: "Hay pocas probabilidades de que cambien la fecha.", en: "There is little chance that they will change the date." }, accept: ["probability", "likelihood", "chance"], hint: "The noun of probable in this lesson. Often plural: hay muchas probabilidades de que + subjunctive." },
      ],
    },
    {
      id: "es-u54l3",
