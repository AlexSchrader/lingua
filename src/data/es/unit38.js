  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u38l4-seran", type: "vocab", front: "serán", reading: "seran", meaning: "they will be", example: { jp: "Serán las tres de la tarde.", en: "It'll be three in the afternoon." }, accept: ["they'll be", "it will be"], hint: "Also used to guess a time: serán las tres — it must be about three." },
