  ...
  lessons: [
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Say what you used to do, -ar verbs: antes hablaba español, trabajaba en Madrid, estudiaba mucho.",
      items: [
        ...
        { id: "es-u38l1-trabajaba", type: "vocab", front: "trabajaba", reading: "trabajaba", meaning: "I used to work / was working", example: { jp: "Antes trabajaba en un banco.", en: "I used to work at a bank." }, accept: ["i was working", "he used to work", "she was working"], hint: "trabajar → trabajaba. Perfect for a job you had for a stretch of time in the past." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u38l2-salia", type: "vocab", front: "salía", reading: "salia", meaning: "I used to go out / was leaving", example: { jp: "Antes salía con mis amigos los sábados.", en: "I used to go out with my friends on Saturdays." }, accept: ["i was going out", "he used to leave", "she was leaving"], hint: "salir → salía. Any -ir verb, however irregular in the present, is regular here: salgo (present) but salía (imperfect)." },
