  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u56l2-eficiente", type: "vocab", front: "eficiente", reading: "eficiente", meaning: "efficient", example: { jp: "Es un equipo pequeño pero muy eficiente.", en: "It's a small team but a very efficient one." }, accept: ["efficient", "effective"], hint: "Careful with eficaz in this lesson: eficaz gets the result; eficiente gets it with less time and money." },
        { id: "es-u56l2-productivo", type: "vocab", front: "productivo", reading: "productivo", meaning: "productive", example: { jp: "La reunión fue corta pero muy productiva.", en: "The meeting was short but very productive." }, accept: ["productive", "fruitful"], hint: "Of a day, a meeting or a person that actually produced something. La productividad is the noun." },
      ],
    },
    {
      id: "es-u56l3",
      ...
      items: [
        ...
        { id: "es-u56l3-laplantilla", type: "vocab", front: "la plantilla", reading: "laplantilla", meaning: "the staff / workforce", example: { jp: "La empresa ha aumentado la plantilla este año.", en: "The company has increased its workforce this year." }, accept: ["the staff", "the workforce", "the payroll"], hint: "Everyone on the books, as a group. It also means a template — context decides." },
        { id: "es-u56l3-laformacion", type: "vocab", front: "la formación", reading: "laformacion", meaning: "training / education", example: { jp: "La empresa ofrece formación a todos los empleados nuevos.", en: "The company offers training to all new employees." }, accept: ["training", "education", "background"], hint: "On a CV it is your education; at work it is the training you are given." },
        { id: "es-u56l3-jubilarse", type: "vocab", front: "jubilarse", reading: "jubilarse", meaning: "to retire", example: { jp: "Mi tío se jubiló a los sesenta y cinco años.", en: "My uncle retired at sixty-five." }, accept: ["to retire"], hint: "Always reflexive: me jubilo, se jubila. La jubilación = retirement." },
      ],
    },
    {
      id: "es-u56l4",
      ...
      items: [
        ...
        { id: "es-u56l4-lacargadetrabajo", type: "vocab", front: "la carga de trabajo", reading: "lacargadetrabajo", meaning: "the workload", example: { jp: "La carga de trabajo aumenta cada mes y nadie dice nada.", en: "The workload grows every month and nobody says anything." }, accept: ["the workload", "the amount of work"], hint: "La carga = the load. Often with repartir: repartir la carga de trabajo entre el equipo." },
      ],
    },
  ],
};
