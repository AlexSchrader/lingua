  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u56l3-laformacion", type: "vocab", front: "la formación", reading: "laformacion", meaning: "training / education", example: { jp: "La empresa da formación a todos los empleados nuevos.", en: "The company gives training to all new employees." }, accept: ["training", "education", "background"], hint: "On a CV it is your education; at work it is the training you are given." },
        { id: "es-u56l3-jubilarse", type: "vocab", front: "jubilarse", reading: "jubilarse", meaning: "to retire", example: { jp: "Mi tío se jubiló el año pasado después de mucho tiempo.", en: "My uncle retired last year after a long time." }, accept: ["to retire"], hint: "Always reflexive: me jubilo, se jubila. La jubilación = retirement." },
      ],
    },
    {
      id: "es-u56l4",
