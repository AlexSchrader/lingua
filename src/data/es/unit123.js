  ...
  lessons: [
    {
      ...
      unit: 123,
      lesson: 1,
      title: "Lo inmediato y lo inminente",
      cefr: "B2",
      dominantMode: "recall",
      ...
      items: [
        ...
        { id: "es-u123l1-enelacto", type: "vocab", front: "en el acto", reading: "enelacto", meaning: "there and then / on the spot", example: { jp: "Lo detuvieron en el acto, delante de todos.", en: "They arrested him on the spot, in front of everyone." }, accept: ["on the spot", "there and then", "immediately"], hint: "In the same act, without a gap. Shop signs use it for while-you-wait service: reparaciones en el acto." },
        { id: "es-u123l1-actoseguido", type: "vocab", front: "acto seguido", reading: "actoseguido", meaning: "immediately afterwards", example: { jp: "Leyó la sentencia y, acto seguido, salió de la sala.", en: "He read out the ruling and, immediately afterwards, left the room." }, accept: ["immediately afterwards", "straight after", "thereupon"], hint: "Narrative, not conversational: it links two actions in a written account of events." },
        { id: "es-u123l1-inminente", type: "vocab", front: "inminente", reading: "inminente", meaning: "imminent", example: { jp: "Todos daban por inminente la decisión del tribunal.", en: "Everyone took the court's decision to be imminent." }, accept: ["imminent", "impending", "about to happen"], hint: "Hanging over the present. Used of decisions, storms and collapses — rarely of good news." },
    ...
    },
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Talk about spans of time: the gap between two events, what happened in the meantime, and what has lasted.",
      items: [
        ...
        { id: "es-u123l3-elintervalo", type: "vocab", front: "el intervalo", reading: "elintervalo", meaning: "the interval / gap", example: { jp: "Los trenes salen a intervalos de diez minutos.", en: "The trains leave at ten-minute intervals." }, accept: ["the interval", "the gap", "the spacing"], hint: "The empty space between two events, and so it repeats: a intervalos regulares." },
        ...
        { id: "es-u123l3-perdurar", type: "vocab", front: "perdurar", reading: "perdurar", meaning: "to endure / last on", example: { jp: "Aquella costumbre ha perdurado hasta hoy.", en: "That custom has endured to this day." }, accept: ["to endure", "to last", "to live on"], hint: "Surviving where other things did not — customs, buildings, reputations." },
      ],
    },
    {
      id: "es-u123l4",
