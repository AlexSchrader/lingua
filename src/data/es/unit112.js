  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u112l1-manifiesto", type: "vocab", front: "manifiesto", reading: "manifiesto", meaning: "manifest / plain to see", example: { jp: "Su desinterés por el tema es manifiesto.", en: "His lack of interest in the subject is plain to see." }, accept: ["manifest", "evident", "plain"], hint: "Poner de manifiesto = to bring to light. As a noun, un manifiesto is a published declaration." },
      ],
    },
    {
      id: "es-u112l2",
