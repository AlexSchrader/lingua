...
export const ES_UNIT121 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "es-u121l3-latramoya", type: "vocab", front: "la tramoya", reading: "latramoya", meaning: "the stage machinery", example: { jp: "Toda la tramoya se maneja desde arriba, sin que el público la vea.", en: "All the stage machinery is worked from above, without the audience seeing it." }, accept: ["the stage machinery", "the stage works", "the machinery behind the scenes"], hint: "The ropes and platforms that move the set. Figuratively, la tramoya política is the machinery nobody is meant to see." },
