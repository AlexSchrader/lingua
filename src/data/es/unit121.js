...
export const ES_UNIT121 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Describe how a play is put on: the stage, the production, the cast, the set, the curtain and the rehearsals.",
      items: [
        { id: "es-u121l3-elescenario", type: "vocab", front: "el escenario", reading: "elescenario", meaning: "the stage", example: { jp: "Salió al escenario sin decir una palabra.", en: "He came out onto the stage without saying a word." }, accept: ["the stage", "the setting"], hint: "The physical stage, and by extension any setting where something plays out — un escenario político." },
        ...
        { id: "es-u121l3-elensayo", type: "vocab", front: "el ensayo", reading: "elensayo", meaning: "the rehearsal", example: { jp: "El último ensayo duró hasta las dos de la mañana.", en: "The last rehearsal went on until two in the morning." }, accept: ["the rehearsal", "the practice"], hint: "Ensayar is to rehearse. The same noun is also the literary essay and a scientific trial — context decides." },
      ],
    },
    {
      id: "es-u121l4",
