...
export const ES_UNIT121 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Describe how a play is put on: its acts and stage directions, the production, the cast, the set and the curtain.",
      items: [
        { id: "es-u121l3-elacto", type: "vocab", front: "el acto", reading: "elacto", meaning: "the act (of a play)", example: { jp: "La obra tiene tres actos y dura casi dos horas.", en: "The play has three acts and lasts almost two hours." }, accept: ["the act", "the act of a play"], hint: "The large division of a play; inside it come las escenas. The same noun means a public ceremony." },
        ...
        { id: "es-u121l3-laacotacion", type: "vocab", front: "la acotación", reading: "laacotacion", meaning: "the stage direction", example: { jp: "Las acotaciones explican cómo debe moverse cada personaje.", en: "The stage directions explain how each character should move." }, accept: ["the stage direction", "the stage note"], hint: "The author writing in the margin, telling the actors what to do. Usually printed in italics and never spoken." },
      ],
    },
    {
      id: "es-u121l4",
