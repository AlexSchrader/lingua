  ...
  lessons: [
    {
      ...
      items: [
        { id: "es-u105l1-ambivalencia", type: "vocab", front: "la ambivalencia", reading: "laambivalencia", meaning: "ambivalence", example: { jp: "Su ambivalencia sobre el trabajo nuevo duró meses.", en: "Her ambivalence about the new job lasted months." }, drill: { jp: "Me molesta la ambivalencia de mi jefe", en: "My boss's ambivalence annoys me" }, accept: ["ambivalence", "mixed feelings"], hint: "Two opposite feelings held at the same time, neither winning. Not doubt about a fact — that is la duda (u76) — but doubt about how you feel." },
        { id: "es-u105l1-desconcierto", type: "vocab", front: "el desconcierto", reading: "eldesconcierto", meaning: "bewilderment", example: { jp: "Su respuesta creó mucho desconcierto entre todos.", en: "Her answer created a lot of bewilderment among everyone." }, drill: { jp: "El desconcierto duró hasta el final del partido", en: "The bewilderment lasted until the end of the match" }, accept: ["bewilderment", "confusion", "puzzlement", "disarray"], hint: "Not knowing what to think or feel — the state before a feeling settles into one. From concertar: things have stopped agreeing with each other." },
        ...
        { id: "es-u105l1-agridulce", type: "vocab", front: "agridulce", reading: "agridulce", meaning: "bittersweet", example: { jp: "El día final fue agridulce para todos.", en: "The last day was bittersweet for everyone." }, drill: { jp: "Su vuelta a casa fue algo agridulce", en: "His return home was somewhat bittersweet" }, accept: ["bittersweet"], hint: "Built from agrio + dulce, sour plus sweet, and used for food as well as farewells. One word for the whole two-way feeling." },
        { id: "es-u105l1-contradiccion", type: "vocab", front: "la contradicción", reading: "lacontradiccion", meaning: "contradiction", example: { jp: "Vivo en una contradicción: quiero irme y quiero quedarme.", en: "I live in a contradiction: I want to leave and I want to stay." }, drill: { jp: "La contradicción salta a la vista", en: "The contradiction is obvious" }, accept: ["contradiction", "inconsistency"], hint: "Two things that cannot both be true, in an argument or in a person. Caer en una contradicción = to contradict yourself." },
        { id: "es-u105l1-incomodidad", type: "vocab", front: "la incomodidad", reading: "laincomodidad", meaning: "discomfort / awkwardness", example: { jp: "Nadie habló de la incomodidad de esa comida.", en: "Nobody mentioned the awkwardness of that meal." }, drill: { jp: "Todos notaron la incomodidad del nuevo jefe", en: "Everyone noticed the new boss's awkwardness" }, accept: ["discomfort", "awkwardness", "unease", "uneasiness"], hint: "Social discomfort more often than physical: the feeling of a room where something has not been said." },
      ],
    },
    {
      id: "es-u105l2",
      ...
      items: [
        { id: "es-u105l2-resignacion", type: "vocab", front: "la resignación", reading: "laresignacion", meaning: "resignation (acceptance)", example: { jp: "Lo dijo con una resignación muy triste.", en: "He said it with a very sad resignation." }, drill: { jp: "Con la resignación no se arregla nada", en: "Nothing gets fixed with resignation" }, accept: ["resignation", "acceptance", "forbearance"], hint: "Accepting what you cannot change, without being at peace with it. Never the leaving-a-job sense — that is la dimisión." },
        ...
        { id: "es-u105l2-desencanto", type: "vocab", front: "el desencanto", reading: "eldesencanto", meaning: "disenchantment", example: { jp: "Después de las elecciones llegó el desencanto.", en: "After the elections came the disenchantment." }, drill: { jp: "El desencanto con la política crece cada año", en: "Disenchantment with politics grows every year" }, accept: ["disenchantment", "disillusionment", "disappointment"], hint: "The flatness left when something you believed in stops convincing you. Literally the un-casting of a spell — el encanto is the charm." },
      ],
    },
    {
      id: "es-u105l3",
