  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u105l1-ambivalente", type: "vocab", front: "ambivalente", reading: "ambivalente", meaning: "ambivalent", example: { jp: "Me siento ambivalente ante esa decisión.", en: "I feel ambivalent about that decision." }, accept: ["ambivalent", "torn", "of two minds"], hint: "The adjective for a person or an attitude. Ambiguo (u81) is about a thing being unclear; ambivalente is about you being divided." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u105l2-indiferencia", type: "vocab", front: "la indiferencia", reading: "laindiferencia", meaning: "indifference", example: { jp: "Su indiferencia fue peor que cualquier palabra.", en: "Her indifference was worse than any word." }, accept: ["indifference", "apathy", "coldness"], hint: "Not caring either way — which is why it wounds more than opposition. Con indiferencia is the manner." },
        { id: "es-u105l2-desapego", type: "vocab", front: "el desapego", reading: "eldesapego", meaning: "detachment", example: { jp: "Habla de su ciudad con un desapego raro.", en: "He talks about his city with a strange detachment." }, accept: ["detachment", "aloofness", "distance", "emotional distance"], hint: "A loosening of an attachment you used to have. It can be a loss or a discipline, and the word does not decide which." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u105l3-recelo", type: "vocab", front: "el recelo", reading: "elrecelo", meaning: "wariness / mistrust", example: { jp: "Leyó el papel con recelo antes de escribir nada.", en: "She read the form warily before writing anything." }, accept: ["wariness", "mistrust", "suspicion", "misgiving"], hint: "Suspicion you keep to yourself. Softer than an accusation: con recelo says you are holding back, not that you have proof." },
        { id: "es-u105l3-receloso", type: "vocab", front: "receloso", reading: "receloso", meaning: "wary / mistrustful", example: { jp: "Se quedó receloso aunque todos le dijeron que era verdad.", en: "He stayed wary even though everyone told him it was true." }, accept: ["wary", "mistrustful", "suspicious", "distrustful"], hint: "The adjective for the person carrying el recelo. Ser receloso is a character; estar receloso is today." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u105l4-reticente", type: "vocab", front: "reticente", reading: "reticente", meaning: "reluctant", example: { jp: "Los padres se mostraron reticentes ante el cambio.", en: "The parents were reluctant about the change." }, accept: ["reluctant", "hesitant", "unwilling", "wary"], hint: "Mostrarse reticente is the standard phrase in a report: it names an attitude without calling it opposition." },
        ...
        { id: "es-u105l4-titubear", type: "vocab", front: "titubear", reading: "titubear", meaning: "to hesitate / waver", example: { jp: "Titubeó un momento antes de decir que no.", en: "He hesitated for a moment before saying no." }, accept: ["to hesitate", "to waver", "to falter", "hesitate"], hint: "The visible hesitation — the pause, the half-started sentence. Sin titubear = without missing a beat." },
