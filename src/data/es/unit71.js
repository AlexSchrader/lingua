  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u71l1-lacreacion", type: "vocab", front: "la creación", reading: "lacreacion", meaning: "the creation / setting up", example: { jp: "La creación de este parque cambió el barrio entero.", en: "The creation of this park changed the whole neighbourhood." }, accept: ["the creation", "the setting up", "the founding"], hint: "From crear. Written Spanish prefers the noun — la creación de… — where speech says se creó…" },
        ...
        { id: "es-u71l1-laproduccion", type: "vocab", front: "la producción", reading: "laproduccion", meaning: "production / output", example: { jp: "La producción de la fábrica bajó un diez por ciento.", en: "The factory's output fell by ten per cent." }, accept: ["production", "output"], hint: "From producir. La producción nacional; also the making of a film." },
      ],
    },
    {
      id: "es-u71l2",
      ...
      items: [
        ...
        { id: "es-u71l2-laperspectiva", type: "vocab", front: "la perspectiva", reading: "laperspectiva", meaning: "the perspective / outlook", example: { jp: "Desde otra perspectiva, el problema parece mucho menor.", en: "From another perspective, the problem looks much smaller." }, accept: ["the perspective", "the point of view", "the outlook"], hint: "Close to el punto de vista, the first card here. It also means what lies ahead: las perspectivas económicas." },
