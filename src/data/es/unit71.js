  ...
  lessons: [
    {
      ...
      items: [
        { id: "es-u71l1-elaumento", type: "vocab", front: "el aumento", reading: "elaumento", meaning: "the increase", example: { jp: "El aumento de los precios preocupa a las familias, sobre todo a las más pobres.", en: "The increase in prices worries families, especially the poorest." }, accept: ["the rise", "growth"], hint: "From aumentar, to increase. Writing says el aumento de los precios where speech says los precios suben." },
        ...
        { id: "es-u71l1-eldesarrollo", type: "vocab", front: "el desarrollo", reading: "eldesarrollo", meaning: "the development", example: { jp: "El desarrollo de esta región depende del turismo, y eso preocupa a muchos.", en: "The development of this region depends on tourism, and that worries a lot of people." }, accept: ["growth", "expansion"], hint: "el desarrollo sostenible = sustainable development, the phrase you'll meet everywhere." },
        ...
        { id: "es-u71l1-lamejora", type: "vocab", front: "la mejora", reading: "lamejora", meaning: "the improvement", example: { jp: "Esta mejora es importante para todos, aunque cueste mucho dinero.", en: "This improvement is important for everyone, although it costs a lot of money." }, accept: ["the upgrade", "betterment"], hint: "From mejorar, to improve (from mejor, u37). Note the subjunctive after aunque: cueste." },
      ],
    },
    {
      id: "es-u71l2",
      ...
      items: [
        { id: "es-u71l2-lanocion", type: "vocab", front: "la noción", reading: "lanocion", meaning: "the notion", example: { jp: "La noción del tiempo cambia según la cultura, aunque no lo notemos.", en: "The notion of time changes according to culture, although we don't notice it." }, accept: ["the idea", "grasp", "concept"], hint: "tener nociones de algo = to have a basic grounding in something." },
        { id: "es-u71l2-elconcepto", type: "vocab", front: "el concepto", reading: "elconcepto", meaning: "the concept", example: { jp: "El concepto es interesante, aunque no todos lo entiendan igual.", en: "The concept is interesting, although not everyone understands it the same way." }, accept: ["the idea"], hint: "A near-perfect cognate. Tener un concepto claro de algo." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u71l4-elproposito", type: "vocab", front: "el propósito", reading: "elproposito", meaning: "the purpose", example: { jp: "El propósito de la reunión es claro, así que no perdamos tiempo en otras cosas.", en: "The purpose of the meeting is clear, so let's not waste time on other things." }, accept: ["the aim", "goal", "intention"], hint: "A propósito = on purpose, and also 'by the way'. Los propósitos de año nuevo are New Year's resolutions." },
        { id: "es-u71l4-elproceso", type: "vocab", front: "el proceso", reading: "elproceso", meaning: "the process", example: { jp: "El proceso fue muy largo, así que al final mucha gente se cansó de esperar.", en: "The process was very long, so in the end a lot of people got tired of waiting." }, accept: ["the procedure", "the case"], hint: "A process or sequence of steps. Also a legal case: un proceso judicial." },
