  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u106l3-dedarseelcaso", type: "vocab", front: "de darse el caso", reading: "dedarseelcaso", meaning: "should the case arise", example: { jp: "De darse el caso, la empresa tendría que pagar.", en: "Should the case arise, the company would have to pay." }, accept: ["should the case arise", "if that happens", "in that event"], hint: "De + infinitive replaces a si clause in formal prose: de darse, de mediar, de no ser así." },
