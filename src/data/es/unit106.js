  ...
  lessons: [
    {
      ...
      items: [
        { id: "es-u106l1-siempreycuando", type: "vocab", front: "siempre y cuando", reading: "siempreycuando", meaning: "provided that / as long as", example: { jp: "Puedes usar la casa siempre y cuando la dejes limpia.", en: "You can use the house provided you leave it clean." }, drill: { jp: "Firmo el contrato siempre y cuando paguen más", en: "I'll sign the contract provided they pay more" }, accept: ["provided that", "as long as", "on condition that", "so long as"], hint: "The most formal of the provisos, and always followed by the subjunctive. Heavier than siempre que, which does the same job in speech." },
        { id: "es-u106l1-acondiciondeque", type: "vocab", front: "a condición de que", reading: "acondiciondeque", meaning: "on condition that", example: { jp: "Dijo que sí a condición de que pagaran el viaje.", en: "She said yes on condition that they paid for the trip." }, drill: { jp: "Firmaron a condición de que nadie hablara", en: "They signed on condition that nobody would talk" }, accept: ["on condition that", "provided that", "on the condition that"], hint: "Names the condition as a condition — the wording of a negotiation. With a following infinitive, drop the que: a condición de pagar." },
        { id: "es-u106l1-siempreque", type: "vocab", front: "siempre que", reading: "siempreque", meaning: "as long as / whenever", example: { jp: "Te ayudo siempre que me avises antes.", en: "I'll help you as long as you let me know first." }, drill: { jp: "Puedes quedarte siempre que ayudes en casa", en: "You can stay as long as you help at home" }, accept: ["as long as", "provided that", "whenever"], hint: "Two readings in one phrase: with the subjunctive it is a condition, with the indicative it just means every time — siempre que viene, trae algo." },
        { id: "es-u106l1-salvoque", type: "vocab", front: "salvo que", reading: "salvoque", meaning: "unless", example: { jp: "Vamos a salir, salvo que el tiempo cambie.", en: "We're going out, unless the weather changes." }, drill: { jp: "Nadie va a decir nada salvo que preguntes", en: "Nobody is going to say anything unless you ask" }, accept: ["unless", "except that", "save that"], hint: "The written-register unless, built on salvo (u36). A menos que (u69) is the same idea in ordinary speech." },
        { id: "es-u106l1-supeditar", type: "vocab", front: "supeditar", reading: "supeditar", meaning: "to make subject to / subordinate", example: { jp: "El plan queda supeditado al dinero que llegue.", en: "The plan is subject to whatever money comes in." }, drill: { jp: "No quiero supeditar mi vida al trabajo", en: "I don't want to make my life subject to work" }, accept: ["to make subject to", "to subordinate", "to make conditional on", "subordinate"], hint: "Almost always in the participle: supeditado a. It is the formal way to say something only happens if something else does." },
        { id: "es-u106l1-condicionante", type: "vocab", front: "el condicionante", reading: "elcondicionante", meaning: "constraining factor", example: { jp: "El precio fue el gran condicionante de la decisión.", en: "Price was the big constraint on the decision." }, drill: { jp: "El horario fue el condicionante de todo", en: "The timetable was the constraint on everything" }, accept: ["constraint", "constraining factor", "determining factor", "limiting factor"], hint: "The thing that shapes what is possible before anyone chooses. Not the condition itself but the pressure behind it." },
      ],
    },
    {
      id: "es-u106l2",
      ...
      items: [
        { id: "es-u106l2-excepto", type: "vocab", front: "excepto", reading: "excepto", meaning: "except", example: { jp: "Vinieron todos excepto ella.", en: "Everyone came except her." }, drill: { jp: "Abre todos los días excepto los domingos", en: "It opens every day except Sundays" }, accept: ["except", "apart from", "but"], hint: "Interchangeable with salvo (u36) and menos in this sense. Note the pronoun stays subject-like: excepto yo, not excepto mí." },
        ...
        { id: "es-u106l2-deotromodo", type: "vocab", front: "de otro modo", reading: "deotromodo", meaning: "otherwise / in another way", example: { jp: "Debemos cambiar el plan; de otro modo, no va a funcionar.", en: "We must change the plan; otherwise it won't work." }, drill: { jp: "Hay que hacerlo de otro modo", en: "It has to be done another way" }, accept: ["otherwise", "in another way", "or else", "differently"], hint: "Built on el modo. Very close to de lo contrario, but it can also simply mean by some other means: hazlo de otro modo." },
        ...
        { id: "es-u106l2-contemplar", type: "vocab", front: "contemplar", reading: "contemplar", meaning: "to provide for / envisage", example: { jp: "La ley no contempla ese caso.", en: "The law does not provide for that case." }, drill: { jp: "El contrato debe contemplar ese caso también", en: "The contract must provide for that case too" }, accept: ["to provide for", "to envisage", "to cover", "to allow for"], hint: "The rule-writer's verb: a text contempla a situation when it has thought of it in advance. The looking-at sense is the everyday one." },
        { id: "es-u106l2-afaltade", type: "vocab", front: "a falta de", reading: "afaltade", meaning: "in the absence of / failing that", example: { jp: "A falta de pruebas, el caso se cerró.", en: "In the absence of evidence, the case was closed." }, drill: { jp: "A falta de tiempo dejamos el resto", en: "For lack of time we left the rest" }, accept: ["in the absence of", "failing", "for want of"], hint: "Followed by a noun. A falta de una mejor idea = for want of a better idea." },
      ],
    },
    {
      id: "es-u106l3",
      ...
      items: [
        { id: "es-u106l3-suponiendoque", type: "vocab", front: "suponiendo que", reading: "suponiendoque", meaning: "assuming that", example: { jp: "Suponiendo que sea cierto, ¿qué hacemos ahora?", en: "Assuming that is true, what do we do now?" }, drill: { jp: "Suponiendo que llueva mañana no salimos", en: "Assuming it rains tomorrow we are not going out" }, accept: ["assuming that", "supposing that", "if we assume that"], hint: "Takes the subjunctive. It grants something for the sake of argument without agreeing to it — from suponer." },
        { id: "es-u106l3-pongamosque", type: "vocab", front: "pongamos que", reading: "pongamosque", meaning: "let's say that", example: { jp: "Pongamos que ganamos: ¿cambiaría algo?", en: "Let's say we win: would anything change?" }, drill: { jp: "Pongamos que nadie viene a la fiesta", en: "Let's say nobody comes to the party" }, accept: ["let's say that", "let's suppose that", "say that", "suppose"], hint: "The spoken way into a hypothesis, from poner. Digamos que does the same work with a shade more hedging." },
        ...
        { id: "es-u106l3-apriori", type: "vocab", front: "a priori", reading: "apriori", meaning: "on the face of it", example: { jp: "A priori el plan parece sencillo, pero nadie lo probó.", en: "On the face of it the plan looks simple, but nobody has tried it." }, drill: { jp: "A priori nadie tiene la culpa", en: "On the face of it nobody is to blame" }, accept: ["on the face of it", "a priori", "at first sight", "in principle"], hint: "A supposition made before the evidence is in. Its opposite, a posteriori, judges after the fact." },
        ...
        { id: "es-u106l3-hipotetico", type: "vocab", front: "hipotético", reading: "hipotetico", meaning: "hypothetical", example: { jp: "Es un caso hipotético, no ha pasado nunca.", en: "It's a hypothetical case; it has never happened." }, drill: { jp: "Ese peligro sigue siendo bastante hipotético", en: "That danger is still fairly hypothetical" }, accept: ["hypothetical", "theoretical", "supposed"], hint: "From la hipótesis. En un supuesto hipotético is how a lawyer opens an example." },
      ],
    },
    {
      id: "es-u106l4",
      ...
      items: [
        { id: "es-u106l4-denoserpor", type: "vocab", front: "de no ser por", reading: "denoserpor", meaning: "if it were not for", example: { jp: "De no ser por ella, todo sería mucho peor.", en: "If it were not for her, everything would be much worse." }, drill: { jp: "De no ser por el tren llegaríamos tarde", en: "If it were not for the train we would arrive late" }, accept: ["if it were not for", "but for", "if not for", "were it not for"], hint: "Names the one thing that stopped a bad outcome. The past version is de no haber sido por." },
        { id: "es-u106l4-dehaber", type: "vocab", front: "de haber", reading: "dehaber", meaning: "if there had been / had there been", example: { jp: "De haber más dinero, el plan sería otro.", en: "If there were more money, the plan would be different." }, drill: { jp: "De haber sabido eso nadie habría venido", en: "Had we known that nobody would have come" }, accept: ["if there had been", "had there been", "if there were"], hint: "De + infinitive is a compact written way to build a conditional with no si at all: de saberlo, te lo diría." },
        { id: "es-u106l4-deserasi", type: "vocab", front: "de ser así", reading: "deserasi", meaning: "if that is the case", example: { jp: "De ser así, tendríamos que cambiar la fecha.", en: "If that is the case, we would have to change the date." }, drill: { jp: "De ser así todo el plan cambia", en: "If that is so the whole plan changes" }, accept: ["if that is the case", "if so", "should that be so"], hint: "Points back at what was just said and makes it the condition. Si es así is the same move in ordinary speech." },
        { id: "es-u106l4-entalcaso", type: "vocab", front: "en tal caso", reading: "entalcaso", meaning: "in that case", example: { jp: "El tiempo puede cambiar; en tal caso, nos quedamos en casa.", en: "The weather may change; in that case, we'll stay at home." }, drill: { jp: "En tal caso prefiero hablar con ellos", en: "In that case I'd rather talk to them" }, accept: ["in that case", "in such a case", "if so"], hint: "Introduces the consequence of the case just named. En ese caso is the everyday form; tal keeps it formal." },
        { id: "es-u106l4-llegadoelcaso", type: "vocab", front: "llegado el caso", reading: "llegadoelcaso", meaning: "if it comes to it", example: { jp: "Llegado el caso, hablaré yo con ellos.", en: "If it comes to it, I'll talk to them myself." }, drill: { jp: "Llegado el caso pedimos ayuda a los vecinos", en: "If it comes to it we'll ask the neighbours for help" }, accept: ["if it comes to it", "if need be", "should it come to that", "if necessary"], hint: "A participle used absolutely — literally the case having arrived. It marks a plan you hope not to need." },
        { id: "es-u106l4-ensudefecto", type: "vocab", front: "en su defecto", reading: "ensudefecto", meaning: "failing that / otherwise", example: { jp: "Traiga el original o, en su defecto, una copia firmada.", en: "Bring the original or, failing that, a signed copy." }, drill: { jp: "Firma el jefe o en su defecto yo", en: "The boss signs or failing that I do" }, accept: ["failing that", "otherwise", "or alternatively"], hint: "Offers the fallback after an or. Administrative register — you meet it on forms." },
      ],
    },
  ],
};
