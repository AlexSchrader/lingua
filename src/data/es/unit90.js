  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u90l3-laenvergadura", type: "vocab", front: "la envergadura", reading: "laenvergadura", meaning: "the span", example: { jp: "Es un proyecto de una envergadura enorme.", en: "It's a project of enormous span." }, accept: ["the span", "the scale", "the scope", "the wingspan"], hint: "Literally a wingspan: how far a thing reaches. De gran envergadura is the standard phrase for a big undertaking. La magnitud measures the quantity; la envergadura measures the reach." },
      ],
    },
    {
      id: "es-u90l4",
