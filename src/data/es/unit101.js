  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u101l2-sancion", type: "vocab", front: "la sanción", reading: "lasancion", meaning: "penalty / sanction", example: { jp: "La empresa pagó una sanción muy alta por contaminar el río.", en: "The company paid a very high penalty for polluting the river." }, accept: ["penalty", "sanction", "fine"], hint: "The official punishment for breaking a rule. Wider than la multa (u61), which is only money — una sanción can also close a business." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u101l3-transicion", type: "vocab", front: "la transición", reading: "latransicion", meaning: "transition", example: { jp: "La transición hacia otras energías será lenta y cara.", en: "The transition towards other kinds of energy will be slow and expensive." }, accept: ["transition", "shift", "changeover"], hint: "A managed change from one system to another. In Spain la Transición with a capital letter means one in particular: the move to democracy after 1975." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u101l4-gobernanza", type: "vocab", front: "la gobernanza", reading: "lagobernanza", meaning: "governance", example: { jp: "La gobernanza del agua es un problema político, no técnico.", en: "Water governance is a political problem, not a technical one." }, accept: ["governance"], hint: "Who decides, and how — not who governs. El gobierno (u32) is the institution; la gobernanza is the way decisions actually get made." },
        ...
        { id: "es-u101l4-mitigacion", type: "vocab", front: "la mitigación", reading: "lamitigacion", meaning: "mitigation", example: { jp: "La mitigación cuesta mucho menos que arreglar el daño después.", en: "Mitigation costs far less than fixing the damage afterwards." }, accept: ["mitigation", "reduction of harm"], hint: "Acting to make a problem smaller. Policy pairs it with la adaptación: mitigation reduces the cause, adaptation lives with the effect." },
      ],
    },
  ],
};
