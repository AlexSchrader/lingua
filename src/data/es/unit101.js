  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u101l1-ratificar", type: "vocab", front: "ratificar", reading: "ratificar", meaning: "to ratify", example: { jp: "El gobierno va a ratificar el acuerdo en junio.", en: "The government is going to ratify the agreement in June." }, drill: { jp: "Falta ratificar el texto en el parlamento", en: "The text still has to be ratified in parliament" }, accept: ["to ratify", "ratify", "to confirm formally"], hint: "The step after signing: the state's own institutions make the commitment real. Un acuerdo no ratificado no obliga a nadie." },
        { id: "es-u101l1-suscribir", type: "vocab", front: "suscribir", reading: "suscribir", meaning: "to sign up to / to endorse", example: { jp: "Muchas empresas quieren suscribir el convenio.", en: "Many companies want to sign up to the convention." }, drill: { jp: "Los vecinos van a suscribir el mismo acuerdo", en: "The neighbours are going to sign up to the same agreement" }, accept: ["to sign up to", "to endorse", "to subscribe to", "endorse"], hint: "To put your name to something someone else wrote. Also used of opinions: suscribo cada palabra = I endorse every word." },
        { id: "es-u101l1-vinculante", type: "vocab", front: "vinculante", reading: "vinculante", meaning: "binding", example: { jp: "La decisión de la cumbre no es vinculante para nadie.", en: "The summit's decision is not binding on anyone." }, drill: { jp: "Firmaron un acuerdo vinculante para las dos partes", en: "They signed an agreement binding on both sides" }, accept: ["binding", "legally binding"], hint: "The word that decides whether an agreement has teeth. Un acuerdo no vinculante is a promise, not an obligation." },
      ],
    },
    {
      id: "es-u101l2",
    ...
    },
    {
      ...
      items: [
        { id: "es-u101l3-emisiones", type: "vocab", front: "las emisiones", reading: "lasemisiones", meaning: "emissions", example: { jp: "Las emisiones de la industria bajaron mucho el año pasado.", en: "Industry emissions fell a lot last year." }, drill: { jp: "Las emisiones bajaron mucho el año pasado", en: "Emissions fell a lot last year" }, accept: ["emissions", "carbon emissions"], hint: "Almost always plural in this sense. From emitir; the singular una emisión is a broadcast or an issue of shares." },
        { id: "es-u101l3-carbono", type: "vocab", front: "el carbono", reading: "elcarbono", meaning: "carbon", example: { jp: "El carbono que sale de los coches contamina el aire de la ciudad.", en: "The carbon that comes out of cars pollutes the city's air." }, drill: { jp: "Los árboles guardan el carbono durante siglos", en: "Trees store carbon for centuries" }, accept: ["carbon"], hint: "The element, and by extension the thing being counted in climate policy. Not el carbón = coal — one letter and an accent apart." },
        { id: "es-u101l3-neutralidad", type: "vocab", front: "la neutralidad", reading: "laneutralidad", meaning: "neutrality", example: { jp: "El país quiere llegar a la neutralidad antes de 2050.", en: "The country wants to reach neutrality before 2050." }, drill: { jp: "La neutralidad parece todavía muy difícil", en: "Neutrality still looks very hard" }, accept: ["neutrality", "carbon neutrality"], hint: "Emitting no more than you remove. The same noun does the political job: la neutralidad de un país en una guerra." },
        { id: "es-u101l3-transicion", type: "vocab", front: "la transición", reading: "latransicion", meaning: "transition", example: { jp: "La transición hacia otras energías será larga y cara.", en: "The transition towards other kinds of energy will be long and expensive." }, drill: { jp: "La transición energética costará mucho dinero", en: "The energy transition will cost a lot of money" }, accept: ["transition", "shift", "changeover"], hint: "A managed change from one system to another. In Spain la Transición with a capital letter means one in particular: the move to democracy after 1975." },
        { id: "es-u101l3-combustible", type: "vocab", front: "el combustible", reading: "elcombustible", meaning: "fuel", example: { jp: "El precio del combustible subió otra vez este mes.", en: "The price of fuel went up again this month." }, drill: { jp: "Llenamos el depósito porque el combustible estaba barato", en: "We filled the tank because the fuel was cheap" }, accept: ["fuel", "the fuel"], hint: "Anything burned for energy — petrol, gas, wood. As an adjective it means flammable: un material combustible." },
        { id: "es-u101l3-fosil", type: "vocab", front: "fósil", reading: "fosil", meaning: "fossil (as in fossil fuel)", example: { jp: "Todavía dependemos demasiado de la energía fósil.", en: "We still depend too much on fossil energy." }, drill: { jp: "El transporte todavía usa combustible fósil", en: "Transport still uses fossil fuel" }, accept: ["fossil", "fossil fuel"], hint: "Adjective and noun both: la energía fósil, and un fósil is the thing in the rock. Los combustibles fósiles is the phrase you will meet most." },
      ],
    },
    {
      id: "es-u101l4",
      ...
      items: [
        { id: "es-u101l4-sostenibilidad", type: "vocab", front: "la sostenibilidad", reading: "lasostenibilidad", meaning: "sustainability", example: { jp: "La sostenibilidad ya no es solo una idea bonita.", en: "Sustainability is no longer just a nice idea." }, drill: { jp: "La sostenibilidad exige decisiones incómodas", en: "Sustainability demands uncomfortable decisions" }, accept: ["sustainability"], hint: "The noun behind sostenible (u65). It names the political goal, which is why it turns up in company reports as often as in science." },
        { id: "es-u101l4-incentivo", type: "vocab", front: "el incentivo", reading: "elincentivo", meaning: "incentive", example: { jp: "El gobierno da un incentivo a quien gaste menos energía.", en: "The government gives an incentive to whoever uses less energy." }, drill: { jp: "El incentivo funcionó mejor que la multa", en: "The incentive worked better than the fine" }, accept: ["incentive", "inducement"], hint: "A reason built into the rules to make people choose something. The positive twin of penalizar in lesson 2." },
        { id: "es-u101l4-subvencion", type: "vocab", front: "la subvención", reading: "lasubvencion", meaning: "subsidy / grant", example: { jp: "La subvención ayuda a las familias con menos dinero.", en: "The subsidy helps families with less money." }, drill: { jp: "La subvención llegó con mucho retraso", en: "The grant arrived very late" }, accept: ["subsidy", "grant", "public funding"], hint: "Public money given to make something cheaper or possible. Solicitar una subvención = to apply for a grant." },
        { id: "es-u101l4-escasez", type: "vocab", front: "la escasez", reading: "laescasez", meaning: "scarcity / shortage", example: { jp: "La escasez de agua ya afecta a media región.", en: "Water scarcity already affects half the region." }, drill: { jp: "La escasez de médicos preocupa en los pueblos", en: "The shortage of doctors is worrying in the villages" }, accept: ["scarcity", "shortage", "lack"], hint: "Not enough of something, as a lasting condition. From escaso; la escasez de agua is the standard collocation in this register." },
        { id: "es-u101l4-gravamen", type: "vocab", front: "el gravamen", reading: "elgravamen", meaning: "the levy", example: { jp: "Un gravamen sobre el plástico reduciría el consumo.", en: "A levy on plastic would reduce consumption." }, drill: { jp: "El gravamen sobre el azúcar subió otra vez", en: "The levy on sugar went up again" }, accept: ["the levy", "the charge", "the tax burden", "the duty"], hint: "A charge imposed to change behaviour, the mirror image of un incentivo. Gravar is the verb." },
        { id: "es-u101l4-laresiliencia", type: "vocab", front: "la resiliencia", reading: "laresiliencia", meaning: "resilience", example: { jp: "El plan busca aumentar la resiliencia de las ciudades ante el calor.", en: "The plan seeks to increase cities' resilience to heat." }, drill: { jp: "La resiliencia de esa familia sorprende a cualquiera", en: "That family's resilience surprises anyone" }, accept: ["resilience", "resistance", "adaptability"], hint: "The capacity to take a shock and recover. Standard in climate policy: resiliencia climática." },
      ],
    },
  ],
};
