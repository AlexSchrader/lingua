  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u69l1-pormuchoque", type: "vocab", front: "por mucho que", reading: "pormuchoque", meaning: "no matter how much", example: { jp: "Por mucho que lo intentes, no va a cambiar de opinión.", en: "No matter how much you try, he isn't going to change his mind." }, accept: ["no matter how much", "however much", "try as you might"], hint: "The same shape as por más que, the card before: subjunctive when it has not happened yet." },
      ],
    },
    {
      id: "es-u69l2",
