  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u40l2-quedar", type: "vocab", front: "quedar", reading: "quedar", meaning: "to arrange to meet / to be left", example: { jp: "Quedamos el sábado por la tarde.", en: "We're meeting on Saturday afternoon." }, drill: { jp: "Podemos quedar mañana por la tarde", en: "We can meet up tomorrow afternoon" }, accept: ["to arrange to meet", "to meet up", "to be left"], hint: "Two everyday senses: quedar CON alguien = to arrange to meet, and quedar = to be left over (queda poco tiempo)." },
      ],
    },
    {
      id: "es-u40l3",
    ...
    },
    {
      ...
      items: [
        { id: "es-u40l5-mayor", type: "vocab", front: "mayor", reading: "mayor", meaning: "greater / older", example: { jp: "Mi hermana mayor vive en Madrid.", en: "My older sister lives in Madrid." }, drill: { jp: "Mi hermano mayor trabaja en Sevilla", en: "My older brother works in Seville" }, accept: ["greater", "bigger", "older", "elder"], hint: "The comparative of grande, and the normal word for an older sibling. La mayoría (u32) comes from it." },
        { id: "es-u40l5-menor", type: "vocab", front: "menor", reading: "menor", meaning: "lesser / younger", example: { jp: "El problema es menor de lo que parecía.", en: "The problem is smaller than it seemed." }, drill: { jp: "Mi hermana menor estudia en Madrid", en: "My younger sister studies in Madrid" }, accept: ["lesser", "smaller", "younger", "minor"], hint: "The mirror of mayor. Un menor is also a minor in the legal sense." },
        { id: "es-u40l5-completo", type: "vocab", front: "completo", reading: "completo", meaning: "complete / full", example: { jp: "El informe todavía no está completo.", en: "The report isn't complete yet." }, drill: { jp: "El hotel está completo este fin de semana", en: "The hotel is full this weekend" }, accept: ["complete", "full", "whole"], hint: "Nothing missing — where entero (u43) means not divided. Por completo = completely." },
        { id: "es-u40l5-grave", type: "vocab", front: "grave", reading: "grave", meaning: "serious / grave", example: { jp: "Es un error grave, no una tontería.", en: "It's a serious mistake, not a silly one." }, drill: { jp: "Su problema es más grave ahora", en: "His problem is more serious now" }, accept: ["serious", "grave", "severe"], hint: "Of illnesses, mistakes and situations. Serio (u31) describes a person's manner; grave measures how bad something is." },
        { id: "es-u40l5-puro", type: "vocab", front: "puro", reading: "puro", meaning: "pure / sheer", example: { jp: "Fue pura suerte que llegara a tiempo.", en: "It was pure luck that he arrived on time." }, drill: { jp: "Es puro trabajo duro", en: "It is sheer hard work" }, accept: ["pure", "sheer", "clean"], hint: "Before the noun it means sheer: pura suerte. After it, literally pure: agua pura." },
        { id: "es-u40l5-privado", type: "vocab", front: "privado", reading: "privado", meaning: "private", example: { jp: "Es un asunto privado, no quiere hablar.", en: "It's a private matter; he doesn't want to talk." }, drill: { jp: "Trabaja en un hospital privado", en: "She works at a private hospital" }, accept: ["private", "personal"], hint: "Of matters and of the sector: la sanidad privada. En privado = in private." },
      ],
    },
    {
      id: "es-u40l6",
      ...
      items: [
        { id: "es-u40l6-delante", type: "vocab", front: "delante", reading: "delante", meaning: "in front", example: { jp: "El coche está delante de la casa.", en: "The car is in front of the house." }, drill: { jp: "Hay un coche delante de la puerta", en: "There's a car in front of the door" }, accept: ["in front", "ahead", "before"], hint: "delante DE algo. Its opposite is detrás; for time, use antes instead." },
        { id: "es-u40l6-encima", type: "vocab", front: "encima", reading: "encima", meaning: "on top / above", example: { jp: "Puso el libro encima de la mesa.", en: "He put the book on top of the table." }, drill: { jp: "Deja las llaves encima de la mesa", en: "Leave the keys on top of the table" }, accept: ["on top", "above", "over"], hint: "encima DE algo. Also 'on top of that' when you pile on a complaint: y encima llegó tarde." },
        { id: "es-u40l6-frentea", type: "vocab", front: "frente a", reading: "frentea", meaning: "facing / as opposed to", example: { jp: "El museo está frente a la estación.", en: "The museum is opposite the station." }, drill: { jp: "Vivo frente a la escuela", en: "I live opposite the school" }, accept: ["facing", "opposite", "as opposed to"], hint: "Taught as the phrase, because bare frente splits three ways: la frente is a forehead, el frente is a front line." },
        { id: "es-u40l6-segundo", type: "vocab", front: "segundo", reading: "segundo", meaning: "second", example: { jp: "Vive en el segundo piso.", en: "He lives on the second floor." }, drill: { jp: "Es el segundo día de lluvia", en: "It's the second day of rain" }, accept: ["second", "2nd"], hint: "Follows primero (u21). Un segundo is also a second of time." },
        { id: "es-u40l6-tercero", type: "vocab", front: "tercero", reading: "tercero", meaning: "third", example: { jp: "Es la tercera vez que lo intento.", en: "It's the third time I've tried it." }, drill: { jp: "El tercero en llegar fue mi hermano", en: "The third one to arrive was my brother" }, accept: ["third", "3rd"], hint: "Drops its o before a masculine noun: el tercer piso, like primero → primer." },
        { id: "es-u40l6-diario", type: "vocab", front: "diario", reading: "diario", meaning: "daily", example: { jp: "Escribe un informe diario.", en: "He writes a daily report." }, drill: { jp: "El trabajo diario me cansa mucho", en: "The daily work tires me out a lot" }, accept: ["daily", "everyday", "the newspaper"], hint: "As a noun it is a newspaper or a diary. Cotidiano (u75) is the same idea one register up." },
        { id: "es-u40l6-inicial", type: "vocab", front: "inicial", reading: "inicial", meaning: "initial", example: { jp: "La idea inicial era mucho más simple.", en: "The initial idea was much simpler." }, drill: { jp: "El precio inicial era más bajo", en: "The initial price was lower" }, accept: ["initial", "first", "opening"], hint: "From el inicio. Inicialmente is the adverb." },
      ],
    },
  ],
};
