  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u53l2-eltriple", type: "vocab", front: "el triple", reading: "eltriple", meaning: "three times as much", example: { jp: "Ahora gana el triple que hace diez años.", en: "He now earns three times as much as ten years ago." }, accept: ["triple", "three times as much", "three times as many"], hint: "Same family as el doble in this lesson: el doble, el triple. El triple QUE for the comparison." },
      ],
    },
    {
      id: "es-u53l3",
      ...
      items: [
        ...
        { id: "es-u53l3-resaltar", type: "vocab", front: "resaltar", reading: "resaltar", meaning: "to highlight / stand out", example: { jp: "El informe resalta la importancia de este cambio.", en: "The report highlights the importance of this change." }, accept: ["to highlight", "to emphasize", "to stand out"], hint: "Two directions: resaltar algo = make it stand out; resaltar = to stand out itself." },
        { id: "es-u53l3-singular", type: "vocab", front: "singular", reading: "singular", meaning: "unique / one of a kind", example: { jp: "Es un caso singular en la historia del país.", en: "It's a unique case in the country's history." }, accept: ["unique", "remarkable", "singular"], hint: "Not 'single'. Un talento singular = a one-of-a-kind talent." },
        { id: "es-u53l3-peculiar", type: "vocab", front: "peculiar", reading: "peculiar", meaning: "distinctive / peculiar", example: { jp: "Tiene una forma peculiar de hablar con la gente.", en: "He has a distinctive way of talking to people." }, accept: ["distinctive", "characteristic", "odd"], hint: "More neutral than English 'peculiar': it marks what is characteristic of that one thing." },
      ],
    },
    {
      id: "es-u53l4",
