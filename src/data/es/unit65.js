  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u65l2-extinguirse", type: "vocab", front: "extinguirse", reading: "extinguirse", meaning: "to become extinct / die out", example: { jp: "Muchas aves podrían extinguirse en pocos años.", en: "Many birds could become extinct within a few years." }, accept: ["to become extinct", "to die out", "to go extinct"], hint: "Reflexive: una especie se extingue. You meet it first in en peligro de extinción." },
      ],
    },
    {
      id: "es-u65l3",
