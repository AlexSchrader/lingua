  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u65l2-laflora", type: "vocab", front: "la flora", reading: "laflora", meaning: "the flora / plant life", example: { jp: "La flora de esta región es muy variada.", en: "The plant life of this region is very varied." }, accept: ["the flora", "the plant life", "the vegetation"], hint: "The plant half of the pair with la fauna, the card before it." },
        { id: "es-u65l2-extinguirse", type: "vocab", front: "extinguirse", reading: "extinguirse", meaning: "to become extinct / die out", example: { jp: "Muchos animales podrían extinguirse en pocos años.", en: "Many animals could become extinct within a few years." }, accept: ["to become extinct", "to die out", "to go extinct"], hint: "Reflexive: una especie se extingue. You meet it first in en peligro de extinción." },
      ],
    },
    {
      id: "es-u65l3",
