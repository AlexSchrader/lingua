  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u65l2-amenazar", type: "vocab", front: "amenazar", reading: "amenazar", meaning: "to threaten", example: { jp: "El calentamiento amenaza a muchas especies, y nadie sabe muy bien qué hacer.", en: "Global warming threatens many species, and nobody quite knows what to do." }, accept: ["to endanger", "to put at risk"], hint: "The noun is la amenaza, the threat." },
        { id: "es-u65l2-desaparecer", type: "vocab", front: "desaparecer", reading: "desaparecer", meaning: "to disappear", example: { jp: "Estos animales van a desaparecer si no cambia nada pronto.", en: "These animals are going to disappear if nothing changes soon." }, accept: ["to vanish", "to die out", "to go extinct"], hint: "The opposite of aparecer. From parecer (u31), with the prefix des-." },
