  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u120l1-lacumbre", type: "vocab", front: "la cumbre", reading: "lacumbre", meaning: "the summit", example: { jp: "Llegaron a la cumbre muy pronto por la mañana.", en: "They reached the summit very early in the morning." }, accept: ["the summit", "the peak", "the top"], hint: "The same noun names a political summit — una cumbre europea." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u120l2-lallanura", type: "vocab", front: "la llanura", reading: "lallanura", meaning: "the plain", example: { jp: "La llanura se extiende hasta el horizonte.", en: "The plain stretches to the horizon." }, accept: ["the plain", "the flatland", "the lowland"], hint: "From llano, flat. Big and open — the geography word, where el campo is the everyday one." },
        { id: "es-u120l2-lameseta", type: "vocab", front: "la meseta", reading: "lameseta", meaning: "the plateau / tableland", example: { jp: "En la meseta hace mucho frío en invierno.", en: "On the plateau it is very cold in winter." }, accept: ["the plateau", "the tableland"], hint: "Literally a little table: flat, but high up. La Meseta with a capital M is the centre of Spain." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u120l3-elafluente", type: "vocab", front: "el afluente", reading: "elafluente", meaning: "the tributary", example: { jp: "Ese río es un afluente del Ebro.", en: "That river is a tributary of the Ebro." }, accept: ["the tributary", "the feeder river"], hint: "Afluente DE another river. From fluir, to flow — it flows towards the bigger one." },
        { id: "es-u120l3-lacuenca", type: "vocab", front: "la cuenca", reading: "lacuenca", meaning: "the (river) basin", example: { jp: "Toda la cuenca depende de la lluvia de primavera.", en: "The whole basin depends on the spring rain." }, accept: ["the basin", "the river basin", "the catchment"], hint: "Every drop of land that drains into the same river. Also a mining basin: la cuenca minera." },
        ...
        { id: "es-u120l3-elmanantial", type: "vocab", front: "el manantial", reading: "elmanantial", meaning: "the spring / source", example: { jp: "El agua del manantial sale muy fría todo el año.", en: "The water from the spring comes out very cold all year." }, accept: ["the spring", "the source", "the wellspring"], hint: "Where water leaves the ground on its own. Agua de manantial is what the bottle says." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u120l4-labahia", type: "vocab", front: "la bahía", reading: "labahia", meaning: "the bay", example: { jp: "Los barcos esperan en la bahía cuando hay tormenta.", en: "The boats wait in the bay when there is a storm." }, accept: ["the bay", "the bight"], hint: "Open water partly enclosed by land. A small one is una cala." },
