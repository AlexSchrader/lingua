  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u15l1-elsalon", type: "vocab", front: "el salón", reading: "elsalon", meaning: "the living room", example: { jp: "El salón de mi casa es muy grande.", en: "My house's living room is very big." }, accept: ["living room", "lounge", "sitting room"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u15l4-elsuelo", type: "vocab", front: "el suelo", reading: "elsuelo", meaning: "the floor", example: { jp: "El niño está en el suelo.", en: "The child is on the floor." }, accept: ["floor", "ground"], hint: "el suelo is the surface you stand on; el piso (below) is the storey of a building — or the whole flat." },
