  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u44l1-dudar", type: "vocab", front: "dudar", reading: "dudar", meaning: "to doubt", example: { jp: "Dudo de la respuesta.", en: "I doubt the answer." }, accept: ["to hesitate", "to be unsure"], hint: "The noun is la duda (u45). Sin dudar = without hesitating." },
