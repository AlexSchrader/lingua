  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u97l2-lalealtad", type: "vocab", front: "la lealtad", reading: "lalealtad", meaning: "loyalty", example: { jp: "Le exigían lealtad total al partido.", en: "They demanded total loyalty to the party from him." }, accept: ["loyalty", "the loyalty", "allegiance"], hint: "Lealtad A alguien. Standing by someone when it costs you something." },
      ],
    },
    {
      id: "es-u97l3",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u97l4-elegoismo", type: "vocab", front: "el egoísmo", reading: "elegoismo", meaning: "selfishness", example: { jp: "Lo que parecía miedo era solo egoísmo.", en: "What looked like fear was only selfishness." }, accept: ["selfishness", "egoism", "self-interest"], hint: "Egoísta is the person and the adjective. Not the same as el ego." },
