  ...
  lessons: [
    {
      ...
      unit: 42,
      lesson: 1,
      title: "Importante, seguro, claro",
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Judge how things stand: es importante, es posible, no estoy seguro, está claro.",
      items: [
        ...
        { id: "es-u42l1-cierto", type: "vocab", front: "cierto", reading: "cierto", meaning: "true / certain", example: { jp: "Es cierto que hoy hace frío.", en: "It's true that it's cold today." }, accept: ["right", "a certain"], hint: "es cierto = it's true. Before a noun it means \"a certain\": cierto día = a certain day. ¿No es cierto? = isn't that so?" },
        { id: "es-u42l1-claro", type: "vocab", front: "claro", reading: "claro", meaning: "clear / of course", example: { jp: "Hoy el cielo está claro.", en: "The sky is clear today." }, accept: ["bright", "light (colour)", "sure"], hint: "Clear or bright. On its own, ¡Claro! = Of course! Está claro que… = it's obvious that…" },
      ],
    },
    {
      id: "es-u42l2",
      unit: 42,
      lesson: 2,
      title: "Libre, ocupado, listo",
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Describe availability and readiness: estar libre, estar ocupado, estar listo, ser útil.",
      items: [
        { id: "es-u42l2-libre", type: "vocab", front: "libre", reading: "libre", meaning: "free / available", example: { jp: "¿Estás libre el sábado?", en: "Are you free on Saturday?" }, accept: ["vacant", "at liberty"], hint: "Ends in -e: un día libre, una mesa libre. Free as in available or at liberty — not free of charge (that's gratis)." },
    ...
    },
    {
      ...
      unit: 42,
      lesson: 3,
      title: "Normal, especial, general",
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Place things on a scale of ordinary to special: normal, común, especial, principal.",
      items: [
        { id: "es-u42l3-normal", type: "vocab", front: "normal", reading: "normal", meaning: "normal / usual", example: { jp: "Es normal estar cansado por la noche.", en: "It's normal to be tired at night." }, accept: ["ordinary", "usual"], hint: "Ends in a consonant, plural normales. Es normal que… = it's only natural that…" },
