  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u94l2-laformula", type: "vocab", front: "la fórmula", reading: "laformula", meaning: "the formula", example: { jp: "Usaron la misma fórmula para todos los cálculos.", en: "They used the same formula for all the calculations." }, accept: ["the formula", "the equation"], hint: "Mathematical, chemical, or figurative: la fórmula del éxito. Note the stress: FÓR-mu-la." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u94l3-laviabilidad", type: "vocab", front: "la viabilidad", reading: "laviabilidad", meaning: "the feasibility", example: { jp: "Dudaban de la viabilidad del proyecto desde el principio.", en: "They doubted the feasibility of the project from the start." }, accept: ["the feasibility", "the viability", "workability"], hint: "Whether it can actually be done, not whether it is a good idea. Viable is the adjective." },
      ],
    },
    {
      id: "es-u94l4",
