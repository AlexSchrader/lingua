  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u33l4-instalar", type: "vocab", front: "instalar", reading: "instalar", meaning: "to install", example: { jp: "Voy a instalar esto en el ordenador nuevo.", en: "I'm going to install this on the new computer." }, drill: { jp: "Quiero instalar una aplicación nueva", en: "I want to install a new app" }, accept: ["to install", "to set up", "to put in"], hint: "Software or equipment alike: instalar un programa, instalar una lámpara. La instalación is the noun." },
      ],
    },
  ],
};
