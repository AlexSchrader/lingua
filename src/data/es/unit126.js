  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "es-u126l1-conmirasa", type: "vocab", front: "con miras a", reading: "conmirasa", meaning: "with a view to", example: { jp: "Se abrió una investigación con miras a esclarecer los hechos.", en: "An investigation was opened with a view to clearing up the facts." }, accept: ["with a view to", "with an eye to", "aiming at"], hint: "The goal is further off and less certain than with a fin de. Frequent in Latin American officialese." },
        { id: "es-u126l1-convistasa", type: "vocab", front: "con vistas a", reading: "convistasa", meaning: "with a view to / looking ahead to", example: { jp: "Están preparando el terreno con vistas a las elecciones.", en: "They are preparing the ground with a view to the elections." }, accept: ["with a view to", "looking ahead to", "in preparation for"], hint: "The Spanish twin of con miras a, and usually pointed at a date that is coming." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "es-u126l3-salvoque", type: "vocab", front: "salvo que", reading: "salvoque", meaning: "unless", example: { jp: "El plazo termina el viernes, salvo que el tribunal decida otra cosa.", en: "The deadline ends on Friday, unless the court decides otherwise." }, accept: ["unless", "except that", "save that"], hint: "Subjunctive. The formal register's a menos que, and the standard phrase in contracts." },
