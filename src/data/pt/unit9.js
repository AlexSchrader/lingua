...
export const PT_UNIT9 = {
  ...
  lessons: [
    ...
    // question word the whole unit is an answer to.
    {
      ...
      items: [
        { id: "pt-u9l2-sabado", type: "vocab", front: "sábado", reading: "sabado", meaning: "Saturday", example: { jp: "Sábado não é um dia de trabalho.", en: "Saturday isn't a working day." }, drill: { jp: "Sábado não é um dia de trabalho", en: "Saturday isn't a working day" }, accept: ["sat", "on saturday"], hint: "SA-ba-du. The counting stops here — sábado comes from the Sabbath, not from sete. No -feira, and no number." },
        { id: "pt-u9l2-domingo", type: "vocab", front: "domingo", reading: "domingo", meaning: "Sunday", example: { jp: "Domingo é um dia de família.", en: "Sunday is a family day." }, drill: { jp: "Domingo é um dia de família", en: "Sunday is a family day" }, accept: ["sun", "on sunday"], hint: "du-MEEN-gu, from the Latin for \"the Lord's day\" — and it is day ONE, which is why Monday ended up second. Shops open, but the long Sunday lunch is still real in Portugal." },
        { id: "pt-u9l2-ofimdesemana", type: "vocab", front: "o fim de semana", reading: "ofimdesemana", meaning: "weekend", example: { jp: "O fim de semana em Lisboa é fantástico.", en: "The weekend in Lisbon is fantastic." }, drill: { jp: "O fim de semana é fantástico", en: "The weekend is fantastic" }, accept: ["the weekend"], hint: "Literally \"end of week\", built on a semana from Unit 5. Portugal used to hyphenate it — fim-de-semana — and the 1990 accord dropped the hyphens, so both countries now write it open. O fim on its own is the end of anything." },
        { id: "pt-u9l2-omes", type: "vocab", front: "o mês", reading: "omes", meaning: "month", example: { jp: "Um mês tem quatro semanas.", en: "A month has four weeks." }, drill: { jp: "O mês de agosto é quente", en: "The month of August is hot" }, accept: ["the month"], hint: "MESH — circumflex, closed e, and the final s shushes like três. Plural os meses, where the e opens right up again: MEH-zesh. Nothing to do with a mesa, a table." },
        { id: "pt-u9l2-anoite", type: "vocab", front: "a noite", reading: "anoite", meaning: "night", example: { jp: "A noite de sábado é fantástica em Lisboa.", en: "Saturday night is fantastic in Lisbon." }, drill: { jp: "A noite de sábado é fantástica", en: "Saturday night is fantastic" }, accept: ["the night", "evening", "nighttime"], hint: "NOY-te. It covers evening AND night — Portuguese has no separate word, which is why boa noite from Unit 2 does the work of both \"good evening\" and \"good night\". Its daytime partner is a tarde, the afternoon inside boa tarde." },
        { id: "pt-u9l2-quando", type: "vocab", front: "quando", reading: "quando", meaning: "when", example: { jp: "Quando é o teu aniversário?", en: "When is your birthday?" }, drill: { jp: "Quando é o teu aniversário", en: "When is your birthday" }, accept: ["when?", "whenever", "at what time"], hint: "KWAN-du, nasal. The partner of onde from Unit 7 — onde asks where, quando asks when. Also works as a plain link: quando faz sol, a praça fica cheia." },
      ],
    },
    ...
    // em rather than an article: em maio, never "no maio".
    {
      ...
      items: [
        { id: "pt-u9l3-janeiro", type: "vocab", front: "janeiro", reading: "janeiro", meaning: "January", example: { jp: "Em janeiro faz muito frio.", en: "In January it's very cold." }, drill: { jp: "Em janeiro faz muito frio", en: "In January it's very cold" }, accept: ["jan", "in january"], hint: "zha-NAY-ru — the j is the \"zh\" of \"measure\", never the English j. Months are lowercase in Portuguese, and they take em: em janeiro, not \"no janeiro\"." },
        { id: "pt-u9l3-fevereiro", type: "vocab", front: "fevereiro", reading: "fevereiro", meaning: "February", example: { jp: "Fevereiro tem vinte e oito dias.", en: "February has twenty-eight days." }, drill: { jp: "Fevereiro tem vinte e oito dias", en: "February has twenty-eight days" }, accept: ["feb", "in february"], hint: "fe-ve-RAY-ru. Portuguese keeps both r's, unlike the English word most people mispronounce. Carnaval falls here, and in Portugal it is a serious excuse for a long weekend." },
        { id: "pt-u9l3-marco", type: "vocab", front: "março", reading: "marco", meaning: "March", example: { jp: "Em março é primavera.", en: "In March it's spring." }, drill: { jp: "Em março é primavera", en: "In March it's spring" }, accept: ["mar", "in march"], hint: "MAR-su, cedilla — the same soft s the maçã of Unit 1 has. Note the spelling trap: um marco without the cedilla is a milestone or a landmark, a completely different word." },
        { id: "pt-u9l3-abril", type: "vocab", front: "abril", reading: "abril", meaning: "April", example: { jp: "O vinte e cinco de abril é um dia importante em Portugal.", en: "The twenty-fifth of April is an important day in Portugal." }, drill: { jp: "O vinte e cinco de abril", en: "The twenty-fifth of April" }, accept: ["apr", "in april"], hint: "a-BREEL. The date in the example is the Carnation Revolution of 1974 — say \"o 25 de Abril\" to anyone in Portugal and they know exactly what you mean. Dates are built number-de-month: dois de maio." },
        { id: "pt-u9l3-maio", type: "vocab", front: "maio", reading: "maio", meaning: "May", example: { jp: "Em maio faz sol em Lisboa.", en: "In May it's sunny in Lisbon." }, drill: { jp: "Em maio faz sol em Lisboa", en: "In May it's sunny in Lisbon" }, accept: ["in may"], hint: "MY-u, two syllables. The shortest month name, and the only one an English speaker will read correctly by accident. Do not confuse it with mais, \"more\", from Unit 1." },
        { id: "pt-u9l3-junho", type: "vocab", front: "junho", reading: "junho", meaning: "June", example: { jp: "Junho é o mês de Santo António em Lisboa.", en: "June is the month of Saint Anthony in Lisbon." }, drill: { jp: "Junho é o mês de Santo António", en: "June is the month of Saint Anthony" }, accept: ["jun", "in june"], hint: "ZHOO-nyu — zh again, then the nh of manhã. The whole month is os Santos Populares: sardines, paper decorations, and Lisbon awake all night on the twelfth." },
      ],
    },
    ...
    // up for months, so they sit either side of the lesson boundary on purpose.
    {
      ...
      items: [
        { id: "pt-u9l4-julho", type: "vocab", front: "julho", reading: "julho", meaning: "July", example: { jp: "Em julho faz muito calor.", en: "In July it's very hot." }, drill: { jp: "Em julho faz muito calor", en: "In July it's very hot" }, accept: ["jul", "in july"], hint: "ZHOO-lyu — lh, where junho has nh. Those two letters are the ONLY difference between June and July in Portuguese, so say them apart deliberately: ZHOO-nyu, ZHOO-lyu." },
        { id: "pt-u9l4-agosto", type: "vocab", front: "agosto", reading: "agosto", meaning: "August", example: { jp: "Agosto é um mês de calor.", en: "August is a month of heat." }, drill: { jp: "Agosto é um mês de calor", en: "August is a month of heat" }, accept: ["aug", "in august"], hint: "a-GOSH-tu. The month Portugal closes: much of Lisbon empties, small shops hang up encerrado para férias, and the whole country appears to be at the beach at once." },
        { id: "pt-u9l4-setembro", type: "vocab", front: "setembro", reading: "setembro", meaning: "September", example: { jp: "Em setembro é outono.", en: "In September it's autumn." }, drill: { jp: "Em setembro é outono", en: "In September it's autumn" }, accept: ["sep", "sept", "in september"], hint: "se-TEM-bru. From sete — it was the seventh month before the Romans moved the new year, which is also why outubro, novembro and dezembro are all two out of step." },
        { id: "pt-u9l4-outubro", type: "vocab", front: "outubro", reading: "outubro", meaning: "October", example: { jp: "Outubro não é um mês quente.", en: "October isn't a hot month." }, drill: { jp: "Outubro não é um mês quente", en: "October isn't a hot month" }, accept: ["oct", "in october"], hint: "oh-TOO-bru — the same ou-as-plain-o as outono. From oito, the eighth. This is when the rain comes back to the north." },
        { id: "pt-u9l4-novembro", type: "vocab", front: "novembro", reading: "novembro", meaning: "November", example: { jp: "Novembro é um mês de chuva.", en: "November is a month of rain." }, drill: { jp: "Novembro é um mês de chuva", en: "November is a month of rain" }, accept: ["nov", "in november"], hint: "nu-VEM-bru, from nove. Nothing to do with novo, \"new\" — the resemblance is a coincidence of the same Latin root for \"nine\" and \"new\"." },
        { id: "pt-u9l4-dezembro", type: "vocab", front: "dezembro", reading: "dezembro", meaning: "December", example: { jp: "Vinte e cinco de dezembro é Natal.", en: "The twenty-fifth of December is Christmas." }, drill: { jp: "Vinte e cinco de dezembro é Natal", en: "The twenty-fifth of December is Christmas" }, accept: ["dec", "in december"], hint: "de-ZEM-bru, from dez. The full date pattern, one last time: number + de + month, no article on the month — vinte e cinco de dezembro. Boas Festas is what you wish people." },
      ],
    },
  ],
};
