    ...
    // marks a claim as a position rather than a fact.
    {
      ...
      items: [
        ...
        },
        {
          ...
          reading: "afirmar",
          meaning: "to state",
          example: { jp: "O cientista vai afirmar que o clima mudou, e a imprensa vai contar a notícia hoje.", en: "The scientist is going to state that the climate has changed, and the press will report the news today." },
        ...
        },
        {
          ...
          reading: "considerar",
          meaning: "to consider",
          example: { jp: "Vamos considerar o problema com tempo, porque o resultado vai mudar o bairro.", en: "Let's consider the problem properly, because the result will change the neighbourhood." },
    ...
    // the vocabulary of a news panel or a meeting minute.
    {
      ...
      items: [
        ...
        },
        {
          ...
          drill: { jp: "Vamos argumentar com o relatório", en: "Let's argue with the report" },
        ...
        },
        {
          ...
          reading: "arazao",
          meaning: "reason",
          example: { jp: "Ninguém explicou a razão do acordo, e por isso os cidadãos ainda não apoiam o acordo do governo.", en: "Nobody explained the reason for the agreement, and so the citizens still don't support the government's agreement." },
        ...
        },
        {
          ...
          example: { jp: "É importante salientar a diferença dos dois casos, porque a lei não é igual para todos.", en: "It's important to point out the difference between the two cases, because the law isn't the same for everyone." },
          drill: { jp: "Vou salientar a diferença dos casos", en: "I'm going to point out the difference of the cases" },
