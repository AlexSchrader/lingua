...
export const PT_UNIT42 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "pt-u42l3-osaco", type: "vocab", front: "o saco", reading: "osaco", meaning: "bag", example: { jp: "O saco de plástico da loja não é enorme e o pão não fica bem ali.", en: "The shop's plastic bag isn't big and the bread doesn't sit well in it." }, drill: { jp: "O saco da loja é enorme", en: "The shop's bag is enormous" }, accept: ["the bag", "sack", "carrier bag"], hint: "SA-ku. A bag or a sack: um saco de plástico is a carrier bag, um saco-cama a sleeping bag. A handbag is something else again — uma mala de mão, built on a mala from Unit 20." },
