  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u4l4-ogato", type: "vocab", front: "o gato", reading: "ogato", meaning: "cat", example: { jp: "A minha irmã tem um gato e um cão.", en: "My sister has a cat and a dog." }, drill: { jp: "O gato e o cão de Ana", en: "Ana's cat and dog" }, accept: ["the cat", "tomcat"], hint: "GA-tu, hard g. Feminine a gata. Portuguese has no separate everyday word for a kitten — it is um gato pequeno." },
