// PT Unit 72 — Tratar por tu ou por si (slot: register-1) — B1
// ─────────────────────────────────────────────────────────────────────────────
...
// English or Spanish equivalent, so it is carried through this unit's examples
// and named in the hints rather than being given an invented front of its own
// (a proper name is not a vocabulary card).
//
  ...
  lessons: [
    {
      ...
      items: [
        { id: "pt-u72l1-tratarportu", type: "vocab", front: "tratar por tu", reading: "tratarportu", meaning: "to address as tu", example: { jp: "Podemos tratar por tu, porque trabalhamos juntos há dois anos e já somos amigos.", en: "We can use tu with each other, because we have worked together for two years and are friends by now." }, drill: { jp: "Podemos tratar por tu", en: "We can address each other as tu" }, accept: ["address as tu", "use tu", "be on first-name terms", "speak informally"], hint: "The moment itself has a phrase: podemos tratar-nos por tu? — shall we switch to tu? In Portugal the older or senior person offers it, and until they do you stay formal." },
        { id: "pt-u72l1-tratarporvoce", type: "vocab", front: "tratar por você", reading: "tratarporvoce", meaning: "to address as você", example: { jp: "Em Portugal, tratar por você pode ser frio com um desconhecido, por isso é melhor dizer o senhor ou o nome da pessoa.", en: "In Portugal, using você can sound cold with a stranger, so it is better to say o senhor or the person's name." }, drill: { jp: "Tratar por você pode ser frio", en: "Using você can sound cold" }, accept: ["address as você", "use você", "speak formally"], hint: "THE trap for anyone who learned Brazilian Portuguese, where você is simply \"you\". In Portugal it sits awkwardly between tu and o senhor: fine with a colleague you do not know well, cold with a stranger, rude to somebody older." },
    ...
    },
    {
      ...
      items: [
        { id: "pt-u72l2-sefazfavor", type: "vocab", front: "se faz favor", reading: "sefazfavor", meaning: "please", example: { jp: "Um café e um copo de água, se faz favor.", en: "A coffee and a glass of water, please." }, drill: { jp: "Um café e água se faz favor", en: "A coffee and water please" }, accept: ["please", "if you please"], hint: "The Portuguese \"please\" you will hear in every café — more common in Portugal than por favor (u2), which is the one textbooks teach. Goes at the END of the request, after a small pause." },
