...
export const PT_UNIT72 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "pt-u72l2-sefazfavor", type: "vocab", front: "se faz favor", reading: "sefazfavor", meaning: "please (in a shop or cafe)", example: { jp: "Um café e um copo de água, se faz favor.", en: "A coffee and a glass of water, please." }, drill: { jp: "Mais um café se faz favor", en: "One more coffee please" }, accept: ["please", "if you please"], hint: "The Portuguese \"please\" you will hear in every café — more common in Portugal than por favor (u2), which is the one textbooks teach. Goes at the END of the request, after a small pause." },
