  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u72l1-tratarporvoce", type: "vocab", front: "tratar por você", reading: "tratarporvoce", meaning: "to address as você", example: { jp: "Em Portugal, tratar por você pode ser frio com um desconhecido, por isso dizemos antes O João quer um café e usamos o nome da pessoa.", en: "In Portugal, using você can sound cold with a stranger, so instead we say Does Joao want a coffee, using the person own name in the third person." }, drill: { jp: "Tratar por você pode ser frio", en: "Using você can sound cold" }, accept: ["address as você", "use você", "speak formally"], hint: "THE trap for anyone who learned Brazilian Portuguese, where você is simply \"you\". In Portugal it sits awkwardly between tu and o senhor: fine with a colleague you do not know well, cold with a stranger, rude to somebody older." },
