  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u74l1-mandar", type: "vocab", front: "mandar", reading: "mandar", meaning: "to send (a message)", example: { jp: "Mando-te a morada assim que chegar a casa, porque não a sei de cor.", en: "I will send you the address as soon as I get home, because I do not know it by heart." }, drill: { jp: "Vou mandar a morada esta noite", en: "I am going to send the address tonight" }, accept: ["send", "to order", "to have something done"], hint: "Two jobs: to send (mandar uma mensagem) and to order somebody about (quem manda aqui?). Mandar fazer is to have something done — mandei arranjar o carro." },
        { id: "pt-u74l1-abordar", type: "vocab", front: "abordar", reading: "abordar", meaning: "to bring up", example: { jp: "Ninguém quis abordar o assunto do dinheiro, embora fosse o motivo da reunião toda.", en: "Nobody wanted to bring up the subject of money, although it was the reason for the whole meeting." }, drill: { jp: "Ninguém quis abordar o assunto", en: "Nobody wanted to bring up the subject" }, accept: ["bring up", "to raise", "to address", "to approach"], hint: "a-bor-DAR. To raise a subject, and also to approach a person in the street — abordou-me à saída. From bordo, a ship's side: to come alongside." },
        { id: "pt-u74l1-destacar", type: "vocab", front: "destacar", reading: "destacar", meaning: "to highlight", example: { jp: "O jornal quis destacar a parte boa da notícia, no entanto os números diziam outra coisa.", en: "The newspaper wanted to highlight the good part of the news; the figures, however, said something else." }, drill: { jp: "O jornal quis destacar a parte boa", en: "The newspaper wanted to highlight the good part" }, accept: ["highlight", "to stress", "to single out", "to emphasise"], hint: "desh-ta-KAR. To make something stand out from the rest. Destacar-se is to stand out yourself — destacou-se na escola." },
      ],
    },
    {
      id: "pt-u74l2",
      ...
      items: [
        ...
        { id: "pt-u74l2-aplicar", type: "vocab", front: "aplicar", reading: "aplicar", meaning: "to apply", example: { jp: "A câmara vai aplicar a regra nova a partir de janeiro, por isso convém ler o papel todo.", en: "The council is going to apply the new rule from January, so it is worth reading the whole document." }, drill: { jp: "A câmara vai aplicar a regra nova", en: "The council is going to apply the new rule" }, accept: ["apply", "to enforce", "to put into practice"], hint: "a-plee-KAR. To apply a rule, a cream or money — aplicar dinheiro is to invest it. NOT for applying for a job, which is candidatar-se a." },
        { id: "pt-u74l2-adaptar", type: "vocab", front: "adaptar", reading: "adaptar", meaning: "to adapt", example: { jp: "Tivemos de adaptar o horário ao comboio, porque só há dois por dia nesta linha.", en: "We had to adapt the schedule to the train, because there are only two a day on this line." }, drill: { jp: "Tivemos de adaptar o horário ao comboio", en: "We had to adapt the schedule to the train" }, accept: ["adapt", "to adjust", "to fit"], hint: "a-dap-TAR. Adaptar alguma coisa A outra. Adaptar-se is what a person does — adaptou-se bem à cidade nova — and it is the commoner half of this verb." },
        { id: "pt-u74l2-atribuir", type: "vocab", front: "atribuir", reading: "atribuir", meaning: "to attribute", example: { jp: "O médico atribuiu tudo ao stress, embora o doente falasse de uma dor antiga nas costas.", en: "The doctor attributed everything to stress, although the patient was talking about an old pain in his back." }, drill: { jp: "O médico vai atribuir tudo ao stress", en: "The doctor is going to attribute everything to stress" }, accept: ["attribute", "to put down to", "to award", "to assign"], hint: "a-tree-BWEER. Atribuir alguma coisa A alguma coisa — to put it down to something. Also to award: atribuir um prémio." },
        { id: "pt-u74l2-encerrar", type: "vocab", front: "encerrar", reading: "encerrar", meaning: "to close", example: { jp: "A empresa vai encerrar a loja do centro, por isso os funcionários mudam para outra cidade.", en: "The company is going to close the shop in the centre, so the staff are moving to another city." }, drill: { jp: "A empresa vai encerrar a loja do centro", en: "The company is going to close the shop in the centre" }, accept: ["close", "to shut down", "to close down", "to end"], hint: "en-suh-RRAR. The formal fechar — a business, a meeting or an account. Encerrado on a door means closed for good, or at least for today; fechado just means shut." },
      ],
    },
    {
      id: "pt-u74l3",
      ...
      items: [
        ...
        { id: "pt-u74l3-prolongar", type: "vocab", front: "prolongar", reading: "prolongar", meaning: "to extend", example: { jp: "A chuva vai prolongar as obras até março, embora o prazo do contrato acabe em janeiro.", en: "The rain is going to extend the work until March, although the contract deadline ends in January." }, drill: { jp: "A chuva vai prolongar as obras", en: "The rain is going to extend the work" }, accept: ["extend", "to prolong", "to drag out", "to lengthen"], hint: "pru-lon-GAR. Of time, not of objects — prolongar o prazo, prolongar a viagem. Prolongar-se is for something that drags on: a reunião prolongou-se até às nove." },
        { id: "pt-u74l3-acumular", type: "vocab", front: "acumular", reading: "acumular", meaning: "to build up", example: { jp: "O trabalho acumulou durante a doença, por isso agora fica no escritório até tarde.", en: "The work built up during the illness, so now he stays at the office until late." }, drill: { jp: "O trabalho vai acumular esta semana", en: "The work is going to build up this week" }, accept: ["build up", "to accumulate", "to pile up", "to gather"], hint: "a-ku-mu-LAR. Of work, of dust, of money. Acumular-se is what the washing-up does; acumular funções is what a person does when they hold two jobs at once." },
      ],
    },
    {
      id: "pt-u74l4",
      ...
      items: [
        { id: "pt-u74l4-levar", type: "vocab", front: "levar", reading: "levar", meaning: "to take (to carry there)", example: { jp: "Levo o carro à oficina amanhã, porque a viagem ao Porto leva quase três horas.", en: "I am taking the car to the garage tomorrow, because the journey to Porto takes almost three hours." }, drill: { jp: "Vou levar o carro amanhã", en: "I am going to take the car tomorrow" }, accept: ["take", "to carry", "to take away", "to last"], hint: "Take AWAY from here — trazer is to bring TOWARDS. Second job: how long something takes, leva três horas. Third: para levar is takeaway food." },
        { id: "pt-u74l4-deixar", type: "vocab", front: "deixar", reading: "deixar", meaning: "to leave (behind)", example: { jp: "Deixei o telemóvel em casa, por isso ninguém me conseguiu apanhar a manhã toda.", en: "I left my phone at home, so nobody could reach me all morning." }, drill: { jp: "Não quero deixar o telemóvel em casa", en: "I do not want to leave the phone at home" }, accept: ["leave", "to let", "to quit", "to allow"], hint: "Three jobs worth learning together: leave something behind (deixei as chaves), let somebody do something (deixa-me ver), and quit a habit (deixar de fumar, u67)." },
        ...
        { id: "pt-u74l4-perder", type: "vocab", front: "perder", reading: "perder", meaning: "to lose", example: { jp: "Perdi a chave de casa e tive de esperar pelo meu irmão quase uma hora.", en: "I missed the seven o'clock train, so I got to work almost an hour late." }, drill: { jp: "Não quero perder o comboio das sete", en: "I do not want to miss the seven o'clock train" }, accept: ["lose", "to miss", "to waste"], hint: "Lose AND miss — perder o comboio, perder a chave, perder tempo. u31 gave you perder-se, to get lost; this is the plain verb the course never taught." },
