  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u74l1-propor", type: "vocab", front: "propor", reading: "propor", meaning: "to propose", example: { jp: "O sindicato vai propor um horário diferente, embora a empresa já tenha recusado a ideia uma vez.", en: "The union is going to propose a different schedule, although the company has already refused the idea once." }, drill: { jp: "O sindicato vai propor um horário diferente", en: "The union is going to propose a different schedule" }, accept: ["propose", "to suggest", "to put forward"], hint: "Conjugates like pôr, which is inside it — proponho, propõe. Propor-se a is to volunteer for something: propôs-se a ajudar." },
        { id: "pt-u74l1-garantir", type: "vocab", front: "garantir", reading: "garantir", meaning: "to guarantee", example: { jp: "Garanto que o trabalho fica pronto até sexta, a não ser que o material chegue tarde.", en: "I guarantee the work will be ready by Friday, unless the material arrives late." }, drill: { jp: "Ninguém pode garantir o preço", en: "Nobody can guarantee the price" }, accept: ["guarantee", "to assure", "to promise"], hint: "Garantir QUE plus the indicative when you are sure — the certainty is why this one does NOT take the subjunctive, unlike duvido que (u69)." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u74l2-permitir", type: "vocab", front: "permitir", reading: "permitir", meaning: "to allow", example: { jp: "O contrato não permite obras sem falar com o senhorio, por isso escrevemos um email primeiro.", en: "The contract does not allow work without speaking to the landlord, so we wrote an email first." }, drill: { jp: "O contrato não vai permitir isso", en: "The contract is not going to allow that" }, accept: ["allow", "to permit", "to let"], hint: "Permitir QUE takes the subjunctive — não permite que façam obras. With an infinitive it needs no que: não permite fazer obras." },
        ...
        { id: "pt-u74l2-impedir", type: "vocab", front: "impedir", reading: "impedir", meaning: "to prevent", example: { jp: "A chuva impediu o jogo no domingo, no entanto ninguém quis mudar a data.", en: "The rain prevented the match on Sunday; however, nobody wanted to change the date." }, drill: { jp: "A chuva pode impedir o jogo", en: "The rain may prevent the match" }, accept: ["prevent", "to stop", "to block"], hint: "Impedir QUE plus subjunctive, or impedir alguém DE fazer. Conjugates like pedir — impeço, impede." },
        { id: "pt-u74l2-evitar", type: "vocab", front: "evitar", reading: "evitar", meaning: "to avoid", example: { jp: "Para evitar o trânsito, saímos cedinho e comemos qualquer coisa no caminho.", en: "To avoid the traffic, we left nice and early and ate something on the way." }, drill: { jp: "Para evitar o trânsito saímos cedinho", en: "To avoid the traffic we left early" }, accept: ["avoid", "to prevent", "to dodge"], hint: "Evitar + infinitive with no preposition: evitar falar, evitar comer tarde. Evita-se, impersonal, is what a health notice says." },
        { id: "pt-u74l2-planear", type: "vocab", front: "planear", reading: "planear", meaning: "to plan", example: { jp: "Estamos a planear as férias com calma, porque o ano passado decidimos tudo à última hora.", en: "We are planning the holidays calmly, because last year we decided everything at the last minute." }, drill: { jp: "Estamos a planear as férias", en: "We are planning the holidays" }, accept: ["plan", "to plan out", "to arrange"], hint: "Portugal writes planear; Brazil planejar. The example uses estar a + infinitive from u69 — this is what that construction is for." },
      ],
    },
    {
      id: "pt-u74l3",
      ...
      items: [
        { id: "pt-u74l3-aumentar", type: "vocab", front: "aumentar", reading: "aumentar", meaning: "to increase", example: { jp: "O preço da energia aumentou outra vez, por isso muitas famílias mudaram os hábitos de casa.", en: "The price of energy has increased again, so many families changed their habits at home." }, drill: { jp: "O preço da energia vai aumentar", en: "The price of energy is going to increase" }, accept: ["increase", "to rise", "to go up", "raise"], hint: "The pair of reduzir (u65), and it works both ways: os preços aumentaram (they went up) and a empresa aumentou os preços (it raised them). Same verb, no change." },
        ...
        { id: "pt-u74l3-arriscar", type: "vocab", front: "arriscar", reading: "arriscar", meaning: "to risk", example: { jp: "Não vale a pena arriscar o dinheiro todo num negócio que ninguém conhece.", en: "It is not worth risking all the money on a business nobody knows." }, drill: { jp: "Não quero arriscar o dinheiro todo", en: "I do not want to risk all the money" }, accept: ["risk", "to take a chance", "to gamble"], hint: "From o risco (u47). Arriscar-se A is to run the risk of: arriscas-te a perder tudo." },
      ],
    },
    {
      id: "pt-u74l4",
