  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u74l4-perder", type: "vocab", front: "perder", reading: "perder", meaning: "to lose", example: { jp: "Perdi a chave de casa e tive de esperar pelo meu irmão quase uma hora.", en: "I lost my house key and had to wait for my brother for almost an hour." }, drill: { jp: "Não quero perder o comboio das sete", en: "I do not want to miss the seven o'clock train" }, accept: ["lose", "to miss", "to waste"], hint: "Lose AND miss — perder o comboio, perder a chave, perder tempo. u31 gave you perder-se, to get lost; this is the plain verb the course never taught." },
