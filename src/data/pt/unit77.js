  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u77l1-reagir", type: "vocab", front: "reagir", reading: "reagir", meaning: "to react", example: { jp: "A cidade reagiu bem à notícia e ninguém ficou em casa.", en: "The city reacted well to the news and nobody stayed at home." }, drill: { jp: "A cidade vai reagir bem", en: "The city is going to react well" }, accept: ["react", "to react", "to respond", "to answer back"], hint: "rre-a-ZHEER, with a for what you react to: reagir A uma notícia. A reação is the reaction, and reagir mal is to take something badly." },
      ],
    },
    {
      id: "pt-u77l2",
    ...
    },
    {
      ...
      items: [
        { id: "pt-u77l4-comunicar", type: "vocab", front: "comunicar", reading: "comunicar", meaning: "to communicate (to announce officially)", example: { jp: "A empresa comunicou a regra nova aos funcionários na reunião da manhã.", en: "The company announced the new rule to the staff at the morning meeting." }, drill: { jp: "A empresa vai comunicar a regra", en: "The company is going to announce the rule" }, accept: ["communicate", "to communicate", "to report", "to inform", "announce"], hint: "ku-mu-ni-KAR. In Portuguese this is mostly OFFICIAL telling — a company, a school or a police station comunica something to you. For chatting you want falar." },
