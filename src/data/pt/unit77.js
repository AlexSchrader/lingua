  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u77l3-aobservacao", type: "vocab", front: "a observação", reading: "aobservacao", meaning: "remark", example: { jp: "A observação do chefe na reunião não foi clara para ninguém.", en: "The boss's remark at the meeting wasn't clear to anybody." }, drill: { jp: "A observação do chefe não foi clara", en: "The boss's remark wasn't clear" }, accept: ["the remark", "remark", "observation", "the observation", "comment"], hint: "ob-ser-va-SOWN, from observar. Two senses, as in English: a remark you make, and the act of watching. Fazer uma observação is to make a point." },
      ],
    },
    {
      id: "pt-u77l4",
