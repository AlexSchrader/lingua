  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u50l1-ociclismo", type: "vocab", front: "o ciclismo", reading: "ociclismo", meaning: "cycling", example: { jp: "O ciclismo é duro e a Volta a Portugal é famosa em agosto.", en: "Cycling is hard and the Tour of Portugal is famous in August." }, drill: { jp: "O ciclismo é duro e rápido", en: "Cycling is hard and fast" }, accept: ["the cycling", "bike racing"], hint: "si-KLEESH-mu. A Volta a Portugal has been run since 1927, with breaks for war and politics, and is held in August. The cyclist is um ciclista — one of those -ista nouns that takes o or a without changing its ending." },
        ...
        { id: "pt-u50l1-ogolfe", type: "vocab", front: "o golfe", reading: "ogolfe", meaning: "golf", example: { jp: "O golfe do Algarve é famoso em toda a Europa.", en: "The Algarve's golf is famous across Europe." }, drill: { jp: "O golfe do Algarve é famoso", en: "The Algarve's golf is famous" }, accept: ["golf", "the golf"], hint: "GOL-fe — with an e on the end, because Portuguese will not let a word finish on that consonant cluster. The Algarve is Europe's best-known golf destination, which is much of why it looks the way it does." },
      ],
    },
    {
      id: "pt-u50l2",
    ...
    },
    {
      ...
      items: [
        { id: "pt-u50l3-ocampeonato", type: "vocab", front: "o campeonato", reading: "ocampeonato", meaning: "championship", example: { jp: "O campeonato de futebol é importante e a equipa do Porto é forte.", en: "The football championship is important and the Porto team is strong." }, drill: { jp: "O campeonato de futebol é importante", en: "The football championship is important" }, accept: ["the championship", "league", "tournament"], hint: "kam-pi-u-NA-tu. Portugal's football league is o Campeonato Nacional and everybody calls it a Liga. Built on o campo from Unit 20 — the field it is played on." },
        ...
        { id: "pt-u50l3-ogolo", type: "vocab", front: "o golo", reading: "ogolo", meaning: "goal", example: { jp: "O golo da equipa foi importante e o povo do Porto celebrou na rua.", en: "The team's goal was important and Porto's people celebrated in the street." }, drill: { jp: "O golo da equipa foi importante", en: "The team's goal was important" }, accept: ["the goal", "score"], hint: "PORTUGAL SAYS GOLO — GO-lu. Brazil says o gol, and you can hear which country a commentary comes from in one syllable. Marcar um golo is to score, and GOLO! is what the radio holds for ten seconds." },
      ],
    },
    {
      id: "pt-u50l4",
