  ...
  lessons: [
    {
      ...
      items: [
        { id: "pt-u39l1-oamigo", type: "vocab", front: "o amigo", reading: "oamigo", meaning: "friend", example: { jp: "O amigo de Ana mora em Braga, mas está em Lisboa quase todos os meses.", en: "Ana's friend lives in Braga, but he is in Lisbon almost every month." }, drill: { jp: "O amigo de Ana mora em Braga", en: "Ana's friend lives in Braga" }, accept: ["the friend", "mate", "pal"], hint: "a-MEE-gu; feminine a amiga. Portugal keeps um amigo and um conhecido further apart than English does — a conhecido is someone you know, and calling them amigo would overstate it. O meu amigo, with the article, as A1 u4 taught." },
