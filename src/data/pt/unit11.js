  ...
  lessons: [
    ...
    // the top and the hand is used in examples rather than re-taught.
    {
      ...
      items: [
        ...
        { id: "pt-u11l1-acabeca", type: "vocab", front: "a cabeça", reading: "acabeca", meaning: "head", example: { jp: "A cabeça é pequena, o corpo é grande.", en: "The head is small, the body is big." }, accept: ["the head", "mind"], hint: "ka-BE-sa — cedilla, so a soft s, like a maçã in Unit 1. It carries the same figurative load as English: perder a cabeça is to lose your head, and o cabeça de família is the head of the household." },
        { id: "pt-u11l1-ocabelo", type: "vocab", front: "o cabelo", reading: "ocabelo", meaning: "hair", example: { jp: "O cabelo de Ana é castanho.", en: "Ana's hair is brown." }, accept: ["the hair"], hint: "ka-BE-lu. Singular for a whole head of hair — o cabelo, never \"os cabelos\", which would be individual strands. One letter from a cabeça, so keep them apart: cabeÇa is the head, cabeLo grows on it." },
        { id: "pt-u11l1-oolho", type: "vocab", front: "o olho", reading: "oolho", meaning: "eye", example: { jp: "O bebé tem um olho azul.", en: "The baby has one blue eye." }, accept: ["the eye"], hint: "O-lyu, with the lh. Plural os olhos, and that is how you will usually meet it. The two o's on the card are just the article meeting the word: o + olho." },
        { id: "pt-u11l1-aboca", type: "vocab", front: "a boca", reading: "aboca", meaning: "mouth", example: { jp: "A boca de um bebé é muito pequena.", en: "A baby's mouth is very small." }, accept: ["the mouth"], hint: "BO-ka, open o. Boca do metro is a metro entrance, and a Boca do Inferno is the sea cave at Cascais — Portuguese hands the word to any opening." },
        { id: "pt-u11l1-onariz", type: "vocab", front: "o nariz", reading: "onariz", meaning: "nose", example: { jp: "O nariz de Pedro é grande.", en: "Pedro's nose is big." }, accept: ["the nose"], hint: "na-REESH — stress at the end, and the final z shushes exactly like a final s. Plural narizes. Remember the nasal vowels of Unit 1 all come out through this." },
      ],
    },
    ...
    // word the unit1 header uses as its worked example of the accent fold.
    {
      ...
      items: [
        { id: "pt-u11l2-obraco", type: "vocab", front: "o braço", reading: "obraco", meaning: "arm", example: { jp: "O braço é comprido.", en: "The arm is long." }, accept: ["the arm"], hint: "BRA-su, cedilla. Plural os braços. Portugal uses it for the arm of a chair and for a branch of a river too — o braço do Tejo." },
        { id: "pt-u11l2-aperna", type: "vocab", front: "a perna", reading: "aperna", meaning: "leg", example: { jp: "O gato tem quatro pernas.", en: "The cat has four legs." }, accept: ["the leg"], hint: "PER-na. Do not let it collide with o pai or with pão — this one has the r. Esticar as pernas is to stretch your legs, and it is what everyone says after a long comboio ride." },
        { id: "pt-u11l2-ope", type: "vocab", front: "o pé", reading: "ope", meaning: "foot", example: { jp: "Ir a pé é fantástico.", en: "Going on foot is fantastic." }, accept: ["the foot"], hint: "PEH, open e — you met the phrase a pé in Unit 7's ir card, the one way of travelling that does not take de. Plural os pés. Ao pé de something means next to it, which is a very Portuguese way to give directions." },
        { id: "pt-u11l2-odedo", type: "vocab", front: "o dedo", reading: "odedo", meaning: "finger", example: { jp: "A mão tem cinco dedos.", en: "The hand has five fingers." }, accept: ["the finger", "toe", "digit"], hint: "DE-du. One word for finger AND toe — a toe is o dedo do pé if you need to be precise. Built on the same Latin root as the Spanish dedo, and here they genuinely agree." },
    ...
    // or with the impersonal doer (dói-me a cabeça) — never with ser.
    {
      ...
      items: [
        { id: "pt-u11l3-doente", type: "vocab", front: "doente", reading: "doente", meaning: "ill", example: { jp: "Hoje não estou bem: estou doente.", en: "Today I'm not well: I'm ill." }, accept: ["sick", "unwell", "patient", "the patient"], hint: "du-EN-te, same for both genders. Always with estar, never with ser — estou doente is a state you are in today. As a noun, um doente is a patient." },
        { id: "pt-u11l3-ador", type: "vocab", front: "a dor", reading: "ador", meaning: "pain", example: { jp: "A dor de cabeça não é uma coisa boa.", en: "A headache isn't a good thing." }, accept: ["ache", "the pain", "hurt", "sore"], hint: "DOR, and it is FEMININE — a dor — where o calor from Unit 8 is masculine on the same -or ending. Portuguese builds every ache this way: dor de cabeça, dor de barriga, dor de dentes." },
        { id: "pt-u11l3-doime", type: "vocab", front: "dói-me", reading: "doime", meaning: "it hurts me", example: { jp: "Dói-me a cabeça.", en: "My head hurts." }, accept: ["my ... hurts", "it hurts", "i have a pain in"], hint: "Learn it whole, like chamo-me in Unit 3. The verb is doer, and it works backwards from English: the head does the hurting and the me receives it — dói-me a cabeça, literally \"the head hurts me\". Plural things take doem-me: doem-me os pés." },
        { id: "pt-u11l3-afebre", type: "vocab", front: "a febre", reading: "afebre", meaning: "fever", example: { jp: "O bebé tem febre.", en: "The baby has a fever." }, accept: ["temperature", "the fever", "high temperature"], hint: "FE-bre, open e. You HAVE it, with ter: tem febre, not \"é febre\". Portuguese drops the article here — tenho febre — which it does with most symptoms." },
        { id: "pt-u11l3-agripe", type: "vocab", front: "a gripe", reading: "agripe", meaning: "flu", example: { jp: "A gripe é um problema de inverno.", en: "Flu is a winter problem." }, accept: ["influenza", "the flu"], hint: "GREE-pe, hard g. Not a complaint — English \"gripe\" is a different word entirely. Portugal separates it firmly from uma constipação, a common cold, and Lesson 4 has the adjective for that." },
        { id: "pt-u11l3-cansado", type: "vocab", front: "cansado", reading: "cansado", meaning: "tired", example: { jp: "Um médico cansado não é bom.", en: "A tired doctor isn't good." }, accept: ["exhausted", "weary", "worn out"], hint: "kan-SA-du; feminine cansada. With estar, like doente — estou cansado. The verb underneath is cansar, to tire, and its opposite descansar is the first card of the next lesson." },
      ],
    },
    ...
    // most likely to be needed and most likely to come out wrong.
    {
      ...
      items: [
        { id: "pt-u11l4-constipado", type: "vocab", front: "constipado", reading: "constipado", meaning: "having a cold", example: { jp: "Em janeiro, Tiago está sempre constipado.", en: "In January, Tiago always has a cold." }, accept: ["with a cold", "bunged up", "stuffed up", "cold"], hint: "FALSE FRIEND, and this one is English, not Spanish. Estou constipado means I HAVE A COLD. It does not mean constipated — that word is obstipado, and you will not need it. Feminine constipada; the noun is uma constipação." },
        ...
        { id: "pt-u11l4-melhor", type: "vocab", front: "melhor", reading: "melhor", meaning: "better", example: { jp: "Hoje estou melhor.", en: "Today I'm better." }, accept: ["best", "the best", "improved"], hint: "me-LYOR, with the lh. Irregular — it replaces \"mais bom\", which does not exist, exactly as English replaces \"more good\". Same word for better and best, and its opposite is pior. As melhoras! is what you wish someone who is ill." },
      ],
    },
  ],
};
