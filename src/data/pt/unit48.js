...
export const PT_UNIT48 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Talk about the past in Portuguese — what happened, and which era it belonged to.",
      items: [
        ...
        { id: "pt-u48l3-descobrir", type: "vocab", front: "descobrir", reading: "descobrir", meaning: "to discover", example: { jp: "Portugal foi descobrir o Brasil no tempo do rei D. Manuel.", en: "Portugal set out to discover Brazil in the time of King Manuel." }, drill: { jp: "Descobrir o Brasil foi importante", en: "Discovering Brazil was important" }, accept: ["discover", "to find out", "to uncover", "find out"], hint: "desh-ku-BREER: descubro, descobres, descobre — the o turns to u in the \"I\" form. Literally des- plus cobrir, to UNcover. Portugal calls its own age of exploration os Descobrimentos." },
      ],
    },
    {
      id: "pt-u48l4",
