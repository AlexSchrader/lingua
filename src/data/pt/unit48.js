...
export const PT_UNIT48 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "pt-u48l2-aguerra", type: "vocab", front: "a guerra", reading: "aguerra", meaning: "war", example: { jp: "A guerra foi dura e a paz chegou em abril.", en: "The war was hard and peace arrived in April." }, drill: { jp: "A guerra de Portugal foi dura", en: "Portugal's war was hard" }, accept: ["the war", "warfare", "conflict"], hint: "GE-rra, strong rr — and the u is silent, because gue is always \"ge\". A Guerra Colonial of 1961 to 1974 is the one that finally brought down the dictatorship." },
    ...
    },
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Talk about the past in Portuguese — its eras, its dates, and how a people remembers it.",
      items: [
        ...
        { id: "pt-u48l3-amemoria", type: "vocab", front: "a memória", reading: "amemoria", meaning: "memory", example: { jp: "A memória de Portugal é antiga e a história é enorme.", en: "Portugal's memory is ancient and the history is enormous." }, drill: { jp: "A memória de Portugal é antiga", en: "Portugal's memory is ancient" }, accept: ["the memory", "remembrance", "recollection"], hint: "me-MO-ria. The faculty and a single recollection both. De memória is by heart. It is computer memory too, borrowed unchanged — and um memorial is a monument to something remembered." },
        { id: "pt-u48l3-adata", type: "vocab", front: "a data", reading: "adata", meaning: "date", example: { jp: "A data da festa é importante e o aniversário de Ana é amanhã.", en: "The party's date matters and Ana's birthday is tomorrow." }, drill: { jp: "A data da festa é importante", en: "The party's date is important" }, accept: ["the date", "calendar date"], hint: "DA-ta — a date on a calendar, never a romantic one, which Portugal calls um encontro. Keep it apart from o dia: a data is the numbered point, o dia is the day itself. The verb is datar." },
      ],
    },
    {
      id: "pt-u48l4",
