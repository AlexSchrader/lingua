  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u65l1-opetroleo", type: "vocab", front: "o petróleo", reading: "opetroleo", meaning: "oil", example: { jp: "O petróleo ainda paga quase tudo em alguns países, mas o preço muda todos os meses.", en: "Oil still pays for almost everything in some countries, but the price changes every month." }, drill: { jp: "O petróleo é caro este ano", en: "Oil is expensive this year" }, accept: ["oil", "crude oil", "petroleum"], hint: "pe-TROH-lyu. The crude, the industry. The stuff you put in the car is a gasolina; cooking oil is o azeite (olive) or o óleo — three different words English collapses into one." },
        { id: "pt-u65l1-ocarvao", type: "vocab", front: "o carvão", reading: "ocarvao", meaning: "coal", example: { jp: "O carvão foi muito usado no passado, no entanto quase ninguém quer uma fábrica de carvão hoje.", en: "Coal was widely used in the past; however, almost nobody wants a coal factory today." }, drill: { jp: "O carvão foi usado no passado", en: "Coal was used in the past" }, accept: ["coal", "charcoal"], hint: "kar-VOWNG; plural os carvões. Also the charcoal under a grill — carne no carvão is how a Portuguese menu says charcoal-grilled." },
    ...
    },
    {
      ...
      items: [
        { id: "pt-u65l3-aalteracao", type: "vocab", front: "a alteração", reading: "aalteracao", meaning: "change", example: { jp: "As alterações do clima já mudaram o verão português, no entanto muitas pessoas ainda não querem falar do assunto.", en: "Climate change has already changed the Portuguese summer; however, many people still do not want to talk about the subject." }, drill: { jp: "A alteração do clima mudou tudo", en: "The change in the climate changed everything" }, accept: ["change", "alteration", "the change"], hint: "al-te-ra-SOWNG; plural as alterações. As alterações climáticas is the standard term for climate change — always plural. A mudança (u29's mudar) is any change; uma alteração is a change made TO something that already existed." },
