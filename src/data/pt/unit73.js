  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u73l3-pelocontrario", type: "vocab", front: "pelo contrário", reading: "pelocontrario", meaning: "on the contrary", example: { jp: "A chuva não atrasou o trabalho; pelo contrário, tudo ficou pronto antes do prazo.", en: "The rain did not delay the work; on the contrary, everything was ready before the deadline." }, drill: { jp: "Pelo contrário tudo ficou pronto antes", en: "On the contrary everything was ready early" }, accept: ["on the contrary", "quite the opposite", "far from it"], hint: "Turns a correction into an argument for the other side. Portuguese uses it where English often just says \"no\" — and it is much less confrontational than it looks on the page." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u73l4-considerar", type: "vocab", front: "considerar", reading: "considerar", meaning: "to consider", example: { jp: "A empresa vai considerar o pedido, embora o prazo já tenha acabado na semana passada.", en: "The company is going to consider the request, although the deadline already ended last week." }, drill: { jp: "A empresa vai considerar o pedido", en: "The company is going to consider the request" }, accept: ["consider", "to take into account", "to regard"], hint: "Also \"to regard as\": considero-o um bom médico. The clitic placement there is u71's enclitic rule, and it is very common with this verb in formal writing." },
