  ...
  lessons: [
    {
      ...
      items: [
        { id: "pt-u73l1-venhoporestemeio", type: "vocab", front: "venho por este meio", reading: "venhoporestemeio", meaning: "I am writing to", example: { jp: "Venho por este meio pedir informações sobre o apartamento que está para alugar.", en: "I am writing to ask for information about the flat that is up for rent." }, drill: { jp: "Venho por este meio pedir informações", en: "I am writing to ask for information" }, accept: ["I am writing to", "I hereby", "this is to"], hint: "Literally \"I come by this means\". The standard opening of a formal Portuguese email or letter, and it sounds normal rather than pompous — English's \"I am writing to\" is the exact match." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u73l3-emcontrapartida", type: "vocab", front: "em contrapartida", reading: "emcontrapartida", meaning: "in return", example: { jp: "O prazo é mais curto; em contrapartida, a empresa paga o trabalho todo antes do fim do mês.", en: "The deadline is shorter; in return, the company pays for all the work before the end of the month." }, drill: { jp: "Em contrapartida a empresa paga tudo antes", en: "In return the company pays everything in advance" }, accept: ["in return", "on the other hand", "in exchange", "however"], hint: "Two jobs at once: the trade-off (in exchange for) and the contrast (on the other hand). Formal but not stiff — it is ordinary in a meeting and common in the press." },
      ],
    },
    {
      id: "pt-u73l4",
      ...
      items: [
        ...
        { id: "pt-u73l4-dirigirse", type: "vocab", front: "dirigir-se", reading: "dirigirse", meaning: "to make your way to", example: { jp: "Os doentes devem dirigir-se ao balcão da entrada, informa a senhora da receção.", en: "Patients should make their way to the front desk, the receptionist informs us." }, drill: { jp: "Os doentes devem dirigir-se ao balcão", en: "Patients should make their way to the desk" }, accept: ["make your way to", "to go to", "to address", "to head for"], hint: "dee-ree-ZHEER-suh. Dirija-se ao balcão is the sign in every Portuguese station, hospital and airport, where English would say \"proceed to\". Second sense: dirigir-se A alguém is to address them — and dirigir on its own is to drive or to run a company." },
        ...
        { id: "pt-u73l4-anexar", type: "vocab", front: "anexar", reading: "anexar", meaning: "to attach", example: { jp: "Vou anexar a cópia do contrato ao email, para que possa ver tudo antes da reunião.", en: "I will attach the copy of the contract to the email, so that you can see everything before the meeting." }, drill: { jp: "Vou anexar a cópia ao email", en: "I am going to attach the copy to the email" }, accept: ["attach", "to enclose", "to append"], hint: "a-ne-KSAR. The email verb, and the formal one for enclosing a document. Em anexo — \"attached\" — is what the covering line says: envio em anexo os documentos." },
      ],
    },
  ],
};
