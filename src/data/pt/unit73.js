  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u73l4-anexar", type: "vocab", front: "anexar", reading: "anexar", meaning: "to attach", example: { jp: "Vou anexar a cópia do contrato ao email, para que possa ver tudo antes da reunião.", en: "I will attach the copy of the contract to the email, so that you can see everything before the meeting." }, drill: { jp: "Vou anexar a cópia ao email", en: "I am going to attach the copy to the email" }, accept: ["attach", "to enclose", "to append"], hint: "a-ne-ZAR. The email verb, and the formal one for enclosing a document. Em anexo — \"attached\" — is what the covering line says: envio em anexo os documentos." },
      ],
    },
  ],
};
