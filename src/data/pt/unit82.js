  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u82l1-somar", type: "vocab", front: "somar", reading: "somar", meaning: "to add up", example: { jp: "A criança já sabe somar os números até cem.", en: "The child can already add up the numbers to a hundred." }, drill: { jp: "Vamos somar os preços das duas casas", en: "We are going to add up the prices of the two houses" }, accept: ["add", "to add", "add up", "to add up", "to total", "to sum"], hint: "su-MAR. Numbers only — for adding to what was said, Portuguese uses acrescentar. A soma is the sum, and ao todo soma cem is it comes to a hundred in all." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u82l3-otriplo", type: "vocab", front: "o triplo", reading: "otriplo", meaning: "triple", example: { jp: "A família pagou o triplo do preço do carro novo.", en: "The family paid triple the price of the new car." }, drill: { jp: "Este ano o pão custa o triplo", en: "This year bread costs triple" }, accept: ["the triple", "triple", "three times", "threefold"], hint: "TREE-plu. Three times the amount, built exactly like o dobro, which you met at Unit 43 for twice. O triplo DE something." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u82l4-aproximado", type: "vocab", front: "aproximado", reading: "aproximado", meaning: "approximate", example: { jp: "O número aproximado de pessoas na festa foi cem.", en: "The approximate number of people at the party was a hundred." }, drill: { jp: "O valor aproximado é sempre mais alto", en: "The approximate figure is always higher" }, accept: ["approximate", "rough", "estimated", "ballpark"], hint: "a-pro-si-MA-du, from aproximar-se, to come close. A rough figure, the honest one when you have not counted. Aproximadamente is the adverb." },
