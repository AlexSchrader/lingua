  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u82l3-otriplo", type: "vocab", front: "o triplo", reading: "otriplo", meaning: "triple", example: { jp: "A família pagou o triplo do preço pelo carro novo.", en: "The family paid triple the price for the new car." }, drill: { jp: "A família pagou o triplo do preço", en: "The family paid triple the price" }, accept: ["the triple", "triple", "three times", "threefold"], hint: "TREE-plu. Three times the amount, built exactly like o dobro, which you met at Unit 43 for twice. O triplo DE something." },
