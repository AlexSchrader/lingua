  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u27l3-osaldo", type: "vocab", front: "o saldo", reading: "osaldo", meaning: "sale", example: { jp: "Comprei o casaco nos saldos de janeiro por metade do preço.", en: "I bought the coat in the January sales for half price." }, drill: { jp: "O saldo do banco é pequeno", en: "The bank balance is small" }, accept: ["the sale", "clearance", "balance"], hint: "SAL-du. Usually plural for the shop sense — os saldos, the seasonal sales. In the singular it is also a bank balance, which is what your app shows you." },
