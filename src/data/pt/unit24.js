  ...
  lessons: [
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Apply for a Portuguese job — send a CV, read a contract, and name the post you are applying for.",
      items: [
