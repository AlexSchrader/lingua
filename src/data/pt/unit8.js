...
export const PT_UNIT8 = {
  ...
  lessons: [
    ...
    // the answer usually starts with faz or está, never with é.
    {
      ...
      items: [
        { id: "pt-u8l3-otempo", type: "vocab", front: "o tempo", reading: "otempo", meaning: "weather", example: { jp: "O tempo em Lisboa é fantástico.", en: "The weather in Lisbon is fantastic." }, drill: { jp: "O tempo em Lisboa é fantástico", en: "The weather in Lisbon is fantastic" }, accept: ["the weather", "time", "the time"], hint: "TEM-pu, nasal first syllable. ONE word for two English ones: o tempo is the weather AND time in general — não tenho tempo, I don't have time. A clock hour is a hora, from Unit 5, never o tempo." },
        { id: "pt-u8l3-quetempofaz", type: "vocab", front: "que tempo faz", reading: "quetempofaz", meaning: "what's the weather like", example: { jp: "Que tempo faz hoje em Braga?", en: "What's the weather like today in Braga?" }, drill: { jp: "Que tempo faz hoje em Braga", en: "What's the weather like today in Braga" }, accept: ["how is the weather", "what is the weather like", "hows the weather"], hint: "Learn it as one block. Literally \"what weather does it make\" — Portuguese hands the weather to fazer, the verb from Unit 3, where English uses \"to be\". The answer comes back the same way: faz sol, faz frio." },
        { id: "pt-u8l3-osol", type: "vocab", front: "o sol", reading: "osol", meaning: "sun", example: { jp: "Hoje faz sol.", en: "Today it's sunny." }, drill: { jp: "Em Lisboa o sol é fantástico", en: "In Lisbon the sun is fantastic" }, accept: ["the sun", "sunshine", "sunny"], hint: "SOL, short and open. Faz sol and está sol are both normal; \"é sol\" is not. Sunglasses are óculos de sol, and sunbathing is apanhar sol — literally catching sun." },
        { id: "pt-u8l3-achuva", type: "vocab", front: "a chuva", reading: "achuva", meaning: "rain", example: { jp: "A chuva não é um problema em Lisboa.", en: "The rain isn't a problem in Lisbon." }, drill: { jp: "A chuva de Braga não é um problema", en: "Braga's rain isn't a problem" }, accept: ["the rain", "rainfall"], hint: "SHOO-va — ch in Portuguese is always \"sh\", never the \"ch\" of English \"church\". The verb is chover: está a chover means it is raining, and that a is not a mistake — Unit 13 explains it." },
        { id: "pt-u8l3-ovento", type: "vocab", front: "o vento", reading: "ovento", meaning: "wind", example: { jp: "Hoje faz muito vento.", en: "Today it's very windy." }, drill: { jp: "Em Braga o vento é enorme", en: "In Braga the wind is enormous" }, accept: ["the wind", "windy"], hint: "VEN-tu, nasal. Portuguese counts wind rather than measuring it: faz muito vento, literally \"it makes a lot of wind\". The Atlantic coast north of Lisbon runs on it." },
        { id: "pt-u8l3-ofrio", type: "vocab", front: "o frio", reading: "ofrio", meaning: "cold", example: { jp: "Em Braga faz frio.", en: "In Braga it's cold." }, drill: { jp: "Hoje o frio não é um problema", en: "Today the cold isn't a problem" }, accept: ["the cold", "chilly", "coldness"], hint: "FREE-u. Both a noun and an adjective: faz frio (the weather is cold) but também a água está fria (this particular water is cold). Careful with people — you don't \"are\" cold in Portuguese, you HAVE it: tenho frio." },
      ],
    },
