  ...
  lessons: [
    {
      ...
      unit: 44,
      lesson: 1,
      title: "As regras e a justiça",
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Say what is allowed and what is forbidden in Portugal, and name the rule that decides it.",
      items: [
        { id: "pt-u44l1-ajustica", type: "vocab", front: "a justiça", reading: "ajustica", meaning: "justice", example: { jp: "A justiça de Portugal é importante e o tribunal de Lisboa é enorme.", en: "Portugal's justice matters and the Lisbon court is enormous." }, drill: { jp: "A justiça de Portugal é importante", en: "Portugal's justice is important" }, accept: ["the justice", "fairness", "the courts", "the law"], hint: "zhush-TEE-sa, cedilla. Justice — and, capitalised, a Justiça is what the news calls the court system as a whole. Fazer justiça is to do right by someone." },
        { id: "pt-u44l1-anorma", type: "vocab", front: "a norma", reading: "anorma", meaning: "norm", example: { jp: "A norma da escola é clara e a regra está na porta da sala.", en: "The school's standard is clear and the rule is on the classroom door." }, drill: { jp: "A norma da escola é clara", en: "The school's standard is clear" }, accept: ["the norm", "standard", "rule", "regulation"], hint: "NOR-ma. A standard or a norm — more formal and more written than uma regra. Em norma means \"as a rule\". Normal comes straight out of it, and so does normalmente." },
        { id: "pt-u44l1-legal", type: "vocab", front: "legal", reading: "legal", meaning: "legal", example: { jp: "O documento é legal e o carimbo do tribunal está no papel.", en: "The document is legal and the court's stamp is on the paper." }, drill: { jp: "O documento é legal e claro", en: "The document is legal and clear" }, accept: ["lawful", "legitimate", "valid", "above board"], hint: "le-GAL, stressed at the end; plural legais, opposite ilegal. WATCH BRAZIL: there legal in speech means \"cool\" or \"nice\" — Portugal keeps the word strictly to the law and says fixe for cool." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u44l4-avalidade", type: "vocab", front: "a validade", reading: "avalidade", meaning: "validity", example: { jp: "A validade do documento é de cinco anos e a assinatura é do juiz.", en: "The document's validity is five years and the signature is the judge's." }, drill: { jp: "A validade do documento é importante", en: "The document's validity is important" }, accept: ["the validity", "expiry", "expiry date", "shelf life"], hint: "va-li-DA-de, another -dade noun; the adjective is válido. On food it is the use-by date — o prazo de validade — which is the line every Portuguese shopper checks on the packet." },
