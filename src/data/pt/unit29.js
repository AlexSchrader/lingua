  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u29l3-lembrar", type: "vocab", front: "lembrar", reading: "lembrar", meaning: "to remember", example: { jp: "Lembro-me bem do dia em que cheguei a Lisboa.", en: "I remember well the day I arrived in Lisbon." }, drill: { jp: "Lembrar o exame ao professor", en: "Reminding the teacher about the exam" }, accept: ["remember", "to recall", "recall", "remind"], hint: "Reflexive with de for remembering — lembro-me DE ti. Without the pronoun it means to remind: lembra-me de comprar pão." },
    ...
    },
    {
      ...
      items: [
        { id: "pt-u29l4-doque", type: "vocab", front: "do que", reading: "doque", meaning: "than", example: { jp: "O comboio é mais rápido do que o autocarro mas custa mais.", en: "The train is faster than the bus but costs more." }, drill: { jp: "O comboio é melhor do que o autocarro", en: "The train is better than the bus" }, accept: ["than (comparison)", "compared to"], hint: "The comparison frame is mais or menos plus adjective plus DO QUE. Portuguese can shorten it to que alone, but do que is what you will hear said." },
