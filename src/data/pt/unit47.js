  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u47l1-aseguranca", type: "vocab", front: "a segurança", reading: "aseguranca", meaning: "safety", example: { jp: "A segurança do prédio é boa e a chave está sempre com Ana.", en: "The building's security is good and Ana always has the key." }, drill: { jp: "A segurança do prédio é boa", en: "The building's security is good" }, accept: ["the security", "safety"], hint: "se-gu-RAN-sa, cedilla. Safety and security both — and, masculine, o segurança is the security guard himself. The gender splits the abstract idea from the person standing at the door." },
    ...
    },
    {
      ...
      canDo: "Report a fire in Portuguese and name who comes to put it out.",
      items: [
        { id: "pt-u47l2-oincendio", type: "vocab", front: "o incêndio", reading: "oincendio", meaning: "blaze", example: { jp: "O incêndio foi enorme no verão e os bombeiros do Porto foram ali.", en: "The blaze was enormous in the summer and Porto's firefighters went there." }, drill: { jp: "O incêndio do verão foi enorme", en: "The summer blaze was enormous" }, accept: ["the fire", "blaze", "wildfire", "the blaze"], hint: "in-SEN-diu — fire in the destructive sense. Portugal's summer fires are a national emergency every single year, and os incêndios florestais is the phrase the news uses for them." },
        ...
        { id: "pt-u47l2-apagar", type: "vocab", front: "apagar", reading: "apagar", meaning: "to put out", example: { jp: "Vou apagar o fogo da cozinha com muita água.", en: "I'm going to put out the kitchen fire with plenty of water." }, drill: { jp: "Apagar o fogo com água", en: "To put out the fire with water" }, accept: ["put out", "to extinguish", "to switch off", "to erase", "to delete"], hint: "a-pa-GAR: apago, apagas, apaga. One verb for extinguishing anything — a fire, a light, a file on a computer, or a memory. Portuguese does not need a separate word for any of them." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u47l4-oacidente", type: "vocab", front: "o acidente", reading: "oacidente", meaning: "accident", example: { jp: "O acidente da estrada foi enorme e o hospital está cheio.", en: "The road accident was enormous and the hospital is full." }, drill: { jp: "O acidente da estrada foi enorme", en: "The road accident was enormous" }, accept: ["the accident", "crash", "collision"], hint: "a-si-DEN-te. Por acidente means by chance. Portuguese does not stretch it to the light English sense of a mishap — for that you would just say um problema." },
        ...
        { id: "pt-u47l4-proteger", type: "vocab", front: "proteger", reading: "proteger", meaning: "to protect", example: { jp: "A lei vai proteger a vítima do crime e o tribunal é claro.", en: "The law is going to protect the victim of the crime and the court is clear." }, drill: { jp: "Proteger a vítima é importante", en: "Protecting the victim is important" }, accept: ["protect", "to defend", "to shield", "defend"], hint: "pru-te-ZHER: protejo, proteges, protege — note the g turns to a j before o, purely to keep the zh sound. The noun is a proteção, with the post-1990 spelling and no c." },
