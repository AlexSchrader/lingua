  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u47l1-aseguranca", type: "vocab", front: "a segurança", reading: "aseguranca", meaning: "safety", example: { jp: "A segurança do prédio é boa e a chave está sempre com Ana.", en: "The building's security is good and Ana always has the key." }, drill: { jp: "A segurança do prédio é boa", en: "The building's security is good" }, accept: ["the security", "safety", "the safety"], hint: "se-gu-RAN-sa, cedilla. Safety and security both — and, masculine, o segurança is the security guard himself. The gender splits the abstract idea from the person standing at the door." },
