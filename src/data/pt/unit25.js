...
export const PT_UNIT25 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "pt-u25l4-saudavel", type: "vocab", front: "saudável", reading: "saudavel", meaning: "healthy", example: { jp: "Comer peixe e legumes todos os dias é muito saudável.", en: "Eating fish and vegetables every day is very healthy." }, drill: { jp: "Comer peixe é muito saudável", en: "Eating fish is very healthy" }, accept: ["wholesome", "good for you", "health-giving"], hint: "sau-DA-vel, built on saúde from Unit 2. One form for both genders since it ends in -l; the plural is saudáveis. It describes people and habits alike: uma pessoa saudável, uma dieta saudável." },
