...
export const PT_UNIT85 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "pt-u85l4-adificuldade", type: "vocab", front: "a dificuldade", reading: "adificuldade", meaning: "difficulty", example: { jp: "A dificuldade do trabalho novo é a língua, não as horas.", en: "The difficulty of the new job is the language, not the hours." }, drill: { jp: "A dificuldade do trabalho é a língua", en: "The difficulty of the job is the language" }, accept: ["the difficulty", "difficulty", "trouble", "hardship", "problem"], hint: "di-fi-kul-DA-de, from difícil. Com dificuldade is with difficulty; passar dificuldades means going through hard times, usually about money." },
