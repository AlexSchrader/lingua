  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u85l4-afraqueza", type: "vocab", front: "a fraqueza", reading: "afraqueza", meaning: "weakness", example: { jp: "A fraqueza da equipa aparece sempre no fim do jogo.", en: "The team's weakness always shows at the end of the game." }, drill: { jp: "A fraqueza da equipa aparece no fim", en: "The team's weakness shows at the end" }, accept: ["the weakness", "weakness", "failing", "the failing", "frailty"], hint: "fra-KE-za, from fraco, which you met at Unit 10. A failing in a plan or a person, and also physical faintness — senti uma fraqueza." },
