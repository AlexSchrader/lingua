  ...
  lessons: [
    // Lesson 1: the press — the people and the products, not the paper.
    {
      ...
      items: [
        ...
        { id: "pt-u64l1-otitulo", type: "vocab", front: "o título", reading: "otitulo", meaning: "title (of an article)", example: { jp: "O título do artigo é pequeno, mas a manchete da primeira página fala do mesmo assunto.", en: "The article's heading is small, but the front-page headline is about the same subject." }, drill: { jp: "O título do artigo é pequeno", en: "The heading of the article is small" }, accept: ["title", "heading", "the title"], hint: "TEE-tu-lu. The heading of an article, a book or a film. A manchete is the big front-page one; o título is every other heading, including the one on your diploma." },
      ],
    },
    ...
    // u35 owns the theatre and a personagem. This lesson is what is behind them.
    {
      ...
      items: [
        ...
        { id: "pt-u64l3-alegenda", type: "vocab", front: "a legenda", reading: "alegenda", meaning: "subtitle", example: { jp: "Em Portugal quase todos os filmes têm legendas, por isso as pessoas aprendem a ler depressa.", en: "In Portugal almost all films have subtitles, so people learn to read quickly." }, drill: { jp: "A legenda da foto do jornal está errada", en: "The caption of the newspaper photo is wrong" }, accept: ["the subtitle", "caption"], hint: "luh-ZHEN-duh. Usually plural in practice — as legendas. Also the caption under a photo, and the legend on a map. Portugal subtitles rather than dubs, which is why this word is everyday here and technical elsewhere." },
    ...
    // the unit and the reason it is not a vocabulary list about screens.
    {
      ...
      items: [
        ...
        { id: "pt-u64l4-acensura", type: "vocab", front: "a censura", reading: "acensura", meaning: "censorship", example: { jp: "A censura acabou em 1974, por isso os jornais já podem escrever tudo.", en: "Censorship ended in 1974, so newspapers can now write everything." }, drill: { jp: "A censura acabou em Portugal", en: "Censorship ended in Portugal" }, accept: ["censorship", "the censorship"], hint: "sen-SOO-ruh. Portugal lived under it until 1974 and the word carries that weight — a censura, with the article, means the historical institution. Also plain criticism: uma censura é uma crítica dura." },
        { id: "pt-u64l4-comentar", type: "vocab", front: "comentar", reading: "comentar", meaning: "to comment", example: { jp: "Ninguém quis comentar o boato, mas toda a gente falou disso no escritório.", en: "Nobody wanted to comment on the rumour, but everyone talked about it in the office." }, drill: { jp: "Ninguém quis comentar o boato", en: "Nobody wanted to comment on the rumour" }, accept: ["comment", "to remark", "to comment on"], hint: "ku-men-TAR. Comentar alguma coisa, with no preposition — comentar a notícia, not comentar sobre. Sem comentários is what a Portuguese politician says at the door." },
      ],
    },
  ],
};
