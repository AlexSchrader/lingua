  ...
  lessons: [
    ...
    // the unit and the reason it is not a vocabulary list about screens.
    {
      ...
      items: [
        ...
        { id: "pt-u64l4-acensura", type: "vocab", front: "a censura", reading: "acensura", meaning: "censorship", example: { jp: "A censura acabou em 1974, por isso os jornais podem escrever o que quiserem.", en: "Censorship ended in 1974, so newspapers can write whatever they want." }, drill: { jp: "A censura acabou em Portugal", en: "Censorship ended in Portugal" }, accept: ["censorship", "the censorship"], hint: "sen-SOO-ruh. Portugal lived under it until 1974 and the word carries that weight — a censura, with the article, means the historical institution. Also plain criticism: uma censura é uma crítica dura." },
        { id: "pt-u64l4-comentar", type: "vocab", front: "comentar", reading: "comentar", meaning: "to comment", example: { jp: "Ninguém quis comentar o boato, embora toda a gente falasse disso no escritório.", en: "Nobody wanted to comment on the rumour, although everyone was talking about it in the office." }, drill: { jp: "Ninguém quis comentar o boato", en: "Nobody wanted to comment on the rumour" }, accept: ["comment", "to remark", "to comment on"], hint: "ku-men-TAR. Comentar alguma coisa, with no preposition — comentar a notícia, not comentar sobre. Sem comentários is what a Portuguese politician says at the door." },
      ],
    },
  ],
};
