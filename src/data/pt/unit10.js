...
export const PT_UNIT10 = {
  ...
  lessons: [
    // Lesson 1: size and dimension — and the Spanish trap that lives inside it.
    {
      ...
      items: [
        { id: "pt-u10l1-grande", type: "vocab", front: "grande", reading: "grande", meaning: "big", example: { jp: "Lisboa é uma cidade grande.", en: "Lisbon is a big city." }, drill: { jp: "Lisboa é uma cidade grande", en: "Lisbon is a big city" }, accept: ["large", "great", "tall"], hint: "GRAN-de. Same for masculine and feminine, like verde. Position changes it: uma cidade grande is a big city, but uma grande cidade is a GREAT one — before the noun it turns into praise." },
        { id: "pt-u10l1-pequeno", type: "vocab", front: "pequeno", reading: "pequeno", meaning: "small", example: { jp: "O museu não é pequeno.", en: "The museum isn't small." }, drill: { jp: "O museu não é pequeno", en: "The museum isn't small" }, accept: ["little", "tiny", "short"], hint: "pe-KE-nu; feminine pequena. You already know it hiding inside o pequeno-almoço from Unit 6 — the \"small lunch\" Portugal eats in the morning. Here it stands on its own." },
        { id: "pt-u10l1-alto", type: "vocab", front: "alto", reading: "alto", meaning: "tall", example: { jp: "O homem alto é o pai de Ana.", en: "The tall man is Ana's father." }, drill: { jp: "O homem alto é o pai de Ana", en: "The tall man is Ana's father" }, accept: ["high", "loud", "the high"], hint: "AL-tu; feminine alta. It does tall, high AND loud — a música está muito alta means the music is too loud. Em voz alta is out loud." },
        { id: "pt-u10l1-baixo", type: "vocab", front: "baixo", reading: "baixo", meaning: "low", example: { jp: "O preço é muito baixo.", en: "The price is very low." }, drill: { jp: "O preço é muito baixo", en: "The price is very low" }, accept: ["short", "quiet", "the low"], hint: "BY-shu — that x is a \"sh\". The exact mirror of alto: low, short in height, and quiet. Em baixo also means downstairs, and the Baixa is Lisbon's flat downtown." },
        { id: "pt-u10l1-comprido", type: "vocab", front: "comprido", reading: "comprido", meaning: "long", example: { jp: "O comboio é comprido.", en: "The train is long." }, drill: { jp: "O comboio de Lisboa é comprido", en: "The Lisbon train is long" }, accept: ["lengthy", "the long"], hint: "kom-PREE-du; feminine comprida. This is LONG in space — a long street, long hair. For a long TIME Portuguese uses longo: um longo dia. Its opposite is curto, short." },
        { id: "pt-u10l1-largo", type: "vocab", front: "largo", reading: "largo", meaning: "wide", example: { jp: "O carro é largo, não é comprido.", en: "The car is wide, it isn't long." }, drill: { jp: "O carro é largo e não é comprido", en: "The car is wide and it isn't long" }, accept: ["broad", "the wide", "square"], hint: "FALSE FRIEND — the big one. Spanish largo is LONG; Portuguese largo is WIDE. Long is comprido, the card before. As a noun um largo is a small town square, smaller than uma praça — you will see it on every street sign in Lisbon." },
      ],
    },
    ...
    // learner has already been using since bom dia without noticing.
    {
      ...
      items: [
        { id: "pt-u10l2-bom", type: "vocab", front: "bom", reading: "bom", meaning: "good", example: { jp: "O vinho português é muito bom.", en: "Portuguese wine is very good." }, drill: { jp: "O vinho português é muito bom", en: "Portuguese wine is very good" }, accept: ["fine", "nice", "the good"], hint: "BONG, nasal — the same -m ending as sim and um in Unit 1. Irregular feminine: BOA, not \"boma\", which is why Unit 2 taught boa tarde and boa noite next to bom dia. Plural bons / boas." },
        { id: "pt-u10l2-mau", type: "vocab", front: "mau", reading: "mau", meaning: "bad", example: { jp: "Não é um mau preço.", en: "It isn't a bad price." }, drill: { jp: "Não é um mau preço", en: "It isn't a bad price" }, accept: ["evil", "poor", "the bad"], hint: "MAU, one syllable, rhymes with English \"how\". Feminine MÁ, which is as irregular as boa. Do not confuse it with mais, \"more\", or with mão, \"hand\" — three short words, three different sounds." },
        { id: "pt-u10l2-bonito", type: "vocab", front: "bonito", reading: "bonito", meaning: "beautiful", example: { jp: "O elétrico é bonito.", en: "The tram is beautiful." }, drill: { jp: "O elétrico de Lisboa é bonito", en: "The Lisbon tram is beautiful" }, accept: ["pretty", "handsome", "lovely", "nice"], hint: "bu-NEE-tu; feminine bonita. Portugal's everyday word for good-looking, of people and things alike. Lindo is stronger, and giro is the slangy one you will hear all day in Lisbon." },
        { id: "pt-u10l2-feio", type: "vocab", front: "feio", reading: "feio", meaning: "ugly", example: { jp: "O hotel não é feio.", en: "The hotel isn't ugly." }, drill: { jp: "O hotel não é feio", en: "The hotel isn't ugly" }, accept: ["unpleasant", "nasty"], hint: "FAY-u, two syllables; feminine feia. It stretches past looks: ficar feio is for behaviour that looks bad, roughly \"that's a bad look\"." },
        { id: "pt-u10l2-novo", type: "vocab", front: "novo", reading: "novo", meaning: "new", example: { jp: "O comboio é novo e rápido.", en: "The train is new and rapid." }, drill: { jp: "O comboio é novo e rápido", en: "The train is new and rapid" }, accept: ["young", "brand new", "fresh"], hint: "NO-vu with a closed o, but the feminine opens it right up: NO-va. It also means young of people — ele é novo, he's young. De novo means again." },
        { id: "pt-u10l2-velho", type: "vocab", front: "velho", reading: "velho", meaning: "old", example: { jp: "O museu é velho e famoso.", en: "The museum is old and famous." }, drill: { jp: "O museu é velho e famoso", en: "The museum is old and famous" }, accept: ["ancient", "aged", "the old"], hint: "VE-lyu, lh again; feminine velha. Careful with people: calling someone velho is blunt, and Portuguese prefers idoso, or simply saying the age with ter — tem oitenta anos." },
      ],
    },
    ...
    // rather than ser. u12 makes that split a rule; here it is just a habit.
    {
      ...
      items: [
        { id: "pt-u10l3-facil", type: "vocab", front: "fácil", reading: "facil", meaning: "easy", example: { jp: "O português não é fácil!", en: "Portuguese isn't easy!" }, drill: { jp: "O português não é fácil", en: "Portuguese isn't easy" }, accept: ["simple", "straightforward"], hint: "FA-sil, stress on the first syllable — the accent tells you so. No separate feminine: um livro fácil, uma rua fácil. Plural fáceis, with that -l to -eis swap azul also makes." },
        { id: "pt-u10l3-dificil", type: "vocab", front: "difícil", reading: "dificil", meaning: "difficult", example: { jp: "O trabalho é difícil.", en: "The work is difficult." }, drill: { jp: "O trabalho de Ana é difícil", en: "Ana's work is difficult" }, accept: ["hard", "tough", "tricky"], hint: "di-FEE-sil. Same shape as fácil and the same plural, difíceis. Both keep an accent because Portuguese would otherwise stress the last syllable, which is where -l words normally take it." },
        { id: "pt-u10l3-limpo", type: "vocab", front: "limpo", reading: "limpo", meaning: "clean", example: { jp: "O hotel é limpo e moderno.", en: "The hotel is clean and modern." }, drill: { jp: "O hotel é limpo e moderno", en: "The hotel is clean and modern" }, accept: ["tidy", "the clean"], hint: "LEEM-pu, nasal; feminine limpa. The verb is limpar, to clean. A limpeza is the cleaning — you will see it on signs in every casa de banho." },
        { id: "pt-u10l3-sujo", type: "vocab", front: "sujo", reading: "sujo", meaning: "dirty", example: { jp: "O carro sujo é de Pedro.", en: "The dirty car is Pedro's." }, drill: { jp: "O carro sujo é de Pedro", en: "The dirty car is Pedro's" }, accept: ["filthy", "unclean", "messy"], hint: "SOO-zhu — that j is the \"zh\" of measure; feminine suja. Note it is nothing to do with a sopa, and nothing to do with the Spanish sucio, which took a different route from the same Latin word." },
        { id: "pt-u10l3-cheio", type: "vocab", front: "cheio", reading: "cheio", meaning: "full", example: { jp: "O museu é pequeno e está sempre cheio.", en: "The museum is small and it's always full." }, drill: { jp: "O museu está sempre cheio", en: "The museum is always full" }, accept: ["crowded", "packed", "filled"], hint: "SHAY-u — ch is always \"sh\", as in a chuva; feminine cheia. Cheio DE something is full of it: cheio de gente, packed with people. Estou cheio after a meal means you could not eat another bite." },
        { id: "pt-u10l3-vazio", type: "vocab", front: "vazio", reading: "vazio", meaning: "empty", example: { jp: "Hoje o mercado está vazio.", en: "Today the market is empty." }, drill: { jp: "Hoje o mercado está vazio", en: "Today the market is empty" }, accept: ["vacant", "blank", "the empty"], hint: "va-ZEE-u, stress on the i; feminine vazia. The z is a plain z here, and the whole word is three syllables. Its opposite is cheio, the card before." },
      ],
    },
