  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u75l3-disponivel", type: "vocab", front: "disponível", reading: "disponivel", meaning: "available", example: { jp: "Não há quartos disponíveis para o fim de semana, por isso vamos ficar em casa da minha irmã.", en: "There are no rooms available for the weekend, so we are going to stay at my sister's." }, drill: { jp: "O quarto não está disponível hoje", en: "The room is not available today" }, accept: ["available", "free", "on offer"], hint: "dish-pu-NEE-vel; plural disponíveis, like renovável (u65). Of rooms, tickets and people: fico à disposição, from u73, is the formal way of saying you are available." },
      ],
    },
    {
      id: "pt-u75l4",
      ...
      items: [
        ...
        { id: "pt-u75l4-urgente", type: "vocab", front: "urgente", reading: "urgente", meaning: "urgent", example: { jp: "O caso não é urgente, no entanto o médico quer ver as análises antes do fim do mês.", en: "The case is not urgent; however, the doctor wants to see the tests before the end of the month." }, drill: { jp: "O caso não é urgente", en: "The case is not urgent" }, accept: ["urgent", "pressing"], hint: "oor-ZHEN-tuh; same form for both genders. a urgência (u25) is the A&E department, from the same root — and in a Portuguese hospital that word on a sign means exactly what it does in English." },
