  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u75l4-essencial", type: "vocab", front: "essencial", reading: "essencial", meaning: "essential (crucial)", example: { jp: "O descanso é essencial depois da cirurgia, embora quase ninguém descanse o tempo que devia.", en: "Rest is essential after surgery, although almost nobody rests for as long as they should." }, drill: { jp: "O descanso é essencial depois da cirurgia", en: "Rest is essential after surgery" }, accept: ["vital", "crucial", "key"], hint: "e-sen-see-AL; plural essenciais, same form for both genders. O essencial as a noun is \"the main thing\": o essencial é chegar bem." },
      ],
    },
  ],
};
