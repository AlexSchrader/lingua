  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u75l4-essencial", type: "vocab", front: "essencial", reading: "essencial", meaning: "essential", example: { jp: "O descanso é essencial depois da cirurgia, embora quase ninguém pare o tempo que devia.", en: "Rest is essential after surgery, although almost nobody stops for as long as they should." }, drill: { jp: "O descanso é essencial depois da cirurgia", en: "Rest is essential after surgery" }, accept: ["essential", "vital", "crucial", "key"], hint: "e-sen-see-AL; plural essenciais, same form for both genders. O essencial as a noun is \"the main thing\": o essencial é chegar bem." },
      ],
    },
  ],
};
