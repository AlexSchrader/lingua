  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u40l1-algo", type: "vocab", front: "algo", reading: "algo", meaning: "something", example: { jp: "Ele disse algo muito importante na reunião, mas falou tão baixo que a turma não o ouviu.", en: "He said something very important in the meeting, but spoke so quietly that the class didn't hear him." }, drill: { jp: "Ele disse algo muito importante", en: "He said something very important" }, accept: ["anything", "somewhat"], hint: "AL-gu, invariable. Slightly formal — in speech Portugal much prefers alguma coisa, which means exactly the same and is two words. Learn algo to read it; say alguma coisa." },
        { id: "pt-u40l1-cada", type: "vocab", front: "cada", reading: "cada", meaning: "each", example: { jp: "Cada pessoa tem uma opinião do governo, e quase sempre a diz sem lhe perguntarem.", en: "Each person has an opinion about the government, and almost always says it without being asked." }, drill: { jp: "Cada pessoa tem uma opinião", en: "Each person has an opinion" }, accept: ["every", "apiece", "each one"], hint: "KA-da. NEVER changes — cada homem, cada mulher, cada dia — and it is always followed by a SINGULAR noun, even though English says \"each of the books\". Cada vez mais means \"more and more\", which you will hear constantly." },
      ],
    },
    {
      id: "pt-u40l2",
      ...
      items: [
        ...
        { id: "pt-u40l2-qualquer", type: "vocab", front: "qualquer", reading: "qualquer", meaning: "any", example: { jp: "Qualquer pessoa pode votar aqui, se já tiver mais de vinte anos.", en: "Any person can vote here, if they are already over twenty." }, drill: { jp: "Qualquer pessoa pode votar aqui", en: "Any person can vote here" }, accept: ["whichever", "whatever", "either", "any at all"], hint: "kwal-KER. \"Any\" in the sense of it-doesn't-matter-which — qualquer dia, qualquer coisa. Its plural is IRREGULAR and splits down the middle: quaisquer, not \"qualqueres\", because it is qual + quer welded together." },
    ...
    },
    {
      ...
      items: [
        { id: "pt-u40l3-aideia", type: "vocab", front: "a ideia", reading: "aideia", meaning: "idea", example: { jp: "A ideia de Ana foi muito boa, mas ninguém a quis ouvir na reunião.", en: "Ana's idea was very good, but nobody wanted to hear it in the meeting." }, drill: { jp: "A ideia de Ana foi muito boa", en: "Ana's idea was very good" }, accept: ["the idea", "notion", "thought", "plan"], hint: "i-DAY-a, three syllables, and NO accent in the Portuguese spelling — Brazil writes ideia too since the accord, but you will still see the old idéia in older Brazilian books. Não faço ideia is \"I have no idea\"." },
