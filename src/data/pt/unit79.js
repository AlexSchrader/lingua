  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u79l1-parar", type: "vocab", front: "parar", reading: "parar", meaning: "to stop", example: { jp: "O carro parou na rua e ficou ali toda a noite.", en: "The car stopped in the street and stayed there all night." }, drill: { jp: "O carro vai parar na rua", en: "The car is going to stop in the street" }, accept: ["stop", "to stop", "to halt", "to pull up"], hint: "pa-RAR. A paragem is the bus stop you wait at, from this verb. Para de falar! is stop talking — and note the clash with para, for: the verb keeps its stress on the last syllable." },
      ],
    },
    {
      id: "pt-u79l2",
    ...
    },
    {
      ...
      items: [
        { id: "pt-u79l3-saltar", type: "vocab", front: "saltar", reading: "saltar", meaning: "to jump", example: { jp: "O cão saltou a janela do jardim e foi para a rua.", en: "The dog jumped the garden window and went into the street." }, drill: { jp: "O cão vai saltar a janela", en: "The dog is going to jump the window" }, accept: ["jump", "to jump", "to leap", "to skip", "to hop"], hint: "sal-TAR. Also to skip something — saltar uma página, saltar o pequeno-almoço. Um salto is both a jump and the heel of a shoe." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u79l4-opasso", type: "vocab", front: "o passo", reading: "opasso", meaning: "step", example: { jp: "O passo do pai é sempre forte e o cão acorda logo.", en: "My father's step is always heavy and the dog wakes up straight away." }, drill: { jp: "O passo do pai é forte", en: "My father's step is heavy" }, accept: ["the step", "step", "pace", "footstep"], hint: "PA-su. The foot's step and the pace you keep — a passo lento. Careful with the near-twin o passo and o país: different words, different stress." },
