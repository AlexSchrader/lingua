  ...
  lessons: [
    {
      ...
      items: [
        { id: "pt-u17l1-aaula", type: "vocab", front: "a aula", reading: "aaula", meaning: "lesson", example: { jp: "A aula de português é às nove.", en: "The Portuguese lesson is at nine." }, drill: { jp: "A aula de português é às nove", en: "The Portuguese lesson is at nine" }, accept: ["the lesson", "class", "the class"], hint: "OW-la, au said as one glide. It is the LESSON — the hour — not the room. The room is uma sala de aula, built on a sala from Unit 15. Note a + as fusing into às before a time." },
        { id: "pt-u17l1-aturma", type: "vocab", front: "a turma", reading: "aturma", meaning: "class group", example: { jp: "A turma de Ana é enorme.", en: "Ana's class is enormous." }, drill: { jp: "A turma de Ana é enorme", en: "Ana's class is enormous" }, accept: ["the class group", "class", "the group", "form", "the class"], hint: "TUR-ma. The other half of English \"class\": a turma is the GROUP of pupils, a aula is the hour they spend together. Portuguese schools label them 7.º A, 7.º B — each one uma turma." },
        { id: "pt-u17l1-aprender", type: "vocab", front: "aprender", reading: "aprender", meaning: "to learn", example: { jp: "Aprender português é fantástico.", en: "Learning Portuguese is fantastic." }, drill: { jp: "Aprender português é fantástico", en: "Learning Portuguese is fantastic" }, accept: ["learn", "to study", "to pick up"], hint: "a-pren-DER: aprendo, aprendes, aprende — a second-conjugation verb like comer from Unit 6. To learn TO do something inserts a: aprender a falar." },
        { id: "pt-u17l1-ensinar", type: "vocab", front: "ensinar", reading: "ensinar", meaning: "to teach", example: { jp: "O professor de Ana ensina português.", en: "Ana's teacher teaches Portuguese." }, drill: { jp: "Ensinar português é o trabalho de Ana", en: "Teaching Portuguese is Ana's job" }, accept: ["teach", "to instruct", "instruct"], hint: "en-si-NAR, nasal first syllable. The other side of aprender. Its root runs through o ensino (education) and o ensino secundário, which is what Portugal calls secondary school." },
        { id: "pt-u17l1-apergunta", type: "vocab", front: "a pergunta", reading: "apergunta", meaning: "question", example: { jp: "A pergunta de Tiago é importante.", en: "Tiago's question is important." }, drill: { jp: "A pergunta de Tiago é importante", en: "Tiago's question is important" }, accept: ["the question", "query"], hint: "per-GUN-ta; the verb is perguntar, to ask. WATCH SPANISH: it is pregunta there and pergunta here — the r and the e trade places, and putting them back the Spanish way is the commonest slip a Spanish speaker makes in Portuguese." },
        { id: "pt-u17l1-aresposta", type: "vocab", front: "a resposta", reading: "aresposta", meaning: "answer", example: { jp: "A resposta não é sim, é não.", en: "The answer isn't yes, it's no." }, drill: { jp: "A resposta de Ana é importante", en: "Ana's answer is important" }, accept: ["the answer", "reply", "response"], hint: "resh-POSH-ta, with two shushing s sounds. The verb is responder. Answering the PHONE is a different verb again — atender, not responder." },
      ],
    },
    {
      id: "pt-u17l2",
