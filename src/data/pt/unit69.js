  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u69l1-tenha", type: "vocab", front: "tenha", reading: "tenha", meaning: "(that it) have", example: { jp: "Espero que tenha tempo para almoçar amanhã, porque quero falar da mudança consigo.", en: "I hope you have time for lunch tomorrow, because I want to talk to you about the move." }, drill: { jp: "Espero que tenha tempo amanhã", en: "I hope you have time tomorrow" }, accept: ["have", "has", "that it have"], hint: "Present subjunctive of ter. Note it doubles as the polite \"you\" form: espero que tenha um bom dia is said to a stranger, tenhas to a friend." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u69l3-paraque", type: "vocab", front: "para que", reading: "paraque", meaning: "so that", example: { jp: "Dei a chave à vizinha para que ela possa entrar, porque volto só no domingo à noite.", en: "I gave the key to the neighbour so that she can get in, because I only come back on Sunday night." }, drill: { jp: "Dei a chave para que ela possa entrar", en: "I gave the key so that she can get in" }, accept: ["so that", "in order that", "so"], hint: "Two subjects, so que plus the subjunctive. One subject and you use para plus the infinitive instead: saí cedo para chegar a tempo. Portuguese is strict about this split." },
        { id: "pt-u69l3-antesque", type: "vocab", front: "antes que", reading: "antesque", meaning: "before", example: { jp: "Quero falar com ele antes que a notícia saia no jornal, por isso vou ligar esta noite.", en: "I want to talk to him before the news comes out in the paper, so I am going to call tonight." }, drill: { jp: "Quero falar antes que a notícia saia", en: "I want to talk before the news comes out" }, accept: ["before", "before that"], hint: "Antes que + subjunctive when the two subjects differ; antes de + infinitive when they are the same (saí antes de comer). u28's antes on its own is the plain adverb." },
        { id: "pt-u69l3-ateque", type: "vocab", front: "até que", reading: "ateque", meaning: "until", example: { jp: "Vou esperar aqui até que eles cheguem, embora já sejam quase dez horas.", en: "I am going to wait here until they arrive, although it is already almost ten o'clock." }, drill: { jp: "Vou esperar até que eles cheguem", en: "I am going to wait until they arrive" }, accept: ["until", "till"], hint: "Subjunctive when the arrival is still ahead. Já ter chegado is past and takes the indicative — esperei até que chegaram is what you say afterwards." },
