  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u35l3-aleitura", type: "vocab", front: "a leitura", reading: "aleitura", meaning: "reading", example: { jp: "A leitura é o passatempo de Ana, especialmente no inverno.", en: "Reading is Ana's hobby, especially in winter." }, drill: { jp: "A leitura é o passatempo de Ana", en: "Reading is Ana's hobby" }, accept: ["the reading", "read"], hint: "lay-TU-ra, from ler in A1 u17 — note the stem changes, lê becoming leit-, the same way the past participle lido does not look like its verb either. Uma leitura is also one interpretation of something." },
    ...
    },
    {
      ...
      items: [
        { id: "pt-u35l4-opassatempo", type: "vocab", front: "o passatempo", reading: "opassatempo", meaning: "hobby", example: { jp: "O passatempo de Ana é a leitura, mas ao domingo também joga futebol.", en: "Ana's hobby is reading, but on Sundays she also plays football." }, drill: { jp: "O passatempo de Ana é a leitura", en: "Ana's hobby is reading" }, accept: ["pastime", "the hobby", "interest"], hint: "pa-sa-TEM-pu — literally \"pass-time\", built from passar and o tempo, exactly as English built \"pastime\". Portugal also says um hobby, said the English way, but passatempo is the word on a form." },
