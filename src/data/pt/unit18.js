  ...
  lessons: [
    {
      ...
      cefr: "A1",
      dominantMode: "recall",
      canDo: "Talk about a Portuguese workplace — say who you work with, who is in charge, when the meeting is and what the hours are.",
      items: [
        { id: "pt-u18l1-ohorario", type: "vocab", front: "o horário", reading: "ohorario", meaning: "schedule", example: { jp: "O horário da reunião é às dez.", en: "The meeting's schedule is at ten." }, drill: { jp: "O horário do comboio é importante", en: "The train schedule is important" }, accept: ["the schedule", "timetable", "working hours", "opening hours"], hint: "o-RÁ-riu. Built on a hora from Unit 5 but a different word — a hora is an hour, o horário is the timetable the hours are arranged into. It is also what is posted on a shop door or a train platform." },
        { id: "pt-u18l1-aentrevista", type: "vocab", front: "a entrevista", reading: "aentrevista", meaning: "interview", example: { jp: "A entrevista de Ana é amanhã, às nove.", en: "Ana's interview is tomorrow, at nine." }, drill: { jp: "A entrevista de Ana é amanhã", en: "Ana's interview is tomorrow" }, accept: ["the interview", "job interview"], hint: "en-tre-VISH-ta. A job interview and a press interview both. Take it apart and it is entre (between) plus a form of ver (to see) — a seeing-between, exactly the image inside English \"interview\"." },
        { id: "pt-u18l1-ochefe", type: "vocab", front: "o chefe", reading: "ochefe", meaning: "boss", example: { jp: "O chefe de Tiago é português.", en: "Tiago's boss is Portuguese." }, drill: { jp: "O chefe de Tiago é português", en: "Tiago's boss is Portuguese" }, accept: ["the boss", "chief", "head", "manager"], hint: "SHE-fe, ch as sh. Boss, head or chief — and in a kitchen, the chef. The spelling does not change for a woman: a chefe, with only the article moving." },
        { id: "pt-u18l1-ocolega", type: "vocab", front: "o colega", reading: "ocolega", meaning: "colleague", example: { jp: "O colega de Ana também é médico.", en: "Ana's colleague is also a doctor." }, drill: { jp: "O colega de Ana é médico", en: "Ana's colleague is a doctor" }, accept: ["the colleague", "workmate", "coworker", "co-worker"], hint: "ku-LE-ga. It ends in -a but takes o for a man: o colega, a colega. A small family of nouns works like this, where the article alone carries the gender. A schoolmate is um colega de turma, from Unit 17." },
        { id: "pt-u18l1-aempresa", type: "vocab", front: "a empresa", reading: "aempresa", meaning: "company", example: { jp: "A empresa é enorme e o escritório é em Lisboa.", en: "The company is enormous and the office is in Lisbon." }, drill: { jp: "A empresa de Tiago é enorme", en: "Tiago's company is enormous" }, accept: ["the company", "firm", "business", "enterprise"], hint: "em-PRE-za, s between vowels saying z. Any business at all. Do not let English \"enterprise\" pull it toward something grander — this is the everyday word, and Spanish empresa matches it exactly." },
        { id: "pt-u18l1-areuniao", type: "vocab", front: "a reunião", reading: "areuniao", meaning: "meeting", example: { jp: "A reunião de hoje é às dez.", en: "Today's meeting is at ten." }, drill: { jp: "A reunião de hoje é às dez", en: "Today's meeting is at ten" }, accept: ["the meeting", "gathering"], hint: "rreu-ni-AWNG — opening on the strong throat-r of a rua and closing on the -ão nasal of o pão. The plural makes the õe swap from Unit 1: as reuniões." },
      ],
    },
    {
      id: "pt-u18l2",
    ...
    },
    {
      ...
      items: [
        { id: "pt-u18l3-ganhar", type: "vocab", front: "ganhar", reading: "ganhar", meaning: "to earn", example: { jp: "Trabalhar e ganhar dinheiro em Lisboa.", en: "To work and earn money in Lisbon." }, drill: { jp: "Ganhar dinheiro é importante", en: "Earning money is important" }, accept: ["earn", "to win", "win", "to gain"], hint: "ga-NYAR, with nh: ganho, ganhas, ganha. One verb for earning money AND winning a game — ganhar o jogo — so payday and the football result share a word." },
        { id: "pt-u18l3-gastar", type: "vocab", front: "gastar", reading: "gastar", meaning: "to spend", example: { jp: "Gastar dinheiro na loja de roupa.", en: "To spend money in the clothes shop." }, drill: { jp: "Gastar dinheiro na loja de roupa", en: "To spend money in the clothes shop" }, accept: ["spend", "to use up", "to waste"], hint: "gash-TAR: gasto, gastas, gasta. Money and time both — gastar dinheiro, gastar tempo. Spanish gastar is the same verb doing the same job, so this one carries over intact. Its opposite is poupar, next." },
        { id: "pt-u18l3-poupar", type: "vocab", front: "poupar", reading: "poupar", meaning: "to save", example: { jp: "Poupar dinheiro é importante.", en: "Saving money is important." }, drill: { jp: "Poupar dinheiro é fantástico", en: "Saving money is fantastic" }, accept: ["save", "to save up", "to economise", "to economize"], hint: "POH-par: poupo, poupas, poupa — ou is a single \"oh\" sound. Spanish offers no help here at all, since it says ahorrar, so poupar has to be learned outright. Savings are as poupanças." },
        { id: "pt-u18l3-osalario", type: "vocab", front: "o salário", reading: "osalario", meaning: "salary", example: { jp: "O salário do médico não é o salário do professor.", en: "The doctor's salary isn't the teacher's salary." }, drill: { jp: "O salário do médico é enorme", en: "The doctor's salary is enormous" }, accept: ["the salary", "wage", "pay", "wages"], hint: "sa-LA-riu, the -ário ending once more. Portugal says o ordenado just as often for the same thing, and o vencimento on official paperwork. The minimum wage is o salário mínimo." },
        { id: "pt-u18l3-aconta", type: "vocab", front: "a conta", reading: "aconta", meaning: "bill", example: { jp: "A conta, por favor!", en: "The bill, please!" }, drill: { jp: "A conta do restaurante é enorme", en: "The restaurant bill is enormous" }, accept: ["the bill", "account", "check", "the check", "bank account"], hint: "KON-ta. Memorise the whole sentence — a conta, por favor — because it is how every Portuguese meal ends. It is also a bank account (uma conta no banco), and the verb contar means both to count and to tell a story." },
        { id: "pt-u18l3-afatura", type: "vocab", front: "a fatura", reading: "afatura", meaning: "invoice", example: { jp: "A fatura da loja é de dez euros.", en: "The shop's invoice is ten euros." }, drill: { jp: "A fatura da loja é de dez euros", en: "The shop's invoice is ten euros" }, accept: ["the invoice", "receipt", "the receipt", "bill"], hint: "fa-TU-ra. You will be asked fatura com contribuinte? at almost every till in the country — whether to print your tax number on the receipt, which is a genuinely national habit. Note the post-1990 spelling: fatura, no c." },
      ],
    },
    {
      id: "pt-u18l4",
