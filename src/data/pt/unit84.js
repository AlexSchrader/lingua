  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u84l1-localizar", type: "vocab", front: "localizar", reading: "localizar", meaning: "to locate", example: { jp: "O pai localizou o livro no fundo da caixa.", en: "My father located the book at the bottom of the box." }, drill: { jp: "Vou localizar o livro na escola", en: "I'm going to locate the book at the school" }, accept: ["locate", "to locate", "to find", "to track down", "to pinpoint"], hint: "lu-ka-li-ZAR, from o local. Finding WHERE a thing is, rather than finding it at all — a phone, a file, a person on a map. A localização is the location." },
        { id: "pt-u84l1-apesquisa", type: "vocab", front: "a pesquisa", reading: "apesquisa", meaning: "research (a search)", example: { jp: "A pesquisa do jornal aumentou a informação sobre o caso.", en: "The paper's research increased the information about the case." }, drill: { jp: "A pesquisa do jornal foi grande", en: "The paper's research was extensive" }, accept: ["the research", "research", "the search", "search"], hint: "pesh-KEE-za. Academic research and an internet search alike — fazer uma pesquisa covers both. Pesquisar is the verb, built straight off it." },
