  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u84l1-encontrar", type: "vocab", front: "encontrar", reading: "encontrar", meaning: "to find", example: { jp: "O pai encontrou o parafuso no fundo da caixa da escada.", en: "My father found the screw at the bottom of the box on the stairs." }, drill: { jp: "Vou encontrar o livro na escola", en: "I'm going to find the book at the school" }, accept: ["find", "to find", "to come across", "to meet", "to locate"], hint: "en-kon-TRAR. The result where procurar is the act. Reflexively it means to meet: encontrámo-nos no café — and um encontro is both a meeting and a date." },
        { id: "pt-u84l1-apesquisa", type: "vocab", front: "a pesquisa", reading: "apesquisa", meaning: "research", example: { jp: "A pesquisa do estudo novo aumentou a informação sobre a cidade.", en: "The new study's research increased the information about the city." }, drill: { jp: "A pesquisa do estudo foi grande", en: "The study's research was extensive" }, accept: ["the research", "research", "the search", "search", "survey"], hint: "pesh-KEE-za. Academic research and an internet search alike — fazer uma pesquisa covers both. Pesquisar is the verb, built straight off it." },
        { id: "pt-u84l1-investigar", type: "vocab", front: "investigar", reading: "investigar", meaning: "to investigate", example: { jp: "O jornal investigou o caso da empresa durante um ano.", en: "The paper investigated the company's case for a year." }, drill: { jp: "O jornal vai investigar o caso", en: "The paper is going to investigate the case" }, accept: ["investigate", "to investigate", "to look into", "to probe", "to research"], hint: "in-vesh-ti-GAR. Police, journalists and scientists all investigam. Um investigador is both a detective and a research scientist, which tells you how the language sees the job." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u84l2-oinquerito", type: "vocab", front: "o inquérito", reading: "oinquerito", meaning: "survey", example: { jp: "O inquérito da escola diz que a turma quer mais aulas de música.", en: "The school's survey says that the class wants more music lessons." }, drill: { jp: "O inquérito da escola diz tudo", en: "The school's survey says everything" }, accept: ["the survey", "survey", "inquiry", "the inquiry", "poll"], hint: "in-KE-ri-tu. A questionnaire or an official inquiry — responder a um inquérito. Portuguese keeps it for the formal thing; a casual poll among friends is uma sondagem." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u84l3-confirmar", type: "vocab", front: "confirmar", reading: "confirmar", meaning: "to confirm", example: { jp: "A escola confirmou a data do teste por email.", en: "The school confirmed the date of the test by email." }, drill: { jp: "A escola vai confirmar a data", en: "The school is going to confirm the date" }, accept: ["confirm", "to confirm", "to acknowledge", "to back up"], hint: "kon-fir-MAR, built on firme, firm — you make the thing firm. Confirmar a presença is to RSVP, the line at the bottom of every Portuguese invitation." },
        ...
        { id: "pt-u84l3-oerro", type: "vocab", front: "o erro", reading: "oerro", meaning: "mistake", example: { jp: "O erro do estudo foi a amostra pequena e ninguém reparou.", en: "The study's mistake was the small sample and nobody noticed." }, drill: { jp: "O erro do estudo foi a amostra", en: "The study's mistake was the sample" }, accept: ["the mistake", "mistake", "error", "the error", "slip"], hint: "E-rru, with the strong rr. Errar is to make a mistake — errar é humano. Note por erro means by mistake, where de propósito is on purpose." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u84l4-comparar", type: "vocab", front: "comparar", reading: "comparar", meaning: "to compare", example: { jp: "O estudo compara a vida na cidade com a vida na aldeia.", en: "The study compares life in the city with life in the village." }, drill: { jp: "Vou comparar a cidade com a aldeia", en: "I'm going to compare the city with the village" }, accept: ["compare", "to compare", "to contrast", "to liken"], hint: "kom-pa-RAR. Comparar A com B — with com, where English allows both with and to. Em comparação com is in comparison with, the written form." },
        { id: "pt-u84l4-oestudo", type: "vocab", front: "o estudo", reading: "oestudo", meaning: "study", example: { jp: "O estudo da escola sobre as horas de trabalho é novo.", en: "The school's study on working hours is new." }, drill: { jp: "O estudo da escola é novo", en: "The school's study is new" }, accept: ["the study", "study", "research", "survey", "paper"], hint: "esh-TOO-du, from estudar. A research study, and also the act of studying: o estudo é importante. Um estúdio, with the í, is a recording studio — different word, one letter apart." },
        { id: "pt-u84l4-concluir", type: "vocab", front: "concluir", reading: "concluir", meaning: "to conclude", example: { jp: "O jornal concluiu que a informação da empresa não era clara.", en: "The paper concluded that the company's information wasn't clear." }, drill: { jp: "O jornal vai concluir o estudo", en: "The paper is going to conclude the study" }, accept: ["conclude", "to conclude", "to come to a conclusion", "to finish", "to wrap up"], hint: "kon-klu-EER: concluo, concluis, conclui. Reaching a conclusion, and finishing a piece of work — concluir o curso is to graduate. A conclusão is the noun." },
        { id: "pt-u84l4-citar", type: "vocab", front: "citar", reading: "citar", meaning: "to quote", example: { jp: "A professora citou o estudo novo na aula de hoje.", en: "The teacher quoted the new study in today's lesson." }, drill: { jp: "A professora vai citar o estudo", en: "The teacher is going to quote the study" }, accept: ["quote", "to quote", "to cite", "cite", "to name"], hint: "si-TAR. Quoting a source by name — uma citação is the quotation. In court it also means to summon somebody, which is the older legal sense." },
        { id: "pt-u84l4-abase", type: "vocab", front: "a base", reading: "abase", meaning: "basis", example: { jp: "A base do estudo é o inquérito de cem pessoas da cidade.", en: "The basis of the study is the survey of a hundred people in the city." }, drill: { jp: "A base do estudo é o inquérito", en: "The basis of the study is the survey" }, accept: ["the basis", "basis", "the base", "base", "foundation", "grounds"], hint: "BA-ze. What a claim rests on. Com base em is on the basis of, the phrase a Portuguese report leans on, and uma base de dados is a database." },
      ],
    },
  ],
};
