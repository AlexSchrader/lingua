  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u37l1-querer", type: "vocab", front: "querer", reading: "querer", meaning: "to want", example: { jp: "Querer não é poder, como dizem os portugueses quando um projeto corre mal.", en: "Wanting is not being able, as the Portuguese say when a project goes wrong." }, drill: { jp: "Querer não é poder", en: "Wanting is not being able" }, accept: ["want", "to wish", "to love"], hint: "ke-RER, irregular: quero, queres, quer, queremos, querem. The drill is a real Portuguese proverb. Careful in a shop — quero um café is blunt; queria um café, the imperfect, is the polite form and is what people actually say." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u37l2-farei", type: "vocab", front: "farei", reading: "farei", meaning: "I will do", example: { jp: "Amanhã farei o jantar em casa, porque no restaurante está sempre cheio ao sábado.", en: "Tomorrow I will make dinner at home, because the restaurant is always full on Saturdays." }, drill: { jp: "Amanhã farei o jantar em casa", en: "Tomorrow I will make dinner at home" }, accept: ["i will make", "i shall do", "will do", "i'll do"], hint: "fa-RAY. -ei is the eu ending. Fazer is one of only THREE verbs with an irregular future stem — far-, diz- and traz- — so farei, not \"fazerei\". The other two are the next card and trazer." },
