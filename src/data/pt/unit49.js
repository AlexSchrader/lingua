  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u49l1-enviar", type: "vocab", front: "enviar", reading: "enviar", meaning: "to send", example: { jp: "Vou enviar a carta e o postal amanhã de manhã.", en: "I'm going to send the letter and the postcard tomorrow morning." }, drill: { jp: "Enviar a carta amanhã", en: "To send the letter tomorrow" }, accept: ["send", "to post", "to mail", "post"], hint: "en-vi-AR: envio, envias, envia. Mandar also means to send and is commoner in speech; enviar is a shade more formal and is what a form or a website will say." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u49l3-acandidatura", type: "vocab", front: "a candidatura", reading: "acandidatura", meaning: "application", example: { jp: "A candidatura de Tiago à universidade está no formulário.", en: "Tiago's application to the university is on the form." }, drill: { jp: "A candidatura está no formulário", en: "The application is on the form" }, accept: ["the application", "candidacy", "job application", "bid"], hint: "kan-di-da-TOO-ra. An application for a place or a job, where um requerimento is the formal written request to an office. The verb is reflexive — candidatar-se, with the pronoun on the end." },
      ],
    },
    {
      id: "pt-u49l4",
      ...
      cefr: "A2",
      dominantMode: "recognize",
      canDo: "Ask for something at a Portuguese counter, and complain properly when it goes wrong.",
      items: [
        ...
        { id: "pt-u49l4-atender", type: "vocab", front: "atender", reading: "atender", meaning: "to attend to", example: { jp: "O funcionário vai atender a fila e o balcão abre às nove.", en: "The official is going to see to the queue and the counter opens at nine." }, drill: { jp: "Atender a fila é o trabalho", en: "Seeing to the queue is the job" }, accept: ["attend to", "to serve", "to see to", "to answer"], hint: "a-ten-DER: atendo, atendes, atende. To see to someone — a customer, a patient, a queue. And it is ALSO how you answer a telephone: atende!, pick up. Never responder for a phone, as Unit 17 warned." },
