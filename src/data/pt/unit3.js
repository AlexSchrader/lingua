  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u3l3-oaniversario", type: "vocab", front: "o aniversário", reading: "oaniversario", meaning: "birthday", example: { jp: "Parabéns! Bom aniversário, Ana!", en: "Congratulations! Happy birthday, Ana!" }, drill: { jp: "O aniversário de Ana é fantástico", en: "Ana's birthday is fantastic" }, accept: ["the birthday", "anniversary"], hint: "Covers both a birthday and an anniversary. The everyday wish, though, is just Parabéns! — Portugal rarely says the longer phrase." },
