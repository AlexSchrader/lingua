  ...
  lessons: [
    {
      ...
      items: [
        { id: "pt-u78l1-reparar", type: "vocab", front: "reparar", reading: "reparar", meaning: "to notice (to spot)", example: { jp: "Reparei na luz da cozinha e vi que ninguém estava em casa.", en: "I noticed the kitchen light and saw that nobody was home." }, drill: { jp: "Vou reparar na luz da cozinha", en: "I'm going to notice the kitchen light" }, accept: ["notice", "to notice", "to spot", "spot", "to note"], hint: "rre-pa-RAR. With em it means to notice: reparaste no carro novo? Without em it means to repair — the same verb fixes a window and spots one, and that little em is what keeps them apart." },
        { id: "pt-u78l1-aperceberse", type: "vocab", front: "aperceber-se", reading: "aperceberse", meaning: "to realise", example: { jp: "Agora apercebi-me da diferença entre os dois nomes do livro.", en: "Now I've realised the difference between the two names in the book." }, drill: { jp: "Aperceber-se da diferença é difícil", en: "Realising the difference is hard" }, accept: ["realise", "to realise", "realize", "to realize", "to become aware"], hint: "a-per-se-BER-se, always reflexive and always with de: apercebi-me DO erro. It is the moment the thing arrives in your head, not the looking that got it there." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u78l3-otoque", type: "vocab", front: "o toque", reading: "otoque", meaning: "touch (contact)", example: { jp: "O toque da água fria na mão acorda qualquer pessoa de manhã.", en: "The touch of cold water on the hand wakes anyone up in the morning." }, drill: { jp: "O toque da água fria acorda qualquer pessoa", en: "The touch of cold water wakes anyone up" }, accept: ["the touch", "contact", "a touch", "ringtone", "the ring"], hint: "TO-ke, from tocar. The SENSE and the act of touching — this lesson's fourth sense, beside o sabor, o gosto and o paladar. Because tocar also rings and knocks, o toque is a phone's ringtone and a knock at a door as well." },
        { id: "pt-u78l3-opaladar", type: "vocab", front: "o paladar", reading: "opaladar", meaning: "sense of taste", example: { jp: "O paladar da criança muda com a idade e o sabor forte fica bom.", en: "A child's sense of taste changes with age and strong flavour becomes good." }, drill: { jp: "O paladar da criança muda muito", en: "A child's sense of taste changes a lot" }, accept: ["sense of taste", "palate", "the palate"], hint: "pa-la-DAR. The SENSE itself, where o sabor is what the food has and o gosto is what you make of it — three words where English stretches one." },
      ],
    },
    {
      id: "pt-u78l4",
