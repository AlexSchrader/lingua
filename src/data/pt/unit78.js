  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u78l1-notar", type: "vocab", front: "notar", reading: "notar", meaning: "to note", example: { jp: "A professora notou a diferença nas duas frases e explicou tudo à turma.", en: "The teacher noted the difference in the two sentences and explained everything to the class." }, drill: { jp: "Vou notar a diferença nas frases", en: "I'm going to note the difference in the sentences" }, accept: ["note", "to note", "notice", "to notice", "to observe"], hint: "nu-TAR. Cooler and more deliberate than reparar: you notice something and file it. Nota-se que… is the very Portuguese way of saying you can tell that something is the case." },
        ...
        { id: "pt-u78l1-reconhecer", type: "vocab", front: "reconhecer", reading: "reconhecer", meaning: "to recognise", example: { jp: "Reconheci a música logo na primeira aula e comecei a cantar.", en: "I recognised the music right in the first lesson and started singing." }, drill: { jp: "Reconhecer a música é sempre fácil", en: "Recognising the music is always easy" }, accept: ["recognise", "to recognise", "recognize", "to recognize", "to admit", "to acknowledge"], hint: "rre-ku-nye-SER, with the nh sound in the middle. Conhecer, to know, with re- putting it back together. It stretches to admitting you were wrong: reconheço que foi um erro." },
      ],
    },
    {
      id: "pt-u78l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u78l3-ocheiro", type: "vocab", front: "o cheiro", reading: "ocheiro", meaning: "smell", example: { jp: "O cheiro do café de manhã acorda a casa toda.", en: "The smell of coffee in the morning wakes the whole house." }, drill: { jp: "O cheiro do café é bom", en: "The smell of the coffee is good" }, accept: ["the smell", "smell", "scent", "odour", "aroma"], hint: "SHAY-ru. Neutral in Portuguese — a cheiro can be good or bad, and the adjective decides. Um cheirinho, the diminutive, is the little waft that pulls you into a pastelaria." },
    ...
    },
    {
      ...
      items: [
        { id: "pt-u78l4-aatencao", type: "vocab", front: "a atenção", reading: "aatencao", meaning: "attention", example: { jp: "A atenção da turma na aula da manhã é sempre melhor.", en: "The class's attention in the morning lesson is always better." }, drill: { jp: "A atenção da turma é melhor", en: "The class's attention is better" }, accept: ["the attention", "attention", "notice", "care"], hint: "a-ten-SOWN, nasal. Prestar atenção is to pay attention — Portuguese LENDS it where English pays it. On a sign, Atenção! on its own means watch out." },
