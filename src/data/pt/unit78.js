  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u78l1-aperceberse", type: "vocab", front: "aperceber-se", reading: "aperceberse", meaning: "to realise", example: { jp: "Agora apercebi-me da diferença entre os dois nomes do livro.", en: "Now I've realised the difference in the two names in the book." }, drill: { jp: "Aperceber-se da diferença é difícil", en: "Realising the difference is hard" }, accept: ["realise", "to realise", "realize", "to realize", "to become aware"], hint: "a-per-se-BER-se, always reflexive and always with de: apercebi-me DO erro. It is the moment the thing arrives in your head, not the looking that got it there." },
