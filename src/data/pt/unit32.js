  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u32l2-votar", type: "vocab", front: "votar", reading: "votar", meaning: "to vote", example: { jp: "Em Portugal pode votar quem já tem vinte anos de idade.", en: "In Portugal anyone who is already twenty years old can vote." }, drill: { jp: "Votar é um direito e um dever", en: "Voting is a right and a duty" }, accept: ["vote", "to cast a vote"], hint: "vu-TAR, regular -ar. Votar EM someone — voto no Tiago — with the contraction from Unit 12. Votar em branco, using branco from Unit 8, is to hand in a deliberately blank ballot, and Portugal counts those separately." },
        ...
        { id: "pt-u32l2-oimposto", type: "vocab", front: "o imposto", reading: "oimposto", meaning: "tax", example: { jp: "O imposto da gasolina subiu outra vez, e por isso o carro ficou muito caro.", en: "Fuel tax has gone up again, and so the car has become very expensive." }, drill: { jp: "O imposto é muito alto este ano", en: "The tax is very high this year" }, accept: ["the tax", "duty", "levy"], hint: "eem-POSH-tu. The one you meet daily is o IVA, Portugal's VAT, printed on every recibo. Note it is masculine even though it ends in -o after a nasal — imposto, not \"imposta\"." },
