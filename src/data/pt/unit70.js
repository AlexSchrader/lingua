  ...
  lessons: [
    {
      ...
      items: [
        { id: "pt-u70l1-visse", type: "vocab", front: "visse", reading: "visse", meaning: "(if it) saw", example: { jp: "Se visse o estado da casa, não pagava aquele preço, porque a cozinha precisa de obras.", en: "If he saw the state of the house, he would not pay that price, because the kitchen needs work." }, drill: { jp: "Se visse a casa não pagava tanto", en: "If he saw the house he would not pay so much" }, accept: ["saw", "if it saw", "were to see"], hint: "Imperfect subjunctive of ver — and the neighbour that catches everyone: VISSE is ver, VIESSE is vir. One letter, and the lesson on vir is three cards away." },
        ...
        { id: "pt-u70l1-podia", type: "vocab", front: "podia", reading: "podia", meaning: "could (would be able to)", example: { jp: "Se tivesse carro, podia ir ver a avó todas as semanas, mas o comboio só vai lá duas vezes por dia.", en: "If I had a car, I could go and see my grandmother every week, but the train only goes there twice a day." }, drill: { jp: "Se tivesse carro podia ver a avó", en: "If I had a car I could see my grandmother" }, accept: ["could", "was able", "would be able"], hint: "The other half of the pair — the imperfect of poder doing the conditional's job, which is what Portugal says. Poderia exists and sounds formal. Podia also softens a request: podia ajudar-me?" },
      ],
    },
    {
      id: "pt-u70l2",
