  ...
  lessons: [
    {
      ...
      items: [
        { id: "pt-u70l1-seeufosse", type: "vocab", front: "se eu fosse", reading: "seeufosse", meaning: "if I were", example: { jp: "Se eu fosse a ti, falava com o médico antes de decidir alguma coisa.", en: "If I were you, I would talk to the doctor before deciding anything." }, drill: { jp: "Se eu fosse a ti falava com ele", en: "If I were you I would talk to him" }, accept: ["if I were", "if I was", "if I were you"], hint: "Se eu fosse A TI, not \"no teu lugar\" — Portuguese puts the person after a. Note the second half here is falava, the imperfect indicative: that is what Portugal actually says, where the written language would use falaria." },
        { id: "pt-u70l1-fosse", type: "vocab", front: "fosse", reading: "fosse", meaning: "(if it) were", example: { jp: "Se a casa fosse maior, ficávamos todos lá no domingo, mas assim não é fácil.", en: "If the house were bigger, we would all stay there on Sunday, but as it is, it is not easy." }, drill: { jp: "Se a casa fosse maior ficávamos todos", en: "If the house were bigger we would all stay" }, accept: ["were", "was", "if it were", "went"], hint: "Imperfect subjunctive of BOTH ser and ir — the two verbs share it, and only the sentence tells you which. Se fosse rico (ser) versus se fosse a Lisboa (ir)." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u70l4-sesoubesse", type: "vocab", front: "se soubesse", reading: "sesoubesse", meaning: "if I had known", example: { jp: "Se soubesse que a estrada estava fechada, tinha ido de comboio.", en: "If I had known the road was closed, I would have gone by train." }, drill: { jp: "Se soubesse que a estrada estava fechada", en: "If I had known the road was closed" }, accept: ["if I had known", "had I known", "if I knew"], hint: "Carded as a chunk because it is one: the single commonest regret-opener in spoken Portuguese, and it takes tinha ido rather than teria ido in almost every real mouth." },
      ],
    },
  ],
};
