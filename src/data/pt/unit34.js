  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u34l1-anatureza", type: "vocab", front: "a natureza", reading: "anatureza", meaning: "nature", example: { jp: "A natureza do campo é tranquila, mas na cidade quase não há árvores.", en: "The countryside's nature is peaceful, but in the city there are almost no trees." }, drill: { jp: "A natureza do campo é tranquila", en: "The countryside's nature is peaceful" }, accept: ["the nature", "the natural world", "wildlife"], hint: "na-tu-RE-za, with the s of the spelling said as a z — the same rule as a casa in Unit 1. It also means someone's essential nature, which is close to o feitio from Unit 31 but colder and less personal." },
        { id: "pt-u34l1-apoluicao", type: "vocab", front: "a poluição", reading: "apoluicao", meaning: "pollution", example: { jp: "A poluição da cidade é enorme, especialmente quando faz calor e não faz vento.", en: "The city's pollution is enormous, especially when it is hot and there is no wind." }, drill: { jp: "A poluição da cidade é enorme", en: "The city's pollution is enormous" }, accept: ["the pollution", "contamination"], hint: "pu-lwi-SAWNG. Another -ção noun and so feminine — by now that ending should be doing the gender work for you without being checked. Do not confuse it with a população from Unit 32: one letter apart, two very different words." },
    ...
    },
    {
      ...
      items: [
        { id: "pt-u34l3-aciencia", type: "vocab", front: "a ciência", reading: "aciencia", meaning: "science", example: { jp: "A ciência explica muitas coisas, mas não explica porque é que as pessoas não acreditam nela.", en: "Science explains many things, but it doesn't explain why people don't believe it." }, drill: { jp: "A ciência explica muitas coisas", en: "Science explains many things" }, accept: ["the science", "knowledge"], hint: "si-EN-si-a — that first c is soft before i, and the two c's in the word say different things only because of the vowel after them. As ciências, plural, is the school subject." },
