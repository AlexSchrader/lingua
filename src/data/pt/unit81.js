  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u81l1-firme", type: "vocab", front: "firme", reading: "firme", meaning: "firm", example: { jp: "A mesa nova é firme e o prato pesado fica bem ali.", en: "The new table is firm and the heavy plate sits well on it." }, drill: { jp: "A mesa nova é firme", en: "The new table is firm" }, accept: ["firm", "steady", "solid", "stable", "unwavering"], hint: "FEER-me. It does not move when pushed — a table, a hand, a decision. Manter-se firme is to stand your ground, and passo firme is a steady step." },
      ],
    },
    {
      id: "pt-u81l2",
      ...
      items: [
        { id: "pt-u81l2-fragil", type: "vocab", front: "frágil", reading: "fragil", meaning: "fragile", example: { jp: "O vidro da janela é frágil e parte-se com o vento.", en: "The window glass is fragile and breaks in the wind." }, drill: { jp: "O vidro da janela é frágil", en: "The window glass is fragile" }, accept: ["fragile", "delicate", "brittle", "weak"], hint: "FRA-zhil, stress on the first syllable. Frágil is stamped on parcels. Of a person it means frail or in a delicate state, where fraco, which you know, is simply weak." },
        ...
        { id: "pt-u81l2-quebrar", type: "vocab", front: "quebrar", reading: "quebrar", meaning: "to break", example: { jp: "O vidro fino quebrou com o vento forte da noite.", en: "The thin glass broke in the strong wind during the night." }, drill: { jp: "O vidro fino vai quebrar", en: "The thin glass is going to break" }, accept: ["to break", "to snap", "to shatter", "to smash"], hint: "ke-BRAR. Clean breaking into pieces, where rachar only cracks. In Portugal partir does much of this work in speech; quebrar is the written and technical one, and quebrar um recorde is to break a record." },
      ],
    },
    {
      id: "pt-u81l3",
      ...
      items: [
        ...
        { id: "pt-u81l3-rigido", type: "vocab", front: "rígido", reading: "rigido", meaning: "rigid", example: { jp: "O vidro da janela é rígido, mas o fio do telemóvel é flexível.", en: "The glass in the window is rigid, but the mobile's cable is flexible." }, drill: { jp: "O vidro da janela é rígido", en: "The glass in the window is rigid" }, accept: ["stiff", "hard", "inflexible", "strict"], hint: "RREE-zhi-du. The exact opposite of flexível, and this lesson is about material: vidro rígido, plástico rígido. The same word does the human sense too — um professor rígido, regras rígidas." },
