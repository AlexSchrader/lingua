  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u81l1-estavel", type: "vocab", front: "estável", reading: "estavel", meaning: "steady", example: { jp: "A cadeira nova é estável e ninguém cai dela.", en: "The new chair is steady and nobody falls off it." }, drill: { jp: "A cadeira nova é estável", en: "The new chair is steady" }, accept: ["stable", "steady", "firm", "settled"], hint: "esh-TA-vel. It does not wobble — and it does not swing about: um emprego estável is a steady job, o tempo está estável is settled weather. Instável is its opposite." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u81l2-falhar", type: "vocab", front: "falhar", reading: "falhar", meaning: "to fail", example: { jp: "A luz da cozinha falhou a noite toda e ninguém dormiu.", en: "The kitchen light failed all night and nobody slept." }, drill: { jp: "A luz da cozinha vai falhar", en: "The kitchen light is going to fail" }, accept: ["fail", "to fail", "to go out", "to miss", "to break down"], hint: "fa-LYAR, lh. Power, brakes and plans all falham. Falhar um exame is to fail an exam, and sem falha means without fail." },
