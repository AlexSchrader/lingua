  ...
  lessons: [
    {
      ...
      items: [
        { id: "pt-u20l1-asferias", type: "vocab", front: "as férias", reading: "asferias", meaning: "holidays", example: { jp: "As férias de Ana são em Portugal.", en: "Ana's holidays are in Portugal." }, accept: ["the holidays", "holiday", "vacation", "the vacation", "holidays"], hint: "FE-riash. ALWAYS PLURAL, like as calças in Unit 16 — as férias, never \"a féria\". Estar de férias is to be on holiday. A single public holiday is um feriado, a different word entirely." },
        ...
        { id: "pt-u20l1-amala", type: "vocab", front: "a mala", reading: "amala", meaning: "suitcase", example: { jp: "A mala de Ana não é enorme.", en: "Ana's suitcase isn't enormous." }, accept: ["the suitcase", "bag", "case", "luggage"], hint: "MA-la. SPANISH TRAP, and a sharp one — in Spanish mala is simply the feminine of \"bad\", while Spanish for a suitcase is una maleta. Here a mala is the suitcase, and packing is fazer as malas." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u20l2-nadar", type: "vocab", front: "nadar", reading: "nadar", meaning: "to swim", example: { jp: "Nadar no mar é fantástico.", en: "Swimming in the sea is fantastic." }, accept: ["swim", "to go swimming"], hint: "na-DAR: nado, nadas, nada. Careful — nada, spelled identically, is also the word for \"nothing\", which you already met inside de nada in Unit 2. Ele nada is he swims; ele não faz nada is he does nothing." },
        { id: "pt-u20l2-obarco", type: "vocab", front: "o barco", reading: "obarco", meaning: "boat", example: { jp: "O barco de Lisboa não é rápido.", en: "The Lisbon boat isn't rapid." }, accept: ["the boat", "ship", "vessel"], hint: "BAR-ku. One letter from o banco in Unit 7, so keep them apart: a boat and a bank. The Douro's flat-bottomed wine boats are os barcos rabelos; a large ship is um navio." },
        { id: "pt-u20l2-opolvo", type: "vocab", front: "o polvo", reading: "opolvo", meaning: "octopus", example: { jp: "O polvo é delicioso e não é caro.", en: "The octopus is delicious and isn't expensive." }, accept: ["the octopus"], hint: "SPANISH TRAP. POL-vu. Here it is OCTOPUS — polvo à lagareiro, roasted whole with olive oil and garlic, is a dish Portugal is genuinely proud of. In SPANISH polvo means DUST, and Spanish for octopus is pulpo. One letter, and you have ordered dust." },
      ],
    },
    {
      id: "pt-u20l3",
      ...
      items: [
        ...
        { id: "pt-u20l3-voar", type: "vocab", front: "voar", reading: "voar", meaning: "to fly", example: { jp: "Voar é mais rápido, e o comboio é mais barato.", en: "Flying is faster, and the train is cheaper." }, accept: ["fly", "to take off"], hint: "vu-AR: voo, voas, voa. That voo, with its two o's side by side, is also the noun — um voo is a flight. It means to fly in the air only; for the journey itself Portuguese says ir de avião." },
        { id: "pt-u20l3-chegar", type: "vocab", front: "chegar", reading: "chegar", meaning: "to arrive", example: { jp: "Chegar ao aeroporto às nove.", en: "To arrive at the airport at nine." }, accept: ["arrive", "to get to", "to reach", "reach"], hint: "she-GAR, ch as sh: chego, chegas, chega. Arriving AT a place takes a, which fuses with the article — chegar ao aeroporto, chegar à praia. The arrivals board reads CHEGADAS, and Chega! on its own means \"enough!\"" },
        { id: "pt-u20l3-omapa", type: "vocab", front: "o mapa", reading: "omapa", meaning: "map", example: { jp: "O mapa de Portugal é da biblioteca.", en: "The map of Portugal is from the library." }, accept: ["the map", "chart"], hint: "MA-pa. MASCULINE in spite of the -a, exactly like o cinema and o problema — o mapa, never \"a mapa\". This one catches learners constantly, because almost everything else ending in -a is feminine." },
    ...
    },
    {
      ...
      items: [
        { id: "pt-u20l4-ficar", type: "vocab", front: "ficar", reading: "ficar", meaning: "to stay", example: { jp: "Ficar em casa de Ana no fim de semana.", en: "To stay at Ana's house at the weekend." }, accept: ["stay", "to remain", "remain", "to be located", "to become"], hint: "fi-KAR: fico, ficas, fica. To stay or remain — and, very usefully, to BE LOCATED. Onde fica a estação? is how a Portuguese person actually asks where something is, more often than onde é. It also means to become." },
