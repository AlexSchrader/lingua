...
// Unit 45), and a costa (coastline) against as costas (your back). a serra's
// example says Portugal CONTINENTAL: the country's highest point is Pico, Azores.
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u46l2-aserra", type: "vocab", front: "a serra", reading: "aserra", meaning: "mountain range", example: { jp: "A serra da Estrela é a montanha mais alta do continente.", en: "The Serra da Estrela is the highest mountain on the mainland." }, drill: { jp: "A serra da Estrela é alta", en: "The Serra da Estrela is high" }, accept: ["the mountain range", "range", "sierra", "mountains"], hint: "SE-rra, strong double rr. The highest ground on the mainland; the country's true summit is Pico, in the Azores. A mountain RANGE — and this is the word Portuguese maps and road signs actually use, far more often than montanha. Serra also means a saw, which is exactly the image: a toothed ridge." },
        { id: "pt-u46l2-acosta", type: "vocab", front: "a costa", reading: "acosta", meaning: "coast", example: { jp: "A costa de Portugal é comprida e o mar é frio no inverno.", en: "Portugal's coast is long and the sea is cold in winter." }, drill: { jp: "A costa de Portugal é comprida", en: "Portugal's coast is long" }, accept: ["the coast", "coastline", "shore", "seaside"], hint: "KOSH-ta — over 900 kilometres of it on the mainland alone. Careful with the plural: as costas is your BACK, the body word. Same spelling, and only the number tells you which one is meant." },
    ...
    },
    {
      ...
      items: [
        { id: "pt-u46l3-afronteira", type: "vocab", front: "a fronteira", reading: "afronteira", meaning: "border", example: { jp: "A fronteira de Portugal com Espanha é comprida e tranquila.", en: "Portugal's border with Spain is long and quiet." }, drill: { jp: "A fronteira de Portugal é comprida", en: "Portugal's border is long" }, accept: ["the border", "frontier", "boundary"], hint: "fron-TAY-ra. Portugal's border with Spain has barely moved since 1297, which makes it one of the oldest in the world. The old country word for that same line is a raia." },
