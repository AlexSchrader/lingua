  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u21l2-esperar", type: "vocab", front: "esperar", reading: "esperar", meaning: "to wait", example: { jp: "Esperei o autocarro vinte minutos debaixo da chuva.", en: "I waited for the bus twenty minutes in the rain." }, drill: { jp: "Esperar o autocarro todos os dias", en: "Waiting for the bus every day" }, accept: ["wait", "to hope", "hope", "expect"], hint: "Two meanings in one verb: to wait and to hope. Espero que sim means I hope so. Unlike English it takes no preposition — espero o autocarro, never espero por... in everyday speech." },
    ...
    },
    {
      ...
      items: [
        { id: "pt-u21l4-mas", type: "vocab", front: "mas", reading: "mas", meaning: "but", example: { jp: "Queria ir à praia mas o tempo piorou durante a manhã.", en: "I wanted to go to the beach but the weather got worse during the morning." }, drill: { jp: "Queria ir mas o tempo piorou", en: "I wanted to go but the weather worsened" }, accept: ["however", "yet", "though"], hint: "MASH. The everyday contrast word. Do not confuse it with mais from Unit 1 — one letter apart, and in fast speech only the vowel separates them." },
        { id: "pt-u21l4-ou", type: "vocab", front: "ou", reading: "ou", meaning: "or", example: { jp: "Podemos ir de comboio ou apanhar o autocarro das nove.", en: "We can go by train or catch the nine o'clock bus." }, drill: { jp: "De comboio ou de autocarro", en: "By train or by bus" }, accept: ["either", "otherwise"], hint: "OH. Doubled it becomes either-or: ou de comboio ou de carro. Note it never takes an accent, unlike the French où." },
        { id: "pt-u21l4-entao", type: "vocab", front: "então", reading: "entao", meaning: "so", example: { jp: "Estava a chover, então ficámos em casa a ver um filme.", en: "It was raining, so we stayed at home watching a film." }, drill: { jp: "Estava a chover então ficámos", en: "It was raining so we stayed" }, accept: ["then", "in that case", "well then"], hint: "en-TAWNG, two nasals. It concludes and it also opens a sentence conversationally — Então? on its own means so, what's happening?" },
        { id: "pt-u21l4-alemdisso", type: "vocab", front: "além disso", reading: "alemdisso", meaning: "besides", example: { jp: "O hotel era caro e além disso ficava longe do centro.", en: "The hotel was expensive and besides it was far from the centre." }, drill: { jp: "É muito caro além disso", en: "It is very expensive besides that" }, accept: ["moreover", "furthermore", "in addition", "what's more"], hint: "a-LAING-dee-su. Literally beyond that. Além de is beyond or in addition to, and o Além is the hereafter — the same word doing heavy work." },
        { id: "pt-u21l4-noentanto", type: "vocab", front: "no entanto", reading: "noentanto", meaning: "however", example: { jp: "O exame foi difícil, no entanto consegui uma boa nota.", en: "The exam was hard, however I managed a good mark." }, drill: { jp: "O exame foi difícil no entanto passei", en: "The exam was hard however I passed" }, accept: ["nevertheless", "nonetheless", "even so", "yet"], hint: "Three syllables and a fixed phrase. It is a shade more formal than mas and sits at the start of a clause, where mas joins two directly." },
        { id: "pt-u21l4-porisso", type: "vocab", front: "por isso", reading: "porisso", meaning: "that's why", example: { jp: "Perdi o comboio, por isso cheguei atrasado à reunião.", en: "I missed the train, that's why I arrived late for the meeting." }, drill: { jp: "Perdi o comboio por isso cheguei tarde", en: "I missed the train so I arrived late" }, accept: ["so", "therefore", "for that reason"], hint: "Built on por and isso from Unit 1. It is the everyday spoken cousin of portanto, which belongs more to writing." },
      ],
    },
  ],
};
