  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u83l4-olimite", type: "vocab", front: "o limite", reading: "olimite", meaning: "limit", example: { jp: "O limite do jardim fica onde começa a rua.", en: "The boundary of the garden is where the street begins." }, drill: { jp: "O limite do jardim fica ali", en: "The boundary of the garden is there" }, accept: ["the limit", "limit", "boundary", "the boundary", "border"], hint: "li-MEE-te. A physical boundary and a limit you must not pass — o limite de velocidade. Sem limites is limitless, and é o limite! is that's the last straw." },
        ...
        { id: "pt-u83l4-azona", type: "vocab", front: "a zona", reading: "azona", meaning: "area", example: { jp: "A zona perto do mar é mais calma do que o centro da cidade.", en: "The area near the sea is calmer than the city centre." }, drill: { jp: "A zona perto do mar é calma", en: "The area near the sea is calm" }, accept: ["the area", "area", "zone", "the zone", "district"], hint: "ZO-na. A part of a town, a country or a body. Zona azul is paid street parking in Portuguese cities, and a zona histórica is the old quarter." },
        { id: "pt-u83l4-oconjunto", type: "vocab", front: "o conjunto", reading: "oconjunto", meaning: "set", example: { jp: "O conjunto de cadeiras da cozinha é da casa do avô.", en: "The set of kitchen chairs is from my grandfather's house." }, drill: { jp: "O conjunto de cadeiras é novo", en: "The set of chairs is new" }, accept: ["the set", "set", "group", "the group", "collection", "outfit"], hint: "kon-ZHOON-tu. A set of things that go together — chairs, clothes, or a band. Em conjunto means together, as a whole: trabalhar em conjunto." },
