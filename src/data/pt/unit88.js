...
export const PT_UNIT88 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "pt-u88l4-porconseguinte", type: "vocab", front: "por conseguinte", reading: "porconseguinte", meaning: "consequently", example: { jp: "O raciocínio está errado e, por conseguinte, tudo o que o livro diz a seguir cai.", en: "The reasoning is wrong and, consequently, everything the book says afterwards falls." }, drill: { jp: "O raciocínio está errado por conseguinte tudo cai", en: "The reasoning is wrong consequently everything falls" }, accept: ["consequently", "therefore", "hence", "accordingly", "as a result"], hint: "The written cousin of portanto (u29), which you already have. Portanto is what you SAY; por conseguinte is what a report, a ruling or an essay writes. Using it in conversation sounds like reading aloud." },
