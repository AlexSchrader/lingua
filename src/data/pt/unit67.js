...
export const PT_UNIT67 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "pt-u67l3-aansiedade", type: "vocab", front: "a ansiedade", reading: "aansiedade", meaning: "anxiety", example: { jp: "A ansiedade antes de uma entrevista é normal, no entanto para algumas pessoas nunca passa.", en: "Anxiety before an interview is normal; for some people, however, it never goes away." }, drill: { jp: "A ansiedade antes da entrevista é normal", en: "Anxiety before the interview is normal" }, accept: ["anxiety", "the anxiety", "nervousness"], hint: "an-see-uh-DAH-duh. The clinical word and the everyday one. Estar ansioso is to be anxious — or, in a good way, eager: estou ansioso por te ver." },
