  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u67l3-odescanso", type: "vocab", front: "o descanso", reading: "odescanso", meaning: "rest", example: { jp: "O descanso é parte do tratamento, mas quase ninguém consegue descansar uma semana inteira.", en: "Rest is part of the treatment, but almost nobody manages to rest for a whole week." }, drill: { jp: "O descanso é parte do tratamento", en: "Rest is part of the treatment" }, accept: ["rest", "the rest", "a lie-down"], hint: "desh-KAN-su. The noun of descansar (u11). Um dia de descanso is a day off; o descanso do jogo is half-time." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u67l4-ovicio", type: "vocab", front: "o vício", reading: "ovicio", meaning: "bad habit", example: { jp: "O café é o vício dele: bebe seis por dia e dorme mal.", en: "Coffee is his vice: he drinks six a day and sleeps badly." }, drill: { jp: "O vício dele é o café", en: "His vice is coffee" }, accept: ["vice", "addiction", "the habit", "bad habit"], hint: "VEE-syu. Lighter than English \"vice\" — um vício can be chocolate. For the medical sense Portuguese uses a dependência, the next card." },
