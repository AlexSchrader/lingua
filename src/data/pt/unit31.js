  ...
  lessons: [
    {
      ...
      items: [
        { id: "pt-u31l1-apersonalidade", type: "vocab", front: "a personalidade", reading: "apersonalidade", meaning: "personality", example: { jp: "A personalidade da Ana é muito forte, mas ela é sempre educada.", en: "Ana's personality is very strong, but she is always polite." }, drill: { jp: "A personalidade da Ana é forte", en: "Ana's personality is strong" }, accept: ["the personality", "character"], hint: "per-su-na-li-DA-de, six syllables, stress right at the end like every -dade word — a cidade, a idade, a qualidade. It is the formal word; the everyday one is the next card." },
        { id: "pt-u31l1-ofeitio", type: "vocab", front: "o feitio", reading: "ofeitio", meaning: "nature (someone's disposition)", example: { jp: "O Tiago tem muito bom feitio e nunca fica zangado com a família.", en: "Tiago has a very good nature and never gets angry with his family." }, drill: { jp: "O feitio do Tiago é bom", en: "Tiago's nature is good" }, accept: ["temperament", "disposition", "character", "the nature"], hint: "fay-TEE-u. THE word this unit exists for — Portugal says ter bom feitio and ter mau feitio far more often than it says personalidade, and neither English nor Brazil has a clean match. Literally it is the \"make\" of a person, from feito." },
        ...
        { id: "pt-u31l1-timido", type: "vocab", front: "tímido", reading: "timido", meaning: "shy", example: { jp: "O irmão da Ana é tímido e quase não fala com os outros.", en: "Ana's brother is shy and hardly speaks with others." }, drill: { jp: "O irmão da Ana é tímido", en: "Ana's brother is shy" }, accept: ["timid", "bashful", "reserved"], hint: "TEE-mi-du, stress on the first syllable — the accent tells you. Feminine tímida. It goes with SER, because it is what someone is; estar tímido would mean they have gone shy just for now." },
