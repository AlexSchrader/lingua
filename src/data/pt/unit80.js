  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u80l4-oparentesco", type: "vocab", front: "o parentesco", reading: "oparentesco", meaning: "family tie", example: { jp: "O parentesco das duas famílias da aldeia é antigo.", en: "The family tie of the two village families is an old one." }, drill: { jp: "Ninguém sabe o parentesco entre eles", en: "Nobody knows the family connection between them" }, accept: ["the relationship", "family tie", "kinship", "the kinship", "relation"], hint: "pa-ren-TESH-ku, from os parentes, relatives. The blood relation itself — ter parentesco com is to be related to. Note os parentes are relatives, never parents, who are os pais." },
      ],
    },
  ],
};
