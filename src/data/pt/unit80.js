  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u80l2-sustentar", type: "vocab", front: "sustentar", reading: "sustentar", meaning: "to support", example: { jp: "O pai sustentou a família toda com o trabalho no campo.", en: "My father supported the whole family with work in the fields." }, drill: { jp: "O pai vai sustentar a família", en: "My father is going to support the family" }, accept: ["support", "to support", "to provide for", "to keep", "to sustain"], hint: "sush-ten-TAR. Feeding and housing people — sustentar uma família. It also holds a thing up physically, and holds up an argument." },
