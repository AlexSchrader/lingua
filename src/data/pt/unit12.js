...
export const PT_UNIT12 = {
  ...
  lessons: [
    ...
    // something is, estar says HOW or WHERE it is right now.
    {
      ...
      items: [
        { id: "pt-u12l2-ser", type: "vocab", front: "ser", reading: "ser", meaning: "to be", example: { jp: "Ser professor é um trabalho difícil.", en: "To be a teacher is difficult work." }, drill: { jp: "Ser professor é um trabalho difícil", en: "To be a teacher is difficult work" }, accept: ["being", "to be (permanent)", "be"], hint: "The identity verb: WHAT something is. Names, jobs, nationality, origin, the material a thing is made of, and the hour — que horas são, from Unit 5. Wildly irregular: sou, és, é, somos, são. You have been using é since Unit 1 without being told its name." },
        { id: "pt-u12l2-estar", type: "vocab", front: "estar", reading: "estar", meaning: "to be (state)", example: { jp: "Estar em Lisboa é fantástico.", en: "Being in Lisbon is fantastic." }, drill: { jp: "Estar em Lisboa é fantástico", en: "Being in Lisbon is fantastic" }, accept: ["to be located", "being", "to be (temporary)", "be"], hint: "The state verb: HOW or WHERE something is right now. Location, mood, weather, health — estou bem from Unit 2 was this verb all along. Forms: estou, estás, está, estamos, estão. Careful, it is not \"temporary vs permanent\": a person's death is estar morto, and it is not temporary." },
        { id: "pt-u12l2-estou", type: "vocab", front: "estou", reading: "estou", meaning: "I am (right now)", example: { jp: "Estou em casa.", en: "I am at home." }, drill: { jp: "Estou em casa hoje", en: "I am at home today" }, accept: ["im", "i'm", "i am (right now)"], hint: "shtOH. Compare with sou, from Unit 3: SOU médico is my profession, ESTOU cansado is how I feel today. Swap them and a Portuguese speaker will understand you and also know instantly that you are not one." },
        { id: "pt-u12l2-esta", type: "vocab", front: "está", reading: "esta", meaning: "he is", example: { jp: "Onde está o meu livro?", en: "Where is my book?" }, drill: { jp: "Onde está o meu livro", en: "Where is my book" }, accept: ["she is", "it is", "you are", "is"], hint: "shtA. Does he, she, it AND the polite you — o senhor está bem? Its partner is é: o café É bom (always) but o café ESTÁ quente (now). Location always takes está, never é, once you are talking about a movable thing." },
        { id: "pt-u12l2-somos", type: "vocab", front: "somos", reading: "somos", meaning: "we are", example: { jp: "Nós somos portugueses.", en: "We are Portuguese." }, drill: { jp: "Nós somos portugueses", en: "We are Portuguese" }, accept: ["were", "we're", "we are (ser)"], hint: "SO-mush, from ser. Goes with nós, Unit 4 — though you will usually drop the nós, because -mos already says \"we\". The estar version is estamos: estamos em Lisboa." },
        { id: "pt-u12l2-sao", type: "vocab", front: "são", reading: "sao", meaning: "they are", example: { jp: "Eles são muito simpáticos.", en: "They are very nice." }, drill: { jp: "Eles são muito simpáticos", en: "They are very nice" }, accept: ["you are (plural)", "theyre", "they're", "are"], hint: "SAWNG, the ão nasal from Unit 1. Covers eles, elas AND vocês. You have already met it inside que horas são, Unit 5 — the clock takes ser. The estar version is estão. And yes, são also means \"saint\": São Tiago." },
      ],
    },
