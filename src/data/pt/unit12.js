  ...
  lessons: [
    ...
    // something is, estar says HOW or WHERE it is right now.
    {
      ...
      items: [
        ...
        { id: "pt-u12l2-estou", type: "vocab", front: "estou", reading: "estou", meaning: "I am", example: { jp: "Estou em casa.", en: "I am at home." }, drill: { jp: "Estou em casa hoje", en: "I am at home today" }, accept: ["im", "i'm", "i am (right now)"], hint: "shtOH. Compare with sou, from Unit 3: SOU médico is my profession, ESTOU cansado is how I feel today. Swap them and a Portuguese speaker will understand you and also know instantly that you are not one." },
    ...
    // agreement will feel like a rule the learner already half knows.
    {
      ...
      items: [
        ...
        { id: "pt-u12l4-aquele", type: "vocab", front: "aquele", reading: "aquele", meaning: "that", example: { jp: "Aquele homem é o pai de Ana.", en: "That man is Ana's father." }, drill: { jp: "Aquele homem é o pai de Ana", en: "That man is Ana's father" }, accept: ["that one", "that over there", "that (m)"], hint: "a-KE-le. Feminine aquela, neuter aquilo. Portuguese points three ways, matching aqui / aí / ali from Unit 7: este is by me, esse is by you, aquele is over there away from us both. English collapses the last two into \"that\"." },
        { id: "pt-u12l4-outro", type: "vocab", front: "outro", reading: "outro", meaning: "other", example: { jp: "Não é este livro, é o outro.", en: "It isn't this book, it's the other one." }, drill: { jp: "Não é este livro é o outro", en: "It isn't this book it's the other one" }, accept: ["another", "the other", "other one"], hint: "OH-tru — ou as a plain long o, like outono. Feminine outra, plurals outros/outras. Note what it does NOT take: \"another\" is simply outro, never \"um outro\", so um outro livro is a beginner's tell." },
      ],
    },
  ],
};
