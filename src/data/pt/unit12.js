  ...
  lessons: [
    ...
    // not something anyone writes or says.
    {
      ...
      items: [
        ...
        { id: "pt-u12l3-as", type: "vocab", front: "às", reading: "as", meaning: "at (with a time)", example: { jp: "O jantar é às oito.", en: "Dinner is at eight." }, accept: ["to the (feminine plural)", "at", "at the"], hint: "The plural of à — a + as. Every one of the six contractions above has a plural twin: dos, das, nos, nas, aos, às. This is the one you will say most, because Portuguese puts clock times in the plural: às nove, às dez, às três — but ao meio-dia and à uma, which are singular." },
      ],
    },
