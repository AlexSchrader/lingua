  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u68l1-ocompromisso", type: "vocab", front: "o compromisso", reading: "ocompromisso", meaning: "commitment", example: { jp: "O compromisso entre os dois é claro, por isso ninguém da família ficou preocupado com a mudança.", en: "The commitment between the two is clear, so nobody in the family was worried about the move." }, drill: { jp: "O compromisso entre os dois é claro", en: "The commitment between the two is clear" }, accept: ["commitment", "the commitment", "engagement", "obligation"], hint: "kom-pru-MEE-su. Both the personal commitment and an appointment you cannot move — tenho um compromisso às três is how Portugal declines an invitation politely." },
        { id: "pt-u68l1-manter", type: "vocab", front: "manter", reading: "manter", meaning: "to keep up", example: { jp: "É difícil manter uma amizade a esta distância, mas eles falam quase todas as semanas.", en: "It is hard to keep up a friendship at this distance, but they talk almost every week." }, drill: { jp: "É difícil manter uma amizade", en: "It is hard to keep up a friendship" }, accept: ["keep", "to maintain", "keep up", "to sustain"], hint: "man-TER. Conjugates like ter, which is inside it — eu mantenho, ele mantém. Manter-se is to stay a certain way: mantém-se calmo." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u68l2-aculpa", type: "vocab", front: "a culpa", reading: "aculpa", meaning: "fault", example: { jp: "A culpa não foi de ninguém, no entanto os dois passaram meses sem se falar.", en: "It was nobody's fault; however, the two of them went months without speaking to each other." }, drill: { jp: "A culpa não foi de ninguém", en: "It was nobody's fault" }, accept: ["fault", "blame", "guilt", "the fault"], hint: "KOOL-puh. A culpa é minha is how you take the blame, and ter culpa is to be at fault. Also guilt in the moral sense — sentir culpa." },
    ...
    },
    {
      ...
      items: [
        { id: "pt-u68l3-oapoio", type: "vocab", front: "o apoio", reading: "oapoio", meaning: "support", example: { jp: "O apoio da família foi tudo durante a doença, no entanto os vizinhos também ajudaram muito.", en: "The family's support was everything during the illness; the neighbours, however, also helped a lot." }, drill: { jp: "O apoio da família foi tudo", en: "The family's support was everything" }, accept: ["support", "the support", "backing", "help"], hint: "a-POY-u. Emotional and official alike — o apoio social is state support. Dar apoio a alguém is the everyday phrase." },
        { id: "pt-u68l3-apoiar", type: "vocab", front: "apoiar", reading: "apoiar", meaning: "to support", example: { jp: "Os pais decidiram apoiar a filha até ao fim do curso, além disso pagaram o quarto no Porto.", en: "The parents decided to support their daughter until the end of her course; what is more, they paid for the room in Porto." }, drill: { jp: "Os pais vão apoiar a filha", en: "The parents are going to support their daughter" }, accept: ["support", "to back", "to stand by"], hint: "a-poy-AR. Of people, of teams and of ideas. Apoiar-se em is to lean on something physically — apoiou-se na mesa." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u68l4-recusar", type: "vocab", front: "recusar", reading: "recusar", meaning: "to refuse", example: { jp: "A empresa recusou o pedido do sindicato, por isso os funcionários decidiram falar com a imprensa.", en: "The company refused the union's request, so the staff decided to talk to the press." }, drill: { jp: "A empresa vai recusar o pedido", en: "The company is going to refuse the request" }, accept: ["refuse", "to turn down", "reject", "decline"], hint: "rre-ku-ZAR. Of a request, an offer or an invitation. Recusar-se a + infinitive is to refuse to DO something: recusou-se a sair." },
      ],
    },
  ],
};
