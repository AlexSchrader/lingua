  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u68l1-oafeto", type: "vocab", front: "o afeto", reading: "oafeto", meaning: "affection", example: { jp: "O afeto entre os dois é claro, embora quase nunca falem disso à frente dos filhos.", en: "The affection between the two of them is clear, although they almost never talk about it in front of the children." }, drill: { jp: "O afeto entre os dois é claro", en: "The affection between the two is clear" }, accept: ["affection", "the affection", "fondness"], hint: "a-FEH-tu. Portugal writes afeto, Brazil afeto too since the spelling agreement — the older afecto is what you see in print before 2009. Afetuoso is the adjective." },
      ],
    },
    {
      id: "pt-u68l2",
