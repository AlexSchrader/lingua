  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u86l3-ademora", type: "vocab", front: "a demora", reading: "ademora", meaning: "delay", example: { jp: "A demora do comboio da manhã foi grande e a turma chegou depois da aula.", en: "The delay of the morning train was long and the class arrived after the lesson." }, drill: { jp: "A demora do comboio foi grande", en: "The delay of the train was long" }, accept: ["the delay", "delay", "wait", "the wait", "hold-up"], hint: "de-MO-ra, from demorar. The time something takes when it takes too much of it. Sem demora means without delay, the phrase on official letters." },
