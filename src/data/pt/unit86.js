  ...
  lessons: [
    {
      ...
      items: [
        { id: "pt-u86l1-anterior", type: "vocab", front: "anterior", reading: "anterior", meaning: "previous", example: { jp: "A aula anterior foi mais difícil do que a aula de hoje.", en: "The previous lesson was harder than today's lesson." }, drill: { jp: "A aula anterior foi mais difícil", en: "The previous lesson was harder" }, accept: ["previous", "earlier", "preceding", "former", "front"], hint: "an-te-ri-OR. The one before, in time or in place — a porta anterior is the front door of a car. No dia anterior is the day before, where ontem is fixed to yesterday." },
        ...
        { id: "pt-u86l1-seguinte", type: "vocab", front: "seguinte", reading: "seguinte", meaning: "next", example: { jp: "O dia seguinte ao jogo foi calmo em toda a cidade.", en: "The day after the match was quiet across the whole city." }, drill: { jp: "O dia seguinte ao jogo foi calmo", en: "The day after the match was quiet" }, accept: ["next", "following", "the following", "subsequent"], hint: "se-GHEEN-te, from seguir. The next one in a series that has already started — o seguinte, please, is what a Portuguese counter clerk calls. Próximo is the next one coming up." },
        ...
        { id: "pt-u86l1-ofim", type: "vocab", front: "o fim", reading: "ofim", meaning: "end", example: { jp: "O fim do estudo foi melhor do que o início.", en: "The end of the study was better than the beginning." }, drill: { jp: "O fim do estudo foi melhor", en: "The end of the study was better" }, accept: ["the end", "end", "ending", "finish", "purpose"], hint: "FEENG, nasal. The end of a thing, and the purpose of it — com o fim de, with the aim of. O fim de semana is the weekend, and por fim means at last." },
      ],
    },
    {
      id: "pt-u86l2",
      ...
      items: [
        { id: "pt-u86l2-afase", type: "vocab", front: "a fase", reading: "afase", meaning: "stage", example: { jp: "A fase difícil do trabalho já acabou e a equipa está calma.", en: "The hard stage of the job is over and the team is calm." }, drill: { jp: "A fase difícil do trabalho já acabou", en: "The hard stage of the job is over" }, accept: ["the stage", "stage", "the phase", "phase", "period"], hint: "FA-ze. A stage of a process or of a life — está numa fase difícil is said kindly about a person. Por fases means bit by bit." },
        { id: "pt-u86l2-oprocesso", type: "vocab", front: "o processo", reading: "oprocesso", meaning: "process", example: { jp: "O processo da empresa é grande e tem muitas fases.", en: "The company's process is big and has many stages." }, drill: { jp: "O processo da empresa tem muitas fases", en: "The company's process has many stages" }, accept: ["the process", "process", "procedure", "the procedure", "case"], hint: "pru-SE-su. A process, a procedure, and in law a case — um processo em tribunal. Estar em processo de is to be in the middle of doing something." },
        ...
        { id: "pt-u86l2-aordem", type: "vocab", front: "a ordem", reading: "aordem", meaning: "order", example: { jp: "A ordem dos nomes na lista não é por idade.", en: "The order of the names on the list isn't by age." }, drill: { jp: "A ordem dos nomes não é clara", en: "The order of the names isn't clear" }, accept: ["the order", "order", "sequence", "command", "tidiness"], hint: "OR-dem. Three jobs in one word: the order things come in, tidiness — está tudo em ordem — and an order given: dar uma ordem. Às ordens! is at your service." },
        { id: "pt-u86l2-ointervalo", type: "vocab", front: "o intervalo", reading: "ointervalo", meaning: "break", example: { jp: "O intervalo das duas aulas é curto para o café.", en: "The break in the two lessons is short for a coffee." }, drill: { jp: "O intervalo das aulas é curto", en: "The break in the lessons is short" }, accept: ["the break", "break", "the interval", "interval", "gap"], hint: "in-ter-VA-lu. The school break, the interval at the theatre, and the gap between two numbers. Note that in a Portuguese school day, o intervalo is the thing everyone waits for." },
    ...
    },
    {
      ...
      items: [
        { id: "pt-u86l3-adiar", type: "vocab", front: "adiar", reading: "adiar", meaning: "to postpone", example: { jp: "A escola adiou o teste para a semana seguinte.", en: "The school postponed the test to the following week." }, drill: { jp: "A escola vai adiar o teste", en: "The school is going to postpone the test" }, accept: ["postpone", "to postpone", "to put off", "put off", "to delay", "to defer"], hint: "a-di-AR, with dia, day, inside it — you push it to another day. Adiar para amanhã is to put it off till tomorrow, and o adiamento is the postponement." },
        { id: "pt-u86l3-antecipar", type: "vocab", front: "antecipar", reading: "antecipar", meaning: "to bring forward", example: { jp: "A empresa antecipou a reunião para a manhã de hoje.", en: "The company brought the meeting forward to this morning." }, drill: { jp: "A empresa vai antecipar a reunião", en: "The company is going to bring the meeting forward" }, accept: ["bring forward", "to bring forward", "to move up", "to anticipate", "to advance"], hint: "an-te-si-PAR, the opposite of adiar. It also carries the English sense of expecting something in advance — antecipar um problema." },
        ...
        { id: "pt-u86l3-adiantar", type: "vocab", front: "adiantar", reading: "adiantar", meaning: "to get ahead", example: { jp: "O chefe adiantou o trabalho da semana e ficou calmo.", en: "The boss got ahead with the week's work and relaxed." }, drill: { jp: "Vou adiantar o trabalho da semana", en: "I'm going to get ahead with the week's work" }, accept: ["get ahead", "to get ahead", "to bring forward", "to advance", "to be of use"], hint: "a-di-an-TAR, the mirror of atrasar. Getting work done early, and paying money up front. Não adianta is a very common not worth it — literally it gets you nowhere." },
        { id: "pt-u86l3-apausa", type: "vocab", front: "a pausa", reading: "apausa", meaning: "pause", example: { jp: "A pausa no meio da aula ajudou a atenção da turma.", en: "The pause in the middle of the lesson helped the class's attention." }, drill: { jp: "A pausa no meio da aula ajudou", en: "The pause in the middle of the lesson helped" }, accept: ["the pause", "pause", "break", "the break", "rest"], hint: "PAU-za. A short stop inside something that is still running, where o intervalo is the scheduled gap. Fazer uma pausa is to take a break." },
