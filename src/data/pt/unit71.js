  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u71l1-puder", type: "vocab", front: "puder", reading: "puder", meaning: "when/if I can", example: { jp: "Falo com o chefe quando puder, porque preciso de saber o dia da reunião.", en: "I will speak to the boss when I can, because I need to know the day of the meeting." }, drill: { jp: "Faço isso quando puder", en: "I will do that when I can" }, accept: ["can", "when I can", "if I can"], hint: "Future subjunctive of poder, and the politest thing in this unit: quando puder is how you ask for something without setting a deadline. Note puder (future) against pudesse (imperfect) — one letter, two worlds." },
