  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u71l2-logoque", type: "vocab", front: "logo que", reading: "logoque", meaning: "as soon as", example: { jp: "Logo que a reunião acabar, mando-te uma mensagem com a decisão toda.", en: "As soon as the meeting finishes, I will send you a message with the whole decision." }, drill: { jp: "Logo que a reunião acabar mando uma mensagem", en: "As soon as the meeting finishes I will send a message" }, accept: ["as soon as", "the moment that", "once"], hint: "Interchangeable with assim que (u36) and slightly more formal. Both take the future subjunctive when they point forward. Logo on its own is \"later\" — até logo, u2." },
        { id: "pt-u71l2-oquequiser", type: "vocab", front: "o que quiser", reading: "oquequiser", meaning: "whatever you want", example: { jp: "Faça o que quiser com o terreno, porque a casa já não é minha desde o ano passado.", en: "Do whatever you want with the land, because the house has not been mine since last year." }, drill: { jp: "Faça o que quiser com o terreno", en: "Do whatever you want with the land" }, accept: ["whatever you want", "anything you want", "as you like"], hint: "Carded as a chunk because Portuguese has no word for \"whatever\" — it builds it from o que + future subjunctive. Same machinery: o que disser, o que for, onde quiser, quando puder." },
      ],
    },
    {
      id: "pt-u71l3",
