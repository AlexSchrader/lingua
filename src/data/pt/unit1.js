...
export const PT_UNIT1 = {
  ...
  lessons: [
    ...
    // word in its own right, e and de reduce to almost nothing.
    {
      ...
      items: [
        { id: "pt-u1l1-glyphaacute", type: "glyph", front: "á", reading: "a", meaning: null, example: null, hint: "The OPEN a, mouth wide — the a of \"father\". The acute also tells you WHERE the stress falls: rápido is RA-pi-du, not ra-PI-du.\nPhone: hold A, then tap á\nPortuguese keyboard: press ´, then A" },
        { id: "pt-u1l1-glyphacircum", type: "glyph", front: "â", reading: "a", meaning: null, example: null, hint: "The CLOSED a, short and swallowed — câmara is KUH-ma-ra. Same letter as á, opposite mouth: the acute opens the vowel, the hat closes it.\nPhone: hold A, then tap â\nPortuguese keyboard: press ^, then A" },
        { id: "pt-u1l1-glyphecircum", type: "glyph", front: "ê", reading: "e", meaning: null, example: null, hint: "The CLOSED e — the \"ay\" of \"say\" with no glide on the end: três, você. Its partner é opens the same vowel to the \"eh\" of \"bed\", and you meet é in this very lesson as a word in its own right.\nPhone: hold E, then tap ê\nPortuguese keyboard: press ^, then E" },
    ...
    // the note in the header says why it cannot be spread further.
    {
      ...
      items: [
        { id: "pt-u1l2-glyphiacute", type: "glyph", front: "í", reading: "i", meaning: null, example: null, hint: "A stressed \"ee\" — país is pa-EESH. Portuguese i is ALWAYS \"ee\"; the accent changes nothing about the sound, it only says \"the stress is here\", pulling it off the vowel before.\nPhone: hold I, then tap í\nPortuguese keyboard: press ´, then I" },
        { id: "pt-u1l2-glyphoacute", type: "glyph", front: "ó", reading: "o", meaning: null, example: null, hint: "The OPEN o — the o of \"hot\", said wide: avó, grandmother.\nPhone: hold O, then tap ó\nPortuguese keyboard: press ´, then O" },
        { id: "pt-u1l2-glyphocircum", type: "glyph", front: "ô", reading: "o", meaning: null, example: null, hint: "The CLOSED o — the \"oh\" of \"go\": avô, grandfather. One accent apart from avó and it changes which grandparent you mean, so the hat is not decoration.\nPhone: hold O, then tap ô\nPortuguese keyboard: press ^, then O" },
        { id: "pt-u1l2-glyphuacute", type: "glyph", front: "ú", reading: "u", meaning: null, example: null, hint: "A stressed \"oo\" — número, açúcar. Like í, it moves the stress rather than the sound: u is always \"oo\" in Portuguese.\nPhone: hold U, then tap ú\nPortuguese keyboard: press ´, then U" },
    ...
    // sound foreigners are recognised by — so it comes early.
    {
      ...
      items: [
        { id: "pt-u1l3-glyphao", type: "glyph", front: "ão", reading: "ao", meaning: null, example: null, hint: "Two letters, one nasal sound, and the sound Portuguese is recognised by. Start to say \"ow\" and route it down your nose: pão, não.\nPhone: hold A, tap ã, then type o\nPortuguese keyboard: press ~, then A, then O" },
        { id: "pt-u1l3-glyphae", type: "glyph", front: "ãe", reading: "ae", meaning: null, example: null, hint: "A nasal \"eye\": mãe. One letter away from ão and a completely different word — mão is a hand, mãe is a mother.\nPhone: hold A, tap ã, then type e\nPortuguese keyboard: press ~, then A, then E" },
    ...
    // a vowel: a final m that never closes your lips.
    {
      ...
      items: [
        { id: "pt-u1l4-glyphatilde", type: "glyph", front: "ã", reading: "a", meaning: null, example: null, hint: "The tilde sends the air out through your NOSE. Say \"ah\" and let it come down your nose instead: maçã, irmã. It is not a stress mark — it is a different vowel.\nPhone: hold A, then tap ã\nPortuguese keyboard: press ~, then A" },
        { id: "pt-u1l4-glyphcedilha", type: "glyph", front: "ç", reading: "c", meaning: null, example: null, hint: "The cedilha — the little tail that forces a soft \"s\" where a plain c would go hard: maçã, preço, açúcar. It appears ONLY before a, o or u; before e and i the c is already soft, so ç is never needed there.\nPhone: hold C, then tap ç\nPortuguese keyboard: ç has its own key, right of L" },
