  ...
  lessons: [
    {
      ...
      cefr: "A1",
      dominantMode: "recall",
      canDo: "Say what you do at the weekend in Portugal — rest, sleep, walk, and invite someone to a party.",
      items: [
        { id: "pt-u19l1-ofimdesemana", type: "vocab", front: "o fim de semana", reading: "ofimdesemana", meaning: "weekend", example: { jp: "O fim de semana em Lisboa é fantástico.", en: "The weekend in Lisbon is fantastic." }, accept: ["the weekend"], hint: "A three-word chunk that behaves as a single noun: fing-de-se-MA-na, built straight on a semana from Unit 5. On its own o fim is \"the end\". Portugal writes it open like this; Brazil often hyphenates." },
        { id: "pt-u19l1-descansar", type: "vocab", front: "descansar", reading: "descansar", meaning: "to rest", example: { jp: "Descansar em casa é fantástico.", en: "Resting at home is fantastic." }, accept: ["rest", "to relax", "relax", "to take a break"], hint: "desh-kan-SAR: descanso, descansas, descansa. Built on cansado (tired) with des- reversing it — the same prefix that turned ligar into desligar in Unit 18. Bom descanso! is what you wish someone heading off to rest." },
        { id: "pt-u19l1-dormir", type: "vocab", front: "dormir", reading: "dormir", meaning: "to sleep", example: { jp: "Dormir oito horas é importante.", en: "Sleeping eight hours is important." }, accept: ["sleep", "to be asleep"], hint: "dur-MEER: durmo, dormes, dorme — the o turns to u in the \"I\" form, which is worth noticing now because several verbs do it. A nap is uma sesta; to fall asleep is adormecer." },
        ...
        { id: "pt-u19l1-afesta", type: "vocab", front: "a festa", reading: "afesta", meaning: "party", example: { jp: "A festa de aniversário de Ana é amanhã.", en: "Ana's birthday party is tomorrow." }, accept: ["the party", "celebration", "festival", "feast"], hint: "FESH-ta. A party, and also a public holiday or a saint's festival. Lisbon's are as Festas de Santo António every June, when the entire city grills sardines in the street." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u19l3-cantar", type: "vocab", front: "cantar", reading: "cantar", meaning: "to sing", example: { jp: "Cantar e dançar na festa de Ana.", en: "To sing and dance at Ana's party." }, accept: ["sing", "to chant"], hint: "kan-TAR: canto, cantas, canta. A song is uma canção, with the -ção ending from Unit 1, and the singer is um cantor or uma cantora." },
        { id: "pt-u19l3-dancar", type: "vocab", front: "dançar", reading: "dancar", meaning: "to dance", example: { jp: "Dançar na festa do fim de semana.", en: "To dance at the weekend party." }, accept: ["dance", "to have a dance"], hint: "dan-SAR, cedilla giving the s: danço, danças, dança. Watch where the ç goes — it appears only before a and o, where c would otherwise go hard, so danço takes it and danças does not." },
