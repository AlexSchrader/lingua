  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u16l1-acamisa", type: "vocab", front: "a camisa", reading: "acamisa", meaning: "shirt", example: { jp: "A camisa do pai de Tiago é elegante.", en: "Tiago's father's shirt is elegant." }, accept: ["the shirt", "blouse"], hint: "ka-MEE-za — s between vowels says z, as in a casa. A proper buttoned shirt; a t-shirt is uma t-shirt, said the English way. Do not mix it with a camisola in the next lesson, which is a sweater." },
        { id: "pt-u16l1-ascalcas", type: "vocab", front: "as calças", reading: "ascalcas", meaning: "trousers", example: { jp: "As calças de Tiago não são caras.", en: "Tiago's trousers aren't expensive." }, accept: ["trousers", "pants", "the trousers", "the pants"], hint: "KAL-sash, cedilla giving an s and the final s shushing. ALWAYS PLURAL, like English trousers, so it takes as and umas — umas calças. Shorts are uns calções; Brazil says a calça, singular." },
        { id: "pt-u16l1-ovestido", type: "vocab", front: "o vestido", reading: "ovestido", meaning: "dress", example: { jp: "O vestido é elegante e não é caro.", en: "The dress is elegant and isn't expensive." }, accept: ["the dress", "gown", "frock"], hint: "vesh-TEE-du — the s before t shushes. It is literally the past participle of vestir, \"the worn thing\", turned into a noun; the verb arrives in the next lesson." },
        { id: "pt-u16l1-asaia", type: "vocab", front: "a saia", reading: "asaia", meaning: "skirt", example: { jp: "A saia de Maria é moderna.", en: "Maria's skirt is modern." }, accept: ["the skirt"], hint: "SIGH-a. Spanish uses la falda, so there is no shortcut here — this one is learned fresh. Spelled identically, saia is also \"leave!\" from the verb sair; context never leaves it in doubt." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u16l2-ossapatos", type: "vocab", front: "os sapatos", reading: "ossapatos", meaning: "shoes", example: { jp: "Os sapatos são de Ana.", en: "The shoes are Ana's." }, accept: ["the shoes", "shoe"], hint: "sa-PA-tush — that final s shushes, which is most of why Portuguese plurals sound like \"-sh\". One shoe is um sapato; trainers are uns ténis." },
        ...
        { id: "pt-u16l2-ochapeu", type: "vocab", front: "o chapéu", reading: "ochapeu", meaning: "hat", example: { jp: "O chapéu de Pedro é famoso.", en: "Pedro's hat is famous." }, accept: ["the hat", "cap"], hint: "sha-PEU, ch as sh. The same word as French chapeau, and the accent over the e tells you the stress lands on that final syllable." },
        { id: "pt-u16l2-vestir", type: "vocab", front: "vestir", reading: "vestir", meaning: "to wear", example: { jp: "Vestir a camisa e o casaco.", en: "To put on the shirt and the coat." }, accept: ["to put on", "wear", "to dress", "put on"], hint: "vesh-TEER: visto, vestes, veste — the e turns to i in the \"I\" form. Portuguese SPLITS English's \"put on\": vestir for clothes on the body, calçar for anything on the feet. Getting dressed is vestir-me, pronoun hooked on the end." },
        { id: "pt-u16l2-calcar", type: "vocab", front: "calçar", reading: "calcar", meaning: "to put on (footwear)", example: { jp: "Calçar os sapatos e as meias.", en: "To put on the shoes and the socks." }, accept: ["to wear (shoes)", "put on shoes", "to put on footwear", "to shoe"], hint: "kal-SAR, cedilla. The footwear half of the pair — you vestir a camisa but calçar os sapatos, and mixing them up is instantly foreign. It also asks shoe size: que número calça? Gloves take a third verb again, pôr." },
      ],
    },
    {
      id: "pt-u16l3",
      ...
      items: [
        { id: "pt-u16l3-comprar", type: "vocab", front: "comprar", reading: "comprar", meaning: "to buy", example: { jp: "Comprar um chapéu na loja de Ana.", en: "To buy a hat in Ana's shop." }, accept: ["buy", "to purchase", "purchase"], hint: "kom-PRAR: compro, compras, compra. Shopping as an activity is as compras — ir às compras, where a + as has fused into às." },
        { id: "pt-u16l3-quantocusta", type: "vocab", front: "quanto custa", reading: "quantocusta", meaning: "how much is it", example: { jp: "Quanto custa o casaco?", en: "How much is the coat?" }, accept: ["how much does it cost", "how much", "what does it cost", "how much is that", "how much is this"], hint: "A fixed chunk — the one question that gets you through any Portuguese shop. KWAN-tu KUSH-ta. For more than one thing it becomes quanto custam. The answer comes back as a number plus euros." },
        { id: "pt-u16l3-pagar", type: "vocab", front: "pagar", reading: "pagar", meaning: "to pay", example: { jp: "Pagar o bilhete e o café.", en: "To pay for the ticket and the coffee." }, accept: ["pay", "to pay for", "settle"], hint: "pa-GAR: pago, pagas, paga. No preposition follows it — you pagar a conta, never \"pay FOR\" it. Paying by card is pagar com cartão, and the sign meaning cash only is só dinheiro." },
        { id: "pt-u16l3-barato", type: "vocab", front: "barato", reading: "barato", meaning: "cheap", example: { jp: "O chapéu é barato e a camisola é cara.", en: "The hat is cheap and the sweater is expensive." }, accept: ["inexpensive", "low-priced", "affordable"], hint: "ba-RA-tu. The exact opposite of caro from Unit 1, and it agrees the same way: barato, barata, baratos, baratas. One warning — as a noun, uma barata is a cockroach." },
        { id: "pt-u16l3-otamanho", type: "vocab", front: "o tamanho", reading: "otamanho", meaning: "size", example: { jp: "Que tamanho é o vestido?", en: "What size is the dress?" }, accept: ["the size"], hint: "ta-MA-nyu, with nh. Portuguese clothes use the European numbers — 38, 40, 42 — never S/M/L. Shoes are the exception: for those you ask o número, not o tamanho." },
        { id: "pt-u16l3-provar", type: "vocab", front: "provar", reading: "provar", meaning: "to try on", example: { jp: "Provar o vestido e a camisa na loja.", en: "To try on the dress and the shirt in the shop." }, accept: ["try on", "to taste", "to try", "to test", "try"], hint: "pru-VAR. Two jobs and you need both: to try ON clothes, and to TASTE food or wine — provar o vinho. The fitting room is o gabinete de provas." },
      ],
    },
    {
      id: "pt-u16l4",
      ...
      items: [
        ...
        { id: "pt-u16l4-aprenda", type: "vocab", front: "a prenda", reading: "aprenda", meaning: "gift", example: { jp: "A prenda de aniversário de Ana é um chapéu.", en: "Ana's birthday present is a hat." }, accept: ["the gift", "present", "the present"], hint: "PORTUGAL SAYS PRENDA — PREN-da. Brazil says o presente, which sounds oddly formal here. And watch Spanish: una prenda there is a garment or a pledge, never a gift." },
        { id: "pt-u16l4-ocartao", type: "vocab", front: "o cartão", reading: "ocartao", meaning: "card", example: { jp: "O cartão é de Ana, não é o meu.", en: "The card is Ana's, it isn't mine." }, accept: ["the card", "bank card", "credit card"], hint: "kar-TAWNG, the -ão nasal of o pão. It covers a bank card, a birthday card and plain cardboard. Your bank card is o cartão multibanco; the ID everyone here carries is o cartão de cidadão." },
        ...
        { id: "pt-u16l4-acaixa", type: "vocab", front: "a caixa", reading: "acaixa", meaning: "checkout", example: { jp: "A caixa da loja é ali, à esquerda.", en: "The shop's checkout is there, on the left." }, accept: ["the checkout", "till", "cash register", "box", "cashier"], hint: "KIGH-sha — x says sh. Till, checkout, cashier and also simply a box. In a bank the gender splits the job: o caixa is the man at the counter, a caixa is the till itself." },
