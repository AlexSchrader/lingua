  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u36l4-achar", type: "vocab", front: "achar", reading: "achar", meaning: "to think", example: { jp: "Achar que sim não é saber, e em Portugal acha-se muito e estuda-se menos.", en: "Thinking so is not knowing, and in Portugal people think a lot and study less." }, drill: { jp: "Achar que sim não é saber", en: "Thinking so is not knowing" }, accept: ["think", "to find", "to reckon", "to consider"], hint: "a-SHAR. THE everyday \"I think\" in Portugal — acho que sim, acho que não — far more common than pensar for an opinion. Its literal meaning is to find: achei as chaves. Block 1's u24 teaches a opinião, the noun beside it." },
