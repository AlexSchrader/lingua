  ...
  lessons: [
    ...
    // and Portuguese simply lets context decide which.
    {
      ...
      items: [
        ...
        { id: "pt-u14l3-fez", type: "vocab", front: "fez", reading: "fez", meaning: "he did", example: { jp: "Ela fez um bolo fantástico.", en: "She made a fantastic cake." }, drill: { jp: "Ela fez um bolo fantástico", en: "She made a fantastic cake" }, accept: ["she made", "he made", "you did (polite)", "did", "made"], hint: "FESH. Note it drops the -z- stem that fiz and fizeram carry, which is why it looks shorter than it should. Portuguese also uses it for elapsed time: fez dois anos, it's been two years." },
      ],
    },
