...
export const PT_UNIT14 = {
  ...
  lessons: [
    ...
    // so they have to be learned rather than derived.
    {
      ...
      items: [
        { id: "pt-u14l1-falei", type: "vocab", front: "falei", reading: "falei", meaning: "I spoke", example: { jp: "Falei com o médico ontem.", en: "I spoke with the doctor yesterday." }, drill: { jp: "Falei com o médico ontem", en: "I spoke with the doctor yesterday" }, accept: ["i talked", "i did speak", "i have spoken", "spoke"], hint: "The pretérito perfeito: a finished action at a finished time. -ei is the eu ending for every regular -ar verb — falei, estudei, trabalhei, gostei. Careful: falo has one syllable of stress at the front, falei has it at the back." },
        { id: "pt-u14l1-falaste", type: "vocab", front: "falaste", reading: "falaste", meaning: "you spoke", example: { jp: "Falaste com Ana?", en: "Did you speak with Ana?" }, drill: { jp: "Falaste com Ana ontem", en: "You spoke with Ana yesterday" }, accept: ["you talked", "did you speak", "you did speak"], hint: "-aste for tu. Portuguese does not need a helper word for questions — no \"did\" — so falaste? on its own is the whole question. Do not let the -ste ending pull you toward Spanish -aste-with-an-s at the end; Portugal says fa-LASH-te." },
        { id: "pt-u14l1-falou", type: "vocab", front: "falou", reading: "falou", meaning: "he spoke", example: { jp: "Ela falou muito bem.", en: "She spoke very well." }, drill: { jp: "Ela falou muito bem", en: "She spoke very well" }, accept: ["she spoke", "you spoke (polite)", "spoke", "it spoke"], hint: "fa-LOH. -ou for he, she, it and the polite you. This is the ending you will hear most, and it is one letter of sound away from the present -a: ela fala, ela falou." },
        { id: "pt-u14l1-falaram", type: "vocab", front: "falaram", reading: "falaram", meaning: "they spoke", example: { jp: "Eles falaram inglês no hospital.", en: "They spoke English at the hospital." }, drill: { jp: "Eles falaram inglês no hospital", en: "They spoke English at the hospital" }, accept: ["you spoke (plural)", "they talked", "they did speak"], hint: "-aram, and covers eles, elas and vocês. The nós form is falÁmos with an accent, which is what tells it apart from falamos, \"we speak\" — Portugal keeps that accent and Brazil does not. Say them apart: fa-LĂ-mush for the present, with the swallowed a of Unit 1, and fa-LAH-mush for the past, with the a wide open." },
        { id: "pt-u14l1-estudei", type: "vocab", front: "estudei", reading: "estudei", meaning: "I studied", example: { jp: "Estudei português em Coimbra.", en: "I studied Portuguese in Coimbra." }, drill: { jp: "Estudei português em Coimbra", en: "I studied Portuguese in Coimbra" }, accept: ["i did study", "i have studied", "studied"], hint: "Same -ei ending, on estudar from Unit 3. Coimbra has had a university since 1290, and the black student capes are not a costume — they are still worn." },
        { id: "pt-u14l1-trabalhei", type: "vocab", front: "trabalhei", reading: "trabalhei", meaning: "I worked", example: { jp: "Trabalhei na farmácia.", en: "I worked at the pharmacy." }, drill: { jp: "Trabalhei na farmácia em Lisboa", en: "I worked at the pharmacy in Lisbon" }, accept: ["i did work", "i have worked", "worked"], hint: "-ei again, on trabalhar from Unit 13. Three verbs, one ending: once you have it, every regular -ar verb in Portuguese is open to you in the past. Note na, em + a, from Unit 12." },
      ],
    },
    ...
    // only the third-person singular splits, comeu against abriu.
    {
      ...
      items: [
        { id: "pt-u14l2-comi", type: "vocab", front: "comi", reading: "comi", meaning: "I ate", example: { jp: "Comi peixe ao jantar.", en: "I ate fish for dinner." }, drill: { jp: "Comi peixe ao jantar", en: "I ate fish for dinner" }, accept: ["i did eat", "i have eaten", "ate"], hint: "-i for eu, in BOTH the -er and the -ir families: comi, bebi, vivi, abri, parti. One ending, two families, and nothing like the -ei of the -ar verbs." },
        { id: "pt-u14l2-comeste", type: "vocab", front: "comeste", reading: "comeste", meaning: "you ate", example: { jp: "Comeste o bolo?", en: "Did you eat the cake?" }, drill: { jp: "Comeste o bolo de Ana", en: "You ate Ana's cake" }, accept: ["you did eat", "did you eat", "you have eaten"], hint: "-este for tu. Watch it against the present comes — co-MES-te has the extra syllable, and dropping it is the most common beginner slip in this tense. The -ir version is -iste: abriste." },
        { id: "pt-u14l2-comeu", type: "vocab", front: "comeu", reading: "comeu", meaning: "he ate", example: { jp: "Ele comeu a sopa.", en: "He ate the soup." }, drill: { jp: "Ele comeu a sopa", en: "He ate the soup" }, accept: ["she ate", "you ate (polite)", "ate", "it ate"], hint: "ku-MEH-oo. THIS is where -er and -ir finally part company: -er takes -eu, -ir takes -iu. comeu but abriu. Everything else in the past is shared." },
        { id: "pt-u14l2-bebi", type: "vocab", front: "bebi", reading: "bebi", meaning: "I drank", example: { jp: "Bebi um sumo de laranja.", en: "I drank an orange juice." }, drill: { jp: "Bebi um sumo de laranja", en: "I drank an orange juice" }, accept: ["i did drink", "i have drunk", "drank"], hint: "-i again, on beber from Unit 6. And o sumo is the Portugal word — Brazil says o suco. Um sumo de laranja natural, freshly squeezed, is on every café counter here." },
        { id: "pt-u14l2-abri", type: "vocab", front: "abri", reading: "abri", meaning: "I opened", example: { jp: "Abri a loja às oito.", en: "I opened the shop at eight." }, drill: { jp: "Abri a loja às oito", en: "I opened the shop at eight" }, accept: ["i did open", "i have opened", "opened"], hint: "-i, the shared ending, on abrir from Unit 13. Full -ir past: -i, -iste, -iu, -imos, -iram. Note abrimos is identical in the present and the past — context is the only thing that tells them apart. And keep abri apart from abril, the month in Unit 9: one letter, no relation." },
        { id: "pt-u14l2-abriu", type: "vocab", front: "abriu", reading: "abriu", meaning: "he opened", example: { jp: "A farmácia abriu ontem.", en: "The pharmacy opened yesterday." }, drill: { jp: "A farmácia abriu ontem", en: "The pharmacy opened yesterday" }, accept: ["she opened", "it opened", "you opened (polite)", "opened"], hint: "a-BREE-oo. The one ending that separates the families, from the other side: comEU but abrIU. Say the pair out loud together and the difference stops being invisible." },
      ],
    },
    ...
    // and Portuguese simply lets context decide which.
    {
      ...
      items: [
        { id: "pt-u14l3-fui", type: "vocab", front: "fui", reading: "fui", meaning: "I went", example: { jp: "Fui ao mercado ontem.", en: "I went to the market yesterday." }, drill: { jp: "Fui ao mercado ontem", en: "I went to the market yesterday" }, accept: ["i was", "i have been", "went", "was"], hint: "FOO-ee. The strangest fact in Portuguese grammar: ser and ir share their entire past tense. Fui means BOTH \"I went\" and \"I was\", and nothing in the word tells you which — fui ao mercado is went, fui médico is was. Context decides, every time." },
        { id: "pt-u14l3-foi", type: "vocab", front: "foi", reading: "foi", meaning: "he went", example: { jp: "Ontem foi domingo.", en: "Yesterday was Sunday." }, drill: { jp: "Ontem foi domingo", en: "Yesterday was Sunday" }, accept: ["she went", "it was", "he was", "was", "went"], hint: "FOY. Same double life as fui, in the third person — the example is the \"was\" reading. Full set: fui, foste, foi, fomos, foram. Do not confuse foi with fui: one letter, one person." },
        { id: "pt-u14l3-tive", type: "vocab", front: "tive", reading: "tive", meaning: "I had", example: { jp: "Tive febre.", en: "I had a fever." }, drill: { jp: "Tive febre em janeiro", en: "I had a fever in January" }, accept: ["i have had", "i did have", "had"], hint: "TEE-ve, from ter. Irregular right through: tive, tiveste, teve, tivemos, tiveram — the stem swaps its vowel and there is no rule to derive it from. With an illness, Portuguese drops the article: tive febre, not \"tive uma febre\"." },
        { id: "pt-u14l3-teve", type: "vocab", front: "teve", reading: "teve", meaning: "he had", example: { jp: "Ela teve gripe.", en: "She had the flu." }, drill: { jp: "Ela teve gripe ontem", en: "She had flu yesterday" }, accept: ["she had", "you had (polite)", "had", "it had"], hint: "TEH-ve. One vowel from tive, and it is the difference between me and her — so this is a pair to say aloud: TEE-ve, TEH-ve. Estar makes the same shape: estive, esteve." },
        { id: "pt-u14l3-fiz", type: "vocab", front: "fiz", reading: "fiz", meaning: "I did", example: { jp: "Fiz o jantar.", en: "I made dinner." }, drill: { jp: "Fiz o jantar ontem", en: "I made dinner yesterday" }, accept: ["i made", "i have done", "did", "made"], hint: "FEESH — the z shushes like a final s. From fazer: fiz, fizeste, fez, fizemos, fizeram. Do and make, in the past as in the present." },
        { id: "pt-u14l3-fez", type: "vocab", front: "fez", reading: "fez", meaning: "he did", example: { jp: "Ela fez um bolo fantástico.", en: "She made a fantastic cake." }, drill: { jp: "Ela fez um bolo fantástico", en: "She made a fantastic cake" }, accept: ["she made", "he made", "you did (polite)", "did", "made"], hint: "FESH. From fazer: fiz, fizeste, fez, fizemos, fizeram — the stem vowel shifts and the z stays throughout. For elapsed time Portuguese uses the present: faz dois anos." },
      ],
    },
