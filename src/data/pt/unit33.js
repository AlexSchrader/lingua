  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u33l1-oteclado", type: "vocab", front: "o teclado", reading: "oteclado", meaning: "keyboard", example: { jp: "O teclado do portátil está sujo porque como sempre à frente do computador.", en: "The laptop keyboard is dirty because I always eat in front of the computer." }, drill: { jp: "O teclado do portátil está sujo", en: "The laptop keyboard is dirty" }, accept: ["the keyboard", "keypad"], hint: "te-KLA-du, from a tecla, a key. A Portuguese keyboard is not a Brazilian one: it puts ç on its own key and needs no dead-key trick, which is why a ficheiro written on one opens correctly on the other and a password often does not." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u33l2-navegar", type: "vocab", front: "navegar", reading: "navegar", meaning: "to browse", example: { jp: "Navegar na internet à noite é o passatempo de Tiago, porque já não vê televisão.", en: "Browsing the internet at night is Tiago's pastime, because he no longer watches television." }, drill: { jp: "Navegar na internet é muito fácil", en: "Browsing the internet is very easy" }, accept: ["browse", "to sail", "to navigate", "to surf"], hint: "na-ve-GAR. It still means to sail, which in Portugal is not a dead metaphor — o navegador is both a web browser and a navigator of the Age of Discoveries. Navegar na internet, with na, not \"em a\"." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u33l3-apagar", type: "vocab", front: "apagar", reading: "apagar", meaning: "to delete", example: { jp: "Apagar a foto foi um problema, porque não havia outra cópia no computador.", en: "Deleting the photo was a problem, because there was no other copy on the computer." }, drill: { jp: "Apagar a foto foi um problema", en: "Deleting the photo was a problem" }, accept: ["delete", "to erase", "to switch off", "to put out"], hint: "a-pa-GAR. THREE jobs, and they all come from one idea — to put out: apagar um ficheiro, apagar a luz, apagar um fogo. The opposite for the light is acender. Its noun-cousin a borracha, the eraser, is A1 u17." },
