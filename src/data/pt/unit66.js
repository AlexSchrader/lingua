  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u66l3-produzir", type: "vocab", front: "produzir", reading: "produzir", meaning: "to produce", example: { jp: "Este país não consegue produzir energia para todos, por isso compra gás a outros países.", en: "This country cannot produce energy for everyone, so it buys gas from other countries." }, drill: { jp: "O país quer produzir mais energia", en: "The country wants to produce more energy" }, accept: ["produce", "to make", "manufacture"], hint: "pru-du-ZEER. Irregular eu form — eu produzo — exactly like reduzir (u65), which shares the -duzir family." },
    ...
    },
    {
      ...
      items: [
        { id: "pt-u66l4-ocrescimento", type: "vocab", front: "o crescimento", reading: "ocrescimento", meaning: "growth", example: { jp: "O crescimento foi pequeno no ano passado, no entanto o desemprego ficou mais baixo na mesma altura.", en: "Growth was small last year; unemployment, however, fell in the same period." }, drill: { jp: "O crescimento foi pequeno este ano", en: "Growth was small this year" }, accept: ["growth", "the growth", "increase"], hint: "kresh-see-MEN-tu. From crescer, to grow — used of an economy, a city and a child alike." },
