  ...
  lessons: [
    {
      ...
      items: [
        { id: "pt-u66l1-aeconomia", type: "vocab", front: "a economia", reading: "aeconomia", meaning: "economy", example: { jp: "A economia portuguesa vive muito dos turistas, no entanto o governo quer mudar isso nos próximos anos.", en: "The Portuguese economy lives largely on tourists; however, the government wants to change that in the coming years." }, drill: { jp: "A economia vive muito dos turistas", en: "The economy lives largely on tourists" }, accept: ["the economy", "economics"], hint: "e-ku-nu-MEE-uh. Both the economy and the school subject. Also, in everyday speech, thrift: fazer economia de água is to go easy on the water." },
        { id: "pt-u66l1-aoferta", type: "vocab", front: "a oferta", reading: "aoferta", meaning: "supply", example: { jp: "A oferta de casas é pequena em Lisboa, por isso os preços continuam altos.", en: "The supply of houses is small in Lisbon, so prices remain high." }, drill: { jp: "A oferta de casas é pequena", en: "The supply of houses is small" }, accept: ["supply", "offer", "the supply", "special offer"], hint: "u-FEHR-tuh. Careful, three senses: the economic supply, a special offer in a shop, and — the everyday one — a GIFT. For a birthday present Portugal says uma prenda; oferta as gift is the shop's word, and oferecer is to give one." },
        { id: "pt-u66l1-aprocura", type: "vocab", front: "a procura", reading: "aprocura", meaning: "demand", example: { jp: "A procura de carros elétricos é cada vez maior, além disso o preço já não é tão alto.", en: "Demand for electric cars is greater every year; what is more, the price is no longer so high." }, drill: { jp: "A procura de carros é cada vez maior", en: "Demand for cars is greater every year" }, accept: ["demand", "the demand", "search"], hint: "pru-KOO-ruh. The noun of procurar, to look for — so \"demand\" in Portuguese is literally the looking-for. A oferta e a procura is the fixed pair, in that order, where English says supply and demand." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u66l3-exportar", type: "vocab", front: "exportar", reading: "exportar", meaning: "to export", example: { jp: "Portugal exporta muito vinho e azeite, por isso o preço lá fora conta tanto para os agricultores.", en: "Portugal exports a lot of wine and olive oil, so the price abroad matters so much to farmers." }, drill: { jp: "Portugal vai exportar mais vinho", en: "Portugal is going to export more wine" }, accept: ["export", "to sell abroad"], hint: "aish-pur-TAR — the initial e is pronounced. Regular -ar verb. The x here says \"sh\" before a consonant, as in explicar — not the \"ks\" an English reader expects." },
        ...
        { id: "pt-u66l3-fabricar", type: "vocab", front: "fabricar", reading: "fabricar", meaning: "to manufacture", example: { jp: "A empresa deixou de fabricar sapatos aqui, por isso a fábrica está vazia desde o ano passado.", en: "The company stopped manufacturing shoes here, so the factory has been empty since last year." }, drill: { jp: "A empresa vai fabricar sapatos aqui", en: "The company is going to manufacture shoes here" }, accept: ["manufacture", "to make", "to produce"], hint: "fa-bree-KAR. Narrower than produzir: you fabricar objects in a factory, but a country produz energia. Same family as a fábrica (u65)." },
      ],
    },
    {
      id: "pt-u66l4",
      ...
      items: [
        ...
        { id: "pt-u66l4-aconcorrencia", type: "vocab", front: "a concorrência", reading: "aconcorrencia", meaning: "competition (rivalry in business)", example: { jp: "A concorrência entre as marcas baixou os preços, no entanto as lojas pequenas fecharam quase todas.", en: "Competition between the brands brought prices down; the small shops, however, almost all closed." }, drill: { jp: "A concorrência baixou os preços", en: "Competition brought prices down" }, accept: ["competition", "the competition", "rivalry"], hint: "kon-ku-RREN-syuh. Business competition, and also the other companies themselves: a concorrência abriu ao lado. A sporting competition is a competição — different word, different world." },
        { id: "pt-u66l4-amarca", type: "vocab", front: "a marca", reading: "amarca", meaning: "brand", example: { jp: "Esta marca é conhecida em toda a Europa, porque a publicidade chegou antes do produto.", en: "This brand is known all over Europe, because the advertising arrived before the product did." }, drill: { jp: "A marca é conhecida em Portugal", en: "The brand is known in Portugal" }, accept: ["brand", "make", "the brand", "mark"], hint: "MAR-kuh. A brand, and also a mark left on something — a marca do copo na mesa. The verb marcar is to mark and to book an appointment." },
        { id: "pt-u66l4-afalencia", type: "vocab", front: "a falência", reading: "afalencia", meaning: "bankruptcy", example: { jp: "A falência da empresa apanhou toda a gente, no entanto os sinais já estavam nas contas do ano passado.", en: "The company's bankruptcy caught everybody out; the signs, however, were already in last year's accounts." }, drill: { jp: "A falência da empresa apanhou toda a gente", en: "The company's bankruptcy caught everybody out" }, accept: ["bankruptcy", "the bankruptcy", "failure", "collapse"], hint: "fa-LEN-syuh. Ir à falência is to go bust. Built on falir, to go bust — the noun of a business failing rather than a person failing." },
      ],
    },
  ],
};
