  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u87l1-odano", type: "vocab", front: "o dano", reading: "odano", meaning: "damage", example: { jp: "O dano da chuva na madeira da porta é grande.", en: "The damage from the rain to the wood of the door is extensive." }, drill: { jp: "O dano da chuva na madeira é grande", en: "The rain damage to the wood is extensive" }, accept: ["the damage", "damage", "harm", "the harm", "injury"], hint: "DA-nu. The damage itself, the noun a Portuguese insurance form is built around — danos materiais. Danificar is the verb, and sem danos means undamaged." },
      ],
    },
    {
      id: "pt-u87l2",
