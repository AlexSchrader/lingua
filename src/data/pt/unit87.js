  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u87l1-oestado", type: "vocab", front: "o estado", reading: "oestado", meaning: "condition", example: { jp: "O estado do carro velho é mau mas ainda funciona.", en: "The old car's condition is bad but it still works." }, drill: { jp: "O estado do carro é mau", en: "The car's condition is bad" }, accept: ["the condition", "condition", "the state", "state"], hint: "esh-TA-du. The condition a thing is in — em bom estado, em mau estado. With a capital it is the State, the government, which is why o Estado pays Portuguese pensions." },
      ],
    },
    {
      id: "pt-u87l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u87l4-manter", type: "vocab", front: "manter", reading: "manter", meaning: "to keep", example: { jp: "A empresa mantém as máquinas sempre boas com o técnico da cidade.", en: "The company keeps its machines in good order with the town technician." }, drill: { jp: "A empresa vai manter as máquinas boas", en: "The company is going to keep the machines in order" }, accept: ["keep", "to keep", "to maintain", "maintain", "to keep up"], hint: "man-TER, and it follows ter: mantenho, manténs, mantém. Keeping a machine, a promise or a straight face. A manutenção, the servicing in this unit's title, is its noun." },
      ],
    },
  ],
};
