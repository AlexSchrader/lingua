  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u87l1-entupir", type: "vocab", front: "entupir", reading: "entupir", meaning: "to block", example: { jp: "O nariz da criança entupiu com o frio.", en: "The child's nose got blocked with the cold." }, drill: { jp: "O nariz da criança vai entupir", en: "The child's nose is going to block up" }, accept: ["block", "to block", "to clog", "to block up", "to get blocked"], hint: "en-tu-PEER. What a drain, a nose or a road does when nothing gets through. O cano entupiu is the sentence that calls a plumber; estou entupido is what you say with a cold." },
        ...
        { id: "pt-u87l1-odano", type: "vocab", front: "o dano", reading: "odano", meaning: "damage", example: { jp: "O dano da chuva na madeira da porta é grande.", en: "The damage from the rain to the wood of the door is extensive." }, drill: { jp: "Ninguém quer pagar o dano", en: "Nobody wants to pay for the damage" }, accept: ["the damage", "damage", "harm", "the harm", "injury"], hint: "DA-nu. The damage itself, the noun a Portuguese insurance form is built around — danos materiais. Danificar is the verb, and sem danos means undamaged." },
      ],
    },
    {
      id: "pt-u87l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u87l3-omartelo", type: "vocab", front: "o martelo", reading: "omartelo", meaning: "hammer", example: { jp: "O martelo do avô é velho mas é bom.", en: "My grandfather's hammer is old but it's a good one." }, drill: { jp: "O martelo está na caixa das ferramentas", en: "The hammer is in the toolbox" }, accept: ["the hammer", "hammer", "mallet"], hint: "mar-TE-lu. Martelar is to hammer, and it stretches to hammering a point home. A marteladas means by brute force, which is not a compliment about the work." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u87l4-apertar", type: "vocab", front: "apertar", reading: "apertar", meaning: "to tighten", example: { jp: "O pai apertou o parafuso da cadeira com a ferramenta do avô.", en: "My father tightened the chair's screw with my grandfather's tool." }, drill: { jp: "Vou apertar o parafuso da cadeira", en: "I'm going to tighten the chair's screw" }, accept: ["tighten", "to tighten", "to do up", "to squeeze", "to press"], hint: "a-per-TAR. Tightening a screw, doing up a belt, and shaking a hand — apertar a mão. Sapatos que apertam are shoes that pinch." },
      ],
    },
  ],
};
