  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "pt-u87l1-entupir", type: "vocab", front: "entupir", reading: "entupir", meaning: "to block", example: { jp: "O buraco da cozinha entupiu com o óleo velho.", en: "The hole in the kitchen sink got blocked with old oil." }, drill: { jp: "O buraco da cozinha vai entupir", en: "The hole in the kitchen sink is going to block up" }, accept: ["block", "to block", "to clog", "to block up", "to get blocked"], hint: "en-tu-PEER. What a drain, a nose or a road does when nothing gets through. O cano entupiu is the sentence that calls a plumber; estou entupido is what you say with a cold." },
