  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pt-u5l3-meiodia", type: "vocab", front: "o meio-dia", reading: "omeiodia", meaning: "midday", example: { jp: "É meio-dia e o pai não está em casa.", en: "It's midday and dad isn't at home." }, drill: { jp: "O meio-dia em Lisboa é quente", en: "Midday in Lisbon is hot" }, accept: ["noon", "12pm", "midday"], hint: "meio is \"half\", so this is literally \"half-day\". Portugal writes the hyphen. Lunch is usually well after it — one o'clock at the earliest." },
