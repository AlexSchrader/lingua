...
export const NO_UNIT18 = {
  ...
  lessons: [
    ...
    // unit (u11) is block 2's and en lege belongs to it.
    {
      ...
      items: [
        { id: "no-u18l4-enbonde", type: "vocab", front: "en bonde", reading: "enbonde", meaning: "farmer", example: { jp: "En bonde jobber mye.", en: "A farmer works a lot." }, accept: ["a farmer", "peasant"], drill: { jp: "En bonde jobber tidlig", en: "A farmer works early" }, hint: "BON-ne — the d is silent. Masculine: definite bonden, and the plural is bønder, with a vowel change. En gård is the farm itself." },
