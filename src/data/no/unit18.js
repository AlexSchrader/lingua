...
// en skole, en lærer, en elev, å jobbe (u3), å lære (u1), å forstå, å begynne,
// å slutte, en time. This unit takes what a learner still cannot say: reading
  ...
  lessons: [
    // Lesson 1: reading, writing, and the things you do it with.
    {
      ...
      items: [
        ...
        { id: "no-u18l1-enpenn", type: "vocab", front: "en penn", reading: "enpenn", meaning: "pen", example: { jp: "En penn er på ei hylle.", en: "A pen is on a shelf." }, accept: ["a pen", "biro", "ballpoint"], hint: "PENN. Masculine: definite pennen, plural penner. A pencil is en blyant — a different word, and the one a Norwegian child starts school with." },
        { id: "no-u18l1-etpapir", type: "vocab", front: "et papir", reading: "etpapir", meaning: "paper", example: { jp: "Jeg skriver på et papir.", en: "I am writing on a sheet of paper." }, accept: ["a paper", "a sheet of paper", "sheet of paper", "a piece of paper"], hint: "pa-PEER, with the stress at the end. Neuter: definite papiret, plural papirer. A newspaper is ei avis, never a papir." },
