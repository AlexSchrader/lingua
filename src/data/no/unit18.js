  ...
  lessons: [
    // Lesson 1: reading, writing, and the things you do it with.
    {
      ...
      items: [
        ...
        { id: "no-u18l1-eibok", type: "vocab", front: "ei bok", reading: "eibok", meaning: "book", example: { jp: "Boka ligger på et bord.", en: "The book is lying on a table." }, accept: ["a book", "volume"], drill: { jp: "Ei bok er tung", en: "A book is heavy" }, hint: "BOOK. Feminine: definite boka, plural bøker — the vowel changes in the plural. You will very often see this one written en bok / boken; Bokmål allows both and boken is everywhere in print. This course writes ei, because ei is what predicts the -a definite and en tells you nothing." },
        { id: "no-u18l1-enpenn", type: "vocab", front: "en penn", reading: "enpenn", meaning: "pen", example: { jp: "Det ligger en penn på hylla.", en: "There is a pen lying on the shelf." }, accept: ["a pen", "biro", "ballpoint"], drill: { jp: "En penn er billig", en: "A pen is cheap" }, hint: "PENN. Masculine: definite pennen, plural penner. A pencil is en blyant — a different word, and the one a Norwegian child starts school with." },
        { id: "no-u18l1-etpapir", type: "vocab", front: "et papir", reading: "etpapir", meaning: "paper", example: { jp: "Jeg skriver på papir.", en: "I write on paper." }, accept: ["a paper", "paper", "a document", "document"], drill: { jp: "Et papir er hvitt", en: "A paper is white" }, hint: "pa-PEER, with the stress at the end. Neuter: definite papiret, plural papirer. Bare papir is the MATERIAL, which is why the example has no article; et papir counted out singly is a document or an official form. A single sheet is et ark, and a newspaper is ei avis — never a papir." },
        { id: "no-u18l1-etord", type: "vocab", front: "et ord", reading: "etord", meaning: "word", example: { jp: "Hva er ordet på norsk?", en: "What is the word in Norwegian?" }, accept: ["a word", "term"], drill: { jp: "Et ord er kort", en: "A word is short" }, hint: "OOR — the d is silent, like god and sted. Neuter: definite ordet, and the plural is ord, unchanged. Ei ordbok is a dictionary: ord welded onto bok." },
      ],
    },
    ...
    // Lesson 3: the workplace. `arbeid` is the mass-noun exception.
    {
      ...
      items: [
        ...
        { id: "no-u18l3-etkontor", type: "vocab", front: "et kontor", reading: "etkontor", meaning: "office", example: { jp: "Jeg jobber på et kontor i Oslo.", en: "I work in an office in Oslo." }, accept: ["an office"], drill: { jp: "Et kontor er stort", en: "An office is big" }, hint: "kon-TOOR, stress at the end. Neuter: definite kontoret, plural kontorer. Note på et kontor — a workplace takes på, exactly like på en skole in unit 7, where English says \"in\"." },
        { id: "no-u18l3-ensjef", type: "vocab", front: "en sjef", reading: "ensjef", meaning: "boss", example: { jp: "Sjefen min er hyggelig.", en: "My boss is nice." }, accept: ["a boss", "chief", "manager", "head", "supervisor"], drill: { jp: "En sjef er hyggelig", en: "A boss is nice" }, hint: "SHEHF — sj is the broad sh of sjø. Masculine: definite sjefen, plural sjefer. Borrowed from French chef and respelled the way Norwegian actually says it." },
        { id: "no-u18l3-enkollega", type: "vocab", front: "en kollega", reading: "enkollega", meaning: "colleague", example: { jp: "En kollega hjelper meg på kontoret.", en: "A colleague is helping me at the office." }, accept: ["a colleague", "coworker", "co-worker", "workmate"], drill: { jp: "En kollega er hyggelig", en: "A colleague is nice" }, hint: "ko-LEH-ga, hard g. Masculine: definite kollegaen, plural kolleger. Norwegian workplaces are famously flat: you say du to en sjef as readily as to en kollega, and first names go all the way up." },
    ...
    // unit (u11) is block 2's and en lege belongs to it.
    {
      ...
      items: [
        { id: "no-u18l4-enbonde", type: "vocab", front: "en bonde", reading: "enbonde", meaning: "farmer", example: { jp: "En bonde jobber mye.", en: "A farmer works a lot." }, accept: ["a farmer", "peasant"], drill: { jp: "En bonde jobber mye", en: "A farmer works a lot" }, hint: "BON-ne — the d is silent. Masculine: definite bonden, and the plural is bønder, with a vowel change. En gård is the farm itself." },
        { id: "no-u18l4-enkokk", type: "vocab", front: "en kokk", reading: "enkokk", meaning: "cook", example: { jp: "En kokk lager middag på en restaurant.", en: "A cook makes dinner at a restaurant." }, accept: ["a cook", "chef"], drill: { jp: "En kokk lager en middag", en: "A cook makes a dinner" }, hint: "KOKK. Masculine: definite kokken, plural kokker. Å koke is to boil — the verb the job is named from. Note å lage mat from unit 6 is what a kokk does all day." },
        { id: "no-u18l4-ensjafor", type: "vocab", front: "en sjåfør", reading: "ensjafor", meaning: "driver", example: { jp: "En sjåfør kjører en buss.", en: "A driver drives a bus." }, accept: ["a driver", "chauffeur"], drill: { jp: "En sjåfør kjører en buss", en: "A driver drives a bus" }, hint: "sho-FUR — sj is the broad sh again. The reading folds twice, å to a and ø to o, giving ensjafor. Masculine: definite sjåføren, plural sjåfører. French chauffeur, spelled the Norwegian way." },
        { id: "no-u18l4-enselger", type: "vocab", front: "en selger", reading: "enselger", meaning: "salesperson", example: { jp: "En selger jobber i en butikk.", en: "A salesperson works in a shop." }, accept: ["a seller", "salesman", "shop assistant", "sales assistant", "a salesperson"], drill: { jp: "En selger jobber i en butikk", en: "A salesperson works in a shop" }, hint: "SEL-ger, hard g. Masculine: definite selgeren, plural selgere. From å selge, to sell: the -er ending builds a doer out of a verb, exactly as it built en lærer out of å lære in unit 3." },
