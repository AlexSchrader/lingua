...
export const NO_UNIT18 = {
  ...
  lessons: [
    // Lesson 1: reading, writing, and the things you do it with.
    {
      ...
      cefr: "A1",
      dominantMode: "recall",
      canDo: "Say that you read and write, name a book, a pen and paper, and ask what a word is in Norwegian.",
      items: [
        ...
        { id: "no-u18l1-etpapir", type: "vocab", front: "et papir", reading: "etpapir", meaning: "paper", example: { jp: "Jeg skriver på papir.", en: "I write on paper." }, accept: ["a paper", "paper", "a document", "document"], drill: { jp: "Læreren gir meg et papir", en: "The teacher gives me a document" }, hint: "pa-PEER, with the stress at the end. Neuter: definite papiret, plural papirer. Bare papir is the MATERIAL, which is why the example has no article; et papir counted out singly is a document or an official form. A single sheet is et ark, and a newspaper is ei avis — never a papir." },
    ...
    // unit (u11) is block 2's and en lege belongs to it.
    {
      ...
      cefr: "A1",
      dominantMode: "recall",
      canDo: "Name what people do for a living — farmer, cook, driver, salesperson, carpenter, hairdresser — and say what each of them does.",
      items: [
