  ...
  lessons: [
    ...
    // Lesson 2: the dark end of the palette, plus lys/mørk and the flag.
    {
      ...
      items: [
        ...
        { id: "no-u8l2-lys", type: "vocab", front: "lys", reading: "lys", meaning: "light", example: { jp: "Hun har ei lys skjorte.", en: "She has a light shirt." }, accept: ["pale", "bright", "light-coloured", "light-colored"], drill: { jp: "Ei skjorte er lys", en: "A shirt is light" }, hint: "Of colour, not of weight — a pale shade. Norwegian y is the u of gul with the tongue even higher: LUES. As a noun et lys is a candle." },
    ...
    // Lesson 4: how it feels — cold, warm, wet, dry, windy, freezing.
    {
      ...
      items: [
        ...
        { id: "no-u8l4-varm", type: "vocab", front: "varm", reading: "varm", meaning: "warm", example: { jp: "Sola er varm.", en: "The sun is warm." }, accept: ["hot"], drill: { jp: "En kopp er varm", en: "A cup is warm" }, hint: "VARM. Norwegian uses varm for both \"warm\" and \"hot\" — of drinks, of food and of weather. Neuter varmt." },
