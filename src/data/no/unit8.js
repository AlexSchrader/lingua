  ...
  lessons: [
    ...
    // Lesson 2: the dark end of the palette, plus lys/mørk and the flag.
    {
      ...
      items: [
        ...
        { id: "no-u8l2-brun", type: "vocab", front: "brun", reading: "brun", meaning: "brown", example: { jp: "Hunden er brun.", en: "The dog is brown." }, accept: [], hint: "The u here is Norwegian's own — the tight, forward vowel you meet on gul, not an English \"oo\". Brunost, brown cheese, is a national institution: sweet, caramel-coloured, and made from ost." },
    ...
    // Lesson 3: the weather nouns and the two weather verbs.
    {
      ...
      items: [
        ...
        { id: "no-u8l3-envind", type: "vocab", front: "en vind", reading: "envind", meaning: "wind", example: { jp: "Vinden kommer fra sjøen.", en: "The wind is coming from the sea." }, accept: ["a wind", "breeze"], hint: "Masculine: en vind → vinden. Final d is silent, as in god and med: VINN." },
    ...
    // Lesson 4: how it feels — cold, warm, wet, dry, windy, freezing.
    {
      ...
      items: [
        ...
        { id: "no-u8l4-ablase", type: "vocab", front: "å blåse", reading: "ablase", meaning: "to blow", example: { jp: "Det blåser mye på øya.", en: "There is a lot of wind on the island." }, accept: ["blow", "to be windy"], hint: "BLAW-se. Det blåser is the ordinary way to say \"it is windy\" — Norwegian makes the wind a verb where English makes it an adjective." },
