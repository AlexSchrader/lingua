  ...
  lessons: [
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Pile on another point — dessuten, i tillegg, samt, både … og, for eksempel, nemlig.",
      items: [
        ...
        { id: "no-u29l1-foreksempel", type: "vocab", front: "for eksempel", reading: "foreksempel", meaning: "for example", example: { jp: "Jeg liker dyr, for eksempel hunder og katter.", en: "I like animals, for example dogs and cats." }, accept: ["for instance", "e.g."], drill: { jp: "for eksempel en hund", en: "for example a dog" }, hint: "Written short as f.eks. From et eksempel, an example (A2 u18)." },
    ...
    },
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Put steps in order and mark a result — deretter, til slutt, altså, dermed, slik at, siden.",
      items: [
        ...
        { id: "no-u29l2-tilslutt", type: "vocab", front: "til slutt", reading: "tilslutt", meaning: "finally", example: { jp: "Vi ventet en stund, og til slutt fant vi huset.", en: "We waited a while, and finally we found the house." }, accept: ["in the end", "at last", "lastly"], drill: { jp: "Til slutt sov barnet", en: "Finally the child slept" }, hint: "From en slutt, an end (A1). Marks the last thing in a sequence." },
    ...
    },
    {
      ...
      items: [
        { id: "no-u29l3-likevel", type: "vocab", front: "likevel", reading: "likevel", meaning: "still", example: { jp: "Det var dyrt, men vi kjøpte det likevel.", en: "It was expensive, but we bought it anyway." }, accept: ["anyway", "nevertheless", "even so"], drill: { jp: "Likevel kom han", en: "He came anyway" }, hint: "LEE-ke-vel. Concedes the first point and carries on: dyrt, men likevel. Fronts and inverts." },
        ...
        { id: "no-u29l3-derimot", type: "vocab", front: "derimot", reading: "derimot", meaning: "on the other hand", example: { jp: "Jeg liker te. Kaffe, derimot, drikker jeg aldri.", en: "I like tea. Coffee, on the other hand, I never drink." }, accept: ["by contrast", "whereas"], drill: { jp: "Han sa derimot nei", en: "He said no, by contrast" }, hint: "DER-ee-mot. Sets one thing directly against another — sharper than men." },
        { id: "no-u29l3-tvertimot", type: "vocab", front: "tvert imot", reading: "tvertimot", meaning: "on the contrary", example: { jp: "Han var ikke sint. Tvert imot, han lo av det.", en: "He wasn't angry. On the contrary, he laughed at it." }, accept: ["quite the opposite", "far from it"], drill: { jp: "Tvert imot liker jeg det", en: "On the contrary, I like it" }, hint: "tvert ee-MOT. Flatly reverses what was just said or expected. Stronger than derimot." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u29l4-heller", type: "vocab", front: "heller", reading: "heller", meaning: "rather", example: { jp: "Jeg vil heller bli hjemme enn å gå ut i dag.", en: "I'd rather stay home than go out today." }, accept: ["preferably", "instead"], drill: { jp: "Jeg tar heller te", en: "I'd rather have tea" }, hint: "HEL-ler. vil heller = would rather; heller enn = rather than. In a negative it means \"either\": jeg vet det ikke heller." },
        { id: "no-u29l4-dersom", type: "vocab", front: "dersom", reading: "dersom", meaning: "if", example: { jp: "Dersom det blir fint vær, drar vi på tur.", en: "If the weather turns nice, we'll go on a trip." }, accept: ["provided that", "in case"], drill: { jp: "dersom du vil", en: "if you want" }, hint: "DER-som. A slightly more formal hvis (A1) — same job, same clause order: dersom det BLIR fint." },
