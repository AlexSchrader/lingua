  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u29l2-tilslutt", type: "vocab", front: "til slutt", reading: "tilslutt", meaning: "in the end", example: { jp: "Vi går lenge, og til slutt ser vi huset.", en: "We walk a long time, and finally we see the house." }, accept: ["finally", "at last", "lastly"], drill: { jp: "Til slutt kommer bussen", en: "Finally the bus comes" }, hint: "From en slutt, an end (A1). Marks the last thing in a sequence." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u29l3-enda", type: "vocab", front: "enda", reading: "enda", meaning: "even", example: { jp: "I dag er det enda kaldere enn i går.", en: "Today it's even colder than yesterday." }, accept: ["still", "yet more"], drill: { jp: "enda kaldere enn i dag", en: "even colder than today" }, hint: "EN-da. Before a comparative it means \"even\": enda kaldere. Don't confuse it with ennå (still, not yet), taught in u28." },
      ],
    },
    {
      id: "no-u29l4",
