  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u105l4-enmedfolelse", type: "vocab", front: "en medfølelse", reading: "enmedfolelse", meaning: "compassion", example: { jp: "Medfølelsen er ærlig nok, men den gjør ingenting med det som faktisk er problemet hennes.", en: "The compassion is honest enough, but it does nothing about what is actually her problem." }, accept: ["compassion", "sympathy"], drill: { jp: "Hun møtte en medfølelse hun ikke ventet", en: "She met a compassion she did not expect" }, hint: "en medfølelse → medfølelsen. ⚠ -else er hankjønn, aldri ei. Med + en følelse (u40). Merk ø-folden: lesinga er enmedfolelse. Du føler MED noen; du synes ikke synd på dem." },
