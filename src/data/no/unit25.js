  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u25l1-enforkjolelse", type: "vocab", front: "en forkjølelse", reading: "enforkjolelse", meaning: "a cold (the illness)", example: { jp: "Forkjølelsen tar en uke, men han er mye bedre nå.", en: "The cold takes a week, but he is much better now." }, accept: ["cold", "head cold"], drill: { jp: "En forkjølelse tar ei uke", en: "A cold takes a week" }, hint: "for-HYUR-lel-se — the thin kj from A1 unit 1. Masculine: definite forkjølelsen. Built on kald, cold — literally a chilling." },
