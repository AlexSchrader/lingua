  ...
  lessons: [
    {
      ...
      items: [
        { id: "no-u25l1-ensmerte", type: "vocab", front: "en smerte", reading: "ensmerte", meaning: "pain", example: { jp: "Smerten kom sent, men den er ikke så vond nå når jeg har sovet.", en: "The pain came late, but it does not hurt so much now that I have slept." }, accept: ["a pain", "ache", "hurt"], drill: { jp: "En smerte kommer sakte", en: "A pain comes slowly" }, hint: "SMER-te. Masculine: definite smerten, plural smerter. A1's `vond` is the adjective — det gjør vondt; en smerte is the thing itself." },
        ...
        { id: "no-u25l1-enforkjolelse", type: "vocab", front: "en forkjølelse", reading: "enforkjolelse", meaning: "a cold (the illness)", example: { jp: "Forkjølelsen tar en uke, men han er frisk nå.", en: "The cold takes a week, but he is well now." }, accept: ["cold", "head cold"], drill: { jp: "En forkjølelse tar ei uke", en: "A cold takes a week" }, hint: "for-HYUR-lel-se — the thin kj from A1 unit 1. Masculine: definite forkjølelsen. Built on kald, cold — literally a chilling." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u25l2-sovn", type: "vocab", front: "søvn", reading: "sovn", meaning: "sleep", example: { jp: "Søvnen er viktig, fordi kroppen blir frisk igjen når du sover.", en: "Sleep is important, because the body gets well again when you sleep." }, accept: ["the sleep", "slumber"], drill: { jp: "Søvn er viktig for kroppen", en: "Sleep is important for the body" }, hint: "SURVN. A mass noun, so it is taught bare (§1b). Masculine: definite søvnen. A1 taught the verb å sove; this is the noun, and the two look less alike than they are." },
        ...
        { id: "no-u25l2-aslite", type: "vocab", front: "å slite", reading: "aslite", meaning: "to struggle", example: { jp: "Hun sliter med søvnen, men hun sover godt når hun trener.", en: "She struggles with sleep, but she sleeps well when she exercises." }, accept: ["struggle", "to toil", "to have a hard time", "to wear out"], drill: { jp: "Det er tungt å slite mye", en: "It is hard to struggle a lot" }, hint: "SLEE-te. You slite MED something — å slite med søvnen. It also means to wear something out." },
      ],
    },
    {
      id: "no-u25l3",
    ...
    },
    {
      ...
      items: [
        { id: "no-u25l4-eibedring", type: "vocab", front: "ei bedring", reading: "eibedring", meaning: "improvement", example: { jp: "Det er ei bedring i dag, men legen sier at han må hvile.", en: "There is an improvement today, but the doctor says he has to rest." }, accept: ["an improvement", "recovery"], drill: { jp: "Det er ei bedring nå", en: "There is an improvement now" }, hint: "BEH-dring, from god → bedre, better — the comparative itself is taught at u37. Feminine: definite bedringa. God bedring! is what you say to someone ill — get well soon." },
        { id: "no-u25l4-enkur", type: "vocab", front: "en kur", reading: "enkur", meaning: "cure", example: { jp: "Det finnes ingen kur, men medisinen hjelper når smerten kommer.", en: "There is no cure, but the medicine helps when the pain comes." }, accept: ["a cure", "course of treatment", "remedy"], drill: { jp: "En kur kan bli lang", en: "A cure can be long" }, hint: "KOOR. Masculine: definite kuren. En kur is also a course of pills — å ta en kur." },
