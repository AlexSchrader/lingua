  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u25l2-sovn", type: "vocab", front: "søvn", reading: "sovn", meaning: "sleep", example: { jp: "Søvnen er viktig, fordi kroppen blir frisk igjen når du sover.", en: "Sleep is important, because the body gets well again when you sleep." }, accept: ["the sleep", "slumber"], drill: { jp: "God søvn er viktig", en: "Good sleep is important" }, hint: "SURVN. A mass noun, so it is taught bare (§1b). Masculine: definite søvnen. A1 taught the verb å sove; this is the noun, and the two look less alike than they are." },
