  ...
  lessons: [
    ...
    // subordinate clause, where it must stand before the verb.
    {
      ...
      items: [
        ...
        { id: "no-u69l1-muligens", type: "vocab", front: "muligens", reading: "muligens", meaning: "possibly (formal)", example: { jp: "Han sa at han muligens kommer litt for sent.", en: "He said that he will possibly come a little too late." }, drill: { jp: "Hun kommer muligens litt for sent", en: "She will possibly come a little too late" }, accept: ["maybe (written)", "perhaps", "it may be that"], hint: "MU-li-ens. Mulig plus -ens. It is a sentence adverb, so in a leddsetning it goes in FRONT of the verb — at han muligens kommer, never at han kommer muligens. Drier than kanskje and it never opens the sentence." },
      ],
    },
