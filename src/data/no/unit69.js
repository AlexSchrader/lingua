...
export const NO_UNIT69 = {
  ...
  lessons: [
    ...
    // subordinate clause, where it must stand before the verb.
    {
      ...
      items: [
        { id: "no-u69l1-stadig", type: "vocab", front: "stadig", reading: "stadig", meaning: "constantly", example: { jp: "Jeg ser at han stadig kommer for sent.", en: "I see that he constantly arrives late." }, accept: ["continually", "repeatedly", "still"], drill: { jp: "Han kommer stadig for sent", en: "He constantly arrives late" }, hint: "⚠ THE RULE OF THIS LESSON: in a leddsetning the adverb stands BEFORE the verb — at han stadig kommer. In a main clause it stands after — han kommer stadig. ikke behaves exactly the same way. stadig flere also means \"more and more\"." },
        { id: "no-u69l1-neppe", type: "vocab", front: "neppe", reading: "neppe", meaning: "hardly", example: { jp: "Jeg tror at hun neppe kommer i dag.", en: "I think that she is hardly likely to come today." }, accept: ["scarcely", "unlikely", "hardly likely"], drill: { jp: "Hun kommer neppe i dag", en: "She is hardly likely to come today" }, hint: "A negative adverb, so it takes ikke's place and you never use both. Politer than a flat no: han kommer neppe softens the refusal." },
        { id: "no-u69l1-antakelig", type: "vocab", front: "antakelig", reading: "antakelig", meaning: "probably", example: { jp: "Han sier at det antakelig blir kaldt i morgen.", en: "He says that it will probably be cold tomorrow." }, accept: ["presumably", "most likely"], drill: { jp: "Det blir antakelig kaldt i morgen", en: "It will probably be cold tomorrow" }, hint: "From å anta, to assume. -ig, so no -t in the neuter. The everyday one of the four probability words in this unit." },
        { id: "no-u69l1-trolig", type: "vocab", front: "trolig", reading: "trolig", meaning: "likely", example: { jp: "Vi vet at hun trolig flytter til Bergen.", en: "We know that she is likely to move to Bergen." }, accept: ["probable", "in all likelihood"], drill: { jp: "Hun flytter trolig til Bergen", en: "She is likely to move to Bergen" }, hint: "å tro (u12) + -lig — what can be believed. Adjective and adverb in one, like opprinnelig (u63)." },
    ...
    // Lesson 2: the som paradigm. som never opens a relative clause alone.
    {
      ...
      items: [
        { id: "no-u69l2-der", type: "vocab", front: "der", reading: "der", meaning: "where", example: { jp: "Dette er huset der jeg vokste opp.", en: "This is the house where I grew up." }, accept: ["there", "in which"], drill: { jp: "Dette er byen der jeg bor", en: "This is the town where I live" }, hint: "der ties a PLACE to a clause; som ties a thing. Also the everyday \"there\": boka står der. Norwegians often say hvor instead of der here, and both are correct." },
        { id: "no-u69l2-detsom", type: "vocab", front: "det som", reading: "detsom", meaning: "what", example: { jp: "Jeg forstår ikke det som skjer nå.", en: "I do not understand what is happening now." }, accept: ["that which", "the thing that"], drill: { jp: "Jeg forstår ikke det som skjer", en: "I do not understand what is happening" }, hint: "⚠ English \"what\" as a relative is TWO words in Norwegian: det som. Never hva — hva only asks questions." },
    ...
    // fronted, and every example shows that inversion.
    {
      ...
      items: [
        ...
        { id: "no-u69l3-padenannenside", type: "vocab", front: "på den annen side", reading: "padenannenside", meaning: "on the other hand", example: { jp: "På den annen side er det billigere i Bergen.", en: "On the other hand, it is cheaper in Bergen." }, accept: ["then again", "conversely"], drill: { jp: "På den annen side er det billigere", en: "On the other hand it is cheaper" }, hint: "⚠ annen, not andre — the phrase keeps an older form, and changing it sounds wrong. It pairs with på den ene siden." },
    ...
    // Lesson 4: indirect questions, and time relations more precise than når.
    {
      ...
      items: [
        { id: "no-u69l4-hvorvidt", type: "vocab", front: "hvorvidt", reading: "hvorvidt", meaning: "whether", example: { jp: "Han spurte hvorvidt vi hadde betalt.", en: "He asked whether we had paid." }, accept: ["if (whether)", "as to whether"], drill: { jp: "Han spurte hvorvidt vi hadde betalt", en: "He asked whether we had paid" }, hint: "The formal twin of om (u28). Writers reach for it when om could be read as \"if\" instead of \"whether\"." },
        { id: "no-u69l4-hvasom", type: "vocab", front: "hva som", reading: "hvasom", meaning: "what happened", example: { jp: "Ingen vet hva som skjedde den natta.", en: "Nobody knows what happened that night." }, accept: ["what (as subject)", "what"], drill: { jp: "Ingen vet hva som skjedde", en: "Nobody knows what happened" }, hint: "Same rule as hvem som in l2: when the question word is the SUBJECT of the reported clause, som follows it. Compare hva han sa, where hva is the object and som never appears." },
        { id: "no-u69l4-meddetsamme", type: "vocab", front: "med det samme", reading: "meddetsamme", meaning: "right away", example: { jp: "Ring meg med det samme du kommer.", en: "Call me as soon as you arrive." }, accept: ["as soon as", "immediately", "straight away"], drill: { jp: "Ring meg med det samme du kommer", en: "Call me as soon as you arrive" }, hint: "Two jobs in one phrase: \"immediately\" on its own (jeg kommer med det samme), and \"as soon as\" in front of a clause." },
        ...
        { id: "no-u69l4-savidt", type: "vocab", front: "så vidt", reading: "savidt", meaning: "barely", example: { jp: "Vi rakk så vidt toget.", en: "We barely caught the train." }, accept: ["only just", "hardly", "as far as"], drill: { jp: "Vi rakk så vidt toget", en: "We barely caught the train" }, hint: "Two senses, both common: \"barely\" (vi rakk det så vidt) and \"as far as\" in så vidt jeg vet — as far as I know." },
      ],
    },
  ],
};
