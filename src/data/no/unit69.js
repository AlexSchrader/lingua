  ...
  lessons: [
    ...
    // subordinate clause, where it must stand before the verb.
    {
      ...
      items: [
        ...
        { id: "no-u69l1-utvilsomt", type: "vocab", front: "utvilsomt", reading: "utvilsomt", meaning: "undoubtedly", example: { jp: "Han er utvilsomt den beste læreren på skolen.", en: "He is undoubtedly the best teacher at the school." }, accept: ["without doubt", "no doubt", "beyond question"], drill: { jp: "Hun er utvilsomt best", en: "She is undoubtedly best" }, hint: "u- + tvil + -somt. Setningsadverb: i en leddsetning står det FØR verbet — ...at han utvilsomt er best." },
        { id: "no-u69l1-unektelig", type: "vocab", front: "unektelig", reading: "unektelig", meaning: "undeniably", example: { jp: "Han har unektelig gjort mye for oss.", en: "He has undeniably done a lot for us." }, accept: ["admittedly", "there is no denying"], drill: { jp: "Han har unektelig gjort mye", en: "He has undeniably done a lot" }, hint: "u- + nekte + -lig: det som ikke kan nektes. Brukes når du innrømmer noe som taler mot deg selv." },
      ],
    },
