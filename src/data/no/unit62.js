  ...
  lessons: [
    ...
    // opplegg is real praise.
    {
      ...
      items: [
        ...
        { id: "no-u62l3-asorge", type: "vocab", front: "å sørge", reading: "asorge", meaning: "to make sure", example: { jp: "Sørg for at alle får beskjed.", en: "Make sure everyone gets word." }, drill: { jp: "Det er viktig å sørge for alt", en: "It is important to see to everything" }, accept: ["see to it", "to provide for", "to grieve", "make sure"], hint: "SUR-ge. Present sørger, past sørget. ⚠ Two senses that feel unrelated and share one verb: å sørge FOR noe is to see to it, and å sørge on its own is to grieve. The for is the whole difference." },
    ...
    // learner, and it is built on å tåle plus mot — the courage to bear it.
    {
      ...
      items: [
        ...
        { id: "no-u62l4-talmodig", type: "vocab", front: "tålmodig", reading: "talmodig", meaning: "patient", example: { jp: "Hun er tålmodig med alle elevene.", en: "She is patient with all the pupils." }, drill: { jp: "Du må være tålmodig her", en: "You have to be patient here" }, accept: ["patient with someone", "forbearing", "willing to wait", "long-suffering"], hint: "tawl-MO-di — silent g. Å tåle, to bear, plus mot, courage: the courage to bear it. Neuter tålmodig, plural tålmodige. Utålmodig is impatient, and tålmodighet is patience." },
      ],
    },
  ],
};
