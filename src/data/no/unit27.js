  ...
  lessons: [
    ...
    // Lesson 2: what happens at the till.
    {
      ...
      items: [
        ...
        { id: "no-u27l2-gratis", type: "vocab", front: "gratis", reading: "gratis", meaning: "free", example: { jp: "Et produkt er gratis hvis en butikk vil at vi skal smake.", en: "A product is free if a shop wants us to taste it." }, drill: { jp: "Et glass vann er gratis", en: "A glass of water is free" }, accept: ["free of charge", "for nothing", "complimentary"], hint: "GRAH-tis. Free as in costing nothing, never free as in unconstrained — that is fri, a different word. Gratis does not inflect: gratis in every gender and number." },
      ],
    },
    ...
    // Lesson 4: the money itself, and the shop it crosses.
    {
      ...
      items: [
        ...
        { id: "no-u27l4-aveksle", type: "vocab", front: "å veksle", reading: "aveksle", meaning: "to change", example: { jp: "En butikk veksler en seddel hvis en kunde ikke har mynter.", en: "A shop changes a note if a customer does not have coins." }, drill: { jp: "Det er lett å veksle en seddel", en: "It is easy to change a note" }, accept: ["change", "to give change", "to exchange", "to alternate"], hint: "VEK-sle, present veksler. To change money into smaller units or another currency — veksling is the noun. Å bytte from A1 unit 20 is swapping one thing for another; å veksle is specifically about money, or about alternating between two things." },
      ],
    },
  ],
};
