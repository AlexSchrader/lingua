...
export const NO_UNIT60 = {
  ...
  lessons: [
    ...
    // single English noun that does the same job.
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Get behind someone — support them, give advice, encourage them, seize a chance, name the effort they put in, and say what you gave up for it.",
      items: [
        { id: "no-u60l3-astotte", type: "vocab", front: "å støtte", reading: "astotte", meaning: "to support", example: { jp: "Familien støttet ham hele veien.", en: "The family supported him the whole way." }, drill: { jp: "Det er viktig å støtte en venn", en: "It is important to support a friend" }, accept: ["support", "to back", "back", "to stand behind"], hint: "STUT-te. Present støtter, past støttet. Ei støtte is the support itself — the money and the shoulder alike. ⚠ Not the same as å hjelpe: you hjelper with a task and støtter a person or a cause." },
    ...
    // about the trap: oppgi, written together, is a different verb entirely.
    {
      ...
      items: [
        ...
        { id: "no-u60l4-omsider", type: "vocab", front: "omsider", reading: "omsider", meaning: "at last", example: { jp: "Omsider kom bussen, altfor sent.", en: "At last the bus came, far too late." }, drill: { jp: "Omsider kom han hjem igjen", en: "At last he came home again" }, accept: ["finally", "eventually", "in the end", "after all that"], hint: "om-SI-der. ⚠ It carries an impatience that endelig does not: omsider means \"and about time too\". It fronts the clause and takes V2 with it: Omsider KOM bussen." },
      ],
    },
  ],
};
