  ...
  lessons: [
    ...
    // single English noun that does the same job.
    {
      ...
      items: [
        ...
        { id: "no-u60l3-astilleopp", type: "vocab", front: "å stille opp", reading: "astilleopp", meaning: "to show up for someone", example: { jp: "Gode venner stiller opp når du trenger hjelp.", en: "Good friends show up for you when you need help." }, drill: { jp: "Det er viktig å stille opp for andre", en: "It is important to show up for others" }, accept: ["to be there for someone", "to turn out", "to lend a hand"], hint: "STIL-le opp. Present stiller opp, past stilte opp. Not the same as å møte opp, which is only about being present: å stille opp FOR noen is putting yourself at their disposal." },
      ],
    },
    ...
    // about the trap: oppgi, written together, is a different verb entirely.
    {
      ...
      items: [
        ...
        { id: "no-u60l4-etgjennombrudd", type: "vocab", front: "et gjennombrudd", reading: "etgjennombrudd", meaning: "a breakthrough", example: { jp: "Etter mange år kom det endelig et gjennombrudd i saka.", en: "After many years a breakthrough finally came in the case." }, drill: { jp: "Han fikk et gjennombrudd etter mange år", en: "He got a breakthrough after many years" }, accept: ["a big step forward", "a decisive advance"], hint: "YEN-nom-brudd. Gjennom plus brudd, a break — the wall gives way. Neuter: definite gjennombruddet, plural gjennombrudd. The moment the outcome stops being in doubt." },
      ],
    },
  ],
};
