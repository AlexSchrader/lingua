...
// and `sparing` (u66) carry no article on the card, because the indefinite
...
// itself.
//
// GENDER: -ing/-ning feminine (ei forurensning, ei oppvarming, ei kilde is just
// feminine); -else masculine; compounds take the gender of their LAST element
// (ei klima + ei endring → ei klimaendring, en klima + en gass → en klimagass).
  ...
  lessons: [
    // Lesson 1: the climate itself, and where the emissions come from.
    {
      ...
      items: [
        ...
        { id: "no-u65l1-utslipp", type: "vocab", front: "et utslipp", reading: "etutslipp", meaning: "an emission", example: { jp: "Utslippene fra biler er et stort problem i byen.", en: "Emissions from cars are a big problem in town." }, accept: ["emission", "discharge"], drill: { jp: "Bilene gir et utslipp i byen", en: "The cars give off an emission in town" }, hint: "ut + å slippe — what is let out. Neuter, and unchanged in the plural: et utslipp, flere utslipp, utslippet." },
        ...
        { id: "no-u65l1-forurensning", type: "vocab", front: "ei forurensning", reading: "eiforurensning", meaning: "pollution", example: { jp: "Forurensninga i lufta er verst om vinteren.", en: "The pollution in the air is worst in winter." }, accept: ["pollution", "contamination"], drill: { jp: "Det er ei forurensning i elva", en: "There is pollution in the river" }, hint: "From å forurense, the next card. -ning → feminine: forurensninga. Usually uncountable, like English pollution." },
    ...
    // Lesson 3: where the power comes from, and why it should last.
    {
      ...
      items: [
        ...
        { id: "no-u65l3-kilde", type: "vocab", front: "ei kilde", reading: "eikilde", meaning: "a source", example: { jp: "Sola er ei viktig kilde til energi.", en: "The sun is an important source of energy." }, accept: ["source", "spring"], drill: { jp: "Sola er ei kilde til energi", en: "The sun is a source of energy" }, hint: "Feminine: kilda. Three senses in one word — a spring of water, a source of energy, and the source behind a claim in a news story." },
    ...
    // Lesson 4: what is protected, and what is lost when nobody protects it.
    {
      ...
      items: [
        ...
        { id: "no-u65l4-vern", type: "vocab", front: "et vern", reading: "etvern", meaning: "a protection", example: { jp: "Vernet av elva kom sent, men det kom.", en: "The protection of the river came late, but it came." }, accept: ["protection", "conservation", "safeguard"], drill: { jp: "Elva trenger et vern i loven", en: "The river needs a protection in the law" }, hint: "Neuter: vernet. The noun behind å verne, and it lives mostly inside compounds: naturvern, miljøvern, personvern (u75)." },
        ...
        { id: "no-u65l4-odelegge", type: "vocab", front: "å ødelegge", reading: "aodelegge", meaning: "to destroy", example: { jp: "Utslippene ødelegger elva og livet i den.", en: "The emissions destroy the river and the life in it." }, accept: ["destroy", "to ruin", "to break"], drill: { jp: "Det er lett å ødelegge naturen", en: "It is easy to destroy nature" }, hint: "øde (desolate) + å legge. Present ødelegger, past ødela, participle ødelagt — and you meet ødelagt again as a card in u70." },
      ],
    },
  ],
};
