  ...
  lessons: [
    ...
    // Lesson 3: where the power comes from, and why it should last.
    {
      ...
      items: [
        ...
        { id: "no-u65l3-kilde", type: "vocab", front: "en kilde", reading: "enkilde", meaning: "a source", example: { jp: "Sola er en viktig kilde til energi.", en: "The sun is an important source of energy." }, accept: ["source", "spring"], drill: { jp: "Sola er en kilde til energi", en: "The sun is a source of energy" }, hint: "⚠ MASCULINE: en kilde, kilden. It looks like the feminine -e nouns and is not one — kilda is the Nynorsk-flavoured form and is wrong in Bokmål. Three senses in one word — a spring of water, a source of energy, and the source behind a claim in a news story." },
