  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u83l4-etskispor", type: "vocab", front: "et skispor", reading: "etskispor", meaning: "ski track", example: { jp: "Skisporet var nytt, så det gikk lett hele veien.", en: "The ski track was new, so it went easily all the way." }, accept: ["a ski trail", "a groomed track"], drill: { jp: "Det går et skispor forbi hytta", en: "A ski track runs past the cabin" }, hint: "et skispor → skisporet, flertall skispor. Et spor (u45) + ski. Kommunen legger dem, og folk følger med på når." },
