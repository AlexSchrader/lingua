  ...
  lessons: [
    ...
    // Lesson 2: the furniture the rooms are filled with.
    {
      ...
      items: [
        ...
        { id: "no-u16l2-enstol", type: "vocab", front: "en stol", reading: "enstol", meaning: "chair", example: { jp: "Det er en stol i stua.", en: "There is a chair in the living room." }, accept: ["a chair", "seat"], hint: "STOOL — and it is an ordinary chair with a back, not the English backless \"stool\". Masculine: definite stolen, plural stoler. An armchair is en lenestol." },
        { id: "no-u16l2-eihylle", type: "vocab", front: "ei hylle", reading: "eihylle", meaning: "shelf", example: { jp: "Det er en kopp på hylla.", en: "There is a cup on the shelf." }, accept: ["a shelf", "rack", "ledge"], hint: "HUEL-le. Feminine: definite hylla, plural hyller. Ei bokhylle is a bookshelf — bok welded onto hylle, the compounding pattern from sykehus." },
        { id: "no-u16l2-etteppe", type: "vocab", front: "et teppe", reading: "etteppe", meaning: "rug", example: { jp: "Det er et teppe i stua.", en: "There is a rug in the living room." }, accept: ["a carpet", "carpet", "blanket", "a rug", "a blanket"], hint: "TEP-pe. Neuter: definite teppet, plural tepper. Both the rug on the floor and the blanket on a bed — one word for both. The throw over your legs is et pledd." },
    ...
    // (gaffel, kniv, skje, skål); this is what surrounds it.
    {
      ...
      items: [
        { id: "no-u16l3-entallerken", type: "vocab", front: "en tallerken", reading: "entallerken", meaning: "plate", example: { jp: "Det er en fisk på en tallerken.", en: "There is a fish on a plate." }, accept: ["a plate", "dish"], hint: "tal-LÆR-ken. Masculine: definite tallerkenen, plural tallerkener. Unit 6 gave you ei skål, the bowl; this is the flat one beside it." },
        ...
        { id: "no-u16l3-etspeil", type: "vocab", front: "et speil", reading: "etspeil", meaning: "mirror", example: { jp: "Det er et speil på badet.", en: "There is a mirror in the bathroom." }, accept: ["a mirror", "looking glass"], hint: "SPEIL, with the ei diphthong of hei and reise. Neuter: definite speilet, plural speil, unchanged. Note på badet — rooms of a house take på here, the same as på skolen in unit 7." },
