...
export const NO_UNIT16 = {
  ...
  lessons: [
    // Lesson 1: the rooms, and the ways in and out of them.
    {
      ...
      items: [
        { id: "no-u16l1-eistue", type: "vocab", front: "ei stue", reading: "eistue", meaning: "living room", example: { jp: "Stua er veldig hyggelig.", en: "The living room is very nice." }, accept: ["a living room", "sitting room", "lounge", "the living room"], drill: { jp: "Vi sitter i ei stue", en: "We sit in a living room" }, hint: "STOO-e. Feminine: definite stua. The room a Norwegian home is organised around. You will also see this written en stue / stuen; Bokmål allows both and the en form is common in print. This course writes ei, because ei is what tells you the definite ends in -a." },
    ...
    // Lesson 2: the furniture the rooms are filled with.
    {
      ...
      items: [
        ...
        { id: "no-u16l2-eihylle", type: "vocab", front: "ei hylle", reading: "eihylle", meaning: "shelf", example: { jp: "På hylla er det en kopp.", en: "On the shelf there is a cup." }, accept: ["a shelf", "rack", "ledge"], drill: { jp: "Ei hylle er på en vegg", en: "A shelf is on a wall" }, hint: "HUEL-le. Feminine: definite hylla, plural hyller. Ei bokhylle is a bookshelf — bok welded onto hylle, the compounding pattern from sykehus." },
        ...
        { id: "no-u16l2-eilampe", type: "vocab", front: "ei lampe", reading: "eilampe", meaning: "lamp", example: { jp: "Det er ei lampe på bordet.", en: "There is a lamp on the table." }, accept: ["a lamp", "light"], drill: { jp: "Ei lampe står på et bord", en: "A lamp stands on a table" }, hint: "LAM-pe. Feminine: definite lampa, plural lamper. Norway is dark for half the year, so lamper are not decoration — they are the reason the rooms feel the way they do." },
