...
// English does not have. Its hint says so.
//
  ...
  lessons: [
    // Lesson 1: the rooms, and the ways in and out of them.
    {
      ...
      items: [
        ...
        { id: "no-u16l1-etbad", type: "vocab", front: "et bad", reading: "etbad", meaning: "bathroom", example: { jp: "Et bad er et rom i et hus.", en: "A bathroom is a room in a house." }, accept: ["a bathroom", "bath", "toilet"], hint: "BAHD — and here the d IS sounded, unlike the silent one in god and sted. Neuter: definite badet, plural bad, unchanged. It is both the room and the bath itself: å bade is to bathe or to swim." },
        ...
        { id: "no-u16l1-etvindu", type: "vocab", front: "et vindu", reading: "etvindu", meaning: "window", example: { jp: "Et vindu er i stua.", en: "A window is in the living room." }, accept: ["a window"], hint: "VIN-du. Neuter: definite vinduet, plural vinduer. From vind, wind, plus an old word for eye — a \"wind-eye\". English borrowed that very word from Norse and it became \"window\"." },
    ...
    // Lesson 2: the furniture the rooms are filled with.
    {
      ...
      cefr: "A1",
      dominantMode: "recall",
      canDo: "Name the furniture in a room — seng, stol, hylle, teppe, lampe — and say what is standing or hanging where.",
      items: [
        ...
        { id: "no-u16l2-enstol", type: "vocab", front: "en stol", reading: "enstol", meaning: "chair", example: { jp: "En stol er i stua.", en: "A chair is in the living room." }, accept: ["a chair", "seat"], hint: "STOOL — and it is an ordinary chair with a back, not the English backless \"stool\". Masculine: definite stolen, plural stoler. An armchair is en lenestol." },
        { id: "no-u16l2-eihylle", type: "vocab", front: "ei hylle", reading: "eihylle", meaning: "shelf", example: { jp: "En kopp er på hylla.", en: "A cup is on the shelf." }, accept: ["a shelf", "rack", "ledge"], hint: "HUEL-le. Feminine: definite hylla, plural hyller. Ei bokhylle is a bookshelf — bok welded onto hylle, the compounding pattern from sykehus." },
        { id: "no-u16l2-etteppe", type: "vocab", front: "et teppe", reading: "etteppe", meaning: "rug", example: { jp: "Et teppe er i stua.", en: "A rug is in the living room." }, accept: ["a carpet", "carpet", "blanket", "a rug", "a blanket"], hint: "TEP-pe. Neuter: definite teppet, plural tepper. Both the rug on the floor and the blanket on a bed — one word for both. The throw over your legs is et pledd." },
        { id: "no-u16l2-eilampe", type: "vocab", front: "ei lampe", reading: "eilampe", meaning: "lamp", example: { jp: "Ei lampe er på et bord.", en: "A lamp is on a table." }, accept: ["a lamp", "light"], hint: "LAM-pe. Feminine: definite lampa, plural lamper. Norway is dark for half the year, so lamper are not decoration — they are the reason the rooms feel the way they do." },
    ...
    // (gaffel, kniv, skje, skål); this is what surrounds it.
    {
      ...
      cefr: "A1",
      dominantMode: "recall",
      canDo: "Name what a Norwegian kitchen and bathroom hold — tallerken, gryte, ovn, speil, såpe, håndkle — and say what is cooking or lying where.",
      items: [
        { id: "no-u16l3-entallerken", type: "vocab", front: "en tallerken", reading: "entallerken", meaning: "plate", example: { jp: "En fisk er på en tallerken.", en: "A fish is on a plate." }, accept: ["a plate", "dish"], hint: "tal-LÆR-ken. Masculine: definite tallerkenen, plural tallerkener. Unit 6 gave you ei skål, the bowl; this is the flat one beside it." },
        ...
        { id: "no-u16l3-enovn", type: "vocab", front: "en ovn", reading: "enovn", meaning: "oven", example: { jp: "Et brød er i ovnen.", en: "A loaf of bread is in the oven." }, accept: ["an oven", "stove", "cooker", "heater"], hint: "OVN, both consonants sounded. Masculine: definite ovnen, plural ovner. It is also the heater in a room — en vedovn is the wood stove a hytte is built around." },
        { id: "no-u16l3-etspeil", type: "vocab", front: "et speil", reading: "etspeil", meaning: "mirror", example: { jp: "Et speil er på badet.", en: "A mirror is in the bathroom." }, accept: ["a mirror", "looking glass"], hint: "SPEIL, with the ei diphthong of hei and reise. Neuter: definite speilet, plural speil, unchanged. Note på badet — rooms of a house take på here, the same as på skolen in unit 7." },
    ...
    // and the two surfaces everything else sits on.
    {
      ...
      items: [
        ...
        { id: "no-u16l4-etgulv", type: "vocab", front: "et gulv", reading: "etgulv", meaning: "floor", example: { jp: "Et teppe er på gulvet.", en: "A rug is on the floor." }, accept: ["a floor", "the floor", "ground"], hint: "GUELV, hard g. Neuter: definite gulvet, plural gulv, unchanged. This is the surface you walk on; a storey of a building is en etasje, a completely different word." },
        { id: "no-u16l4-envegg", type: "vocab", front: "en vegg", reading: "envegg", meaning: "wall", example: { jp: "Et bilde er på veggen.", en: "A picture is on the wall." }, accept: ["a wall"], hint: "VEGG. Masculine: definite veggen, plural vegger. An inside wall or the outside of a house; a free-standing garden wall is en mur." },
