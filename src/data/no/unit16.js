  ...
  lessons: [
    ...
    // Lesson 2: the furniture the rooms are filled with.
    {
      ...
      items: [
        ...
        { id: "no-u16l2-eilampe", type: "vocab", front: "ei lampe", reading: "eilampe", meaning: "lamp", example: { jp: "Det er ei lampe på bordet.", en: "There is a lamp on the table." }, accept: ["a lamp", "light"], drill: { jp: "Ei lampe er ny", en: "A lamp is new" }, hint: "LAM-pe. Feminine: definite lampa, plural lamper. Norway is dark for half the year, so lamper are not decoration — they are the reason the rooms feel the way they do." },
    ...
    // and the two surfaces everything else sits on.
    {
      ...
      items: [
        ...
        { id: "no-u16l4-aflytte", type: "vocab", front: "å flytte", reading: "aflytte", meaning: "to move", example: { jp: "Vi flytter til Bergen.", en: "We are moving to Bergen." }, accept: ["move", "to move house", "move house", "relocate", "to relocate"], drill: { jp: "Det er tungt å flytte ei seng", en: "It is hard to move a bed" }, hint: "FLUET-te, present flytter. Moving house — and moving any object: flytt stolen, move the chair." },
