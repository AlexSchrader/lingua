...
export const NO_UNIT16 = {
  ...
  lessons: [
    // Lesson 1: the rooms, and the ways in and out of them.
    {
      ...
      items: [
        { id: "no-u16l1-eistue", type: "vocab", front: "ei stue", reading: "eistue", meaning: "living room", example: { jp: "Stua er veldig hyggelig.", en: "The living room is very nice." }, accept: ["a living room", "sitting room", "lounge", "the living room"], drill: { jp: "Ei stue er stor", en: "A living room is big" }, hint: "STOO-e. Feminine: definite stua. The room a Norwegian home is organised around. You will also see this written en stue / stuen; Bokmål allows both and the en form is common in print. This course writes ei, because ei is what tells you the definite ends in -a." },
        ...
        { id: "no-u16l1-eitrapp", type: "vocab", front: "ei trapp", reading: "eitrapp", meaning: "staircase", example: { jp: "Erling går i trappa.", en: "Erling is walking on the stairs." }, accept: ["stairs", "a staircase", "steps", "the stairs", "staircase"], drill: { jp: "Ei trapp er lang", en: "A staircase is long" }, hint: "TRAPP. Feminine: definite trappa, plural trapper. Norwegian counts a staircase as ONE thing where English insists on the plural \"stairs\": ei trapp, one staircase." },
    ...
    // Lesson 2: the furniture the rooms are filled with.
    {
      ...
      items: [
        { id: "no-u16l2-eiseng", type: "vocab", front: "ei seng", reading: "eiseng", meaning: "bed", example: { jp: "Kari har ei seng i rommet.", en: "Kari has a bed in the room." }, accept: ["a bed", "bunk"], drill: { jp: "Ei seng er varm", en: "A bed is warm" }, hint: "SENG. Feminine: definite senga, plural senger. Å legge seg is to go to bed, and senga is where you end up." },
        { id: "no-u16l2-enstol", type: "vocab", front: "en stol", reading: "enstol", meaning: "chair", example: { jp: "Vi har en stol i stua.", en: "We have a chair in the living room." }, accept: ["a chair", "seat"], drill: { jp: "En stol er ny", en: "A chair is new" }, hint: "STOOL — and it is an ordinary chair with a back, not the English backless \"stool\". Masculine: definite stolen, plural stoler. An armchair is en lenestol." },
        { id: "no-u16l2-eihylle", type: "vocab", front: "ei hylle", reading: "eihylle", meaning: "shelf", example: { jp: "På hylla er det en kopp.", en: "On the shelf there is a cup." }, accept: ["a shelf", "rack", "ledge"], drill: { jp: "Ei hylle er lang", en: "A shelf is long" }, hint: "HUEL-le. Feminine: definite hylla, plural hyller. Ei bokhylle is a bookshelf — bok welded onto hylle, the compounding pattern from sykehus." },
        ...
        { id: "no-u16l2-eilampe", type: "vocab", front: "ei lampe", reading: "eilampe", meaning: "lamp", example: { jp: "Det er ei lampe på bordet.", en: "There is a lamp on the table." }, accept: ["a lamp", "light"], drill: { jp: "Ei lampe er lys", en: "A lamp is light" }, hint: "LAM-pe. Feminine: definite lampa, plural lamper. Norway is dark for half the year, so lamper are not decoration — they are the reason the rooms feel the way they do." },
        { id: "no-u16l2-etbilde", type: "vocab", front: "et bilde", reading: "etbilde", meaning: "picture", example: { jp: "Erling ser på et bilde.", en: "Erling is looking at a picture." }, accept: ["a picture", "photo", "image", "painting", "photograph"], drill: { jp: "Et bilde er fint", en: "A picture is nice" }, hint: "BIL-de. Neuter: definite bildet, plural bilder. A photo, a painting or a picture on a screen — one word covers all three. Å se på is to look AT something, where plain å se is just to see." },
      ],
    },
    ...
    // and the two surfaces everything else sits on.
    {
      ...
      items: [
        { id: "no-u16l4-enleilighet", type: "vocab", front: "en leilighet", reading: "enleilighet", meaning: "flat", example: { jp: "Anna bor i en leilighet i Oslo.", en: "Anna lives in a flat in Oslo." }, accept: ["an apartment", "apartment", "a flat"], drill: { jp: "En leilighet er dyr", en: "A flat is expensive" }, hint: "LAY-li-het. Masculine: definite leiligheten, plural leiligheter. Most Norwegians in a city live in one. The ending -het builds abstract nouns the way English -ness does, and it always takes en." },
        { id: "no-u16l4-ennabo", type: "vocab", front: "en nabo", reading: "ennabo", meaning: "neighbour", example: { jp: "Her bor naboen min.", en: "My neighbour lives here." }, accept: ["a neighbor", "neighbor", "neighbour", "next-door neighbour"], drill: { jp: "En nabo er hyggelig", en: "A neighbour is nice" }, hint: "NAH-bo. Masculine: definite naboen, plural naboer. Watch the word order: with her opening the sentence, the verb still has to come second, so the subject drops in behind it — Her bor naboen min, never Her naboen min bor." },
        { id: "no-u16l4-aflytte", type: "vocab", front: "å flytte", reading: "aflytte", meaning: "to move", example: { jp: "Vi flytter til Bergen.", en: "We are moving to Bergen." }, accept: ["move", "to move house", "move house", "relocate", "to relocate"], drill: { jp: "Det er tungt å flytte", en: "It is hard to move" }, hint: "FLUET-te, present flytter. Moving house — and moving any object: flytt stolen, move the chair." },
        ...
        { id: "no-u16l4-arydde", type: "vocab", front: "å rydde", reading: "arydde", meaning: "to tidy up", example: { jp: "Jeg rydder i stua.", en: "I am tidying up in the living room." }, accept: ["tidy", "to tidy", "tidy up", "clean up", "to clear up", "clear up"], drill: { jp: "Det er viktig å rydde", en: "It is important to tidy up" }, hint: "RUED-de, present rydder. To tidy or clear away — the full phrase is å rydde opp. Keep it apart from å vaske in unit 15: rydde puts things where they belong, vaske gets them clean." },
      ],
    },
  ],
};
