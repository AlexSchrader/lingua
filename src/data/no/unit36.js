  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u36l2-iogmedat", type: "vocab", front: "i og med at", reading: "iogmedat", meaning: "seeing as", example: { jp: "I og med at han er syk, kan han ikke komme i dag.", en: "Given that he is ill, he cannot come today." }, drill: { jp: "I og med at det regner nå", en: "Seeing as it is raining now" }, accept: ["given that", "since (given that)", "as", "because"], hint: "Literally \"in and with that\". A because whose reason both of you already know — it points back at something just said. It takes a whole clause: i og med at + subject + verb." },
      ],
    },
    {
      id: "no-u36l3",
