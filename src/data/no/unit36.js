  ...
  lessons: [
    {
      ...
      items: [
        { id: "no-u36l1-dersom", type: "vocab", front: "dersom", reading: "dersom", meaning: "if", example: { jp: "Dersom du vil, kan vi møtes i morgen.", en: "If you want, we can meet tomorrow." }, accept: ["provided that", "in case", "should"], drill: { jp: "Jeg kommer dersom du vil", en: "I'll come if you want" }, hint: "A more formal hvis (A1). Fronting it inverts the main clause: Dersom du vil, KAN vi — verb before subject." },
        { id: "no-u36l1-medmindre", type: "vocab", front: "med mindre", reading: "medmindre", meaning: "unless", example: { jp: "Jeg kommer ikke med mindre du ringer meg.", en: "I won't come unless you call me." }, accept: ["except if", "save that"], drill: { jp: "Jeg venter her med mindre du ringer", en: "I'll wait here unless you call" }, hint: "med mindre = unless. The clause after it keeps normal order: ...med mindre du ringer. Literally 'with less'." },
        ...
        { id: "no-u36l1-sasant", type: "vocab", front: "så sant", reading: "sasant", meaning: "provided that", example: { jp: "Vi drar på tur så sant været er fint.", en: "We'll go on a hike as long as the weather is nice." }, accept: ["as long as", "so long as"], drill: { jp: "Vi kommer så sant vi kan", en: "We'll come as long as we can" }, hint: "Literally 'so true' — sant is the neuter of sann, true. A condition you expect to hold." },
        { id: "no-u36l1-hvisikke", type: "vocab", front: "hvis ikke", reading: "hvisikke", meaning: "if not", example: { jp: "Skynd deg, hvis ikke kommer vi for sent på skolen.", en: "Hurry up, otherwise we'll be too late for school." }, accept: ["otherwise", "if you don't", "or else"], drill: { jp: "Ring meg hvis ikke", en: "Call me if not" }, hint: "hvis (A1) + ikke. Standing alone it means 'if not / otherwise', and the clause after it inverts: hvis ikke KOMMER vi for sent." },
        { id: "no-u36l1-ellers", type: "vocab", front: "ellers", reading: "ellers", meaning: "otherwise", example: { jp: "Vi må gå nå, ellers rekker vi ikke bussen.", en: "We have to go now, otherwise we won't catch the bus." }, accept: ["or else", "apart from that"], drill: { jp: "Ellers er alt bra", en: "Otherwise everything is fine" }, hint: "ellers = otherwise, and it inverts what follows: ellers REKKER vi ikke. Also 'apart from that': ellers går det bra." },
      ],
    },
    {
      id: "no-u36l2",
      ...
      items: [
        { id: "no-u36l2-siden", type: "vocab", front: "siden", reading: "siden", meaning: "since", example: { jp: "Siden du er her, kan du hjelpe meg litt.", en: "Since you're here, you can help me a bit." }, accept: ["as", "because", "seeing as"], drill: { jp: "Vi drar ikke ut siden det regner", en: "We're not going out since it's raining" }, hint: "Reason and time both: siden du er her (as); for lenge siden (a long time ago). Fronting inverts: Siden du er her, KAN du." },
        { id: "no-u36l2-ettersom", type: "vocab", front: "ettersom", reading: "ettersom", meaning: "as", example: { jp: "Ettersom det er sent, går vi hjem nå.", en: "As it's late, we're going home now." }, accept: ["since", "seeing that", "because"], drill: { jp: "Vi drar ettersom det er sent", en: "We set off as it's late" }, hint: "A slightly formal siden, for a reason. Built on etter, after." },
        { id: "no-u36l2-selvom", type: "vocab", front: "selv om", reading: "selvom", meaning: "even though", example: { jp: "Selv om det regner, går vi en tur i skogen.", en: "Even though it's raining, we're going for a walk in the forest." }, accept: ["although", "even if"], drill: { jp: "Vi går ut selv om det regner", en: "We go out even though it rains" }, hint: "The main concession word. Fronting it inverts: Selv om det regner, GÅR vi. Do not split it — selv alone means 'self'." },
        { id: "no-u36l2-enda", type: "vocab", front: "enda", reading: "enda", meaning: "even though (spoken)", example: { jp: "Enda han er syk, går han på skolen hver dag.", en: "Even though he's ill, he goes to school every day." }, accept: ["even though", "although", "yet", "still"], drill: { jp: "Han jobber enda han er trøtt", en: "He works even though he's tired" }, hint: "A spoken selv om. Careful: enda also means 'even more' before an adjective — enda større, even bigger." },
    ...
    },
    {
      ...
      items: [
        { id: "no-u36l3-da", type: "vocab", front: "da", reading: "da", meaning: "when (past)", example: { jp: "Da jeg var ung, bodde jeg i en liten by.", en: "When I was young, I lived in a small town." }, accept: ["when", "as", "then"], drill: { jp: "Alle sov da jeg kom", en: "Everyone was asleep when I arrived" }, hint: "da for a SINGLE moment in the past; når (A1) for something repeated or future. This split is one of the classic Norwegian tests." },
        { id: "no-u36l3-etterat", type: "vocab", front: "etter at", reading: "etterat", meaning: "after", example: { jp: "Etter at vi kom hjem, gikk vi en tur.", en: "After we got home, we went for a walk." }, accept: ["after (something happens)"], drill: { jp: "Vi spiser etter at han kommer", en: "We eat after he comes" }, hint: "etter (A1) + at joins a clause; etter alone takes a noun: etter middag. Fronting inverts: Etter at vi spiste, GIKK vi." },
    ...
    },
    {
      ...
      items: [
        { id: "no-u36l4-forat", type: "vocab", front: "for at", reading: "forat", meaning: "so that", example: { jp: "Jeg snakker sakte for at alle skal forstå meg.", en: "I speak slowly so that everyone will understand me." }, accept: ["in order that", "so as to"], drill: { jp: "Jeg skriver det for at du skal se", en: "I write it so that you'll see" }, hint: "Purpose with a NEW subject, usually with skal: for at alle skal forstå. When the subject is the same, use for å + infinitive." },
        { id: "no-u36l4-slikat", type: "vocab", front: "slik at", reading: "slikat", meaning: "in such a way that", example: { jp: "Hun forklarte alt på nytt, slik at vi forsto det.", en: "She explained everything again, so that we understood it." }, accept: ["so that", "with the result that"], drill: { jp: "Skriv det slik at alle forstår", en: "Write it so that everyone understands" }, hint: "Result or purpose. slik alone means 'like this / such': slik gjør vi det, that's how we do it." },
        { id: "no-u36l4-utenat", type: "vocab", front: "uten at", reading: "utenat", meaning: "without", example: { jp: "Han gikk ut uten at noen så det.", en: "He went out without anyone seeing it." }, accept: ["without (someone doing)"], drill: { jp: "Hun drar uten at vi vet det", en: "She leaves without us knowing" }, hint: "uten (without) + at when a clause follows and its subject differs. Same subject: uten å + infinitive — uten å si noe, without saying anything." },
        ...
        { id: "no-u36l4-bade", type: "vocab", front: "både", reading: "bade", meaning: "both", example: { jp: "Hun leser både bøker og aviser.", en: "She reads both books and newspapers." }, accept: ["both ... and"], drill: { jp: "Både du og jeg", en: "Both you and me" }, hint: "The pair både ... og = both ... and. Written with å: både, folded to bade in the reading." },
      ],
    },
  ],
};
