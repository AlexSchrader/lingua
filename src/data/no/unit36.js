...
export const NO_UNIT36 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "no-u36l3-da", type: "vocab", front: "da", reading: "da", meaning: "when (past)", example: { jp: "Da jeg var ung, bodde jeg i en liten by.", en: "When I was young, I lived in a small town." }, accept: ["when", "as", "then"], drill: { jp: "Alle sov da jeg kom", en: "Everyone was asleep when I came" }, hint: "da for a SINGLE moment in the past; når (A1) for something repeated or future. This split is one of the classic Norwegian tests." },
        { id: "no-u36l3-etterat", type: "vocab", front: "etter at", reading: "etterat", meaning: "after (a whole clause)", example: { jp: "Etter at vi hadde spist, gikk vi en tur.", en: "After we had eaten, we went for a walk." }, accept: ["after", "once"], drill: { jp: "Vi spiste etter at han kom", en: "We ate after he came" }, hint: "etter (A1) + at joins a clause; etter alone takes a noun: etter middag. Fronting inverts: Etter at vi spiste, GIKK vi." },
