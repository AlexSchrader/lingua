  ...
  lessons: [
    ...
    // tilstrekkelig deliberately — the two ends of what a plan can demand.
    {
      ...
      items: [
        ...
        { id: "no-u58l3-etvilkar", type: "vocab", front: "et vilkår", reading: "etvilkar", meaning: "a term (condition)", example: { jp: "Et vilkår i kontrakten er at du jobber her.", en: "One condition in the contract is that you work here." }, drill: { jp: "Et vilkår i kontrakten er viktig", en: "One condition in the contract is important" }, accept: ["a term", "a stipulation", "a requirement", "a condition", "condition"], hint: "VIL-kawr. Neuter: definite vilkåret, plural vilkår — no ending. Vil plus kår, circumstances. ⚠ Usually plural in real life: vilkårene are the terms and conditions of a contract." },
    ...
    // steps and the learner can watch it happen.
    {
      ...
      items: [
        ...
        { id: "no-u58l4-konkret", type: "vocab", front: "konkret", reading: "konkret", meaning: "concrete (specific)", example: { jp: "Gi meg et konkret eksempel.", en: "Give me a concrete example." }, drill: { jp: "Han ga et konkret eksempel", en: "He gave a concrete example" }, accept: ["specific", "tangible", "definite", "actual", "concrete"], hint: "kon-KRET. Neuter konkret, plural konkrete. The opposite of abstrakt. ⚠ In a Norwegian meeting it is a request, not a description: vær konkret means \"give me something I can actually act on\"." },
