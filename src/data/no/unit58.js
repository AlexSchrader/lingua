  ...
  lessons: [
    ...
    // here rather than left to a hint.
    {
      ...
      items: [
        ...
        { id: "no-u58l1-etinnhold", type: "vocab", front: "innhold", reading: "innhold", meaning: "content", example: { jp: "Innhold er viktigere enn form.", en: "Content matters more than form." }, drill: { jp: "Innhold er viktig her", en: "Content matters here" }, accept: ["contents", "substance", "what is inside", "the content"], hint: "INN-hold. Neuter: definite innholdet, and NO plural — so it is taught bare (unit1.js §1b). Inn plus hold, holding — what is held inside. It covers the contents of a bag, a book and an argument alike." },
    ...
    // state you are in, the other is attention you are paying.
    {
      ...
      items: [
        { id: "no-u58l2-enfornuft", type: "vocab", front: "fornuft", reading: "fornuft", meaning: "good sense", example: { jp: "Fornuften sier at vi må vente litt.", en: "Reason says that we have to wait a bit." }, drill: { jp: "Fornuft er ikke nok her", en: "Good sense is not enough here" }, accept: ["reason", "sense", "rationality", "common sense", "good judgement"], hint: "for-NUFT. Masculine: definite fornuften, and NO plural — so it is taught bare (unit1.js §1b). Fornuftig is the adjective — sensible, which in Norwegian is real praise. Sunn fornuft is common sense, literally \"healthy reason\"." },
    ...
    // tilstrekkelig deliberately — the two ends of what a plan can demand.
    {
      ...
      items: [
        { id: "no-u58l3-enfrihet", type: "vocab", front: "frihet", reading: "frihet", meaning: "freedom", example: { jp: "Frihet for alle er et viktig mål.", en: "Freedom for everyone is an important goal." }, drill: { jp: "Frihet for alle er viktig", en: "Freedom for everyone is important" }, accept: ["liberty", "independence", "freedom"], hint: "FRI-het. Masculine: definite friheten. Taught bare because THIS sense is a mass noun; a single liberty can be counted — en frihet, friheter. ⚠ -het is always masculine — there is no *friheta. Fri is the adjective. Ytringsfrihet, which you met in u55, is built on this word." },
        ...
        { id: "no-u58l3-etvilkar", type: "vocab", front: "et vilkår", reading: "etvilkar", meaning: "a term (condition)", example: { jp: "Et vilkår i kontrakten er at du jobber her.", en: "One condition in the contract is that you work here." }, drill: { jp: "Et vilkår i kontrakten er viktig", en: "One condition in the contract is important" }, accept: ["a term", "a stipulation", "a requirement", "a condition", "condition", "condition"], hint: "VIL-kawr. Neuter: definite vilkåret, plural vilkår — no ending. Vil plus kår, circumstances. ⚠ Usually plural in real life: vilkårene are the terms and conditions of a contract." },
    ...
    // steps and the learner can watch it happen.
    {
      ...
      unit: 58,
      lesson: 4,
      title: "Fakta og inntrykk",
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Tell what is real from what only looks real — name a fact, describe an insight, ask for something concrete, call a common belief a myth, and say you sense something without knowing it.",
      items: [
        ...
        { id: "no-u58l4-konkret", type: "vocab", front: "konkret", reading: "konkret", meaning: "concrete (specific)", example: { jp: "Gi meg et konkret eksempel.", en: "Give me a concrete example." }, drill: { jp: "Han ga et konkret eksempel", en: "He gave a concrete example" }, accept: ["specific", "tangible", "definite", "actual", "concrete", "concrete"], hint: "kon-KRET. Neuter konkret, plural konkrete. The opposite of abstrakt. ⚠ In a Norwegian meeting it is a request, not a description: vær konkret means \"give me something I can actually act on\"." },
        ...
        { id: "no-u58l4-akalle", type: "vocab", front: "å kalle", reading: "akalle", meaning: "to call (name)", example: { jp: "Mange kaller det en myte, men det er sant.", en: "Many call it a myth, but it is true." }, accept: ["to name", "to term", "to refer to as"], drill: { jp: "Vi pleier å kalle det en myte", en: "We usually call it a myth" }, hint: "å kalle → kaller, kalte. Å kalle NOE for noe: de kaller det en myte. ⚠ Ikke å ringe (u20), som er å ta telefonen. Passivformen kalles kommer i u70l1."},
      ],
    },
  ],
};
