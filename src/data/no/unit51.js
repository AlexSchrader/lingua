  ...
  lessons: [
    ...
    // something with it on the same screen.
    {
      ...
      items: [
        ...
        { id: "no-u51l1-ahevde", type: "vocab", front: "å hevde", reading: "ahevde", meaning: "to assert", example: { jp: "Han hevder at prisen er altfor høy.", en: "He claims that the price is far too high." }, drill: { jp: "Det er lett å hevde noe her", en: "It is easy to claim something here" }, accept: ["claim", "to assert", "assert", "to maintain", "to claim", "to claim"], hint: "HEV-de. Present hevder, past hevdet. Stronger than å si and weaker than å bevise: you put a claim forward and it is on you to back it up." },
