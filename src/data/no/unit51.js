  ...
  lessons: [
    ...
    // exaggeration.
    {
      ...
      items: [
        ...
        { id: "no-u51l2-aprotestere", type: "vocab", front: "å protestere", reading: "aprotestere", meaning: "to protest", example: { jp: "Mange protesterer imot forslaget fra sjefen.", en: "Many people are protesting against the proposal from the boss." }, drill: { jp: "Det er lett å protestere imot alt", en: "It is easy to protest against everything" }, accept: ["protest", "to object loudly", "to demonstrate against"], hint: "pro-tes-TE-re. Present protesterer, past protesterte. You protesterer MOT or IMOT something — both forms are right, and imot is the one this course has taught you. Louder than å avvise: a protest is meant to be heard by other people." },
      ],
    },
