  ...
  lessons: [
    ...
    // something with it on the same screen.
    {
      ...
      items: [
        ...
        { id: "no-u51l1-ahevde", type: "vocab", front: "å hevde", reading: "ahevde", meaning: "to claim", example: { jp: "Han hevder at prisen er altfor høy.", en: "He claims that the price is far too high." }, drill: { jp: "Det er lett å hevde noe her", en: "It is easy to claim something here" }, accept: ["claim", "to assert", "assert", "to maintain"], hint: "HEV-de. Present hevder, past hevdet. Stronger than å si and weaker than å bevise: you put a claim forward and it is on you to back it up." },
        ...
        { id: "no-u51l1-tydelig", type: "vocab", front: "tydelig", reading: "tydelig", meaning: "clear", example: { jp: "Det er tydelig at han er sint i dag.", en: "It is clear that he is angry today." }, drill: { jp: "Han skriver et tydelig brev", en: "He writes a clear letter" }, accept: ["evident", "obvious", "distinct", "plain"], hint: "TUE-de-li — silent g again. Klar is clear as in ready, or see-through; tydelig is clear as in easy to make out. Neuter tydelig, plural tydelige." },
    ...
    // exaggeration.
    {
      ...
      items: [
        ...
        { id: "no-u51l2-ainnvende", type: "vocab", front: "å innvende", reading: "ainnvende", meaning: "to object", example: { jp: "Hun innvender at planen er dårlig.", en: "She objects that the plan is bad." }, drill: { jp: "Han begynner å innvende noe", en: "He starts to object to something" }, accept: ["object", "to raise an objection", "to counter", "to protest"], hint: "INN-ven-ne. Inn plus vende, to turn in — you turn a point back against what was said. Present innvender, past innvendte. To object is not to refuse: å nekte is the refusing one." },
