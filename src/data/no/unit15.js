...
export const NO_UNIT15 = {
  ...
  lessons: [
    ...
    // so it is used here and never re-taught.
    {
      ...
      items: [
        { id: "no-u15l1-klaer", type: "vocab", front: "klær", reading: "klaer", meaning: "clothes", example: { jp: "Kari har mange klær.", en: "Kari has a lot of clothes." }, accept: ["clothing", "garments", "the clothes"], drill: { jp: "Vi kjøper klær i Oslo", en: "We buy clothes in Oslo" }, hint: "KLAIR, with the æ of unit 1. Plural only — there is no \"a clothes\", so this front carries no article, exactly like penger. The definite is klærne, \"the clothes\"." },
        { id: "no-u15l1-eibukse", type: "vocab", front: "ei bukse", reading: "eibukse", meaning: "trousers", example: { jp: "Ei bukse er billig her.", en: "A pair of trousers is cheap here." }, accept: ["pants", "a pair of trousers", "trousers", "a pair of pants"], drill: { jp: "Erling har ei bukse", en: "Erling has a pair of trousers" }, hint: "BUEK-se. Feminine: definite buksa. One garment, one singular — Norwegian counts trousers the way English counts a shirt, so ei bukse IS a pair. You will also see this written en bukse / buksen; Bokmål allows both and print uses the en form freely. This course writes ei, because ei tells you the definite ends in -a." },
        { id: "no-u15l1-engenser", type: "vocab", front: "en genser", reading: "engenser", meaning: "jumper", example: { jp: "Erling har en genser fra Norge.", en: "Erling has a jumper from Norway." }, accept: ["sweater", "pullover", "a jumper", "a sweater"], drill: { jp: "Kari kjøper en genser", en: "Kari is buying a jumper" }, hint: "GEN-ser, hard g before e. Masculine: definite genseren, plural gensere. The wool genser is the thing every visitor takes home from Norway." },
        { id: "no-u15l1-enkjole", type: "vocab", front: "en kjole", reading: "enkjole", meaning: "dress", example: { jp: "Kari kjøper en kjole.", en: "Kari is buying a dress." }, accept: ["a dress", "gown", "frock"], drill: { jp: "Anna har en kjole", en: "Anna has a dress" }, hint: "HYOO-le — the thin kj of unit 1, the same sound as in kjøpe and kjøkken. Masculine: definite kjolen." },
        { id: "no-u15l1-eijakke", type: "vocab", front: "ei jakke", reading: "eijakke", meaning: "jacket", example: { jp: "Jakka er ikke dyr.", en: "The jacket is not expensive." }, accept: ["a jacket", "coat", "a coat"], drill: { jp: "Ei jakke er billig", en: "A jacket is cheap" }, hint: "YAK-ke — Norwegian j is always the y of \"yes\". Feminine: definite jakka. Note where ikke sits: straight after the finite verb, er ikke, never ikke er." },
        { id: "no-u15l1-ensko", type: "vocab", front: "en sko", reading: "ensko", meaning: "shoe", example: { jp: "Jeg finner ikke skoen min.", en: "I cannot find my shoe." }, accept: ["a shoe"], drill: { jp: "En sko er borte", en: "A shoe is gone" }, hint: "SKOO — sk before o is a hard sk, as in skole, not the sh of skje. Masculine: definite skoen. The plural is just sko, unchanged: to sko is a pair of shoes." },
      ],
    },
    // Lesson 2: what goes on over and around the garments.
    {
      ...
      items: [
        { id: "no-u15l2-sokker", type: "vocab", front: "sokker", reading: "sokker", meaning: "socks", example: { jp: "Jeg kjøper sokker i butikken.", en: "I am buying socks in the shop." }, accept: ["stockings", "the socks", "a pair of socks"], drill: { jp: "Erling har sokker og sko", en: "Erling has socks and shoes" }, hint: "SOK-ker. Taught in the plural like klær and penger, because the thing you own is a pair. One sock IS en sokk, definite sokken — but you will hear sokker nearly every time. Definite plural sokkene." },
        { id: "no-u15l2-eilue", type: "vocab", front: "ei lue", reading: "eilue", meaning: "woolly hat", example: { jp: "Kari har ei lue og ei jakke.", en: "Kari has a woolly hat and a jacket." }, accept: ["hat", "a hat", "beanie", "cap", "a woolly hat"], drill: { jp: "Jeg kjøper ei lue", en: "I am buying a woolly hat" }, hint: "LOO-e. Feminine: definite lua. Specifically the knitted winter hat — a sun hat or a cap with a brim is en hatt, a different word." },
        { id: "no-u15l2-etskjerf", type: "vocab", front: "et skjerf", reading: "etskjerf", meaning: "scarf", example: { jp: "Skjerfet er fra Bergen.", en: "The scarf is from Bergen." }, accept: ["a scarf", "muffler"], drill: { jp: "Erling har et skjerf", en: "Erling has a scarf" }, hint: "SHÆRF — skj is the broad sh of skje and skjorte, never a k sound. Neuter: definite skjerfet." },
        { id: "no-u15l2-enhanske", type: "vocab", front: "en hanske", reading: "enhanske", meaning: "glove", example: { jp: "Erling har hansker og ei lue.", en: "Erling has gloves and a woolly hat." }, accept: ["a glove", "mitten", "gloves"], drill: { jp: "En hanske er borte", en: "A glove is gone" }, hint: "HAN-ske. Masculine: definite hansken, plural hansker. You will meet the plural far more often than the singular — nobody buys en hanske." },
        { id: "no-u15l2-etbelte", type: "vocab", front: "et belte", reading: "etbelte", meaning: "belt", example: { jp: "Beltet er til ei bukse.", en: "The belt is for a pair of trousers." }, accept: ["a belt", "strap"], drill: { jp: "Jeg kjøper et belte", en: "I am buying a belt" }, hint: "BEL-te. Neuter: definite beltet. A seatbelt is et bilbelte — bil welded onto belte, the same compounding that built sykehus out of syke and hus." },
        { id: "no-u15l2-eiveske", type: "vocab", front: "ei veske", reading: "eiveske", meaning: "bag", example: { jp: "Anna har penger i veska.", en: "Anna has money in her bag." }, accept: ["a bag", "handbag", "purse", "satchel"], drill: { jp: "Kari har ei veske", en: "Kari has a bag" }, hint: "VES-ke. Feminine: definite veska. A bag you carry, not a paper bag. Note the English: Norwegian says i veska, \"in the bag\", where English insists on \"in her bag\"." },
      ],
    },
    ...
    // uses them — see the header note on per-unit scope resolution.
    {
      ...
      cefr: "A1",
      dominantMode: "recall",
      canDo: "Try something on, say whether it fits, ask about a size, choose what you want, and talk about the price in kroner.",
      items: [
        { id: "no-u15l3-aprove", type: "vocab", front: "å prøve", reading: "aprove", meaning: "to try", example: { jp: "Jeg prøver ei jakke i butikken.", en: "I am trying on a jacket in the shop." }, accept: ["try", "to try on", "try on", "to attempt", "attempt"], drill: { jp: "Det er lett å prøve en genser", en: "It is easy to try on a jumper" }, hint: "PRUR-ve, present prøver — and a hand-folded reading, aprove, because ø is the one letter that does not fold on its own. It covers trying a garment on AND trying to do something." },
        { id: "no-u15l3-apasse", type: "vocab", front: "å passe", reading: "apasse", meaning: "to fit", example: { jp: "Buksa passer ikke.", en: "The trousers do not fit." }, accept: ["fit", "to suit", "suit", "to look after", "to be right"], drill: { jp: "Buksa begynner å passe", en: "The trousers are starting to fit" }, hint: "PAS-se, present passer. Of clothes it is fit; of a time it is suit — det passer bra, that works for me. It also means to look after: å passe et barn." },
        { id: "no-u15l3-enstorrelse", type: "vocab", front: "en størrelse", reading: "enstorrelse", meaning: "size", example: { jp: "Hva er størrelsen på skjorta?", en: "What size is the shirt?" }, accept: ["a size", "the size"], drill: { jp: "Vi velger en størrelse", en: "We choose a size" }, hint: "STUR-rel-se, hand-folded to enstorrelse. Masculine: definite størrelsen. Built from stor, big, plus -else — the ending that turns an adjective into a noun." },
        { id: "no-u15l3-etpar", type: "vocab", front: "et par", reading: "etpar", meaning: "pair", example: { jp: "Jeg kjøper et par sko.", en: "I am buying a pair of shoes." }, accept: ["a pair", "couple", "a couple", "two"], drill: { jp: "Jeg kjøper et par sokker", en: "I am buying a pair of socks" }, hint: "PAHR. Neuter: definite paret. Also a couple of people — and loosely \"a couple of\" anything: et par dager, a couple of days." },
        { id: "no-u15l3-avelge", type: "vocab", front: "å velge", reading: "avelge", meaning: "to choose", example: { jp: "Nå velger Erling en genser.", en: "Now Erling is choosing a jumper." }, accept: ["choose", "to pick", "pick", "to select", "select"], drill: { jp: "Det er lett å velge ei jakke", en: "It is easy to choose a jacket" }, hint: "VEL-ge, present velger. Watch the word order: when nå opens the sentence the verb must come second, so the subject drops in behind it — Nå velger Erling, never Nå Erling velger. That is Norwegian's V2 rule, and it is not optional." },
        { id: "no-u15l3-eikrone", type: "vocab", front: "ei krone", reading: "eikrone", meaning: "krone", example: { jp: "Ei krone er ikke mye penger.", en: "A krone is not much money." }, accept: ["crown", "the norwegian krone", "kroner", "norwegian crown"], drill: { jp: "Jeg har ei krone i veska", en: "I have a krone in my bag" }, hint: "KROO-ne. Feminine: definite krona. Norway's money — one krone, and the plural you actually hear on every price is kroner. Written NOK on a tag." },
      ],
    },
    // Lesson 4: looking after the clothes, and the two small parts of a garment.
    {
      ...
      items: [
        { id: "no-u15l4-avaske", type: "vocab", front: "å vaske", reading: "avaske", meaning: "to wash", example: { jp: "Jeg vasker klær nå.", en: "I am washing clothes now." }, accept: ["wash", "to clean", "clean", "to do the washing"], drill: { jp: "Det er viktig å vaske klær", en: "It is important to wash clothes" }, hint: "VAS-ke, present vasker. Clothes, dishes, hands, floors — one verb covers all of them. Å vaske seg is to wash yourself." },
        { id: "no-u15l4-askifte", type: "vocab", front: "å skifte", reading: "askifte", meaning: "to change", example: { jp: "Erling skifter skjorte.", en: "Erling is changing his shirt." }, accept: ["change", "to change clothes", "swap", "to switch", "switch"], drill: { jp: "Det er lett å skifte klær", en: "It is easy to change clothes" }, hint: "SHIF-te — sk before i is the broad sh again. Present skifter. Note skifte skjorte with no article at all, the same bare-noun pattern as kjøre bil." },
        { id: "no-u15l4-eilomme", type: "vocab", front: "ei lomme", reading: "eilomme", meaning: "pocket", example: { jp: "Jeg har penger i lomma.", en: "I have money in my pocket." }, accept: ["a pocket"], drill: { jp: "Det er penger i ei lomme", en: "There is money in a pocket" }, hint: "LOM-me. Feminine: definite lomma. A wallet is ei lommebok — a pocket-book, welded together the way sykehus was." },
        { id: "no-u15l4-enknapp", type: "vocab", front: "en knapp", reading: "enknapp", meaning: "button", example: { jp: "Jeg kjøper en knapp til skjorta.", en: "I am buying a button for the shirt." }, accept: ["a button", "knob"], drill: { jp: "En knapp er borte", en: "A button is gone" }, hint: "KNAPP — and the k IS pronounced, unlike English \"knee\". Masculine: definite knappen. The same word is the button you press on a machine." },
        { id: "no-u15l4-ull", type: "vocab", front: "ull", reading: "ull", meaning: "wool", example: { jp: "En genser i ull er veldig god.", en: "A jumper made of wool is very good." }, accept: ["woollen", "woolen", "the wool"], drill: { jp: "Ull er varm", en: "Wool is warm" }, hint: "UELL, with the tight Norwegian u. A mass noun, so the front carries no article — same class as vann and melk. Feminine: definite ulla. En ullgenser and ei ullbukse are what Norwegians actually put on in winter." },
        { id: "no-u15l4-etskap", type: "vocab", front: "et skap", reading: "etskap", meaning: "cupboard", example: { jp: "Klærne er i skapet.", en: "The clothes are in the cupboard." }, accept: ["a cupboard", "closet", "cabinet", "wardrobe"], drill: { jp: "Klær ligger i et skap", en: "Clothes lie in a cupboard" }, hint: "SKAHP. Neuter: definite skapet. A wardrobe is et klesskap — klær plus skap — and a fridge is et kjøleskap. Learn skap and you have read half the doors in a Norwegian flat." },
      ],
    },
  ],
};
