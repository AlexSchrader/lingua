...
export const NO_UNIT15 = {
  ...
  lessons: [
    ...
    // uses them — see the header note on per-unit scope resolution.
    {
      ...
      items: [
        { id: "no-u15l3-aprove", type: "vocab", front: "å prøve", reading: "aprove", meaning: "to try", example: { jp: "Jeg prøver ei jakke i butikken.", en: "I am trying on a jacket in the shop." }, accept: ["try", "to try on", "try on", "to attempt", "attempt"], drill: { jp: "Det er lett å prøve ei jakke", en: "It is easy to try on a jacket" }, hint: "PRUR-ve, present prøver — and a hand-folded reading, aprove, because ø is the one letter that does not fold on its own. It covers trying a garment on AND trying to do something." },
        ...
        { id: "no-u15l3-eikrone", type: "vocab", front: "ei krone", reading: "eikrone", meaning: "krone", example: { jp: "Ei krone er ikke mye penger.", en: "A krone is not much money." }, accept: ["crown", "the norwegian krone", "kroner", "norwegian crown"], drill: { jp: "Ei krone er ikke mange penger", en: "A krone is not much money" }, hint: "KROO-ne. Feminine: definite krona. Norway's money — one krone, and the plural you actually hear on every price is kroner. Written NOK on a tag." },
      ],
    },
