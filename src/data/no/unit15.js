...
export const NO_UNIT15 = {
  ...
  lessons: [
    ...
    // Lesson 2: what goes on over and around the garments.
    {
      ...
      items: [
        { id: "no-u15l2-sokker", type: "vocab", front: "sokker", reading: "sokker", meaning: "socks", example: { jp: "Jeg kjøper sokker i butikken.", en: "I am buying socks in the shop." }, accept: ["stockings", "the socks", "a pair of socks"], drill: { jp: "Sokker er varme og billige", en: "Socks are warm and cheap" }, hint: "SOK-ker. Taught in the plural like klær and penger, because the thing you own is a pair. One sock IS en sokk, definite sokken — but you will hear sokker nearly every time. Definite plural sokkene." },
    ...
    // Lesson 4: looking after the clothes, and the two small parts of a garment.
    {
      ...
      items: [
        ...
        { id: "no-u15l4-eilomme", type: "vocab", front: "ei lomme", reading: "eilomme", meaning: "pocket", example: { jp: "Jeg har penger i lomma.", en: "I have money in my pocket." }, accept: ["a pocket"], drill: { jp: "Ei lomme er lita", en: "A pocket is small" }, hint: "LOM-me. Feminine: definite lomma. A wallet is ei lommebok — a pocket-book, welded together the way sykehus was." },
