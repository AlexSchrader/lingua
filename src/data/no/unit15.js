...
export const NO_UNIT15 = {
  ...
  lessons: [
    ...
    // Lesson 2: what goes on over and around the garments.
    {
      ...
      items: [
        { id: "no-u15l2-sokker", type: "vocab", front: "sokker", reading: "sokker", meaning: "socks", example: { jp: "Sokker er billige.", en: "Socks are cheap." }, accept: ["stockings", "the socks", "a pair of socks"], hint: "SOK-ker. Taught in the plural like klær and penger, because the thing you own is a pair. One sock IS en sokk, definite sokken — but you will hear sokker nearly every time. Definite plural sokkene." },
        ...
        { id: "no-u15l2-enhanske", type: "vocab", front: "en hanske", reading: "enhanske", meaning: "glove", example: { jp: "Jeg kjøper hansker i butikken.", en: "I am buying gloves in the shop." }, accept: ["a glove", "mitten", "gloves"], hint: "HAN-ske. Masculine: definite hansken, plural hansker. You will meet the plural far more often than the singular — nobody buys en hanske." },
    ...
    // Lesson 4: looking after the clothes, and the two small parts of a garment.
    {
      ...
      items: [
        ...
        { id: "no-u15l4-enknapp", type: "vocab", front: "en knapp", reading: "enknapp", meaning: "button", example: { jp: "En knapp er ikke på skjorta.", en: "A button is not on the shirt." }, accept: ["a button", "knob"], hint: "KNAPP — and the k IS pronounced, unlike English \"knee\". Masculine: definite knappen. The same word is the button you press on a machine." },
        { id: "no-u15l4-ull", type: "vocab", front: "ull", reading: "ull", meaning: "wool", example: { jp: "Ull er veldig god i Norge.", en: "Wool is very good in Norway." }, accept: ["woollen", "woolen", "the wool"], hint: "UELL, with the tight Norwegian u. A mass noun, so the front carries no article — same class as vann and melk. Feminine: definite ulla. En ullgenser and ei ullbukse are what Norwegians actually put on in winter." },
