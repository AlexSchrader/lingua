  ...
  lessons: [
    ...
    // so it is used here and never re-taught.
    {
      ...
      items: [
        ...
        { id: "no-u15l1-eibukse", type: "vocab", front: "ei bukse", reading: "eibukse", meaning: "trousers", example: { jp: "Ei bukse er billig her.", en: "A pair of trousers is cheap here." }, accept: ["pants", "a pair of trousers", "trousers", "a pair of pants"], drill: { jp: "Ei bukse er ny", en: "A pair of trousers is new" }, hint: "BUEK-se. Feminine: definite buksa. One garment, one singular — Norwegian counts trousers the way English counts a shirt, so ei bukse IS a pair. You will also see this written en bukse / buksen; Bokmål allows both and print uses the en form freely. This course writes ei, because ei tells you the definite ends in -a." },
        { id: "no-u15l1-engenser", type: "vocab", front: "en genser", reading: "engenser", meaning: "jumper", example: { jp: "Erling har en genser fra Norge.", en: "Erling has a jumper from Norway." }, accept: ["sweater", "pullover", "a jumper", "a sweater"], drill: { jp: "En genser er varm", en: "A jumper is warm" }, hint: "GEN-ser, hard g before e. Masculine: definite genseren, plural gensere. The wool genser is the thing every visitor takes home from Norway." },
        { id: "no-u15l1-enkjole", type: "vocab", front: "en kjole", reading: "enkjole", meaning: "dress", example: { jp: "Kari kjøper en kjole.", en: "Kari is buying a dress." }, accept: ["a dress", "gown", "frock"], drill: { jp: "En kjole er fin", en: "A dress is nice" }, hint: "HYOO-le — the thin kj of unit 1, the same sound as in kjøpe and kjøkken. Masculine: definite kjolen." },
        { id: "no-u15l1-eijakke", type: "vocab", front: "ei jakke", reading: "eijakke", meaning: "jacket", example: { jp: "Jakka er ikke dyr.", en: "The jacket is not expensive." }, accept: ["a jacket", "coat", "a coat"], drill: { jp: "Ei jakke er dyr", en: "A jacket is expensive" }, hint: "YAK-ke — Norwegian j is always the y of \"yes\". Feminine: definite jakka. Note where ikke sits: straight after the finite verb, er ikke, never ikke er." },
        { id: "no-u15l1-ensko", type: "vocab", front: "en sko", reading: "ensko", meaning: "shoe", example: { jp: "Jeg finner ikke skoen min.", en: "I cannot find my shoe." }, accept: ["a shoe"], drill: { jp: "En sko er skitten", en: "A shoe is dirty" }, hint: "SKOO — sk before o is a hard sk, as in skole, not the sh of skje. Masculine: definite skoen. The plural is just sko, unchanged: to sko is a pair of shoes." },
      ],
    },
    // Lesson 2: what goes on over and around the garments.
    {
      ...
      items: [
        { id: "no-u15l2-sokker", type: "vocab", front: "sokker", reading: "sokker", meaning: "socks", example: { jp: "Jeg kjøper sokker i butikken.", en: "I am buying socks in the shop." }, accept: ["stockings", "the socks", "a pair of socks"], drill: { jp: "Sokker er varme i vinter", en: "Socks are warm in winter" }, hint: "SOK-ker. Taught in the plural like klær and penger, because the thing you own is a pair. One sock IS en sokk, definite sokken — but you will hear sokker nearly every time. Definite plural sokkene." },
        { id: "no-u15l2-eilue", type: "vocab", front: "ei lue", reading: "eilue", meaning: "woolly hat", example: { jp: "Kari har ei lue og ei jakke.", en: "Kari has a woolly hat and a jacket." }, accept: ["hat", "a hat", "beanie", "cap", "a woolly hat"], drill: { jp: "Ei lue er varm", en: "A woolly hat is warm" }, hint: "LOO-e. Feminine: definite lua. Specifically the knitted winter hat — a sun hat or a cap with a brim is en hatt, a different word." },
        { id: "no-u15l2-etskjerf", type: "vocab", front: "et skjerf", reading: "etskjerf", meaning: "scarf", example: { jp: "Skjerfet er fra Bergen.", en: "The scarf is from Bergen." }, accept: ["a scarf", "muffler"], drill: { jp: "Et skjerf er langt", en: "A scarf is long" }, hint: "SHÆRF — skj is the broad sh of skje and skjorte, never a k sound. Neuter: definite skjerfet." },
    ...
    // uses them — see the header note on per-unit scope resolution.
    {
      ...
      items: [
        { id: "no-u15l3-aprove", type: "vocab", front: "å prøve", reading: "aprove", meaning: "to try", example: { jp: "Jeg prøver ei jakke i butikken.", en: "I am trying on a jacket in the shop." }, accept: ["try", "to try on", "try on", "to attempt", "attempt"], drill: { jp: "Det er lett å prøve", en: "It is easy to try" }, hint: "PRUR-ve, present prøver — and a hand-folded reading, aprove, because ø is the one letter that does not fold on its own. It covers trying a garment on AND trying to do something." },
        { id: "no-u15l3-apasse", type: "vocab", front: "å passe", reading: "apasse", meaning: "to fit", example: { jp: "Buksa passer ikke.", en: "The trousers do not fit." }, accept: ["fit", "to suit", "suit", "to look after", "to be right"], drill: { jp: "Det er viktig å passe", en: "It is important to fit" }, hint: "PAS-se, present passer. Of clothes it is fit; of a time it is suit — det passer bra, that works for me. It also means to look after: å passe et barn." },
        { id: "no-u15l3-enstorrelse", type: "vocab", front: "en størrelse", reading: "enstorrelse", meaning: "size", example: { jp: "Hva er størrelsen på skjorta?", en: "What size is the shirt?" }, accept: ["a size", "the size"], drill: { jp: "En størrelse er viktig", en: "A size is important" }, hint: "STUR-rel-se, hand-folded to enstorrelse. Masculine: definite størrelsen. Built from stor, big, plus -else — the ending that turns an adjective into a noun." },
        ...
        { id: "no-u15l3-avelge", type: "vocab", front: "å velge", reading: "avelge", meaning: "to choose", example: { jp: "Nå velger Erling en genser.", en: "Now Erling is choosing a jumper." }, accept: ["choose", "to pick", "pick", "to select", "select"], drill: { jp: "Det er lett å velge", en: "It is easy to choose" }, hint: "VEL-ge, present velger. Watch the word order: when nå opens the sentence the verb must come second, so the subject drops in behind it — Nå velger Erling, never Nå Erling velger. That is Norwegian's V2 rule, and it is not optional." },
        { id: "no-u15l3-eikrone", type: "vocab", front: "ei krone", reading: "eikrone", meaning: "krone", example: { jp: "Ei krone er ikke mye penger.", en: "A krone is not much money." }, accept: ["crown", "the norwegian krone", "kroner", "norwegian crown"], drill: { jp: "Ei krone er ikke mye", en: "A krone is not much" }, hint: "KROO-ne. Feminine: definite krona. Norway's money — one krone, and the plural you actually hear on every price is kroner. Written NOK on a tag." },
      ],
    },
    // Lesson 4: looking after the clothes, and the two small parts of a garment.
    {
      ...
      items: [
        ...
        { id: "no-u15l4-askifte", type: "vocab", front: "å skifte", reading: "askifte", meaning: "to change", example: { jp: "Erling skifter skjorte.", en: "Erling is changing his shirt." }, accept: ["change", "to change clothes", "swap", "to switch", "switch"], drill: { jp: "Det er lett å skifte", en: "It is easy to change" }, hint: "SHIF-te — sk before i is the broad sh again. Present skifter. Note skifte skjorte with no article at all, the same bare-noun pattern as kjøre bil." },
        { id: "no-u15l4-eilomme", type: "vocab", front: "ei lomme", reading: "eilomme", meaning: "pocket", example: { jp: "Jeg har penger i lomma.", en: "I have money in my pocket." }, accept: ["a pocket"], drill: { jp: "Ei lomme er liten", en: "A pocket is small" }, hint: "LOM-me. Feminine: definite lomma. A wallet is ei lommebok — a pocket-book, welded together the way sykehus was." },
