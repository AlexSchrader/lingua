...
//   l3 endring:   en vekst · et skifte · en overgang
//   l4 valg:      et forsøk · en vurdering · en holdning
//
  ...
  lessons: [
    // Lesson 1: the frame words — reason, way, matter, case, purpose, connection.
    {
      ...
      items: [
        ...
        { id: "no-u50l1-entanke", type: "vocab", front: "en tanke", reading: "entanke", meaning: "thought", example: { jp: "En tanke kommer, men den blir borte hvis vi ikke skriver den.", en: "A thought comes, but it disappears if we do not write it down." }, drill: { jp: "Jeg har en tanke i dag", en: "I have a thought today" }, accept: ["an idea", "a notion"], hint: "TANG-ke. Masculine: definite tanken, plural tanker. Built on å tenke from A1 unit 17. Tanker in the plural is what you are lost in: han er i egne tanker." },
      ],
    },
    ...
    // Lesson 3: comparison and change.
    {
      ...
      unit: 50,
      lesson: 3,
      title: "Likhet og endring",
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Compare and describe change — forskjell, likhet, endring, vekst, verdi, behov.",
      items: [
        ...
        { id: "no-u50l3-enverdi", type: "vocab", front: "en verdi", reading: "enverdi", meaning: "value", example: { jp: "En verdi er ikke alltid penger, og det vet alle.", en: "A value is not always money, and everyone knows that." }, drill: { jp: "Et smykke har en verdi", en: "A piece of jewellery has a value" }, accept: ["worth", "a price"], hint: "vær-DEE, stress at the end. Masculine: definite verdien, plural verdier. Both the price of a thing and what a person believes in — verdier in the plural is values in the moral sense, exactly as in English." },
    ...
    // Lesson 4: choice and responsibility. The last lesson of Norwegian A2.
    {
      ...
      unit: 50,
      lesson: 4,
      title: "Valg og ansvar",
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Talk about choices and duties — valg, erfaring, inntrykk, skikk, ansvar, forsøk.",
      items: [
        ...
        { id: "no-u50l4-etforsok", type: "vocab", front: "et forsøk", reading: "etforsok", meaning: "attempt", example: { jp: "Et forsøk er nok, hvis vi gjør det godt.", en: "One attempt is enough, if we do it well." }, drill: { jp: "Vi gjør et forsøk i dag", en: "We make an attempt today" }, accept: ["a try", "an experiment", "an effort"], hint: "for-SURK, hand-folded to etforsok. Neuter: definite forsøket, plural forsøk, unchanged. Built on å forsøke, to try. Both an attempt and a scientific experiment. ⚠ `et krav` would have been the natural card here; block 2 teaches it at u32. This is the last card of Norwegian A2." },
      ],
    },
  ],
};
