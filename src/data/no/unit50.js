...
//   -ing / -ning  feminine IS permitted (løsninga is correct Bokmål), and §1 is
//          binding: the band marks the whole class `ei` so the definite -a stays
//          derivable — ei løsning, ei endring, ei utvikling, ei erfaring,
//          ei holdning, ei setning (u49).
//          (An earlier version of this header claimed "BOTH sibling blocks
//          standardised on `en`". They had not — the band ran eleven `ei` cards
//          against ten `en` ones. The claim was false, not merely stale.)
  ...
  lessons: [
    ...
    // Lesson 2: when it goes wrong.
    {
      ...
      items: [
        ...
        { id: "no-u50l2-eilosning", type: "vocab", front: "ei løsning", reading: "eilosning", meaning: "solution", example: { jp: "Ei løsning er ikke lett å finne når alle krangler.", en: "A solution is not easy to find when everyone is quarrelling." }, drill: { jp: "Vi finner ei løsning sammen", en: "We find a solution together" }, accept: ["an answer", "a fix", "a resolution"], hint: "LURS-ning, hand-folded to eilosning. Feminine: definite løsninga, plural løsninger. Built on å løse, to solve or to loosen. Bokmål allows løsningen too; the band marks the -ing class ei under §1, so the definite -a stays derivable." },
    ...
    // Lesson 3: comparison and change.
    {
      ...
      items: [
        ...
        { id: "no-u50l3-enlikhet", type: "vocab", front: "en likhet", reading: "enlikhet", meaning: "similarity", example: { jp: "En likhet mellom to språk gjør det lett å lære.", en: "A similarity between two languages makes it easy to learn." }, drill: { jp: "Vi ser en likhet i dag", en: "We see a similarity today" }, accept: ["a resemblance", "equality", "a likeness"], hint: "LEEK-het. Masculine — -het again, no feminine option. Definite likheten, plural likheter. Built on lik, alike. It also means equality, which is why likestilling is the Norwegian word for gender equality." },
        { id: "no-u50l3-eiendring", type: "vocab", front: "ei endring", reading: "eiendring", meaning: "change", example: { jp: "Ei endring i været kommer ofte på et fjell.", en: "A change in the weather comes often on a mountain." }, drill: { jp: "Vi ser ei endring i saka", en: "We see a change in the matter" }, accept: ["an alteration", "a shift", "a modification"], hint: "EN-dring. Feminine: definite endringa, plural endringer. Built on å endre, to change something. Where et skifte is a swap of one thing for another, en endring is the same thing becoming different." },
    ...
    // Lesson 4: choice and responsibility. The last lesson of Norwegian A2.
    {
      ...
      items: [
        ...
        { id: "no-u50l4-eierfaring", type: "vocab", front: "ei erfaring", reading: "eierfaring", meaning: "experience", example: { jp: "Ei erfaring gir mer enn ei bok, sier bestefar.", en: "An experience gives more than a book, grandfather says." }, drill: { jp: "Vi får ei erfaring i dag", en: "We get an experience today" }, accept: ["a piece of experience", "practice"], hint: "ær-FAH-ring. Feminine: definite erfaringa, plural erfaringer — Bokmål allows erfaringen too, and the band marks the -ing class ei so the definite -a stays derivable. Å erfare is the verb." },
        ...
        { id: "no-u50l4-eiholdning", type: "vocab", front: "ei holdning", reading: "eiholdning", meaning: "attitude", example: { jp: "Ei holdning blir ofte en vane, og den er tung.", en: "An attitude often becomes a habit, and it is heavy." }, drill: { jp: "Vi ser ei holdning i saka", en: "We see an attitude in the matter" }, accept: ["a stance", "an outlook", "a posture"], hint: "HOL-ning. Feminine: definite holdninga, plural holdninger. Built on å holde, to hold — the position you hold on a question, and also literally how you hold your body. Marked `ei` like every other -ing/-ning noun in the band (§1); Bokmål permits en holdning too. The -het nouns in this unit stay `en` — they have no feminine form at all. ⚠ Third card in this unit surrendered to block 2 — et krav to u32, et forsøk to u34. This is the last card of Norwegian A2." },
      ],
    },
  ],
};
