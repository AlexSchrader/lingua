...
export const NO_UNIT32 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "no-u32l2-enrett", type: "vocab", front: "en rett", reading: "enrett", meaning: "right", example: { jp: "Alle har rett til å gå på skole.", en: "Everyone has a right to go to school." }, accept: ["a right", "entitlement"], drill: { jp: "Barn har en rett til skole", en: "Children have a right to school" }, hint: "Masculine: en rett → retten. Three senses in one word — a right, a dish of food, and a court of law. Here it is the entitlement, and it takes til: å ha rett til." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u32l3-agjelde", type: "vocab", front: "å gjelde", reading: "agjelde", meaning: "to apply", example: { jp: "Denne regelen gjelder i dag.", en: "This rule applies today." }, accept: ["apply", "to be valid", "be valid", "count"], drill: { jp: "Loven begynner å gjelde nå", en: "The law starts to apply now" }, hint: "Present gjelder — gj is a plain y sound, as in gjøre: YEL-ler. It is what a rule or a ticket does: regelen gjelder, billetten gjelder i to timer." },
