  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u77l3-begge", type: "vocab", front: "begge", reading: "begge", meaning: "both (of two)", example: { jp: "Begge barna bor fremdeles hjemme hos moren sin.", en: "Both children still live at home with their mother." }, accept: ["the two of them", "both", "both"], drill: { jp: "Begge bilene er nye", en: "Both cars are new" }, hint: "Begge + bestemt form: begge bilene. Begge deler = both things. Bruk to when you are counting, begge when you mean the pair." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u77l4-fremdeles", type: "vocab", front: "fremdeles", reading: "fremdeles", meaning: "still (up to now)", example: { jp: "Han bor fremdeles i den gamle leiligheten sin i Oslo.", en: "He still lives in his old flat in Oslo." }, accept: ["yet", "as before", "still", "still"], drill: { jp: "Hun jobber fremdeles der", en: "She still works there" }, hint: "Samme betydning som fortsatt (u28), litt mer skriftlig. Begge er helt vanlige." },
