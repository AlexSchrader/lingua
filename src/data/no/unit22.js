  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u22l3-overrasket", type: "vocab", front: "overrasket", reading: "overrasket", meaning: "surprised", example: { jp: "Vi blir overrasket når Kari kommer, fordi hun aldri sier noe først.", en: "We are surprised whenever Kari turns up, because she never says anything first." }, accept: ["astonished", "taken aback"], drill: { jp: "Jeg er overrasket i dag", en: "I am surprised today" }, hint: "OV-er-ras-ket, built on over. Used with å bli for the moment it happens: jeg ble overrasket." },
