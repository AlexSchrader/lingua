  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u22l1-lettet", type: "vocab", front: "lettet", reading: "lettet", meaning: "relieved", example: { jp: "Jeg ble lettet når jeg forsto at vi ikke måtte jobbe på søndag.", en: "I was relieved when I understood that we did not have to work on Sunday." }, accept: ["relief"], hint: "LET-tet, from lett (A1 u10, easy) — the weight comes off. Used with å bli: jeg ble lettet.", drill: { jp: "Vi er lettet nå", en: "We are relieved now" } },
        { id: "no-u22l1-flau", type: "vocab", front: "flau", reading: "flau", meaning: "embarrassed", example: { jp: "Han ble flau når han forsto at han glemte navnet hennes.", en: "He got embarrassed when he realised that he forgot her name." }, accept: ["ashamed", "awkward", "sheepish"], drill: { jp: "Jeg er litt flau nå", en: "I am a little embarrassed now" }, hint: "FLAU, one syllable rhyming with \"now\". Neuter flaut, plural flaue." },
      ],
    },
    {
      id: "no-u22l2",
      ...
      items: [
        ...
        { id: "no-u22l2-abryseg", type: "vocab", front: "å bry seg", reading: "abryseg", meaning: "to care", example: { jp: "Hun bryr seg og ringer familien sin i dag.", en: "She cares and calls her family today." }, accept: ["care", "to mind", "to be bothered"], drill: { jp: "Det er fint å bry seg", en: "It is nice to care" }, hint: "BRUE seg. The seg changes with the person: jeg bryr MEG. Bryr deg ikke! means don't worry about it." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u22l3-overrasket", type: "vocab", front: "overrasket", reading: "overrasket", meaning: "surprised", example: { jp: "Vi ble overrasket når Kari kom, fordi hun ikke sa noe.", en: "We were surprised when Kari came, because she said nothing." }, accept: ["astonished", "taken aback"], drill: { jp: "Jeg er overrasket i dag", en: "I am surprised today" }, hint: "OV-er-ras-ket, built on over. Used with å bli for the moment it happens: jeg ble overrasket." },
        { id: "no-u22l3-skuffet", type: "vocab", front: "skuffet", reading: "skuffet", meaning: "disappointed", example: { jp: "Elevene var skuffet fordi turen ble stengt av dårlig vær.", en: "The pupils were disappointed because the trip was closed off by bad weather." }, accept: ["let down", "disillusioned"], drill: { jp: "Han er skuffet nå", en: "He is disappointed now" }, hint: "SKUF-fet — the sk before u is a hard sk, not the sh of skje. Ei skuffe is a drawer; unrelated." },
        ...
        { id: "no-u22l3-anyte", type: "vocab", front: "å nyte", reading: "anyte", meaning: "to enjoy", example: { jp: "Vi nyter en rolig kveld hjemme, når vi ikke må gjøre noe.", en: "We enjoy a calm evening at home, when we do not have to do anything." }, accept: ["enjoy", "to savour", "to relish"], drill: { jp: "Det er godt å nyte en pause", en: "It is good to enjoy a break" }, hint: "NUE-te. Stronger and more deliberate than å like — you savour something. Past nøt." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u22l4-sjalu", type: "vocab", front: "sjalu", reading: "sjalu", meaning: "jealous", example: { jp: "Han ble sjalu når han så at vennen hans kjøpte en ny bil.", en: "He got jealous when he saw that his friend bought a new car." }, accept: ["envious"], drill: { jp: "Hun er litt sjalu nå", en: "She is a little jealous now" }, hint: "sha-LOO — the sj hush from A1 unit 1, and the stress on the end. It does not change form: sjalu for every gender and number." },
