  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u22l2-abryseg", type: "vocab", front: "å bry seg", reading: "abryseg", meaning: "to care", example: { jp: "Jeg bryr meg og ringer familien min i dag.", en: "I care and call my family today." }, accept: ["care", "to mind", "to be bothered"], drill: { jp: "Det er fint å bry seg", en: "It is nice to care" }, hint: "BRUE seg. The seg changes with the person: jeg bryr MEG. Bryr deg ikke! means don't worry about it." },
