  ...
  lessons: [
    {
      ...
      items: [
        { id: "no-u80l1-enutleier", type: "vocab", front: "en utleier", reading: "enutleier", meaning: "a landlord (who lets)", example: { jp: "Utleieren bor i samme hus, så han ser alt vi gjør.", en: "The landlord lives in the same house, so he sees everything we do." }, accept: ["a lessor", "a landlady", "landlord"], drill: { jp: "Hun er en utleier folk liker", en: "She is a landlord people like" }, hint: "en utleier → utleieren. Ut + å leie (u30). Samme form for kvinne og mann." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u80l2-envaktmester", type: "vocab", front: "en vaktmester", reading: "envaktmester", meaning: "caretaker", example: { jp: "Ring vaktmesteren hvis heisen stopper igjen.", en: "Call the caretaker if the lift stops again." }, accept: ["a janitor", "a superintendent"], drill: { jp: "Hvert hus har en vaktmester", en: "Every house has a caretaker" }, hint: "en vaktmester → vaktmesteren. En vakt + en mester. Personen som fikser alt som ikke er ditt." },
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Deal with electricity and heating — the grid rent, the meter, the heating cable in the floor, and a power cut.",
      items: [
        ...
        { id: "no-u80l3-enmaler", type: "vocab", front: "en måler", reading: "enmaler", meaning: "meter (gauge)", example: { jp: "Måleren står nede i kjelleren ved døra.", en: "The meter is downstairs in the basement by the door." }, accept: ["a gauge", "a counter"], drill: { jp: "Hvert hus har en måler", en: "Every house has a meter" }, hint: "en måler → måleren. Fra å måle (u34). NB: folder til maler, som også er 'a painter' — samme skriftbilde uten å." },
        { id: "no-u80l3-eivarmepumpe", type: "vocab", front: "ei varmepumpe", reading: "eivarmepumpe", meaning: "heat pump", example: { jp: "Vi satte inn ei varmepumpe for å spare strøm.", en: "We put in a heat pump to save electricity." }, accept: ["air pump", "heating pump"], drill: { jp: "Vi har ei varmepumpe hjemme", en: "We have a heat pump at home" }, hint: "å varme + ei pumpe → hunkjønn: varmepumpa (også varmepumpen). Nesten annethvert norsk hus har en — den henter varme fra lufta ute."},
        { id: "no-u80l3-envarmekabel", type: "vocab", front: "en varmekabel", reading: "envarmekabel", meaning: "an underfloor heating cable", example: { jp: "Det ligger en varmekabel i gulvet på badet.", en: "There is a heating cable in the floor in the bathroom." }, drill: { jp: "Badet har en varmekabel i gulvet", en: "The bathroom has a heating cable in the floor" }, accept: ["a heating cable", "underfloor heating", "a floor heating wire"], hint: "VAR-me-ka-bel. Varme plus en kabel, so masculine after kabel: definite varmekabelen, plural varmekabler. Almost every Norwegian bathroom has one, and it is the part of nettleia you feel in February." },
      ],
    },
    {
      id: "no-u80l4",
      ...
      items: [
        ...
        { id: "no-u80l4-vedlikehold", type: "vocab", front: "vedlikehold", reading: "vedlikehold", meaning: "maintenance", example: { jp: "Utleieren har ansvar for vedlikeholdet av huset.", en: "The landlord is responsible for the maintenance of the house." }, accept: ["upkeep", "servicing"], drill: { jp: "Huset trenger vedlikehold hvert år", en: "The house needs maintenance every year" }, hint: "vedlikehold → vedlikeholdet. Ved + like + å holde (u59): keeping it the same. Massesubstantiv, derfor bart oppslag. Står alltid i kontrakten." },
        { id: "no-u80l4-fukt", type: "vocab", front: "fukt", reading: "fukt", meaning: "damp", example: { jp: "Det er fukt i veggen på badet.", en: "There is damp in the wall in the bathroom." }, drill: { jp: "Vi fant fukt i veggen her", en: "We found damp in the wall here" }, accept: ["moisture", "dampness", "wet in the structure"], hint: "FUKT. Taught bare, like vann, because you never count it. Definite fukta, and you will meet fukten in print. In a Norwegian rental it is the fault the landlord has to act on: fukt becomes mugg if nobody does." },
      ],
    },
  ],
};
