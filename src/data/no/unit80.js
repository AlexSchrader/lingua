  ...
  lessons: [
    {
      ...
      items: [
        { id: "no-u80l1-enutleier", type: "vocab", front: "en utleier", reading: "enutleier", meaning: "a landlord (who lets)", example: { jp: "Utleieren bor i samme hus, så han ser alt vi gjør.", en: "The landlord lives in the same house, so he sees everything we do." }, accept: ["a lessor", "a landlady", "landlord", "landlord"], drill: { jp: "Hun er en utleier folk liker", en: "She is a landlord people like" }, hint: "en utleier → utleieren. Ut + å leie (u30). Samme form for kvinne og mann." },
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Deal with electricity and heating — the grid rent, the meter and a power cut.",
      items: [
