  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u107l3-medhensyntil", type: "vocab", front: "med hensyn til", reading: "medhensyntil", meaning: "with regard to", example: { jp: "Med hensyn til prisen er vi enige, og det er det vi er enige om.", en: "With regard to the price we agree, and that is what we agree about." }, accept: ["as regards", "concerning"], drill: { jp: "Vi sier ingenting med hensyn til prisen", en: "We say nothing with regard to the price" }, hint: "med hensyn til + substantiv. Et hensyn (u61). Forkortes m.h.t. i skrift. Sier hva du snakker OM — ikke at du tar hensyn til noen." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u107l4-dels", type: "vocab", front: "dels", reading: "dels", meaning: "partly (dels ... dels)", example: { jp: "Det skyldes dels prisen og dels at ingen visste om tilbudet.", en: "It is partly due to the price and partly to nobody knowing about the offer." }, accept: ["in part"], drill: { jp: "Det er dels dyrt og dels tungt", en: "It is partly expensive and partly heavy" }, hint: "dels … dels, nesten alltid i par. Fra en del (u47). Deler opp ÅRSAKEN i to like viktige halvdeler — ikke i en hoved- og en bigrunn." },
