  ...
  lessons: [
    ...
    // that makes the unit usable rather than decorative.
    {
      ...
      items: [
        ...
        { id: "no-u72l4-utfore", type: "vocab", front: "å utføre", reading: "autfore", meaning: "to carry out (formal)", example: { jp: "Arbeidet ble utført på to dager.", en: "The work was carried out in two days." }, accept: ["carry out", "to carry out", "to perform", "to execute"], drill: { jp: "Vi pleier å utføre arbeidet her", en: "We usually carry out the work here" }, hint: "ut + å føre. utfører, utførte. ⚠ THE PAIR: å gjøre (u11) in speech, å utføre in writing." },
