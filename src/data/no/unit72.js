  ...
  lessons: [
    ...
    // reads weekly and says almost never.
    {
      ...
      items: [
        ...
        { id: "no-u72l1-medvennlighilsen", type: "vocab", front: "med vennlig hilsen", reading: "medvennlighilsen", meaning: "yours sincerely", example: { jp: "Brevet slutter med vennlig hilsen og et navn.", en: "The letter ends with \"yours sincerely\" and a name." }, drill: { jp: "Hun skriver med vennlig hilsen i brevet", en: "She writes \"yours sincerely\" in the letter" }, accept: ["kind regards", "best regards", "yours faithfully"], hint: "The standard sign-off on every formal Norwegian letter and e-mail — \"with friendly greeting\". Often shortened to Mvh in a quick message. Three words, one frozen formula: never rearrange them." },
      ],
    },
    // Lesson 2: asking for something, at the formal end.
    {
      ...
      items: [
        ...
        { id: "no-u72l2-enforesporsel", type: "vocab", front: "en forespørsel", reading: "enforesporsel", meaning: "a formal request", example: { jp: "Vi har sendt en forespørsel til kommunen om saka.", en: "We have sent a formal request to the council about the matter." }, drill: { jp: "Kontoret svarer på en forespørsel i dag", en: "The office answers a request today" }, accept: ["an enquiry (written)", "a query", "a request for information"], hint: "FO-re-spoer-sel. Masculine: definite forespørselen, plural forespørsler — the e drops before the ending. For plus spørre, to ask ahead. En henvendelse is you making contact; en forespørsel is the question you are actually asking." },
      ],
    },
    // Lesson 3: the other end. Short, blunt, and what people actually say.
    {
      ...
      items: [
        { id: "no-u72l3-greit", type: "vocab", front: "greit", reading: "greit", meaning: "OK (that's fine)", example: { jp: "Greit, vi møtes klokka ni.", en: "Fine, we will meet at nine." }, accept: ["ok", "all right", "okay", "fine"], drill: { jp: "Det er greit for meg", en: "That is fine by me" }, hint: "The neuter of grei (u31), used alone as a whole answer. Greit! is probably the commonest yes in Norway — and det går greit is \"it is going fine\"." },
        ...
        { id: "no-u72l3-goy", type: "vocab", front: "gøy", reading: "goy", meaning: "fun", example: { jp: "Det var veldig gøy på turen i går.", en: "It was really fun on the trip yesterday." }, drill: { jp: "Turen var skikkelig gøy i går", en: "The trip was really fun yesterday" }, accept: ["enjoyable", "a laugh", "good fun"], hint: "GOEY, one syllable. It never changes — et gøy spill, gøye dager is what you will hear, but gøy on its own covers nearly everything. Pure spoken Norwegian: a formal letter would write morsomt instead." },
      ],
    },
    ...
    // that makes the unit usable rather than decorative.
    {
      ...
      items: [
        ...
        { id: "no-u72l4-abenytte", type: "vocab", front: "å benytte", reading: "abenytte", meaning: "to make use of", example: { jp: "Du kan benytte dette skjemaet hvis du vil søke.", en: "You may make use of this form if you want to apply." }, drill: { jp: "Det er vanlig å benytte dette skjemaet", en: "It is normal to make use of this form" }, accept: ["to utilise", "to avail yourself of", "to employ (a thing)"], hint: "be-NUET-te. Present benytter, past benyttet. This is å bruke in a suit — same meaning, and a form or a letter will always pick benytte. Say bruke out loud and write benytte to an office." },
      ],
    },
  ],
};
