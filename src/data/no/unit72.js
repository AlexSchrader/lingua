  ...
  lessons: [
    ...
    // reads weekly and says almost never.
    {
      ...
      items: [
        ...
        { id: "no-u72l1-bekrefte", type: "vocab", front: "å bekrefte", reading: "abekrefte", meaning: "to confirm", example: { jp: "Vi bekrefter at vi har fått søknaden din.", en: "We confirm that we have received your application." }, accept: ["confirm", "to acknowledge"], drill: { jp: "Vi pleier å bekrefte hver avtale", en: "We usually confirm every appointment" }, hint: "be- + kraft (u34) — to give something force. bekrefter, bekreftet. Every Norwegian booking e-mail is built on this verb." },
        ...
        { id: "no-u72l1-vennligst", type: "vocab", front: "vennligst", reading: "vennligst", meaning: "please", example: { jp: "Vennligst send skjemaet innen fredag.", en: "Please send the form by Friday." }, accept: ["kindly", "please (formal)"], drill: { jp: "Vennligst send skjemaet innen fredag", en: "Please send the form by Friday" }, hint: "vennlig + -st, the superlative ending doing duty as politeness. ⚠ WRITTEN ONLY. Said out loud to a person it sounds cold — in speech Norwegians use vær så snill (u2), or simply nothing at all." },
      ],
    },
    // Lesson 2: asking for something, at the formal end.
    {
      ...
      items: [
        ...
        { id: "no-u72l2-eventuelt", type: "vocab", front: "eventuelt", reading: "eventuelt", meaning: "if need be", example: { jp: "Vi kan møtes fredag, eventuelt lørdag.", en: "We can meet on Friday, or Saturday if need be." }, accept: ["possibly", "alternatively", "or else"], drill: { jp: "Vi kan møtes fredag eventuelt lørdag", en: "We can meet Friday or Saturday if need be" }, hint: "⚠ FALSE FRIEND. It does NOT mean \"eventually\" — it means \"or else\", \"if necessary\". Written evt. in e-mail, and used constantly." },
      ],
    },
    // Lesson 3: the other end. Short, blunt, and what people actually say.
    {
      ...
      items: [
        { id: "no-u72l3-sann", type: "vocab", front: "sånn", reading: "sann", meaning: "like that", example: { jp: "Det er sånn vi gjør det her.", en: "That is how we do it here." }, accept: ["that way", "such", "so"], drill: { jp: "Det er sånn vi gjør det", en: "That is how we do it" }, hint: "The spoken form of slik, and far commoner. Also a filler at the end of a job: Sånn, da er vi ferdige." },
        { id: "no-u72l3-greit", type: "vocab", front: "greit", reading: "greit", meaning: "fine", example: { jp: "Greit, vi møtes klokka ni.", en: "Fine, we will meet at nine." }, accept: ["ok", "all right", "okay"], drill: { jp: "Det er greit for meg", en: "That is fine by me" }, hint: "The neuter of grei (u31), used alone as a whole answer. Greit! is probably the commonest yes in Norway — and det går greit is \"it is going fine\"." },
        { id: "no-u72l3-kult", type: "vocab", front: "kult", reading: "kult", meaning: "cool", example: { jp: "Det var kult å se deg igjen.", en: "It was cool to see you again." }, accept: ["nice", "great", "awesome"], drill: { jp: "Det var kult å se deg", en: "It was cool to see you" }, hint: "The neuter of kul, borrowed straight from English and inflected like a Norwegian adjective. Spoken only." },
    ...
    // that makes the unit usable rather than decorative.
    {
      ...
      items: [
        ...
        { id: "no-u72l4-utfore", type: "vocab", front: "å utføre", reading: "autfore", meaning: "to carry out", example: { jp: "Arbeidet ble utført på to dager.", en: "The work was carried out in two days." }, accept: ["carry out", "to perform", "to execute"], drill: { jp: "Vi pleier å utføre arbeidet her", en: "We usually carry out the work here" }, hint: "ut + å føre. utfører, utførte. ⚠ THE PAIR: å gjøre (u11) in speech, å utføre in writing." },
