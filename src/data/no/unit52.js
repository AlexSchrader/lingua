  ...
  lessons: [
    ...
    // opposite moods, and the learner should feel the verb jump twice in a row.
    {
      ...
      items: [
        ...
        { id: "no-u52l3-medtankepa", type: "vocab", front: "med tanke på", reading: "medtankepa", meaning: "with a view to", example: { jp: "Med tanke på været tar vi bussen i dag.", en: "With a view to the weather, we are taking the bus today." }, drill: { jp: "Han sparer penger med tanke på ferien", en: "He is saving money with a view to the holiday" }, accept: ["considering", "with an eye to", "in view of", "bearing in mind"], hint: "Literally \"with thought on\". It names the PURPOSE or the thing you are allowing for: du gjør X med tanke på Y. One thing in the mouth — the three words never come apart." },
      ],
    },
