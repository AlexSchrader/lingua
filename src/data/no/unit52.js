  ...
  lessons: [
    ...
    // opposite moods, and the learner should feel the verb jump twice in a row.
    {
      ...
      items: [
        ...
        { id: "no-u52l3-dessverre", type: "vocab", front: "dessverre", reading: "dessverre", meaning: "unfortunately", example: { jp: "Dessverre er museet stengt i dag.", en: "Unfortunately the museum is closed today." }, drill: { jp: "Dessverre er toget forsinket i dag", en: "Unfortunately the train is delayed today" }, accept: ["sadly", "regrettably", "I am afraid", "alas"], hint: "des-VÆR-re. Dess plus verre, all the worse. ⚠ It is the clearest V2 word in the language: put dessverre first and the VERB must come next — Dessverre ER museet stengt, never Dessverre museet er." },
