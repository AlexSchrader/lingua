  ...
  lessons: [
    // Lesson 1: six ways to turn an adjective down a notch.
    {
      ...
      items: [
        ...
        { id: "no-u73l1-noksa", type: "vocab", front: "nokså", reading: "noksa", meaning: "rather", example: { jp: "Boka var nokså kjedelig.", en: "The book was rather boring." }, accept: ["somewhat", "fairly", "kind of"], drill: { jp: "Boka var nokså kjedelig", en: "The book was rather boring" }, hint: "nok (u10) + så. The same strength as temmelig, but it leans faintly negative — nokså dyr is a complaint, temmelig dyr is a measurement." },
        ...
        { id: "no-u73l1-snarere", type: "vocab", front: "snarere", reading: "snarere", meaning: "rather", example: { jp: "Det var ikke dyrt, snarere billig.", en: "It was not expensive — rather, it was cheap." }, accept: ["instead", "more like", "if anything"], drill: { jp: "Det var ikke dyrt snarere billig", en: "It was not expensive rather cheap" }, hint: "The comparative of snar, quick. It CORRECTS rather than softens: not X — snarere Y. snarere enn is \"rather than\"." },
    ...
    // lesson and of Norwegian argument generally.
    {
      ...
      items: [
        ...
        { id: "no-u73l4-standpunkt", type: "vocab", front: "et standpunkt", reading: "etstandpunkt", meaning: "a position", example: { jp: "Hun forandret standpunkt etter praten.", en: "She changed her position after the conversation." }, accept: ["standpoint", "stance", "point of view"], drill: { jp: "Hun hadde et standpunkt alle forsto", en: "She had a position everyone understood" }, hint: "å stå (u13) + punkt — where you are standing. Neuter: standpunktet. å ta standpunkt til noe is to make your mind up about it." },
      ],
    },
  ],
};
