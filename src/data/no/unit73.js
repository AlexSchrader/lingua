  ...
  lessons: [
    // Lesson 1: six ways to turn an adjective down a notch.
    {
      ...
      items: [
        ...
        { id: "no-u73l1-inoengrad", type: "vocab", front: "i noen grad", reading: "inoengrad", meaning: "to some degree", example: { jp: "Jeg er i noen grad enig med deg i dette.", en: "I agree with you to some degree on this." }, drill: { jp: "Vi er i noen grad enige her", en: "We agree to some degree here" }, accept: ["to an extent", "up to a point", "somewhat (formally)"], hint: "En grad is a degree, so this is \"in some degree\". The written cousin of delvis, and the safest way to agree without being held to all of it. Three words, always in this order." },
      ],
    },
    // Lesson 2: keeping an exit open.
    {
      ...
      items: [
        ...
        { id: "no-u73l2-forutsatt", type: "vocab", front: "forutsatt", reading: "forutsatt", meaning: "on condition that", example: { jp: "Vi kommer på lørdag, forutsatt at været er fint.", en: "We are coming on Saturday, provided that the weather is fine." }, drill: { jp: "Vi kommer forutsatt at været er fint", en: "We are coming provided that the weather is fine" }, accept: ["provided that", "assuming that", "as long as (conditional)"], hint: "FO-rut-satt. For plus ut plus satt, the participle of å sette: the condition is set out in advance. Almost always followed by at plus a clause. Dersom opens a condition; forutsatt at hangs one on a promise you have already made." },
      ],
    },
    ...
    // twice.
    {
      ...
      items: [
        ...
        { id: "no-u73l3-etavbud", type: "vocab", front: "et avbud", reading: "etavbud", meaning: "a cancellation of attendance", example: { jp: "Hun måtte sende et avbud til middagen i kveld.", en: "She had to send word that she could not come to the dinner tonight." }, drill: { jp: "Han sendte et avbud til møtet", en: "He sent word that he could not come to the meeting" }, accept: ["a message that you cannot come", "calling off (your attendance)", "a withdrawal"], hint: "AV-bud. Av plus bud, a message: the message that you are off. Neuter: definite avbudet, plural avbud. Å melde avbud is the set phrase, and it is the polite Norwegian way to pull out of something." },
      ],
    },
    ...
    // lesson and of Norwegian argument generally.
    {
      ...
      items: [
        ...
        { id: "no-u73l4-lydhor", type: "vocab", front: "lydhør", reading: "lydhor", meaning: "receptive to others", example: { jp: "En god sjef er lydhør når andre er uenige.", en: "A good boss is receptive when others disagree." }, drill: { jp: "Sjefen er lydhør for gode råd", en: "The boss is receptive to good advice" }, accept: ["a good listener", "open to what others say", "attentive"], hint: "LUED-hoer. En lyd is a sound and å høre is to hear — you hear even the quiet things. Neuter lydhørt, plural lydhøre. You are lydhør FOR something. The one quality that keeps a disagreement from becoming a krangel." },
      ],
    },
  ],
};
