  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u39l3-skaltila", type: "vocab", front: "skal til å", reading: "skaltila", meaning: "about to", example: { jp: "Jeg skal til å gå, men jeg venter på deg.", en: "I'm about to leave, but I'm waiting for you." }, accept: ["is about to", "on the point of"], drill: { jp: "Vi skal til å dra", en: "We're about to leave" }, hint: "skal til å = on the point of. Add akkurat for 'just about to': skal akkurat til å gå." },
        ...
        { id: "no-u39l3-planleggera", type: "vocab", front: "planlegger å", reading: "planleggera", meaning: "am planning to", example: { jp: "De planlegger å kjøpe hus når de har penger nok.", en: "They're planning to buy a house once they have enough money." }, accept: ["plan to", "intend to"], drill: { jp: "Vi planlegger å flytte", en: "We're planning to move" }, hint: "å planlegge → planlegger. The firmest of the intention verbs. legge (to lay) hides inside it." },
      ],
    },
    {
      id: "no-u39l4",
      ...
      items: [
        ...
        { id: "no-u39l4-sier", type: "vocab", front: "sier", reading: "sier", meaning: "say", example: { jp: "Hun sier at hun kommer, men jeg tror det ikke.", en: "She says she's coming, but I don't believe it." }, accept: ["says", "am saying"], drill: { jp: "Jeg sier det til deg", en: "I say it to you" }, hint: "å si → sier — the i comes back in the present. Said 'SEE-er'. Past sa (A1)." },
        { id: "no-u39l4-spor", type: "vocab", front: "spør", reading: "spor", meaning: "ask", example: { jp: "Hvis du vil vite det, så spør du bare læreren.", en: "If you want to know, just ask the teacher." }, accept: ["asks", "am asking"], drill: { jp: "Jeg spør om veien", en: "I ask for directions" }, hint: "å spørre → spør, not 'spørrer'. Past spurte (u38). ø → o in the reading." },
        { id: "no-u39l4-far", type: "vocab", front: "får", reading: "far", meaning: "get", example: { jp: "Hvis vi skynder oss, får vi toget.", en: "If we hurry, we'll get the train." }, accept: ["gets", "am getting", "may"], drill: { jp: "Jeg får lønn i dag", en: "I get paid today" }, hint: "å få → får, not 'fåer'. Also 'may / is allowed to': du får gå, you may go. Careful with far, father — same reading, different word." },
        { id: "no-u39l4-ser", type: "vocab", front: "ser", reading: "ser", meaning: "see", example: { jp: "Jeg ser at du er trøtt, så vi kan ta en pause.", en: "I see that you're tired, so we can take a break." }, accept: ["sees", "am looking"], drill: { jp: "Jeg ser en fugl", en: "I see a bird" }, hint: "å se → ser. ser ut = looks (appears): du ser sliten ut, you look tired. Past så (A1)." },
      ],
    },
  ],
};
