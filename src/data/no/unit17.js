  ...
  lessons: [
    ...
    // posture verbs Norwegian uses where English just says "is".
    {
      ...
      items: [
        ...
        { id: "no-u17l2-asitte", type: "vocab", front: "å sitte", reading: "asitte", meaning: "to sit", example: { jp: "Vi sitter på en stol.", en: "We are sitting on a chair." }, accept: ["sit", "to be sitting", "be sitting", "to be seated", "be seated"], hint: "SIT-te, present sitter. Sitting as a STATE, not the act of sitting down. Norwegian keeps sitte, stå and ligge carefully apart and uses them where English would just say \"is\"." },
        { id: "no-u17l2-asta", type: "vocab", front: "å stå", reading: "asta", meaning: "to stand", example: { jp: "En lampe står på et bord.", en: "A lamp is standing on a table." }, accept: ["stand", "to be standing", "be standing", "to stand up", "stand up"], hint: "STAW, present står. Used for upright objects as readily as for people — ei flaske står på bordet. Å stå opp is to get out of bed." },
    ...
    // Lesson 3: speech. Note å spørre's irregular present, flagged on the card.
    {
      ...
      items: [
        ...
        { id: "no-u17l3-afortelle", type: "vocab", front: "å fortelle", reading: "afortelle", meaning: "to tell", example: { jp: "Kari forteller hva hun gjør.", en: "Kari is telling what she does." }, accept: ["tell", "to narrate", "narrate", "to recount", "recount", "to relate"], hint: "for-TEL-le, present forteller. To tell a story or relate something, where å si is just to utter words. Built from for plus telle, to count — the same shift English made from \"tell\" to a bank \"teller\"." },
      ],
    },
