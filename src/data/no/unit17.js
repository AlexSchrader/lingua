  ...
  lessons: [
    ...
    // the unit leans on (en vane, å bruke).
    {
      ...
      items: [
        ...
        { id: "no-u17l1-adusje", type: "vocab", front: "å dusje", reading: "adusje", meaning: "to shower", example: { jp: "Erling dusjer på badet.", en: "Erling is showering in the bathroom." }, accept: ["shower", "to take a shower", "take a shower", "have a shower"], drill: { jp: "Det er godt å dusje tidlig", en: "It is good to shower early" }, hint: "DUE-she, present dusjer — sj is the broad sh of sjø and skjorte. En dusj is the shower itself." },
        ...
        { id: "no-u17l1-ahvile", type: "vocab", front: "å hvile", reading: "ahvile", meaning: "to rest", example: { jp: "Nå hviler jeg i stua.", en: "Now I am resting in the living room." }, accept: ["rest", "to relax", "relax", "to take a rest", "take a rest"], drill: { jp: "Det er godt å hvile ei natt", en: "It is good to rest for a night" }, hint: "VEE-le — hv- is a silent h, the same trick as in hva and hvor. Present hviler. And note the order: with nå in front, hviler comes second and jeg falls in behind it. That is Norwegian's V2 rule, not a stylistic choice." },
    ...
    // is dimension and quality, u11 is illness.
    {
      ...
      items: [
        ...
        { id: "no-u17l2-ale", type: "vocab", front: "å le", reading: "ale", meaning: "to laugh", example: { jp: "Vi ler sammen.", en: "We are laughing together." }, accept: ["laugh", "to laugh at", "chuckle"], drill: { jp: "Det er godt å le sammen", en: "It is good to laugh together" }, hint: "LEH, present ler — one of the shortest verbs in the language, and its present is just the infinitive plus -r. Å le av noe is to laugh AT something." },
    ...
    // "think", plus remembering, forgetting and hoping.
    {
      ...
      items: [
        ...
        { id: "no-u17l3-ahuske", type: "vocab", front: "å huske", reading: "ahuske", meaning: "to remember", example: { jp: "Husker du navnet?", en: "Do you remember the name?" }, accept: ["remember", "to recall", "recall", "to memorise", "memorize"], drill: { jp: "Det er viktig å huske et navn", en: "It is important to remember a name" }, hint: "HUES-ke, present husker. Look at the question: Norwegian makes a yes/no question by putting the verb FIRST — Husker du. There is no do-support in the language at all, so \"Gjør du huske?\" is not a sentence." },
        { id: "no-u17l3-aglemme", type: "vocab", front: "å glemme", reading: "aglemme", meaning: "to forget", example: { jp: "Erling glemmer nøkkelen i bilen.", en: "Erling leaves the key in the car." }, accept: ["forget", "to leave behind", "leave behind"], drill: { jp: "Det er lett å glemme et navn", en: "It is easy to forget a name" }, hint: "GLEM-me, hard g, present glemmer. Also for leaving something behind by accident, which is what the example does. The opposite of å huske, and worth learning as a pair with it." },
        ...
        { id: "no-u17l3-ahape", type: "vocab", front: "å håpe", reading: "ahape", meaning: "to hope", example: { jp: "Jeg håper Kari kommer.", en: "I hope Kari is coming." }, accept: ["hope", "to hope for", "hope for"], drill: { jp: "Det er godt å håpe på noe", en: "It is good to hope for something" }, hint: "HAW-pe, present håper — the å folds to a on its own. Et håp is a hope. Jeg håper det is \"I hope so\"." },
    ...
    // Lesson 4: arranging to meet, and the small courtesies around it.
    {
      ...
      items: [
        { id: "no-u17l4-aringe", type: "vocab", front: "å ringe", reading: "aringe", meaning: "to call", example: { jp: "Jeg ringer til Kari.", en: "I am calling Kari." }, accept: ["call", "to phone", "phone", "to ring", "ring", "to telephone"], drill: { jp: "Det er lett å ringe en lege", en: "It is easy to call a doctor" }, hint: "RING-e, present ringer. On the telephone, and it takes til: ringe til noen. It is also what a bell does — klokka ringer." },
