  ...
  lessons: [
    ...
    // the unit leans on (en vane, å bruke).
    {
      ...
      items: [
        ...
        { id: "no-u17l1-ahvile", type: "vocab", front: "å hvile", reading: "ahvile", meaning: "to rest", example: { jp: "Nå hviler jeg i stua.", en: "Now I am resting in the living room." }, accept: ["rest", "to relax", "relax", "to take a rest", "take a rest"], drill: { jp: "Det er godt å hvile litt", en: "It is good to rest a little" }, hint: "VEE-le — hv- is a silent h, the same trick as in hva and hvor. Present hviler. And note the order: with nå in front, hviler comes second and jeg falls in behind it. That is Norwegian's V2 rule, not a stylistic choice." },
