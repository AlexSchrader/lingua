  ...
  lessons: [
    ...
    // the unit leans on (en vane, å bruke).
    {
      ...
      items: [
        ...
        { id: "no-u17l1-adusje", type: "vocab", front: "å dusje", reading: "adusje", meaning: "to shower", example: { jp: "Erling dusjer på badet.", en: "Erling is showering in the bathroom." }, accept: ["shower", "to take a shower", "take a shower", "have a shower"], drill: { jp: "Det er godt å dusje", en: "It is good to shower" }, hint: "DUE-she, present dusjer — sj is the broad sh of sjø and skjorte. En dusj is the shower itself." },
        ...
        { id: "no-u17l1-ahvile", type: "vocab", front: "å hvile", reading: "ahvile", meaning: "to rest", example: { jp: "Nå hviler jeg i stua.", en: "Now I am resting in the living room." }, accept: ["rest", "to relax", "relax", "to take a rest", "take a rest"], drill: { jp: "Det er godt å hvile", en: "It is good to rest" }, hint: "VEE-le — hv- is a silent h, the same trick as in hva and hvor. Present hviler. And note the order: with nå in front, hviler comes second and jeg falls in behind it. That is Norwegian's V2 rule, not a stylistic choice." },
        { id: "no-u17l1-envane", type: "vocab", front: "en vane", reading: "envane", meaning: "habit", example: { jp: "Det er en god vane.", en: "That is a good habit." }, accept: ["a habit", "custom", "routine", "practice"], drill: { jp: "En vane er sterk", en: "A habit is strong" }, hint: "VAH-ne. Masculine: definite vanen, plural vaner. Å ha for vane is to be in the habit of something. Vanlig, \"ordinary\", is built straight on it — the ordinary is what happens by habit." },
        { id: "no-u17l1-abruke", type: "vocab", front: "å bruke", reading: "abruke", meaning: "to use", example: { jp: "Kari bruker mye penger.", en: "Kari spends a lot of money." }, accept: ["use", "to spend", "spend", "to wear", "wear"], drill: { jp: "Det er lett å bruke", en: "It is easy to use" }, hint: "BRUE-ke, present bruker. One verb doing three English jobs: to use a thing, to spend money (bruke penger), and to wear glasses or a clothing size (bruke briller)." },
      ],
    },
    ...
    // is dimension and quality, u11 is illness.
    {
      ...
      items: [
        ...
        { id: "no-u17l2-ale", type: "vocab", front: "å le", reading: "ale", meaning: "to laugh", example: { jp: "Vi ler sammen.", en: "We are laughing together." }, accept: ["laugh", "to laugh at", "chuckle"], drill: { jp: "Det er godt å le", en: "It is good to laugh" }, hint: "LEH, present ler — one of the shortest verbs in the language, and its present is just the infinitive plus -r. Å le av noe is to laugh AT something." },
        { id: "no-u17l2-asmile", type: "vocab", front: "å smile", reading: "asmile", meaning: "to smile", example: { jp: "Kari smiler til meg.", en: "Kari is smiling at me." }, accept: ["smile", "to grin", "grin"], drill: { jp: "Det er hyggelig å smile", en: "It is nice to smile" }, hint: "SMEE-le, present smiler. Et smil is a smile. Norwegians smile at strangers far less than the British do, which is exactly why it carries more weight when they do." },
      ],
    },
    ...
    // "think", plus remembering, forgetting and hoping.
    {
      ...
      items: [
        { id: "no-u17l3-atenke", type: "vocab", front: "å tenke", reading: "atenke", meaning: "to think", example: { jp: "Jeg tenker på Norge.", en: "I am thinking about Norway." }, accept: ["think", "to think about", "think about", "to reflect", "reflect"], drill: { jp: "Det er viktig å tenke", en: "It is important to think" }, hint: "TENG-ke, present tenker. This is the mental WORK of thinking — å tenke på, to think about something. It is NOT the \"I think\" of an opinion; that is synes, two cards down." },
        { id: "no-u17l3-ahuske", type: "vocab", front: "å huske", reading: "ahuske", meaning: "to remember", example: { jp: "Husker du navnet?", en: "Do you remember the name?" }, accept: ["remember", "to recall", "recall", "to memorise", "memorize"], drill: { jp: "Det er viktig å huske", en: "It is important to remember" }, hint: "HUES-ke, present husker. Look at the question: Norwegian makes a yes/no question by putting the verb FIRST — Husker du. There is no do-support in the language at all, so \"Gjør du huske?\" is not a sentence." },
        { id: "no-u17l3-aglemme", type: "vocab", front: "å glemme", reading: "aglemme", meaning: "to forget", example: { jp: "Erling glemmer nøkkelen i bilen.", en: "Erling leaves the key in the car." }, accept: ["forget", "to leave behind", "leave behind"], drill: { jp: "Det er lett å glemme", en: "It is easy to forget" }, hint: "GLEM-me, hard g, present glemmer. Also for leaving something behind by accident, which is what the example does. The opposite of å huske, and worth learning as a pair with it." },
        { id: "no-u17l3-asynes", type: "vocab", front: "å synes", reading: "asynes", meaning: "to think (opinion)", example: { jp: "Jeg synes norsk er hyggelig.", en: "I think Norwegian is nice." }, accept: ["to think", "think", "to find", "find", "to be of the opinion", "feel", "reckon"], drill: { jp: "Det er lett å synes noe", en: "It is easy to have an opinion" }, hint: "SUE-nes, present synes — the -s belongs to the verb and never drops. This is your PERSONAL opinion, the \"I think\" of taste: jeg synes filmen er god. Norwegian splits English think four ways — synes for how a thing strikes you, tenke for the mental work, tro for a belief about the facts, and mene, two cards down, for a position you could argue for." },
        { id: "no-u17l3-ahape", type: "vocab", front: "å håpe", reading: "ahape", meaning: "to hope", example: { jp: "Jeg håper Kari kommer.", en: "I hope Kari is coming." }, accept: ["hope", "to hope for", "hope for"], drill: { jp: "Det er godt å håpe", en: "It is good to hope" }, hint: "HAW-pe, present håper — the å folds to a on its own. Et håp is a hope. Jeg håper det is \"I hope so\"." },
        { id: "no-u17l3-amene", type: "vocab", front: "å mene", reading: "amene", meaning: "to mean", example: { jp: "Hva mener du?", en: "What do you mean?" }, accept: ["to be of the opinion", "to hold", "to reckon", "to intend"], drill: { jp: "Det er lett å mene noe", en: "It is easy to mean something" }, hint: "MEH-ne, present mener. Two jobs: what somebody MEANS by what they said (hva mener du?), and holding a considered opinion — which is the shade separating it from synes, a matter of taste. En mening is both a meaning and an opinion." },
      ],
    },
    // Lesson 4: arranging to meet, and the small courtesies around it.
    {
      ...
      items: [
        ...
        { id: "no-u17l4-ahilse", type: "vocab", front: "å hilse", reading: "ahilse", meaning: "to greet", example: { jp: "Jeg hilser på en venn.", en: "I greet a friend." }, accept: ["greet", "to say hello", "say hello", "to send regards", "to shake hands"], drill: { jp: "Det er hyggelig å hilse", en: "It is nice to greet" }, hint: "HIL-se, present hilser. Å hilse PÅ noen is to greet somebody or to be introduced to them. The phrase you will actually need is Hils Kari fra meg — say hello to Kari from me." },
        ...
        { id: "no-u17l4-avente", type: "vocab", front: "å vente", reading: "avente", meaning: "to wait", example: { jp: "Vi venter på bussen.", en: "We are waiting for the bus." }, accept: ["wait", "to wait for", "wait for", "to expect", "expect"], drill: { jp: "Det er tungt å vente", en: "It is hard to wait" }, hint: "VEN-te, present venter. You wait PÅ something, not \"for\" it. The same verb also means to expect — jeg venter et barn, I am expecting a child — which is why it closes a lesson about arrangements." },
      ],
    },
  ],
};
