...
export const NO_UNIT14 = {
  ...
  lessons: [
    ...
    // Lesson 4: two complete three-form paradigms.
    {
      ...
      items: [
        { id: "no-u14l4-annen", type: "vocab", front: "annen", reading: "annen", meaning: "other (masculine/feminine)", example: { jp: "Erling har en annen bil.", en: "Erling has another car." }, accept: ["other", "another", "different", "second"], hint: "For en and ei nouns alike: en annen bil, ei annen skjorte. This is the one adjective where the feminine may also differ — ei anna skjorte is equally correct Bokmål — so annen is the exception to the rule this unit states, not an example of it. egen, below, is the regular one; between them you get a complete paradigm twice over." },
