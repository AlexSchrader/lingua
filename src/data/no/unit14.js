  ...
  lessons: [
    ...
    // Lesson 2: the six irregular pasts an A1 learner cannot do without.
    {
      ...
      items: [
        ...
        { id: "no-u14l2-gikk", type: "vocab", front: "gikk", reading: "gikk", meaning: "went", example: { jp: "Vi gikk til torget i går.", en: "We walked to the square yesterday." }, accept: ["walked", "did go", "left"], drill: { jp: "Han gikk til en butikk", en: "He went to a shop" }, hint: "The past of å gå, with the vowel replaced outright — the same trick English plays in go → went. Verbs that do this are called sterke verb, strong verbs, and you learn them one at a time." },
    ...
    // Lesson 3: this/that/these — and the agreement rule they carry.
    {
      ...
      items: [
        ...
        { id: "no-u14l3-dette", type: "vocab", front: "dette", reading: "dette", meaning: "this (neuter)", example: { jp: "Dette huset er stort.", en: "This house is big." }, accept: ["this", "this one", "this thing"], drill: { jp: "Dette huset er stort", en: "This house is big" }, hint: "The neuter of denne: dette huset, dette året. Now look at stort — hus is an et word, so stor takes a -t. That is the first half of the whole agreement system: et word → adjective + t. et stort hus, et rødt flagg, et kaldt rom." },
        ...
        { id: "no-u14l3-alle", type: "vocab", front: "alle", reading: "alle", meaning: "everyone", example: { jp: "Alle barna er syke.", en: "All the children are ill." }, accept: ["all", "everybody", "all of them"], drill: { jp: "Alle kom til en kafé", en: "Everyone came to a café" }, hint: "The plural of all, covering both \"everyone\" and \"all the\". And syke shows the plural -e at work on a real adjective — syk becomes syke because barna is plural." },
      ],
    },
