...
export const NO_UNIT14 = {
  ...
  lessons: [
    // Lesson 1: yesterday, and the two regular past endings.
    {
      ...
      items: [
        { id: "no-u14l1-igar", type: "vocab", front: "i går", reading: "igar", meaning: "yesterday", example: { jp: "I går snakket jeg med Erling.", en: "Yesterday I spoke with Erling." }, accept: ["the day before"], drill: { jp: "I går spiste vi middag", en: "Yesterday we ate dinner" }, hint: "Two words, like i dag and i morgen. It is the anchor for this whole unit — i går forces the past tense, and Norwegian has no present-tense way round it. Note the order: i går is the first element, snakket is second, jeg comes behind it." },
        { id: "no-u14l1-snakket", type: "vocab", front: "snakket", reading: "snakket", meaning: "spoke", example: { jp: "Vi snakket norsk i går.", en: "We spoke Norwegian yesterday." }, accept: ["talked", "did speak", "said"], drill: { jp: "Jeg snakket norsk i går", en: "I spoke Norwegian yesterday" }, hint: "The past of å snakke, and the biggest regular class in the language: add -et to the stem and stop. Best of all, it is one form for every person — jeg snakket, du snakket, de snakket." },
        { id: "no-u14l1-jobbet", type: "vocab", front: "jobbet", reading: "jobbet", meaning: "worked", example: { jp: "Kari jobbet på sykehuset.", en: "Kari worked at the hospital." }, accept: ["did work", "had a job"], drill: { jp: "Han jobbet på et sykehus", en: "He worked at a hospital" }, hint: "The past of å jobbe, the same -et class. Rule of thumb: if the stem ends in two consonants, -et is usually the ending you want." },
        { id: "no-u14l1-spiste", type: "vocab", front: "spiste", reading: "spiste", meaning: "ate", example: { jp: "Vi spiste middag klokka sju.", en: "We ate dinner at seven o'clock." }, accept: ["did eat", "had", "ate up"], drill: { jp: "Vi spiste frokost tidlig", en: "We ate breakfast early" }, hint: "The past of å spise, and the other regular class: -te where snakket took -et. Stems ending in a single consonant usually take -te." },
        { id: "no-u14l1-kjopte", type: "vocab", front: "kjøpte", reading: "kjopte", meaning: "bought", example: { jp: "Jeg kjøpte ei ny skjorte.", en: "I bought a new shirt." }, accept: ["did buy", "purchased", "got"], drill: { jp: "Kari kjøpte et brød", en: "Kari bought a loaf" }, hint: "The past of å kjøpe, -te class. The thin kj sound is unchanged: HYUP-te." },
        { id: "no-u14l1-laerte", type: "vocab", front: "lærte", reading: "laerte", meaning: "learned", example: { jp: "I går lærte jeg mye norsk.", en: "Yesterday I learned a lot of Norwegian." }, accept: ["learnt", "did learn", "taught"], drill: { jp: "Erling lærte norsk i går", en: "Erling learned Norwegian yesterday" }, hint: "The past of å lære, -te class. Norwegian uses one verb for learning and for teaching — jeg lærte norsk, jeg lærte ham norsk — and the second is what a lærer does all day." },
      ],
    },
    // Lesson 2: the six irregular pasts an A1 learner cannot do without.
    {
      ...
      items: [
        { id: "no-u14l2-var", type: "vocab", front: "var", reading: "var", meaning: "was", example: { jp: "Været var dårlig i går.", en: "The weather was bad yesterday." }, accept: ["were", "used to be"], drill: { jp: "Jeg var syk i går", en: "I was ill yesterday" }, hint: "The past of å være — no -et, no -te, a stem of its own. One form for everyone: jeg var, du var, vi var. It is the most used past form in Norwegian by a wide margin." },
        { id: "no-u14l2-hadde", type: "vocab", front: "hadde", reading: "hadde", meaning: "had", example: { jp: "Erling hadde vondt i hodet.", en: "Erling had a headache." }, accept: ["did have", "possessed"], drill: { jp: "Vi hadde en god dag", en: "We had a good day" }, hint: "The past of å ha, said HAD-de with a clear double d. Irregular, and once again identical for every person." },
        { id: "no-u14l2-gikk", type: "vocab", front: "gikk", reading: "gikk", meaning: "went", example: { jp: "Vi gikk til torget i går.", en: "We walked to the square yesterday." }, accept: ["walked", "did go", "left"], drill: { jp: "Han gikk til butikken", en: "He went to the shop" }, hint: "The past of å gå, with the vowel replaced outright — the same trick English plays in go → went. Verbs that do this are called sterke verb, strong verbs, and you learn them one at a time." },
        { id: "no-u14l2-kom", type: "vocab", front: "kom", reading: "kom", meaning: "came", example: { jp: "Kari kom med bussen.", en: "Kari came by bus." }, accept: ["did come", "arrived"], drill: { jp: "Kari kom tilbake i går", en: "Kari came back yesterday" }, hint: "The past of å komme, and one of the gentler strong verbs — just drop the ending. Watch out: kom is also the imperative, as in Kom inn!" },
        { id: "no-u14l2-sa", type: "vocab", front: "så", reading: "sa", meaning: "saw", example: { jp: "Jeg så Erling på torget.", en: "I saw Erling in the square." }, accept: ["did see", "looked"], drill: { jp: "Jeg så en lege i går", en: "I saw a doctor yesterday" }, hint: "The past of å se, said SAW. Two things to watch. The answer key folds å to a, so it comes out as sa — which is also the past of å si, a different verb. And så has a third life as a word meaning \"then, so\"." },
        { id: "no-u14l2-ble", type: "vocab", front: "ble", reading: "ble", meaning: "became", example: { jp: "Det ble mørkt klokka fire.", en: "It got dark at four o'clock." }, accept: ["did become", "got", "stayed", "was"], drill: { jp: "Det ble kaldt i går", en: "It became cold yesterday" }, hint: "The past of å bli, said BLEH. And look at mørkt — the subject is det, which is neuter, so the adjective takes a -t. Lesson 3 turns that into a rule you can apply yourself." },
      ],
    },
    // Lesson 3: this/that/these — and the agreement rule they carry.
    {
      ...
      items: [
        { id: "no-u14l3-den", type: "vocab", front: "den", reading: "den", meaning: "that (masculine/feminine)", example: { jp: "Den bilen er ny.", en: "That car is new." }, accept: ["that", "it", "the", "that one"], drill: { jp: "Den bilen er dyr", en: "That car is expensive" }, hint: "For en and ei nouns — den bilen, den skjorta. Its neuter twin is det and its plural is de, both already familiar. The rule this lesson is built on: choose the determiner by the gender of the noun. den/denne for en and ei, det/dette for et, de/disse for plurals." },
        { id: "no-u14l3-denne", type: "vocab", front: "denne", reading: "denne", meaning: "this (masculine/feminine)", example: { jp: "Denne skjorta er stygg.", en: "This shirt is ugly." }, accept: ["this", "this one"], drill: { jp: "Denne katten er liten", en: "This cat is small" }, hint: "DEN-ne — the \"this\" to den's \"that\", and again for en and ei nouns only. Norwegian doubles up: denne skjorta, with the noun in its definite form as well as the determiner in front." },
        { id: "no-u14l3-dette", type: "vocab", front: "dette", reading: "dette", meaning: "this (neuter)", example: { jp: "Dette huset er stort.", en: "This house is big." }, accept: ["this", "this one", "this thing"], drill: { jp: "Dette rommet er lite", en: "This room is small" }, hint: "The neuter of denne: dette huset, dette året. Now look at stort — hus is an et word, so stor takes a -t. That is the first half of the whole agreement system: et word → adjective + t. et stort hus, et rødt flagg, et kaldt rom." },
        { id: "no-u14l3-disse", type: "vocab", front: "disse", reading: "disse", meaning: "these", example: { jp: "Disse husene er store.", en: "These houses are big." }, accept: ["those"], drill: { jp: "Disse elevene er unge", en: "These pupils are young" }, hint: "The plural of denne and dette together. And here is the second half: plural → adjective + e. store hus, røde flagg, kalde dager. Two endings, -t and -e, cover nearly all Norwegian adjective agreement." },
        { id: "no-u14l3-alt", type: "vocab", front: "alt", reading: "alt", meaning: "everything", example: { jp: "Jeg forstår ikke alt.", en: "I do not understand everything." }, accept: ["all", "all of it"], drill: { jp: "Jeg så alt i går", en: "I saw everything yesterday" }, hint: "The neuter of all — and in Norwegian the neuter is what does duty for \"everything\": alt er bra, all is well. Notice its -t is the very same -t the adjectives take." },
        { id: "no-u14l3-alle", type: "vocab", front: "alle", reading: "alle", meaning: "everyone", example: { jp: "Alle barna er syke.", en: "All the children are ill." }, accept: ["all", "everybody", "all of them"], drill: { jp: "Alle kom til kafeen", en: "Everyone came to the café" }, hint: "The plural of all, covering both \"everyone\" and \"all the\". And syke shows the plural -e at work on a real adjective — syk becomes syke because barna is plural." },
      ],
    },
    // Lesson 4: two complete three-form paradigms.
    {
      ...
      items: [
        { id: "no-u14l4-annen", type: "vocab", front: "annen", reading: "annen", meaning: "other (masculine/feminine)", example: { jp: "Erling har en annen bil.", en: "Erling has another car." }, accept: ["other", "another", "different", "second"], drill: { jp: "En annen bil er ny", en: "Another car is new" }, hint: "For en and ei nouns alike: en annen bil, ei annen skjorte. This is one of only two adjectives whose feminine can differ — ei anna skjorte is equally correct Bokmål, and the other is liten → lita from unit 10 — so annen is an exception to the rule this unit states, not an example of it. The difference: lita is obligatory, anna is optional. egen, below, is the regular one; between them you get a complete paradigm twice over." },
        { id: "no-u14l4-annet", type: "vocab", front: "annet", reading: "annet", meaning: "other (neuter)", example: { jp: "Dette er et annet hus.", en: "This is another house." }, accept: ["other", "another", "different", "something else"], drill: { jp: "Et annet hus er stort", en: "Another house is big" }, hint: "The neuter — the lesson-3 -t, sitting on an irregular stem: et annet hus, et annet år. noe annet is \"something else\"." },
        { id: "no-u14l4-andre", type: "vocab", front: "andre", reading: "andre", meaning: "others (plural)", example: { jp: "De andre kommer i morgen.", en: "The others are coming tomorrow." }, accept: ["others", "other", "the others", "second"], drill: { jp: "Andre elever kom i går", en: "Other pupils came yesterday" }, hint: "The plural, and thoroughly irregular — andre, not \"anne\". It doubles as \"second\": den andre dagen, the second day. So den andre can be \"the other one\" or \"the second one\", and only context decides." },
        { id: "no-u14l4-egen", type: "vocab", front: "egen", reading: "egen", meaning: "own (masculine/feminine)", example: { jp: "Jeg har min egen bil.", en: "I have my own car." }, accept: ["own", "one's own", "private"], drill: { jp: "Han har en egen bil", en: "He has his own car" }, hint: "EH-gen, for en and ei nouns. Learn it as one three-part unit — egen / eget / egne — and you have the pattern for every adjective in the language. Norwegian reaches for it much more often than English does." },
        { id: "no-u14l4-eget", type: "vocab", front: "eget", reading: "eget", meaning: "own (neuter)", example: { jp: "Erling har et eget rom.", en: "Erling has his own room." }, accept: ["own", "one's own", "private"], drill: { jp: "Hun har et eget rom", en: "She has her own room" }, hint: "The neuter: et eget rom, et eget hus. The same -t as annet and stort — once you can hear where the neuter is, you can build the form instead of memorising it." },
        { id: "no-u14l4-egne", type: "vocab", front: "egne", reading: "egne", meaning: "own (plural)", example: { jp: "De har egne rom.", en: "They have their own rooms." }, accept: ["own", "one's own", "private"], drill: { jp: "De har egne barn", en: "They have their own children" }, hint: "The plural: egne rom, egne barn. Three forms, one word — and that -e is the same plural -e you saw on store and syke. That is the whole system: nothing in the masculine and feminine, -t in the neuter, -e in the plural." },
      ],
    },
  ],
};
