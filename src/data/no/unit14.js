  ...
  lessons: [
    // Lesson 1: yesterday, and the two regular past endings.
    {
      ...
      items: [
        ...
        { id: "no-u14l1-kjopte", type: "vocab", front: "kjøpte", reading: "kjopte", meaning: "bought", example: { jp: "Jeg kjøpte ei ny skjorte.", en: "I bought a new shirt." }, accept: ["did buy", "purchased", "got"], hint: "The past of å kjøpe — the -te class, with the p hardening in front of the t. The thin kj sound is unchanged: HYUP-te." },
    ...
    // Lesson 3: this/that/these — and the agreement rule they carry.
    {
      ...
      items: [
        { id: "no-u14l3-den", type: "vocab", front: "den", reading: "den", meaning: "that", example: { jp: "Den bilen er ny.", en: "That car is new." }, accept: ["it", "the", "that one"], hint: "For en and ei nouns — den bilen, den skjorta. Its neuter twin is det and its plural is de, both already familiar. The rule this lesson is built on: choose the determiner by the gender of the noun. den/denne for en and ei, det/dette for et, de/disse for plurals." },
        { id: "no-u14l3-denne", type: "vocab", front: "denne", reading: "denne", meaning: "this", example: { jp: "Denne skjorta er stygg.", en: "This shirt is ugly." }, accept: ["this one"], hint: "DEN-ne — the \"this\" to den's \"that\", and again for en and ei nouns only. Norwegian doubles up: denne skjorta, with the noun in its definite form as well as the determiner in front." },
        { id: "no-u14l3-dette", type: "vocab", front: "dette", reading: "dette", meaning: "this", example: { jp: "Dette huset er stort.", en: "This house is big." }, accept: ["this one", "this thing"], hint: "The neuter of denne: dette huset, dette året. Now look at stort — hus is an et word, so stor takes a -t. That is the first half of the whole agreement system: et word → adjective + t. et stort hus, et rødt flagg, et kaldt vann." },
    ...
    // Lesson 4: two complete three-form paradigms.
    {
      ...
      items: [
        { id: "no-u14l4-annen", type: "vocab", front: "annen", reading: "annen", meaning: "other", example: { jp: "Erling har en annen bil.", en: "Erling has another car." }, accept: ["another", "different", "second"], hint: "The masculine and feminine form: en annen bil, ei anna skjorte. annen and egen below give you a complete adjective paradigm each — the same shape every Norwegian adjective has, just more visible because these two change more than most." },
        { id: "no-u14l4-annet", type: "vocab", front: "annet", reading: "annet", meaning: "other", example: { jp: "Dette er et annet hus.", en: "This is another house." }, accept: ["another", "different", "something else"], hint: "The neuter — the lesson-3 -t, sitting on an irregular stem: et annet hus, et annet år. noe annet is \"something else\"." },
        { id: "no-u14l4-andre", type: "vocab", front: "andre", reading: "andre", meaning: "others", example: { jp: "De andre kommer i morgen.", en: "The others are coming tomorrow." }, accept: ["other", "the others", "second"], hint: "The plural, and thoroughly irregular — andre, not \"anne\". It doubles as \"second\": den andre dagen, the second day. So den andre can be \"the other one\" or \"the second one\", and only context decides." },
        { id: "no-u14l4-egen", type: "vocab", front: "egen", reading: "egen", meaning: "own", example: { jp: "Jeg har min egen bil.", en: "I have my own car." }, accept: ["one's own", "private"], hint: "EH-gen, for en and ei nouns. Learn it as one three-part unit — egen / eget / egne — and you have the pattern for every adjective in the language. Norwegian reaches for it much more often than English does." },
        { id: "no-u14l4-eget", type: "vocab", front: "eget", reading: "eget", meaning: "own", example: { jp: "Erling har et eget rom.", en: "Erling has his own room." }, accept: ["one's own", "private"], hint: "The neuter: et eget rom, et eget hus. The same -t as annet and stort — once you can hear where the neuter is, you can build the form instead of memorising it." },
        { id: "no-u14l4-egne", type: "vocab", front: "egne", reading: "egne", meaning: "own", example: { jp: "De har egne rom.", en: "They have their own rooms." }, accept: ["one's own", "private"], hint: "The plural: egne rom, egne barn. Three forms, one word — and that -e is the same plural -e you saw on store and syke. That is the whole system: nothing in the masculine and feminine, -t in the neuter, -e in the plural." },
      ],
    },
  ],
};
