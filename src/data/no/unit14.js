  ...
  lessons: [
    ...
    // Lesson 2: the six irregular pasts an A1 learner cannot do without.
    {
      ...
      items: [
        ...
        { id: "no-u14l2-sa", type: "vocab", front: "så", reading: "sa", meaning: "saw", example: { jp: "Jeg så Erling på torget.", en: "I saw Erling in the square." }, accept: ["did see", "looked"], drill: { jp: "Jeg så en bil i går", en: "I saw a car yesterday" }, hint: "The past of å se, said SAW. Two things to watch. The answer key folds å to a, so it comes out as sa — which is also the past of å si, a different verb. And så has a third life as a word meaning \"then, so\"." },
