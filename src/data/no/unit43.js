  ...
  lessons: [
    // Lesson 1: weather that makes the news.
    {
      ...
      items: [
        ...
        { id: "no-u43l1-entorden", type: "vocab", front: "en torden", reading: "entorden", meaning: "thunder", example: { jp: "Erling hører en torden når det regner mye.", en: "Erling hears thunder when it rains a lot." }, drill: { jp: "Det kommer en torden nå", en: "Thunder is coming now" }, accept: ["thunderclap", "a thunderclap"], hint: "TOR-den. Masculine: definite tordenen. Thunder and lightning together are torden og lyn, in that order — the reverse of the English pairing." },
    ...
    // Lesson 3: what the seasons do. `is` is the mass-noun exception.
    {
      ...
      items: [
        { id: "no-u43l3-eiblomst", type: "vocab", front: "ei blomst", reading: "eiblomst", meaning: "flower", example: { jp: "Kari kjøper ei blomst fordi bestemor kommer på besøk.", en: "Kari buys a flower because grandmother is coming to visit." }, drill: { jp: "Det står ei blomst på bordet", en: "There is a flower on the table" }, accept: ["a flower", "a bloom", "a blossom"], hint: "BLOMST. Feminine: definite blomsta, plural blomster — and blomster is what you will hear far more often than the singular. A Norwegian arriving for middag brings them." },
        ...
        { id: "no-u43l3-agro", type: "vocab", front: "å gro", reading: "agro", meaning: "to grow", example: { jp: "Blomster gror når det er varmt og vått.", en: "Flowers grow when it is warm and wet." }, drill: { jp: "Blomster begynner å gro", en: "Flowers start to grow" }, accept: ["grow", "to sprout", "sprout"], hint: "GROO, present gror — a one-syllable verb, so the present is the infinitive plus -r. Of plants and of a wound healing. Å dyrke is to grow something on purpose." },
    ...
    // Lesson 4: the sun, the shadow, and the forecast.
    {
      ...
      items: [
        ...
        { id: "no-u43l4-eistjerne", type: "vocab", front: "ei stjerne", reading: "eistjerne", meaning: "star", example: { jp: "Vi ser mange stjerner når himmelen er klar.", en: "We see many stars when the sky is clear." }, drill: { jp: "Det er ei stjerne på himmelen", en: "There is a star in the sky" }, accept: ["a star"], hint: "SHÆR-ne — stj is another broad sh, so the t is not said. Feminine: definite stjerna, plural stjerner. Also a film star, exactly as in English." },
