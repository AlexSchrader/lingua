...
export const NO_UNIT43 = {
  ...
  lessons: [
    ...
    // Lesson 4: the sun, the shadow, and the forecast.
    {
      ...
      unit: 43,
      lesson: 4,
      title: "Sun and forecast",
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Talk about sun and shade — skygge, måne, å skinne — say what the forecast says, and name the climate you live in.",
      items: [
