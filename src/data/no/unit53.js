  ...
  lessons: [
    ...
    // both items' examples and drills, four times over.
    {
      ...
      items: [
        ...
        { id: "no-u53l2-itaktmed", type: "vocab", front: "i takt med", reading: "itaktmed", meaning: "in step with", example: { jp: "Lønna øker i takt med prisene i landet.", en: "Wages rise in step with prices in the country." }, drill: { jp: "Alt øker i takt med prisene", en: "Everything rises in step with the prices" }, accept: ["at the same rate as", "keeping pace with", "along with"], hint: "En takt is a beat, so this is \"to the same beat as\". It is the prose version of jo … desto: one thing moves and the other moves with it, at the same speed." },
      ],
    },
    ...
    // the one that only works with a negative.
    {
      ...
      items: [
        ...
        { id: "no-u53l3-betydelig", type: "vocab", front: "betydelig", reading: "betydelig", meaning: "considerable", example: { jp: "Forskjellen på de to prisene er betydelig.", en: "The difference between the two prices is considerable." }, drill: { jp: "Prisen er betydelig høyere i byen", en: "The price is considerably higher in the city" }, accept: ["significant", "substantial (in amount)", "considerably", "sizeable"], hint: "be-TUE-de-li — silent g, as in viktig. Neuter betydelig, plural betydelige. It works as an adverb too, with no change: betydelig høyere, betydelig bedre." },
      ],
    },
