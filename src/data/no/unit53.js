  ...
  lessons: [
    ...
    // both items' examples and drills, four times over.
    {
      ...
      items: [
        ...
        { id: "no-u53l2-stadig", type: "vocab", front: "stadig", reading: "stadig", meaning: "increasingly", example: { jp: "Det blir stadig dyrere å bo i byen.", en: "It is getting ever more expensive to live in the city." }, drill: { jp: "Prisene blir stadig høyere her", en: "The prices are getting ever higher here" }, accept: ["constantly", "ever more", "steadily", "continually"], hint: "STA-di — silent g. Two everyday uses: stadig in front of a comparative means \"ever more\" (stadig dyrere), and stadig on its own means \"constantly\" (han spør stadig)." },
    ...
    // the one that only works with a negative.
    {
      ...
      items: [
        ...
        { id: "no-u53l3-temmelig", type: "vocab", front: "temmelig", reading: "temmelig", meaning: "rather", example: { jp: "Det er temmelig kaldt ute i dag.", en: "It is rather cold outside today." }, drill: { jp: "Oppgaven er temmelig lang", en: "The assignment is rather long" }, accept: ["fairly", "pretty", "quite", "somewhat"], hint: "TEM-me-li — silent g. It sits above ganske and below veldig: temmelig kaldt is colder than ganske kaldt. Never stands alone — always in front of an adjective." },
        { id: "no-u53l3-svaert", type: "vocab", front: "svært", reading: "svaert", meaning: "very", example: { jp: "Boka er svært god, og alle bør lese den.", en: "The book is very good, and everyone should read it." }, drill: { jp: "Været er svært dårlig i dag", en: "The weather is very bad today" }, accept: ["extremely", "highly", "greatly", "really"], hint: "SVÆRT. Stronger than veldig and one step short of altfor. It is the neuter of svær, huge — so you are literally saying \"hugely\". It stays svært whatever it describes." },
        { id: "no-u53l3-noksa", type: "vocab", front: "nokså", reading: "noksa", meaning: "fairly", example: { jp: "Hun var nokså trøtt i går.", en: "She was fairly tired yesterday." }, drill: { jp: "Han er nokså sikker nå", en: "He is fairly sure now" }, accept: ["quite", "rather", "reasonably", "pretty"], hint: "NOK-saw. Nok plus så, \"enough so\" — enough of the quality to be worth mentioning, not enough to impress. It is the polite Norwegian way of saying not great: nokså bra." },
