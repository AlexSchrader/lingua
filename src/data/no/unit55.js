  ...
  lessons: [
    ...
    // the lesson on the difference between mentioning a quote and getting it right.
    {
      ...
      items: [
        ...
        { id: "no-u55l2-enreportasje", type: "vocab", front: "en reportasje", reading: "enreportasje", meaning: "a news feature", example: { jp: "Avisa har en lang reportasje om saka i dag.", en: "The newspaper has a long feature about the matter today." }, drill: { jp: "Han skriver en reportasje om byen", en: "He is writing a feature about the city" }, accept: ["a report (in the press)", "a feature story", "a news piece"], hint: "re-por-TA-sje — the -sje hisses like sj. Masculine: definite reportasjen, plural reportasjer. Longer and more worked-up than en artikkel: a journalist goes somewhere and comes back with it." },
      ],
    },
    ...
    // English equivalent — "solidarity" is too political and "togetherness" too soft.
    {
      ...
      items: [
        ...
        { id: "no-u55l3-etklasseskille", type: "vocab", front: "et klasseskille", reading: "etklasseskille", meaning: "a class divide", example: { jp: "Mange ser et klasseskille i samfunnet i dag.", en: "Many people see a class divide in society today." }, drill: { jp: "Byen har et klasseskille i dag", en: "The city has a class divide today" }, accept: ["a class division", "a social divide", "a gulf between classes"], hint: "KLAS-se-skil-le. Neuter, because the last element et skille is neuter — a compound always takes the gender of its final part. Definite klasseskillet." },
      ],
    },
