...
export const NO_UNIT55 = {
  ...
  lessons: [
    ...
    // is the whole Norwegian political story in two cards.
    {
      ...
      items: [
        { id: "no-u55l1-eimakt", type: "vocab", front: "ei makt", reading: "eimakt", meaning: "power", example: { jp: "Politikerne har ei makt de må bruke godt.", en: "The politicians have a power they must use well." }, drill: { jp: "Politikerne har ei makt her", en: "The politicians have a power here" }, accept: ["might", "authority", "a power", "force"], hint: "MAKT. Feminine: definite makta, plural makter. You will also see it written en makt / makten — Bokmål allows both and print leans on the en- form; this course writes ei because ei is what tells you the definite ends in -a. Å ha makt is to hold power, and ei stormakt is a great power." },
        ...
        { id: "no-u55l1-enrettighet", type: "vocab", front: "en rettighet", reading: "enrettighet", meaning: "right", example: { jp: "Alle har en rettighet til skole og helse.", en: "Everyone has a right to school and health care." }, drill: { jp: "Dette er en rettighet for alle", en: "This is a right for everyone" }, accept: ["an entitlement", "a legal right", "a claim"], hint: "RET-ti-het. Masculine: definite rettigheten, plural rettigheter. ⚠ Every -het noun is masculine — there is no *rettigheta, however feminine it may feel. Rett plus -ig plus -het: the state of having right on your side." },
    ...
    // the lesson on the difference between mentioning a quote and getting it right.
    {
      ...
      items: [
        { id: "no-u55l2-enhendelse", type: "vocab", front: "en hendelse", reading: "enhendelse", meaning: "event", example: { jp: "En hendelse i byen er i alle aviser i dag.", en: "An event in the city is in every newspaper today." }, drill: { jp: "En hendelse i Oslo var alvorlig", en: "An event in Oslo was serious" }, accept: ["an occurrence", "an incident", "a happening", "an episode"], hint: "HEN-del-se. Masculine: definite hendelsen, plural hendelser. ⚠ Every -else noun is masculine, exactly like every -het noun. Å hende is to happen — the same verb inside hva har hendt?" },
        ...
        { id: "no-u55l2-etoppslag", type: "vocab", front: "et oppslag", reading: "etoppslag", meaning: "news item", example: { jp: "Et oppslag i avisa handlet om skolen.", en: "A news item in the newspaper was about the school." }, drill: { jp: "Avisa har et oppslag om saka", en: "The newspaper has a story about the matter" }, accept: ["a story", "a spread", "a feature", "a notice"], hint: "OPP-slag. Neuter: definite oppslaget, plural oppslag — no ending in the plural. Opp plus slag, a strike: what is struck up on the wall. It is both a notice on a board and a big story in a paper." },
        ...
        { id: "no-u55l2-agjengi", type: "vocab", front: "å gjengi", reading: "agjengi", meaning: "to report accurately", example: { jp: "Avisa gjengir hva politikeren sa i går.", en: "The newspaper reports exactly what the politician said yesterday." }, drill: { jp: "Det er viktig å gjengi alt riktig", en: "It is important to report everything accurately" }, accept: ["reproduce", "to quote", "quote", "to render", "to repeat faithfully"], hint: "YEN-yi — both g's are y sounds. Gjen, again, plus gi, to give: to give it again exactly as it was. Present gjengir, past gjengav. To gjengi a quote is to get it right, not merely to mention it." },
      ],
    },
    ...
    // English equivalent — "solidarity" is too political and "togetherness" too soft.
    {
      ...
      items: [
        { id: "no-u55l3-etsamhold", type: "vocab", front: "et samhold", reading: "etsamhold", meaning: "togetherness", example: { jp: "Et samhold i en liten bygd er ofte sterkt.", en: "The togetherness in a small village is often strong." }, drill: { jp: "Et samhold er viktig her", en: "Togetherness is important here" }, accept: ["solidarity", "unity", "cohesion", "a sense of community"], hint: "SAM-hold. Neuter: definite samholdet, and it has no plural. Sam, together, plus hold, holding — the holding-together. Warmer than English \"unity\": Norwegians use it about a village, a team, a family." },
        ...
        { id: "no-u55l3-eigruppe", type: "vocab", front: "ei gruppe", reading: "eigruppe", meaning: "group", example: { jp: "Ei gruppe elever venter på bussen.", en: "A group of pupils is waiting for the bus." }, drill: { jp: "Ei gruppe venner reiser sammen", en: "A group of friends travel together" }, accept: ["a group", "a party", "a bunch", "a team"], hint: "GRUP-pe. Feminine: definite gruppa, plural grupper. Gruppa is what a school class calls itself when it works in fours; you will see gruppen in formal writing." },
        { id: "no-u55l3-envelferd", type: "vocab", front: "en velferd", reading: "envelferd", meaning: "welfare", example: { jp: "En velferd for alle er et viktig mål i Norge.", en: "Welfare for everyone is an important goal in Norway." }, drill: { jp: "En velferd for alle koster penger", en: "Welfare for everyone costs money" }, accept: ["wellbeing", "social security", "public welfare", "provision"], hint: "VEL-fer — the d is silent. Masculine: definite velferden, and no plural. Vel, well, plus ferd, journey: how well the journey goes. Velferdsstaten, the welfare state, is what Norwegians call the whole arrangement." },
      ],
    },
