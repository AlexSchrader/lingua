  ...
  lessons: [
    ...
    // feminine is `ei bygd` in l3, which carries the en-/ei- note.
    {
      ...
      items: [
        ...
        { id: "no-u45l2-eninnsjo", type: "vocab", front: "en innsjø", reading: "eninnsjo", meaning: "inland lake", example: { jp: "En innsjø ligger i en dal, og vi svømmer i den når det er varmt.", en: "A lake lies in a valley, and we swim in it when it is warm." }, drill: { jp: "Det ligger en innsjø i dalen", en: "There is a lake lying in the valley" }, accept: ["lake", "a lake"], hint: "INN-shur, hand-folded to eninnsjo. Masculine: definite innsjøen. Inn plus sjø: an inland sjø, welded together to say precisely the thing that plain sjø leaves ambiguous." },
      ],
    },
    ...
    // Lesson 4: finding the way. Five å-verbs, so their drills use å-frames.
    {
      ...
      items: [
        { id: "no-u45l4-avende", type: "vocab", front: "å vende", reading: "avende", meaning: "to turn (to face another way)", example: { jp: "Vi vender tilbake til byen når det blir mørkt.", en: "We turn back towards the town when it gets dark." }, drill: { jp: "Det er lett å vende tilbake", en: "It is easy to turn back" }, accept: ["to turn", "to turn around"], hint: "VEN-ne, present vender. To turn something round, or to turn in a direction. Å vende tilbake is to return. ⚠ `å svinge` would have been the natural card here; block 1 teaches it at u23." },
