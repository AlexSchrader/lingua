...
export const NO_UNIT45 = {
  ...
  lessons: [
    ...
    // Lesson 4: finding the way. Five å-verbs, so their drills use å-frames.
    {
      ...
      items: [
        { id: "no-u45l4-avende", type: "vocab", front: "å vende", reading: "avende", meaning: "to turn (to face another way)", example: { jp: "Vi vender til høyre når vi kommer til et hjørne.", en: "We turn right when we come to a corner." }, drill: { jp: "Det er lett å vende til venstre", en: "It is easy to turn left" }, accept: ["to turn", "to turn around"], hint: "VEN-ne, present vender. To turn something round, or to turn in a direction. Å vende tilbake is to return. ⚠ `å svinge` would have been the natural card here; block 1 teaches it at u23." },
