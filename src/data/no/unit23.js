  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u23l2-eiretning", type: "vocab", front: "ei retning", reading: "eiretning", meaning: "direction", example: { jp: "Vi går i en annen retning, fordi jeg leste kartet dårlig.", en: "We are going in another direction, because I read the map badly." }, accept: ["a direction", "way", "bearing"], drill: { jp: "Vi går i ei retning", en: "We are walking in one direction" }, hint: "RET-ning, from rett, straight. Feminine: definite retninga. I retning av means \"in the direction of\"." },
        ...
        { id: "no-u23l2-enomvei", type: "vocab", front: "en omvei", reading: "enomvei", meaning: "detour", example: { jp: "Vi tok en omvei fordi brua var stengt, og vi kom fram sent.", en: "We took a detour because the bridge was closed, and we arrived late." }, accept: ["a detour", "roundabout way", "diversion"], drill: { jp: "Vi tar en omvei i dag", en: "We are taking a detour today" }, hint: "OM-vei — om (around) plus vei (A1 u20). Definite omveien." },
    ...
    },
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Book a seat and get on board — å reservere, et sete, en passasjer, ei kø — and say what a ticket cost you.",
      items: [
        ...
        { id: "no-u23l3-eiko", type: "vocab", front: "ei kø", reading: "eiko", meaning: "queue", example: { jp: "Det står ei lang kø i butikken, fordi bare én person jobber i dag.", en: "There is a long queue in the shop, because only one person is working today." }, accept: ["a queue", "line", "traffic jam"], drill: { jp: "Det står ei kø her", en: "There is a queue here" }, hint: "KUR, one syllable. Feminine: definite køa. It is also what Norwegians call a traffic jam: å stå i kø." },
