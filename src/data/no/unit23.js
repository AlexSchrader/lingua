...
export const NO_UNIT23 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Describe a route and which way it goes — ei rute, ei retning, å svinge, en omvei — beyond A1's høyre and venstre.",
      items: [
        ...
        { id: "no-u23l2-eiretning", type: "vocab", front: "ei retning", reading: "eiretning", meaning: "direction", example: { jp: "Retninga er viktig, fordi vi ikke ser veien på kartet.", en: "The direction matters, because we cannot see the road on the map." }, accept: ["a direction", "way", "bearing"], drill: { jp: "Vi går i ei retning", en: "We are walking in one direction" }, hint: "RET-ning, from rett, straight. Feminine: definite retninga — and you will also meet en retning / retningen, which Bokmål allows for -ing nouns built on a verb. The course writes ei so the definite -a is predictable. I retning av means \"in the direction of\"." },
        ...
        { id: "no-u23l2-enomvei", type: "vocab", front: "en omvei", reading: "enomvei", meaning: "detour", example: { jp: "Vi må kjøre en omvei, fordi brua er stengt og veien er lang.", en: "We have to drive a detour, because the bridge is closed and the road is long." }, accept: ["a detour", "roundabout way", "diversion"], drill: { jp: "Vi tar en omvei i dag", en: "We are taking a detour today" }, hint: "OM-vei — om (around) plus vei (A1 u20). Definite omveien." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u23l3-etsete", type: "vocab", front: "et sete", reading: "etsete", meaning: "seat", example: { jp: "Dette setet er ledig, men vi må betale for det.", en: "This seat is free, but we have to pay for it." }, accept: ["a seat"], drill: { jp: "Det er et sete ledig", en: "There is a seat free" }, hint: "SEH-te, from å sitte (A1 u13). Neuter: definite setet, plural seter. En stol is a chair in a room; et sete is a place on a vehicle." },
        ...
        { id: "no-u23l3-bagasje", type: "vocab", front: "bagasje", reading: "bagasje", meaning: "luggage", example: { jp: "Bagasjen er tung, fordi jeg pakket mange klær.", en: "The luggage is heavy, because I packed a lot of clothes." }, accept: ["baggage", "the luggage"], drill: { jp: "Vi har mye bagasje i dag", en: "We have a lot of luggage today" }, hint: "ba-GA-she — sj again. A mass noun, so it is taught bare (§1b). Masculine: definite bagasjen, never *bagasja. Usually singular, the way English \"luggage\" is." },
      ],
    },
    {
      id: "no-u23l4",
      ...
      items: [
        { id: "no-u23l4-autsette", type: "vocab", front: "å utsette", reading: "autsette", meaning: "to postpone", example: { jp: "Vi må utsette turen, fordi været blir dårlig på fredag.", en: "We have to postpone the trip, because the weather is turning bad on Friday." }, accept: ["postpone", "to put off", "put off", "to delay"], drill: { jp: "Det er lett å utsette en tur", en: "It is easy to postpone a trip" }, hint: "OOT-set-te — ut plus sette. Past utsatte. Not the same as forsinket, which happens TO you." },
        ...
        { id: "no-u23l4-trafikk", type: "vocab", front: "trafikk", reading: "trafikk", meaning: "traffic", example: { jp: "Trafikken er tung tidlig, når alle skal jobbe samtidig.", en: "The traffic is heavy early, when everyone is going to work at the same time." }, accept: ["the traffic"], drill: { jp: "Det er mye trafikk i byen", en: "There is a lot of traffic in the city" }, hint: "tra-FIKK, stress on the end. A mass noun, so it is taught bare — \"en trafikk\" is not Norwegian (§1b). Masculine: definite trafikken, and that definite is the form you will nearly always hear." },
        ...
        { id: "no-u23l4-enhavn", type: "vocab", front: "en havn", reading: "enhavn", meaning: "harbour", example: { jp: "Ferja ligger i havna, og den går ikke før været blir fint.", en: "The ferry is in the harbour, and it will not leave before the weather turns fine." }, accept: ["a harbour", "port", "harbor"], drill: { jp: "En havn er nær en by", en: "A harbour is near a city" }, hint: "HAVN. Definite havna or havnen — both are standard. Bergen and Oslo are both built around one." },
