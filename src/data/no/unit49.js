  ...
  lessons: [
    ...
    // Lesson 3: how a thing is said.
    {
      ...
      items: [
        ...
        { id: "no-u49l3-arope", type: "vocab", front: "å rope", reading: "arope", meaning: "to shout", example: { jp: "Et publikum roper når noen lager et mål.", en: "An audience shouts when somebody scores a goal." }, drill: { jp: "Det er ikke fint å rope", en: "It is not nice to shout" }, accept: ["shout", "to call out", "call out", "to yell"], hint: "ROO-pe, present roper. To call out, not necessarily in anger — å rope på noen is to call somebody over. Å skrike is the one with fear or pain in it." },
