...
export const NO_UNIT44 = {
  ...
  lessons: [
    ...
    // drill uses an å-taking frame: a modal would swallow the å.
    {
      ...
      items: [
        { id: "no-u44l2-asla", type: "vocab", front: "å slå", reading: "asla", meaning: "to beat", example: { jp: "Vi slår Bergen hvis alle spiller godt.", en: "We beat Bergen if everyone plays well." }, drill: { jp: "Det er fint å slå Bergen", en: "It is nice to beat Bergen" }, accept: ["beat", "to hit", "hit", "to strike", "defeat"], hint: "SLOH, present slår — a one-syllable verb, so the present is the infinitive plus -r. To hit, and to beat an opponent. Å slå på is to switch something on, which is the sense you will meet on a machine." },
    ...
    // Lesson 4: how it ends.
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Report how it ended — runde, seier, poeng, rekord, øvelse, medalje — and name an event.",
      items: [
        { id: "no-u44l4-enrunde", type: "vocab", front: "en runde", reading: "enrunde", meaning: "round", example: { jp: "En runde er slutt, og en ny begynner snart.", en: "A round is over, and a new one starts soon." }, drill: { jp: "Vi venter på en runde til", en: "We wait for one more round" }, accept: ["a lap", "a heat", "a bout"], hint: "RUN-de. Masculine: definite runden, plural runder. A round of a competition, a lap of a bane, and a round of drinks. Built on rund, round — the same word behind rundt in unit 45. ⚠ `et resultat` would have been the natural card here; block 1 teaches it at u24 and the lower slot owns it (RUNBOOK §4)." },
