  ...
  lessons: [
    ...
    // Lesson 3: comparison, weight and speed.
    {
      ...
      items: [
        ...
        { id: "no-u10l3-tung", type: "vocab", front: "tung", reading: "tung", meaning: "heavy", example: { jp: "Skåla er tung.", en: "The bowl is heavy." }, accept: ["hard", "difficult"], hint: "TOONG, ng as in \"sing\". It also means hard going, about work or about a day: en tung dag. Note skåla — ei skål takes -a in the definite." },
    ...
    // Lesson 4: quality — nice, ugly, bad, new, clean, dirty.
    {
      ...
      items: [
        { id: "no-u10l4-fin", type: "vocab", front: "fin", reading: "fin", meaning: "nice", example: { jp: "Det er en fin dag i dag.", en: "It is a nice day today." }, accept: ["fine", "lovely", "smart", "pretty"], hint: "FEEN. The everyday compliment for a thing — en fin dag, ei fin skjorte. For a person you reach for hyggelig instead." },
