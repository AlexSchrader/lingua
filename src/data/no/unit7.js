...
export const NO_UNIT7 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "no-u7l2-enskole", type: "vocab", front: "en skole", reading: "enskole", meaning: "school", example: { jp: "Jeg jobber på en skole.", en: "I work at a school." }, accept: ["a school"], drill: { jp: "Kari går på en skole", en: "Kari goes to a school" }, hint: "SKOO-le — sk before o is a hard sk, not the sh of skje. Masculine: definite skolen. Institutions take på where English says at or in: på skolen, på sykehuset, på jobb. Buildings and streets still take i — i butikken, i ei gate." },
        ...
        { id: "no-u7l2-ettorg", type: "vocab", front: "et torg", reading: "ettorg", meaning: "square", example: { jp: "Et torg er i en by.", en: "A square is in a city." }, accept: ["a square", "market square", "marketplace"], drill: { jp: "Vi går til et torg", en: "We are walking to a square" }, hint: "TORG, both consonants sounded. The open market square at the centre of a town — where the fish and flowers are sold." },
        { id: "no-u7l2-enkino", type: "vocab", front: "en kino", reading: "enkino", meaning: "cinema", example: { jp: "En kino er hyggelig.", en: "A cinema is nice." }, accept: ["a cinema", "movie theater", "the movies"], drill: { jp: "En kino er nær ei gate", en: "A cinema is near a street" }, hint: "HYEE-no — there is that thin kj sound again, because k comes before i. Masculine: definite kinoen. Going to see a film is å gå på kino, with no article at all." },
      ],
    },
    {
      id: "no-u7l3",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u7l4-apen", type: "vocab", front: "åpen", reading: "apen", meaning: "open", example: { jp: "En butikk er åpen klokka ni.", en: "A shop is open at nine o'clock." }, accept: ["opened", "unlocked"], drill: { jp: "En kino er åpen nå", en: "A cinema is open now" }, hint: "AW-pen, with the rounded å. The verb is å åpne, to open — two å's in a row." },
        { id: "no-u7l4-stengt", type: "vocab", front: "stengt", reading: "stengt", meaning: "closed", example: { jp: "En kino er stengt nå.", en: "A cinema is closed now." }, accept: ["shut", "not open"], drill: { jp: "En butikk er stengt nå", en: "A shop is closed now" }, hint: "STENGT. The sign on the door — and on a Sunday in Norway you will see it on almost every one." },
      ],
    },
  ],
};
