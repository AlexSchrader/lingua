  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u7l1-enbat", type: "vocab", front: "en båt", reading: "enbat", meaning: "boat", example: { jp: "Det er en båt på en sjø.", en: "There is a boat on a lake." }, accept: ["a boat", "ship", "vessel"], hint: "BOAT, with the rounded å. In a country this shape, a båt is transport, not a hobby." },
        ...
        { id: "no-u7l1-pa", type: "vocab", front: "på", reading: "pa", meaning: "on", example: { jp: "Det er en kopp på et bord.", en: "There is a cup on a table." }, accept: ["at", "upon", "in"], hint: "PAW. On a surface — but Norwegian also uses it where English says \"at\" or \"in\": på skolen, på jobb, på kino." },
      ],
    },
    {
      id: "no-u7l2",
      ...
      items: [
        ...
        { id: "no-u7l2-ettorg", type: "vocab", front: "et torg", reading: "ettorg", meaning: "square", example: { jp: "Det er et torg i en by.", en: "There is a square in a city." }, accept: ["a square", "market square", "marketplace"], hint: "TORG, both consonants sounded. The open market square at the centre of a town — where the fish and flowers are sold." },
    ...
    },
    {
      ...
      items: [
        { id: "no-u7l3-hoyre", type: "vocab", front: "høyre", reading: "hoyre", meaning: "right", example: { jp: "Det er ei kirke til høyre.", en: "There is a church on the right." }, accept: ["right side", "to the right", "the right"], hint: "HOY-re, the øy diphthong from ei øy — and another hand-folded reading, hoyre. The full phrase is til høyre, \"to the right\"." },
        { id: "no-u7l3-venstre", type: "vocab", front: "venstre", reading: "venstre", meaning: "left", example: { jp: "Det er en kino til venstre.", en: "There is a cinema on the left." }, accept: ["left side", "to the left", "the left"], hint: "VEN-stre. Same shape: til venstre. Both words are also the names of two Norwegian political parties, which confuses everyone." },
        { id: "no-u7l3-naer", type: "vocab", front: "nær", reading: "naer", meaning: "near", example: { jp: "Det er en butikk nær et torg.", en: "There is a shop near a square." }, accept: ["close", "close to", "nearby"], hint: "NAIR, with the æ of unit 1. The opposite is langt — langt fra, far from." },
