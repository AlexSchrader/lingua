  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u7l2-eigate", type: "vocab", front: "ei gate", reading: "eigate", meaning: "street", example: { jp: "Vi bor i ei gate i Oslo.", en: "We live on a street in Oslo." }, accept: ["a street", "road"], drill: { jp: "Ei gate er nær et torg", en: "A street is near a square" }, hint: "GAH-te, hard g. Feminine: definite gata. Karl Johans gate is Oslo's main street — gate, not \"gaten\", in the name." },
