  ...
  lessons: [
    {
      ...
      items: [
        { id: "no-u7l1-enskole", type: "vocab", front: "en skole", reading: "enskole", meaning: "school", example: { jp: "Jeg jobber på en skole.", en: "I work at a school." }, accept: ["a school"], hint: "SKOO-le — sk before o is a hard sk, not the sh of skje. Masculine: definite skolen." },
        ...
        { id: "no-u7l1-etsykehus", type: "vocab", front: "et sykehus", reading: "etsykehus", meaning: "hospital", example: { jp: "Han jobber på et sykehus.", en: "He works at a hospital." }, accept: ["a hospital", "infirmary"], hint: "syke (sick) plus hus (house) — a sick-house. Norwegian builds long nouns by welding short ones together, and this is the pattern to expect everywhere." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u7l2-akjore", type: "vocab", front: "å kjøre", reading: "akjore", meaning: "to drive", example: { jp: "Jeg kjører bil til Bergen.", en: "I am driving to Bergen." }, accept: ["drive", "to ride", "ride", "to go by vehicle"], hint: "HYUR-re — the thin kj again, and a hand-folded reading, akjore. It covers driving AND riding: du kjører buss." },
    ...
    },
    {
      ...
      items: [
        { id: "no-u7l3-til", type: "vocab", front: "til", reading: "til", meaning: "to", example: { jp: "Jeg går til skolen.", en: "I am walking to the school." }, accept: ["towards", "until", "for"], hint: "TIL. Motion toward something. With a place name it needs nothing else: til Oslo, til Bergen." },
