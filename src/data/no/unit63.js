  ...
  lessons: [
    ...
    // Lesson 2: the moments a life story is told in — the event, the turn, the peak.
    {
      ...
      items: [
        ...
        { id: "no-u63l2-uforglemmelig", type: "vocab", front: "uforglemmelig", reading: "uforglemmelig", meaning: "unforgettable", example: { jp: "Turen til Bergen ble uforglemmelig for hele familien.", en: "The trip to Bergen was unforgettable for the whole family." }, drill: { jp: "Turen til Bergen var uforglemmelig", en: "The trip to Bergen was unforgettable" }, accept: ["one you never forget", "indelible", "memorable (never forgotten)"], hint: "u-for-GLEM-me-li — silent g at the end. U- plus glemme, to forget. Neuter uforglemmelig, plural uforglemmelige. The word you save for the two or three days that actually earn it." },
      ],
    },
    ...
    // older generation did differently.
    {
      ...
      items: [
        ...
        { id: "no-u63l4-dengang", type: "vocab", front: "den gang", reading: "dengang", meaning: "back then", example: { jp: "Den gang var alt billigere enn det er nå.", en: "Back then everything was cheaper than it is now." }, drill: { jp: "Den gang bodde vi i Bergen", en: "Back then we lived in Bergen" }, accept: ["at that time", "in those days", "then (in the past)"], hint: "Den plus gang, one occasion: \"that time\". Two words, one thing in the mouth. Put it first and V2 takes over — den gang BODDE vi, never den gang vi bodde." },
      ],
    },
  ],
};
