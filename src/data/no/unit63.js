  ...
  lessons: [
    // Lesson 1: where a life story starts — the childhood and the memories of it.
    {
      ...
      items: [
        ...
        { id: "no-u63l1-oppvekst", type: "vocab", front: "en oppvekst", reading: "enoppvekst", meaning: "an upbringing", example: { jp: "Kari forteller ofte om en oppvekst i Bergen.", en: "Kari often talks about an upbringing in Bergen." }, accept: ["upbringing", "childhood years"], drill: { jp: "Erling snakker om en oppvekst i Bergen", en: "Erling talks about an upbringing in Bergen" }, hint: "Literally \"the growing up\" — from å vokse opp, the next card. Masculine: oppveksten." },
    ...
    // Lesson 2: the moments a life story is told in — the event, the turn, the peak.
    {
      ...
      items: [
        { id: "no-u63l2-hendelse", type: "vocab", front: "en hendelse", reading: "enhendelse", meaning: "an incident", example: { jp: "Ulykken i gata var en hendelse ingen i byen glemmer.", en: "The accident in the street was an event nobody in town forgets." }, accept: ["event", "an event", "occurrence"], drill: { jp: "Dette var en hendelse i Oslo", en: "This was an event in Oslo" }, hint: "From å hende, to happen. ⚠ -else nouns are MASCULINE and have no feminine form — en hendelse, hendelsen. Never ei hendelse." },
    ...
    // older generation did differently.
    {
      ...
      items: [
        ...
        { id: "no-u63l4-bevare", type: "vocab", front: "å bevare", reading: "abevare", meaning: "to preserve", example: { jp: "Kommunen vil bevare de gamle husene i gata.", en: "The municipality wants to preserve the old houses in the street." }, accept: ["preserve", "to keep", "to conserve"], drill: { jp: "Det er viktig å bevare gamle hus", en: "It is important to preserve old houses" }, hint: "bevarer, bevarte. Keeping something as it is — bevare naturen, bevare et minne. Compare å spare (u27), which is about money and effort." },
        ...
        { id: "no-u63l4-opprinnelig", type: "vocab", front: "opprinnelig", reading: "opprinnelig", meaning: "originally", example: { jp: "Huset var opprinnelig en liten hytte ved sjøen.", en: "The house was originally a small cabin by the sea." }, accept: ["original", "at first", "to begin with"], drill: { jp: "Huset var opprinnelig en hytte", en: "The house was originally a cabin" }, hint: "Adjective and adverb in one: den opprinnelige planen, and \"originally\". Adjectives in -lig never take -t in the neuter." },
      ],
    },
  ],
};
