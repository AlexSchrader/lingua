...
export const NO_UNIT63 = {
  ...
  lessons: [
    ...
    // Lesson 2: the moments a life story is told in — the event, the turn, the peak.
    {
      ...
      items: [
        { id: "no-u63l2-hendelse", type: "vocab", front: "en hendelse", reading: "enhendelse", meaning: "an event", example: { jp: "Ulykken i gata var en hendelse ingen i byen glemmer.", en: "The accident in the street was an event nobody in town forgets." }, accept: ["event", "incident", "occurrence"], drill: { jp: "Dette var en hendelse i Oslo", en: "This was an event in Oslo" }, hint: "From å hende, to happen. ⚠ -else nouns are MASCULINE and have no feminine form — en hendelse, hendelsen. Never ei hendelse." },
