  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u84l4-asperre", type: "vocab", front: "å sperre", reading: "asperre", meaning: "to block (bar)", example: { jp: "Jeg måtte sperre telefonen med en gang.", en: "I had to block the phone straight away." }, accept: ["to bar", "to disable", "to freeze (an account)"], drill: { jp: "Det er lurt å sperre telefonen", en: "It is wise to block the phone" }, hint: "å sperre → sperrer, sperret. Du ber noen andre stenge tilgangen — banken sperrer, du ber om det." },
