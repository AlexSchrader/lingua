...
export const NO_UNIT84 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Keep a phone alive — the battery, the charger, the card that carries your number, and what to do when it is slow.",
      items: [
        ...
        { id: "no-u84l2-etsimkort", type: "vocab", front: "et simkort", reading: "etsimkort", meaning: "a SIM card", example: { jp: "Du må sette inn et simkort før telefonen virker.", en: "You have to put in a SIM card before the phone works." }, drill: { jp: "Han kjøpte et simkort i butikken", en: "He bought a SIM card in the shop" }, accept: ["a phone card", "a mobile card"], hint: "SIMM-kort. Et kort is neuter, so the compound is too: definite simkortet, plural simkort with no ending. It is the chip that carries your number — swap it and the same phone gets a new one." },
      ],
    },
    {
      id: "no-u84l3",
