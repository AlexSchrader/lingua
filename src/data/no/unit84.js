  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u84l1-aleggepa", type: "vocab", front: "å legge på", reading: "aleggepa", meaning: "to hang up (a phone)", example: { jp: "Hun la på uten å si noe.", en: "She hung up without saying anything." }, accept: ["to put the phone down", "to end the call", "to hang up", "to hang up"], drill: { jp: "Det er dumt å legge på sånn", en: "It is silly to hang up like that" }, hint: "å legge (u77) + på. Fra den tida røret ble lagt på gaffelen. Ikke å legge seg, to go to bed." },
