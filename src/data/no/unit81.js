  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u81l4-etdrivstoff", type: "vocab", front: "et drivstoff", reading: "etdrivstoff", meaning: "fuel", example: { jp: "Prisen på drivstoff har steget mye i år.", en: "The price of fuel has risen a lot this year." }, accept: ["motor fuel", "petrol or diesel"], drill: { jp: "Prisen på et drivstoff stiger", en: "The price of a fuel is rising" }, hint: "å drive + et stoff. Samlebegrepet for bensin og diesel — det ordet staten og avisene bruker."},
      ],
    },
  ],
};
