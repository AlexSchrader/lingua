  ...
  lessons: [
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Drive legally — the licence, the speed limit, the fine, the signs and the people crossing.",
      items: [
        ...
        { id: "no-u81l1-eifartsgrense", type: "vocab", front: "ei fartsgrense", reading: "eifartsgrense", meaning: "speed limit", example: { jp: "Fartsgrensa er lav her, men alle kjører fortere.", en: "The speed limit is low here, but everybody drives faster." }, accept: ["a speed restriction"], drill: { jp: "Hver vei har ei fartsgrense", en: "Every road has a speed limit" }, hint: "ei fartsgrense → fartsgrensa. En fart (u28) + ei grense (u22). Alltid i kilometer i timen." },
        { id: "no-u81l1-eibot", type: "vocab", front: "ei bot", reading: "eibot", meaning: "fine (penalty)", example: { jp: "Jeg fikk ei bot fordi jeg parkerte feil utenfor butikken.", en: "I got a fine because I parked wrongly outside the shop." }, accept: ["a penalty", "a ticket"], drill: { jp: "Jeg fikk ei bot i går", en: "I got a fine yesterday" }, hint: "ei bot → bota, flertall bøter. Merk flertallet — det bytter vokal. Å bøte betyr både to mend and to pay for." },
        { id: "no-u81l1-etskilt", type: "vocab", front: "et skilt", reading: "etskilt", meaning: "sign", example: { jp: "Skiltet sto bak et tre, så ingen så det.", en: "The sign was behind a tree, so nobody saw it." }, accept: ["a road sign", "a signpost"], drill: { jp: "Det står et skilt ved veien", en: "There is a sign by the road" }, hint: "et skilt → skiltet, flertall skilt. Både trafikkskilt og navneskiltet på døra." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u81l2-arygge", type: "vocab", front: "å rygge", reading: "arygge", meaning: "to reverse", example: { jp: "Det er vanskelig å rygge ut av denne gata.", en: "It's difficult to reverse out of this street." }, accept: ["to back up", "reverse"], drill: { jp: "Det er vanskelig å rygge her", en: "It is difficult to reverse here" }, hint: "å rygge → rygger. Fra en rygg (u11), a back: to go back-first." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u81l3-etveiarbeid", type: "vocab", front: "et veiarbeid", reading: "etveiarbeid", meaning: "roadworks", example: { jp: "Det er veiarbeid hele sommeren på denne veien.", en: "There are roadworks all summer on this road." }, accept: ["road construction", "roadwork"], drill: { jp: "Vi møtte et veiarbeid på turen", en: "We met roadworks on the trip" }, hint: "et veiarbeid → veiarbeidet. En vei (u7) + et arbeid (u18). Brukes ofte uten artikkel: det er veiarbeid." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u81l4-enavgift", type: "vocab", front: "en avgift", reading: "enavgift", meaning: "duty (levy)", example: { jp: "Det er en høy avgift på nye biler i Norge.", en: "There's a high duty on new cars in Norway." }, accept: ["a fee", "a tax", "a levy"], drill: { jp: "Det er en avgift på nye biler", en: "There is a duty on new cars" }, hint: "en avgift → avgiften. Av + å gi. En skatt (u32) tas av inntekten din; en avgift ligger på en ting." },
        ...
        { id: "no-u81l4-aavlyse", type: "vocab", front: "å avlyse", reading: "aavlyse", meaning: "to cancel (call off)", example: { jp: "De avlyste alle togene på grunn av snøen.", en: "They cancelled all the trains because of the snow." }, accept: ["to call off", "cancel"], drill: { jp: "Det er dumt å avlyse alt", en: "It is silly to cancel everything" }, hint: "å avlyse → avlyser, avlyste. Om et arrangement eller en avgang. Å si opp (u79) er om en avtale du selv har." },
      ],
    },
  ],
};
