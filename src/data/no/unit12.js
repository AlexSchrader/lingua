  ...
  lessons: [
    ...
    // Lesson 3: asking and answering.
    {
      ...
      items: [
        ...
        { id: "no-u12l3-avite", type: "vocab", front: "å vite", reading: "avite", meaning: "to know (a fact)", example: { jp: "Jeg vet ikke.", en: "I do not know." }, accept: ["know", "to know", "to know a fact"], drill: { jp: "Det er bra å vite noe", en: "It is good to know something" }, hint: "Irregular present: vet, not \"viter\". Jeg vet ikke earns its keep on day one. This is knowing a FACT — knowing a person or a place is å kjenne, from unit 1." },
      ],
    },
