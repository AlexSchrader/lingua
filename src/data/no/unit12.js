  ...
  lessons: [
    // Lesson 1: the V2 rule itself, carried by the sentence adverbs that sit around the verb.
    {
      ...
      items: [
        ...
        { id: "no-u12l1-sjelden", type: "vocab", front: "sjelden", reading: "sjelden", meaning: "seldom", example: { jp: "Det snør sjelden i Oslo.", en: "It seldom snows in Oslo." }, accept: ["rarely", "rare"], drill: { jp: "Kari jobber sjelden på søndag", en: "Kari seldom works on Sunday" }, hint: "The broad hush of sjø and skje: SHEL-den. It doubles as an adjective — en sjelden dag, a rare day." },
    ...
    // Lesson 2: joining clauses — and the subordinate-clause exception.
    {
      ...
      items: [
        ...
        { id: "no-u12l2-fordi", type: "vocab", front: "fordi", reading: "fordi", meaning: "because", example: { jp: "Jeg spiser fordi jeg er sulten.", en: "I am eating because I am hungry." }, accept: ["since", "as"], drill: { jp: "Jeg spiser fordi jeg er sulten", en: "I am eating because I am hungry" }, hint: "for-DEE, stressed on the second half. It opens a SUBORDINATE clause, and there the V2 rule is switched off: ikke and alltid move in front of the verb — fordi jeg ikke er sulten, not \"fordi jeg er ikke sulten\". This is the one big exception to the rule in lesson 1." },
        { id: "no-u12l2-hvis", type: "vocab", front: "hvis", reading: "hvis", meaning: "if", example: { jp: "Hvis det regner, kommer Erling ikke.", en: "If it rains, Erling is not coming." }, accept: ["in case", "whether"], drill: { jp: "Hvis det regner er jeg her", en: "If it rains I am here" }, hint: "Silent h, like hva and hvor: VISS. Look at the main clause — the whole hvis-clause counts as the FIRST element, so kommer comes second and Erling follows it. English says \"Erling is not coming\"; Norwegian will not." },
        { id: "no-u12l2-atro", type: "vocab", front: "å tro", reading: "atro", meaning: "to believe", example: { jp: "Jeg tror at det snør i morgen.", en: "I think it will snow tomorrow." }, accept: ["believe", "think", "to think"], drill: { jp: "Det er lett å tro", en: "It is easy to believe" }, hint: "Present tror: TROOR. This is \"think\" as an opinion or a guess — jeg tror det. Thinking hard about something is å tenke, a different verb." },
      ],
    },
    // Lesson 3: asking and answering.
    {
      ...
      items: [
        ...
        { id: "no-u12l3-asporre", type: "vocab", front: "å spørre", reading: "asporre", meaning: "to ask", example: { jp: "Jeg spør legen.", en: "I am asking the doctor." }, accept: ["ask", "to enquire", "enquire", "to inquire"], drill: { jp: "Det er viktig å spørre", en: "It is important to ask" }, hint: "Irregular: the present is spør, not \"spørrer\" — SPURR. The noun built on it is et spørsmål, a question." },
        { id: "no-u12l3-asvare", type: "vocab", front: "å svare", reading: "asvare", meaning: "to answer", example: { jp: "Erling svarer ikke.", en: "Erling is not answering." }, accept: ["answer", "to reply", "reply", "to respond"], drill: { jp: "Det er viktig å svare", en: "It is important to answer" }, hint: "Present svarer, perfectly regular. The noun is et svar. Notice where ikke goes — straight after the finite verb, every time." },
        ...
        { id: "no-u12l3-avite", type: "vocab", front: "å vite", reading: "avite", meaning: "to know (a fact)", example: { jp: "Jeg vet ikke.", en: "I do not know." }, accept: ["know", "to know", "to know a fact"], drill: { jp: "Det er bra å vite", en: "It is good to know" }, hint: "Irregular present: vet, not \"viter\". Jeg vet ikke earns its keep on day one. This is knowing a FACT — knowing a person or a place is å kjenne, from unit 1." },
      ],
    },
