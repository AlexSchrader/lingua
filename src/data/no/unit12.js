...
export const NO_UNIT12 = {
  ...
  lessons: [
    ...
    // Lesson 2: joining clauses — and the subordinate-clause exception.
    {
      ...
      items: [
        { id: "no-u12l2-men", type: "vocab", front: "men", reading: "men", meaning: "but", example: { jp: "Jeg er trøtt, men jeg er ikke syk.", en: "I am tired, but I am not ill." }, accept: ["however", "though"], hint: "MEN. It joins two main clauses and leaves both alone — the verb is still second on either side of it. og, men and eller all behave this way." },
        { id: "no-u12l2-eller", type: "vocab", front: "eller", reading: "eller", meaning: "or", example: { jp: "Er det mandag eller tirsdag?", en: "Is it Monday or Tuesday?" }, accept: ["either"], hint: "EL-ler. Like og and men, it joins equals and changes no word order. Tacked onto the end of a sentence — ...eller? — it softens the whole thing, the way English adds \"...right?\"" },
        { id: "no-u12l2-at", type: "vocab", front: "at", reading: "at", meaning: "that", example: { jp: "Jeg tror at Erling er norsk.", en: "I think that Erling is Norwegian." }, accept: ["that (conjunction)"], hint: "AT — the linking \"that\", never the question word \"what\". Norwegian keeps it where English is happy to drop it: jeg tror at han kommer. It is not the å that marks an infinitive." },
        { id: "no-u12l2-fordi", type: "vocab", front: "fordi", reading: "fordi", meaning: "because", example: { jp: "Jeg spiser fordi jeg er sulten.", en: "I am eating because I am hungry." }, accept: ["since", "as"], hint: "for-DEE, stressed on the second half. It opens a SUBORDINATE clause, and there the V2 rule is switched off: ikke and alltid move in front of the verb — fordi jeg ikke er sulten, not \"fordi jeg er ikke sulten\". This is the one big exception to the rule in lesson 1." },
        { id: "no-u12l2-hvis", type: "vocab", front: "hvis", reading: "hvis", meaning: "if", example: { jp: "Hvis det regner, kommer Erling ikke.", en: "If it rains, Erling is not coming." }, accept: ["in case", "whether"], hint: "Silent h, like hva and hvor: VISS. Look at the main clause — the whole hvis-clause counts as the FIRST element, so kommer comes second and Erling follows it. English says \"Erling is not coming\"; Norwegian will not." },
        { id: "no-u12l2-atro", type: "vocab", front: "å tro", reading: "atro", meaning: "to believe", example: { jp: "Jeg tror at det snør i morgen.", en: "I think it will snow tomorrow." }, accept: ["believe", "think", "to think"], hint: "Present tror: TROOR. This is \"think\" as an opinion or a guess — jeg tror det. Thinking hard about something is å tenke, a different verb." },
      ],
    },
    // Lesson 3: asking and answering.
    {
      ...
      items: [
        { id: "no-u12l3-hvorfor", type: "vocab", front: "hvorfor", reading: "hvorfor", meaning: "why", example: { jp: "Hvorfor er du trøtt?", en: "Why are you tired?" }, accept: ["what for", "how come"], hint: "Silent h once more: VOR-for. Built from hvor + for, \"where for\" — the same idea as the old English \"wherefore\". Its answer is fordi." },
        { id: "no-u12l3-hvilken", type: "vocab", front: "hvilken", reading: "hvilken", meaning: "which", example: { jp: "Hvilken dag er det i dag?", en: "What day is it today?" }, accept: ["what", "which one"], hint: "VIL-ken. It changes with the noun — hvilken dag, hvilket år, hvilke dager — the same three-way split you meet again in unit 14." },
        { id: "no-u12l3-asporre", type: "vocab", front: "å spørre", reading: "asporre", meaning: "to ask", example: { jp: "Jeg spør legen.", en: "I am asking the doctor." }, accept: ["ask", "to enquire", "enquire", "to inquire"], hint: "Irregular: the present is spør, not \"spørrer\" — SPURR. The noun built on it is et spørsmål, a question." },
        { id: "no-u12l3-asvare", type: "vocab", front: "å svare", reading: "asvare", meaning: "to answer", example: { jp: "Erling svarer ikke.", en: "Erling is not answering." }, accept: ["answer", "to reply", "reply", "to respond"], hint: "Present svarer, perfectly regular. The noun is et svar. Notice where ikke goes — straight after the finite verb, every time." },
        { id: "no-u12l3-asi", type: "vocab", front: "å si", reading: "asi", meaning: "to say", example: { jp: "Hva sier du?", en: "What are you saying?" }, accept: ["say", "to tell", "tell"], hint: "Present sier, said SEE-er. Hva sier du? is also how you ask someone to say that again. The past is irregular and unit 14 has it." },
        { id: "no-u12l3-avite", type: "vocab", front: "å vite", reading: "avite", meaning: "to know", example: { jp: "Jeg vet ikke.", en: "I do not know." }, accept: ["know", "to know a fact"], hint: "Irregular present: vet, not \"viter\". Jeg vet ikke earns its keep on day one. This is knowing a FACT — knowing a person or a place is å kjenne, from unit 1." },
      ],
    },
    // Lesson 4: the object pronouns block 1 left out.
    {
      ...
      items: [
        { id: "no-u12l4-ham", type: "vocab", front: "ham", reading: "ham", meaning: "him", example: { jp: "Jeg kjenner ham.", en: "I know him." }, accept: ["he"], hint: "The object form of han, exactly as meg is the object form of jeg. In everyday speech Norwegians simply say han for both — jeg kjenner han — but ham is what you will read." },
        { id: "no-u12l4-henne", type: "vocab", front: "henne", reading: "henne", meaning: "her", example: { jp: "Erling kjenner henne ikke.", en: "Erling does not know her." }, accept: ["she"], hint: "HEN-ne, the object form of hun. Notice the order: a pronoun object slips in BEFORE ikke, where a noun object stays after it — Erling kjenner henne ikke, but Erling kjenner ikke Kari." },
        { id: "no-u12l4-oss", type: "vocab", front: "oss", reading: "oss", meaning: "us", example: { jp: "Kari hjelper oss.", en: "Kari is helping us." }, accept: ["we"], hint: "OSS, the object form of vi — vi ser deg, du ser oss. It is also the reflexive for vi: vi liker oss her." },
        { id: "no-u12l4-dere", type: "vocab", front: "dere", reading: "dere", meaning: "you", example: { jp: "Hva gjør dere i kveld?", en: "What are you doing tonight?" }, accept: ["you all", "you plural", "y'all"], hint: "DEH-re — the plural \"you\" that English lost. One form for subject and object both: dere kommer, jeg ser dere. Norwegian has no polite/familiar split at all; du and dere cover everybody, including strangers and the prime minister." },
        { id: "no-u12l4-deres", type: "vocab", front: "deres", reading: "deres", meaning: "their", example: { jp: "Bilen deres er ny.", en: "Their car is new." }, accept: ["theirs", "your", "yours"], hint: "The possessive of de and of dere at once — bilen deres is \"their car\" or \"your car\", and only the situation decides. It never changes shape: bilen deres, huset deres, barna deres." },
        { id: "no-u12l4-seg", type: "vocab", front: "seg", reading: "seg", meaning: "oneself", example: { jp: "Erling liker seg i Oslo.", en: "Erling is happy in Oslo." }, accept: ["himself", "herself", "themselves", "itself"], hint: "Said SAY, rhyming with meg and deg. It is the object when the object is the same person as the subject — han ser seg, he sees himself — for han, hun, de and dere alike. Norwegian glues it onto whole verbs far more than English does: å like seg is to be happy somewhere." },
      ],
    },
  ],
};
