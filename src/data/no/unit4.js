  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u4l1-enfar", type: "vocab", front: "en far", reading: "enfar", meaning: "father", example: { jp: "Han er en god far.", en: "He is a good father." }, accept: ["a father", "dad", "a dad"], drill: { jp: "Jeg har en far i Oslo", en: "I have a father in Oslo" }, hint: "Masculine: definite faren. Same trick as mor — far alone is what you call him." },
