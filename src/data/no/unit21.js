  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u21l2-enbeskjed", type: "vocab", front: "en beskjed", reading: "enbeskjed", meaning: "message (passed on)", example: { jp: "Han ga meg en beskjed at han kommer klokka ti.", en: "He gave me a message that he is coming at ten." }, accept: ["a message", "word", "note"], drill: { jp: "Han sender en beskjed", en: "He sends a message" }, hint: "be-SHEH — the silent d again, and the skj hush from A1 unit 1. A1's ei melding is a written message; en beskjed is the information itself, often spoken." },
