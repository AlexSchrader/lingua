  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u21l1-samtidig", type: "vocab", front: "samtidig", reading: "samtidig", meaning: "at the same time", example: { jp: "Han hører på musikk samtidig som han lager middag.", en: "He listens to music at the same time as he makes dinner." }, accept: ["simultaneously", "meanwhile"], drill: { jp: "Han leser og spiser samtidig", en: "He reads and eats at the same time" }, hint: "SAM-ti-di — sam (together) plus tid (time), and the silent -ig g again. Add som to attach a clause: samtidig som." },
    ...
    },
    {
      ...
      items: [
        { id: "no-u21l2-enplan", type: "vocab", front: "en plan", reading: "enplan", meaning: "plan", example: { jp: "Vi har en plan for helga, men vi vet ikke hva været blir.", en: "We have a plan for the weekend, but we do not know what the weather will be." }, accept: ["a plan", "scheme"], drill: { jp: "Vi lager en plan sammen", en: "We make a plan together" }, hint: "PLAAN. Masculine: definite planen, plural planer. Note om here means \"whether\", not \"about\"." },
        ...
        { id: "no-u21l2-enbeskjed", type: "vocab", front: "en beskjed", reading: "enbeskjed", meaning: "message", example: { jp: "Han ga meg en beskjed at han kommer klokka ti.", en: "He gave me a message that he is coming at ten." }, accept: ["a message", "notice", "word"], drill: { jp: "Han sender en beskjed", en: "He sends a message" }, hint: "be-SHEH — the silent d again, and the skj hush from A1 unit 1. A1's ei melding is a written message; en beskjed is the information itself, often spoken." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u21l3-arekke", type: "vocab", front: "å rekke", reading: "arekke", meaning: "to make it in time", example: { jp: "Hvis vi skynder oss, rekker vi bussen som går klokka ti.", en: "If we hurry, we will catch the bus that leaves at ten o'clock." }, accept: ["to catch", "catch", "to have time for", "to manage in time"], drill: { jp: "Det er lett å rekke bussen", en: "It is easy to catch the bus" }, hint: "REK-ke. Specifically about TIME — rekke bussen is to catch it before it goes. Note the V2: hvis-clause first, so the verb rekker comes straight after it." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u21l4-afortsette", type: "vocab", front: "å fortsette", reading: "afortsette", meaning: "to continue", example: { jp: "Vi fortsetter å lese boka, men den er lang.", en: "We continue reading the book, but it is long." }, accept: ["continue", "to carry on", "carry on", "to go on"], drill: { jp: "Det er viktig å fortsette å lese", en: "It is important to continue reading" }, hint: "FORT-set-te. Takes å plus a verb: fortsette å lese. Selv om means \"even though\" and takes a full clause." },
