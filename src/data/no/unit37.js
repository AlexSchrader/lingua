  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u37l1-skulle", type: "vocab", front: "skulle", meaning: "should", reading: "skulle", example: { jp: "Jeg skulle gjerne blitt her, men jeg må dra nå.", en: "I would love to have stayed here, but I have to leave now." }, accept: ["would", "was going to"], drill: { jp: "Jeg skulle sagt det", en: "I should have said it" }, hint: "The preterite of å skulle (A1, shall). skulle gjerne = would love to; jeg skulle sagt = I should have said." },
        ...
        { id: "no-u37l1-burde", type: "vocab", front: "burde", reading: "burde", meaning: "ought to", example: { jp: "Du burde sovet mer, for du ser trøtt ut.", en: "You should have slept more, because you look tired." }, accept: ["should", "had better"], drill: { jp: "Du burde spurt læreren", en: "You should have asked the teacher" }, hint: "The preterite of å burde (A1, should). Softer than må: a piece of advice, not an order." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u37l2-mer", type: "vocab", front: "mer", reading: "mer", meaning: "more", example: { jp: "Jeg trenger mer penger enn jeg har.", en: "I need more money than I have." }, accept: ["more of"], drill: { jp: "Jeg vil ha mer kaffe", en: "I want more coffee" }, hint: "The comparative of mye (A1, much). For countables use flere (more, in number): flere bøker, more books." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u37l3-flest", type: "vocab", front: "flest", reading: "flest", meaning: "most (in number)", example: { jp: "De fleste barna liker å synge.", en: "Most of the children like to sing." }, accept: ["the most", "most people"], drill: { jp: "Han har flest bøker", en: "He has the most books" }, hint: "The superlative of mange (A1, many) — for countable things. de fleste = most people. Comparative flere." },
      ],
    },
    {
      id: "no-u37l4",
      ...
      items: [
        ...
        { id: "no-u37l4-omtrent", type: "vocab", front: "omtrent", reading: "omtrent", meaning: "about", example: { jp: "Det tar omtrent en time å gå til skolen.", en: "It takes about an hour to walk to school." }, accept: ["approximately", "roughly", "around"], drill: { jp: "Det er omtrent ti", en: "It's about ten" }, hint: "omtrent = roughly, with a number. A synonym is cirka, often written ca." },
