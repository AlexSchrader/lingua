  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u37l3-flest", type: "vocab", front: "flest", reading: "flest", meaning: "most (in number)", example: { jp: "De fleste barna liker å leke ute.", en: "Most of the children like to play outside." }, accept: ["the most", "most people"], drill: { jp: "Han har flest bøker", en: "He has the most books" }, hint: "The superlative of mange (A1, many) — for countable things. de fleste = most people. Comparative flere." },
      ],
    },
    {
      id: "no-u37l4",
