  ...
  lessons: [
    {
      ...
      items: [
        { id: "no-u37l1-ville", type: "vocab", front: "ville", reading: "ville", meaning: "would", example: { jp: "Jeg ville hatt en ny bil hvis jeg hadde penger.", en: "I would have a new car if I had money." }, accept: ["would (want to)"], drill: { jp: "Jeg ville gjort det", en: "I would do it" }, hint: "The preterite of å ville (A1, to want), used for the conditional 'would'. Add a verb: jeg ville reist, I would travel." },
        { id: "no-u37l1-skulle", type: "vocab", front: "skulle", meaning: "should have", reading: "skulle", example: { jp: "Jeg skulle gjerne blitt en time til, men jeg må dra nå.", en: "I would gladly have stayed another hour, but I have to leave now." }, accept: ["would have", "should", "was going to"], drill: { jp: "Jeg skulle sagt det", en: "I should have said it" }, hint: "The preterite of å skulle (A1, shall). skulle gjerne = would love to; jeg skulle sagt = I should have said." },
        ...
        { id: "no-u37l1-burde", type: "vocab", front: "burde", reading: "burde", meaning: "ought to", example: { jp: "Du burde sovet mer, for du er trøtt.", en: "You should have slept more, because you are tired." }, accept: ["should", "had better"], drill: { jp: "Du burde spurt læreren", en: "You should have asked the teacher" }, hint: "The preterite of å burde (A1, should). Softer than må: a piece of advice, not an order." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u37l2-verre", type: "vocab", front: "verre", reading: "verre", meaning: "worse", example: { jp: "Trafikken er verre i dag enn i går.", en: "The traffic is worse today than yesterday." }, accept: ["more badly"], drill: { jp: "Været blir verre", en: "The weather is getting worse" }, hint: "The comparative of vond / dårlig — never 'dårligere' in this sense. bad → worse. Superlative verst." },
        { id: "no-u37l2-mindre", type: "vocab", front: "mindre", reading: "mindre", meaning: "smaller", example: { jp: "Leiligheten min er mindre enn din, men den er billigere.", en: "My flat is smaller than yours, but it's cheaper." }, accept: ["less", "littler"], drill: { jp: "Denne er mindre enn den", en: "This one is smaller than that" }, hint: "The comparative of liten (A1, small) and of lite (little). You met it inside med mindre, 'unless' (u29)." },
        { id: "no-u37l2-mer", type: "vocab", front: "mer", reading: "mer", meaning: "more", example: { jp: "Jeg trenger mer tid enn deg for å bli ferdig.", en: "I need more time than you to finish." }, accept: ["more of"], drill: { jp: "Jeg vil ha mer kaffe", en: "I want more coffee" }, hint: "The comparative of mye (A1, much). For countables use flere (more, in number): flere bøker, more books." },
    ...
    },
    {
      ...
      items: [
        { id: "no-u37l3-storst", type: "vocab", front: "størst", reading: "storst", meaning: "biggest", example: { jp: "Dette er den største byen i landet.", en: "This is the biggest city in the country." }, accept: ["largest"], drill: { jp: "Dette huset er størst", en: "This house is biggest" }, hint: "The superlative of stor. With 'the', it takes -e and an article: den største byen, the biggest city." },
        { id: "no-u37l3-best", type: "vocab", front: "best", reading: "best", meaning: "best", example: { jp: "Han er den beste læreren jeg har hatt.", en: "He is the best teacher I've had." }, accept: ["the best"], drill: { jp: "Denne boka er best", en: "This book is best" }, hint: "The superlative of god — never 'godest'. good → better → best, exactly like English." },
        { id: "no-u37l3-verst", type: "vocab", front: "verst", reading: "verst", meaning: "worst", example: { jp: "Mandag er den verste dagen i uka for meg.", en: "Monday is the worst day of the week for me." }, accept: ["the worst"], drill: { jp: "Den dagen var verst", en: "That day was worst" }, hint: "The superlative of vond / dårlig. bad → worse → worst: verre, verst." },
        { id: "no-u37l3-minst", type: "vocab", front: "minst", reading: "minst", meaning: "smallest", example: { jp: "Hun er den minste i familien, men også den raskeste.", en: "She is the smallest in the family, but also the fastest." }, accept: ["least", "at least"], drill: { jp: "Dette rommet er minst", en: "This room is smallest" }, hint: "The superlative of liten. Also 'at least': minst ti stykker, at least ten." },
        ...
        { id: "no-u37l3-flest", type: "vocab", front: "flest", reading: "flest", meaning: "most (in number)", example: { jp: "De fleste barna liker å være ute.", en: "Most of the children like being outside." }, accept: ["the most", "most people"], drill: { jp: "Han har flest bøker", en: "He has the most books" }, hint: "The superlative of mange (A1, many) — for countable things. de fleste = most people. Comparative flere." },
      ],
    },
    {
      id: "no-u37l4",
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Grade a statement — altfor, ganske, nesten, omtrent, i hvert fall, særlig.",
      items: [
        ...
        { id: "no-u37l4-nesten", type: "vocab", front: "nesten", reading: "nesten", meaning: "almost", example: { jp: "Jeg er nesten klar, så vent litt til.", en: "I'm almost ready, so wait a little longer." }, accept: ["nearly", "practically"], drill: { jp: "Klokka er nesten fem", en: "It's almost five o'clock" }, hint: "nesten = almost. nesten aldri, almost never; nesten alltid, almost always." },
        { id: "no-u37l4-omtrent", type: "vocab", front: "omtrent", reading: "omtrent", meaning: "about", example: { jp: "Det tar omtrent en time å gå hjem.", en: "It takes about an hour to walk home." }, accept: ["approximately", "roughly", "around"], drill: { jp: "Det er omtrent ti", en: "It's about ten" }, hint: "omtrent = roughly, with a number. A synonym is cirka, often written ca." },
        ...
        { id: "no-u37l4-saerlig", type: "vocab", front: "særlig", reading: "saerlig", meaning: "particularly", example: { jp: "Han er ikke særlig glad i fisk, men han spiser det.", en: "He is not particularly fond of fish, but he eats it." }, accept: ["especially", "very (in a negative)"], drill: { jp: "Det er ikke særlig dyrt", en: "It is not particularly expensive" }, hint: "SÆR-li — æ written ae in the reading. You meet it most after a negative: ikke særlig = not very. On its own it means especially." },
      ],
    },
  ],
};
