  ...
  lessons: [
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Talk about the two big holidays — when they are, what happens, and what you call the day itself.",
      items: [
        ...
        { id: "no-u86l1-afeire", type: "vocab", front: "å feire", reading: "afeire", meaning: "to celebrate", example: { jp: "Vi feirer alltid med hele familien hos moren min.", en: "We always celebrate with the whole family at my mother's." }, accept: ["celebrate", "to mark"], drill: { jp: "Det er fint å feire sammen", en: "It is nice to celebrate together" }, hint: "å feire → feirer, feiret. Ei feiring er substantivet. Å feire noen = to celebrate somebody." },
        { id: "no-u86l1-entradisjon", type: "vocab", front: "en tradisjon", reading: "entradisjon", meaning: "tradition", example: { jp: "Det er en gammel tradisjon i familien hans.", en: "It's an old tradition in his family." }, accept: ["a custom", "a convention"], drill: { jp: "Dette er en tradisjon i familien", en: "This is a tradition in the family" }, hint: "en tradisjon → tradisjonen, flertall tradisjoner. Uttales -sjon som i stasjon. En skikk (u50) er nærmere 'a custom'." },
      ],
    },
    {
      id: "no-u86l2",
    ...
    },
    {
      ...
      items: [
        { id: "no-u86l3-etbryllup", type: "vocab", front: "et bryllup", reading: "etbryllup", meaning: "wedding", example: { jp: "Vi er invitert i et bryllup på lørdag i Bergen.", en: "We're invited to a wedding on Saturday in Bergen." }, accept: ["a marriage ceremony"], drill: { jp: "Vi er invitert i et bryllup", en: "We are invited to a wedding" }, hint: "et bryllup → bryllupet, flertall bryllup. NB: du er invitert I et bryllup, ikke til." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u86l4-etarrangement", type: "vocab", front: "et arrangement", reading: "etarrangement", meaning: "event", example: { jp: "Kommunen har et gratis arrangement for barn i parken.", en: "The municipality has a free event for children in the park." }, accept: ["an occasion", "a function"], drill: { jp: "Kommunen har et arrangement i parken", en: "The municipality has an event in the park" }, hint: "et arrangement → arrangementet. Stum t til slutt, som i abonnement (u79). Å arrangere er verbet." },
