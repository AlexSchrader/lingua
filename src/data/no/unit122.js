  ...
  lessons: [
    {
      ...
      items: [
        { id: "no-u122l1-aforplikteseg", type: "vocab", front: "å forplikte seg", reading: "aforplikteseg", meaning: "to commit oneself (take on a duty)", example: { jp: "De forplikter seg til tre år, og i avtalen står det at de kan gå ut etter det første.", en: "They commit themselves to three years, and the agreement says they can leave after the first." }, accept: ["to undertake", "to bind oneself"], drill: { jp: "Det er dyrt å forplikte seg for lenge", en: "It is expensive to commit oneself for too long" }, hint: "å forplikte seg → forplikter seg, forpliktet seg, har forpliktet seg. Alltid med seg og med til. Ei plikt + for. ⚠ Det TYNGSTE ordet i leksjonen: en forpliktelse (u97) kan tvinges gjennom, et løfte kan bare brytes." },
