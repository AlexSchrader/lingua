  ...
  lessons: [
    ...
    // READS on a Norwegian sign long before they ever say it.
    {
      ...
      items: [
        ...
        { id: "no-u61l1-abryte", type: "vocab", front: "å bryte", reading: "abryte", meaning: "to break (a rule)", example: { jp: "Han brøt regelen og fikk ei bot.", en: "He broke the rule and got a fine." }, drill: { jp: "Det er lett å bryte en regel", en: "It is easy to break a rule" }, accept: ["break", "to violate", "violate", "to breach", "to break", "to break"], hint: "BRUE-te. Present bryter, past brøt, perfect har brutt. ⚠ A2 taught you å avbryte, to interrupt — this is the plain verb inside it. You bryter a rule, a promise or a bone; å brekke is the one for a leg." },
