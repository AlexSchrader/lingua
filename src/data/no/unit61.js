  ...
  lessons: [
    ...
    // READS on a Norwegian sign long before they ever say it.
    {
      ...
      items: [
        ...
        { id: "no-u61l1-atillate", type: "vocab", front: "å tillate", reading: "atillate", meaning: "to allow", example: { jp: "Kommunen tillater ikke en ny butikk her.", en: "The municipality does not allow a new shop here." }, drill: { jp: "Det er lett å tillate alt", en: "It is easy to allow everything" }, accept: ["allow", "to permit", "permit", "to let"], hint: "TIL-la-te. Til plus late, to let. Present tillater, past tillot. ⚠ Ei tillatelse is the permission itself, the piece of paper. Tillatt is the participle, and it is the exact opposite of forbudt." },
        { id: "no-u61l1-abryte", type: "vocab", front: "å bryte", reading: "abryte", meaning: "to break", example: { jp: "Han brøt regelen og fikk ei bot.", en: "He broke the rule and got a fine." }, drill: { jp: "Det er lett å bryte en regel", en: "It is easy to break a rule" }, accept: ["break", "to violate", "violate", "to breach"], hint: "BRUE-te. Present bryter, past brøt, perfect har brutt. ⚠ A2 taught you å avbryte, to interrupt — this is the plain verb inside it. You bryter a rule, a promise or a bone; å brekke is the one for a leg." },
    ...
    // let off. See the header on å slippe.
    {
      ...
      items: [
        ...
        { id: "no-u61l2-atvinge", type: "vocab", front: "å tvinge", reading: "atvinge", meaning: "to force", example: { jp: "Ingen kan tvinge deg til å bli.", en: "Nobody can force you to stay." }, drill: { jp: "Det er galt å tvinge et barn", en: "It is wrong to force a child" }, accept: ["force", "to compel", "compel", "to coerce"], hint: "TVING-e. Present tvinger, past tvang, perfect har tvunget — the i → a → u ladder again, as in forsvinne and overvinne. ⚠ The frame is å tvinge noen TIL Å gjøre noe. Tvunget is the participle: jeg ble tvunget." },
    ...
    // reliably get wrong — Norwegian treats the police as ONE thing, singular.
    {
      ...
      items: [
        { id: "no-u61l3-etpoliti", type: "vocab", front: "et politi", reading: "etpoliti", meaning: "police", example: { jp: "Et politi som alle stoler på er viktig.", en: "A police force everyone trusts is important." }, drill: { jp: "Et politi må være rettferdig", en: "A police force has to be fair" }, accept: ["the police", "a police force", "law enforcement"], hint: "po-li-TI. Neuter: definite politiet, and effectively no plural. ⚠ Norwegian treats it as ONE thing, not many people: politiet KOMMER, the police IS coming. En politimann or en politibetjent is the individual officer." },
        { id: "no-u61l3-envakt", type: "vocab", front: "en vakt", reading: "envakt", meaning: "guard", example: { jp: "En vakt passer på huset hele natta.", en: "A guard watches the house all night." }, drill: { jp: "Sjefen snakker med en vakt", en: "The boss is talking to a guard" }, accept: ["a watchman", "a shift", "a watch", "a guard"], hint: "VAKT. Masculine: definite vakten, plural vakter. ⚠ Two senses: the person, and the shift they work — jeg har vakt i kveld means I'm on duty tonight. Å våke is to stay awake and watch." },
        ...
        { id: "no-u61l3-enorden", type: "vocab", front: "en orden", reading: "enorden", meaning: "tidiness", example: { jp: "En orden i huset gjør alt lettere.", en: "Tidiness in the house makes everything easier." }, drill: { jp: "En orden i huset er viktig", en: "Tidiness in the house is important" }, accept: ["orderliness", "arrangement", "order", "neatness"], hint: "OR-den. Masculine: definite ordenen, and rarely plural. ⚠ It is tidiness and proper arrangement, NOT a command — that is en ordre, with the -e. I orden! is the everyday \"all right, fine\"." },
    ...
    // a newcomer is judged on: thanking for the food, and returning a nod.
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Handle the unwritten rules — call behaviour rude, name a tradition and a social norm, thank someone properly, say when a line was crossed, and greet with a nod.",
      items: [
        ...
        { id: "no-u61l4-entradisjon", type: "vocab", front: "en tradisjon", reading: "entradisjon", meaning: "tradition", example: { jp: "En tradisjon i Norge er å gå på ski.", en: "A tradition in Norway is to go skiing." }, drill: { jp: "Dette er en tradisjon i Norge", en: "This is a tradition in Norway" }, accept: ["a custom", "a practice", "a convention", "a tradition"], hint: "tra-di-SHON — -sjon is a hush, as it always is. Masculine: definite tradisjonen, plural tradisjoner. Tradisjonell is the adjective." },
