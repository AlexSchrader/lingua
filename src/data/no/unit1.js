  ...
  lessons: [
    // Lesson 1: the three letters that come after z — æ, ø, å.
    {
      ...
      items: [
        ...
        { id: "no-u1l1-aga", type: "vocab", front: "å gå", reading: "aga", meaning: "to go", example: { jp: "Erling går.", en: "Erling is leaving." }, accept: ["go", "to walk", "walk", "to leave"], drill: { jp: "Det er viktig å gå", en: "It is important to walk" }, hint: "Two å's, both long: aw-GAW. It covers walking and leaving on foot — and it is the verb inside hvordan går det, \"how's it going\"." },
      ],
    },
    // Lesson 2: the letters you write and never say — hv-, final -d, the g in og/jeg.
    {
      ...
      items: [
        { id: "no-u1l2-hva", type: "vocab", front: "hva", reading: "hva", meaning: "what", example: { jp: "Hva er det?", en: "What is that?" }, accept: ["what?"], drill: { jp: "Hva er det", en: "What is that" }, hint: "Say VA. Every question word starting hv- drops the h — hva, hvor, hvem, hvordan all begin with a plain v sound." },
        ...
        { id: "no-u1l2-hvor", type: "vocab", front: "hvor", reading: "hvor", meaning: "where", example: { jp: "Hvor er Erling?", en: "Where is Erling?" }, accept: ["where?", "how"], drill: { jp: "Hvor er Erling", en: "Where is Erling" }, hint: "VOR — silent h again. With an adjective it means \"how\": hvor gammel, how old." },
        { id: "no-u1l2-god", type: "vocab", front: "god", reading: "god", meaning: "good", example: { jp: "Det er en god kafé.", en: "That is a good café." }, accept: ["nice", "fine"], drill: { jp: "Det er en god kafé", en: "That is a good café" }, hint: "The d is silent and the o is a long oo: GOO. A final d is silent in most short words — god, med, ved." },
        ...
        { id: "no-u1l2-jeg", type: "vocab", front: "jeg", reading: "jeg", meaning: "I", example: { jp: "Jeg lærer norsk.", en: "I am learning Norwegian." }, accept: [], drill: { jp: "Jeg lærer norsk", en: "I am learning Norwegian" }, hint: "Said YAY — the j is a y sound and the g is silent. Norwegian j is always the y of \"yes\", never the j of \"jam\"." },
      ],
    },
    // Lesson 3: the hush sounds — kj, skj, sj.
    {
      ...
      items: [
        { id: "no-u1l3-akjope", type: "vocab", front: "å kjøpe", reading: "akjope", meaning: "to buy", example: { jp: "Jeg kjøper ei skje.", en: "I am buying a spoon." }, accept: ["buy", "to purchase", "purchase"], drill: { jp: "Det er billig å kjøpe", en: "It is cheap to buy" }, hint: "kj is a thin, breathy hiss — the h of \"huge\", not \"k\". Say HYUR-pe. k before i or y does the same: kino sounds like HYEE-no." },
        { id: "no-u1l3-etkjokken", type: "vocab", front: "et kjøkken", reading: "etkjokken", meaning: "kitchen", example: { jp: "Det er et kjøkken.", en: "That is a kitchen." }, accept: ["a kitchen"], drill: { jp: "Det er et kjøkken", en: "That is a kitchen" }, hint: "HYUR-ken. Neuter, so the definite is kjøkkenet — the kitchen." },
    ...
    // Lesson 4: the g that vanishes (-ig), the -eg that says "ay", and the g that turns into j.
    {
      ...
      items: [
        { id: "no-u1l4-hyggelig", type: "vocab", front: "hyggelig", reading: "hyggelig", meaning: "nice", example: { jp: "Erling er hyggelig.", en: "Erling is nice." }, accept: ["pleasant", "friendly", "cosy", "lovely"], drill: { jp: "Erling er hyggelig", en: "Erling is nice" }, hint: "The g of -ig is silent: HUEG-ge-li. The single most Norwegian compliment there is — warm, easy, good company." },
        ...
        { id: "no-u1l4-meg", type: "vocab", front: "meg", reading: "meg", meaning: "me", example: { jp: "Erling kjenner meg.", en: "Erling knows me." }, accept: ["myself"], drill: { jp: "Erling kjenner meg", en: "Erling knows me" }, hint: "Spelled -eg, said MY. The same trick as jeg: -eg is pronounced \"ay\", never as written." },
        { id: "no-u1l4-deg", type: "vocab", front: "deg", reading: "deg", meaning: "you (object form)", example: { jp: "Jeg kjenner deg.", en: "I know you." }, accept: ["you", "yourself"], drill: { jp: "Jeg kjenner deg", en: "I know you" }, hint: "DYE, rhyming with meg. jeg/meg and du/deg — subject and object, same -eg spelling, same \"ay\" sound." },
        { id: "no-u1l4-agi", type: "vocab", front: "å gi", reading: "agi", meaning: "to give", example: { jp: "Jeg gir Erling ei skje.", en: "I give Erling a spoon." }, accept: ["give", "to hand", "hand over"], drill: { jp: "Det er hyggelig å gi", en: "It is nice to give" }, hint: "g before i or y turns into a y sound: YEE. Same in gi, gift, gynge — but hard before a, o, u and å: god is GOO." },
      ],
    },
  ],
};
