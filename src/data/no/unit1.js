  ...
  lessons: [
    ...
    // Lesson 2: the letters you write and never say — hv-, final -d, the g in og/jeg.
    {
      ...
      items: [
        ...
        { id: "no-u1l2-hvor", type: "vocab", front: "hvor", reading: "hvor", meaning: "where", example: { jp: "Hvor er Erling?", en: "Where is Erling?" }, accept: ["where?", "how"], drill: { jp: "Hvor er ei skje", en: "Where is a spoon" }, hint: "VOR — silent h again. With an adjective it means \"how\": hvor gammel, how old." },
        { id: "no-u1l2-god", type: "vocab", front: "god", reading: "god", meaning: "good", example: { jp: "Det er en god kafé.", en: "That is a good café." }, accept: ["nice", "fine"], drill: { jp: "Erling er god og hyggelig", en: "Erling is good and nice" }, hint: "The d is silent and the o is a long oo: GOO. A final d is silent in most short words — god, med, ved." },
        ...
        { id: "no-u1l2-jeg", type: "vocab", front: "jeg", reading: "jeg", meaning: "I", example: { jp: "Jeg lærer norsk.", en: "I am learning Norwegian." }, accept: [], drill: { jp: "Jeg kjenner Erling og Kari", en: "I know Erling and Kari" }, hint: "Said YAY — the j is a y sound and the g is silent. Norwegian j is always the y of \"yes\", never the j of \"jam\"." },
      ],
    },
    ...
    // Lesson 4: the g that vanishes (-ig), the -eg that says "ay", and the g that turns into j.
    {
      ...
      items: [
        { id: "no-u1l4-hyggelig", type: "vocab", front: "hyggelig", reading: "hyggelig", meaning: "nice", example: { jp: "Erling er hyggelig.", en: "Erling is nice." }, accept: ["pleasant", "friendly", "cosy", "lovely"], drill: { jp: "Det er hyggelig å lære norsk", en: "It is nice to learn Norwegian" }, hint: "The g of -ig is silent: HUEG-ge-li. The single most Norwegian compliment there is — warm, easy, good company." },
        ...
        { id: "no-u1l4-agi", type: "vocab", front: "å gi", reading: "agi", meaning: "to give", example: { jp: "Jeg gir Erling ei skje.", en: "I give Erling a spoon." }, accept: ["give", "to hand", "hand over"], drill: { jp: "Det er hyggelig å gi deg ei skje", en: "It is nice to give you a spoon" }, hint: "g before i or y turns into a y sound: YEE. Same in gi, gift, gynge — but hard before a, o, u and å: god is GOO." },
      ],
    },
  ],
};
