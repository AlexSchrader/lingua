  ...
  lessons: [
    ...
    // the fold still applies and "avaere" passes.
    {
      ...
      items: [
        ...
        { id: "no-u1l1-glypheacute", type: "glyph", front: "\u00e9", reading: "e", meaning: null, example: null, hint: "Said \"ay\". NOT one of the 29 letters \u2014 it only rides on loanwords like kaf\u00e9 and id\u00e9, marking the stressed final e.\nPhone: hold E, then tap é\nMac: Option+E, then E\nWindows: Alt+0233" },
