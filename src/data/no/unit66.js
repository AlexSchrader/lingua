  ...
  lessons: [
    ...
    // Lesson 4: the bottom line, and what happens when it goes the wrong way.
    {
      ...
      items: [
        ...
        { id: "no-u66l4-aselge", type: "vocab", front: "å selge", reading: "aselge", meaning: "to sell", example: { jp: "De måtte selge huset til slutt.", en: "They had to sell the house in the end." }, accept: ["to sell off", "to trade"], drill: { jp: "Det er ikke lett å selge et hus", en: "It is not easy to sell a house" }, hint: "å selge → selger, solgte, har solgt. ⚠ Sterkt verb: SOLGTE, ikke *selgte. Agentnavnet en selger (u18) er samme ord. Passivformen selges kommer i u70l1."},
      ],
    },
  ],
};
