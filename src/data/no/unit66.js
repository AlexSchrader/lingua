  ...
  lessons: [
    ...
    // Lesson 4: the bottom line, and what happens when it goes the wrong way.
    {
      ...
      items: [
        ...
        { id: "no-u66l4-krise", type: "vocab", front: "ei krise", reading: "eikrise", meaning: "a crisis", example: { jp: "Krisa i økonomien varte i to år.", en: "The crisis in the economy lasted two years." }, accept: ["crisis", "emergency"], drill: { jp: "Dette ble ei krise for banken", en: "This became a crisis for the bank" }, hint: "Feminine: krisa — print also writes krisen. Any bad stretch qualifies, from the national economy down to en krise på jobben." },
