  ...
  lessons: [
    // Lesson 1: shapes.
    {
      ...
      items: [
        ...
        { id: "no-u46l1-eikule", type: "vocab", front: "ei kule", reading: "eikule", meaning: "ball", example: { jp: "Ei kule er lett å kaste, og barna liker den.", en: "A ball is easy to throw, and the children like it." }, drill: { jp: "Det ligger ei kule på gulvet", en: "There is a ball lying on the floor" }, accept: ["a sphere", "a bullet", "a marble"], hint: "KUE-le. Feminine: definite kula, plural kuler. You will also see ei kule written en kule / kulen; Bokmål allows both, and this course writes ei because ei predicts the -a definite. A geometric sphere, a marble, and a bullet — all the same word. En ball from A1 unit 19 is the one you play with." },
        { id: "no-u46l1-enfirkant", type: "vocab", front: "en firkant", reading: "enfirkant", meaning: "square", example: { jp: "En firkant har fire hjørner, og et vindu har ofte en firkant.", en: "A square has four corners, and a window often has a square." }, drill: { jp: "Et vindu har en firkant", en: "A window has a square" }, accept: ["a quadrilateral", "a rectangle", "a square"], hint: "FEER-kant. Masculine: definite firkanten, plural firkanter. Fire plus kant, four-edge — Norwegian builds its geometry out of ordinary words, where English reaches for Latin." },
    ...
    // Lesson 2: materials. Six bare mass nouns; the gender lives in the hint.
    {
      ...
      items: [
        ...
        { id: "no-u46l2-gummi", type: "vocab", front: "gummi", reading: "gummi", meaning: "rubber", example: { jp: "En støvel er av gummi fordi den skal være tørr.", en: "A boot is of rubber because it has to be dry." }, drill: { jp: "En støvel av gummi er våt", en: "A boot of rubber is wet" }, accept: ["the rubber"], hint: "GUM-mi, hard g. A mass noun: no article. Masculine: definite gummien. Et gummistøvel — or more often ei gummistøvle — is the wellington every Norwegian child owns." },
    ...
    // Lesson 4: changing a thing's shape. Six å-verbs, six å-frames.
    {
      ...
      items: [
        ...
        { id: "no-u46l4-abrekke", type: "vocab", front: "å brekke", reading: "abrekke", meaning: "to break", example: { jp: "Barnet brekker en penn fordi den er tynn.", en: "The child breaks a pen because it is thin." }, drill: { jp: "Det er lett å brekke ei kule", en: "It is easy to break a ball" }, accept: ["break", "to snap", "snap", "to fracture"], hint: "BREK-ke, present brekker. Of a long thing that snaps — a bone, a stick, a board. Å knuse is what glass does instead, and Norwegian keeps the two apart." },
        { id: "no-u46l4-aklippe", type: "vocab", front: "å klippe", reading: "aklippe", meaning: "to cut", example: { jp: "Vi klipper et stoff når vi skal sy ei bluse.", en: "We cut a fabric when we are going to sew a blouse." }, drill: { jp: "Det er lett å klippe et papir", en: "It is easy to cut a piece of paper" }, accept: ["cut", "to clip", "clip", "to snip"], hint: "KLIP-pe, present klipper. Specifically with scissors, where å skjære from unit 41 is with a blade. En frisør from A1 unit 18 klipper hair." },
