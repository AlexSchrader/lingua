  ...
  lessons: [
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Measure time in something other than hours — et sekund, et minutt, et døgn, ei stund, et øyeblikk, en alder.",
      items: [
        ...
        { id: "no-u28l1-etdogn", type: "vocab", front: "et døgn", reading: "etdogn", meaning: "24 hours", example: { jp: "Et døgn er en dag og ei natt, og butikken er åpen hele døgnet.", en: "A day-and-night is a day and a night, and the shop is open around the clock." }, accept: ["a day and night", "24 hours", "a full day"], drill: { jp: "Et døgn er tjuefire timer", en: "A day-and-night is twenty-four hours" }, hint: "DOYN — ø written o in the reading. Neuter: definite døgnet, plural døgn unchanged. English has no single word for it: a day AND its night, counted together." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u28l2-engang", type: "vocab", front: "en gang", reading: "engang", meaning: "once", example: { jp: "Vi drar til Bergen en gang i året, og barna gleder seg lenge.", en: "We go to Bergen once a year, and the children look forward to it for a long time." }, accept: ["one time", "a time"], drill: { jp: "Vi trener en gang i uka", en: "We exercise once a week" }, hint: "en GANG. Masculine: definite gangen, plural ganger — to ganger, twice. `en gang` alone can also mean `once upon a time`." },
        ...
        { id: "no-u28l2-mens", type: "vocab", front: "mens", reading: "mens", meaning: "while", example: { jp: "Han jobber mens barna sover, fordi huset er rolig da.", en: "He works while the children sleep, because the house is calm then." }, accept: ["whilst", "as"], drill: { jp: "Jeg leser mens du lager mat", en: "I read while you make food" }, hint: "MENS. A subordinator, so the clause after it keeps subject before verb: mens barna SOVER. It joins A1's at, fordi, hvis, men, eller and når." },
    ...
    },
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Place an event against now — allerede, fortsatt, ennå, nettopp, endelig, plutselig.",
      items: [
        ...
        { id: "no-u28l3-enna", type: "vocab", front: "ennå", reading: "enna", meaning: "yet", example: { jp: "Vi har ikke spist ennå, men middagen er nesten ferdig.", en: "We have not eaten yet, but the dinner is almost ready." }, accept: ["still", "as yet"], drill: { jp: "Han er ikke hjemme ennå", en: "He is not home yet" }, hint: "en-NAW — å written a in the reading. It lives with a negative: ikke ... ennå. Pair it with fortsatt and you have both halves of `still`." },
        { id: "no-u28l3-nettopp", type: "vocab", front: "nettopp", reading: "nettopp", meaning: "just now", example: { jp: "Toget gikk nettopp, og det neste kommer om tjue minutter.", en: "The train just left, and the next one comes in twenty minutes." }, accept: ["just", "a moment ago", "precisely"], drill: { jp: "Legen kom nettopp inn", en: "The doctor just came in" }, hint: "NETT-opp. A very short time ago. On its own as an answer it means `exactly` — Nettopp!" },
        ...
        { id: "no-u28l3-plutselig", type: "vocab", front: "plutselig", reading: "plutselig", meaning: "suddenly", example: { jp: "Plutselig ble det mørkt, og vi fant ikke stien tilbake.", en: "Suddenly it got dark, and we did not find the path back." }, accept: ["all at once", "abruptly"], drill: { jp: "Plutselig ble det kaldt ute", en: "Suddenly it got cold outside" }, hint: "PLUT-se-lig. Also an adjective — en plutselig skade. Fronting it keeps the verb second: Plutselig BLE det mørkt." },
      ],
    },
    {
      id: "no-u28l4",
      ...
      items: [
        { id: "no-u28l4-eifortid", type: "vocab", front: "ei fortid", reading: "eifortid", meaning: "past", example: { jp: "Fortida er ikke borte, men vi kan ikke gjøre noe med den.", en: "The past is not gone, but we cannot do anything about it." }, accept: ["a past", "the past"], drill: { jp: "Ei fortid er alltid der", en: "A past is always there" }, hint: "FOR-tid — for (before) plus tid (time). Feminine: definite fortida, per §1. It is also the grammatical past tense." },
        { id: "no-u28l4-eiframtid", type: "vocab", front: "ei framtid", reading: "eiframtid", meaning: "future", example: { jp: "Framtida er lang når du er ung, sa bestemora og lo.", en: "The future is long when you are young, said grandmother and laughed." }, accept: ["a future", "the future"], drill: { jp: "Ei framtid er alltid lang", en: "A future is always long" }, hint: "FRAM-tid — fram (forward) plus tid. Feminine: definite framtida. Written fremtid in the more conservative Bokmål; both are correct." },
        { id: "no-u28l4-ettidspunkt", type: "vocab", front: "et tidspunkt", reading: "ettidspunkt", meaning: "point in time", example: { jp: "Vi må finne et tidspunkt som passer, men alle har det travelt.", en: "We have to find a time that suits, but everyone is busy." }, accept: ["a time", "a moment", "a juncture"], drill: { jp: "Et tidspunkt passer alle her", en: "One point in time suits everyone here" }, hint: "TIDS-punkt — tid plus punkt (a point), with the linking s Norwegian puts between compound halves. Neuter: definite tidspunktet." },
