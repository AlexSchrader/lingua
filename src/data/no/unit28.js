  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u28l1-eistund", type: "vocab", front: "ei stund", reading: "eistund", meaning: "a while (a stretch of time)", example: { jp: "Vi venter ei stund i hagen, fordi det er varmt og ingen har det travelt.", en: "We wait a while in the garden, because it is warm and nobody is in a hurry." }, accept: ["while", "a spell", "a moment"], drill: { jp: "Vi venter ei stund til", en: "We wait a while longer" }, hint: "STUNN, the d is silent. Feminine: definite stunda. Vaguer than any clock word — somewhere between minutes and hours." },
        ...
        { id: "no-u28l1-enalder", type: "vocab", front: "en alder", reading: "enalder", meaning: "age", example: { jp: "Alderen sier lite, men kroppen orker lite når du blir gammel.", en: "Age says little, but the body can stand little when you get old." }, accept: ["an age"], drill: { jp: "En alder er bare et tall", en: "An age is only a number" }, hint: "AL-der. Masculine: definite alderen. It is how old a person IS — for asking, A1 gives you hvor gammel er du." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u28l2-lenge", type: "vocab", front: "lenge", reading: "lenge", meaning: "for a long time", example: { jp: "Vi var lenge i kafeen og snakket sammen.", en: "We were a long time in the café and talked together." }, accept: ["a long time", "long"], drill: { jp: "Han sover lenge hver dag", en: "He sleeps a long time every day" }, hint: "LENG-e. Only about duration, never about size — that is lang. Ask with hvor lenge?, and note the comparative lenger, any longer." },
      ],
    },
    {
      id: "no-u28l3",
      ...
      items: [
        { id: "no-u28l3-allerede", type: "vocab", front: "allerede", reading: "allerede", meaning: "already", example: { jp: "Han er allerede frisk, men legen vil se ham en gang til.", en: "He is already well, but the doctor wants to see him one more time." }, accept: ["by now", "as early as"], drill: { jp: "Barna sover allerede nå", en: "The children are already asleep now" }, hint: "al-le-RE-de, four syllables. It says the thing happened EARLIER than you expected." },
        ...
        { id: "no-u28l3-plutselig", type: "vocab", front: "plutselig", reading: "plutselig", meaning: "suddenly", example: { jp: "Plutselig ble det mørkt, og vi så ikke veien tilbake.", en: "Suddenly it got dark, and we could not see the way back." }, accept: ["all at once", "abruptly"], drill: { jp: "Plutselig ble det kaldt ute", en: "Suddenly it got cold outside" }, hint: "PLUT-se-lig. Also an adjective — en plutselig skade. Fronting it keeps the verb second: Plutselig BLE det mørkt." },
