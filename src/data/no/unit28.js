  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u28l1-eistund", type: "vocab", front: "ei stund", reading: "eistund", meaning: "a while (a stretch of time)", example: { jp: "Vi satt ei stund i hagen, fordi det var varmt og ingen hadde det travelt.", en: "We sat a while in the garden, because it was warm and nobody was in a hurry." }, accept: ["while", "a spell", "a moment"], drill: { jp: "Vi venter ei stund til", en: "We wait a while longer" }, hint: "STUNN, the d is silent. Feminine: definite stunda. Vaguer than any clock word — somewhere between minutes and hours." },
