  ...
  lessons: [
    // Lesson 1: head, hand, foot, eye, ear — and the ha vondt i frame.
    {
      ...
      items: [
        ...
        { id: "no-u11l1-ethode", type: "vocab", front: "et hode", reading: "ethode", meaning: "head", example: { jp: "Hun har vondt i hodet.", en: "She has a headache." }, accept: ["a head"], hint: "Neuter: et hode → hodet, with the d silent: HOO-e. Learn ha vondt i as one piece — jeg har vondt i hodet, \"I have a pain in the head\". It is how Norwegian reports every ache there is." },
    ...
    // Lesson 2: the face and the limbs.
    {
      ...
      items: [
        ...
        { id: "no-u11l2-enmunn", type: "vocab", front: "en munn", reading: "enmunn", meaning: "mouth", example: { jp: "Barnet har noe i munnen.", en: "The child has something in its mouth." }, accept: ["a mouth"], hint: "Masculine: en munn → munnen. The double n keeps the vowel short: MOONN. Hold munn! is \"be quiet\" — literally \"hold mouth\"." },
    ...
    // Lesson 3: ill, well, sore — and the doctor.
    {
      ...
      items: [
        ...
        { id: "no-u11l3-frisk", type: "vocab", front: "frisk", reading: "frisk", meaning: "well", example: { jp: "Nå er Erling frisk.", en: "Erling is well now." }, accept: ["healthy", "fresh", "fit", "recovered"], hint: "FRISK. Of a person it means recovered or in good health; of air or water it means fresh. It is the answer to er du syk? — Nei, jeg er frisk." },
