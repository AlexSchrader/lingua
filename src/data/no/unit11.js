  ...
  lessons: [
    // Lesson 1: head, hand, foot, eye, ear — and the ha vondt i frame.
    {
      ...
      items: [
        ...
        { id: "no-u11l1-eihand", type: "vocab", front: "ei hånd", reading: "eihand", meaning: "hand", example: { jp: "Han har ei kald hånd.", en: "He has a cold hand." }, accept: ["a hand"], drill: { jp: "Kari gir meg ei hånd", en: "Kari gives me a hand" }, hint: "Feminine: ei hånd → hånda, plural hender. You will also see en hånd / hånden — Bokmål allows both, and this course writes ei so the definite -a is predictable. The d is silent: HONN." },
    ...
    // Lesson 2: the face and the limbs.
    {
      ...
      items: [
        { id: "no-u11l2-etansikt", type: "vocab", front: "et ansikt", reading: "etansikt", meaning: "face", example: { jp: "Jeg kjenner ansiktet.", en: "I recognise the face." }, accept: ["a face"], drill: { jp: "Jeg kjenner et ansikt her", en: "I recognise a face here" }, hint: "Neuter: et ansikt → ansiktet. Built from an- (\"toward\") and sikt (\"sight\") — the side of you that is turned toward other people." },
        { id: "no-u11l2-enmunn", type: "vocab", front: "en munn", reading: "enmunn", meaning: "mouth", example: { jp: "Barnet har noe i munnen.", en: "The child has something in its mouth." }, accept: ["a mouth"], drill: { jp: "En munn spiser og snakker", en: "A mouth eats and speaks" }, hint: "Masculine: en munn → munnen. The double n clips the vowel short — the tight u of gul, cut off. Hold munn! is \"be quiet\" — literally \"hold mouth\"." },
        { id: "no-u11l2-einese", type: "vocab", front: "ei nese", reading: "einese", meaning: "nose", example: { jp: "Nesa er kald.", en: "The nose is cold." }, accept: ["a nose"], drill: { jp: "Ei nese fryser når det snør", en: "A nose gets cold when it snows" }, hint: "Feminine: ei nese → nesa, plural neser. You will also see en nese / nesen; both are Bokmål." },
        ...
        { id: "no-u11l2-enarm", type: "vocab", front: "en arm", reading: "enarm", meaning: "arm", example: { jp: "Armen min er vond.", en: "My arm is sore." }, accept: ["an arm"], drill: { jp: "En arm og ei hånd hjelper meg", en: "An arm and a hand help me" }, hint: "Masculine: en arm → armen, plural armer. The same word as English, but the a is long and open: AARM." },
        { id: "no-u11l2-etbein", type: "vocab", front: "et bein", reading: "etbein", meaning: "leg", example: { jp: "Erling har lange bein.", en: "Erling has long legs." }, accept: ["a leg", "bone", "a bone"], drill: { jp: "Et bein hjelper meg å gå", en: "A leg helps me to walk" }, hint: "Neuter: et bein → beinet. The indefinite plural takes no ending at all — lange bein — which is normal for short neuter nouns. It means both the leg and the bone inside it, and is also spelled ben; both are correct." },
      ],
    },
    ...
    // Lesson 4: teeth, tiredness, sleep, help, hearing, health.
    {
      ...
      items: [
        { id: "no-u11l4-eitann", type: "vocab", front: "ei tann", reading: "eitann", meaning: "tooth", example: { jp: "Jeg har vondt i tanna.", en: "I have toothache." }, accept: ["a tooth"], drill: { jp: "Ei tann gjør vondt", en: "A tooth hurts" }, hint: "Feminine: ei tann → tanna, plural tenner — the vowel changes, like fot → føtter. A tannlege is a dentist: literally a tooth-doctor." },
