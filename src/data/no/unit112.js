...
export const NO_UNIT112 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "no-u112l4-enmalestokk", type: "vocab", front: "en målestokk", reading: "enmalestokk", meaning: "yardstick (scale)", example: { jp: "De bytter målestokk underveis, og da er ikke de to tallene mulige å sammenligne.", en: "They change the yardstick along the way, and then the two figures are not possible to compare." }, accept: ["a scale", "a benchmark"], drill: { jp: "De brukte en målestokk ingen kjente", en: "They used a yardstick nobody knew" }, hint: "en målestokk → målestokken, flertall målestokker. Å måle (u34) + en stokk. Merk å-folden: lesinga er enmalestokk. Både på kart og i overført tydning." },
