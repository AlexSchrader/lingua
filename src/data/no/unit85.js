  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u85l1-aleke", type: "vocab", front: "å leke", reading: "aleke", meaning: "to play (as children do)", example: { jp: "Ungene leker ute helt til det blir mørkt.", en: "The kids play outside right until it gets dark." }, accept: ["play", "to play about", "to play"], drill: { jp: "Det er godt å leke ute", en: "It is good to play outside" }, hint: "å leke → leker, lekte. Om barn som leker. Å spille (u19) er om et spill, en kamp eller et instrument." },
      ],
    },
    {
      id: "no-u85l2",
      ...
      items: [
        ...
        { id: "no-u85l2-etskolear", type: "vocab", front: "et skoleår", reading: "etskolear", meaning: "school year", example: { jp: "Skoleåret begynner i august hvert år.", en: "The school year starts in August every year." }, accept: ["an academic year"], drill: { jp: "Et skoleår varer i ti måneder", en: "A school year lasts ten months" }, hint: "et skoleår → skoleåret, flertall skoleår. En skole (u7) + et år (u5). August til juni, med lang sommerferie." },
        { id: "no-u85l2-enskolevei", type: "vocab", front: "en skolevei", reading: "enskolevei", meaning: "way to school", example: { jp: "Skoleveien går langs en stor vei, og det liker vi dårlig.", en: "The way to school runs along a big road, and we don't like that." }, accept: ["a school route", "the school run"], drill: { jp: "De har en skolevei som er lang", en: "They have a way to school that is long" }, hint: "en skolevei → skoleveien. En skole + en vei (u20). Trygg skolevei er et fast politisk tema i hver kommune." },
        { id: "no-u85l2-entimeplan", type: "vocab", front: "en timeplan", reading: "entimeplan", meaning: "a timetable", example: { jp: "Klassen får en timeplan før skolen begynner igjen.", en: "The class gets a timetable before school starts again." }, drill: { jp: "Læreren viser en timeplan til elevene", en: "The teacher shows a timetable to the pupils" }, accept: ["a schedule", "a class schedule", "a lesson plan (of times)"], hint: "TI-me-plan. En time plus en plan, so masculine after plan: definite timeplanen, plural timeplaner. It is the grid on the wall that says which fag comes when — a friminutt sits between two of them." },
      ],
    },
    {
      id: "no-u85l3",
      ...
      items: [
        ...
        { id: "no-u85l3-ettrinn", type: "vocab", front: "et trinn", reading: "ettrinn", meaning: "a year group", example: { jp: "Et trinn kan ha flere klasser på en stor skole.", en: "A year group can have several classes at a big school." }, drill: { jp: "Hun begynner på et trinn til høsten", en: "She is starting in a year group in the autumn" }, accept: ["a grade (school year)", "a step (in a sequence)", "a year at school"], hint: "TRINN. Neuter: definite trinnet, plural trinn with no ending. A trinn is literally a step on a stair, and Norwegian schools count them straight through: sjuende trinn is the first year of ungdomsskolen." },
      ],
    },
    {
      id: "no-u85l4",
      ...
      items: [
        ...
        { id: "no-u85l4-enmaster", type: "vocab", front: "en master", reading: "enmaster", meaning: "a master's degree", example: { jp: "Hun tar en master i historie ved universitetet i Oslo.", en: "She is doing a master's degree in history at the university in Oslo." }, drill: { jp: "Han tar en master til våren", en: "He is doing a master's degree in the spring" }, accept: ["a master's", "a postgraduate degree", "an MA"], hint: "MAS-ter. Masculine: definite masteren, plural mastere. It is two years on top of en bachelor, and Norwegians say å ta en master far more often than the full mastergrad." },
      ],
    },
  ],
};
