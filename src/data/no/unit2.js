  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u2l1-godkveld", type: "vocab", front: "god kveld", reading: "godkveld", meaning: "good evening", example: { jp: "God kveld og velkommen!", en: "Good evening and welcome!" }, accept: ["evening", "good evening!"], drill: { jp: "God kveld Erling og Kari", en: "Good evening Erling and Kari" }, hint: "kveld is the evening — the stretch after dinner. God natt is what you say when someone is actually going to bed, not on arrival." },
        { id: "no-u2l1-hadet", type: "vocab", front: "ha det", reading: "hadet", meaning: "bye", example: { jp: "Ha det, Erling!", en: "Bye, Erling!" }, accept: ["goodbye", "see you", "bye bye"], drill: { jp: "Ha det og takk", en: "Bye and thanks" }, hint: "Literally \"have it\" — short for ha det bra, \"have it good\". Say ha-DE, with det's silent t." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u2l2-bare", type: "vocab", front: "bare", reading: "bare", meaning: "only", example: { jp: "Jeg lærer bare norsk.", en: "I am only learning Norwegian." }, accept: ["just", "merely", "simply"], drill: { jp: "Jeg kjenner bare Erling", en: "I only know Erling" }, hint: "BAH-re. Also softens a request the way English \"just\" does: bare gi meg ei skje." },
        { id: "no-u2l2-takk", type: "vocab", front: "takk", reading: "takk", meaning: "thank you", example: { jp: "Takk, det er hyggelig.", en: "Thanks, that is nice." }, accept: ["thanks", "thank you!", "cheers"], drill: { jp: "Takk og ha det", en: "Thanks and bye" }, hint: "Tusen takk is \"a thousand thanks\" and is the warm version. Takk also means \"yes please\" when you are offered something." },
    ...
    },
    {
      ...
      items: [
        { id: "no-u2l3-ja", type: "vocab", front: "ja", reading: "ja", meaning: "yes", example: { jp: "Ja, jeg er norsk.", en: "Yes, I am Norwegian." }, accept: ["yeah", "yep", "yes!"], drill: { jp: "Ja vi kjenner Kari", en: "Yes we know Kari" }, hint: "YAH — j is always a y. To contradict a negative question there is a special yes, jo: \"Er du ikke norsk?\" \"Jo!\"" },
        ...
        { id: "no-u2l3-unnskyld", type: "vocab", front: "unnskyld", reading: "unnskyld", meaning: "excuse me", example: { jp: "Unnskyld, hvor er en kafé?", en: "Excuse me, where is a café?" }, accept: ["sorry", "pardon", "I'm sorry", "pardon me"], drill: { jp: "Unnskyld er du Erling", en: "Excuse me are you Erling" }, hint: "sk before y is the broad sh again: UNN-shuel. Use it to get attention and to apologise for something small." },
        { id: "no-u2l3-vaersasnill", type: "vocab", front: "vær så snill", reading: "vaersasnill", meaning: "please", example: { jp: "Vær så snill, gi meg ei skje.", en: "Please, give me a spoon." }, accept: ["please!", "be so kind"], drill: { jp: "Vær så snill Erling", en: "Please Erling" }, hint: "Literally \"be so kind\". Norwegian has no everyday word for please — most of the time politeness is carried by tone, or by takk afterwards." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u2l4-vi", type: "vocab", front: "vi", reading: "vi", meaning: "we", example: { jp: "Vi lærer norsk.", en: "We are learning Norwegian." }, accept: ["us"], drill: { jp: "Vi kjenner Kari og Erling", en: "We know Kari and Erling" }, hint: "VEE. The verb does not change for it — jeg lærer, vi lærer, de lærer. One present-tense form for every person." },
        { id: "no-u2l4-snart", type: "vocab", front: "snart", reading: "snart", meaning: "soon", example: { jp: "Snart ser vi Erling.", en: "Soon we will see Erling." }, accept: ["shortly", "in a moment", "before long"], drill: { jp: "Snart møter vi Kari", en: "Soon we are meeting Kari" }, hint: "V2 in action: snart takes slot one, so ser comes second and vi lands behind it. Never \"Snart vi ser\"." },
        ...
        { id: "no-u2l4-igjen", type: "vocab", front: "igjen", reading: "igjen", meaning: "again", example: { jp: "Vi møter Erling igjen.", en: "We are meeting Erling again." }, accept: ["once more", "left over", "remaining"], drill: { jp: "Vi ser deg snart igjen", en: "We will see you again soon" }, hint: "The g is silent and the j is a y: i-YEN. It also means \"left over\" — det er ei skje igjen, there is one spoon left." },
        { id: "no-u2l4-envenn", type: "vocab", front: "en venn", reading: "envenn", meaning: "friend", example: { jp: "Erling er en god venn.", en: "Erling is a good friend." }, accept: ["a friend", "pal", "mate"], drill: { jp: "Jeg møter en venn i Oslo", en: "I am meeting a friend in Oslo" }, hint: "Masculine, so the definite is vennen and the plural venner. Norwegians reserve venn for the real thing — an acquaintance is a kjenning." },
      ],
    },
  ],
};
