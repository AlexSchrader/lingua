...
export const NO_UNIT42 = {
  ...
  lessons: [
    ...
    // Lesson 2: what a person looks like. Base-form adjectives only.
    {
      ...
      unit: 42,
      lesson: 2,
      title: "What somebody looks like",
      cefr: "A2",
      dominantMode: "recall",
      ...
      items: [
        ...
        { id: "no-u42l2-etskjegg", type: "vocab", front: "et skjegg", reading: "etskjegg", meaning: "beard", example: { jp: "Faren min har et skjegg, men broren min har ikke det.", en: "My father has a beard, but my brother does not." }, drill: { jp: "Bestefar har et skjegg", en: "Grandfather has a beard" }, accept: ["a beard", "whiskers"], hint: "SHEGG — skj again, the broad sh. Neuter: definite skjegget — and an adjective on it takes the neuter -t with it: et langt skjegg, not *et lang skjegg." },
    ...
    // Lesson 4: what a garment is made of and what it looks like.
    {
      ...
      items: [
        ...
        { id: "no-u42l4-prikkete", type: "vocab", front: "prikkete", reading: "prikkete", meaning: "spotted", example: { jp: "Ei skjorte kan være prikkete, men jeg liker striper bedre.", en: "A shirt can be spotted, but I like stripes better." }, accept: ["dotted", "polka-dot", "speckled"], drill: { jp: "Denne blusa er prikkete", en: "This blouse is spotted" }, hint: "PRIK-ke-te. From en prikk, a dot, plus -ete — the ending that turns a noun into \"having that thing\", exactly as stripete comes from ei stripe. It does not inflect: prikkete in every gender and number. ⚠ `ei rute`, a check, would have been the natural card here, but block 1 teaches it at u23 and the lower slot owns it." },
      ],
    },
  ],
};
