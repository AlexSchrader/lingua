  ...
  lessons: [
    ...
    // the one verb here that cuts both ways depending on who the subject is.
    {
      ...
      items: [
        ...
        { id: "no-u56l1-asiopp", type: "vocab", front: "å si opp", reading: "asiopp", meaning: "to resign", example: { jp: "Han sa opp stillinga i går.", en: "He resigned from the post yesterday." }, drill: { jp: "Det er lett å si opp ei stilling", en: "It is easy to resign from a post" }, accept: ["quit", "resign", "to give notice", "to fire someone"], hint: "si OPP. ⚠ It cuts both ways and only the subject tells you which: jeg sier opp means I resign, sjefen sier meg opp means the boss fires me. Present sier opp, past sa opp. En oppsigelse is the notice itself." },
    ...
    // the three verbs that move work through it, then the order it must happen in.
    {
      ...
      items: [
        ...
        { id: "no-u56l2-autfore", type: "vocab", front: "å utføre", reading: "autfore", meaning: "to carry out", example: { jp: "Legen utfører en operasjon i morgen.", en: "The doctor is carrying out an operation tomorrow." }, drill: { jp: "Det er viktig å utføre arbeidet godt", en: "It is important to carry out the work well" }, accept: ["carry out", "to perform", "perform", "to execute"], hint: "UT-fo-re. Ut plus føre, to lead out — you take the plan out into the world. Present utfører, past utførte. You utfører a task; you gjennomfører a whole project." },
        ...
        { id: "no-u56l2-afordele", type: "vocab", front: "å fordele", reading: "afordele", meaning: "to share out", example: { jp: "Sjefen fordeler oppgavene i gruppa.", en: "The boss shares out the tasks in the group." }, drill: { jp: "Det er lett å fordele arbeidet", en: "It is easy to share out the work" }, accept: ["distribute", "to allocate", "to divide up", "allocate"], hint: "for-DE-le. For plus dele, to divide — you divide it out among people. Present fordeler, past fordelte. ⚠ Nothing to do with en fordel, an advantage, despite how alike they look." },
    ...
    // instinct an English speaker arrives with.
    {
      ...
      items: [
        { id: "no-u56l3-enkvalitet", type: "vocab", front: "en kvalitet", reading: "enkvalitet", meaning: "quality", example: { jp: "En god kvalitet koster alltid mer.", en: "Good quality always costs more." }, drill: { jp: "Denne jakka har en kvalitet vi liker", en: "This jacket has a quality we like" }, accept: ["a standard", "a grade", "a property", "quality"], hint: "kva-li-TET. Masculine: definite kvaliteten, plural kvaliteter. ⚠ Second sense, and it is common: en kvalitet is also a good trait in a person — han har mange gode kvaliteter." },
