  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u38l1-kastet", type: "vocab", front: "kastet", reading: "kastet", meaning: "threw", example: { jp: "Hun kastet ballen så langt hun kunne.", en: "She threw the ball as far as she could." }, accept: ["tossed", "thrown"], drill: { jp: "Han kastet ballen", en: "He threw the ball" }, hint: "å kaste → kastet. kaste opp also means to throw up / be sick." },
      ],
    },
    {
      id: "no-u38l2",
      ...
      items: [
        ...
        { id: "no-u38l2-horte", type: "vocab", front: "hørte", reading: "horte", meaning: "heard", example: { jp: "Vi hørte at naboen spilte musikk hele natten.", en: "We heard that the neighbour played music all night." }, accept: ["listened"], drill: { jp: "Jeg hørte en sang", en: "I heard a song" }, hint: "å høre → hørte. høre på = to listen to. ø → o in the reading." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u38l3-fikk", type: "vocab", front: "fikk", reading: "fikk", meaning: "got", example: { jp: "Jeg fikk en fin gave av mora mi.", en: "I got a nice present from my mother." }, accept: ["received"], drill: { jp: "Hun fikk et brev", en: "She got a letter" }, hint: "å få → fikk. å få is tiny but strong: få → fikk → har fått." },
        { id: "no-u38l3-fant", type: "vocab", front: "fant", reading: "fant", meaning: "found", example: { jp: "Endelig fant vi huset i den lille byen.", en: "We finally found the house in the small town." }, accept: ["discovered"], drill: { jp: "Jeg fant boka", en: "I found the book" }, hint: "å finne → fant. i → a, and the -nn- becomes -nt. Perfect har funnet." },
    ...
    },
    {
      ...
      items: [
        { id: "no-u38l4-ga", type: "vocab", front: "ga", reading: "ga", meaning: "gave", example: { jp: "Hun ga meg ei bok da jeg kom.", en: "She gave me a book when I arrived." }, accept: ["handed"], drill: { jp: "Jeg ga ham en gave", en: "I gave him a present" }, hint: "å gi → ga (also spelled gav). i → a. Perfect har gitt." },
