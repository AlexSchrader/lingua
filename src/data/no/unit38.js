  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u38l1-laget", type: "vocab", front: "laget", reading: "laget", meaning: "made", example: { jp: "Hun laget middag mens vi ryddet stua.", en: "She made dinner while we tidied the living room." }, accept: ["cooked", "prepared"], drill: { jp: "Vi laget mat sammen", en: "We made food together" }, hint: "å lage → laget. Same -et ending. Careful: et lag is a team, but the verb is unrelated." },
        ...
        { id: "no-u38l1-ventet", type: "vocab", front: "ventet", reading: "ventet", meaning: "waited", example: { jp: "Vi ventet på bussen i tjue minutter i regnet.", en: "We waited for the bus for twenty minutes in the rain." }, accept: ["expected"], drill: { jp: "Jeg ventet på deg", en: "I waited for you" }, hint: "å vente → ventet. vente på = to wait for. Also 'expected': jeg ventet det ikke." },
        { id: "no-u38l1-husket", type: "vocab", front: "husket", reading: "husket", meaning: "remembered", example: { jp: "Han husket ikke hvor han hadde lagt nøklene.", en: "He didn't remember where he had put the keys." }, accept: ["recalled"], drill: { jp: "Jeg husket navnet", en: "I remembered the name" }, hint: "å huske → husket. Nothing to do with et hus, a house, despite the look." },
        { id: "no-u38l1-kastet", type: "vocab", front: "kastet", reading: "kastet", meaning: "threw", example: { jp: "Hun kastet ballen så langt hun kunne.", en: "She threw the ball as far as she could." }, accept: ["tossed", "thrown"], drill: { jp: "Han kastet søpla", en: "He threw out the rubbish" }, hint: "å kaste → kastet. kaste opp also means to throw up / be sick." },
      ],
    },
    {
      id: "no-u38l2",
      ...
      items: [
        ...
        { id: "no-u38l2-kjorte", type: "vocab", front: "kjørte", reading: "kjorte", meaning: "drove", example: { jp: "Faren min kjørte oss til flyplassen tidlig om morgenen.", en: "My father drove us to the airport early in the morning." }, accept: ["was driving"], drill: { jp: "Jeg kjørte til jobb", en: "I drove to work" }, hint: "å kjøre → kjørte. ø becomes o in the reading: kjorte." },
        { id: "no-u38l2-horte", type: "vocab", front: "hørte", reading: "horte", meaning: "heard", example: { jp: "Vi hørte at naboen spilte musikk hele natten.", en: "We heard that the neighbour played music all night." }, accept: ["listened"], drill: { jp: "Jeg hørte en lyd", en: "I heard a sound" }, hint: "å høre → hørte. høre på = to listen to. ø → o in the reading." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u38l3-skrev", type: "vocab", front: "skrev", reading: "skrev", meaning: "wrote", example: { jp: "Hun skrev et langt brev til bestemoren sin.", en: "She wrote a long letter to her grandmother." }, accept: ["was writing"], drill: { jp: "Jeg skrev en melding", en: "I wrote a message" }, hint: "å skrive → skrev. Vowel change i → e, no ending. Perfect har skrevet." },
        ...
        { id: "no-u38l3-fikk", type: "vocab", front: "fikk", reading: "fikk", meaning: "got", example: { jp: "Jeg fikk en fin gave da jeg fylte år.", en: "I got a nice present on my birthday." }, accept: ["received"], drill: { jp: "Hun fikk et brev", en: "She got a letter" }, hint: "å få → fikk. å få is tiny but strong: få → fikk → har fått." },
        { id: "no-u38l3-fant", type: "vocab", front: "fant", reading: "fant", meaning: "found", example: { jp: "Endelig fant vi nøklene under sofaen.", en: "We finally found the keys under the sofa." }, accept: ["discovered"], drill: { jp: "Jeg fant boka", en: "I found the book" }, hint: "å finne → fant. i → a, and the -nn- becomes -nt. Perfect har funnet." },
    ...
    },
    {
      ...
      items: [
        { id: "no-u38l4-ga", type: "vocab", front: "ga", reading: "ga", meaning: "gave", example: { jp: "Hun ga meg boka si fordi jeg hadde glemt min.", en: "She gave me her book because I had forgotten mine." }, accept: ["handed"], drill: { jp: "Jeg ga ham en gave", en: "I gave him a present" }, hint: "å gi → ga (also spelled gav). i → a. Perfect har gitt." },
        { id: "no-u38l4-la", type: "vocab", front: "lå", reading: "la", meaning: "lay", example: { jp: "Katten lå i sola hele ettermiddagen.", en: "The cat lay in the sun all afternoon." }, accept: ["was lying"], drill: { jp: "Boka lå på bordet", en: "The book lay on the table" }, hint: "å ligge → lå. Careful: lå (lay) is not la, the past of å legge, to put down. Perfect har ligget." },
        ...
        { id: "no-u38l4-trodde", type: "vocab", front: "trodde", reading: "trodde", meaning: "thought", example: { jp: "Jeg trodde at toget gikk klokka ti, men jeg tok feil.", en: "I thought the train left at ten, but I was wrong." }, accept: ["believed"], drill: { jp: "Jeg trodde på deg", en: "I believed you" }, hint: "å tro → trodde, same -dde as bodde. This is 'thought' as in believed; å tenke → tenkte is 'thought' as in used one's head." },
        { id: "no-u38l4-forsto", type: "vocab", front: "forsto", reading: "forsto", meaning: "understood", example: { jp: "Hun forsto ikke hva læreren mente med spørsmålet.", en: "She didn't understand what the teacher meant by the question." }, accept: ["got it"], drill: { jp: "Jeg forsto alt", en: "I understood everything" }, hint: "å forstå → forsto (also forstod). Built on stå → sto, to stand. Perfect har forstått." },
      ],
    },
  ],
};
