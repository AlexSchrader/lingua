...
export const NO_UNIT41 = {
  ...
  lessons: [
    ...
    // in the header of u45, where `rett` also means "straight".
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Order and describe a meal — lunsj, suppe, salat, dessert, porsjon — and read a menu.",
      items: [
        ...
        { id: "no-u41l2-enporsjon", type: "vocab", front: "en porsjon", reading: "enporsjon", meaning: "portion", example: { jp: "Dette er en porsjon, og barna liker den.", en: "This is a portion, and the children like it." }, drill: { jp: "Vi lager en porsjon med kjøtt", en: "We make a portion with meat" }, accept: ["a helping", "a serving", "a portion"], hint: "por-SHOON — sj is the broad sh of sjø. Masculine: definite porsjonen, plural porsjoner. What one person gets served. ⚠ `en rett`, a dish, would have been the natural card here, but block 2 teaches it at u32 and the lower slot owns it (RUNBOOK §4)." },
