  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u78l1-amoteopp", type: "vocab", front: "å møte opp", reading: "amoteopp", meaning: "to show up (attend)", example: { jp: "Du må møte opp klokka ni, ellers får du ikke timen.", en: "You have to turn up at nine, otherwise you do not get the appointment." }, accept: ["to show up", "to attend", "to turn up", "to turn up"], drill: { jp: "Det er viktig å møte opp tidlig", en: "It is important to turn up early" }, hint: "å møte (u2) + opp. Partikkelen gjør det til 'physically be there', ikke bare 'meet'." },
