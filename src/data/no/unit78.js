  ...
  lessons: [
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Handle an appointment at a public office — who handles your case, what a decision is called, and what they need from you.",
      items: [
        ...
        { id: "no-u78l1-enveileder", type: "vocab", front: "en veileder", reading: "enveileder", meaning: "adviser (guide)", example: { jp: "Veilederen hjalp meg med å forstå hele brevet.", en: "The adviser helped me understand the whole letter." }, accept: ["a counsellor", "a supervisor"], drill: { jp: "Du kan snakke med en veileder", en: "You can talk to an adviser" }, hint: "en veileder → veilederen. En vei + å lede. Også om en student sin veileder på skolen." },
        { id: "no-u78l1-amoteopp", type: "vocab", front: "å møte opp", reading: "amoteopp", meaning: "to turn up", example: { jp: "Du må møte opp klokka ni, ellers får du ikke timen.", en: "You have to turn up at nine, otherwise you do not get the appointment." }, accept: ["to show up", "to attend"], drill: { jp: "Det er viktig å møte opp tidlig", en: "It is important to turn up early" }, hint: "å møte (u2) + opp. Partikkelen gjør det til 'physically be there', ikke bare 'meet'." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u78l2-etvedlegg", type: "vocab", front: "et vedlegg", reading: "etvedlegg", meaning: "attachment", example: { jp: "Husk å sende et vedlegg med passet ditt.", en: "Remember to send an attachment with your passport." }, accept: ["an enclosure", "an appendix"], drill: { jp: "Send et vedlegg med søknaden", en: "Send an attachment with the application" }, hint: "et vedlegg → vedlegget, flertall vedlegg. Ved + å legge (u77). Både på papir og i e-post." },
    ...
    },
    {
      ...
      items: [
        { id: "no-u78l3-eitrygd", type: "vocab", front: "ei trygd", reading: "eitrygd", meaning: "benefit (welfare)", example: { jp: "Han lever på ei trygd fordi han ikke kan jobbe mer.", en: "He lives on a benefit because he can't work any more." }, accept: ["social security", "welfare"], drill: { jp: "Han lever på ei trygd", en: "He lives on a benefit" }, hint: "ei trygd → trygda. Fra trygg, safe — the money that makes you safe. Trygdekontoret het det før NAV." },
        { id: "no-u78l3-enrettighet", type: "vocab", front: "en rettighet", reading: "enrettighet", meaning: "right (entitlement)", example: { jp: "Ferie er en rettighet her, ikke noe sjefen gir deg.", en: "Holiday is a right here, not something the boss gives you." }, accept: ["an entitlement", "a claim"], drill: { jp: "Dette er en rettighet", en: "This is a right" }, hint: "en rettighet → rettigheten. -het-ord er HANKJØNN, aldri ei (regel 1). Paret til en plikt (u32)." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u78l4-aavsla", type: "vocab", front: "å avslå", reading: "aavsla", meaning: "to reject", example: { jp: "Kommunen avslo søknaden, men vi kan klage på det.", en: "The municipality rejected the application, but we can appeal against it." }, accept: ["to refuse", "to turn down", "reject"], drill: { jp: "Det er vanskelig å avslå slike søknader", en: "It is difficult to reject such applications" }, hint: "å avslå → avslår, avslo, avslått. Av + å slå. Formelt; å si nei er det vanlige i tale." },
        ...
        { id: "no-u78l4-riktig", type: "vocab", front: "riktig", reading: "riktig", meaning: "correct", example: { jp: "Er dette det riktige skjemaet, eller tok jeg feil igjen?", en: "Is this the correct form, or did I get it wrong again?" }, accept: ["right", "proper"], drill: { jp: "Dette svaret er riktig", en: "This answer is correct" }, hint: "riktig → invariant som alle -ig-ord. Også som adverb: riktig godt, really good. En rett (u41) er noe annet — a dish." },
        { id: "no-u78l4-gal", type: "vocab", front: "gal", reading: "gal", meaning: "wrong", example: { jp: "Jeg skrev gal adresse på brevet, så det kom aldri.", en: "I wrote the wrong address on the letter, so it never arrived." }, accept: ["incorrect", "mad", "crazy"], drill: { jp: "Du står i gal kø", en: "You are standing in the wrong queue" }, hint: "gal → galt, gale. Motsatt av riktig. Om folk betyr det crazy: han er helt gal." },
      ],
    },
  ],
};
