  ...
  lessons: [
    ...
    // option, and it is a verb English has no single word for.
    {
      ...
      items: [
        ...
        { id: "no-u57l4-ethumor", type: "vocab", front: "et humør", reading: "ethumor", meaning: "spirits (humour)", example: { jp: "Han er i godt humør i dag.", en: "He is in a good mood today." }, drill: { jp: "Et humør kan skifte raskt", en: "A mood can change quickly" }, accept: ["a mood", "spirits", "temper", "frame of mind", "mood", "mood"], hint: "hu-MUR. Neuter: definite humøret, and no plural. ⚠ FALSE FRIEND — it is not \"humour\" in the funny sense; that is humor, said HU-mor. Humør is the mood you are in: i godt humør, i dårlig humør." },
