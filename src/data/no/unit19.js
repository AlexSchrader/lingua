  ...
  lessons: [
    ...
    // Lesson 2: the landscape.
    {
      ...
      items: [
        ...
        { id: "no-u19l2-eielv", type: "vocab", front: "ei elv", reading: "eielv", meaning: "river", example: { jp: "Det er ei elv i skogen.", en: "There is a river in the forest." }, accept: ["a river", "stream"], drill: { jp: "Vi svømmer i ei elv", en: "We swim in a river" }, hint: "ELV. Feminine: definite elva, plural elver. You will also see en elv / elven; Bokmål allows both and print uses the en form freely, but this course writes ei because ei predicts the -a definite. A small one is en bekk." },
