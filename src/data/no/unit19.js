...
export const NO_UNIT19 = {
  ...
  lessons: [
    ...
    // Lesson 2: the landscape.
    {
      ...
      items: [
        { id: "no-u19l2-etfjell", type: "vocab", front: "et fjell", reading: "etfjell", meaning: "mountain", example: { jp: "Det er et fjell nær Bergen.", en: "There is a mountain near Bergen." }, accept: ["a mountain", "hill", "fell"], hint: "FYELL — fj is f plus a y sound. Neuter: definite fjellet, plural fjell, unchanged. På fjellet means up in the mountains generally, and it is where a large part of Norway goes at Easter." },
        ...
        { id: "no-u19l2-eielv", type: "vocab", front: "ei elv", reading: "eielv", meaning: "river", example: { jp: "Det er ei elv i skogen.", en: "There is a river in the forest." }, accept: ["a river", "stream"], hint: "ELV. Feminine: definite elva, plural elver. You will also see en elv / elven; Bokmål allows both and print uses the en form freely, but this course writes ei because ei predicts the -a definite. A small one is en bekk." },
        { id: "no-u19l2-ettre", type: "vocab", front: "et tre", reading: "ettre", meaning: "tree", example: { jp: "Det står et tre i hagen.", en: "There is a tree standing in the garden." }, accept: ["a tree", "wood", "timber"], hint: "TREH. Neuter: definite treet, plural trær. ⚠ Spelled exactly like tre, the number three from unit 5 — two unrelated words that happen to look alike, and the article settles it every time: tre trær, three trees. It also means wood as a material." },
        { id: "no-u19l2-eistrand", type: "vocab", front: "ei strand", reading: "eistrand", meaning: "beach", example: { jp: "Det er ei strand nær en sjø.", en: "There is a beach near a lake." }, accept: ["a beach", "shore", "seaside", "coast"], hint: "STRANN — the d is silent. Feminine: definite stranda, plural strender. Beach or shore, by a lake or by the sea alike." },
    ...
    // Lesson 3: the animals in that landscape.
    {
      ...
      items: [
        ...
        { id: "no-u19l3-enfugl", type: "vocab", front: "en fugl", reading: "enfugl", meaning: "bird", example: { jp: "Det sitter en fugl i et tre.", en: "There is a bird sitting in a tree." }, accept: ["a bird"], hint: "FUEL — the g is silent. Masculine: definite fuglen, plural fugler. English \"fowl\" is the very same old word, narrowed down to the ones you eat." },
        ...
        { id: "no-u19l3-eiku", type: "vocab", front: "ei ku", reading: "eiku", meaning: "cow", example: { jp: "Ei ku gir melk.", en: "A cow gives milk." }, accept: ["a cow"], hint: "KUE, with the tight Norwegian u. Feminine: definite kua, and the plural is kuer or kyr — both current standard Bokmål, with kyr the form a dictionary lists first. Norwegian cows spend their summers loose på fjellet." },
        { id: "no-u19l3-ensau", type: "vocab", front: "en sau", reading: "ensau", meaning: "sheep", example: { jp: "Det står en sau på et fjell.", en: "There is a sheep standing on a mountain." }, accept: ["a sheep", "ewe", "ram"], hint: "SOU, rhyming with English \"how\". Masculine: definite sauen, plural sauer — Norwegian counts sheep in the ordinary way, where English cannot. Their wool is the ull of unit 15." },
