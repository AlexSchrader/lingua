...
export const NO_UNIT19 = {
  ...
  lessons: [
    ...
    // (without one it is å leke), so musikk has to be on the table before it.
    {
      ...
      items: [
        { id: "no-u19l1-musikk", type: "vocab", front: "musikk", reading: "musikk", meaning: "music", example: { jp: "Jeg hører på musikk nå.", en: "I am listening to music now." }, accept: ["the music"], drill: { jp: "Musikk er viktig", en: "Music is important" }, hint: "mu-SIKK, stress at the end. A mass noun, so the front carries no article — you cannot buy \"a music\". Masculine: definite musikken. Note å høre PÅ from unit 17: listening on purpose, not just hearing." },
        { id: "no-u19l1-ensang", type: "vocab", front: "en sang", reading: "ensang", meaning: "song", example: { jp: "Anna liker en sang på norsk.", en: "Anna likes a song in Norwegian." }, accept: ["a song", "tune", "a tune", "singing"], drill: { jp: "En sang er kort", en: "A song is short" }, hint: "SANG. Masculine: definite sangen, plural sanger. Taught right beside å synge on purpose: sang is the thing, synge is the doing, and the vowel change between them is the same one English made between song and sing." },
        { id: "no-u19l1-enfilm", type: "vocab", front: "en film", reading: "enfilm", meaning: "film", example: { jp: "Vi ser en film på kino.", en: "We are watching a film at the cinema." }, accept: ["a movie", "movie", "a film"], drill: { jp: "En film er lang", en: "A film is long" }, hint: "FILM. Masculine: definite filmen, plural filmer. Note på kino with no article at all — unit 7 flagged that phrase on en kino, and this is it doing its job." },
        { id: "no-u19l1-aspille", type: "vocab", front: "å spille", reading: "aspille", meaning: "to play", example: { jp: "Erling spiller musikk i en park.", en: "Erling is playing music in a park." }, accept: ["play", "to perform", "perform", "to act", "act"], drill: { jp: "Det er hyggelig å spille", en: "It is nice to play" }, hint: "SPIL-le, present spiller. For an instrument, a game or a role, and it wants an object — jeg spiller piano, han spiller musikk. Children playing about with no rules is å leke, a different verb entirely, so \"spiller i en park\" on its own would be the wrong one." },
        { id: "no-u19l1-asynge", type: "vocab", front: "å synge", reading: "asynge", meaning: "to sing", example: { jp: "Barna synger på skolen.", en: "The children are singing at school." }, accept: ["sing", "to chant", "chant"], drill: { jp: "Det er hyggelig å synge", en: "It is nice to sing" }, hint: "SUENG-e, present synger. The letters ng spell a SINGLE sound here — the ng of English \"singer\", with no separate g released after it. En sang, taught just above, is what comes out: the same pair as English sing and song." },
        { id: "no-u19l1-adanse", type: "vocab", front: "å danse", reading: "adanse", meaning: "to dance", example: { jp: "Vi danser i stua.", en: "We are dancing in the living room." }, accept: ["dance", "to have a dance"], drill: { jp: "Det er hyggelig å danse", en: "It is nice to dance" }, hint: "DAN-se, present danser. En dans is a dance, and et dansegulv is a dance floor — dans welded onto the gulv of unit 16." },
      ],
    },
    // Lesson 2: the landscape.
    {
      ...
      items: [
        ...
        { id: "no-u19l2-eielv", type: "vocab", front: "ei elv", reading: "eielv", meaning: "river", example: { jp: "Det er ei elv i skogen.", en: "There is a river in the forest." }, accept: ["a river", "stream"], drill: { jp: "Ei elv er lang", en: "A river is long" }, hint: "ELV. Feminine: definite elva, plural elver. You will also see en elv / elven; Bokmål allows both and print uses the en form freely, but this course writes ei because ei predicts the -a definite. A small one is en bekk." },
    ...
    // Lesson 3: the animals in that landscape.
    {
      ...
      items: [
        { id: "no-u19l3-etdyr", type: "vocab", front: "et dyr", reading: "etdyr", meaning: "animal", example: { jp: "En hund er et dyr.", en: "A dog is an animal." }, accept: ["an animal", "beast", "creature", "a creature"], drill: { jp: "Et dyr er sterkt", en: "An animal is strong" }, hint: "DUER. Neuter: definite dyret, plural dyr, unchanged. ⚠ Spelled exactly like dyr, \"expensive\", from unit 7 — whose own hint warned you this card was coming. Two different words. The article helps — et dyr is the animal — but the plural is dyr too, so Dyr er dyre, \"animals are expensive\", is both words in one sentence with no article in sight. Context really does do the work. En bil er dyr, but en bil er ikke et dyr." },
        { id: "no-u19l3-enfugl", type: "vocab", front: "en fugl", reading: "enfugl", meaning: "bird", example: { jp: "Det sitter en fugl i et tre.", en: "There is a bird sitting in a tree." }, accept: ["a bird"], drill: { jp: "En fugl er liten", en: "A bird is small" }, hint: "FUEL — the g is silent. Masculine: definite fuglen, plural fugler. English \"fowl\" is the very same old word, narrowed down to the ones you eat." },
        { id: "no-u19l3-enhest", type: "vocab", front: "en hest", reading: "enhest", meaning: "horse", example: { jp: "Bonden har en hest.", en: "The farmer has a horse." }, accept: ["a horse", "stallion", "mare"], drill: { jp: "En hest er stor", en: "A horse is big" }, hint: "HEST. Masculine: definite hesten, plural hester. Å ri is to ride one — and en hest is what en bonde from unit 18 keeps on the gård." },
        { id: "no-u19l3-eiku", type: "vocab", front: "ei ku", reading: "eiku", meaning: "cow", example: { jp: "Ei ku gir melk.", en: "A cow gives milk." }, accept: ["a cow"], drill: { jp: "Ei ku er brun", en: "A cow is brown" }, hint: "KUE, with the tight Norwegian u. Feminine: definite kua, and the plural is kuer or kyr — both current standard Bokmål, with kyr the form a dictionary lists first. Norwegian cows spend their summers loose på fjellet." },
        { id: "no-u19l3-ensau", type: "vocab", front: "en sau", reading: "ensau", meaning: "sheep", example: { jp: "Det går en sau på fjellet.", en: "There is a sheep out on the mountain." }, accept: ["a sheep", "ewe", "ram"], drill: { jp: "En sau er hvit", en: "A sheep is white" }, hint: "SOU, rhyming with English \"how\". Masculine: definite sauen, plural sauer — Norwegian counts sheep in the ordinary way, where English cannot. Their wool is the ull of unit 15." },
        { id: "no-u19l3-enelg", type: "vocab", front: "en elg", reading: "enelg", meaning: "moose", example: { jp: "Det er en elg i skogen.", en: "There is a moose in the forest." }, accept: ["an elk", "elk", "a moose", "european elk"], drill: { jp: "En elg er stor", en: "A moose is big" }, hint: "ELG, both consonants sounded. Masculine: definite elgen, plural elger. The animal on the warning signs along every Norwegian road. British English calls it an elk and American English a moose — same animal, and elg is neither confusing nor optional if you drive at dusk." },
      ],
    },
    // Lesson 4: sport and play, out in that landscape.
    {
      ...
      items: [
        { id: "no-u19l4-asvomme", type: "vocab", front: "å svømme", reading: "asvomme", meaning: "to swim", example: { jp: "Vi svømmer i en sjø.", en: "We are swimming in a lake." }, accept: ["swim", "to go swimming", "go swimming"], drill: { jp: "Det er godt å svømme", en: "It is good to swim" }, hint: "SVUM-me, present svømmer, hand-folded to asvomme. En svømmehall is an indoor pool — and given the water temperature, that is where Norwegians swim most of the year." },
        { id: "no-u19l4-afiske", type: "vocab", front: "å fiske", reading: "afiske", meaning: "to fish", example: { jp: "Erling fisker i ei elv.", en: "Erling is fishing in a river." }, accept: ["fish", "to go fishing", "go fishing", "to angle", "angle"], drill: { jp: "Det er hyggelig å fiske", en: "It is nice to fish" }, hint: "FIS-ke, present fisker. Straight from en fisk in unit 6 — the noun with a verb ending welded on, the same move English makes turning a fish into \"to fish\"." },
        { id: "no-u19l4-ahoppe", type: "vocab", front: "å hoppe", reading: "ahoppe", meaning: "to jump", example: { jp: "Barna hopper i senga.", en: "The children are jumping on the bed." }, accept: ["jump", "to leap", "leap", "to hop", "hop"], drill: { jp: "Det er lett å hoppe", en: "It is easy to jump" }, hint: "HOP-pe, present hopper. Å hoppe på ski is ski jumping — a sport Norway more or less invented and still expects to win." },
        { id: "no-u19l4-akaste", type: "vocab", front: "å kaste", reading: "akaste", meaning: "to throw", example: { jp: "Kari kaster et eple til meg.", en: "Kari throws an apple to me." }, accept: ["throw", "to toss", "toss", "to chuck", "to cast"], drill: { jp: "Det er lett å kaste en ball", en: "It is easy to throw a ball" }, hint: "KAS-te, present kaster. Also to throw something away: å kaste noe. English \"cast\" is the same Norse word, kept for fishing lines and film crews." },
        { id: "no-u19l4-enball", type: "vocab", front: "en ball", reading: "enball", meaning: "ball", example: { jp: "Barna spiller ball i hagen.", en: "The children are playing ball in the garden." }, accept: ["a ball"], drill: { jp: "En ball er liten", en: "A ball is small" }, hint: "BALL. Masculine: definite ballen, plural baller. Å spille ball takes no article at all — the same bare-noun pattern as kjøre bil in unit 7. Football is fotball, one word." },
