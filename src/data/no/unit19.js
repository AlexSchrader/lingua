  ...
  lessons: [
    ...
    // (without one it is å leke), so musikk has to be on the table before it.
    {
      ...
      items: [
        ...
        { id: "no-u19l1-aspille", type: "vocab", front: "å spille", reading: "aspille", meaning: "to play", example: { jp: "Erling spiller musikk i en park.", en: "Erling is playing music in a park." }, accept: ["play", "to perform", "perform", "to act", "act"], drill: { jp: "Det er hyggelig å spille musikk", en: "It is nice to play music" }, hint: "SPIL-le, present spiller. For an instrument, a game or a role, and it wants an object — jeg spiller piano, han spiller musikk. Children playing about with no rules is å leke, a different verb entirely, so \"spiller i en park\" on its own would be the wrong one." },
        { id: "no-u19l1-asynge", type: "vocab", front: "å synge", reading: "asynge", meaning: "to sing", example: { jp: "Barna synger på skolen.", en: "The children are singing at school." }, accept: ["sing", "to chant", "chant"], drill: { jp: "Det er hyggelig å synge en sang", en: "It is nice to sing a song" }, hint: "SUENG-e, present synger. The letters ng spell a SINGLE sound here — the ng of English \"singer\", with no separate g released after it. En sang, taught just above, is what comes out: the same pair as English sing and song." },
        { id: "no-u19l1-adanse", type: "vocab", front: "å danse", reading: "adanse", meaning: "to dance", example: { jp: "Vi danser i stua.", en: "We are dancing in the living room." }, accept: ["dance", "to have a dance"], drill: { jp: "Det er hyggelig å danse sammen", en: "It is nice to dance together" }, hint: "DAN-se, present danser. En dans is a dance, and et dansegulv is a dance floor — dans welded onto the gulv of unit 16." },
      ],
    },
    ...
    // Lesson 4: sport and play, out in that landscape.
    {
      ...
      items: [
        ...
        { id: "no-u19l4-afiske", type: "vocab", front: "å fiske", reading: "afiske", meaning: "to fish", example: { jp: "Erling fisker i ei elv.", en: "Erling is fishing in a river." }, accept: ["fish", "to go fishing", "go fishing", "to angle", "angle"], drill: { jp: "Det er hyggelig å fiske i ei elv", en: "It is nice to fish in a river" }, hint: "FIS-ke, present fisker. Straight from en fisk in unit 6 — the noun with a verb ending welded on, the same move English makes turning a fish into \"to fish\"." },
