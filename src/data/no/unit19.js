  ...
  lessons: [
    ...
    // Lesson 3: the animals in that landscape.
    {
      ...
      items: [
        ...
        { id: "no-u19l3-ensau", type: "vocab", front: "en sau", reading: "ensau", meaning: "sheep", example: { jp: "Det går en sau på fjellet.", en: "There is a sheep out on the mountain." }, accept: ["a sheep", "ewe", "ram"], hint: "SOU, rhyming with English \"how\". Masculine: definite sauen, plural sauer — Norwegian counts sheep in the ordinary way, where English cannot. Their wool is the ull of unit 15." },
