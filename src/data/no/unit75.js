  ...
  lessons: [
    // Lesson 1: getting online and staying there.
    {
      ...
      items: [
        ...
        { id: "no-u75l1-nettleser", type: "vocab", front: "en nettleser", reading: "ennettleser", meaning: "a browser", example: { jp: "Nettleseren viser sida med det samme.", en: "The browser shows the page right away." }, accept: ["browser", "web browser"], drill: { jp: "Vi bruker en nettleser hver dag", en: "We use a browser every day" }, hint: "et nett + en leser, from å lese (u18) — literally a net-reader. Masculine: nettleseren." },
    ...
    // Lesson 3: the half of Norwegian digital life that is about being careful.
    {
      ...
      items: [
        ...
        { id: "no-u75l3-aoppgi", type: "vocab", front: "å oppgi", reading: "aoppgi", meaning: "to state your details", example: { jp: "Du skal aldri oppgi passordet ditt til noen.", en: "You should never give out your password to anybody." }, drill: { jp: "Det er dumt å oppgi passordet ditt", en: "It is stupid to give out your password" }, accept: ["to give out (information)", "to supply (details)", "to declare"], hint: "OPP-ji — the g softens to a y, as in å gi. Present oppgir, past oppga. It is the word every form and every scam message uses: oppgi navn og fødselsdato. Note å gi opp, in this same course, means to give up — the two little words swap places and so does the meaning." },
      ],
    },
    // Lesson 4: what the machines are doing now.
    {
      ...
      items: [
        { id: "no-u75l4-digital", type: "vocab", front: "digital", reading: "digital", meaning: "computer-based", example: { jp: "Alt er digitalt i Norge nå.", en: "Everything is digital in Norway now." }, accept: ["digital", "electronic", "online"], drill: { jp: "Vi trenger en digital løsning", en: "We need a digital solution" }, hint: "Neuter digitalt, plural digitale. Norway is further down this road than most countries — digitalt is the default and paper is the exception." },
        ...
        { id: "no-u75l4-automatisk", type: "vocab", front: "automatisk", reading: "automatisk", meaning: "automatic", example: { jp: "Døra åpner seg automatisk når du kommer nær.", en: "The door opens automatically when you come close." }, drill: { jp: "Systemet gjør dette helt automatisk", en: "The system does this completely automatically" }, accept: ["automatically", "by itself", "without anybody doing it"], hint: "au-to-MA-tisk. No -t in the neuter — -sk adjectives never take one: et automatisk system. Plural automatiske. The same form does the adverb job with no change at all." },
      ],
    },
  ],
};
