...
//
// FIRST FEMININE OF THE UNIT is `ei mengde` (l1) and it carries the en-/ei-
...
export const NO_UNIT47 = {
  ...
  lessons: [
    // Lesson 1: parts and wholes.
    {
      ...
      unit: 47,
      lesson: 1,
      title: "Deler og mengder",
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Talk about how much of a thing there is — mengde, del, rest, stykke, helhet, antall — and say what is left.",
      items: [
        { id: "no-u47l1-eimengde", type: "vocab", front: "ei mengde", reading: "eimengde", meaning: "quantity", example: { jp: "Ei mengde med sukker er nok, men vi trenger mer salt.", en: "A quantity of sugar is enough, but we need more salt." }, drill: { jp: "Det er ei mengde sukker i kaka", en: "There is a quantity of sugar in the cake" }, accept: ["an amount", "a lot", "a crowd"], hint: "MENG-de. Feminine: definite mengda, plural mengder. You will also see ei mengde written en mengde / mengden; Bokmål allows both, and this course writes ei because ei is what tells you the definite ends in -a. En mengde folk is a crowd — the word slides from amount to throng." },
        ...
        { id: "no-u47l1-enrest", type: "vocab", front: "en rest", reading: "enrest", meaning: "rest", example: { jp: "En rest av middagen står i et skap, og vi spiser den i kveld.", en: "A rest of the dinner is in a cupboard, and we eat it tonight." }, drill: { jp: "Det er en rest av suppa", en: "There is a rest of the soup" }, accept: ["a remainder", "leftovers", "a remnant"], hint: "REST. Masculine: definite resten, plural rester. Rester in the plural is specifically leftovers, and restemiddag — a dinner made of them — is a word Norwegian has and English needs." },
        ...
        { id: "no-u47l1-enhelhet", type: "vocab", front: "en helhet", reading: "enhelhet", meaning: "whole", example: { jp: "En helhet er mer enn en del, og alle vet det.", en: "A whole is more than a part, and everyone knows that." }, drill: { jp: "Vi ser en helhet i et bilde", en: "We see a whole in a picture" }, accept: ["a totality", "an entirety"], hint: "HEHL-het. Masculine: definite helheten. ⚠ Nouns in -het are masculine in Bokmål with NO feminine option — there is no helheta — which is why this one is not marked ei even though so many other -e nouns in this block are." },
        { id: "no-u47l1-etantall", type: "vocab", front: "et antall", reading: "etantall", meaning: "number", example: { jp: "Et antall barn kommer, men vi vet ikke hvor mange.", en: "A number of children are coming, but we do not know how many." }, drill: { jp: "Et antall gjester kommer i kveld", en: "A number of guests are coming tonight" }, accept: ["a quantity", "a count", "an amount"], hint: "AN-tall. Neuter: definite antallet, and the plural is antall, unchanged. Et tall from A1 unit 5 is the numeral itself; et antall is how many of something there are." },
      ],
    },
    ...
    // Lesson 3: what you put a quantity into.
    {
      ...
      items: [
        ...
        { id: "no-u47l3-eipose", type: "vocab", front: "ei pose", reading: "eipose", meaning: "bag", example: { jp: "Vi bruker ei pose når vi går i butikken, fordi den er lett å bruke.", en: "We use a bag when we go to the shop, because it is easy to use." }, drill: { jp: "Det er poteter i ei pose", en: "There are potatoes in a bag" }, accept: ["a paper bag", "a plastic bag", "a sack"], hint: "POO-se. Feminine: definite posa, plural poser. A paper or plastic bag from a shop, where ei veske from A1 unit 15 is the bag you carry every day." },
        { id: "no-u47l3-etbeger", type: "vocab", front: "et beger", reading: "etbeger", meaning: "cup", example: { jp: "Et beger med melk står på et bord, og barnet vil ha det.", en: "A cup of milk is on a table, and the child wants it." }, drill: { jp: "Det står et beger på hylla", en: "There is a cup standing on the shelf" }, accept: ["a beaker", "a tub", "a carton"], hint: "BEH-ger, hard g. Neuter: definite begeret, plural begre. A disposable or measuring cup — a yoghurt tub is et beger — where en kopp from A1 unit 6 is the one with a handle you drink coffee from." },
