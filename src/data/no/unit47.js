  ...
  lessons: [
    ...
    // Lesson 3: what you put a quantity into.
    {
      ...
      items: [
        ...
        { id: "no-u47l3-enpose", type: "vocab", front: "en pose", reading: "enpose", meaning: "bag", example: { jp: "Vi bruker en pose når vi går i butikken, fordi den er lett å bruke.", en: "We use a bag when we go to the shop, because it is easy to use." }, drill: { jp: "Det er poteter i en pose", en: "There are potatoes in a bag" }, accept: ["a paper bag", "a plastic bag", "a sack"], hint: "POO-se. Masculine: definite posen, plural poser. A paper or plastic bag from a shop, where en veske from A1 unit 15 is the bag you carry every day." },
