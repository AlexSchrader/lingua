...
// not the word. `ifølge` is taught at u70l4 (block 2), so this unit no longer teaches
...
export const NO_UNIT76 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Leave something out, make an exception, say what sits next to what, and say where information comes from.",
      items: [
        { id: "no-u76l4-uten", type: "vocab", front: "uten", reading: "uten", meaning: "without (preposition)", example: { jp: "Jeg drikker aldri kaffe uten melk hjemme.", en: "I never drink coffee without milk at home." }, accept: ["lacking", "without"], drill: { jp: "Jeg drar uten deg", en: "I am leaving without you" }, hint: "Uten + substantiv, uten å + infinitiv: han gikk uten å si noe." },
        ...
        { id: "no-u76l4-vedsidenav", type: "vocab", front: "ved siden av", reading: "vedsidenav", meaning: "next to", example: { jp: "Banken ligger ved siden av kafeen i denne gata.", en: "The bank is next to the café in this street." }, drill: { jp: "Butikken ligger ved siden av banken", en: "The shop is next to the bank" }, accept: ["beside", "alongside", "right by"], hint: "Ei side is a side, so this is \"by the side of\". Three words that never come apart, and the noun always follows av. It also means \"on top of that\" about time: ved siden av jobben studerer han." },
      ],
    },
  ],
};
