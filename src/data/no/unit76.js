...
export const NO_UNIT76 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "no-u76l4-uten", type: "vocab", front: "uten", reading: "uten", meaning: "without (preposition)", example: { jp: "Jeg drikker aldri kaffe uten melk hjemme.", en: "I never drink coffee without milk at home." }, accept: ["lacking", "without", "without"], drill: { jp: "Jeg drar uten deg", en: "I am leaving without you" }, hint: "Uten + substantiv, uten å + infinitiv: han gikk uten å si noe." },
