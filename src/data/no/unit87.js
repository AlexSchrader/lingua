...
// noun. Nothing in 1215 words teaches en brann, et politi, en ambulanse, et
// nødnummer, å redde, ei førstehjelp or en rømningsvei. A learner who can discuss
// a headache and cannot report a fire has a gap that is not a matter of fluency.
//
  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u87l1-politiet", type: "vocab", front: "politiet", reading: "politiet", meaning: "police", example: { jp: "Politiet kom ti minutter etter at vi ringte.", en: "The police came ten minutes after we called." }, accept: ["a police force", "a police officer"], drill: { jp: "Politiet kom ti minutter etter", en: "The police came ten minutes later" }, hint: "politiet — alltid entall og alltid bestemt form, som allemannsretten (u83). En politibetjent er én person. Ring 112." },
    ...
    },
    {
      ...
      items: [
        { id: "no-u87l2-forstehjelp", type: "vocab", front: "førstehjelp", reading: "forstehjelp", meaning: "first aid", example: { jp: "Alle på jobben har hatt kurs i førstehjelp.", en: "Everybody at work has had a course in first aid." }, accept: ["emergency aid"], drill: { jp: "Alle har hatt kurs i førstehjelp", en: "Everybody has had a course in first aid" }, hint: "førstehjelp → førstehjelpa. Først (u21) + ei hjelp. Står alltid uten artikkel og er derfor bart oppslag (regel 1b): kurs i førstehjelp." },
        { id: "no-u87l2-aredde", type: "vocab", front: "å redde", reading: "aredde", meaning: "to rescue", example: { jp: "Naboen reddet katten ned fra taket i går.", en: "The neighbour rescued the cat down from the roof yesterday." }, accept: ["to save", "rescue"], drill: { jp: "Det er godt å redde noen", en: "It is good to rescue somebody" }, hint: "å redde → redder, reddet. Ei redning er substantivet. Redd (u22) betyr afraid — samme skrivemåte, annet ord." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u87l3-enrisiko", type: "vocab", front: "en risiko", reading: "enrisiko", meaning: "risk", example: { jp: "Det er alltid en risiko når du går ut i fjellet.", en: "There's always a risk when you go out in the mountains." }, accept: ["a danger", "a hazard"], drill: { jp: "Det er alltid en risiko her", en: "There is always a risk here" }, hint: "en risiko → risikoen, flertall risikoer. Å ta en risiko, å være i risikosonen. Farlig (u22) er adjektivet." },
        { id: "no-u87l3-entrygghet", type: "vocab", front: "en trygghet", reading: "entrygghet", meaning: "sense of safety", example: { jp: "Det gir en trygghet å vite at noen er hjemme.", en: "It gives a sense of safety to know that somebody is at home." }, accept: ["security", "reassurance"], drill: { jp: "Det gir en trygghet å vite det", en: "It gives a sense of safety to know it" }, hint: "en trygghet → tryggheten. -het-ord er hankjønn (regel 1), aldri ei. Fra trygg (u22). Trygghet er følelsen, sikkerhet er tilstanden." },
      ],
    },
    {
      id: "no-u87l4",
      ...
      items: [
        ...
        { id: "no-u87l4-enroyk", type: "vocab", front: "en røyk", reading: "enroyk", meaning: "smoke", example: { jp: "Røyken er verre enn flammene i et hus.", en: "The smoke is worse than the flames in a house." }, accept: ["a cigarette", "fumes"], drill: { jp: "Det kom en røyk fra kjelleren", en: "Smoke came from the basement" }, hint: "en røyk → røyken. Betyr også a cigarette: ta en røyk. Å røyke er verbet, for begge betydningene." },
        { id: "no-u87l4-aslukke", type: "vocab", front: "å slukke", reading: "aslukke", meaning: "to put out (extinguish)", example: { jp: "De klarte å slukke brannen før den nådde taket.", en: "They managed to put the fire out before it reached the roof." }, accept: ["to extinguish", "to switch off"], drill: { jp: "De klarte å slukke brannen", en: "They managed to put out the fire" }, hint: "å slukke → slukker, slukket. Både om en brann og om et lys. Motsatt av å fyre opp (u83)." },
