  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u87l1-etbrannvesen", type: "vocab", front: "et brannvesen", reading: "etbrannvesen", meaning: "a fire brigade", example: { jp: "Et brannvesen kommer med en gang du ringer nødnummeret.", en: "A fire brigade comes at once when you call the emergency number." }, drill: { jp: "Vi ringer til et brannvesen nå", en: "We are calling a fire brigade now" }, accept: ["the fire service", "firefighters", "a fire department"], hint: "BRANN-ve-sen. En brann plus et vesen, a body or agency — neuter after vesen: definite brannvesenet. You reach them on 110, and they come for more than fire: floods, leaks and people locked in." },
      ],
    },
    {
      id: "no-u87l2",
      ...
      items: [
        ...
        { id: "no-u87l2-bevisstlos", type: "vocab", front: "bevisstløs", reading: "bevisstlos", meaning: "unconscious", example: { jp: "Mannen er bevisstløs, og vi ringer etter en ambulanse.", en: "The man is unconscious, and we are calling for an ambulance." }, drill: { jp: "Mannen ligger bevisstløs på gulvet", en: "The man is lying unconscious on the floor" }, accept: ["out cold", "knocked out", "not conscious"], hint: "be-VISST-loess. Bevisst, aware, plus -løs, the ending that means \"without\" — the same -løs as in arbeidsløs. Neuter bevisstløst, plural bevisstløse. Å besvime is the moment; bevisstløs is the state afterwards, and it is what you tell the operator first." },
      ],
    },
    {
      id: "no-u87l3",
      ...
      items: [
        ...
        { id: "no-u87l3-aholdeoyemed", type: "vocab", front: "å holde øye med", reading: "aholdeoyemed", meaning: "to keep an eye on", example: { jp: "Naboen holder øye med huset mens vi er borte.", en: "The neighbour keeps an eye on the house while we are away." }, drill: { jp: "Det er lurt å holde øye med barna", en: "It is sensible to keep an eye on the children" }, accept: ["to watch over", "to keep watch on", "to look out for"], hint: "HOL-le oy-e me. Å holde plus et øye — four words, one thing in the mouth, and the øye stays singular. Å passe på is taking charge of something; å holde øye med is only watching it." },
      ],
    },
    {
      id: "no-u87l4",
