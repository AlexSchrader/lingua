  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u116l3-forsettlig", type: "vocab", front: "forsettlig", reading: "forsettlig", meaning: "wilful (done on purpose, in law)", example: { jp: "Handlingen var forsettlig, sier de, men ingen av vitnene så noe på forhånd.", en: "The act was wilful, they say, but none of the witnesses saw anything beforehand." }, accept: ["deliberate", "intentional"], drill: { jp: "Handlingen var forsettlig og ikke mer", en: "The act was wilful and nothing more" }, hint: "forsettlig → forsettlig, forsettlige. -ig-ord får ikke -t i intetkjønn. ⚠ Juridisk og tungt: si «med vilje» i tale. Bruker du forsettlig om en kollega, har du anklaget vedkommende for noe alvorlig." },
