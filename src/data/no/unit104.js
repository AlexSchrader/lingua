...
export const NO_UNIT104 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "no-u104l3-enredaksjon", type: "vocab", front: "en redaksjon", reading: "enredaksjon", meaning: "editorial team", example: { jp: "Redaksjonen er blitt mindre hvert år, og likevel skal den dekke like mange saker som før.", en: "The editorial team has got smaller every year, and still it is meant to cover as many stories as before." }, accept: ["a newsroom", "the editorial staff"], drill: { jp: "Hun jobber i en redaksjon i Oslo", en: "She works in an editorial team in Oslo" }, hint: "en redaksjon → redaksjonen, flertall redaksjoner. -sjon er hankjønn. Menneskene OG rommet. En redaktør (u48) leder den." },
