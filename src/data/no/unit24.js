...
//
// GENDER, applying the block-3 seat's rule PRE-EMPTIVELY rather than being
// corrected later: -ing and -het nouns are MASCULINE in Bokmål. So en avdeling,
// en stilling, en utdanning — not ei. Two of my u23 fronts (ei retning, ei kø)
// were caught as gender errors after committing, and under unit1.js §1 the ei
// marking is a promise that the definite ends in -a, so a wrong marking actively
// teaches a wrong form.
//
  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u24l1-enstilling", type: "vocab", front: "en stilling", reading: "enstilling", meaning: "position", example: { jp: "Stillingen er ledig fra januar, hvis vi finner en god lærer.", en: "The position is vacant from January, if we find a good teacher." }, accept: ["a position", "a job", "post", "vacancy"], drill: { jp: "En stilling er ledig nå", en: "A position is vacant now" }, hint: "STIL-ling. MASCULINE, not feminine — -ing nouns are masculine in Bokmål, so definite stillingen. Built on å stille." },
    ...
    },
    {
      ...
      items: [
        { id: "no-u24l2-enavdeling", type: "vocab", front: "en avdeling", reading: "enavdeling", meaning: "department", example: { jp: "Avdelingen min er liten, men vi samarbeider med et kontor i Oslo.", en: "My department is small, but we work together with an office in Oslo." }, accept: ["a department", "division", "section", "ward"], drill: { jp: "En avdeling er travel i dag", en: "A department is busy today" }, hint: "AV-de-ling. MASCULINE — -ing again, so definite avdelingen. In a hospital it is a ward." },
        ...
        { id: "no-u24l2-atjene", type: "vocab", front: "å tjene", reading: "atjene", meaning: "to earn", example: { jp: "Han tjener godt i den nye stillingen, men han jobber også mange timer.", en: "He earns well in the new position, but he also works many hours." }, accept: ["earn", "to make money", "to serve"], drill: { jp: "Det er godt å tjene penger", en: "It is good to earn money" }, hint: "HYEH-ne — tj is the same thin hush as kj, from A1 unit 1. Past tjente." },
    ...
    },
    {
      ...
      items: [
        { id: "no-u24l3-enutdanning", type: "vocab", front: "en utdanning", reading: "enutdanning", meaning: "education", example: { jp: "Utdanningen tar fire år, men hun vil begynne å jobbe før den er slutt.", en: "The education takes four years, but she wants to start working before it ends." }, accept: ["an education", "training", "degree"], drill: { jp: "En utdanning er viktig", en: "An education is important" }, hint: "OOT-dan-ning. MASCULINE, definite utdanningen — the third -ing noun in this unit and all three are en, not ei." },
