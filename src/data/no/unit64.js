  ...
  lessons: [
    ...
    // adjectives that never change.
    {
      ...
      items: [
        ...
        { id: "no-u64l3-humor", type: "vocab", front: "en humor", reading: "enhumor", meaning: "humour", example: { jp: "Han har en tørr humor som ikke alle forstår.", en: "He has a dry humour that not everyone understands." }, accept: ["humor", "sense of humour", "wit"], drill: { jp: "Han har en humor jeg liker", en: "He has a humour I like" }, hint: "Masculine and normally singular: humoren. tørr humor is dry humour, the same picture as in English." },
    ...
    // words you actually use in a review.
    {
      ...
      items: [
        ...
        { id: "no-u64l4-anmelde", type: "vocab", front: "å anmelde", reading: "aanmelde", meaning: "to review", example: { jp: "Hun anmelder bøker for ei avis i Oslo.", en: "She reviews books for a paper in Oslo." }, accept: ["review", "to critique"], drill: { jp: "Hun pleier å anmelde nye bøker", en: "She usually reviews new books" }, hint: "anmelder, anmeldte. It also means to report someone to the police — context decides, and that is the older sense of the two." },
        { id: "no-u64l4-kritiker", type: "vocab", front: "en kritiker", reading: "enkritiker", meaning: "a critic", example: { jp: "Kritikerne likte filmen, men publikum gjorde ikke det.", en: "The critics liked the film, but the audience did not." }, accept: ["critic", "reviewer"], drill: { jp: "Hun er en kritiker i Oslo", en: "She is a critic in Oslo" }, hint: "Masculine: kritikeren. -er on a stem makes the person who does it, the same ending as skuespiller and forsker." },
