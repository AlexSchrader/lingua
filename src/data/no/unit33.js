  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u33l2-eifil", type: "vocab", front: "ei fil", reading: "eifil", meaning: "file", example: { jp: "Fila er veldig stor.", en: "The file is very big." }, accept: ["a file", "lane"], drill: { jp: "Ei fil ligger på datamaskinen", en: "A file is on the computer" }, hint: "Feminine: ei fil → fila, plural filer. Three senses in one short word: a computer file, a lane on a motorway, and the tool you smooth metal with." },
        { id: "no-u33l2-alagre", type: "vocab", front: "å lagre", reading: "alagre", meaning: "to save", example: { jp: "Husk å lagre filene dine.", en: "Remember to save your files." }, accept: ["save", "to store", "store"], drill: { jp: "Vi begynner å lagre bilder", en: "We start saving pictures" }, hint: "Present lagrer. From et lager, a store or warehouse — to put something into storage. Saving money is å spare, a different verb entirely." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u33l4-etinnlegg", type: "vocab", front: "et innlegg", reading: "etinnlegg", meaning: "post", example: { jp: "Jeg leste et innlegg på nettet.", en: "I read a post on the internet." }, accept: ["a post", "contribution", "comment"], drill: { jp: "Et innlegg står på ei side", en: "A post is on a page" }, hint: "Neuter: et innlegg → innlegget, and the plural takes no ending. From inn plus legge, to lay — something laid in. It is a post on a forum and also a speech in a debate." },
