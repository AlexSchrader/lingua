...
export const NO_UNIT70 = {
  ...
  lessons: [
    ...
    // Lesson 4: reporting what somebody else said.
    {
      ...
      items: [
        { id: "no-u70l4-hevde", type: "vocab", front: "å hevde", reading: "ahevde", meaning: "to claim", example: { jp: "Han hevder at han ikke var der.", en: "He claims that he was not there." }, accept: ["claim", "to assert", "to maintain"], drill: { jp: "Han pleier å hevde at han har rett", en: "He usually claims that he is right" }, hint: "hevder, hevdet. Stronger and cooler than å si (u12): what somebody hevder is something you are not vouching for. The noun is en påstand (u71)." },
