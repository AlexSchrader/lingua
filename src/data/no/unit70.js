  ...
  lessons: [
    ...
    // here on purpose — four of these six verbs take it.
    {
      ...
      items: [
        ...
        { id: "no-u70l3-afalovtil", type: "vocab", front: "å få lov til", reading: "afalovtil", meaning: "to be allowed to", example: { jp: "Barna får lov til å være ute til klokka ni.", en: "The children are allowed to be outside until nine o'clock." }, drill: { jp: "Han håper å få lov til å bli", en: "He hopes to be allowed to stay" }, accept: ["to get permission", "to be permitted", "to have leave to"], hint: "faw LOVE til. Ei lov is a law and å få lov is to be given it — permission in four words. It takes å plus an infinitive after it: få lov TIL Å gjøre noe. En tillatelse is the paper; å få lov til is the everyday thing." },
      ],
    },
    // Lesson 4: reporting what somebody else said.
    {
      ...
      items: [
        ...
        { id: "no-u70l4-enuttalelse", type: "vocab", front: "en uttalelse", reading: "enuttalelse", meaning: "a public statement", example: { jp: "Ifølge en uttalelse fra kommunen blir veien stengt.", en: "According to a statement from the council, the road will be closed." }, drill: { jp: "Sjefen kom med en uttalelse i dag", en: "The boss put out a statement today" }, accept: ["a statement", "an official comment", "a pronouncement"], hint: "UT-ta-lel-se. Masculine, like every -else: definite uttalelsen, plural uttalelser. Å uttale seg is to go on the record, so en uttalelse is the record — something said on purpose, for others to quote." },
      ],
    },
  ],
};
