  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u93l3-etutbytte", type: "vocab", front: "et utbytte", reading: "etutbytte", meaning: "dividend (payout)", example: { jp: "Utbyttet var stort i år, men jobbene forsvant likevel.", en: "The dividend was big this year, but the jobs disappeared all the same." }, accept: ["a return", "a yield", "a payout"], drill: { jp: "De tok ut et utbytte på millioner", en: "They took out a dividend in the millions" }, hint: "et utbytte → utbyttet, flertall utbytter. Ut + å bytte. Pengene eierne tar ut. Også i overført tyding: godt utbytte av et kurs (u24)." },
