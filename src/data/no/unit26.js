  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u26l2-eiflue", type: "vocab", front: "ei flue", reading: "eiflue", meaning: "fly", example: { jp: "Flua sitter på vinduet, men den drar straks vi kommer nær.", en: "The fly sits on the window, but it leaves the moment we come close." }, accept: ["a fly"], drill: { jp: "Det sitter ei flue på vinduet", en: "There is a fly sitting on the window" }, hint: "FLOO-e. Feminine: definite flua, plural fluer. Not to be confused with et fly, an aeroplane, from u20." },
        ...
        { id: "no-u26l2-etegg", type: "vocab", front: "et egg", reading: "etegg", meaning: "egg", example: { jp: "Egget ligger i reiret, fordi fuglen vil ha det varmt.", en: "The egg lies in the nest, because the bird wants to keep it warm." }, accept: ["an egg"], drill: { jp: "Det ligger et egg i gresset", en: "There is an egg lying in the grass" }, hint: "EGG. Neuter: definite egget, and the plural is egg unchanged — to egg, two eggs." },
        { id: "no-u26l2-etreir", type: "vocab", front: "et reir", reading: "etreir", meaning: "nest", example: { jp: "Fuglen lager et reir i treet fordi den skal ha unger.", en: "The bird makes a nest in the tree because it is going to have young." }, accept: ["a nest"], drill: { jp: "Det ligger et reir høyt i treet", en: "There is a nest high up in the tree" }, hint: "REIR, one syllable, the ei as in `nei`. Neuter: definite reiret, plural reir unchanged." },
        { id: "no-u26l2-eifjaer", type: "vocab", front: "ei fjær", reading: "eifjaer", meaning: "feather", example: { jp: "Det ligger ei fjær i gresset, men vi finner ikke fuglen igjen.", en: "There is a feather lying in the grass, but we do not find the bird again." }, accept: ["a feather", "a spring"], drill: { jp: "Ei fjær er hvit og lett", en: "A feather is white and light" }, hint: "FYAER — æ written ae in the reading. Feminine: definite fjæra, plural fjær unchanged. It also means a metal spring." },
      ],
    },
    {
      id: "no-u26l3",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u26l4-gress", type: "vocab", front: "gress", reading: "gress", meaning: "grass", example: { jp: "Gresset blir grønt igjen når våren kommer.", en: "The grass turns green again when spring comes." }, accept: ["grass"], drill: { jp: "Sauene spiser mye gress", en: "The sheep eat a lot of grass" }, hint: "GRESS. A mass noun, so it is taught bare — \"et gress\" is not Norwegian (§1b). Neuter: definite gresset, and you rarely need a plural." },
      ],
    },
  ],
};
