...
export const NO_UNIT35 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "no-u35l2-eiforestilling", type: "vocab", front: "ei forestilling", reading: "eiforestilling", meaning: "show", example: { jp: "Forestillinga begynner klokka sju, så vi må dra nå.", en: "The show starts at seven, so we have to set off now." }, accept: ["a performance", "showing"], drill: { jp: "Vi ser ei forestilling", en: "We watch a show" }, hint: "ei forestilling → forestillinga, and Bokmål allows forestillingen too. Also a mental picture: jeg har ingen forestilling om det, 'I have no idea about it'." },
        { id: "no-u35l2-eistjerne", type: "vocab", front: "ei stjerne", reading: "eistjerne", meaning: "star", example: { jp: "Han ble ei stjerne etter den nye filmen sin.", en: "He became a star after his new film." }, accept: ["a star"], drill: { jp: "Hun er ei stjerne nå", en: "She is a star now" }, hint: "SHÆR-ne — stj is a broad sh, so the t is not said. Feminine: definite stjerna, plural stjerner; print also writes stjernen. A film star and a star in the sky are the same word." },
        { id: "no-u35l2-eirolle", type: "vocab", front: "ei rolle", reading: "eirolle", meaning: "role", example: { jp: "Hun spiller ei viktig rolle i filmen.", en: "She plays an important role in the film." }, accept: ["a role", "a part"], drill: { jp: "Hun har ei rolle i filmen", en: "She has a role in the film" }, hint: "ROL-le. Feminine: definite rolla, plural roller. å spille ei rolle, to play a role — on a stage and in life alike." },
        { id: "no-u35l2-eiutstilling", type: "vocab", front: "ei utstilling", reading: "eiutstilling", meaning: "exhibition", example: { jp: "Det er ei ny utstilling i byen i dag.", en: "There is a new exhibition in town today." }, accept: ["an exhibition", "a display"], drill: { jp: "Byen har ei utstilling", en: "The city has an exhibition" }, hint: "ei utstilling → utstillinga. Literally 'out-setting', ut + stille — you set things out for people to see." },
        { id: "no-u35l2-aopptre", type: "vocab", front: "å opptre", reading: "aopptre", meaning: "to perform", example: { jp: "Han skal opptre på torget i kveld.", en: "He is going to perform in the square tonight." }, accept: ["perform", "to appear"], drill: { jp: "Hun liker å opptre", en: "She likes to perform" }, hint: "opp + tre, 'step up' onto a stage. Present opptrer. Also 'to behave': opptre pent means to behave nicely." },
        { id: "no-u35l2-aunderholde", type: "vocab", front: "å underholde", reading: "aunderholde", meaning: "to entertain", example: { jp: "Læreren underholder barna mens de spiser.", en: "The teacher entertains the children while they eat." }, accept: ["entertain", "to amuse"], drill: { jp: "Det er fint å underholde barna", en: "It is nice to entertain the children" }, hint: "under + holde, literally 'hold up'. Present underholder. The noun underholdning is entertainment." },
      ],
    },
    {
      id: "no-u35l3",
      ...
      items: [
        { id: "no-u35l3-eifortelling", type: "vocab", front: "ei fortelling", reading: "eifortelling", meaning: "tale", example: { jp: "Bestemor leser ei fortelling for barna hver kveld.", en: "Grandmother reads a tale to the children every evening." }, accept: ["a tale", "a narrative", "story"], drill: { jp: "Han leser ei fortelling", en: "He reads a tale" }, hint: "ei fortelling → fortellinga. From å fortelle, to tell (A1) — the -ing ending turns the verb into the thing told." },
        ...
        { id: "no-u35l3-eihistorie", type: "vocab", front: "ei historie", reading: "eihistorie", meaning: "story", example: { jp: "Bestefar forteller alltid den samme historia.", en: "Grandfather always tells the same story." }, accept: ["a story", "history", "tale"], drill: { jp: "Hun forteller ei historie", en: "She tells a story" }, hint: "his-TOO-ri-e. Feminine: definite historia, plural historier. One word for a story you tell and for History the subject." },
        { id: "no-u35l3-etdikt", type: "vocab", front: "et dikt", reading: "etdikt", meaning: "poem", example: { jp: "Hun skriver et kort dikt til moren sin.", en: "She writes a short poem for her mother." }, accept: ["a poem"], drill: { jp: "Han skriver et dikt", en: "He writes a poem" }, hint: "Neuter: et dikt → diktet, plural dikt (unchanged). From å dikte, to make things up — a poet is en dikter." },
        { id: "no-u35l3-enhelt", type: "vocab", front: "en helt", reading: "enhelt", meaning: "hero", example: { jp: "I boka er en ung mann helten.", en: "In the book a young man is the hero." }, accept: ["a hero"], drill: { jp: "Læreren er en helt", en: "The teacher is a hero" }, hint: "en helt → helten. Do not confuse it with the adverb helt, 'completely' — same spelling, different word." },
    ...
    },
    {
      ...
      items: [
        { id: "no-u35l4-enhobby", type: "vocab", front: "en hobby", reading: "enhobby", meaning: "hobby", example: { jp: "Å ta bilder er en dyr hobby, men jeg elsker den.", en: "Taking pictures is an expensive hobby, but I love it." }, accept: ["a hobby", "pastime"], drill: { jp: "Musikk er en hobby", en: "Music is a hobby" }, hint: "en hobby → hobbyen, plural hobbyer. An English loan, kept whole." },
        { id: "no-u35l4-eninteresse", type: "vocab", front: "en interesse", reading: "eninteresse", meaning: "interest", example: { jp: "Vi har mange interesser sammen, derfor er vi gode venner.", en: "We have many interests in common, so we are good friends." }, accept: ["an interest"], drill: { jp: "Kunst er en interesse", en: "Art is an interest" }, hint: "en interesse → interessen. The verb is å interessere seg for, to be interested in." },
        { id: "no-u35l4-etspill", type: "vocab", front: "et spill", reading: "etspill", meaning: "game", example: { jp: "Vi spiller et spill sammen hver fredag.", en: "We play a game together every Friday." }, accept: ["a game", "play"], drill: { jp: "Han kjøpte et spill i går", en: "He bought a game yesterday" }, hint: "Neuter: et spill → spillet, plural spill (unchanged). The noun beside the A1 verb å spille, to play." },
        ...
        { id: "no-u35l4-ategne", type: "vocab", front: "å tegne", reading: "ategne", meaning: "to draw", example: { jp: "Datteren min tegner dyr når hun har tid.", en: "My daughter draws animals when she has time." }, accept: ["draw", "to sketch"], drill: { jp: "Barna liker å tegne", en: "The children like to draw" }, hint: "å tegne → tegner. The g is silent: TAI-ne. A drawing is en tegning, and et tegn (u33) is a sign." },
