  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u35l3-enhistorie", type: "vocab", front: "en historie", reading: "enhistorie", meaning: "story", example: { jp: "Bestefar forteller alltid den samme historien.", en: "Grandfather always tells the same story." }, accept: ["a story", "history", "tale"], drill: { jp: "Hun forteller en historie", en: "She tells a story" }, hint: "en historie → historien. One word for a story and for History the subject, exactly as in French and Spanish." },
