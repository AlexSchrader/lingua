  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u35l3-etdikt", type: "vocab", front: "et dikt", reading: "etdikt", meaning: "poem", example: { jp: "Hun skrev et kort dikt til bursdagen min.", en: "She wrote a short poem for my birthday." }, accept: ["a poem"], drill: { jp: "Han skriver et dikt", en: "He writes a poem" }, hint: "Neuter: et dikt → diktet, plural dikt (unchanged). From å dikte, to make things up — a poet is en dikter." },
        { id: "no-u35l3-enhelt", type: "vocab", front: "en helt", reading: "enhelt", meaning: "hero", example: { jp: "I boka er en vanlig gutt helten.", en: "In the book, an ordinary boy is the hero." }, accept: ["a hero"], drill: { jp: "Gutten er en helt", en: "The boy is a hero" }, hint: "en helt → helten. Do not confuse it with the adverb helt, 'completely' — same spelling, different word." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u35l4-etspill", type: "vocab", front: "et spill", reading: "etspill", meaning: "game", example: { jp: "Vi spiller et spill sammen hver fredag.", en: "We play a game together every Friday." }, accept: ["a game", "play"], drill: { jp: "Vi spiller et spill", en: "We play a game" }, hint: "Neuter: et spill → spillet, plural spill (unchanged). The noun beside the A1 verb å spille, to play." },
        ...
        { id: "no-u35l4-ategne", type: "vocab", front: "å tegne", reading: "ategne", meaning: "to draw", example: { jp: "Datteren min tegner dyr når hun har fri.", en: "My daughter draws animals when she has time off." }, accept: ["draw", "to sketch"], drill: { jp: "Barna liker å tegne", en: "The children like to draw" }, hint: "å tegne → tegner. The g is silent: TAI-ne. A drawing is en tegning, and et tegn (A1) is a sign." },
