  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u35l4-amale", type: "vocab", front: "å male", reading: "amale", meaning: "to paint", example: { jp: "Faren min maler bilder på søndager, for da er han glad.", en: "My father paints pictures on Sundays, because he's happy then." }, accept: ["paint"], drill: { jp: "Jeg liker å male", en: "I like to paint" }, hint: "å male → maler. A painting is et maleri (this unit). Also to grind coffee, å male kaffe — the same spelling, a different verb." },
