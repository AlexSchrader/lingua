  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u35l4-amale", type: "vocab", front: "å male", reading: "amale", meaning: "to paint", example: { jp: "Faren min maler bilder på søndager, for han har god tid.", en: "My father paints pictures on Sundays, because he has plenty of time." }, accept: ["paint"], drill: { jp: "Jeg liker å male", en: "I like to paint" }, hint: "å male → maler. A painting is et maleri (this unit). Also to grind coffee, å male kaffe — the same spelling, a different verb." },
