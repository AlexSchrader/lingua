  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u34l4-eiutvikling", type: "vocab", front: "ei utvikling", reading: "eiutvikling", meaning: "development", example: { jp: "Utviklinga i byen har vært rask.", en: "The development in the city has been fast." }, accept: ["a development", "progress", "trend"], drill: { jp: "Ei utvikling tar mange år", en: "A development takes many years" }, hint: "Feminine: ei utvikling → utviklinga, plural utviklinger. You will also see en utvikling / utviklingen — Bokmål allows both for -ing nouns built on a verb, and this course writes ei so the definite -a is derivable. The endings that have NO feminine at all are -het and -else: en mulighet, en øvelse." },
        ...
        { id: "no-u34l4-enverdi", type: "vocab", front: "en verdi", reading: "enverdi", meaning: "value", example: { jp: "Huset har en høy verdi nå.", en: "The house has a high value now." }, accept: ["a value", "worth"], drill: { jp: "En verdi kan bli liten", en: "A value can become small" }, hint: "Masculine: en verdi → verdien, plural verdier. ver-DEE, stress at the end. From verd, worth. In the plural it also means values in the moral sense: norske verdier." },
      ],
    },
  ],
};
