  ...
  lessons: [
    {
      ...
      items: [
        { id: "no-u34l1-ennatur", type: "vocab", front: "en natur", reading: "ennatur", meaning: "nature", example: { jp: "Naturen i Norge er veldig fin.", en: "Nature in Norway is very beautiful." }, accept: ["the nature", "countryside"], drill: { jp: "En natur trenger rene elver", en: "Nature needs clean rivers" }, hint: "Masculine: en natur → naturen. Usually used in the definite — naturen — where English says just \"nature\". It also means someone's character: det ligger i naturen hans." },
        ...
        { id: "no-u34l1-eirot", type: "vocab", front: "ei rot", reading: "eirot", meaning: "root", example: { jp: "Røttene går dypt ned i jorda.", en: "The roots go deep down into the soil." }, accept: ["a root"], drill: { jp: "Ei rot ligger under jorda", en: "A root lies under the soil" }, hint: "Feminine: ei rot → rota, and the plural changes its vowel — røtter, definite røttene, exactly like fot → føtter. Also the root of a word or of a problem." },
        { id: "no-u34l1-etmenneske", type: "vocab", front: "et menneske", reading: "etmenneske", meaning: "human being", example: { jp: "Et menneske kan lære et nytt språk hele livet.", en: "A human being can learn a new language all their life." }, accept: ["a human", "a person", "human"], drill: { jp: "Et menneske trenger luft og vann", en: "A human being needs air and water" }, hint: "Neuter: et menneske → mennesket, plural mennesker. MEN-nes-ke. It is the neutral word for a person of any kind — en mann and ei kvinne are specific, et menneske is not." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u34l2-energi", type: "vocab", front: "energi", reading: "energi", meaning: "energy", example: { jp: "Vi bruker mye energi om vinteren.", en: "We use a lot of energy in the winter." }, accept: ["the energy", "power"], drill: { jp: "Energi koster mange penger nå", en: "Energy costs a lot of money now" }, hint: "Taught bare, as a mass noun — you do not usually count it. Masculine when it takes a definite: energien. e-ner-GEE, with a hard g and the stress at the end." },
      ],
    },
    {
      id: "no-u34l3",
      ...
      items: [
        ...
        { id: "no-u34l3-enforsker", type: "vocab", front: "en forsker", reading: "enforsker", meaning: "researcher", example: { jp: "En forsker jobber ofte på et universitet.", en: "A researcher often works at a university." }, accept: ["a scientist", "scholar"], drill: { jp: "En forsker leser mange bøker", en: "A researcher reads many books" }, hint: "Masculine: en forsker → forskeren, plural forskere. From å forske, to do research. Norwegian uses one word where English splits scientist and researcher." },
        ...
        { id: "no-u34l3-etbevis", type: "vocab", front: "et bevis", reading: "etbevis", meaning: "proof", example: { jp: "Vi har ikke et bevis for at dette er sant.", en: "We do not have proof that this is true." }, accept: ["evidence", "a proof"], drill: { jp: "Et bevis er ikke en teori", en: "Proof is not a theory" }, hint: "Neuter: et bevis → beviset, plural bevis — no ending. From å bevise, to prove. Also the certificate you are given: et førerbevis is a driving licence." },
        { id: "no-u34l3-enteori", type: "vocab", front: "en teori", reading: "enteori", meaning: "theory", example: { jp: "Jeg har en teori om hvorfor han er sen.", en: "I have a theory about why he is late." }, accept: ["a theory"], drill: { jp: "En teori trenger gode forsøk", en: "A theory needs good experiments" }, hint: "Masculine: en teori → teorien, plural teorier. te-o-REE, three syllables with the stress last. In practice is i praksis, its usual partner." },
      ],
    },
    {
      id: "no-u34l4",
      ...
      items: [
        { id: "no-u34l4-amale", type: "vocab", front: "å måle", reading: "amale", meaning: "to measure", example: { jp: "Vi måler hvor lang veien er.", en: "We measure how long the road is." }, accept: ["measure", "to gauge"], drill: { jp: "Vi begynner å måle et rom", en: "We start measuring a room" }, hint: "Present måler, said MAW-ler. Careful with the near-neighbours: å male with a short a is to paint, and et mål is both a goal and a measurement." },
        ...
        { id: "no-u34l4-enfart", type: "vocab", front: "en fart", reading: "enfart", meaning: "speed", example: { jp: "Bilen har for stor fart i gata.", en: "The car is going too fast in the street." }, accept: ["a speed", "pace", "velocity"], drill: { jp: "En fart kan bli stor", en: "A speed can become great" }, hint: "Masculine: en fart → farten. Usually in the definite: i farten, \"in a hurry\". Fartsgrense is a speed limit, and you will see the word on every Norwegian road sign." },
