  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u34l3-enforsker", type: "vocab", front: "en forsker", reading: "enforsker", meaning: "researcher", example: { jp: "En forsker jobber ofte på en skole.", en: "A researcher often works at a school." }, accept: ["a scientist", "scholar"], drill: { jp: "En forsker leser mange bøker", en: "A researcher reads many books" }, hint: "Masculine: en forsker → forskeren, plural forskere. From å forske, to do research. Norwegian uses one word where English splits scientist and researcher." },
