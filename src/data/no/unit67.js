...
// feminine. en angst, en depresjon, en selvtillit, en balanse are masculine;
// `hygiene` is a mass noun, taught bare per unit1.js §1b.
  ...
  lessons: [
    ...
    // you sleep.
    {
      ...
      items: [
        ...
        { id: "no-u67l3-mosjon", type: "vocab", front: "en mosjon", reading: "enmosjon", meaning: "exercise", example: { jp: "En liten tur hver dag er nok mosjon for de fleste.", en: "A short walk every day is enough exercise for most people." }, accept: ["exercise", "physical activity"], drill: { jp: "Dette er en mosjon som passer alle", en: "This is an exercise that suits everyone" }, hint: "Masculine and normally singular: mosjonen. Gentler than å trene (u21) — mosjon is the walk, trening is the gym." },
    ...
    // words a Norwegian uses when the feeling has lasted.
    {
      ...
      items: [
        ...
        { id: "no-u67l4-selvtillit", type: "vocab", front: "en selvtillit", reading: "enselvtillit", meaning: "self-confidence", example: { jp: "Selvtilliten kom tilbake da hun mestret arbeidet.", en: "Her self-confidence came back when she mastered the work." }, accept: ["self-confidence", "confidence", "self-esteem"], drill: { jp: "Han fikk en selvtillit han ikke hadde", en: "He got a self-confidence he did not have" }, hint: "selv + en tillit, trust in yourself. Masculine and normally singular: selvtilliten." },
      ],
    },
  ],
};
