  ...
  lessons: [
    ...
    // you sleep.
    {
      ...
      items: [
        ...
        { id: "no-u67l3-mosjon", type: "vocab", front: "en mosjon", reading: "enmosjon", meaning: "gentle exercise", example: { jp: "En liten tur hver dag er nok mosjon for de fleste.", en: "A short walk every day is enough exercise for most people." }, accept: ["exercise", "physical activity", "light exercise"], drill: { jp: "Dette er en mosjon som passer alle", en: "This is an exercise that suits everyone" }, hint: "Masculine and normally singular: mosjonen. Gentler than å trene (u21) — mosjon is the walk, trening is the gym." },
