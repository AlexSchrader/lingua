...
export const NO_UNIT48 = {
  ...
  lessons: [
    ...
    // Lesson 3: how a story is built.
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Talk about a story — roman, forfatter, kapittel, scene, sitat, sjanger — and say what kind of book somebody reads.",
      items: [
        ...
        { id: "no-u48l3-ensjanger", type: "vocab", front: "en sjanger", reading: "ensjanger", meaning: "genre", example: { jp: "Hun leser bare én sjanger, og det er romaner.", en: "She only reads one genre, and that is novels." }, accept: ["a genre", "a kind", "type"], drill: { jp: "Han liker en sjanger best", en: "He likes one genre best" }, hint: "SHANG-er — sj is the broad sh. Masculine: definite sjangeren, plural sjangere. French by way of Danish, so it does not look Norwegian." },
        { id: "no-u48l3-etsitat", type: "vocab", front: "et sitat", reading: "etsitat", meaning: "quotation", example: { jp: "Artikkelen begynner med et sitat fra boka.", en: "The article begins with a quotation from the book." }, accept: ["a quote", "a quotation"], drill: { jp: "Han skrev et sitat i boka", en: "He wrote a quotation in the book" }, hint: "si-TAAT. Neuter: definite sitatet, plural sitater. From å sitere, to quote somebody word for word." },
