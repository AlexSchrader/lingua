  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u94l4-eibrikke", type: "vocab", front: "ei brikke", reading: "eibrikke", meaning: "chip (microchip)", example: { jp: "Hele verden ventet på ei brikke som ble laget ett sted.", en: "The whole world was waiting for a chip that was made in one place." }, accept: ["a microchip", "a piece (in a game)"], drill: { jp: "Her mangler det ei brikke", en: "Here a chip is missing" }, hint: "ei brikke → brikka, flertall brikker. Du vil også se brikken i trykk. ⚠ Tre liv: i en datamaskin, i et spill (u35), og under et glass på bordet." },
