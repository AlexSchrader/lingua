  ...
  lessons: [
    // Lesson 1: the prepositions block 1 did not need. Function words first — unit7.js.
    {
      ...
      items: [
        ...
        { id: "no-u13l1-under", type: "vocab", front: "under", reading: "under", meaning: "under", example: { jp: "Katten sover under bordet.", en: "The cat is sleeping under the table." }, accept: ["below", "beneath", "during"], hint: "UN-der, with the tight u of gul rather than an English \"oo\". Also \"during\" — under middagen — and \"less than\" with a number: under ti." },
      ],
    },
    ...
    // Lesson 3: the six directional particles that build Norwegian's particle verbs.
    {
      ...
      items: [
        { id: "no-u13l3-ut", type: "vocab", front: "ut", reading: "ut", meaning: "out", example: { jp: "Vi går ut nå.", en: "We are going out now." }, accept: ["outside", "outward"], hint: "The tight u of gul, held long. Norwegian builds verbs by hanging a direction on the end — gå ut, komme ut, ta ut — and the particle carries most of the meaning, so six of them buy you dozens of verbs. ut is movement outward; already being outside is ute." },
        { id: "no-u13l3-inn", type: "vocab", front: "inn", reading: "inn", meaning: "in (movement)", example: { jp: "Kom inn!", en: "Come in!" }, accept: ["in", "inside", "inward", "into"], hint: "INN, the movement partner of ut. Already being inside is inne — the same pattern both ways round: ut/ute, inn/inne." },
        { id: "no-u13l3-opp", type: "vocab", front: "opp", reading: "opp", meaning: "up", example: { jp: "Bussen kjører opp til sykehuset.", en: "The bus drives up to the hospital." }, accept: ["upward", "upwards"], hint: "OPP. å stå opp is \"to get up\" in the morning, and one of the commonest particle verbs in the language. Already being up is oppe." },
        ...
        { id: "no-u13l3-bort", type: "vocab", front: "bort", reading: "bort", meaning: "away", example: { jp: "Erling reiser bort i morgen.", en: "Erling is going away tomorrow." }, accept: ["off"], hint: "BORT: movement away from here. Already being away is borte — which is also how Norwegian says something is lost or gone: telefonen er borte." },
