...
export const NO_UNIT13 = {
  ...
  lessons: [
    // Lesson 1: the prepositions block 1 did not need. Function words first — unit7.js.
    {
      ...
      items: [
        { id: "no-u13l1-med", type: "vocab", front: "med", reading: "med", meaning: "with", example: { jp: "Jeg kommer med bussen.", en: "I am coming by bus." }, accept: ["along with", "by"], hint: "The d is silent: MEH. It covers company (med Erling), instrument (med en kniv) and transport — and Norwegian says med bussen, med tog, where English says \"by bus\", \"by train\"." },
        { id: "no-u13l1-av", type: "vocab", front: "av", reading: "av", meaning: "of", example: { jp: "Erling er en av oss.", en: "Erling is one of us." }, accept: ["off", "by", "from"], hint: "AAV, with a soft v. This is \"of\" in the sense of belonging to a group — en av oss — and also \"off\": ta av deg skjorta. It is not the \"of\" of ownership; Norwegian does that with -s or with til." },
        { id: "no-u13l1-etter", type: "vocab", front: "etter", reading: "etter", meaning: "after", example: { jp: "Etter middagen går vi på kino.", en: "After dinner we are going to the cinema." }, accept: ["afterwards", "behind"], hint: "ET-ter, in time and in space both — etter middagen, etter deg. And look at the order: the etter-phrase is the first element, so går is second and vi comes behind it." },
        { id: "no-u13l1-for", type: "vocab", front: "før", reading: "for", meaning: "before", example: { jp: "Jeg spiser før jeg går.", en: "I eat before I leave." }, accept: ["earlier", "previously", "until"], hint: "FURR — the ø is folded to o in the answer key, so the key looks like for. They are different words and they sound different: før is FURR, for is FORR." },
        { id: "no-u13l1-over", type: "vocab", front: "over", reading: "over", meaning: "over", example: { jp: "Sola er over husene.", en: "The sun is above the houses." }, accept: ["above", "across", "more than"], hint: "AW-ver. It also means \"more than\" in front of a number — over ti — and \"finished\": Nå er det over." },
        { id: "no-u13l1-under", type: "vocab", front: "under", reading: "under", meaning: "under", example: { jp: "Katten sover under bordet.", en: "The cat is sleeping under the table." }, accept: ["below", "beneath", "during"], hint: "OON-der. Also \"during\" — under middagen — and \"less than\" with a number: under ti." },
      ],
    },
    // Lesson 2: the modals. Headworded in the infinitive; the hint carries the present.
    {
      ...
      items: [
        ...
        { id: "no-u13l2-amatte", type: "vocab", front: "å måtte", reading: "amatte", meaning: "must", example: { jp: "Nå må jeg gå.", en: "Now I have to go." }, accept: ["have to", "to have to", "to must"], hint: "Present må, said MAW. Plainer than English \"must\" — jeg må gå is simply \"I have to go\". Its negative is a trap worth learning now: jeg må ikke means \"I don't have to\", not \"I mustn't\". And note nå in the first slot, må second, jeg behind it." },
    ...
    // Lesson 3: the six directional particles that build Norwegian's particle verbs.
    {
      ...
      items: [
        { id: "no-u13l3-ut", type: "vocab", front: "ut", reading: "ut", meaning: "out", example: { jp: "Vi går ut nå.", en: "We are going out now." }, accept: ["outside", "outward"], hint: "OOT. Norwegian builds verbs by hanging a direction on the end — gå ut, komme ut, ta ut — and the particle carries most of the meaning, so six of them buy you dozens of verbs. ut is movement outward; already being outside is ute." },
        { id: "no-u13l3-inn", type: "vocab", front: "inn", reading: "inn", meaning: "in", example: { jp: "Kom inn!", en: "Come in!" }, accept: ["inside", "inward", "into"], hint: "INN, the movement partner of ut. Already being inside is inne — the same pattern both ways round: ut/ute, inn/inne." },
        { id: "no-u13l3-opp", type: "vocab", front: "opp", reading: "opp", meaning: "up", example: { jp: "Jeg står opp tidlig.", en: "I get up early." }, accept: ["upward", "upwards"], hint: "OPP. å stå opp is \"to get up\" in the morning, and one of the commonest particle verbs in the language. Already being up is oppe." },
        { id: "no-u13l3-ned", type: "vocab", front: "ned", reading: "ned", meaning: "down", example: { jp: "Vi går ned til torget.", en: "We are walking down to the square." }, accept: ["downward", "downwards"], hint: "NEH — silent d, like god and med. Sett deg ned is \"sit down\". Already being down is nede." },
        { id: "no-u13l3-bort", type: "vocab", front: "bort", reading: "bort", meaning: "away", example: { jp: "Erling går bort.", en: "Erling is walking away." }, accept: ["off"], hint: "BORT: movement away from here. Already being away is borte — which is also how Norwegian says something is lost or gone: telefonen er borte." },
        { id: "no-u13l3-tilbake", type: "vocab", front: "tilbake", reading: "tilbake", meaning: "back", example: { jp: "Vi kommer tilbake i morgen.", en: "We are coming back tomorrow." }, accept: ["backward", "backwards", "return"], hint: "til-BAA-ke, built from til + bake, \"to the back\". It is the particle of returning: komme tilbake, gå tilbake, ta tilbake." },
      ],
    },
    // Lesson 4: the verbs those particles attach to.
    {
      ...
      items: [
        { id: "no-u13l4-ata", type: "vocab", front: "å ta", reading: "ata", meaning: "to take", example: { jp: "Jeg tar bussen til skolen.", en: "I take the bus to school." }, accept: ["take", "to catch", "catch"], hint: "Present tar. As broad as English \"take\" — ta bussen, ta en kopp kaffe — and it multiplies with particles: ta på, ta av, ta ut, ta med (to bring along)." },
        { id: "no-u13l4-asta", type: "vocab", front: "å stå", reading: "asta", meaning: "to stand", example: { jp: "Bilen står i gata.", en: "The car is standing in the street." }, accept: ["stand", "to be standing"], hint: "Present står, STAWR. Norwegian is fussy where English just says \"is\": a car står, a knife ligger, a person sitter. Choosing the right one is one of the fastest ways to sound less foreign." },
        { id: "no-u13l4-asitte", type: "vocab", front: "å sitte", reading: "asitte", meaning: "to sit", example: { jp: "Vi sitter og spiser.", en: "We are sitting eating." }, accept: ["sit", "to be sitting"], hint: "Present sitter. Norwegian loves the frame sitte og + verb — sitter og spiser, sitter og snakker — where English uses a plain continuous. It is one action described from the posture, not two." },
        { id: "no-u13l4-aligge", type: "vocab", front: "å ligge", reading: "aligge", meaning: "to lie", example: { jp: "Bergen ligger i Norge.", en: "Bergen is in Norway." }, accept: ["lie", "to be lying", "to be situated", "be located"], hint: "Present ligger. It is where things lie flat — kniven ligger på bordet — and it is also how Norwegian says where a PLACE is: Bergen ligger i Norge, not \"Bergen er i Norge\"." },
        { id: "no-u13l4-abli", type: "vocab", front: "å bli", reading: "abli", meaning: "to become", example: { jp: "Erling blir lege.", en: "Erling is becoming a doctor." }, accept: ["become", "to stay", "stay", "to get", "get"], hint: "Present blir, said BLEER. Two jobs in one word — to become (han blir lege) and to stay (jeg blir her) — and what follows it tells you which." },
        { id: "no-u13l4-atrenge", type: "vocab", front: "å trenge", reading: "atrenge", meaning: "to need", example: { jp: "Jeg trenger en ny bil.", en: "I need a new car." }, accept: ["need", "to require", "require"], hint: "Present trenger. It nearly always takes a noun after it — jeg trenger tid, jeg trenger en lege. For \"need to do something\", Norwegian usually reaches for må instead." },
      ],
    },
  ],
};
