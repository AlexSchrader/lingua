  ...
  lessons: [
    ...
    // Lesson 2: the modals. Headworded in the infinitive; the hint carries the present.
    {
      ...
      items: [
        ...
        { id: "no-u13l2-aville", type: "vocab", front: "å ville", reading: "aville", meaning: "to want to", example: { jp: "Vil du ha kaffe?", en: "Would you like some coffee?" }, accept: ["want", "to want", "will", "would like"], drill: { jp: "Det er viktig å ville noe", en: "It is important to want something" }, hint: "Present vil. It is \"want\" first and \"will\" second. Vil du ha...? is how Norwegians offer you anything at all. No å after it either: jeg vil gå." },
        ...
        { id: "no-u13l2-amatte", type: "vocab", front: "å måtte", reading: "amatte", meaning: "must", example: { jp: "Nå må jeg gå.", en: "Now I have to go." }, accept: ["have to", "to have to", "to must"], drill: { jp: "Jeg liker ikke å måtte jobbe", en: "I do not like having to work" }, hint: "Present må, said MAW. Plainer than English \"must\" — jeg må gå is simply \"I have to go\". Its negative is genuinely ambiguous and worth care: du må ikke gjøre det is normally heard as a prohibition, \"you must not\", though context can pull it toward \"you need not\". When you mean \"I don't have to\", say jeg trenger ikke instead. And note nå in the first slot, må second, jeg behind it." },
        { id: "no-u13l2-aburde", type: "vocab", front: "bør", reading: "bor", meaning: "should", example: { jp: "Du bør sove nå.", en: "You should sleep now." }, drill: { jp: "Du bør sove mer", en: "You should sleep more" }, accept: ["ought to", "to ought to", "ought"], hint: "Present bør, BURR — the ø shows up in the present, not the infinitive. It is advice, where må is obligation: du bør sove is a suggestion; du må sove is not." },
    ...
    // Lesson 4: the verbs those particles attach to.
    {
      ...
      items: [
        ...
        { id: "no-u13l4-asta", type: "vocab", front: "å stå", reading: "asta", meaning: "to stand", example: { jp: "Bilen står i gata.", en: "The car is standing in the street." }, accept: ["stand", "to be standing"], drill: { jp: "Jeg begynner å stå opp tidlig", en: "I am starting to get up early" }, hint: "Present står, STAWR. Norwegian is fussy where English just says \"is\": a car står, a knife ligger, a person sitter. Choosing the right one is one of the fastest ways to sound less foreign." },
        ...
        { id: "no-u13l4-aligge", type: "vocab", front: "å ligge", reading: "aligge", meaning: "to lie", example: { jp: "Bergen ligger i Norge.", en: "Bergen is in Norway." }, accept: ["lie", "to be lying", "to be situated", "be located"], drill: { jp: "Jeg liker å ligge her", en: "I like lying here" }, hint: "Present ligger. It is where things lie flat — kniven ligger på bordet — and it is also the idiomatic way to say where a PLACE is: Bergen ligger i Norge. Bergen er i Norge is grammatical too, but a Norwegian reaches for ligger." },
        { id: "no-u13l4-abli", type: "vocab", front: "å bli", reading: "abli", meaning: "to become", example: { jp: "Erling blir lege.", en: "Erling is becoming a doctor." }, accept: ["become", "to stay", "stay", "to get", "get"], drill: { jp: "Kari begynner å bli trøtt", en: "Kari is starting to get tired" }, hint: "Present blir, said BLEER. Two jobs in one word — to become (han blir lege) and to stay (jeg blir her) — and what follows it tells you which." },
