...
export const NO_UNIT13 = {
  ...
  lessons: [
    // Lesson 1: the prepositions block 1 did not need. Function words first — unit7.js.
    {
      ...
      items: [
        { id: "no-u13l1-med", type: "vocab", front: "med", reading: "med", meaning: "with", example: { jp: "Jeg kommer med bussen.", en: "I am coming by bus." }, accept: ["along with", "by"], drill: { jp: "Jeg reiser med en buss", en: "I travel by bus" }, hint: "The d is silent: MEH. It covers company (med Erling), instrument (med en kniv) and transport — and Norwegian says med bussen, med tog, where English says \"by bus\", \"by train\"." },
    ...
    // Lesson 2: the modals. Headworded in the infinitive; the hint carries the present.
    {
      ...
      items: [
        ...
        { id: "no-u13l2-aville", type: "vocab", front: "å ville", reading: "aville", meaning: "to want to", example: { jp: "Vil du ha kaffe?", en: "Would you like some coffee?" }, accept: ["want", "to want", "will", "would like"], drill: { jp: "Det er lett å ville mye", en: "It is easy to want a lot" }, hint: "Present vil. It is \"want\" first and \"will\" second. Vil du ha...? is how Norwegians offer you anything at all. No å after it either: jeg vil gå." },
        { id: "no-u13l2-askulle", type: "vocab", front: "å skulle", reading: "askulle", meaning: "shall", example: { jp: "Vi skal reise i morgen.", en: "We are going to travel tomorrow." }, accept: ["will", "should", "to be going to", "going to"], drill: { jp: "Det er tungt å skulle reise", en: "It is hard to have to travel" }, hint: "Present skal. Norwegian has no future TENSE at all, and skal + infinitive is the commonest way to talk about what is going to happen — though it carries intention, and the plain present (jeg reiser i morgen) and vil both do future work too. At A1, skal is the one to reach for." },
    ...
    // Lesson 3: the six directional particles that build Norwegian's particle verbs.
    {
      ...
      items: [
        ...
        { id: "no-u13l3-ned", type: "vocab", front: "ned", reading: "ned", meaning: "down", example: { jp: "Vi går ned til torget.", en: "We are walking down to the square." }, accept: ["downward", "downwards"], drill: { jp: "Han går ned til en butikk", en: "He goes down to a shop" }, hint: "NEH — silent d, like god and med. Sett deg ned is \"sit down\". Already being down is nede." },
    ...
    // Lesson 4: the verbs those particles attach to.
    {
      ...
      items: [
        ...
        { id: "no-u13l4-abli", type: "vocab", front: "å bli", reading: "abli", meaning: "to become", example: { jp: "Erling blir lege.", en: "Erling is becoming a doctor." }, accept: ["become", "to stay", "stay", "to get", "get"], drill: { jp: "Det er hyggelig å bli her", en: "It is nice to stay here" }, hint: "Present blir, said BLEER. Two jobs in one word — to become (han blir lege) and to stay (jeg blir her) — and what follows it tells you which." },
        { id: "no-u13l4-atrenge", type: "vocab", front: "å trenge", reading: "atrenge", meaning: "to need", example: { jp: "Jeg trenger en ny bil.", en: "I need a new car." }, accept: ["need", "to require", "require"], drill: { jp: "Det er lett å trenge noe", en: "It is easy to need something" }, hint: "Present trenger. It nearly always takes a noun after it — jeg trenger tid, jeg trenger en lege. For \"need to do something\", Norwegian usually reaches for må instead." },
      ],
    },
  ],
};
