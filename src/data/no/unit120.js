  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u120l1-normal", type: "vocab", front: "normal", reading: "normal", meaning: "normal (within what is expected)", example: { jp: "Tallet er normalt for tida, men det er ikke normalt for et sted som ligger så høyt.", en: "The figure is normal for the time of year, but it is not normal for a place that lies so high." }, accept: ["normal", "within the norm"], drill: { jp: "Tallet er normal for denne tida", en: "The figure is normal for this time" }, hint: "normal → normalt, normale. ⚠ Forskjellen fra vanlig (u40) er en NORM: normal måler mot en fastsatt forventning, vanlig teller bare hvor ofte noe skjer. Derfor krever normal at du sier hva normen er." },
