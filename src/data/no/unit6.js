...
export const NO_UNIT6 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "no-u6l3-enfrokost", type: "vocab", front: "en frokost", reading: "enfrokost", meaning: "breakfast", example: { jp: "Jeg spiser frokost klokka åtte.", en: "I eat breakfast at eight o'clock." }, accept: ["a breakfast", "morning meal"], drill: { jp: "Vi lager en frokost sammen", en: "We are making a breakfast together" }, hint: "FROO-kost. Named meals drop the article after spise: spiser frokost, not \"spiser en frokost\"." },
        { id: "no-u6l3-enmiddag", type: "vocab", front: "en middag", reading: "enmiddag", meaning: "dinner", example: { jp: "Vi lager middag sammen.", en: "We are making dinner together." }, accept: ["a dinner", "main meal", "supper"], drill: { jp: "Erling lager en middag", en: "Erling is making a dinner" }, hint: "Literally \"midday\" — but Norwegians eat middag in the late afternoon, around four or five, not at noon." },
