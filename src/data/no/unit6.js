  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u6l1-enost", type: "vocab", front: "en ost", reading: "enost", meaning: "cheese", example: { jp: "En ost er ikke billig.", en: "Cheese is not cheap." }, accept: ["a cheese", "a whole cheese"], hint: "OOST. Masculine: definite osten. Brunost — brown cheese, sweet and caramelly — is the one Norwegians will make you try." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u6l3-alage", type: "vocab", front: "å lage", reading: "alage", meaning: "to make", example: { jp: "Kari lager en middag.", en: "Kari is making a dinner." }, accept: ["make", "to cook", "cook", "to prepare"], hint: "LAH-ge, hard g, present lager. It covers making and cooking both — å lage mat is simply \"to cook\"." },
        { id: "no-u6l3-asmake", type: "vocab", front: "å smake", reading: "asmake", meaning: "to taste", example: { jp: "En ost smaker godt.", en: "Cheese tastes good." }, accept: ["taste", "to try", "to sample"], hint: "SMAH-ke. Note godt, not god — after smaker the adjective is working as an adverb and takes -t." },
      ],
    },
    {
      id: "no-u6l4",
      ...
      items: [
        ...
        { id: "no-u6l4-enbutikk", type: "vocab", front: "en butikk", reading: "enbutikk", meaning: "shop", example: { jp: "Erling kjøper melk i en butikk.", en: "Erling buys milk in a shop." }, accept: ["a shop", "store", "a store"], hint: "bue-TIKK, stress on the end. Masculine: definite butikken." },
