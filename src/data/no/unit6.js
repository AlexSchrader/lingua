...
export const NO_UNIT6 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "no-u6l4-etbord", type: "vocab", front: "et bord", reading: "etbord", meaning: "table", example: { jp: "Vi har et bord i et rom.", en: "We have a table in a room." }, accept: ["a table", "desk", "board"], drill: { jp: "Et bord er i et kjøkken", en: "A table is in a kitchen" }, hint: "BOOR — the d is silent. Neuter: definite bordet, plural bord, unchanged." },
        { id: "no-u6l4-engaffel", type: "vocab", front: "en gaffel", reading: "engaffel", meaning: "fork", example: { jp: "Gi meg en gaffel, vær så snill.", en: "Give me a fork, please." }, accept: ["a fork"], drill: { jp: "En gaffel er ikke en kniv", en: "A fork is not a knife" }, hint: "GAF-fel, hard g. Masculine: definite gaffelen, plural gafler — the middle e drops out." },
        ...
        { id: "no-u6l4-eiskal", type: "vocab", front: "ei skål", reading: "eiskal", meaning: "bowl", example: { jp: "Jeg har ei skål og en kopp.", en: "I have a bowl and a cup." }, accept: ["a bowl", "dish", "a dish"], drill: { jp: "Ei skål er ikke ei skje", en: "A bowl is not a spoon" }, hint: "SKOL — sk before å is a hard sk, not the sh of skje. On its own, Skål! is what Norwegians say when they raise a glass." },
