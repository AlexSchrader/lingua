  ...
  lessons: [
    {
      ...
      items: [
        { id: "no-u6l1-etbrod", type: "vocab", front: "et brød", reading: "etbrod", meaning: "bread", example: { jp: "Jeg kjøper et brød.", en: "I am buying a loaf of bread." }, accept: ["a loaf", "loaf", "a loaf of bread"], drill: { jp: "Jeg kjøper et brød", en: "I am buying a loaf" }, hint: "BRUR. et brød is one whole loaf; the stuff in general is brød with no article. Neuter: definite brødet. The reading is hand-written etbrod — ø will not fold on its own." },
        { id: "no-u6l1-enost", type: "vocab", front: "en ost", reading: "enost", meaning: "cheese", example: { jp: "En ost er ikke billig.", en: "A cheese is not cheap." }, accept: ["a cheese", "a whole cheese"], drill: { jp: "En ost er ikke billig", en: "A cheese is not cheap" }, hint: "OOST. Masculine: definite osten. Brunost — brown cheese, sweet and caramelly — is the one Norwegians will make you try." },
        { id: "no-u6l1-eipolse", type: "vocab", front: "ei pølse", reading: "eipolse", meaning: "sausage", example: { jp: "Ei pølse er god.", en: "A sausage is good." }, accept: ["a sausage", "hot dog", "a hot dog"], drill: { jp: "Ei pølse er god", en: "A sausage is good" }, hint: "PURL-se. Feminine: definite pølsa. A pølse i lompe — in a soft potato flatbread — is the national street food." },
        { id: "no-u6l1-enfisk", type: "vocab", front: "en fisk", reading: "enfisk", meaning: "fish", example: { jp: "Erling kjøper en fisk.", en: "Erling is buying a fish." }, accept: ["a fish"], drill: { jp: "Erling kjøper en fisk", en: "Erling is buying a fish" }, hint: "Masculine: definite fisken, plural fisker. Laks, salmon, is the one Norway is famous for." },
        { id: "no-u6l1-eikake", type: "vocab", front: "ei kake", reading: "eikake", meaning: "cake", example: { jp: "Kari kjøper ei kake.", en: "Kari is buying a cake." }, accept: ["a cake", "pastry"], drill: { jp: "Kari kjøper ei kake", en: "Kari is buying a cake" }, hint: "KAH-ke. Feminine: definite kaka. Norwegians eat it with coffee, constantly." },
        { id: "no-u6l1-eteple", type: "vocab", front: "et eple", reading: "eteple", meaning: "apple", example: { jp: "Et eple er billig.", en: "An apple is cheap." }, accept: ["an apple"], drill: { jp: "Et eple er billig", en: "An apple is cheap" }, hint: "EP-le. Neuter: definite eplet, plural epler." },
      ],
    },
    {
      id: "no-u6l2",
      ...
      items: [
        ...
        { id: "no-u6l2-vann", type: "vocab", front: "vann", reading: "vann", meaning: "water", example: { jp: "Jeg drikker vann.", en: "I drink water." }, accept: ["the water"], drill: { jp: "Jeg drikker vann", en: "I drink water" }, hint: "VANN. No article — this is the mass-noun rule: et vann means a LAKE, not a glass of water. Neuter, so the definite is vannet." },
        { id: "no-u6l2-melk", type: "vocab", front: "melk", reading: "melk", meaning: "milk", example: { jp: "Kari kjøper melk.", en: "Kari is buying milk." }, accept: ["the milk"], drill: { jp: "Kari kjøper melk", en: "Kari is buying milk" }, hint: "MELK. No article either, for the same reason — you cannot have \"a milk\". Feminine, so the definite is melka." },
    ...
    },
    {
      ...
      items: [
        { id: "no-u6l3-enfrokost", type: "vocab", front: "en frokost", reading: "enfrokost", meaning: "breakfast", example: { jp: "Jeg spiser frokost klokka åtte.", en: "I eat breakfast at eight o'clock." }, accept: ["a breakfast", "morning meal"], drill: { jp: "En frokost er viktig", en: "A breakfast is important" }, hint: "FROO-kost. Named meals drop the article after spise: spiser frokost, not \"spiser en frokost\"." },
        { id: "no-u6l3-enmiddag", type: "vocab", front: "en middag", reading: "enmiddag", meaning: "dinner", example: { jp: "Vi lager middag sammen.", en: "We are making dinner together." }, accept: ["a dinner", "main meal", "supper"], drill: { jp: "Vi lager en middag", en: "We are making a dinner" }, hint: "Literally \"midday\" — but Norwegians eat middag in the late afternoon, around four or five, not at noon." },
        { id: "no-u6l3-sulten", type: "vocab", front: "sulten", reading: "sulten", meaning: "hungry", example: { jp: "Jeg er sulten nå.", en: "I am hungry now." }, accept: ["starving", "famished"], drill: { jp: "Jeg er sulten nå", en: "I am hungry now" }, hint: "SUEL-ten. Norwegian says you ARE hungry, like English and unlike French or Spanish — jeg er sulten, never \"jeg har\"." },
        { id: "no-u6l3-torst", type: "vocab", front: "tørst", reading: "torst", meaning: "thirsty", example: { jp: "Er du tørst?", en: "Are you thirsty?" }, accept: ["parched"], drill: { jp: "Er du tørst", en: "Are you thirsty" }, hint: "TURST — hand-folded reading again, torst. Same pattern as sulten: jeg er tørst." },
