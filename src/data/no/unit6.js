  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u6l1-eipolse", type: "vocab", front: "ei pølse", reading: "eipolse", meaning: "sausage", example: { jp: "Ei pølse er god.", en: "A sausage is good." }, accept: ["a sausage", "hot dog", "a hot dog"], hint: "PURL-se. Feminine: definite pølsa. A pølse i lompe — in a soft potato flatbread — is the national street food." },
        ...
        { id: "no-u6l1-eikake", type: "vocab", front: "ei kake", reading: "eikake", meaning: "cake", example: { jp: "Kari kjøper ei kake.", en: "Kari is buying a cake." }, accept: ["a cake", "pastry"], hint: "KAH-ke. Feminine: definite kaka. Norwegians eat it with coffee, constantly." },
