...
//
// GENDER: ei forelesning · ei innlevering · ei forskning · ei undersøkelse?
  ...
  lessons: [
    ...
    // Lesson 2: actually doing the studying.
    {
      ...
      items: [
        ...
        { id: "no-u74l2-notat", type: "vocab", front: "et notat", reading: "etnotat", meaning: "a note", example: { jp: "Notatene hans var bedre enn boka.", en: "His notes were better than the book." }, accept: ["note", "memo", "notes"], drill: { jp: "Han skrev et notat i timen", en: "He wrote a note in class" }, hint: "From å notere (u33). Neuter: notatet, flere notater. A written note you keep — a message to somebody else is en beskjed (u21)." },
    ...
    // research text.
    {
      ...
      items: [
        { id: "no-u74l3-forskning", type: "vocab", front: "ei forskning", reading: "eiforskning", meaning: "a research", example: { jp: "Forskninga viser at barn sover for lite.", en: "The research shows that children sleep too little." }, accept: ["research", "scientific work"], drill: { jp: "Forskninga er ei forskning fra Bergen", en: "The research is a research from Bergen" }, hint: "en forsker (u34) + -ning → feminine: forskninga. Usually uncountable, like English research, and nearly always said in the definite: forskninga viser …" },
        ...
        { id: "no-u74l3-analyse", type: "vocab", front: "ei analyse", reading: "eianalyse", meaning: "an analysis", example: { jp: "Analysen tok lengre tid enn de trodde.", en: "The analysis took longer than they thought." }, accept: ["analysis", "breakdown"], drill: { jp: "Vi gjorde ei analyse av tallene", en: "We did an analysis of the numbers" }, hint: "Feminine: analysen or analysa — both are in use, and this course marks ei. The verb å analysere is not taught separately; one word, one mastery track." },
