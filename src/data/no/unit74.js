...
// en tvil (å tvile, same lesson) · å bevise (et bevis u34) · ei tolkning
...
export const NO_UNIT74 = {
  ...
  lessons: [
    ...
    // research text.
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Follow a piece of research in Norwegian — what was investigated, what was found, in what field, and where it was published.",
      items: [
        ...
        { id: "no-u74l3-analyse", type: "vocab", front: "en analyse", reading: "enanalyse", meaning: "an analysis", example: { jp: "Analysen tok lengre tid enn de trodde.", en: "The analysis took longer than they thought." }, accept: ["analysis", "breakdown"], drill: { jp: "Vi gjorde en analyse av tallene", en: "We did an analysis of the numbers" }, hint: "⚠ MASCULINE: en analyse, analysen. The -e loanwords take en, not ei — the same class as en diagnose (u67) and en kilde (u54); analysa is not Bokmål. The verb å analysere is not taught separately; one word, one mastery track." },
        ...
        { id: "no-u74l3-apublisere", type: "vocab", front: "å publisere", reading: "apublisere", meaning: "to publish research", example: { jp: "Forskerne skal publisere resultatene til høsten.", en: "The researchers are going to publish the results in the autumn." }, drill: { jp: "De håper å publisere analysen snart", en: "They hope to publish the analysis soon" }, accept: ["publish", "to put out (in print)", "to release (a paper)"], hint: "pub-li-SE-re. Present publiserer, past publiserte. In research it is the whole point: et funn is not really a funn until somebody publiserer it where others can check it." },
      ],
    },
    // Lesson 4: drawing a conclusion, and the verbs of being careful about it.
    {
      ...
      items: [
        ...
        { id: "no-u74l4-anta", type: "vocab", front: "å anta", reading: "aanta", meaning: "to assume", example: { jp: "Vi antar at alle kommer i morgen.", en: "We assume that everyone is coming tomorrow." }, accept: ["assume", "to presume", "to suppose"], drill: { jp: "Det er lett å anta for mye", en: "It is easy to assume too much" }, hint: "an + å ta (u13): antar, antok, har antatt. The verb behind antakelig (u54) — \"assumable\", and so \"probably\"." },
        { id: "no-u74l4-tvile", type: "vocab", front: "å tvile", reading: "atvile", meaning: "to doubt", example: { jp: "Jeg tviler på at han kommer.", en: "I doubt that he is coming." }, accept: ["doubt", "to be doubtful", "to question"], drill: { jp: "Det er lov å tvile på noe", en: "It is allowed to doubt something" }, hint: "tviler, tvilte, and it takes på: tvile på noe. The noun en tvil is not taught separately — one word, one card." },
        ...
        { id: "no-u74l4-autlede", type: "vocab", front: "å utlede", reading: "autlede", meaning: "to derive a conclusion", example: { jp: "Fra disse tallene kan vi utlede en klar slutning.", en: "From these figures we can derive a clear conclusion." }, drill: { jp: "Det er mulig å utlede et svar", en: "It is possible to derive an answer" }, accept: ["to work out from evidence", "to infer", "to deduce"], hint: "UT-le-de. Ut plus lede, to lead — you lead the conclusion out of the numbers. Present utleder, past utledet. Å anta is a guess you have not earned; å utlede is one the evidence pays for." },
      ],
    },
  ],
};
