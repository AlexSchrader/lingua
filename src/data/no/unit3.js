  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u3l1-etnavn", type: "vocab", front: "et navn", reading: "etnavn", meaning: "name", example: { jp: "Erling er et navn.", en: "Erling is a name." }, accept: ["a name"], drill: { jp: "Erling er et navn i Norge", en: "Erling is a name in Norway" }, hint: "Neuter: definite navnet, and the plural is navn — unchanged. Short neuter nouns often do that." },
