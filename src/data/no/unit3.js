  ...
  lessons: [
    {
      ...
      items: [
        { id: "no-u3l1-ahete", type: "vocab", front: "heter", reading: "heter", meaning: "is called", example: { jp: "Jeg heter Erling.", en: "My name is Erling." }, drill: { jp: "Hva heter du", en: "What are you called" }, accept: ["be called", "to be named", "be named"], hint: "Norwegian does not say \"my name is\" — it says \"I am called\": jeg heter. Ask it back with hva heter du?" },
        { id: "no-u3l1-etnavn", type: "vocab", front: "et navn", reading: "etnavn", meaning: "name", example: { jp: "Erling er et navn.", en: "Erling is a name." }, accept: ["a name"], drill: { jp: "Vi lærer et navn", en: "We learn a name" }, hint: "Neuter: definite navnet, and the plural is navn — unchanged. Short neuter nouns often do that." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u3l2-etland", type: "vocab", front: "et land", reading: "etland", meaning: "country", example: { jp: "Norge er et land i Europa.", en: "Norway is a country in Europe." }, accept: ["a country", "land", "nation"], drill: { jp: "Vi bor i et land", en: "We live in a country" }, hint: "Neuter: definite landet, plural land — unchanged again. It also means \"land\" as opposed to sea." },
        ...
        { id: "no-u3l2-enby", type: "vocab", front: "en by", reading: "enby", meaning: "city", example: { jp: "Bergen er en by i Norge.", en: "Bergen is a city in Norway." }, accept: ["a city", "town", "a town"], drill: { jp: "Jeg bor i en by", en: "I live in a city" }, hint: "BUE, with the tight Norwegian y — say \"ee\" and round your lips. One word for both city and town; Norway has few big enough to argue about." },
    ...
    },
    {
      ...
      items: [
        { id: "no-u3l3-gammel", type: "vocab", front: "gammel", reading: "gammel", meaning: "old", example: { jp: "Hvor gammel er du?", en: "How old are you?" }, accept: ["aged", "elderly", "ancient"], drill: { jp: "Hvor gammel er Erling", en: "How old is Erling" }, hint: "hvor plus an adjective means \"how\" — hvor gammel, how old. That is how every measurement question is built." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u3l4-alike", type: "vocab", front: "å like", reading: "alike", meaning: "to like", example: { jp: "Jeg liker Oslo.", en: "I like Oslo." }, accept: ["like", "to enjoy", "enjoy", "to be fond of"], drill: { jp: "Det er mye å like her", en: "There is a lot to like here" }, hint: "LEE-ke, present liker. For stronger feeling there is å elske, to love." },
