...
export const NO_UNIT71 = {
  ...
  lessons: [
    ...
    // clearest marker of someone who has stopped translating from English.
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Colour a sentence the way a Norwegian does — with jo, vel and visst rather than with extra words.",
      items: [
        { id: "no-u71l1-jo", type: "vocab", front: "jo", reading: "jo", meaning: "you know", example: { jp: "Du kan jo spørre Erling om det.", en: "You could always ask Erling about it, you know." }, accept: ["after all", "of course", "yes (to a negative question)"], drill: { jp: "Du kan jo spørre Erling", en: "You could always ask Erling" }, hint: "Unstressed jo means \"as you and I both know\" and softens a suggestion. ⚠ Stressed and alone, Jo! is the word for YES to a NEGATIVE question — Kommer du ikke? Jo! Ja would be wrong there." },
        { id: "no-u71l1-vel", type: "vocab", front: "vel", reading: "vel", meaning: "presumably", example: { jp: "Du kommer vel i morgen?", en: "You are coming tomorrow, surely?" }, accept: ["surely", "I suppose", "I assume"], drill: { jp: "Du kommer vel i morgen", en: "You are coming tomorrow I assume" }, hint: "Turns a statement into a question you expect agreement with — English does this with a tag, \"…aren't you?\". Nothing to do with bra; vel is only ever this particle, plus the exclamation Vel!" },
        { id: "no-u71l1-visst", type: "vocab", front: "visst", reading: "visst", meaning: "apparently", example: { jp: "Han er visst syk i dag.", en: "He is apparently ill today." }, accept: ["I gather", "seemingly", "so I hear"], drill: { jp: "Han er visst syk i dag", en: "He is apparently ill today" }, hint: "Marks hearsay: I was told this, I did not see it. Norwegian does with one small word what English needs a whole clause for." },
        ...
        { id: "no-u71l1-visstnok", type: "vocab", front: "visstnok", reading: "visstnok", meaning: "reportedly", example: { jp: "Butikken er visstnok stengt i dag.", en: "The shop is reportedly closed today." }, accept: ["allegedly", "supposedly", "it is said"], drill: { jp: "Butikken er visstnok stengt i dag", en: "The shop is reportedly closed today" }, hint: "visst + nok (u10). A shade more formal than plain visst, and the word a newspaper uses when it has not checked something itself." },
      ],
    },
    // Lesson 2: the nominalization machine, run on verbs the learner already has.
    {
      ...
      items: [
        ...
        { id: "no-u71l2-oppfatning", type: "vocab", front: "ei oppfatning", reading: "eioppfatning", meaning: "a perception", example: { jp: "Mange har ei oppfatning av hva som er rett.", en: "Many people have a perception of what is right." }, accept: ["view", "opinion", "understanding"], drill: { jp: "Mange har ei oppfatning av saken", en: "Many people have a perception of the matter" }, hint: "å oppfatte (to grasp) + -ning → feminine: oppfatninga. Note the preposition: ei oppfatning AV noe." },
    ...
    // Lesson 3: -het, and the one gender rule it teaches six times over.
    {
      ...
      items: [
        ...
        { id: "no-u71l3-frihet", type: "vocab", front: "en frihet", reading: "enfrihet", meaning: "a freedom", example: { jp: "Frihet til å velge er viktig for alle.", en: "Freedom to choose is important for everyone." }, accept: ["freedom", "liberty"], drill: { jp: "Han fikk en frihet han ikke hadde", en: "He got a freedom he did not have" }, hint: "fri + -het. Masculine: friheten. Often used with no article at all in general statements — frihet er viktig." },
    ...
    // Lesson 4: adjective formation — u-, -lig, -ig, and the one that inflects.
    {
      ...
      items: [
        { id: "no-u71l4-umulig", type: "vocab", front: "umulig", reading: "umulig", meaning: "impossible", example: { jp: "Det er umulig å komme i dag.", en: "It is impossible to come today." }, accept: ["not possible"], drill: { jp: "Det er umulig å komme i dag", en: "It is impossible to come today" }, hint: "⚠ THE RULE OF THIS LESSON: u- is Norwegian's un-, and it is productive — mulig (u40) → umulig, enig → uenighet (u68), vanlig → uvanlig. And -ig adjectives NEVER add -t in the neuter: et umulig valg." },
        ...
        { id: "no-u71l4-tydelig", type: "vocab", front: "tydelig", reading: "tydelig", meaning: "clear to see", example: { jp: "Det er tydelig at hun er trøtt.", en: "It is clear that she is tired." }, accept: ["clear", "obvious", "distinct", "plain"], drill: { jp: "Det er tydelig at hun er trøtt", en: "It is clear that she is tired" }, hint: "å tyde (to read a sign) + -lig — the same verb behind å antyde (u70). Clear to the eye and to the ear alike: snakk tydelig." },
      ],
    },
  ],
};
