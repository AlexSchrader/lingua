  ...
  lessons: [
    ...
    // clearest marker of someone who has stopped translating from English.
    {
      ...
      items: [
        ...
        { id: "no-u71l1-vel", type: "vocab", front: "vel", reading: "vel", meaning: "surely", example: { jp: "Du kommer vel i morgen?", en: "You are coming tomorrow, surely?" }, accept: ["I suppose", "I assume", "presumably"], drill: { jp: "Du kommer vel i morgen", en: "You are coming tomorrow I assume" }, hint: "Turns a statement into a question you expect agreement with — English does this with a tag, \"…aren't you?\". Nothing to do with bra; vel is only ever this particle, plus the exclamation Vel!" },
    ...
    // Lesson 4: adjective formation — u-, -lig, -ig, and the one that inflects.
    {
      ...
      items: [
        ...
        { id: "no-u71l4-tydelig", type: "vocab", front: "tydelig", reading: "tydelig", meaning: "clear", example: { jp: "Det er tydelig at hun er trøtt.", en: "It is clear that she is tired." }, accept: ["obvious", "distinct", "plain"], drill: { jp: "Det er tydelig at hun er trøtt", en: "It is clear that she is tired" }, hint: "å tyde (to read a sign) + -lig — the same verb behind å antyde (u70). Clear to the eye and to the ear alike: snakk tydelig." },
      ],
    },
  ],
};
