  ...
  lessons: [
    ...
    // clearest marker of someone who has stopped translating from English.
    {
      ...
      items: [
        ...
        { id: "no-u71l1-jammen", type: "vocab", front: "jammen", reading: "jammen", meaning: "indeed (surprise)", example: { jp: "Jammen sa du at du skulle komme tidlig!", en: "But you did say you were going to come early!" }, accept: ["but", "well", "why"], drill: { jp: "Jammen sa du det", en: "But you did say so" }, hint: "Uformelt småord, mest muntlig. Uttrykker overraskelse eller mild protest. Skriftlig blir det gjerne men." },
      ],
    },
