...
export const NO_UNIT71 = {
  ...
  lessons: [
    ...
    // clearest marker of someone who has stopped translating from English.
    {
      ...
      items: [
        { id: "no-u71l1-vel", type: "vocab", front: "vel", reading: "vel", meaning: "I suppose", example: { jp: "Du kommer vel i morgen?", en: "You are coming tomorrow, surely?" }, accept: ["surely", "I suppose", "I assume", "presumably"], drill: { jp: "Du kommer vel i morgen", en: "You are coming tomorrow I assume" }, hint: "Turns a statement into a question you expect agreement with — English does this with a tag, \"…aren't you?\". Nothing to do with bra; vel is only ever this particle, plus the exclamation Vel!" },
        { id: "no-u71l1-visst", type: "vocab", front: "visst", reading: "visst", meaning: "I gather", example: { jp: "Han er visst syk i dag.", en: "He is apparently ill today." }, accept: ["I gather", "seemingly", "so I hear", "apparently"], drill: { jp: "Han er visst syk i dag", en: "He is apparently ill today" }, hint: "Marks hearsay: I was told this, I did not see it. Norwegian does with one small word what English needs a whole clause for." },
        ...
        { id: "no-u71l1-joda", type: "vocab", front: "jo da", reading: "joda", meaning: "sure (reassuring)", example: { jp: "Jo da, jeg husker deg godt fra før.", en: "Sure, I remember you well from before." }, drill: { jp: "Jo da han kommer helt sikkert", en: "Sure, he will definitely come" }, accept: ["oh yes", "sure enough", "yes of course", "don't worry"], hint: "YU-da, both words light. Jo answers a negative, and da softens it — together they calm somebody down: no, it really is fine. Nei da does the same job in reverse: no, really, it's nothing." },
      ],
    },
    // Lesson 2: the nominalization machine, run on verbs the learner already has.
    {
      ...
      items: [
        ...
        { id: "no-u71l2-enoppdagelse", type: "vocab", front: "en oppdagelse", reading: "enoppdagelse", meaning: "a discovery", example: { jp: "Forskerne gjorde en viktig oppdagelse i år.", en: "The researchers made an important discovery this year." }, drill: { jp: "Dette var en oppdagelse for oss alle", en: "This was a discovery for all of us" }, accept: ["a finding (something found)", "something discovered", "a revelation"], hint: "OPP-da-gel-se. Å oppdage plus -else, and -else is always masculine: definite oppdagelsen, plural oppdagelser. This is the pattern the lesson is teaching — take the verb, add the ending, get en." },
      ],
    },
    // Lesson 3: -het, and the one gender rule it teaches six times over.
    {
      ...
      items: [
        ...
        { id: "no-u71l3-enhemmelighet", type: "vocab", front: "en hemmelighet", reading: "enhemmelighet", meaning: "a secret", example: { jp: "Hun har en hemmelighet som ingen andre kjenner.", en: "She has a secret that nobody else knows." }, drill: { jp: "Han holder en hemmelighet for seg selv", en: "He keeps a secret to himself" }, accept: ["something kept quiet", "a confidence", "a thing untold"], hint: "HEM-me-li-het. Hemmelig plus -het, and -het is always masculine: definite hemmeligheten, plural hemmeligheter. Unlike the mass nouns beside it, this one you can count — en hemmelighet, to hemmeligheter." },
      ],
    },
    // Lesson 4: adjective formation — u-, -lig, -ig, and the one that inflects.
    {
      ...
      items: [
        ...
        { id: "no-u71l4-uavhengig", type: "vocab", front: "uavhengig", reading: "uavhengig", meaning: "independent", example: { jp: "Han er helt uavhengig av hjelp fra familien nå.", en: "He is completely independent of help from the family now." }, drill: { jp: "Hun er uavhengig av andre nå", en: "She is independent of others now" }, accept: ["not dependent", "self-reliant", "free of (someone)"], hint: "U-av-heng-i — silent g. U- plus avhengig, dependent, which is å henge, to hang, plus -ig: you are not hanging off anybody. No -t in the neuter, because -ig never takes one: et uavhengig land." },
      ],
    },
  ],
};
