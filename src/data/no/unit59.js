  ...
  lessons: [
    ...
    // reliably an insult.
    {
      ...
      items: [
        ...
        { id: "no-u59l2-ettiar", type: "vocab", front: "et tiår", reading: "ettiar", meaning: "a decade", example: { jp: "Vi har bodd her i et tiår, og nesten alt er nytt.", en: "We have lived here for a decade, and almost everything is new." }, drill: { jp: "Familien har bodd her i et tiår", en: "The family has lived here for a decade" }, accept: ["ten years", "a ten-year period"], hint: "TI-awr. Ti plus år. Neuter: definite tiåret, and the plural is tiår with no ending, exactly like år itself. Et århundre is a hundred of these." },
      ],
    },
    ...
    // a pessimist.
    {
      ...
      items: [
        ...
        { id: "no-u59l3-bratt", type: "vocab", front: "brått", reading: "bratt", meaning: "abruptly", example: { jp: "Alt forandret seg brått da krisa kom til byen.", en: "Everything changed abruptly when the crisis came to the city." }, drill: { jp: "Bilen stoppet brått i veien", en: "The car stopped abruptly in the road" }, accept: ["suddenly", "all at once", "without warning"], hint: "BROTT, short. It is the neuter form of brå, and the neuter is what does the adverb work — so brått is what you will say and write. Plutselig is the same idea; brått adds a jolt." },
      ],
    },
