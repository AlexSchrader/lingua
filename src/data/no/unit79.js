  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u79l2-einedbetaling", type: "vocab", front: "ei nedbetaling", reading: "einedbetaling", meaning: "repayment", example: { jp: "Nedbetalinga på huset tar mange år.", en: "The repayment on the house takes many years." }, accept: ["paying off", "instalment plan"], drill: { jp: "Vi har ei nedbetaling hver måned", en: "We have a repayment every month" }, hint: "ned + å betale + -ing → hunkjønn: nedbetalinga (også nedbetalingen, som du vil se i aviser). Selve det å betale ned et lån, over tid." },
