  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u79l2-okonomisk", type: "vocab", front: "økonomisk", reading: "okonomisk", meaning: "financial", example: { jp: "Familien har en vanskelig økonomisk tid nå.", en: "The family is having a difficult financial time now." }, drill: { jp: "Dette er en økonomisk god løsning", en: "This is a financially good solution" }, accept: ["economic", "money-related", "financially"], hint: "oe-ko-NO-misk. No -t in the neuter, because -sk never takes one: et økonomisk problem. It does the adverb job unchanged too — økonomisk vanskelig. En økonomi is the noun underneath it." },
      ],
    },
    {
      id: "no-u79l3",
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Talk about borrowed money — the instalments, the debt, the deposit, and what happens when a bill goes to collection.",
      items: [
        ...
        { id: "no-u79l3-inkasso", type: "vocab", front: "inkasso", reading: "inkasso", meaning: "debt collection", example: { jp: "Regninga gikk til inkasso fordi han ikke betalte i tide.", en: "The bill went to debt collection because he did not pay in time." }, drill: { jp: "Regninga gikk til inkasso i går", en: "The bill went to debt collection yesterday" }, accept: ["collections", "a debt collector's case", "recovery of a debt"], hint: "in-KAS-so. Taught bare, like penger, because you never say \"en inkasso\" — it is the stage a bill reaches, not a thing you count. Masculine when it does take an ending: inkassoen. Å sende noe til inkasso is the step after a purring, and it adds cost." },
      ],
    },
    {
      id: "no-u79l4",
      ...
      items: [
        ...
        { id: "no-u79l4-enavtalegiro", type: "vocab", front: "en avtalegiro", reading: "enavtalegiro", meaning: "a direct debit", example: { jp: "Med en avtalegiro blir regninga betalt automatisk hver måned.", en: "With a direct debit the bill gets paid automatically every month." }, drill: { jp: "Hun betaler regninga med en avtalegiro", en: "She pays the bill with a direct debit" }, accept: ["a standing payment agreement", "an automatic payment", "a bank mandate"], hint: "AV-ta-le-ji-ro. En avtale plus en giro, so masculine after giro: definite avtalegiroen. The bank pays the bill for you on the day it falls due, which is how Norwegians handle et abonnement they never want to think about again." },
      ],
    },
  ],
};
