  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "no-u82l1-eisag", type: "vocab", front: "ei sag", reading: "eisag", meaning: "a saw (tool)", example: { jp: "Han lånte ei sag av naboen for å dele treet.", en: "He borrowed a saw from the neighbour to cut the tree in two." }, accept: ["a handsaw", "saw", "saw"], drill: { jp: "Han lånte ei sag av naboen", en: "He borrowed a saw from the neighbour" }, hint: "ei sag → saga, flertall sager. Verbet å sage. Ei motorsag er the chainsaw." },
