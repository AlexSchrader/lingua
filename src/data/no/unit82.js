  ...
  lessons: [
    {
      ...
      items: [
        { id: "no-u82l1-etverktoy", type: "vocab", front: "et verktøy", reading: "etverktoy", meaning: "tool", example: { jp: "Alt verktøyet ligger nede i kjelleren i en kasse.", en: "All the tools are down in the basement in a box." }, accept: ["a tool", "tools", "equipment"], drill: { jp: "Dette er et verktøy du trenger", en: "This is a tool you need" }, hint: "et verktøy → verktøyet, flertall verktøy. Brukes ofte som massesubstantiv: alt verktøyet. Et verk + et tøy." },
        ...
        { id: "no-u82l1-eisag", type: "vocab", front: "ei sag", reading: "eisag", meaning: "saw", example: { jp: "Han lånte ei sag av naboen for å dele treet.", en: "He borrowed a saw from the neighbour to cut the tree in two." }, accept: ["a handsaw"], drill: { jp: "Han lånte ei sag av naboen", en: "He borrowed a saw from the neighbour" }, hint: "ei sag → saga, flertall sager. Verbet å sage. Ei motorsag er the chainsaw." },
        { id: "no-u82l1-enstige", type: "vocab", front: "en stige", reading: "enstige", meaning: "ladder", example: { jp: "Stigen er ikke lang nok til å nå opp til taket.", en: "The ladder isn't long enough to reach up to the roof." }, accept: ["a stepladder"], drill: { jp: "Vi må ha en stige her", en: "We have to have a ladder here" }, hint: "en stige → stigen, flertall stiger. Fra å stige, to climb. Ikke forveksl med en sti (neste enhet), a path." },
      ],
    },
    {
      id: "no-u82l2",
      ...
      items: [
        { id: "no-u82l2-enspiker", type: "vocab", front: "en spiker", reading: "enspiker", meaning: "nail", example: { jp: "Det står en spiker ut av veggen, så vær forsiktig.", en: "There's a nail sticking out of the wall, so be careful." }, accept: ["a tack"], drill: { jp: "Det står en spiker ut", en: "There is a nail sticking out" }, hint: "en spiker → spikeren, flertall spikre eller spiker. Å spikre er verbet. En negl (u11) er neglen på fingeren — to helt ulike ord." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u82l3-afeste", type: "vocab", front: "å feste", reading: "afeste", meaning: "to fasten", example: { jp: "Vi festet hylla i veggen med fire lange skruer.", en: "We fastened the shelf to the wall with four long screws." }, accept: ["to attach", "to secure", "fasten"], drill: { jp: "Det er viktig å feste alt godt", en: "It is important to fasten everything properly" }, hint: "å feste → fester, festet. Fast (u21) er adjektivet. Et feste er the fixing point; en fest er a party — annet ord." },
        ...
        { id: "no-u82l3-afikse", type: "vocab", front: "å fikse", reading: "afikse", meaning: "to fix", example: { jp: "Han fikser alt selv, og det tar alltid lengre tid.", en: "He fixes everything himself, and it always takes longer." }, accept: ["to sort out", "to repair", "fix"], drill: { jp: "Han begynner å fikse alt selv", en: "He starts fixing everything himself" }, hint: "å fikse → fikser. Uformelt; å reparere (u80) er ordet på verkstedet. Å fikse opp = to do up a place." },
        { id: "no-u82l3-aerstatte", type: "vocab", front: "å erstatte", reading: "aerstatte", meaning: "to replace", example: { jp: "Vi må erstatte hele døra, for den er altfor gammel.", en: "We have to replace the whole door, because it's far too old." }, accept: ["to substitute", "to compensate", "replace"], drill: { jp: "Det er dyrt å erstatte hele døra", en: "It is expensive to replace the whole door" }, hint: "å erstatte → erstatter. Også to compensate somebody: forsikringa erstatter skaden. Ei erstatning er begge deler." },
