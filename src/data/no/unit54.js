  ...
  lessons: [
    ...
    // a machine that works — is one the learner meets daily.
    {
      ...
      items: [
        ...
        { id: "no-u54l1-tydeligvis", type: "vocab", front: "tydeligvis", reading: "tydeligvis", meaning: "evidently", example: { jp: "Lyset er av, og han er tydeligvis ikke hjemme.", en: "The light is off, and he is evidently not at home." }, drill: { jp: "Hun er tydeligvis ikke hjemme nå", en: "She is evidently not at home now" }, accept: ["clearly (by the look of it)", "obviously", "plainly", "by all appearances"], hint: "TUE-de-li-vis. Tydelig (u51) plus the -vis that makes vanligvis: you are reading it off the evidence, not off the thing itself. Weaker than åpenbart — you saw a sign, not the fact." },
      ],
    },
    ...
    // pattern, and å stole PÅ in l4 closes the set.
    {
      ...
      items: [
        ...
        { id: "no-u54l2-vag", type: "vocab", front: "vag", reading: "vag", meaning: "vague", example: { jp: "Planen er fortsatt vag, og ingen vet hva vi skal gjøre.", en: "The plan is still vague, and nobody knows what we are going to do." }, drill: { jp: "Planen hans er ganske vag", en: "His plan is rather vague" }, accept: ["woolly", "unclear", "fuzzy", "imprecise"], hint: "VAAG, long a. Neuter vagt, plural vage. Usikker is you not knowing; vag is the THING not being sharp enough to know. Et vagt svar tells you almost nothing." },
      ],
    },
    ...
    // as a grammatical one. eventuelt is last and carries the false-friend warning.
    {
      ...
      items: [
        ...
        { id: "no-u54l3-ensmule", type: "vocab", front: "en smule", reading: "ensmule", meaning: "a tad", example: { jp: "Jeg er en smule usikker på svaret her.", en: "I am a tad unsure about the answer here." }, drill: { jp: "Han er en smule usikker nå", en: "He is a tad unsure now" }, accept: ["a touch", "slightly", "a little bit", "somewhat"], hint: "SMU-le. Masculine: definite smulen, plural smuler — a smule is a crumb, so \"a crumb of\". Drier and more written than litt, and it softens whatever follows it." },
      ],
    },
    ...
    // asking the question the other four raise: do you believe it?
    {
      ...
      items: [
        ...
        { id: "no-u54l4-anonym", type: "vocab", front: "anonym", reading: "anonym", meaning: "anonymous", example: { jp: "Kilden er anonym, og avisa skriver ikke navnet.", en: "The source is anonymous, and the newspaper does not print the name." }, drill: { jp: "Brevet kom fra en anonym person", en: "The letter came from an anonymous person" }, accept: ["unnamed", "nameless", "without a name"], hint: "a-no-NUEM. Neuter anonymt, plural anonyme. An anonym kilde is the reason a claim can be true and unverifiable at the same time — weigh it against pålitelig." },
      ],
    },
  ],
};
