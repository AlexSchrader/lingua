  ...
  lessons: [
    ...
    // a machine that works — is one the learner meets daily.
    {
      ...
      items: [
        ...
        { id: "no-u54l1-atydepa", type: "vocab", front: "å tyde på", reading: "atydepa", meaning: "to indicate", example: { jp: "Alt tyder på at det blir kaldt i morgen.", en: "Everything indicates that it will be cold tomorrow." }, accept: ["to suggest", "to point to", "to indicate that"], drill: { jp: "Mye ser ut til å tyde på det", en: "A lot seems to indicate that" }, hint: "å tyde på → tyder på, tydet på. Brukes om tegn og tall, ikke om personer: DU sier noe, men tallene tyder på noe." },
      ],
    },
