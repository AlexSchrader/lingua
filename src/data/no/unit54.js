  ...
  lessons: [
    ...
    // a machine that works — is one the learner meets daily.
    {
      ...
      items: [
        ...
        { id: "no-u54l1-aanta", type: "vocab", front: "å anta", reading: "aanta", meaning: "to assume", example: { jp: "Jeg antar at han kommer i morgen.", en: "I assume that he is coming tomorrow." }, drill: { jp: "Det er lett å anta noe her", en: "It is easy to assume something here" }, accept: ["assume", "to presume", "presume", "to suppose"], hint: "AN-ta. An-, an old prefix, plus ta — to take a thing as given. Present antar, past antok. Jeg antar det is the Norwegian shrug: \"I suppose so\"." },
        { id: "no-u54l1-sannsynlig", type: "vocab", front: "sannsynlig", reading: "sannsynlig", meaning: "likely", example: { jp: "Det er sannsynlig at det regner i kveld.", en: "It is likely that it will rain this evening." }, drill: { jp: "Det er sannsynlig at han kommer", en: "It is likely that he is coming" }, accept: ["probable", "plausible", "likely to happen"], hint: "sann-SUEN-li — silent g. Sann, true, plus synlig, visible: it LOOKS true. Neuter sannsynlig, plural sannsynlige. Sannsynligvis is the adverb, probably." },
    ...
    // pattern, and å stole PÅ in l4 closes the set.
    {
      ...
      items: [
        { id: "no-u54l2-atvile", type: "vocab", front: "å tvile", reading: "atvile", meaning: "to doubt", example: { jp: "Jeg tviler på at han kommer i dag.", en: "I doubt that he is coming today." }, drill: { jp: "Det er lett å tvile på noe", en: "It is easy to doubt something" }, accept: ["doubt", "to be doubtful", "to question", "doubt it"], hint: "TVI-le. Present tviler, past tvilte. ⚠ Always with på: jeg tviler PÅ det. En tvil is the noun, and i tvil means in doubt." },
        { id: "no-u54l2-alure", type: "vocab", front: "å lure", reading: "alure", meaning: "to wonder", example: { jp: "Jeg lurer på hva han mener om saka.", en: "I wonder what he thinks about the matter." }, drill: { jp: "Jeg begynner å lure på noe", en: "I am starting to wonder about something" }, accept: ["wonder", "to wonder about", "to be curious", "to trick"], hint: "LU-re. Present lurer, past lurte. ⚠ Two meanings in one word, and the preposition tells you which: å lure PÅ noe is to wonder about it, å lure NOEN is to trick them." },
    ...
    // as a grammatical one. eventuelt is last and carries the false-friend warning.
    {
      ...
      items: [
        ...
        { id: "no-u54l3-snarere", type: "vocab", front: "snarere", reading: "snarere", meaning: "more like", example: { jp: "Det er ikke dyrt, snarere billig.", en: "It is not expensive, more like cheap." }, drill: { jp: "Han er snarere trøtt enn syk", en: "He is tired rather than ill" }, accept: ["rather", "if anything", "instead", "sooner", "rather than"], hint: "SNA-re-re. The comparative of snar, quick — \"sooner\", as in \"I'd sooner say\". The frame is snarere X enn Y: snarere trøtt enn syk." },
        ...
        { id: "no-u54l3-liksom", type: "vocab", front: "liksom", reading: "liksom", meaning: "sort of", example: { jp: "Han var liksom ikke helt sikker.", en: "He was sort of not entirely sure." }, drill: { jp: "Hun er liksom ikke sikker", en: "She is sort of not sure" }, accept: ["kind of", "like", "as it were", "supposedly"], hint: "LIK-som. Lik plus som, \"alike as\". Two lives: the filler that softens a statement, exactly like English \"like\", and a sharper one meaning \"supposedly\" — han skulle liksom hjelpe, he was supposed to help." },
    ...
    // asking the question the other four raise: do you believe it?
    {
      ...
      items: [
        { id: "no-u54l4-ifolge", type: "vocab", front: "ifølge", reading: "ifolge", meaning: "according to", example: { jp: "Ifølge avisa regner det i morgen.", en: "According to the newspaper it will rain tomorrow." }, drill: { jp: "Ifølge legen er han frisk", en: "According to the doctor he is healthy" }, accept: ["as stated by", "per", "going by", "on the authority of"], hint: "i-FUL-le. I plus følge, in the following of — you are walking behind what they said. ⚠ It fronts the clause and V2 follows: Ifølge avisa REGNER det — verb straight after, never *Ifølge avisa det regner. One word, never two." },
        ...
        { id: "no-u54l4-astole", type: "vocab", front: "å stole", reading: "astole", meaning: "to trust", example: { jp: "Du kan stole på Erling i denne saka.", en: "You can trust Erling in this matter." }, drill: { jp: "Det er lett å stole på henne", en: "It is easy to trust her" }, accept: ["trust", "to rely on", "rely on", "to count on"], hint: "STO-le. Present stoler, past stolte. ⚠ Always with på: jeg stoler PÅ deg. Nothing whatever to do with en stol, a chair — the words only meet by accident." },
