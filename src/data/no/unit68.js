  ...
  lessons: [
    ...
    // the one that ends.
    {
      ...
      items: [
        ...
        { id: "no-u68l3-omsorg", type: "vocab", front: "en omsorg", reading: "enomsorg", meaning: "a care", example: { jp: "Omsorgen for de gamle er kommunens ansvar.", en: "Care for the elderly is the municipality's responsibility." }, accept: ["care", "caring", "nurture"], drill: { jp: "Vi trenger en omsorg som varer", en: "We need a care that lasts" }, hint: "om + sorg (sorrow) — caring about. Masculine and normally singular: omsorgen. Omsorg is a big political word in Norway, not only a private one." },
