...
//
// GENDER: en tillit, en konflikt, en omsorg, en rettighet are MASCULINE — note
  ...
  lessons: [
    // Lesson 1: what a close relationship is made of, and what breaks it.
    {
      ...
      items: [
        ...
        { id: "no-u68l1-tillit", type: "vocab", front: "en tillit", reading: "entillit", meaning: "a trust", example: { jp: "Tilliten til naboene ble mindre etter den saken.", en: "The trust in the neighbours got smaller after that business." }, accept: ["trust", "confidence"], drill: { jp: "Vi har en tillit til hverandre", en: "We have a trust in each other" }, hint: "til + å lite (to rely). Masculine and normally singular: tilliten. Norway runs on it — høy tillit is how Norwegians describe their own society." },
        { id: "no-u68l1-stolepa", type: "vocab", front: "å stole på", reading: "astolepa", meaning: "to trust", example: { jp: "Du kan stole på henne når det gjelder.", en: "You can trust her when it matters." }, accept: ["trust", "to rely on", "to count on"], drill: { jp: "Det er godt å stole på noen", en: "It is good to trust someone" }, hint: "stoler på, stolte på. Always with på — and nothing to do with en stol (u16), which just happens to look the same." },
        ...
        { id: "no-u68l1-svikte", type: "vocab", front: "å svikte", reading: "asvikte", meaning: "to let down", example: { jp: "Han sviktet vennen sin da det ble tungt.", en: "He let his friend down when it got tough." }, accept: ["let down", "to fail", "to betray"], drill: { jp: "Det er lett å svikte en venn", en: "It is easy to let a friend down" }, hint: "svikter, sviktet. Strong word — heavier than å skuffe (u64's skuffende). It is also what a bridge or a knee does when it gives way." },
      ],
    },
    // Lesson 2: the falling-out, and the way back from it.
    {
      ...
      items: [
        ...
        { id: "no-u68l2-tilgi", type: "vocab", front: "å tilgi", reading: "atilgi", meaning: "to forgive", example: { jp: "Hun tilga ham, men hun glemte det aldri.", en: "She forgave him, but she never forgot it." }, accept: ["forgive", "to pardon"], drill: { jp: "Det er ikke lett å tilgi noen", en: "It is not easy to forgive someone" }, hint: "til + å gi (u13) — the same picture as English \"forgive\". It follows gi: tilgir, tilga, har tilgitt. The noun is en tilgivelse." },
      ],
    },
    ...
    // the one that ends.
    {
      ...
      items: [
        ...
        { id: "no-u68l3-omsorg", type: "vocab", front: "en omsorg", reading: "enomsorg", meaning: "care for someone", example: { jp: "Omsorgen for de gamle er kommunens ansvar.", en: "Care for the elderly is the municipality's responsibility." }, accept: ["care", "caring", "nurture", "a care"], drill: { jp: "Vi trenger en omsorg som varer", en: "We need a care that lasts" }, hint: "om + sorg (sorrow) — caring about. Masculine and normally singular: omsorgen. Omsorg is a big political word in Norway, not only a private one." },
    ...
    // Lesson 4: the wider circle — belonging to something bigger than a family.
    {
      ...
      items: [
        ...
        { id: "no-u68l4-likestilling", type: "vocab", front: "ei likestilling", reading: "eilikestilling", meaning: "an equality", example: { jp: "Likestillinga for kvinner og menn kom sakte.", en: "Equality for women and men came slowly." }, accept: ["equality", "equal rights", "gender equality"], drill: { jp: "Vi trenger ei likestilling som varer", en: "We need an equality that lasts" }, hint: "lik (equal) + ei stilling (u24) — being placed alike. -ing → feminine: likestillinga. In Norwegian it means gender equality unless something else is said." },
        { id: "no-u68l4-rettighet", type: "vocab", front: "en rettighet", reading: "enrettighet", meaning: "a right", example: { jp: "Alle har en rettighet til skole i Norge.", en: "Everyone has a right to school in Norway." }, accept: ["right", "entitlement"], drill: { jp: "Alle har en rettighet til skole", en: "Everyone has a right to school" }, hint: "en rett (u32) + -ig + -het. ⚠ -het is MASCULINE: rettigheten, flere rettigheter. Never ei rettighet." },
      ],
    },
  ],
};
