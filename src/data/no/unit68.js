  ...
  lessons: [
    ...
    // Lesson 4: the wider circle — belonging to something bigger than a family.
    {
      ...
      items: [
        ...
        { id: "no-u68l4-rettighet", type: "vocab", front: "en rettighet", reading: "enrettighet", meaning: "a right", example: { jp: "Retten til skole er en rettighet i Norge.", en: "The right to school is an entitlement in Norway." }, accept: ["right", "entitlement"], drill: { jp: "Skole er en rettighet i Norge", en: "School is an entitlement in Norway" }, hint: "en rett (u32) + -ig + -het. ⚠ -het is MASCULINE: rettigheten, flere rettigheter. Never ei rettighet." },
      ],
    },
  ],
};
