  ...
  lessons: [
    {
      ...
      items: [
        { id: "no-u40l1-aoppleve", type: "vocab", front: "å oppleve", reading: "aoppleve", meaning: "to experience", example: { jp: "Vi opplever ofte at været skifter fort her.", en: "We often experience the weather changing quickly here." }, accept: ["experience", "to go through"], drill: { jp: "Det er fint å oppleve mye", en: "It's nice to experience a lot" }, hint: "å oppleve → opplever. opp + leve, 'live through'. The noun en opplevelse is an experience." },
        ...
        { id: "no-u40l1-aforandre", type: "vocab", front: "å forandre", reading: "aforandre", meaning: "to change", example: { jp: "Livet kan forandre seg fort når vi minst venter det.", en: "Life can change quickly when we least expect it." }, accept: ["to alter", "change"], drill: { jp: "Vi prøver å forandre alt", en: "We try to change everything" }, hint: "å forandre → forandrer. Reflexive forandre seg = to change (of itself). Literally 'to make other', for + andre (u1)." },
        { id: "no-u40l1-abety", type: "vocab", front: "å bety", reading: "abety", meaning: "to mean", example: { jp: "Hva betyr dette ordet på norsk?", en: "What does this word mean in Norwegian?" }, accept: ["to signify", "mean"], drill: { jp: "Det er fint å bety noe for noen", en: "It's nice to mean something to someone" }, hint: "å bety → betyr (no extra -er). The noun en betydning, a meaning, is in this unit." },
        { id: "no-u40l1-aforetrekke", type: "vocab", front: "å foretrekke", reading: "aforetrekke", meaning: "to prefer", example: { jp: "Jeg foretrekker kaffe, men mannen min liker vann best.", en: "I prefer coffee, but my husband likes water best." }, accept: ["prefer", "to rather"], drill: { jp: "Det er lett å foretrekke kaffe", en: "It's easy to prefer coffee" }, hint: "å foretrekke → foretrekker. Literally 'pull forth', fore + trekke. Present is regular even though the verb is strong elsewhere." },
        { id: "no-u40l1-aangre", type: "vocab", front: "å angre", reading: "aangre", meaning: "to regret", example: { jp: "Jeg angrer på at jeg ikke sa noe.", en: "I regret that I didn't say anything." }, accept: ["regret", "to be sorry"], drill: { jp: "Det er lett å angre på alt", en: "It's easy to regret everything" }, hint: "å angre → angrer. angre på noe = to regret something. Stronger than å beklage (A1), to be sorry / apologise." },
      ],
    },
    {
      id: "no-u40l2",
      ...
      items: [
        ...
        { id: "no-u40l2-atilby", type: "vocab", front: "å tilby", reading: "atilby", meaning: "to offer", example: { jp: "Butikken tilbyr gratis kaffe til alle kundene i dag.", en: "The shop offers free coffee to all its customers today." }, accept: ["offer", "to provide"], drill: { jp: "Det er fint å tilby hjelp", en: "It's nice to offer help" }, hint: "å tilby → tilbyr. til + by (to bid). The noun et tilbud is an offer, and also a sale in a shop." },
        { id: "no-u40l2-akreve", type: "vocab", front: "å kreve", reading: "akreve", meaning: "to require", example: { jp: "Arbeidet krever at du snakker godt norsk.", en: "The job requires you to speak Norwegian well." }, accept: ["to demand", "require"], drill: { jp: "Det er mye å kreve av barna", en: "That's a lot to ask of the children" }, hint: "å kreve → krever. et krav (u32, this band), a requirement, is the noun. kreve at + a clause." },
        { id: "no-u40l2-askape", type: "vocab", front: "å skape", reading: "askape", meaning: "to create", example: { jp: "En ny butikk skaper mange nye jobber i byen.", en: "A new shop creates many new jobs in town." }, accept: ["create", "to bring about"], drill: { jp: "Vi prøver å skape noe", en: "We try to create something" }, hint: "å skape → skaper. To create or bring into being. Unrelated to et skap (A1), a cupboard, despite the look." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u40l4-egentlig", type: "vocab", front: "egentlig", reading: "egentlig", meaning: "actually", example: { jp: "Jeg vet egentlig ikke hva jeg vil gjøre.", en: "I don't actually know what I want to do." }, accept: ["really", "in fact"], drill: { jp: "Jeg er egentlig trøtt nå", en: "I'm actually tired now" }, hint: "egentlig softens or corrects — 'actually, really'. eg is said 'ay': AY-gent-li." },
