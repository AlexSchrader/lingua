  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u40l2-akreve", type: "vocab", front: "å kreve", reading: "akreve", meaning: "to require", example: { jp: "Arbeidet krever at du snakker godt norsk.", en: "The job requires you to speak Norwegian well." }, accept: ["to demand", "require"], drill: { jp: "Det er mye å kreve av barna", en: "That's a lot to ask of the children" }, hint: "å kreve → krever. et krav (A1), a requirement, is the noun. kreve at + a clause." },
