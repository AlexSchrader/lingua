  ...
  lessons: [
    {
      ...
      items: [
        { id: "no-u40l1-aoppleve", type: "vocab", front: "å oppleve", reading: "aoppleve", meaning: "to experience", example: { jp: "Vi opplever ofte at været skifter fort her ved kysten.", en: "We often experience the weather changing quickly here on the coast." }, accept: ["experience", "to go through"], drill: { jp: "Det er fint å oppleve mye", en: "It's nice to experience a lot" }, hint: "å oppleve → opplever. opp + leve, 'live through'. The noun en opplevelse is an experience." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u40l2-akreve", type: "vocab", front: "å kreve", reading: "akreve", meaning: "to require", example: { jp: "Arbeidet krever at du snakker godt norsk.", en: "The job requires you to speak Norwegian well." }, accept: ["to demand", "require"], drill: { jp: "Det er mye å kreve", en: "That's a lot to ask" }, hint: "å kreve → krever. et krav (A1), a requirement, is the noun. kreve at + a clause." },
        { id: "no-u40l2-askape", type: "vocab", front: "å skape", reading: "askape", meaning: "to create", example: { jp: "Ny teknologi skaper mange nye jobber, men fjerner også noen.", en: "New technology creates many new jobs, but also removes some." }, accept: ["create", "to bring about"], drill: { jp: "Vi prøver å skape noe", en: "We try to create something" }, hint: "å skape → skaper. To create or bring into being. Unrelated to et skap (A1), a cupboard, despite the look." },
