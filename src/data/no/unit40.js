...
export const NO_UNIT40 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Name everyday abstractions — en fordel, en ulempe, et forslag, ei beslutning, ei betydning, en tilstand.",
      items: [
        ...
        { id: "no-u40l3-etforslag", type: "vocab", front: "et forslag", reading: "etforslag", meaning: "suggestion", example: { jp: "Har du et bedre forslag enn dette?", en: "Do you have a better suggestion than this?" }, accept: ["a proposal", "a proposition"], drill: { jp: "Jeg har et forslag", en: "I have a suggestion" }, hint: "Neuter: et forslag → forslaget, plural forslag (unchanged). From å foreslå (u21), to suggest." },
        { id: "no-u40l3-eibeslutning", type: "vocab", front: "ei beslutning", reading: "eibeslutning", meaning: "decision", example: { jp: "Det var ei viktig beslutning for hele familien.", en: "It was an important decision for the whole family." }, accept: ["a resolution"], drill: { jp: "Vi tok ei beslutning", en: "We made a decision" }, hint: "ei beslutning → beslutninga. ta ei beslutning = to make a decision. A step more formal than å bestemme seg (u21)." },
        { id: "no-u40l3-eibetydning", type: "vocab", front: "ei betydning", reading: "eibetydning", meaning: "meaning", example: { jp: "Vet du betydninga av dette ordet?", en: "Do you know the meaning of this word?" }, accept: ["a significance", "importance"], drill: { jp: "Ordet har ei betydning", en: "The word has a meaning" }, hint: "ei betydning → betydninga. From å bety (this unit). Also importance: av stor betydning, of great importance." },
