  ...
  lessons: [
    // Lesson 1: the airport and the bag you take there.
    {
      ...
      items: [
        ...
        { id: "no-u20l1-apakke", type: "vocab", front: "å pakke", reading: "apakke", meaning: "to pack", example: { jp: "Nå pakker jeg kofferten.", en: "Now I am packing the suitcase." }, accept: ["pack", "to pack up", "pack up", "to wrap", "wrap"], drill: { jp: "Det er tungt å pakke", en: "It is hard to pack" }, hint: "PAK-ke, present pakker. Ei pakke is a parcel. And the order once more: nå at the front pushes pakker into second place and jeg in behind it — V2, every time, no exceptions." },
      ],
    },
