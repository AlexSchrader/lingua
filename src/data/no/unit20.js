  ...
  lessons: [
    ...
    // Lesson 3: the holiday itself.
    {
      ...
      items: [
        ...
        { id: "no-u20l3-ettelt", type: "vocab", front: "et telt", reading: "ettelt", meaning: "tent", example: { jp: "Vi sover i et telt i skogen.", en: "We sleep in a tent in the forest." }, accept: ["a tent"], drill: { jp: "Vi har et telt i bilen", en: "We have a tent in the car" }, hint: "TELT. Neuter: definite teltet, plural telt, unchanged. Allemannsretten — the right to roam — lets you pitch one almost anywhere in Norway, as long as you keep 150 metres from the nearest house." },
