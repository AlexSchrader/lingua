  ...
  lessons: [
    // Lesson 1: the airport and the bag you take there.
    {
      ...
      items: [
        ...
        { id: "no-u20l1-apakke", type: "vocab", front: "å pakke", reading: "apakke", meaning: "to pack", example: { jp: "Nå pakker jeg kofferten.", en: "Now I am packing the suitcase." }, accept: ["pack", "to pack up", "pack up", "to wrap", "wrap"], drill: { jp: "Det er tungt å pakke en koffert", en: "It is hard to pack a suitcase" }, hint: "PAK-ke, present pakker. Ei pakke is a parcel. And the order once more: nå at the front pushes pakker into second place and jeg in behind it — V2, every time, no exceptions." },
      ],
    },
    ...
    // decoration — with this coastline they ARE the road.
    {
      ...
      items: [
        ...
        { id: "no-u20l2-eibru", type: "vocab", front: "ei bru", reading: "eibru", meaning: "bridge", example: { jp: "Det går ei bru til ei øy.", en: "There is a bridge going to an island." }, accept: ["a bridge"], drill: { jp: "Ei bru er lang", en: "A bridge is long" }, hint: "BRUE, tight u. Feminine: definite brua, plural bruer. ⚠ This one varies more than most: you will also see en bro / broen, a different STEM as well as a different gender, and bro is common in print and in place names. Both are correct Bokmål. This course writes ei bru, because ei predicts the -a definite — but recognise bro when you meet it." },
        { id: "no-u20l2-eiferje", type: "vocab", front: "ei ferje", reading: "eiferje", meaning: "ferry", example: { jp: "Vi kjører bilen på ferja.", en: "We drive the car onto the ferry." }, accept: ["a ferry", "ferryboat"], drill: { jp: "Ei ferje er stor", en: "A ferry is big" }, hint: "FÆR-ye. Feminine: definite ferja, plural ferjer — also spelt ferge, and both are correct. With a coast this shape, ferja is ordinary public transport, not an excursion: whole national roads run straight onto one." },
      ],
    },
    // Lesson 3: the holiday itself.
    {
      ...
      items: [
        { id: "no-u20l3-eihytte", type: "vocab", front: "ei hytte", reading: "eihytte", meaning: "cabin", example: { jp: "Familien min har ei hytte på fjellet.", en: "My family has a cabin in the mountains." }, accept: ["a cabin", "cottage", "hut", "chalet", "a cottage"], drill: { jp: "Ei hytte er lita", en: "A cabin is small" }, hint: "HUET-te. Feminine: definite hytta, plural hytter. Possibly the most Norwegian noun there is: a cabin på fjellet or ved sjøen, and på hytta is where a large part of the country goes at every single holiday." },
        { id: "no-u20l3-ettelt", type: "vocab", front: "et telt", reading: "ettelt", meaning: "tent", example: { jp: "Vi sover i et telt i skogen.", en: "We sleep in a tent in the forest." }, accept: ["a tent"], drill: { jp: "Et telt er lite", en: "A tent is small" }, hint: "TELT. Neuter: definite teltet, plural telt, unchanged. Allemannsretten — the right to roam — lets you pitch one almost anywhere in Norway, as long as you keep 150 metres from the nearest house." },
        ...
        { id: "no-u20l3-engave", type: "vocab", front: "en gave", reading: "engave", meaning: "present", example: { jp: "Jeg gir Kari en gave.", en: "I give Kari a present." }, accept: ["a gift", "gift", "present", "a present"], drill: { jp: "En gave er hyggelig", en: "A present is nice" }, hint: "GAH-ve, hard g. Masculine: definite gaven, plural gaver. Straight from å gi in unit 1 — the thing that gets given." },
