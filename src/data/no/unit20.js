...
export const NO_UNIT20 = {
  ...
  lessons: [
    ...
    // decoration — with this coastline they ARE the road.
    {
      ...
      items: [
        { id: "no-u20l2-envei", type: "vocab", front: "en vei", reading: "envei", meaning: "road", example: { jp: "Det går en vei til flyplassen.", en: "There is a road going to the airport." }, accept: ["a road", "way", "route", "a way"], drill: { jp: "En vei går til Bergen", en: "A road goes to Bergen" }, hint: "VAY, the ei diphthong of hei and reise. Masculine: definite veien, plural veier. Ei gate from unit 7 is a street inside a town; en vei is the road between them — and it is also \"the way\": på vei til Oslo, on the way to Oslo." },
        { id: "no-u20l2-etkart", type: "vocab", front: "et kart", reading: "etkart", meaning: "map", example: { jp: "Jeg ser på et kart.", en: "I am looking at a map." }, accept: ["a map", "chart"], drill: { jp: "Vi ser på et kart", en: "We look at a map" }, hint: "KART. Neuter: definite kartet, plural kart, unchanged. Å lese kart is to read a map. Keep it apart from et kort, with an o — that is a card, including the one you pay with." },
        { id: "no-u20l2-astoppe", type: "vocab", front: "å stoppe", reading: "astoppe", meaning: "to stop", example: { jp: "Bussen stopper nær ei kirke.", en: "The bus stops near a church." }, accept: ["stop", "to halt", "halt", "to come to a stop"], drill: { jp: "Det er lett å stoppe en bil", en: "It is easy to stop a car" }, hint: "STOP-pe, present stopper. Å slutte from unit 5 is to finish something off; å stoppe is to come to a halt. Stopp! on its own is the shout, and the word on the road sign." },
        { id: "no-u20l2-abytte", type: "vocab", front: "å bytte", reading: "abytte", meaning: "to swap", example: { jp: "Vi bytter tog i Oslo.", en: "We change trains in Oslo." }, accept: ["change", "to change", "swap", "to exchange", "exchange", "to switch", "switch"], drill: { jp: "Det er lett å bytte penger", en: "It is easy to change money" }, hint: "BUET-te, present bytter. Swapping one thing for another — bytte tog, bytte penger. Å skifte from unit 15 is closer to changing your clothes; å bytte is an exchange between two things." },
        { id: "no-u20l2-eibru", type: "vocab", front: "ei bru", reading: "eibru", meaning: "bridge", example: { jp: "Det går ei bru til ei øy.", en: "There is a bridge going to an island." }, accept: ["a bridge"], drill: { jp: "Vi går over ei bru", en: "We walk over a bridge" }, hint: "BRUE, tight u. Feminine: definite brua, plural bruer. ⚠ This one varies more than most: you will also see en bro / broen, a different STEM as well as a different gender, and bro is common in print and in place names. Both are correct Bokmål. This course writes ei bru, because ei predicts the -a definite — but recognise bro when you meet it." },
        { id: "no-u20l2-eiferje", type: "vocab", front: "ei ferje", reading: "eiferje", meaning: "ferry", example: { jp: "Vi kjører bilen på ferja.", en: "We drive the car onto the ferry." }, accept: ["a ferry", "ferryboat"], drill: { jp: "Ei ferje går til ei øy", en: "A ferry goes to an island" }, hint: "FÆR-ye. Feminine: definite ferja, plural ferjer — also spelt ferge, and both are correct. With a coast this shape, ferja is ordinary public transport, not an excursion: whole national roads run straight onto one." },
      ],
    },
    // Lesson 3: the holiday itself.
    {
      ...
      items: [
        { id: "no-u20l3-eihytte", type: "vocab", front: "ei hytte", reading: "eihytte", meaning: "cabin", example: { jp: "Familien min har ei hytte på fjellet.", en: "My family has a cabin in the mountains." }, accept: ["a cabin", "cottage", "hut", "chalet", "a cottage"], drill: { jp: "Vi reiser til ei hytte", en: "We travel to a cabin" }, hint: "HUET-te. Feminine: definite hytta, plural hytter. Possibly the most Norwegian noun there is: a cabin på fjellet or ved sjøen, and på hytta is where a large part of the country goes at every single holiday." },
        { id: "no-u20l3-ettelt", type: "vocab", front: "et telt", reading: "ettelt", meaning: "tent", example: { jp: "Vi sover i et telt i skogen.", en: "We sleep in a tent in the forest." }, accept: ["a tent"], drill: { jp: "Vi sover i et telt", en: "We sleep in a tent" }, hint: "TELT. Neuter: definite teltet, plural telt, unchanged. Allemannsretten — the right to roam — lets you pitch one almost anywhere in Norway, as long as you keep 150 metres from the nearest house." },
        { id: "no-u20l3-engjest", type: "vocab", front: "en gjest", reading: "engjest", meaning: "guest", example: { jp: "En gjest kommer til middag.", en: "A guest is coming for dinner." }, accept: ["a guest", "visitor", "a visitor"], drill: { jp: "En gjest kommer i kveld", en: "A guest is coming tonight" }, hint: "YEST — gj is a silent g plus a y sound, the same trick as in å gjøre. Masculine: definite gjesten, plural gjester." },
        { id: "no-u20l3-engave", type: "vocab", front: "en gave", reading: "engave", meaning: "present", example: { jp: "Jeg gir Kari en gave.", en: "I give Kari a present." }, accept: ["a gift", "gift", "present", "a present"], drill: { jp: "Jeg gir deg en gave", en: "I give you a present" }, hint: "GAH-ve, hard g. Masculine: definite gaven, plural gaver. Straight from å gi in unit 1 — the thing that gets given." },
        { id: "no-u20l3-abesoke", type: "vocab", front: "å besøke", reading: "abesoke", meaning: "to visit", example: { jp: "Vi besøker en venn i Bergen.", en: "We are visiting a friend in Bergen." }, accept: ["visit", "to call on", "call on", "to go and see", "go and see"], drill: { jp: "Det er hyggelig å besøke noen", en: "It is nice to visit someone" }, hint: "be-SUR-ke, present besøker, hand-folded to abesoke. Et besøk is a visit, and Norwegians say på besøk: jeg er på besøk hos Kari, I am visiting Kari." },
        { id: "no-u20l3-alane", type: "vocab", front: "å låne", reading: "alane", meaning: "to borrow", example: { jp: "Vi låner ei hytte i Norge.", en: "We are borrowing a cabin in Norway." }, accept: ["borrow", "to lend", "lend", "to loan", "loan"], drill: { jp: "Det er lett å låne penger", en: "It is easy to borrow money" }, hint: "LAW-ne, present låner — the å folds to a on its own. ONE verb where English needs two: jeg låner ei bok is I BORROW a book, and jeg låner deg ei bok is I LEND you one. The direction usually comes from the sentence rather than the verb — though Norwegians do also say å låne bort or å låne ut when they specifically mean to lend. Paying for it is å leie, to rent." },
      ],
    },
    ...
    // journey is made of. Last lesson of Norwegian A1.
    {
      ...
      items: [
        { id: "no-u20l4-adra", type: "vocab", front: "å dra", reading: "adra", meaning: "to set off", example: { jp: "Snart drar vi til Oslo.", en: "Soon we are going to Oslo." }, accept: ["go", "to go", "to leave", "leave", "set off", "depart", "to depart"], drill: { jp: "Det er tungt å dra tidlig", en: "It is hard to set off early" }, hint: "DRAH, present drar. Å gå from unit 1 is on foot; å dra is going by any means at all, and it is what Norwegians actually say about a journey. Note snart at the front pushing drar into second place — V2 one last time." },
        { id: "no-u20l4-ahente", type: "vocab", front: "å hente", reading: "ahente", meaning: "to fetch", example: { jp: "Jeg henter Anna på flyplassen.", en: "I am picking Anna up at the airport." }, accept: ["fetch", "to pick up", "pick up", "to collect", "collect", "get"], drill: { jp: "Det er lett å hente noe", en: "It is easy to fetch something" }, hint: "HEN-te, present henter. To go and get someone or something and bring it back. Å hente et barn på skolen is the daily school run, and the verb every Norwegian parent uses at four o'clock." },
        { id: "no-u20l4-asende", type: "vocab", front: "å sende", reading: "asende", meaning: "to send", example: { jp: "Kari sender en gave til meg.", en: "Kari is sending me a present." }, accept: ["send", "to post", "post", "to mail", "mail", "to dispatch"], drill: { jp: "Det er lett å sende ei melding", en: "It is easy to send a message" }, hint: "SEN-ne — the d barely sounds. Present sender. A parcel, a message or an email: one verb for all of them." },
        { id: "no-u20l4-avise", type: "vocab", front: "å vise", reading: "avise", meaning: "to show", example: { jp: "Erling viser meg et kart.", en: "Erling is showing me a map." }, accept: ["show", "to point out", "point out", "to display", "display"], drill: { jp: "Det er hyggelig å vise noe til Kari", en: "It is nice to show something to Kari" }, hint: "VEE-se, present viser. Å vise noen noe — to show somebody something, with the person first, exactly the order English uses. Keep it apart from ei avis, a newspaper, which only looks related." },
        { id: "no-u20l4-aonske", type: "vocab", front: "å ønske", reading: "aonske", meaning: "to wish", example: { jp: "Vi ønsker deg velkommen.", en: "We welcome you." }, accept: ["wish", "to want", "want", "to desire", "desire"], drill: { jp: "Det er lett å ønske seg noe", en: "It is easy to wish for something" }, hint: "ONS-ke, present ønsker, hand-folded to aonske. Et ønske is a wish. Å ønske velkommen is the set phrase for welcoming somebody — it is what a Norwegian host actually says in the doorway, and it pairs with the velkommen you learned in unit 2." },
        { id: "no-u20l4-eimelding", type: "vocab", front: "ei melding", reading: "eimelding", meaning: "message", example: { jp: "Jeg sender ei melding til Jonas.", en: "I am sending a message to Jonas." }, accept: ["a message", "text", "a text", "text message", "note"], drill: { jp: "Jeg sender ei melding", en: "I am sending a message" }, hint: "MEL-ding. Feminine: definite meldinga, plural meldinger. A text message or any short notice. Nouns ending in -ing are usually feminine, which is why it is meldinga — though you will see meldingen too, as always." },
      ],
    },
  ],
};
