...
//
// V2 is modelled twice: "Nå pakker jeg en koffert." (l1) and "Snart drar vi til
...
export const NO_UNIT20 = {
  ...
  lessons: [
    // Lesson 1: the airport and the bag you take there.
    {
      ...
      items: [
        { id: "no-u20l1-etfly", type: "vocab", front: "et fly", reading: "etfly", meaning: "plane", example: { jp: "Et fly går til Bergen.", en: "A plane goes to Bergen." }, accept: ["an airplane", "airplane", "aeroplane", "a plane", "aircraft"], hint: "FLUE. Neuter: definite flyet, plural fly, unchanged. Å fly is to fly — verb and noun are the same word, and it is the article that keeps them apart, which is exactly why this card carries et." },
        { id: "no-u20l1-enflyplass", type: "vocab", front: "en flyplass", reading: "enflyplass", meaning: "airport", example: { jp: "En flyplass er nær Oslo.", en: "An airport is near Oslo." }, accept: ["an airport", "airfield"], hint: "FLUE-plass. Masculine: definite flyplassen, plural flyplasser. Fly plus plass, a place for planes — welded together exactly the way sykehus was in unit 7." },
    ...
    // decoration — with this coastline they ARE the road.
    {
      ...
      items: [
        ...
        { id: "no-u20l2-eibru", type: "vocab", front: "ei bru", reading: "eibru", meaning: "bridge", example: { jp: "Ei bru går til ei øy.", en: "A bridge goes to an island." }, accept: ["a bridge"], hint: "BRUE, tight u. Feminine: definite brua, plural bruer. ⚠ This one varies more than most: you will also see en bro / broen, a different STEM as well as a different gender, and bro is common in print and in place names. Both are correct Bokmål. This course writes ei bru, because ei predicts the -a definite — but recognise bro when you meet it." },
        { id: "no-u20l2-eiferje", type: "vocab", front: "ei ferje", reading: "eiferje", meaning: "ferry", example: { jp: "Vi kjører en bil på ei ferje.", en: "We drive a car onto a ferry." }, accept: ["a ferry", "ferryboat"], hint: "FÆR-ye. Feminine: definite ferja, plural ferjer — also spelt ferge, and both are correct. With a coast this shape, ferja is ordinary public transport, not an excursion: whole national roads run straight onto one." },
      ],
    },
    // Lesson 3: the holiday itself.
    {
      ...
      items: [
        { id: "no-u20l3-enferie", type: "vocab", front: "en ferie", reading: "enferie", meaning: "holiday", example: { jp: "Vi reiser til Norge i en ferie.", en: "We travel to Norway on a holiday." }, accept: ["a vacation", "vacation", "holiday", "break", "a break"], hint: "FEH-ri-e. Masculine: definite ferien, plural ferier. Note i ferien for \"on holiday\" — Norwegian uses i where English insists on \"on\"." },
        { id: "no-u20l3-eihytte", type: "vocab", front: "ei hytte", reading: "eihytte", meaning: "cabin", example: { jp: "Familien min har ei hytte på et fjell.", en: "My family has a cabin in the mountains." }, accept: ["a cabin", "cottage", "hut", "chalet", "a cottage"], hint: "HUET-te. Feminine: definite hytta, plural hytter. Possibly the most Norwegian noun there is: a cabin på fjellet or ved sjøen, and på hytta is where a large part of the country goes at every single holiday." },
    ...
    // journey is made of. Last lesson of Norwegian A1.
    {
      ...
      items: [
        ...
        { id: "no-u20l4-ahente", type: "vocab", front: "å hente", reading: "ahente", meaning: "to fetch", example: { jp: "Jeg henter Anna på en flyplass.", en: "I am picking Anna up at an airport." }, accept: ["fetch", "to pick up", "pick up", "to collect", "collect", "get"], hint: "HEN-te, present henter. To go and get someone or something and bring it back. Å hente et barn på skolen is the daily school run, and the verb every Norwegian parent uses at four o'clock." },
