  ...
  lessons: [
    ...
    // decoration — with this coastline they ARE the road.
    {
      ...
      items: [
        ...
        { id: "no-u20l2-abytte", type: "vocab", front: "å bytte", reading: "abytte", meaning: "to swap", example: { jp: "Vi bytter tog i Oslo.", en: "We change trains in Oslo." }, accept: ["change", "to change", "swap", "to exchange", "exchange", "to switch", "switch"], hint: "BUET-te, present bytter. Swapping one thing for another — bytte tog, bytte penger. Å skifte from unit 15 is closer to changing your clothes; å bytte is an exchange between two things." },
    ...
    // journey is made of. Last lesson of Norwegian A1.
    {
      ...
      items: [
        { id: "no-u20l4-adra", type: "vocab", front: "å dra", reading: "adra", meaning: "to set off", example: { jp: "Snart drar vi til Oslo.", en: "Soon we are going to Oslo." }, accept: ["go", "to go", "to leave", "leave", "set off", "depart", "to depart"], hint: "DRAH, present drar. Å gå from unit 1 is on foot; å dra is going by any means at all, and it is what Norwegians actually say about a journey. Note snart at the front pushing drar into second place — V2 one last time." },
