  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "no-u31l4-morsom", type: "vocab", front: "morsom", reading: "morsom", meaning: "funny", example: { jp: "Filmen var morsom, men boka var også god.", en: "The film was funny, but the book was good too." }, accept: ["amusing", "fun", "entertaining"], drill: { jp: "En morsom film er aldri kjedelig", en: "A funny film is never boring" }, hint: "MOSH-om — the rs runs together into a sh sound, as in norsk. From moro, fun, plus the same -som as omtenksom. Det var morsomt is what you say after a good evening." },
