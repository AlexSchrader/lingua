...
export const NO_UNIT31 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "no-u31l3-lat", type: "vocab", front: "lat", reading: "lat", meaning: "lazy", example: { jp: "Jeg er lat på søndager.", en: "I am lazy on Sundays." }, accept: ["idle"], drill: { jp: "En lat elev gjør ingenting", en: "A lazy pupil does nothing" }, hint: "LAAT. It already ends in -t, so the neuter is spelled the same. Do not confuse it with å la, to let, which is a verb and a different word entirely." },
