  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u120l1-jeder", type: "vocab", front: "jeder", reading: "jeder", meaning: "each one", example: { jp: "Jeder im Raum durfte eine Frage stellen, aber nur wenige haben die Gelegenheit benutzt.", en: "Each person in the room was allowed to ask a question, but only a few used the opportunity." }, drill: { jp: "Jeder kennt diese alte Geschichte", en: "Each one knows this old story" }, accept: ["each", "each one", "every", "everyone", "everybody"], hint: "Rank 524. Declines like dieser: jeder, jede, jedes, jeden, jedem. Always singular, even where English would say 'all' — jeder weiß, not 'jeder wissen'." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u120l4-darum", type: "vocab", front: "darum", reading: "darum", meaning: "that is why", example: { jp: "Darum haben wir die Sache noch einmal von vorn begonnen, obwohl die Zeit eigentlich zu knapp war.", en: "For that reason we started the matter again from the beginning, although the time was really too short." }, drill: { jp: "Darum ist er heute nicht hier", en: "For that reason he is not here today" }, accept: ["for that reason", "therefore", "that's why", "so", "about it"], hint: "Rank 708. Two jobs: 'therefore', and the da- form of um — sich darum kümmern, to see to it. As a bare answer to warum, Darum! is a parent's 'because I said so'." },
