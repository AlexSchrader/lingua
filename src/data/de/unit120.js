  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u120l1-jeder", type: "vocab", front: "jeder", reading: "jeder", meaning: "each one", example: { jp: "Jeder im Raum durfte eine Frage stellen, aber nur wenige haben etwas gesagt.", en: "Each person in the room was allowed to ask a question, but only a few said anything." }, drill: { jp: "Jeder kennt diese alte Geschichte", en: "Each one knows this old story" }, accept: ["each", "each one", "every", "everyone", "everybody"], hint: "Rank 524. Declines like dieser: jeder, jede, jedes, jeden, jedem. Always singular, even where English would say 'all' — jeder weiß, not 'jeder wissen'." },
