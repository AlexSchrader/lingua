  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u28l1-gestern", type: "vocab", front: "gestern", reading: "gestern", meaning: "yesterday", example: { jp: "Gestern bin ich nach Hause gekommen.", en: "Yesterday I came home." }, drill: { jp: "Gestern bin ich nach Hause gekommen", en: "Yesterday I came home" }, accept: ["yesterday"], hint: "Takes the Perfekt in speech — Germans say gestern bin ich gekommen, not the simple past, which stays mostly in writing." },
        { id: "de-u28l1-vorgestern", type: "vocab", front: "vorgestern", reading: "vorgestern", meaning: "the day before yesterday", example: { jp: "Vorgestern bin ich zu Hause gewesen.", en: "The day before yesterday I was at home." }, drill: { jp: "Vorgestern bin ich zu Hause gewesen", en: "The day before yesterday I was at home" }, accept: ["the day before yesterday", "day before yesterday", "two days ago"], hint: "vor + gestern, one word where English needs four. German builds these tidily and expects you to as well." },
        { id: "de-u28l1-ubermorgen", type: "vocab", front: "übermorgen", reading: "ubermorgen", meaning: "the day after tomorrow", example: { jp: "Übermorgen fahren wir nach Berlin.", en: "The day after tomorrow we travel to Berlin." }, drill: { jp: "Übermorgen fahren wir nach Berlin", en: "The day after tomorrow we travel to Berlin" }, accept: ["the day after tomorrow", "day after tomorrow", "in two days"], hint: "The mirror of vorgestern: über + morgen, beyond-tomorrow. Note German uses the present tense for the future here — fahren, not a will-form." },
        { id: "de-u28l1-damals", type: "vocab", front: "damals", reading: "damals", meaning: "back then", example: { jp: "Damals bin ich in Wien gewesen.", en: "Back then I was in Vienna." }, drill: { jp: "Damals bin ich in Wien gewesen", en: "Back then I was in Vienna" }, accept: ["back then", "at that time", "in those days", "then"], hint: "For a distant past you are looking back on, not for u12's dann, which means next. Confusing the two is the commonest slip with this word." },
        { id: "de-u28l1-neulich", type: "vocab", front: "neulich", reading: "neulich", meaning: "recently", example: { jp: "Neulich bin ich im Museum gewesen.", en: "Recently I was at the museum." }, drill: { jp: "Neulich bin ich im Museum gewesen", en: "Recently I was at the museum" }, accept: ["recently", "the other day", "lately"], hint: "Built on u10's neu. It means the other day — a specific recent occasion, not a stretch of time." },
        { id: "de-u28l1-bald", type: "vocab", front: "bald", reading: "bald", meaning: "soon", example: { jp: "Wir fahren bald nach Hause.", en: "We are going home soon." }, drill: { jp: "Wir fahren bald nach Hause", en: "We are going home soon" }, accept: ["soon", "shortly", "before long"], hint: "You have been saying it since u2 in bis bald, see you soon. Nothing to do with English bald." },
      ],
    },
    {
      id: "de-u28l2",
      ...
      items: [
        { id: "de-u28l2-sofort", type: "vocab", front: "sofort", reading: "sofort", meaning: "immediately", example: { jp: "Der Arzt kommt sofort.", en: "The doctor is coming immediately." }, drill: { jp: "Der Arzt kommt sofort nach Hause", en: "The doctor comes home immediately" }, accept: ["immediately", "at once", "right away", "straight away"], hint: "The strongest of the three: sofort is now, gleich is in a minute, bald is sometime soon. Germans hold that ladder firmly." },
        { id: "de-u28l2-gerade", type: "vocab", front: "gerade", reading: "gerade", meaning: "right now", example: { jp: "Ich lese gerade die Zeitung.", en: "I am reading the newspaper right now." }, drill: { jp: "Ich lese gerade die Zeitung", en: "I am reading the newspaper right now" }, accept: ["right now", "just now", "at the moment", "just"], hint: "German has no continuous tense, so gerade is how it says -ing: ich lese gerade means I am reading. The same word also means straight." },
        { id: "de-u28l2-gleich", type: "vocab", front: "gleich", reading: "gleich", meaning: "in a moment", example: { jp: "Wir gehen gleich nach Hause.", en: "We are going home in a moment." }, drill: { jp: "Wir gehen gleich nach Hause", en: "We are going home in a moment" }, accept: ["in a moment", "shortly", "in a minute", "right away"], hint: "Also means equal or same — gleich groß, the same size. Bis gleich is see you in a minute, as against u2's bis bald." },
        { id: "de-u28l2-plotzlich", type: "vocab", front: "plötzlich", reading: "plotzlich", meaning: "suddenly", example: { jp: "Plötzlich ist das Licht aus.", en: "Suddenly the light is off." }, drill: { jp: "Plötzlich ist das Licht aus", en: "Suddenly the light is off" }, accept: ["suddenly", "all at once", "all of a sudden"], hint: "Put it first and the verb still comes second — plötzlich IST das Licht aus. The rule from u12 has not bent once." },
        { id: "de-u28l2-dermoment", type: "vocab", front: "der Moment", reading: "dermoment", meaning: "the moment", example: { jp: "Der Moment ist sehr schön.", en: "The moment is very lovely." }, drill: { jp: "Der Moment ist sehr schön", en: "The moment is very lovely" }, accept: ["the moment", "moment"], hint: "Moment mal! is the everyday hang on a second. Im Moment means at the moment, and is the phrase you will use most." },
        { id: "de-u28l2-deraugenblick", type: "vocab", front: "der Augenblick", reading: "deraugenblick", meaning: "the instant", example: { jp: "Der Augenblick ist sehr kurz.", en: "The instant is very short." }, drill: { jp: "Der Augenblick ist sehr kurz", en: "The instant is very short" }, accept: ["the instant", "instant", "the split second", "the moment"], hint: "Auge + Blick, the glance of an eye — German's own word for what Moment borrows from Latin. Slightly more literary, and beautifully literal." },
      ],
    },
    {
      id: "de-u28l3",
      ...
      items: [
        { id: "de-u28l3-vorher", type: "vocab", front: "vorher", reading: "vorher", meaning: "beforehand", example: { jp: "Wir essen vorher zu Hause.", en: "We eat at home beforehand." }, drill: { jp: "Wir essen vorher zu Hause", en: "We eat at home beforehand" }, accept: ["beforehand", "before", "before that", "in advance"], hint: "Points back at something already mentioned, the way u21's danach points forward. For linking a whole clause you want u29's bevor." },
        { id: "de-u28l3-nachher", type: "vocab", front: "nachher", reading: "nachher", meaning: "afterwards", example: { jp: "Wir gehen nachher in den Park.", en: "We are going to the park afterwards." }, drill: { jp: "Wir gehen nachher in den Park", en: "We are going to the park afterwards" }, accept: ["afterwards", "later on", "after that", "later"], hint: "Close to u21's danach, with one difference worth holding: danach means after THAT, nachher just means later today." },
        { id: "de-u28l3-bisher", type: "vocab", front: "bisher", reading: "bisher", meaning: "so far", example: { jp: "Bisher ist das Wetter schön.", en: "So far the weather is lovely." }, drill: { jp: "Bisher ist das Wetter schön", en: "So far the weather is lovely" }, accept: ["so far", "up to now", "until now", "thus far"], hint: "bis + her, up-to-hither. It takes the present in German where English reaches for a perfect: bisher ist es gut, so far it has been good." },
        { id: "de-u28l3-inzwischen", type: "vocab", front: "inzwischen", reading: "inzwischen", meaning: "meanwhile", example: { jp: "Inzwischen ist der Zug hier.", en: "Meanwhile the train is here." }, drill: { jp: "Inzwischen ist der Zug hier", en: "Meanwhile the train is here" }, accept: ["meanwhile", "in the meantime", "by now", "since then"], hint: "Built on u14's zwischen, between. It carries both meanwhile and by now — the sense is always the gap between two points." },
        { id: "de-u28l3-haufig", type: "vocab", front: "häufig", reading: "haufig", meaning: "frequently", example: { jp: "Der Bus kommt häufig zu spät.", en: "The bus frequently arrives late." }, drill: { jp: "Der Bus kommt häufig zu spät", en: "The bus frequently arrives late" }, accept: ["frequently", "often", "commonly"], hint: "The bookish twin of u12's oft — same meaning, higher register. Der Haufen is a heap, and a frequent thing is one that heaps up." },
        { id: "de-u28l3-standig", type: "vocab", front: "ständig", reading: "standig", meaning: "constantly", example: { jp: "Das Kind fragt ständig nach dem Essen.", en: "The child constantly asks about the meal." }, drill: { jp: "Das Kind fragt ständig nach dem Essen", en: "The child constantly asks about the meal" }, accept: ["constantly", "all the time", "continually", "permanently"], hint: "Stronger than häufig and usually a complaint. From stehen — something that stands there without stopping." },
      ],
    },
    {
      id: "de-u28l4",
