  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u97l4-bereuen", type: "vocab", front: "bereuen", reading: "bereuen", meaning: "to be truly sorry", example: { jp: "Öffentlich bereuen die meisten nichts, im Gespräch klingt es dann oft ganz anders.", en: "Publicly most regret nothing; in conversation it then often sounds quite different." }, drill: { jp: "Viele Firmen bereuen den Vertrag", en: "Many companies regret the contract" }, accept: ["to regret", "regret", "to repent", "repent", "to rue", "to be sorry for"], hint: "die Reue (remorse) is the noun. Stronger and more moral than bedauern, which is closer to 'to be sorry about' — a court cares about Reue." },
      ],
    },
  ],
};
