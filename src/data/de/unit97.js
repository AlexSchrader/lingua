...
// ⚠️ CORRECTION (2026-09-17, content-auditor revision 1). An earlier version of
// this header said `die Würde` was BLOCKED as a front by `würde` (u37) because
// "the fold is case-insensitive". THAT RULE DOES NOT EXIST. `frontKey` in
// src/data/contract.js:77 is `lang + "\u0000" + item.front` — an exact,
// case-sensitive string, with no article stripping. "die Würde" and "würde"
// cannot collide. What actually fired was check-front.mjs's deliberately
// over-reporting lexeme stemmer, on three unrelated lexemes (Würde / würde /
// wurde). A core B2 word was dropped for nothing, and the header would have made
// blocks 2 and 3 drop more. die Würde is now taught, in l1 where it belongs.
// THE LESSON, and it is the same one as §4 in unit88.js: the tool over-reports by
// design. A LEXEME verdict is a prompt to go and read the corpus, never a ruling.
//
  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u97l1-diewurde", type: "vocab", front: "die Würde", reading: "diewurde", meaning: "the dignity", example: { jp: "Die Würde des Menschen ist unantastbar, und dieser Satz steht aus gutem Grund ganz am Anfang.", en: "Human dignity is inviolable, and that sentence stands right at the beginning for good reason." }, drill: { jp: "Die Würde steht über dem Gewinn", en: "Dignity stands above profit" }, accept: ["dignity", "the dignity", "human dignity"], hint: "Article 1 of the German constitution opens with it: Die Würde des Menschen ist unantastbar. würdig = dignified, die Menschenwürde = human dignity. Unrelated to würde, the subjunctive of werden — same letters, different word." },
      ],
    },
    {
      id: "de-u97l2",
      ...
      items: [
        ...
        { id: "de-u97l2-dermissbrauch", type: "vocab", front: "der Missbrauch", reading: "dermissbrauch", meaning: "the abuse", example: { jp: "Der Missbrauch der Daten wurde erst bemerkt, als die Behörde selbst eine Prüfung verlangte.", en: "The misuse of the data was only noticed when the authority itself demanded an audit." }, drill: { jp: "Der Missbrauch kostet viel Vertrauen", en: "The abuse costs a lot of trust" }, accept: ["abuse", "the abuse", "misuse", "the misuse", "malpractice"], hint: "miss- (wrongly) + brauchen (to use): using something wrongly. Not der Brauch, which is a custom. Two s's and no ß — Missbrauch, not Mißbrauch, since the 1996 spelling reform. Covers data misuse, drug abuse and abuse of office alike." },
        ...
        { id: "de-u97l2-fahrlassig", type: "vocab", front: "fahrlässig", reading: "fahrlassig", meaning: "negligent", example: { jp: "Fahrlässig heißt nicht absichtlich, trotzdem haftet die Firma für den ganzen Schaden.", en: "Negligent does not mean intentional; nevertheless the company is liable for the whole damage." }, drill: { jp: "Dieser Fehler wirkt sehr fahrlässig", en: "This mistake seems very negligent" }, accept: ["negligent", "negligently", "careless", "reckless"], hint: "A legal grade, not an insult: at grob fahrlässig a German insurer may cut what it pays in proportion to the fault (VVG §81 since 2008), rather than simply refusing. Its opposite is vorsätzlich, below." },
