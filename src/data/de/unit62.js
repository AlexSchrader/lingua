  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u62l1-dieabsicht", type: "vocab", front: "die Absicht", reading: "dieabsicht", meaning: "the intention", example: { jp: "Meine Absicht war gut, aber das Ergebnis war am Ende leider schlecht.", en: "My intention was good, but unfortunately the result was bad in the end." }, drill: { jp: "Die Absicht war sehr gut", en: "The intention was very good" }, accept: ["intention", "the intention", "intent", "the intent", "purpose", "the purpose", "aim"], hint: "ab + sehen: what you have in view. mit Absicht = on purpose; ohne Absicht = by accident." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u62l3-dieveranstaltung", type: "vocab", front: "die Veranstaltung", reading: "dieveranstaltung", meaning: "the organized event", example: { jp: "Die Veranstaltung war gut, obwohl viel weniger Gäste gekommen sind.", en: "The event was good, although far fewer guests came." }, drill: { jp: "Die Veranstaltung war sehr gut", en: "The event was very good" }, accept: ["event", "the event", "function", "the function", "occasion", "the occasion"], hint: "From veranstalten, to put on. Unlike das Ereignis (u55), somebody has to ORGANIZE a Veranstaltung." },
