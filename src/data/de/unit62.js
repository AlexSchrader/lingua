  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u62l1-derplan", type: "vocab", front: "der Plan", reading: "derplan", meaning: "the plan", example: { jp: "Der Plan für nächste Woche steht schon fest.", en: "The plan for next week is already settled." }, drill: { jp: "Der Plan steht schon lange fest", en: "The plan has been settled for a long time" }, accept: ["plan", "the plan", "scheme", "the scheme", "map", "schedule"], hint: "Plural Pläne. einen Plan machen; nach Plan laufen = to go to plan. planen (u48) is the verb and der Fahrplan (u19) is the same Plan." },
      ],
    },
    {
      id: "de-u62l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u62l3-treffen", type: "vocab", front: "treffen", reading: "treffen", meaning: "to meet", example: { jp: "Wir treffen uns am Samstag vor dem Museum.", en: "We are meeting on Saturday in front of the museum." }, drill: { jp: "Wir wollen uns morgen treffen", en: "We want to meet tomorrow" }, accept: ["to meet", "meet", "to meet up", "to hit", "to encounter"], hint: "Reflexive when you arrange to see someone: sich mit jemandem treffen. On its own it means to hit a target, and übertreffen (u53) is \"to beat\" off the same verb. Strong: traf, hat getroffen." },
      ],
    },
    {
      id: "de-u62l4",
