  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u17l3-einpaar", type: "vocab", front: "ein paar", reading: "einpaar", meaning: "a few", example: { jp: "Wir haben ein paar Minuten.", en: "We have a few minutes." }, drill: { jp: "Ich brauche ein paar Stunden", en: "I need a few hours" }, accept: ["a few", "a couple", "a couple of", "some"], hint: "Lower-case paar means a few; capital das Paar is a pair or a couple. ein paar Schuhe is some shoes, ein Paar Schuhe is exactly one pair. It never changes its ending." },
      ],
    },
    {
      id: "de-u17l4",
