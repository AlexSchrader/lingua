  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u17l1-derschuh", type: "vocab", front: "der Schuh", reading: "derschuh", meaning: "the shoe", example: { jp: "Die Schuhe sind neu und noch nicht schmutzig.", en: "The shoes are new and not yet dirty." }, accept: ["the shoe"], hint: "Almost always used in the plural, die Schuhe, because they come in twos." },
        { id: "de-u17l1-dietasche", type: "vocab", front: "die Tasche", reading: "dietasche", meaning: "the bag", example: { jp: "Mein Schlüssel ist in der Tasche.", en: "My key is in the bag." }, accept: ["the bag", "the pocket", "the handbag"], hint: "Both a bag you carry and a pocket in your clothes — context decides which." },
      ],
    },
    {
      id: "de-u17l2",
      ...
      items: [
        { id: "de-u17l2-diejacke", type: "vocab", front: "die Jacke", reading: "diejacke", meaning: "the jacket", example: { jp: "Es ist kalt — nimm die Jacke.", en: "It is cold — take the jacket." }, accept: ["the jacket"], hint: "Jacket and Jacke are the same word. The ck is one sound, as in English back." },
        { id: "de-u17l2-dermantel", type: "vocab", front: "der Mantel", reading: "dermantel", meaning: "the coat", example: { jp: "Im Winter trage ich immer einen Mantel.", en: "In winter I always wear a coat." }, accept: ["the coat", "the overcoat"], hint: "Longer and warmer than eine Jacke. Plural umlauts: die Mäntel." },
        ...
        { id: "de-u17l2-diesocke", type: "vocab", front: "die Socke", reading: "diesocke", meaning: "the sock", example: { jp: "Die Socken sind rot und gelb.", en: "The socks are red and yellow." }, accept: ["the sock"], hint: "Like shoes, nearly always plural: die Socken." },
        { id: "de-u17l2-diemutze", type: "vocab", front: "die Mütze", reading: "diemutze", meaning: "the woolly cap", example: { jp: "Bei Schnee brauche ich eine Mütze.", en: "When it snows I need a cap." }, accept: ["the cap", "the woolly hat", "the beanie"], hint: "The soft knitted kind. A hat with a brim is der Hut — a different word for a different object." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u17l3-tragen", type: "vocab", front: "tragen", reading: "tragen", meaning: "to wear / carry", example: { jp: "Sie trägt heute ein Kleid.", en: "She is wearing a dress today." }, accept: ["to wear", "to carry"], hint: "One verb for both jobs: you tragen clothes and you tragen a heavy bag. The vowel shifts in er/sie: er trägt." },
        ...
        { id: "de-u17l3-passen", type: "vocab", front: "passen", reading: "passen", meaning: "to fit", example: { jp: "Die Hose passt mir nicht.", en: "The trousers do not fit me." }, accept: ["to fit", "to suit"], hint: "Takes the dative person: die Hose passt MIR. Nothing to do with der Pass, a passport." },
        ...
        { id: "de-u17l3-gefallen", type: "vocab", front: "gefallen", reading: "gefallen", meaning: "to please / appeal to", example: { jp: "Der Mantel gefällt mir sehr.", en: "I like the coat very much." }, accept: ["to please", "to appeal to", "to like"], hint: "Backwards from English: the THING is the subject and YOU are dative — der Mantel gefällt mir, the coat pleases me." },
      ],
    },
    {
      id: "de-u17l4",
      ...
      items: [
        { id: "de-u17l4-kaufen", type: "vocab", front: "kaufen", reading: "kaufen", meaning: "to buy", example: { jp: "Ich kaufe die Schuhe für vierzig Euro.", en: "I am buying the shoes for forty euros." }, accept: ["to buy", "to purchase"], hint: "Einkaufen, with ein-, is to do the shopping — the whole trip rather than one purchase." },
        ...
        { id: "de-u17l4-diekasse", type: "vocab", front: "die Kasse", reading: "diekasse", meaning: "the till", example: { jp: "Sie bezahlen bitte an der Kasse.", en: "Please pay at the till." }, accept: ["the till", "the checkout", "the cash desk"], hint: "An der Kasse is where you queue. The same word covers a cinema box office." },
