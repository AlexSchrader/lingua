...
export const DE_UNIT14 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u14l2-mir", type: "vocab", front: "mir", reading: "mir", meaning: "me — dative", example: { jp: "Mir ist kalt.", en: "I am cold." }, accept: ["me", "to me", "for me"], hint: "The form u8 promised you. German does not say I am cold — it says to-me is cold: Mir ist kalt. Same with Es geht mir gut." },
        { id: "de-u14l2-dir", type: "vocab", front: "dir", reading: "dir", meaning: "you — dative", example: { jp: "Wie geht es dir?", en: "How are you?" }, accept: ["you", "to you", "for you"], hint: "You have been saying this since u2: wie geht's is wie geht es dir squeezed together. Now you can see the dative inside it." },
        { id: "de-u14l2-ihm", type: "vocab", front: "ihm", reading: "ihm", meaning: "him — dative", example: { jp: "Ich helfe ihm.", en: "I am helping him." }, accept: ["him", "to him", "for him", "it"], hint: "er → ihn in the accusative (u13) → ihm in the dative. Three forms of one small word, and this is the last of them." },
        { id: "de-u14l2-ihnen", type: "vocab", front: "ihnen", reading: "ihnen", meaning: "them — dative", example: { jp: "Wir helfen ihnen.", en: "We are helping them." }, accept: ["them", "to them", "for them"], hint: "Capitalised as Ihnen it means to you formally — the dative of Sie (u3). Same sound, and only the capital letter tells them apart." },
        { id: "de-u14l2-wem", type: "vocab", front: "wem", reading: "wem", meaning: "whom — dative", example: { jp: "Wem hilfst du?", en: "Whom are you helping?" }, accept: ["whom", "to whom", "who"], hint: "The set is now complete: wer asks the subject (u12), wen the object (u13), wem the dative. Wer hilft dir? against Wem hilfst du?" },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u14l3-nach", type: "vocab", front: "nach", reading: "nach", meaning: "after", example: { jp: "Wir fahren nach Berlin.", en: "We are driving to Berlin." }, accept: ["to", "after", "towards"], hint: "For cities and countries it means to — nach Berlin, nach Deutschland. For time it means after. Do not confuse it with noch (u12)." },
