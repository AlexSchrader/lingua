  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u60l1-diepanne", type: "vocab", front: "die Panne", reading: "diepanne", meaning: "the breakdown", example: { jp: "Wir hatten eine Panne auf der Straße, deshalb sind wir zu spät gekommen.", en: "We had a breakdown on the road, so we arrived too late." }, drill: { jp: "Die Panne war sehr teuer", en: "The breakdown was very expensive" }, accept: ["breakdown", "the breakdown", "mishap", "the mishap", "glitch", "the glitch", "hitch"], hint: "A car that stops, and by extension any small disaster: eine Panne haben. Borrowed from French." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u60l2-derausweg", type: "vocab", front: "der Ausweg", reading: "derausweg", meaning: "the way out", example: { jp: "Es gab keinen Ausweg, deshalb haben wir den Termin am Ende abgesagt.", en: "There was no way out, so in the end we cancelled the appointment." }, drill: { jp: "Der Ausweg war sehr teuer", en: "The way out was very expensive" }, accept: ["way out", "the way out", "escape", "the escape", "solution", "the solution", "alternative"], hint: "aus + der Weg: the road out of a fix. keinen Ausweg mehr sehen = to see no way out." },
        { id: "de-u60l2-derrat", type: "vocab", front: "der Rat", reading: "derrat", meaning: "the advice", example: { jp: "Der Rat von meiner Mutter war gut, deshalb habe ich ihn genommen.", en: "My mother's advice was good, so I took it." }, drill: { jp: "Der Rat war sehr gut", en: "The advice was very good" }, accept: ["advice", "the advice", "counsel", "the counsel", "tip", "council", "the council"], hint: "Singular for advice; the plural Ratschläge is English's 'pieces of advice'. Also a council: der Stadtrat." },
        { id: "de-u60l2-diemassnahme", type: "vocab", front: "die Maßnahme", reading: "diemassnahme", meaning: "the measure", example: { jp: "Die Maßnahme hat geholfen, aber sie war für viele Bürger sehr hart.", en: "The measure helped, but it was very hard for many citizens." }, drill: { jp: "Die Maßnahme war sehr hart", en: "The measure was very hard" }, accept: ["measure", "the measure", "step", "the step", "action", "the action", "precaution"], hint: "das Maß + nehmen: to take a measure. It has ß, so the reading is written with ss. Usually plural in the news." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u60l3-derschaden", type: "vocab", front: "der Schaden", reading: "derschaden", meaning: "the damage", example: { jp: "Der Schaden am Auto war groß, aber die Versicherung hat den Schaden bezahlt.", en: "The damage to the car was great, but the insurance paid for the damage." }, drill: { jp: "Der Schaden war sehr groß", en: "The damage was very great" }, accept: ["damage", "the damage", "harm", "the harm", "loss", "the loss"], hint: "Schaden nehmen = to be damaged. Plural Schäden. schade! (what a pity) is the same family." },
        ...
        { id: "de-u60l3-retten", type: "vocab", front: "retten", reading: "retten", meaning: "to rescue", example: { jp: "Der Hund hat das Kind gerettet, und die Presse war sofort da.", en: "The dog rescued the child, and the press was there immediately." }, drill: { jp: "Zwei Männer retten das Kind", en: "Two men rescue the child" }, accept: ["to rescue", "rescue", "to save", "save"], hint: "Of people and of situations alike: den Abend retten. die Rettung is the rescue; der Krankenwagen is also der Rettungswagen." },
        ...
        { id: "de-u60l3-zerstoren", type: "vocab", front: "zerstören", reading: "zerstoren", meaning: "to destroy", example: { jp: "Der Sturm hat den Garten zerstört, und die Bäume liegen immer noch da.", en: "The storm destroyed the garden, and the trees are still lying there." }, drill: { jp: "Stürme zerstören viele Gärten", en: "Storms destroy many gardens" }, accept: ["to destroy", "destroy", "to wreck", "wreck", "to ruin", "ruin", "to demolish"], hint: "zer- is the prefix of breaking apart: zerbrechen, zerschneiden, zerstören. You already know zerbrechlich." },
      ],
    },
    {
      id: "de-u60l4",
