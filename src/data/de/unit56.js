  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u56l2-derablauf", type: "vocab", front: "der Ablauf", reading: "derablauf", meaning: "the sequence of events", example: { jp: "Den genauen Ablauf der Besprechung finden Sie in den Unterlagen.", en: "You'll find the exact running order of the meeting in the documents." }, drill: { jp: "Der Ablauf steht in den Unterlagen", en: "The running order is in the documents" }, accept: ["sequence", "the sequence", "procedure", "the procedure", "running order", "process", "course of events"], hint: "What happens in what order — a schedule of actions, not of times. reibungsloser Ablauf = a smooth run. ablaufen (u76) is about a deadline expiring, a different sense." },
      ],
    },
    {
      id: "de-u56l3",
      ...
      items: [
        ...
        { id: "de-u56l3-dieeinigung", type: "vocab", front: "die Einigung", reading: "dieeinigung", meaning: "the agreement reached", example: { jp: "Nach drei Stunden gab es endlich eine Einigung zwischen den beiden Seiten.", en: "After three hours there was finally an agreement between the two sides." }, drill: { jp: "Die Einigung kam nach drei Stunden", en: "The agreement came after three hours" }, accept: ["agreement", "the agreement", "settlement", "the settlement", "deal", "accord"], hint: "The RESULT of sich einigen in this lesson: the deal you end up with. eine Einigung erzielen = to reach an agreement. der Vertrag is the paper it is written on." },
      ],
    },
    {
      id: "de-u56l4",
      ...
      items: [
        ...
        { id: "de-u56l4-erfolgreich", type: "vocab", front: "erfolgreich", reading: "erfolgreich", meaning: "successful (of an effort)", example: { jp: "Die Sache war erfolgreich, obwohl der Aufwand sehr hoch war.", en: "The thing was successful, although the effort was very high." }, drill: { jp: "Die Sache war sehr erfolgreich", en: "The thing was very successful" }, accept: ["successful", "successfully"], hint: "der Erfolg in this lesson + -reich (rich in). Works as an adverb unchanged: etwas erfolgreich abschließen." },
      ],
    },
  ],
};
