  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u106l2-vermeintlich", type: "vocab", front: "vermeintlich", reading: "vermeintlich", meaning: "supposed (wrongly believed to be)", example: { jp: "Der vermeintliche Fehler war gar keiner, die Zahlen waren von einem anderen Jahr.", en: "The supposed error was not one at all; the figures were from a different year." }, drill: { jp: "Der vermeintliche Fehler war gar keiner", en: "The supposed error was not one at all" }, accept: ["supposed", "putative", "alleged", "so-called"], hint: "Marks that the speaker doubts it: der vermeintliche Täter. Angeblich (u54) puts the claim on someone else instead." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u106l4-anderenfalls", type: "vocab", front: "widrigenfalls", reading: "widrigenfalls", meaning: "failing which (official warning register)", example: { jp: "Bitte zahlen Sie bis zum 30. Juni, widrigenfalls geht die Sache vor Gericht.", en: "Please pay by 30 June, failing which the matter goes to court." }, drill: { jp: "Bitte zahlen Sie widrigenfalls folgt eine Klage", en: "Please pay failing which a lawsuit follows" }, accept: ["failing which", "otherwise", "in default of which"], hint: "Pure Amtsdeutsch — you will meet it in a letter and never in a conversation. Andernfalls (u70) is the neutral word for the same thing." },
      ],
    },
  ],
};
