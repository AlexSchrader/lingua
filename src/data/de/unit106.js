  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u106l1-nachtraglich", type: "vocab", front: "nachträglich", reading: "nachtraglich", meaning: "after the event (belatedly)", example: { jp: "Nachträglich hat die Firma zugegeben, dass die Zahlen falsch waren.", en: "After the event the company admitted that the figures were wrong." }, drill: { jp: "Nachträglich wurde alles noch einmal geändert", en: "Afterwards everything was changed again" }, accept: ["belatedly", "after the event", "retrospectively", "afterwards"], hint: "Also the standard word on a late birthday card: nachträglich alles Gute!" },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u106l3-sofern", type: "vocab", front: "sofern", reading: "sofern", meaning: "provided that (as long as)", example: { jp: "Sofern die Kasse zustimmt, beginnt die Behandlung noch im Mai.", en: "Provided that the insurer agrees, the treatment starts as early as May." }, drill: { jp: "Sofern die Kasse zustimmt bezahlen wir", en: "Provided the insurer agrees we pay" }, accept: ["provided that", "as long as", "if", "assuming that"], hint: "Written register; in speech Germans say wenn. Verb to the end, like every subordinating conjunction." },
        { id: "de-u106l3-ohnedass", type: "vocab", front: "ohne dass", reading: "ohnedass", meaning: "without (something happening)", example: { jp: "Die Firma hat die Vorgaben geändert, ohne dass jemand gefragt wurde.", en: "The company changed the requirements without anybody being asked." }, drill: { jp: "Er ging ohne dass jemand etwas sagte", en: "He left without anyone saying anything" }, accept: ["without", "without it happening", "without the fact that"], hint: "Use ohne dass when the two clauses have different subjects; with the same subject German prefers ohne … zu + infinitive." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u106l4-keinesfalls", type: "vocab", front: "keinesfalls", reading: "keinesfalls", meaning: "under no circumstances", example: { jp: "Diese Zahlen darf man keinesfalls einzeln lesen.", en: "These figures must under no circumstances be read on their own." }, drill: { jp: "Man darf das keinesfalls so entscheiden", en: "One must under no circumstances decide it that way" }, accept: ["under no circumstances", "by no means", "definitely not", "on no account"], hint: "Stronger and more formal than auf keinen Fall, and it happily starts a sentence: Keinesfalls ist damit gesagt, dass …" },
        ...
        { id: "de-u106l4-widrigenfalls", type: "vocab", front: "widrigenfalls", reading: "widrigenfalls", meaning: "failing which (official warning register)", example: { jp: "Bitte zahlen Sie bis zum 30. Juni, widrigenfalls geht die Sache vor Gericht.", en: "Please pay by 30 June, failing which the matter goes to court." }, drill: { jp: "Bitte bezahlen Sie widrigenfalls kommt eine Klage", en: "Please pay failing which a lawsuit comes" }, accept: ["failing which", "otherwise", "in default of which"], hint: "Pure Amtsdeutsch — you will meet it in a letter and never in a conversation. Andernfalls (u70) is the neutral word for the same thing." },
      ],
    },
  ],
};
