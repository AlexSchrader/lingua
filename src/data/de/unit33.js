  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u33l4-daskonto", type: "vocab", front: "das Konto", reading: "daskonto", meaning: "account", example: { jp: "Das Konto ist neu, weil ich Geld sparen möchte.", en: "The account is new because I want to save money." }, drill: { jp: "Das Konto ist noch sehr neu", en: "The account is still very new" }, accept: ["account", "bank account"], hint: "A bank account and an online account alike. Its plural is Italian and irregular: die Konten." },
