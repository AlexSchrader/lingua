  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u55l1-diequelle", type: "vocab", front: "die Quelle", reading: "diequelle", meaning: "the source", example: { jp: "Die Quelle war gut, deshalb haben wir dem Bericht auch geglaubt.", en: "The source was good, so we believed the report too." }, drill: { jp: "Die Quelle steht im Internet", en: "The source is on the internet" }, accept: ["source", "the source", "spring", "the spring"], hint: "Also a spring of water — the place a thing flows from. aus sicherer Quelle = from a reliable source." },
        ...
        { id: "de-u55l1-diepresse", type: "vocab", front: "die Presse", reading: "diepresse", meaning: "the press", example: { jp: "Die Presse hat über den Streit geschrieben, obwohl niemand mit ihr sprechen wollte.", en: "The press wrote about the quarrel, although nobody wanted to talk to them." }, drill: { jp: "Die Presse schreibt über den Streik", en: "The press writes about the strike" }, accept: ["press", "the press", "media", "the media"], hint: "The printing press, then the newspapers, then all news media. die Pressefreiheit = freedom of the press." },
        { id: "de-u55l1-dieredaktion", type: "vocab", front: "die Redaktion", reading: "dieredaktion", meaning: "the editorial team", example: { jp: "Die Redaktion hat den Bericht lange gelesen, bevor die Zeitung ihn veröffentlicht hat.", en: "The editorial team read the report for a long time before the newspaper published it." }, drill: { jp: "Die Redaktion arbeitet bis spät", en: "The editorial team works late" }, accept: ["editorial team", "the editorial team", "the editors", "newsroom", "the newsroom"], hint: "The people who decide what goes in, and the room they sit in. From redigieren, to edit." },
        { id: "de-u55l1-derleser", type: "vocab", front: "der Leser", reading: "derleser", meaning: "the reader", example: { jp: "Der Leser hat wenig Zeit, deshalb muss der Bericht kurz sein.", en: "The reader has little time, so the report has to be short." }, drill: { jp: "Der Leser hat wenig Zeit", en: "The reader has little time" }, accept: ["reader", "the reader"], hint: "From lesen. The plural is the same: die Leser. A woman is die Leserin." },
      ],
    },
    {
      id: "de-u55l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u55l4-fordern", type: "vocab", front: "fordern", reading: "fordern", meaning: "to call for", example: { jp: "Die Kollegen fordern mehr Geld, weil die Preise so stark gestiegen sind.", en: "The colleagues are calling for more money, because prices have risen so sharply." }, drill: { jp: "Die Kollegen fordern mehr Geld", en: "The colleagues call for more money" }, accept: ["to demand", "demand", "to call for", "call for", "to require", "to claim"], hint: "A demand made out loud and in public, where bitten is a request. Close to verlangen. Don't confuse it with fördern (to promote), one umlaut away." },
