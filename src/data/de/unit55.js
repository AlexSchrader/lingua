  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u55l1-dasereignis", type: "vocab", front: "das Ereignis", reading: "dasereignis", meaning: "the occurrence", example: { jp: "Das Ereignis am Samstag war groß, und die Presse hat sehr viel geschrieben.", en: "What happened on Saturday was big, and the press wrote a great deal." }, drill: { jp: "Das Ereignis steht in der Zeitung", en: "The occurrence is in the newspaper" }, accept: ["event", "the event", "occurrence", "the occurrence", "incident", "the incident"], hint: "Something that HAPPENS, planned or not. Compare die Veranstaltung (u62), which somebody has to organize." },
