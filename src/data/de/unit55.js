  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u55l1-dieschlagzeile", type: "vocab", front: "die Schlagzeile", reading: "dieschlagzeile", meaning: "the headline", example: { jp: "Die Schlagzeile war sehr groß, aber der Bericht hatte wenig Inhalt.", en: "The headline was very big, but the report had little content." }, drill: { jp: "Die Schlagzeile war sehr groß", en: "The headline was very big" }, accept: ["headline", "the headline"], hint: "schlagen (to strike) + die Zeile (the line): the line that hits you. Plural: die Schlagzeilen." },
        { id: "de-u55l1-derbericht", type: "vocab", front: "der Bericht", reading: "derbericht", meaning: "the report", example: { jp: "Der Bericht über die Wahl war lang, aber er hat wenig erklärt.", en: "The report about the election was long, but it explained little." }, drill: { jp: "Der Bericht war sehr lang", en: "The report was very long" }, accept: ["report", "the report", "account", "the account", "coverage"], hint: "From berichten, to report. einen Bericht schreiben — for school, for work and for the news." },
        { id: "de-u55l1-diequelle", type: "vocab", front: "die Quelle", reading: "diequelle", meaning: "the source", example: { jp: "Die Quelle war gut, deshalb haben wir dem Bericht auch geglaubt.", en: "The source was good, so we believed the report too." }, drill: { jp: "Die Quelle war sehr gut", en: "The source was very good" }, accept: ["source", "the source", "spring", "the spring"], hint: "Also a spring of water — the place a thing flows from. aus sicherer Quelle = from a reliable source." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u55l2-diemacht", type: "vocab", front: "die Macht", reading: "diemacht", meaning: "the power", example: { jp: "Wer die Macht hat, hört selten auf die Kritik von unten.", en: "Whoever has the power rarely listens to criticism from below." }, drill: { jp: "Die Macht ist sehr groß", en: "The power is very great" }, accept: ["power", "the power", "might", "the might", "authority", "the authority"], hint: "an der Macht sein = to be in power. Plural die Mächte for the great powers of the world." },
        ...
        { id: "de-u55l2-diepolitik", type: "vocab", front: "die Politik", reading: "diepolitik", meaning: "the politics", example: { jp: "Über Politik spricht man am Tisch lieber nicht, sagt meine Mutter.", en: "You'd better not talk about politics at the table, my mother says." }, drill: { jp: "Die Politik ist sehr schwer", en: "Politics is very difficult" }, accept: ["politics", "the politics", "policy", "the policy"], hint: "Both 'politics' and 'a policy': die Politik der Firma. No plural in the first sense." },
      ],
    },
    {
      id: "de-u55l3",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u55l4-dieheimat", type: "vocab", front: "die Heimat", reading: "dieheimat", meaning: "the home", example: { jp: "Nach zehn Jahren ist die Stadt für uns zur Heimat geworden.", en: "After ten years the city has become home for us." }, drill: { jp: "Die Heimat ist immer wichtig", en: "Home is always important" }, accept: ["home", "the home", "homeland", "the homeland", "native country", "where you are from"], hint: "Where you feel you belong — never das Haus. English has no clean word for it, which is why German keeps it." },
        { id: "de-u55l4-diekritik", type: "vocab", front: "die Kritik", reading: "diekritik", meaning: "the criticism", example: { jp: "Die Kritik war hart, aber am Ende hat sie uns sehr geholfen.", en: "The criticism was harsh, but in the end it helped us a lot." }, drill: { jp: "Die Kritik war sehr hart", en: "The criticism was very harsh" }, accept: ["criticism", "the criticism", "critique", "the critique", "review", "the review"], hint: "Also a review of a book or a film. Kritik üben an etwas = to criticize something." },
      ],
    },
  ],
};
