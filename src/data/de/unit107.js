  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u107l1-bezuglich", type: "vocab", front: "bezüglich", reading: "bezuglich", meaning: "concerning (with regard to)", example: { jp: "Bezüglich Ihrer Anfrage vom 3. Mai teilen wir Ihnen Folgendes mit.", en: "Concerning your enquiry of 3 May, we inform you of the following." }, drill: { jp: "Bezüglich der Frist gibt es Probleme", en: "Concerning the deadline there are problems" }, accept: ["concerning", "regarding", "with regard to", "in respect of"], hint: "Takes the genitive. The spoken equivalent is wegen or the plain phrase es geht um." },
        { id: "de-u107l1-gemass", type: "vocab", front: "gemäß", reading: "gemass", meaning: "in accordance with", example: { jp: "Gemäß den neuen Vorgaben muss jeder Betrieb die Werte selbst melden.", en: "In accordance with the new requirements, every plant must report the values itself." }, drill: { jp: "Gemäß dem Vertrag bezahlt die Firma alles", en: "In accordance with the contract the company pays everything" }, accept: ["in accordance with", "according to", "pursuant to", "as per"], hint: "Dative, and it may stand after its noun: dem Vertrag gemäß. Laut is the lighter everyday version." },
        ...
        { id: "de-u107l1-ungeachtet", type: "vocab", front: "ungeachtet", reading: "ungeachtet", meaning: "notwithstanding (in spite of)", example: { jp: "Ungeachtet der Kosten hat die Stadt das Haus gekauft.", en: "Notwithstanding the costs, the city bought the house." }, drill: { jp: "Ungeachtet der Kosten geht es weiter", en: "Notwithstanding the costs it continues" }, accept: ["notwithstanding", "in spite of", "regardless of", "despite"], hint: "Genitive. Trotz (u62) says the same thing in one everyday syllable — keep ungeachtet for writing." },
      ],
    },
    {
      id: "de-u107l2",
      ...
      items: [
        { id: "de-u107l2-imrahmen", type: "vocab", front: "im Rahmen", reading: "imrahmen", meaning: "as part of (within the framework of)", example: { jp: "Im Rahmen der Fortbildung haben alle auch eine Stunde über Sicherheit gehört.", en: "As part of the training everyone also heard an hour about safety." }, drill: { jp: "Im Rahmen der Forschung entstand ein Bericht", en: "As part of the research a report was produced" }, accept: ["as part of", "within the framework of", "in the context of", "under"], hint: "Der Rahmen is the picture frame. Im Rahmen + genitive puts an event inside a bigger one — the commonest frame in German officialese." },
        ...
        { id: "de-u107l2-zurverfugungstellen", type: "vocab", front: "zur Verfügung stellen", reading: "zurverfugungstellen", meaning: "to make available (place at someone's disposal)", example: { jp: "Die Stadt will der Schule zwei Zimmer zur Verfügung stellen.", en: "The city wants to make two rooms available to the school." }, drill: { jp: "Wir können Ihnen zwei Zimmer zur Verfügung stellen", en: "We can make two rooms available to you" }, accept: ["to make available", "to provide", "to place at someone's disposal", "to supply"], hint: "A Funktionsverbgefüge: the noun carries the meaning, stellen only carries the grammar. Its partner is zur Verfügung stehen — to be available." },
        { id: "de-u107l2-inanspruchnehmen", type: "vocab", front: "in Anspruch nehmen", reading: "inanspruchnehmen", meaning: "to make use of (claim a service or right)", example: { jp: "Wer die Beratung in Anspruch nehmen will, meldet sich bis Freitag.", en: "Anyone wanting to make use of the advice service signs up by Friday." }, drill: { jp: "Alle wollen die Hilfe in Anspruch nehmen", en: "Everyone wants to make use of the help" }, accept: ["to make use of", "to take advantage of", "to claim", "to use"], hint: "Der Anspruch is the claim or entitlement. Also of time: die Arbeit nimmt mich sehr in Anspruch — it takes a lot out of me." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u107l4-beinhalten", type: "vocab", front: "beinhalten", reading: "beinhalten", meaning: "to contain (have as its content)", example: { jp: "Der Vertrag beinhaltet auch eine Frist, die niemand gelesen hat.", en: "The contract also contains a deadline that nobody read." }, drill: { jp: "Der Vertrag kann strenge Auflagen beinhalten", en: "The contract may contain strict conditions" }, accept: ["to contain", "to include", "to comprise", "to cover"], hint: "bei + Inhalt: what is inside it. Written register — in speech Germans say enthalten." },
        { id: "de-u107l4-beruhen", type: "vocab", front: "beruhen", reading: "beruhen", meaning: "to rest on (be based on)", example: { jp: "Die ganze Rechnung beruht auf Zahlen aus dem Jahr 2019.", en: "The whole calculation rests on figures from 2019." }, drill: { jp: "Die Kritik kann auf einem Fehler beruhen", en: "The criticism may rest on an error" }, accept: ["to rest on", "to be based on", "to be founded on", "to derive from"], hint: "Always with auf + dative, and the auf-phrase comes first: auf einem Fehler beruhen. Never used alone." },
        { id: "de-u107l4-verfugen", type: "vocab", front: "verfügen", reading: "verfugen", meaning: "to have at one's disposal (über + accusative)", example: { jp: "Die Klinik verfügt über zwei eigene Stationen und ein kleines Institut.", en: "The clinic has two wards of its own and a small institute at its disposal." }, drill: { jp: "Das Institut kann über viel Geld verfügen", en: "The institute can draw on a lot of money" }, accept: ["to have at one's disposal", "to have", "to possess", "to command"], hint: "Accusative after über. Alone, verfügen means to decree — die Behörde hat verfügt, dass …" },
      ],
    },
  ],
};
