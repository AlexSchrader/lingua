  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u58l1-wahr", type: "vocab", front: "wahr", reading: "wahr", meaning: "true", example: { jp: "Was er gestern erzählt hat, ist zum Glück nicht wahr.", en: "What he told us yesterday is luckily not true." }, drill: { jp: "Das ist alles wirklich wahr", en: "That is all really true" }, accept: ["true", "real", "genuine", "correct"], hint: "The adjective under die Wahrheit in this lesson. nicht wahr? tacked onto a sentence is German's 'isn't it?'." },
      ],
    },
    {
      id: "de-u58l2",
      ...
      items: [
        ...
        { id: "de-u58l2-dasideal", type: "vocab", front: "das Ideal", reading: "dasideal", meaning: "the ideal", example: { jp: "Das Ideal ist schön, aber im Alltag hilft es selten.", en: "The ideal is beautiful, but in daily life it rarely helps." }, drill: { jp: "Das Ideal hilft im Alltag selten", en: "The ideal rarely helps in daily life" }, accept: ["ideal", "the ideal", "model", "the model"], hint: "Stressed on the last syllable: ide-AHL. The noun; ideal is also the adjective. einem Ideal nachjagen = to chase an ideal." },
      ],
    },
    {
      id: "de-u58l3",
