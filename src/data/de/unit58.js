  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u58l1-derbegriff", type: "vocab", front: "der Begriff", reading: "derbegriff", meaning: "the concept", example: { jp: "Der Begriff ist schwer zu erklären, weil man ihn nicht sehen kann.", en: "The concept is hard to explain, because you can't see it." }, drill: { jp: "Der Begriff ist sehr schwer", en: "The concept is very difficult" }, accept: ["concept", "the concept", "term", "the term", "notion", "the notion", "idea"], hint: "From begreifen (to grasp): what your mind can get hold of. im Begriff sein, etwas zu tun = to be about to do it." },
        ...
        { id: "de-u58l1-diebedeutung", type: "vocab", front: "die Bedeutung", reading: "diebedeutung", meaning: "the meaning", example: { jp: "Das Wort hat zwei Bedeutungen, deshalb gibt es oft ein Missverständnis.", en: "The word has two meanings, which is why there is often a misunderstanding." }, drill: { jp: "Die Bedeutung ist sehr wichtig", en: "The meaning is very important" }, accept: ["meaning", "the meaning", "significance", "the significance", "importance", "the importance", "sense"], hint: "From bedeuten, to mean. It also does 'importance': von großer Bedeutung = of great importance." },
        { id: "de-u58l1-dersinn", type: "vocab", front: "der Sinn", reading: "dersinn", meaning: "the sense", example: { jp: "Der Sinn der Übung ist nicht das Ergebnis, sondern der Weg.", en: "The point of the exercise isn't the result, but the path." }, drill: { jp: "Der Sinn ist sehr wichtig", en: "The point is very important" }, accept: ["sense", "the sense", "meaning", "the meaning", "point", "the point", "purpose"], hint: "Das hat keinen Sinn = that makes no sense. Also the five senses — and the root under der Unsinn (u51)." },
        { id: "de-u58l1-dievernunft", type: "vocab", front: "die Vernunft", reading: "dievernunft", meaning: "common sense", example: { jp: "Am Ende hat die Vernunft gewonnen, und wir sind zu Hause geblieben.", en: "In the end reason won, and we stayed at home." }, drill: { jp: "Die Vernunft hat am Ende gewonnen", en: "Reason won in the end" }, accept: ["reason", "the reason", "common sense", "the common sense", "sense", "rationality"], hint: "NOT der Grund, which is a reason WHY. This is the faculty of thinking straight. vernünftig = sensible." },
        { id: "de-u58l1-dieausnahme", type: "vocab", front: "die Ausnahme", reading: "dieausnahme", meaning: "the exception", example: { jp: "Es gibt eine Ausnahme für Kinder, die noch nicht sechs Jahre alt sind.", en: "There is an exception for children who aren't six years old yet." }, drill: { jp: "Die Ausnahme ist sehr wichtig", en: "The exception is very important" }, accept: ["exception", "the exception"], hint: "aus + nehmen: what is taken out of the rule. eine Ausnahme machen = to make an exception." },
      ],
    },
    {
      id: "de-u58l2",
      ...
      items: [
        { id: "de-u58l2-derwert", type: "vocab", front: "der Wert", reading: "derwert", meaning: "the value", example: { jp: "Der Wert der alten Uhr ist hoch, aber verkaufen will sie niemand.", en: "The value of the old clock is high, but nobody wants to sell it." }, drill: { jp: "Der Wert ist sehr hoch", en: "The value is very high" }, accept: ["value", "the value", "worth", "the worth"], hint: "Money value and moral value in one word: Werte haben = to have principles. wert sein = to be worth." },
        { id: "de-u58l2-dasprinzip", type: "vocab", front: "das Prinzip", reading: "dasprinzip", meaning: "the principle", example: { jp: "Aus Prinzip nimmt er kein Geld für die Arbeit, auch von Freunden nicht.", en: "On principle he takes no money for the work, not even from friends." }, drill: { jp: "Das Prinzip ist sehr wichtig", en: "The principle is very important" }, accept: ["principle", "the principle", "rule", "the rule"], hint: "Plural Prinzipien. aus Prinzip = on principle; im Prinzip = in principle, which in German also means 'in theory, but…'." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u58l4-derursprung", type: "vocab", front: "der Ursprung", reading: "derursprung", meaning: "the origin", example: { jp: "Der Ursprung des Wortes liegt weit in der Vergangenheit.", en: "The origin of the word lies far back in the past." }, drill: { jp: "Der Ursprung ist sehr alt", en: "The origin is very old" }, accept: ["origin", "the origin", "source", "the source", "beginning", "the beginning", "root"], hint: "ur- (primal) + der Sprung (the leap): where a thing first leapt into being. ursprünglich = originally." },
        ...
        { id: "de-u58l4-derzufall", type: "vocab", front: "der Zufall", reading: "derzufall", meaning: "the coincidence", example: { jp: "Es war ein Zufall, dass wir uns am Bahnhof getroffen haben.", en: "It was a coincidence that we met at the station." }, drill: { jp: "Der Zufall war sehr schön", en: "The coincidence was very nice" }, accept: ["coincidence", "the coincidence", "chance", "the chance", "accident", "the accident", "fluke"], hint: "zu + fallen: what falls to you. durch Zufall = by chance; zufällig = by accident, coincidentally." },
        { id: "de-u58l4-dieeinzelheit", type: "vocab", front: "die Einzelheit", reading: "dieeinzelheit", meaning: "the detail", example: { jp: "Die Einzelheiten kann ich morgen erklären, heute habe ich keine Zeit.", en: "I can explain the details tomorrow; today I have no time." }, drill: { jp: "Die Einzelheit ist sehr wichtig", en: "The detail is very important" }, accept: ["detail", "the detail", "particular", "the particular", "point", "the point", "specific"], hint: "einzeln (individual) + -heit. Usually plural: die Einzelheiten. The borrowed everyday word is das Detail." },
        { id: "de-u58l4-dasmerkmal", type: "vocab", front: "das Merkmal", reading: "dasmerkmal", meaning: "the feature", example: { jp: "Ein Merkmal von gutem Deutsch ist die richtige Reihenfolge der Wörter.", en: "A feature of good German is the correct order of the words." }, drill: { jp: "Das Merkmal ist sehr deutlich", en: "The feature is very clear" }, accept: ["feature", "the feature", "characteristic", "the characteristic", "trait", "the trait", "mark", "the mark"], hint: "merken (to notice) + das Mal (the mark): the mark you notice a thing by." },
        { id: "de-u58l4-gelten", type: "vocab", front: "gelten", reading: "gelten", meaning: "to be valid", example: { jp: "Die Regel gilt auch für Kinder, aber nicht am Wochenende.", en: "The rule applies to children too, but not at the weekend." }, drill: { jp: "Die alten Regeln gelten weiter", en: "The old rules still apply" }, accept: ["to apply", "apply", "to be valid", "be valid", "to hold", "hold", "to count", "to be in force"], hint: "Strong verb: es gilt, es galt. als etwas gelten = to be regarded as something." },
      ],
    },
  ],
};
