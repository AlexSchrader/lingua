  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u58l4-dasmerkmal", type: "vocab", front: "das Merkmal", reading: "dasmerkmal", meaning: "the feature", example: { jp: "Ein Merkmal von gutem Deutsch ist die richtige Reihenfolge der Wörter.", en: "A feature of good German is the correct order of the words." }, drill: { jp: "Das Merkmal zeigt sich beim Sprechen", en: "The feature shows when speaking" }, accept: ["feature", "the feature", "characteristic", "the characteristic", "trait", "the trait", "mark", "the mark"], hint: "merken (to notice) + das Mal (the mark): the mark you notice a thing by." },
