  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u43l2-kraftig", type: "vocab", front: "kräftig", reading: "kraftig", meaning: "strongly built", example: { jp: "Sie ist kräftig, weil sie viel arbeitet.", en: "She is strongly built, because she works a lot." }, drill: { jp: "Der Mann ist sehr kräftig", en: "The man is very strongly built" }, accept: ["strongly built", "strong", "sturdy", "powerful"], hint: "From die Kraft, strength. Also used of a colour or a taste that is intense." },
      ],
    },
    {
      id: "de-u43l3",
