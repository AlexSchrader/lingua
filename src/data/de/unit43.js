  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u43l1-diewange", type: "vocab", front: "die Wange", reading: "diewange", meaning: "the cheek", example: { jp: "Die Wangen sind rot, weil es kalt ist.", en: "Her cheeks are red because it is cold." }, drill: { jp: "Die Wange ist sehr rot", en: "The cheek is very red" }, accept: ["the cheek"], hint: "Die Backe means the same and is more colloquial. Wange is the one you meet in writing." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u43l2-muskulos", type: "vocab", front: "muskulös", reading: "muskulos", meaning: "muscular", example: { jp: "Mein Bruder ist groß und muskulös.", en: "My brother is tall and muscular." }, drill: { jp: "Der Mann ist sehr muskulös", en: "The man is very muscular" }, accept: ["muscular", "brawny", "well-built"], hint: "Having strong, visible muscles, from der Muskel. For a clearly athletic build." },
      ],
    },
    {
      id: "de-u43l3",
