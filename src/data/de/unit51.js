  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u51l1-derpunkt", type: "vocab", front: "der Punkt", reading: "derpunkt", meaning: "the point", example: { jp: "Das ist genau der Punkt, den ich betonen wollte.", en: "That is exactly the point I wanted to stress." }, drill: { jp: "Der Punkt ist wirklich wichtig", en: "The point is really important" }, accept: ["point", "the point", "dot", "the dot", "full stop", "item"], hint: "The point in an argument, the dot on the page and the full stop alike. der Standpunkt in this lesson is built on it; etwas auf den Punkt bringen = to sum it up." },
      ],
    },
    {
      id: "de-u51l2",
