  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u51l1-derstandpunkt", type: "vocab", front: "der Standpunkt", reading: "derstandpunkt", meaning: "the point of view", example: { jp: "Ich verstehe deinen Standpunkt, aber ich bin nicht einverstanden.", en: "I understand your point of view, but I don't agree." }, drill: { jp: "Der Standpunkt ist interessant", en: "The point of view is interesting" }, accept: ["point of view", "the point of view", "standpoint", "the standpoint", "position", "the position"], hint: "der Stand (where you stand) + der Punkt: the point you are standing on. einen Standpunkt vertreten = to hold a position." },
        ...
        { id: "de-u51l1-dietatsache", type: "vocab", front: "die Tatsache", reading: "dietatsache", meaning: "the fact", example: { jp: "Die Tatsache ist, dass wir für die Arbeit zu wenig Zeit haben.", en: "The fact is that we have too little time for the work." }, drill: { jp: "Die Tatsache ist wichtig", en: "The fact is important" }, accept: ["fact", "the fact"], hint: "die Tat (the deed) + die Sache (the thing): a thing that was actually done. Tatsache ist… opens a lot of German arguments." },
        { id: "de-u51l1-dervorschlag", type: "vocab", front: "der Vorschlag", reading: "dervorschlag", meaning: "the suggestion", example: { jp: "Mein Vorschlag war gut, aber der Chef hat ihn sofort abgelehnt.", en: "My suggestion was good, but the boss turned it down immediately." }, drill: { jp: "Der Vorschlag ist sehr gut", en: "The suggestion is very good" }, accept: ["suggestion", "the suggestion", "proposal", "the proposal"], hint: "From vorschlagen, literally 'to strike forward'. einen Vorschlag machen = to make a suggestion. Plural: Vorschläge." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u51l3-derstreit", type: "vocab", front: "der Streit", reading: "derstreit", meaning: "the quarrel", example: { jp: "Der Streit zwischen zwei Kollegen dauert schon eine Woche.", en: "The quarrel between the two colleagues has been going on for a week." }, drill: { jp: "Der Streit war sehr laut", en: "The quarrel was very loud" }, accept: ["quarrel", "the quarrel", "argument", "the argument", "dispute", "the dispute", "row"], hint: "A real fight in words, not a polite disagreement. Streit haben mit jemandem = to be having a row with someone." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u51l4-dasmissverstandnis", type: "vocab", front: "das Missverständnis", reading: "dasmissverstandnis", meaning: "the misunderstanding", example: { jp: "Es war ein Missverständnis, weil wir über verschiedene Themen gesprochen haben.", en: "It was a misunderstanding, because we were talking about different topics." }, drill: { jp: "Das Missverständnis war sehr groß", en: "The misunderstanding was very big" }, accept: ["misunderstanding", "the misunderstanding", "mix-up", "the mix-up", "mixup"], hint: "miss- (wrongly) + verstehen: understanding gone wrong. Note the double s before the t, and the ä from verständlich." },
        ...
        { id: "de-u51l4-dasvorurteil", type: "vocab", front: "das Vorurteil", reading: "dasvorurteil", meaning: "the prejudice", example: { jp: "Er hat ein Vorurteil gegen die Stadt, obwohl er nie dort war.", en: "He has a prejudice against the city, although he has never been there." }, drill: { jp: "Das Vorurteil ist sehr alt", en: "The prejudice is very old" }, accept: ["prejudice", "the prejudice", "bias", "the bias", "preconception"], hint: "vor + das Urteil (the judgement): judging before you know. Plural: Vorurteile." },
