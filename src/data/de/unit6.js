  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u6l1-dasei", type: "vocab", front: "das Ei", reading: "dasei", meaning: "egg", example: { jp: "Ein Ei, bitte!", en: "One egg, please!" }, accept: ["egg", "the egg"], hint: "Said exactly like English \"eye\" — the ei rule from u1. Plural die Eier." },
        { id: "de-u6l1-derreis", type: "vocab", front: "der Reis", reading: "derreis", meaning: "rice", example: { jp: "Wir essen Reis.", en: "We eat rice." }, accept: ["rice", "the rice"], hint: "RICE, with the same ei. Like English, it takes no article when you mean rice in general." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u6l2-derapfel", type: "vocab", front: "der Apfel", reading: "derapfel", meaning: "apple", example: { jp: "Ein Apfel ist gut.", en: "An apple is good." }, accept: ["apple", "the apple"], hint: "AP-fel — pf is one sound, lips together then straight into f. Plural die Äpfel, with the umlaut." },
        ...
        { id: "de-u6l2-dietomate", type: "vocab", front: "die Tomate", reading: "dietomate", meaning: "tomato", example: { jp: "Wir essen eine Tomate.", en: "We are eating a tomato." }, accept: ["tomato", "the tomato"], hint: "to-MAH-te. Same -e ending, same die." },
        ...
        { id: "de-u6l2-dasgemuse", type: "vocab", front: "das Gemüse", reading: "dasgemuse", meaning: "vegetables", example: { jp: "Gemüse ist sehr gut.", en: "Vegetables are very good." }, accept: ["vegetables", "vegetable", "veg"], hint: "ge-MÜ-ze, with the ü of Tür. Grammatically SINGULAR where English is plural: Gemüse ist, never sind." },
        { id: "de-u6l2-dasobst", type: "vocab", front: "das Obst", reading: "dasobst", meaning: "fruit", example: { jp: "Obst und Gemüse sind lecker.", en: "Fruit and vegetables are delicious." }, accept: ["fruit", "the fruit"], hint: "OHPST — the b hardens to p. Also singular, and it means fruit collectively, not one piece." },
      ],
    },
    {
      id: "de-u6l3",
      ...
      items: [
        { id: "de-u6l3-daswasser", type: "vocab", front: "das Wasser", reading: "daswasser", meaning: "water", example: { jp: "Wasser, bitte!", en: "Water, please!" }, accept: ["water", "the water"], hint: "VA-ser, with w as v. Ordering it, Germans specify: mit Gas or ohne Gas." },
        { id: "de-u6l3-derkaffee", type: "vocab", front: "der Kaffee", reading: "derkaffee", meaning: "coffee", example: { jp: "Wir trinken Kaffee.", en: "We drink coffee." }, accept: ["coffee", "the coffee"], hint: "KA-fay, stress on the first syllable — unlike English \"caf-FAY\"." },
        { id: "de-u6l3-dertee", type: "vocab", front: "der Tee", reading: "dertee", meaning: "tea", example: { jp: "Ich trinke Tee.", en: "I drink tea." }, accept: ["tea", "the tea"], hint: "TAY, one long syllable. Both Kaffee and Tee are masculine." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u6l4-trinken", type: "vocab", front: "trinken", reading: "trinken", meaning: "to drink", example: { jp: "Was trinkst du?", en: "What are you drinking?" }, accept: ["to drink", "drink"], hint: "Fully regular: ich trinke, du trinkst, er trinkt. German has no separate \"am drinking\" form — trinke covers both." },
        ...
        { id: "de-u6l4-derhunger", type: "vocab", front: "der Hunger", reading: "derhunger", meaning: "hunger", example: { jp: "Ich habe Hunger.", en: "I am hungry." }, accept: ["hunger", "the hunger"], hint: "German HAS hunger where English IS hungry: Ich habe Hunger. Same with thirst — Ich habe Durst." },
      ],
    },
  ],
};
