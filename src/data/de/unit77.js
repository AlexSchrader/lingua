  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u77l1-dasfreizeichen", type: "vocab", front: "das Freizeichen", reading: "dasfreizeichen", meaning: "the ringing tone", example: { jp: "Ich höre das Freizeichen, aber niemand antwortet.", en: "I hear the ringing tone, but nobody answers." }, drill: { jp: "Das Freizeichen kommt sehr spät", en: "The ringing tone comes very late" }, accept: ["ringing tone", "the ringing tone", "dial tone", "the dial tone", "the ring tone"], hint: "frei = free, das Zeichen = the signal: the line is free and ringing." },
        { id: "de-u77l1-annehmen", type: "vocab", front: "annehmen", reading: "annehmen", meaning: "to take a call", example: { jp: "Können Sie das Telefon für mich annehmen?", en: "Can you take the phone for me?" }, drill: { jp: "Ich kann das Telefon annehmen", en: "I can take the phone" }, accept: ["to take a call", "take a call", "to accept", "accept", "to answer a call"], hint: "Separable: ich nehme den Anruf an. It also means to assume or suppose." },
      ],
    },
    {
      id: "de-u77l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u77l3-deutlich", type: "vocab", front: "deutlich", reading: "deutlich", meaning: "clear to make out", example: { jp: "Sprechen Sie bitte laut und deutlich.", en: "Please speak loudly and clearly." }, drill: { jp: "Sagen Sie das bitte deutlich", en: "Please say that clearly" }, accept: ["clear", "clearly", "distinct", "plain", "easy to make out"], hint: "Clear enough to make out. Not the same as klar, which is clear in the mind." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u77l4-unterbrechen", type: "vocab", front: "unterbrechen", reading: "unterbrechen", meaning: "to interrupt", example: { jp: "Bitte unterbrechen Sie mich nicht.", en: "Please don't interrupt me." }, drill: { jp: "Sie darf mich nicht unterbrechen", en: "She must not interrupt me" }, accept: ["to interrupt", "interrupt", "to break in", "to cut in", "to cut off"], hint: "unter + brechen. NOT separable: ich unterbreche dich." },
      ],
    },
  ],
};
