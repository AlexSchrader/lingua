  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u77l1-dierufnummer", type: "vocab", front: "die Rufnummer", reading: "dierufnummer", meaning: "the phone number", example: { jp: "Bitte geben Sie Ihre Rufnummer mit Vorwahl an.", en: "Please give your phone number with the area code." }, drill: { jp: "Die Rufnummer steht auf dem Formular", en: "The phone number is on the form" }, accept: ["phone number", "the phone number", "telephone number", "number", "the number"], hint: "The formal word on forms and answering machines; in speech people say die Nummer or die Telefonnummer. rufen + die Nummer." },
      ],
    },
    {
      id: "de-u77l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u77l3-derruckruf", type: "vocab", front: "der Rückruf", reading: "derruckruf", meaning: "the call back", example: { jp: "Ich bitte um einen kurzen Rückruf, sobald Sie wieder im Haus sind.", en: "I'd ask for a short call back as soon as you are back in the building." }, drill: { jp: "Der Rückruf kam erst am Montag", en: "The call back only came on Monday" }, accept: ["call back", "the call back", "callback", "return call", "the return call"], hint: "zurück + der Ruf: exactly what you ask for on an Anrufbeantworter. um Rückruf bitten is the standard phrasing; zurückrufen is the verb." },
      ],
    },
    {
      id: "de-u77l4",
      ...
      items: [
        ...
        { id: "de-u77l4-dieleitung", type: "vocab", front: "die Leitung", reading: "dieleitung", meaning: "the phone line", example: { jp: "Die Leitung war so schlecht, dass wir uns kaum verstanden haben.", en: "The line was so bad that we could hardly understand each other." }, drill: { jp: "Die Leitung war heute sehr schlecht", en: "The line was very bad today" }, accept: ["line", "the line", "connection", "the connection", "cable", "management"], hint: "The wire itself — die Störung in this lesson is what goes wrong on it. Same word for a water pipe, and for the management of a firm: die Leitung übernehmen." },
      ],
    },
  ],
};
