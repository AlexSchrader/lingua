...
export const DE_UNIT29 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u29l2-dass", type: "vocab", front: "dass", reading: "dass", meaning: "that — links a clause", example: { jp: "Ich weiß, dass du hier bist.", en: "I know that you are here." }, drill: { jp: "Der Chef sagt dass wir kommen", en: "The boss says that we are coming" }, accept: ["that"], hint: "⚠️ Two words one letter apart: das points at something (das Buch, das ist gut), dass links two clauses. If you can replace it with \"which\" or \"this\", it is das; if it introduces a whole clause, it is dass. Verb to the end after it." },
        ...
        { id: "de-u29l2-hoffen", type: "vocab", front: "hoffen", reading: "hoffen", meaning: "to hope", example: { jp: "Wir hoffen, dass ihr kommt.", en: "We hope that you are coming." }, drill: { jp: "Die Eltern hoffen auf gutes Wetter", en: "The parents hope for good weather" }, accept: ["to hope", "hope"], hint: "Hoffentlich is the everyday adverb built from it: Hoffentlich regnet es nicht — hopefully it will not rain." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u29l3-wenn", type: "vocab", front: "wenn", reading: "wenn", meaning: "if — a condition", example: { jp: "Wenn es regnet, bleiben wir hier.", en: "If it rains, we will stay here." }, drill: { jp: "Wenn der Chef kommt arbeiten wir", en: "When the boss comes we work" }, accept: ["if", "when", "whenever"], hint: "⚠️ Do not confuse with the already-taught wann, which only asks a question: Wann kommst du? Wenn never asks — it sets up a condition or a repeated occasion." },
        ...
        { id: "de-u29l3-bevor", type: "vocab", front: "bevor", reading: "bevor", meaning: "before", example: { jp: "Bevor wir gehen, trinken wir Kaffee.", en: "Before we go, we drink coffee." }, drill: { jp: "Bevor der Zug kommt warten wir", en: "Before the train comes we wait" }, accept: ["before"], hint: "The conjunction, taking a whole clause. The preposition vor, which you know from u13, takes only a noun: vor dem Essen." },
        ...
        { id: "de-u29l3-waehrend", type: "vocab", front: "während", reading: "wahrend", meaning: "while", example: { jp: "Während wir arbeiten, hören wir Musik.", en: "While we work, we listen to music." }, drill: { jp: "Während wir warten lesen wir", en: "While we wait we read" }, accept: ["while", "during", "whilst"], hint: "Also a preposition with the genitive — während des Tages — but as a conjunction it takes a clause and sends the verb to the end." },
      ],
    },
    {
      id: "de-u29l4",
      ...
      items: [
        { id: "de-u29l4-obwohl", type: "vocab", front: "obwohl", reading: "obwohl", meaning: "although", example: { jp: "Obwohl es regnet, gehen wir.", en: "Although it is raining, we are going." }, drill: { jp: "Obwohl es kalt ist gehen wir", en: "Although it is cold we are going" }, accept: ["although", "though", "even though"], hint: "Sends the verb to the end, like every subordinator here. Its non-subordinating partner is trotzdem, the next card." },
        ...
        { id: "de-u29l4-falls", type: "vocab", front: "falls", reading: "falls", meaning: "in case", example: { jp: "Falls es regnet, bleiben wir hier.", en: "In case it rains, we will stay here." }, drill: { jp: "Falls es kalt ist bleiben wir hier", en: "In case it is cold we will stay here" }, accept: ["in case", "if", "should"], hint: "A more cautious wenn — it leans towards the unlikely. Built from der Fall, the case." },
