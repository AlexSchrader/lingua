  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u29l1-dergrund", type: "vocab", front: "der Grund", reading: "dergrund", meaning: "the reason", example: { jp: "Der Grund ist das Wetter.", en: "The reason is the weather." }, drill: { jp: "Der Grund ist das Wetter", en: "The reason is the weather" }, accept: ["the reason", "reason", "the ground"], hint: "Aus diesem Grund = for this reason. It also means the ground you stand on, and the bottom of a lake." },
        { id: "de-u29l1-naemlich", type: "vocab", front: "nämlich", reading: "namlich", meaning: "namely", example: { jp: "Wir gehen nicht, es regnet nämlich.", en: "We are not going — it is raining, you see." }, drill: { jp: "Es regnet nämlich sehr", en: "It is raining a great deal, you see" }, accept: ["namely", "you see", "that is", "as it happens"], hint: "Never first in the sentence. It slips in after the verb to explain what you just said — closest to English \"you see\" tacked on the end." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u29l2-erzaehlen", type: "vocab", front: "erzählen", reading: "erzahlen", meaning: "to tell", example: { jp: "Die Kinder erzählen von der Schule.", en: "The children are telling about school." }, drill: { jp: "Die Kinder erzählen von der Schule", en: "The children talk about school" }, accept: ["to tell", "to recount", "tell"], hint: "erzählen VON etwas, with the dative. Do not confuse it with sagen — you sagen a fact, you erzählen a story." },
        { id: "de-u29l2-diemeinung", type: "vocab", front: "die Meinung", reading: "diemeinung", meaning: "the opinion", example: { jp: "Die Meinung ist nicht falsch.", en: "The opinion is not wrong." }, drill: { jp: "Die Meinung ist nicht falsch", en: "The opinion is not wrong" }, accept: ["the opinion", "opinion", "view"], hint: "Meiner Meinung nach = in my opinion, and it is the phrase you will use most. Nouns in -ung are always die." },
      ],
    },
    {
      id: "de-u29l3",
      ...
      items: [
        { id: "de-u29l3-wenn", type: "vocab", front: "wenn", reading: "wenn", meaning: "if or when — condition", example: { jp: "Wenn es regnet, bleiben wir hier.", en: "If it rains, we will stay here." }, drill: { jp: "Wenn es regnet bleiben wir", en: "If it rains we stay" }, accept: ["if", "when", "whenever"], hint: "⚠️ Do not confuse with the already-taught wann, which only asks a question: Wann kommst du? Wenn never asks — it sets up a condition or a repeated occasion." },
