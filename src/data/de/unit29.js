  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u29l1-naemlich", type: "vocab", front: "nämlich", reading: "namlich", meaning: "namely", example: { jp: "Wir gehen nicht, es regnet nämlich.", en: "We are not going — it is raining, you see." }, drill: { jp: "Wir bleiben hier, es regnet nämlich", en: "We are staying here, it is raining, you see" }, accept: ["namely", "you see", "that is", "as it happens"], hint: "Never first in the sentence. It slips in after the verb to explain what you just said — closest to English \"you see\" tacked on the end." },
