...
export const DE_UNIT110 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u110l2-dasgremium", type: "vocab", front: "das Gremium", reading: "dasgremium", meaning: "body (formally constituted group)", example: { jp: "Das Gremium hat elf Mitglieder und entscheidet über die Drittmittel.", en: "The body has eleven members and decides on the third-party funding." }, drill: { jp: "Das Gremium entscheidet über alle Mittel", en: "The body decides on all the funding" }, accept: ["body", "committee", "panel", "board"], hint: "Plural die Gremien. The umbrella word for any formal group that decides together — Ausschuss, Rat, Beirat are all Gremien." },
        { id: "de-u110l2-derausschuss", type: "vocab", front: "der Ausschuss", reading: "derausschuss", meaning: "committee (working sub-group)", example: { jp: "Der Ausschuss bereitet die Entscheidung vor, treffen muss sie jemand anderes.", en: "The committee prepares the decision; somebody else has to take it." }, drill: { jp: "Der Ausschuss tagt am nächsten Dienstag", en: "The committee meets next Tuesday" }, accept: ["committee", "subcommittee", "panel"], hint: "A working group cut out of a larger body — the parliamentary standard. A second sense is factory waste: Ausschuss produzieren." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u110l3-dieinstanz", type: "vocab", front: "die Instanz", reading: "dieinstanz", meaning: "level of authority (court or administrative stage)", example: { jp: "In der ersten Instanz hat er verloren, in der zweiten gewonnen.", en: "He lost at the first level and won at the second." }, drill: { jp: "Die Instanz darüber entscheidet noch einmal", en: "The level above decides once more" }, accept: ["level of authority", "instance", "court level", "tier"], hint: "Each Instanz can overturn the one below. Letzte Instanz means both the final court and, in everyday speech, the last word." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u110l4-verlautbaren", type: "vocab", front: "verlautbaren", reading: "verlautbaren", meaning: "to state publicly (issue a formal word)", example: { jp: "Aus dem Ministerium wurde verlautbart, dass die Prüfung weiterläuft.", en: "It was stated publicly from the ministry that the examination continues." }, drill: { jp: "Das Ministerium wollte dazu nichts verlautbaren", en: "The ministry wanted to state nothing publicly on it" }, accept: ["to state publicly", "to announce officially", "to give out", "to issue a statement"], hint: "Stiff even for officialese, and usually passive: es wurde verlautbart. Its everyday relative is the far commoner verlauten lassen." },
      ],
    },
  ],
};
