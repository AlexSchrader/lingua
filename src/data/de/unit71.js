  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u71l1-trotz", type: "vocab", front: "trotz", reading: "trotz", meaning: "in spite of", example: { jp: "Trotz des Regens sind viele Kinder auf der Wiese.", en: "In spite of the rain there are many children on the meadow." }, drill: { jp: "Trotz des Regens gehen wir", en: "In spite of the rain we are going" }, accept: ["in spite of", "despite", "notwithstanding"], hint: "The preposition behind trotzdem (u29), which is the adverb form." },
        { id: "de-u71l1-statt", type: "vocab", front: "statt", reading: "statt", meaning: "instead of", example: { jp: "Statt des Autos nehmen wir bei dem Wetter besser den Zug.", en: "Instead of the car we had better take the train in this weather." }, drill: { jp: "Statt des Autos nehmen wir den Zug", en: "Instead of the car we take the train" }, accept: ["instead of", "in place of", "rather than"], hint: "anstatt (u36) is the same word in full. Also opens a clause: statt zu warten." },
