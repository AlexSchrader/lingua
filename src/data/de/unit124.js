  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u124l1-diesosse", type: "vocab", front: "die Soße", reading: "diesosse", meaning: "the sauce", example: { jp: "Zu den Nudeln gab es eine Soße aus frischen Tomaten.", en: "With the pasta there was a sauce made of fresh tomatoes." }, drill: { jp: "Die Soße schmeckt nach frischen Tomaten", en: "The sauce tastes of fresh tomatoes" }, accept: ["sauce", "the sauce", "gravy", "the gravy", "dressing"], hint: "Also spelled Sauce on menus; the ß is the everyday form and types as ss: diesosse. Covers gravy too — Soße zum Braten." },
      ],
    },
    {
      id: "de-u124l2",
      ...
      items: [
        ...
        { id: "de-u124l2-diegastfreundschaft", type: "vocab", front: "die Gastfreundschaft", reading: "diegastfreundschaft", meaning: "the hospitality", example: { jp: "Die Gastfreundschaft in diesem Haus ist wirklich groß.", en: "The hospitality in this house is really great." }, drill: { jp: "Die Gastfreundschaft in diesem Haus ist groß", en: "The hospitality in this house is great" }, accept: ["hospitality", "the hospitality", "welcome", "the welcome"], hint: "der Gast + die Freundschaft. What der Besuch in this lesson is met with. The standard thank-you line: vielen Dank für die Gastfreundschaft." },
      ],
    },
    {
      id: "de-u124l3",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u124l4-stoehnen", type: "vocab", front: "stöhnen", reading: "stohnen", meaning: "to groan", example: { jp: "Alle stöhnen über die neue Regel, aber niemand sagt es dem Chef ins Gesicht.", en: "Everyone groans about the new rule, but nobody says it to the boss's face." }, drill: { jp: "Die Leute stöhnen über die Preise", en: "People groan about the prices" }, accept: ["to groan", "groan", "to moan", "moan", "to complain"], hint: "Tier D — chosen, not measured. It completes a set the course already opened: seufzen, gähnen, zittern and flüstern are all taught (u57, u85, u86) and this one was missing. über etwas stöhnen is to grumble about it." },
        { id: "de-u124l4-derschwur", type: "vocab", front: "der Schwur", reading: "derschwur", meaning: "the oath", example: { jp: "Der Schwur war schnell gesprochen, aber gehalten hat ihn niemand.", en: "The oath was quickly spoken, but nobody kept it." }, drill: { jp: "Der Schwur war schnell gesprochen", en: "The oath was quickly spoken" }, accept: ["oath", "the oath", "vow", "the vow", "pledge"], hint: "The noun beside schwören in this lesson — note the vowel change: schwören, schwor, der Schwur. In court you take den Eid instead." },
      ],
    },
  ],
};
