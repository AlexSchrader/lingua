  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u124l2-daszuhause", type: "vocab", front: "das Zuhause", reading: "daszuhause", meaning: "the home (one's own)", example: { jp: "Nach so vielen Jahren im Ausland will er vor allem ein richtiges Zuhause.", en: "After so many years abroad, what he wants above all is a real home." }, drill: { jp: "Das Zuhause ist ihm sehr wichtig", en: "Home is very important to him" }, accept: ["home", "the home", "a home"], hint: "Rank 1777. The noun, written as one word and capitalised — distinct from the adverb zu Hause (at home), which stays two words. German draws the line English does not." },
        ...
        { id: "de-u124l2-dergedanke", type: "vocab", front: "der Gedanke", reading: "dergedanke", meaning: "the thought", example: { jp: "Der Gedanke kam ihm erst am Abend, als die anderen schon lange nach Hause waren.", en: "The thought only came to him in the evening, when the others had long since gone home." }, drill: { jp: "Der Gedanke kam mir heute Morgen", en: "The thought came to me this morning" }, accept: ["thought", "the thought", "idea", "notion"], hint: "Rank 1341. From denken. A weak masculine with an odd genitive: des Gedankens. ⚠️ Nothing to do with danke (thanks, u2), which the stem checker flags as a false family." },
      ],
    },
    {
      id: "de-u124l3",
