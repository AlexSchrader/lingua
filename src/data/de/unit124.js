...
// FREE: gemacht, gegessen, gekommen, gefunden, getrunken, gedacht
export const DE_UNIT124 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u124l2-derbesuch", type: "vocab", front: "der Besuch", reading: "derbesuch", meaning: "the visit", example: { jp: "Der Besuch bleibt nur zwei Tage, und trotzdem hat die halbe Familie frei genommen.", en: "The visitors are staying only two days, and yet half the family has taken time off." }, drill: { jp: "Der Besuch kommt erst am Abend", en: "The visit comes only in the evening" }, accept: ["visit", "the visit", "visitors", "company", "guest"], hint: "Rank 1647. Both the visit and the PEOPLE visiting — Besuch haben is to have company. Singular even when several people come." },
        { id: "de-u124l2-daszuhause", type: "vocab", front: "das Zuhause", reading: "daszuhause", meaning: "the home", example: { jp: "Nach so vielen Jahren im Ausland will er vor allem ein richtiges Zuhause.", en: "After so many years abroad, what he wants above all is a real home." }, drill: { jp: "Das Zuhause ist ihm sehr wichtig", en: "Home is very important to him" }, accept: ["home", "the home", "a home"], hint: "Rank 1777. The noun, written as one word and capitalised — distinct from the adverb zu Hause (at home), which stays two words. German draws the line English does not." },
        { id: "de-u124l2-derspass", type: "vocab", front: "der Spaß", reading: "derspass", meaning: "the fun", example: { jp: "Die Arbeit macht ihm Spaß, auch wenn sie ihn fast jeden Abend eine Stunde kostet.", en: "He enjoys the work, even though it costs him an hour almost every evening." }, drill: { jp: "Der Spaß war es wirklich wert", en: "The fun was really worth it" }, accept: ["fun", "the fun", "enjoyment", "joke", "pleasure"], hint: "Rank 583. Spaß machen is the standard way to say you enjoy something — the fun is the subject, not you. Also a joke: aus Spaß, as a joke." },
        { id: "de-u124l2-dieachtung", type: "vocab", front: "die Achtung", reading: "dieachtung", meaning: "the respect", example: { jp: "Vor seiner Arbeit hat im Betrieb jeder Achtung, auch die Leute, die ihn nicht mögen.", en: "Everyone in the firm has respect for his work, even the people who don't like him." }, drill: { jp: "Die Achtung war ihm sehr wichtig", en: "The respect was very important to him" }, accept: ["respect", "the respect", "regard", "esteem", "attention"], hint: "Rank 1501. As a bare shout — Achtung! — it means 'look out', which is how most learners meet it first. Achtung vor jemandem haben is to respect them." },
        { id: "de-u124l2-dieidee", type: "vocab", front: "die Idee", reading: "dieidee", meaning: "the idea", example: { jp: "Die Idee ist nicht neu, aber bisher hat sie niemand so genau zu Ende gedacht.", en: "The idea is not new, but so far nobody has thought it through so precisely." }, drill: { jp: "Die Idee war von Anfang an gut", en: "The idea was good from the start" }, accept: ["idea", "the idea", "notion", "thought", "concept"], hint: "Rank 504 and taught nowhere in 113 units. Three syllables, stress on the last: i-DEE. keine Idee is 'no idea at all'." },
      ],
    },
    {
      id: "de-u124l3",
