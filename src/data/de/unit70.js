  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u70l1-geschehen", type: "vocab", front: "geschehen", reading: "geschehen", meaning: "to happen (formal)", example: { jp: "Nach dem harten Winter ist in der Stadt viel geschehen.", en: "After the hard winter a lot happened in the city." }, drill: { jp: "Hier kann noch viel geschehen", en: "A lot can still happen here" }, accept: ["to happen", "to occur", "to come about"], hint: "Perfect with sein and no extra ge-: es ist geschehen. Gern geschehen! = you're welcome." },
        ...
        { id: "de-u70l1-vorkommen", type: "vocab", front: "vorkommen", reading: "vorkommen", meaning: "to occur (crop up)", example: { jp: "So ein Fehler darf in einem fertigen Bericht nicht vorkommen.", en: "A mistake like that must not occur in a finished report." }, drill: { jp: "So ein Fehler darf nicht vorkommen", en: "A mistake like that must not occur" }, accept: ["to occur", "occur", "to happen", "to appear", "to crop up"], hint: "Separable: es kommt selten vor. Of things that turn up rather than events that take place — for the latter use stattfinden (u62). Das kommt mir bekannt vor = that seems familiar to me." },
      ],
    },
    {
      id: "de-u70l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u70l4-hypothetisch", type: "vocab", front: "hypothetisch", reading: "hypothetisch", meaning: "hypothetical", example: { jp: "Die Frage ist nur hypothetisch, denn so weit wird es nicht kommen.", en: "The question is only hypothetical, because it will not come to that." }, drill: { jp: "Die Frage ist nur hypothetisch gemeint", en: "The question is meant only hypothetically" }, accept: ["hypothetical", "hypothetically", "theoretical", "purely theoretical"], hint: "hü-po-TEH-tisch, with the German h sounded. The label for exactly the sentences this lesson builds: angenommen…, an deiner Stelle…" },
      ],
    },
  ],
};
