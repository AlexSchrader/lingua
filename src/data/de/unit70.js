  ...
  lessons: [
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Say what was done without naming who did it: the passive participle, to take place, to occur, to happen, to arise, to turn out.",
      items: [
        ...
        { id: "de-u70l1-erfolgen", type: "vocab", front: "erfolgen", reading: "erfolgen", meaning: "to take place", example: { jp: "Die Antwort von der Firma erfolgt in den Tagen danach.", en: "The answer from the firm comes in the days after that." }, drill: { jp: "Die Antwort kann bald erfolgen", en: "The answer can come soon" }, accept: ["to take place", "to occur", "to come", "to ensue", "to be carried out"], hint: "Official German for 'it happens'. You will read it on every form and letter." },
        { id: "de-u70l1-stattfinden", type: "vocab", front: "stattfinden", reading: "stattfinden", meaning: "to take place", example: { jp: "Das Konzert am Meer findet auch bei Regen statt.", en: "The concert by the sea takes place even in the rain." }, drill: { jp: "Das Konzert kann morgen stattfinden", en: "The concert can take place tomorrow" }, accept: ["to take place", "to happen", "to be held", "to go ahead"], hint: "Separable: es findet statt. Only of arranged events, never of accidents." },
        ...
        { id: "de-u70l1-sichergeben", type: "vocab", front: "sich ergeben", reading: "sichergeben", meaning: "to arise", example: { jp: "Aus dem langen Streit hat sich am Ende eine gute Lösung ergeben.", en: "Out of the long argument a good solution arose in the end." }, drill: { jp: "Die Frage kann sich ergeben", en: "The question can arise" }, accept: ["to arise", "to come up", "to result", "to emerge", "to surrender"], hint: "Of a question or a chance arising. Of a soldier it means to surrender." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u70l4-beinahe", type: "vocab", front: "beinahe", reading: "beinahe", meaning: "almost", example: { jp: "Beinahe wären wir zu spät zum Zug nach Hamburg.", en: "We were almost too late for the train to Hamburg." }, drill: { jp: "Wir waren beinahe zu spät", en: "We were almost too late" }, accept: ["almost", "nearly", "very nearly"], hint: "Same sense as fast (u28), but beinahe is the one used with a Konjunktiv for a near miss." },
