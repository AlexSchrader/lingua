...
export const DE_UNIT70 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u70l4-beinahe", type: "vocab", front: "beinahe", reading: "beinahe", meaning: "almost", example: { jp: "Beinahe wären wir zu spät zum Zug nach Hamburg gekommen.", en: "We were almost too late for the train to Hamburg." }, drill: { jp: "Wir waren beinahe zu spät", en: "We were almost too late" }, accept: ["almost", "nearly", "very nearly"], hint: "Same sense as fast (u28), but beinahe is the one used with a Konjunktiv for a near miss." },
