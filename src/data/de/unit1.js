  ...
  lessons: [
    ...
    // before groß because groß's example ("Die Schule ist groß und schön") uses it.
    {
      ...
      items: [
        ...
        { id: "de-u1l5-hasslich", type: "vocab", front: "hässlich", reading: "hasslich", meaning: "ugly", example: { jp: "Die Straße hier ist hässlich.", en: "The street here is ugly." }, drill: { jp: "Die Schule hier ist hässlich", en: "The school here is ugly" }, accept: ["ugly", "hideous", "unsightly"], hint: "The opposite of schön, and it carries both new letters at once: ä as in spät, then the ß of Straße. Type it hasslich." },
      ],
    },
  ],
};
