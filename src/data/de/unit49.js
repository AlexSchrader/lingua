...
// vocab introduced at or before u49; adjectives are shown in the predicate.
  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u49l1-flach", type: "vocab", front: "flach", reading: "flach", meaning: "flat", example: { jp: "Das Land hier ist sehr flach.", en: "The land here is very flat." }, drill: { jp: "Der Teller ist flach", en: "The plate is flat" }, accept: ["flat", "shallow", "level"], hint: "Of land, a plate, or shallow water — flaches Wasser." },
        ...
        { id: "de-u49l1-eckig", type: "vocab", front: "eckig", reading: "eckig", meaning: "angular", example: { jp: "Die Uhr ist eckig, nicht rund.", en: "The clock is square, not round." }, drill: { jp: "Das Fenster ist eckig", en: "The window is square" }, accept: ["angular", "square", "cornered", "boxy"], hint: "From die Ecke, the corner. Having corners rather than being round." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u49l2-stumpf", type: "vocab", front: "stumpf", reading: "stumpf", meaning: "blunt", example: { jp: "Das Messer ist stumpf und schneidet nicht.", en: "The knife is blunt and doesn't cut." }, drill: { jp: "Die Schere ist stumpf", en: "The scissors are blunt" }, accept: ["blunt", "dull"], hint: "The opposite of scharf (sharp). Also of a colour or mood: dull." },
        { id: "de-u49l2-hohl", type: "vocab", front: "hohl", reading: "hohl", meaning: "hollow", example: { jp: "Der alte Baum ist innen hohl.", en: "The old tree is hollow inside." }, drill: { jp: "Der Ball ist hohl", en: "The ball is hollow" }, accept: ["hollow", "empty inside"], hint: "Empty on the inside. die Höhle is a cave." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u49l3-roh", type: "vocab", front: "roh", reading: "roh", meaning: "raw", example: { jp: "Das Fleisch ist noch roh.", en: "The meat is still raw." }, drill: { jp: "Das Ei ist roh", en: "The egg is raw" }, accept: ["raw", "uncooked"], hint: "Not cooked. Also rough or brutal: rohe Gewalt." },
        ...
        { id: "de-u49l3-zah", type: "vocab", front: "zäh", reading: "zah", meaning: "tough", example: { jp: "Das Fleisch ist alt und zäh.", en: "The meat is old and tough." }, drill: { jp: "Das Fleisch ist zäh", en: "The meat is tough" }, accept: ["tough", "chewy", "tenacious"], hint: "Hard to chew. Of a person: tough, persistent." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u49l4-giftig", type: "vocab", front: "giftig", reading: "giftig", meaning: "poisonous", example: { jp: "Diese Pflanze ist sehr giftig.", en: "This plant is very poisonous." }, drill: { jp: "Die Beeren sind giftig", en: "The berries are poisonous" }, accept: ["poisonous", "toxic", "venomous"], hint: "From das Gift, poison (a false friend — Gift is not a present!)." },
