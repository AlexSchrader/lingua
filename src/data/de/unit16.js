...
export const DE_UNIT16 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u16l3-tausend", type: "vocab", front: "tausend", reading: "tausend", meaning: "thousand", example: { jp: "Das Auto kostet tausend Euro.", en: "The car costs a thousand euros." }, drill: { jp: "Tausend Euro ist viel Geld", en: "A thousand euros is a lot of money" }, accept: ["thousand", "one thousand", "1000"], hint: "Like hundert, it takes no ein. Note the au — it is said like the ow in how." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u16l4-bezahlen", type: "vocab", front: "bezahlen", reading: "bezahlen", meaning: "to pay", example: { jp: "Wir bezahlen zusammen, bitte.", en: "We will pay together, please." }, drill: { jp: "Sie bezahlen hundert Euro", en: "They pay a hundred euros" }, accept: ["to pay", "to pay for"], hint: "Said in every restaurant in Germany. Careful: bezahlen is to pay, zählen is to count — the umlaut is the difference." },
        { id: "de-u16l4-genug", type: "vocab", front: "genug", reading: "genug", meaning: "enough", example: { jp: "Ich habe genug Geld für das Buch.", en: "I have enough money for the book." }, drill: { jp: "Wir haben genug Zeit", en: "We have enough time" }, accept: ["enough"], hint: "Comes before the noun but after an adjective or verb: genug Geld, but gut genug." },
      ],
    },
  ],
};
