  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u16l2-sehen", type: "vocab", front: "sehen", reading: "sehen", meaning: "to see (with the eyes)", example: { jp: "Aus dem Fenster sehen wir den Park.", en: "From the window we see the park." }, drill: { jp: "Hier sehen wir das Schiff", en: "Here we see the ship" }, accept: ["to see", "to look"], hint: "Vowel shift again: ich sehe, but er sieht. Not the same as u2's bis bald, which is a goodbye, not this verb." },
        { id: "de-u16l2-geben", type: "vocab", front: "geben", reading: "geben", meaning: "to give", example: { jp: "Der Lehrer gibt dem Schüler ein Buch.", en: "The teacher gives the pupil a book." }, drill: { jp: "Wir geben dem Kind ein Buch", en: "We give the child a book." }, accept: ["to give"], hint: "Two objects: person dative, thing accusative — exactly u13 and u14 together. u13's es gibt, there is, is built from it." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u16l4-schwimmen", type: "vocab", front: "schwimmen", reading: "schwimmen", meaning: "to swim", example: { jp: "Im Urlaub schwimmen wir sehr oft.", en: "On holiday we swim very often." }, drill: { jp: "Die Kinder wollen schwimmen", en: "The children want to swim" }, accept: ["to swim"], hint: "Swim and schwimmen are the same word — German writes the sw sound as schw." },
