  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u16l1-sollen", type: "vocab", front: "sollen", reading: "sollen", meaning: "to be supposed to", example: { jp: "Was soll ich dem Chef sagen?", en: "What am I supposed to tell the boss?" }, drill: { jp: "Die Schüler sollen die Wörter sagen", en: "The pupils are supposed to say the words." }, accept: ["should", "to be supposed to", "ought to"], hint: "Someone else's instruction or expectation: du sollst warten, you are to wait." },
