  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u16l1-sein", type: "vocab", front: "sein", reading: "sein", meaning: "to be", example: { jp: "Ich will hier sein.", en: "I want to be here." }, drill: { jp: "Wir wollen zusammen sein", en: "We want to be together" }, accept: ["to be", "be"], hint: "The infinitive hiding behind ist, bin, bist and sind (u1, u3). It surfaces after a modal, after werden (u8) and with zu: Ich muss hier sein, Ich werde da sein. ⚠️ A different word from the possessive sein/seine \"his\" (u4)." },
        { id: "de-u16l1-mogen", type: "vocab", front: "mögen", reading: "mogen", meaning: "to like", example: { jp: "Wir mögen die Musik.", en: "We like the music." }, drill: { jp: "Die Kinder mögen das Brot", en: "The children like the bread" }, accept: ["to like", "like"], hint: "ich mag, du magst, er mag — the SINGULAR loses the ö and the stem shortens. The plural keeps it: wir mögen, ihr mögt, sie mögen. mögen is liking a thing; möchten (this lesson) is its polite \"would like\" and asks for one." },
      ],
    },
    {
      id: "de-u16l2",
      ...
      items: [
        ...
        { id: "de-u16l2-tun", type: "vocab", front: "tun", reading: "tun", meaning: "to do (an act)", example: { jp: "Was können wir tun?", en: "What can we do?" }, drill: { jp: "Wir müssen etwas tun", en: "We must do something" }, accept: ["to do", "do", "to act"], hint: "machen (this lesson) is the everyday do/make. tun is narrower — to carry out an act — and lives in fixed phrases like Das tut mir leid (u2). ich tue, du tust, er tut." },
        { id: "de-u16l2-bringen", type: "vocab", front: "bringen", reading: "bringen", meaning: "to bring", example: { jp: "Ich kann das Buch bringen.", en: "I can bring the book." }, drill: { jp: "Kannst du das Wasser bringen", en: "Can you bring the water" }, accept: ["to bring", "bring"], hint: "bringen is to bring something TO someone, so it usually has two objects: Ich bringe dir das Buch. Its past forms are irregular — brachte, gebracht." },
      ],
    },
    {
      id: "de-u16l3",
