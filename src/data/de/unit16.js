  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u16l1-sein", type: "vocab", front: "sein", reading: "sein", meaning: "to be", example: { jp: "Ich will hier sein.", en: "I want to be here." }, drill: { jp: "Wir wollen zusammen sein", en: "We want to be together" }, accept: ["to be", "be"], hint: "The infinitive hiding behind ist, bin, bist and sind (u1, u3). It only surfaces after a modal or with zu: Ich muss hier sein. ⚠️ A different word from the possessive sein/seine \"his\" (u4)." },
        { id: "de-u16l1-mogen", type: "vocab", front: "mögen", reading: "mogen", meaning: "to like", example: { jp: "Wir mögen die Musik.", en: "We like the music." }, drill: { jp: "Die Kinder mögen das Brot", en: "The children like the bread" }, accept: ["to like", "like"], hint: "ich mag, du magst, er mag — the finite forms lose the ö. mögen is liking a thing; möchten (this lesson) is its polite \"would like\" and asks for one." },
      ],
    },
    {
      id: "de-u16l2",
