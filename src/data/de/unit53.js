  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u53l1-gering", type: "vocab", front: "gering", reading: "gering", meaning: "slight", example: { jp: "Der Unterschied ist gering, aber mit guten Geräten kann man ihn messen.", en: "The difference is slight, but with good instruments you can measure it." }, drill: { jp: "Der Unterschied ist sehr gering", en: "The difference is very slight" }, accept: ["slight", "small", "low", "minor", "marginal", "negligible"], hint: "Of amounts and differences, never of physical size — that is klein. The opposite here is hoch." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u53l2-zunehmen", type: "vocab", front: "zunehmen", reading: "zunehmen", meaning: "to increase", example: { jp: "Die Zahl der Gäste nimmt weiter zu, weil die Stadt so schön ist.", en: "The number of guests keeps increasing, because the city is so beautiful." }, drill: { jp: "Die Zahlen werden weiter zunehmen", en: "The numbers will keep increasing" }, accept: ["to increase", "increase", "to grow", "grow", "to rise", "to go up", "to put on weight"], hint: "zu + nehmen: to take on more. Of numbers, and of a person putting on weight. Separable: es nimmt zu." },
        ...
        { id: "de-u53l2-sinken", type: "vocab", front: "sinken", reading: "sinken", meaning: "to drop", example: { jp: "Wenn die Temperatur in der Nacht sinkt, wird es in der Wohnung kalt.", en: "When the temperature falls at night, it gets cold in the flat." }, drill: { jp: "Die Preise sinken im Winter", en: "Prices fall in winter" }, accept: ["to fall", "fall", "to sink", "sink", "to drop", "drop", "to decline", "to go down"], hint: "The mirror of steigen. Prices, temperature, ships — and die Sonne sinkt at the end of the day." },
        { id: "de-u53l2-deranteil", type: "vocab", front: "der Anteil", reading: "deranteil", meaning: "the share", example: { jp: "Der Anteil der jungen Gäste ist deutlich gestiegen, obwohl die Preise hoch sind.", en: "The share of young guests has risen clearly, although prices are high." }, drill: { jp: "Der Anteil ist sehr gering", en: "The share is very slight" }, accept: ["share", "the share", "proportion", "the proportion", "percentage", "the percentage", "part", "the part"], hint: "an + der Teil: the part that falls to you. der Anteil an etwas — normally given as a percentage." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u53l3-beinahe", type: "vocab", front: "beinahe", reading: "beinahe", meaning: "very nearly", example: { jp: "Wir haben beinahe den Zug verloren, weil der Bus so spät gekommen ist.", en: "We almost missed the train, because the bus came so late." }, drill: { jp: "Wir waren beinahe zu spät", en: "We were almost too late" }, accept: ["almost", "nearly", "very nearly", "just about", "all but"], hint: "bei + nahe: right up next to it. Same as fast, with a touch more drama — beinahe means it nearly went wrong." },
      ],
    },
    {
      id: "de-u53l4",
      ...
      items: [
        ...
        { id: "de-u53l4-vollig", type: "vocab", front: "völlig", reading: "vollig", meaning: "totally", example: { jp: "Ich bin völlig sicher, dass wir den Termin am Montag halten können.", en: "I am completely sure that we can keep the appointment on Monday." }, drill: { jp: "Das ist völlig richtig", en: "That is completely right" }, accept: ["completely", "totally", "entirely", "utterly", "absolutely", "fully"], hint: "From voll (full). völlig falsch, völlig egal — it is the word that ends an argument." },
        { id: "de-u53l4-knapp", type: "vocab", front: "knapp", reading: "knapp", meaning: "barely", example: { jp: "Wir haben es knapp geschafft, weil der Bus zehn Minuten zu spät war.", en: "We barely managed it, because the bus was ten minutes late." }, drill: { jp: "Das Geld ist sehr knapp", en: "Money is very tight" }, accept: ["barely", "just", "narrowly", "scarcely", "tight", "scarce", "just under"], hint: "Two senses, one idea — nothing left over: knapp gewinnen (win narrowly), das Geld ist knapp (money is tight)." },
        { id: "de-u53l4-mindestens", type: "vocab", front: "mindestens", reading: "mindestens", meaning: "at least", example: { jp: "Wir brauchen mindestens drei Stunden, sonst wird die Arbeit nicht gut.", en: "We need at least three hours, otherwise the work won't be good." }, drill: { jp: "Wir brauchen mindestens drei Stunden", en: "We need at least three hours" }, accept: ["at least", "at the minimum", "a minimum of", "no less than"], hint: "Sets the FLOOR under a number. Its pair höchstens sets the ceiling — learn the two together." },
        { id: "de-u53l4-hochstens", type: "vocab", front: "höchstens", reading: "hochstens", meaning: "at most", example: { jp: "Es dauert höchstens eine Stunde, meistens sogar deutlich weniger.", en: "It takes at most an hour, usually even considerably less." }, drill: { jp: "Es dauert höchstens eine Stunde", en: "It takes an hour at most" }, accept: ["at most", "at the maximum", "a maximum of", "no more than"], hint: "From hoch: the ceiling over a number, and the exact pair to mindestens." },
        { id: "de-u53l4-uberhaupt", type: "vocab", front: "überhaupt", reading: "uberhaupt", meaning: "at all", example: { jp: "Hast du überhaupt Zeit, oder sollen wir lieber später noch einmal fragen?", en: "Do you have time at all, or should we rather ask again later?" }, drill: { jp: "Hast du überhaupt Zeit", en: "Do you have time at all" }, accept: ["at all", "actually", "in the first place", "even", "anyway"], hint: "The small word that puts a whole question in doubt. With a negative it strengthens it: überhaupt nicht = not at all." },
      ],
    },
  ],
};
