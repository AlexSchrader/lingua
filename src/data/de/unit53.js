  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u53l2-diehalfte", type: "vocab", front: "die Hälfte", reading: "diehalfte", meaning: "the half", example: { jp: "Die Hälfte der Gäste ist früher gegangen als geplant.", en: "Half the guests left earlier than planned." }, drill: { jp: "Die Hälfte der Gäste ist gegangen", en: "Half the guests have left" }, accept: ["half", "the half"], hint: "The noun, so it takes an article: die Hälfte der Leute. halb is the adjective. um die Hälfte steigen = to rise by half." },
      ],
    },
    {
      id: "de-u53l3",
