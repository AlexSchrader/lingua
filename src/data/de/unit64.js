  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u64l1-diefolge", type: "vocab", front: "die Folge", reading: "diefolge", meaning: "the episode", example: { jp: "In der neuen Folge kommt der alte Chef wieder in die Stadt.", en: "In the new episode the old boss comes back into the city." }, drill: { jp: "Die Folge dauert eine Stunde", en: "The episode lasts an hour" }, accept: ["episode", "the episode", "instalment", "consequence"], hint: "Also 'consequence' — die Folgen des Wetters. Context tells you which." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u64l4-diekritik", type: "vocab", front: "die Kritik", reading: "diekritik", meaning: "the criticism", example: { jp: "Die Kritik in der Zeitung war hart, aber sie war richtig.", en: "The criticism in the newspaper was harsh, but it was right." }, drill: { jp: "Die Kritik war sehr hart", en: "The criticism was very harsh" }, accept: ["criticism", "the criticism", "review", "the review", "critique"], hint: "Both the negative sense and a written review of a film." },
        ...
        { id: "de-u64l4-diequelle", type: "vocab", front: "die Quelle", reading: "diequelle", meaning: "the source", example: { jp: "Vor dem Lesen frage ich immer, woher die Quelle kommt.", en: "Before reading I always ask where the source comes from." }, drill: { jp: "Die Quelle ist nicht sicher", en: "The source is not reliable" }, accept: ["source", "the source", "the spring"], hint: "Literally a spring of water. In media: where the information came from." },
