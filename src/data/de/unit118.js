  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u118l1-ueberall", type: "vocab", front: "überall", reading: "uberall", meaning: "everywhere", example: { jp: "Überall in der Stadt stehen jetzt neue Häuser, und trotzdem findet kaum jemand eine Wohnung.", en: "Everywhere in the city there are new houses now, and yet hardly anyone finds a flat." }, drill: { jp: "Überall liegt Schnee auf dem Boden", en: "Everywhere there is snow on the ground" }, accept: ["everywhere", "all over", "all around", "throughout"], hint: "über + all. Its opposite is nirgendwo (nowhere), and überallhin means 'to everywhere' — German marks direction separately." },
        { id: "de-u118l1-irgendwo", type: "vocab", front: "irgendwo", reading: "irgendwo", meaning: "somewhere", example: { jp: "Der Schlüssel muss irgendwo im Haus sein, weil ihn seit gestern niemand mit nach draußen genommen hat.", en: "The key must be somewhere in the house, because nobody has taken it outside since yesterday." }, drill: { jp: "Das Buch liegt irgendwo im Zimmer", en: "The book is lying somewhere in the room" }, accept: ["somewhere", "anywhere", "someplace"], hint: "The irgend- family is large and regular: irgendwo (somewhere), irgendwann (u28, sometime), irgendwas (something) — teach one and you can read them all." },
        { id: "de-u118l1-drinnen", type: "vocab", front: "drinnen", reading: "drinnen", meaning: "indoors", example: { jp: "Bei diesem Wetter bleiben wir lieber drinnen und machen den Rest der Arbeit am Tisch.", en: "In this weather we'd rather stay indoors and do the rest of the work at the table." }, drill: { jp: "Die Kinder spielen heute drinnen", en: "The children are playing indoors today" }, accept: ["indoors", "inside", "within"], hint: "Position only, never movement — to go inside is hinein or just rein. Its pair draußen is the next card." },
        { id: "de-u118l1-draussen", type: "vocab", front: "draußen", reading: "draussen", meaning: "outdoors", example: { jp: "Draußen ist es schon dunkel, deshalb sollten wir den Weg durch den Wald lieber morgen gehen.", en: "It's already dark outside, so we should take the path through the forest tomorrow instead." }, drill: { jp: "Die Gäste warten schon draußen", en: "The guests are already waiting outside" }, accept: ["outdoors", "outside", "out there"], hint: "Pairs with drinnen above. Note the ß — draußen, not 'draussen', because the au is a long diphthong." },
        { id: "de-u118l1-drueben", type: "vocab", front: "drüben", reading: "druben", meaning: "over on the other side", example: { jp: "Drüben auf der anderen Seite steht ein großes Geschäft.", en: "Over there on the other side stands a large shop." }, drill: { jp: "Drüben steht das alte Haus", en: "Over there stands the old house" }, accept: ["over there", "across", "on the other side"], hint: "Points across something — a street, a river, a border. In German history writing drüben meant the other German state, and older speakers still use it that way." },
        { id: "de-u118l1-nirgendwo", type: "vocab", front: "nirgendwo", reading: "nirgendwo", meaning: "nowhere", example: { jp: "Den Schlüssel habe ich nirgendwo gefunden, weder drinnen noch draußen.", en: "I found the key nowhere, neither inside nor outside." }, drill: { jp: "Den Schlüssel finde ich nirgendwo", en: "I can find the key nowhere" }, accept: ["nowhere", "not anywhere", "nowhere at all"], hint: "The negative of irgendwo in this lesson. German keeps the single negative: ich finde ihn nirgendwo, never nicht nirgendwo. nirgends is the shorter variant." },
      ],
    },
    {
      id: "de-u118l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u118l4-derbrief", type: "vocab", front: "der Brief", reading: "derbrief", meaning: "the letter (post)", example: { jp: "Der Brief kam erst drei Wochen später an, weil die Adresse darauf schon alt war.", en: "The letter only arrived three weeks later, because the address on it was already old." }, drill: { jp: "Der Brief liegt noch auf dem Tisch", en: "The letter is still lying on the table" }, accept: ["letter", "the letter", "note", "missive"], hint: "Paper post specifically — an email is die Mail. ⚠️ The course teaches der Briefkasten (u30, the letterbox) but never taught der Brief itself: the compound before the base word, the same shape as Freizeichen/Zeichen below." },
        { id: "de-u118l4-daszeichen", type: "vocab", front: "das Zeichen", reading: "daszeichen", meaning: "the sign (a mark)", example: { jp: "Das Zeichen an der Tür heißt, dass hier niemand ohne Schlüssel arbeiten darf.", en: "The sign on the door means that nobody may work here without a key." }, drill: { jp: "Das Zeichen war nicht zu sehen", en: "The sign was not visible" }, accept: ["sign", "the sign", "signal", "mark", "token", "character"], hint: "A written character, a mark and an omen all at once. ⚠️ The course already taught das Freizeichen (u77, the dial tone) — the compound before the base word — which is how this hole stayed invisible." },
        { id: "de-u118l4-dieentfernung", type: "vocab", front: "die Entfernung", reading: "dieentfernung", meaning: "the distance", example: { jp: "Die Entfernung zwischen den beiden Städten beträgt knapp hundert Kilometer.", en: "The distance between the two cities is just under a hundred kilometres." }, drill: { jp: "Die Entfernung beträgt knapp hundert Kilometer", en: "The distance is just under a hundred kilometres" }, accept: ["distance", "the distance", "range", "the range"], hint: "The measured gap — how far it is, in figures. aus der Entfernung = from a distance. entfernt (u120) is the adjective 'far off'." },
      ],
    },
  ],
};
