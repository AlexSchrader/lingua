  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u118l1-drueben", type: "vocab", front: "drüben", reading: "drueben", meaning: "over there", example: { jp: "Drüben auf der anderen Seite gibt es einen Laden, der auch am Sonntag arbeitet.", en: "Over there on the other side there is a shop that works on Sunday too." }, drill: { jp: "Drüben steht das alte Haus", en: "Over there stands the old house" }, accept: ["over there", "across", "on the other side"], hint: "Rank 829. Points across something — a street, a river, a border. In German history writing drüben meant the other German state, and older speakers still use it that way." },
      ],
    },
    {
      id: "de-u118l2",
    ...
    },
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Give and follow directions in writing — a direction, an address, a centre, a row and a sign.",
      items: [
