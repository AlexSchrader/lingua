  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u102l1-dieversorgung", type: "vocab", front: "die Versorgung", reading: "dieversorgung", meaning: "provision of care (the supply side)", example: { jp: "Auf dem Dorf ist die Versorgung schlechter als in der Stadt, obwohl beide dieselbe Kasse haben.", en: "In the village the provision of care is worse than in the city, although both have the same insurer." }, drill: { jp: "Die Versorgung im Gebirge wird schlechter", en: "Care provision in the mountains is getting worse" }, accept: ["provision", "care provision", "supply", "provision of care"], hint: "Wide word: medizinische Versorgung, Versorgung mit Strom, die Versorgung der Kinder. Always the supplying, never the receiving." },
        { id: "de-u102l1-derzugang", type: "vocab", front: "der Zugang", reading: "derzugang", meaning: "access (being able to reach a service)", example: { jp: "Ohne Auto hat kaum jemand hier Zugang zu einem Facharzt.", en: "Without a car hardly anyone here has access to a specialist." }, drill: { jp: "Der Zugang zur Klinik ist schwer", en: "Access to the clinic is hard" }, accept: ["access", "admission", "entry"], hint: "Zugang zu + dative. Also physical — der Zugang zum Gebäude — and digital: Zugang zum Konto." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u102l3-diepflegekraft", type: "vocab", front: "die Pflegekraft", reading: "diepflegekraft", meaning: "nurse (professional carer)", example: { jp: "Zwei Pflegekräfte betreuen nachts die ganze Station.", en: "Two nurses look after the whole ward at night." }, drill: { jp: "Die Pflegekraft arbeitet oft in der Nacht", en: "The nurse often works at night" }, accept: ["nurse", "carer", "care worker", "nursing staff"], hint: "The gender-neutral official term; die Krankenschwester and der Krankenpfleger are the older gendered pair." },
