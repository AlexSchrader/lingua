  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u102l3-diefachkraft", type: "vocab", front: "die Fachkraft", reading: "diefachkraft", meaning: "qualified professional (trained specialist worker)", example: { jp: "Ohne Fachkräfte aus dem Ausland würde keine Station mehr laufen.", en: "Without qualified professionals from abroad no ward would still be running." }, drill: { jp: "Die Fachkraft fehlt auf jeder Station", en: "The qualified professional is missing on every ward" }, accept: ["qualified professional", "skilled worker", "specialist worker", "trained professional"], hint: "Fach + Kraft — a worker with a completed training. Der Fachkräftemangel is one of the most-used words in German public debate." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u102l4-vorbeugen", type: "vocab", front: "vorbeugen", reading: "vorbeugen", meaning: "to prevent (head something off)", example: { jp: "Mit Bewegung und Schlaf kann man vielen Krankheiten vorbeugen.", en: "With exercise and sleep you can prevent many illnesses." }, drill: { jp: "Bewegung kann vielen Krankheiten vorbeugen", en: "Exercise can prevent many illnesses" }, accept: ["to prevent", "prevent", "to forestall", "to ward off"], hint: "Takes the dative — einem Problem vorbeugen — because you bend (beugen) forward in front of it. Verhindern stops what is already happening." },
