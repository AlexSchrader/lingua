  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u68l4-diegerechtigkeit", type: "vocab", front: "die Gerechtigkeit", reading: "diegerechtigkeit", meaning: "the justice", example: { jp: "Ohne Gerechtigkeit hat auch ein gutes Gesetz keinen Wert.", en: "Without justice even a good law has no value." }, drill: { jp: "Die Gerechtigkeit ist sehr wichtig", en: "Justice is very important" }, accept: ["justice", "the justice", "the fairness"], hint: "From gerecht, fair. Four syllables: ge-RECH-tig-keit." },
