  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u68l1-dienahe", type: "vocab", front: "die Nähe", reading: "dienahe", meaning: "the closeness", example: { jp: "In dieser Beziehung ist die Nähe wichtiger als ein teures Geschenk.", en: "In this relationship closeness matters more than an expensive present." }, drill: { jp: "Die Nähe ist ihr sehr wichtig", en: "Closeness is very important to her" }, accept: ["closeness", "the closeness", "proximity", "the proximity", "intimacy", "nearness"], hint: "The noun under nah (u7). Physical and emotional alike: in der Nähe wohnen, and Nähe zulassen = to let someone close." },
      ],
    },
    {
      id: "de-u68l2",
      ...
      items: [
        ...
        { id: "de-u68l2-diescheidung", type: "vocab", front: "die Scheidung", reading: "diescheidung", meaning: "the divorce", example: { jp: "Nach der Scheidung sind die beiden gute Freunde geblieben.", en: "After the divorce the two stayed good friends." }, drill: { jp: "Die Scheidung war für alle schwer", en: "The divorce was hard for everyone" }, accept: ["divorce", "the divorce", "separation"], hint: "The legal end of die Ehe in this lesson. sich scheiden lassen is what you DO — German uses the passive-ish phrase, never 'ich scheide mich'." },
      ],
    },
    {
      id: "de-u68l3",
      ...
      items: [
        ...
        { id: "de-u68l3-dievielfalt", type: "vocab", front: "die Vielfalt", reading: "dievielfalt", meaning: "the diversity", example: { jp: "Die Vielfalt in der Stadt ist groß, und das macht sie so interessant.", en: "The diversity in the city is great, and that is what makes it so interesting." }, drill: { jp: "Die Vielfalt ist sehr groß", en: "The diversity is very great" }, accept: ["diversity", "the diversity", "variety", "the variety", "range"], hint: "viel + die Falt (a fold): many folds. The adjective is vielfältig, varied." },
        { id: "de-u68l3-dienachbarschaft", type: "vocab", front: "die Nachbarschaft", reading: "dienachbarschaft", meaning: "the neighbourhood", example: { jp: "In der Nachbarschaft helfen sich die Familien, wenn es Probleme gibt.", en: "In the neighbourhood the families help each other when there are problems." }, drill: { jp: "Die Nachbarschaft ist sehr ruhig", en: "The neighbourhood is very quiet" }, accept: ["neighbourhood", "the neighbourhood", "neighborhood", "the neighborhood", "the neighbours"], hint: "der Nachbar + -schaft, the ending that makes a group out of a person — like die Gesellschaft, die Mannschaft." },
      ],
    },
    {
      id: "de-u68l4",
      ...
      items: [
        ...
        { id: "de-u68l4-diehilfsbereitschaft", type: "vocab", front: "die Hilfsbereitschaft", reading: "diehilfsbereitschaft", meaning: "the willingness to help", example: { jp: "Nach dem Sturm hat uns die Hilfsbereitschaft der Nachbarn überrascht.", en: "After the storm the neighbours' willingness to help surprised us." }, drill: { jp: "Die Hilfsbereitschaft der Nachbarn war groß", en: "The neighbours' willingness to help was great" }, accept: ["helpfulness", "the helpfulness", "willingness to help", "readiness to help"], hint: "hilfsbereit (u31) turned into a noun. The quality that makes das Ehrenamt and der Zusammenhalt in this lesson possible." },
      ],
    },
  ],
};
