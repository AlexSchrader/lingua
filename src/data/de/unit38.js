  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u38l1-wohnte", type: "vocab", front: "wohnte", reading: "wohnte", meaning: "lived — past of wohnen", example: { jp: "Sie wohnte lange in der Stadt und arbeitete dort.", en: "She lived a long time in the city and worked there." }, drill: { jp: "Sie wohnte lange in der Stadt", en: "She lived in the city a long time" }, accept: ["lived", "resided"], hint: "wohn plus te. For where someone used to live, German uses this plus früher (lesson 4) rather than a used-to construction." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u38l2-arbeitete", type: "vocab", front: "arbeitete", reading: "arbeitete", meaning: "worked — past of arbeiten", example: { jp: "Mein Vater arbeitete hier im Büro.", en: "My father worked here in the office." }, drill: { jp: "Mein Vater arbeitete lange hier", en: "My father worked here a long time" }, accept: ["worked"], hint: "The stem arbeit already ends in t, so arbeitte would be unsayable — German slips in an e: arbeit-e-te. That is the whole of this lesson." },
        { id: "de-u38l2-wartete", type: "vocab", front: "wartete", reading: "wartete", meaning: "waited — past of warten", example: { jp: "Wir warteten lange auf den Zug.", en: "We waited a long time for the train." }, drill: { jp: "Er wartete sehr lange", en: "He waited a very long time" }, accept: ["waited"], hint: "wart plus e plus te, same reason as arbeitete. Say it aloud and you can hear why the e has to be there." },
        ...
        { id: "de-u38l2-regnete", type: "vocab", front: "regnete", reading: "regnete", meaning: "rained — past of regnen", example: { jp: "Es regnete lange, deshalb spielte das Kind im Haus.", en: "It rained a long time, therefore the child played in the house." }, drill: { jp: "Es regnete sehr lange", en: "It rained a very long time" }, accept: ["rained"], hint: "regn-e-te, the e needed after the gn cluster. Weather verbs stay impersonal in the past too: es regnete, never ich regnete." },
        { id: "de-u38l2-dauerte", type: "vocab", front: "dauerte", reading: "dauerte", meaning: "lasted — past of dauern", example: { jp: "Die Prüfung dauerte zwei Stunden.", en: "The exam lasted two hours." }, drill: { jp: "Die Prüfung dauerte sehr lange", en: "The exam lasted a very long time" }, accept: ["lasted", "took"], hint: "dauern ends in -ern, not -en, so the stem is dauer and you simply add -te. The -ern and -eln verbs all behave like this." },
      ],
    },
    {
      id: "de-u38l3",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u38l4-musste", type: "vocab", front: "musste", reading: "musste", meaning: "had to — past of müssen", example: { jp: "Wir mussten sehr lange warten.", en: "We had to wait a very long time." }, drill: { jp: "Er musste sehr lange warten", en: "He had to wait a very long time" }, accept: ["had to", "must have"], hint: "müssen to musste, umlaut gone. The double s stays, so it is musste and never mußte in modern spelling." },
