  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u18l1-dasfahrrad", type: "vocab", front: "das Fahrrad", reading: "dasfahrrad", meaning: "the bicycle", example: { jp: "Mein Fahrrad ist im Keller.", en: "My bicycle is in the cellar." }, accept: ["the bicycle", "the bike"], hint: "Fahr, from fahren, plus Rad, wheel. Everyone says das Rad for short." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u18l2-dasziel", type: "vocab", front: "das Ziel", reading: "dasziel", meaning: "the destination", example: { jp: "Mein Ziel ist München.", en: "My destination is Munich." }, accept: ["the destination", "the goal", "the target"], hint: "Where you are headed, and also a goal in life. Note the ie — said zeel." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u18l3-einsteigen", type: "vocab", front: "einsteigen", reading: "einsteigen", meaning: "to board", example: { jp: "Bitte einsteigen!", en: "All aboard, please!" }, accept: ["to board", "to get on", "to get in"], hint: "The announcement you hear on every German platform. steigen means to climb — you climb in." },
        { id: "de-u18l3-umsteigen", type: "vocab", front: "umsteigen", reading: "umsteigen", meaning: "to change trains", example: { jp: "In Köln steigen wir um.", en: "We change trains in Cologne." }, accept: ["to change trains", "to change", "to transfer"], hint: "um- means around or over: you climb over into another train. The single most useful travel verb in Germany." },
        { id: "de-u18l3-dauern", type: "vocab", front: "dauern", reading: "dauern", meaning: "to last", example: { jp: "Die Reise dauert drei Stunden.", en: "The journey lasts three hours." }, accept: ["to last", "to take (time)"], hint: "Only about time, and the subject is the event: die Fahrt dauert lange, the trip takes a long time." },
        { id: "de-u18l3-diegrenze", type: "vocab", front: "die Grenze", reading: "diegrenze", meaning: "the border", example: { jp: "Nach der Grenze sind wir in Österreich.", en: "After the border we are in Austria." }, accept: ["the border", "the boundary", "the limit"], hint: "Also a limit in the abstract sense. English borrowed it late and unusually — from Polish, through German." },
      ],
    },
    {
      id: "de-u18l4",
      ...
      items: [
        { id: "de-u18l4-derurlaub", type: "vocab", front: "der Urlaub", reading: "derurlaub", meaning: "the holiday", example: { jp: "Im Urlaub sind wir immer in Österreich.", en: "On holiday we are always in Austria." }, accept: ["the holiday", "the vacation", "the leave"], hint: "Time off work. School holidays are die Ferien — German keeps the two apart." },
        { id: "de-u18l4-derkoffer", type: "vocab", front: "der Koffer", reading: "derkoffer", meaning: "the suitcase", example: { jp: "Mein Koffer ist zu schwer.", en: "My suitcase is too heavy." }, accept: ["the suitcase", "the case"], hint: "Plural is identical: ein Koffer, zwei Koffer. English coffer is the same word, and once meant the same box." },
        ...
        { id: "de-u18l4-dasausland", type: "vocab", front: "das Ausland", reading: "dasausland", meaning: "abroad", example: { jp: "Meine Tochter arbeitet im Ausland.", en: "My daughter works abroad." }, accept: ["abroad", "foreign countries", "overseas"], hint: "A noun where English uses an adverb: im Ausland, in the abroad. Aus, out, plus Land." },
        { id: "de-u18l4-derpass", type: "vocab", front: "der Pass", reading: "derpass", meaning: "the passport", example: { jp: "Mein Pass ist in der Tasche.", en: "My passport is in the bag." }, accept: ["the passport"], hint: "Short for der Reisepass. Nothing to do with passen, to fit, which you met in u17." },
        { id: "de-u18l4-diewelt", type: "vocab", front: "die Welt", reading: "diewelt", meaning: "the world", example: { jp: "Die Welt ist groß und ich habe wenig Zeit.", en: "The world is big and I have little time." }, accept: ["the world"], hint: "Auf der Welt, in the world. Die ganze Welt is the whole world." },
      ],
    },
  ],
};
