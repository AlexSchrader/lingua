  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u18l1-derzug", type: "vocab", front: "der Zug", reading: "derzug", meaning: "the train", example: { jp: "Der Zug nach Berlin ist sehr schnell.", en: "The train to Berlin is very fast." }, drill: { jp: "Der Zug ist heute sehr voll", en: "The train is very full today" }, accept: ["the train"], hint: "Mit dem Zug fahren — the vehicle takes mit plus the dative, every time." },
        { id: "de-u18l1-derbus", type: "vocab", front: "der Bus", reading: "derbus", meaning: "the bus", example: { jp: "Der Bus kommt um neunzehn Uhr.", en: "The bus comes at seven in the evening." }, drill: { jp: "Der Bus kommt jetzt nicht", en: "The bus is not coming now" }, accept: ["the bus"], hint: "Same word as English, but the plural doubles the s: die Busse." },
        { id: "de-u18l1-diebahn", type: "vocab", front: "die Bahn", reading: "diebahn", meaning: "the railway", example: { jp: "Die Bahn ist heute nicht teuer.", en: "The railway is not expensive today." }, drill: { jp: "Die Bahn ist sehr schnell", en: "The railway is very fast" }, accept: ["the railway", "the train", "the tram"], hint: "The system rather than the vehicle — die Deutsche Bahn. In a city, die S-Bahn and die U-Bahn." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u18l2-warten", type: "vocab", front: "warten", reading: "warten", meaning: "to wait", example: { jp: "Wir warten hier auf den Bus.", en: "We are waiting for the bus here." }, drill: { jp: "Sie warten am Bahnhof", en: "They are waiting at the station" }, accept: ["to wait", "to wait for"], hint: "warten AUF plus the accusative — you wait on something, not for it, in German." },
      ],
    },
    {
      id: "de-u18l3",
