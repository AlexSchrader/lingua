...
//
// ⚠️ WHY FIVE CARDS A LESSON AND NOT SIX. The measured gap does not support six.
// The only external list this repo owns is 2000 words deep; after removing the
// film/TV register it over-represents (86 entries: ranks, weapons, insults,
// US-isms) it yields 177 teachable gaps, and the other two probes add ~40 more.
// That is ~215 words for 12 remaining units. Authoring 24 a unit would mean ~70
// cards of padding, which is the same failure as the "Vocabulary N" scaffold.
// Five is inside the 5-8 band in src/data/lint.js, so this is in-standard, not a
// shortfall — and the honest number is in the hand-back.
//
// Already taught, used here but not re-taught: der Film (u64), das Buch (u19),
// das Wetter (u8), die Reise (u18), das Essen (u6).
//
...
// FREE: gemacht, geworden, geschmeckt, gestellt, gesessen, geaendert, gewartet, gedauert, geändert
