  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u101l2-dergrenzwert", type: "vocab", front: "der Grenzwert", reading: "dergrenzwert", meaning: "limit value (legal maximum)", example: { jp: "Der Grenzwert für die Luft in der Stadt wurde im letzten Jahr zweimal überschritten.", en: "The limit value for air in the city was exceeded twice last year." }, drill: { jp: "Der Grenzwert liegt deutlich zu hoch", en: "The limit value is clearly too high" }, accept: ["limit value", "limit", "threshold", "legal limit"], hint: "Grenze + Wert: the number a measurement may not pass. The verb that goes with it is überschreiten — to exceed it." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u101l3-dieemission", type: "vocab", front: "die Emission", reading: "dieemission", meaning: "emission (released into the air)", example: { jp: "Die Emissionen aus dem Verkehr sind seit 1990 kaum gesunken.", en: "Emissions from traffic have barely fallen since 1990." }, drill: { jp: "Die Emission sinkt viel zu langsam", en: "The emission is falling far too slowly" }, accept: ["emission", "emissions"], hint: "The technical word, almost always plural in policy talk. Der Ausstoß (u65) is the everyday German for the same thing." },
        ...
        { id: "de-u101l3-diewende", type: "vocab", front: "die Wende", reading: "diewende", meaning: "turnaround (decisive change of direction)", example: { jp: "Ohne billigen Strom aus Wind und Sonne ist die Wende in der Energie kaum zu schaffen.", en: "Without cheap electricity from wind and sun, the turnaround in energy is hard to manage." }, drill: { jp: "Die Wende in der Energie kostet Geld", en: "The turnaround in energy costs money" }, accept: ["turnaround", "turning point", "shift", "transition"], hint: "The word Germans use for a change of direction that is chosen, not suffered: die Energiewende, die Verkehrswende. Capitalised, die Wende also means 1989." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u101l4-dieabgabe", type: "vocab", front: "die Abgabe", reading: "dieabgabe", meaning: "levy (charge paid to the state)", example: { jp: "Auf jede Tonne wird eine Abgabe fällig, die jedes Jahr steigt.", en: "A levy falls due on every tonne, and it rises every year." }, drill: { jp: "Die Abgabe steigt in jedem Jahr", en: "The levy rises every year" }, accept: ["levy", "charge", "duty", "state charge"], hint: "Narrower than die Steuer (u32): a Steuer funds the state generally, an Abgabe is charged for a specific thing and often steers behaviour." },
