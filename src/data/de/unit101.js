  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u101l3-diewende", type: "vocab", front: "die Wende", reading: "diewende", meaning: "turnaround (decisive change of direction)", example: { jp: "Ohne billigen Strom aus Wind und Sonne ist die Wende in der Energiepolitik kaum zu schaffen.", en: "Without cheap electricity from wind and sun, the turnaround in energy policy is hard to manage." }, drill: { jp: "Die Wende kostet den Staat viel Geld", en: "The turnaround costs the state a lot of money" }, accept: ["turnaround", "turning point", "shift", "transition"], hint: "The word Germans use for a change of direction that is chosen, not suffered: die Energiewende, die Verkehrswende. Capitalised, die Wende also means 1989." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u101l4-dieabgabe", type: "vocab", front: "die Abgabe", reading: "dieabgabe", meaning: "levy (charge paid to the state)", example: { jp: "Für jede Tonne wird eine Abgabe fällig, die jedes Jahr steigt.", en: "A levy falls due on every tonne, and it rises every year." }, drill: { jp: "Die Abgabe steigt schon wieder", en: "The levy is rising yet again" }, accept: ["levy", "charge", "duty", "state charge"], hint: "Narrower than die Steuer (u32): a Steuer funds the state generally, an Abgabe is charged for a specific thing and often steers behaviour." },
        { id: "de-u101l4-wirksam", type: "vocab", front: "wirksam", reading: "wirksam", meaning: "effective (actually produces the effect)", example: { jp: "Eine Vorgabe ist nur wirksam, wenn jemand sie auch überwacht.", en: "A requirement is only effective if somebody also monitors it." }, drill: { jp: "Die Maßnahme war sehr wirksam", en: "The measure was very effective" }, accept: ["effective", "efficacious", "potent"], hint: "From wirken, to have an effect. Note the medicine sense too: ein wirksames Mittel. Not the same as effizient, which is about cost." },
