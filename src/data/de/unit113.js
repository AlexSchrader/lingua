  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u113l4-derspielraum", type: "vocab", front: "der Spielraum", reading: "derspielraum", meaning: "leeway (room to act within the limits)", example: { jp: "Die Richtlinie lässt jeder Klinik einen gewissen Spielraum.", en: "The guideline leaves every clinic a certain leeway." }, drill: { jp: "Der Spielraum ist hier sehr klein", en: "The leeway here is very small" }, accept: ["leeway", "room for manoeuvre", "scope", "latitude"], hint: "Spiel here is the play in a mechanism, not a game. Spielraum lassen, haben, nutzen — the three collocations worth keeping." },
      ],
    },
  ],
};
