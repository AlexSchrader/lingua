  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u113l1-nunmehr", type: "vocab", front: "nunmehr", reading: "nunmehr", meaning: "now (as of this point, formal)", example: { jp: "Der Antrag liegt nunmehr bei der zweiten Instanz.", en: "The application is now with the second level of authority." }, drill: { jp: "Der Vorgang liegt nunmehr bei der Behörde", en: "The matter now lies with the authority" }, accept: ["now", "as of now", "by now", "at this point"], hint: "nun + mehr: from now on, as things have turned out. Pure officialese — in speech, simply jetzt." },
        { id: "de-u113l1-fortan", type: "vocab", front: "fortan", reading: "fortan", meaning: "from then on (henceforth)", example: { jp: "Nach dem Erlass mussten die Betriebe fortan jeden Wert selbst melden.", en: "After the decree the plants had from then on to report every value themselves." }, drill: { jp: "Fortan musste die Firma alles selbst bezahlen", en: "From then on the firm had to pay for everything itself" }, accept: ["from then on", "henceforth", "from now on", "thereafter"], hint: "Literary and a little solemn; in a story it marks the point where the new state begins." },
        { id: "de-u113l1-zeitgleich", type: "vocab", front: "zeitgleich", reading: "zeitgleich", meaning: "at the same time (simultaneously)", example: { jp: "Zeitgleich mit der Pressemitteilung stand der Bericht im Netz.", en: "At the same time as the press release, the report was online." }, drill: { jp: "Die Sitzungen waren zeitgleich am Montag", en: "The meetings were simultaneous on Monday" }, accept: ["at the same time", "simultaneously", "concurrently", "in parallel"], hint: "From sport, where two runners finish zeitgleich. With mit + dative when you name the other event." },
      ],
    },
    {
      id: "de-u113l2",
      ...
      items: [
        { id: "de-u113l2-unlangst", type: "vocab", front: "unlängst", reading: "unlangst", meaning: "recently (not long ago)", example: { jp: "Unlängst hat das Gremium genau darüber getagt.", en: "Recently the body met about exactly that." }, drill: { jp: "Unlängst hat die Behörde darüber entschieden", en: "Recently the authority decided about it" }, accept: ["recently", "not long ago", "lately", "the other day"], hint: "un + lang: literally not long ago. Neutral in register, slightly more written than neulich." },
        ...
        { id: "de-u113l2-hierzulande", type: "vocab", front: "hierzulande", reading: "hierzulande", meaning: "in this country (here where we are)", example: { jp: "Hierzulande zahlt die Kasse, in anderen Ländern der Patient selbst.", en: "In this country the insurer pays; in other countries the patient does." }, drill: { jp: "Hierzulande bezahlt oft die Kasse", en: "In this country the insurer often pays" }, accept: ["in this country", "here", "in our country", "over here"], hint: "One word, and it always compares with abroad — a favourite opening of German feature articles." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u113l3-zahlreich", type: "vocab", front: "zahlreich", reading: "zahlreich", meaning: "numerous", example: { jp: "Zahlreiche Stellungnahmen sind eingegangen, gelesen wurden nur wenige.", en: "Numerous written comments came in; only a few were read." }, drill: { jp: "Die Stellungnahmen waren sehr zahlreich", en: "The written comments were very numerous" }, accept: ["numerous", "many", "a large number of"], hint: "Zahl + reich, rich in number. Also used of people attending: zahlreich erscheinen — to turn up in force." },
        ...
        { id: "de-u113l3-nahezu", type: "vocab", front: "nahezu", reading: "nahezu", meaning: "virtually (almost entirely)", example: { jp: "Das Zimmer war nahezu leer, obwohl die Sitzung öffentlich war.", en: "The room was virtually empty, although the meeting was public." }, drill: { jp: "Das Zimmer war nahezu völlig leer", en: "The room was virtually completely empty" }, accept: ["virtually", "almost", "nearly", "practically"], hint: "Written German's fast. Fast is neutral, nahezu is the register you use next to a figure." },
        { id: "de-u113l3-einvielfaches", type: "vocab", front: "ein Vielfaches", reading: "einvielfaches", meaning: "many times as much", example: { jp: "Die Prävention kostet einen Bruchteil, die Behandlung ein Vielfaches.", en: "Prevention costs a fraction; the treatment many times as much." }, drill: { jp: "Der Eingriff kostet ein Vielfaches davon", en: "The operation costs many times that" }, accept: ["many times as much", "a multiple", "several times over"], hint: "Its opposite is ein Bruchteil, a fraction. Um ein Vielfaches teurer — many times more expensive." },
      ],
    },
    {
      id: "de-u113l4",
      ...
      items: [
        ...
        { id: "de-u113l4-spatestens", type: "vocab", front: "spätestens", reading: "spatestens", meaning: "at the latest", example: { jp: "Spätestens im Herbst muss das Gremium entscheiden.", en: "At the latest in autumn the body has to decide." }, drill: { jp: "Spätestens im Herbst gilt die neue Regel", en: "At the latest in autumn the new rule applies" }, accept: ["at the latest", "no later than", "by the latest"], hint: "Its pair is frühestens, at the earliest. Both are superlatives doing the work of a deadline." },
        { id: "de-u113l4-derstichtag", type: "vocab", front: "der Stichtag", reading: "derstichtag", meaning: "cut-off date (the date that counts)", example: { jp: "Wer am Stichtag noch keine Antwort hat, muss den Antrag neu stellen.", en: "Whoever has no answer by the cut-off date has to submit the application again." }, drill: { jp: "Der Stichtag ist der erste Juli", en: "The cut-off date is the first of July" }, accept: ["cut-off date", "deadline", "qualifying date", "reference date"], hint: "Not quite die Frist (u56): a Frist is a span of time, der Stichtag the single day the count is taken." },
        ...
        { id: "de-u113l4-derhochststand", type: "vocab", front: "der Höchststand", reading: "derhochststand", meaning: "record high (highest level reached)", example: { jp: "Die Zahl der Anträge hat im Juni einen Höchststand erreicht.", en: "The number of applications reached a record high in June." }, drill: { jp: "Der Höchststand war schon im Juni", en: "The record high was already in June" }, accept: ["record high", "peak level", "high point", "all-time high"], hint: "Its opposite is der Tiefststand. Note the difference from der Höhepunkt (u96): a Höchststand is a measured level, a Höhepunkt a moment." },
        { id: "de-u113l4-fristgerecht", type: "vocab", front: "fristgerecht", reading: "fristgerecht", meaning: "within the deadline (in due time)", example: { jp: "Die Unterlagen sind fristgerecht eingegangen, gelesen hat sie erst im August jemand.", en: "The documents arrived within the deadline; somebody read them only in August." }, drill: { jp: "Der Antrag ging fristgerecht bei uns ein", en: "The application reached us within the deadline" }, accept: ["within the deadline", "in due time", "on time", "punctually"], hint: "Frist + gerecht (in accordance with). The word on every German form; its opposite, verspätet, costs you the application." },
      ],
    },
  ],
};
