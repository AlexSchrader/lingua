  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u113l3-zahlreich", type: "vocab", front: "zahlreich", reading: "zahlreich", meaning: "numerous", example: { jp: "Zahlreiche Stellungnahmen sind eingegangen, gelesen wurden nur wenige.", en: "Numerous written comments came in; only a few were read." }, drill: { jp: "Zahlreiche Anträge sind bereits eingegangen", en: "Numerous applications have already come in" }, accept: ["numerous", "many", "a large number of"], hint: "Zahl + reich, rich in number. Also used of people attending: zahlreich erscheinen — to turn up in force." },
        ...
        { id: "de-u113l3-jeweilig", type: "vocab", front: "jeweilig", reading: "jeweilig", meaning: "respective (each in its own case)", example: { jp: "Die jeweilige Behörde entscheidet selbst, wie sie die Richtlinie umsetzt.", en: "The respective authority decides for itself how it implements the guideline." }, drill: { jp: "Die jeweilige Klinik entscheidet das selbst", en: "The respective clinic decides that itself" }, accept: ["respective", "relevant", "each", "in each case"], hint: "The adjective to jeweils (u87). It saves a whole relative clause: die jeweils zuständige Stelle." },
