  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u32l2-diesteuer", type: "vocab", front: "die Steuer", reading: "diesteuer", meaning: "tax", example: { jp: "Wer viel verdient, bezahlt viel Steuer.", en: "Whoever earns a lot pays a lot of tax." }, drill: { jp: "Die Steuer ist sehr hoch", en: "The tax is very high" }, accept: ["tax", "duty"], hint: "Do not confuse it with teuer (u10), expensive — one letter apart and a very German joke. Das Steuer, neuter, is a steering wheel." },
        { id: "de-u32l2-derausweis", type: "vocab", front: "der Ausweis", reading: "derausweis", meaning: "ID card", example: { jp: "Ohne Ausweis komme ich nicht zu der Wahl.", en: "Without ID I do not get to the election." }, drill: { jp: "Der Ausweis liegt auf dem Tisch", en: "The ID card is lying on the table" }, accept: ["id", "id card", "identity card", "identification"], hint: "The card every German adult carries. Der Pass (u18) is for crossing borders; der Ausweis is for everything at home." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u32l4-dasthema", type: "vocab", front: "das Thema", reading: "dasthema", meaning: "topic / subject", example: { jp: "Das Thema ist schwer, deshalb sprechen wir darüber.", en: "The topic is difficult, therefore we talk about it." }, drill: { jp: "Das Thema ist heute das Gesetz", en: "The topic today is the law" }, accept: ["topic", "subject", "theme"], hint: "TAY-ma, with a t said plainly — the h is silent. Its plural is irregular and Greek: die Themen." },
      ],
    },
  ],
};
