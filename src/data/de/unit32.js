...
// DECLARED OUT-OF-SCOPE TOKEN: zur, in l1's der Bürger example.
// The idiom is `zur Wahl gehen`; "zu der Wahl gehen" is not German, so the
// contraction is obligatory here rather than stylistic. u14l1 cards `im` and `am`
// but never carded zum/zur/beim/vom, so zur is the one token in u21-u50 that
// scope-strict-de reports. Fixing it by un-contracting would restore bad German;
// fixing it by carding zur belongs in u14 (A1), not here. Declared, and routed.
//
// UPDATE (naturalness pass, 2026-09-13): `vom` IS now carded, at u21l3, because the
// same argument applied to it thirteen times over — "das Dach von dem Haus" reads as
// "of THAT house" and every uncontracted von+dem in the band read as a learner error.
// `zum` is licensed from u36 as half of the front `zum Beispiel`, not by a card of its
// own; `beim` and `zur` are still untaught and still A1's to fix. See u21's header.
  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u32l1-dieregierung", type: "vocab", front: "die Regierung", reading: "dieregierung", meaning: "government", example: { jp: "Die Regierung macht das Gesetz.", en: "The government makes the law." }, drill: { jp: "Die Regierung arbeitet für die Bürger", en: "The government works for the citizens" }, accept: ["government", "administration"], hint: "From regieren, to govern. Die Regierung is the people currently in charge; der Staat outlasts them." },
