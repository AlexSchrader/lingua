  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u75l2-diestrafe", type: "vocab", front: "die Strafe", reading: "diestrafe", meaning: "the punishment", example: { jp: "Die Strafe für zu schnelles Fahren ist in Deutschland hoch.", en: "The punishment for driving too fast is high in Germany." }, drill: { jp: "Die Strafe war sehr hoch", en: "The punishment was very high" }, accept: ["punishment", "the punishment", "the penalty", "the fine", "the sentence"], hint: "A parking ticket is ein Strafzettel, from the same word." },
        ...
        { id: "de-u75l2-dievorschrift", type: "vocab", front: "die Vorschrift", reading: "dievorschrift", meaning: "the regulation", example: { jp: "Die Vorschrift für den Betrieb steht in einem alten Gesetz.", en: "The regulation for the plant is set out in an old law." }, drill: { jp: "Die Vorschrift steht im Gesetz", en: "The regulation is set out in the law" }, accept: ["regulation", "the regulation", "the rule", "the requirement"], hint: "vor + schreiben: written in advance. Smaller than ein Gesetz (u32)." },
      ],
    },
    {
      id: "de-u75l3",
      ...
      items: [
        ...
        { id: "de-u75l3-derantrag", type: "vocab", front: "der Antrag", reading: "derantrag", meaning: "the application", example: { jp: "Der Antrag auf eine Wohnung liegt seit Wochen auf dem Amt.", en: "The application for a flat has been at the office for weeks." }, drill: { jp: "Der Antrag kommt heute an das Amt", en: "The application goes to the office today" }, accept: ["application", "the application", "the request", "the motion", "the proposal"], hint: "einen Antrag stellen = to put in an application. The verb is beantragen." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u75l4-diefrist", type: "vocab", front: "die Frist", reading: "diefrist", meaning: "the deadline", example: { jp: "Die Frist für den Antrag ist am Montag zu Ende.", en: "The deadline for the application ends on Monday." }, drill: { jp: "Die Frist ist am Montag zu Ende", en: "The deadline ends on Monday" }, accept: ["deadline", "the deadline", "the time limit", "the period", "the notice period"], hint: "eine Frist einhalten = to meet a deadline. Missing one is expensive in Germany." },
        { id: "de-u75l4-gultig", type: "vocab", front: "gültig", reading: "gultig", meaning: "valid", example: { jp: "Der Ausweis ist noch zwei Jahre gültig, der alte war es nicht.", en: "The ID is valid for two more years, the old one was not." }, drill: { jp: "Der Ausweis ist noch gültig", en: "The ID is still valid" }, accept: ["valid", "in force", "current"], hint: "From gelten, to be in force. The opposite is ungültig." },
        ...
        { id: "de-u75l4-dieakte", type: "vocab", front: "die Akte", reading: "dieakte", meaning: "the file", example: { jp: "Die Akte über den Fall liegt seit Jahren im Gericht.", en: "The file on the case has been at the court for years." }, drill: { jp: "Die Akte liegt auf dem Tisch", en: "The file is on the table" }, accept: ["file", "the file", "the record", "the dossier"], hint: "Usually plural: die Akten. zu den Akten legen = to file and forget." },
      ],
    },
  ],
};
