  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u25l1-diepraxis", type: "vocab", front: "die Praxis", reading: "diepraxis", meaning: "the surgery", example: { jp: "Die Praxis ist heute sehr voll.", en: "The surgery is very busy today." }, drill: { jp: "Die Praxis ist heute sehr voll", en: "The surgery is very busy today" }, accept: ["the surgery", "surgery", "the practice", "the doctor's office", "the office"], hint: "The doctor's rooms, not an operation — an operation is die Operation. Plural is Praxen, one of the Greek-derived nouns that changes its ending." },
        { id: "de-u25l1-derpatient", type: "vocab", front: "der Patient", reading: "derpatient", meaning: "the patient", example: { jp: "Der Patient wartet in der Praxis.", en: "The patient is waiting at the surgery." }, drill: { jp: "Der Patient wartet in der Praxis", en: "The patient is waiting at the surgery" }, accept: ["the patient", "patient"], hint: "One of the nouns that adds -en everywhere except the nominative: der Patient, but den Patienten. Der Kollege from u19 does the same." },
        { id: "de-u25l1-dasrezept", type: "vocab", front: "das Rezept", reading: "dasrezept", meaning: "the prescription", example: { jp: "Der Arzt schreibt das Rezept.", en: "The doctor writes the prescription." }, drill: { jp: "Der Arzt schreibt das Rezept", en: "The doctor writes the prescription" }, accept: ["the prescription", "prescription", "the recipe", "recipe"], hint: "The same word does duty as a cooking recipe — both are instructions to be made up by someone else. Context alone tells them apart." },
        { id: "de-u25l1-dietablette", type: "vocab", front: "die Tablette", reading: "dietablette", meaning: "the tablet", example: { jp: "Die Tablette ist klein und weiß.", en: "The tablet is small and white." }, drill: { jp: "Die Tablette ist klein und weiß", en: "The tablet is small and white" }, accept: ["the tablet", "tablet", "the pill", "pill"], hint: "Note it is not the computer, which Germans also call ein Tablet — spelled without the final -e and pronounced the English way." },
        { id: "de-u25l1-diespritze", type: "vocab", front: "die Spritze", reading: "diespritze", meaning: "the injection", example: { jp: "Der Arzt gibt die Spritze.", en: "The doctor gives the injection." }, drill: { jp: "Der Arzt gibt die Spritze", en: "The doctor gives the injection" }, accept: ["the injection", "injection", "the jab", "the shot", "the syringe"], hint: "Both the syringe and the jab it delivers. From spritzen, to squirt — which is also what a garden hose does." },
        { id: "de-u25l1-diebehandlung", type: "vocab", front: "die Behandlung", reading: "diebehandlung", meaning: "the treatment", example: { jp: "Die Behandlung dauert eine Woche.", en: "The treatment lasts a week." }, drill: { jp: "Die Behandlung dauert eine Woche", en: "The treatment lasts a week" }, accept: ["the treatment", "treatment", "the course of treatment"], hint: "Hiding u11's Hand — behandeln is literally to put hands on. The -ung ending makes it feminine, as it did in Bewerbung and Erfahrung." },
      ],
    },
    {
      id: "de-u25l2",
    ...
    },
    {
      ...
      items: [
        { id: "de-u25l3-diegrippe", type: "vocab", front: "die Grippe", reading: "diegrippe", meaning: "the flu", example: { jp: "Die Grippe kommt oft im Winter.", en: "The flu often comes in winter." }, drill: { jp: "Die Grippe kommt oft im Winter", en: "The flu often comes in winter" }, accept: ["the flu", "flu", "the influenza", "influenza"], hint: "Stronger than u11's Erkältung, which is only a cold. Germans distinguish the two firmly and will correct you if you blur them." },
        { id: "de-u25l3-dieallergie", type: "vocab", front: "die Allergie", reading: "dieallergie", meaning: "the allergy", example: { jp: "Die Allergie kommt im Frühling.", en: "The allergy comes in spring." }, drill: { jp: "Die Allergie kommt im Frühling", en: "The allergy comes in spring" }, accept: ["the allergy", "allergy"], hint: "Stress the last syllable — aller-GIE, with a soft g like the s in measure. Nouns in -ie are feminine and end-stressed as a class." },
        ...
        { id: "de-u25l3-dasblut", type: "vocab", front: "das Blut", reading: "dasblut", meaning: "the blood", example: { jp: "Das Blut ist rot und warm.", en: "The blood is red and warm." }, drill: { jp: "Das Blut ist rot und warm", en: "The blood is red and warm" }, accept: ["the blood", "blood"], hint: "Singular only, like u21's Geschirr — there is no plural. Bluten is the verb, to bleed." },
      ],
    },
    {
      id: "de-u25l4",
