  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u25l4-diehilfe", type: "vocab", front: "die Hilfe", reading: "diehilfe", meaning: "the help", example: { jp: "Die Hilfe kommt schnell.", en: "The help arrives quickly." }, drill: { jp: "Die Hilfe ist jetzt da", en: "Help is here now" }, accept: ["help", "the help", "assistance", "aid"], hint: "Hilfe! on its own is the shout for help. The verb is helfen (u14), and it takes the dative: Ich helfe dir, never ich helfe dich." },
      ],
    },
  ],
};
