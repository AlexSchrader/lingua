...
//
// ⚠️ Self-check, CORRECTED BY THE GATE: an earlier draft said "der Film is NOT
// here - it is already taught (u64)". It is not taught anywhere; it is a FREE
// cognate on unit1.js's line, and FREE means "allowed in an example", never
// "taught". der Film is now a card in l1. das Fernsehen
  ...
  lessons: [
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Name what you listen to and look at — music, radio, a photo, a concert, a theatre and a film.",
      items: [
        ...
        { id: "de-u122l1-derfilm", type: "vocab", front: "der Film", reading: "derfilm", meaning: "the film", example: { jp: "Der Film dauert fast drei Stunden, und trotzdem bleiben fast alle bis zum Ende.", en: "The film lasts almost three hours, and even so almost everyone stays to the end." }, drill: { jp: "Der Film beginnt um acht", en: "The film begins at eight" }, accept: ["film", "the film", "movie", "the movie"], hint: "One word for cinema and for the material in a camera. der Streifen is the older slang for a movie, and einen Film drehen is to shoot one." },
      ],
    },
    {
      id: "de-u122l2",
      ...
      items: [
        ...
        { id: "de-u122l2-derdrucker", type: "vocab", front: "der Drucker", reading: "derdrucker", meaning: "the printer", example: { jp: "Der Drucker im Büro geht schon wieder nicht.", en: "The printer in the office is out of order again." }, drill: { jp: "Der Drucker im Büro geht nicht", en: "The printer in the office does not work" }, accept: ["printer", "the printer", "print shop"], hint: "From drucken (to print) — not drücken (u44, to press), which is a different verb with the same look. Also a person who prints for a living." },
      ],
    },
    {
      id: "de-u122l3",
      ...
      items: [
        { id: "de-u122l3-dieinformation", type: "vocab", front: "die Information", reading: "dieinformation", meaning: "the information", example: { jp: "Die Information kam zu spät, und deshalb hat die halbe Gruppe den falschen Weg genommen.", en: "The information came too late, and so half the group took the wrong route." }, drill: { jp: "Die Information war leider falsch", en: "Unfortunately the information was wrong" }, accept: ["information", "the information", "piece of information", "intelligence"], hint: "Countable in German where English is not — eine Information, drei Informationen. Stress on the last syllable: informaTION." },
        ...
        { id: "de-u122l3-diefakultat", type: "vocab", front: "die Fakultät", reading: "diefakultat", meaning: "the faculty", example: { jp: "Die Fakultät liegt im alten Gebäude neben dem Park.", en: "The faculty is in the old building next to the park." }, drill: { jp: "Die Fakultät liegt im alten Gebäude", en: "The faculty is in the old building" }, accept: ["faculty", "the faculty", "department", "the department", "school"], hint: "One division of die Universität in this lesson — law, medicine, philosophy. NOT the teaching staff, which English 'faculty' can mean; that is das Lehrpersonal." },
      ],
    },
    {
      id: "de-u122l4",
