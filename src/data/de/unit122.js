  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u122l1-derfilm", type: "vocab", front: "der Film", reading: "derfilm", meaning: "the film", example: { jp: "Der Film dauert fast drei Stunden, und trotzdem geht am Ende niemand vorher.", en: "The film lasts almost three hours, and even so nobody leaves early at the end." }, drill: { jp: "Der Film beginnt um acht", en: "The film begins at eight" }, accept: ["film", "the film", "movie", "the movie"], hint: "⚠️ This card exists because a gate caught an error in this unit’s own header, which had claimed der Film was already taught in u64. It is not — it is a FREE cognate on unit1.js’s line, and FREE means ‘allowed in an example’, never ‘taught’. Used 6 times in the corpus with no card." },
      ],
    },
    {
      id: "de-u122l2",
    ...
    },
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Use the abstract nouns a report leans on — control, contact, a position, a situation and a chance.",
      items: [
