  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u65l2-dietonne", type: "vocab", front: "die Tonne", reading: "dietonne", meaning: "the wheelie bin", example: { jp: "Vor dem Haus in der Straße steht eine große Tonne.", en: "There is a big bin in front of the house on the street." }, drill: { jp: "Die Tonne steht vor dem Haus", en: "The bin is standing in front of the house" }, accept: ["bin", "the bin", "the barrel", "the tonne", "tonne"], hint: "Also the weight: eine Tonne, a metric ton. Same word, both senses." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u65l4-derlebensraum", type: "vocab", front: "der Lebensraum", reading: "derlebensraum", meaning: "the habitat", example: { jp: "Durch den Bau der Straße geht vielen Tieren der Lebensraum verloren.", en: "Many animals lose their habitat through the building of the road." }, drill: { jp: "Der Lebensraum vieler Tiere verschwindet", en: "The habitat of many animals is disappearing" }, accept: ["habitat", "the habitat", "living space", "the living space"], hint: "das Leben + der Raum: the space a species lives in. The word a nature programme uses, and the reason aussterben in this lesson happens." },
      ],
    },
  ],
};
