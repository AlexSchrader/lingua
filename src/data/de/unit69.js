  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u69l3-wodurch", type: "vocab", front: "wodurch", reading: "wodurch", meaning: "through which", example: { jp: "Die Preise sind gestiegen, wodurch viele Familien weniger ausgeben können.", en: "Prices have risen, as a result of which many families can spend less." }, drill: { jp: "Wodurch ist das Problem entstanden", en: "Through what did the problem arise" }, accept: ["through which", "by which", "as a result of which", "whereby", "by what means"], hint: "wo- + durch, the same build as worin and wobei in this lesson. As a question it asks by what means: Wodurch ist das passiert?" },
      ],
    },
    {
      id: "de-u69l4",
      ...
      items: [
        ...
        { id: "de-u69l4-sodass", type: "vocab", front: "sodass", reading: "sodass", meaning: "with the result that", example: { jp: "Es regnet den ganzen Tag, sodass wir zu Hause bleiben.", en: "It is raining all day, so that we are staying at home." }, drill: { jp: "Es regnet sodass wir bleiben", en: "It is raining so that we are staying" }, accept: ["so that", "with the result that", "and so", "so"], hint: "The RESULT. damit (u29) is the PURPOSE — the difference matters." },
        ...
        { id: "de-u69l4-wohingegen", type: "vocab", front: "wohingegen", reading: "wohingegen", meaning: "whereas", example: { jp: "Im Sommer war es hier sehr heiß, wohingegen es im Winter kaum kalt wurde.", en: "In summer it was very hot here, whereas in winter it hardly got cold." }, drill: { jp: "Er bleibt hier wohingegen sie fährt", en: "He stays here whereas she leaves" }, accept: ["whereas", "while", "by contrast", "on the other hand"], hint: "A contrast joiner, so the verb goes last. Heavier and more written than aber; in speech people say während or und dafür." },
      ],
    },
  ],
};
