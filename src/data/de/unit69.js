  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u69l3-wodurch", type: "vocab", front: "wodurch", reading: "wodurch", meaning: "through which", example: { jp: "Die Preise sind gestiegen, wodurch viele Familien weniger ausgeben können.", en: "Prices have risen, as a result of which many families can spend less." }, drill: { jp: "Die Preise stiegen wodurch alle sparten", en: "Prices rose through which everyone saved" }, accept: ["through which", "by which", "as a result of which", "whereby", "by what means"], hint: "wo- + durch, the same build as worin and wobei in this lesson. As a question it asks by what means: Wodurch ist das passiert?" },
      ],
    },
    {
      id: "de-u69l4",
