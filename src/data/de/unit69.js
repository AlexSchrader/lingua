  ...
  lessons: [
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Ask a question about a thing the German way: what … on, what … of, what … with, what … about, what … for.",
      items: [
        { id: "de-u69l1-worauf", type: "vocab", front: "worauf", reading: "worauf", meaning: "on what", example: { jp: "Worauf wartest du noch? Der Bus nach Hamburg ist schon weg.", en: "What are you still waiting for? The bus to Hamburg has already gone." }, drill: { jp: "Worauf wartest du noch", en: "What are you still waiting for" }, accept: ["on what", "what on", "for what", "what for", "what … for"], hint: "wo + r + auf, because auf starts with a vowel. For a person you say auf wen." },
        ...
        { id: "de-u69l1-wovon", type: "vocab", front: "wovon", reading: "wovon", meaning: "of what", example: { jp: "Wovon sprechen die Kinder im Zimmer?", en: "What are the children in the room talking about?" }, drill: { jp: "Wovon sprechen die Kinder", en: "What are the children talking about" }, accept: ["of what", "what of", "about what", "what about", "from what"], hint: "Goes with sprechen von, träumen von, leben von." },
        { id: "de-u69l1-woruber", type: "vocab", front: "worüber", reading: "woruber", meaning: "about what", example: { jp: "Worüber sprechen wir heute in der Schule?", en: "What are we talking about in school today?" }, drill: { jp: "Worüber sprechen wir heute", en: "What are we talking about today" }, accept: ["about what", "what about", "over what"], hint: "Both über and von work with sprechen, so worüber and wovon can both fit." },
        { id: "de-u69l1-wofur", type: "vocab", front: "wofür", reading: "wofur", meaning: "what for", example: { jp: "Wofür brauchst du das Geld? Für ein Auto oder für die Miete?", en: "What do you need the money for? For a car or for the rent?" }, drill: { jp: "Wofür brauchst du das Geld", en: "What do you need the money for" }, accept: ["what for", "for what", "why"], hint: "No -r-. Careful: warum asks the reason, wofür asks the purpose." },
      ],
    },
    {
      id: "de-u69l2",
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Point back at a thing already mentioned: on it, of it, about it, in the process, against it.",
      items: [
        { id: "de-u69l2-darauf", type: "vocab", front: "darauf", reading: "darauf", meaning: "on it", example: { jp: "Die Antwort kommt bald, und wir warten schon lange darauf.", en: "The answer is coming soon, and we have been waiting for it a long time." }, drill: { jp: "Wir warten schon lange darauf", en: "We have been waiting for it a long time" }, accept: ["on it", "for it", "on that", "for that"], hint: "The answer form of worauf: da + r + auf. Never 'auf es' — that is not German." },
        ...
        { id: "de-u69l2-davon", type: "vocab", front: "davon", reading: "davon", meaning: "of it", example: { jp: "Es gibt einen neuen Chef in der Firma, aber wir wissen nichts davon.", en: "There is a new boss at the firm, but we know nothing about it." }, drill: { jp: "Davon wissen wir nichts", en: "We know nothing about it" }, accept: ["of it", "about it", "from it", "of that"], hint: "No -r-. Common in speech: Ich habe nichts davon gewusst." },
        { id: "de-u69l2-daruber", type: "vocab", front: "darüber", reading: "daruber", meaning: "about it", example: { jp: "Der Streit ist zu neu, darüber sprechen wir morgen.", en: "The argument is too fresh, we will talk about it tomorrow." }, drill: { jp: "Darüber sprechen wir morgen", en: "We will talk about it tomorrow" }, accept: ["about it", "over it", "about that"], hint: "da + r + über. Also physical: das Bild und die Uhr darüber." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u69l3-dadurch", type: "vocab", front: "dadurch", reading: "dadurch", meaning: "as a result", example: { jp: "Der Chef hat einen neuen Plan und dadurch wurde die Arbeit besser.", en: "The boss has a new plan and as a result the work got better." }, drill: { jp: "Dadurch wurde die Arbeit besser", en: "As a result the work got better" }, accept: ["as a result", "through it", "by it", "thereby", "because of that"], hint: "No -r-. dadurch, dass … is the everyday way to say 'by doing …'." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u69l4-seitdem", type: "vocab", front: "seitdem", reading: "seitdem", meaning: "ever since", example: { jp: "Seitdem wir am Meer wohnen, geht es meinem Vater besser.", en: "Ever since we have lived by the sea, my father has been better." }, drill: { jp: "Seitdem geht es uns besser", en: "Ever since then we have been better" }, accept: ["ever since", "since then", "since"], hint: "Opens a clause, unlike seither (u63) which only stands alone." },
