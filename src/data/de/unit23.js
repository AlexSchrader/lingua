  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u23l1-diereservierung", type: "vocab", front: "die Reservierung", reading: "diereservierung", meaning: "the reservation", example: { jp: "Die Reservierung ist auf meinen Namen.", en: "The reservation is in my name." }, drill: { jp: "Die Reservierung ist für heute Abend", en: "The reservation is for this evening" }, accept: ["the reservation", "reservation", "the booking", "booking"], hint: "Auf den Namen, with the accusative — the reservation is put ONTO a name. The verb is reservieren, and reserviert on a table means taken." },
        { id: "de-u23l1-dieunterkunft", type: "vocab", front: "die Unterkunft", reading: "dieunterkunft", meaning: "the accommodation", example: { jp: "Die Unterkunft in der Stadt ist teuer.", en: "The accommodation in the city is expensive." }, drill: { jp: "Wir buchen die Unterkunft am Montag", en: "We book the accommodation on Monday" }, accept: ["the accommodation", "accommodation", "the lodging", "a place to stay"], hint: "Unter + kommen, where you come to rest. It covers a hotel, a hostel or a friend's sofa — the neutral word for wherever you are sleeping." },
        ...
        { id: "de-u23l1-diesehenswurdigkeit", type: "vocab", front: "die Sehenswürdigkeit", reading: "diesehenswurdigkeit", meaning: "the sight", example: { jp: "Die Sehenswürdigkeit ist heute sehr voll.", en: "The sight is very crowded today." }, drill: { jp: "Die Sehenswürdigkeit in der Stadt ist alt", en: "The sight in the city is old" }, accept: ["the sight", "sight", "the attraction", "the landmark"], hint: "Take it apart and it says itself: sehen + würdig + -keit, worthiness-of-being-seen. Long, but every piece is a word you already have." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u23l2-fliegen", type: "vocab", front: "fliegen", reading: "fliegen", meaning: "to fly", example: { jp: "Wir fliegen im Sommer nach Wien.", en: "We fly to Vienna in the summer." }, drill: { jp: "Die Eltern wollen nach Berlin fliegen", en: "The parents want to fly to Berlin" }, accept: ["to fly", "fly"], hint: "The verb behind u18's Flugzeug — the vowel shifts from ie to u across the pair, a pattern you will see again in ziehen and Zug." },
      ],
    },
    {
      id: "de-u23l3",
      ...
      items: [
        { id: "de-u23l3-dierezeption", type: "vocab", front: "die Rezeption", reading: "dierezeption", meaning: "the reception", example: { jp: "Die Rezeption ist hier rechts.", en: "Reception is here on the right." }, drill: { jp: "Die Rezeption im Hotel ist klein", en: "The reception in the hotel is small" }, accept: ["the reception", "reception", "the front desk", "the reception desk"], hint: "Stress the last syllable: Rezep-TSION. The -tion ending is always feminine and always stressed at the end, which makes a whole class of words predictable." },
        { id: "de-u23l3-daseinzelzimmer", type: "vocab", front: "das Einzelzimmer", reading: "daseinzelzimmer", meaning: "the single room", example: { jp: "Das Einzelzimmer kostet vierzig Euro.", en: "The single room costs forty euros." }, drill: { jp: "Das Einzelzimmer ist klein und teuer", en: "The single room is small and expensive" }, accept: ["the single room", "single room", "a single"], hint: "Einzel- is the prefix for one-of, from ein. It reappears in Einzelkind, an only child, and Einzelfahrkarte, a single ticket." },
        { id: "de-u23l3-dasdoppelzimmer", type: "vocab", front: "das Doppelzimmer", reading: "dasdoppelzimmer", meaning: "the double room", example: { jp: "Das Doppelzimmer hat ein großes Fenster.", en: "The double room has a big window." }, drill: { jp: "Das Doppelzimmer ist groß und hell", en: "The double room is big and bright" }, accept: ["the double room", "double room", "a double"], hint: "Doppel- is double, and it stacks the same way Einzel- does. Both take das, because the head of the compound is das Zimmer and the last word always decides." },
        { id: "de-u23l3-dieubernachtung", type: "vocab", front: "die Übernachtung", reading: "dieubernachtung", meaning: "the overnight stay", example: { jp: "Die Übernachtung im Hotel ist teuer.", en: "The overnight stay at the hotel is expensive." }, drill: { jp: "Die Übernachtung kostet sechzig Euro", en: "The overnight stay costs sixty euros" }, accept: ["the overnight stay", "overnight stay", "the night", "the stay"], hint: "Über + Nacht + -ung: the getting-through-a-night. It is what a hotel actually charges for, so it is the word on the bill." },
        { id: "de-u23l3-dieaussicht", type: "vocab", front: "die Aussicht", reading: "dieaussicht", meaning: "the view", example: { jp: "Die Aussicht aus dem Zimmer ist schön.", en: "The view from the room is lovely." }, drill: { jp: "Die Aussicht ist heute sehr gut", en: "The view is very good today" }, accept: ["the view", "view", "the outlook", "the prospect"], hint: "Aus + Sicht, the seeing-out. It also means prospect in the sense of what lies ahead — gute Aussichten are good prospects." },
        { id: "de-u23l3-frei", type: "vocab", front: "frei", reading: "frei", meaning: "vacant", example: { jp: "Heute ist kein Zimmer frei.", en: "No room is vacant today." }, drill: { jp: "Am Montag ist ein Zimmer frei", en: "On Monday a room is vacant" }, accept: ["vacant", "free", "available", "unoccupied"], hint: "Frei carries both senses English splits — a vacant room and a free afternoon. For free of charge Germans say kostenlos instead." },
      ],
    },
    {
      id: "de-u23l4",
      ...
      items: [
        ...
        { id: "de-u23l4-dieampel", type: "vocab", front: "die Ampel", reading: "dieampel", meaning: "the traffic light", example: { jp: "Die Ampel vor der Schule ist rot.", en: "The traffic light in front of the school is red." }, drill: { jp: "Die Ampel ist jetzt grün", en: "The traffic light is green now" }, accept: ["the traffic light", "traffic light", "the traffic lights", "the lights"], hint: "Singular where English often goes plural — die Ampel ist rot, not are red. Germans wait at a red one even with no car in sight." },
      ],
    },
  ],
};
