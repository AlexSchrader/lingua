  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u20l3-sitzen", type: "vocab", front: "sitzen", reading: "sitzen", meaning: "to sit", example: { jp: "Wir sitzen zusammen auf dem Sofa.", en: "We are sitting together on the sofa." }, drill: { jp: "Die Kinder sitzen im Garten", en: "The children are sitting in the garden" }, accept: ["to sit", "to be sitting"], hint: "Being seated, not the act of sitting down — that is sich setzen. Takes the dative for where." },
