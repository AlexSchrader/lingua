  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u20l2-sehen", type: "vocab", front: "sehen", reading: "sehen", meaning: "to see (with the eyes)", example: { jp: "Aus dem Fenster sehen wir den Park.", en: "From the window we see the park." }, accept: ["to see", "to look"], hint: "Vowel shift again: ich sehe, but er sieht. Not the same as u2's bis bald, which is a goodbye, not this verb." },
        ...
        { id: "de-u20l2-nehmen", type: "vocab", front: "nehmen", reading: "nehmen", meaning: "to take", example: { jp: "Wir nehmen den Bus nach Berlin.", en: "We take the bus to Berlin." }, accept: ["to take"], hint: "Badly irregular: ich nehme, du nimmst, er nimmt. Worth learning as three separate shapes." },
