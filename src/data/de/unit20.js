  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u20l1-konnen", type: "vocab", front: "können", reading: "konnen", meaning: "to be able to", example: { jp: "Ich kann sehr gut schwimmen.", en: "I can swim very well." }, accept: ["can", "to be able to", "to be able"], hint: "The second verb goes to the very end in the infinitive: ich kann … schwimmen. Irregular: ich kann, du kannst, wir können." },
        ...
        { id: "de-u20l1-wollen", type: "vocab", front: "wollen", reading: "wollen", meaning: "to want to", example: { jp: "Sie will einen Mantel kaufen.", en: "She wants to buy a coat." }, accept: ["to want", "to want to"], hint: "ich will, du willst. A false friend for English speakers: will is want, not the future tense." },
        ...
        { id: "de-u20l1-sollen", type: "vocab", front: "sollen", reading: "sollen", meaning: "to be supposed to", example: { jp: "Was soll ich dem Chef sagen?", en: "What am I supposed to tell the boss?" }, accept: ["should", "to be supposed to", "ought to"], hint: "Someone else's instruction or expectation: du sollst warten, you are to wait." },
        { id: "de-u20l1-mochten", type: "vocab", front: "möchten", reading: "mochten", meaning: "would like", example: { jp: "Ich möchte einen Kaffee, bitte.", en: "I would like a coffee, please." }, accept: ["would like", "to would like"], hint: "The politest way to order or ask for anything in German. It is really the subjunctive of mögen, to like, but you meet it first and use it far more." },
      ],
    },
    {
      id: "de-u20l2",
      ...
      items: [
        { id: "de-u20l2-machen", type: "vocab", front: "machen", reading: "machen", meaning: "to do / make", example: { jp: "Was machst du am Sonntag?", en: "What are you doing on Sunday?" }, accept: ["to do", "to make"], hint: "Was machst du? is both what are you doing and what do you do for a living. Probably the most-used verb in spoken German." },
        { id: "de-u20l2-sagen", type: "vocab", front: "sagen", reading: "sagen", meaning: "to say", example: { jp: "Sie sagt nichts und geht.", en: "She says nothing and leaves." }, accept: ["to say", "to tell"], hint: "The person told is dative: sag mir, tell me. Sagen is to say; sprechen (u1) is to speak." },
        ...
        { id: "de-u20l2-geben", type: "vocab", front: "geben", reading: "geben", meaning: "to give", example: { jp: "Der Lehrer gibt dem Schüler ein Buch.", en: "The teacher gives the pupil a book." }, accept: ["to give"], hint: "Two objects: person dative, thing accusative — exactly u13 and u14 together. u13's es gibt, there is, is built from it." },
        ...
        { id: "de-u20l2-wissen", type: "vocab", front: "wissen", reading: "wissen", meaning: "to know", example: { jp: "Ich weiß, wo das Museum ist.", en: "I know where the museum is." }, accept: ["to know", "to know a fact"], hint: "For facts. Knowing a person or a place is kennen — German splits what English calls knowing. ich weiß, du weißt." },
      ],
    },
    {
      id: "de-u20l3",
      ...
      items: [
        { id: "de-u20l3-schlafen", type: "vocab", front: "schlafen", reading: "schlafen", meaning: "to sleep", example: { jp: "Das Kind schläft im Bett.", en: "The child is sleeping in bed." }, accept: ["to sleep"], hint: "Vowel shift: ich schlafe, er schläft. das Schlafzimmer in u15 is built on it." },
        { id: "de-u20l3-aufstehen", type: "vocab", front: "aufstehen", reading: "aufstehen", meaning: "to get up", example: { jp: "Am Montag stehe ich um sechs Uhr auf.", en: "On Monday I get up at six o'clock." }, accept: ["to get up", "to stand up", "to rise"], hint: "Separable — the auf- goes to the end: ich stehe … auf. Watch the word order in the example." },
        ...
        { id: "de-u20l3-liegen", type: "vocab", front: "liegen", reading: "liegen", meaning: "to lie", example: { jp: "Die Zeitung liegt auf dem Tisch.", en: "The newspaper is lying on the table." }, accept: ["to lie", "to be lying", "to be situated"], hint: "Used constantly for where a thing IS: das Buch liegt dort. Also for towns — Wien liegt in Österreich." },
        ...
        { id: "de-u20l3-denken", type: "vocab", front: "denken", reading: "denken", meaning: "to think", example: { jp: "Ich denke oft an meine Großeltern.", en: "I often think about my grandparents." }, accept: ["to think"], hint: "denken AN plus accusative for thinking about someone. English think and denken are the same old word." },
      ],
    },
    {
      id: "de-u20l4",
      ...
      items: [
        ...
        { id: "de-u20l4-tanzen", type: "vocab", front: "tanzen", reading: "tanzen", meaning: "to dance", example: { jp: "Meine Schwester tanzt sehr gut.", en: "My sister dances very well." }, accept: ["to dance"], hint: "The z is ts: TAN-tsen. Same word as English dance, arrived from French in both languages." },
        ...
        { id: "de-u20l4-kochen", type: "vocab", front: "kochen", reading: "kochen", meaning: "to cook", example: { jp: "Am Sonntag kocht mein Vater.", en: "On Sunday my father cooks." }, accept: ["to cook", "to boil"], hint: "Also to boil: das Wasser kocht. der Koch is a cook — not to be confused with der Chef, the boss." },
        { id: "de-u20l4-laufen", type: "vocab", front: "laufen", reading: "laufen", meaning: "to run", example: { jp: "Er läuft am Morgen im Park.", en: "He runs in the park in the morning." }, accept: ["to run", "to walk", "to go"], hint: "Run, but in much of Germany simply to walk — ich laufe zur Schule. Vowel shift: er läuft." },
      ],
    },
  ],
};
