  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u20l2-diefrage", type: "vocab", front: "die Frage", reading: "diefrage", meaning: "the question", example: { jp: "Die Frage ist heute nicht schwer.", en: "The question isn't hard today." }, drill: { jp: "Die Frage ist heute sehr schwer", en: "The question is very hard today" }, accept: ["question", "the question", "query", "the query"], hint: "The noun beside fragen. German STELLS a question: eine Frage stellen, never machen. Plural Fragen." },
        { id: "de-u20l2-dieantwort", type: "vocab", front: "die Antwort", reading: "dieantwort", meaning: "the answer", example: { jp: "Die Antwort ist kurz, aber sie ist richtig.", en: "The answer is short, but it is right." }, drill: { jp: "Die Antwort ist immer richtig", en: "The answer is always right" }, accept: ["answer", "the answer", "reply", "the reply", "response"], hint: "The noun beside antworten. You antworten AUF a question, and the noun keeps it: die Antwort auf die Frage." },
      ],
    },
    {
      id: "de-u20l3",
