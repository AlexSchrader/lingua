  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u78l1-dasanliegen", type: "vocab", front: "das Anliegen", reading: "dasanliegen", meaning: "the concern", example: { jp: "Was ist Ihr Anliegen?", en: "What is your request?" }, drill: { jp: "Das Anliegen ist nicht neu", en: "The request is not new" }, accept: ["request", "the request", "concern", "the concern", "the matter", "matter"], hint: "The polite office word for what you have come about. Haben Sie ein Anliegen?" },
        { id: "de-u78l1-mangelhaft", type: "vocab", front: "mangelhaft", reading: "mangelhaft", meaning: "defective", example: { jp: "Das neue Gerät war leider mangelhaft.", en: "The new device was unfortunately defective." }, drill: { jp: "Das Gerät war leider völlig mangelhaft", en: "The device was unfortunately completely defective" }, accept: ["defective", "faulty", "deficient", "substandard", "inadequate"], hint: "The word a written complaint uses — der Mangel (u60) + -haft. defekt in this lesson means broken; mangelhaft means it does not meet the standard. It is also school grade 5." },
      ],
    },
    {
      id: "de-u78l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u78l3-derersatz", type: "vocab", front: "der Ersatz", reading: "derersatz", meaning: "the replacement", example: { jp: "Als Ersatz für das kaputte Gerät haben wir ein neues geschickt.", en: "As a replacement for the broken device we sent a new one." }, drill: { jp: "Der Ersatz war zum Glück kostenlos", en: "The replacement was luckily free" }, accept: ["replacement", "the replacement", "substitute", "the substitute", "compensation"], hint: "No plural. From ersetzen (u60). Ersatz für etwas verlangen = to demand a replacement; der Ersatzteil is the spare part." },
      ],
    },
    {
      id: "de-u78l4",
      ...
      items: [
        ...
        { id: "de-u78l4-nachhaken", type: "vocab", front: "nachhaken", reading: "nachhaken", meaning: "to press the point", example: { jp: "Wenn niemand antwortet, müssen Sie höflich nachhaken.", en: "If nobody answers, you have to press the point politely." }, drill: { jp: "Wir müssen bei der Firma nachhaken", en: "We have to press the point with the company" }, accept: ["to press the point", "press the point", "to follow up", "to probe further", "to chase it up"], hint: "nach + der Haken (the hook): getting the hook in again. Separable, and less formal than nachfragen." },
        { id: "de-u78l4-beharren", type: "vocab", front: "beharren", reading: "beharren", meaning: "to insist", example: { jp: "Er beharrt auf der Forderung, obwohl die Firma schon Nein gesagt hat.", en: "He insists on the demand, although the company has already said no." }, drill: { jp: "Wir wollen auf der Forderung beharren", en: "We want to insist on the demand" }, accept: ["to insist", "insist", "to persist", "persist", "to stand firm"], hint: "auf etwas beharren — the preposition is auf + dative. Harder than bestehen auf: you will not move at all." },
      ],
    },
  ],
};
