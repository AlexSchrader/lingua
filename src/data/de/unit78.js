  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u78l1-dermangel", type: "vocab", front: "der Mangel", reading: "dermangel", meaning: "the fault in goods", example: { jp: "Das Gerät hat einen Mangel, es geht nicht.", en: "The device has a fault, it doesn't work." }, drill: { jp: "Der Mangel ist sehr groß", en: "The fault is very big" }, accept: ["fault", "the fault", "defect", "the defect", "the shortcoming", "the lack"], hint: "A fault in goods — and also a lack of something: Mangel an Zeit. Plural: die Mängel." },
        ...
        { id: "de-u78l1-kaputtgehen", type: "vocab", front: "kaputtgehen", reading: "kaputtgehen", meaning: "to break down", example: { jp: "Das Fahrrad kann jeden Tag kaputtgehen.", en: "The bike could break down any day." }, drill: { jp: "Die Uhr kann leicht kaputtgehen", en: "The watch can break easily" }, accept: ["to break down", "break down", "to break", "to stop working", "to give out"], hint: "kaputt + gehen. Separable: die Uhr geht kaputt." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u78l2-diegarantie", type: "vocab", front: "die Garantie", reading: "diegarantie", meaning: "the guarantee", example: { jp: "Die Garantie ist nach zwei Jahren zu Ende.", en: "The guarantee ends after two years." }, drill: { jp: "Die Garantie ist noch gültig", en: "The guarantee is still valid" }, accept: ["guarantee", "the guarantee", "warranty", "the warranty"], hint: "Two years by law in Germany. Said 'ga-ran-TEE', stress on the end." },
      ],
    },
    {
      id: "de-u78l3",
      ...
      items: [
        { id: "de-u78l3-ersetzen", type: "vocab", front: "ersetzen", reading: "ersetzen", meaning: "to replace", example: { jp: "Die Firma will das Gerät ersetzen.", en: "The company wants to replace the device." }, drill: { jp: "Sie müssen das Gerät ersetzen", en: "They have to replace the device" }, accept: ["to replace", "replace", "to substitute", "to make good"], hint: "er + setzen. Also to reimburse: den Schaden ersetzen. Noun: der Ersatz." },
        ...
        { id: "de-u78l3-dieentschadigung", type: "vocab", front: "die Entschädigung", reading: "dieentschadigung", meaning: "the compensation", example: { jp: "Für die späte Bahn gibt es eine Entschädigung.", en: "There is compensation for the late train." }, drill: { jp: "Die Entschädigung kommt im Juni", en: "The compensation comes in June" }, accept: ["compensation", "the compensation", "damages", "the payout"], hint: "der Schaden = the harm; entschädigen = to make the harm good." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u78l4-sicherkundigen", type: "vocab", front: "sich erkundigen", reading: "sicherkundigen", meaning: "to enquire", example: { jp: "Ich möchte mich nach dem Antrag erkundigen.", en: "I would like to enquire about the application." }, drill: { jp: "Man kann sich erkundigen", en: "You can enquire" }, accept: ["to enquire", "enquire", "to inquire", "to ask about", "to make enquiries"], hint: "Reflexive with nach: ich erkundige mich nach dem Preis. Politer than fragen." },
        { id: "de-u78l4-nachfragen", type: "vocab", front: "nachfragen", reading: "nachfragen", meaning: "to ask after something", example: { jp: "Wenn nichts kommt, müssen Sie nachfragen.", en: "If nothing comes, you have to ask after it." }, drill: { jp: "Ich will bei der Firma nachfragen", en: "I want to ask at the company" }, accept: ["to ask after something", "to follow up", "follow up", "to ask again", "to enquire again"], hint: "nach + fragen: to ask after it. Separable: ich frage nach." },
        ...
        { id: "de-u78l4-widerrufen", type: "vocab", front: "widerrufen", reading: "widerrufen", meaning: "to withdraw an order", example: { jp: "Sie können den Antrag in zwei Wochen widerrufen.", en: "You can withdraw the application within two weeks." }, drill: { jp: "Man kann den Antrag widerrufen", en: "You can withdraw the application" }, accept: ["to withdraw an order", "to revoke", "to retract", "to cancel", "to take back"], hint: "wider = against + rufen. NOT separable. das Widerrufsrecht = the right to cancel." },
      ],
    },
  ],
};
