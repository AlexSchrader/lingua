  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u93l2-deraufschlag", type: "vocab", front: "der Aufschlag", reading: "deraufschlag", meaning: "the surcharge", example: { jp: "Der Aufschlag für die schnelle Lieferung ist beträchtlich, trotzdem nehmen ihn die meisten Kunden.", en: "The surcharge for fast delivery is considerable, and yet most customers take it." }, drill: { jp: "Der Aufschlag kostet zehn Prozent", en: "The surcharge costs ten percent" }, accept: ["surcharge", "the surcharge", "markup", "the markup", "extra charge", "serve"], hint: "auf + schlagen: what is struck on top of the price. In tennis it is the serve — same picture, different court." },
      ],
    },
    {
      id: "de-u93l3",
      ...
      items: [
        ...
        { id: "de-u93l3-derpreisdruck", type: "vocab", front: "der Preisdruck", reading: "derpreisdruck", meaning: "the price pressure", example: { jp: "Der Preisdruck kommt aus dem Ausland, und deshalb hilft ein besseres Produkt allein wenig.", en: "The price pressure comes from abroad, which is why a better product alone helps little." }, drill: { jp: "Der Preisdruck steigt in der ganzen Branche", en: "The price pressure is rising across the whole sector" }, accept: ["price pressure", "the price pressure", "pricing pressure", "pressure on prices"], hint: "der Preis + der Druck (pressure). unter Druck stehen = to be under pressure; German business German runs on Druck compounds." },
