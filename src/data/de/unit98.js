  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u98l2-derernstfall", type: "vocab", front: "der Ernstfall", reading: "derernstfall", meaning: "the emergency", example: { jp: "Im Ernstfall zählt nur, wer vorher geübt hat, und nicht wer den besseren Plan geschrieben hat.", en: "In an emergency only those who practised beforehand count, and not those who wrote the better plan." }, drill: { jp: "Der Ernstfall kommt meistens sehr schnell", en: "The emergency usually comes very quickly" }, accept: ["emergency", "the emergency", "serious case", "real emergency", "when it counts"], hint: "ernst (serious) + der Fall: the case where it is no longer a drill. im Ernstfall is the fixed phrase, and the whole German civil-protection vocabulary hangs off it." },
      ],
    },
    {
      id: "de-u98l3",
      ...
      items: [
        ...
        { id: "de-u98l3-riskant", type: "vocab", front: "riskant", reading: "riskant", meaning: "risky", example: { jp: "Der Weg ist riskant, aber jede andere Entscheidung kostet das Doppelte.", en: "The route is risky, but every other decision costs twice as much." }, drill: { jp: "Dieser Weg bleibt sehr riskant", en: "This route remains very risky" }, accept: ["risky", "hazardous", "chancy", "dicey"], hint: "The adjective to das Risiko (u60). German also says gewagt for a bold risk taken on purpose — riskant is the neutral description." },
        { id: "de-u98l3-abschatzen", type: "vocab", front: "abschätzen", reading: "abschatzen", meaning: "to gauge", example: { jp: "Die Folgen lassen sich heute kaum abschätzen, weil die Daten aus nur einem Jahr stammen.", en: "The consequences can hardly be gauged today, because the data come from only one year." }, drill: { jp: "Wir können den Schaden noch nicht abschätzen", en: "We cannot yet gauge the damage" }, accept: ["to gauge", "gauge", "to estimate", "estimate", "to assess", "assess", "to judge"], hint: "Separable: schätzt … ab. From schätzen (to estimate, and to treasure). nicht abzuschätzen = impossible to assess, the phrase German uses after a disaster." },
      ],
    },
    {
      id: "de-u98l4",
      ...
      items: [
        ...
        { id: "de-u98l4-diezuversicht", type: "vocab", front: "die Zuversicht", reading: "diezuversicht", meaning: "the confidence", example: { jp: "Die Zuversicht kam langsam zurück, zuerst in der Branche und erst viel später bei den Kunden.", en: "Confidence came back slowly, first in the sector and only much later among the customers." }, drill: { jp: "Die Zuversicht wächst seit dem Sommer", en: "Confidence has been growing since the summer" }, accept: ["confidence", "the confidence", "optimism", "assurance", "hopefulness"], hint: "Not the same as das Vertrauen (trust in someone) or die Sicherheit (certainty): Zuversicht is quiet confidence that things will turn out. zuversichtlich is the adjective." },
        { id: "de-u98l4-diesicherheit", type: "vocab", front: "die Sicherheit", reading: "diesicherheit", meaning: "the safety", example: { jp: "Sicherheit kostet Geld, und deshalb streiten beide Seiten über jede einzelne Maßnahme.", en: "Safety costs money, and that is why both sides argue about every single measure." }, drill: { jp: "Die Sicherheit geht immer vor", en: "Safety always comes first" }, accept: ["safety", "the safety", "security", "the security", "certainty", "confidence"], hint: "⚠️ Untaught in German before u98 — see the header. Three senses in one word: safety, security, and certainty (mit Sicherheit = certainly). Its opposite, die Unsicherheit, is in l1." },
      ],
    },
  ],
};
