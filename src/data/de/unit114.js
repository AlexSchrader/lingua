  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u114l1-kriegen", type: "vocab", front: "kriegen", reading: "kriegen", meaning: "to get (casually)", example: { jp: "Wenn du jetzt nicht gehst, dann kriegst du den Zug nicht mehr.", en: "If you don't go now, you won't get the train any more." }, drill: { jp: "Ich will auch ein Stück kriegen", en: "I want to get a piece too" }, accept: ["to get", "get", "to get hold of", "to land", "to catch"], hint: "Spoken German only — extremely common in speech, and out of place in anything written. Unrelated to der Krieg (war, u95) despite the spelling." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u114l2-beschuetzen", type: "vocab", front: "beschützen", reading: "beschuetzen", meaning: "to protect (a person)", example: { jp: "Der Baum soll die Blumen beschützen, bis sie stark genug sind.", en: "The tree is meant to protect the flowers until they are strong enough." }, drill: { jp: "Eltern wollen ihre Kinder beschützen", en: "Parents want to protect their children" }, accept: ["to protect", "protect", "to shield", "shield", "to guard", "to defend"], hint: "Standing between someone and a danger. Distinguish schützen vor (to protect against a thing) — beschützen takes a person as its object and needs no preposition." },
      ],
    },
    {
      id: "de-u114l3",
      ...
      items: [
        ...
        { id: "de-u114l3-starten", type: "vocab", front: "starten", reading: "starten", meaning: "to launch", example: { jp: "Die Firma startet im Sommer ein neues Angebot, obwohl das alte gut lief.", en: "The company is launching a new offer in summer, although the old one was doing well." }, drill: { jp: "Wir starten den Versuch im Mai", en: "We are launching the trial in May" }, accept: ["to launch", "launch", "to start", "start", "to set off", "to take off"], hint: "Used for machines, programmes, campaigns and aircraft rather than for meetings or lessons — for those, beginnen. A plane starts (takes off) and lands." },
        { id: "de-u114l3-oeffnen", type: "vocab", front: "öffnen", reading: "oeffnen", meaning: "to open", example: { jp: "Bitte öffnen Sie das Fenster nicht, solange der Wind so stark ist.", en: "Please don't open the window while the wind is so strong." }, drill: { jp: "Können Sie bitte die Tür öffnen", en: "Could you please open the door" }, accept: ["to open", "open", "to unlock", "to open up"], hint: "The written and formal word; speech often prefers aufmachen. offen (the adjective, taught in u121) belongs to it, and die Öffnung is the opening itself." },
        { id: "de-u114l3-aufhoeren", type: "vocab", front: "aufhören", reading: "aufhoeren", meaning: "to stop (doing)", example: { jp: "Der Lärm muss endlich aufhören, sonst kann hier niemand mehr arbeiten.", en: "The noise must finally stop, otherwise nobody can work here any more." }, drill: { jp: "Du sollst mit dem Lärm aufhören", en: "You should stop with the noise" }, accept: ["to stop", "stop", "to cease", "cease", "to quit", "to end"], hint: "Separable, and it takes mit for what you stop doing: mit dem Rauchen aufhören. Nothing to do with listening, despite sharing a stem with hören (u1) and zuhören (u86)." },
      ],
    },
    {
      id: "de-u114l4",
      ...
      items: [
        ...
        { id: "de-u114l4-luegen", type: "vocab", front: "lügen", reading: "luegen", meaning: "to lie (tell untruths)", example: { jp: "Wer einmal lügt, dem glaubt man auch dann nicht mehr, wenn er die Wahrheit sagt.", en: "Once someone lies, people no longer believe them even when they are telling the truth." }, drill: { jp: "Kinder lügen manchmal aus Angst", en: "Children sometimes lie out of fear" }, accept: ["to lie", "lie", "to tell lies", "to tell a lie", "to fib"], hint: "Never confuse with liegen (to lie down, u44) — lügen/log/gelogen against liegen/lag/gelegen. die Lüge is the lie itself." },
