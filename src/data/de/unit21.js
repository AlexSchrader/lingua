...
//
// `vom` (u21l3, 7th card) — ADDED IN THE NATURALNESS PASS, 2026-09-13, and it is a
// function word in a housework lesson on purpose. German contracts von+dem
// obligatorily in this position; uncontracted "von dem Haus" means "of THAT house".
// Thirteen sentences across u22-u47 were written with "von dem" only because the word
// was untaught (see u32's header for the earlier ruling), and every one of them read
// as a learner error. One card at the head of A2 licenses all thirteen. It is carded
// at u21 rather than later because u22l2 is the first use, and `vom` appears nowhere
// in A1, so it creates no forward reference. Same slotting precedent as man (u45l4),
// wichtig (u45l1), fast (u47l2), selbst (u48l1), hart (u49l2) and ganz (u49l3).
// ============================================================================
  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u21l1-frueh", type: "vocab", front: "früh", reading: "fruh", meaning: "early", example: { jp: "Am Montag kommen wir sehr früh.", en: "On Monday we come very early." }, drill: { jp: "Der Bus kommt heute sehr früh", en: "The bus comes very early today" }, accept: ["early"], hint: "The opposite of the already-taught spät. Früher means both earlier and, on its own, \"in the old days\"." },
        { id: "de-u21l1-puenktlich", type: "vocab", front: "pünktlich", reading: "punktlich", meaning: "on time", example: { jp: "Der Zug ist heute pünktlich.", en: "The train is on time today." }, drill: { jp: "Die Kinder sind immer pünktlich", en: "The children are always on time" }, accept: ["on time", "punctual", "punctually"], hint: "From der Punkt. A word Germans use about trains with some feeling; pünktlich um acht means at eight exactly." },
      ],
    },
    {
      id: "de-u21l2",
      ...
      items: [
        ...
        { id: "de-u21l2-zuerst", type: "vocab", front: "zuerst", reading: "zuerst", meaning: "first of all", example: { jp: "Zuerst dusche ich, dann esse ich.", en: "First I shower, then I eat." }, drill: { jp: "Zuerst trinke ich einen Kaffee", en: "First of all I drink a coffee" }, accept: ["first", "first of all", "at first"], hint: "Put it first and the verb still comes second — zuerst DUSCHE ich. The A1 rule from u12 does not bend." },
        ...
        { id: "de-u21l2-spaeter", type: "vocab", front: "später", reading: "spater", meaning: "later", example: { jp: "Wir sprechen später über das Problem.", en: "We will talk about the problem later." }, drill: { jp: "Die Kinder kommen später nach Hause", en: "The children come home later" }, accept: ["later", "afterwards"], hint: "The comparative of spät, and you have met it since u2 inside bis später." },
        ...
        { id: "de-u21l2-fertig", type: "vocab", front: "fertig", reading: "fertig", meaning: "finished / ready", example: { jp: "Ich bin fertig.", en: "I am finished." }, drill: { jp: "Das Frühstück ist jetzt fertig", en: "Breakfast is ready now" }, accept: ["finished", "ready", "done"], hint: "One word for both \"done with it\" and \"ready to go\" — Ich bin fertig covers each. fertig machen is to get ready, or to finish something off." },
        { id: "de-u21l2-erst", type: "vocab", front: "erst", reading: "erst", meaning: "not until", example: { jp: "Er kommt erst morgen.", en: "He is not coming until tomorrow." }, drill: { jp: "Wir essen erst später", en: "We are not eating until later" }, accept: ["not until", "only", "first", "only then"], hint: "With a time, erst means \"not before\": Erst um acht. Compare nur (u3), which limits amount rather than time, and zuerst (this lesson), which means first of all." },
      ],
    },
    {
      id: "de-u21l3",
      ...
      items: [
        ...
        { id: "de-u21l3-putzen", type: "vocab", front: "putzen", reading: "putzen", meaning: "to scrub", example: { jp: "Am Samstag putzen wir das Bad.", en: "On Saturday we clean the bathroom." }, drill: { jp: "Die Kinder putzen das Fenster", en: "The children clean the window" }, accept: ["to clean", "clean", "to scrub", "scrub"], hint: "For scrubbing something physically. Also what you do to your teeth: Zähne putzen." },
        ...
        { id: "de-u21l3-diewaesche", type: "vocab", front: "die Wäsche", reading: "diewasche", meaning: "the laundry", example: { jp: "Am Samstag mache ich die Wäsche.", en: "On Saturday I do the laundry." }, drill: { jp: "Meine Mutter macht heute die Wäsche", en: "My mother does the laundry today" }, accept: ["the laundry", "laundry", "the washing"], hint: "Wäsche waschen is to do the laundry — the noun and the verb share a stem, which is why the phrase sounds doubled to an English ear." },
        { id: "de-u21l3-dermuell", type: "vocab", front: "der Müll", reading: "dermull", meaning: "the rubbish", example: { jp: "Wir haben heute viel Müll.", en: "We have a lot of rubbish today." }, drill: { jp: "Der Müll kommt am Montag", en: "The rubbish goes out on Monday" }, accept: ["the rubbish", "rubbish", "the trash", "the garbage"], hint: "Singular only, like das Geschirr. Germans separate it obsessively, so you will meet Restmüll, Biomüll and Papiermüll on every bin." },
        { id: "de-u21l3-vom", type: "vocab", front: "vom", reading: "vom", meaning: "from the", example: { jp: "Ich nehme das Geschirr vom Tisch.", en: "I take the dishes off the table." }, drill: { jp: "Wir nehmen die Wäsche vom Stuhl", en: "We take the laundry off the chair" }, accept: ["from the", "of the", "off the", "from"], hint: "vom = von + dem. German fuses the two and the long form von dem is only for pointing at THAT one. Same family as im (in dem), am (an dem) and zum (zu dem)." },
        { id: "de-u21l3-zur", type: "vocab", front: "zur", reading: "zur", meaning: "to the", example: { jp: "Die Kinder gehen zur Schule.", en: "The children go to the school." }, drill: { jp: "Wir fahren zur Stadt", en: "We drive to the town" }, accept: ["to the", "to"], hint: "zur = zu + der, the FEMININE partner of zum (zu + dem). die Schule is feminine, so zu der Schule fuses to zur Schule. Like vom above it, the long form is only for pointing at THAT one." },
      ],
    },
    {
      id: "de-u21l4",
      ...
      items: [
        ...
        { id: "de-u21l4-zweimal", type: "vocab", front: "zweimal", reading: "zweimal", meaning: "twice", example: { jp: "Ich gehe zweimal in der Woche schwimmen.", en: "I go swimming twice a week." }, drill: { jp: "Wir essen zweimal am Tag", en: "We eat twice a day" }, accept: ["twice", "two times"], hint: "Any number plus -mal makes a frequency: einmal, zweimal, dreimal, hundertmal." },
        { id: "de-u21l4-meistens", type: "vocab", front: "meistens", reading: "meistens", meaning: "usually", example: { jp: "Meistens esse ich zu Hause.", en: "Usually I eat at home." }, drill: { jp: "Der Bus kommt meistens zu spät", en: "The bus is usually late" }, accept: ["usually", "mostly", "most of the time"], hint: "Stronger than the already-taught oft: meistens means it is the normal case, not merely frequent." },
        ...
        { id: "de-u21l4-normalerweise", type: "vocab", front: "normalerweise", reading: "normalerweise", meaning: "normally", example: { jp: "Normalerweise arbeite ich bis fünf.", en: "Normally I work until five." }, drill: { jp: "Normalerweise kommt der Zug pünktlich", en: "Normally the train is on time" }, accept: ["normally", "usually", "as a rule"], hint: "The -weise ending turns an adjective into an adverb of manner, and German builds many of them this way: glücklicherweise, teilweise." },
        { id: "de-u21l4-derfeierabend", type: "vocab", front: "der Feierabend", reading: "derfeierabend", meaning: "the end of the working day", example: { jp: "Nach Feierabend gehen wir nach Hause.", en: "After work we go home." }, drill: { jp: "Der Feierabend ist um fünf", en: "The end of the working day is at five" }, accept: ["the end of the working day", "knocking-off time", "after work"], hint: "No English word does this job. Feierabend machen means to stop work for the day, and Schönen Feierabend! is what colleagues say as they leave." },
        { id: "de-u21l4-einmal", type: "vocab", front: "einmal", reading: "einmal", meaning: "once", example: { jp: "Ich fahre einmal im Jahr nach Berlin.", en: "I go to Berlin once a year." }, drill: { jp: "Wir essen einmal am Tag", en: "We eat once a day" }, accept: ["once", "one time", "once upon a time"], hint: "Counts like zweimal (this lesson): einmal, zweimal, dreimal. Es war einmal opens every German fairy tale. ⚠️ The particle that softens a command is the shorter mal — Sag mal! — not einmal, and it is the next card." },
        { id: "de-u21l4-mal", type: "vocab", front: "mal", reading: "mal", meaning: "just — softening a request", example: { jp: "Warte mal hier.", en: "Wait here a moment." }, drill: { jp: "Hör mal gut zu", en: "Listen carefully for a moment" }, accept: ["just", "for a moment", "a sec", "times"], hint: "Unstressed, never first in the clause, and it takes the edge off an order: Warte! is \"Wait!\", Warte mal is \"hang on a sec\". It is the same -mal that ends einmal and zweimal in this lesson, and manchmal (u12)." },
      ],
    },
  ],
};
