  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u21l4-einmal", type: "vocab", front: "einmal", reading: "einmal", meaning: "once", example: { jp: "Ich fahre einmal im Jahr.", en: "I travel once a year." }, drill: { jp: "Wir essen einmal am Tag", en: "We eat once a day" }, accept: ["once", "one time", "once upon a time"], hint: "Counts like zweimal (this lesson): einmal, zweimal, dreimal. As a softener it turns a command into a request — Sag mal! — and Es war einmal opens every fairy tale." },
      ],
    },
  ],
};
