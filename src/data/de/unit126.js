...
//
// ⚠️ LAST UNIT OF THE BAND. With this merged, de has no locked stubs left:
// u1-u126 are all authored. The "Add a language" row on the Ladder reads its
...
// FREE: gemacht, gesehen, gegeben, genommen, gilt, gewusst, gelohnt, geglaubt, geschrieben, gelernt, geworden
export const DE_UNIT126 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      unit: 126,
      lesson: 2,
      title: "Spucken, pusten, stöhnen",
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Say what a mouth does besides speaking — spit, blow, groan, and say what disgusts you.",
      items: [
        { id: "de-u126l2-spucken", type: "vocab", front: "spucken", reading: "spucken", meaning: "to spit", example: { jp: "Auf der Straße spucken gilt hier als sehr unhöflich.", en: "Spitting in the street is considered very rude here." }, drill: { jp: "Man soll nicht auf den Boden spucken", en: "One should not spit on the ground" }, accept: ["to spit", "spit", "to expectorate"], hint: "Tier D, extending u85. Also of machines and volcanoes throwing something out — Feuer spucken, to spit fire." },
        ...
        { id: "de-u126l2-stoehnen2", type: "vocab", front: "seufzen und stöhnen", reading: "seufzenundstoehnen", meaning: "sighing and groaning", example: { jp: "Das Seufzen und Stöhnen im Raum war deutlich zu hören.", en: "The sighing and groaning in the room was clearly audible." }, drill: { jp: "Wir hören nur seufzen und stöhnen", en: "We hear only sighing and groaning" }, accept: ["sighing and groaning", "sighs and groans", "moaning"], hint: "Tier D. A set phrase rather than two separate cards — seufzen alone is already taught (u85) and stöhnen in u124 of this block, so this teaches the pairing German uses as one idea." },
        { id: "de-u126l2-derekel2", type: "vocab", front: "ekelhaft", reading: "ekelhaft", meaning: "disgusting", example: { jp: "Das Essen war ekelhaft, und trotzdem hat das Kind den ganzen Teller leer gegessen.", en: "The food was disgusting, and yet the child ate the whole plate empty." }, drill: { jp: "Das Wasser schmeckt einfach ekelhaft", en: "The water simply tastes disgusting" }, accept: ["disgusting", "revolting", "repulsive", "vile", "nasty"], hint: "Tier D. The adjective to der Ekel, taught in u125 of this block. ⚠️ A learner meets this far more often than the noun, so both earn a card." },
