  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u103l1-diedurchlassigkeit", type: "vocab", front: "die Durchlässigkeit", reading: "diedurchlassigkeit", meaning: "permeability (being able to move between school tracks)", example: { jp: "Ohne Durchlässigkeit entscheidet die Grundschule über das ganze Leben.", en: "Without permeability, primary school decides a whole life." }, drill: { jp: "Die Durchlässigkeit ist bei uns gering", en: "Permeability here with us is low" }, accept: ["permeability", "mobility between tracks", "flexibility", "openness"], hint: "durch + lassen: how easily the system lets you through from one Schulform to another. The word every German education debate turns on." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u103l3-derlehrstuhl", type: "vocab", front: "der Lehrstuhl", reading: "derlehrstuhl", meaning: "professorial chair (a professor's post)", example: { jp: "Der Lehrstuhl ist seit zwei Jahren frei, weil sich niemand bewirbt.", en: "The chair has been vacant for two years because nobody applies." }, drill: { jp: "Der Lehrstuhl bleibt noch immer leer", en: "The chair is still empty" }, accept: ["chair", "professorship", "professorial chair"], hint: "Literally the teaching chair — the post, its money and its staff, not the furniture." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u103l4-dienachhilfe", type: "vocab", front: "die Nachhilfe", reading: "dienachhilfe", meaning: "private tutoring (extra paid help)", example: { jp: "Fast jedes zweite Kind in der Klasse bekommt Nachhilfe in Mathe.", en: "Almost every second child in the class gets private tutoring in maths." }, drill: { jp: "Die Nachhilfe kostet dreißig Euro", en: "The tutoring costs thirty euros" }, accept: ["private tutoring", "tutoring", "extra lessons", "coaching"], hint: "nach + Hilfe: help afterwards, outside school. A whole industry, and one of the clearest places money turns into grades." },
        ...
        { id: "de-u103l4-begabt", type: "vocab", front: "begabt", reading: "begabt", meaning: "gifted (naturally talented)", example: { jp: "Ein begabtes Kind fällt in einer großen Klasse oft gar nicht auf.", en: "A gifted child often does not stand out at all in a large class." }, drill: { jp: "Das Kind ist sehr begabt", en: "The child is very gifted" }, accept: ["gifted", "talented", "able"], hint: "From die Gabe, the gift — the same image as English. Begabt für Sprachen, begabt in Mathe." },
        { id: "de-u103l4-dasfernstudium", type: "vocab", front: "das Fernstudium", reading: "dasfernstudium", meaning: "distance learning degree", example: { jp: "Ein Fernstudium dauert länger, aber man kann nebenbei arbeiten.", en: "A distance learning degree takes longer, but you can work alongside it." }, drill: { jp: "Das Fernstudium dauert meistens länger", en: "A distance learning degree usually takes longer" }, accept: ["distance learning", "distance degree", "correspondence course", "remote study"], hint: "fern (far) + Studium. The classic German second-chance route, and the reason die Hochschule accepts people without an Abitur." },
      ],
    },
  ],
};
