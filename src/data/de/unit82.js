  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u82l4-diewerkstatt", type: "vocab", front: "die Werkstatt", reading: "diewerkstatt", meaning: "the garage", example: { jp: "Der Wagen steht seit gestern in der Werkstatt und ist morgen fertig.", en: "The car has been at the garage since yesterday and is ready tomorrow." }, drill: { jp: "Die Werkstatt ruft uns morgen an", en: "The garage will call us tomorrow" }, accept: ["garage", "the garage", "workshop", "the workshop", "repair shop"], hint: "das Werk + die Statt (place). Plural Werkstätten. Where the car goes after abschleppen in this lesson — die Garage is only where you park it." },
      ],
    },
  ],
};
