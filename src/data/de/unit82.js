...
//   die Werkstatt (u46) · das Lenkrad (lexeme of lenken, carded here).
...
export const DE_UNIT82 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u82l4-diepanne", type: "vocab", front: "die Panne", reading: "diepanne", meaning: "the breakdown", example: { jp: "Das Auto hat eine Panne.", en: "The car has broken down." }, drill: { jp: "Die Panne war nicht groß", en: "The breakdown was not big" }, accept: ["breakdown", "the breakdown", "the mechanical failure", "the mishap"], hint: "Said 'PA-neh'. Also a slip-up in general: eine Panne im Büro." },
        { id: "de-u82l4-abschleppen", type: "vocab", front: "abschleppen", reading: "abschleppen", meaning: "to tow away", example: { jp: "Nach der Panne muss man das Auto abschleppen.", en: "After the breakdown the car has to be towed away." }, drill: { jp: "Sie können das Auto abschleppen", en: "They can tow the car away" }, accept: ["to tow away", "tow away", "to tow", "tow"], hint: "Separable: sie schleppen es ab. Park badly and you get abgeschleppt." },
        ...
        { id: "de-u82l4-dasbussgeld", type: "vocab", front: "das Bußgeld", reading: "dasbussgeld", meaning: "the fine", example: { jp: "Für die Geschwindigkeit gibt es ein Bußgeld.", en: "There is a fine for the speed." }, drill: { jp: "Das Bußgeld ist sehr hoch", en: "The fine is very high" }, accept: ["fine", "the fine", "the penalty", "the penalty payment"], hint: "die Buße = the penance + das Geld. Written with ß." },
      ],
    },
  ],
};
