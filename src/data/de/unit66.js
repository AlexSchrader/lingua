  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u66l1-dienachfrage", type: "vocab", front: "die Nachfrage", reading: "dienachfrage", meaning: "the demand", example: { jp: "Die Nachfrage nach kleinen Wohnungen ist in der Stadt sehr groß.", en: "Demand for small flats in the city is very high." }, drill: { jp: "Die Nachfrage nach Wohnungen ist hoch", en: "Demand for flats is high" }, accept: ["demand", "the demand"], hint: "nach + fragen: asking after something. Its pair is das Angebot (u27), supply." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u66l3-borgen", type: "vocab", front: "borgen", reading: "borgen", meaning: "to lend", example: { jp: "Kannst du mir bis Montag zwanzig Euro borgen?", en: "Can you lend me twenty euros until Monday?" }, drill: { jp: "Wir borgen dem Freund Geld", en: "We lend our friend money" }, accept: ["to lend", "to borrow", "to loan"], hint: "Works both ways like leihen (u27): jemandem etwas borgen, or sich etwas borgen." },
        ...
        { id: "de-u66l3-diegebuhr", type: "vocab", front: "die Gebühr", reading: "diegebuhr", meaning: "the fee", example: { jp: "Für das Konto bei der Bank zahlen wir keine Gebühr.", en: "We pay no fee for the account at the bank." }, drill: { jp: "Die Gebühr für das Konto ist hoch", en: "The fee for the account is high" }, accept: ["fee", "the fee", "the charge"], hint: "A charge set by an office or a bank, never the price of a thing." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u66l4-deranteil", type: "vocab", front: "der Anteil", reading: "deranteil", meaning: "the share", example: { jp: "Der Anteil vom Lohn für die Miete ist zu groß.", en: "The share of the wage going on rent is too big." }, drill: { jp: "Der Anteil ist sehr klein", en: "The share is very small" }, accept: ["share", "the share", "the portion", "the proportion"], hint: "an + Teil, a part of. Anteil nehmen = to show sympathy." },
