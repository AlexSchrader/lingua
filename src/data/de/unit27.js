...
export const DE_UNIT27 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u27l3-dasangebot", type: "vocab", front: "das Angebot", reading: "dasangebot", meaning: "the offer", example: { jp: "Das Angebot im Supermarkt ist gut.", en: "The offer at the supermarket is good." }, drill: { jp: "Das Angebot in der Bäckerei ist gut", en: "The offer at the bakery is good" }, accept: ["the offer", "offer", "the special offer", "the deal"], hint: "From anbieten, to offer. Im Angebot means on special this week — the phrase on every German shelf label." },
        { id: "de-u27l3-derrabatt", type: "vocab", front: "der Rabatt", reading: "derrabatt", meaning: "the discount", example: { jp: "Der Rabatt für Studenten ist groß.", en: "The student discount is large." }, drill: { jp: "Der Rabatt ist sehr klein", en: "The discount is very small" }, accept: ["the discount", "discount", "the reduction"], hint: "Stress the second syllable, ra-BATT. It is the amount taken off; das Angebot is the deal as a whole." },
        { id: "de-u27l3-gunstig", type: "vocab", front: "günstig", reading: "gunstig", meaning: "good value", example: { jp: "Das Hemd ist heute sehr günstig.", en: "The shirt is very good value today." }, drill: { jp: "Die Jacke ist im Angebot günstig", en: "The jacket is good value in the sale" }, accept: ["good value", "reasonable", "reasonably priced", "favourable", "cheap"], hint: "Not the same as u10's billig, and the difference matters to Germans: billig hints at poor quality, günstig says you got a fair price for a good thing." },
        { id: "de-u27l3-reduziert", type: "vocab", front: "reduziert", reading: "reduziert", meaning: "reduced", example: { jp: "Die Jacke ist im Angebot reduziert.", en: "The jacket is reduced in the sale." }, drill: { jp: "Die Schuhe sind heute reduziert", en: "The shoes are reduced today" }, accept: ["reduced", "marked down", "on sale", "discounted"], hint: "A past participle used as an adjective, like u22's enttäuscht. The -ieren verbs are almost all borrowings, and they never take ge- in the participle." },
        { id: "de-u27l3-diewerbung", type: "vocab", front: "die Werbung", reading: "diewerbung", meaning: "the advert", example: { jp: "Die Werbung im Radio ist laut.", en: "The advert on the radio is loud." }, drill: { jp: "Die Werbung kostet viel Geld", en: "The advertising costs a lot of money" }, accept: ["the advert", "advert", "the advertising", "advertising", "the commercial"], hint: "Covers both a single advert and advertising as a whole. From werben, to court someone — advertising as wooing, which is a fair description." },
