  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u46l1-diesage", type: "vocab", front: "die Säge", reading: "diesage", meaning: "the saw", example: { jp: "Mit der Säge schneidet man den Baum.", en: "You cut the tree down with the saw." }, drill: { jp: "Die Säge ist scharf", en: "The saw is sharp" }, accept: ["saw", "the saw"], hint: "The tool. (The verb 'to saw' is not taught here — it would clash with sagen, to say.)" },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u46l2-diefeile", type: "vocab", front: "die Feile", reading: "diefeile", meaning: "the file", example: { jp: "Mit der Feile macht man den Nagel kurz.", en: "You make the nail short with the file." }, drill: { jp: "Die Feile ist klein", en: "The file is small" }, accept: ["file", "the file"], hint: "The tool that smooths. A nail file is die Nagelfeile." },
      ],
    },
    {
      id: "de-u46l3",
