...
// "die Säge" (→ diesage) is kept. der Meißel carries a HAND-WRITTEN reading
  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u46l1-derhammer", type: "vocab", front: "der Hammer", reading: "derhammer", meaning: "the hammer", example: { jp: "Gib mir bitte den Hammer.", en: "Give me the hammer, please." }, drill: { jp: "Der Hammer ist schwer", en: "The hammer is heavy" }, accept: ["hammer", "the hammer"], hint: "Also slang: das ist der Hammer! = that's amazing (or terrible)." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u46l2-dieschraube", type: "vocab", front: "die Schraube", reading: "dieschraube", meaning: "the screw", example: { jp: "Diese Schraube ist zu klein.", en: "This screw is too small." }, drill: { jp: "Die Schraube ist lang", en: "The screw is long" }, accept: ["screw", "the screw", "the bolt"], hint: "The verb schrauben and der Schraubenzieher are built on it." },
        ...
        { id: "de-u46l2-dasklebeband", type: "vocab", front: "das Klebeband", reading: "dasklebeband", meaning: "the tape", example: { jp: "Ich mache das Paket mit Klebeband zu.", en: "I close the parcel with tape." }, drill: { jp: "Das Klebeband ist weg", en: "The tape is gone" }, accept: ["tape", "the tape", "the sticky tape", "adhesive tape"], hint: "kleben (to stick) + das Band (band, tape)." },
        { id: "de-u46l2-derhaken", type: "vocab", front: "der Haken", reading: "derhaken", meaning: "the hook", example: { jp: "An dem Haken hängt die Jacke.", en: "The jacket hangs on the hook." }, drill: { jp: "Der Haken ist an der Wand", en: "The hook is on the wall" }, accept: ["hook", "the hook", "the catch"], hint: "Also a snag or catch: die Sache hat einen Haken, there's a catch." },
        { id: "de-u46l2-diefeile", type: "vocab", front: "die Feile", reading: "diefeile", meaning: "the file", example: { jp: "Mit der Feile macht man das Metall glatt.", en: "You make the metal smooth with the file." }, drill: { jp: "Die Feile ist klein", en: "The file is small" }, accept: ["file", "the file"], hint: "The tool that smooths. A nail file is die Nagelfeile." },
      ],
    },
    {
      id: "de-u46l3",
      ...
      items: [
        ...
        { id: "de-u46l3-hammern", type: "vocab", front: "hämmern", reading: "hammern", meaning: "to hammer", example: { jp: "Der Mann hämmert schon eine Stunde.", en: "The man has been hammering for an hour." }, drill: { jp: "Wir hämmern den Nagel", en: "We hammer the nail" }, accept: ["to hammer", "to pound"], hint: "From der Hammer. Also of the heart: mein Herz hämmert." },
        { id: "de-u46l3-schleifen", type: "vocab", front: "schleifen", reading: "schleifen", meaning: "to sand", example: { jp: "Man muss das Holz noch schleifen.", en: "The wood still has to be sanded." }, drill: { jp: "Wir schleifen das Brett", en: "We sand the board" }, accept: ["to sand", "to grind", "to sharpen"], hint: "To smooth or sharpen by rubbing — wood, or a knife." },
        { id: "de-u46l3-kleben", type: "vocab", front: "kleben", reading: "kleben", meaning: "to glue", example: { jp: "Ich klebe das Papier an die Wand.", en: "I stick the paper on the wall." }, drill: { jp: "Wir kleben das Bild an die Wand", en: "We stick the picture on the wall" }, accept: ["to glue", "to stick", "to paste"], hint: "das Klebeband (tape) is built on it. Also intransitive: to be sticky." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u46l4-dieklinge", type: "vocab", front: "die Klinge", reading: "dieklinge", meaning: "the blade", example: { jp: "Die Klinge von dem Messer ist scharf.", en: "The knife's blade is sharp." }, drill: { jp: "Die Klinge ist sehr scharf", en: "The blade is very sharp" }, accept: ["blade", "the blade"], hint: "The sharp part of a knife or a tool." },
        { id: "de-u46l4-dermeissel", type: "vocab", front: "der Meißel", reading: "dermeissel", meaning: "the chisel", example: { jp: "Mit dem Meißel arbeitet man in Stein.", en: "You work in stone with the chisel." }, drill: { jp: "Der Meißel ist alt", en: "The chisel is old" }, accept: ["chisel", "the chisel"], hint: "For stone or wood. Note the ß — the reading is spelled dermeissel." },
        { id: "de-u46l4-dieanleitung", type: "vocab", front: "die Anleitung", reading: "dieanleitung", meaning: "the instructions", example: { jp: "Ohne Anleitung kann ich das nicht bauen.", en: "Without the instructions I can't build it." }, drill: { jp: "Ich lese die Anleitung", en: "I read the instructions" }, accept: ["instructions", "the instructions", "the manual", "the guide"], hint: "From anleiten, to guide. The step-by-step manual." },
      ],
    },
  ],
};
