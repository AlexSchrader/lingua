  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u87l1-derteil", type: "vocab", front: "der Teil", reading: "derteil", meaning: "the part", example: { jp: "Der größte Teil des Geldes ist schon ausgegeben.", en: "The largest part of the money has already been spent." }, drill: { jp: "Der Teil ist deutlich zu klein", en: "The part is clearly too small" }, accept: ["part", "the part", "portion", "the portion", "section", "share"], hint: "zum Teil = partly; der größte Teil = most of. der Anteil (u53) and das Gegenteil (u58) are both built on it. das Teil, neuter, is a component — a different word." },
      ],
    },
    {
      id: "de-u87l2",
      ...
      items: [
        ...
        { id: "de-u87l2-diegesamtzahl", type: "vocab", front: "die Gesamtzahl", reading: "diegesamtzahl", meaning: "the total number", example: { jp: "Die Gesamtzahl der Anmeldungen liegt deutlich über dem Durchschnitt.", en: "The total number of registrations lies clearly above the average." }, drill: { jp: "Die Gesamtzahl liegt über dem Durchschnitt", en: "The total number lies above the average" }, accept: ["total number", "the total number", "total", "the total", "overall number"], hint: "gesamt + die Zahl. A count of things; die Summe in this lesson is what the figures add up to. insgesamt is the adverb." },
      ],
    },
    {
      id: "de-u87l3",
      ...
      items: [
        ...
        { id: "de-u87l3-schatzungsweise", type: "vocab", front: "schätzungsweise", reading: "schatzungsweise", meaning: "at a rough guess", example: { jp: "Auf dem Platz waren schätzungsweise tausend Leute.", en: "There were roughly a thousand people in the square." }, drill: { jp: "Dort waren schätzungsweise tausend Leute", en: "There were roughly a thousand people there" }, accept: ["at a rough guess", "roughly", "approximately", "an estimated", "about"], hint: "die Schätzung + -weise, so it flags the number as YOUR estimate, not a measurement. ungefähr in this lesson just says the figure is not exact." },
      ],
    },
    {
      id: "de-u87l4",
      ...
      items: [
        ...
        { id: "de-u87l4-dietabelle", type: "vocab", front: "die Tabelle", reading: "dietabelle", meaning: "the table of figures", example: { jp: "In der Tabelle unten stehen die Zahlen für die letzten fünf Jahre.", en: "In the table below are the figures for the last five years." }, drill: { jp: "Die Tabelle zeigt alle Zahlen genau", en: "The table shows all the figures exactly" }, accept: ["table", "the table", "chart", "the chart", "spreadsheet", "league table"], hint: "Rows and columns, never der Tisch — that is furniture. Also the league table in sport: oben in der Tabelle stehen." },
      ],
    },
  ],
};
