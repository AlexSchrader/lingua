  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u36l1-beziehungsweise", type: "vocab", front: "beziehungsweise", reading: "beziehungsweise", meaning: "or rather — naming a more exact option", example: { jp: "Wir kommen am Montag beziehungsweise am Dienstag.", en: "We are coming on Monday, or rather on Tuesday." }, drill: { jp: "Wir kommen am Montag beziehungsweise am Dienstag", en: "We come on Monday or rather on Tuesday" }, accept: ["or rather", "respectively", "or", "that is"], hint: "Almost always written bzw. Longer than any word needs to be, which is the joke Germans make about it themselves." },
