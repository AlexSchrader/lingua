  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u36l1-weder", type: "vocab", front: "weder", reading: "weder", meaning: "neither", example: { jp: "Er hat weder Zeit noch Geld.", en: "He has neither time nor money." }, drill: { jp: "Er hat weder Zeit noch Geld", en: "He has neither time nor money" }, accept: ["neither"], hint: "Paired with noch (u12): weder … noch. Note that German uses no extra nicht — weder already carries the negative." },
        { id: "de-u36l1-sowohl", type: "vocab", front: "sowohl", reading: "sowohl", meaning: "both — in the pair sowohl … als auch", example: { jp: "Sowohl der Vater als auch die Mutter arbeitet hier.", en: "Both the father and the mother work here." }, drill: { jp: "Sowohl der Vater als auch die Mutter arbeitet", en: "Both the father and the mother work" }, accept: ["both", "both and", "as well as"], hint: "The fixed frame is sowohl … als auch, using u29's als and u3's auch. It is the positive mirror of weder … noch." },
        { id: "de-u36l1-zwar", type: "vocab", front: "zwar", reading: "zwar", meaning: "admittedly — setting up a following aber", example: { jp: "Das Buch ist zwar alt, aber sehr gut.", en: "The book is admittedly old, but very good." }, drill: { jp: "Das Buch ist zwar alt aber gut", en: "The book is admittedly old but good" }, accept: ["admittedly", "it is true that", "indeed"], hint: "It announces a concession before you make it: zwar …, aber … . A German hears zwar and waits for the aber." },
        { id: "de-u36l1-beziehungsweise", type: "vocab", front: "beziehungsweise", reading: "beziehungsweise", meaning: "or rather — naming a second, more exact option", example: { jp: "Wir kommen am Montag beziehungsweise am Dienstag.", en: "We are coming on Monday, or rather on Tuesday." }, drill: { jp: "Wir kommen am Montag beziehungsweise am Dienstag", en: "We come on Monday or rather on Tuesday" }, accept: ["or rather", "respectively", "or", "that is"], hint: "Almost always written bzw. Longer than any word needs to be, which is the joke Germans make about it themselves." },
        { id: "de-u36l1-sowie", type: "vocab", front: "sowie", reading: "sowie", meaning: "as well as — listing items, not joining clauses", example: { jp: "Wir kaufen Brot sowie Käse und Milch.", en: "We are buying bread as well as cheese and milk." }, drill: { jp: "Wir kaufen Brot sowie Käse und Milch", en: "We buy bread as well as cheese and milk" }, accept: ["as well as", "and also", "plus"], hint: "It joins nouns in a list, where und (u1) joins anything at all. A shopping list or a contract uses sowie; speech uses und." },
      ],
    },
    {
      id: "de-u36l2",
      ...
      items: [
        { id: "de-u36l2-ausserdem", type: "vocab", front: "außerdem", reading: "ausserdem", meaning: "besides — adding a further reason", example: { jp: "Es ist spät, außerdem bin ich müde.", en: "It is late, and besides I am tired." }, drill: { jp: "Es ist spät außerdem bin ich müde", en: "It is late and besides I am tired" }, accept: ["besides", "in addition", "moreover", "what is more"], hint: "Adds a NEW argument, where auch (u3) only adds another instance of the same one. It pushes the verb to second place after it." },
        { id: "de-u36l2-jedoch", type: "vocab", front: "jedoch", reading: "jedoch", meaning: "however — the written-register turn", example: { jp: "Das Zimmer ist klein, jedoch sehr hell.", en: "The room is small, however very bright." }, drill: { jp: "Das Zimmer ist klein jedoch sehr hell", en: "The room is small however very bright" }, accept: ["however", "but", "yet", "nevertheless"], hint: "Means what aber (u12) means and belongs to writing. aber never changes the word order; jedoch can take first position and push the verb second." },
        { id: "de-u36l2-dennoch", type: "vocab", front: "dennoch", reading: "dennoch", meaning: "nevertheless — stronger than trotzdem", example: { jp: "Es regnet, dennoch gehen wir in den Park.", en: "It is raining; nevertheless we are going to the park." }, drill: { jp: "Es regnet dennoch gehen wir", en: "It is raining nevertheless we go" }, accept: ["nevertheless", "nonetheless", "even so", "still"], hint: "u29 taught trotzdem for this job. dennoch is the heavier, more written of the two, and the two are otherwise interchangeable." },
        { id: "de-u36l2-allerdings", type: "vocab", front: "allerdings", reading: "allerdings", meaning: "though — conceding one point only", example: { jp: "Das Buch ist gut, allerdings ist es zu lang.", en: "The book is good, though it is too long." }, drill: { jp: "Das Buch ist gut allerdings zu lang", en: "The book is good though too long" }, accept: ["though", "admittedly", "mind you", "however"], hint: "Smaller than jedoch: it concedes one detail rather than turning the whole argument. On its own, Allerdings! means absolutely, quite so." },
        ...
        { id: "de-u36l2-sogar", type: "vocab", front: "sogar", reading: "sogar", meaning: "even — more than you would expect", example: { jp: "Er arbeitet sogar am Sonntag.", en: "He even works on Sunday." }, drill: { jp: "Er arbeitet sogar am Sonntag", en: "He even works on Sunday" }, accept: ["even"], hint: "Goes directly before the surprising word. Do not confuse it with u29's als or with auch — sogar always signals that this is the extreme case." },
      ],
    },
    {
      id: "de-u36l3",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u36l4-anstatt", type: "vocab", front: "anstatt", reading: "anstatt", meaning: "instead of", example: { jp: "Wir gehen anstatt zu fahren.", en: "We walk instead of driving." }, drill: { jp: "Wir gehen anstatt zu fahren", en: "We walk instead of driving" }, accept: ["instead of", "rather than", "in place of"], hint: "With an infinitive it takes zu: anstatt zu fahren. The shorter statt means the same and is commoner in speech." },
