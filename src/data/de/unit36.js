  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u36l1-sowohl", type: "vocab", front: "sowohl", reading: "sowohl", meaning: "both — in the pair sowohl … als auch", example: { jp: "Sowohl der Vater als auch die Mutter arbeiten hier.", en: "Both the father and the mother work here." }, drill: { jp: "Sowohl der Lehrer als auch die Kinder lernen", en: "Both the teacher and the children are learning" }, accept: ["both", "both and", "as well as"], hint: "The fixed frame is sowohl … als auch, using u29's als and u3's auch. It is the positive mirror of weder … noch." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u36l2-uebrigens", type: "vocab", front: "übrigens", reading: "ubrigens", meaning: "by the way", example: { jp: "Übrigens kommt der Chef heute später.", en: "By the way, the boss is coming later today." }, drill: { jp: "Übrigens ist der Zug heute pünktlich", en: "By the way, the train is on time today" }, accept: ["by the way", "incidentally"], hint: "Drops a side remark into a conversation. Ü-bri-gens, stress at the front, and it takes first position with the verb straight after." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u36l3-schliesslich", type: "vocab", front: "schließlich", reading: "schliesslich", meaning: "finally — the last step of a sequence", example: { jp: "Schließlich kommt der Zug doch noch.", en: "Finally the train comes after all." }, drill: { jp: "Schließlich gehen wir nach Hause", en: "Finally we go home" }, accept: ["finally", "in the end", "after all", "eventually"], hint: "Closes what zuerst opened. It has a second use meaning after all, giving a reason: Er ist müde, schließlich hat er gearbeitet." },
        { id: "de-u36l3-voralem", type: "vocab", front: "vor allem", reading: "vorallem", meaning: "above all", example: { jp: "Vor allem brauchen wir viel Zeit.", en: "Above all we need a lot of time." }, drill: { jp: "Vor allem kostet das Haus zu viel", en: "Above all the house costs too much" }, accept: ["above all", "especially", "most of all", "particularly"], hint: "Two words, built on vor (u13). It marks the most important item on a list you have just given." },
        { id: "de-u36l3-zumbeispiel", type: "vocab", front: "zum Beispiel", reading: "zumbeispiel", meaning: "for example", example: { jp: "Wir lernen Sprachen, zum Beispiel Deutsch.", en: "We learn languages, for example German." }, drill: { jp: "Wir kaufen zum Beispiel Brot und Käse", en: "We buy bread and cheese, for example" }, accept: ["for example", "for instance", "such as", "e.g."], hint: "Written z. B. and said tsum BY-shpeel. zum is zu plus dem — the dative contraction from u14." },
        { id: "de-u36l3-erstens", type: "vocab", front: "erstens", reading: "erstens", meaning: "firstly — numbering a point in an argument", example: { jp: "Erstens ist das Buch zu teuer und zu lang.", en: "Firstly the book is too expensive and too long." }, drill: { jp: "Erstens haben wir keine Zeit", en: "Firstly we have no time" }, accept: ["firstly", "first of all", "for one thing", "in the first place"], hint: "For listing reasons, not events — zuerst (u21) does time order; erstens numbers the points in an argument. It runs erstens, zweitens, drittens." },
