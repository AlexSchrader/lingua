  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u54l3-diegefahr", type: "vocab", front: "die Gefahr", reading: "diegefahr", meaning: "the danger", example: { jp: "Es besteht die Gefahr, dass der Fluss nach dem Regen zu hoch wird.", en: "There is a danger that the river will get too high after the rain." }, drill: { jp: "Die Gefahr kommt aus dem Wald", en: "The danger comes from the forest" }, accept: ["danger", "the danger", "risk", "the risk", "hazard", "the hazard", "peril"], hint: "außer Gefahr = out of danger. Gefahr laufen, etwas zu tun = to run the risk of doing something." },
      ],
    },
    {
      id: "de-u54l4",
