...
export const DE_UNIT54 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u54l2-derzweifel", type: "vocab", front: "der Zweifel", reading: "derzweifel", meaning: "the doubt", example: { jp: "Ich habe große Zweifel, ob das ohne mehr Geld überhaupt funktioniert.", en: "I have serious doubts whether that works at all without more money." }, drill: { jp: "Der Zweifel ist sehr groß", en: "The doubt is very great" }, accept: ["doubt", "the doubt", "misgiving", "the misgiving", "reservation", "the reservation"], hint: "zwei (two) sits inside it — a mind split in two. Zweifel haben an etwas; ohne Zweifel = without doubt. Plural looks the same." },
        { id: "de-u54l2-ungefahr", type: "vocab", front: "ungefähr", reading: "ungefahr", meaning: "approximately", example: { jp: "Die Fahrt dauert ungefähr zwei Stunden, je nach Wetter auch länger.", en: "The journey takes approximately two hours, depending on the weather even longer." }, drill: { jp: "Die Fahrt dauert ungefähr zwei Stunden", en: "The journey takes about two hours" }, accept: ["approximately", "about", "roughly", "around", "some"], hint: "The standard word for 'about' in front of a number: ungefähr zwanzig Euro. Interchangeable with etwa." },
        ...
        { id: "de-u54l2-zumindest", type: "vocab", front: "zumindest", reading: "zumindest", meaning: "at any rate", example: { jp: "Der Tag war sehr lang, aber zumindest hat das Essen gut geschmeckt.", en: "The day was very long, but at least the food tasted good." }, drill: { jp: "Zumindest hat das Essen geschmeckt", en: "At least the food tasted good" }, accept: ["at least", "at any rate", "at the very least", "if nothing else"], hint: "NOT the number floor — that is mindestens. This one is the consolation: zumindest ist es warm." },
        { id: "de-u54l2-dieahnung", type: "vocab", front: "die Ahnung", reading: "dieahnung", meaning: "the idea", example: { jp: "Ich habe keine Ahnung, warum der Zug heute überhaupt nicht fährt.", en: "I have no idea why the train isn't running at all today." }, drill: { jp: "Die Ahnung war ganz richtig", en: "The hunch was quite right" }, accept: ["idea", "the idea", "clue", "the clue", "inkling", "the inkling", "notion", "the notion", "hunch"], hint: "Nine times in ten you meet it as keine Ahnung! = no idea. From ahnen, to sense something coming." },
      ],
    },
    {
      id: "de-u54l3",
      ...
      items: [
        ...
        { id: "de-u54l3-dereindruck", type: "vocab", front: "der Eindruck", reading: "dereindruck", meaning: "the impression", example: { jp: "Ich habe den Eindruck, dass er in der Nacht sehr schlecht geschlafen hat.", en: "I have the impression that he slept very badly during the night." }, drill: { jp: "Der Eindruck war sehr gut", en: "The impression was very good" }, accept: ["impression", "the impression", "feeling", "the feeling", "sense", "the sense"], hint: "ein + drücken (to press): what pressed itself into you. den Eindruck haben, dass… = to get the feeling that…" },
        { id: "de-u54l3-diegefahr", type: "vocab", front: "die Gefahr", reading: "diegefahr", meaning: "the danger", example: { jp: "Es besteht die Gefahr, dass der Fluss nach dem Regen zu hoch wird.", en: "There is a danger that the river will get too high after the rain." }, drill: { jp: "Die Gefahr ist sehr groß", en: "The danger is very great" }, accept: ["danger", "the danger", "risk", "the risk", "hazard", "the hazard", "peril"], hint: "außer Gefahr = out of danger. Gefahr laufen, etwas zu tun = to run the risk of doing something." },
      ],
    },
    {
      id: "de-u54l4",
