  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u12l4-nie", type: "vocab", front: "nie", reading: "nie", meaning: "never", example: { jp: "Ich trinke nie Kaffee.", en: "I never drink coffee." }, drill: { jp: "Er kommt nie spät", en: "He is never late" }, accept: ["never", "not ever"], hint: "The bottom of lesson 1's frequency scale: immer, oft, manchmal, selten, nie. It sits in the same middle position they do." },
