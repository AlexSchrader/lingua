...
export const DE_UNIT12 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u12l4-kein", type: "vocab", front: "kein", reading: "kein", meaning: "not a", example: { jp: "Ich habe kein Buch.", en: "I do not have a book." }, accept: ["no", "not a", "not any", "none"], hint: "The single most important split in German negation: nicht (u3) negates a verb or an adjective, kein negates a NOUN. Never nicht ein — always kein." },
