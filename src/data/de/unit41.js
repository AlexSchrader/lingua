...
export const DE_UNIT41 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u41l2-dertopf", type: "vocab", front: "der Topf", reading: "dertopf", meaning: "the pot", example: { jp: "Im Topf kocht das Wasser.", en: "The water is boiling in the pot." }, drill: { jp: "Der Topf ist zu klein", en: "The pot is too small" }, accept: ["the pot", "the saucepan"], hint: "Deep, with a lid, for anything wet. Plural umlauts: die Töpfe." },
        ...
        { id: "de-u41l2-derteller", type: "vocab", front: "der Teller", reading: "derteller", meaning: "the plate", example: { jp: "Auf dem Teller ist nichts.", en: "There is nothing on the plate." }, drill: { jp: "Der Teller ist noch heiß", en: "The plate is still hot" }, accept: ["the plate", "the dish"], hint: "Masculine, and its plural does not change: der Teller, die Teller." },
      ],
    },
    {
      id: "de-u41l3",
      ...
      items: [
        ...
        { id: "de-u41l3-dassalz", type: "vocab", front: "das Salz", reading: "dassalz", meaning: "the salt", example: { jp: "Das Salz ist neben dem Zucker.", en: "The salt is next to the sugar." }, drill: { jp: "Das Salz ist in der Suppe", en: "The salt is in the soup" }, accept: ["the salt"], hint: "English salt with a German z, which is said ts: zalts." },
