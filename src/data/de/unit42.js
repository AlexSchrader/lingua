  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u42l1-derkellner", type: "vocab", front: "der Kellner", reading: "derkellner", meaning: "the waiter", example: { jp: "Der Kellner gibt uns die Karte.", en: "The waiter gives us the menu." }, drill: { jp: "Der Kellner arbeitet sehr schnell", en: "The waiter works very fast" }, accept: ["the waiter", "the server"], hint: "A woman is die Kellnerin. Plural identical to the singular: der Kellner, die Kellner." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u42l2-diespeisekarte", type: "vocab", front: "die Speisekarte", reading: "diespeisekarte", meaning: "the menu", example: { jp: "Die Speisekarte liegt hier auf dem Tisch.", en: "The menu is lying here on the table." }, drill: { jp: "Die Speisekarte ist sehr lang", en: "The menu is very long" }, accept: ["the menu"], hint: "Speise, a dish, plus Karte. Everyone shortens it to die Karte in speech." },
        { id: "de-u42l2-bestellen", type: "vocab", front: "bestellen", reading: "bestellen", meaning: "to order", example: { jp: "Wir bestellen zwei Bier und ein Wasser.", en: "We are ordering two beers and a water." }, drill: { jp: "Die Gäste bestellen das Hauptgericht", en: "The guests order the main course" }, accept: ["to order"], hint: "In a restaurant and online alike. The noun is die Bestellung, your order." },
        { id: "de-u42l2-wahlen", type: "vocab", front: "wählen", reading: "wahlen", meaning: "to choose", example: { jp: "Wir wählen das Hauptgericht zusammen.", en: "We choose the main course together." }, drill: { jp: "Die Gäste wählen den Nachtisch", en: "The guests choose the dessert" }, accept: ["to choose", "to select", "to pick"], hint: "Also to vote and to dial a number — one verb for all three." },
        ...
        { id: "de-u42l2-dasgetrank", type: "vocab", front: "das Getränk", reading: "dasgetrank", meaning: "the beverage", example: { jp: "Das Getränk kostet vier Euro.", en: "The drink costs four euros." }, drill: { jp: "Das Getränk ist zu warm", en: "The drink is too warm" }, accept: ["the drink", "the beverage"], hint: "Built on trinken. The Ge- prefix makes a noun of the whole activity — the same shape as das Gemüse." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u42l4-dastrinkgeld", type: "vocab", front: "das Trinkgeld", reading: "dastrinkgeld", meaning: "the tip", example: { jp: "Das Trinkgeld ist für die Bedienung, nicht für die Küche.", en: "The tip is for the waiting staff, not for the kitchen." }, drill: { jp: "Das Trinkgeld ist heute sehr klein", en: "The tip is very small today" }, accept: ["the tip", "the gratuity"], hint: "Literally drink-money. In Germany you round up and say the total, rather than leaving coins." },
        ...
        { id: "de-u42l4-dieserviette", type: "vocab", front: "die Serviette", reading: "dieserviette", meaning: "the napkin", example: { jp: "Die Serviette liegt neben dem Teller.", en: "The napkin is lying next to the plate." }, drill: { jp: "Die Serviette ist weiß und klein", en: "The napkin is white and small" }, accept: ["the napkin", "the serviette"], hint: "From French, so the ending says -ET-te. Paper or cloth, both the same word." },
