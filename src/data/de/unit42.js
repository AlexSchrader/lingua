  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u42l1-dergast", type: "vocab", front: "der Gast", reading: "dergast", meaning: "the guest", example: { jp: "Der Gast wartet an der Tür, weil kein Tisch frei ist.", en: "The guest is waiting at the door because no table is free." }, drill: { jp: "Der Gast wartet an der Tür", en: "The guest is waiting at the door" }, accept: ["the guest", "the customer", "the diner"], hint: "Anyone being served or hosted — in a restaurant, a hotel or your home. Plural umlauts: die Gäste." },
        ...
        { id: "de-u42l1-frei", type: "vocab", front: "frei", reading: "frei", meaning: "free / available", example: { jp: "Der Tisch am Fenster ist noch frei.", en: "The table by the window is still free." }, drill: { jp: "Der Tisch am Fenster ist frei", en: "The table by the window is free" }, accept: ["free", "available", "vacant", "unoccupied"], hint: "Free as in not taken, and also free as in at liberty — never free of charge, which is kostenlos." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u42l2-diespeisekarte", type: "vocab", front: "die Speisekarte", reading: "diespeisekarte", meaning: "the menu", example: { jp: "Die Speisekarte liegt schon auf dem Tisch.", en: "The menu is already lying on the table." }, drill: { jp: "Die Speisekarte liegt auf dem Tisch", en: "The menu is lying on the table" }, accept: ["the menu"], hint: "Speise, a dish, plus Karte. Everyone shortens it to die Karte in speech." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u42l3-dernachtisch", type: "vocab", front: "der Nachtisch", reading: "dernachtisch", meaning: "the dessert", example: { jp: "Nach dem Essen nehmen wir einen Nachtisch.", en: "After the meal we will have a dessert." }, drill: { jp: "Der Nachtisch ist sehr süß", en: "The dessert is very sweet" }, accept: ["the dessert", "the pudding", "the sweet"], hint: "Literally after-table, and nothing to do with die Nacht, night. Zum Nachtisch is the set phrase." },
        ...
        { id: "de-u42l3-probieren", type: "vocab", front: "probieren", reading: "probieren", meaning: "to try / taste", example: { jp: "Du musst den Salat probieren, er ist sehr frisch.", en: "You have to try the salad, it is very fresh." }, drill: { jp: "Wir probieren den Salat und die Suppe", en: "We are trying the salad and the soup" }, accept: ["to try", "to taste", "to sample"], hint: "Trying food, or trying anything out. anprobieren, from u17, is the clothes-shop version." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u42l4-satt", type: "vocab", front: "satt", reading: "satt", meaning: "full (of food)", example: { jp: "Ich bin satt, deshalb nehme ich keinen Nachtisch.", en: "I am full, so I am not having any dessert." }, drill: { jp: "Ich bin jetzt satt", en: "I am full now" }, accept: ["full", "satisfied", "full up"], hint: "Only about food. Never voll, which for a person means drunk — a genuinely useful thing to keep apart." },
