  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u72l2-diegrussformel", type: "vocab", front: "die Grußformel", reading: "diegrussformel", meaning: "the set greeting", example: { jp: "Am Ende einer offiziellen Nachricht steht immer eine Grußformel.", en: "At the end of an official message there is always a closing formula." }, drill: { jp: "Die Grußformel steht ganz am Ende", en: "The set greeting stands right at the end" }, accept: ["greeting formula", "the greeting formula", "set greeting", "salutation", "closing formula"], hint: "der Gruß in this lesson + die Formel: the fixed wording, not a personal greeting. Sehr geehrte… opens, Mit freundlichen Grüßen closes. Type the ß as ss: diegrussformel." },
      ],
    },
    {
      id: "de-u72l3",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u72l4-derquatsch", type: "vocab", front: "der Quatsch", reading: "derquatsch", meaning: "the nonsense (spoken)", example: { jp: "Was er da erzählt, ist doch völliger Quatsch.", en: "What he's telling you there is complete nonsense." }, drill: { jp: "Der Quatsch war nicht besonders lustig", en: "The nonsense wasn't particularly funny" }, accept: ["nonsense", "the nonsense", "rubbish", "the rubbish", "garbage", "baloney"], hint: "Spoken only, and friendlier than it looks — Quatsch! on its own means 'don't be silly' or waves away thanks. der Unsinn (u51) is its written cousin." },
      ],
    },
  ],
};
