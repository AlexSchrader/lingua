  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u72l2-derempfanger", type: "vocab", front: "der Empfänger", reading: "derempfanger", meaning: "the recipient", example: { jp: "Der Empfänger von der Mitteilung wohnt nicht mehr in Hamburg.", en: "The recipient of the notice no longer lives in Hamburg." }, drill: { jp: "Der Empfänger wohnt in Hamburg", en: "The recipient lives in Hamburg" }, accept: ["recipient", "the recipient", "the addressee", "the receiver"], hint: "From empfangen, to receive. Also the receiver in a radio." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u72l4-eben", type: "vocab", front: "eben", reading: "eben", meaning: "just", example: { jp: "Das Auto war eben zu teuer, also nehmen wir den Zug.", en: "The car was just too expensive, so we are taking the train." }, drill: { jp: "Das war eben zu teuer", en: "That was just too expensive" }, accept: ["just", "simply", "that's just how it is", "precisely", "flat"], hint: "Three jobs: 'just', 'exactly right' as a one-word answer, and 'flat' as an adjective." },
