...
export const DE_UNIT67 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Handle medicines and prevention: a vaccination, precaution, an ointment, a dose, a side effect, blood pressure.",
      items: [
        ...
        { id: "de-u67l2-dievorsorge", type: "vocab", front: "die Vorsorge", reading: "dievorsorge", meaning: "the prevention", example: { jp: "Zur Vorsorge geht mein Vater im Herbst zum Arzt.", en: "My father goes to the doctor in autumn for a check-up." }, drill: { jp: "Die Vorsorge ist besser als die Therapie", en: "Prevention is better than therapy" }, accept: ["prevention", "the prevention", "precaution", "check-up", "the check-up", "the screening"], hint: "vor + sorgen: caring in advance. The CHECK-UP itself is die Vorsorgeuntersuchung; Vorsorge alone is the precaution." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u67l4-dasgleichgewicht", type: "vocab", front: "das Gleichgewicht", reading: "dasgleichgewicht", meaning: "the balance", example: { jp: "Wer gut schläft und viel Sport macht, hält sein Gleichgewicht leichter.", en: "Someone who sleeps well and does a lot of sport keeps their balance more easily." }, drill: { jp: "Das Gleichgewicht ist sehr wichtig", en: "Balance is very important" }, accept: ["balance", "the balance", "equilibrium", "the equilibrium"], hint: "gleich + das Gewicht: equal weight. Both senses — standing upright, and an inner balance: das seelische Gleichgewicht." },
      ],
    },
  ],
};
