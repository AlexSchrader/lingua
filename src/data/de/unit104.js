  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u104l1-derjournalist", type: "vocab", front: "der Journalist", reading: "derjournalist", meaning: "journalist", example: { jp: "Der Journalist hat mit zwanzig Leuten gesprochen und keinen Namen genannt.", en: "The journalist spoke with twenty people and named nobody." }, drill: { jp: "Der Journalist hat keine Quelle", en: "The journalist has no source" }, accept: ["journalist", "reporter"], hint: "Pronounced the French way: zhoor-na-LIST. Weak noun — den Journalisten, dem Journalisten. Female: die Journalistin." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u104l2-dieerzahlung", type: "vocab", front: "die Erzählung", reading: "dieerzahlung", meaning: "narrative (the account being told)", example: { jp: "Beide Seiten haben ihre eigene Erzählung, und die Fakten passen in beide.", en: "Both sides have their own narrative, and the facts fit into both." }, drill: { jp: "Die Erzählung der Firma war falsch", en: "The firm's narrative was wrong" }, accept: ["narrative", "account", "story", "tale"], hint: "Also a literary form — a short story. In media talk it is the narrative, the shape a side gives the events." },
        { id: "de-u104l2-dieerzahlweise", type: "vocab", front: "die Erzählweise", reading: "dieerzahlweise", meaning: "manner of telling (how a story is narrated)", example: { jp: "Die Erzählweise ist ruhig, obwohl in jeder Szene etwas Schlimmes passiert.", en: "The manner of telling is calm, although something bad happens in every scene." }, drill: { jp: "Die Erzählweise bleibt bis zum Ende ruhig", en: "The manner of telling stays calm until the end" }, accept: ["manner of telling", "narrative style", "way of narrating", "narration"], hint: "Erzählen + Weise (manner). Not WHAT is told — that is die Erzählung — but HOW." },
        { id: "de-u104l2-diesichtweise", type: "vocab", front: "die Sichtweise", reading: "diesichtweise", meaning: "way of seeing (someone's take on events)", example: { jp: "Das Buch zeigt nur eine Sichtweise, und es sagt das auch selbst.", en: "The book shows only one way of seeing it, and it says so itself." }, drill: { jp: "Die Sichtweise der Familie ist wichtig", en: "The family's way of seeing it matters" }, accept: ["way of seeing", "view", "take", "outlook"], hint: "Softer than die Meinung (u51): a Sichtweise is where somebody stands, not what they claim." },
        { id: "de-u104l2-dieruckblende", type: "vocab", front: "die Rückblende", reading: "dieruckblende", meaning: "flashback", example: { jp: "In einer Rückblende sieht man, warum die beiden nicht mehr reden.", en: "In a flashback you see why the two no longer speak." }, drill: { jp: "Die Rückblende erklärt den ganzen Streit", en: "The flashback explains the whole quarrel" }, accept: ["flashback", "retrospective scene", "look back"], hint: "zurück + blenden, the film term Germans also use about a text: in einer Rückblende erzählen." },
        { id: "de-u104l2-derverlauf", type: "vocab", front: "der Verlauf", reading: "derverlauf", meaning: "course (how events unfold over time)", example: { jp: "Im Verlauf des Abends wurde aus einem Streit eine Debatte.", en: "In the course of the evening an argument turned into a debate." }, drill: { jp: "Der Verlauf war von Anfang an klar", en: "The course of events was clear from the start" }, accept: ["course", "progression", "development", "sequence"], hint: "From verlaufen, to run its course. Im Verlauf + genitive is the standard written way to say during." },
        { id: "de-u104l2-dieperspektive", type: "vocab", front: "die Perspektive", reading: "dieperspektive", meaning: "point of view (angle a story is told from)", example: { jp: "Erzählt man dieselbe Woche aus der Perspektive der Kinder, klingt sie ganz anders.", en: "If you tell the same week from the children's point of view, it sounds completely different." }, drill: { jp: "Die Perspektive der Kinder kommt zu kurz", en: "The children's point of view gets too little space" }, accept: ["point of view", "perspective", "angle", "viewpoint"], hint: "Also prospects, in the plural: berufliche Perspektiven. Context tells you which sense is meant." },
      ],
    },
    {
      id: "de-u104l3",
      ...
      items: [
        ...
        { id: "de-u104l3-beschonigen", type: "vocab", front: "beschönigen", reading: "beschonigen", meaning: "to gloss over (make something sound better)", example: { jp: "Der Bericht beschönigt nichts, und genau deshalb hat ihn niemand gern gelesen.", en: "The report glosses over nothing, and that is exactly why nobody enjoyed reading it." }, drill: { jp: "Die Zahlen lassen sich nicht beschönigen", en: "The figures cannot be glossed over" }, accept: ["to gloss over", "to whitewash", "to play down", "to sugar-coat"], hint: "From schön: to talk something pretty. Da gibt es nichts zu beschönigen is the standard phrase for admitting a failure." },
        { id: "de-u104l3-deraufhanger", type: "vocab", front: "der Aufhänger", reading: "deraufhanger", meaning: "news hook (the peg a story hangs on)", example: { jp: "Der Aufhänger war ein alter Brief, das Thema selbst ist zwanzig Jahre alt.", en: "The hook was an old letter; the topic itself is twenty years old." }, drill: { jp: "Der Aufhänger war eine kurze Meldung", en: "The hook was a short news item" }, accept: ["hook", "news hook", "peg", "angle"], hint: "From aufhängen — what the story is hung on. Without one, an editor will not run a piece however important it is." },
        { id: "de-u104l3-inszenieren", type: "vocab", front: "inszenieren", reading: "inszenieren", meaning: "to stage (arrange so it looks spontaneous)", example: { jp: "Man kann ein Gespräch am Küchentisch genauso inszenieren wie eine große Rede.", en: "You can stage a conversation at the kitchen table just as much as a big speech." }, drill: { jp: "Sie inszenieren das Gespräch sehr genau", en: "They stage the conversation very precisely" }, accept: ["to stage", "to stage-manage", "to produce", "stage"], hint: "From die Szene. Reflexive for people who perform themselves: er inszeniert sich gern = he likes to put on a show." },
        { id: "de-u104l3-reisserisch", type: "vocab", front: "reißerisch", reading: "reisserisch", meaning: "sensationalist (loud and lurid)", example: { jp: "Die Schlagzeile war reißerisch, der Text darunter erstaunlich vorsichtig.", en: "The headline was sensationalist; the text underneath was surprisingly careful." }, drill: { jp: "Die Schlagzeile war einfach zu reißerisch", en: "The headline was simply too sensationalist" }, accept: ["sensationalist", "lurid", "sensational", "over the top"], hint: "From reißen, to rip: a headline that rips your attention away. Always negative." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u104l4-derskandal", type: "vocab", front: "der Skandal", reading: "derskandal", meaning: "scandal", example: { jp: "Aus einer Meldung wurde erst ein Skandal, als die alten Briefe auftauchten.", en: "A news item only became a scandal when the old letters turned up." }, drill: { jp: "Der Skandal betrifft die ganze Firma", en: "The scandal affects the whole firm" }, accept: ["scandal", "outrage", "affair"], hint: "Note the German stress: skan-DAL. Der Skandal um X is the fixed way to name whose scandal it is." },
