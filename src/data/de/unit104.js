  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u104l1-recherchieren", type: "vocab", front: "recherchieren", reading: "recherchieren", meaning: "to investigate (dig for a story)", example: { jp: "Zwei Leute haben monatelang recherchiert, bevor die Zeitung etwas gedruckt hat.", en: "Two people investigated for months before the paper printed anything." }, drill: { jp: "Sie recherchieren seit vielen Monaten", en: "They have been investigating for many months" }, accept: ["to investigate", "to research", "investigate", "research"], hint: "What a journalist does; what a student does is nachlesen or suchen. Recherchieren implies asking people, not reading." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u104l2-darstellen", type: "vocab", front: "darstellen", reading: "darstellen", meaning: "to portray (present in a certain way)", example: { jp: "Der Film stellt die Familie viel ärmer dar, als sie wirklich war.", en: "The film portrays the family as much poorer than it really was." }, drill: { jp: "Der Film will die Familie anders darstellen", en: "The film wants to portray the family differently" }, accept: ["to portray", "to depict", "to present", "portray"], hint: "Separable: stellt … dar. Also plain to constitute: das stellt kein Problem dar = that is not a problem." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u104l3-dieinszenierung", type: "vocab", front: "die Inszenierung", reading: "dieinszenierung", meaning: "staging (an event arranged for effect)", example: { jp: "Der Besuch war eine Inszenierung: die Kameras standen schon da, bevor er ankam.", en: "The visit was a staging: the cameras were already there before he arrived." }, drill: { jp: "Die Inszenierung war von Anfang an geplant", en: "The staging was planned from the start" }, accept: ["staging", "production", "stage-management", "performance"], hint: "In the theatre it is neutral — the production. About politics it is an accusation: das war reine Inszenierung." },
        ...
        { id: "de-u104l3-reisserisch", type: "vocab", front: "reißerisch", reading: "reisserisch", meaning: "sensationalist (loud and lurid)", example: { jp: "Die Überschrift war reißerisch, der Text darunter erstaunlich vorsichtig.", en: "The headline was sensationalist; the text underneath was surprisingly careful." }, drill: { jp: "Die Überschrift klingt einfach zu reißerisch", en: "The headline simply sounds too sensationalist" }, accept: ["sensationalist", "lurid", "sensational", "over the top"], hint: "From reißen, to rip: a headline that rips your attention away. Always negative." },
