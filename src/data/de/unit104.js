  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u104l2-diesichtweise", type: "vocab", front: "die Sichtweise", reading: "diesichtweise", meaning: "way of seeing (someone's take on events)", example: { jp: "Der Film zeigt nur eine Sichtweise, und er sagt das auch selbst.", en: "The film shows only one way of seeing it, and it says so itself." }, drill: { jp: "Die Sichtweise der Familie fehlt völlig", en: "The family's way of seeing it is missing" }, accept: ["way of seeing", "view", "take", "outlook"], hint: "Softer than die Meinung (u51): a Sichtweise is where somebody stands, not what they claim." },
