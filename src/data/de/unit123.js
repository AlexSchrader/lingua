  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u123l4-daszeug", type: "vocab", front: "das Zeug", reading: "daszeug", meaning: "the stuff", example: { jp: "Das Zeug im Keller braucht niemand mehr, und trotzdem bleibt es dort.", en: "Nobody needs the stuff in the cellar any more, and yet it stays there." }, drill: { jp: "Das Zeug liegt seit Jahren hier", en: "The stuff has been lying here for years" }, accept: ["stuff", "the stuff", "gear", "things", "kit"], hint: "Rank 1629. Uncountable and mildly dismissive, exactly like English ‘stuff’. ⚠️ Unrelated to der Zeuge (witness, u75) in the modern language, whatever the shared spelling suggests." },
      ],
    },
  ],
};
