  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u13l1-den", type: "vocab", front: "den", reading: "den", meaning: "object form of der", example: { jp: "Ich suche den Weg.", en: "I am looking for the way." }, accept: ["the", "the (accusative)", "the (object)"], hint: "der becomes den when the noun is the OBJECT. Der Weg ist lang, but Ich suche den Weg. Only the masculine does this — die and das never change." },
        { id: "de-u13l1-einen", type: "vocab", front: "einen", reading: "einen", meaning: "object form of ein", example: { jp: "Ich suche einen Park.", en: "I am looking for a park." }, accept: ["a", "an", "a (accusative)", "one"], hint: "ein (u5) does exactly what der does: ein Park ist schön, but Ich suche einen Park. Feminine eine and neuter ein stay as they are." },
        ...
        { id: "de-u13l1-meinen", type: "vocab", front: "meinen", reading: "meinen", meaning: "object form of mein", example: { jp: "Ich suche meinen Bruder.", en: "I am looking for my brother." }, accept: ["my", "my (accusative)"], hint: "mein (u4) joins the same club: mein Bruder ist hier, but Ich suche meinen Bruder. Once you know ein → einen, every one of these follows." },
        { id: "de-u13l1-deinen", type: "vocab", front: "deinen", reading: "deinen", meaning: "object form of dein", example: { jp: "Ich suche deinen Freund.", en: "I am looking for your friend." }, accept: ["your", "your (accusative)"], hint: "dein (u4) behaves identically. The pattern is now five words wide — den, einen, keinen, meinen, deinen — and it is one single rule." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u13l2-mich", type: "vocab", front: "mich", reading: "mich", meaning: "me — object", example: { jp: "Du findest mich hier.", en: "You will find me here." }, accept: ["me"], hint: "ich (u3) is the subject form, mich the object — the same I/me split English makes. MISH, with the soft ch of ich." },
        ...
        { id: "de-u13l2-ihn", type: "vocab", front: "ihn", reading: "ihn", meaning: "him — object", example: { jp: "Ich finde ihn nicht.", en: "I cannot find him." }, accept: ["him", "it"], hint: "er (u3) → ihn. It also means it for any masculine thing: Der Weg? Ich finde ihn nicht." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u13l4-an", type: "vocab", front: "an", reading: "an", meaning: "on — a vertical surface", example: { jp: "Wir fahren an den Bahnhof.", en: "We are driving to the station." }, accept: ["on", "at", "to", "onto", "against"], hint: "Up against something rather than on top of it — a picture hangs an der Wand. With movement, accusative: an den Bahnhof." },
