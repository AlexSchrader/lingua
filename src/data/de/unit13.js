  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u13l3-brauchen", type: "vocab", front: "brauchen", reading: "brauchen", meaning: "to need", example: { jp: "Ich brauche einen Arzt.", en: "I need a doctor." }, accept: ["to need", "need", "to require"], hint: "A verb that always takes an accusative object, which makes it a good one to practise the new endings on: Ich brauche einen…" },
      ],
    },
    {
      id: "de-u13l4",
