  ...
  lessons: [
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Follow spoken German when it swallows the long forms — in it, at it, on it, around, up close and out.",
      items: [
        { id: "de-u121l1-drin", type: "vocab", front: "drin", reading: "drin", meaning: "in it (spoken)", example: { jp: "In der Tasche ist bestimmt noch etwas drin.", en: "In the bag there is certainly still something in it." }, drill: { jp: "In dem Brief steht nichts drin", en: "There is nothing in the letter" }, accept: ["in it", "inside", "in there", "within"], hint: "The spoken form of darin. Da ist nichts mehr drin is also idiomatic for 'nothing more is possible' — of a negotiation as much as a box." },
        { id: "de-u121l1-dran", type: "vocab", front: "dran", reading: "dran", meaning: "at it", example: { jp: "Wer ist jetzt dran, oder sollen wir einfach von vorne beginnen?", en: "Whose turn is it now, or should we simply start from the beginning?" }, drill: { jp: "Jetzt bist du endlich dran", en: "Now it is finally your turn" }, accept: ["at it", "on it", "up", "one's turn", "attached"], hint: "Spoken daran. dran sein is 'to be next' — the everyday way to take turns. gut dran sein means to be well off." },
        { id: "de-u121l1-drauf", type: "vocab", front: "drauf", reading: "drauf", meaning: "on it (colloquial)", example: { jp: "Das Buch lag auf dem Tisch, und drauf stand nur ein Name.", en: "The book lay on the table, and on it there was only a name." }, drill: { jp: "Auf dem Foto sind wir alle drauf", en: "We are all in the photo" }, accept: ["on it", "on top", "on there", "upon it"], hint: "Spoken darauf. drauf sein describes a mood — gut drauf sein, to be in good spirits — which no textbook form carries." },
        { id: "de-u121l1-rum", type: "vocab", front: "rum", reading: "rum", meaning: "around (spoken)", example: { jp: "Die Kinder laufen den ganzen Tag im Garten rum, und am Abend sind sie dann wirklich müde.", en: "The children run around in the garden all day, and in the evening they really are tired." }, drill: { jp: "Wir sitzen nur rum und warten", en: "We just sit around and wait" }, accept: ["around", "round", "about"], hint: "Spoken herum (u118). Attaches to verbs freely — rumsitzen, rumlaufen, rumstehen — and always carries a hint of aimlessness." },
        { id: "de-u121l1-ran", type: "vocab", front: "ran", reading: "ran", meaning: "up close", example: { jp: "Geh ruhig näher ran, weil man von hier aus kaum etwas lesen kann.", en: "Do go closer, because from here you can hardly read anything." }, drill: { jp: "Komm bitte näher ran", en: "Please come up closer" }, accept: ["up", "up close", "closer", "over", "at it"], hint: "Spoken heran. As a bare command — Ran! — it means 'get to it'. ranrufen and rangehen are what people say for answering the phone." },
        { id: "de-u121l1-raus", type: "vocab", front: "raus", reading: "raus", meaning: "out (spoken)", example: { jp: "Komm raus, draußen ist es heute viel schöner als im Haus.", en: "Come out, outside it is much nicer today than indoors." }, drill: { jp: "Wir gehen jetzt alle raus", en: "We are all going out now" }, accept: ["out", "out of", "outside", "out there"], hint: "Spoken heraus and hinaus at once — u118 teaches the long form and this is what a German actually says. ⚠️ Its partner rein (in) is NOT taught: unit1.js declares it untaught on purpose, and the adjective rein (pure) would collide with it." },
      ],
    },
    {
      id: "de-u121l2",
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Use the spoken words for down, across, looking and hitting — the ones a textbook replaces with longer forms.",
      items: [
        { id: "de-u121l2-runter", type: "vocab", front: "runter", reading: "runter", meaning: "down (spoken)", example: { jp: "Komm bitte runter, das Essen steht seit zehn Minuten auf dem Tisch.", en: "Please come down; the food has been on the table for ten minutes." }, drill: { jp: "Die Preise gehen langsam runter", en: "The prices are slowly going down" }, accept: ["down", "downwards", "downstairs"], hint: "Spoken herunter and hinunter at once — speech has stopped distinguishing them. runterladen is what everyone says for 'to download'." },
        { id: "de-u121l2-rueber", type: "vocab", front: "rüber", reading: "ruber", meaning: "across (spoken)", example: { jp: "Bring den Stuhl bitte rüber, weil wir auf dieser Seite noch einen Platz brauchen.", en: "Please bring the chair across, because we still need a seat on this side." }, drill: { jp: "Wir gehen kurz rüber zum Nachbarn", en: "We are going across to the neighbour for a moment" }, accept: ["across", "over", "over there", "round"], hint: "Spoken herüber. Pairs with drüben (u118), which is the position — you go rüber in order to be drüben." },
        { id: "de-u121l2-drueber", type: "vocab", front: "drüber", reading: "druber", meaning: "about it (spoken)", example: { jp: "Wir müssen noch mal drüber reden, weil im Moment jeder etwas anderes verstanden hat.", en: "We have to talk about it again, because at the moment everyone has understood something different." }, drill: { jp: "Reden wir morgen noch mal drüber", en: "Let us talk about it again tomorrow" }, accept: ["about it", "over it", "above it", "on it"], hint: "Spoken darüber, and like it, both literal (above) and topical (about). drüber reden is the ordinary way to say 'talk it over'." },
        { id: "de-u121l2-gucken", type: "vocab", front: "gucken", reading: "gucken", meaning: "to look (northern)", example: { jp: "Guck mal aus dem Fenster, weil der Himmel gerade eine schöne Farbe hat.", en: "Have a look out of the window, because the sky has a beautiful colour right now." }, drill: { jp: "Wir gucken heute Abend einen Film", en: "We are watching a film this evening" }, accept: ["to look (northern)", "to watch", "watch", "to have a look"], hint: "The everyday northern word where books write schauen or sehen. Fernsehen gucken is what people actually say. In the south, schauen wins instead." },
        { id: "de-u121l2-hauen", type: "vocab", front: "hauen", reading: "hauen", meaning: "to hit", example: { jp: "Die Kinder sollen sich nicht hauen, auch dann nicht, wenn einer von ihnen im Recht ist.", en: "The children should not hit each other, not even when one of them is in the right." }, drill: { jp: "Er will niemanden hauen", en: "He does not want to hit anyone" }, accept: ["to hit", "hit", "to strike", "strike", "to whack", "to bash"], hint: "Blunt and physical, where schlagen is the neutral word. abhauen — to clear off — is far commoner than the simple verb and worth recognising." },
        { id: "de-u121l2-schauen", type: "vocab", front: "schauen", reading: "schauen", meaning: "to look (southern)", example: { jp: "Schauen wir morgen noch einmal, ob der Brief schon da ist.", en: "Let's look again tomorrow whether the letter is already there." }, drill: { jp: "Wir schauen kurz aus dem Fenster", en: "We look briefly out of the window" }, accept: ["to look (southern)", "to see", "to glance"], hint: "The southern and Austrian twin of gucken above — same meaning, opposite half of the country. Schau mal is the standard 'look here' in the south." },
      ],
    },
    {
      id: "de-u121l3",
      ...
      items: [
        ...
        { id: "de-u121l3-deridiot", type: "vocab", front: "der Idiot", reading: "deridiot", meaning: "the idiot", example: { jp: "Nenn ihn nicht Idiot, auch wenn der Fehler wirklich leicht zu vermeiden gewesen wäre.", en: "Don't call him an idiot, even if the mistake really would have been easy to avoid." }, drill: { jp: "Der Idiot hat alles kaputt gemacht", en: "The idiot broke everything" }, accept: ["idiot", "the idiot", "fool", "moron"], hint: "Weak masculine: den Idioten, dem Idioten. Genuinely rude — included because a learner needs to RECOGNISE it, not to use it." },
        { id: "de-u121l3-derfan", type: "vocab", front: "der Fan", reading: "derfan", meaning: "the fan", example: { jp: "Der Fan wartet seit Stunden draußen vor der Tür.", en: "The fan has been waiting outside the door for hours." }, drill: { jp: "Der Fan wartet schon seit Stunden", en: "The fan has been waiting for hours" }, accept: ["fan", "the fan", "supporter", "the supporter", "enthusiast"], hint: "Said the English way, FEN. Plural die Fans. German keeps the English word for a supporter; the thing on the ceiling is der Ventilator." },
      ],
    },
    {
      id: "de-u121l4",
      ...
      items: [
        ...
        { id: "de-u121l4-namens", type: "vocab", front: "namens", reading: "namens", meaning: "by the name of", example: { jp: "Ein Mann namens Weber hat heute Morgen zweimal angerufen und will bis Freitag eine Antwort.", en: "A man by the name of Weber called twice this morning and wants an answer by Friday." }, drill: { jp: "Ein Kind namens Anna wartet draußen", en: "A child by the name of Anna is waiting outside" }, accept: ["by the name of", "named", "called", "on behalf of"], hint: "Stands right after the noun and needs no article. In formal letters it also means 'on behalf of' — namens der Firma." },
        { id: "de-u121l4-angetan", type: "vocab", front: "angetan", reading: "angetan", meaning: "taken (with something)", example: { jp: "Alle waren von dem neuen Plan angetan, obwohl noch niemand die genauen Kosten kannte.", en: "Everyone was taken with the new plan, although nobody yet knew the exact costs." }, drill: { jp: "Der Chef war sehr angetan", en: "The boss was very taken with it" }, accept: ["taken", "impressed", "pleased", "keen", "charmed"], hint: "Always von etwas angetan sein — a warm but measured approval, the sort a German uses instead of enthusiasm. Only ever used in this phrase." },
        { id: "de-u121l4-dieankundigung", type: "vocab", front: "die Ankündigung", reading: "dieankundigung", meaning: "the announcement", example: { jp: "Die Ankündigung kam so kurzfristig, dass kaum jemand kommen konnte.", en: "The announcement came at such short notice that hardly anyone could come." }, drill: { jp: "Die Ankündigung kam viel zu kurzfristig", en: "The announcement came far too late" }, accept: ["announcement", "the announcement", "notice", "the notice", "advance notice"], hint: "ankündigen: to say in advance that something is coming. die Neuigkeit in this lesson is the news itself; die Ankündigung is the notice of it." },
      ],
    },
  ],
};
