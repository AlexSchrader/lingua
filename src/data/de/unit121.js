  ...
  lessons: [
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Follow spoken German when it swallows the long forms — in it, at it, on it, around and up close.",
      items: [
        ...
        { id: "de-u121l1-raus", type: "vocab", front: "raus", reading: "raus", meaning: "out (spoken)", example: { jp: "Komm raus, draußen ist es heute viel schöner als im Haus.", en: "Come out, outside it is much nicer today than indoors." }, drill: { jp: "Wir gehen jetzt alle raus", en: "We are all going out now" }, accept: ["out", "out of", "outside", "out there"], hint: "Rank 232. Spoken heraus and hinaus at once — u118 teaches the long form and this is what a German actually says. ⚠️ Its partner rein (in) is NOT taught: unit1.js declares it untaught on purpose, and the adjective rein (pure) would collide with it." },
      ],
    },
    {
      id: "de-u121l2",
      ...
      items: [
        ...
        { id: "de-u121l2-schauen", type: "vocab", front: "schauen", reading: "schauen", meaning: "to look (southern)", example: { jp: "Schauen wir morgen noch einmal, ob der Brief schon da ist.", en: "Let’s look again tomorrow whether the letter is already there." }, drill: { jp: "Wir schauen kurz aus dem Fenster", en: "We look briefly out of the window" }, accept: ["to look", "look", "to have a look", "to watch", "to see"], hint: "Rank 655. The southern and Austrian twin of gucken above — same meaning, opposite half of the country. Schau mal is the standard ‘look here’ in the south." },
      ],
    },
    {
      id: "de-u121l3",
