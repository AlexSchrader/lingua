  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u37l1-identisch", type: "vocab", front: "identisch", reading: "identisch", meaning: "identical", example: { jp: "Die Zimmer sind identisch, obwohl die Häuser verschieden sind.", en: "The rooms are identical, although the houses are different." }, drill: { jp: "Die zwei Zimmer sind identisch", en: "The two rooms are identical" }, accept: ["identical", "the same", "exactly the same"], hint: "A near-cognate of English identical, and stronger than ähnlich: the same in every detail. (The everyday adverb gleich, in a moment, is taught in u28.)" },
        { id: "de-u37l1-aehnlich", type: "vocab", front: "ähnlich", reading: "ahnlich", meaning: "similar", example: { jp: "Das Buch ist ähnlich, aber nicht identisch.", en: "The book is similar, but not identical." }, drill: { jp: "Die zwei Bücher sind ähnlich", en: "The two books are similar" }, accept: ["similar", "alike", "like"], hint: "The step below gleich. Jemandem ähnlich sehen is to look like someone — with a DATIVE person: er sieht seinem Vater ähnlich." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u37l3-derwunsch", type: "vocab", front: "der Wunsch", reading: "derwunsch", meaning: "wish", example: { jp: "Mein Wunsch wäre mehr Zeit für die Familie.", en: "My wish would be more time for the family." }, drill: { jp: "Der Wunsch ist sehr groß", en: "The wish is very great" }, accept: ["wish", "desire", "request"], hint: "The noun the Konjunktiv exists to express. Its plural umlauts: die Wünsche. In a shop, Haben Sie noch einen Wunsch? means anything else?" },
        { id: "de-u37l3-hoffentlich", type: "vocab", front: "hoffentlich", reading: "hoffentlich", meaning: "hopefully", example: { jp: "Hoffentlich ist das Wetter morgen besser.", en: "Hopefully the weather will be better tomorrow." }, drill: { jp: "Hoffentlich kommt der Zug pünktlich", en: "Hopefully the train comes on time" }, accept: ["hopefully", "I hope", "let us hope"], hint: "Built from u29's hoffen. Unlike English hopefully it is never criticised — it is simply the normal word, and it takes first position." },
      ],
    },
    {
      id: "de-u37l4",
