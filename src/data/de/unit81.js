  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u81l1-alarmieren", type: "vocab", front: "alarmieren", reading: "alarmieren", meaning: "to alert the emergency services", example: { jp: "Wer den Unfall sieht, soll sofort die Feuerwehr alarmieren.", en: "Whoever sees the accident should alert the fire brigade immediately." }, drill: { jp: "Sofort die Feuerwehr alarmieren und warten", en: "Alert the fire brigade immediately and wait" }, accept: ["to alert", "alert", "to call out", "to raise the alarm", "to notify"], hint: "-ieren, so the participle is alarmiert with no ge-. Of services you call out; for people it means to alarm: die Nachricht hat uns alarmiert." },
      ],
    },
    {
      id: "de-u81l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u81l3-derpuls", type: "vocab", front: "der Puls", reading: "derpuls", meaning: "the pulse", example: { jp: "Der Puls war sehr schnell, aber der Schock ist schon vorbei.", en: "The pulse was very fast, but the shock is already over." }, drill: { jp: "Der Puls ist viel zu schnell", en: "The pulse is far too fast" }, accept: ["pulse", "the pulse", "heartbeat", "the heartbeat"], hint: "Said PULS, one syllable. den Puls fühlen or messen. The first thing you check on someone who is ohnmächtig in this lesson." },
      ],
    },
    {
      id: "de-u81l4",
      ...
      items: [
        ...
        { id: "de-u81l4-dietaschenlampe", type: "vocab", front: "die Taschenlampe", reading: "dietaschenlampe", meaning: "the torch", example: { jp: "Ohne Taschenlampe finden Sie den Weg im Wald bestimmt nicht.", en: "Without a torch you certainly won't find the way in the forest." }, drill: { jp: "Die Taschenlampe liegt im Auto", en: "The torch is in the car" }, accept: ["torch", "the torch", "flashlight", "the flashlight"], hint: "die Tasche + die Lampe: a pocket lamp. German builds the thing out of its parts." },
        { id: "de-u81l4-derverbandskasten", type: "vocab", front: "der Verbandskasten", reading: "derverbandskasten", meaning: "the first-aid kit", example: { jp: "Im Auto muss ein Verbandskasten sein, das ist in Deutschland Vorschrift.", en: "There has to be a first-aid kit in the car — that is a regulation in Germany." }, drill: { jp: "Der Verbandskasten liegt im Auto", en: "The first-aid kit is in the car" }, accept: ["first-aid kit", "the first-aid kit", "first aid box", "the first aid box"], hint: "der Verband (the bandage) + der Kasten (the box). Legally required in every German car." },
      ],
    },
  ],
};
