  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u111l3-derrichtwert", type: "vocab", front: "der Richtwert", reading: "derrichtwert", meaning: "guide value (a target, not a limit)", example: { jp: "Der Richtwert ist kein Grenzwert: wer ihn überschreitet, zahlt nichts.", en: "A guide value is not a limit value: whoever exceeds it pays nothing." }, drill: { jp: "Der Richtwert ist bewusst kein Grenzwert", en: "The guide value is deliberately not a limit value" }, accept: ["guide value", "guideline figure", "benchmark", "reference value"], hint: "richten (to orient) + Wert. The pair worth learning together with block 1's Grenzwert: one guides, the other binds." },
