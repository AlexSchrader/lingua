  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u47l1-derbeutel", type: "vocab", front: "der Beutel", reading: "derbeutel", meaning: "the pouch", example: { jp: "Ich trage die Äpfel in einem Beutel.", en: "I carry the apples in a bag." }, drill: { jp: "Der Beutel ist voll", en: "The bag is full" }, accept: ["bag", "the bag", "the pouch"], hint: "A soft small bag. der Teebeutel = the teabag." },
      ],
    },
    {
      id: "de-u47l2",
      ...
      items: [
        ...
        { id: "de-u47l2-diekanne", type: "vocab", front: "die Kanne", reading: "diekanne", meaning: "the pot (for tea or coffee)", example: { jp: "Sie macht eine Kanne Kaffee.", en: "She makes a pot of coffee." }, drill: { jp: "Die Kanne ist heiß", en: "The pot is hot" }, accept: ["pot", "the pot", "the jug", "the pitcher"], hint: "For pouring — die Kaffeekanne, die Teekanne, die Gießkanne (watering can)." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u47l4-derinhalt", type: "vocab", front: "der Inhalt", reading: "derinhalt", meaning: "the contents", example: { jp: "Was ist der Inhalt vom Paket?", en: "What are the contents of the parcel?" }, drill: { jp: "Der Inhalt ist wichtig", en: "The contents are important" }, accept: ["contents", "the contents", "the content"], hint: "What is inside — also the contents of a book or a talk." },
