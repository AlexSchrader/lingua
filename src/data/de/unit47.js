...
// distinct, no clash. Examples use only vocab introduced at or before u47.
  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u47l1-diepackung", type: "vocab", front: "die Packung", reading: "diepackung", meaning: "the pack", example: { jp: "Die Packung ist schon leer.", en: "The pack is already empty." }, drill: { jp: "Die Packung ist leer", en: "The pack is empty" }, accept: ["pack", "the pack", "the packet"], hint: "From packen, to pack. eine Packung Nudeln, a packet of pasta." },
        ...
        { id: "de-u47l1-derbeutel", type: "vocab", front: "der Beutel", reading: "derbeutel", meaning: "the bag", example: { jp: "Ich trage die Äpfel in einem Beutel.", en: "I carry the apples in a bag." }, drill: { jp: "Der Beutel ist aus Papier", en: "The bag is made of paper" }, accept: ["bag", "the bag", "the pouch"], hint: "A soft small bag. der Teebeutel = the teabag." },
      ],
    },
    {
      id: "de-u47l2",
      ...
      items: [
        { id: "de-u47l2-diedose", type: "vocab", front: "die Dose", reading: "diedose", meaning: "the can", example: { jp: "In der Dose ist noch Suppe.", en: "There is still soup in the can." }, drill: { jp: "Die Dose ist offen", en: "The can is open" }, accept: ["can", "the can", "the tin"], hint: "A metal tin, or a small plastic box with a lid." },
        ...
        { id: "de-u47l2-dertank", type: "vocab", front: "der Tank", reading: "dertank", meaning: "the tank", example: { jp: "Der Tank vom Auto ist leer.", en: "The car's tank is empty." }, drill: { jp: "Der Tank ist voll", en: "The tank is full" }, accept: ["tank", "the tank", "the fuel tank"], hint: "A fuel or water tank. The verb tanken = to fill up with fuel." },
      ],
    },
    {
      id: "de-u47l3",
      ...
      items: [
        ...
        { id: "de-u47l3-derhenkel", type: "vocab", front: "der Henkel", reading: "derhenkel", meaning: "the handle", example: { jp: "Der Henkel von der Tasse ist kaputt.", en: "The handle of the cup is broken." }, drill: { jp: "Der Henkel ist ab", en: "The handle has come off" }, accept: ["handle", "the handle"], hint: "The loop handle of a cup, bag or pot — distinct from der Griff, a grip you hold in the hand." },
      ],
    },
    {
      id: "de-u47l4",
