  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u8l2-diefarbe", type: "vocab", front: "die Farbe", reading: "diefarbe", meaning: "colour", example: { jp: "Blau ist meine Farbe.", en: "Blue is my colour." }, accept: ["colour", "color", "the colour", "the color"], hint: "The noun behind all of them. Feminine, so meine and not mein — mein was taught at u4 and takes an e before a feminine noun." },
    ...
    },
    {
      ...
      cefr: "A1",
      dominantMode: "recall",
      canDo: "Say what the weather is doing, using the German pattern that has no subject you can point at: Es regnet.",
      items: [
        ...
        { id: "de-u8l3-derregen", type: "vocab", front: "der Regen", reading: "derregen", meaning: "rain", example: { jp: "Der Regen kommt.", en: "The rain is coming." }, accept: ["rain", "the rain"], hint: "The noun. Its verb, regnen, is the very next card and drops the e: Regen but es regnet." },
        { id: "de-u8l3-regnen", type: "vocab", front: "regnen", reading: "regnen", meaning: "to rain", example: { jp: "Es regnet.", en: "It is raining." }, accept: ["to rain", "rain", "raining"], hint: "Es regnet is the complete sentence — es is a placeholder subject with nothing behind it, just like English \"it\" in \"it is raining\"." },
        { id: "de-u8l3-derschnee", type: "vocab", front: "der Schnee", reading: "derschnee", meaning: "snow", example: { jp: "Der Schnee ist weiß.", en: "The snow is white." }, accept: ["snow", "the snow"], hint: "SHNAY — the double e is one long sound, never two. Same sch as in schwarz." },
        { id: "de-u8l3-schneien", type: "vocab", front: "schneien", reading: "schneien", meaning: "to snow", example: { jp: "Es schneit hier nicht.", en: "It does not snow here." }, accept: ["to snow", "snow", "snowing"], hint: "Built from Schnee the way regnen is built from Regen: es schneit. Note where nicht sits — after the verb, at the end. That position is u12's whole subject." },
      ],
    },
    {
      id: "de-u8l4",
