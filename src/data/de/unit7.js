  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u7l3-fahren", type: "vocab", front: "fahren", reading: "fahren", meaning: "to go (by vehicle) / to drive", example: { jp: "Ich fahre morgen.", en: "I am travelling tomorrow." }, accept: ["to drive", "to go by vehicle", "to travel", "to ride"], hint: "Any wheels or rails — car, bike, train. Mixing it up with gehen is the classic English-speaker error." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u7l4-suchen", type: "vocab", front: "suchen", reading: "suchen", meaning: "to look for", example: { jp: "Ich suche die Post.", en: "I am looking for the post office." }, accept: ["to look for", "to search for", "to seek", "search"], hint: "ZOO-khen. One word where English needs two — no separate \"for\" follows it." },
