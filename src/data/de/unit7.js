  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u7l3-zuruck", type: "vocab", front: "zurück", reading: "zuruck", meaning: "back", example: { jp: "Wir gehen zurück.", en: "We are going back." }, drill: { jp: "Der Bruder fährt morgen zurück", en: "The brother drives back tomorrow" }, accept: ["back", "backwards", "return"], hint: "zurück drops to the END of the clause: Ich gehe jetzt zurück. It also glues onto verbs — zurückkommen, zurückfahren — and splits off again when they are used." },
      ],
    },
    {
      id: "de-u7l4",
