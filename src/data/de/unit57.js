  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u57l1-froh", type: "vocab", front: "froh", reading: "froh", meaning: "glad", example: { jp: "Ich bin froh, dass du es mir gleich gesagt hast.", en: "I'm glad you told me straight away." }, drill: { jp: "Wir sind froh über das Ergebnis", en: "We are glad about the result" }, accept: ["glad", "happy", "pleased", "cheerful"], hint: "Lighter than glücklich and quicker than zufrieden: froh sein, dass… Frohe Weihnachten is the same word." },
      ],
    },
    {
      id: "de-u57l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u57l4-einfuhlsam", type: "vocab", front: "einfühlsam", reading: "einfuhlsam", meaning: "sensitive to others", example: { jp: "Sie hat sehr einfühlsam mit ihm gesprochen, als er von seiner Sorge erzählt hat.", en: "She spoke very sensitively with him when he told her about his worry." }, drill: { jp: "Sie spricht sehr einfühlsam mit ihm", en: "She speaks very sensitively with him" }, accept: ["sensitive", "empathetic", "empathic", "understanding", "tactful"], hint: "sich einfühlen (to feel your way in) + -sam. NOT empfindlich (u57), which means easily hurt — einfühlsam is being good at reading other people." },
      ],
    },
  ],
};
