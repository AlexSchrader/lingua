  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u57l2-diesehnsucht", type: "vocab", front: "die Sehnsucht", reading: "diesehnsucht", meaning: "the longing", example: { jp: "Nach zehn Jahren im Ausland hatte er große Sehnsucht nach der Heimat.", en: "After ten years abroad he had a great longing for home." }, drill: { jp: "Die Sehnsucht war sehr groß", en: "The longing was very great" }, accept: ["longing", "the longing", "yearning", "the yearning", "nostalgia", "deep desire"], hint: "sehnen (to yearn) + die Sucht (the craving). Sehnsucht nach etwas haben — one of German's famous untranslatables." },
        { id: "de-u57l2-derkummer", type: "vocab", front: "der Kummer", reading: "derkummer", meaning: "the grief", example: { jp: "Der Kummer war groß, aber mit der Zeit wurde es besser.", en: "The grief was great, but with time it got better." }, drill: { jp: "Der Kummer war sehr groß", en: "The grief was very great" }, accept: ["grief", "the grief", "sorrow", "the sorrow", "distress", "the distress", "heartache", "trouble"], hint: "Quiet, long-lasting sadness — the kind you carry around. Kummer haben; jemandem Kummer machen." },
      ],
    },
    {
      id: "de-u57l3",
      ...
      items: [
        { id: "de-u57l3-erschrecken", type: "vocab", front: "erschrecken", reading: "erschrecken", meaning: "to be startled", example: { jp: "Ich bin sehr erschrocken, als plötzlich jemand hinter mir stand.", en: "I was very startled when somebody suddenly stood behind me." }, drill: { jp: "Die Kinder erschrecken sehr leicht", en: "The children are startled very easily" }, accept: ["to be startled", "be startled", "to get a fright", "to be frightened", "to startle", "to scare"], hint: "It works both ways: ich erschrecke (I get a fright) and du erschreckst mich (you frighten me). Context decides." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u57l4-dasvertrauen", type: "vocab", front: "das Vertrauen", reading: "dasvertrauen", meaning: "the trust", example: { jp: "Ohne Vertrauen kann eine Gruppe nicht lange zusammen arbeiten.", en: "Without trust a group can't work together for long." }, drill: { jp: "Das Vertrauen war sehr groß", en: "The trust was very great" }, accept: ["trust", "the trust", "confidence", "the confidence", "faith", "the faith"], hint: "ver- + trauen (to dare). Vertrauen haben zu jemandem; das Vertrauen verlieren is the hard half." },
