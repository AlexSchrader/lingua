  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u24l1-diestelle", type: "vocab", front: "die Stelle", reading: "diestelle", meaning: "the position", example: { jp: "Die Stelle in der Firma ist frei.", en: "The position at the company is open." }, drill: { jp: "Die Stelle ist neu und gut", en: "The position is new and good" }, accept: ["the position", "position", "the job", "the post", "the vacancy"], hint: "Also simply a place or spot — an der Stelle means at that spot. For work it is the neutral word; der Job is borrowed and more casual." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u24l4-dasfach", type: "vocab", front: "das Fach", reading: "dasfach", meaning: "the subject", example: { jp: "Das Fach in der Schule ist neu.", en: "The subject at school is new." }, drill: { jp: "Das Fach ist für die Kinder schwer", en: "The subject is difficult for the children" }, accept: ["the subject", "subject", "the school subject", "the field"], hint: "Originally a compartment or pigeonhole, and it still means that. A specialist is a Fachmann — someone who lives in one compartment." },
        { id: "de-u24l4-dienote", type: "vocab", front: "die Note", reading: "dienote", meaning: "the grade", example: { jp: "Die Note für die Prüfung ist gut.", en: "The grade for the exam is good." }, drill: { jp: "Die Note im Zeugnis ist schlecht", en: "The grade on the report card is bad" }, accept: ["the grade", "grade", "the mark", "mark"], hint: "German grades run from 1 to 6 and 1 is the BEST — the opposite of what most systems do. The same word is a musical note." },
        { id: "de-u24l4-diehausaufgabe", type: "vocab", front: "die Hausaufgabe", reading: "diehausaufgabe", meaning: "the homework", example: { jp: "Die Hausaufgabe für morgen ist leicht.", en: "The homework for tomorrow is easy." }, drill: { jp: "Die Hausaufgabe dauert eine Stunde", en: "The homework takes an hour" }, accept: ["the homework", "homework", "the assignment"], hint: "Haus + u19's Aufgabe. Usually said in the plural — die Hausaufgaben machen — where English keeps it singular." },
        { id: "de-u24l4-daszeugnis", type: "vocab", front: "das Zeugnis", reading: "daszeugnis", meaning: "the report card", example: { jp: "Das Zeugnis kommt im Juli.", en: "The report card comes in July." }, drill: { jp: "Das Zeugnis ist sehr gut", en: "The report card is very good" }, accept: ["the report card", "report card", "the report", "the certificate", "the reference"], hint: "From Zeuge, a witness — the paper that testifies to what you did. An employer gives you one too, and in Germany it is legally required." },
        { id: "de-u24l4-diepause", type: "vocab", front: "die Pause", reading: "diepause", meaning: "the break", example: { jp: "Die Pause dauert zwanzig Minuten.", en: "The break lasts twenty minutes." }, drill: { jp: "Die Pause ist um zehn Uhr", en: "The break is at ten o'clock" }, accept: ["the break", "break", "the pause", "the interval"], hint: "School break, work break and the interval at the theatre, all one word. Eine Pause machen is to take a break." },
