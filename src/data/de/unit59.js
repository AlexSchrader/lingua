  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u59l1-andern", type: "vocab", front: "ändern", reading: "andern", meaning: "to change", example: { jp: "Wir müssen den Termin ändern, weil der Chef am Freitag im Urlaub ist.", en: "We have to change the appointment, because the boss is on holiday on Friday." }, drill: { jp: "Wir müssen den Termin ändern", en: "We have to change the appointment" }, accept: ["to change", "change", "to alter", "alter", "to modify", "to amend"], hint: "Of something you change on purpose. sich ändern = to change by itself: Das Wetter ändert sich." },
        { id: "de-u59l1-diegewohnheit", type: "vocab", front: "die Gewohnheit", reading: "diegewohnheit", meaning: "the habit", example: { jp: "Eine alte Gewohnheit kann man schwer ändern, auch wenn man es will.", en: "An old habit is hard to change, even when you want to." }, drill: { jp: "Die Gewohnheit kommt mit der Zeit", en: "The habit comes with time" }, accept: ["habit", "the habit", "custom", "the custom", "routine", "the routine"], hint: "From wohnen — what has moved in and lives with you. aus Gewohnheit = out of habit." },
        ...
        { id: "de-u59l1-derzeitraum", type: "vocab", front: "der Zeitraum", reading: "derzeitraum", meaning: "the period", example: { jp: "In einem Zeitraum von zehn Jahren ist die Stadt sehr stark gewachsen.", en: "Over a period of ten years the city grew very strongly." }, drill: { jp: "Der Zeitraum dauert zehn Jahre", en: "The period lasts ten years" }, accept: ["period", "the period", "period of time", "the period of time", "time frame", "span", "the span"], hint: "die Zeit + der Raum (the space): a space of time. Longer and more formal than plain die Zeit." },
        ...
        { id: "de-u59l1-anders", type: "vocab", front: "anders", reading: "anders", meaning: "differently", example: { jp: "Heute macht er alles anders als noch vor einem Jahr.", en: "Today he does everything differently than a year ago." }, drill: { jp: "Heute machen wir es anders", en: "Today we are doing it differently" }, accept: ["differently", "different", "otherwise", "in a different way"], hint: "The adverb, so it never takes an ending: etwas anders machen. andere (u10) is the adjective 'other'; ändern in this lesson is the verb." },
      ],
    },
    {
      id: "de-u59l2",
    ...
    },
    {
      ...
      items: [
        { id: "de-u59l3-vergehen", type: "vocab", front: "vergehen", reading: "vergehen", meaning: "to go by", example: { jp: "Die Zeit vergeht sehr schnell, wenn die Arbeit interessant ist.", en: "Time goes by very quickly when the work is interesting." }, drill: { jp: "Die Jahre vergehen sehr schnell", en: "The years go by very quickly" }, accept: ["to pass", "pass", "to go by", "go by", "to elapse", "to fade"], hint: "Of TIME and of pain: Der Schmerz vergeht. For a person walking past, German uses vorbeigehen." },
        ...
        { id: "de-u59l3-vorlaufig", type: "vocab", front: "vorläufig", reading: "vorlaufig", meaning: "provisional", example: { jp: "Das ist vorläufig genug, aber im Herbst müssen wir es genau untersuchen.", en: "That is enough for now, but in autumn we have to examine it closely." }, drill: { jp: "Das ist vorläufig genug", en: "That is enough for now" }, accept: ["provisional", "provisionally", "for now", "temporary", "tentative", "interim"], hint: "vor + laufen: running ahead of the real answer. The exact opposite of endgültig, one card up." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u59l4-diekindheit", type: "vocab", front: "die Kindheit", reading: "diekindheit", meaning: "the childhood", example: { jp: "In meiner Kindheit gab es kein Internet, und wir haben den ganzen Tag gespielt.", en: "In my childhood there was no internet, and we played all day." }, drill: { jp: "Die Kindheit vergeht sehr schnell", en: "Childhood passes very quickly" }, accept: ["childhood", "the childhood"], hint: "das Kind + -heit, the same ending as die Wahrheit and die Freiheit. Always feminine." },
        { id: "de-u59l4-erneut", type: "vocab", front: "erneut", reading: "erneut", meaning: "again (formal, anew)", example: { jp: "Wir haben erneut gefragt, aber die Antwort war leider immer noch nein.", en: "We asked again, but unfortunately the answer was still no." }, drill: { jp: "Wir haben erneut gefragt", en: "We asked again" }, accept: ["again", "once again", "anew", "afresh", "a second time", "renewed"], hint: "From neu: made new again. More formal than noch einmal — the word of reports and news bulletins." },
      ],
    },
  ],
};
