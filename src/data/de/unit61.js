  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u61l1-diegenehmigung", type: "vocab", front: "die Genehmigung", reading: "diegenehmigung", meaning: "the permit", example: { jp: "Ohne Genehmigung darf man hier nicht bauen, auch kein kleines Haus.", en: "Without a permit you may not build here, not even a small house." }, drill: { jp: "Die Genehmigung ist sehr wichtig", en: "The permit is very important" }, accept: ["permit", "the permit", "permission", "the permission", "approval", "the approval", "authorization"], hint: "From genehmigen, to approve. The official cousin of die Erlaubnis — this is the one that arrives on paper." },
        { id: "de-u61l1-dievorschrift", type: "vocab", front: "die Vorschrift", reading: "dievorschrift", meaning: "the regulation", example: { jp: "Die Vorschrift ist sehr alt, aber sie gilt in der Firma immer noch.", en: "The regulation is very old, but it still applies in the company." }, drill: { jp: "Die Vorschrift ist sehr streng", en: "The regulation is very strict" }, accept: ["regulation", "the regulation", "rule", "the rule", "instruction", "the instruction", "requirement"], hint: "vor + schreiben: what is written out in front of you to follow. Harder than die Regel — it comes from an authority." },
        { id: "de-u61l1-derantrag", type: "vocab", front: "der Antrag", reading: "derantrag", meaning: "the formal request", example: { jp: "Der Antrag muss bis Freitag bei der Behörde sein, sonst ist er zu spät.", en: "The application has to be at the authority by Friday, otherwise it is too late." }, drill: { jp: "Der Antrag liegt bei der Behörde", en: "The application is with the authority" }, accept: ["application", "the application", "request", "the request", "proposal", "the proposal", "motion"], hint: "an + tragen: to carry a request to somebody. einen Antrag stellen = to submit an application." },
        { id: "de-u61l1-gultig", type: "vocab", front: "gültig", reading: "gultig", meaning: "valid", example: { jp: "Die Karte ist einen Monat gültig, danach muss man eine neue kaufen.", en: "The ticket is valid for a month; after that you have to buy a new one." }, drill: { jp: "Die Karte ist noch gültig", en: "The ticket is still valid" }, accept: ["valid", "in force", "current", "effective"], hint: "From gelten (u58), to hold: what still holds. der Ausweis ist gültig; ungültig = invalid." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u61l2-dieverantwortung", type: "vocab", front: "die Verantwortung", reading: "dieverantwortung", meaning: "the responsibility", example: { jp: "Die Verantwortung liegt beim Chef, auch wenn er an dem Tag nicht da war.", en: "The responsibility lies with the boss, even if he wasn't there that day." }, drill: { jp: "Die Verantwortung ist sehr groß", en: "The responsibility is very great" }, accept: ["responsibility", "the responsibility", "accountability", "the accountability"], hint: "From antworten: the person who has to answer for it. Verantwortung übernehmen = to take responsibility." },
        { id: "de-u61l2-diestrafe", type: "vocab", front: "die Strafe", reading: "diestrafe", meaning: "the punishment", example: { jp: "Die Strafe war hoch, obwohl er sonst immer sehr vorsichtig fährt.", en: "The fine was high, although he otherwise always drives very carefully." }, drill: { jp: "Die Strafe war sehr hoch", en: "The fine was very high" }, accept: ["punishment", "the punishment", "penalty", "the penalty", "fine", "the fine", "sentence"], hint: "A fine and a punishment in one word: eine Strafe zahlen. bestrafen = to punish." },
        { id: "de-u61l2-diegebuhr", type: "vocab", front: "die Gebühr", reading: "diegebuhr", meaning: "the fee", example: { jp: "Für den Ausweis muss man eine Gebühr bezahlen, und sie ist nicht gering.", en: "You have to pay a fee for the ID card, and it isn't small." }, drill: { jp: "Die Gebühr ist sehr hoch", en: "The fee is very high" }, accept: ["fee", "the fee", "charge", "the charge", "levy", "the levy"], hint: "Official money for an official service: die Gebühr für den Pass. Not der Preis, which is what a shop asks." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u61l3-derlarm", type: "vocab", front: "der Lärm", reading: "derlarm", meaning: "the noise", example: { jp: "Der Lärm von der Straße ist so laut, dass ich nachts nicht schlafen kann.", en: "The noise from the street is so loud that I can't sleep at night." }, drill: { jp: "Der Lärm war sehr laut", en: "The noise was very loud" }, accept: ["noise", "the noise", "din", "the din", "racket", "the racket"], hint: "UNWANTED noise only. A sound you like is der Klang; a neutral one is das Geräusch. Lärm machen = to make a racket." },
        ...
        { id: "de-u61l3-dieordnung", type: "vocab", front: "die Ordnung", reading: "dieordnung", meaning: "the order", example: { jp: "In der Küche muss Ordnung sein, sonst findet am Morgen niemand etwas.", en: "There has to be order in the kitchen, otherwise nobody finds anything in the morning." }, drill: { jp: "Die Ordnung ist sehr wichtig", en: "Order is very important" }, accept: ["order", "the order", "tidiness", "the tidiness", "system", "the system"], hint: "From ordentlich, which you already have. In Ordnung! = OK, fine — one of the commonest German replies." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u61l4-dasgericht", type: "vocab", front: "das Gericht", reading: "dasgericht", meaning: "the court", example: { jp: "Der Streit ging am Ende vor Gericht, weil niemand nachgeben wollte.", en: "In the end the quarrel went to court, because nobody wanted to give in." }, drill: { jp: "Das Gericht ist in der Stadt", en: "The court is in the city" }, accept: ["court", "the court", "court of law", "the court of law", "tribunal", "dish", "the dish"], hint: "THE SAME WORD as the das Hauptgericht on a menu: a dish, and a court of law. Both mean 'what is set before you'. vor Gericht gehen = to go to court." },
        { id: "de-u61l4-deranwalt", type: "vocab", front: "der Anwalt", reading: "deranwalt", meaning: "the lawyer", example: { jp: "Ohne Anwalt geht er nicht vor Gericht, denn die Gesetze sind für ihn zu kompliziert.", en: "He won't go to court without a lawyer, because the laws are too complicated for him." }, drill: { jp: "Der Anwalt kommt am Montag", en: "The lawyer is coming on Monday" }, accept: ["lawyer", "the lawyer", "attorney", "the attorney", "solicitor", "the solicitor", "barrister"], hint: "Plural Anwälte; a woman is die Anwältin. The one who is 'called to' your side." },
        { id: "de-u61l4-derrichter", type: "vocab", front: "der Richter", reading: "derrichter", meaning: "the judge", example: { jp: "Der Richter hat sehr lange gefragt, bevor er ein Urteil gesprochen hat.", en: "The judge asked questions for a very long time before he gave a verdict." }, drill: { jp: "Der Richter war sehr streng", en: "The judge was very strict" }, accept: ["judge", "the judge", "magistrate", "the magistrate"], hint: "From richten, to judge or to set straight. das Gericht is built on the same root — the place where richten happens." },
        { id: "de-u61l4-derzeuge", type: "vocab", front: "der Zeuge", reading: "derzeuge", meaning: "the witness", example: { jp: "Der Zeuge hat den Unfall gesehen, aber er war sehr weit weg.", en: "The witness saw the accident, but he was very far away." }, drill: { jp: "Der Zeuge hat den Unfall gesehen", en: "The witness saw the accident" }, accept: ["witness", "the witness", "eyewitness", "the eyewitness"], hint: "From zeugen, to bear witness — the same root that sits inside überzeugen (u51), to convince. Plural Zeugen." },
        { id: "de-u61l4-dasurteil", type: "vocab", front: "das Urteil", reading: "dasurteil", meaning: "the verdict", example: { jp: "Das Urteil war sehr hart, aber die Zeitungen haben es unterstützt.", en: "The verdict was very harsh, but the newspapers supported it." }, drill: { jp: "Das Urteil war sehr hart", en: "The verdict was very harsh" }, accept: ["verdict", "the verdict", "judgement", "the judgement", "judgment", "sentence", "the sentence"], hint: "ur- + der Teil: the original dividing of right from wrong. das Vorurteil (u51) is judging before this happens." },
        { id: "de-u61l4-dieaussage", type: "vocab", front: "die Aussage", reading: "dieaussage", meaning: "the statement", example: { jp: "Die Aussage von dem Zeugen war wichtig, weil sonst niemand dort war.", en: "The witness's statement was important, because nobody else was there." }, drill: { jp: "Die Aussage war sehr wichtig", en: "The statement was very important" }, accept: ["statement", "the statement", "testimony", "the testimony", "evidence", "the evidence", "assertion"], hint: "aus + sagen: what you say out. In court it is testimony; in ordinary German it is the point a sentence makes." },
      ],
    },
  ],
};
