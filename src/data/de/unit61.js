  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u61l4-derrichter", type: "vocab", front: "der Richter", reading: "derrichter", meaning: "the judge", example: { jp: "Der Richter hat sehr lange gefragt, bevor er ein Urteil gesprochen hat.", en: "The judge asked questions for a very long time before he gave a verdict." }, drill: { jp: "Der Richter kommt um zehn Uhr", en: "The judge comes at ten o'clock" }, accept: ["judge", "the judge", "magistrate", "the magistrate"], hint: "From richten, to judge or to set straight. das Gericht is built on the same root — the place where richten happens." },
        ...
        { id: "de-u61l4-dasurteil", type: "vocab", front: "das Urteil", reading: "dasurteil", meaning: "the verdict", example: { jp: "Das Urteil war sehr hart, aber die Zeitungen haben es unterstützt.", en: "The verdict was very harsh, but the newspapers supported it." }, drill: { jp: "Das Urteil kommt am Freitag", en: "The verdict comes on Friday" }, accept: ["verdict", "the verdict", "judgement", "the judgement", "judgment", "sentence", "the sentence"], hint: "ur- + der Teil: the original dividing of right from wrong. das Vorurteil (u51) is judging before this happens." },
