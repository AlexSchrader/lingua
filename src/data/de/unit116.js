  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u116l3-fuerchten", type: "vocab", front: "fürchten", reading: "furchten", meaning: "to be afraid of", example: { jp: "Wir fürchten, dass die Antwort zu spät kommt.", en: "We fear that the answer will come too late." }, drill: { jp: "Sie muss die Wahrheit nicht fürchten", en: "She does not have to fear the truth" }, accept: ["to fear", "fear", "to dread", "dread", "to be afraid of"], hint: "Ich fürchte, … is the polite way to deliver bad news, exactly like English 'I'm afraid…'. Reflexive sich fürchten vor is to be frightened of." },
