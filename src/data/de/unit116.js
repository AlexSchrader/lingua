...
// FREE: gelacht, gesagt, gemacht, geworden
export const DE_UNIT116 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Name the strong reactions — hating, fearing, laughing, shouting and falling in love — as verbs rather than as adjectives.",
      items: [
        { id: "de-u116l3-hassen", type: "vocab", front: "hassen", reading: "hassen", meaning: "to hate", example: { jp: "Ich hasse es zu warten, wenn niemand etwas sagt.", en: "I hate waiting when nobody says anything." }, drill: { jp: "Viele Leute hassen langes Warten", en: "Many people hate long waiting" }, accept: ["to hate", "hate", "to loathe", "loathe", "to detest"], hint: "Tier A rank 911 and tier C at once: its partner lieben is taught in u4 and this half was missing. der Hass is the noun." },
        { id: "de-u116l3-fuerchten", type: "vocab", front: "fürchten", reading: "fuerchten", meaning: "to fear", example: { jp: "Wir fürchten, dass die Antwort zu spät kommt.", en: "We fear that the answer will come too late." }, drill: { jp: "Sie muss die Wahrheit nicht fürchten", en: "She does not have to fear the truth" }, accept: ["to fear", "fear", "to dread", "dread", "to be afraid of"], hint: "Rank 1597. Ich fürchte, … is the polite way to deliver bad news, exactly like English 'I'm afraid…'. Reflexive sich fürchten vor is to be frightened of." },
