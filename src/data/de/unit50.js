  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u50l2-diekalte", type: "vocab", front: "die Kälte", reading: "diekalte", meaning: "the cold", example: { jp: "Die Kälte im Winter ist hart.", en: "The cold in winter is harsh." }, drill: { jp: "Ich finde die Kälte nicht gut", en: "I do not find the cold good" }, accept: ["the cold", "the coldness", "the chill"], hint: "The noun from kalt. The opposite is die Wärme / die Hitze." },
