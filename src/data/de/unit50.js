...
// regnen (the VERB — der Regen itself was never carded, so l4 takes it), Schnee,
// Wind, warm/kalt; this unit takes the storm/sky/season vocabulary
...
// stürmisch→sturmisch. Examples and drills use only vocab introduced at or before u50:
  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u50l1-derblitz", type: "vocab", front: "der Blitz", reading: "derblitz", meaning: "the lightning", example: { jp: "Der Blitz war sehr hell.", en: "The lightning was very bright." }, drill: { jp: "Der Blitz kommt vor dem Donner", en: "The lightning comes before the thunder" }, accept: ["lightning", "the lightning", "the flash"], hint: "A bolt of lightning, and a camera flash. blitzschnell = lightning-fast." },
        ...
        { id: "de-u50l1-derhagel", type: "vocab", front: "der Hagel", reading: "derhagel", meaning: "the hail", example: { jp: "Im Sommer gibt es oft Hagel.", en: "In summer there is often hail." }, drill: { jp: "Der Hagel fällt laut", en: "The hail falls loudly" }, accept: ["hail", "the hail"], hint: "Ice falling from the sky. The verb is hageln: es hagelt." },
        { id: "de-u50l1-derschauer", type: "vocab", front: "der Schauer", reading: "derschauer", meaning: "the shower", example: { jp: "Am Morgen kommt ein kurzer Schauer.", en: "A short shower comes in the morning." }, drill: { jp: "Der Schauer ist kurz", en: "The shower is short" }, accept: ["shower", "the shower", "the rain shower"], hint: "A brief burst of rain. Not a bathroom shower (that's die Dusche)." },
      ],
    },
    {
      id: "de-u50l2",
      ...
      items: [
        { id: "de-u50l2-derfrost", type: "vocab", front: "der Frost", reading: "derfrost", meaning: "the frost", example: { jp: "In der Nacht gibt es Frost.", en: "There is frost during the night." }, drill: { jp: "Der Frost ist stark", en: "The frost is severe" }, accept: ["frost", "the frost"], hint: "Freezing weather. Related to frieren and English 'frost'." },
        { id: "de-u50l2-diekalte", type: "vocab", front: "die Kälte", reading: "diekalte", meaning: "the cold", example: { jp: "Die Kälte im Winter ist hart.", en: "The cold in winter is harsh." }, drill: { jp: "Die Kälte kommt in der Nacht", en: "The cold comes during the night" }, accept: ["the cold", "the coldness", "the chill"], hint: "The noun from kalt. The opposite is die Wärme / die Hitze." },
        { id: "de-u50l2-diehitze", type: "vocab", front: "die Hitze", reading: "diehitze", meaning: "the heat", example: { jp: "Die Hitze im Sommer ist groß.", en: "The heat in summer is great." }, drill: { jp: "Die Hitze ist heute sehr groß", en: "The heat is very great today" }, accept: ["the heat"], hint: "The noun from heiß. Stronger than die Wärme (warmth)." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u50l3-sonnig", type: "vocab", front: "sonnig", reading: "sonnig", meaning: "sunny", example: { jp: "Morgen ist es sonnig und warm.", en: "Tomorrow it is sunny and warm." }, drill: { jp: "Der Tag ist sonnig", en: "The day is sunny" }, accept: ["sunny"], hint: "From die Sonne, the sun." },
        ...
        { id: "de-u50l3-mild", type: "vocab", front: "mild", reading: "mild", meaning: "mild", example: { jp: "Der Winter ist mild und kurz.", en: "The winter is mild and short." }, drill: { jp: "Das Wetter ist mild", en: "The weather is mild" }, accept: ["mild", "gentle"], hint: "Of weather, and of taste: milder Käse, mild cheese." },
      ],
    },
    {
      id: "de-u50l4",
      ...
      items: [
        { id: "de-u50l4-derregen", type: "vocab", front: "der Regen", reading: "derregen", meaning: "the rainfall", example: { jp: "Der Regen ist heute kalt.", en: "The rain is cold today." }, drill: { jp: "Der Regen kommt am Abend", en: "The rain comes in the evening" }, accept: ["rain", "the rain", "rainfall", "the rainfall"], hint: "The NOUN behind A1's regnen (to rain), and the first half of der Regenbogen. Glossed 'rainfall' only so the canonical gloss does not collide with u8 regnen; 'rain' is accepted." },
        ...
        { id: "de-u50l4-dergrad", type: "vocab", front: "der Grad", reading: "dergrad", meaning: "the degree (of temperature)", example: { jp: "Heute sind es zwanzig Grad.", en: "It is twenty degrees today." }, drill: { jp: "Der Grad zeigt die Temperatur", en: "The degree shows the temperature" }, accept: ["degree", "the degree"], hint: "Degrees of temperature, and of an angle. Stays singular after a number: 20 Grad." },
        ...
        { id: "de-u50l4-diejahreszeit", type: "vocab", front: "die Jahreszeit", reading: "diejahreszeit", meaning: "the season", example: { jp: "Der Herbst ist eine schöne Jahreszeit.", en: "Autumn is a beautiful season." }, drill: { jp: "Die Jahreszeit ist schön", en: "The season is beautiful" }, accept: ["season", "the season"], hint: "das Jahr (year) + die Zeit (time). The four: Frühling, Sommer, Herbst, Winter." },
      ],
    },
  ],
};
