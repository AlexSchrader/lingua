  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u50l2-diehitze", type: "vocab", front: "die Hitze", reading: "diehitze", meaning: "the heat", example: { jp: "Die Hitze im Sommer ist groß.", en: "The heat in summer is great." }, drill: { jp: "Die Hitze ist hart", en: "The heat is harsh" }, accept: ["the heat"], hint: "The noun from heiß. Stronger than die Wärme (warmth)." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u50l4-dergrad", type: "vocab", front: "der Grad", reading: "dergrad", meaning: "the degree", example: { jp: "Heute sind es zwanzig Grad.", en: "It is twenty degrees today." }, drill: { jp: "Der Grad zeigt, wie warm es ist", en: "The degree shows how warm it is" }, accept: ["degree", "the degree"], hint: "Degrees of temperature, and of an angle. Stays singular after a number: 20 Grad." },
