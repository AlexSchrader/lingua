...
export const DE_UNIT26 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u26l2-derberg", type: "vocab", front: "der Berg", reading: "derberg", meaning: "the mountain", example: { jp: "Der Berg im Winter ist weiß.", en: "The mountain is white in winter." }, drill: { jp: "Der Berg ist sehr hoch", en: "The mountain is very high" }, accept: ["the mountain", "mountain", "the hill"], hint: "Covers both mountain and sizeable hill. In die Berge fahren means to go to the mountains — the plural, always, for the holiday." },
        { id: "de-u26l2-dersee", type: "vocab", front: "der See", reading: "dersee", meaning: "the lake", example: { jp: "Der See im Wald ist tief.", en: "The lake in the forest is deep." }, drill: { jp: "Der See ist im Sommer warm", en: "The lake is warm in summer" }, accept: ["the lake", "lake"], hint: "The gender does the work here: DER See is a lake, DIE See is the sea. Same spelling, opposite bodies of water — one of the sharpest article traps in German." },
        { id: "de-u26l2-derfluss", type: "vocab", front: "der Fluss", reading: "derfluss", meaning: "the river", example: { jp: "Der Fluss in der Stadt ist lang.", en: "The river in the city is long." }, drill: { jp: "Der Fluss ist heute sehr kalt", en: "The river is very cold today" }, accept: ["the river", "river"], hint: "From fließen, to flow. Note the double s after a short u — Fluss, but the plural lengthens the vowel: die Flüsse." },
        { id: "de-u26l2-dasmeer", type: "vocab", front: "das Meer", reading: "dasmeer", meaning: "the sea", example: { jp: "Das Meer ist heute sehr ruhig.", en: "The sea is very calm today." }, drill: { jp: "Das Meer ist im Winter kalt", en: "The sea is cold in winter" }, accept: ["the sea", "sea", "the ocean", "ocean"], hint: "The everyday word for the sea, and the safe one — die See also means it but collides with der See, the lake. Use Meer and avoid the trap." },
        { id: "de-u26l2-dieinsel", type: "vocab", front: "die Insel", reading: "dieinsel", meaning: "the island", example: { jp: "Die Insel im Meer ist klein.", en: "The island in the sea is small." }, drill: { jp: "Die Insel ist im Sommer voll", en: "The island is crowded in summer" }, accept: ["the island", "island", "the isle"], hint: "From Latin insula, the same root that gives English insulate. The s is pronounced like a z: IN-zel." },
        { id: "de-u26l2-derstrand", type: "vocab", front: "der Strand", reading: "derstrand", meaning: "the beach", example: { jp: "Der Strand ist im Sommer sehr voll.", en: "The beach is very crowded in summer." }, drill: { jp: "Der Strand ist lang und ruhig", en: "The beach is long and quiet" }, accept: ["the beach", "beach", "the shore"], hint: "The same word as English strand, which kept only the poetic sense of a shore. Am Strand is at the beach." },
      ],
    },
    {
      id: "de-u26l3",
      ...
      items: [
        { id: "de-u26l3-dastier", type: "vocab", front: "das Tier", reading: "dastier", meaning: "the animal", example: { jp: "Das Tier im Garten ist klein.", en: "The animal in the garden is small." }, drill: { jp: "Das Tier trinkt viel Wasser", en: "The animal drinks a lot of water" }, accept: ["the animal", "animal", "the creature"], hint: "Neuter, whatever the animal's own gender. Ein Haustier is a pet — literally a house-animal, built the transparent German way." },
        { id: "de-u26l3-derhund", type: "vocab", front: "der Hund", reading: "derhund", meaning: "the dog", example: { jp: "Der Hund läuft schnell in den Park.", en: "The dog runs quickly into the park." }, drill: { jp: "Der Hund schläft unter dem Tisch", en: "The dog is sleeping under the table" }, accept: ["the dog", "dog"], hint: "Cognate with English hound, which narrowed to one kind of dog while German kept them all. The final d is said as a t: Hunt." },
        { id: "de-u26l3-diekatze", type: "vocab", front: "die Katze", reading: "diekatze", meaning: "the cat", example: { jp: "Die Katze schläft auf dem Sofa.", en: "The cat is sleeping on the sofa." }, drill: { jp: "Die Katze trinkt die Milch", en: "The cat drinks the milk" }, accept: ["the cat", "cat"], hint: "Feminine as a species, whatever the individual cat is. Der Kater is specifically a tomcat — and also a hangover." },
        { id: "de-u26l3-daspferd", type: "vocab", front: "das Pferd", reading: "daspferd", meaning: "the horse", example: { jp: "Das Pferd läuft sehr schnell.", en: "The horse runs very fast." }, drill: { jp: "Das Pferd ist sehr groß", en: "The horse is very big" }, accept: ["the horse", "horse"], hint: "Another Pf- word, both letters sounded. Nothing like English horse — it comes from a late Latin word for a post-horse." },
        { id: "de-u26l3-diekuh", type: "vocab", front: "die Kuh", reading: "diekuh", meaning: "the cow", example: { jp: "Die Kuh gibt uns die Milch.", en: "The cow gives us the milk." }, drill: { jp: "Die Kuh ist sehr ruhig", en: "The cow is very calm" }, accept: ["the cow", "cow"], hint: "A close cognate of cow, with the h only lengthening the u — Kuuh, never a breathy sound. Plural die Kühe." },
        ...
        { id: "de-u26l3-dermensch", type: "vocab", front: "der Mensch", reading: "dermensch", meaning: "the human being", example: { jp: "Der Mensch ist kein Tier.", en: "A human being is not an animal." }, drill: { jp: "Der Mensch und das Tier leben zusammen", en: "Humans and animals live together" }, accept: ["human", "human being", "person", "man"], hint: "One person as a member of the species; die Menschen is people in the broad sense, while die Leute (u10) is the everyday crowd. Mensch! alone is a mild \"wow\" or \"oh come on\"." },
      ],
    },
    {
      id: "de-u26l4",
      ...
      items: [
        { id: "de-u26l4-dervogel", type: "vocab", front: "der Vogel", reading: "dervogel", meaning: "the bird", example: { jp: "Der Vogel singt im Frühling.", en: "The bird sings in spring." }, drill: { jp: "Der Vogel fliegt über den Baum", en: "The bird flies over the tree" }, accept: ["the bird", "bird"], hint: "V is said as an f in German: FOH-gel. Plural umlauts to die Vögel, and fliegen from u23 is what it does." },
        { id: "de-u26l4-derfisch", type: "vocab", front: "der Fisch", reading: "derfisch", meaning: "the fish", example: { jp: "Der Fisch schwimmt im See.", en: "The fish swims in the lake." }, drill: { jp: "Der Fisch ist klein und grau", en: "The fish is small and grey" }, accept: ["the fish", "fish"], hint: "Unlike English, it takes a normal plural — die Fische, several fish. The animal and the food are the same word, as in English." },
        { id: "de-u26l4-diemaus", type: "vocab", front: "die Maus", reading: "diemaus", meaning: "the mouse", example: { jp: "Die Maus ist sehr klein und grau.", en: "The mouse is very small and grey." }, drill: { jp: "Die Maus läuft sehr schnell", en: "The mouse runs very fast" }, accept: ["the mouse", "mouse"], hint: "Cognate with mouse and it changes the same way: die Maus, die Mäuse, exactly as mouse becomes mice. The computer one is also die Maus." },
        { id: "de-u26l4-diebiene", type: "vocab", front: "die Biene", reading: "diebiene", meaning: "the bee", example: { jp: "Die Biene fliegt in den Garten.", en: "The bee flies into the garden." }, drill: { jp: "Die Biene ist sehr klein", en: "The bee is very small" }, accept: ["the bee", "bee"], hint: "Two syllables — BEE-neh — where English has one. Der Honig is what it makes, and Bienenstich is both a bee sting and a cake." },
        { id: "de-u26l4-dasnest", type: "vocab", front: "das Nest", reading: "dasnest", meaning: "the nest", example: { jp: "Das Nest im Baum ist klein.", en: "The nest in the tree is small." }, drill: { jp: "Das Nest im Gras ist leer", en: "The nest in the grass is empty" }, accept: ["the nest", "nest"], hint: "Spelled and meant exactly as in English. Said of a village it is mildly rude — ein kleines Nest is a place where nothing happens." },
        { id: "de-u26l4-wild", type: "vocab", front: "wild", reading: "wild", meaning: "wild", example: { jp: "Das Tier im Wald ist wild.", en: "The animal in the forest is wild." }, drill: { jp: "Die Katze ist nicht wild", en: "The cat is not wild" }, accept: ["wild", "feral", "untamed"], hint: "Same spelling as English, said with a short i and a hard d — vilt. As a noun, das Wild is game in the hunting sense." },
      ],
    },
  ],
};
