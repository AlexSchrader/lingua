  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u26l4-derfisch", type: "vocab", front: "der Fisch", reading: "derfisch", meaning: "the fish", example: { jp: "Der Fisch schwimmt in dem See.", en: "The fish swims in the lake." }, drill: { jp: "Der Fisch schwimmt in dem See", en: "The fish swims in the lake" }, accept: ["the fish", "fish"], hint: "Unlike English, it takes a normal plural — die Fische, several fish. The animal and the food are the same word, as in English." },
        ...
        { id: "de-u26l4-dasnest", type: "vocab", front: "das Nest", reading: "dasnest", meaning: "the nest", example: { jp: "Das Nest in dem Baum ist klein.", en: "The nest in the tree is small." }, drill: { jp: "Das Nest in dem Baum ist klein", en: "The nest in the tree is small" }, accept: ["the nest", "nest"], hint: "Spelled and meant exactly as in English. Said of a village it is mildly rude — ein kleines Nest is a place where nothing happens." },
        { id: "de-u26l4-wild", type: "vocab", front: "wild", reading: "wild", meaning: "wild", example: { jp: "Das Tier in dem Wald ist wild.", en: "The animal in the forest is wild." }, drill: { jp: "Das Tier in dem Wald ist wild", en: "The animal in the forest is wild" }, accept: ["wild", "feral", "untamed"], hint: "Same spelling as English, said with a short i and a hard d — vilt. As a noun, das Wild is game in the hunting sense." },
      ],
    },
  ],
};
