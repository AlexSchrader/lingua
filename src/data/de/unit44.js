  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u44l3-drucken", type: "vocab", front: "drücken", reading: "drucken", meaning: "to press", example: { jp: "Du musst hier lange drücken.", en: "You have to press here for a long time." }, drill: { jp: "Die Kinder drücken auf die Klingel", en: "The children press the doorbell" }, accept: ["to press", "to push a button", "to squeeze"], hint: "A button, a hand, a hug. The other half of the door pair with ziehen." },
