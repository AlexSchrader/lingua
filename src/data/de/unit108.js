...
export const DE_UNIT108 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u108l3-wieerwahnt", type: "vocab", front: "wie erwähnt", reading: "wieerwahnt", meaning: "as mentioned (earlier)", example: { jp: "Wie erwähnt liegt der Befund seit einer Woche vor.", en: "As mentioned, the findings have been available for a week." }, drill: { jp: "Wie erwähnt liegt der Bericht bereits vor", en: "As mentioned the report is already available" }, accept: ["as mentioned", "as noted", "as said", "as already mentioned"], hint: "The polite way to repeat yourself. Fuller: wie bereits erwähnt, wie oben erwähnt." },
        ...
        { id: "de-u108l3-anfuhren", type: "vocab", front: "anführen", reading: "anfuhren", meaning: "to cite (bring forward as support)", example: { jp: "Beide Seiten führen dieselbe Studie an und kommen zu verschiedenen Schlüssen.", en: "Both sides cite the same study and reach different conclusions." }, drill: { jp: "Er kann dafür kein einziges Beispiel anführen", en: "He cannot cite a single example for it" }, accept: ["to cite", "to bring forward", "to adduce", "to quote"], hint: "Separable: führt … an. It also means to lead a group — der Anführer is the ringleader." },
