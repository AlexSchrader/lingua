...
export const DE_UNIT108 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u108l4-imwesentlichen", type: "vocab", front: "im Wesentlichen", reading: "imwesentlichen", meaning: "essentially (in the main, leaving detail aside)", example: { jp: "Im Wesentlichen sagen beide Berichte dasselbe, nur die Zahlen stehen anders da.", en: "Essentially both reports say the same thing; only the figures are presented differently." }, drill: { jp: "Im Wesentlichen sagen alle dasselbe", en: "Essentially everyone says the same thing" }, accept: ["essentially", "in the main", "basically", "substantially"], hint: "Note the capital W. It concedes the detail before you make the point — the written twer of eigentlich." },
