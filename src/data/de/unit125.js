  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u125l3-derfluegel", type: "vocab", front: "der Flügel", reading: "derfluegel", meaning: "the wing", example: { jp: "Der Vogel hat einen Flügel gebrochen und kann deshalb im Moment nicht fliegen.", en: "The bird has broken a wing and for that reason cannot fly at the moment." }, drill: { jp: "Der Flügel war leider gebrochen", en: "The wing was unfortunately broken" }, accept: ["wing", "the wing", "grand piano", "blade"], hint: "Tier D. From fliegen (u23). Also the wing of a building, a wing in politics, and — oddly — a grand piano, whose shape gave it the name." },
        { id: "de-u125l3-derschwanz", type: "vocab", front: "der Schwanz", reading: "derschwanz", meaning: "the tail", example: { jp: "Der Hund hat den ganzen Abend mit dem Schwanz gegen den Tisch geschlagen.", en: "The dog beat its tail against the table all evening." }, drill: { jp: "Der Schwanz ist ziemlich lang", en: "The tail is rather long" }, accept: ["tail", "the tail"], hint: "Tier D. Plural Schwänze. ⚠️ Like English 'tail', it has a vulgar secondary sense in casual speech — use it of animals and you will never have a problem." },
        { id: "de-u125l3-diepfote", type: "vocab", front: "die Pfote", reading: "diepfote", meaning: "the paw", example: { jp: "Die Katze hält eine Pfote hoch, weil sie sich am Stein verletzt hat.", en: "The cat is holding up one paw, because it has injured itself on the stone." }, drill: { jp: "Die Pfote war ganz nass", en: "The paw was completely wet" }, accept: ["paw", "the paw"], hint: "Tier D. Only of animals with soft feet — a horse has ein Huf, a bird ein Fuß. Said of a person's hand it is rude but affectionate." },
