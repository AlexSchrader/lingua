  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u125l1-dastal", type: "vocab", front: "das Tal", reading: "dastal", meaning: "the valley", example: { jp: "Vom Gipfel aus sieht man das ganze Tal bis zum Fluss.", en: "From the summit you can see the whole valley down to the river." }, drill: { jp: "Vom Gipfel sieht man das Tal", en: "From the summit you can see the valley" }, accept: ["valley", "the valley", "dale", "the dale"], hint: "Plural Täler. The low ground under der Gipfel in this lesson. It is the Tal in Neandertal, and the root under English 'dale'." },
      ],
    },
    {
      id: "de-u125l2",
      ...
      items: [
        ...
        { id: "de-u125l2-dienadel", type: "vocab", front: "die Nadel", reading: "dienadel", meaning: "the needle", example: { jp: "Ohne Nadel und Faden bekommst du den Knopf nicht wieder an.", en: "Without a needle and thread you won't get the button back on." }, drill: { jp: "Die Nadel liegt neben dem Faden", en: "The needle lies next to the thread" }, accept: ["needle", "the needle", "pin", "the pin"], hint: "Sewing, knitting, a pine needle and the needle of a compass alike. With der Faden and der Knopf in this lesson it is the whole sewing kit." },
      ],
    },
    {
      id: "de-u125l3",
      ...
      items: [
        ...
        { id: "de-u125l3-dashorn", type: "vocab", front: "das Horn", reading: "dashorn", meaning: "the horn", example: { jp: "Das Tier hat ein Horn verloren, sonst geht es ihm gut.", en: "The animal has lost a horn, otherwise it is doing fine." }, drill: { jp: "Das Horn ist leider abgebrochen", en: "The horn has unfortunately broken off" }, accept: ["horn", "the horn", "antler"], hint: "Plural Hörner. The horn on an animal and the brass instrument are the same word; a car's horn is die Hupe." },
      ],
    },
    {
      id: "de-u125l4",
      ...
      items: [
        ...
        { id: "de-u125l4-derneid", type: "vocab", front: "der Neid", reading: "derneid", meaning: "the envy", example: { jp: "Hinter dem freundlichen Lächeln steckte purer Neid.", en: "Behind the friendly smile there was pure envy." }, drill: { jp: "Der Neid steckte hinter dem Lächeln", en: "Envy was behind the smile" }, accept: ["envy", "the envy", "jealousy", "the jealousy"], hint: "No plural. neidisch is the adjective. Wanting what another has — eifersüchtig (u68) is fearing to lose what is yours." },
      ],
    },
  ],
};
