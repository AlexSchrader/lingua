  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u63l2-erfahren", type: "vocab", front: "erfahren", reading: "erfahren", meaning: "to find out (from someone)", example: { jp: "Wir haben erst gestern erfahren, dass er umgezogen ist.", en: "We only found out yesterday that he has moved." }, drill: { jp: "Wir erfahren die Wahrheit erst morgen", en: "We only find out the truth tomorrow" }, accept: ["to find out", "find out", "to learn", "to hear", "to experience", "to undergo"], hint: "Not from a book but from someone: etwas von jemandem erfahren. die Erfahrung (u24) is the experience you end up with." },
      ],
    },
    {
      id: "de-u63l3",
      ...
      items: [
        ...
        { id: "de-u63l3-kurzlich", type: "vocab", front: "kürzlich", reading: "kurzlich", meaning: "the other day", example: { jp: "Kürzlich war mein alter Lehrer wieder in der Stadt.", en: "Recently my old teacher was in town again." }, drill: { jp: "Kürzlich waren wir am Meer", en: "Recently we were at the sea" }, accept: ["recently", "lately", "the other day"], hint: "From kurz. Same sense as neulich (u28); kürzlich is the more written of the two." },
      ],
    },
    {
      id: "de-u63l4",
      ...
      items: [
        ...
        { id: "de-u63l4-dieerinnerung", type: "vocab", front: "die Erinnerung", reading: "dieerinnerung", meaning: "the memory of something", example: { jp: "Die Erinnerung an den ersten Tag in der Schule ist bei ihr noch sehr stark.", en: "Her memory of the first day at school is still very strong for her." }, drill: { jp: "Die Erinnerung an damals bleibt stark", en: "The memory of back then stays strong" }, accept: ["memory", "the memory", "recollection", "the recollection", "reminder"], hint: "ONE remembered thing — das Gedächtnis (u63) is the faculty that stores them. die Erinnerung AN etwas. From sich erinnern (u48)." },
      ],
    },
  ],
};
