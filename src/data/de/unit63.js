  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u63l2-dereindruck", type: "vocab", front: "der Eindruck", reading: "dereindruck", meaning: "the impression", example: { jp: "Ich habe den Eindruck, dass sie mit der Arbeit zufrieden ist.", en: "I have the impression that she is happy with the work." }, drill: { jp: "Der Eindruck war sehr stark", en: "The impression was very strong" }, accept: ["impression", "the impression"], hint: "Fixed phrase: den Eindruck haben, dass … — to have the impression that …" },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u63l4-vermissen", type: "vocab", front: "vermissen", reading: "vermissen", meaning: "to miss", example: { jp: "Seit dem Sommer vermisse ich meine Nachbarn sehr.", en: "Since the summer I have missed my neighbours a lot." }, drill: { jp: "Wir vermissen die alte Wohnung", en: "We miss the old flat" }, accept: ["to miss", "to long for"], hint: "Missing a person or thing you care about. Missing a train is verpassen (u23)." },
