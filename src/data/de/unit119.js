  ...
  lessons: [
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Place an event on a timeline with one word — already, never, ever, again, this time round, or at the close.",
      items: [
        { id: "de-u119l1-bereits", type: "vocab", front: "bereits", reading: "bereits", meaning: "already (formal)", example: { jp: "Die Antwort liegt bereits vor, aber niemand darf sie vor Montag lesen.", en: "The answer is already available, but nobody may read it before Monday." }, drill: { jp: "Der Brief ist bereits im Haus", en: "The letter is already in the house" }, accept: ["already", "as early as", "by now", "previously"], hint: "The written twin of schon (u73): identical in meaning, but bereits belongs in a report and schon in speech. Never stressed the way schon can be." },
        { id: "de-u119l1-niemals", type: "vocab", front: "niemals", reading: "niemals", meaning: "never (emphatic)", example: { jp: "So etwas würde sie niemals sagen, auch dann nicht, wenn man sie sehr lange fragt.", en: "She would never say a thing like that, not even if you question her for a very long time." }, drill: { jp: "Das darf niemals wieder passieren", en: "That must never happen again" }, accept: ["never", "not ever", "at no time"], hint: "nie (u12) with -mals added for weight — the difference is emphasis, not meaning. Niemals! on its own is a flat refusal." },
        { id: "de-u119l1-jemals", type: "vocab", front: "jemals", reading: "jemals", meaning: "ever", example: { jp: "Wenn das Haus jemals verkauft wird, dann sicher nicht zu diesem Preis.", en: "If the house is ever sold, then certainly not at this price." }, drill: { jp: "Hat er jemals davon erzählt", en: "Has he ever told about it" }, accept: ["ever", "at any time", "at any point"], hint: "The positive counterpart of niemals, and it lives in questions and conditions — exactly where English uses 'ever'. In a plain statement German drops it." },
        { id: "de-u119l1-nochmal", type: "vocab", front: "nochmal", reading: "nochmal", meaning: "once more", example: { jp: "Du kannst den Text nochmal lesen, weil in der Mitte etwas Wichtiges steht.", en: "You can read the text once more, because something important is in the middle." }, drill: { jp: "Sag das bitte nochmal langsam", en: "Please say that once more slowly" }, accept: ["once more", "again", "one more time", "over again"], hint: "A spoken contraction of noch einmal, and written as one word. In anything formal, write noch einmal out." },
        { id: "de-u119l1-diesmal", type: "vocab", front: "diesmal", reading: "diesmal", meaning: "this time", example: { jp: "Diesmal beginnt die Gruppe früher, und deshalb ist am Abend fast alles fertig.", en: "This time the group begins earlier, and so by the evening almost everything is finished." }, drill: { jp: "Diesmal machen wir es besser", en: "This time we will do it better" }, accept: ["this time", "on this occasion"], hint: "dieses Mal written as one word. The family runs on: letztes Mal, nächstes Mal, jedes Mal — those stay two words." },
        { id: "de-u119l1-derschluss", type: "vocab", front: "der Schluss", reading: "derschluss", meaning: "the close", example: { jp: "Zum Schluss hat er noch einmal mit allen gesprochen, die an dem Abend geholfen haben.", en: "At the close he spoke again with everyone who had helped that evening." }, drill: { jp: "Der Schluss kam viel zu schnell", en: "The close came much too quickly" }, accept: ["close", "the close", "end", "the end", "conclusion", "ending"], hint: "zum Schluss is the standard 'finally' in a speech. ⚠️ der Abschluss (u24) and der Anschluss (u77) were both taught before the base noun." },
      ],
    },
    {
      id: "de-u119l2",
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Say when something happened relative to now — earlier today, before that, sooner, on the way, as far as you know, and what you take with you.",
      items: [
        { id: "de-u119l2-zuvor", type: "vocab", front: "zuvor", reading: "zuvor", meaning: "previously", example: { jp: "Kurz zuvor wusste niemand im Raum von diesem Ergebnis.", en: "Shortly beforehand nobody in the room knew of this result." }, drill: { jp: "Wir haben uns zuvor kurz gesprochen", en: "We spoke briefly beforehand" }, accept: ["beforehand", "before", "previously", "prior to that", "earlier"], hint: "Points back from a moment in the past, not from now — for 'before now' German uses vorher or früher. nie zuvor is 'never before'." },
        { id: "de-u119l2-vorhin", type: "vocab", front: "vorhin", reading: "vorhin", meaning: "just now", example: { jp: "Vorhin stand noch ein Wagen vor dem Haus, und jetzt ist die Straße wieder leer.", en: "A car was standing in front of the house just now, and now the street is empty again." }, drill: { jp: "Vorhin war das Geschäft noch auf", en: "Just now the shop was still open" }, accept: ["just now", "a moment ago", "earlier on", "a short while ago"], hint: "A narrow window — earlier today, within hours. Not interchangeable with vorher (u28), which is 'before' relative to some other event." },
        { id: "de-u119l2-eher", type: "vocab", front: "eher", reading: "eher", meaning: "more likely", example: { jp: "Das Problem ist eher die Zeit als das Geld.", en: "The problem is rather the time than the money." }, drill: { jp: "Ich bleibe eher zu Hause", en: "I would rather stay at home" }, accept: ["rather", "sooner", "more likely", "instead", "earlier"], hint: "Literally the comparative of früh, so it can mean 'earlier' — but in modern use it almost always means 'rather' or 'more likely'. je eher, desto besser: the sooner the better." },
        { id: "de-u119l2-unterwegs", type: "vocab", front: "unterwegs", reading: "unterwegs", meaning: "on the way", example: { jp: "Der Wagen ist seit einer Stunde unterwegs und sollte bald bei euch sein.", en: "The van has been on the way for an hour and should be with you soon." }, drill: { jp: "Die Antwort ist schon unterwegs", en: "The answer is already on the way" }, accept: ["on the way", "en route", "out and about", "travelling", "traveling"], hint: "Also 'out and about' generally — viel unterwegs sein is to travel a lot for work. Never takes an article." },
        { id: "de-u119l2-soweit", type: "vocab", front: "soweit", reading: "soweit", meaning: "as far as", example: { jp: "Soweit ich weiß, ist die Sache seit dem Sommer in Ordnung.", en: "As far as I know, the matter has been in order since the summer." }, drill: { jp: "Soweit ich sehe ist alles fertig", en: "As far as I can see everything is finished" }, accept: ["as far as", "so far as", "in so far as", "to that extent"], hint: "Soweit ich weiß is the standard hedge — 'as far as I know'. Written apart, so weit, it is literal distance: so weit wie möglich." },
        { id: "de-u119l2-mitnehmen", type: "vocab", front: "mitnehmen", reading: "mitnehmen", meaning: "to take along", example: { jp: "Du sollst den Schlüssel mitnehmen, sonst stehst du am Abend vor der Tür.", en: "You should take the key along, otherwise you will be standing outside the door in the evening." }, drill: { jp: "Wir wollen die Kinder mitnehmen", en: "We want to take the children along" }, accept: ["to take along", "take along", "to take with", "to give a lift", "to take away"], hint: "Separable: nimmt mit, and with zu it infixes — mitzunehmen. Of a person it also means to give them a lift." },
      ],
    },
    {
      id: "de-u119l3",
      ...
      items: [
        ...
        { id: "de-u119l3-pro", type: "vocab", front: "pro", reading: "pro", meaning: "per", example: { jp: "Pro Woche kommen etwa dreißig Briefe an.", en: "About thirty letters arrive per week." }, drill: { jp: "Wir zahlen zehn Euro pro Stunde", en: "We pay ten euros per hour" }, accept: ["per", "a", "each", "for every"], hint: "Takes no article at all — pro Tag, pro Person. Also stands alone as 'for': das Pro und Contra, the pros and cons." },
        { id: "de-u119l3-diemilliarde", type: "vocab", front: "die Milliarde", reading: "diemilliarde", meaning: "the billion", example: { jp: "Das Programm kostet den Staat mehr als eine Milliarde Euro im Jahr.", en: "The programme costs the state more than a billion euros a year." }, drill: { jp: "Die Milliarde ist tausend Millionen", en: "A billion is a thousand million" }, accept: ["billion", "a billion", "the billion", "thousand million", "milliard"], hint: "⚠️ A false friend worth the warning: eine Milliarde is 1 000 000 000, the English BILLION. eine Billion in German is a thousand times more again." },
      ],
    },
    {
      id: "de-u119l4",
      ...
      items: [
        { id: "de-u119l4-zweiter", type: "vocab", front: "zweiter", reading: "zweiter", meaning: "second (in order)", example: { jp: "Der zweite Weg ist länger, aber er führt nicht durch die Stadt und ist deshalb oft schneller.", en: "The second route is longer, but it doesn't go through the city and is therefore often faster." }, drill: { jp: "Ein zweiter Versuch war besser", en: "A second attempt was better" }, accept: ["second", "the second"], hint: "Ordinals below 20 take -t on the number (zwei → zweit-) and then an adjective ending; from 20 up it is -st (zwanzigste). Written as a figure with a full stop: der 2. Mai." },
        { id: "de-u119l4-weiterer", type: "vocab", front: "weiterer", reading: "weiterer", meaning: "further (additional)", example: { jp: "Ein weiterer Grund ist das Geld, aber darüber will im Moment niemand sprechen.", en: "A further reason is the money, but nobody wants to speak about that at the moment." }, drill: { jp: "Ein weiterer Tag ging vorbei", en: "A further day went by" }, accept: ["further", "additional", "another", "more"], hint: "Built on weiter, which is itself a front nowhere in de — routed to the lead with the rest. ohne weiteres means 'without further ado' — one of the commonest set phrases in written German." },
        { id: "de-u119l4-einziger", type: "vocab", front: "einziger", reading: "einziger", meaning: "only (sole)", example: { jp: "Der einzige Zug am Morgen fährt um sechs, und wer ihn nicht nimmt, wartet sehr lange.", en: "The only train in the morning leaves at six, and whoever doesn't take it waits a very long time." }, drill: { jp: "Das war mein einziger Fehler", en: "That was my only mistake" }, accept: ["only", "sole", "single", "one and only"], hint: "From eins. Careful with the near-twin einzeln, which means 'individual' or 'separate' — einzige is 'the only', einzelne 'the individual ones'." },
        { id: "de-u119l4-diereihe", type: "vocab", front: "die Reihe", reading: "diereihe", meaning: "the row", example: { jp: "In der ersten Reihe war kein Platz mehr frei, deshalb haben wir uns nach hinten gesetzt.", en: "In the first row there was no seat left free, so we sat at the back." }, drill: { jp: "Die Reihe war schon ganz voll", en: "The row was already completely full" }, accept: ["row", "the row", "line", "series", "queue"], hint: "A row of seats and also a series — eine Reihe von Fragen. Ich bin an der Reihe means 'it is my turn'." },
        { id: "de-u119l4-dieliste", type: "vocab", front: "die Liste", reading: "dieliste", meaning: "the list", example: { jp: "Auf der Liste stehen mehr Namen als Plätze, und deshalb muss jemand die Liste noch einmal lesen.", en: "On the list there are more names than places, and so somebody has to read the list again." }, drill: { jp: "Die Liste hängt an der Tür", en: "The list hangs on the door" }, accept: ["list", "the list", "roster", "register"], hint: "auf der Liste stehen is to be on the list — auf, not 'in'. ⚠️ Untaught despite u76 (Auf dem Amt) and u83 (Post und Lieferung), both of which are full of lists." },
        { id: "de-u119l4-derabschnitt", type: "vocab", front: "der Abschnitt", reading: "derabschnitt", meaning: "the section", example: { jp: "Der zweite Abschnitt des Textes ist deutlich schwerer als der erste.", en: "The second section of the text is clearly harder than the first." }, drill: { jp: "Der Abschnitt ist deutlich schwerer geworden", en: "The section has become clearly harder" }, accept: ["section", "the section", "paragraph", "the paragraph", "stretch", "stage", "segment"], hint: "ab + schneiden: a piece cut off. A section of a text, a stretch of road, and a stage of a life: ein neuer Lebensabschnitt." },
      ],
    },
  ],
};
