  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u76l4-dieoffnungszeit", type: "vocab", front: "die Öffnungszeit", reading: "dieoffnungszeit", meaning: "the opening hours", example: { jp: "Die Öffnungszeit ist von acht bis zwölf.", en: "The opening hours are from eight to twelve." }, drill: { jp: "Die Öffnungszeit ist sehr kurz", en: "The opening hours are very short" }, accept: ["opening hours", "the opening hours", "opening time", "the opening time"], hint: "Usually plural on a door sign: die Öffnungszeiten. öffnen = to open." },
      ],
    },
  ],
};
