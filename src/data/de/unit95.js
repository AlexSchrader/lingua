  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u95l3-dieuberlieferung", type: "vocab", front: "die Überlieferung", reading: "dieuberlieferung", meaning: "the tradition handed down", example: { jp: "Nach der Überlieferung stand hier eine Kirche, aber die Forschung hat davon bisher nichts gefunden.", en: "According to tradition a church stood here, but research has found nothing of it so far." }, drill: { jp: "Die Überlieferung kommt aus dem Mittelalter", en: "The handed-down tradition comes from the Middle Ages" }, accept: ["tradition handed down", "the tradition", "oral tradition", "transmission", "lore", "received account"], hint: "über + liefern (u83): handed across the generations. Distinct from die Tradition (u40), which is a practice — this is the account of what happened." },
