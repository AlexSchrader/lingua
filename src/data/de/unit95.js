...
export const DE_UNIT95 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u95l3-daserbe", type: "vocab", front: "das Erbe", reading: "daserbe", meaning: "the heritage", example: { jp: "Das Erbe ist schwer zu tragen, weil jede Seite etwas anderes daraus machen will.", en: "The heritage is hard to bear, because each side wants to make something different of it." }, drill: { jp: "Das Erbe bleibt bis heute wichtig", en: "The heritage remains important to this day" }, accept: ["heritage", "the heritage", "inheritance", "the inheritance", "legacy", "the legacy"], hint: "Both an inheritance in money and a cultural legacy — das Weltkulturerbe is the UNESCO term. The heir is der Erbe, masculine; the thing inherited is das Erbe." },
        ...
        { id: "de-u95l3-diegedenkstatte", type: "vocab", front: "die Gedenkstätte", reading: "diegedenkstatte", meaning: "the memorial site", example: { jp: "Die Gedenkstätte liegt außerhalb der Stadt, trotzdem kommen jedes Jahr Tausende von Schülern.", en: "The memorial site lies outside the city; nevertheless thousands of school students come every year." }, drill: { jp: "Die Gedenkstätte liegt außerhalb der Stadt", en: "The memorial site lies outside the city" }, accept: ["memorial site", "the memorial site", "memorial", "place of remembrance"], hint: "gedenken (to commemorate) + die Stätte (place). The word German uses for the sites of the twentieth century — a Gedenkstätte is for remembering, a Denkmal for honouring." },
