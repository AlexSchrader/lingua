  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u2l1-gutenacht", type: "vocab", front: "gute Nacht", reading: "gutenacht", meaning: "good night", example: { jp: "Gute Nacht, Anna!", en: "Good night, Anna!" }, drill: { jp: "Gute Nacht und bis morgen", en: "Good night and see you tomorrow" }, accept: ["good night", "night"], hint: "The odd one out: gute without -n, because Nacht is feminine. And it is a PARTING, never a greeting — you say it going to bed." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u2l2-wiegehts", type: "vocab", front: "wie geht's", reading: "wiegehts", meaning: "how are you", example: { jp: "Hallo Max, wie geht's?", en: "Hello Max, how are you?" }, drill: { jp: "Guten Morgen Thomas wie geht's", en: "Good morning Thomas how are you" }, accept: ["how are you", "how's it going", "how are things"], hint: "Short for wie geht es dir. Learn it as one chunk now; the grammar behind it (it goes TO me) waits for the dative in u14." },
        ...
        { id: "de-u2l2-schlecht", type: "vocab", front: "schlecht", reading: "schlecht", meaning: "bad / badly", example: { jp: "Die Zeitung ist schlecht.", en: "The newspaper is bad." }, drill: { jp: "Das Buch ist sehr schlecht", en: "The book is very bad" }, accept: ["bad", "badly", "poor"], hint: "The opposite of gut. Answering wie geht's with schlecht invites a real conversation, so Germans use it sparingly." },
        { id: "de-u2l2-sehr", type: "vocab", front: "sehr", reading: "sehr", meaning: "very", example: { jp: "Die Küche ist sehr modern.", en: "The kitchen is very modern." }, drill: { jp: "Die Schule ist sehr groß", en: "The school is very big" }, accept: ["very", "really"], hint: "Goes in front of the word it strengthens: sehr gut, sehr schön, sehr müde." },
        { id: "de-u2l2-so", type: "vocab", front: "so", reading: "so", meaning: "so / like this", example: { jp: "Das ist so gut.", en: "That is so good." }, drill: { jp: "Die Schule ist so schön", en: "The school is so beautiful" }, accept: ["so", "like this", "this way", "that"], hint: "In front of an adjective it means \"that much\": so gut, so schnell, so spät. On its own it means \"like this\" — Mach es so." },
      ],
    },
    {
      id: "de-u2l3",
      ...
      items: [
        ...
        { id: "de-u2l3-bisbald", type: "vocab", front: "bis bald", reading: "bisbald", meaning: "see you soon", example: { jp: "Tschüss und bis bald!", en: "Bye and see you soon!" }, drill: { jp: "Danke Anna und bis bald", en: "Thanks Anna and see you soon" }, accept: ["see you soon", "until soon", "so long"], hint: "bis = until. The whole bis-family works the same way: bis bald, bis später, bis morgen." },
        { id: "de-u2l3-bisspater", type: "vocab", front: "bis später", reading: "bisspater", meaning: "see you later", example: { jp: "Bis später, Thomas!", en: "See you later, Thomas!" }, drill: { jp: "Tschüss Anna und bis später", en: "Bye Anna and see you later" }, accept: ["see you later", "until later", "later"], hint: "Later the same day. Uses später, the comparative of spät from u1 — literally \"until later\"." },
        { id: "de-u2l3-bismorgen", type: "vocab", front: "bis morgen", reading: "bismorgen", meaning: "see you tomorrow", example: { jp: "Bis morgen, Anna!", en: "See you tomorrow, Anna!" }, drill: { jp: "Auf Wiedersehen und bis morgen", en: "Goodbye and see you tomorrow" }, accept: ["see you tomorrow", "until tomorrow"], hint: "Watch the pair: der Morgen is the morning, morgen is tomorrow. Capital letter, different word." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u2l4-gern", type: "vocab", front: "gern", reading: "gern", meaning: "gladly / with pleasure", example: { jp: "Anna hört gern Musik.", en: "Anna likes listening to music." }, drill: { jp: "Die Kinder hören gern Musik", en: "The children like listening to music" }, accept: ["gladly", "with pleasure", "willingly"], hint: "Put gern after a verb and it becomes \"likes doing\": hört gern = likes listening. The most useful little word in German." },
        ...
        { id: "de-u2l4-ja", type: "vocab", front: "ja", reading: "ja", meaning: "yes", example: { jp: "Ja, das ist die Schule.", en: "Yes, that is the school." }, drill: { jp: "Ja das Buch ist sehr gut", en: "Yes the book is very good" }, accept: ["yes", "yeah"], hint: "Said YAH. Germans also drop ja into the middle of a sentence to mean \"as you know\"." },
