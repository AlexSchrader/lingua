...
| slot | unit | title |
|---|---|---|
| 88 | `de-u88` | Argument and persuasion |
| 89 | `de-u89` | Evidence and sources |
| 90 | `de-u90` | Systems and abstraction |
| 91 | `de-u91` | Nuance and degree |
| 92 | `de-u92` | Politics and law |
| 93 | `de-u93` | Business and negotiation |
| 94 | `de-u94` | Science and technology |
| 95 | `de-u95` | History and culture |
| 96 | `de-u96` | Arts and criticism |
| 97 | `de-u97` | Ethics and responsibility |
| 98 | `de-u98` | Risk and uncertainty |
| 99 | `de-u99` | Identity and society |
| 100 | `de-u100` | Career and organisations |
...
- `annähernd` — u113 · approximately (close to)
...
- `das Ausmaß` — u111 · extent (scale of something bad)
...
- `der Ausschuss` — u110 · committee (working sub-group)
...
- `der Grenzwert` — u101 · limit value (legal maximum)
...
- `der Höhepunkt` — u111 · peak (highest point of a development)
...
- `der Schwerpunkt` — u111 · main focus (centre of gravity)
...
- `der Spielraum` — u113 · leeway (room to act within the limits)
- `der Sport` — u45 · sport
...
- `der Umfang` — u111 · scope (how much a thing covers)
...
- `der Vorwurf` — u105 · reproach (accusation held against someone)
...
- `die Chancengleichheit` — u103 · equality of opportunity
- `die Darstellung` — u104 · portrayal (how something is presented)
- `die Datei` — u33 · file
...
- `die Emission` — u101 · emission (released into the air)
...
- `die Fachkraft` — u102 · qualified professional (trained specialist worker)
...
- `die Farbe` — u8 · colour
- `die Fassung` — u105 · composure (self-control in a hard moment)
- `die Feile` — u46 · the file
- `die Fernbedienung` — u64 · the remote control
- `die Feuerwehr` — u81 · the fire brigade
- `die Figur` — u104 · character (person in a story)
...
- `die Instanz` — u110 · level of authority (court or administrative stage)
...
- `die Spanne` — u111 · range (gap between two values)
...
- `die Ungleichheit` — u103 · inequality (unequal distribution)
...
- `die Zuversicht` — u105 · confidence (quiet trust that it will turn out well)
...
- `entgegenkommen` — u109 · to accommodate (move towards the other side)
...
- `umarmen` — u85 · to hug
- `umfassen` — u107 · to comprise (cover in extent)
...
- `verzerren` — u104 · to distort (bend out of true)
...
- `vorbeugen` — u102 · to prevent (head something off)
...
- `weitgehend` — u108 · largely (to a great extent)
- `welcher` — u12 · which
- `wem` — u14 · whom — dative
- `wen` — u13 · whom — object
...
**u101 · Die globale Umweltpolitik** (24) — `das Gipfeltreffen`, `das Abkommen`, `das Protokoll`, `ratifizieren`, `unterzeichnen`, `beitreten`, `die Vorgabe`, `die Auflage`, `der Grenzwert`, `überwachen`, `die Sanktion`, `verschärfen`, `die Emission`, `der Ausstieg`, `die Wende`, `senken`, `einsparen`, `der Fußabdruck`, `die Klimaneutralität`, `die Kreislaufwirtschaft`, `der Anreiz`, `die Abgabe`, `wirksam`, `messbar`

**u102 · Das Gesundheitssystem** (24) — `die Krankenkasse`, `die Zuzahlung`, `die Versorgung`, `der Zugang`, `flächendeckend`, `die Kapazität`, `der Hausarzt`, `der Facharzt`, `verschreiben`, `der Befund`, `die Wartezeit`, `ambulant`, `die Klinik`, `die Station`, `stationär`, `das Personal`, `die Fachkraft`, `entlassen`, `pflegebedürftig`, `betreuen`, `die Prävention`, `vorbeugen`, `überlastet`, `der Engpass`

**u103 · Bildung und Forschung** (24) — `die Grundschule`, `das Gymnasium`, `die Schulform`, `der Übergang`, `die Chancengleichheit`, `benachteiligt`, `die Hochschule`, `der Studiengang`, `das Studium`, `der Dozent`, `das Seminar`, `die Promotion`, `das Institut`, `der Lehrstuhl`, `erforschen`, `die Drittmittel`, `das Stipendium`, `der Nachwuchs`, `die Fortbildung`, `die Nachhilfe`, `der Lehrplan`, `vermitteln`, `begabt`, `die Ungleichheit`

**u104 · Medien und Erzählung** (24) — `die Recherche`, `das Zitat`, `die Meldung`, `der Journalist`, `der Kommentar`, `seriös`, `die Erzählung`, `die Darstellung`, `die Sichtweise`, `die Figur`, `der Verlauf`, `die Perspektive`, `zuspitzen`, `verzerren`, `der Aufhänger`, `inszenieren`, `reißerisch`, `der Boulevard`, `die Reichweite`, `die Plattform`, `der Algorithmus`, `die Empörung`, `der Skandal`, `die Debatte`

**u105 · Gemischte Gefühle** (24) — `die Ambivalenz`, `zwiespältig`, `die Zerrissenheit`, `die Wehmut`, `die Ernüchterung`, `nachdenklich`, `der Groll`, `die Reue`, `der Vorwurf`, `die Scham`, `die Verlegenheit`, `gekränkt`, `überfordert`, `aufgewühlt`, `verunsichert`, `angespannt`, `mulmig`, `die Fassung`, `das Mitleid`, `das Mitgefühl`, `die Schadenfreude`, `wohlwollend`, `gerührt`, `die Zuversicht`
...
**u107 · Die Schriftsprache** (24) — `bezüglich`, `gemäß`, `laut`, `mittels`, `seitens`, `ungeachtet`, `im Rahmen`, `im Zuge`, `im Hinblick auf`, `zur Verfügung stellen`, `in Anspruch nehmen`, `Bezug nehmen`, `lässt sich`, `ist zu beachten`, `vorsehen`, `vorliegen`, `in Kraft treten`, `vornehmen`, `die Angelegenheit`, `der Sachverhalt`, `der Wortlaut`, `umfassen`, `beruhen`, `verfügen`

**u108 · Den Text zusammenhalten** (24) — `somit`, `dementsprechend`, `demnach`, `zudem`, `ferner`, `insbesondere`, `hingegen`, `demgegenüber`, `im Gegensatz dazu`, `abgesehen davon`, `geschweige denn`, `unter anderem`, `eingangs`, `im Folgenden`, `erwähnen`, `erläutern`, `anführen`, `abschließend`, `weitgehend`, `tendenziell`, `in der Regel`, `größtenteils`, `darauf hindeuten`, `mutmaßlich`

**u109 · Der höfliche Abstand** (24) — `verehrt`, `geschätzt`, `hochachtungsvoll`, `mit freundlichen Grüßen`, `verbleiben`, `im Voraus`, `vortragen`, `ersuchen`, `nahelegen`, `um Verständnis bitten`, `sich gedulden`, `dienen`, `mit Verlaub`, `bei allem Respekt`, `wohlgemerkt`, `die Nachsicht`, `entgegenkommen`, `die Kulanz`, `danken`, `anerkennen`, `die Auszeichnung`, `würdigen`, `die Wertschätzung`, `zuvorkommend`

**u110 · Die amtliche Stimme** (24) — `der Bescheid`, `die Verfügung`, `die Richtlinie`, `die Satzung`, `der Erlass`, `das Merkblatt`, `das Gremium`, `der Ausschuss`, `die Sitzung`, `tagen`, `die Tagesordnung`, `einberufen`, `der Antragsteller`, `die Instanz`, `die Anhörung`, `die Stellungnahme`, `der Vermerk`, `zur Kenntnis nehmen`, `die Bekanntmachung`, `bekannt geben`, `die Pressemitteilung`, `amtlich`, `im Namen von`, `verlautbaren`

**u111 · Entwicklung und Verlauf** (24) — `der Anstieg`, `der Rückgang`, `rückläufig`, `stetig`, `sprunghaft`, `stagnieren`, `einsetzen`, `anhalten`, `nachlassen`, `ausbleiben`, `vorübergehend`, `der Höhepunkt`, `das Ausmaß`, `die Größenordnung`, `der Umfang`, `die Spanne`, `der Schwerpunkt`, `die Schwankung`, `sich abzeichnen`, `absehbar`, `der Trend`, `der Wendepunkt`, `abflachen`, `dauerhaft`
...
**u113 · Zeit und Menge im Text** (24) — `derzeit`, `bislang`, `vorerst`, `nunmehr`, `fortan`, `zeitgleich`, `unlängst`, `neuerdings`, `geraume Zeit`, `einstweilen`, `hierzulande`, `hierbei`, `etliche`, `zahlreich`, `vereinzelt`, `allesamt`, `nahezu`, `ein Vielfaches`, `binnen`, `spätestens`, `annähernd`, `die Obergrenze`, `der Höchststand`, `der Spielraum`
