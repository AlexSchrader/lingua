...
// das Ziel (u18). Rejected as the same lexeme: die Natur (~u2 natürlich), die Wirkung
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u34l3-dermuell", type: "vocab", front: "der Müll", reading: "dermull", meaning: "rubbish / waste", example: { jp: "Wir machen zu viel Müll.", en: "We make too much rubbish." }, drill: { jp: "Der Müll liegt hier", en: "The rubbish is lying here" }, accept: ["rubbish", "waste", "garbage", "trash"], hint: "Uncountable, like English rubbish — never der Mülle. Germans separate it obsessively, which is why Mülltrennung is a real word." },
        { id: "de-u34l3-schuetzen", type: "vocab", front: "schützen", reading: "schutzen", meaning: "to protect", example: { jp: "Wir schützen die Luft, damit die Kinder gesund bleiben.", en: "We protect the air so that the children stay healthy." }, drill: { jp: "Wir schützen die Umwelt zusammen", en: "We protect the environment together" }, accept: ["to protect", "to safeguard", "protect"], hint: "A1's u26 taught proteger — no, German has only this one: schützen vor is to protect against. der Schutz is the noun." },
