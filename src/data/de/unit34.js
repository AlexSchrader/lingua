  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u34l1-entdecken", type: "vocab", front: "entdecken", reading: "entdecken", meaning: "to discover", example: { jp: "Die Kinder entdecken einen kleinen See.", en: "The children discover a small lake." }, drill: { jp: "Wir entdecken einen neuen Weg", en: "We discover a new path" }, accept: ["to discover", "to find out", "discover"], hint: "ent- plus decken, to cover — literally to un-cover. The same ent- turns up in entwickeln in lesson 4." },
      ],
    },
    {
      id: "de-u34l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u34l3-dasklima", type: "vocab", front: "das Klima", reading: "dasklima", meaning: "climate", example: { jp: "Das Klima ist hier sehr warm.", en: "The climate is very warm here." }, drill: { jp: "Das Klima ist für die Pflanzen gut", en: "The climate is good for the plants" }, accept: ["climate"], hint: "KLEE-ma. Distinct from das Wetter (u8): the weather is today, the climate is the long pattern behind it." },
      ],
    },
    {
      id: "de-u34l4",
