  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u11l3-dasfieber", type: "vocab", front: "das Fieber", reading: "dasfieber", meaning: "fever / temperature", example: { jp: "Das Kind hat Fieber.", en: "The child has a fever." }, accept: ["fever", "temperature", "a fever"], hint: "FEE-ber, with the ie of hier (u1). Fieber haben takes no article at all — the same bare pattern as Hunger haben (u6)." },
        { id: "de-u11l3-derhusten", type: "vocab", front: "der Husten", reading: "derhusten", meaning: "cough", example: { jp: "Ich habe Husten.", en: "I have a cough." }, accept: ["cough", "a cough", "the cough"], hint: "HOOS-ten. Like Fieber and Hunger it goes bare after haben. The verb husten is the same word doing the other job." },
      ],
    },
    {
      id: "de-u11l4",
      ...
      items: [
        ...
        { id: "de-u11l4-dieerkaeltung", type: "vocab", front: "die Erkältung", reading: "dieerkaltung", meaning: "a cold", example: { jp: "Ich habe eine Erkältung.", en: "I have a cold." }, accept: ["a cold", "cold", "the cold"], hint: "Built on kalt (u8) — literally a becoming-cold. Note it takes eine, unlike Husten and Fieber, which go bare." },
        { id: "de-u11l4-derdurst", type: "vocab", front: "der Durst", reading: "derdurst", meaning: "thirst", example: { jp: "Ich habe Durst.", en: "I am thirsty." }, accept: ["thirst", "thirsty"], hint: "The twin of der Hunger (u6): German HAS thirst rather than IS thirsty. Ich habe Durst, never Ich bin durstig in ordinary speech." },
      ],
    },
  ],
};
