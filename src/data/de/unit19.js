  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u19l1-derschuler", type: "vocab", front: "der Schüler", reading: "derschuler", meaning: "the pupil", example: { jp: "Die Schüler sind heute sehr ruhig.", en: "The pupils are very quiet today." }, accept: ["the pupil", "the student", "the schoolchild"], hint: "A school pupil. Someone at university is der Student — German keeps the two apart, English does not." },
        { id: "de-u19l1-derstudent", type: "vocab", front: "der Student", reading: "derstudent", meaning: "the university student", example: { jp: "Mein Bruder ist Student in Berlin.", en: "My brother is a student in Berlin." }, accept: ["the university student", "the student"], hint: "No article after ist for a role: er ist Student, not ein Student. Stress the end: stu-DENT." },
        { id: "de-u19l1-dieklasse", type: "vocab", front: "die Klasse", reading: "dieklasse", meaning: "the class", example: { jp: "In meiner Klasse sind zwanzig Schüler.", en: "There are twenty pupils in my class." }, accept: ["the class", "the year group", "the classroom"], hint: "Both the group of pupils and the room. As an exclamation, Klasse! means great." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u19l2-fragen", type: "vocab", front: "fragen", reading: "fragen", meaning: "to ask", example: { jp: "Der Schüler fragt den Lehrer.", en: "The pupil asks the teacher." }, accept: ["to ask", "to ask a question"], hint: "The person asked is accusative: er fragt DEN Lehrer. The noun is die Frage, a question." },
        { id: "de-u19l2-antworten", type: "vocab", front: "antworten", reading: "antworten", meaning: "to answer", example: { jp: "Der Lehrer antwortet dem Schüler.", en: "The teacher answers the pupil." }, accept: ["to answer", "to reply"], hint: "Mirror image of fragen: this one takes the DATIVE — er antwortet DEM Schüler. The noun is die Antwort." },
        ...
        { id: "de-u19l2-diesprache", type: "vocab", front: "die Sprache", reading: "diesprache", meaning: "the language", example: { jp: "Deutsch ist eine schwere Sprache.", en: "German is a difficult language." }, accept: ["the language", "the speech"], hint: "From sprechen, u1 — the thing that is spoken." },
      ],
    },
    {
      id: "de-u19l3",
      ...
      items: [
        ...
        { id: "de-u19l3-lesen", type: "vocab", front: "lesen", reading: "lesen", meaning: "to read", example: { jp: "Mein Vater liest die Zeitung.", en: "My father reads the newspaper." }, accept: ["to read"], hint: "Vowel shift in er/sie: ich lese, but er liest. One of a small group that swaps e for ie." },
        ...
        { id: "de-u19l3-uben", type: "vocab", front: "üben", reading: "uben", meaning: "to practise", example: { jp: "Ich übe jetzt für die Prüfung.", en: "I am practising for the exam now." }, accept: ["to practise", "to practice", "to rehearse"], hint: "Short and very common. You may type uben or üben — the umlaut folds." },
        ...
        { id: "de-u19l3-erklaren", type: "vocab", front: "erklären", reading: "erklaren", meaning: "to explain", example: { jp: "Der Lehrer erklärt die Aufgabe.", en: "The teacher explains the task." }, accept: ["to explain", "to clarify"], hint: "From klar, clear — to make clear. The person you explain TO is dative." },
      ],
    },
    {
      id: "de-u19l4",
      ...
      items: [
        { id: "de-u19l4-dasburo", type: "vocab", front: "das Büro", reading: "dasburo", meaning: "the workplace", example: { jp: "Mein Büro ist im Zentrum.", en: "My office is in the centre." }, accept: ["the office", "the workplace"], hint: "Borrowed from French bureau, and it kept the stress at the end: bü-RO." },
        ...
        { id: "de-u19l4-derkollege", type: "vocab", front: "der Kollege", reading: "derkollege", meaning: "the colleague", example: { jp: "Meine Kollegen sind sehr nett.", en: "My colleagues are very nice." }, accept: ["the colleague", "the co-worker"], hint: "Like der Kunde in u17, it adds -n outside the nominative: der Kollege, den Kollegen." },
        { id: "de-u19l4-verdienen", type: "vocab", front: "verdienen", reading: "verdienen", meaning: "to earn", example: { jp: "Sie verdient genug Geld für die Familie.", en: "She earns enough money for the family." }, accept: ["to earn", "to deserve"], hint: "Also to deserve: das hast du verdient, you deserved that. From dienen, to serve." },
        { id: "de-u19l4-dertermin", type: "vocab", front: "der Termin", reading: "dertermin", meaning: "the appointment", example: { jp: "Ich habe am Freitag einen Termin.", en: "I have an appointment on Friday." }, accept: ["the appointment", "the date", "the deadline"], hint: "Any fixed time with someone — doctor, bank, boss. Not a romantic date, which is das Date." },
      ],
    },
  ],
};
