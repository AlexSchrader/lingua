...
export const DE_UNIT19 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u19l3-abfahren", type: "vocab", front: "abfahren", reading: "abfahren", meaning: "to depart", example: { jp: "Der Zug fährt um acht Uhr ab.", en: "The train departs at eight o'clock." }, drill: { jp: "Der Bus soll um neun abfahren", en: "The bus is supposed to leave at nine" }, accept: ["to depart", "to leave", "to set off"], hint: "Separable: the ab- goes to the end — der Zug fährt … ab. From fahren, but you would never guess depart from drive." },
        { id: "de-u19l3-ankommen", type: "vocab", front: "ankommen", reading: "ankommen", meaning: "to arrive", example: { jp: "Wir kommen um zehn Uhr in Wien an.", en: "We arrive in Vienna at ten o'clock." }, drill: { jp: "Wir wollen am Flughafen ankommen", en: "We want to arrive at the airport" }, accept: ["to arrive", "to get there"], hint: "The other half of abfahren, and separable in the same way: wir kommen … an." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u19l4-diereise", type: "vocab", front: "die Reise", reading: "diereise", meaning: "the journey", example: { jp: "Die Reise nach Berlin ist lang.", en: "The journey to Berlin is long." }, drill: { jp: "Die Reise dauert drei Stunden", en: "The journey takes three hours" }, accept: ["journey", "the journey", "trip", "the trip", "travel", "voyage"], hint: "Gute Reise! is what you say to someone at the door. eine Reise machen = to take a trip; das Reisebüro is the travel agency." },
      ],
    },
  ],
};
