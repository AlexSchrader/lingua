  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u109l1-verehrt", type: "vocab", front: "verehrt", reading: "verehrt", meaning: "esteemed (in a ceremonial address)", example: { jp: "Verehrte Gäste, ich danke Ihnen, dass Sie den weiten Weg gemacht haben.", en: "Esteemed guests, I thank you for making the long journey." }, drill: { jp: "Verehrte Gäste ich danke Ihnen herzlich", en: "Esteemed guests I thank you warmly" }, accept: ["esteemed", "honoured", "respected", "dear"], hint: "For a speech or a very formal letter, above sehr geehrte (u72). Verehren alone means to revere." },
        { id: "de-u109l1-geschatzt", type: "vocab", front: "geschätzt", reading: "geschatzt", meaning: "valued (in a formal address)", example: { jp: "Geschätzte Kollegen, wir haben in diesem Jahr mehr geschafft als geplant.", en: "Valued colleagues, we have achieved more this year than planned." }, drill: { jp: "Geschätzte Kollegen wir beginnen gleich", en: "Valued colleagues we begin shortly" }, accept: ["valued", "esteemed", "respected"], hint: "Common in Switzerland and Austria as the standard formal address; in Germany it reads warmer than sehr geehrte." },
        ...
        { id: "de-u109l1-mitfreundlichengrussen", type: "vocab", front: "mit freundlichen Grüßen", reading: "mitfreundlichengrussen", meaning: "kind regards (standard closing)", example: { jp: "Fast jeder Brief in Deutschland endet mit freundlichen Grüßen.", en: "Almost every letter in Germany ends with kind regards." }, drill: { jp: "Wir grüßen Sie mit freundlichen Grüßen", en: "We close with kind regards" }, accept: ["kind regards", "yours sincerely", "best regards", "yours faithfully"], hint: "The safe default in every professional letter and e-mail. Abbreviated MfG in a hurry — and that abbreviation is read as curt." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u109l2-dienen", type: "vocab", front: "dienen", reading: "dienen", meaning: "to serve (be of use to someone)", example: { jp: "Womit kann ich Ihnen dienen? — heute nur noch in sehr förmlichen Häusern.", en: "How may I serve you? — today only in very formal establishments." }, drill: { jp: "Diese Regel soll allen Betrieben dienen", en: "This rule is meant to serve all plants" }, accept: ["to serve", "to be of use", "to be of service"], hint: "Dative: jemandem dienen. The phrase Was kann ich für Sie tun? has replaced it almost everywhere." },
      ],
    },
    {
      id: "de-u109l3",
      ...
      items: [
        ...
        { id: "de-u109l3-dasentgegenkommen", type: "vocab", front: "das Entgegenkommen", reading: "dasentgegenkommen", meaning: "accommodation (the concession itself)", example: { jp: "Für Ihr Entgegenkommen in dieser Sache danken wir Ihnen ausdrücklich.", en: "We expressly thank you for your accommodation in this matter." }, drill: { jp: "Das Entgegenkommen der Behörde war überraschend", en: "The authority's accommodation was surprising" }, accept: ["accommodation", "concession", "goodwill", "obligingness"], hint: "The noun of the verb above, and the standard way a German letter thanks someone for bending a rule." },
      ],
    },
    {
      id: "de-u109l4",
      ...
      items: [
        ...
        { id: "de-u109l4-dieanerkennung", type: "vocab", front: "die Anerkennung", reading: "dieanerkennung", meaning: "recognition (credit given for work)", example: { jp: "Für die Anerkennung ihres Abschlusses hat sie zwei Jahre gebraucht.", en: "It took her two years to have her qualification recognised." }, drill: { jp: "Die Anerkennung kam viel zu spät", en: "The recognition came far too late" }, accept: ["recognition", "acknowledgement", "appreciation", "credit"], hint: "Both senses again: das Lob you hear, and der Bescheid an authority sends about a foreign qualification." },
