  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u109l1-hochachtungsvoll", type: "vocab", front: "hochachtungsvoll", reading: "hochachtungsvoll", meaning: "yours faithfully (coldest closing)", example: { jp: "Der Brief endet mit Hochachtungsvoll, und das ist ein Signal für sich.", en: "The letter ends with Yours faithfully, and that is a signal in itself." }, drill: { jp: "Hochachtungsvoll ist heute sehr selten", en: "Yours faithfully is very rare today" }, accept: ["yours faithfully", "yours sincerely", "respectfully yours"], hint: "Today it is so formal that it reads as cold, even hostile — Germans use it when a lawyer is next. Default to Mit freundlichen Grüßen." },
        { id: "de-u109l1-mitfreundlichengrussen", type: "vocab", front: "mit freundlichen Grüßen", reading: "mitfreundlichengrussen", meaning: "kind regards (standard closing)", example: { jp: "Fast jeder Brief in Deutschland endet mit freundlichen Grüßen.", en: "Almost every letter in Germany ends with kind regards." }, drill: { jp: "Unten steht mit freundlichen Grüßen", en: "At the bottom it says kind regards" }, accept: ["kind regards", "yours sincerely", "best regards", "yours faithfully"], hint: "The safe default in every professional letter and e-mail. Abbreviated MfG in a hurry — and that abbreviation is read as curt." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u109l3-einlenken", type: "vocab", front: "einlenken", reading: "einlenken", meaning: "to back down (give way in a dispute)", example: { jp: "Nach zwei Wochen hat die Firma eingelenkt und die Kosten doch übernommen.", en: "After two weeks the company backed down and covered the costs after all." }, drill: { jp: "Am Ende musste die Firma einlenken", en: "In the end the company had to back down" }, accept: ["to back down", "to give way", "to relent", "to climb down"], hint: "From lenken, to steer: you turn your car back onto the other's road. Less humiliating than nachgeben, which is simply yielding." },
        { id: "de-u109l3-diekulanz", type: "vocab", front: "die Kulanz", reading: "diekulanz", meaning: "goodwill (help beyond what is owed)", example: { jp: "Die Firma hat aus Kulanz gezahlt, obwohl die Frist längst vorbei war.", en: "The company paid as a gesture of goodwill, although the deadline had long passed." }, drill: { jp: "Die Kulanz der Firma war sehr groß", en: "The company's goodwill was very great" }, accept: ["goodwill", "discretionary help", "leniency", "as a gesture"], hint: "Aus Kulanz is the fixed phrase, and it means exactly: we did not have to, and we did." },
      ],
    },
    {
      id: "de-u109l4",
      ...
      items: [
        ...
        { id: "de-u109l4-dieauszeichnung", type: "vocab", front: "die Auszeichnung", reading: "dieauszeichnung", meaning: "award (formal honour)", example: { jp: "Die Auszeichnung ging an ein Team, das jahrelang niemand beachtet hatte.", en: "The award went to a team nobody had paid attention to for years." }, drill: { jp: "Die Auszeichnung ging an die Gruppe", en: "The award went to the group" }, accept: ["award", "honour", "distinction", "prize"], hint: "From auszeichnen, to mark out. Mit Auszeichnung bestehen means to pass with distinction." },
        ...
        { id: "de-u109l4-diewertschatzung", type: "vocab", front: "die Wertschätzung", reading: "diewertschatzung", meaning: "appreciation (regard for a person)", example: { jp: "Ein Wort der Wertschätzung wirkt oft mehr als mehr Geld.", en: "A word of appreciation often has more effect than more money." }, drill: { jp: "Die Wertschätzung ist hier sehr gering", en: "Appreciation here is very low" }, accept: ["appreciation", "esteem", "regard", "respect"], hint: "Wert + schätzen. The word every German workplace discussion about Kultur eventually reaches." },
        { id: "de-u109l4-zuvorkommend", type: "vocab", front: "zuvorkommend", reading: "zuvorkommend", meaning: "obliging (courteous and helpful)", example: { jp: "Das Personal war zuvorkommend, obwohl die Station völlig überlastet war.", en: "The staff were obliging, although the ward was completely overstretched." }, drill: { jp: "Der Dozent war immer zuvorkommend", en: "The lecturer was always obliging" }, accept: ["obliging", "courteous", "attentive", "accommodating"], hint: "From zuvorkommen, to get there first: the obliging person meets your wish before you voice it." },
      ],
    },
  ],
};
