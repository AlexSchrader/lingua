  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u85l2-bewegen", type: "vocab", front: "bewegen", reading: "bewegen", meaning: "to move", example: { jp: "Nach dem Unfall konnte er den Arm kaum noch bewegen.", en: "After the accident he could barely move his arm any more." }, drill: { jp: "Er kann den Arm kaum bewegen", en: "He can barely move his arm" }, accept: ["to move", "move", "to shift", "to stir"], hint: "You move something: den Arm bewegen. sich bewegen is to move yourself, and die Bewegung (u71) is the movement itself." },
      ],
    },
    {
      id: "de-u85l3",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u85l4-diemiene", type: "vocab", front: "die Miene", reading: "diemiene", meaning: "the expression on a face", example: { jp: "An seiner Miene war sofort zu sehen, dass ihm die Sache nicht gefiel.", en: "You could see straight away from his expression that he did not like it." }, drill: { jp: "Die Miene sagt mehr als Worte", en: "The expression says more than words" }, accept: ["expression", "the expression", "look", "the look", "countenance", "face"], hint: "Not die Mine (the mine, or a pencil lead) — the extra e is the whole difference. keine Miene verziehen = to keep a straight face." },
      ],
    },
  ],
};
