  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u22l3-dasgluck", type: "vocab", front: "das Glück", reading: "dasgluck", meaning: "the luck", example: { jp: "Wir haben heute wirklich Glück mit dem Wetter.", en: "We're really lucky with the weather today." }, drill: { jp: "Das Glück war heute sehr groß", en: "The luck was very great today" }, accept: ["luck", "the luck", "fortune", "good luck", "happiness"], hint: "One word for luck AND happiness. Zum Glück = luckily; Viel Glück! = good luck. glücklich (u10) is the adjective." },
      ],
    },
    {
      id: "de-u22l4",
      ...
      items: [
        ...
        { id: "de-u22l4-dermut", type: "vocab", front: "der Mut", reading: "dermut", meaning: "the courage", example: { jp: "Für diese Prüfung braucht man wirklich Mut.", en: "You really need courage for this exam." }, drill: { jp: "Der Mut kommt mit der Zeit", en: "Courage comes with time" }, accept: ["courage", "the courage", "bravery", "nerve", "heart"], hint: "The noun under mutig in this lesson. jemandem Mut machen = to encourage someone; der Mut sinkt when it leaves you." },
      ],
    },
  ],
};
