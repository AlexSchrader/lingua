  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u22l1-zufrieden", type: "vocab", front: "zufrieden", reading: "zufrieden", meaning: "satisfied", example: { jp: "Der Chef ist mit der Arbeit zufrieden.", en: "The boss is satisfied with the work." }, drill: { jp: "Der Chef ist mit der Arbeit zufrieden", en: "The boss is satisfied with the work" }, accept: ["satisfied", "content", "pleased", "happy with it"], hint: "Takes mit + dative: zufrieden mit dem Preis. It contains Frieden, peace — quietly, it says at peace with something." },
        { id: "de-u22l1-aufgeregt", type: "vocab", front: "aufgeregt", reading: "aufgeregt", meaning: "excited", example: { jp: "Die Kinder sind vor der Reise aufgeregt.", en: "The children are excited before the trip." }, drill: { jp: "Die Kinder sind vor der Reise aufgeregt", en: "The children are excited before the trip" }, accept: ["excited", "worked up", "keyed up", "agitated"], hint: "Keyed up, and it can be good or bad — before a holiday or before an exam. For the warm English excited a German says, oddly, ich freue mich." },
        { id: "de-u22l1-stolz", type: "vocab", front: "stolz", reading: "stolz", meaning: "proud", example: { jp: "Die Eltern sind sehr stolz auf ihn.", en: "The parents are very proud of him." }, drill: { jp: "Die Eltern sind sehr stolz auf ihn", en: "The parents are very proud of him" }, accept: ["proud"], hint: "Proud OF is stolz auf + accusative, which is why it takes ihn and not ihm — stolz auf dich. The same word is the noun der Stolz." },
        { id: "de-u22l1-nervos", type: "vocab", front: "nervös", reading: "nervos", meaning: "nervous", example: { jp: "Vor der Prüfung bin ich immer nervös.", en: "Before the exam I am always nervous." }, drill: { jp: "Vor der Prüfung bin ich nervös", en: "Before the exam I am nervous" }, accept: ["nervous", "on edge", "jittery"], hint: "Stress the ö: ner-VÖS. Die Nerven is the plural noun, and jemanden nerven is to get on someone's nerves." },
      ],
    },
    {
      id: "de-u22l2",
      ...
      items: [
        { id: "de-u22l2-wutend", type: "vocab", front: "wütend", reading: "wutend", meaning: "furious", example: { jp: "Der Chef ist heute sehr wütend.", en: "The boss is very angry today." }, drill: { jp: "Der Chef ist heute sehr wütend", en: "The boss is very angry today" }, accept: ["furious", "angry", "mad", "livid"], hint: "Stronger than merely annoyed — this is real anger. Wütend AUF a person, wütend ÜBER a thing. The noun is die Wut." },
        ...
        { id: "de-u22l2-enttauscht", type: "vocab", front: "enttäuscht", reading: "enttauscht", meaning: "disappointed", example: { jp: "Die Schüler sind von dem Film enttäuscht.", en: "The students are disappointed by the film." }, drill: { jp: "Die Schüler sind von dem Film enttäuscht", en: "The students are disappointed by the film" }, accept: ["disappointed", "let down"], hint: "A past participle worn as an adjective, just like English disappointed. Von + dative names who or what did it; die Enttäuschung is the disappointment itself." },
        { id: "de-u22l2-diesorge", type: "vocab", front: "die Sorge", reading: "diesorge", meaning: "the worry", example: { jp: "Die Sorge um das Kind ist groß.", en: "The worry about the child is great." }, drill: { jp: "Die Sorge um das Kind ist groß", en: "The worry about the child is great" }, accept: ["the worry", "worry", "the concern", "concern"], hint: "Keine Sorge! is the everyday no worries. To worry is sich Sorgen machen — plural there, singular here, and the shift catches people out." },
        { id: "de-u22l2-einsam", type: "vocab", front: "einsam", reading: "einsam", meaning: "lonely", example: { jp: "Ohne Freunde ist der Abend einsam.", en: "Without friends the evening is lonely." }, drill: { jp: "Ohne Freunde ist der Abend einsam", en: "Without friends the evening is lonely" }, accept: ["lonely", "lonesome", "solitary"], hint: "Built from ein, one, plus -sam, an ending that makes adjectives. Die Einsamkeit is loneliness — and, said of mountains, solitude." },
        { id: "de-u22l2-erschopft", type: "vocab", front: "erschöpft", reading: "erschopft", meaning: "exhausted", example: { jp: "Nach der Arbeit bin ich erschöpft.", en: "After work I am exhausted." }, drill: { jp: "Nach der Arbeit bin ich erschöpft", en: "After work I am exhausted" }, accept: ["exhausted", "worn out", "shattered", "drained"], hint: "Much stronger than u1's müde. Müde wants to sleep; erschöpft has nothing left. From schöpfen, to scoop out." },
      ],
    },
    {
      id: "de-u22l3",
      ...
      items: [
        ...
        { id: "de-u22l3-uberrascht", type: "vocab", front: "überrascht", reading: "uberrascht", meaning: "surprised", example: { jp: "Wir sind von der Antwort überrascht.", en: "We are surprised by the answer." }, drill: { jp: "Wir sind von der Antwort überrascht", en: "We are surprised by the answer" }, accept: ["surprised", "taken aback", "startled"], hint: "From überraschen, which hides rasch, quick — a surprise is what reaches you fast. Die Überraschung is the surprise itself." },
        { id: "de-u22l3-peinlich", type: "vocab", front: "peinlich", reading: "peinlich", meaning: "embarrassing", example: { jp: "Die Frage ist mir sehr peinlich.", en: "The question is very embarrassing to me." }, drill: { jp: "Die Frage ist mir sehr peinlich", en: "The question is very embarrassing to me" }, accept: ["embarrassing", "awkward", "excruciating"], hint: "The person goes in the dative: es ist MIR peinlich. It describes the situation and never the person — you cannot be peinlich yourself." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u22l4-mutig", type: "vocab", front: "mutig", reading: "mutig", meaning: "brave", example: { jp: "Das Kind ist heute sehr mutig.", en: "The child is very brave today." }, drill: { jp: "Das Kind ist heute sehr mutig", en: "The child is very brave today" }, accept: ["brave", "courageous", "bold"], hint: "Der Mut is the courage itself, and -ig makes it an adjective — the same ending you already have in ruhig and lustig." },
        { id: "de-u22l4-schuchtern", type: "vocab", front: "schüchtern", reading: "schuchtern", meaning: "shy", example: { jp: "Der Schüler ist in der Klasse schüchtern.", en: "The student is shy in class." }, drill: { jp: "Der Schüler ist in der Klasse schüchtern", en: "The student is shy in class" }, accept: ["shy", "timid", "bashful"], hint: "The -ern ending here belongs to an adjective, not a verb, however much it looks like one. Die Schüchternheit is shyness." },
        { id: "de-u22l4-leider", type: "vocab", front: "leider", reading: "leider", meaning: "unfortunately", example: { jp: "Leider kann ich heute nicht kommen.", en: "Unfortunately I cannot come today." }, drill: { jp: "Leider kann ich heute nicht kommen", en: "Unfortunately I cannot come today" }, accept: ["unfortunately", "sadly", "I am afraid", "regrettably"], hint: "The same leid you have been saying since u2 in es tut mir leid. Put it first and the verb still comes second — leider KANN ich nicht." },
      ],
    },
  ],
};
