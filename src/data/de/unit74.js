...
// for any of it. Block 3's slots are all open "Vocabulary 3-14 (B1)", so an
// overlap there is possible; if one lands, lower slot wins and this unit keeps it.
  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u74l1-diesilbe", type: "vocab", front: "die Silbe", reading: "diesilbe", meaning: "the syllable", example: { jp: "Das Wort Gedächtnis hat drei Silben und keine ist kurz.", en: "The word Gedächtnis has three syllables and none of them is short." }, drill: { jp: "Die Silbe am Ende ist kurz", en: "The syllable at the end is short" }, accept: ["syllable", "the syllable"], hint: "Two syllables itself: SIL-be. Plural: die Silben." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u74l2-derbegriff", type: "vocab", front: "der Begriff", reading: "derbegriff", meaning: "the term", example: { jp: "Der Begriff Klimawandel kommt aus der Wissenschaft.", en: "The term climate change comes from science." }, drill: { jp: "Der Begriff ist neu für mich", en: "The term is new to me" }, accept: ["term", "the term", "the concept", "the notion"], hint: "From begreifen, to grasp. A word plus the idea behind it." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u74l4-daswoerterbuch", type: "vocab", front: "das Wörterbuch", reading: "daswoerterbuch", meaning: "the dictionary", example: { jp: "Das alte Wörterbuch von meinem Vater liegt noch im Schrank.", en: "My father's old dictionary is still in the cupboard." }, drill: { jp: "Das Wörterbuch liegt auf dem Tisch", en: "The dictionary is on the table" }, accept: ["dictionary", "the dictionary"], hint: "Wörter (the plural) + Buch — a book OF words, so the plural is inside." },
