  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u74l2-bedeuten", type: "vocab", front: "bedeuten", reading: "bedeuten", meaning: "to mean", example: { jp: "Was bedeutet diese Abkürzung, wenn sie in einem Vertrag steht?", en: "What does this abbreviation mean when it appears in a contract?" }, drill: { jp: "Was bedeuten diese zwei Wörter", en: "What do these two words mean" }, accept: ["to mean", "mean", "to signify", "to stand for"], hint: "The verb under die Bedeutung in this lesson. Was bedeutet das? is the everyday 'what does that mean?'; das hat nichts zu bedeuten = it doesn't matter." },
      ],
    },
    {
      id: "de-u74l3",
