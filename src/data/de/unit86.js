  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u86l1-beobachten", type: "vocab", front: "beobachten", reading: "beobachten", meaning: "to watch", example: { jp: "Sie beobachtet die Kinder im Garten.", en: "She watches the children in the garden." }, drill: { jp: "Wir wollen die Kinder beobachten", en: "We want to watch the children" }, accept: ["to observe", "observe", "to watch", "watch", "to keep an eye on", "to monitor"], hint: "Watching over time — a scientist, a nurse, or a nosy neighbour." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u86l3-dergeruch", type: "vocab", front: "der Geruch", reading: "dergeruch", meaning: "the smell", example: { jp: "Der Geruch von frischem Brot liegt schon am Morgen auf der Straße.", en: "The smell of fresh bread is in the street as early as the morning." }, drill: { jp: "Der Geruch von frischem Brot steigt auf", en: "The smell of fresh bread rises" }, accept: ["smell", "the smell", "odour", "the odour", "odor", "scent"], hint: "The neutral noun from riechen in this lesson. der Duft is a pleasant one and der Gestank a foul one — der Geruch is either." },
      ],
    },
    {
      id: "de-u86l4",
      ...
      items: [
        ...
        { id: "de-u86l4-wachsam", type: "vocab", front: "wachsam", reading: "wachsam", meaning: "watchful", example: { jp: "Nach dem Unfall sind die Nachbarn deutlich wachsamer geworden.", en: "After the accident the neighbours have become noticeably more watchful." }, drill: { jp: "Die Nachbarn sind jetzt sehr wachsam", en: "The neighbours are very watchful now" }, accept: ["watchful", "alert", "vigilant", "on guard", "observant"], hint: "wach (awake) + -sam. Of someone deliberately keeping an eye out, which is what der Verdacht in this lesson makes you do. aufmerksam (u86) is attentive in general." },
      ],
    },
  ],
};
