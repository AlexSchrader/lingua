  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u30l1-diemiete", type: "vocab", front: "die Miete", reading: "diemiete", meaning: "the rent", example: { jp: "Die Miete für die Wohnung ist hoch.", en: "The rent for the flat is high." }, drill: { jp: "Die Miete bezahlen wir am Montag", en: "We pay the rent on Monday" }, accept: ["the rent", "rent"], hint: "mieten is to rent FROM someone, vermieten to rent TO them — the ver- flips the direction. Germany is a nation of renters, so this word does a lot of work." },
        ...
        { id: "de-u30l1-deraufzug", type: "vocab", front: "der Aufzug", reading: "deraufzug", meaning: "the lift", example: { jp: "Der Aufzug im Haus ist kaputt.", en: "The lift in the building is broken." }, drill: { jp: "Der Aufzug ist heute sehr voll", en: "The lift is very full today" }, accept: ["the lift", "lift", "the elevator", "elevator"], hint: "auf + Zug, a pulling-up — the same Zug as the train in u18, because both are things that get pulled. Also the word for an act in a play." },
        { id: "de-u30l1-daserdgeschoss", type: "vocab", front: "das Erdgeschoss", reading: "daserdgeschoss", meaning: "the ground floor", example: { jp: "Das Erdgeschoss ist sehr dunkel.", en: "The ground floor is very dark." }, drill: { jp: "Das Erdgeschoss ist für die Eltern", en: "The ground floor is for the parents" }, accept: ["the ground floor", "ground floor", "the first floor"], hint: "Erde + Geschoss, the earth-storey. It is NOT counted as a floor: the first Stock is one above it, so German numbering runs one behind the American." },
        { id: "de-u30l1-derstock", type: "vocab", front: "der Stock", reading: "derstock", meaning: "the storey", example: { jp: "Der Stock über uns ist leer.", en: "The storey above us is empty." }, drill: { jp: "Der Stock unter uns ist laut", en: "The storey below us is loud" }, accept: ["the storey", "storey", "the floor", "the level"], hint: "Im ersten Stock is one floor above the ground. The same word means a stick — the sense is an upright section, stacked." },
        { id: "de-u30l1-derbriefkasten", type: "vocab", front: "der Briefkasten", reading: "derbriefkasten", meaning: "the letterbox", example: { jp: "Der Briefkasten ist heute leer.", en: "The letterbox is empty today." }, drill: { jp: "Der Briefkasten ist vor dem Haus", en: "The letterbox is in front of the house" }, accept: ["the letterbox", "letterbox", "the mailbox", "the postbox"], hint: "Brief + Kasten, letter-box, built exactly as English does it. It covers both the one on your door and the public one you post into." },
      ],
    },
    {
      id: "de-u30l2",
      ...
      items: [
        { id: "de-u30l2-derherd", type: "vocab", front: "der Herd", reading: "derherd", meaning: "the cooker", example: { jp: "Der Herd in der Küche ist neu.", en: "The cooker in the kitchen is new." }, drill: { jp: "Der Herd ist noch sehr heiß", en: "The cooker is still very hot" }, accept: ["the cooker", "cooker", "the stove", "the hob"], hint: "The top you cook ON, as against der Ofen below, which is the box you bake IN. English blurs them into stove; German does not." },
        { id: "de-u30l2-derofen", type: "vocab", front: "der Ofen", reading: "derofen", meaning: "the oven", example: { jp: "Der Ofen ist sehr heiß.", en: "The oven is very hot." }, drill: { jp: "Der Ofen in der Küche ist alt", en: "The oven in the kitchen is old" }, accept: ["the oven", "oven", "the furnace"], hint: "Cognate with oven, and it also covers a heating stove. Plural umlauts: die Öfen." },
        { id: "de-u30l2-diespulmaschine", type: "vocab", front: "die Spülmaschine", reading: "diespulmaschine", meaning: "the dishwasher", example: { jp: "Die Spülmaschine ist heute kaputt.", en: "The dishwasher is broken today." }, drill: { jp: "Die Spülmaschine ist heute sehr laut", en: "The dishwasher is very loud today" }, accept: ["the dishwasher", "dishwasher"], hint: "spülen is to rinse — you met Geschirr spülen in u21. Every -maschine compound is feminine, because die Maschine is and the last word decides." },
        { id: "de-u30l2-diewaschmaschine", type: "vocab", front: "die Waschmaschine", reading: "diewaschmaschine", meaning: "the washing machine", example: { jp: "Die Waschmaschine ist im Keller.", en: "The washing machine is in the cellar." }, drill: { jp: "Die Waschmaschine arbeitet sehr lange", en: "The washing machine runs for a long time" }, accept: ["the washing machine", "washing machine", "the washer"], hint: "Built on u21's sich waschen and die Wäsche. In a German block of flats it genuinely often lives in the cellar, shared." },
        { id: "de-u30l2-derstaubsauger", type: "vocab", front: "der Staubsauger", reading: "derstaubsauger", meaning: "the vacuum cleaner", example: { jp: "Der Staubsauger ist sehr laut.", en: "The vacuum cleaner is very loud." }, drill: { jp: "Der Staubsauger ist heute kaputt", en: "The vacuum cleaner is broken today" }, accept: ["the vacuum cleaner", "vacuum cleaner", "the hoover", "the vacuum"], hint: "Staub is dust and saugen is to suck — the dust-sucker. German names appliances by what they do, which makes them long and guessable." },
        { id: "de-u30l2-dermulleimer", type: "vocab", front: "der Mülleimer", reading: "dermulleimer", meaning: "the bin", example: { jp: "Der Mülleimer in der Küche ist voll.", en: "The bin in the kitchen is full." }, drill: { jp: "Der Mülleimer ist neben dem Herd", en: "The bin is next to the cooker" }, accept: ["the bin", "bin", "the rubbish bin", "the trash can", "the wastebasket"], hint: "u21's Müll plus der Eimer, a bucket. Germans sort their rubbish into several of these, so the plural gets used more than you would expect." },
      ],
    },
    {
      id: "de-u30l3",
      ...
      items: [
        { id: "de-u30l3-dashandtuch", type: "vocab", front: "das Handtuch", reading: "dashandtuch", meaning: "the towel", example: { jp: "Das Handtuch im Bad ist weiß.", en: "The towel in the bathroom is white." }, drill: { jp: "Das Handtuch ist neben der Seife", en: "The towel is next to the soap" }, accept: ["the towel", "towel", "the hand towel"], hint: "u11's Hand plus das Tuch, a cloth. Das Handtuch werfen is to throw in the towel, exactly as in English." },
        { id: "de-u30l3-dieseife", type: "vocab", front: "die Seife", reading: "dieseife", meaning: "the soap", example: { jp: "Die Seife im Bad ist neu.", en: "The soap in the bathroom is new." }, drill: { jp: "Die Seife ist weiß und klein", en: "The soap is white and small" }, accept: ["the soap", "soap"], hint: "A cognate of soap once you allow for the vowel — ZY-feh. The ei is always said like English eye, never like ee." },
        { id: "de-u30l3-dervorhang", type: "vocab", front: "der Vorhang", reading: "dervorhang", meaning: "the curtain", example: { jp: "Der Vorhang vor dem Fenster ist blau.", en: "The curtain in front of the window is blue." }, drill: { jp: "Der Vorhang ist sehr alt", en: "The curtain is very old" }, accept: ["the curtain", "curtain", "the drape"], hint: "vor + hängen, the thing that hangs in front. The same word for a theatre curtain." },
        { id: "de-u30l3-diedecke", type: "vocab", front: "die Decke", reading: "diedecke", meaning: "the ceiling", example: { jp: "Die Decke im Zimmer ist hoch.", en: "The ceiling in the room is high." }, drill: { jp: "Die Decke im Bad ist weiß", en: "The ceiling in the bathroom is white" }, accept: ["the ceiling", "ceiling", "the blanket", "the cover"], hint: "Also a blanket, and a tablecloth — anything that covers, from decken. Context does all the work, and it usually does it easily." },
        { id: "de-u30l3-dasdach", type: "vocab", front: "das Dach", reading: "dasdach", meaning: "the roof", example: { jp: "Das Dach vom Haus ist rot.", en: "The roof of the house is red." }, drill: { jp: "Das Dach ist alt und kaputt", en: "The roof is old and broken" }, accept: ["the roof", "roof"], hint: "Related to decken and so to die Decke above — a roof is what covers. The ch is the rasped sound, as in u1's Buch." },
        { id: "de-u30l3-dieheizung", type: "vocab", front: "die Heizung", reading: "dieheizung", meaning: "the heating", example: { jp: "Die Heizung im Winter ist teuer.", en: "The heating in winter is expensive." }, drill: { jp: "Die Heizung im Zimmer ist warm", en: "The heating in the room is warm" }, accept: ["the heating", "heating", "the radiator", "the heater"], hint: "From heiß in u8 by way of heizen, to heat. It means both the system and the radiator on the wall." },
      ],
    },
    {
      id: "de-u30l4",
      ...
      items: [
        { id: "de-u30l4-daswerkzeug", type: "vocab", front: "das Werkzeug", reading: "daswerkzeug", meaning: "the tool", example: { jp: "Das Werkzeug liegt im Keller.", en: "The tool is in the cellar." }, drill: { jp: "Das Werkzeug ist sehr alt", en: "The tool is very old" }, accept: ["the tool", "tool", "the tools", "the toolkit"], hint: "Werk, a work, plus Zeug, stuff — work-stuff. Usually said as a singular for the whole set, the way English says equipment." },
