...
export const DE_UNIT45 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u45l2-dasspiel", type: "vocab", front: "das Spiel", reading: "dasspiel", meaning: "the game", example: { jp: "Das Spiel dauert zwei Stunden.", en: "The game lasts two hours." }, drill: { jp: "Das Spiel war gut", en: "The game was good" }, accept: ["game", "the game", "the match"], hint: "From spielen. A match, or any game or play." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u45l4-verlieren", type: "vocab", front: "verlieren", reading: "verlieren", meaning: "to lose", example: { jp: "Man kann nicht immer gewinnen, manchmal muss man verlieren.", en: "You cannot always win; sometimes you have to lose." }, drill: { jp: "Wir verlieren das Spiel", en: "We lose the game" }, accept: ["to lose"], hint: "Losing a game, and losing an object: Ich habe meinen Schlüssel verloren." },
