  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u52l1-derzusammenhang", type: "vocab", front: "der Zusammenhang", reading: "derzusammenhang", meaning: "the connection", example: { jp: "Der Zusammenhang zwischen Wetter und Laune ist schwer zu beweisen.", en: "The connection between weather and mood is hard to prove." }, drill: { jp: "Der Zusammenhang ist sehr wichtig", en: "The connection is very important" }, accept: ["connection", "the connection", "link", "the link", "context", "the context", "correlation"], hint: "zusammen + hängen: what hangs together. im Zusammenhang mit = in connection with. Not the adverb zusammen — this is a noun built on it." },
        ...
        { id: "de-u52l1-wegen", type: "vocab", front: "wegen", reading: "wegen", meaning: "because of", example: { jp: "Wegen des Regens bleiben wir heute lieber zu Hause und arbeiten dort.", en: "Because of the rain we would rather stay at home today and work there." }, drill: { jp: "Wegen des Wetters bleiben wir hier", en: "Because of the weather we are staying here" }, accept: ["because of", "due to", "on account of", "owing to"], hint: "Takes the GENITIVE: wegen des Regens, wegen der Arbeit. You will hear the dative in speech (wegen dem Regen) — write the genitive." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u52l2-diefolge", type: "vocab", front: "die Folge", reading: "diefolge", meaning: "the consequence", example: { jp: "Die Folge war, dass wir den ganzen Tag am Bahnhof warten mussten.", en: "The consequence was that we had to wait at the station all day." }, drill: { jp: "Die Folge war sehr teuer", en: "The consequence was very expensive" }, accept: ["consequence", "the consequence", "result", "the result", "outcome", "the outcome", "episode"], hint: "From folgen (to follow): what follows. Folgen haben = to have consequences. It is also a TV episode." },
        ...
        { id: "de-u52l2-dieauswirkung", type: "vocab", front: "die Auswirkung", reading: "dieauswirkung", meaning: "the effect", example: { jp: "Die Auswirkung war sehr groß, obwohl der Grund ganz klein war.", en: "The effect was very big, although the reason was quite small." }, drill: { jp: "Die Auswirkung war sehr groß", en: "The effect was very big" }, accept: ["effect", "the effect", "impact", "the impact", "consequence", "the consequence", "repercussion"], hint: "aus + wirken: the effect a thing works outwards. Usually plural in the news: die Auswirkungen." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u52l3-derumstand", type: "vocab", front: "der Umstand", reading: "derumstand", meaning: "the circumstance", example: { jp: "Unter den Umständen können wir den Termin am Freitag nicht halten.", en: "Under the circumstances we can't keep the appointment on Friday." }, drill: { jp: "Der Umstand ist sehr wichtig", en: "The circumstance is very important" }, accept: ["circumstance", "the circumstance", "fact", "the fact", "situation", "the situation"], hint: "um + stehen: what stands around an event. Mostly plural: unter diesen Umständen = under these circumstances." },
        ...
        { id: "de-u52l3-derzweck", type: "vocab", front: "der Zweck", reading: "derzweck", meaning: "the purpose", example: { jp: "Der Zweck der Übung ist, dass wir am Ende schneller sprechen können.", en: "The purpose of the exercise is that we can speak faster at the end." }, drill: { jp: "Der Zweck ist sehr wichtig", en: "The purpose is very important" }, accept: ["purpose", "the purpose", "point", "the point", "aim", "the aim", "objective"], hint: "What a thing is FOR. zu welchem Zweck? = for what purpose? Das hat keinen Zweck = there is no point." },
      ],
    },
    {
      id: "de-u52l4",
      ...
      items: [
        ...
        { id: "de-u52l4-derhinweis", type: "vocab", front: "der Hinweis", reading: "derhinweis", meaning: "the pointer", example: { jp: "Der Hinweis auf der Karte hat uns geholfen, den richtigen Weg zu finden.", en: "The pointer on the map helped us find the right way." }, drill: { jp: "Der Hinweis war sehr gut", en: "The pointer was very good" }, accept: ["pointer", "the pointer", "hint", "the hint", "tip", "the tip", "clue", "the clue", "note", "the note"], hint: "hin + weisen (to point): a pointer towards something. einen Hinweis geben = to give somebody a tip." },
