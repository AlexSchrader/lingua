  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u3l1-heissen", type: "vocab", front: "heißen", reading: "heissen", meaning: "to be called", example: { jp: "Ich heiße Thomas.", en: "My name is Thomas." }, accept: ["to be called", "to be named", "be called"], hint: "German says \"I am called\", not \"my name is\": ich heiße, du heißt, er heißt. Another ß word — type it heissen." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u3l2-kommen", type: "vocab", front: "kommen", reading: "kommen", meaning: "to come", example: { jp: "Ich komme aus Berlin.", en: "I come from Berlin." }, accept: ["to come", "come"], hint: "ich komme, du kommst, er kommt. The -e, -st, -t endings are the regular pattern for nearly every German verb." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u3l4-arbeiten", type: "vocab", front: "arbeiten", reading: "arbeiten", meaning: "to work", example: { jp: "Ich arbeite hier.", en: "I work here." }, accept: ["to work", "work"], hint: "Stems ending in -t add an extra e so you can say them: du arbeitest, er arbeitet — not arbeitst." },
        { id: "de-u3l4-studieren", type: "vocab", front: "studieren", reading: "studieren", meaning: "to study", example: { jp: "Lena studiert Musik.", en: "Lena studies music." }, accept: ["to study", "study"], hint: "Only at university. School study is lernen. Verbs in -ieren are almost all borrowings and all regular." },
