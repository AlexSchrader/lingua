  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u3l1-du", type: "vocab", front: "du", reading: "du", meaning: "you — informal singular", example: { jp: "Du bist sehr schnell.", en: "You are very fast." }, accept: ["you", "you informal"], hint: "For friends, family, children and fellow students. Using it with a stranger is a real misstep — see Sie in lesson 3." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u3l2-aus", type: "vocab", front: "aus", reading: "aus", meaning: "out of", example: { jp: "Anna kommt aus Wien.", en: "Anna comes from Vienna." }, accept: ["out of", "from", "out"], hint: "For origin: aus Berlin, aus Deutschland. Pairs with kommen almost every time you introduce yourself." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u3l3-ihr", type: "vocab", front: "ihr", reading: "ihr", meaning: "you — plural and informal", example: { jp: "Wo wohnt ihr?", en: "Where do you all live?" }, accept: ["you plural", "you all", "you"], hint: "du to one friend, ihr to several. English lost this distinction; German still needs it." },
