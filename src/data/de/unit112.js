  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u112l1-inbetrachtziehen", type: "vocab", front: "in Betracht ziehen", reading: "inbetrachtziehen", meaning: "to consider (take into consideration)", example: { jp: "Das Gremium will auch eine Lösung ohne neues Gebäude in Betracht ziehen.", en: "The body also wants to consider a solution without a new building." }, drill: { jp: "Wir sollten alle Möglichkeiten in Betracht ziehen", en: "We should consider all the possibilities" }, accept: ["to consider", "to take into consideration", "to contemplate", "to weigh"], hint: "Der Betracht survives only here and in außer Betracht bleiben. Never *in Betracht nehmen*." },
        ...
        { id: "de-u112l1-ausserachtlassen", type: "vocab", front: "außer Acht lassen", reading: "ausserachtlassen", meaning: "to disregard (leave out of account)", example: { jp: "Man darf die Kosten für die Pflege nicht außer Acht lassen.", en: "One must not disregard the costs of care." }, drill: { jp: "Diesen Punkt darf man nicht außer Acht lassen", en: "One must not disregard this point" }, accept: ["to disregard", "to leave out of account", "to ignore", "to overlook"], hint: "Die Acht here is attention, the same word as in Achtung. Almost always negated — nicht außer Acht lassen." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u112l3-diekonsequenzziehen", type: "vocab", front: "die Konsequenz ziehen", reading: "diekonsequenzziehen", meaning: "to draw the consequences (act on a failure)", example: { jp: "Nach dem zweiten Bericht hat der Vorsitz die Konsequenz gezogen und aufgehört.", en: "After the second report the chair drew the consequences and stepped down." }, drill: { jp: "Jemand muss endlich die Konsequenz ziehen", en: "Somebody finally has to draw the consequences" }, accept: ["to draw the consequences", "to act on it", "to take responsibility", "to resign"], hint: "In German public life this is usually a polite way of saying somebody resigned." },
