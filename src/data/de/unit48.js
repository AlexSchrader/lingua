...
// subjects. Examples use only vocab introduced at or before u48.
  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u48l1-versuchen", type: "vocab", front: "versuchen", reading: "versuchen", meaning: "to try", example: { jp: "Ich versuche, jeden Tag zu lernen.", en: "I try to learn every day." }, drill: { jp: "Wir versuchen es noch einmal", en: "We try it once more" }, accept: ["to try", "to attempt"], hint: "versuchen zu + infinitive. der Versuch is an attempt. Also to taste food." },
        ...
        { id: "de-u48l1-planen", type: "vocab", front: "planen", reading: "planen", meaning: "to plan", example: { jp: "Wir planen eine Reise nach Italien.", en: "We are planning a trip to Italy." }, drill: { jp: "Wir planen das Fest", en: "We plan the party" }, accept: ["to plan"], hint: "From der Plan. einplanen = to allow/schedule for." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u48l2-sichweigern", type: "vocab", front: "sich weigern", reading: "sichweigern", meaning: "to refuse", example: { jp: "Der Mann weigert sich zu zahlen.", en: "The man refuses to pay." }, drill: { jp: "Die Leute können sich weigern", en: "The people can refuse" }, accept: ["to refuse", "to decline"], hint: "sich weigern zu + infinitive. A flat refusal to do something." },
        { id: "de-u48l2-ablehnen", type: "vocab", front: "ablehnen", reading: "ablehnen", meaning: "to turn down", example: { jp: "Sie lehnt die Einladung höflich ab.", en: "She politely turns down the invitation." }, drill: { jp: "Wir müssen das Angebot ablehnen", en: "We have to turn down the offer" }, accept: ["to turn down", "to reject", "to refuse", "to decline"], hint: "Separable (lehnt … ab). The opposite of zustimmen. From lehnen, to lean." },
        { id: "de-u48l2-zustimmen", type: "vocab", front: "zustimmen", reading: "zustimmen", meaning: "to agree", example: { jp: "Alle stimmen dem Plan zu.", en: "Everyone agrees to the plan." }, drill: { jp: "Wir können dem Plan zustimmen", en: "We can agree to the plan" }, accept: ["to agree", "to approve", "to consent"], hint: "Separable (stimmt … zu). zustimmen takes the dative. From die Stimme, voice/vote." },
      ],
    },
    {
      id: "de-u48l3",
      ...
      items: [
        { id: "de-u48l3-erlauben", type: "vocab", front: "erlauben", reading: "erlauben", meaning: "to allow", example: { jp: "Die Eltern erlauben das nicht.", en: "The parents don't allow that." }, drill: { jp: "Wir erlauben es den Kindern", en: "We allow the children to do it" }, accept: ["to allow", "to permit", "to let"], hint: "erlauben takes the dative person. die Erlaubnis is permission." },
        { id: "de-u48l3-verbieten", type: "vocab", front: "verbieten", reading: "verbieten", meaning: "to forbid", example: { jp: "Der Arzt verbietet ihm das Rauchen.", en: "The doctor forbids him to smoke." }, drill: { jp: "Wir verbieten das nicht", en: "We don't forbid that" }, accept: ["to forbid", "to ban", "to prohibit"], hint: "The opposite of erlauben. verboten = forbidden, a very common sign." },
        { id: "de-u48l3-gestatten", type: "vocab", front: "gestatten", reading: "gestatten", meaning: "to permit", example: { jp: "Rauchen ist hier nicht gestattet.", en: "Smoking is not permitted here." }, drill: { jp: "Wir gestatten keine Fotos", en: "We do not permit photos" }, accept: ["to permit", "to allow"], hint: "A formal erlauben, seen on signs. Gestatten Sie? = May I?" },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u48l4-vergessen", type: "vocab", front: "vergessen", reading: "vergessen", meaning: "to forget", example: { jp: "Ich vergesse immer seinen Namen.", en: "I always forget his name." }, drill: { jp: "Wir vergessen den Termin nicht", en: "We won't forget the appointment" }, accept: ["to forget"], hint: "Stem change: er vergisst. The opposite is sich erinnern." },
        { id: "de-u48l4-sicherinnern", type: "vocab", front: "sich erinnern", reading: "sicherinnern", meaning: "to remember", example: { jp: "Ich erinnere mich gut an den Tag.", en: "I remember the day well." }, drill: { jp: "Die Leute können sich erinnern", en: "People can remember" }, accept: ["to remember", "to recall"], hint: "sich erinnern an + accusative. The opposite of vergessen." },
        ...
        { id: "de-u48l4-vermeiden", type: "vocab", front: "vermeiden", reading: "vermeiden", meaning: "to avoid", example: { jp: "Wir vermeiden den Verkehr am Morgen.", en: "We avoid the traffic in the morning." }, drill: { jp: "Wir vermeiden den Fehler", en: "We avoid the mistake" }, accept: ["to avoid"], hint: "To keep away from a thing or situation. Stem change in past: vermied." },
