  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u105l1-nachdenklich", type: "vocab", front: "nachdenklich", reading: "nachdenklich", meaning: "pensive (left thinking about something)", example: { jp: "Das Buch war nicht traurig, aber ich war danach den ganzen Abend nachdenklich.", en: "The book was not sad, but afterwards I was pensive the whole evening." }, drill: { jp: "Das Gespräch hat mich nachdenklich gemacht", en: "The conversation made me pensive" }, accept: ["pensive", "thoughtful", "reflective"], hint: "jemanden nachdenklich machen is the standard collocation: to give someone pause." },
      ],
    },
    {
      id: "de-u105l2",
      ...
      items: [
        ...
        { id: "de-u105l2-gekrankt", type: "vocab", front: "gekränkt", reading: "gekrankt", meaning: "hurt (wounded in one's pride)", example: { jp: "Er war gekränkt, weil ihn niemand gefragt hatte, obwohl es um seine Arbeit ging.", en: "He was hurt because nobody had asked him, although it was about his work." }, drill: { jp: "Sie war von der Kritik tief gekränkt", en: "She was deeply hurt by the criticism" }, accept: ["hurt", "offended", "wounded", "slighted"], hint: "From kränken, to wound someone's feelings — same root as krank. It is always the pride that is hit." },
      ],
    },
    {
      id: "de-u105l3",
      ...
      items: [
        ...
        { id: "de-u105l3-verunsichert", type: "vocab", front: "verunsichert", reading: "verunsichert", meaning: "unsettled (made unsure of oneself)", example: { jp: "Die vielen Fragen haben ihn eher verunsichert als überzeugt.", en: "The many questions unsettled him rather than convinced him." }, drill: { jp: "Die Kritik hat die Gruppe verunsichert", en: "The criticism has unsettled the group" }, accept: ["unsettled", "made insecure", "unnerved", "thrown"], hint: "ver + unsicher: someone else did this to you. Sich unsicher fühlen is the state without the cause." },
        { id: "de-u105l3-angespannt", type: "vocab", front: "angespannt", reading: "angespannt", meaning: "tense (strung tight, of a person or a situation)", example: { jp: "Die Stimmung im Büro war seit dem Bericht angespannt.", en: "The mood in the office had been tense since the report." }, drill: { jp: "Die Stimmung bleibt noch immer angespannt", en: "The mood is still tense" }, accept: ["tense", "strained", "on edge", "taut"], hint: "spannen is to stretch a rope; angespannt is the rope under load. Works for Stimmung, Lage, Muskeln and Finanzen." },
        { id: "de-u105l3-mulmig", type: "vocab", front: "mulmig", reading: "mulmig", meaning: "uneasy (vaguely apprehensive)", example: { jp: "Mir war mulmig, als ich das leere Haus von außen sah.", en: "I felt uneasy when I saw the empty house from outside." }, drill: { jp: "Mir wurde vor der Prüfung mulmig", en: "I got uneasy before the exam" }, accept: ["uneasy", "queasy", "apprehensive", "uncomfortable"], hint: "Almost always impersonal with the dative: mir ist mulmig. Quiet stomach-level unease, not real Angst." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u105l4-geruhrt", type: "vocab", front: "gerührt", reading: "geruhrt", meaning: "moved (touched, close to tears)", example: { jp: "Sie war so gerührt, dass sie erst nach einer Weile etwas sagen konnte.", en: "She was so moved that she could only say something after a while." }, drill: { jp: "Alle im Zimmer waren sehr gerührt", en: "Everyone in the room was very moved" }, accept: ["moved", "touched", "affected"], hint: "From rühren, to stir — the same image as English *stirred*. Zu Tränen gerührt is the fixed phrase." },
