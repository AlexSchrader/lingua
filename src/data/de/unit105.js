  ...
  lessons: [
    {
      ...
      items: [
        { id: "de-u105l1-dieambivalenz", type: "vocab", front: "die Ambivalenz", reading: "dieambivalenz", meaning: "ambivalence (two opposed feelings at once)", example: { jp: "Seine Ambivalenz gegenüber der neuen Stelle war allen im Raum klar.", en: "His ambivalence towards the new job was clear to everyone in the room." }, drill: { jp: "Die Ambivalenz war deutlich zu spüren", en: "The ambivalence was clearly noticeable" }, accept: ["ambivalence", "mixed feelings"], hint: "The formal word; in speech Germans say gemischte Gefühle. Ambivalenz gegenüber + dative." },
        ...
        { id: "de-u105l1-diezerrissenheit", type: "vocab", front: "die Zerrissenheit", reading: "diezerrissenheit", meaning: "inner turmoil (being pulled in two directions)", example: { jp: "In dem Brief steht die ganze Zerrissenheit der Jahre nach dem Krieg.", en: "The whole inner turmoil of the years after the war is in that letter." }, drill: { jp: "Die Zerrissenheit zieht sich durch das Buch", en: "The inner turmoil runs through the book" }, accept: ["inner turmoil", "inner conflict", "being torn", "dividedness"], hint: "From zerreißen, to rip apart. Heavier than zwiespältig — this is a state, not a mood." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u105l2-diereue", type: "vocab", front: "die Reue", reading: "diereue", meaning: "remorse (regret over one's own act)", example: { jp: "Vor Gericht zeigte er keine Reue, und genau das hat man ihm angerechnet.", en: "In court he showed no remorse, and that is exactly what was held against him." }, drill: { jp: "Die Reue kam viel zu spät", en: "The remorse came far too late" }, accept: ["remorse", "regret", "repentance", "contrition"], hint: "Reue is about what *you* did; das Bedauern is regret that something happened at all." },
        { id: "de-u105l2-bereuen", type: "vocab", front: "bereuen", reading: "bereuen", meaning: "to regret (wish you had acted differently)", example: { jp: "Ich bereue den Brief nicht, nur den Ton am Ende.", en: "I do not regret the letter, only the tone at the end." }, drill: { jp: "Diesen Satz werde ich lange bereuen", en: "I will regret this sentence for a long time" }, accept: ["to regret", "regret", "to repent", "to rue"], hint: "Takes a direct object — etwas bereuen. For polite regret in a letter, German uses bedauern instead." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u105l3-diefassung", type: "vocab", front: "die Fassung", reading: "diefassung", meaning: "composure (self-control in a hard moment)", example: { jp: "Sie hat die Fassung behalten, bis alle aus dem Zimmer waren.", en: "She kept her composure until everyone was out of the room." }, drill: { jp: "Er hat die Fassung völlig verloren", en: "He completely lost his composure" }, accept: ["composure", "self-control", "countenance", "poise"], hint: "The two collocations to learn as a pair: die Fassung behalten und die Fassung verlieren. A second sense is a version of a text." },
      ],
    },
    {
      id: "de-u105l4",
      ...
      items: [
        ...
        { id: "de-u105l4-geruhrt", type: "vocab", front: "gerührt", reading: "geruhrt", meaning: "moved (touched, close to tears)", example: { jp: "Sie war so gerührt, dass sie erst nach einer Weile etwas sagen konnte.", en: "She was so moved that she could only say something after a while." }, drill: { jp: "Alle im Raum waren sichtlich gerührt", en: "Everyone in the room was visibly moved" }, accept: ["moved", "touched", "affected"], hint: "From rühren, to stir — the same image as English *stirred*. Zu Tränen gerührt is the fixed phrase." },
        { id: "de-u105l4-diezuversicht", type: "vocab", front: "die Zuversicht", reading: "diezuversicht", meaning: "confidence (quiet trust that it will turn out well)", example: { jp: "Nach dem zweiten Befund kam die Zuversicht langsam zurück.", en: "After the second set of findings the confidence slowly came back." }, drill: { jp: "Die Zuversicht kam langsam wieder zurück", en: "The confidence slowly came back" }, accept: ["confidence", "optimism", "trust", "hopefulness"], hint: "Not das Selbstvertrauen, which is confidence in yourself. Zuversicht points at the future: zuversichtlich sein." },
      ],
    },
  ],
};
