  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u15l1-dasschlafzimmer", type: "vocab", front: "das Schlafzimmer", reading: "dasschlafzimmer", meaning: "the bedroom", example: { jp: "Im Schlafzimmer ist es sehr ruhig.", en: "It is very quiet in the bedroom." }, accept: ["the bedroom"], hint: "Schlaf + Zimmer. German builds rooms this way, and the last noun always decides the gender — das Zimmer, so das Schlafzimmer." },
        ...
        { id: "de-u15l1-dergarten", type: "vocab", front: "der Garten", reading: "dergarten", meaning: "the garden", example: { jp: "Im Garten ist es jetzt sehr schön.", en: "It is very lovely in the garden now." }, accept: ["the garden", "the yard"], hint: "English garden is the same word, one consonant shifted. Der Kindergarten is literally the children's garden." },
        { id: "de-u15l1-derkeller", type: "vocab", front: "der Keller", reading: "derkeller", meaning: "the cellar", example: { jp: "Im Keller ist es immer kalt.", en: "It is always cold in the cellar." }, accept: ["the cellar", "the basement"], hint: "Almost every German house has one, and it is where the bicycles and the beer live." },
      ],
    },
    {
      id: "de-u15l2",
      ...
      items: [
        ...
        { id: "de-u15l2-dertisch", type: "vocab", front: "der Tisch", reading: "dertisch", meaning: "the table", example: { jp: "Das Brot ist auf dem Tisch.", en: "The bread is on the table." }, accept: ["the table", "the desk"], hint: "Auf dem Tisch, on the table — dative, because nothing is moving. Also the word for a desk." },
        ...
        { id: "de-u15l2-dassofa", type: "vocab", front: "das Sofa", reading: "dassofa", meaning: "the sofa", example: { jp: "Wir essen oft zusammen auf dem Sofa.", en: "We often eat together on the sofa." }, accept: ["the sofa", "the couch"], hint: "Spelled as in English and neuter. Die Couch also exists and is feminine." },
        { id: "de-u15l2-dasregal", type: "vocab", front: "das Regal", reading: "dasregal", meaning: "the shelf", example: { jp: "Die Bücher sind im Regal.", en: "The books are on the shelf." }, accept: ["the shelf", "the shelves", "the bookcase"], hint: "A whole shelf unit, not one plank. Stress the second syllable: re-GAL." },
      ],
    },
    {
      id: "de-u15l3",
    ...
    },
    {
      ...
      items: [
        { id: "de-u15l4-derschlussel", type: "vocab", front: "der Schlüssel", reading: "derschlussel", meaning: "the key", example: { jp: "Mein Schlüssel ist nicht hier.", en: "My key is not here." }, accept: ["the key"], hint: "Plural is identical: ein Schlüssel, zwei Schlüssel. You may type schlussel or schlüssel — the umlaut folds." },
        ...
        { id: "de-u15l4-derspiegel", type: "vocab", front: "der Spiegel", reading: "derspiegel", meaning: "the mirror", example: { jp: "Im Bad ist ein Spiegel.", en: "There is a mirror in the bathroom." }, accept: ["the mirror"], hint: "Also the name of Germany's best-known news magazine, Der Spiegel." },
        ...
        { id: "de-u15l4-derkuhlschrank", type: "vocab", front: "der Kühlschrank", reading: "derkuhlschrank", meaning: "the fridge", example: { jp: "Die Milch ist im Kühlschrank.", en: "The milk is in the fridge." }, accept: ["the fridge", "the refrigerator"], hint: "Kühl, cool, plus Schrank, cupboard — a cool cupboard, which is exactly what it is." },
