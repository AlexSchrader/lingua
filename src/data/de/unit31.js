  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u31l2-nervoes", type: "vocab", front: "nervös", reading: "nervos", meaning: "jumpy / on edge", example: { jp: "Vor der Prüfung wird er immer nervös.", en: "Before the exam he always gets jumpy." }, drill: { jp: "Die Studenten sind heute nervös", en: "The students are jumpy today" }, accept: ["nervous", "jumpy", "on edge", "anxious"], hint: "ner-VÖS, stress at the end. This unit takes it as a standing disposition — someone who is nervös by nature — rather than as a mood before one exam." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u31l3-mutig", type: "vocab", front: "mutig", reading: "mutig", meaning: "brave", example: { jp: "Es ist mutig, dass sie das macht.", en: "It is brave that she does that." }, drill: { jp: "Der junge Arzt ist sehr mutig", en: "The young doctor is very brave" }, accept: ["brave", "courageous", "bold"], hint: "From der Mut, courage. The -ig ending is said -ich in most of Germany: MOO-tich." },
