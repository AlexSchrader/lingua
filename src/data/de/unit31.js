  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u31l4-dasverhalten", type: "vocab", front: "das Verhalten", reading: "dasverhalten", meaning: "behaviour", example: { jp: "Das Verhalten vom Kind ist nicht höflich.", en: "The child's behaviour is not polite." }, drill: { jp: "Das Verhalten ist sehr schlecht", en: "The behaviour is very bad" }, accept: ["behaviour", "behavior", "conduct"], hint: "What someone does, as against der Charakter, what they are. A singular noun with no plural in ordinary use." },
