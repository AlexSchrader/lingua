  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u80l2-derbewohner", type: "vocab", front: "der Bewohner", reading: "derbewohner", meaning: "the resident", example: { jp: "Im Haus wohnen zehn Bewohner.", en: "Ten residents live in the building." }, drill: { jp: "Der Bewohner hat einen Schlüssel", en: "The resident has a key" }, accept: ["resident", "the resident", "occupant", "the occupant", "the inhabitant"], hint: "bewohnen = to live in. Also used for a town's inhabitants." },
      ],
    },
    {
      id: "de-u80l3",
