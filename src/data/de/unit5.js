  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u5l3-schon", type: "vocab", front: "schon", reading: "schon", meaning: "already", example: { jp: "Es ist schon spät.", en: "It is already late." }, drill: { jp: "Es ist schon sehr spät", en: "It is already very late" }, accept: ["already", "yet"], hint: "⚠️ TYPE IT WITHOUT THE UMLAUT. schon (already) and schön (beautiful, u1) are different words, and the app folds accents away, so both normalise the same — this card demands the exact spelling. The two dots are the whole difference. As a particle it also reassures: Das ist schon gut." },
      ],
    },
    {
      id: "de-u5l4",
