...
export const DE_UNIT83 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "de-u83l3-derabsender", type: "vocab", front: "der Absender", reading: "derabsender", meaning: "the sender", example: { jp: "Der Absender ist oben links.", en: "The sender is at the top left." }, drill: { jp: "Der Absender ist nicht hier", en: "The sender is not here" }, accept: ["sender", "the sender", "the return address", "the person sending"], hint: "ab + senden. On a German envelope it goes top left, small." },
        ...
        { id: "de-u83l3-diesendung", type: "vocab", front: "die Sendung", reading: "diesendung", meaning: "the consignment", example: { jp: "Die Sendung kommt aus Berlin.", en: "The consignment is coming from Berlin." }, drill: { jp: "Die Sendung ist sehr schwer", en: "The consignment is very heavy" }, accept: ["consignment", "the consignment", "the shipment", "the item of post"], hint: "senden = to send. Confusingly it is also a TV programme." },
