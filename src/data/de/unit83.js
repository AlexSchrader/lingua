  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u83l3-dieanschrift", type: "vocab", front: "die Anschrift", reading: "dieanschrift", meaning: "the postal address", example: { jp: "Die Anschrift war falsch, deshalb hat das Paket uns nie erreicht.", en: "The postal address was wrong, so the parcel never reached us." }, drill: { jp: "Die Anschrift steht auf dem Etikett", en: "The address is on the label" }, accept: ["postal address", "the postal address", "address", "the address"], hint: "an + schreiben: what you write on the outside. The formal twin of die Adresse." },
        { id: "de-u83l3-diepostleitzahl", type: "vocab", front: "die Postleitzahl", reading: "diepostleitzahl", meaning: "the postcode", example: { jp: "Ohne Postleitzahl dauert die Lieferung länger, weil die Post lange suchen muss.", en: "Without a postcode the delivery takes longer, because the post has to search for a long time." }, drill: { jp: "Die Postleitzahl steht vor der Stadt", en: "The postcode goes before the town" }, accept: ["postcode", "the postcode", "postal code", "the postal code", "zip code"], hint: "die Post + leiten (to direct) + die Zahl: the number that routes the post. Five digits, written before the town." },
      ],
    },
    {
      id: "de-u83l4",
