  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u89l2-dietendenz", type: "vocab", front: "die Tendenz", reading: "dietendenz", meaning: "the trend", example: { jp: "Die Tendenz geht seit Jahren nach oben, auch wenn ein kurzer Zeitraum das Gegenteil zeigt.", en: "The trend has been going upward for years, even if a short period shows the opposite." }, drill: { jp: "Die Tendenz bleibt bis heute gleich", en: "The trend remains the same to this day" }, accept: ["trend", "the trend", "tendency", "the tendency"], hint: "Tendenz steigend / fallend = trending up / down, the standard German caption on a chart. Of a person it is a leaning, not a fact." },
      ],
    },
    {
      id: "de-u89l3",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u89l4-dievermutung", type: "vocab", front: "die Vermutung", reading: "dievermutung", meaning: "the supposition", example: { jp: "Das ist bisher eine Vermutung, weil niemand den Zusammenhang bisher zeigen konnte.", en: "So far that is a supposition, because nobody has been able to show the connection so far." }, drill: { jp: "Die Vermutung liegt sehr nahe", en: "The supposition strongly suggests itself" }, accept: ["supposition", "the supposition", "assumption", "guess", "hunch", "conjecture", "suspicion"], hint: "From vermuten (to suspect, to guess). Weaker than die Annahme (u88), which you build on; a Vermutung is what you have before the evidence arrives." },
