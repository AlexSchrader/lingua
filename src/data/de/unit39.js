  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u39l2-ass", type: "vocab", front: "aß", reading: "ass", meaning: "ate — past of essen", example: { jp: "Wir aßen zusammen in dem Restaurant.", en: "We ate together in the restaurant." }, drill: { jp: "Er aß das Brot", en: "He ate the bread" }, accept: ["ate"], hint: "essen to aß. Type aß or ass — the ß folds to ss, and the stored reading is written with ss." },
