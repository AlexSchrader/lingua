  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u39l1-hatte", type: "vocab", front: "hatte", reading: "hatte", meaning: "had — past of haben", example: { jp: "Er hatte kein Geld, obwohl er lange arbeitete.", en: "He had no money, although he worked for a long time." }, drill: { jp: "Er hatte kein Geld", en: "He had no money" }, accept: ["had"], hint: "Like war, normal in speech where other verbs take the Perfekt. Careful: hätte with an umlaut (u37) means would have." },
        { id: "de-u39l1-wurde", type: "vocab", front: "wurde", reading: "wurde", meaning: "became — past of werden", example: { jp: "Es wurde dunkel, bevor wir nach Hause kamen.", en: "It became dark before we came home." }, drill: { jp: "Es wurde sehr dunkel", en: "It became very dark" }, accept: ["became", "got", "turned"], hint: "werden is to become. Watch the umlaut once more: wurde is a plain past, würde (u37) is would." },
        { id: "de-u39l1-gab", type: "vocab", front: "gab", reading: "gab", meaning: "gave / there was — past of geben", example: { jp: "Es gab hier keine Schule.", en: "There was no school here." }, drill: { jp: "Damals gab es kein Auto", en: "Back then there was no car" }, accept: ["gave", "there was", "there were"], hint: "es gibt (u13) becomes es gab. That impersonal there was is far commoner than the plain gave." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u39l2-sprach", type: "vocab", front: "sprach", reading: "sprach", meaning: "spoke — past of sprechen", example: { jp: "Sie sprach lange mit dem Arzt, weil sie krank war.", en: "She spoke with the doctor for a long time because she was ill." }, drill: { jp: "Sie sprach lange mit ihm", en: "She spoke with him a long time" }, accept: ["spoke", "talked"], hint: "sprechen to sprach. The participle changes again — gesprochen — so this one verb gives you three stems to hold." },
        ...
        { id: "de-u39l2-ass", type: "vocab", front: "aß", reading: "ass", meaning: "ate — past of essen", example: { jp: "Wir aßen zusammen im Restaurant.", en: "We ate together in the restaurant." }, drill: { jp: "Er aß das Brot", en: "He ate the bread" }, accept: ["ate"], hint: "essen to aß. Type aß or ass — the ß folds to ss, and the stored reading is written with ss." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u39l3-fand", type: "vocab", front: "fand", reading: "fand", meaning: "found — past of finden", example: { jp: "Ich fand das Buch im Zimmer.", en: "I found the book in the room." }, drill: { jp: "Ich fand das Buch dort", en: "I found the book there" }, accept: ["found", "thought"], hint: "finden to fand, i becoming a. Ich fand es gut also means I thought it was good — the same verb carries opinions." },
        { id: "de-u39l3-stand", type: "vocab", front: "stand", reading: "stand", meaning: "stood — past of stehen", example: { jp: "Das Kind stand vor dem Haus und wartete.", en: "The child stood in front of the house and waited." }, drill: { jp: "Der Mann stand lange am Fenster", en: "The man stood at the window for a long time" }, accept: ["stood"], hint: "stehen to stand — and it lands on exactly the English word, which makes it the easiest card here. aufstehen (u20) splits but changes the same way." },
        { id: "de-u39l3-trank", type: "vocab", front: "trank", reading: "trank", meaning: "drank — past of trinken", example: { jp: "Er trank Wasser, weil der Kaffee zu heiß war.", en: "He drank water because the coffee was too hot." }, drill: { jp: "Er trank Wasser und Tee", en: "He drank water and tea" }, accept: ["drank"], hint: "trinken to trank, i becoming a like finden. English drink, drank runs in step with it." },
        { id: "de-u39l3-blieb", type: "vocab", front: "blieb", reading: "blieb", meaning: "stayed — past of bleiben", example: { jp: "Wir blieben zu Hause, weil es regnete.", en: "We stayed at home because it was raining." }, drill: { jp: "Er blieb lange zu Hause", en: "He stayed at home a long time" }, accept: ["stayed", "remained"], hint: "bleiben to blieb, ei becoming ie — the sound goes from EYE to EE. Both cards left in this lesson do the same." },
        { id: "de-u39l3-schrieb", type: "vocab", front: "schrieb", reading: "schrieb", meaning: "wrote — past of schreiben", example: { jp: "Sie schrieb ein Buch, bevor sie ging.", en: "She wrote a book before she left." }, drill: { jp: "Sie schrieb sehr lange", en: "She wrote for a very long time" }, accept: ["wrote"], hint: "schreiben to schrieb, the same ei to ie as blieb. Learn the pair together and you have the whole group." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u39l4-schlief", type: "vocab", front: "schlief", reading: "schlief", meaning: "slept — past of schlafen", example: { jp: "Er schlief lange, weil er sehr müde war.", en: "He slept a long time because he was very tired." }, drill: { jp: "Er schlief sehr lange", en: "He slept a very long time" }, accept: ["slept"], hint: "schlafen to schlief, the same a to ie as laufen to lief. The two rhyme in the past and it is worth hearing that." },
        ...
        { id: "de-u39l4-hiess", type: "vocab", front: "hieß", reading: "hiess", meaning: "was called — past of heißen", example: { jp: "Der Lehrer hieß Thomas.", en: "The teacher was called Thomas." }, drill: { jp: "Die Frau hieß Anna", en: "The woman was called Anna" }, accept: ["was called", "was named"], hint: "heißen to hieß, ei to ie again. Wie hieß er? — what was he called? Type hieß or hiess." },
