  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u40l1-weihnachten", type: "vocab", front: "Weihnachten", reading: "weihnachten", meaning: "Christmas", example: { jp: "An Weihnachten kommt die Familie zusammen.", en: "At Christmas the family comes together." }, drill: { jp: "Weihnachten ist im Dezember", en: "Christmas is in December" }, accept: ["christmas", "christmastime"], hint: "One of the few German nouns used without an article, like a place name. Built from weihen, to consecrate, plus die Nacht (u5)." },
        { id: "de-u40l1-ostern", type: "vocab", front: "Ostern", reading: "ostern", meaning: "Easter", example: { jp: "An Ostern feiern wir zusammen.", en: "At Easter we celebrate together." }, drill: { jp: "Ostern ist im Frühling", en: "Easter is in spring" }, accept: ["easter"], hint: "Article-free like Weihnachten, and it takes an as well: an Ostern. The English word is its direct cousin." },
