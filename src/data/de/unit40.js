  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "de-u40l1-weihnachten", type: "vocab", front: "Weihnachten", reading: "weihnachten", meaning: "Christmas", example: { jp: "An Weihnachten kommt die ganze Familie zusammen.", en: "At Christmas the whole family comes together." }, drill: { jp: "An Weihnachten kommt die Familie", en: "At Christmas the family comes" }, accept: ["christmas", "christmastime"], hint: "One of the few German nouns used without an article, like a place name. Built from weihen, to consecrate, plus die Nacht (u5)." },
        { id: "de-u40l1-ostern", type: "vocab", front: "Ostern", reading: "ostern", meaning: "Easter", example: { jp: "An Ostern haben die Kinder frei.", en: "At Easter the children have time off." }, drill: { jp: "An Ostern haben die Kinder frei", en: "At Easter the children have time off" }, accept: ["easter"], hint: "Article-free like Weihnachten, and it takes an as well: an Ostern. The English word is its direct cousin." },
        { id: "de-u40l1-dietradition", type: "vocab", front: "die Tradition", reading: "dietradition", meaning: "tradition", example: { jp: "Die Tradition ist alt, obwohl niemand den Grund kennt.", en: "The tradition is old, although nobody knows the reason." }, drill: { jp: "Die Tradition ist sehr alt", en: "The tradition is very old" }, accept: ["tradition", "custom"], hint: "tra-di-tsi-OHN, stress at the end, and the t before the ion is said ts. Feminine, like every German noun ending in -ion." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "de-u40l2-dergast", type: "vocab", front: "der Gast", reading: "dergast", meaning: "guest", example: { jp: "Der Gast kam spät, obwohl das Fest früh begann.", en: "The guest came late, although the celebration started early." }, drill: { jp: "Der Gast kam sehr spät", en: "The guest came very late" }, accept: ["guest", "visitor"], hint: "Its plural umlauts: die Gäste. A restaurant calls its customers Gäste rather than Kunden (u16), which is a nicer way to be thought of." },
        { id: "de-u40l2-gratulieren", type: "vocab", front: "gratulieren", reading: "gratulieren", meaning: "to congratulate", example: { jp: "Wir gratulieren dir, weil du die Prüfung geschafft hast.", en: "We congratulate you because you passed the exam." }, drill: { jp: "Wir gratulieren dir sehr herzlich", en: "We congratulate you very warmly" }, accept: ["to congratulate", "congratulate"], hint: "Takes a DATIVE person: ich gratuliere DIR, never dich. Herzlichen Glückwunsch is what you actually say out loud." },
        { id: "de-u40l2-wuenschen", type: "vocab", front: "wünschen", reading: "wunschen", meaning: "to wish", example: { jp: "Ich wünsche dir ein gutes Jahr.", en: "I wish you a good year." }, drill: { jp: "Ich wünsche dir ein gutes Jahr", en: "I wish you a good year" }, accept: ["to wish", "wish"], hint: "Dative person, accusative thing: ich wünsche DIR ein gutes JAHR. der Wunsch (u37) is the noun behind it." },
        { id: "de-u40l2-dierede", type: "vocab", front: "die Rede", reading: "dierede", meaning: "speech", example: { jp: "Die Rede war kurz, deshalb waren die Gäste froh.", en: "The speech was short, therefore the guests were glad." }, drill: { jp: "Die Rede war sehr kurz", en: "The speech was very short" }, accept: ["speech", "talk", "address"], hint: "eine Rede halten is to give a speech — German holds one where English gives one. From reden, to talk." },
    ...
    },
    {
      ...
      items: [
        { id: "de-u40l3-dasgeschenk", type: "vocab", front: "das Geschenk", reading: "dasgeschenk", meaning: "present / gift", example: { jp: "Das Geschenk war klein, aber sie freute sich sehr.", en: "The present was small, but she was very pleased." }, drill: { jp: "Das Geschenk war sehr klein", en: "The present was very small" }, accept: ["present", "gift"], hint: "From schenken, to give as a gift — a verb German keeps quite separate from geben (u19), which is any giving at all." },
        { id: "de-u40l3-diekerze", type: "vocab", front: "die Kerze", reading: "diekerze", meaning: "candle", example: { jp: "Auf dem Kuchen stand eine Kerze für jedes Jahr.", en: "On the cake stood one candle for each year." }, drill: { jp: "Die Kerze steht auf dem Kuchen", en: "The candle is standing on the cake" }, accept: ["candle"], hint: "KER-tse, with z as ts. Germans light them far beyond birthdays — an Advent wreath carries four." },
        { id: "de-u40l3-dieblume", type: "vocab", front: "die Blume", reading: "dieblume", meaning: "flower", example: { jp: "Er brachte Blumen mit, weil er zu spät kam.", en: "He brought flowers because he arrived too late." }, drill: { jp: "Die Blume steht auf dem Tisch", en: "The flower is standing on the table" }, accept: ["flower", "bloom"], hint: "The standard gift when invited to a German home — but never an even number, and never chrysanthemums, which are for graves." },
        { id: "de-u40l3-dieueberraschung", type: "vocab", front: "die Überraschung", reading: "dieuberraschung", meaning: "surprise", example: { jp: "Die Überraschung war gut, obwohl er sie schon kannte.", en: "The surprise was good, although he already knew about it." }, drill: { jp: "Die Überraschung war sehr gut", en: "The surprise was very good" }, accept: ["surprise"], hint: "Five syllables: ü-ber-RA-schung. From überraschen, to surprise, which itself hides rasch, quick." },
        { id: "de-u40l3-dergeburtstag", type: "vocab", front: "der Geburtstag", reading: "dergeburtstag", meaning: "birthday", example: { jp: "Am Geburtstag bekommt das Kind ein Geschenk.", en: "On the birthday the child gets a present." }, drill: { jp: "Der Geburtstag ist im Sommer", en: "The birthday is in the summer" }, accept: ["birthday"], hint: "die Geburt, birth, plus der Tag (u5). Germans do not wish it early — congratulating before the day is genuinely thought unlucky." },
        { id: "de-u40l3-herzlich", type: "vocab", front: "herzlich", reading: "herzlich", meaning: "warm / heartfelt", example: { jp: "Herzlichen Glückwunsch zu dem neuen Jahr.", en: "Warm congratulations on the new year." }, drill: { jp: "Wir gratulieren dir sehr herzlich", en: "We congratulate you very warmly" }, accept: ["warm", "heartfelt", "cordial", "sincere"], hint: "From das Herz, the heart. Herzlichen Glückwunsch is THE German congratulation, and herzlich willkommen the standard welcome." },
      ],
    },
    {
      id: "de-u40l4",
