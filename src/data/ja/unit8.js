  ...
  lessons: [
    ...
    // Lesson 4: people
    {
      ...
      items: [
        ...
        { id: "ja-u8l4-okyaku", type: "vocab", front: "おきゃくさん", reading: "okyakusan", meaning: "guest", example: { jp: "おきゃくさんです。", en: "It's a guest." }, drill: { jp: "おきゃくさんがきます。", en: "A guest is coming." }, accept: ["customer", "visitor", "the customer"] },
    ...
    // Lesson 5: you & others (pronouns)
    {
      ...
      items: [
        ...
        { id: "ja-u8l5-hitori", type: "vocab", front: "ひとり", reading: "hitori", meaning: "one person", example: { jp: "ひとりですか。", en: "Are you alone?" }, drill: { jp: "ひとりでいきます。", en: "I go alone." }, accept: ["alone", "by myself", "one (person)"] },
