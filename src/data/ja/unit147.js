...
export const UNIT147 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "ja-u147l2-marude", type: "vocab", front: "まるで", reading: "marude", meaning: "just like; (not) at all", example: { jp: "そのまちは、まるでえのようにきれいでした。", en: "The town was as pretty as a painting." }, accept: ["as if", "exactly like", "utterly (with negative)"], hint: "まるで…のようだ is one unit — the ending is not optional. With a negative it flips to 'not in the slightest': まるでわからない." },
        ...
        { id: "ja-u147l2-perapera", type: "vocab", front: "ぺらぺら", reading: "perapera", meaning: "fluently", example: { jp: "かのじょはえいごがぺらぺらで、つうやくもできます。", en: "She's fluent in English and can even interpret." }, drill: { jp: "ぺらぺらにはなします。", en: "I speak fluently." }, accept: ["fluent", "flowing (speech)", "glibly"], hint: "The compliment you'll receive long before you deserve it. It can also mean 'talks too freely' — ぺらぺらしゃべる, letting things slip." },
        ...
        { id: "ja-u147l2-ikken", type: "vocab", front: "いっけん", reading: "ikken", meaning: "at first glance", example: { jp: "いっけんかんたんそうですが、やってみるとむずかしいです。", en: "At first glance it looks easy, but it's hard once you try." }, accept: ["seemingly", "on the face of it", "apparently"], hint: "Sets up a correction: what it looks like, then what it is. いっけん…が… is the shape it almost always takes." },
      ],
    },
    {
      id: "ja-u147l3",
      ...
      items: [
        { id: "ja-u147l3-fuini", type: "vocab", front: "ふいに", reading: "fuini", meaning: "abruptly, without warning", example: { jp: "ふいにかぜがつよくなって、かさがこわれました。", en: "The wind picked up without warning and broke my umbrella." }, accept: ["out of the blue", "suddenly", "unexpectedly"], hint: "Written and slightly literary. いきなり implies a skipped step; ふいに is simply unannounced." },
        { id: "ja-u147l3-tsui", type: "vocab", front: "つい", reading: "tsui", meaning: "in spite of oneself", example: { jp: "おいしかったので、つい3つもたべてしまいました。", en: "It was delicious, so I ended up eating three despite myself." }, accept: ["unintentionally", "just", "before I knew it"], hint: "You knew better and did it anyway — weakness, not carelessness. That's the line between つい and うっかり." },
        { id: "ja-u147l3-tossani", type: "vocab", front: "とっさに", reading: "tossani", meaning: "on the spur of the moment", example: { jp: "こどもがおちそうになって、とっさにてをだしました。", en: "The child nearly fell and I put out a hand on reflex." }, accept: ["instantly", "reflexively", "in a split second"], hint: "The reaction beats the thought — used for the good ones. とっさのはんだん is a snap judgement you were right to trust." },
        ...
        { id: "ja-u147l3-nanigenaku", type: "vocab", front: "なにげなく", reading: "nanigenaku", meaning: "casually, without meaning anything by it", example: { jp: "なにげなくいったことばで、ともだちをおこらせてしまいました。", en: "Something I said without thinking made my friend angry." }, accept: ["offhandedly", "innocently", "idly"], hint: "No intention behind the act — which is exactly why it so often precedes an accidental slight." },
