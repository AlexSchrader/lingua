  ...
  lessons: [
    {
      ...
      items: [
        { id: "ja-u105l1-kamoshirenai", type: "vocab", front: "かもしれない", reading: "kamoshirenai", meaning: "might be", example: { jp: "そらが くらいですから、あめが ふるかもしれません。", en: "The sky is dark, so it might rain." }, accept: ["may be", "perhaps", "possibly"], hint: "かもしれない is the weakest guess — maybe 50%. でしょう is stronger, に ちがいない stronger still." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u105l2-kigasuru", type: "vocab", front: "きがする", reading: "kigasuru", meaning: "to have a feeling", example: { jp: "どこかで あった ような きが しますが、なまえを おもいだせません。", en: "I have a feeling we've met somewhere, but I can't remember the name." }, accept: ["to feel like", "to get the impression", "to sense"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u105l3-utagau", type: "vocab", front: "うたがう", reading: "utagau", meaning: "to doubt", example: { jp: "はじめは その はなしを うたがいましたが、じっさいに みて しんじました。", en: "At first I doubted that story, but I believed it once I actually saw it." }, accept: ["to suspect", "to question", "doubt"] },
        ...
        { id: "ja-u105l3-shinjiru", type: "vocab", front: "しんじる", reading: "shinjiru", meaning: "to believe", example: { jp: "わたしは ともだちの ことばを しんじて いますから、しんぱいして いません。", en: "I believe what my friend said, so I'm not worried." }, accept: ["to trust", "to have faith in", "believe"] },
