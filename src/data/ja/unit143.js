  ...
  lessons: [
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Handle exchanges and paperwork: とりけします, とりだします, うけとります, うけつけます.",
      items: [
        { id: "ja-u143l1-torikumimasu", type: "vocab", front: "とりくみます", reading: "torikumimasu", meaning: "to tackle, to work on", example: { jp: "むずかしいもんだいですが、みんなでとりくんでいます。", en: "It's a difficult problem, but we're all working on it." }, drill: { jp: "もんだいにとりくみます。", en: "We tackle the problem." }, accept: ["to address (an issue)", "to take on", "to grapple with"], hint: "とる + くむ (to grapple) — the word for serious, sustained effort on a problem. Newspapers and companies live on it: もんだいにとりくむ." },
        { id: "ja-u143l1-torikeshimasu", type: "vocab", front: "とりけします", reading: "torikeshimasu", meaning: "to cancel, to retract", example: { jp: "よていがかわったので、よやくをとりけしました。", en: "My plans changed, so I cancelled the reservation." }, drill: { jp: "よやくをとりけします。", en: "I cancel the reservation." }, accept: ["to call off", "to withdraw", "cancels"], hint: "Literally 'take and erase'. Used for bookings and for words you wish you hadn't said: いまのはとりけします." },
    ...
    },
    {
      ...
      unit: 143,
      lesson: 2,
      title: "Arranging things with other people",
      cefr: "B1",
      dominantMode: "recall",
      ...
      items: [
        ...
        { id: "ja-u143l2-machiawasemasu", type: "vocab", front: "まちあわせます", reading: "machiawasemasu", meaning: "to meet up (by arrangement)", example: { jp: "えきのまえで7じにまちあわせましょう。", en: "Let's meet in front of the station at seven." }, drill: { jp: "えきのまえでまちあわせます。", en: "We meet up in front of the station." }, accept: ["to rendezvous", "to arrange to meet", "meets up"], hint: "まつ (wait) + あわせる (match) — waiting in a matched place and time. あいます is meeting; まちあわせます is the appointment." },
        { id: "ja-u143l2-tsukiaimasu", type: "vocab", front: "つきあいます", reading: "tsukiaimasu", meaning: "to associate with; to go out with", example: { jp: "かれとは10ねんまえからつきあっています。", en: "I've been going out with him for ten years." }, accept: ["to keep company with", "to date", "to socialize"], hint: "Two very different weights from one verb: professional association and romantic dating. かれとつきあっている means the second unless context says otherwise." },
        { id: "ja-u143l2-hikiukemasu", type: "vocab", front: "ひきうけます", reading: "hikiukemasu", meaning: "to take on, to undertake", example: { jp: "だれもやりたくないというので、わたしがひきうけました。", en: "Nobody wanted to do it, so I took it on." }, accept: ["to accept (a duty)", "to shoulder", "undertakes"], hint: "ひく (pull) + うける (receive) — pulling a responsibility onto yourself. Stronger than やります: it says you're now answerable for it." },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u143l3-shirabenaoshimasu", type: "vocab", front: "しらべなおします", reading: "shirabenaoshimasu", meaning: "to look up again, to re-check", example: { jp: "こたえがちがっていたので、はじめからしらべなおしました。", en: "The answer was wrong, so I looked it all up again from the start." }, accept: ["to recheck", "to research again", "to verify again"], hint: "しらべる + なおす. The same ～なおす as やりなおす and いいなおす — attach it to any verb and you get 'again, properly' free." },
        ...
        { id: "ja-u143l3-minaoshimasu", type: "vocab", front: "みなおします", reading: "minaoshimasu", meaning: "to review; to think better of", example: { jp: "だすまえに、レポートをもういちどみなおしました。", en: "Before submitting it, I looked over the report once more." }, drill: { jp: "レポートをみなおします。", en: "I review the report." }, accept: ["to look over again", "to reassess", "reviews"], hint: "Two senses: checking something again, and revising your opinion of a person upward — かれをみなおした = 'he went up in my estimation'." },
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Describe sudden movement: とびだします, にげだします, ふりむきます, たちどまります, おいかけます.",
      items: [
        ...
        { id: "ja-u143l4-nigedashimasu", type: "vocab", front: "にげだします", reading: "nigedashimasu", meaning: "to run away, to bolt", example: { jp: "おおきなおとがしたので、ねこがにげだしました。", en: "There was a loud noise, so the cat bolted." }, drill: { jp: "ねこがにげだします。", en: "The cat bolts." }, accept: ["to flee", "to take off", "escapes"], hint: "にげる (flee) + だす (start). ～だす after a verb of action means the action began abruptly: ふりだす (start raining), なきだす (burst into tears)." },
        ...
        { id: "ja-u143l4-oikakemasu", type: "vocab", front: "おいかけます", reading: "oikakemasu", meaning: "to chase after", example: { jp: "ボールがころがったので、いそいでおいかけました。", en: "The ball rolled away, so I hurried after it." }, accept: ["to run after", "to pursue", "chases"], hint: "おう (chase) + かける (run). Also used for keeping up with news or a trend: ニュースをおいかける." },
      ],
    },
  ],
};
