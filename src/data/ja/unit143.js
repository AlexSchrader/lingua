  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u143l4-oikakemasu", type: "vocab", front: "おいかけます", reading: "oikakemasu", meaning: "to chase after", example: { jp: "こどもがボールをおいかけて、みちにとびだしました。", en: "A child chased a ball and darted out into the road." }, accept: ["to run after", "to pursue", "chases"], hint: "おう (chase) + かける (run). Also used for keeping up with news or a trend: ニュースをおいかける." },
      ],
    },
  ],
};
