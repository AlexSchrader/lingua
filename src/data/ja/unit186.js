  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u186l2-munashii", type: "vocab", front: "むなしい", reading: "munashii", meaning: "empty of meaning", example: { jp: "何を しても むなしく なる 時期が ありました。", en: "There was a period when everything I did felt hollow." }, accept: ["hollow", "futile", "pointless"] },
        ...
        { id: "ja-u186l2-mijime", type: "vocab", front: "みじめ", reading: "mijime", meaning: "wretched", example: { jp: "みんなの 前で できなくて、みじめな 気持ちに なりました。", en: "Failing in front of everyone left me feeling wretched." }, accept: ["miserable", "humiliated", "pitiful"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u186l3-hokorashii", type: "vocab", front: "ほこらしい", reading: "hokorashii", meaning: "proud on someone's behalf", example: { jp: "子どもの 名前が 読まれた とき、ほこらしく なりました。", en: "When my child's name was read out, I felt proud." }, accept: ["pleased and proud", "swelling with pride"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u186l4-nagori", type: "vocab", front: "なごり", reading: "nagori", meaning: "traces left behind", example: { jp: "古い かべだけが、むかしの なごりとして のこって います。", en: "Only the old wall remains as a trace of the past." }, accept: ["remnants", "the last of it", "parting reluctance"] },
