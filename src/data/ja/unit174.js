  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u174l2-fusegu", type: "vocab", front: "防ぐ", reading: "fusegu", meaning: "to prevent", example: { jp: "事故を 防ぐ ために、みんなで ルールを まもりましょう。", en: "To prevent accidents, let's all follow the rules." }, accept: ["to guard against", "to protect from", "prevent"], hint: "防ぐ (fusegu) = to keep something bad from happening. The 防 you met in 防止 and 予防." },
