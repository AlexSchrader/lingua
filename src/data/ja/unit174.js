  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u174l2-hiteiteki", type: "vocab", front: "ひていてき", reading: "hiteiteki", meaning: "negative (in stance)", example: { jp: "みんな ひていてきでしたが、はっきり 反対とは 言いませんでした。", en: "Everyone was negative about it, but nobody said they opposed it outright." }, accept: ["dismissive", "unfavourable", "sceptical"] },
      ],
    },
    {
      id: "ja-u174l3",
      ...
      items: [
        ...
        { id: "ja-u174l3-kakugo", type: "vocab", front: "かくご", reading: "kakugo", meaning: "being prepared for the worst", example: { jp: "負ける かくごで 出ましたが、けっきょく 勝ちました。", en: "I went in prepared to lose, and ended up winning." }, accept: ["resolve", "readiness", "steeling oneself"] },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u174l4-sonae", type: "vocab", front: "そなえ", reading: "sonae", meaning: "provision made in advance", example: { jp: "地しんへの そなえとして、水と 食べ物を 家に 置いて います。", en: "As provision against an earthquake, I keep water and food at home." }, accept: ["preparedness", "standing ready", "what is laid in"] },
        { id: "ja-u174l4-kiki", type: "vocab", front: "きき", reading: "kiki", meaning: "a crisis", example: { jp: "会社は 一度 ききを むかえましたが、社員は だれも やめませんでした。", en: "The company faced a crisis once, but not one employee left." }, accept: ["emergency", "critical moment", "grave situation"] },
        ...
        { id: "ja-u174l4-sonshitsu", type: "vocab", front: "そんしつ", reading: "sonshitsu", meaning: "a financial loss", example: { jp: "その 年の そんしつは 大きかったですが、つぎの 年に もどしました。", en: "That year's loss was large, but we made it back the following year." }, accept: ["losses", "a deficit", "damage to the books"] },
