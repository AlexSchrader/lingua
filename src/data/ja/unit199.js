  ...
  lessons: [
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Name an uneasy feeling precisely: もやもや, しどろもどろ, くよくよ, はらはら, ひやひや, うずうず.",
      items: [
        ...
        { id: "ja-u199l1-uzuuzu", type: "vocab", front: "うずうず", reading: "uzuuzu", meaning: "itching to do something", example: { jp: "早く 走りたくて、うずうずして います。", en: "I'm itching to get running." }, accept: ["raring to go", "impatient to start"], hint: "Impatience with the body in it — the same idea as うでがなる in u197, but felt all over." },
      ],
    },
    {
      id: "ja-u199l2",
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Say how strongly or gradually something landed: じわじわ, ひしひし, つくづく, まざまざ, まごまご, おどおど.",
      items: [
        ...
        { id: "ja-u199l2-odoodo", type: "vocab", front: "おどおど", reading: "odoodo", meaning: "timidly, nervously", example: { jp: "しかられるかと 思って、おどおどして いました。", en: "I was nervous, thinking I'd be told off." }, accept: ["cowed", "apprehensive", "shrinking"], hint: "Fear of a person, showing in how you stand. びくびく in the next lesson is nearer to flinching." },
      ],
    },
    {
      id: "ja-u199l3",
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Describe wobbling, wandering and looking about: びくびく, ふらふら, くらくら, よろよろ, うろうろ, きょろきょろ.",
      items: [
        ...
        { id: "ja-u199l3-urouro", type: "vocab", front: "うろうろ", reading: "urouro", meaning: "wandering about aimlessly", example: { jp: "出口が 分からず、しばらく うろうろしました。", en: "I couldn't find the exit and wandered about for a while." }, accept: ["milling around", "hanging about", "pacing"], hint: "Movement with no destination, usually because you are lost. Said of a stranger outside a house it sounds suspicious." },
