  ...
  lessons: [
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Read the action kanji: 始 (begin), 終 (end), 止 (stop), 切 (cut), 転 (roll/turn), and the word 開始.",
      items: [
        ...
        { id: "ja-u34l1-kaishi", type: "vocab", front: "開始", reading: "kaishi", meaning: "the start", example: { jp: "しごとの開始は九時です。", en: "Work starts at nine." }, drill: { jp: "開始は九時です。", en: "The start is at nine." }, accept: ["the beginning","commencement","start"], hint: "開 (open) + 始 (begin) — the formal word for a start. 開始します = to commence." },
      ],
    },
    {
      id: "ja-u34l2",
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Read the motion kanji: 走 (run), 歩 (walk), 帰 (return), 住 (live), 去 (leave), and the word 歩道.",
      items: [
        ...
        { id: "ja-u34l2-hodo", type: "vocab", front: "歩道", reading: "hodō", meaning: "the pavement", example: { jp: "子どもは歩道を歩きます。", en: "Children walk on the pavement." }, drill: { jp: "歩道を歩きます。", en: "I walk on the pavement." }, accept: ["the sidewalk","footpath","pavement","sidewalk"], hint: "歩 (walk) + 道 (road) — the part of the street that is for walking." },
      ],
    },
  ],
};
