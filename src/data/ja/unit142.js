...
export const UNIT142 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "ja-u142l2-fuyashimasu", type: "vocab", front: "ふやします", reading: "fuyashimasu", meaning: "to increase (something)", example: { jp: "みせがいそがしいので、てんいんをふやすことにしました。", en: "The shop is busy, so we've decided to take on more staff." }, drill: { jp: "てんいんをふやします。", en: "I increase the staff." }, accept: ["to add to", "to build up", "increases"], hint: "The transitive half of ふえる, which you have from u92. The し in the middle is the giveaway — a great many transitive verbs carry it: なおします, もどします, ふやします." },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u142l3-koboremasu", type: "vocab", front: "こぼれます", reading: "koboremasu", meaning: "to spill (by itself)", example: { jp: "コップがいっぱいで、みずがこぼれそうです。", en: "The glass is full — the water looks like it'll spill." }, drill: { jp: "コップのみずがこぼれます。", en: "The water in the cup spills." }, accept: ["overflows", "runs over", "spills"], hint: "The water does it, not you. Add そうです (u44) and you get the warning you'd actually shout." },
        ...
        { id: "ja-u142l3-korogarimasu", type: "vocab", front: "ころがります", reading: "korogarimasu", meaning: "to roll (by itself)", example: { jp: "ボールがころがって、みちのむこうへいってしまいました。", en: "The ball rolled away and ended up across the road." }, drill: { jp: "ボールがころがります。", en: "The ball rolls." }, accept: ["to tumble", "to roll along", "rolls"], hint: "Anything round moving on its own. Also 'to lie about': へやにものがころがっている." },
