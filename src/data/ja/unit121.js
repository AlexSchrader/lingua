  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u121l4-kin", type: "kanji", front: "禁", reading: "kin", meaning: "forbid", example: { jp: "駅は禁煙ですが、外にたばこを吸える所があります。", en: "The station is non-smoking, but there's a place outside where you can smoke." }, accept: ["prohibit", "ban", "abstain"], hint: "禁 = 林 (a grove) + 示 (an altar) — sacred ground you may not enter. 禁煙 = no smoking." },
