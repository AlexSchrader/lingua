  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u121l2-dai", type: "kanji", front: "第", reading: "dai", meaning: "number (ordinal)", example: { jp: "第一のもくてきはあんぜんですが、速さも大切です。", en: "The number-one aim is safety, but speed matters too." }, accept: ["ordinal marker", "-th", "rank"], hint: "第 = the marker that turns a number into an order: 第一 = the first, 第三 = the third. Not a word on its own." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u121l3-dan", type: "kanji", front: "団", reading: "dan", meaning: "group", example: { jp: "大きな団体が来たので、店はいそがしくなりました。", en: "A large group came, so the shop got busy." }, accept: ["body", "association", "troupe"], hint: "団 = 囗 (an enclosure) with people gathered inside it. 団体 = an organized body, 集団 = a collective." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u121l4-osoi", type: "kanji", front: "遅", reading: "osoi", meaning: "late", example: { jp: "電車が遅れたので、会には出られませんでした。", en: "The train was late, so I couldn't make the meeting." }, accept: ["slow", "delayed", "behind"], hint: "遅 = 辶 (go) dragging along slowly. 遅い = late or slow; 遅れます = to be delayed." },
