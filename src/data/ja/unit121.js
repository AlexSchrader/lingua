  ...
  lessons: [
    {
      ...
      items: [
        { id: "ja-u121l1-oboeru", type: "kanji", front: "覚", reading: "oboeru", meaning: "remember", example: { jp: "日本語をたくさん覚えましたが、話すのはまだ下手です。", en: "I've learned a lot of Japanese, but I'm still poor at speaking." }, accept: ["memorize", "wake up", "sense"], hint: "覚 = seeing 見 with the mind. 覚えます = to learn or remember; 目が覚めます = to wake up." },
        { id: "ja-u121l1-kakeru", type: "kanji", front: "掛", reading: "kakeru", meaning: "hang", example: { jp: "かべにとけいを掛けましたが、少しまがっています。", en: "I hung a clock on the wall, but it's slightly crooked." }, accept: ["hang up", "put on", "cost"], hint: "掛 = 扌 (hand) putting something up on a hook. Also 時間が掛かります = it takes time." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u121l2-kantan", type: "kanji", front: "簡", reading: "kan", meaning: "simple", example: { jp: "せつめいは簡たんでしたが、じっさいはむずかしかったです。", en: "The explanation was simple, but in practice it was hard." }, accept: ["brief", "concise", "plain"], hint: "簡 = 竹 (bamboo) writing strips with only a little on them. 簡単 = simple. Its on-yomi is かん, like 完 and 管." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u121l3-tsumu", type: "kanji", front: "積", reading: "tsumu", meaning: "pile up", example: { jp: "本がたくさん積んでありますが、読む時間がありません。", en: "There are a lot of books piled up, but I've no time to read them." }, accept: ["accumulate", "stack", "load"], hint: "積 = 禾 (grain) heaped higher and higher. 面積 = area, 積もります = to pile up, of snow." },
        { id: "ja-u121l3-toutoi", type: "kanji", front: "貴", reading: "ki", meaning: "precious", example: { jp: "貴重な話を聞きましたが、書くのをわすれました。", en: "I heard something valuable, but I forgot to write it down." }, accept: ["valuable", "noble", "your (formal)"], hint: "貴 = 貝 (money) held up in both hands. 貴重 = precious. Its on-yomi is き, like 機." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u121l4-motomeru", type: "kanji", front: "求", reading: "motomeru", meaning: "seek", example: { jp: "答えを求めましたが、だれも教えてくれませんでした。", en: "I sought an answer, but nobody would tell me." }, accept: ["request", "demand", "look for"], hint: "求 = reaching out for something with both hands. 求人 = a job advert: seeking people." },
