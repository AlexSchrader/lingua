  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u121l3-toutoi", type: "kanji", front: "貴", reading: "ki", meaning: "noble", example: { jp: "貴重な話を聞いたので、わすれないうちに書きました。", en: "I heard something valuable, so I wrote it down before I forgot." }, accept: ["valuable", "noble", "your (formal)", "precious"], hint: "貴 = 貝 (money) held up in both hands. 貴重 = precious. Its on-yomi is き, like 機." },
