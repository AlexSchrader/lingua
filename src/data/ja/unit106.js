  ...
  lessons: [
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Read 政 (politics), 権 (right), 党 (party), 官 (official), and the words 政治 and 政党.",
      items: [
        ...
        { id: "ja-u106l1-seiji", type: "vocab", front: "政治", reading: "seiji", meaning: "politics", example: { jp: "新しい 政治の 話は 新聞で よく 読んで います。", en: "I read a lot about the new politics in the newspaper." }, accept: ["government", "statecraft"] },
        { id: "ja-u106l1-seito", type: "vocab", front: "政党", reading: "seitō", meaning: "political party", example: { jp: "その 政党は 若い 人の 意見を よく 聞いて います。", en: "That party listens closely to young people's views." }, accept: ["party"] },
      ],
    },
    {
      id: "ja-u106l2",
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Read 民 (the people), 律 (law), 選 (to choose), 戦 (war), and the words 法律 and 選手.",
      items: [
        ...
        { id: "ja-u106l2-horitsu", type: "vocab", front: "法律", reading: "hōritsu", meaning: "law", example: { jp: "その 法律は 来年から かわりますから、よく 読んで おきます。", en: "That law changes from next year, so I'll read up on it." }, accept: ["statute", "legislation"], hint: "律 alone is a rule that binds; 法律 is that rule written down by a country." },
        { id: "ja-u106l2-senshu", type: "vocab", front: "選手", reading: "senshu", meaning: "player", example: { jp: "その 選手は 去年 引退して、今は 先生を して います。", en: "That player retired last year and is now a teacher." }, accept: ["athlete", "team member"], hint: "選 (chosen) + 手 (hand) — the chosen hand, i.e. the one picked for the team." },
      ],
    },
    {
      id: "ja-u106l3",
      ...
      items: [
        ...
        { id: "ja-u106l3-heiwa", type: "vocab", front: "平和", reading: "heiwa", meaning: "peace", example: { jp: "長い 争いの あと、やっと 平和に なりました。", en: "After a long conflict, peace finally came." }, accept: ["peaceful", "harmony"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u106l4-kokyo", type: "vocab", front: "公共", reading: "kōkyō", meaning: "public", example: { jp: "公共の 場所では、しずかに 話して ください。", en: "Please speak quietly in public places." }, accept: ["communal", "shared"] },
