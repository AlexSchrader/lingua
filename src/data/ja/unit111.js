  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u111l1-megusuri", type: "vocab", front: "目薬", reading: "megusuri", meaning: "eye drops", example: { jp: "目が 赤いので、目薬を さして います。", en: "My eyes are red, so I'm using eye drops." }, drill: { jp: "目薬を さします。", en: "I put in eye drops." }, accept: ["eye medicine"] },
      ],
    },
    {
      id: "ja-u111l2",
      ...
      items: [
        ...
        { id: "ja-u111l2-joshu", type: "vocab", front: "助手", reading: "joshu", meaning: "assistant", example: { jp: "先生の 助手として、一年 はたらきました。", en: "I worked for a year as the teacher's assistant." }, drill: { jp: "助手は わかいです。", en: "The assistant is young." }, accept: ["helper", "aide"], hint: "助 (help) + 手 (hand) — the helping hand." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u111l3-boka", type: "vocab", front: "防火", reading: "bōka", meaning: "fire prevention", example: { jp: "この ドアは 防火の ために いつも しめて おきます。", en: "This door is kept shut for fire prevention." }, drill: { jp: "防火の ドアです。", en: "It is a fire-prevention door." }, accept: ["fireproofing", "fire safety"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u111l4-rojin", type: "vocab", front: "老人", reading: "rōjin", meaning: "an elderly person", example: { jp: "この 町は 老人が 多くて、病院も たくさん あります。", en: "This town has many elderly people, and plenty of hospitals too." }, drill: { jp: "老人が おおいです。", en: "There are many elderly people." }, accept: ["senior", "old person"] },
