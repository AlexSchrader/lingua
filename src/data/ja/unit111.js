  ...
  lessons: [
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Read 痛 (pain), 薬 (medicine), 寝 (to sleep), 吸 (to breathe in), and the words 頭痛 and 目薬.",
      items: [
        ...
        { id: "ja-u111l1-zutsu", type: "vocab", front: "頭痛", reading: "zutsū", meaning: "headache", example: { jp: "朝から 頭痛が しますから、今日は 早く 休みます。", en: "I've had a headache since morning, so I'll rest early today." }, accept: ["a headache"] },
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Read 舌 (tongue), 助 (to help), 救 (to rescue), 守 (to protect), and the words 助手 and 留守.",
      items: [
        ...
        { id: "ja-u111l2-joshu", type: "vocab", front: "助手", reading: "joshu", meaning: "assistant", example: { jp: "先生の 助手として、一年 働きました。", en: "I worked for a year as the teacher's assistant." }, accept: ["helper", "aide"], hint: "助 (help) + 手 (hand) — the helping hand." },
        { id: "ja-u111l2-rusu", type: "vocab", front: "留守", reading: "rusu", meaning: "being out", example: { jp: "電話しましたが、留守でした。", en: "I called, but nobody was in." }, accept: ["away from home", "absence"], hint: "守 is guard — 留守 is the house left guarding itself. 留守番 = minding an empty house." },
      ],
    },
    {
      id: "ja-u111l3",
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Read 備 (to prepare), 防 (to defend), 険 (steep), 難 (difficult), and the words 予防 and 危険.",
      items: [
        ...
        { id: "ja-u111l3-yobo", type: "vocab", front: "予防", reading: "yobō", meaning: "prevention", example: { jp: "病気の 予防の ために、毎日 手を あらいます。", en: "To prevent illness I wash my hands every day." }, accept: ["to prevent", "precaution"] },
        { id: "ja-u111l3-kiken", type: "vocab", front: "危険", reading: "kiken", meaning: "danger", example: { jp: "この 道は 危険ですから、夜は 通らないで ください。", en: "This road is dangerous, so please don't use it at night." }, accept: ["dangerous", "risk", "hazard"] },
      ],
    },
    {
      id: "ja-u111l4",
