  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u124l1-kaiso", type: "vocab", front: "かいそう", reading: "kaisō", meaning: "reminiscing", example: { jp: "かいそうにふけっていましたが、でんわでわれにかえりました。", en: "I was lost in reminiscence, but the phone brought me back to myself." }, accept: ["recollection", "looking back", "reverie"] },
        ...
        { id: "ja-u124l1-mioboe", type: "vocab", front: "みおぼえ", reading: "mioboe", meaning: "recognizing a face", example: { jp: "みおぼえのあるかおでしたが、なまえがでてきませんでした。", en: "It was a face I recognized, but the name wouldn't come to me." }, accept: ["seeming familiar", "having seen before"] },
        ...
        { id: "ja-u124l1-kinen", type: "vocab", front: "きねん", reading: "kinen", meaning: "commemoration", example: { jp: "きねんにしゃしんをとりましたが、うまくうつりませんでした。", en: "We took a photo to commemorate it, but it didn't come out well." }, accept: ["memento", "keepsake", "anniversary"] },
      ],
    },
    {
      id: "ja-u124l2",
    ...
    },
    {
      ...
      items: [
        { id: "ja-u124l3-kigatsuku", type: "vocab", front: "きがつく", reading: "kigatsuku", meaning: "notice", example: { jp: "まちがいにきがつきましたが、もうおそかったです。", en: "I noticed the mistake, but it was already too late." }, accept: ["to realize", "become aware", "spot"] },
        { id: "ja-u124l3-omoitsuku", type: "vocab", front: "おもいつく", reading: "omoitsuku", meaning: "hit on an idea", example: { jp: "おふろでいいほうほうをおもいつきましたが、あさにはわすれていました。", en: "I hit on a good method in the bath, but by morning I'd forgotten it." }, accept: ["to think of", "come up with", "occur to one"] },
        { id: "ja-u124l3-omoikomi", type: "vocab", front: "おもいこみ", reading: "omoikomi", meaning: "a fixed belief", example: { jp: "それはわたしのおもいこみでしたが、しばらくきづきませんでした。", en: "That was just something I'd assumed, but I didn't realize it for a while." }, accept: ["assumption", "getting an idea into one's head", "preconception"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u124l4-shutoku", type: "vocab", front: "しゅうとく", reading: "shūtoku", meaning: "acquiring a skill", example: { jp: "あたらしいぎじゅつをしゅうとくしましたが、つかうきかいがありません。", en: "I acquired a new skill, but I have no chance to use it." }, accept: ["mastering", "picking up", "attainment"] },
        { id: "ja-u124l4-seijuku", type: "vocab", front: "せいじゅく", reading: "seijuku", meaning: "maturing", example: { jp: "ぎじゅつはせいじゅくしましたが、あたらしいことはまだできません。", en: "The technique has matured, but it still can't do anything new." }, accept: ["ripening", "coming of age", "maturity"] },
        { id: "ja-u124l4-shitashimu", type: "vocab", front: "したしむ", reading: "shitashimu", meaning: "grow fond of", example: { jp: "こどものころからおんがくにしたしんでいましたが、しごとにはしませんでした。", en: "I'd been close to music since childhood, but I didn't make it my job." }, accept: ["become familiar with", "take to", "get close to"] },
        { id: "ja-u124l4-tamesu", type: "vocab", front: "ためす", reading: "tamesu", meaning: "try out", example: { jp: "あたらしいほうほうをためしましたが、けっかはおなじでした。", en: "I tried out a new method, but the result was the same." }, accept: ["to test", "give it a go", "experiment with"] },
      ],
    },
  ],
};
