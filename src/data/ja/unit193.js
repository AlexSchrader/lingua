  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u193l2-kangaenuku", type: "vocab", front: "かんがえぬく", reading: "kangaenuku", meaning: "to think through exhaustively", example: { jp: "かんがえぬいた すえの けつだんですから、こうかいは ありません。", en: "It's a decision I reached after thinking it through, so I have no regrets." }, drill: { jp: "さいごまで かんがえぬく。", en: "I think it through to the end." }, accept: ["to think out fully", "to consider from every angle"], hint: "Not long thinking but complete thinking — every angle taken. かんがえこむ (u194) is brooding; かんがえぬく arrives somewhere." },
        { id: "ja-u193l2-taenuku", type: "vocab", front: "たえぬく", reading: "taenuku", meaning: "to endure to the end", example: { jp: "きびしい 練習に たえぬいて、しあいに 勝ちました。", en: "They endured the hard training right through and won the match." }, drill: { jp: "れんしゅうに たえぬく。", en: "I endure the training to the end." }, accept: ["to hold out", "to bear it through", "to withstand"], hint: "たえる is bearing it; たえぬく is bearing it until the thing being borne stops. The endpoint is built into the word." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u193l3-yaritosu", type: "vocab", front: "やりとおす", reading: "yaritōsu", meaning: "to keep doing without a break", example: { jp: "一人で さいごまで やりとおしたのは 立派です。", en: "Seeing it through alone to the end is admirable." }, drill: { jp: "さいごまで やりとおす。", en: "I keep at it to the end." }, accept: ["to carry on throughout", "to sustain to the end"], hint: "～とおす draws an unbroken line from start to finish. やりぬく beats an obstacle; やりとおす never stopped." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u193l4-sodateageru", type: "vocab", front: "そだてあげる", reading: "sodateageru", meaning: "to raise (to adulthood), to bring on", example: { jp: "女手 一つで 三人を そだてあげました。", en: "She raised three children on her own." }, drill: { jp: "こどもを そだてあげる。", en: "I raise the children." }, accept: ["to bring up", "to nurture to maturity"], hint: "そだてる is raising; そだてあげる is having finished the job — the child is grown, the player is ready. It looks back at a completed span of years." },
      ],
    },
  ],
};
