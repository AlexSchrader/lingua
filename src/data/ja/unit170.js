  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u170l1-hyogenryoku", type: "vocab", front: "ひょうげんりょく", reading: "hyōgenryoku", meaning: "expressive power", example: { jp: "ことばは 少ないですが、ひょうげんりょくが とても 強いです。", en: "There are few words, but the expressive power is very strong." }, accept: ["power of expression", "eloquence"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u170l2-koseiteki", type: "vocab", front: "こうせいてき", reading: "kōseiteki", meaning: "well-composed", example: { jp: "こうせいてきな 写真なので、目が しぜんに 動きます。", en: "The painting is well composed, so the eye moves naturally." }, accept: ["structured", "compositional"] },
        ...
        { id: "ja-u170l2-moho", type: "vocab", front: "もほう", reading: "mohō", meaning: "imitation", example: { jp: "はじめは もほうでも、つづければ 自分の ものに なります。", en: "Even if you start by imitating, keep at it and it becomes your own." }, accept: ["copying", "emulation"] },
    ...
    },
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Review something without simply liking or disliking it: ひはん ようご しんぎ こんきょない ぎゃっきょう ぼうがい.",
      items: [
        ...
        { id: "ja-u170l3-kansho2", type: "vocab", front: "こうけん", reading: "kōken", meaning: "a contribution", example: { jp: "この 作品は、あとの 世代に 大きく こうけんしました。", en: "This work contributed greatly to later generations." }, accept: ["to contribute", "service", "adding to"] },
      ],
    },
    {
      id: "ja-u170l4",
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Place a work against what surrounds it: ぶんかけん たぶんか がいぶ すたれ うけつぎ ひょうか.",
      items: [
        { id: "ja-u170l4-bunkaken", type: "vocab", front: "ぶんかけん", reading: "bunkaken", meaning: "a cultural sphere", example: { jp: "同じ ぶんかけんの 国とは、話が 通じやすいです。", en: "It's easier to understand countries in the same cultural sphere." }, accept: ["cultural area", "shared culture zone"] },
        ...
        { id: "ja-u170l4-shuho2", type: "vocab", front: "しゅりゅう", reading: "shuryū", meaning: "the mainstream", example: { jp: "ぜんえいだった しゅほうが、今では しゅりゅうです。", en: "A technique that was avant-garde is now the mainstream." }, accept: ["the main current", "dominant style"] },
        { id: "ja-u170l4-uketsugi", type: "vocab", front: "うけつぐ", reading: "uketsugu", meaning: "to take over from", example: { jp: "父の 店を うけついで、十年に なります。", en: "It's been ten years since I took over my father's shop." }, accept: ["to inherit", "to carry on", "to succeed to"] },
        { id: "ja-u170l4-tokutoku", type: "vocab", front: "どくとく", reading: "dokutoku", meaning: "distinctive", example: { jp: "この 作者には どくとくの リズムが あります。", en: "This writer has a distinctive rhythm." }, accept: ["unique", "characteristic", "all its own"] },
      ],
    },
  ],
};
