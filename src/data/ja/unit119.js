  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u119l2-in", type: "kanji", front: "因", reading: "in", meaning: "cause", example: { jp: "そのふたつに因果はありませんが、みんな気にしています。", en: "There is no causal link between those two, but everyone frets about it." }, accept: ["reason", "factor", "origin"], hint: "因 = 囗 (an enclosure) round 大 — what a thing is contained by, hence what it comes from. 原因 = the cause." },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u119l4-mawaru", type: "kanji", front: "回", reading: "mawaru", meaning: "turn", example: { jp: "よく回るいすですが、しごとにはつかえません。", en: "It's a chair that spins well, but it's no good for work." }, accept: ["revolve", "times (counter)", "go round"], hint: "回 = one square turning inside another. It also counts occasions: 一回, 二回 = once, twice." },
