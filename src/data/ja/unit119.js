  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u119l4-ikkai", type: "vocab", front: "一回", reading: "ikkai", meaning: "once", example: { jp: "一回だけ行ったので、道をおぼえていません。", en: "I only went once, so I don't remember the way." }, accept: ["one time", "a single time"] },
        { id: "ja-u119l4-meikaku", type: "vocab", front: "明確", reading: "meikaku", meaning: "clear-cut", example: { jp: "明確な答えがなくても、やることは分かりました。", en: "Even without a clear-cut answer, I understood what to do." }, accept: ["definite", "explicit", "unambiguous"] },
      ],
    },
  ],
};
