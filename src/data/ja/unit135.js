...
export const UNIT135 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u135l2-giron", type: "vocab", front: "ぎろん", reading: "giron", meaning: "debate", example: { jp: "ぎろんがながくなって、みんなつかれてしまいました。", en: "The debate dragged on, and everyone ended up worn out." }, accept: ["discussion", "argument", "arguing"] },
                { id: "ja-u135l2-honne", type: "vocab", front: "ほんね", reading: "honne", meaning: "what someone really thinks", example: { jp: "かいぎではだれもほんねをいわないで、あとでみんなはなしました。", en: "Nobody said what they really thought in the meeting, and everyone talked about it afterwards." }, drill: { jp: "ほんねをいいません。", en: "Nobody says what they really think." }, accept: ["true feelings", "real intention", "what they actually mean"] },
        { id: "ja-u135l2-kachikan", type: "vocab", front: "かちかん", reading: "kachikan", meaning: "values", example: { jp: "かちかんはちがいますが、いっしょにはたらけます。", en: "Our values differ, but we can work together." }, accept: ["sense of values", "what someone values"] },
                { id: "ja-u135l2-tatemae", type: "vocab", front: "たてまえ", reading: "tatemae", meaning: "the official line", example: { jp: "それはたてまえですが、じっさいはちがいます。", en: "That is the official line, but the reality is different." }, drill: { jp: "たてまえはちがいます。", en: "The official line is different." }, accept: ["the public position", "what one says publicly", "form"] },
    ...
    },
    {
      ...
      items: [
                { id: "ja-u135l4-kakusa", type: "vocab", front: "かくさ", reading: "kakusa", meaning: "a gap between groups", example: { jp: "しゅうにゅうのかくさがひろがっているのに、はなすひとはすくないです。", en: "The income gap is widening, but few people talk about it." }, drill: { jp: "かくさがひろがっています。", en: "The gap is widening." }, accept: ["disparity", "inequality", "the divide"] },
