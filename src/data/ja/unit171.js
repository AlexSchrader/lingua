  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u171l3-5965", type: "kanji", front: "奥", reading: "ō", meaning: "the interior", example: { jp: "へやの 奥に 大きな はこが おいて あります。", en: "A large box is set at the back of the room." }, accept: ["the back", "the depths", "one's wife (奥さん)"], hint: "奥 (oku) = the innermost part. 奥さん = someone's wife (the person deep in the house), 山奥 = deep in the mountains." },
