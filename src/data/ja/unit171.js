  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u171l2-6b74", type: "kanji", front: "歴", reading: "reki", meaning: "career", example: { jp: "この 町には とても 長い 歴史が あります。", en: "This town has a very long history." }, accept: ["career", "course of events", "history"], hint: "歴 = the passing of time. 歴史 = history, 学歴 = one's educational record, 経歴 = a career/CV." },
