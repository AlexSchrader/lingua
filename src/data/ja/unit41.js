  ...
  lessons: [
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Read the state kanji: 同 (same), 正 (correct), 不 (un-), 無 (nothing), 有 (exist), and the word 有名.",
      items: [
        ...
        { id: "ja-u41l1-yumei", type: "vocab", front: "有名", reading: "yūmei", meaning: "famous", example: { jp: "この店は町で有名です。", en: "This shop is famous in the town." }, drill: { jp: "この店は有名です。", en: "This shop is famous." }, accept: ["well-known","renowned"], hint: "有 (have) + 名 (name) — a thing that has a name. You know it as ゆうめい." },
      ],
    },
    {
      id: "ja-u41l2",
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Read 特 (special), 別 (separate), 物 (thing), 強 (strong), 広 (wide), and the word 名物.",
      items: [
        ...
        { id: "ja-u41l2-meibutsu", type: "vocab", front: "名物", reading: "meibutsu", meaning: "a local specialty", example: { jp: "この町の名物は魚です。", en: "This town’s specialty is fish." }, drill: { jp: "町の名物を食べます。", en: "I eat the town’s specialty." }, accept: ["a speciality","the famous local product","local specialty"], hint: "名 (name) + 物 (thing) — the thing a place is known for. Every town in Japan has one." },
      ],
    },
    {
      id: "ja-u41l3",
      ...
      items: [
        ...
        { id: "ja-u41l3-ongaku", type: "vocab", front: "音楽", reading: "ongaku", meaning: "music", example: { jp: "楽しい音楽を聞きます。", en: "I listen to cheerful music." }, drill: { jp: "音楽を聞きます。", en: "I listen to music." }, accept: ["a piece of music"], hint: "音 (sound) + 楽 (enjoyable) — enjoyable sound. Here 楽 is read がく, not たの." },
      ],
    },
  ],
};
