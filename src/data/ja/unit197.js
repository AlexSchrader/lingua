  ...
  lessons: [
    {
      ...
      items: [
        { id: "ja-u197l1-kigaokenai", type: "vocab", front: "きがおけない", reading: "kigaokenai", meaning: "easy to be with, requiring no formality", example: { jp: "きが おけない 友だちと 話すのは 楽です。", en: "Talking with friends you can be yourself around is easy." }, drill: { jp: "きがおけない ともだちです。", en: "It is a friend I can relax with." }, accept: ["relaxed (company)", "no need to stand on ceremony"], hint: "The most misread idiom in the language: it sounds negative and is warm praise. You need place no 気 between you — no guard, no effort." },
        ...
        { id: "ja-u197l1-kigachiru", type: "vocab", front: "きがちる", reading: "kigachiru", meaning: "to be distracted", example: { jp: "音が 大きくて、きが ちって しまいます。", en: "The noise is loud and it distracts me." }, drill: { jp: "おとで きがちる。", en: "The noise distracts me." }, accept: ["to lose concentration", "to be unable to focus"], hint: "ちる is what petals do — the 気 scatters instead of staying in one place." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u197l2-atamagakatai", type: "vocab", front: "あたまがかたい", reading: "atamagakatai", meaning: "inflexible, set in one's ways", example: { jp: "あたまが かたいと 言われますが、なおせません。", en: "People say I'm inflexible, but I can't change it." }, drill: { jp: "ちちは あたまがかたい。", en: "My father is set in his ways." }, accept: ["rigid", "stubborn (in thinking)"], hint: "Its opposite あたまが やわらかい is praise for someone who can see another way. Hard and soft, not clever and stupid." },
      ],
    },
    {
      id: "ja-u197l3",
