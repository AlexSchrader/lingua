  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u132l1-tami", type: "kanji", front: "民", reading: "min", meaning: "the people", example: { jp: "民間の会社ははやく動きますが、大きな仕事は国がします。", en: "Private-sector companies move fast, but the big jobs are done by the state." }, accept: ["citizens", "folk", "populace"], hint: "民 = the ordinary people of a place, as opposed to those who rule it. 国民 = a nation's people, 民間 = the private sector." },
