  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u37l2-ginko", type: "vocab", front: "銀行", reading: "ginkō", meaning: "bank", example: { jp: "お金は銀行にあります。", en: "The money is in the bank." }, drill: { jp: "銀行に行きます。", en: "I go to the bank." }, accept: ["the bank"], hint: "銀 (silver) + 行 (go) — the place money goes. You know it as ぎんこう." },
      ],
    },
    {
      id: "ja-u37l3",
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Read the work kanji: 工 (craft), 建 (build), 勉 (effort), 事 (matter), 員 (member), and the word 工事.",
      items: [
        ...
        { id: "ja-u37l3-koji", type: "vocab", front: "工事", reading: "kōji", meaning: "roadworks", example: { jp: "駅の前で工事をしています。", en: "There are roadworks in front of the station." }, drill: { jp: "道で工事をしています。", en: "There are roadworks on the road." }, accept: ["construction work","building work","the works"], hint: "工 (craft) + 事 (matter) — the work itself. 工事中 = under construction, on every street sign." },
      ],
    },
  ],
};
