  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u107l2-soshiki", type: "vocab", front: "そしき", reading: "soshiki", meaning: "organisation", example: { jp: "この そしきは ちいさい まちの こどもたちを たすけて います。", en: "This organisation helps children in small towns." }, accept: ["body", "group", "structure"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u107l3-taisaku", type: "vocab", front: "たいさく", reading: "taisaku", meaning: "countermeasure", example: { jp: "まちは じこを ふせぐ たいさくを かんがえて います。", en: "The town is working out measures to prevent accidents." }, accept: ["measures", "response plan", "solution"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u107l4-chosa", type: "vocab", front: "ちょうさ", reading: "chōsa", meaning: "survey", example: { jp: "まちの ひとに ちょうさを して、けっかを はっぴょうしました。", en: "They surveyed the townspeople and announced the results." }, accept: ["investigation", "study", "research"] },
        ...
        { id: "ja-u107l4-shien", type: "vocab", front: "しえん", reading: "shien", meaning: "support", example: { jp: "まちは こどもの いる かぞくを しえんして、まいつき おかねを だして います。", en: "The town supports families with children and pays out money every month." }, accept: ["assistance", "backing", "aid"] },
      ],
    },
  ],
};
