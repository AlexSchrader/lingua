  ...
  lessons: [
    {
      ...
      items: [
        { id: "ja-u172l1-rinri", type: "vocab", front: "りんり", reading: "rinri", meaning: "ethics", example: { jp: "新しい ぎじゅつには、新しい りんりが ひつように なります。", en: "New technology calls for new ethics." }, accept: ["moral principles", "ethical standards"], hint: "りんり is the reasoned system — the rules a profession or a society argues out. どうとく is what an individual feels they ought to do." },
        ...
        { id: "ja-u172l1-songen", type: "vocab", front: "そんげん", reading: "songen", meaning: "dignity", example: { jp: "どんな 人にも、そんげんが あります。", en: "Every person has dignity." }, accept: ["human worth", "honour"] },
        ...
        { id: "ja-u172l1-gimukan", type: "vocab", front: "ぎむかん", reading: "gimukan", meaning: "sense of duty", example: { jp: "ぎむかんだけで つづける しごとは、長く つづきません。", en: "Work continued out of duty alone doesn't last long." }, accept: ["feeling of obligation"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u172l4-jikosekinin", type: "vocab", front: "じこせきにん", reading: "jikosekinin", meaning: "personal responsibility", example: { jp: "なんでも じこせきにんに すると、しゃかいの いみが なくなります。", en: "Make everything a matter of personal responsibility and society stops meaning anything." }, accept: ["own responsibility", "at one's own risk"], hint: "じこせきにん vs そうごふじょ is the axis every argument in this lesson runs along — and neither side wins outright." },
      ],
    },
  ],
};
