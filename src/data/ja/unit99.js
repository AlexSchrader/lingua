  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u99l2-mushiro", type: "vocab", front: "むしろ", reading: "mushiro", meaning: "rather / if anything", example: { jp: "やさいはきらいじゃないです。むしろ、すきです。", en: "I don't dislike vegetables — if anything, I like them." }, accept: ["instead", "sooner"], hint: "むしろ = 'rather / if anything' — overturns an expectation: 'not X; むしろ the opposite.' Picks the second as truer." },
