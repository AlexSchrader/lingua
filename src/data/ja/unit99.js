  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u99l2-kotowaru", type: "vocab", front: "ことわる", reading: "kotowaru", meaning: "to decline", example: { jp: "その ひは いそがしいので、パーティーの さそいを ことわりました。", en: "I was busy that day, so I turned down the invitation to the party." }, accept: ["to refuse", "to turn down", "decline"], hint: "ことわる is a polite no — you give a reason. It is not the same as だめです." },
