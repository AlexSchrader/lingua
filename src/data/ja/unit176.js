  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u176l1-kizoku", type: "vocab", front: "きぞく", reading: "kizoku", meaning: "belonging", example: { jp: "どこにも きぞくして いない ような 気が する ときが あります。", en: "There are times I feel as though I belong nowhere." }, drill: { jp: "きぞくが ありません。", en: "There is no sense of belonging." }, accept: ["affiliation", "being part of", "membership"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u176l2-kosei", type: "vocab", front: "こせい", reading: "kosei", meaning: "individuality", example: { jp: "同じ 服を 着ても、こせいは かくせません。", en: "Even wearing the same clothes, you can't hide individuality." }, drill: { jp: "こせいが つよいです。", en: "The individuality is strong." }, accept: ["what makes someone distinct", "personality", "one's own character"] },
        { id: "ja-u176l2-jisonshin", type: "vocab", front: "じそんしん", reading: "jisonshin", meaning: "self-respect", example: { jp: "人の 前で 直されて、じそんしんが 少し きずつきました。", en: "Being corrected in front of others bruised my self-respect a little." }, drill: { jp: "じそんしんが きずつきました。", en: "My self-respect was hurt." }, accept: ["pride in oneself", "self-esteem", "dignity"] },
        { id: "ja-u176l2-ishiki", type: "vocab", front: "いしき", reading: "ishiki", meaning: "awareness", example: { jp: "安全への いしきが 高まって、けがが へりました。", en: "Awareness of safety rose, and injuries fell." }, drill: { jp: "いしきが たかまりました。", en: "Awareness rose." }, accept: ["consciousness", "mindfulness", "being conscious of"] },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u176l3-kihan", type: "vocab", front: "きはん", reading: "kihan", meaning: "a norm", example: { jp: "書かれて いない きはんの ほうが、きそくより 強い ことが あります。", en: "Unwritten norms are sometimes stronger than the written rules." }, drill: { jp: "きはんが つよいです。", en: "The norm is strong." }, accept: ["standard", "the done thing", "social rule"] },
    ...
    },
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Talk about difference as something a society handles well or badly: たようせい しゅたい そんざい ゆうえつかん れっとうかん そういてん.",
      items: [
        ...
        { id: "ja-u176l4-shutai", type: "vocab", front: "しゅたい", reading: "shutai", meaning: "the acting party", example: { jp: "この 計画の しゅたいは 国では なく 住民です。", en: "The party carrying out this plan is the residents, not the state." }, drill: { jp: "しゅたいは じゅうみんです。", en: "The acting party is the residents." }, accept: ["the agent", "the one acting", "main body"] },
        { id: "ja-u176l4-sonzai", type: "vocab", front: "そんざい", reading: "sonzai", meaning: "presence", example: { jp: "小さな 店ですが、町には 大きな そんざいです。", en: "It's a small shop, but a large presence in the town." }, drill: { jp: "そんざいが おおきいです。", en: "Its presence is large." }, accept: ["existence", "being there", "a figure"] },
        ...
        { id: "ja-u176l4-soiten", type: "vocab", front: "そういてん", reading: "sōiten", meaning: "the point of difference", example: { jp: "二つの 考えの そういてんを まず はっきり させましょう。", en: "Let’s first make clear where the two ideas differ." }, drill: { jp: "二つの 考えの そういてんを 話します。", en: "We discuss where the two ideas differ." }, accept: ["the difference", "the point of contrast", "where they differ"], hint: "そうい (difference) + てん (point) — the specific place two things part company, rather than difference in general." },
      ],
    },
  ],
};
