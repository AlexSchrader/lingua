...
export const UNIT101 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "ja-u101l2-eikyo", type: "vocab", front: "えいきょう", reading: "eikyō", meaning: "influence", example: { jp: "てんきの えいきょうで、やさいの ねだんが たかく なりました。", en: "Under the influence of the weather, vegetable prices have gone up." }, drill: { jp: "えいきょうが おおきいです。", en: "The influence is great." }, accept: ["effect", "impact"] },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u101l4-ataeru", type: "vocab", front: "あたえる", reading: "ataeru", meaning: "to give", example: { jp: "その ニュースは まちの ひとに おおきな えいきょうを あたえました。", en: "That news had a big effect on the people of the town." }, drill: { jp: "えいきょうを あたえる。", en: "It gives an influence." }, accept: ["to grant", "to have (an effect)", "to provide"], hint: "えいきょうを あたえる is the set phrase for \"to affect\" — あげます is for handing someone a present, あたえる for abstract things." },
        ...
        { id: "ja-u101l4-hanno", type: "vocab", front: "はんのう", reading: "hannō", meaning: "reaction", example: { jp: "その ニュースを きいた ひとたちの はんのうは とても つよかったです。", en: "The reaction of the people who heard that news was very strong." }, drill: { jp: "はんのうが つよかったです。", en: "The reaction was strong." }, accept: ["response", "reception"] },
