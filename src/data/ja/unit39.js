...
export const UNIT39 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "ja-u39l2-kan", type: "kanji", front: "館", reading: "kan", meaning: "building", example: { jp: "図書館で本を読みます。", en: "I read books at the library." }, accept: ["building", "hall"], hint: "館 = hall / large building. 図書館 (としょかん) = library. 食 (eat) radical + 官: a grand public building." },
        ...
        { id: "ja-u39l2-do", type: "kanji", front: "堂", reading: "dō", meaning: "dining hall", example: { jp: "食堂でひるごはんを食べます。", en: "I eat lunch in the dining hall." }, accept: ["dining hall", "hall"], hint: "堂 = hall. 食堂 (しょくどう) = dining hall / cafeteria. 尚 over 土 (earth): a raised hall." },
