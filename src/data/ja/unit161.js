  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u161l1-ichijirushii", type: "vocab", front: "いちじるしい", reading: "ichijirushii", meaning: "marked", example: { jp: "この 十年で、町の すがたは いちじるしく 変わりました。", en: "Over these ten years the town's appearance has changed markedly." }, accept: ["striking", "conspicuous", "remarkable"] },
        { id: "ja-u161l1-kyugeki", type: "vocab", front: "きゅうげき", reading: "kyūgeki", meaning: "abrupt", example: { jp: "きゅうげきな へんかには、体が ついて いきません。", en: "The body can't keep up with abrupt change." }, accept: ["sudden", "sharp", "rapid"] },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u161l2-kasuka", type: "vocab", front: "かすか", reading: "kasuka", meaning: "faint", example: { jp: "とおくから かすかな 音が 聞こえて きました。", en: "A faint sound came from far away." }, accept: ["dim", "slight", "barely there"] },
        { id: "ja-u161l2-gokuwazuka", type: "vocab", front: "ごくわずか", reading: "gokuwazuka", meaning: "the merest fraction", example: { jp: "ごくわずかな 人しか、その 話を 知りません。", en: "Only the merest handful know that story." }, accept: ["a tiny amount", "very few", "minimal"] },
        { id: "ja-u161l2-hodohodo", type: "vocab", front: "ほどほど", reading: "hodohodo", meaning: "in moderation", example: { jp: "べんきょうも ほどほどに しないと、体を こわします。", en: "Even studying has to be in moderation, or you'll wreck your health." }, accept: ["moderately", "not overdoing it"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u161l3-omaka", type: "vocab", front: "おおまか", reading: "ōmaka", meaning: "broadly", example: { jp: "おおまかな よていだけ 決めて、あとは その 日に 考えます。", en: "We set only a broad plan and decide the rest on the day." }, accept: ["rough", "general", "in outline"] },
