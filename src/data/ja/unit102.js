  ...
  lessons: [
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Read the kanji of explanation: 説 (explain), 記 (write down), 議 (discuss), 評 (review), 表 (show), 示 (indicate).",
      items: [
        ...
        { id: "ja-u102l1-ki", type: "kanji", front: "記", reading: "ki", meaning: "to write down", example: { jp: "会った 人の 名前を ノートに 記して おきます。", en: "I write down the names of people I meet in my notebook." }, accept: ["record", "note", "account"], hint: "記 = put into writing — 言 (word) + 己 (self). 日記 = diary, 記事 = news article." },
        ...
        { id: "ja-u102l1-omote", type: "kanji", front: "表", reading: "hyō", meaning: "to show", example: { jp: "考えを ことばで 表すのは かんたんでは ありません。", en: "Expressing your thoughts in words isn't easy." }, accept: ["surface", "chart", "to express"], hint: "表 = the outward side — 表す (to express), 発表 (announcement), and also a table/chart on a page." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u102l2-sho", type: "kanji", front: "章", reading: "shō", meaning: "chapter", example: { jp: "この 本の 三章まで 読んで、今日は 休みます。", en: "I'll read up to chapter three of this book and stop for today." }, accept: ["section", "badge", "text"], hint: "章 = a chapter or a badge — a marked-off piece. 文章 = a piece of writing." },
      ],
    },
    {
      id: "ja-u102l3",
      ...
      items: [
        ...
        { id: "ja-u102l3-mosu", type: "kanji", front: "申", reading: "mōsu", meaning: "to say (humbly)", example: { jp: "山田と申しますが、店長さんは いますか。", en: "My name is Yamada — is the manager in?" }, accept: ["to state humbly", "to apply", "to report"], hint: "申す is the humble form of 言う — you use it about yourself, never about the person you are speaking to." },
