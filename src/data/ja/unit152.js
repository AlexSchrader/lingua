  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u152l1-shuden", type: "vocab", front: "しゅうでん", reading: "shūden", meaning: "last train of the night", example: { jp: "しゅうでんをのがしたので、タクシーでかえりました。", en: "I missed the last train, so I went home by taxi." }, accept: ["final train", "last service"], hint: "しゅう (end) + でん (train). しゅうでんまでに is an implicit deadline in every evening conversation in Japan." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u152l2-chakuriku", type: "vocab", front: "ちゃくりく", reading: "chakuriku", meaning: "landing", example: { jp: "ちゃくりくしてから、けいたいをつかってもいいです。", en: "You may use your phone after landing." }, accept: ["touching down", "to land"], hint: "ちゃく (arrive) + りく (land). The same ちゃく as とうちゃく (arrival) — one element, two useful words." },
      ],
    },
    {
      id: "ja-u152l3",
      ...
      items: [
        { id: "ja-u152l3-toho", type: "vocab", front: "とほ", reading: "toho", meaning: "on foot", example: { jp: "えきからとほ5ふんなので、あるいていきます。", en: "It's five minutes on foot from the station, so I'll walk." }, accept: ["walking (distance)", "by foot"], hint: "とほ5ふん is on every rental listing and restaurant page in Japan — the standard way of stating distance." },
        ...
        { id: "ja-u152l3-magarikado", type: "vocab", front: "まがりかど", reading: "magarikado", meaning: "corner (in a road)", example: { jp: "つぎのまがりかどをみぎにまがってください。", en: "Please turn right at the next corner." }, accept: ["turning", "street corner", "bend"], hint: "まがる (turn) + かど (corner). Also a turning point in life: じんせいのまがりかど." },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u152l4-minshuku", type: "vocab", front: "みんしゅく", reading: "minshuku", meaning: "family-run guesthouse", example: { jp: "ホテルよりやすいので、みんしゅくにとまりました。", en: "It's cheaper than a hotel, so we stayed at a guesthouse." }, accept: ["B&B", "guest house", "homestay inn"], hint: "A private home taking guests — cheaper and more personal than a りょかん, and usually including two home-cooked meals." },
        ...
        { id: "ja-u152l4-ryogae", type: "vocab", front: "りょうがえ", reading: "ryōgae", meaning: "currency exchange", example: { jp: "くうこうでりょうがえしましたが、レートがよくなかったです。", en: "I exchanged money at the airport, but the rate wasn't good." }, accept: ["changing money", "money exchange"], hint: "りょう (an old word for money) + かえる (change), with the か voicing to が. Also 'breaking a note into coins'." },
