  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u104l2-sho", type: "kanji", front: "商", reading: "shō", meaning: "commerce", example: { jp: "駅の 前に 小さな 商店が ならんで いて、いつも にぎやかです。", en: "Small shops line the front of the station, and it's always lively." }, accept: ["business", "merchant", "trade"], hint: "商 = buying and selling. 商品 = goods, 商店 = a shop, 商売 = business." },
        { id: "ja-u104l2-san", type: "kanji", front: "産", reading: "san", meaning: "to produce", example: { jp: "この 町の 主な 産業は 魚を とる 仕事で、秋は とても いそがしいです。", en: "This town's main industry is fishing, and autumn is very busy." }, accept: ["product", "industry", "birth"], hint: "産 = bring forth. 産業 = industry, お産 = childbirth — the same character for making anything new." },
      ],
    },
    {
      id: "ja-u104l3",
      ...
      items: [
        ...
        { id: "ja-u104l3-ne", type: "kanji", front: "値", reading: "ne", meaning: "price", example: { jp: "この 服は 値段が 高いですが、とても いい 品です。", en: "These clothes are pricey, but they're a very good product." }, accept: ["value", "worth", "figure"], hint: "値 = what a thing is worth — 亻 (person) + 直 (straight). 値段 = price, 価値 = value." },
