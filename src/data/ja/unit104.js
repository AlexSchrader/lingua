  ...
  lessons: [
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Read 職 (occupation), 勤 (to serve), 務 (duty), 労 (labour), and the words 勤務 and 労働.",
      items: [
        ...
        { id: "ja-u104l1-rodo", type: "vocab", front: "労働", reading: "rōdō", meaning: "labour", example: { jp: "長い 労働の あとの お茶は おいしいです。", en: "Tea after a long stretch of work tastes good." }, accept: ["work", "toil"], hint: "労 + 働 — both mean work; together they name work as a thing society organises, not a task you do." },
      ],
    },
    {
      id: "ja-u104l2",
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Read 貿 (trade), 商 (commerce), 産 (to produce), 収 (to take in), and the words 貿易 and 生産.",
      items: [
        ...
        { id: "ja-u104l3-boeki", type: "vocab", front: "貿易", reading: "bōeki", meaning: "trade", example: { jp: "この 国は 貿易で 大きく なりました。", en: "This country grew large through trade." }, accept: ["commerce", "import and export"] },
        { id: "ja-u104l3-seisan", type: "vocab", front: "生産", reading: "seisan", meaning: "production", example: { jp: "この 工場は 車の 部品を 生産して います。", en: "This factory produces car parts." }, accept: ["to produce", "manufacture", "output"] },
      ],
    },
    {
      id: "ja-u104l4",
