  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u104l1-kinmu", type: "vocab", front: "勤務", reading: "kinmu", meaning: "service (at a job)", example: { jp: "父の 勤務時間は 朝 早くから 始まります。", en: "My father's working hours start early in the morning." }, accept: ["service", "work", "shift"] },
