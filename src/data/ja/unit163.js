  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u163l2-kaisei", type: "vocab", front: "かいせい", reading: "kaisei", meaning: "amendment", example: { jp: "決まりの かいせいには、長い 話しあいが ひつようです。", en: "Amending a rule takes long discussion." }, accept: ["revision", "to amend", "reform"] },
      ],
    },
    {
      id: "ja-u163l3",
    ...
    },
    {
      ...
      items: [
        { id: "ja-u163l4-joyaku", type: "vocab", front: "じょうやく", reading: "jōyaku", meaning: "a treaty", example: { jp: "二つの 国は 平和の じょうやくを むすびました。", en: "The two countries concluded a peace treaty." }, accept: ["pact", "convention", "accord"] },
        ...
        { id: "ja-u163l4-shuken", type: "vocab", front: "しゅけん", reading: "shuken", meaning: "sovereignty", example: { jp: "小さな 国でも、しゅけんは 大きな 国と 同じです。", en: "Even a small country's sovereignty is equal to a large one's." }, accept: ["supreme authority", "self-rule"] },
