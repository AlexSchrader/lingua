...
export const UNIT151 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "ja-u151l3-danraku", type: "vocab", front: "だんらく", reading: "danraku", meaning: "paragraph", example: { jp: "さいごのだんらくが、いちばんたいせつです。", en: "The final paragraph is the most important." }, accept: ["section", "block of text"], hint: "The unit above a sentence. Japanese paragraphs are marked by a one-space indent, not a blank line." },
        { id: "ja-u151l3-ketsuron", type: "vocab", front: "けつろん", reading: "ketsuron", meaning: "conclusion", example: { jp: "ながくはなしましたが、けつろんはでませんでした。", en: "We talked for a long time, but reached no conclusion." }, accept: ["upshot", "finding", "verdict"], hint: "The end of an argument, in writing or in a meeting. けつろんからいうと = 'to give you the conclusion first' — a very useful opener." },
        ...
        { id: "ja-u151l3-dokusha", type: "vocab", front: "どくしゃ", reading: "dokusha", meaning: "reader (the person)", example: { jp: "どくしゃにわかりやすくかくのは、むずかしいです。", en: "Writing in a way that's clear to the reader is difficult." }, accept: ["readership", "audience (of a text)"], hint: "どく (read) + しゃ (person), the same しゃ as さくしゃ. Learn ～しゃ and you can guess ひつようしゃ, りようしゃ, さんかしゃ." },
      ],
    },
    {
      id: "ja-u151l4",
      ...
      items: [
        { id: "ja-u151l4-yosuruni", type: "vocab", front: "ようするに", reading: "yōsuruni", meaning: "in short, to sum up", example: { jp: "ようするに、じかんがたりないということです。", en: "In short, it comes down to not having enough time." }, accept: ["basically", "the point is", "in a nutshell"], hint: "Signals that you're about to compress everything into one sentence. Pairs naturally with ということです from u139." },
        { id: "ja-u151l4-kekkyoku", type: "vocab", front: "けっきょく", reading: "kekkyoku", meaning: "in the end, after all", example: { jp: "いろいろかんがえましたが、けっきょくいかないことにしました。", en: "I thought about it a lot, but in the end I decided not to go." }, accept: ["ultimately", "when all's said and done", "finally"], hint: "Reports where a process landed, usually after effort that didn't change much. Slightly weary in tone." },
        ...
        { id: "ja-u151l4-iwaba", type: "vocab", front: "いわば", reading: "iwaba", meaning: "so to speak, as it were", example: { jp: "かれはいわば、このチームのちちです。", en: "He is, so to speak, the father of this team." }, accept: ["you might say", "in a sense", "figuratively"], hint: "Flags the phrase that follows as a comparison, not a fact. It buys you permission to be imprecise on purpose." },
