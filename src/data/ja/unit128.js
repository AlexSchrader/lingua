  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u128l1-zetsu", type: "kanji", front: "絶", reading: "taeru", meaning: "sever", example: { jp: "その店は絶えず開いていますが、店員は少ないです。", en: "That shop is open without a break, but it has few staff." }, accept: ["cut off", "cease", "extinct"], hint: "絶 = 糸 (thread) cut clean through. 絶えず = without ceasing, 絶対 = absolutely." },
