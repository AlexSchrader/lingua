  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u128l1-ki", type: "kanji", front: "規", reading: "ki", meaning: "standard", example: { jp: "会社の規則は多いですが、みんな守っています。", en: "The company has a lot of rules, but everyone keeps to them." }, accept: ["rule", "norm", "measure"], hint: "規 = 夫 + 見 — measuring a thing against an agreed size. 規則 = regulations, 規もぼ = scale." },
        ...
        { id: "ja-u128l1-zetsu", type: "kanji", front: "絶", reading: "zetsu", meaning: "sever", example: { jp: "その店は絶えず開いていますが、店員は少ないです。", en: "That shop is open without a break, but it has few staff." }, accept: ["cut off", "cease", "extinct"], hint: "絶 = 糸 (thread) cut clean through. 絶えず = without ceasing, 絶対 = absolutely." },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u128l2-yuki", type: "kanji", front: "雪", reading: "setsu", meaning: "snow", example: { jp: "雪がふりましたが、道はこおりませんでした。", en: "It snowed, but the roads didn't ice over." }, accept: ["snowfall", "snowy"], hint: "雪 = 雨 (rain) + a hand sweeping — the rain you have to clear away. 大雪 = heavy snow." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u128l3-tsukuru", type: "kanji", front: "造", reading: "zō", meaning: "construct", example: { jp: "この家は木造ですが、火には強いそうです。", en: "This house is wooden construction, but apparently it's strong against fire." }, accept: ["build", "manufacture", "make"], hint: "造 = 辶 (go) + 告 — building something up step by step. 木造 = wooden-built. Same ぞう as 像." },
        ...
        { id: "ja-u128l3-hakaru", type: "kanji", front: "測", reading: "soku", meaning: "measure", example: { jp: "時間を測ったら、思ったより早かったです。", en: "When I measured the time, it was faster than I thought." }, accept: ["gauge", "take a measurement", "survey"], hint: "測 = 氵 (water) + 則 (rule) — laying a rule against water to read the depth. Same そく as 則, and the same right half." },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u128l4-ta", type: "kanji", front: "他", reading: "ta", meaning: "other", example: { jp: "他の店にも行きましたが、ここがいちばん安かったです。", en: "I went to other shops too, but this one was the cheapest." }, accept: ["another", "else", "the rest"], hint: "他 = 人 (person) + 也 — a person who is not this one. 他国 = another country, その他 = and others." },
        ...
        { id: "ja-u128l4-gun", type: "kanji", front: "隊", reading: "tai", meaning: "squad", example: { jp: "山に行った隊は無事でしたが、道はきびしかったです。", en: "The party that went into the mountains was safe, but the route was harsh." }, accept: ["unit", "corps", "party"], hint: "隊 = a line of people moving together down a slope 阝. Same たい sound as 対." },
