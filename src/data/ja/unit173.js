  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u173l1-7070", type: "kanji", front: "灰", reading: "hai", meaning: "ash", example: { jp: "そらが 灰色に なって、雨が ふりそうです。", en: "The sky has turned grey; it looks like rain." }, accept: ["ashes", "grey"], hint: "灰 (hai) = ash — 火 (fire) under a hand, what fire leaves. 灰色 = grey, 火山灰 = volcanic ash." },
        ...
        { id: "ja-u173l1-haiiro", type: "vocab", front: "灰色", reading: "haiiro", meaning: "grey", example: { jp: "ふゆの そらは いつも 灰色で、さむそうです。", en: "The winter sky is always grey and looks cold." }, drill: { jp: "灰色の そらです。", en: "It is a grey sky." }, accept: ["ash-coloured", "gray"] },
      ],
    },
    {
      id: "ja-u173l2",
      ...
      items: [
        ...
        { id: "ja-u173l2-hikaku", type: "vocab", front: "比較", reading: "hikaku", meaning: "comparison", example: { jp: "ねだんを 比較して、やすい ほうを えらびました。", en: "I compared the prices and chose the cheaper one." }, drill: { jp: "比較を しました。", en: "I made a comparison." }, accept: ["a contrast", "comparing"] },
      ],
    },
    {
      id: "ja-u173l3",
      ...
      items: [
        ...
        { id: "ja-u173l3-jikoku", type: "vocab", front: "時刻", reading: "jikoku", meaning: "the time", example: { jp: "バスの 出る 時刻を もう 一度 かくにんします。", en: "I'll check the bus departure time once more." }, drill: { jp: "時刻を かくにんします。", en: "I check the time." }, accept: ["the hour", "a point in time"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u173l4-keizai", type: "vocab", front: "経済", reading: "keizai", meaning: "economy", example: { jp: "大学で 世界の 経済に ついて 勉強して います。", en: "I'm studying the world economy at university." }, drill: { jp: "経済を べんきょうします。", en: "I study economics." }, accept: ["economics", "finance"] },
