  ...
  lessons: [
    {
      ...
      items: [
        { id: "ja-u158l1-suchi", type: "vocab", front: "すうち", reading: "sūchi", meaning: "a numerical value", example: { jp: "その すうちは 大きく 見えますが、たんいを 見ると 小さいです。", en: "That figure looks large, but it's small once you check the unit." }, drill: { jp: "すうちが おおきいです。", en: "The numerical value is large." }, accept: ["figure", "number", "reading"] },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u158l3-kensho", type: "vocab", front: "けんしょう", reading: "kenshō", meaning: "verification", example: { jp: "新聞は その 話の けんしょうに 半年 かけました。", en: "The paper spent six months verifying that story." }, drill: { jp: "けんしょうに じかんが かかります。", en: "Verification takes time." }, accept: ["to verify", "examination", "fact-checking"] },
        { id: "ja-u158l3-tekikaku", type: "vocab", front: "てきかく", reading: "tekikaku", meaning: "accurate", example: { jp: "てきかくな せつめいだったので、だれも 質問しませんでした。", en: "The explanation was accurate, so nobody asked anything." }, drill: { jp: "てきかくに せつめいします。", en: "I explain accurately." }, accept: ["precise", "apt", "to the point"] },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u158l4-hendo", type: "vocab", front: "へんどう", reading: "hendō", meaning: "fluctuation", example: { jp: "ねだんの へんどうが 大きいので、店も こまって います。", en: "Prices fluctuate a lot, so the shops are struggling too." }, drill: { jp: "へんどうが おおきいです。", en: "The fluctuation is large." }, accept: ["to fluctuate", "variation", "shift"] },
        ...
        { id: "ja-u158l4-fuantei", type: "vocab", front: "ふあんてい", reading: "fuantei", meaning: "unstable", example: { jp: "天気が ふあんていな 日は、ふねが 出ません。", en: "On days when the weather is unstable, the boats don't sail." }, drill: { jp: "ふあんていに なりました。", en: "It became unstable." }, accept: ["unsteady", "precarious", "shaky"] },
        ...
        { id: "ja-u158l4-kinko", type: "vocab", front: "きんこう", reading: "kinkō", meaning: "equilibrium", example: { jp: "入って くる お金と 出て いく お金の きんこうが 大切です。", en: "The equilibrium between money coming in and going out matters." }, drill: { jp: "きんこうが たいせつです。", en: "Equilibrium is important." }, accept: ["balance", "parity", "evenness"] },
      ],
    },
  ],
};
