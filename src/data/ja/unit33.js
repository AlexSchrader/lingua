  ...
  lessons: [
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Read the action kanji: 発 (emit), 動 (move), 開 (open), 通 (pass through), 使 (use), and the word 通学.",
      items: [
        ...
        { id: "ja-u33l1-tsugaku", type: "vocab", front: "通学", reading: "tsūgaku", meaning: "commuting to school", example: { jp: "毎日電車で通学します。", en: "I commute to school by train every day." }, drill: { jp: "電車で通学します。", en: "I commute to school by train." }, accept: ["going to school","the school commute"], hint: "通 (pass through) + 学 (study) — the trip to school you make over and over." },
      ],
    },
    {
      id: "ja-u33l2",
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Read the action kanji: 集 (gather), 送 (send), 起 (get up), 着 (arrive), 運 (carry), and the word 運動.",
      items: [
        ...
        { id: "ja-u33l2-undo", type: "vocab", front: "運動", reading: "undō", meaning: "exercise", example: { jp: "私は毎日運動します。", en: "I exercise every day." }, drill: { jp: "毎日運動します。", en: "I exercise every day." }, accept: ["sport","physical exercise","a workout"], hint: "運 (carry) + 動 (move) — moving your body about. You know it as うんどう; this is the writing." },
      ],
    },
  ],
};
