  ...
  lessons: [
    {
      ...
      items: [
        { id: "ja-u198l1-issekinicho", type: "vocab", front: "いっせきにちょう", reading: "issekinichō", meaning: "killing two birds with one stone", example: { jp: "歩いて 会社に 行けば、お金も かからず 体にも いい。いっせきにちょうです。", en: "Walking to work costs nothing and is good for you — two birds with one stone." }, accept: ["two birds one stone", "doubly effective"], hint: "一石二鳥 — one stone, two birds. The English idiom is the same image, which makes this the easiest of the set to keep." },
        ...
        { id: "ja-u198l1-yugenjikko", type: "vocab", front: "ゆうげんじっこう", reading: "yūgenjikkō", meaning: "doing what you said you'd do", example: { jp: "あの 人は ゆうげんじっこうで、言った ことは かならず やります。", en: "He's as good as his word — whatever he says, he does." }, accept: ["true to one's word", "suiting the action to the word"], hint: "有言実行 — words spoken, deeds done. A modern reversal of the older 不言実行 in the next card." },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u198l2-junintoiro", type: "vocab", front: "じゅうにんといろ", reading: "jūnintoiro", meaning: "everyone is different", example: { jp: "考え方は じゅうにんといろですから、話しあう ことが 大切です。", en: "Everyone thinks differently, so talking it over matters." }, accept: ["to each their own", "so many people so many minds"], hint: "十人十色 — ten people, ten colours. Used to close an argument gently rather than to win it." },
