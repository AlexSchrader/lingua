  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u145l1-bukiyo", type: "vocab", front: "ぶきよう", reading: "bukiyō", meaning: "clumsy with one's hands", example: { jp: "ぶきようなので、じをきれいにかくのがへたです。", en: "I'm clumsy, so I'm bad at writing neatly." }, accept: ["ham-fisted", "awkward", "unhandy"], hint: "ぶ～ is a negating prefix you'll meet again: ぶきよう, ぶあいそう. It flips the word it's attached to." },
        { id: "ja-u145l1-nonki", type: "vocab", front: "のんき", reading: "nonki", meaning: "easy-going, carefree", example: { jp: "かれはのんきで、テストのまえでもしんぱいしません。", en: "He's easy-going and doesn't worry even before a test." }, accept: ["laid-back", "happy-go-lucky", "unworried"], hint: "Admiring or exasperated depending on tone — the same trait is calm from inside and irresponsible from outside." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u145l2-taira", type: "vocab", front: "たいら", reading: "taira", meaning: "flat, level", example: { jp: "ここはたいらなので、テントをおくのにいいです。", en: "It's flat here, so it's a good spot for a tent." }, accept: ["even", "smooth", "horizontal"], hint: "Physically level ground or surface. For a flat, thin object (a plate, a board) you'd say うすい instead." },
      ],
    },
    {
      id: "ja-u145l3",
      ...
      items: [
        ...
        { id: "ja-u145l3-fushizen", type: "vocab", front: "ふしぜん", reading: "fushizen", meaning: "unnatural, forced", example: { jp: "このぶんはふしぜんなので、いいなおしたほうがいいです。", en: "This sentence sounds unnatural — better to rephrase it." }, accept: ["artificial", "awkward", "contrived"], hint: "ふ～ negates again (ふこうへい, ふゆかい). The single most useful word for asking about your own Japanese: ふしぜんですか。" },
