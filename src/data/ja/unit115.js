  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u115l2-kinto", type: "vocab", front: "均等", reading: "kintō", meaning: "evenly divided", example: { jp: "品物を みんなで 均等に 分けましたから、だれも こまりませんでした。", en: "We split the goods evenly between us, so nobody lost out." }, drill: { jp: "均等に わけます。", en: "We divide it evenly." }, accept: ["equal shares", "uniform", "even"], hint: "均 (even) + 等 (equal) — both glyphs of this lesson, meaning the same thing twice." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u115l3-manin", type: "vocab", front: "満員", reading: "manin", meaning: "full up", example: { jp: "バスが 満員で のれなかったので、あるいて 帰りました。", en: "The bus was packed and I couldn't get on, so I walked home." }, drill: { jp: "満員で のれません。", en: "It is full so I cannot get on." }, accept: ["packed", "no seats left", "sold out"] },
