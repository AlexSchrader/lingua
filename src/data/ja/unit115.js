  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u115l1-to", type: "kanji", front: "等", reading: "tō", meaning: "equal", example: { jp: "みんなに 同じ 品を 平等に わたしましたから、だれも こまりませんでした。", en: "The same items went to everyone equally, so nobody lost out." }, accept: ["and so on", "class", "grade"], hint: "等 = of the same rank — 竹 (bamboo) on top. 平等 = equality; after a list it means 'et cetera'." },
      ],
    },
    {
      id: "ja-u115l2",
      ...
      items: [
        ...
        { id: "ja-u115l2-man", type: "kanji", front: "満", reading: "man", meaning: "full", example: { jp: "電車が 満員でしたから、つぎのを 待つ ことに しました。", en: "The train was full, so I decided to wait for the next one." }, accept: ["to fill", "satisfaction"], hint: "満 = filled up — 氵 (water) at the left, a vessel brimming. 満員 = full up (of people), 満足 = satisfaction." },
        { id: "ja-u115l2-mi", type: "kanji", front: "未", reading: "mi", meaning: "not yet", example: { jp: "未来の ことは 分かりませんが、今 できる ことを します。", en: "I don't know what the future holds, but I'll do what I can now." }, accept: ["un-", "incomplete", "future"], hint: "未 = not yet — a tree 木 whose top branch hasn't grown out. 未来 = the future, what hasn't come." },
