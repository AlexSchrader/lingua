  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u115l1-suji", type: "vocab", front: "数字", reading: "sūji", meaning: "a numeral", example: { jp: "この 数字は 小さすぎて、読めません。", en: "This figure is too small to read." }, accept: ["figure", "digit", "number"] },
        { id: "ja-u115l1-tango", type: "vocab", front: "単語", reading: "tango", meaning: "a word", example: { jp: "知らない 単語が 多いので、まいにち おぼえて います。", en: "There are many words I don't know, so I learn some every day." }, accept: ["vocabulary item", "term"], hint: "単 (single) + 語 (word) — a word standing on its own, as against 文章." },
      ],
    },
    {
      id: "ja-u115l2",
      ...
      items: [
        ...
        { id: "ja-u115l2-to", type: "kanji", front: "等", reading: "tō", meaning: "equal", example: { jp: "みんなに 同じ 品を 平等に わたしましたから、だれも こまりませんでした。", en: "We split the goods evenly between us, so nobody lost out." }, accept: ["and so on", "class", "grade"], hint: "等 = of the same rank — 竹 (bamboo) on top. 平等 = equality; after a list it means 'et cetera'." },
        ...
        { id: "ja-u115l2-kinto", type: "vocab", front: "均等", reading: "kintō", meaning: "evenly divided", example: { jp: "品物を みんなで 均等に 分けましたから、だれも こまりませんでした。", en: "We split the goods evenly between us, so nobody lost out." }, accept: ["equal shares", "uniform", "even"], hint: "均 (even) + 等 (equal) — both glyphs of this lesson, meaning the same thing twice." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u115l3-manin", type: "vocab", front: "満員", reading: "manin", meaning: "full up", example: { jp: "バスが 満員で のれなかったので、あるいて 帰りました。", en: "The bus was packed and I couldn't get on, so I walked home." }, accept: ["packed", "no seats left", "sold out"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u115l4-wari", type: "kanji", front: "割", reading: "wari", meaning: "to divide", example: { jp: "ねだんの 一割を 先に はらって、のこりは あとで はらいます。", en: "I paid ten percent of the price up front and the rest later." }, accept: ["proportion", "ten percent", "to split"], hint: "割 = split into parts — 刂 (knife) on the right. 一割 = one tenth, so 三割引き is 30% off." },
        ...
        { id: "ja-u115l4-sun", type: "kanji", front: "寸", reading: "sun", meaning: "a little", example: { jp: "少し 時間を もらって、しあいの 寸前まで れんしゅうしました。", en: "I got a little extra time and practised right up to the moment of the match." }, accept: ["tiny amount", "old unit of length"], hint: "寸 = an old unit about 3cm, so by extension 'a tiny bit'. 寸前 = just before, at the last moment." },
        { id: "ja-u115l4-ryoshin", type: "vocab", front: "両親", reading: "ryōshin", meaning: "both parents", example: { jp: "両親に 手紙を 書いて、しゃしんも 送りました。", en: "I wrote my parents a letter and sent photos too." }, accept: ["parents", "mother and father"] },
