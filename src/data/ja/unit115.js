...
export const UNIT115 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Read 第 (number (ordinal)), 等 (equal), 均 (even), 総 (overall), and the words 平等 and 第一.",
      items: [
        ...
        { id: "ja-u115l2-byodo", type: "vocab", front: "平等", reading: "byōdō", meaning: "equality", example: { jp: "みんなに 同じ 品を 平等に わたしました。", en: "The same items went to everyone equally." }, accept: ["equal", "fair", "even-handed"] },
