  ...
  lessons: [
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Read 期 (period), 昨 (yesterday), 初 (first), 順 (order), and the words 学期 and 順番.",
      items: [
        ...
        { id: "ja-u117l1-gakki", type: "vocab", front: "学期", reading: "gakki", meaning: "school term", example: { jp: "学期の 終わりに 試験が ありますから、今から 勉強します。", en: "There's an exam at the end of term, so I'm studying from now." }, accept: ["semester", "term"] },
        { id: "ja-u117l1-junban", type: "vocab", front: "順番", reading: "junban", meaning: "one's turn", example: { jp: "順番に ならんで、一人ずつ 中に 入ります。", en: "Line up in turn and go in one at a time." }, accept: ["order", "sequence", "queue position"] },
      ],
    },
    {
      id: "ja-u117l2",
      ...
      items: [
        ...
        { id: "ja-u117l2-nichijo", type: "vocab", front: "日常", reading: "nichijō", meaning: "everyday life", example: { jp: "この 店は 日常の 品を 安く 売って います。", en: "This shop sells everyday goods cheaply." }, accept: ["daily life", "routine", "ordinary"] },
        { id: "ja-u117l2-kosoku", type: "vocab", front: "高速", reading: "kōsoku", meaning: "high speed", example: { jp: "高速の 電車なら、一時間で 着きます。", en: "On the fast train it's an hour." }, accept: ["express", "fast"], hint: "高 (high) + 速 (speed). 高速道路 = motorway." },
      ],
    },
    {
      id: "ja-u117l3",
      ...
      items: [
        ...
        { id: "ja-u117l3-to", type: "kanji", front: "到", reading: "tō", meaning: "to arrive", example: { jp: "ふねが 港に 到着して、みんな 元気に おりました。", en: "The ship arrived at the harbour, and everyone got off in good spirits." }, accept: ["reach", "arrival"], hint: "到 = reach the destination — 至 (arrive) + 刂. You meet it mostly in 到着 = arrival, the partner of 出発." },
        ...
        { id: "ja-u117l3-tochaku", type: "vocab", front: "到着", reading: "tōchaku", meaning: "arrival", example: { jp: "ふねが 港に 到着して、みんな 元気に おりました。", en: "The ship arrived at the harbour and everyone got off in good spirits." }, accept: ["to arrive", "getting in"] },
      ],
    },
    {
      id: "ja-u117l4",
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Read 束 (bundle), 予 (beforehand), 約 (promise), 存 (to exist), and the words 存在 and 花束.",
      items: [
        ...
        { id: "ja-u117l4-sonzai", type: "vocab", front: "存在", reading: "sonzai", meaning: "existence", example: { jp: "その 古い 店は 今も 存在して いて、みんなが よく 行きます。", en: "That old shop still exists, and people go there often." }, accept: ["to exist", "being", "presence"] },
