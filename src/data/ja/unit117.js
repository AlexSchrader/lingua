  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u117l3-to", type: "kanji", front: "到", reading: "tō", meaning: "to arrive", example: { jp: "ふねが 港に 到着して、みんな ゆっくり おりました。", en: "The ship arrived at the harbour, and everyone got off in good spirits." }, accept: ["reach", "arrival"], hint: "到 = reach the destination — 至 (arrive) + 刂. You meet it mostly in 到着 = arrival, the partner of 出発." },
        ...
        { id: "ja-u117l3-tochaku", type: "vocab", front: "到着", reading: "tōchaku", meaning: "arrival", example: { jp: "電車の 到着が おくれたので、会議に まにあいませんでした。", en: "The train's arrival was delayed, so I missed the meeting." }, accept: ["to arrive", "getting in"] },
      ],
    },
    {
      id: "ja-u117l4",
      ...
      items: [
        ...
        { id: "ja-u117l4-son", type: "kanji", front: "存", reading: "son", meaning: "to exist", example: { jp: "その 古い 店は 今も のこって いて、みんなが よく 行きます。", en: "That old shop is still there, and people go often." }, accept: ["to be", "existence", "to remain"], hint: "存 = be there / still standing. 存在 = existence; ご存じですか = do you know? — the polite form built on it." },
