  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u117l4-son", type: "kanji", front: "存", reading: "son", meaning: "to exist", example: { jp: "その 記録が 存在する ことを、今日 はじめて 知りました。", en: "I learned only today that the record exists." }, accept: ["to be", "existence", "to remain"], hint: "存 = be there / still standing. 存在 = existence; ご存じですか = do you know? — the polite form built on it." },
