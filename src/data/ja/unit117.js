  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u117l2-osoi", type: "kanji", front: "遅", reading: "osoi", meaning: "late", example: { jp: "電車が 遅れたので、会議に まに合いませんでした。", en: "The train was late, so I didn't make the meeting." }, accept: ["slow", "to be delayed", "behind"], hint: "遅 = behind time — ⻌ road again. 遅れる = to be delayed, 遅刻 = arriving late." },
        ...
        { id: "ja-u117l2-tei", type: "kanji", front: "停", reading: "tei", meaning: "to halt", example: { jp: "バス停で 十分 待って から、やっと 乗れました。", en: "I waited ten minutes at the bus stop and finally got on." }, accept: ["stop", "to stop over", "suspension"], hint: "停 = come to a stop — 亻 (person) on the left. バス停 = bus stop, 停電 = a power cut." },
        { id: "ja-u117l2-to", type: "kanji", front: "到", reading: "tō", meaning: "to arrive", example: { jp: "船が 港に 到着して、みんな 元気に 降りました。", en: "The ship arrived at the harbour, and everyone got off in good spirits." }, accept: ["reach", "arrival"], hint: "到 = reach the destination — 至 (arrive) + 刂. You meet it mostly in 到着 = arrival, the partner of 出発." },
      ],
    },
    {
      id: "ja-u117l3",
      ...
      items: [
        { id: "ja-u117l3-sho", type: "kanji", front: "昇", reading: "shō", meaning: "to rise", example: { jp: "朝 早く 山に 登って、日が 昇るのを 見ました。", en: "I climbed the mountain early and watched the sun rise." }, accept: ["to ascend", "promotion", "to go up"], hint: "昇 = go up — 日 (sun) on top. 日が 昇る = the sun rises; 昇進 = promotion at work." },
        ...
        { id: "ja-u117l3-yo", type: "kanji", front: "予", reading: "yo", meaning: "beforehand", example: { jp: "店に 予約を してから、友だちと 出かけました。", en: "I made a booking at the restaurant, then went out with my friend." }, accept: ["in advance", "reservation", "pre-"], hint: "予 = ahead of time. 予定 = a plan, 予約 = a reservation, 天気予報 = the weather forecast." },
        ...
        { id: "ja-u117l3-son", type: "kanji", front: "存", reading: "son", meaning: "to exist", example: { jp: "その 古い 店は 今も 存在して いて、みんなが よく 行きます。", en: "That old shop still exists, and people go there often." }, accept: ["to be", "existence", "to know (ご存じ)"], hint: "存 = be there / still standing. 存在 = existence; ご存じですか = do you know? — the polite form built on it." },
      ],
    },
  ],
};
