  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u117l4-yoyaku", type: "vocab", front: "予約", reading: "yoyaku", meaning: "a reservation", example: { jp: "店に 予約を してから、友だちと 出かけました。", en: "I made a booking at the shop, then went out with my friend." }, accept: ["booking", "appointment", "to reserve"], hint: "予 (beforehand) + 約 (promise) — a promise made in advance." },
