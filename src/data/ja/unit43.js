  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u43l1-teshimau", type: "vocab", front: "てしまう", reading: "teshimau", meaning: "do completely / (regrettably)", example: { jp: "ケーキをぜんぶたべてしまいました。", en: "I ate the whole cake (all of it)." }, drill: { jp: "ケーキをぜんぶたべてしまう。", en: "I eat the whole cake." }, accept: ["finish ~ing","end up ~ing","do it all"], hint: "て-form + しまう = finish completely, often with regret: たべてしまう = eat it all up." },
      ],
    },
    {
      id: "ja-u43l2",
      ...
      items: [
        ...
        { id: "ja-u43l2-kureru", type: "vocab", front: "くれる", reading: "kureru", meaning: "to give (to me/us)", example: { jp: "ちちがとけいをくれました。", en: "My dad gave me a watch." }, drill: { jp: "ちちがとけいをくれる。", en: "My father gives me a watch." }, accept: ["give me","give to me/us"], hint: "くれる = someone gives TO me (or my side). Same shape (は・に・を) but the direction is toward you. Use this, not あげる, when the gift comes to you." },
        { id: "ja-u43l2-morau", type: "vocab", front: "もらう", reading: "morau", meaning: "to receive", example: { jp: "ともだちにチョコレートをもらいました。", en: "I received chocolate from a friend." }, drill: { jp: "ともだちにチョコレートをもらう。", en: "I receive chocolate from a friend." }, accept: ["receive","get"], hint: "もらう = receive. The giver is marked with に (or から): (giver) に (thing) を もらう = 'get (thing) from (giver)'." },
