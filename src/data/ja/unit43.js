...
export const UNIT43 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Say who gives to whom (あげる・くれる・もらう・いただく), state what you intend to do (～つもり), and guess (だろう).",
      items: [
        ...
        { id: "ja-u43l2-itadaku", type: "vocab", front: "いただく", reading: "itadaku", meaning: "to receive (humble)", example: { jp: "せんせいに本をいただきました。", en: "I received a book from my teacher." }, drill: { jp: "せんせいから本をいただく。", en: "I receive a book from my teacher." }, accept: ["to receive humbly","to be given","receive"], hint: "The humble もらう, used when the giver outranks you — a teacher, a client, a host. いただきます before a meal is this same verb." },
      ],
    },
  ],
};
