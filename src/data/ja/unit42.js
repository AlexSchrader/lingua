...
export const UNIT42 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Read: 公 (public), 洋 (Western/ocean), 服 (clothes), 旅 (travel), 真 (true/real), and the word 旅行.",
      items: [
        ...
        { id: "ja-u42l2-ryoko", type: "vocab", front: "旅行", reading: "ryokō", meaning: "a trip", example: { jp: "来月、家族と旅行します。", en: "Next month I’m travelling with my family." }, drill: { jp: "旅行に行きます。", en: "I’m going on a trip." }, accept: ["travel","a journey","trip"], hint: "旅 (travel) + 行 (go). 旅行します = to take a trip; 旅行者 = a traveller." },
      ],
    },
  ],
};
