  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u150l1-juryo", type: "vocab", front: "じゅうりょう", reading: "jūryō", meaning: "weight", example: { jp: "にもつのじゅうりょうがおおいと、りょうきんがたかくなります。", en: "If the luggage weight is high, the charge goes up." }, accept: ["heaviness", "mass", "load"], hint: "The formal noun. おもさ (from おもい + さ) is the everyday word — that ～さ ending turns any adjective into its measure." },
        ...
        { id: "ja-u150l1-sunpo", type: "vocab", front: "すんぽう", reading: "sunpō", meaning: "measurements, dimensions", example: { jp: "かうまえに、すんぽうをはかっておきましょう。", en: "Let's measure the dimensions before we buy it." }, accept: ["size", "specification", "measurement"], hint: "The whole set of numbers together. From すん, an old unit of length — the word survived the unit itself." },
      ],
    },
    {
      id: "ja-u150l2",
      ...
      items: [
        ...
        { id: "ja-u150l2-heikin", type: "vocab", front: "へいきん", reading: "heikin", meaning: "average", example: { jp: "ことしのてんすうは、へいきんよりすこしよかったです。", en: "This year's score was a little better than average." }, accept: ["mean", "on average", "typical level"], hint: "Both the noun and the adverb: へいきんして3じかん = 'three hours on average'." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u150l3-gensho", type: "vocab", front: "げんしょう", reading: "genshō", meaning: "decrease", example: { jp: "こどものかずのげんしょうが、おおきなもんだいになっています。", en: "The decrease in the number of children has become a serious problem." }, accept: ["decline", "drop", "to decrease"], hint: "The pair to ぞうか, and the noun behind へります. じんこうげんしょう is a phrase you'll meet on any Japanese news page." },
        ...
        { id: "ja-u150l3-warizan", type: "vocab", front: "わりざん", reading: "warizan", meaning: "division", example: { jp: "わりざんのこたえがきれいにでないときもあります。", en: "Sometimes a division doesn't come out neatly." }, accept: ["dividing", "divided by"], hint: "わる (to divide, to split) + ざん. The same わる as わります in u142 — splitting something." },
      ],
    },
    {
      id: "ja-u150l4",
      ...
      items: [
        ...
        { id: "ja-u150l4-nodo", type: "vocab", front: "のうど", reading: "nōdo", meaning: "concentration (of a substance)", example: { jp: "のうどがこいので、みずでうすめてつかいます。", en: "The concentration is strong, so dilute it with water before use." }, accept: ["strength (of a solution)", "density"], hint: "How much of something is dissolved in something else. こい (strong) and うすい (weak) are the adjectives that go with it." },
        { id: "ja-u150l4-shindo", type: "vocab", front: "しんど", reading: "shindo", meaning: "seismic intensity", example: { jp: "しんど4のじしんがありましたが、けがはありませんでした。", en: "There was a magnitude-4 earthquake, but nobody was hurt." }, accept: ["quake intensity", "shaking scale"], hint: "Japan's own 0–7 scale of how strongly a quake was FELT at a place — different from マグニチュード, which measures the quake itself." },
        { id: "ja-u150l4-keta", type: "vocab", front: "けた", reading: "keta", meaning: "digit, order of magnitude", example: { jp: "けたをまちがえて、10ばいのきんがくをにゅうりょくしました。", en: "I got the digit wrong and entered ten times the amount." }, accept: ["place (of a number)", "figure", "column"], hint: "けたがちがう ('a different order of magnitude') is a common way to say something isn't even comparable." },
      ],
    },
  ],
};
