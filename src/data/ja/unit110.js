  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u110l2-fuku", type: "kanji", front: "福", reading: "fuku", meaning: "fortune", example: { jp: "みんなの幸福をねがいます。", en: "I wish for everyone's happiness." }, accept: ["luck","blessing"], hint: "こうふく 幸福 = happiness. 福（ふく）= good fortune." },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u110l3-hi2", type: "kanji", front: "非", reading: "hi", meaning: "non-", example: { jp: "きょうは非常にたのしいです。", en: "Today is very fun." }, accept: ["un-","not"], hint: "非常に（ひじょうに）= very. 非（ひ）= non-/not." },
        { id: "ja-u110l3-kan4", type: "kanji", front: "観", reading: "kan", meaning: "view", example: { jp: "あしたまちを観光します。", en: "Tomorrow I go sightseeing in the town." }, accept: ["outlook","look"], hint: "かんこう 観光 = sightseeing. 観る（みる）= to watch." },
        ...
        { id: "ja-u110l3-dan3", type: "kanji", front: "段", reading: "dan", meaning: "step", example: { jp: "階段をゆっくりのぼります。", en: "I climb the stairs slowly." }, accept: ["grade","stairs"], hint: "かいだん 階段 = stairs. 段（だん）= step/grade." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u110l4-yo6", type: "kanji", front: "様", reading: "yō", meaning: "Mr./Ms.", example: { jp: "お客様がきます。", en: "A customer is coming." }, accept: ["way","manner"], hint: "さま = polite suffix (Mr./Ms.). ようす 様子 = appearance." },
        { id: "ja-u110l4-zai2", type: "kanji", front: "財", reading: "zai", meaning: "wealth", example: { jp: "かれは財産がおおいです。", en: "He has a lot of wealth." }, accept: ["property","assets"], hint: "ざいさん 財産 = assets. さいふ 財布 = wallet." },
        ...
        { id: "ja-u110l4-shiki2", type: "kanji", front: "識", reading: "shiki", meaning: "knowledge", example: { jp: "せんせいは知識がふかいです。", en: "The teacher has deep knowledge." }, accept: ["know","discern"], hint: "ちしき 知識 = knowledge. じょうしき 常識 = common sense." },
