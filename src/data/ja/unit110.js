  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u110l1-susumeru", type: "vocab", front: "すすめる", reading: "susumeru", meaning: "to move forward", example: { jp: "けいかくを すすめる まえに、みんなの いけんを ききます。", en: "Before moving the plan forward, I'll ask everyone's opinion." }, accept: ["to advance", "to carry on with", "to push ahead"], hint: "Transitive: YOU move something forward. Its intransitive partner すすみます (already taught) is the thing moving by itself — 「はなしが すすむ」." },
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Handle the paperwork around a job: うちあわせ ていしゅつ しゅうせい きょか さんか ちょうせい.",
      items: [
        ...
        { id: "ja-u110l2-teishutsu", type: "vocab", front: "ていしゅつ", reading: "teishutsu", meaning: "submission", example: { jp: "レポートを きんようびまでに ていしゅつしなければ なりません。", en: "I have to submit the report by Friday." }, drill: { jp: "ていしゅつを します。", en: "I submit it." }, accept: ["handing in", "to submit", "filing"] },
        { id: "ja-u110l2-shusei", type: "vocab", front: "しゅうせい", reading: "shūsei", meaning: "revision", example: { jp: "しりょうを すこし しゅうせいしてから、もう いちど おくります。", en: "I'll revise the materials a little, then send them again." }, drill: { jp: "しゅうせいが おわりました。", en: "The revision is finished." }, accept: ["correction", "to amend", "fix"] },
        { id: "ja-u110l2-kyoka", type: "vocab", front: "きょか", reading: "kyoka", meaning: "permission", example: { jp: "しゃしんを とる まえに、みせの ひとの きょかを もらいました。", en: "Before taking photos I got the shopkeeper's permission." }, drill: { jp: "きょかを もらいました。", en: "I got permission." }, accept: ["approval", "authorisation", "consent"] },
        { id: "ja-u110l2-sanka", type: "vocab", front: "さんか", reading: "sanka", meaning: "to take part", example: { jp: "あしたの かいぎに さんかしますが、はやく かえります。", en: "I'll take part in tomorrow's meeting, but I'll leave early." }, accept: ["to participate", "to attend", "join"], hint: "さんかする takes に: 「かいぎに さんかします」. Using を is the commonest learner slip here." },
        { id: "ja-u110l2-chosei", type: "vocab", front: "ちょうせい", reading: "chōsei", meaning: "adjustment", example: { jp: "みんなの よていを ちょうせいして、あたらしい ひを きめました。", en: "We adjusted everyone's schedules and settled on a new day." }, drill: { jp: "ちょうせいを します。", en: "I make an adjustment." }, accept: ["coordination", "to arrange", "tuning"] },
      ],
    },
    {
      id: "ja-u110l3",
      ...
      items: [
        ...
        { id: "ja-u110l3-noritsu", type: "vocab", front: "のうりつ", reading: "nōritsu", meaning: "efficiency", example: { jp: "あさの ほうが のうりつが いいので、たいせつな しごとは あさに します。", en: "I'm more efficient in the morning, so I do the important work then." }, drill: { jp: "のうりつが いいです。", en: "The efficiency is good." }, accept: ["productivity", "how well it goes"] },
        { id: "ja-u110l3-tassei", type: "vocab", front: "たっせい", reading: "tassei", meaning: "achievement", example: { jp: "ことしの もくひょうを たっせいして、みんな とても うれしかったです。", en: "We achieved this year's goal, and everyone was very happy." }, drill: { jp: "たっせいが うれしいです。", en: "The achievement is a joy." }, accept: ["attainment", "to accomplish", "reaching a goal"] },
      ],
    },
    {
      id: "ja-u110l4",
