  ...
  lessons: [
    ...
    // Lesson 3: treatment
    {
      ...
      items: [
        ...
        { id: "ja-u72l3-kensa", type: "vocab", front: "けんさ", reading: "kensa", meaning: "examination", example: { jp: "びょういんでけんさをします。", en: "I have a test at the hospital." }, drill: { jp: "けんさをびょういんでします。", en: "I have the examination at the hospital." }, accept: ["test", "inspection"] },
    ...
    // Lesson 4: hospital & medical people
    {
      ...
      items: [
        ...
        { id: "ja-u72l4-taiin", type: "vocab", front: "たいいん", reading: "taiin", meaning: "leaving hospital", example: { jp: "あした、たいいんします。", en: "I leave the hospital tomorrow." }, drill: { jp: "たいいんはあしたです。", en: "Leaving hospital is tomorrow." }, accept: ["hospital discharge", "being discharged"] },
        ...
        { id: "ja-u72l4-kangoshi", type: "vocab", front: "かんごし", reading: "kangoshi", meaning: "nurse", example: { jp: "かのじょはかんごしです。", en: "She is a nurse." }, drill: { jp: "かんごしはしんせつです。", en: "The nurse is kind." }, accept: ["a nurse"] },
