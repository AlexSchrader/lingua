  ...
  lessons: [
    {
      ...
      items: [
        { id: "ja-u202l1-fukisoku", type: "vocab", front: "ふきそく", reading: "fukisoku", meaning: "irregular", example: { jp: "しごとの 時間が ふきそくで、体に よく ありません。", en: "My working hours are irregular, which isn't good for my health." }, drill: { jp: "ふきそくに なります。", en: "It becomes irregular." }, accept: ["erratic", "unsystematic"], hint: "不 says the quality is absent or wrong; 無 says the thing itself is not there. ふきそく = not regular; むいみ = without meaning." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u202l2-mikansei", type: "vocab", front: "みかんせい", reading: "mikansei", meaning: "unfinished", example: { jp: "この 画は みかんせいの ままで 残されました。", en: "This painting was left unfinished." }, drill: { jp: "みかんせいの ままです。", en: "It stays unfinished." }, accept: ["incomplete", "not finished"] },
