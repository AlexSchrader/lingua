...
export const UNIT20 = {
  ...
  lessons: [
    ...
    // Lesson 2: に and が — going & existing
    {
      ...
      cefr: "A1",
      dominantMode: "recall",
      canDo: "Use に for a destination/place of existence and が to mark what exists: がっこうにいきます, ねこがいます — and say なにかあります when you cannot name it.",
      items: [
        ...
        { id: "ja-u20l2-nanika", type: "vocab", front: "なにか", reading: "nanika", meaning: "something", example: { jp: "へやになにかあります。", en: "There is something in the room." }, drill: { jp: "なにかあります。", en: "There is something." }, accept: ["anything","some thing"], hint: "なに + か turns the question word into “some-”. なにか = something, and the same か gives だれか (someone) and どこか (somewhere)." },
      ],
    },
    ...
    // Lesson 4: へ・から・まで + frequency
    {
      ...
      cefr: "A1",
      dominantMode: "recall",
      canDo: "Give direction and range: がっこうへいきます, くじからごじまで. Say how often with よく / あまり, and roughly when with ごろ.",
      items: [
        ...
        { id: "ja-u20l4-goro", type: "vocab", front: "ごろ", reading: "goro", meaning: "around (a time)", example: { jp: "くじごろいきます。", en: "I’ll go at about nine." }, drill: { jp: "くじごろかえります。", en: "I go home at about nine." }, accept: ["about (a time)","approximately","at about","around"], hint: "ごろ attaches to a POINT in time — くじごろ, around nine. For a LENGTH of time Japanese uses ぐらい instead." },
      ],
    },
    // Lesson 5: invitations & requests
    {
      ...
      cefr: "A1",
      dominantMode: "recall",
      canDo: "Invite and request: たべませんか (shall we eat?), いきましょう (let's go), みずをください (water, please), みてください (please look).",
      items: [
        ...
        { id: "ja-u20l5-tekudasai", type: "vocab", front: "てください", reading: "tekudasai", meaning: "please do ~", example: { jp: "これをみてください。", en: "Please look at this." }, drill: { jp: "まどをあけてください。", en: "Please open the window." }, accept: ["please (do something)","do ~ please","please"], hint: "ください on its own asks for a THING: みずをください. Put a verb’s て-form in front and it asks for an ACTION: みてください, よんでください." },
      ],
    },
  ],
};
