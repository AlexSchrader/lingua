  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u136l2-ryoterritory", type: "kanji", front: "領", reading: "ryō", meaning: "territory", example: { jp: "この島は国の領土ですが、人は住んでいません。", en: "This island is national territory, but nobody lives there." }, accept: ["domain", "jurisdiction", "possession"], hint: "領 = 令 (command) + 頁 (head) — the ground someone's word runs over. 領土 = territory, 領事館 = a consulate." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u136l3-ro", type: "kanji", front: "路", reading: "ro", meaning: "road", example: { jp: "道路が広くなったので、車が早く走ります。", en: "The road got wider, so cars go fast." }, accept: ["route", "way", "path"], hint: "路 = 足 (foot) + 各 — where feet go. 道路 = a road, 線路 = a railway line." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u136l4-wa", type: "kanji", front: "和", reading: "wa", meaning: "harmony", example: { jp: "和食は体にいいですが、作るのは難しいです。", en: "Japanese food is good for you, but it's difficult to make." }, accept: ["Japanese-style", "peace", "sum"], hint: "和 = 禾 (grain) + 口 (mouth) — everyone fed, nobody quarrelling. 平和 = peace; as a prefix, 和 = Japanese-style." },
