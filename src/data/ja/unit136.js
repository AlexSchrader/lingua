  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u136l2-midareru", type: "kanji", front: "乱", reading: "midareru", meaning: "disorder", example: { jp: "風で紙が乱れましたが、すぐ直しました。", en: "The papers were thrown into disorder by the wind, but I tidied them at once." }, accept: ["chaos", "be in a mess", "riot"], hint: "乱 = threads all tangled at once. 乱れます = to fall into disorder, 乱暴 = violent behaviour." },
