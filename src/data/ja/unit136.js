  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u136l1-sama", type: "kanji", front: "様", reading: "yō", meaning: "manner", example: { jp: "同じ様に作りましたが、味がちがいます。", en: "I made it the same way, but the taste is different." }, accept: ["way", "appearance", "Mr/Ms (polite)"], hint: "様 = the way a thing is or appears. 田中様 = Mr/Ms Tanaka, a step politer than さん; 様子 = how things look." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u136l2-midareru", type: "kanji", front: "乱", reading: "midareru", meaning: "disorder", example: { jp: "風で紙が乱れましたが、すぐ直しました。", en: "The papers were thrown into disorder by the wind, but I tidied them at once." }, accept: ["chaos", "be in a mess", "riot"], hint: "乱 = threads all tangled at once. 乱れます = to fall into disorder, 乱ぼう = violent behaviour." },
