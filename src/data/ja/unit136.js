  ...
  lessons: [
    {
      ...
      items: [
        { id: "ja-u136l1-yu", type: "kanji", front: "輸", reading: "yu", meaning: "convey", example: { jp: "車を輸出する会社なので、外国語を使う日が多いです。", en: "It's a company that exports cars, so we use foreign languages most days." }, accept: ["ship", "convey", "export/import", "transport"], hint: "輸 = 車 (vehicle) carrying goods away. 輸出 = export (out), 輸入 = import (in)." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u136l4-ro", type: "kanji", front: "路", reading: "ro", meaning: "route", example: { jp: "道路が広くなったので、車が速く走ります。", en: "The road got wider, so cars go fast." }, accept: ["route", "way", "path", "road"], hint: "路 = 足 (foot) + 各 — where feet go. 道路 = a road, 線路 = a railway line." },
