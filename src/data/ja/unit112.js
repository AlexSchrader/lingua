  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u112l2-nasakenai", type: "vocab", front: "なさけない", reading: "nasakenai", meaning: "pathetic", example: { jp: "かんたんな まちがいを して、じぶんが なさけなく なりました。", en: "I made a simple mistake and felt pathetic." }, accept: ["ashamed of oneself", "miserable", "sorry"] },
        { id: "ja-u112l2-tomadoi", type: "vocab", front: "とまどい", reading: "tomadoi", meaning: "bewilderment", example: { jp: "あたらしい しごとの はじめは とまどいが おおきかったですが、いまは なれました。", en: "At the start of the new job the bewilderment was great, but now I've got used to it." }, accept: ["confusion", "being at a loss", "puzzlement"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u112l3-akogare", type: "vocab", front: "あこがれ", reading: "akogare", meaning: "longing", example: { jp: "こどもの ときから、せんせいに あこがれが ありました。", en: "Ever since I was a child I've looked up to teachers." }, accept: ["admiration", "yearning", "looking up to"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u112l4-shinken", type: "vocab", front: "しんけん", reading: "shinken", meaning: "serious", example: { jp: "あの ひとは しんけんな かおで はなしを きいて いました。", en: "That person listened with a serious face." }, accept: ["earnest", "in earnest", "sincere"] },
        ...
        { id: "ja-u112l4-yaruki", type: "vocab", front: "やるき", reading: "yaruki", meaning: "motivation", example: { jp: "あたらしい しごとを もらって、やるきが でて きました。", en: "I was given new work, and my motivation came back." }, accept: ["drive", "willingness", "enthusiasm"] },
      ],
    },
  ],
};
