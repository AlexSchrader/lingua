  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u149l3-tsushin", type: "vocab", front: "つうしん", reading: "tsūshin", meaning: "communication, data transmission", example: { jp: "やまのなかでは、つうしんがきれてしまいました。", en: "Up in the mountains the connection dropped." }, accept: ["signal", "correspondence", "telecoms"], hint: "The traffic rather than the link — つうしんりょう is your data allowance. せつぞく is being connected; つうしん is what flows." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u149l4-nokogiri", type: "vocab", front: "のこぎり", reading: "nokogiri", meaning: "saw", example: { jp: "のこぎりできをきって、はこをつくりました。", en: "I cut the wood with a saw and made a box." }, accept: ["handsaw", "wood saw"], hint: "A Japanese saw cuts on the PULL stroke, not the push — worth knowing before you borrow one." },
