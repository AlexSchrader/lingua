  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u149l1-shuri", type: "vocab", front: "しゅうり", reading: "shūri", meaning: "repair", example: { jp: "しゅうりにだしたら、いっしゅうかんかかるといわれました。", en: "I sent it for repair and was told it would take a week." }, accept: ["to fix", "mending", "servicing"], hint: "The formal noun; なおします is the everyday verb. しゅうりにだす = to send something off to be fixed." },
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Work a Japanese interface: にゅうりょく, けんさく, ファイル, さくじょ, キーボード, マウス.",
      items: [
        ...
        { id: "ja-u149l2-nyuryoku", type: "vocab", front: "にゅうりょく", reading: "nyūryoku", meaning: "input, entering data", example: { jp: "なまえとじゅうしょをにゅうりょくしてから、つぎへすすんでください。", en: "Enter your name and address, then move on to the next step." }, accept: ["to enter", "to type in", "data entry"], hint: "On every Japanese form and app. Its opposite しゅつりょく (output) follows the same shape." },
        { id: "ja-u149l2-kensaku", type: "vocab", front: "けんさく", reading: "kensaku", meaning: "searching (for information)", example: { jp: "わからないことばは、すぐけんさくするようにしています。", en: "I make a point of searching any word I don't know straight away." }, accept: ["to search", "look-up", "to google"], hint: "Searching a database or the web. さがします is looking for a physical thing; けんさく is looking it up." },
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Get yourself online and signed in: とうろく, ログイン, パスワード, せつぞく, つうしん, ほぞん.",
      items: [
        { id: "ja-u149l3-toroku", type: "vocab", front: "とうろく", reading: "tōroku", meaning: "registration", example: { jp: "とうろくがおわったら、すぐにつかえるようになります。", en: "Once registration is finished, you'll be able to use it right away." }, accept: ["to register", "sign-up", "enrolment"], hint: "Signing up for anything — a service, a class, a residence record. とうろくする is the button you press." },
        ...
        { id: "ja-u149l3-tsushin", type: "vocab", front: "つうしん", reading: "tsūshin", meaning: "communication, data transmission", example: { jp: "でんぱがよわくて、つうしんがきれてしまいました。", en: "The signal was weak and the connection dropped." }, accept: ["signal", "correspondence", "telecoms"], hint: "The traffic rather than the link — つうしんりょう is your data allowance. せつぞく is being connected; つうしん is what flows." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u149l4-kanazuchi", type: "vocab", front: "かなづち", reading: "kanazuchi", meaning: "hammer", example: { jp: "かなづちでくぎをうって、たなをつけました。", en: "I hammered in a nail and put up the shelf." }, accept: ["mallet", "claw hammer"], hint: "かな (metal) + つち (mallet), with the つ voicing to づ inside the compound. It also means someone who can't swim at all." },
        { id: "ja-u149l4-nokogiri", type: "vocab", front: "のこぎり", reading: "nokogiri", meaning: "saw", example: { jp: "のこぎりでいたをきって、はこをつくりました。", en: "I cut the board with a saw and made a box." }, accept: ["handsaw", "wood saw"], hint: "A Japanese saw cuts on the PULL stroke, not the push — worth knowing before you borrow one." },
        ...
        { id: "ja-u149l4-suitchi", type: "vocab", front: "スイッチ", reading: "suitchi", meaning: "switch", example: { jp: "でんきのスイッチは、ドアのよこにあります。", en: "The light switch is next to the door." }, accept: ["light switch", "toggle"], hint: "スイッチをいれる (turn on) and スイッチをきる (turn off) — いれる/きる, not オン/オフ, in normal speech." },
