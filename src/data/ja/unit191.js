...
export const UNIT191 = {
  ...
  lessons: [
    ...
    // Lesson 2: lowering yourself — the humble frame
    {
      ...
      items: [
        { id: "ja-u191l2-omochisuru", type: "vocab", front: "おもちする", reading: "omochisuru", meaning: "to carry / bring (humble)", example: { jp: "おにもつは 私が おもちします。", en: "I'll carry your luggage." }, accept: ["I'll bring", "humbly carry", "let me hold that"], hint: "The humble master frame: お + verb stem + する lowers YOUR OWN action to serve the other. 持つ→おもちする. For する-verbs it becomes ご～する (ご連絡する)." },
    ...
    // Lesson 3: the humble verbs the frame can't build
    {
      ...
      items: [
        ...
        { id: "ja-u191l3-omenikakeru", type: "vocab", front: "おめにかける", reading: "omenikakeru", meaning: "to show (humble)", example: { jp: "新しい 作品を おめにかけたいと 思います。", en: "I'd like to show you my new work." }, accept: ["to let you see", "humbly present", "to put before you"], hint: "お目にかける — the minimal-pair partner of おめにかかる: かかる is 'I meet you', かける is 'I show you'. The humble 見せる, for presenting your own thing to a superior." },
        ...
        { id: "ja-u191l3-haidokusuru", type: "vocab", front: "はいどくする", reading: "haidokusuru", meaning: "to read (humble)", example: { jp: "お手紙を はいどくしました。ご返事が おそくなり、失礼しました。", en: "I have read your letter. My apologies for the late reply." }, accept: ["to humbly read", "have read (respectfully)", "read your (letter)"], hint: "拝読 — the humble 読む, for reading something a superior wrote. はいどくしました is the standard opening once you've read someone's letter or document." },
        { id: "ja-u191l3-haichosuru", type: "vocab", front: "はいちょうする", reading: "haichōsuru", meaning: "to listen (humble)", example: { jp: "先生の お話を はいちょうして、考えが 変わりました。", en: "Having listened to your talk, sensei, my thinking changed." }, accept: ["to humbly listen", "hear (respectfully)", "attend to (a talk)"], hint: "拝聴 — the humble 聞く, for listening to a talk or performance by someone senior. Completes the 拝 family with 拝借 and 拝読." },
    ...
    // Lesson 4: the formal apparatus
    {
      ...
      items: [
        ...
        { id: "ja-u191l4-teorimasu", type: "vocab", front: "ております", reading: "teorimasu", meaning: "to be doing (humble ～ている)", example: { jp: "その 件は、私どもも しょうちして おります。", en: "We too are aware of that matter." }, accept: ["am ~ing (humble)", "humble of ている", "we are (doing)"], hint: "おる is the humble いる, so て+おります humbly lowers ～ている about yourself: 待っております, 存じております. Never use it about the listener — for them it's ～ていらっしゃる." },
