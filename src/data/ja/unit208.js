  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u208l1-okotaru", type: "vocab", front: "おこたる", reading: "okotaru", meaning: "to neglect (a duty)", example: { jp: "かくにんを おこたった ことが げんいんです。", en: "The cause was a failure to check." }, drill: { jp: "かくにんを おこたる。", en: "I neglect the check." }, accept: ["to fail to do", "to be remiss in"], hint: "Formal blame for something not done that should have been. Reports and apologies use it; conversation says わすれた." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u208l2-makanau", type: "vocab", front: "まかなう", reading: "makanau", meaning: "to cover (a cost), to provide for", example: { jp: "ひようは ぜんぶ じぶんで まかないました。", en: "I covered all the costs myself." }, drill: { jp: "ひようを じぶんで まかなう。", en: "I cover the cost myself." }, accept: ["to finance", "to cater for"], hint: "Making the supply meet the need — money, food, staff. まかないつき on a job ad means meals are included." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u208l4-yashinau", type: "vocab", front: "やしなう", reading: "yashinau", meaning: "to support (a family); to cultivate (a habit)", example: { jp: "はたらいて 家ぞくを やしなって います。", en: "He works to support his family." }, drill: { jp: "かぞくを やしなう。", en: "I support my family." }, accept: ["to provide for", "to foster", "to build up"], hint: "Feeding a family, and growing a quality in yourself — しゅうかんを やしなう, ちからを やしなう. Both are long, patient nourishment." },
        ...
        { id: "ja-u208l4-moyosu", type: "vocab", front: "もよおす", reading: "moyōsu", meaning: "to hold (an event)", example: { jp: "毎年 この 時期に 大きな 会を もよおします。", en: "Every year at this time they hold a large gathering." }, drill: { jp: "おおきな かいを もよおす。", en: "We hold a big gathering." }, accept: ["to stage", "to put on (an event)"], hint: "The formal かいさい (u192), and the noun もよおし is what a listings page calls an event." },
      ],
    },
  ],
};
