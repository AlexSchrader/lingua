  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u195l1-mitsumeau", type: "vocab", front: "みつめあう", reading: "mitsumeau", meaning: "to look into each other's eyes", example: { jp: "二人は だまって みつめあって いました。", en: "The two of them were silently looking into each other's eyes." }, drill: { jp: "ふたりが みつめあう。", en: "The two look into each other's eyes." }, accept: ["to gaze at one another", "to lock eyes"] },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u195l2-oitsuku", type: "vocab", front: "おいつく", reading: "oitsuku", meaning: "to catch up with", example: { jp: "急いで 走って、やっと おいつきました。", en: "I hurried and ran, and finally caught up." }, drill: { jp: "はしって おいつく。", en: "I run and catch up." }, accept: ["to overtake (to level)", "to draw level with"], hint: "おう (chase) + つく (arrive) — the chase ends in arrival. For work and study too: おくれを おいつく." },
        { id: "ja-u195l2-tadoritsuku", type: "vocab", front: "たどりつく", reading: "tadoritsuku", meaning: "to finally reach (after difficulty)", example: { jp: "道に まよって、暗く なってから 宿に たどりつきました。", en: "I got lost and reached the inn only after dark." }, drill: { jp: "やっと やどに たどりつく。", en: "I finally reach the inn." }, accept: ["to struggle to", "to make it at last"], hint: "The arrival was hard-won. つく alone is neutral; たどりつく has the whole difficult journey inside it." },
        { id: "ja-u195l2-shigamitsuku", type: "vocab", front: "しがみつく", reading: "shigamitsuku", meaning: "to cling on to", example: { jp: "子どもが 母おやに しがみついて 泣いて いました。", en: "The child was clinging to its mother and crying." }, drill: { jp: "こどもが ははおやに しがみつく。", en: "The child clings to its mother." }, accept: ["to hold on tight", "to cling desperately"], hint: "Physical clinging, and clinging to a job or a position past the point of dignity." },
        { id: "ja-u195l2-musubitsuku", type: "vocab", front: "むすびつく", reading: "musubitsuku", meaning: "to be connected to, to lead to", example: { jp: "毎日の 練習が よい けっかに むすびつきました。", en: "The daily practice led to a good result." }, drill: { jp: "れんしゅうが けっかに むすびつく。", en: "The practice leads to results." }, accept: ["to link up with", "to tie in with", "to result in"], hint: "むすぶ is tying; むすびつく is two things turning out to be tied. Its transitive twin むすびつける is you doing the tying." },
        { id: "ja-u195l2-yakitsukeru", type: "vocab", front: "やきつける", reading: "yakitsukeru", meaning: "to burn into (the memory)", example: { jp: "その けしきを 目に やきつけました。", en: "I burned that scene into my memory." }, drill: { jp: "けしきを めに やきつける。", en: "I burn the scenery into my memory." }, accept: ["to sear in", "to fix in the mind", "to print (a photo)"], hint: "やく (burn) + つける (fix on). 目に やきつける is the set phrase for a sight you intend never to lose." },
        { id: "ja-u195l2-hikitsukeru", type: "vocab", front: "ひきつける", reading: "hikitsukeru", meaning: "to attract, to draw in", example: { jp: "その 話は 多くの 人を ひきつけました。", en: "That story drew a lot of people in." }, drill: { jp: "おおくの ひとを ひきつける。", en: "It attracts many people." }, accept: ["to captivate", "to pull in", "to fascinate"], hint: "ひく (pull) + つける — pulling something toward you and holding it there. Used of speakers, shops and magnets alike." },
      ],
    },
    {
      id: "ja-u195l3",
      ...
      items: [
        ...
        { id: "ja-u195l3-sagashimawaru", type: "vocab", front: "さがしまわる", reading: "sagashimawaru", meaning: "to search high and low", example: { jp: "かぎを 家じゅう さがしまわりました。", en: "I searched high and low for the key all over the house." }, drill: { jp: "いえじゅう さがしまわる。", en: "I search the whole house." }, accept: ["to hunt everywhere", "to scour"] },
        ...
        { id: "ja-u195l3-mimawaru", type: "vocab", front: "みまわる", reading: "mimawaru", meaning: "to patrol, to make the rounds", example: { jp: "夜に なると、けいびの 人が みまわります。", en: "At night the security staff make their rounds." }, drill: { jp: "よるに みまわる。", en: "They patrol at night." }, accept: ["to do a round", "to inspect (on a circuit)"], hint: "Looking with a route — a guard, a nurse, a teacher on duty. The noun みまわり is the round itself." },
