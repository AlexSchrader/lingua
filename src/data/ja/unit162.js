  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u162l2-9650", type: "kanji", front: "限", reading: "gen", meaning: "limit", example: { jp: "時間には 限りが あるので、はやめに もうしこんで ください。", en: "There's a limit on the time, so please apply early." }, accept: ["bound", "restriction"], hint: "限り (kagiri) = a limit or 'as far as'. 制限 = a restriction; 限界 = the very edge of what is possible." },
