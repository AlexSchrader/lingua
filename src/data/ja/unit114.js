  ...
  lessons: [
    {
      ...
      items: [
        { id: "ja-u114l1-gainen", type: "vocab", front: "がいねん", reading: "gainen", meaning: "concept", example: { jp: "じかんと いう がいねんは、くにによって ちがう ことも あります。", en: "The concept of time can differ from country to country." }, drill: { jp: "がいねんが むずかしいです。", en: "The concept is difficult." }, accept: ["notion", "idea"] },
        ...
        { id: "ja-u114l1-gutaiteki", type: "vocab", front: "ぐたいてき", reading: "gutaiteki", meaning: "concrete", example: { jp: "ぐたいてきな れいを あげて せつめいすると、みんな よく わかります。", en: "If you explain by giving a concrete example, everyone understands." }, drill: { jp: "ぐたいてきに せつめいします。", en: "I explain it concretely." }, accept: ["specific", "definite", "tangible"] },
        { id: "ja-u114l1-igi", type: "vocab", front: "いぎ", reading: "igi", meaning: "significance", example: { jp: "この しごとには おおきな いぎが ありますから、つづけたいです。", en: "This work has great significance, so I want to carry on with it." }, drill: { jp: "いぎが あります。", en: "It has significance." }, accept: ["meaning", "point", "value"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u114l3-rikai", type: "vocab", front: "りかい", reading: "rikai", meaning: "understanding", example: { jp: "せつめいを きいて、もんだいの りかいが ふかく なりました。", en: "I listened to the explanation, and my understanding of the problem deepened." }, drill: { jp: "りかいが ふかく なりました。", en: "My understanding got deeper." }, accept: ["comprehension", "to understand", "grasp"] },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u114l4-seishitsu", type: "vocab", front: "せいしつ", reading: "seishitsu", meaning: "nature", example: { jp: "この どうぶつは しずかな せいしつで、こどもにも あんぜんです。", en: "This animal has a quiet nature, and is safe around children too." }, drill: { jp: "せいしつが しずかです。", en: "Its nature is quiet." }, accept: ["character", "property", "disposition"] },
        { id: "ja-u114l4-keishiki", type: "vocab", front: "けいしき", reading: "keishiki", meaning: "form", example: { jp: "レポートの けいしきは たいせつですから、よく かくにんして ください。", en: "The form of the report matters, so please check it carefully." }, drill: { jp: "けいしきは たいせつです。", en: "The form is important." }, accept: ["format", "style", "formality"] },
