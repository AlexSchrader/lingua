  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u167l1-bunshi", type: "vocab", front: "ぶんし", reading: "bunshi", meaning: "a molecule", example: { jp: "水の ぶんしは、げんしが 三つ あつまって できて います。", en: "A water molecule is made of three atoms together." }, accept: ["molecular"], hint: "げんし is the single piece; ぶんし is the assembly. 原 = origin, 分 = divide — the naming runs the opposite way to English." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u167l3-kogaku", type: "vocab", front: "こうがく", reading: "kōgaku", meaning: "engineering", example: { jp: "大学で こうがくを 勉強して、車を 作る 会社に 入りました。", en: "I studied engineering at university and joined a carmaker." }, accept: ["technology studies", "applied science"] },
