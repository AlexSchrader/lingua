  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u168l2-sutareru", type: "vocab", front: "すたれる", reading: "sutareru", meaning: "to fall out of use", example: { jp: "べんりな ものが 出ると、古い やり方は すたれます。", en: "When something convenient appears, the old way falls out of use." }, drill: { jp: "ふるい やりかたが すたれる。", en: "The old method falls out of use." }, accept: ["to die out", "to become obsolete"] },
      ],
    },
    {
      id: "ja-u168l3",
      ...
      items: [
        ...
        { id: "ja-u168l3-shinko", type: "vocab", front: "しんこう", reading: "shinkō", meaning: "religious belief", example: { jp: "山への しんこうは、この 地いきで 今も 生きて います。", en: "Belief in the mountain is still alive in this region." }, drill: { jp: "しんこうが つづいて います。", en: "The religious belief continues." }, accept: ["devotion", "faith in something"], hint: "しゅうきょう is the institution; しんこう is what a person actually holds. Someone can have しんこう with no しゅうきょう." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u168l4-tsutae", type: "vocab", front: "つたえ", reading: "tsutae", meaning: "a handed-down account", example: { jp: "この 地いきの つたえでは、湖の 底に 町が あるそうです。", en: "According to this village's lore, there's a town at the bottom of the lake." }, drill: { jp: "つたえが のこって います。", en: "A handed-down account remains." }, accept: ["legend", "oral tradition", "lore"] },
        { id: "ja-u168l4-gyakuten", type: "vocab", front: "ぎゃくてん", reading: "gyakuten", meaning: "a reversal", example: { jp: "新しい しりょうで、これまでの 考えが ぎゃくてんしました。", en: "New materials reversed what had been believed until then." }, drill: { jp: "ぎゃくてんが おきました。", en: "A reversal happened." }, accept: ["turnaround", "overturning", "flip"] },
