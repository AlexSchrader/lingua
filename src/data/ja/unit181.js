  ...
  lessons: [
    {
      ...
      items: [
        { id: "ja-u181l1-iryo", type: "vocab", front: "いりょう", reading: "iryō", meaning: "medical care", example: { jp: "この 地方の いりょうは、少ない 人数で 支えられて います。", en: "Medical care in this region is held up by a small number of people." }, drill: { jp: "いりょうが たいせつです。", en: "Medical care is important." }, accept: ["healthcare", "medicine (as a field)", "treatment"] },
        ...
        { id: "ja-u181l1-kaigo", type: "vocab", front: "かいご", reading: "kaigo", meaning: "long-term care", example: { jp: "母の かいごの ために、仕事の 時間を みじかく しました。", en: "For my mother's care I shortened my working hours." }, drill: { jp: "かいごを して います。", en: "I am giving long-term care." }, accept: ["caregiving", "elder care", "looking after someone"], hint: "かんご is medical, done by trained staff for illness; かいご is daily living support — eating, moving, washing — and is as often family as professional." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u181l2-shochi", type: "vocab", front: "しょち", reading: "shochi", meaning: "a medical procedure", example: { jp: "その 場で かんたんな しょちを して もらいました。", en: "They performed a simple procedure on the spot." }, drill: { jp: "しょちを して もらいました。", en: "I had a procedure done." }, accept: ["treatment given", "dealing with it", "intervention"] },
        { id: "ja-u181l2-naika", type: "vocab", front: "ないか", reading: "naika", meaning: "internal medicine", example: { jp: "ねつが 続くので、ないかへ 行く ことに しました。", en: "The fever kept on, so I decided to go to internal medicine." }, drill: { jp: "ないかへ いきます。", en: "I go to internal medicine." }, accept: ["general medicine", "physician's department"] },
