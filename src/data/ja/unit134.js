...
export const UNIT134 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "ja-u134l4-ri", type: "kanji", front: "利", reading: "ri", meaning: "advantage", example: { jp: "この道は近くて利がありますが、車が多いです。", en: "This road is near and has that advantage, but there's a lot of traffic." }, accept: ["benefit", "profit", "gain"], hint: "利 = 禾 (grain) + 刂 (blade) — a sharp tool that pays off. 便利 = convenient, 利用 = making use of." },
        ...
        { id: "ja-u134l4-ritsu", type: "kanji", front: "律", reading: "ritsu", meaning: "rule", example: { jp: "自分に律を持つ人は強いですが、少ないです。", en: "People who hold themselves to a rule are strong, but they're rare." }, accept: ["law", "discipline", "rhythm"], hint: "律 = a rule you walk 彳 by. 法律 = the law, 自律 = self-discipline." },
