  ...
  lessons: [
    ...
    // Lesson 4: everyday set expressions
    {
      ...
      items: [
        ...
        { id: "ja-u68l4-itterasshai", type: "vocab", front: "いってらっしゃい", reading: "itterasshai", meaning: "take care", example: { jp: "いってらっしゃい。", en: "Take care (as you head out)." }, drill: { jp: "いってらっしゃいといいます。", en: "I say take care." }, accept: ["have a good day", "see you off"] },
        ...
        { id: "ja-u68l4-itadakimasu", type: "vocab", front: "いただきます", reading: "itadakimasu", meaning: "let's eat", example: { jp: "いただきます。", en: "Thanks for the food (before eating)." }, drill: { jp: "いただきますといいます。", en: "I say let's eat." }, accept: ["thanks for the meal", "bon appetit"] },
        { id: "ja-u68l4-gochisosama", type: "vocab", front: "ごちそうさま", reading: "gochisōsama", meaning: "thanks for the meal", example: { jp: "ごちそうさま。", en: "Thanks for the meal (after eating)." }, drill: { jp: "ごちそうさまといいます。", en: "I say thanks for the meal." }, accept: ["that was delicious", "thanks for the food"] },
      ],
    },
  ],
};
