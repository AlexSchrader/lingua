  ...
  lessons: [
    ...
    // Lesson 4: position & direction
    {
      ...
      items: [
        ...
        { id: "ja-u10l4-hidari", type: "vocab", front: "ひだり", reading: "hidari", meaning: "left", example: { jp: "えきのひだりです。", en: "It's to the left of the station." }, drill: { jp: "ひだりにえきがあります。", en: "There is a station on the left." }, accept: ["left side", "the left"] },
        ...
        { id: "ja-u10l4-mae",    type: "vocab", front: "まえ", reading: "mae", meaning: "front", example: { jp: "えきのまえです。", en: "It's in front of the station." }, drill: { jp: "まえにくるまがあります。", en: "There is a car in front." }, accept: ["in front", "before", "the front"] },
        { id: "ja-u10l4-ushiro", type: "vocab", front: "うしろ", reading: "ushiro", meaning: "behind", example: { jp: "いえのうしろです。", en: "It's behind the house." }, drill: { jp: "うしろにいえがあります。", en: "There is a house behind." }, accept: ["back", "rear", "at the back"] },
