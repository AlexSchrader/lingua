  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u184l1-fukusen", type: "vocab", front: "ふくせん", reading: "fukusen", meaning: "a plant laid earlier", example: { jp: "はじめの ふくせんに 気づくと、二回目が もっと おもしろく なります。", en: "Once you notice the setup laid early on, a second viewing gets better." }, drill: { jp: "ふくせんに きづきます。", en: "I notice the plant laid earlier." }, accept: ["foreshadowing", "groundwork in a plot", "a seed planted"], hint: "ふくせん is laid EARLY and paid off LATER — you often only see it the second time through. That delay is the whole point of the word." },
      ],
    },
    {
      id: "ja-u184l2",
      ...
      items: [
        ...
        { id: "ja-u184l2-buntai", type: "vocab", front: "ぶんたい", reading: "buntai", meaning: "writing style", example: { jp: "この 人の ぶんたいは みじかくて、読むのが 速く なります。", en: "This writer's style is clipped, and it makes you read faster." }, drill: { jp: "ぶんたいが みじかいです。", en: "The writing style is short." }, accept: ["prose style", "the way it is written"] },
        { id: "ja-u184l2-byosha", type: "vocab", front: "びょうしゃ", reading: "byōsha", meaning: "depiction", example: { jp: "町の びょうしゃが 細かくて、行った ことが ある 気に なります。", en: "The depiction of the town is so detailed you feel you've been there." }, drill: { jp: "びょうしゃが こまかいです。", en: "The depiction is detailed." }, accept: ["portrayal", "描写 in prose", "rendering"] },
        ...
        { id: "ja-u184l2-media", type: "vocab", front: "メディア", reading: "media", meaning: "the media", example: { jp: "同じ 話でも、メディアに よって 見え方が ちがいます。", en: "Even the same story looks different depending on the outlet." }, drill: { jp: "メディアに よって ちがいます。", en: "It differs by media outlet." }, accept: ["press", "outlets", "a medium"] },
      ],
    },
    {
      id: "ja-u184l3",
