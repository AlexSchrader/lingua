  ...
  lessons: [
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Read 変 (to change), 増 (to increase), 進 (to advance), 退 (to retreat), and the words 進行 and 退院.",
      items: [
        ...
        { id: "ja-u109l1-shinko", type: "vocab", front: "進行", reading: "shinkō", meaning: "progress", example: { jp: "こうじの 進行が おそくて、道は まだ 通れません。", en: "The work is progressing slowly, and the road still isn't passable." }, accept: ["advance", "to proceed", "going forward"] },
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Read 越 (to cross over), 過 (to pass), 流 (to flow), 落 (to fall), and the words 通過 and 落下.",
      items: [
        ...
        { id: "ja-u109l2-tsuka", type: "vocab", front: "通過", reading: "tsūka", meaning: "passing through", example: { jp: "急行は この 駅を 通過しますから、つぎのに のります。", en: "The express passes through this station, so I'll take the next one." }, drill: { jp: "通過を まちます。", en: "I wait for it to pass through." }, accept: ["to pass by", "transit", "going past"], hint: "通 (pass through) + 過 (go past) — the train that does not stop." },
        { id: "ja-u109l2-rakka", type: "vocab", front: "落下", reading: "rakka", meaning: "a fall", example: { jp: "強い 風で 木の えだが 落下しました。", en: "A branch fell in the strong wind." }, accept: ["falling", "to drop", "descent"] },
      ],
    },
    {
      id: "ja-u109l3",
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Read 追 (to chase), 押 (to push), 引 (to pull), 投 (to throw), and the words 引用 and 投手.",
      items: [
        ...
        { id: "ja-u109l4-inyo", type: "vocab", front: "引用", reading: "inyō", meaning: "a quotation", example: { jp: "この 文章は 古い 本からの 引用です。", en: "This passage is a quotation from an old book." }, accept: ["citation", "to quote"], hint: "引 (pull) + 用 (use) — pulling someone's words out to use them." },
        { id: "ja-u109l4-toshu", type: "vocab", front: "投手", reading: "tōshu", meaning: "pitcher", example: { jp: "その 投手は ボールが とても はやいです。", en: "That pitcher throws very fast." }, accept: ["baseball pitcher"] },
      ],
    },
  ],
};
