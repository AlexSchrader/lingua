  ...
  lessons: [
    {
      ...
      items: [
        { id: "ja-u109l1-hen", type: "kanji", front: "変", reading: "hen", meaning: "to change", example: { jp: "会社の 方しんが 変わって、みんな いそがしく なりました。", en: "The company's direction changed, and everyone got busy." }, accept: ["strange", "to alter", "odd"], hint: "変 = change — and also 'strange': 変な人 = an odd person. Something that has changed from what you expected." },
        ...
        { id: "ja-u109l1-tai", type: "kanji", front: "退", reading: "tai", meaning: "to retreat", example: { jp: "体の ぐあいが 悪いので、しあいを 退きました。", en: "I wasn't feeling well, so I withdrew from the match." }, accept: ["to withdraw", "to step back", "to quit"], hint: "退 = step back — the ⻌ road again, going the other way. 進退 = advance and retreat, i.e. one's position." },
        ...
        { id: "ja-u109l1-ka", type: "kanji", front: "過", reading: "ka", meaning: "to pass", example: { jp: "あれから 長い 時間が 過ぎましたが、まだ よく おぼえて います。", en: "A long time has passed since then, but I still remember it well." }, accept: ["excess", "to go past", "fault"], hint: "過 = pass by, or go too far. 過ぎる = to pass/exceed, 過去 = the past." },
      ],
    },
    {
      id: "ja-u109l2",
      ...
      items: [
        ...
        { id: "ja-u109l2-raku", type: "kanji", front: "落", reading: "raku", meaning: "to fall", example: { jp: "秋に なると 木の 葉が 落ちて、道が 赤く なります。", en: "In autumn the leaves fall and the road turns red." }, accept: ["to drop", "to fail", "to come down"], hint: "落 = fall — the 艹 grass radical on top: leaves coming down. 落ちる = to fall, 落とす = to drop something." },
