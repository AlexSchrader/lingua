  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u109l2-tsuka", type: "vocab", front: "通過", reading: "tsūka", meaning: "passing through", example: { jp: "急行は この 駅を 通過しますから、つぎのに のります。", en: "The express passes through this station, so I'll take the next one." }, accept: ["to pass by", "transit", "going past"], hint: "通 (pass through) + 過 (go past) — the train that does not stop." },
