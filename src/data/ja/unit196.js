  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u196l4-ashiwohipparu", type: "vocab", front: "あしをひっぱる", reading: "ashiwohipparu", meaning: "to hold (the team) back", example: { jp: "みんなの あしを ひっぱらないように、練習して います。", en: "I'm practising so as not to hold everyone back." }, accept: ["to drag down", "to be a liability"], hint: "Said about yourself it is modest and extremely common; said about someone else it is harsh." },
        { id: "ja-u196l4-ashigabo", type: "vocab", front: "あしがぼうになる", reading: "ashigabōninaru", meaning: "to be worn out from walking", example: { jp: "一日じゅう 歩いて、あしが ぼうに なりました。", en: "I walked all day and my legs are like lead." }, accept: ["legs like lead", "dead on one's feet"], hint: "Literally 'the legs become sticks' — they stop bending. Only ever from walking or standing." },
