  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u194l1-fumikomu", type: "vocab", front: "ふみこむ", reading: "fumikomu", meaning: "to step into; to go further than expected", example: { jp: "そこまで ふみこんだ 話は、まだ できません。", en: "I can't go into it that deeply yet." }, drill: { jp: "そこまで ふみこむ。", en: "I go that far into it." }, accept: ["to venture into", "to press further", "to tread in"], hint: "Literal for stepping in, and very common figuratively for going past the safe part of a subject. ふみこんだ質問 is a question that pushes." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u194l2-suikomu", type: "vocab", front: "すいこむ", reading: "suikomu", meaning: "to suck in, to absorb", example: { jp: "外の きれいな 空気を 大きく すいこみました。", en: "I took a deep breath of the clean air outside." }, drill: { jp: "くうきを すいこむ。", en: "I breathe in the air." }, accept: ["to breathe in", "to draw in", "to soak up"], hint: "Air, dust, water, or knowledge. A child すいこむように おぼえる — absorbs like a sponge." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u194l3-mitsukedasu", type: "vocab", front: "みつけだす", reading: "mitsukedasu", meaning: "to track down, to find at last", example: { jp: "古い 記録の 中から、その 名前を みつけだしました。", en: "I tracked that name down among the old records." }, drill: { jp: "なまえを みつけだす。", en: "I track down the name." }, accept: ["to unearth", "to locate (after searching)"], hint: "みつける is finding; みつけだす is finding after a search that took work — the ～だす drags it out into view." },
        { id: "ja-u194l3-fukidasu", type: "vocab", front: "ふきだす", reading: "fukidasu", meaning: "to burst out laughing; to gush out", example: { jp: "まじめな かおで 言うので、思わず ふきだしました。", en: "He said it with such a straight face that I burst out laughing." }, drill: { jp: "おもわず ふきだす。", en: "I burst out laughing." }, accept: ["to spurt", "to burst out", "to blow out"], hint: "Steam from a pipe and laughter from a person take the same verb — both are something held in that suddenly is not." },
        ...
        { id: "ja-u194l3-nagaredasu", type: "vocab", front: "ながれだす", reading: "nagaredasu", meaning: "to start flowing, to begin to play", example: { jp: "しずかな 音楽が ながれだしました。", en: "Quiet music began to play." }, drill: { jp: "おんがくが ながれだす。", en: "The music begins to play." }, accept: ["to begin to flow", "to stream out"], hint: "Water, crowds and music all ながれる, so all three can ながれだす. For music it is the standard way to say it started." },
      ],
    },
    {
      id: "ja-u194l4",
