...
export const UNIT141 = {
  ...
  lessons: [
    ...
    // Lesson 2: not asserting things flat
    {
      ...
      items: [
        { id: "ja-u141l2-kuseni", type: "vocab", front: "くせに", reading: "kuseni", meaning: "even though (critical)", example: { jp: "知っているくせに、なにも言いませんでした。", en: "Even though he knew, he said nothing." }, accept: ["despite", "and yet", "although"], hint: "くせに is のに with blame attached — it always criticises, so never use it about the person you are speaking to." },
        { id: "ja-u141l2-soretomo", type: "vocab", front: "それとも", reading: "soretomo", meaning: "or", example: { jp: "おちゃにしますか。それとも、コーヒーにしますか。", en: "Will you have tea? Or coffee?" }, accept: ["or else", "alternatively"], hint: "それとも joins two questions; あるいは joins two statements." },
    ...
    // Lesson 3: the keigo you HEAR
    {
      ...
      items: [
        ...
        { id: "ja-u141l3-omachikudasai", type: "vocab", front: "おまちください", reading: "omachikudasai", meaning: "please wait (respectful)", example: { jp: "こちらでおまちくださいといわれたので、10ぷんまちました。", en: "I was asked to wait here, so I waited ten minutes." }, accept: ["kindly wait", "one moment please", "hold please"], hint: "The productive respectful frame: お + verb stem + ください. Learn the FRAME and おもちください, おはいりください, おつかいください come free." },
    ...
    // Lesson 4: the keigo you SAY
    {
      ...
      items: [
        ...
        { id: "ja-u141l4-onegaiitashimasu", type: "vocab", front: "おねがいいたします", reading: "onegaiitashimasu", meaning: "I ask this of you (humble)", example: { jp: "それでは、よろしくおねがいいたします。", en: "In that case, I'll leave it with you — thank you." }, accept: ["please", "if you would be so kind", "I request"], hint: "The humble おねがいします, built on the いたす of u90. It ends most requests and most emails — the polite full stop." },
        ...
        { id: "ja-u141l4-zonjiteorimasu", type: "vocab", front: "ぞんじております", reading: "zonjiteorimasu", meaning: "I know (humble)", example: { jp: "そのことなら、ぞんじております。", en: "I'm aware of that matter." }, accept: ["I am aware", "humbly know", "I do know"], hint: "The humble しっています. Its respectful partner ごぞんじ (u95) is for the other person's knowing — same root, opposite direction." },
        { id: "ja-u141l4-chodaishimasu", type: "vocab", front: "ちょうだいします", reading: "chōdaishimasu", meaning: "I gratefully receive (humble)", example: { jp: "せんせいからおみやげをちょうだいしました。", en: "I received a souvenir from my teacher." }, drill: { jp: "おみやげをちょうだいします。", en: "I gratefully receive a souvenir." }, accept: ["I'll take it", "humbly accept", "receive gratefully"], hint: "A step above いただきます for accepting a gift or a document. おなまえをちょうだいできますか is a very formal 'may I have your name?'." },
      ],
    },
  ],
};
