  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u129l1-kyori", type: "vocab", front: "きょり", reading: "kyori", meaning: "distance", example: { jp: "えきまでのきょりはみじかいので、いつもあるいていきます。", en: "The distance to the station is short, so I always walk." }, accept: ["range", "how far"] },
      ],
    },
    {
      id: "ja-u129l2",
      ...
      items: [
        ...
        { id: "ja-u129l2-haiki", type: "vocab", front: "はいき", reading: "haiki", meaning: "disposal", example: { jp: "ふるいパソコンのはいきがめんどうで、まだいえにおいてあります。", en: "Disposing of an old computer is a hassle, and it's still sitting at home." }, accept: ["scrapping", "discarding", "waste disposal"] },
        { id: "ja-u129l2-hakai", type: "vocab", front: "はかい", reading: "hakai", meaning: "destruction", example: { jp: "しぜんのはかいはすぐですが、なおすにはひゃくねんかかります。", en: "Destroying nature is quick, but repairing it takes a hundred years." }, drill: { jp: "はかいがすすみます。", en: "The destruction advances." }, accept: ["ruining", "wrecking", "damage"] },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u129l3-hogo", type: "vocab", front: "ほご", reading: "hogo", meaning: "protection", example: { jp: "とりのほごがはじまったので、かずがふえてきました。", en: "Protection of the birds started, so their numbers have been rising." }, drill: { jp: "ほごがはじまりました。", en: "The protection began." }, accept: ["conservation", "safeguarding", "preservation"] },
        { id: "ja-u129l3-sodatsu", type: "vocab", front: "そだつ", reading: "sodatsu", meaning: "grow up", example: { jp: "このやさいはみずがすくなくてもそだつので、そだてやすいです。", en: "This vegetable grows even with little water, so it's easy to raise." }, accept: ["to be raised", "grow", "be brought up"] },
        { id: "ja-u129l3-nogyo", type: "vocab", front: "のうぎょう", reading: "nōgyō", meaning: "agriculture", example: { jp: "このちほうののうぎょうはゆうめいで、まいとしおおくのひとがみにきます。", en: "This region's agriculture is famous, and every year many people come to see it." }, accept: ["farming", "the farming industry"] },
        ...
        { id: "ja-u129l3-bosai", type: "vocab", front: "ぼうさい", reading: "bōsai", meaning: "disaster preparedness", example: { jp: "ぼうさいのれんしゅうをしてから、あんしんしてねられます。", en: "Since we did the disaster drill, I can sleep easy." }, accept: ["disaster prevention", "emergency preparedness"] },
