  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u129l1-taiki", type: "vocab", front: "たいき", reading: "taiki", meaning: "the atmosphere", example: { jp: "たいきのおせんがひどいので、まちのそらはいつも白くみえます。", en: "The atmospheric pollution is bad, so the town sky always looks white." }, accept: ["the air", "air"] },
