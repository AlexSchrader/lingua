  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u129l1-taiki", type: "vocab", front: "たいき", reading: "taiki", meaning: "the atmosphere", example: { jp: "やまのうえはたいきがきれいなので、ほしがよくみえます。", en: "The atmosphere is clean up the mountain, so the stars are easy to see." }, accept: ["the air", "air"] },
