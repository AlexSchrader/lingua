  ...
  lessons: [
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Give a vague but useful number: すうめい, すうねん, すうかい, ひとけた, ふたけた, たしょう.",
      items: [
        ...
        { id: "ja-u205l1-tasho", type: "vocab", front: "たしょう", reading: "tashō", meaning: "somewhat, more or less", example: { jp: "たしょう おくれても だいじょうぶです。", en: "It's fine if you're a little late." }, accept: ["a little", "to some extent"], hint: "多 (many) + 少 (few) — the word holds both ends and lands on 'some amount, never mind exactly'." },
      ],
    },
    {
      id: "ja-u205l2",
      ...
      items: [
        ...
        { id: "ja-u205l2-daibubun", type: "vocab", front: "だいぶぶん", reading: "daibubun", meaning: "most of, the greater part", example: { jp: "お金の だいぶぶんは 本に 使いました。", en: "I spent most of the money on books." }, accept: ["the bulk", "nearly all"] },
    ...
    },
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Rank things and count repetitions: さいあく, じょうい, じゅんい, いくつも, いくども, なんども.",
      items: [
                { id: "ja-u205l3-saiaku", type: "vocab", front: "さいあく", reading: "saiaku", meaning: "the worst case", example: { jp: "さいあくの ばあいを 考えて、じゅんびして おきます。", en: "I'll prepare for the worst case." }, accept: ["worst-case", "at worst"], hint: "さい～ superlative again. さいあくの ばあい — the worst case — is the standard frame for planning against failure." },
