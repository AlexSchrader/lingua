  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u205l1-futaketa", type: "vocab", front: "ふたけた", reading: "futaketa", meaning: "double figures", example: { jp: "その 店の 売り上げは ふたけた のびました。", en: "That shop's sales grew by double figures." }, accept: ["two digits", "ten or more"] },
                { id: "ja-u205l1-sunichi", type: "vocab", front: "すうにち", reading: "sūnichi", meaning: "a few days", example: { jp: "すうにち 前に 手紙が とどきました。", en: "A letter arrived a few days ago." }, accept: ["several days", "some days"] },
      ],
    },
    {
      id: "ja-u205l2",
