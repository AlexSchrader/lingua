  ...
  lessons: [
    // Lesson 1: feelings & emotions
    {
      ...
      items: [
        ...
        { id: "ja-u70l1-kando", type: "vocab", front: "かんどう", reading: "kandō", meaning: "being moved", example: { jp: "えいがにかんどうしました。", en: "I was moved by the movie." }, drill: { jp: "かんどうのはなしです。", en: "It is a moving story." }, accept: ["being deeply moved", "being touched"] },
    ...
    // Lesson 2: hopes & the heart
    {
      ...
      items: [
        ...
        { id: "ja-u70l2-aijo", type: "vocab", front: "あいじょう", reading: "aijō", meaning: "affection", example: { jp: "こどもにあいじょうがあります。", en: "I have affection for the child." }, drill: { jp: "あいじょうがあります。", en: "There is affection." }, accept: ["love", "tenderness"] },
    ...
    // Lesson 3: impressions & character
    {
      ...
      items: [
        ...
        { id: "ja-u70l3-seikaku", type: "vocab", front: "せいかく", reading: "seikaku", meaning: "personality", example: { jp: "あかるいせいかくです。", en: "She has a cheerful personality." }, drill: { jp: "せいかくはあかるいです。", en: "The personality is cheerful." }, accept: ["character", "nature"] },
