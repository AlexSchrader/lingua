  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u144l1-nasakenai", type: "vocab", front: "なさけない", reading: "nasakenai", meaning: "pathetic, shameful", example: { jp: "こんなかんたんなもんだいがとけないなんて、なさけないです。", en: "Not being able to solve such a simple problem is pathetic." }, accept: ["miserable", "disappointing", "sorry (state)"], hint: "Usually turned on yourself — disappointment rather than contempt. Said about another person it stings badly." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u144l4-arigatai", type: "vocab", front: "ありがたい", reading: "arigatai", meaning: "welcome, much appreciated", example: { jp: "てつだってくれると、とてもありがたいです。", en: "It would be a great help if you could lend a hand." }, accept: ["thankful", "a blessing", "grateful for"], hint: "The adjective behind ありがとう. Use it to describe the FAVOUR, not the person: ありがたいおはなしです." },
        { id: "ja-u144l4-moshiwakenai", type: "vocab", front: "もうしわけない", reading: "mōshiwakenai", meaning: "terribly sorry", example: { jp: "おそくなって、もうしわけないです。", en: "I'm terribly sorry for being late." }, accept: ["inexcusable", "deeply apologetic", "no excuse"], hint: "Literally 'there is no excuse I can offer'. Heavier than すみません — for real mistakes, and standard in business apologies as もうしわけございません." },
      ],
    },
  ],
};
