...
export const UNIT144 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "ja-u144l3-awatadashii", type: "vocab", front: "あわただしい", reading: "awatadashii", meaning: "hectic, rushed", example: { jp: "しけんのまえは、まいにちあわただしかったです。", en: "The days before the exam were hectic." }, drill: { jp: "まいにちあわただしい。", en: "Every day is hectic." }, accept: ["frantic", "busy and rushed", "hurried"], hint: "いそがしい is having a lot to do; あわただしい is the feeling of not having time to breathe between things." },
        ...
        { id: "ja-u144l3-kewashii", type: "vocab", front: "けわしい", reading: "kewashii", meaning: "steep; grim (expression)", example: { jp: "みちがけわしかったので、やまにのぼるのに5じかんかかりました。", en: "The path was steep, so climbing the mountain took five hours." }, drill: { jp: "やまのみちがけわしい。", en: "The mountain path is steep." }, accept: ["rugged", "harsh", "severe"], hint: "Mountains and faces: けわしいかお is a hard, forbidding expression. Both senses mean 'difficult to get past'." },
