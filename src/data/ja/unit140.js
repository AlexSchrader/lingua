  ...
  lessons: [
    ...
    // Lesson 2: plain verbs and adjectives
    {
      ...
      items: [
        ...
        { id: "ja-u140l2-yo", type: "vocab", front: "よう", reading: "yō", meaning: "let's (plain)", example: { jp: "つかれたから、そろそろねよう。", en: "I'm tired, so let's turn in soon." }, accept: ["shall we", "plain ましょう", "I think I'll"], hint: "ましょう → おう／よう: かえりましょう → かえろう, たべましょう → たべよう. Alone in your head it means 'I think I'll…'." },
