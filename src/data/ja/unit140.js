...
export const UNIT140 = {
  ...
  lessons: [
    // Lesson 1: the plain copula
    {
      ...
      items: [
        { id: "ja-u140l1-da", type: "vocab", front: "だ", reading: "da", meaning: "is (plain)", example: { jp: "あしたはやすみだから、ゆっくりねられる。", en: "Tomorrow's a day off, so I can sleep in." }, accept: ["plain です", "am", "are"], hint: "だ is です with the politeness removed — same meaning, different audience. Note that women often drop it entirely: あしたやすみ。" },
    ...
    // Lesson 2: plain verbs and adjectives
    {
      ...
      items: [
        { id: "ja-u140l2-ta", type: "vocab", front: "た", reading: "ta", meaning: "(plain past)", example: { jp: "ゆうべはやくねたから、けさはとてもげんきだ。", en: "I went to bed early last night, so this morning I feel great." }, accept: ["plain ました", "-ed", "did"], hint: "ました → た: たべました → たべた, いきました → いった. This same た form is what you attach とたん, ことがある and ら to." },
        { id: "ja-u140l2-nakatta", type: "vocab", front: "なかった", reading: "nakatta", meaning: "(plain past negative)", example: { jp: "じかんがなかったので、ひるごはんをたべなかった。", en: "I had no time, so I didn't eat lunch." }, accept: ["plain ませんでした", "didn't", "wasn't"], hint: "ませんでした → なかった: たべませんでした → たべなかった. Built from ない, so it conjugates like an い-adjective." },
    ...
    // Lesson 3: how people actually talk
    {
      ...
      items: [
        ...
        { id: "ja-u140l3-toku", type: "vocab", front: "とく", reading: "toku", meaning: "do in advance (contracted ておく)", example: { jp: "あとでつかうから、きっぷをかっとくね。", en: "We'll need them later, so I'll buy the tickets now." }, accept: ["contracted ておく", "get it done", "do beforehand"], hint: "ておく → とく, and でおく → どく (よんどく). Same meaning as u138's ておきます, half the syllables." },
