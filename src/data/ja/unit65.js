  ...
  lessons: [
    ...
    // Lesson 2: deals & sales
    {
      ...
      items: [
        ...
        { id: "ja-u65l2-osusume", type: "vocab", front: "おすすめ", reading: "osusume", meaning: "recommendation", example: { jp: "これはおすすめです。", en: "This one is recommended." }, drill: { jp: "おすすめはこれです。", en: "The recommendation is this one." }, accept: ["suggestion", "recommended item"] },
