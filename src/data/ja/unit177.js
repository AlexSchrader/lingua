  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u177l1-saiyo", type: "vocab", front: "さいよう", reading: "saiyō", meaning: "hiring", example: { jp: "今年の さいようは 少ないと 聞いて、心配に なりました。", en: "I heard hiring is light this year, and it worried me." }, accept: ["recruitment", "taking someone on", "adoption"] },
        ...
        { id: "ja-u177l1-haizoku", type: "vocab", front: "はいぞく", reading: "haizoku", meaning: "being assigned to a post", example: { jp: "きぼうとは ちがう 場所に はいぞくされましたが、今は 気に 入って います。", en: "I was assigned somewhere other than my first choice, but I like it now." }, accept: ["posting", "placement", "being allocated"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u177l2-bumon", type: "vocab", front: "ぶもん", reading: "bumon", meaning: "a division", example: { jp: "この ぶもんは 人が 少ないので、一人が 多くを します。", en: "This division is short-staffed, so one person does a great deal." }, accept: ["department", "section", "arm of the business"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u177l4-nenshu", type: "vocab", front: "ねんしゅう", reading: "nenshū", meaning: "annual income", example: { jp: "ねんしゅうより、家に 帰れる 時間の ほうが 大切です。", en: "The time I get home matters more to me than annual income." }, accept: ["yearly earnings", "salary a year"] },
        ...
        { id: "ja-u177l4-jinzai", type: "vocab", front: "じんざい", reading: "jinzai", meaning: "talented staff", example: { jp: "いい じんざいが 集まる 会社は、いい 仕事も 集まります。", en: "A company that gathers good people gathers good work too." }, accept: ["human resources", "capable people", "talent"] },
      ],
    },
  ],
};
