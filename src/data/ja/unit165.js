  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u165l2-ketsuretsu", type: "vocab", front: "けつれつ", reading: "ketsuretsu", meaning: "a breakdown", example: { jp: "こうしょうが けつれつして、両方が こまって います。", en: "The negotiation broke down and both sides are stuck." }, drill: { jp: "けつれつに なりました。", en: "It ended in a breakdown." }, accept: ["collapse", "rupture", "falling through"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u165l4-fukuri", type: "vocab", front: "ふくり", reading: "fukuri", meaning: "employee benefits", example: { jp: "きゅうりょうより、ふくりで 会社を 選ぶ 人も います。", en: "Some people choose a company for its benefits rather than its pay." }, drill: { jp: "ふくりで えらびます。", en: "I choose by the benefits." }, accept: ["welfare provision", "perks"] },
      ],
    },
  ],
};
