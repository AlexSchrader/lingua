...
export const UNIT183 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "ja-u183l3-taisho", type: "vocab", front: "たいしょう", reading: "taishō", meaning: "the subject studied", example: { jp: "この 研究の たいしょうは、十代の 若い 人です。", en: "The subject of this study is people in their teens." }, drill: { jp: "たいしょうは わかい ひとです。", en: "The subject studied is young people." }, accept: ["object of study", "target group", "who it covers"] },
        { id: "ja-u183l3-sansho", type: "vocab", front: "さんしょう", reading: "sanshō", meaning: "consulting a source", example: { jp: "古い 記ろくを さんしょうして、日にちを 直しました。", en: "I consulted the old records and corrected the date." }, drill: { jp: "さんしょうを しました。", en: "I consulted the source." }, accept: ["reference to", "looking it up", "see (in a citation)"] },
