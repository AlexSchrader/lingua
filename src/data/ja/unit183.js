...
export const UNIT183 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Take an idea from guess to demonstrated result: かせつ がくせつ りろん こうさつ じっしょう しょうめい.",
      items: [
        { id: "ja-u183l2-kasetsu", type: "vocab", front: "かせつ", reading: "kasetsu", meaning: "a hypothesis", example: { jp: "はじめの かせつは まちがって いましたが、つぎの 一歩に なりました。", en: "The first hypothesis was wrong, but it became the next step." }, accept: ["working assumption", "conjecture"] },
        ...
        { id: "ja-u183l2-riron", type: "vocab", front: "りろん", reading: "riron", meaning: "theory", example: { jp: "りろんの 上では できますが、お金が 足りません。", en: "In theory it can be done, but there isn't the money." }, accept: ["the theoretical side", "principle"], hint: "がくせつ is one named scholar's position; りろん is the general framework several がくせつ argue inside." },
    ...
    },
    {
      ...
      cefr: "B2",
      dominantMode: "recall",
      canDo: "Handle other people's work properly: たいしょう さんしょう いんよう ちょさく とうこう がくじゅつ.",
      items: [
        ...
        { id: "ja-u183l3-inyo", type: "vocab", front: "いんよう", reading: "inyō", meaning: "quotation", example: { jp: "いんようする ときは、どこから 取ったか 必ず 書きます。", en: "When you quote, you always write where you took it from." }, accept: ["citing", "a quote", "excerpt"] },
