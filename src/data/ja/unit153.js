  ...
  lessons: [
    {
      ...
      items: [
        { id: "ja-u153l1-yachin", type: "vocab", front: "やちん", reading: "yachin", meaning: "rent", example: { jp: "えきにちかいので、やちんがすこしたかいです。", en: "It's close to the station, so the rent is a bit high." }, accept: ["monthly rent", "rental cost"], hint: "や (house) + ちん (charge). The same ちん as ちんぎん (wages) — a payment for use." },
        ...
        { id: "ja-u153l1-soko", type: "vocab", front: "そうこ", reading: "sōko", meaning: "storeroom, warehouse", example: { jp: "つかわないものは、そうこにいれてあります。", en: "The things we don't use are kept in the storeroom." }, accept: ["storage", "depot", "shed"], hint: "そう (store) + こ (house). Anything from a garden shed to a distribution warehouse — scale comes from context." },
      ],
    },
    {
      id: "ja-u153l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u153l3-senzai", type: "vocab", front: "せんざい", reading: "senzai", meaning: "detergent", example: { jp: "せんざいをいれすぎると、あわがおおくなります。", en: "If you put in too much detergent, you get too many suds." }, accept: ["washing liquid", "cleaning agent", "soap powder"], hint: "せん (wash) + ざい (agent). ～ざい names substances that do a job: しょうどくざい, せっちゃくざい." },
        { id: "ja-u153l3-monohoshi", type: "vocab", front: "ものほし", reading: "monohoshi", meaning: "drying rack, washing line", example: { jp: "あめがふりそうなので、ものほしからとりこみます。", en: "It looks like rain, so I'll bring the washing in off the line." }, accept: ["clothes airer", "laundry pole", "drying line"], hint: "もの (things) + ほす (to dry in the sun). Hanging laundry outdoors is still the norm in Japan, dryer or no dryer." },
        { id: "ja-u153l3-kansoki", type: "vocab", front: "かんそうき", reading: "kansōki", meaning: "dryer", example: { jp: "つゆのときは、かんそうきがないとこまります。", en: "During the rainy season you're stuck without a dryer." }, accept: ["tumble dryer", "drying machine"], hint: "かんそう (drying) + き (machine). ～き is the machine suffix: せんたくき, けいさんき, じどうはんばいき." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u153l4-rosoku", type: "vocab", front: "ろうそく", reading: "rōsoku", meaning: "candle", example: { jp: "たいふうのときのために、ろうそくをかっておきました。", en: "I bought candles in advance in case of a typhoon." }, accept: ["wax candle", "taper"], hint: "Kept for emergencies more than atmosphere in most Japanese homes. Pairs with ておきます (u138) — the grammar of preparation." },
