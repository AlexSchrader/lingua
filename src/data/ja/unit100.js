  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u100l1-aijo", type: "vocab", front: "愛情", reading: "aijō", meaning: "affection", example: { jp: "母の 愛情を 感じて、いつも 安心して います。", en: "I feel my mother's affection and always feel secure." }, accept: ["love", "warm feeling"], hint: "愛 + 情 — the two heart-words of this lesson, joined." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u100l2-akumu", type: "vocab", front: "悪夢", reading: "akumu", meaning: "nightmare", example: { jp: "こわい 悪夢を 見て、夜中に 起きました。", en: "I had a frightening nightmare and woke in the night." }, accept: ["bad dream"] },
      ],
    },
    {
      id: "ja-u100l3",
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Read 情 (feeling), 夢 (dream), 信 (trust), 尊 (respect), and the words 信用 and 尊重.",
      items: [
        ...
        { id: "ja-u100l3-shinyo", type: "vocab", front: "信用", reading: "shinyō", meaning: "trust", example: { jp: "一度 うそを つくと、信用を なくします。", en: "Tell one lie and you lose people's trust." }, accept: ["credit", "confidence", "reliance"] },
        { id: "ja-u100l3-soncho", type: "vocab", front: "尊重", reading: "sonchō", meaning: "respect", example: { jp: "あいての 気持ちを 尊重して、ゆっくり 話しました。", en: "I respected the other person's feelings and spoke slowly." }, accept: ["consideration", "regard", "to respect"] },
      ],
    },
    {
      id: "ja-u100l4",
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Read 欲 (desire), 神 (god), 精 (spirit), 命 (life), and the words 精神 and 生命.",
      items: [
        ...
        { id: "ja-u100l4-seishin", type: "vocab", front: "精神", reading: "seishin", meaning: "mind", example: { jp: "体だけで なく、精神も 休ませて ください。", en: "Rest your mind as well as your body." }, accept: ["spirit", "mentality", "psyche"] },
        { id: "ja-u100l4-seimei", type: "vocab", front: "生命", reading: "seimei", meaning: "life", example: { jp: "生命は 一つ しか ありませんから、大切に します。", en: "You only have one life, so I look after it." }, accept: ["a life", "living things"], hint: "生命 is life as a thing that exists; 命 alone is the life you were given." },
      ],
    },
  ],
};
