  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u100l2-muchu", type: "vocab", front: "夢中", reading: "muchū", meaning: "absorbed in", example: { jp: "弟は ゲームに 夢中で、私の 話を 聞いて いません。", en: "My younger brother is absorbed in his game and isn't listening to me." }, drill: { jp: "夢中に なります。", en: "I get absorbed in it." }, accept: ["engrossed", "crazy about", "lost in"], hint: "夢 (dream) + 中 (inside) — you are inside a dream, i.e. you notice nothing else." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u100l3-shinyo", type: "vocab", front: "信用", reading: "shinyō", meaning: "credibility", example: { jp: "一度 うそを つくと、信用を なくします。", en: "Tell one lie and you lose people's trust." }, accept: ["trust", "credit", "confidence", "reliance"] },
