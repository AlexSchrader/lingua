  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u100l1-naku", type: "kanji", front: "泣", reading: "naku", meaning: "to cry", example: { jp: "子どもが 泣いて いましたが、母が 来ると すぐに 元気に なりました。", en: "The child was crying, but cheered up as soon as their mother came." }, accept: ["to weep", "crying", "tears"], hint: "泣 = cry — the water radical 氵 next to 立 (stand): standing there in tears." },
        { id: "ja-u100l1-nayami", type: "kanji", front: "悩", reading: "nayami", meaning: "worry", example: { jp: "一人で 悩まないで、だれかに 話して ください。", en: "Don't worry about it alone — please talk to someone." }, accept: ["trouble", "to be troubled", "distress"], hint: "悩 = a trouble you carry. The 忄 on the left is 心 (heart) stood on its side — it marks most feeling kanji." },
      ],
    },
    {
      id: "ja-u100l2",
      ...
      items: [
        ...
        { id: "ja-u100l2-jo", type: "kanji", front: "情", reading: "jō", meaning: "feeling", example: { jp: "あの 人は 情に あつくて、いつも 人を たすけます。", en: "That person is warm-hearted and always helps people." }, accept: ["emotion", "warmth", "circumstances"], hint: "情 = feeling — 忄 (heart) again. 感情 = emotion, 情に あつい = warm-hearted; 情報 = information." },
        { id: "ja-u100l2-yume", type: "kanji", front: "夢", reading: "yume", meaning: "dream", example: { jp: "小さい ころの 夢は、学校の 先生に なる ことでした。", en: "My childhood dream was to become a school teacher." }, accept: ["a dream", "aspiration"], hint: "夢 = dream — both the one you have asleep and the one you work towards, exactly like English." },
        { id: "ja-u100l2-shin", type: "kanji", front: "信", reading: "shin", meaning: "trust", example: { jp: "友だちの ことばを 信じて、待つ ことに しました。", en: "I trusted my friend's word and decided to wait." }, accept: ["belief", "to believe", "faith"], hint: "信 = trust — 人 (person) beside 言 (word): someone who stands by what they say." },
      ],
    },
    {
      id: "ja-u100l3",
      ...
      items: [
        ...
        { id: "ja-u100l3-kami", type: "kanji", front: "神", reading: "kami", meaning: "god", example: { jp: "山の 上に 古い 神社が あって、毎年 おまつりが あります。", en: "There's an old shrine up the mountain, and a festival every year." }, accept: ["deity", "spirit", "divine"], hint: "神 = god — the 礻 radical marks anything to do with worship. 神社 = shrine." },
        { id: "ja-u100l3-sei", type: "kanji", front: "精", reading: "sei", meaning: "spirit", example: { jp: "毎日 元気で いるには、精神も 体も 大切です。", en: "To stay well day to day, both mind and body matter." }, accept: ["energy", "refined", "vitality"], hint: "精 = refined energy. 精神 = the mind/spirit, 精一杯 = with everything you have." },
