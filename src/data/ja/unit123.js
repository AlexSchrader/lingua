  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u123l1-san", type: "kanji", front: "参", reading: "mairu", meaning: "take part", example: { jp: "会に参りましたが、だれも知りませんでした。", en: "I attended the gathering, but I didn't know anyone." }, accept: ["participate", "go (humble)", "refer to"], hint: "参 = joining the group. 参加 = participation, 参考 = a reference you consult." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u123l4-matsuri", type: "kanji", front: "祭", reading: "matsuri", meaning: "festival", example: { jp: "夏の祭は楽しいですが、人が多すぎます。", en: "The summer festival is fun, but there are too many people." }, accept: ["celebration", "rite", "fete"], hint: "祭 = a hand offering meat 月 at an altar 示. お祭り = a festival, 祭日 = a public holiday." },
