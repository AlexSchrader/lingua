  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u123l1-kei", type: "kanji", front: "景", reading: "kei", meaning: "view", example: { jp: "山の風景がきれいで、しばらく立ったまま見ていました。", en: "The mountain scenery was beautiful, and I stood looking at it for a while." }, accept: ["view", "scene", "landscape", "scenery"], hint: "景 = 日 (sun) over 京 (the capital) — a wide lit view. 風景 = scenery, 景色 = a view." },
        ...
        { id: "ja-u123l1-fukei", type: "vocab", front: "風景", reading: "fūkei", meaning: "scenery", example: { jp: "まどからの風景がよかったので、その部屋にきめました。", en: "The view from the window was good, so I settled on that room." }, drill: { jp: "風景が よかったです。", en: "The scenery was good." }, accept: ["landscape", "the view", "scene"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u123l2-yoken", type: "vocab", front: "用件", reading: "yōken", meaning: "the business at hand", example: { jp: "用件だけ言うつもりが、あとで長く話しました。", en: "I meant to say only what I'd come about, and we ended up talking at length." }, drill: { jp: "用件を つたえます。", en: "I pass on the business at hand." }, accept: ["what one has come about", "the matter", "one's errand"] },
      ],
    },
    {
      id: "ja-u123l3",
