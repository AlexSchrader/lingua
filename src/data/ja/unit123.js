  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u123l1-heru", type: "kanji", front: "経", reading: "tatsu", meaning: "pass through", example: { jp: "五年が経ちましたが、まだよくおぼえています。", en: "Five years have passed, but I still remember it well." }, accept: ["elapse", "manage", "undergo"], hint: "経 = 糸 (thread) running the length of the cloth. 時が経ちます = time passes; 経理 = the running of the accounts." },
        { id: "ja-u123l1-san", type: "kanji", front: "参", reading: "mairu", meaning: "go (humble)", example: { jp: "会に参りましたが、だれも知りませんでした。", en: "I attended the gathering, but I didn't know anyone." }, accept: ["come (humble)", "take part", "refer to"], hint: "参 = joining the group. 参加 = participation, 参考 = a reference you consult." },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u123l2-mukaeru", type: "kanji", front: "迎", reading: "mukaeru", meaning: "welcome", example: { jp: "駅まで迎えに行きましたが、時間をまちがえました。", en: "I went to meet them at the station, but I got the time wrong." }, accept: ["greet", "go to meet", "receive"], hint: "迎 = 辶 (go) out towards someone who is arriving. 迎えに行きます = to go and pick someone up." },
        { id: "ja-u123l2-kaku", type: "kanji", front: "欠", reading: "kakeru", meaning: "lack", example: { jp: "一人が欠けましたが、しあいはできました。", en: "One person was missing, but we could still play the match." }, accept: ["be absent", "chip", "be short of"], hint: "欠 = a person with their mouth open — something is missing. 欠点 = a shortcoming." },
        { id: "ja-u123l2-kimeru", type: "kanji", front: "決", reading: "kimeru", meaning: "decide", example: { jp: "行くと決めましたが、まだ言っていません。", en: "I've decided to go, but I haven't said so yet." }, accept: ["settle", "determine", "resolve"], hint: "決 = 氵 (water) breaking through a bank — the moment it goes one way. 決心 = making up one's mind. Its on-yomi is けつ, like 欠." },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u123l3-gen", type: "kanji", front: "現", reading: "arawareru", meaning: "present", example: { jp: "現れた人は知らない人でしたが、話はよく分かりました。", en: "The person who appeared was a stranger, but what they said made sense." }, accept: ["appear", "actual", "current"], hint: "現 = 王 (jewel) + 見 (see) — what is visible right now. 現れます = to appear, 現代 = the present age." },
        { id: "ja-u123l3-muku", type: "kanji", front: "向", reading: "mukau", meaning: "face towards", example: { jp: "駅に向かって歩きましたが、道をまちがえました。", en: "I walked towards the station, but I took the wrong road." }, accept: ["turn to", "suit", "direction"], hint: "向 = a window in a wall, facing out. 向かいます = to head towards; 向いています = to be suited to." },
        ...
        { id: "ja-u123l3-go", type: "kanji", front: "号", reading: "gō", meaning: "number", example: { jp: "この本は五月号ですが、まだ読んでいません。", en: "This book is the May issue, but I haven't read it yet." }, accept: ["issue", "sign", "call"], hint: "号 = a called-out sign. 番号 = a number, 一号 = No. 1, 信号 = a traffic light." },
        ...
        { id: "ja-u123l3-koun", type: "vocab", front: "幸運", reading: "kōun", meaning: "good fortune", example: { jp: "幸運でしたが、実力もありました。", en: "It was good fortune, but there was real ability there too." }, accept: ["luck", "a lucky break", "being fortunate"] },
      ],
    },
    {
      id: "ja-u123l4",
      ...
      items: [
        ...
        { id: "ja-u123l4-matsuri", type: "kanji", front: "祭", reading: "matsuri", meaning: "festival", example: { jp: "夏祭りは楽しいですが、人が多すぎます。", en: "The summer festival is fun, but there are too many people." }, accept: ["celebration", "rite", "fete"], hint: "祭 = a hand offering meat 月 at an altar 示. お祭り = a festival, 祭日 = a public holiday." },
