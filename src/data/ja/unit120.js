  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u120l3-shitagau", type: "vocab", front: "したがう", reading: "shitagau", meaning: "follow", example: { jp: "みんなできめたので、わたしもそれにしたがいます。", en: "We all decided it, so I will go along with it too." }, accept: ["to obey", "go along with", "comply"] },
        ...
        { id: "ja-u120l3-shikatanai", type: "vocab", front: "しかたない", reading: "shikatanai", meaning: "it can't be helped", example: { jp: "あめでしかたなく、いえでほんをよみました。", en: "It couldn't be helped in the rain, so I read a book at home." }, accept: ["no choice", "nothing to be done", "unavoidable"] },
      ],
    },
    {
      id: "ja-u120l4",
