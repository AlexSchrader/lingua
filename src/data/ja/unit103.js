...
export const UNIT103 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "ja-u103l4-heru", type: "vocab", front: "へる", reading: "heru", meaning: "to decrease", example: { jp: "この まちの こどもの かずは まいとし へって いて、がっこうも すくなく なりました。", en: "The number of children in this town falls every year, and the schools have shrunk too." }, accept: ["to go down", "to diminish", "decrease"] },
