  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u103l1-kotonaru", type: "vocab", front: "ことなる", reading: "kotonaru", meaning: "to differ", example: { jp: "くにによって しゅうかんは ことなりますから、しらべて おいた ほうが いいです。", en: "Customs differ from country to country, so it's better to look them up in advance." }, drill: { jp: "しゅうかんが ことなる。", en: "The customs differ." }, accept: ["to be different", "to vary", "differ"], hint: "ことなる is the written form of ちがいます — reports and signs use it, conversation uses ちがう." },
        ...
        { id: "ja-u103l1-warini", type: "vocab", front: "わりに", reading: "warini", meaning: "for (considering)", example: { jp: "この レストランは ねだんの わりに おいしいので、いつも こんで います。", en: "This restaurant is good for the price, so it's always crowded." }, accept: ["considering", "relatively", "for its"] },
      ],
    },
    {
      id: "ja-u103l2",
      ...
      items: [
        ...
        { id: "ja-u103l2-isso", type: "vocab", front: "いっそう", reading: "issō", meaning: "even more", example: { jp: "ことしの なつは きょねんより いっそう あついので、そとに でたく ありません。", en: "This summer is even hotter than last year, so I don't want to go out." }, accept: ["still more", "all the more", "further"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u103l3-masaru", type: "vocab", front: "まさる", reading: "masaru", meaning: "to surpass", example: { jp: "この カメラは ねだんが たかいですが、ほかの カメラより まさって います。", en: "This camera is expensive, but it surpasses the others." }, drill: { jp: "ほかより まさる。", en: "It surpasses the others." }, accept: ["to be better", "to excel", "to outdo"] },
        { id: "ja-u103l3-otoru", type: "vocab", front: "おとる", reading: "otoru", meaning: "to be inferior", example: { jp: "この ほうほうは はやさでは おとりますが、あんぜんです。", en: "This method is inferior on speed, but it's safe." }, accept: ["to be worse", "to fall behind", "to be outdone"], hint: "まさる and おとる are a pair — both take より for what you measure against." },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u103l4-heru", type: "vocab", front: "へる", reading: "heru", meaning: "to decrease", example: { jp: "この まちの こどもの かずは まいとし へって いて、がっこうも すくなく なりました。", en: "The number of children in this town falls every year, and the schools have shrunk too." }, drill: { jp: "こどもの かずが へる。", en: "The number of children decreases." }, accept: ["to go down", "to diminish", "decrease"] },
        { id: "ja-u103l4-taihan", type: "vocab", front: "たいはん", reading: "taihan", meaning: "most of", example: { jp: "クラスの たいはんの ひとが その えいがを みて、とても よかったと いって いました。", en: "Most of the class saw that film and said it was very good." }, accept: ["the majority", "the greater part"] },
        ...
        { id: "ja-u103l4-tasu", type: "vocab", front: "たすう", reading: "tasū", meaning: "a large number", example: { jp: "たすうの ひとが その いけんに さんせいしましたから、けいかくは すすみます。", en: "A large number of people agreed with that opinion, so the plan goes ahead." }, accept: ["many", "the majority", "numerous"] },
