  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u108l2-riku", type: "kanji", front: "陸", reading: "riku", meaning: "land", example: { jp: "長い ふねの 旅の あと、やっと 陸が 見えました。", en: "After a long sea voyage, land finally came into view." }, accept: ["shore", "dry land", "continent"], hint: "陸 = dry land as opposed to sea. 大陸 = continent, 上陸 = coming ashore." },
        ...
        { id: "ja-u108l2-hatake", type: "kanji", front: "畑", reading: "hatake", meaning: "field", example: { jp: "父は 畑で やさいを 作って、店に 売って います。", en: "My father grows vegetables in the field and sells them to shops." }, accept: ["cultivated field", "plot"], hint: "畑 = 火 (fire) + 田 (rice paddy) — a dry field, cleared by burning. 田 is wet, 畑 is dry." },
      ],
    },
    {
      id: "ja-u108l3",
      ...
      items: [
        ...
        { id: "ja-u108l3-men", type: "kanji", front: "綿", reading: "men", meaning: "cotton", example: { jp: "夏は 綿の シャツが 気持ち いいので、よく きて います。", en: "A cotton shirt feels good in summer, so I wear one often." }, accept: ["cotton cloth", "wadding"], hint: "綿 = cotton — 糸 (thread) on the left, the radical that marks thread, cloth and string words." },
        ...
        { id: "ja-u108l3-kona", type: "kanji", front: "粉", reading: "kona", meaning: "powder", example: { jp: "こむぎの 粉と 水を まぜて、パンを 作りました。", en: "I mixed wheat flour and water and made bread." }, accept: ["flour", "dust"], hint: "粉 = powder — 米 (rice) + 分 (divide): grain broken down small. 小麦粉 = wheat flour." },
      ],
    },
  ],
};
