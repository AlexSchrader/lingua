  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u116l3-igo", type: "vocab", front: "いご", reading: "igo", meaning: "from then on", example: { jp: "らいしゅう いごは じかんが ありますから、また あいましょう。", en: "From next week on I'll have time, so let's meet again." }, accept: ["after", "hereafter", "onwards"], hint: "いぜん and いご are a pair and attach to a time word: らいしゅう いご = from next week on." },
