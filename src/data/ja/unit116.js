  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u116l1-gensho", type: "vocab", front: "げんしょう", reading: "genshō", meaning: "decrease", example: { jp: "まちの じんこうの げんしょうが つづいて いて、がっこうも すくなく なりました。", en: "The town's population decline is continuing, and there are fewer schools too." }, drill: { jp: "げんしょうが つづいて います。", en: "The decrease is continuing." }, accept: ["reduction", "falling off", "to decrease"] },
        ...
        { id: "ja-u116l1-tamaru", type: "vocab", front: "たまる", reading: "tamaru", meaning: "to accumulate", example: { jp: "しごとが たまって いますから、しゅうまつも はたらきます。", en: "Work has piled up, so I'm working at the weekend too." }, drill: { jp: "しごとが たまる。", en: "Work piles up." }, accept: ["to build up", "to collect", "to pile up"] },
      ],
    },
    {
      id: "ja-u116l2",
      ...
      items: [
        ...
        { id: "ja-u116l2-otoroeru", type: "vocab", front: "おとろえる", reading: "otoroeru", meaning: "to weaken", example: { jp: "としを とると ちからは おとろえますが、けいけんは ふえます。", en: "As you get older your strength weakens, but your experience grows." }, drill: { jp: "ちからが おとろえる。", en: "Strength weakens." }, accept: ["to decline", "to fade", "to grow weak"] },
      ],
    },
    {
      id: "ja-u116l3",
      ...
      items: [
        ...
        { id: "ja-u116l3-genzai", type: "vocab", front: "げんざい", reading: "genzai", meaning: "at present", example: { jp: "げんざい この みせは やすんで いますが、らいげつ また あきます。", en: "At present this shop is closed, but it opens again next month." }, drill: { jp: "げんざいは やすんで います。", en: "At present it is closed." }, accept: ["now", "currently", "the present"] },
