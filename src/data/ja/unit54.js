  ...
  lessons: [
    ...
    // Lesson 2: fruit
    {
      ...
      items: [
        ...
        { id: "ja-u54l2-momo", type: "vocab", front: "もも", reading: "momo", meaning: "peach", example: { jp: "このももはあまいです。", en: "This peach is sweet." }, drill: { jp: "ももはあまいです。", en: "The peach is sweet." }, accept: ["peaches"] },
    ...
    // Lesson 3: cooking & seasoning
    {
      ...
      items: [
        ...
        { id: "ja-u54l3-shio", type: "vocab", front: "しお", reading: "shio", meaning: "salt", example: { jp: "りょうりにしおをいれます。", en: "I put salt in the food." }, drill: { jp: "しおをりょうりにいれます。", en: "I put salt in the food." }, accept: [] },
        { id: "ja-u54l3-shoyu", type: "vocab", front: "しょうゆ", reading: "shōyu", meaning: "soy sauce", example: { jp: "すしにしょうゆをつけます。", en: "I put soy sauce on the sushi." }, drill: { jp: "しょうゆをすしにつけます。", en: "I put soy sauce on the sushi." }, accept: ["soy"] },
