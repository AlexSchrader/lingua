...
export const UNIT131 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Talk about investing, and describe a country or person as rich or poor: とうし かぶ こうざ しゅうし ゆたか まずしい.",
      items: [
        ...
        { id: "ja-u131l4-yutaka", type: "vocab", front: "ゆたか", reading: "yutaka", meaning: "affluent", example: { jp: "このくにはゆたかですが、みんながしあわせではありません。", en: "This country is affluent, but not everyone is happy." }, accept: ["rich", "abundant", "well-off"] },
