  ...
  lessons: [
    {
      ...
      items: [
        { id: "ja-u131l1-kakei", type: "vocab", front: "かけい", reading: "kakei", meaning: "household finances", example: { jp: "こどもがうまれてから、かけいがくるしくなりました。", en: "Since the child was born, the household finances have got tight." }, drill: { jp: "かけいがくるしいです。", en: "The household finances are tight." }, accept: ["family budget", "the household purse"] },
        ...
        { id: "ja-u131l1-shakkin", type: "vocab", front: "しゃっきん", reading: "shakkin", meaning: "debt", example: { jp: "しゃっきんをぜんぶかえしてから、やっとよくねむれます。", en: "Since I paid back all the debt, I finally sleep well." }, accept: ["loan owed", "borrowing", "what one owes"] },
        { id: "ja-u131l1-ron", type: "vocab", front: "ローン", reading: "rōn", meaning: "loan", example: { jp: "いえのローンがながいので、まいつきすこしずつはらっています。", en: "The house loan runs a long time, so I pay it off little by little each month." }, accept: ["mortgage", "instalment plan"] },
      ],
    },
    {
      id: "ja-u131l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u131l3-keihi", type: "vocab", front: "けいひ", reading: "keihi", meaning: "business expenses", example: { jp: "でんしゃだいはけいひになるので、あとでもどってきます。", en: "The train fare counts as a business expense, so it comes back later." }, accept: ["overheads", "running costs", "expenses"] },
      ],
    },
    {
      id: "ja-u131l4",
      ...
      items: [
        { id: "ja-u131l4-toshi", type: "vocab", front: "とうし", reading: "tōshi", meaning: "investment", example: { jp: "とうしもべんきょうすれば、そんなにこわくありません。", en: "If you study it, investment isn't all that frightening." }, accept: ["investing", "putting money in"] },
        ...
        { id: "ja-u131l4-keiki", type: "vocab", front: "けいき", reading: "keiki", meaning: "business conditions", example: { jp: "けいきがよくなったのに、きゅうりょうはあがりません。", en: "Business conditions have improved, but wages aren't going up." }, accept: ["the economy", "economic climate", "trade"] },
