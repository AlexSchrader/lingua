  ...
  lessons: [
    {
      ...
      items: [
        { id: "ja-u130l1-hotoke", type: "kanji", front: "仏", reading: "butsu", meaning: "Buddha", example: { jp: "古い仏の前はしずかでしたので、少し休みました。", en: "It was quiet in front of the old Buddha, so I rested a while." }, accept: ["Buddhist", "the Buddha", "image of Buddha"], hint: "仏 = 人 (person) + 厶 — the figure people gather before. 仏教 = Buddhism, お仏だん = a household altar." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u130l3-ho", type: "kanji", front: "報", reading: "hō", meaning: "report", example: { jp: "電報を送りましたが、すぐに返事が来ました。", en: "I sent a telegram, and a reply came back at once." }, accept: ["news", "inform", "requite"], hint: "報 = news carried back to whoever is waiting. 電報 = a telegram, 天気予報 = the forecast, 情報 = information." },
