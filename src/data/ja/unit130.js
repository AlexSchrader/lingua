  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u130l1-tatsujin", type: "vocab", front: "達人", reading: "tatsujin", meaning: "a master", example: { jp: "父は魚を切る達人なので、正月はいつも父の出ばんです。", en: "My father is a master at cutting fish, so New Year is always his turn." }, drill: { jp: "達人に なりました。", en: "He became a master." }, accept: ["expert", "adept", "someone who has mastered it"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u130l3-teika", type: "vocab", front: "低下", reading: "teika", meaning: "a decline", example: { jp: "力の低下が分かってきたので、むりはしないことにしました。", en: "I've come to feel my strength declining, so I've decided not to overdo it." }, drill: { jp: "低下が わかりました。", en: "The decline became clear." }, accept: ["drop", "fall", "deterioration"] },
      ],
    },
    {
      id: "ja-u130l4",
      ...
      items: [
        ...
        { id: "ja-u130l4-chiten", type: "vocab", front: "地点", reading: "chiten", meaning: "a point on the map", example: { jp: "この地点で車をとめて、その先は歩きます。", en: "You leave the car at this point, and walk on from there." }, drill: { jp: "地点で とまります。", en: "We stop at this point." }, accept: ["spot", "location", "site"] },
