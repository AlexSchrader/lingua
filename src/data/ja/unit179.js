  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u179l1-ryushutsu", type: "vocab", front: "りゅうしゅつ", reading: "ryūshutsu", meaning: "flowing out", example: { jp: "土の りゅうしゅつを 止めるために、木を 植えました。", en: "Trees were planted to stop the soil flowing away." }, drill: { jp: "りゅうしゅつを とめます。", en: "We stop the outflow." }, accept: ["runoff", "leaking out", "outflow"] },
        ...
        { id: "ja-u179l1-suishitsu", type: "vocab", front: "すいしつ", reading: "suishitsu", meaning: "water quality", example: { jp: "川の すいしつが よく なって、魚が もどって きました。", en: "The river's water quality improved and the fish came back." }, drill: { jp: "すいしつが よく なりました。", en: "The water quality improved." }, accept: ["how clean the water is", "quality of water"] },
    ...
    },
    {
      ...
      items: [
        { id: "ja-u179l3-hatsuden", type: "vocab", front: "はつでん", reading: "hatsuden", meaning: "generating power", example: { jp: "この 川の 水で はつでんして、町の 電気を 作って います。", en: "They generate power from this river's water and make the town's electricity." }, drill: { jp: "はつでんを して います。", en: "We are generating power." }, accept: ["power generation", "producing electricity"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u179l4-yokusei", type: "vocab", front: "よくせい", reading: "yokusei", meaning: "holding something down", example: { jp: "夜の 電気を よくせいして、朝に 回す ことに しました。", en: "We decided to hold down evening power use and shift it to the morning." }, drill: { jp: "よくせいを します。", en: "We hold it down." }, accept: ["restraint", "curbing", "suppression"], hint: "さくげん cuts the TOTAL; よくせい holds the RATE down without necessarily reducing the whole." },
