  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u155l1-katsudo", type: "vocab", front: "かつどう", reading: "katsudō", meaning: "activity, campaign", example: { jp: "まちをきれいにするかつどうに、まいつきさんかしています。", en: "I take part every month in an activity to clean up the town." }, accept: ["operations", "drive", "to be active"], hint: "Organised, purposeful activity — clubs, campaigns, volunteering. Not the same as doing something on your own." },
      ],
    },
    {
      id: "ja-u155l2",
      ...
      items: [
        { id: "ja-u155l2-kokumin", type: "vocab", front: "こくみん", reading: "kokumin", meaning: "the people of a country, citizens", example: { jp: "このほうりつは、こくみんぜんいんにかんけいがあります。", en: "This law concerns all the citizens of the country." }, accept: ["nationals", "the public", "populace"], hint: "こく (country) + みん (people). しみん is the people of a city; こくみん is the people of the nation." },
        ...
        { id: "ja-u155l2-soshiki", type: "vocab", front: "そしき", reading: "soshiki", meaning: "organisation, structure", example: { jp: "おおきいそしきでは、けっていにじかんがかかります。", en: "In a large organisation, decisions take time." }, accept: ["body (institution)", "system", "setup"], hint: "The structure rather than the people — how a body is put together. Also the biological sense: tissue." },
        { id: "ja-u155l2-borantia", type: "vocab", front: "ボランティア", reading: "borantia", meaning: "volunteer, volunteering", example: { jp: "さいがいのあと、おおくのひとがボランティアにさんかしました。", en: "After the disaster, many people took part as volunteers." }, accept: ["voluntary work", "unpaid helper"], hint: "Both the person and the activity, like English. ボランティアをする is what you'd normally say." },
      ],
    },
    {
      id: "ja-u155l3",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u155l4-fukushi", type: "vocab", front: "ふくし", reading: "fukushi", meaning: "welfare, social services", example: { jp: "ふくしがしっかりしていると、あんしんしてくらせます。", en: "When welfare provision is solid, you can live without worry." }, accept: ["social welfare", "public support", "care services"], hint: "The system supporting those who need it — care for the elderly and disabled especially. ふくしし is a qualified welfare worker." },
