  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u155l1-shudan", type: "vocab", front: "しゅだん", reading: "shudan", meaning: "means, method", example: { jp: "でんしゃがとまったので、ほかのしゅだんをかんがえました。", en: "The trains had stopped, so I thought about other means." }, drill: { jp: "しゅだんをかんがえます。", en: "I think of a means." }, accept: ["way", "measure", "resource"], hint: "The means you use to reach an end, with no comment on whether it is a good one. ほうほう is a method; しゅだん is something you deploy." },
        { id: "ja-u155l1-keiko", type: "vocab", front: "けいこう", reading: "keikō", meaning: "tendency, trend", example: { jp: "さいきん、あさはやくおきるひとがふえるけいこうがあります。", en: "Lately there is a tendency for more people to get up early." }, drill: { jp: "けいこうがあります。", en: "There is a tendency." }, accept: ["inclination", "leaning", "pattern"], hint: "～けいこうがある is the set frame. It reports a direction of change without claiming a cause, which makes it safe in an argument." },
        ...
        { id: "ja-u155l1-kachi", type: "vocab", front: "かち", reading: "kachi", meaning: "value, worth", example: { jp: "ふるいですが、このほんにはかちがあります。", en: "It is old, but this book has real value." }, drill: { jp: "かちがあります。", en: "It has value." }, accept: ["merit", "worth"], hint: "Worth in the abstract, never a price — ねだん is what it costs. ～かちがある means 'worth doing': いくかちがある." },
      ],
    },
    {
      id: "ja-u155l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u155l3-motomemasu", type: "vocab", front: "もとめます", reading: "motomemasu", meaning: "to seek, to ask for", example: { jp: "こまったときは、まわりのひとにたすけをもとめてください。", en: "When you're in trouble, ask the people around you for help." }, drill: { jp: "たすけをもとめます。", en: "I ask for help." }, accept: ["to request", "to look for", "to demand"], hint: "Reaching for something you lack — help, an answer, a job. さがします is looking for a thing that exists somewhere; もとめます is seeking what you need." },
