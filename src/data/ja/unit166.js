  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u166l2-8a3c", type: "kanji", front: "証", reading: "shō", meaning: "certificate", example: { jp: "かれが 正しかった ことが、あとで 証明されました。", en: "It was later proved that he had been right." }, accept: ["evidence", "a certificate", "proof"], hint: "証 = 言 (words) that 正 (make right/true). 証明 = proof, 学生証 = a student ID, 保証 = a guarantee." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u166l3-8cac", type: "kanji", front: "責", reading: "seki", meaning: "blame", example: { jp: "自分の しごとには さいごまで 責任を もちます。", en: "I take responsibility for my own work to the very end." }, accept: ["blame", "duty", "responsibility"], hint: "責める (semeru) = to blame. 責任 = responsibility — the duty you are answerable for." },
