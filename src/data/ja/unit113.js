  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u113l1-en", type: "kanji", front: "園", reading: "en", meaning: "garden", example: { jp: "日曜日は 公園で 子どもと あそんで、その あと 買い物を します。", en: "On Sundays I play with the children in the park, then do the shopping." }, accept: ["park", "plantation"], hint: "園 = a walled-off green space — the box around it is the wall. 公園 = park, 動物園 = zoo." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u113l2-hako", type: "kanji", front: "箱", reading: "hako", meaning: "box", example: { jp: "古い 本を 箱に 入れて、へやの すみに おきました。", en: "I put the old books in a box and set it in the corner of the room." }, accept: ["case", "carton"], hint: "箱 = box — the 竹 bamboo radical on top, from woven bamboo containers. ごみ箱 = wastebasket." },
        { id: "ja-u113l2-to", type: "kanji", front: "戸", reading: "to", meaning: "door", example: { jp: "戸を しずかに 開けて、家の 中に 入りました。", en: "I opened the door quietly and went into the house." }, accept: ["sliding door", "household"], hint: "戸 = an old-style sliding door — the picture is one leaf of a double door. It also counts households: 一戸." },
      ],
    },
    {
      id: "ja-u113l3",
      ...
      items: [
        ...
        { id: "ja-u113l3-bu", type: "kanji", front: "部", reading: "bu", meaning: "section", example: { jp: "その 話の 一部は ほんとうですが、全部では ありません。", en: "Part of that story is true, but not all of it." }, accept: ["part", "club", "department"], hint: "部 = a part of a whole. 全部 = all of it, 一部 = a part, 部屋 = a room (a part of a house)." },
        { id: "ja-u113l3-tokoro", type: "kanji", front: "所", reading: "tokoro", meaning: "place", example: { jp: "しずかな 所を さがして、そこで 本を 読みます。", en: "I look for a quiet place and read there." }, accept: ["spot", "address", "location"], hint: "所 = place. 住所 = address, 事務所 = office, 台所 = kitchen — the place with the counter." },
