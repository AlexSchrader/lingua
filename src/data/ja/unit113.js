  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u113l4-migigawa", type: "vocab", front: "右側", reading: "migigawa", meaning: "the right side", example: { jp: "道の 右側を 歩くと、店が よく 見えます。", en: "If you walk on the right side of the road you can see the shops well." }, accept: ["right-hand side"] },
