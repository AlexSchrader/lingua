  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u148l2-gokaku", type: "vocab", front: "ごうかく", reading: "gōkaku", meaning: "passing (an exam)", example: { jp: "いっしょうけんめいべんきょうして、やっとごうかくしました。", en: "I studied as hard as I could and finally passed." }, drill: { jp: "ごうかくがうれしいです。", en: "Passing is a joy." }, accept: ["pass", "success", "to qualify"], hint: "Passing a test or meeting a standard. ごうかくおめでとう is the congratulation you'll hear every March." },
