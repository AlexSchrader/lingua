...
export const UNIT138 = {
  ...
  lessons: [
    // Lesson 1: the passive
    {
      ...
      items: [
        { id: "ja-u138l1-raremasu", type: "vocab", front: "られます", reading: "raremasu", meaning: "(passive) is done to", example: { jp: "ケーキをつくったのに、いもうとにぜんぶたべられました。", en: "I made a cake, but my little sister ate the whole thing on me." }, accept: ["gets done", "is ~ed", "passive"], hint: "ichidan verbs take られます: たべます → たべられます. (します is irregular — its passive is されます, never しられます.) The person it happened TO becomes は/が, and the doer takes に. Note the complaint built into it — the cake was yours." },
