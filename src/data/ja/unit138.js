...
// Fronts were first checked against the corpus as EXACT STRINGS, which was not enough:
// ておきます / てしまいます / てみます / さしあげます each duplicated a dictionary-form lexeme
// already owned by u43 and u93 (ておく, てしまう, てみる, さしあげる). The content gate caught
// it; they were replaced and the check is now lexeme-aware (ます⇄辞書形, noun⇄noun+する).
// The ～ます base verbs (よびます, しります, つかいます, いいます) do have homes in A1/A2 — this
// unit teaches their PASSIVE forms, which are distinct words a learner meets constantly
// and cannot derive by ear.
export const UNIT138 = {
  ...
  lessons: [
    // Lesson 1: the passive
    {
      ...
      items: [
        { id: "ja-u138l1-raremasu", type: "vocab", front: "られます", reading: "raremasu", meaning: "(passive) is done to", example: { jp: "ケーキをつくったのに、いもうとにぜんぶたべられました。", en: "I made a cake, but my little sister ate the whole thing on me." }, drill: { jp: "ケーキをぜんぶたべられます。", en: "The whole cake gets eaten." }, accept: ["gets done", "is ~ed", "passive"], hint: "ichidan verbs take られます: たべます → たべられます. (します is irregular — its passive is されます, never しられます.) The person it happened TO becomes は/が, and the doer takes に. Note the complaint built into it — the cake was yours." },
        { id: "ja-u138l1-remasu", type: "vocab", front: "れます", reading: "remasu", meaning: "is done to (passive, godan verbs)", example: { jp: "こどものとき、よくははにしかられました。", en: "When I was a child I often got scolded by my mother." }, accept: ["gets done", "is ~ed", "passive"], hint: "godan verbs take れます: よみます → よまれます, かきます → かかれます. Same meaning as られます — only the verb group differs." },
        ...
        { id: "ja-u138l1-shiraremasu", type: "vocab", front: "しられます", reading: "shiraremasu", meaning: "becomes known", example: { jp: "そのニュースはすぐにみんなにしられました。", en: "That news quickly became known to everyone." }, drill: { jp: "ニュースがみんなにしられます。", en: "The news becomes known to everyone." }, accept: ["is known", "gets found out", "comes out"], hint: "しられます often carries the sense you'd rather it hadn't: ひみつがしられました = the secret got out." },
    ...
    // Lesson 2: the causative
    {
      ...
      items: [
        ...
        { id: "ja-u138l2-sasetekudasai", type: "vocab", front: "させてください", reading: "sasetekudasai", meaning: "please let me", example: { jp: "あしたのかいぎでは、わたしにせつめいさせてください。", en: "At tomorrow's meeting, please let me be the one to explain." }, accept: ["allow me to", "let me", "may I"], hint: "The politest way to volunteer for something: causative + てください = 'let me do it'. わたしにやらせてください = 'let me handle it'." },
    ...
    // Lesson 3: doing things FOR people
    {
      ...
      items: [
        ...
        { id: "ja-u138l3-teyarimasu", type: "vocab", front: "てやります", reading: "teyarimasu", meaning: "do (something) for someone below you", example: { jp: "こどもがねるまえに、ほんをよんでやりました。", en: "Before the children went to sleep, I read them a book." }, drill: { jp: "こどもにほんをかってやります。", en: "I buy a book for the child." }, accept: ["do for (casual)", "do for a junior", "do for an animal"], hint: "The bottom rung of the giving ladder: てやります for animals, plants and small children — さしあげる at the top, てあげる in the middle. Used to an adult it is openly rude." },
      ],
    },
    // Lesson 4: the ～て auxiliaries
    {
      ...
      unit: 138,
      lesson: 4,
      title: "て-form helpers: てあります・てほしい",
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Add intent to a verb: left ready (てあります), wanted from someone else (てほしい), done to excess (てばかり).",
      items: [
        { id: "ja-u138l4-tearimasu", type: "vocab", front: "てあります", reading: "tearimasu", meaning: "has been done (and stays that way)", example: { jp: "まどがあけてあるので、へやがすずしいです。", en: "The window has been left open, so the room is cool." }, drill: { jp: "まどがあけてあります。", en: "The window has been left open." }, accept: ["is left done", "has been prepared", "stands done"], hint: "Someone did it on purpose and the result is still there. Compare ています (in progress) and ておく (u43 — doing it for later)." },
        { id: "ja-u138l4-tehoshii", type: "vocab", front: "てほしい", reading: "tehoshii", meaning: "want someone else to do", example: { jp: "いそがしいので、だれかにてつだってほしいです。", en: "I'm busy, so I want someone to help me." }, accept: ["would like you to", "wish someone would", "want done"], hint: "たいです is what YOU want to do; てほしい is what you want SOMEONE ELSE to do. The person takes に. Mixing the two is the classic slip." },
        { id: "ja-u138l4-tebakari", type: "vocab", front: "てばかり", reading: "tebakari", meaning: "does nothing but", example: { jp: "おとうとはゲームをしてばかりで、べんきょうしません。", en: "My little brother does nothing but play games — he never studies." }, accept: ["always doing", "keeps on doing", "only ever"], hint: "Always a complaint: the person does this one thing and neglects everything else. てばかりいる is the fuller form." },
        { id: "ja-u138l4-ppanashi", type: "vocab", front: "っぱなし", reading: "ppanashi", meaning: "left as it is (undone)", example: { jp: "でんきをつけっぱなしにして、でかけてしまいました。", en: "I went out and left the lights on." }, accept: ["left on", "left open", "without stopping"], hint: "Verb stem + っぱなし = someone started it and never finished. てあります is deliberate and tidy; っぱなし is careless — the same state, opposite judgement." },
