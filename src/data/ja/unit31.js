  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "ja-u31l1-goranninaru", type: "vocab", front: "ごらんになる", reading: "goranninaru", meaning: "to see / look (respectful)", example: { jp: "こちらをごらんになります。", en: "You look at this one, please." }, accept: ["to look (respectful)", "to watch (respectful)"], hint: "尊敬語 for みる. ごらん = an honorific 'look'. Lower yourself with はいけんする." },
        { id: "ja-u31l1-ossharu", type: "vocab", front: "おっしゃる", reading: "ossharu", meaning: "to say (respectful)", example: { jp: "おなまえをおっしゃいます。", en: "Please say your name." }, accept: ["to speak (respectful)", "to tell (respectful)"], hint: "尊敬語 for いう. Lower yourself with もうす (next lesson)." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u31l2-haikensuru", type: "vocab", front: "はいけんする", reading: "haikensuru", meaning: "to see / look (humble)", example: { jp: "しゃしんをはいけんします。", en: "I'll take a look at the photo." }, accept: ["to look (humble)", "to view (humble)"], hint: "謙譲語 for みる — you humbly look at something of theirs. Pair with the respectful ごらんになる." },
