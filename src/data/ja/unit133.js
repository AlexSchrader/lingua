  ...
  lessons: [
    {
      ...
      items: [
        { id: "ja-u133l1-tairyoku", type: "vocab", front: "たいりょく", reading: "tairyoku", meaning: "stamina", example: { jp: "としをとってたいりょくがおちたので、まいにちあるくことにしました。", en: "My stamina has dropped with age, so I've taken to walking every day." }, accept: ["physical strength", "fitness", "endurance"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u133l2-kayui", type: "vocab", front: "かゆい", reading: "kayui", meaning: "itchy", example: { jp: "せなかがかゆくて、よるよくねられませんでした。", en: "My back was itchy, and I couldn't sleep well at night." }, accept: ["itching", "scratchy"] },
