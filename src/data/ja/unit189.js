  ...
  lessons: [
    // Lesson 1: place, span, and channel
    {
      ...
      items: [
        ...
        { id: "ja-u189l1-wotoshite", type: "vocab", front: "をとおして", reading: "wotōshite", meaning: "through (an intermediary, an experience)", example: { jp: "旅行を とおして、いろいろな 人と しりあいました。", en: "Through travelling, I got to know all sorts of people." }, drill: { jp: "りょこうをとおして しりあいました。", en: "We got to know each other through the trip." }, accept: ["by means of", "via the experience of", "all through"], hint: "Nearly interchangeable with をつうじて; をとおして leans a little more toward a direct experience you passed through. 通す is 'to pass through'." },
    ...
    // Lesson 3: occasions and stages
    {
      ...
      items: [
        ...
        { id: "ja-u189l3-wokikkakeni", type: "vocab", front: "をきっかけに", reading: "wokikkakeni", meaning: "prompted by; taking X as the trigger", example: { jp: "病気を きっかけに、食べ物に 気を つけるように なりました。", en: "Prompted by an illness, I came to be careful about food." }, drill: { jp: "びょうきをきっかけに かわりました。", en: "Prompted by the illness, it changed." }, accept: ["set off by", "using X as the occasion", "which led to"], hint: "きっかけ is the trigger or opening that starts a change. X is the small event; the main clause is the lasting shift it set off." },
