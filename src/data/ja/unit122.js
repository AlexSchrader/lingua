    ...
    },
    {
      ...
      items: [
        { id: "ja-u122l4-mezasu", type: "vocab", front: "めざす", reading: "mezasu", meaning: "aim for", example: { jp: "だいがくをめざして、まいにちべんきょうしています。", en: "I'm aiming for university, so I study every day." }, accept: ["to aim at", "set one's sights on", "go for"] },
                { id: "ja-u122l4-medo", type: "vocab", front: "めど", reading: "medo", meaning: "a prospect of finishing", example: { jp: "かんせいのめどがたったので、すこしやすむことにしました。", en: "There's an end in sight now, so I've decided to take a short break." }, accept: ["outlook", "target date", "an end in sight"] },
