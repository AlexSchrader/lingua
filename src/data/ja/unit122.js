  ...
  lessons: [
    {
      ...
      items: [
                { id: "ja-u122l1-mitoshi", type: "vocab", front: "みとおし", reading: "mitōshi", meaning: "outlook", example: { jp: "ことしのみとおしはあかるいですが、あんしんはできません。", en: "This year is bright in outlook, but we cannot relax." }, accept: ["prospect", "forecast", "the view ahead"] },
                { id: "ja-u122l1-nariyuki", type: "vocab", front: "なりゆき", reading: "nariyuki", meaning: "how things turn out", example: { jp: "なりゆきにまかせましたが、けっかはよかったです。", en: "I left it to take its own course, but the result was good." }, accept: ["the course of events", "how it goes", "development"] },
        ...
        { id: "ja-u122l1-izure", type: "vocab", front: "いずれ", reading: "izure", meaning: "sooner or later", example: { jp: "いずれひっこしますが、いまのところよていはありません。", en: "I'll move sooner or later, but for now there's no plan." }, accept: ["eventually", "in time", "one of these days"] },
                { id: "ja-u122l1-mitsumori", type: "vocab", front: "みつもり", reading: "mitsumori", meaning: "an estimate", example: { jp: "みつもりはたかかったですが、しごとはていねいでした。", en: "The estimate was high, but the work was careful." }, accept: ["quote", "quotation", "rough calculation"] },
                { id: "ja-u122l1-hitomazu", type: "vocab", front: "ひとまず", reading: "hitomazu", meaning: "for the moment", example: { jp: "ひとまずおわりましたが、まだなおすところがあります。", en: "It is finished for the moment, but there are still things to fix." }, accept: ["for now", "tentatively", "for the time being"] },
      ],
    },
    {
      id: "ja-u122l2",
      ...
      items: [
        ...
        { id: "ja-u122l2-torikesu", type: "vocab", front: "とりけす", reading: "torikesu", meaning: "cancel", example: { jp: "よやくをとりけしましたが、おかねはかえってきませんでした。", en: "I cancelled the booking, but the money didn't come back." }, accept: ["to call off", "revoke", "withdraw"] },
        ...
        { id: "ja-u122l2-nobasu", type: "vocab", front: "のばす", reading: "nobasu", meaning: "extend", example: { jp: "りょこうをのばしましたが、しごとがふえてしまいました。", en: "I extended the trip, but my work piled up." }, accept: ["to put off", "postpone", "stretch out"] },
      ],
    },
    {
      id: "ja-u122l3",
    ...
    },
    {
      ...
      items: [
        { id: "ja-u122l4-mezasu", type: "vocab", front: "めざす", reading: "mezasu", meaning: "aim for", example: { jp: "だいがくをめざしていますが、まだじしんがありません。", en: "I'm aiming for university, but I'm not confident yet." }, accept: ["to aim at", "set one's sights on", "go for"] },
                { id: "ja-u122l4-medo", type: "vocab", front: "めど", reading: "medo", meaning: "a prospect of finishing", example: { jp: "かんせいのめどがたちましたが、まだゆだんはできません。", en: "There is now a prospect of finishing, but we still cannot let our guard down." }, accept: ["outlook", "target date", "an end in sight"] },
        ...
        { id: "ja-u122l4-iyoiyo", type: "vocab", front: "いよいよ", reading: "iyoiyo", meaning: "at last", example: { jp: "いよいよあしたですが、まだじゅんびがおわっていません。", en: "It's tomorrow at last, but I still haven't finished preparing." }, accept: ["finally", "at long last", "the moment has come"] },
                { id: "ja-u122l4-juncho", type: "vocab", front: "じゅんちょう", reading: "junchō", meaning: "going smoothly", example: { jp: "しごとはじゅんちょうですが、あまりよろこびすぎないようにしています。", en: "The work is going smoothly, but I try not to celebrate too early." }, accept: ["favourable", "on track", "without a hitch"] },
      ],
    },
  ],
};
