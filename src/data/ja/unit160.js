  ...
  lessons: [
    {
      ...
      items: [
        { id: "ja-u160l1-taikei", type: "vocab", front: "たいけい", reading: "taikei", meaning: "a system", example: { jp: "国に よって 学校の たいけいは 大きく ちがいます。", en: "School systems differ greatly from country to country." }, accept: ["framework", "organised whole", "scheme"], hint: "たいけい is a whole ordered set — 体系 literally 'body-system'. しくみ is how it works; たいけい is that it forms one." },
        ...
        { id: "ja-u160l1-bubun", type: "vocab", front: "ぶぶん", reading: "bubun", meaning: "a part", example: { jp: "こわれたのは 一つの ぶぶんだけで、全体は 動いて います。", en: "Only one part broke; the whole still runs." }, accept: ["portion", "section", "component"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ja-u160l2-izon", type: "vocab", front: "いぞん", reading: "izon", meaning: "dependence", example: { jp: "一つの 会社への いぞんが 高いと、あぶないです。", en: "Heavy dependence on a single company is risky." }, accept: ["reliance", "to depend on", "addiction"] },
        { id: "ja-u160l2-seiyaku", type: "vocab", front: "せいやく", reading: "seiyaku", meaning: "a constraint", example: { jp: "時間の せいやくが ある 中で、できるだけの ことを しました。", en: "Working under a time constraint, we did what we could." }, accept: ["restriction", "limitation", "condition"] },
        { id: "ja-u160l2-togo", type: "vocab", front: "とうごう", reading: "tōgō", meaning: "integration", example: { jp: "二つの 部を とうごうして、一つの 大きな 部に しました。", en: "They integrated the two departments into one large one." }, accept: ["to merge", "unification", "consolidation"], hint: "とうごう and ぶんかい are the pair: putting parts into one whole, and taking a whole back into parts." },
