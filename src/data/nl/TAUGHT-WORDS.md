# NL — words already taught

**Generated file — do not hand-edit.** Regenerate with `npm run taught:words -- nl`.
Snapshot 2026-09-21: **0 words** across **0 authored unit(s)**, **20 slot(s) still stubs**.
...
| slot | unit | title |
|---|---|---|
| 1 | `nl-u1` | Sounds and spelling |
| 2 | `nl-u2` | Greetings |
| 3 | `nl-u3` | Introducing yourself |
| 4 | `nl-u4` | Family |
| 5 | `nl-u5` | Numbers and time |
| 6 | `nl-u6` | Food and drink |
| 7 | `nl-u7` | Town and places |
| 8 | `nl-u8` | Colors and weather |
| 9 | `nl-u9` | Days and months |
| 10 | `nl-u10` | Describing things |
| 11 | `nl-u11` | Body and health |
| 12 | `nl-u12` | Grammar 1 — basic sentence |
| 13 | `nl-u13` | Grammar 2 — verbs and particles |
| 14 | `nl-u14` | Grammar 3 — past tense and agreement |
| 15 | `nl-u15` | Vocabulary 1 |
| 16 | `nl-u16` | Vocabulary 2 |
| 17 | `nl-u17` | Vocabulary 3 |
| 18 | `nl-u18` | Vocabulary 4 |
| 19 | `nl-u19` | Vocabulary 5 |
| 20 | `nl-u20` | Vocabulary 6 |
