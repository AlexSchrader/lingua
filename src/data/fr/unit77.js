  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u77l1-sontfabriques", type: "vocab", front: "sont fabriqués", reading: "sontfabriques", meaning: "are made", example: { jp: "Ces vêtements sont fabriqués en France, donc ils coûtent plus cher.", en: "These clothes are made in France, so they cost more." }, accept: ["are manufactured", "are produced"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u77l4-soidisant", type: "vocab", front: "soi-disant", reading: "soidisant", meaning: "supposedly", example: { jp: "Ce soi-disant scientifique n'a jamais travaillé dans une université.", en: "This so-called scientist has never worked in a university." }, accept: ["so-called", "allegedly", "purportedly"], hint: "Carries doubt, often scorn — you are signalling that you don't believe the label." },
        { id: "fr-u77l4-dapres", type: "vocab", front: "d'après", reading: "dapres", meaning: "according to", example: { jp: "D'après les scientifiques, la situation va être difficile pendant longtemps.", en: "According to scientists, the situation will be difficult for a long time." }, accept: ["going by", "judging by", "as stated by"], hint: "Interchangeable with selon (Unit 43) before a person or a source." },
