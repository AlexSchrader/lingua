  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u77l1-estconstruit", type: "vocab", front: "est construit", reading: "estconstruit", meaning: "is built", example: { jp: "Ce pont est construit en métal, si bien qu'il ne craint pas la pluie.", en: "This bridge is built of metal, so it isn't affected by rain." }, accept: ["is being built", "gets built"], hint: "The passive is être + the participle, and the participle agrees: construit, construite, construits." },
        ...
        { id: "fr-u77l1-sontfabriques", type: "vocab", front: "sont fabriqués", reading: "sontfabriques", meaning: "are made", example: { jp: "Ces produits sont fabriqués en France, donc ils coûtent plus cher.", en: "These products are made in France, so they cost more." }, accept: ["are manufactured", "are produced"] },
        { id: "fr-u77l1-par", type: "vocab", front: "par", reading: "par", meaning: "by", example: { jp: "Ce roman a été écrit par une femme dont personne ne connaît le vrai nom.", en: "This novel was written by a woman whose real name nobody knows." }, accept: ["through", "via", "by means of"], hint: "par names the doer in a passive. It also means \"per\": deux fois par semaine." },
        { id: "fr-u77l1-etreconnu", type: "vocab", front: "être connu", reading: "etreconnu", meaning: "to be known", example: { jp: "Cette région est connue pour ses paysages, et le tourisme y est important.", en: "This region is known for its landscapes, and tourism is important there." }, accept: ["to be famous", "to be well known"], hint: "être connu POUR something. From connaître (Unit 38)." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u77l3-casedit", type: "vocab", front: "ça se dit", reading: "casedit", meaning: "people say that", example: { jp: "« Bonne continuation » ? Oui, ça se dit, surtout à la fin d'un message.", en: "\"Bonne continuation\"? Yes, people say that, especially at the end of a message." }, accept: ["that's said", "you can say that", "it is said"], hint: "The most useful question you can ask a native: est-ce que ça se dit ? — is that something people actually say?" },
        ...
        { id: "fr-u77l3-setrouver", type: "vocab", front: "se trouver", reading: "setrouver", meaning: "to be located", example: { jp: "La gare se trouve à côté du parc, donc c'est facile à trouver.", en: "The station is located next to the park, so it's easy to find." }, accept: ["to be situated", "to be found", "to lie"], hint: "Where French says se trouver, English usually just says \"is\"." },
        { id: "fr-u77l3-ilsagitde", type: "vocab", front: "il s'agit de", reading: "ilsagitde", meaning: "it's about", example: { jp: "Dans ce reportage, il s'agit du réchauffement et de ses effets.", en: "This report is about global warming and its effects." }, accept: ["it is a matter of", "it concerns", "this is about"], hint: "Impersonal only — you can never say \"je m'agis\". The subject is always il." },
        { id: "fr-u77l3-ilreste", type: "vocab", front: "il reste", reading: "ilreste", meaning: "there is left", example: { jp: "Il reste deux jours avant l'examen, et je n'ai rien préparé.", en: "There are two days left before the exam, and I haven't prepared anything." }, accept: ["there remains", "there are left", "what's left"], hint: "Impersonal il — the thing that remains comes after the verb, not before it." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u77l4-ilparaitque", type: "vocab", front: "il paraît que", reading: "ilparaitque", meaning: "apparently", example: { jp: "Il paraît que le film est excellent, mais je ne l'ai pas encore vu.", en: "Apparently the film is excellent, but I haven't seen it yet." }, accept: ["it seems that", "i hear that", "rumour has it"], hint: "Marks hearsay: you're passing on what you were told, without vouching for it." },
        ...
        { id: "fr-u77l4-ilsuffitde", type: "vocab", front: "il suffit de", reading: "ilsuffitde", meaning: "you just have to", example: { jp: "Il suffit de cliquer ici, et le dossier se télécharge tout seul.", en: "You just have to click here, and the file downloads by itself." }, accept: ["it is enough to", "all you need is", "simply"], hint: "The opposite of il faut in tone: il faut is a demand, il suffit de is a reassurance." },
        { id: "fr-u77l4-soidisant", type: "vocab", front: "soi-disant", reading: "soidisant", meaning: "supposedly", example: { jp: "Ce soi-disant expert n'a jamais travaillé dans le domaine.", en: "This so-called expert has never worked in the field." }, accept: ["so-called", "allegedly", "purportedly"], hint: "Carries doubt, often scorn — you are signalling that you don't believe the label." },
        { id: "fr-u77l4-dapres", type: "vocab", front: "d'après", reading: "dapres", meaning: "according to", example: { jp: "D'après les scientifiques, la situation va empirer avant de s'améliorer.", en: "According to scientists, the situation will get worse before it improves." }, accept: ["going by", "judging by", "as stated by"], hint: "Interchangeable with selon (Unit 43) before a person or a source." },
