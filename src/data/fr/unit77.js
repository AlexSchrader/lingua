  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u77l1-estconstruit", type: "vocab", front: "est construit", reading: "estconstruit", meaning: "is built", example: { jp: "Ce pont est construit en métal, si bien qu'il dure très longtemps.", en: "This bridge is built of metal, so it lasts a very long time." }, drill: { jp: "Ce mur est construit en pierre", en: "This wall is built of stone" }, accept: ["is being built", "gets built"], hint: "The passive is être + the participle, and the participle agrees: construit, construite, construits." },
        { id: "fr-u77l1-aetevendu", type: "vocab", front: "a été vendu", reading: "aetevendu", meaning: "was sold", example: { jp: "La maison a été vendue en une semaine, ce qui a surpris tout le monde.", en: "The house was sold in a week, which surprised everyone." }, drill: { jp: "Le vélo a été vendu hier", en: "The bike was sold yesterday" }, accept: ["has been sold", "got sold"], hint: "Past passive stacks two auxiliaries: a été + participle. Long, but completely regular." },
        ...
        { id: "fr-u77l1-etreconnu", type: "vocab", front: "être connu", reading: "etreconnu", meaning: "to be known", example: { jp: "Cette région est connue pour ses paysages, et le tourisme y est important.", en: "This region is known for its landscapes, and tourism is important there." }, drill: { jp: "Il veut être connu partout", en: "He wants to be known everywhere" }, accept: ["to be famous", "to be well known"], hint: "être connu POUR something. From connaître (Unit 49)." },
        { id: "fr-u77l1-onditque", type: "vocab", front: "on dit que", reading: "onditque", meaning: "it is said that", example: { jp: "On dit que ce restaurant est le meilleur de la région, mais je n'y suis jamais allé.", en: "They say this restaurant is the best in the region, but I've never been." }, drill: { jp: "On dit que ce film est bon", en: "It's said that this film is good" }, accept: ["they say", "people say", "it's said"], hint: "French prefers on + active where English reaches for a passive. This is the commonest \"passive\" of all." },
      ],
    },
    {
      id: "fr-u77l2",
      ...
      items: [
        { id: "fr-u77l2-fairefaire", type: "vocab", front: "faire faire", reading: "fairefaire", meaning: "to have something done", example: { jp: "Je vais faire faire une clé, parce que j'ai perdu la mienne.", en: "I'm going to have a key made, because I've lost mine." }, drill: { jp: "Je vais faire faire un gâteau", en: "I'm going to have a cake made" }, accept: ["to get done", "to have made"], hint: "faire + another verb = you arrange it, someone else does it. Two faires in a row is normal here." },
        { id: "fr-u77l2-jefaisreparer", type: "vocab", front: "je fais réparer", reading: "jefaisreparer", meaning: "I'm having it repaired", example: { jp: "Je fais réparer ma voiture, donc je prends le train cette semaine.", en: "I'm having my car repaired, so I'm taking the train this week." }, drill: { jp: "Je fais réparer mon vélo demain", en: "I'm having my bike repaired tomorrow" }, accept: ["i'm getting it fixed", "i have it repaired"], hint: "The everyday shape of faire faire. Note it's NOT \"je répare\" — that would mean you do it yourself." },
        { id: "fr-u77l2-permettre", type: "vocab", front: "permettre", reading: "permettre", meaning: "to allow", example: { jp: "Ce site permet de comparer les prix, ce qui est très utile.", en: "This site allows you to compare prices, which is very useful." }, drill: { jp: "Ça va permettre de gagner du temps", en: "That will allow us to save time" }, accept: ["to permit", "to let", "to enable"], hint: "permettre DE + verb. And se permettre de = to take the liberty of." },
        { id: "fr-u77l2-obliger", type: "vocab", front: "obliger", reading: "obliger", meaning: "to force", example: { jp: "La pluie nous a obligés à rentrer plus tôt.", en: "The rain forced us to go home earlier." }, drill: { jp: "Personne ne peut obliger les autres", en: "Nobody can force the others" }, accept: ["to compel", "to oblige", "to make"], hint: "obliger quelqu'un À faire. The passive of it is je suis obligé de (Unit 44)." },
        ...
        { id: "fr-u77l2-sefaire", type: "vocab", front: "se faire", reading: "sefaire", meaning: "to get (something done to you)", example: { jp: "Il s'est fait voler son portable dans le métro.", en: "He got his phone stolen on the underground." }, drill: { jp: "Il va se faire aider", en: "He's going to get some help" }, accept: ["to have done to oneself", "to get oneself"], hint: "se faire + verb is how French says \"I got my hair cut\" or \"he got robbed\" — the subject receives the action." },
      ],
    },
    {
      id: "fr-u77l3",
      ...
      items: [
        { id: "fr-u77l3-casedit", type: "vocab", front: "ça se dit", reading: "casedit", meaning: "people say that", example: { jp: "« Bonne continuation » ? Oui, ça se dit, surtout à la fin d'un message.", en: "\"Bonne continuation\" (all the best for what comes next)? Yes, people say that, especially at the end of a message." }, drill: { jp: "Ça se dit souvent ici", en: "People say that a lot here" }, accept: ["that's said", "you can say that", "it is said"], hint: "The most useful question you can ask a native: est-ce que ça se dit ? — is that something people actually say?" },
        { id: "fr-u77l3-casefait", type: "vocab", front: "ça se fait", reading: "casefait", meaning: "that's done", example: { jp: "Arriver en retard chez quelqu'un, ça ne se fait pas vraiment en France.", en: "Turning up late at someone's house isn't really done in France." }, drill: { jp: "Ça se fait beaucoup en France", en: "That's done a lot in France" }, accept: ["that's acceptable", "it's the custom", "people do that"], hint: "Almost always heard in the negative — ça ne se fait pas is a rule of manners, not of grammar." },
        ...
        { id: "fr-u77l3-ilreste", type: "vocab", front: "il reste", reading: "ilreste", meaning: "there is left", example: { jp: "Il reste deux jours avant l'examen, et je n'ai rien fait.", en: "There are two days left before the exam, and I haven't done anything." }, drill: { jp: "Il reste encore un peu de pain", en: "There's still a little bread left" }, accept: ["there remains", "there are left", "what's left"], hint: "Impersonal il — the thing that remains comes after the verb, not before it." },
        { id: "fr-u77l3-ilmanque", type: "vocab", front: "il manque", reading: "ilmanque", meaning: "there is missing", example: { jp: "Il manque une page dans ce livre, si bien qu'on ne comprend pas la fin.", en: "There's a page missing from this book, so you don't understand the ending." }, drill: { jp: "Il manque une clé dans la boîte", en: "There's a key missing in the box" }, accept: ["there's a lack of", "is missing", "we're short of"], hint: "Also personal, with a twist: tu me manques = I miss you, literally \"you are lacking to me\"." },
      ],
    },
    {
      id: "fr-u77l4",
      ...
      items: [
        { id: "fr-u77l4-ilparaitque", type: "vocab", front: "il paraît que", reading: "ilparaitque", meaning: "apparently", example: { jp: "Il paraît que le film est très bon, mais je ne l'ai pas encore vu.", en: "Apparently the film is very good, but I haven't seen it yet." }, drill: { jp: "Il paraît que tout va changer", en: "Apparently everything is going to change" }, accept: ["it seems that", "i hear that", "rumour has it"], hint: "Marks hearsay: you're passing on what you were told, without vouching for it." },
        { id: "fr-u77l4-onraconteque", type: "vocab", front: "on raconte que", reading: "onraconteque", meaning: "the story goes that", example: { jp: "On raconte que cette maison est très vieille, pourtant personne n'en est sûr.", en: "The story goes that this house is very old, yet nobody is sure of it." }, drill: { jp: "On raconte que cette histoire est vraie", en: "The story goes that this tale is true" }, accept: ["they say that", "people tell", "legend has it"] },
        { id: "fr-u77l4-ilsuffitde", type: "vocab", front: "il suffit de", reading: "ilsuffitde", meaning: "you just have to", example: { jp: "Il suffit de cliquer ici, et le fichier se télécharge tout seul.", en: "You just have to click here, and the file downloads by itself." }, drill: { jp: "Il suffit de poser la question", en: "You just have to ask the question" }, accept: ["it is enough to", "all you need is", "simply"], hint: "The opposite of il faut in tone: il faut is a demand, il suffit de is a reassurance." },
        ...
        { id: "fr-u77l4-lasource2", type: "vocab", front: "de source sûre", reading: "desourcesure", meaning: "from a reliable source", example: { jp: "Je le sais de source sûre, mais je ne peux pas vous dire qui me l'a dit.", en: "I know it from a reliable source, but I can't tell you who told me." }, drill: { jp: "Cette nouvelle vient de source sûre", en: "This news comes from a reliable source" }, accept: ["on good authority", "reliably"], hint: "The opposite move to il paraît que — here you ARE vouching for it." },
      ],
    },
  ],
};
