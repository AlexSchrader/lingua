  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u74l1-lesymptome", type: "vocab", front: "le symptôme", reading: "lesymptome", meaning: "the symptom", example: { jp: "J'ai expliqué mes symptômes, puis le médecin m'a posé beaucoup de questions.", en: "I explained my symptoms, then the doctor asked me a lot of questions." }, accept: ["symptom", "the sign"] },
        ...
        { id: "fr-u74l1-levaccin", type: "vocab", front: "le vaccin", reading: "levaccin", meaning: "the vaccine", example: { jp: "Le vaccin est gratuit pour tout le monde, donc il ne faut pas attendre.", en: "The vaccine is free for everyone, so there's no reason to wait." }, accept: ["vaccine", "the jab", "vaccination"] },
      ],
    },
    {
      id: "fr-u74l2",
