  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u113l1-quandbienmeme", type: "vocab", front: "quand bien même", reading: "quandbienmeme", meaning: "even if / even though", example: { jp: "Quand bien même il aurait raison, personne ne le croirait.", en: "Even if he were right, no one would believe him." }, accept: ["even if", "even though", "even if it were true"], hint: "+ conditional (aurait, croirait); literary concessive — the outcome holds 'even were it so'." },
