...
export const FR_UNIT120 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "fr-u120l3-fracture", type: "vocab", front: "la fracture", reading: "lafracture", meaning: "the rift, the divide", example: { jp: "Cette réforme creuse la fracture entre les riches et les pauvres, si bien que la colère augmente.", en: "This reform is widening the divide between rich and poor, so anger is rising." }, accept: ["the rift", "the divide", "the split", "the fracture", "the gulf"], hint: "A deep social split: la fracture sociale, la fracture numérique. From fracturer (to break). Feminine." },
