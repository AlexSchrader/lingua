...
export const FR_UNIT109 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "fr-u109l4-lethique", type: "vocab", front: "l'éthique", reading: "lethique", meaning: "ethics", example: { jp: "L'éthique médicale pose des questions difficiles, car soigner n'est pas toujours simple.", en: "Medical ethics raises hard questions, because treating people is not always simple." }, accept: ["ethics", "the ethics", "medical ethics"], hint: "l'éthique = ethics as a field. Feminine despite no -e cue: une éthique claire." },
        ...
        { id: "fr-u109l4-ladignite", type: "vocab", front: "la dignité", reading: "ladignite", meaning: "dignity", example: { jp: "La dignité du malade compte autant que le traitement, surtout en fin de vie.", en: "The patient's dignity matters as much as the treatment, especially at the end of life." }, accept: ["dignity", "the dignity"], hint: "la dignité humaine — a core value in l'éthique médicale. mourir dans la dignité." },
