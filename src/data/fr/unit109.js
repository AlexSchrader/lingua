...
export const FR_UNIT109 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "fr-u109l2-laccesauxsoins", type: "vocab", front: "l'accès aux soins", reading: "laccesauxsoins", meaning: "access to care", example: { jp: "L'accès aux soins reste difficile à la campagne, tandis qu'en ville il y a beaucoup de médecins.", en: "Access to care remains difficult in the countryside, whereas in the city there are lots of doctors." }, drill: { jp: "L'accès aux soins reste très difficile", en: "Access to care remains very difficult" }, accept: ["access to care", "access to healthcare", "healthcare access"], hint: "The phrase in every health debate: l'accès aux soins. soins stays plural." },
        { id: "fr-u109l2-lapriseencharge", type: "vocab", front: "la prise en charge", reading: "lapriseencharge", meaning: "the (medical/financial) handling", example: { jp: "La prise en charge des malades chroniques coûte cher, mais l'hôpital ne refuse personne.", en: "Handling chronically ill patients is expensive, but the hospital turns no one away." }, drill: { jp: "La prise en charge coûte cher", en: "The handling costs a lot" }, accept: ["the coverage", "the handling", "care provision", "taking charge"], hint: "Institutional term: who takes responsibility (and pays) for a patient — la prise en charge." },
        { id: "fr-u109l2-linegalitesdesante", type: "vocab", front: "les inégalités de santé", reading: "lesinegalitesdesante", meaning: "health inequalities", example: { jp: "Les inégalités de santé sont fortes, car les plus pauvres vivent souvent moins longtemps.", en: "Health inequalities are stark, because the poorest often live for less time." }, drill: { jp: "Les inégalités de santé restent fortes", en: "Health inequalities stay strong" }, accept: ["health inequalities", "health inequality", "inequalities in health"], hint: "A plural collocation from l'inégalité (Unit 75): the health gap between rich and poor." },
        { id: "fr-u109l2-ledesertmedical", type: "vocab", front: "le désert médical", reading: "ledesertmedical", meaning: "the medical desert (underserved area)", example: { jp: "Dans un désert médical, il faut attendre des mois pour voir un médecin, si bien que beaucoup renoncent.", en: "In a medical desert, you have to wait months to see a doctor, so many give up." }, drill: { jp: "Le désert médical touche la campagne", en: "The medical desert affects the countryside" }, accept: ["the medical desert", "medical desert", "an underserved area"], hint: "Une zone rurale sans médecins = un désert médical. médical agrees masc. here." },
        { id: "fr-u109l2-lapenurie", type: "vocab", front: "la pénurie", reading: "lapenurie", meaning: "the shortage", example: { jp: "La pénurie de médecins touche surtout les campagnes, tandis que les villes en ont beaucoup.", en: "The shortage of doctors hits the countryside above all, whereas cities have plenty of them." }, drill: { jp: "La pénurie de médecins augmente", en: "The shortage of doctors is growing" }, accept: ["the shortage", "shortage", "the scarcity"], hint: "Une pénurie DE — a serious lack of something needed: une pénurie de médecins, de médicaments." },
        { id: "fr-u109l2-lesoignant", type: "vocab", front: "le soignant", reading: "lesoignant", meaning: "the carer / healthcare worker", example: { jp: "Après la crise, les soignants ont besoin de repos, pourtant ils continuent à aider les malades.", en: "After the crisis, care workers need rest, yet they keep on helping the sick." }, drill: { jp: "Le soignant a besoin de repos", en: "The carer needs rest" }, accept: ["the carer", "the caregiver", "healthcare worker", "care worker"], hint: "From soigner (Unit 32): anyone who gives care — nurse, aide, doctor. les soignants = the care staff." },
      ],
    },
    {
      id: "fr-u109l3",
      ...
      items: [
        { id: "fr-u109l3-laprevention", type: "vocab", front: "la prévention", reading: "laprevention", meaning: "prevention", example: { jp: "La prévention coûte moins cher que le traitement, car il vaut mieux prévenir que guérir.", en: "Prevention costs less than treatment, because it's better to prevent than to cure." }, drill: { jp: "La prévention reste vraiment nécessaire", en: "Prevention stays really necessary" }, accept: ["prevention"], hint: "The noun from prévenir (Unit 74): stopping illness before it starts, not treating it after." },
        { id: "fr-u109l3-ledepistage", type: "vocab", front: "le dépistage", reading: "ledepistage", meaning: "the screening (medical testing)", example: { jp: "Le dépistage permet de voir la maladie plus tôt, si bien que le traitement commence plus vite.", en: "Screening makes it possible to spot the illness earlier, so that treatment starts sooner." }, drill: { jp: "Le dépistage est gratuit ici", en: "The screening is free here" }, accept: ["the screening", "screening", "early detection", "testing"], hint: "Testing a healthy population to catch disease early: le dépistage du cancer. From dépister." },
        { id: "fr-u109l3-lapandemie", type: "vocab", front: "la pandémie", reading: "lapandemie", meaning: "the pandemic", example: { jp: "Une pandémie touche plusieurs pays à la fois, tandis qu'une épidémie reste dans une seule région.", en: "A pandemic strikes several countries at once, whereas an epidemic stays within one region." }, drill: { jp: "La pandémie a changé nos habitudes", en: "The pandemic changed our habits" }, accept: ["the pandemic", "pandemic"], hint: "Bigger than une épidémie (Unit 74): a pandémie crosses countries and continents." },
        { id: "fr-u109l3-leconfinement", type: "vocab", front: "le confinement", reading: "leconfinement", meaning: "the lockdown", example: { jp: "Pendant le confinement, personne ne pouvait sortir, ce qui a protégé les plus fragiles.", en: "During lockdown, no one could go out, which protected the most vulnerable." }, drill: { jp: "Le confinement a protégé les plus fragiles", en: "The lockdown protected the most fragile" }, accept: ["the lockdown", "lockdown", "confinement"], hint: "The 2020 word: staying home to slow a virus. le confinement / le déconfinement." },
        { id: "fr-u109l3-lesperancedevie", type: "vocab", front: "l'espérance de vie", reading: "lesperancedevie", meaning: "life expectancy", example: { jp: "L'espérance de vie augmente d'année en année, mais elle baisse chez les plus pauvres.", en: "Life expectancy rises year after year, but it falls among the poorest." }, drill: { jp: "L'espérance de vie augmente encore", en: "Life expectancy is still rising" }, accept: ["life expectancy", "the life expectancy"], hint: "How many years one can expect to live on average — a key santé publique statistic." },
        { id: "fr-u109l3-lavaccination", type: "vocab", front: "la vaccination", reading: "lavaccination", meaning: "vaccination", example: { jp: "La vaccination protège aussi les autres, car un malade de moins, c'est un risque de moins.", en: "Vaccination protects others too, because one fewer sick person is one fewer risk." }, drill: { jp: "La vaccination reste vraiment importante", en: "Vaccination stays really important" }, accept: ["vaccination", "the vaccination", "immunisation"], hint: "The act/campaign, not the substance: from le vaccin (Unit 74). la vaccination de masse." },
      ],
    },
    {
      id: "fr-u109l4",
