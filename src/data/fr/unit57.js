  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u57l2-lemoment", type: "vocab", front: "le moment", reading: "lemoment", meaning: "moment", example: { jp: "C'est le bon moment.", en: "It's the right moment." }, accept: ["the moment", "point", "instant"], hint: "le bon moment = the right time. bon here means \"right\", not \"good\"." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u57l3-lasolution", type: "vocab", front: "la solution", reading: "lasolution", meaning: "solution", example: { jp: "Je cherche une solution.", en: "I'm looking for a solution." }, accept: ["the solution", "fix", "way out"] },
