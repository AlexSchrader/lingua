  ...
  lessons: [
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Apply heat to food: cook it, boil it, fry it, roast it — and name the pan and the lid.",
      items: [
        ...
        { id: "fr-u92l1-lacasserole", type: "vocab", front: "la casserole", reading: "lacasserole", meaning: "saucepan", example: { jp: "L'eau bout dans la casserole.", en: "The water is boiling in the saucepan." }, accept: ["the saucepan", "pot"], hint: "False friend: NOT an English casserole dish — it's the pan you boil things in." },
      ],
    },
    {
      id: "fr-u92l2",
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Follow a recipe: name the recipe, an ingredient, the cooking time, a dish, a portion — and the oven dish it goes in.",
      items: [
        ...
        { id: "fr-u92l4-lacuisson", type: "vocab", front: "la cuisson", reading: "lacuisson", meaning: "cooking time", example: { jp: "La cuisson est de vingt minutes.", en: "The cooking time is twenty minutes." }, accept: ["the cooking", "baking time"], hint: "The noun from cuire. In a restaurant it's also how you want your steak done." },
        ...
        { id: "fr-u92l4-laportion", type: "vocab", front: "la portion", reading: "laportion", meaning: "portion", example: { jp: "La portion est trop grande.", en: "The portion is too big." }, accept: ["the portion", "helping", "serving"] },
