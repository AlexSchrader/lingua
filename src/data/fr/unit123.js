  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u123l3-larancoeur", type: "vocab", front: "la rancœur", reading: "larancoeur", meaning: "rancour", example: { jp: "Elle parle de cette époque avec rancœur, car elle s'y est sentie trahie.", en: "She speaks of that time with rancour, because she felt betrayed then." }, accept: ["rancour", "the rancour", "rancor", "bitterness", "resentment"], hint: "Bitter, long-held resentment. Close to la rancune, a touch more literary." },
      ],
    },
    {
      id: "fr-u123l4",
