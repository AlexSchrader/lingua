...
export const FR_UNIT58 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "fr-u58l2-certes", type: "vocab", front: "certes", reading: "certes", meaning: "admittedly", example: { jp: "Certes, c'est cher, mais la qualité est vraiment bonne.", en: "Admittedly, it's expensive, but the quality is really good." }, accept: ["admittedly", "certainly", "of course", "granted"], hint: "Concedes a point you're about to push back on: certes… mais…" },
        { id: "fr-u58l2-admettre", type: "vocab", front: "admettre", reading: "admettre", meaning: "to admit", example: { jp: "Je dois admettre que tu avais raison depuis le début.", en: "I have to admit that you were right from the start." }, accept: ["to admit", "to concede", "to acknowledge"], hint: "Also 'to let in' — admettre quelqu'un dans un club." },
