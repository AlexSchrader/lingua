  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u39l3-lanouvelle", type: "vocab", front: "la nouvelle", reading: "lanouvelle", meaning: "the piece of news", example: { jp: "J'ai une bonne nouvelle !", en: "I have good news!" }, accept: ["news", "the news", "piece of news"], hint: "Careful: la nouvelle (an item of news) is spelled like nouvelle (new, feminine). Same word, two jobs." },
