  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u94l1-valoirlapeine", type: "vocab", front: "valoir la peine", reading: "valoirlapeine", meaning: "to be worth it", example: { jp: "Ce voyage vaut la peine.", en: "This trip is worth it." }, accept: ["be worthwhile", "be worth the trouble"] },
