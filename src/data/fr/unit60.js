  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u60l1-demoinsenmoins", type: "vocab", front: "de moins en moins", reading: "demoinsenmoins", meaning: "less and less", example: { jp: "Il y a de moins en moins de neige en hiver.", en: "There is less and less snow in winter." }, accept: ["less and less", "fewer and fewer"], hint: "The falling twin of de plus en plus. Followed by de before a noun." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u60l2-depasser", type: "vocab", front: "dépasser", reading: "depasser", meaning: "to exceed", example: { jp: "Le prix dépasse cent euros sans problème.", en: "The price goes over a hundred euros easily." }, accept: ["to exceed", "to go beyond", "to overtake", "to pass"], hint: "To go beyond — a limit, an amount, or a car: dépasser une voiture = to overtake." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u60l3-semblable", type: "vocab", front: "semblable", reading: "semblable", meaning: "similar", example: { jp: "Les deux maisons sont presque semblables.", en: "The two houses are almost identical." }, accept: ["similar", "alike", "comparable"], hint: "semblable à = similar to. A more formal pareil." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u60l4-inferieur", type: "vocab", front: "inférieur", reading: "inferieur", meaning: "lower", example: { jp: "Un prix inférieur à dix euros, c'est rare ici.", en: "A price below ten euros is rare here." }, accept: ["lower", "inferior", "below", "under"], hint: "inférieur à = lower than / below. Also 'inferior' in quality." },
      ],
    },
  ],
};
