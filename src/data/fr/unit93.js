  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u93l1-lestyle", type: "vocab", front: "le style", reading: "lestyle", meaning: "style", example: { jp: "J'aime beaucoup son style.", en: "I really like their style." }, accept: ["the style", "look"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u93l3-labague", type: "vocab", front: "la bague", reading: "labague", meaning: "ring", example: { jp: "Cette bague est en or.", en: "This ring is made of gold." }, accept: ["the ring"] },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u93l4-semaquiller", type: "vocab", front: "se maquiller", reading: "semaquiller", meaning: "to put on make-up", example: { jp: "Elle se maquille avant de sortir.", en: "She puts on make-up before going out." }, accept: ["do one's make-up", "make oneself up"] },
        { id: "fr-u93l4-lacoiffure", type: "vocab", front: "la coiffure", reading: "lacoiffure", meaning: "hairstyle", example: { jp: "J'aime bien ta nouvelle coiffure.", en: "I really like your new hairstyle." }, accept: ["the hairstyle", "hairdo"], hint: "From le coiffeur, the hairdresser you already know." },
        ...
        { id: "fr-u93l4-leparfum", type: "vocab", front: "le parfum", reading: "leparfum", meaning: "perfume", example: { jp: "Ton parfum sent très bon.", en: "Your perfume smells very good." }, accept: ["the perfume", "scent", "fragrance"], hint: "Also an ice-cream flavour: quel parfum ? — which flavour?" },
      ],
    },
  ],
};
