  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u102l1-ladecennie", type: "vocab", front: "la décennie", reading: "ladecennie", meaning: "the decade", example: { jp: "En quelques décennies, la ville a beaucoup changé.", en: "In a few decades, the city changed a lot." }, accept: ["decade"], hint: "Ten years — la décennie précédente. From déci- (ten)." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u102l2-lacoutume", type: "vocab", front: "la coutume", reading: "lacoutume", meaning: "the custom", example: { jp: "Dans ce pays, cette coutume reste très ancienne.", en: "In this country, this custom is still very old." }, accept: ["custom", "the practice", "the usage"], hint: "A local custom or usage — les coutumes locales. avoir coutume de = to be in the habit of." },
