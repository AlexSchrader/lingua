  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u44l1-onpourrait", type: "vocab", front: "on pourrait", reading: "onpourrait", meaning: "we could", example: { jp: "On pourrait manger au restaurant.", en: "We could eat at the restaurant." }, accept: ["one could", "we might", "we could"], hint: "on pourrait … ? is how a French speaker suggests something." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u44l2-jereussisa", type: "vocab", front: "je réussis à", reading: "jereussisa", meaning: "I manage to", example: { jp: "Je réussis à voir le film.", en: "I manage to see the film." }, accept: ["i succeed in", "i manage", "i get to"], hint: "réussir À + verb. Without the à it means to pass: je réussis mon examen." },
        ...
        { id: "fr-u44l2-jesuiscapablede", type: "vocab", front: "je suis capable de", reading: "jesuiscapablede", meaning: "I'm able to", example: { jp: "Je suis capable de faire ce travail.", en: "I'm able to do this job." }, accept: ["i am capable of", "i'm capable of"], hint: "About ability, not permission — je peux (Unit 9) covers both, this one only the first." },
      ],
    },
    {
      id: "fr-u44l3",
