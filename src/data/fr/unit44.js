  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u44l2-jedois", type: "vocab", front: "je dois", reading: "jedois", meaning: "I must", example: { jp: "Je dois partir maintenant.", en: "I must leave now." }, accept: ["i have to", "i need to", "i've got to"] },
        ...
        { id: "fr-u44l2-jesuisobligede", type: "vocab", front: "je suis obligé de", reading: "jesuisobligede", meaning: "I have to", example: { jp: "Je suis obligé de travailler ce week-end.", en: "I have to work this weekend." }, accept: ["i'm obliged to", "i must", "i am forced to"], hint: "Stronger than je dois — it says someone else decided." },
      ],
    },
    {
      id: "fr-u44l3",
