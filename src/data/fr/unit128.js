  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u128l3-lebuste", type: "vocab", front: "le buste", reading: "lebuste", meaning: "the bust", example: { jp: "Un buste en pierre du vieux roi trône dans l'entrée.", en: "A stone bust of the old king stands in the entrance." }, accept: ["bust", "the bust"], hint: "A sculpture of the head and shoulders. Also the chest or torso." },
