  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u128l3-lesculpteur", type: "vocab", front: "le sculpteur", reading: "lesculpteur", meaning: "the sculptor", example: { jp: "Le sculpteur travaille le marbre depuis trente ans.", en: "The sculptor has worked with marble for thirty years." }, accept: ["sculptor", "the sculptor"], hint: "The artist. The 'p' is silent: sculpteur sounds like 'skul-teur'." },
      ],
    },
    {
      id: "fr-u128l4",
