  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u121l2-poursuivre", type: "vocab", front: "poursuivre", reading: "poursuivre", meaning: "to prosecute", example: { jp: "La justice va le poursuivre, car les preuves sont nombreuses.", en: "The law is going to prosecute him, because the evidence is plentiful." }, accept: ["to prosecute", "to sue", "to pursue"], hint: "Also to chase, and to carry on: poursuivre son chemin." },
      ],
    },
    {
      id: "fr-u121l3",
      ...
      items: [
        { id: "fr-u121l3-letribunal", type: "vocab", front: "le tribunal", reading: "letribunal", meaning: "the court", example: { jp: "Le tribunal était plein, car tout le monde attendait le résultat.", en: "The court was full, because everyone was waiting for the outcome." }, accept: ["court", "the court", "the courthouse", "tribunal"], hint: "The institution and the building. Plural: les tribunaux." },
        { id: "fr-u121l3-leproces", type: "vocab", front: "le procès", reading: "leproces", meaning: "the trial", example: { jp: "Le procès a duré trois jours, et la salle restait silencieuse.", en: "The trial lasted three days, and the room stayed silent." }, accept: ["trial", "the trial", "the lawsuit"], hint: "faire un procès à quelqu'un = to sue someone. Not le processus (process)." },
        ...
        { id: "fr-u121l3-lejury", type: "vocab", front: "le jury", reading: "lejury", meaning: "the jury", example: { jp: "Le jury a longuement discuté avant d'annoncer sa décision.", en: "The jury discussed at length before announcing its decision." }, accept: ["jury", "the jury", "the panel"], hint: "Also the panel of a competition or an exam." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u121l4-coupable", type: "vocab", front: "coupable", reading: "coupable", meaning: "guilty", example: { jp: "Le jury l'a déclaré coupable, malgré les efforts de son avocat.", en: "The jury declared him guilty, despite his lawyer's efforts." }, accept: ["guilty", "the culprit"], hint: "Also a noun: le coupable = the guilty one. se sentir coupable = to feel guilty." },
        { id: "fr-u121l4-innocent", type: "vocab", front: "innocent", reading: "innocent", meaning: "innocent", example: { jp: "Il a toujours dit qu'il était innocent, et le juge l'a enfin cru.", en: "He always said he was innocent, and the judge finally believed him." }, accept: ["innocent", "not guilty"], hint: "The opposite of coupable. Also innocent = naive, harmless." },
        { id: "fr-u121l4-condamner", type: "vocab", front: "condamner", reading: "condamner", meaning: "to sentence", example: { jp: "Le tribunal l'a condamné à deux ans de prison, ce qui a surpris tout le monde.", en: "The court sentenced him to two years in prison, which surprised everyone." }, accept: ["to sentence", "to condemn", "to convict"], hint: "condamner à = to sentence to. Also to condemn morally, or to board up a door." },
