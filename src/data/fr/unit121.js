  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u121l1-commettre", type: "vocab", front: "commettre", reading: "commettre", meaning: "to commit", example: { jp: "Celui qui a commis ce crime sera puni un jour ou l'autre.", en: "Whoever committed this crime will be punished sooner or later." }, drill: { jp: "Personne ne veut commettre une erreur", en: "Nobody wants to commit a mistake" }, accept: ["to commit", "to perpetrate"], hint: "commettre un crime, une erreur. Past participle: commis." },
      ],
    },
    {
      id: "fr-u121l2",
      ...
      items: [
        { id: "fr-u121l2-accuser", type: "vocab", front: "accuser", reading: "accuser", meaning: "to accuse", example: { jp: "On l'accuse d'un vol, mais aucune preuve ne le montre vraiment.", en: "They accuse him of a theft, but no evidence really shows it." }, drill: { jp: "Il ne faut pas accuser sans preuve", en: "You mustn't accuse without proof" }, accept: ["to accuse", "to charge", "to blame"], hint: "accuser quelqu'un de quelque chose = to accuse someone of something." },
        { id: "fr-u121l2-lesuspect", type: "vocab", front: "le suspect", reading: "lesuspect", meaning: "the suspect", example: { jp: "Le suspect nie tout, pourtant plusieurs personnes l'ont reconnu.", en: "The suspect denies everything, yet several people recognised him." }, drill: { jp: "Le suspect nie tout depuis hier", en: "The suspect has denied everything since yesterday" }, accept: ["suspect", "the suspect"], hint: "Also an adjective: un comportement suspect = suspicious behaviour." },
        { id: "fr-u121l2-enqueter", type: "vocab", front: "enquêter", reading: "enqueter", meaning: "to investigate", example: { jp: "La police enquête depuis des semaines, mais elle n'a encore rien trouvé.", en: "The police have been investigating for weeks, but they still haven't found anything." }, drill: { jp: "La police va enquêter tout de suite", en: "The police will investigate right away" }, accept: ["to investigate", "to look into", "to inquire"], hint: "enquêter sur une affaire. The noun l'enquête you already know." },
        { id: "fr-u121l2-senfuir", type: "vocab", front: "s'enfuir", reading: "senfuir", meaning: "to flee", example: { jp: "Le voleur a réussi à s'enfuir avant que la police arrive.", en: "The thief managed to flee before the police arrived." }, drill: { jp: "Il veut s'enfuir cette nuit", en: "He wants to flee tonight" }, accept: ["to flee", "to run away", "to escape"], hint: "Reflexive. Past participle: enfui. Stronger and more sudden than partir." },
        { id: "fr-u121l2-laccusation", type: "vocab", front: "l'accusation", reading: "laccusation", meaning: "the accusation", example: { jp: "Cette accusation est grave, il faut donc être sûr des faits.", en: "This accusation is serious, so you have to be sure of the facts." }, drill: { jp: "L'accusation est vraiment grave", en: "The accusation is really serious" }, accept: ["accusation", "the accusation", "the charge"], hint: "In court, l'accusation is also the prosecution side, facing la défense." },
        { id: "fr-u121l2-inculper", type: "vocab", front: "inculper", reading: "inculper", meaning: "to charge", example: { jp: "La police vient de l'inculper, car les preuves sont nombreuses.", en: "The police have just charged him, because the evidence is plentiful." }, drill: { jp: "La police va l'inculper demain", en: "The police will charge him tomorrow" }, accept: ["to charge", "to indict", "to press charges against"], hint: "To formally accuse of a crime. inculper quelqu'un de. Noun: l'inculpation." },
      ],
    },
    {
      id: "fr-u121l3",
      ...
      items: [
        ...
        { id: "fr-u121l3-lejuge", type: "vocab", front: "le juge", reading: "lejuge", meaning: "the judge", example: { jp: "Le juge a écouté tout le monde avant de prendre sa décision.", en: "The judge listened to everyone before making his decision." }, drill: { jp: "Le juge écoute tout le monde", en: "The judge listens to everyone" }, accept: ["judge", "the judge"], hint: "The person. The verb juger you learned in the argument unit." },
        { id: "fr-u121l3-lavocat", type: "vocab", front: "l'avocat", reading: "lavocat", meaning: "the lawyer", example: { jp: "Son avocat a bien parlé, si bien que le jury a longtemps hésité.", en: "His lawyer spoke well, so much so that the jury hesitated for a long time." }, drill: { jp: "L'avocat a bien parlé hier", en: "The lawyer spoke well yesterday" }, accept: ["lawyer", "the lawyer", "attorney", "the barrister"], hint: "Same word as avocat, the avocado — context tells them apart." },
        ...
        { id: "fr-u121l3-ladefense", type: "vocab", front: "la défense", reading: "ladefense", meaning: "the defence", example: { jp: "La défense a présenté de nouveaux faits, ce qui a tout changé.", en: "The defence presented new facts, which changed everything." }, drill: { jp: "La défense a tout changé", en: "The defence changed everything" }, accept: ["defence", "the defence", "the defense"], hint: "The lawyer's side facing l'accusation; also self-defence, légitime défense." },
      ],
    },
    {
      id: "fr-u121l4",
      ...
      items: [
        ...
        { id: "fr-u121l4-ecrouer", type: "vocab", front: "écrouer", reading: "ecrouer", meaning: "to imprison", example: { jp: "Le juge a décidé de l'écrouer, ce qui a surpris tout le monde.", en: "The judge decided to imprison him, which surprised everyone." }, drill: { jp: "On va l'écrouer ce soir", en: "They're going to imprison him tonight" }, accept: ["to imprison", "to jail", "to lock up", "to remand"], hint: "The formal legal word for putting someone in prison. From l'écrou, the bolt." },
        { id: "fr-u121l4-acquitter", type: "vocab", front: "acquitter", reading: "acquitter", meaning: "to acquit", example: { jp: "Comme il n'y avait aucune preuve, le juge a dû l'acquitter.", en: "As there was no evidence at all, the judge had to acquit him." }, drill: { jp: "Le juge va l'acquitter demain", en: "The judge will acquit him tomorrow" }, accept: ["to acquit", "to clear", "to find not guilty"], hint: "The opposite of condamner — to declare not guilty." },
