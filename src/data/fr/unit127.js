  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u127l2-leruisseau", type: "vocab", front: "le ruisseau", reading: "leruisseau", meaning: "the stream", example: { jp: "Un petit ruisseau traverse le pré derrière la maison.", en: "A little stream crosses the meadow behind the house." }, accept: ["stream", "the stream", "the brook"], hint: "A small natural watercourse. From ruisseler, to trickle." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u127l4-lacote", type: "vocab", front: "la côte", reading: "lacote", meaning: "the coast", example: { jp: "La côte est rocheuse ici, il y a peu de plages.", en: "The coast is rocky here; there are few beaches." }, accept: ["coast", "the coast", "the coastline"], hint: "The land along the sea. Also une côte = a rib, and a slope up a road." },
