  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u30l1-aussique", type: "vocab", front: "aussi … que", reading: "aussique", meaning: "as ... as", example: { jp: "Ma sœur est aussi grande que moi.", en: "My sister is as tall as me." }, accept: ["just as", "as much as"] },
        ...
        { id: "fr-u30l1-meilleur", type: "vocab", front: "meilleur", reading: "meilleur", meaning: "better (adjective)", example: { jp: "Ce café est meilleur que le thé.", en: "This coffee is better than the tea." }, accept: ["better"], hint: "The one adjective that refuses the frame: never \"plus bon\", always meilleur. Describes a THING." },
        { id: "fr-u30l1-mieux", type: "vocab", front: "mieux", reading: "mieux", meaning: "better (adverb)", example: { jp: "Aujourd'hui, je vais mieux !", en: "Today, I'm feeling better!" }, accept: ["better"], hint: "The trap English sets: meilleur describes a NOUN (un meilleur café), mieux describes an ACTION (tu parles mieux). English says \"better\" for both." },
      ],
    },
    {
      id: "fr-u30l2",
      ...
      items: [
        ...
        { id: "fr-u30l2-plusieurs", type: "vocab", front: "plusieurs", reading: "plusieurs", meaning: "several", example: { jp: "J'ai plusieurs amis à Paris.", en: "I have several friends in Paris." }, accept: [], hint: "No de after this one — it sits straight on the noun: plusieurs amis." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u30l3-avant", type: "vocab", front: "avant", reading: "avant", meaning: "before", example: { jp: "Je mange avant le travail.", en: "I eat before work." }, accept: ["prior to", "beforehand"], hint: "Learn it with its mirror image après: avant le dîner, après le dîner." },
        { id: "fr-u30l3-apres", type: "vocab", front: "après", reading: "apres", meaning: "after", example: { jp: "Après le dîner, on va au parc.", en: "After dinner, we go to the park." }, accept: ["afterwards", "then"], hint: "Used constantly in directions and plans — et après ? = \"and then?\"." },
        { id: "fr-u30l3-pendant", type: "vocab", front: "pendant", reading: "pendant", meaning: "during", example: { jp: "Pendant l'été, il fait très chaud.", en: "During the summer, it's very hot." }, accept: ["for", "throughout"], hint: "Also \"for\" with a length of time: pendant deux heures = for two hours." },
        { id: "fr-u30l3-bientot", type: "vocab", front: "bientôt", reading: "bientot", meaning: "soon", example: { jp: "Le dîner est bientôt prêt.", en: "Dinner will be ready soon." }, accept: ["shortly", "before long"], hint: "You've been saying it since your first goodbyes — à bientôt is literally \"until soon\"." },
        ...
        { id: "fr-u30l3-toutdesuite", type: "vocab", front: "tout de suite", reading: "toutdesuite", meaning: "right away", example: { jp: "J'arrive tout de suite !", en: "I'm coming right away!" }, accept: ["immediately", "at once", "straight away"], hint: "Said fast it collapses to \"toot-SWEET\" — which is exactly how English borrowed it as army slang." },
