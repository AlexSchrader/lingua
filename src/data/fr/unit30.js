  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u30l3-laplace", type: "vocab", front: "la place", reading: "laplace", meaning: "seat", example: { jp: "J'ai une place dans le train.", en: "I have a seat on the train." }, accept: ["a seat", "the seat", "space"], hint: "Also the square in the middle of a town — la place is a spot, whether you sit in it or stand in it." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u30l4-leplan", type: "vocab", front: "le plan", reading: "leplan", meaning: "map (of a town)", example: { jp: "Où est le plan de la ville ?", en: "Where is the map of the town?" }, accept: ["street map", "the map", "plan"], hint: "la carte is a card or a menu; the map you unfold in the street is le plan." },
