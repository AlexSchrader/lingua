  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u64l2-effraye", type: "vocab", front: "effrayé", reading: "effraye", meaning: "frightened", example: { jp: "Elle était effrayée par ce grand chien noir.", en: "She was frightened by that big black dog." }, accept: ["frightened", "scared", "terrified"], hint: "Frightened, scared — from effrayer. effrayant = frightening." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u64l3-agace", type: "vocab", front: "agacé", reading: "agace", meaning: "annoyed", example: { jp: "Elle est agacée par toutes ces questions.", en: "She's annoyed by all these questions." }, accept: ["annoyed", "irritated", "bothered"], hint: "Mildly irritated — from agacer. Ça m'agace ! = that bugs me!" },
