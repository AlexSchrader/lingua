  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u45l2-jepourrai", type: "vocab", front: "je pourrai", reading: "jepourrai", meaning: "I will be able to", example: { jp: "Je pourrai partir à cinq heures.", en: "I'll be able to leave at five." }, accept: ["i'll be able to", "i will be able", "i can"], hint: "One letter from je pourrais (Unit 44): pourrai = will be able, pourrais = would be able. They sound the same — context decides." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u45l3-jeprendrai", type: "vocab", front: "je prendrai", reading: "jeprendrai", meaning: "I will take", example: { jp: "Je prendrai le train.", en: "I'll take the train." }, accept: ["i'll take", "i'll have"], hint: "An -re verb drops only its final e: prendre → prendr + ai. All of them do this." },
      ],
    },
    {
      id: "fr-u45l4",
