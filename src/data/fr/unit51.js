  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u51l1-sous", type: "vocab", front: "sous", reading: "sous", meaning: "under", example: { jp: "Le chat est sous la table.", en: "The cat is under the table." }, accept: ["underneath", "below", "beneath"], hint: "The opposite of sur. One letter apart in French, so listen for the vowel: sur / sous." },
        ...
        { id: "fr-u51l1-contre", type: "vocab", front: "contre", reading: "contre", meaning: "against", example: { jp: "Le vélo est contre le mur.", en: "The bike is against the wall." }, accept: ["up against", "next to"] },
        ...
        { id: "fr-u51l1-enfacede", type: "vocab", front: "en face de", reading: "enfacede", meaning: "opposite", example: { jp: "Ma chambre est en face de la mer.", en: "My bedroom is opposite the sea." }, accept: ["across from", "facing", "in front of"] },
      ],
    },
    {
      id: "fr-u51l2",
      ...
      items: [
        ...
        { id: "fr-u51l2-enhaut", type: "vocab", front: "en haut", reading: "enhaut", meaning: "upstairs", example: { jp: "Ma chambre est en haut.", en: "My bedroom is upstairs." }, accept: ["up", "at the top", "above"] },
        { id: "fr-u51l2-enbas", type: "vocab", front: "en bas", reading: "enbas", meaning: "downstairs", example: { jp: "La cuisine est en bas.", en: "The kitchen is downstairs." }, accept: ["down", "at the bottom", "below"] },
        { id: "fr-u51l2-audessus", type: "vocab", front: "au-dessus", reading: "audessus", meaning: "above", example: { jp: "L'appartement au-dessus est vide.", en: "The flat above is empty." }, accept: ["over", "on top", "upstairs from here"] },
        { id: "fr-u51l2-endessous", type: "vocab", front: "en dessous", reading: "endessous", meaning: "below", example: { jp: "L'étage en dessous est fermé.", en: "The floor below is closed." }, accept: ["underneath", "under", "beneath"] },
      ],
    },
    {
      id: "fr-u51l3",
      ...
      items: [
        ...
        { id: "fr-u51l3-autour", type: "vocab", front: "autour", reading: "autour", meaning: "around", example: { jp: "Il y a des arbres autour.", en: "There are trees around." }, accept: ["round about", "all around"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u51l4-lemilieu", type: "vocab", front: "le milieu", reading: "lemilieu", meaning: "middle", example: { jp: "La lampe est au milieu de la table.", en: "The lamp is in the middle of the table." }, accept: ["the middle", "centre", "center"], hint: "au milieu de = in the middle of. That au is just à + le squeezed together." },
        ...
        { id: "fr-u51l4-laplace", type: "vocab", front: "la place", reading: "laplace", meaning: "room", example: { jp: "Il n'y a pas de place.", en: "There's no room." }, accept: ["space", "seat", "square", "the place"], hint: "Three jobs: room (il n'y a pas de place), a seat, and a town square." },
        { id: "fr-u51l4-lecentre", type: "vocab", front: "le centre", reading: "lecentre", meaning: "centre", example: { jp: "Le centre de la ville est loin.", en: "The centre of the town is far." }, accept: ["center", "the centre", "the center", "middle"] },
      ],
    },
  ],
};
