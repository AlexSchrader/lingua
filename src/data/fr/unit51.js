  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u51l4-lefond", type: "vocab", front: "le fond", reading: "lefond", meaning: "the far end", example: { jp: "La table est au fond.", en: "The table is at the far end." }, accept: ["the bottom", "the back", "rear"], hint: "au fond = at the far end of a room, or at the bottom of a bag. Nothing to do with le dos, the back you carry. The d is silent." },
