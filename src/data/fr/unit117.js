  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u117l2-promulguer", type: "vocab", front: "promulguer", reading: "promulguer", meaning: "to promulgate, to enact (a law)", example: { jp: "Le président va promulguer la nouvelle loi, même si une partie du peuple la refuse encore.", en: "The president is going to enact the new law, even though part of the population still rejects it." }, accept: ["to promulgate", "to enact", "to enact into law", "to pass into law"], hint: "The formal act by which a head of state makes a voted law official. Specific to laws/decrees." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u117l3-dispositif", type: "vocab", front: "le dispositif", reading: "ledispositif", meaning: "the scheme, system, set of official measures", example: { jp: "Le nouveau dispositif de sécurité sera installé en janvier, afin de protéger les usagers.", en: "The new security scheme will be put in place in January, in order to protect users." }, accept: ["the scheme", "the system", "the measures", "the arrangement", "the mechanism"], hint: "Admin/press word for an organized set of official measures — NOT a physical 'device' here." },
      ],
    },
    {
      id: "fr-u117l4",
