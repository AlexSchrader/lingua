  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u117l4-undecret", type: "vocab", front: "un décret", reading: "undecret", meaning: "a decree", example: { jp: "Le gouvernement a pris un nouveau décret, mais beaucoup de citoyens le trouvent difficile à appliquer.", en: "The government issued a new decree, but many citizens find it hard to apply." }, drill: { jp: "Le gouvernement a pris un décret", en: "The government issued a decree" }, accept: ["a decree", "decree", "an executive order", "an order"], hint: "A binding act issued by the executive, ranking below a loi. On dit prendre or publier un décret. (un porte-parole is taught in Unit 111.)" },
