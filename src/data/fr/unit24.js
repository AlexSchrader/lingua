  ...
  lessons: [
    {
      ...
      cefr: "A1",
      dominantMode: "recall",
      canDo: "Say what people do: le travail, le professeur, l'étudiant, le serveur, l'infirmier, le boulanger.",
      items: [
        ...
        { id: "fr-u24l1-lemedecin2", type: "vocab", front: "le dentiste", reading: "ledentiste", meaning: "dentist", example: { jp: "J'ai mal à la dent : je vais chez le dentiste.", en: "I have toothache: I'm going to the dentist." }, accept: ["the dentist"] },
