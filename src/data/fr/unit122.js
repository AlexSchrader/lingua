  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u122l1-labonte", type: "vocab", front: "la bonté", reading: "labonte", meaning: "kindness", example: { jp: "Sa bonté touche tout le monde, surtout les plus faibles.", en: "His kindness touches everyone, especially the weakest." }, accept: ["kindness", "the kindness", "goodness"], hint: "From bon. A deep, gentle goodness — warmer than la gentillesse." },
      ],
    },
    {
      id: "fr-u122l2",
