  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u59l2-mener", type: "vocab", front: "mener", reading: "mener", meaning: "to lead to", example: { jp: "Cette rue mène directement à la gare.", en: "This street leads straight to the station." }, accept: ["to lead", "to lead to", "to take"], hint: "To lead — a road, or an action: mener à un résultat. Also to lead a life: mener une vie calme." },
      ],
    },
    {
      id: "fr-u59l3",
