...
export const FR_UNIT65 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "fr-u65l2-laverite", type: "vocab", front: "la vérité", reading: "laverite", meaning: "the truth", example: { jp: "Il vaut mieux dire la vérité, même si c'est difficile.", en: "It's better to tell the truth, even if it's hard." }, accept: ["truth", "the truth"], hint: "The truth. dire la vérité = to tell the truth. The opposite is le mensonge." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u65l4-lacontradiction", type: "vocab", front: "la contradiction", reading: "lacontradiction", meaning: "the contradiction", example: { jp: "Il y a une contradiction entre ce qu'il dit et ce qu'il fait.", en: "There's a contradiction between what he says and what he does." }, accept: ["contradiction"], hint: "A contradiction — from contredire, to contradict. esprit de contradiction = contrariness." },
