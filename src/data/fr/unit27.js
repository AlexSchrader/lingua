  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u27l1-eaigu", type: "vocab", front: "é", reading: "e", meaning: "ay", example: { jp: "le café", en: "the coffee — \"ka-FAY\"" }, accept: ["ay sound", "e acute", "acute e"], hint: "The accent is not decoration — it tells you the sound. é is a closed \"ay\", as in café. Without it, a final e is usually silent." },
        { id: "fr-u27l1-egrave", type: "vocab", front: "è", reading: "e", meaning: "eh", example: { jp: "très bien", en: "very good — \"treh bee-AN\"" }, accept: ["eh sound", "e grave", "grave e"], hint: "è is open, like the e in \"bed\". Compare café (ay) with très (eh) — one accent apart." },
        { id: "fr-u27l1-ecirconflexe", type: "vocab", front: "ê", reading: "e", meaning: "eh", example: { jp: "la fenêtre", en: "the window — \"fuh-NET-ruh\"" }, accept: ["eh sound", "e circumflex", "circumflex e"], hint: "The little hat usually marks a letter that fell out of the word centuries ago — often an s. hôtel was hostel, forêt was forest." },
        { id: "fr-u27l1-cedille", type: "vocab", front: "ç", reading: "c", meaning: "s", example: { jp: "ça va", en: "how's it going — \"sa va\"" }, accept: ["s sound", "c cedilla", "cedilla"], hint: "c is hard before a/o/u (café = kaf). The cedilla forces it soft: ça = \"sa\", not \"ka\"." },
        { id: "fr-u27l1-ocirconflexe", type: "vocab", front: "ô", reading: "o", meaning: "oh", example: { jp: "l'hôtel", en: "the hotel — \"oh-TEL\"" }, accept: ["oh sound", "o circumflex", "circumflex o"] },
        { id: "fr-u27l1-ucirconflexe", type: "vocab", front: "û", reading: "u", meaning: "oo", example: { jp: "bien sûr", en: "of course — \"bee-an SOOR\"" }, accept: ["oo sound", "u circumflex", "circumflex u"], hint: "French u has no English twin: round your lips for \"oo\" and say \"ee\" instead." },
        { id: "fr-u27l1-oe", type: "vocab", front: "œ", reading: "oe", meaning: "ur", example: { jp: "la sœur", en: "the sister — \"surr\"" }, accept: ["ur sound", "oe", "o e ligature", "ligature"], hint: "One letter, not two. You can always type it as oe — sœur / soeur are both accepted here." },
      ],
    },
    {
      id: "fr-u27l2",
      ...
      items: [
        { id: "fr-u27l2-eau", type: "vocab", front: "eau", reading: "eau", meaning: "oh", example: { jp: "l'eau", en: "the water — one syllable, \"oh\"" }, accept: ["oh sound", "o sound"], hint: "Three letters, one sound, and not one of them is o-ish in English. l'eau is simply \"loh\"." },
        { id: "fr-u27l2-au", type: "vocab", front: "au", reading: "au", meaning: "oh", example: { jp: "au revoir", en: "goodbye — \"oh ruh-VWAR\"" }, accept: ["oh sound"] },
        { id: "fr-u27l2-ai", type: "vocab", front: "ai", reading: "ai", meaning: "eh", example: { jp: "j'ai faim", en: "I'm hungry — \"zhay fam\"" }, accept: ["eh sound", "e sound"] },
        { id: "fr-u27l2-oi", type: "vocab", front: "oi", reading: "oi", meaning: "wah", example: { jp: "trois", en: "three — \"trwah\"" }, accept: ["wah sound", "wa"], hint: "Always \"wah\", never \"oy\". moi = \"mwah\", trois = \"trwah\", voilà = \"vwah-la\"." },
        { id: "fr-u27l2-ui", type: "vocab", front: "ui", reading: "ui", meaning: "wee", example: { jp: "oui", en: "yes — \"wee\"" }, accept: ["wee sound"] },
        { id: "fr-u27l2-gn", type: "vocab", front: "gn", reading: "gn", meaning: "ny", example: { jp: "la montagne", en: "the mountain — \"mon-TAN-yuh\"" }, accept: ["ny sound"], hint: "The same sound as Spanish ñ or the ni in \"onion\"." },
        { id: "fr-u27l2-ill", type: "vocab", front: "ill", reading: "ill", meaning: "ee-y", example: { jp: "la fille", en: "the girl — \"fee-y\"" }, accept: ["y sound", "ee y", "eey"], hint: "Not \"ill\" as in English. la fille is \"fee-y\", la famille is \"fa-MEE-y\"." },
      ],
    },
    {
      id: "fr-u27l3",
