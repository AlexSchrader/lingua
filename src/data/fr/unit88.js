  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u88l1-assembler", type: "vocab", front: "assembler", reading: "assembler", meaning: "to put together", example: { jp: "Il faut assembler les pièces.", en: "You have to put the parts together." }, accept: ["assemble", "fit together"] },
        ...
        { id: "fr-u88l1-clouer", type: "vocab", front: "clouer", reading: "clouer", meaning: "to hammer in", example: { jp: "Il va clouer le bois.", en: "He's going to nail the wood." }, accept: ["nail", "nail down"] },
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Handle liquids and loose stuff: mix, pour, fill, empty, soak and wipe.",
      items: [
        ...
        { id: "fr-u88l2-tremper", type: "vocab", front: "tremper", reading: "tremper", meaning: "to soak", example: { jp: "Je trempe le pain dans le lait.", en: "I dip the bread in the milk." }, accept: ["dip", "dunk", "steep"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u88l3-arracher", type: "vocab", front: "arracher", reading: "arracher", meaning: "to tear off", example: { jp: "Le vent a arraché une branche.", en: "The wind tore off a branch." }, accept: ["rip out", "pull off", "yank out"] },
        ...
        { id: "fr-u88l3-detacher", type: "vocab", front: "détacher", reading: "detacher", meaning: "to undo", example: { jp: "Je vais détacher le fil.", en: "I'm going to undo the thread." }, accept: ["detach", "untie", "unfasten"], hint: "dé- reverses the verb, exactly as it does in English un-: attacher / détacher." },
      ],
    },
    {
      id: "fr-u88l4",
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Name the small hardware: glue, a nail, a screw, thread, tape — and DIY itself.",
      items: [
        ...
        { id: "fr-u88l4-leruban", type: "vocab", front: "le ruban", reading: "leruban", meaning: "ribbon", example: { jp: "Le cadeau a un ruban rouge.", en: "The present has a red ribbon." }, accept: ["the ribbon", "tape", "band"] },
