  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u88l1-visser", type: "vocab", front: "visser", reading: "visser", meaning: "to screw in", example: { jp: "Je vais visser l'étagère au mur.", en: "I'm going to screw the shelf to the wall." }, accept: ["screw", "screw in", "screw on", "tighten"] },
        { id: "fr-u88l1-clouer", type: "vocab", front: "clouer", reading: "clouer", meaning: "to hammer in", example: { jp: "Il va clouer le bois au mur.", en: "He's going to nail the wood to the wall." }, accept: ["nail", "nail down", "hammer on"] },
