  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u88l1-clouer", type: "vocab", front: "clouer", reading: "clouer", meaning: "to hammer in", example: { jp: "Il va clouer le bois au mur.", en: "He's going to nail the wood to the wall." }, accept: ["nail down", "hammer on"] },
