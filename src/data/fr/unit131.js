  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u131l1-lacier", type: "vocab", front: "l'acier", reading: "lacier", meaning: "the steel", example: { jp: "La tour est faite d'acier et de verre.", en: "The tower is made of steel and glass." }, accept: ["steel", "the steel"], hint: "Iron made hard and strong. une volonté d'acier = a will of steel." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u131l2-lemarbre", type: "vocab", front: "le marbre", reading: "lemarbre", meaning: "the marble", example: { jp: "Le sol de l'entrée est en marbre blanc.", en: "The floor of the entrance is white marble." }, accept: ["marble", "the marble"], hint: "The smooth, veined stone. rester de marbre = to stay stony-faced." },
        ...
        { id: "fr-u131l2-lecuivre", type: "vocab", front: "le cuivre", reading: "lecuivre", meaning: "the copper", example: { jp: "Les vieilles casseroles en cuivre brillent encore.", en: "The old copper pans still shine." }, accept: ["copper", "the copper"], hint: "The reddish metal, and it conducts electricity. les cuivres = brass instruments." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u131l3-lelin", type: "vocab", front: "le lin", reading: "lelin", meaning: "the linen", example: { jp: "Une chemise en lin est idéale quand il fait chaud.", en: "A linen shirt is ideal when it's hot." }, accept: ["linen", "the linen", "the flax"], hint: "The light summer fabric, from the flax plant." },
        { id: "fr-u131l3-lapaille", type: "vocab", front: "la paille", reading: "lapaille", meaning: "the straw", example: { jp: "Le toit de la vieille ferme est encore en paille.", en: "The roof of the old farm is still made of straw." }, accept: ["straw", "the straw"], hint: "Dried stalks of grain; also a drinking straw. un chapeau de paille." },
        ...
        { id: "fr-u131l3-laficelle", type: "vocab", front: "la ficelle", reading: "laficelle", meaning: "the string", example: { jp: "Il a fermé le paquet avec un peu de ficelle.", en: "He closed the parcel with a bit of string." }, accept: ["string", "the string", "the twine"], hint: "Thin string. Also les ficelles du métier = the tricks of the trade." },
      ],
    },
    {
      id: "fr-u131l4",
      ...
      items: [
        ...
        { id: "fr-u131l4-laplanche", type: "vocab", front: "la planche", reading: "laplanche", meaning: "the plank", example: { jp: "Il a posé une planche entre les deux chaises.", en: "He laid a plank between the two chairs." }, accept: ["plank", "the plank", "the board"], hint: "A flat board of wood. une planche à voile = a windsurf board." },
