  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u131l1-labrique", type: "vocab", front: "la brique", reading: "labrique", meaning: "the brick", example: { jp: "Cette vieille maison en brique rouge date du siècle dernier.", en: "This old red-brick house dates from the last century." }, drill: { jp: "La brique rouge est très ancienne", en: "The red brick is very old" }, accept: ["brick", "the brick"], hint: "The baked clay block. un mur de brique." },
        { id: "fr-u131l1-lebeton", type: "vocab", front: "le béton", reading: "lebeton", meaning: "the concrete", example: { jp: "Le pont est en béton, donc il supporte de lourdes charges.", en: "The bridge is made of concrete, so it bears heavy loads." }, drill: { jp: "Le béton est encore froid", en: "The concrete is still cold" }, accept: ["concrete", "the concrete"], hint: "The grey building material. Slang: en béton = rock-solid (un alibi en béton)." },
        { id: "fr-u131l1-leplatre", type: "vocab", front: "le plâtre", reading: "leplatre", meaning: "the plaster", example: { jp: "On a mis son bras dans le plâtre après sa chute.", en: "They put his arm in plaster after his fall." }, drill: { jp: "Son bras est dans le plâtre", en: "His arm is in plaster" }, accept: ["plaster", "the plaster", "the cast"], hint: "The white wall coating, and the cast for a broken bone." },
        { id: "fr-u131l1-lapoutre", type: "vocab", front: "la poutre", reading: "lapoutre", meaning: "the beam", example: { jp: "Les poutres du plafond sont d'origine, en bois massif.", en: "The ceiling beams are original, in solid wood." }, drill: { jp: "La poutre est en bois massif", en: "The beam is solid wood" }, accept: ["beam", "the beam", "the girder"], hint: "A long horizontal support of wood or steel. Also a beam in gymnastics." },
        ...
        { id: "fr-u131l1-legoudron", type: "vocab", front: "le goudron", reading: "legoudron", meaning: "the tar", example: { jp: "Le goudron fond un peu sous le soleil d'été.", en: "The tar melts a little under the summer sun." }, drill: { jp: "Le goudron fond sous le soleil", en: "The tar melts in the sun" }, accept: ["tar", "the tar", "the asphalt"], hint: "The black sticky material of roads. Also the tar in cigarettes." },
      ],
    },
    {
      id: "fr-u131l2",
      ...
      items: [
        ...
        { id: "fr-u131l2-lavitre", type: "vocab", front: "la vitre", reading: "lavitre", meaning: "the windowpane", example: { jp: "La vitre est si propre qu'on ne la voit presque pas.", en: "The windowpane is so clean you can barely see it." }, drill: { jp: "La vitre est vraiment propre", en: "The windowpane is really clean" }, accept: ["windowpane", "the windowpane", "the pane", "the window"], hint: "The sheet of glass in a window. From le verre (the material)." },
        { id: "fr-u131l2-lecable", type: "vocab", front: "le câble", reading: "lecable", meaning: "the cable", example: { jp: "Un gros câble relie l'île au continent.", en: "A thick cable links the island to the mainland." }, drill: { jp: "Le câble relie les deux maisons", en: "The cable links the two houses" }, accept: ["cable", "the cable", "the wire"], hint: "A thick rope of metal wires, or an electrical cable." },
        { id: "fr-u131l2-legrillage", type: "vocab", front: "le grillage", reading: "legrillage", meaning: "the wire fence", example: { jp: "Un grillage entoure le jardin pour protéger les légumes.", en: "A wire fence surrounds the garden to protect the vegetables." }, drill: { jp: "Le grillage entoure le jardin", en: "The wire fence surrounds the garden" }, accept: ["wire fence", "the wire fence", "the wire netting", "the mesh"], hint: "The metal mesh fence. From la grille, the grid." },
      ],
    },
    {
      id: "fr-u131l3",
      ...
      items: [
        { id: "fr-u131l3-levelours", type: "vocab", front: "le velours", reading: "levelours", meaning: "the velvet", example: { jp: "Les fauteuils du théâtre sont en velours rouge.", en: "The theatre's armchairs are red velvet." }, drill: { jp: "Le velours rouge est très doux", en: "The red velvet is very soft" }, accept: ["velvet", "the velvet"], hint: "The soft, thick fabric. une voix de velours = a smooth voice." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u131l4-lacorde", type: "vocab", front: "la corde", reading: "lacorde", meaning: "the rope", example: { jp: "Ils ont tiré le bateau avec une longue corde.", en: "They pulled the boat with a long rope." }, drill: { jp: "La corde est trop courte", en: "The rope is too short" }, accept: ["rope", "the rope", "the cord", "the string"], hint: "Thick rope. Also the string of an instrument: les cordes d'une guitare." },
        { id: "fr-u131l4-letuyau", type: "vocab", front: "le tuyau", reading: "letuyau", meaning: "the pipe", example: { jp: "Un tuyau a éclaté, et l'eau a coulé partout.", en: "A pipe burst, and water flowed everywhere." }, drill: { jp: "Le tuyau a éclaté ce matin", en: "The pipe burst this morning" }, accept: ["pipe", "the pipe", "the hose", "the tube"], hint: "A pipe or hose. Familiarly, un tuyau = a tip, insider info." },
        ...
        { id: "fr-u131l4-lecaoutchouc", type: "vocab", front: "le caoutchouc", reading: "lecaoutchouc", meaning: "the rubber", example: { jp: "Les bottes en caoutchouc gardent les pieds au sec.", en: "The rubber boots keep your feet dry." }, drill: { jp: "Le caoutchouc garde les pieds au sec", en: "Rubber keeps your feet dry" }, accept: ["rubber", "the rubber"], hint: "The stretchy material of tyres and boots. Tricky spelling — silent letters throughout." },
        { id: "fr-u131l4-largile", type: "vocab", front: "l'argile", reading: "largile", meaning: "the clay", example: { jp: "L'enfant a fait un petit bol en argile à l'école.", en: "The child made a little clay bowl at school." }, drill: { jp: "L'enfant travaille l'argile à l'école", en: "The child works with clay at school" }, accept: ["clay", "the clay"], hint: "The soft earth potters use. Feminine: de l'argile." },
        { id: "fr-u131l4-lacire", type: "vocab", front: "la cire", reading: "lacire", meaning: "the wax", example: { jp: "La cire de la bougie a coulé sur la table.", en: "The wax of the candle dripped onto the table." }, drill: { jp: "La cire a coulé sur la table", en: "The wax ran onto the table" }, accept: ["wax", "the wax"], hint: "Candle or floor wax; also beeswax, la cire d'abeille." },
      ],
    },
  ],
};
