  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u69l1-lesouhait", type: "vocab", front: "le souhait", reading: "lesouhait", meaning: "the wish", example: { jp: "Son souhait, c'est de trouver un bon travail.", en: "His wish is to find a good job." }, accept: ["wish", "the desire"], hint: "A wish — faire un souhait = to make a wish. tous mes souhaits = best wishes." },
