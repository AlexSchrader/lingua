  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u69l1-tenira", type: "vocab", front: "tenir à", reading: "tenira", meaning: "to be keen to", example: { jp: "Elle tient à finir son travail toute seule.", en: "She insists on finishing her work all by herself." }, accept: ["to be keen to", "to insist on", "to be attached to"], hint: "tenir à faire = to be keen to / insist on. Also to be attached to: je tiens à toi." },
        { id: "fr-u69l1-lesouhait", type: "vocab", front: "le souhait", reading: "lesouhait", meaning: "the wish", example: { jp: "Son souhait, c'est de trouver un bon travail.", en: "His wish is to find a good job." }, accept: ["wish", "the desire"], hint: "A wish — faire un souhait = to make a wish. In France, best wishes = meilleurs vœux."},
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u69l3-lambition", type: "vocab", front: "l'ambition", reading: "lambition", meaning: "the ambition", example: { jp: "Il a une grande ambition : devenir médecin.", en: "He has a big ambition: to become a doctor." }, accept: ["ambition"], hint: "Ambition, a driving goal — avoir de l'ambition. réaliser son ambition." },
