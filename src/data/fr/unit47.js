  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u47l1-jelevois", type: "vocab", front: "je le vois", reading: "jelevois", meaning: "I see him", example: { jp: "Mon frère ? Je le vois demain.", en: "My brother? I'm seeing him tomorrow." }, accept: ["i see it", "i'm seeing him", "i see him"], hint: "The pronoun goes BEFORE the verb — je le vois, never \"je vois le\". le = him/it, la = her/it, les = them." },
