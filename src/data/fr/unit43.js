  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u43l1-celui", type: "vocab", front: "celui", reading: "celui", meaning: "the one (masculine)", example: { jp: "Quel livre ? Celui de Marie.", en: "Which book? Marie's one." }, accept: ["that one", "this one", "the one"], hint: "celui stands in for a masculine noun you've already named — celui de Marie, celui de mon frère." },
        { id: "fr-u43l1-celle", type: "vocab", front: "celle", reading: "celle", meaning: "the one (feminine)", example: { jp: "Quelle voiture ? Celle de mon père.", en: "Which car? My father's one." }, accept: ["that one", "this one", "the one"] },
        { id: "fr-u43l1-ceux", type: "vocab", front: "ceux", reading: "ceux", meaning: "the ones", example: { jp: "Ceux de mon frère sont ici.", en: "My brother's ones are here." }, accept: ["those", "those ones", "the ones"], hint: "The plural of celui. For feminine things: celles." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u43l3-gracea", type: "vocab", front: "grâce à", reading: "gracea", meaning: "thanks to", example: { jp: "Grâce à mon professeur, je parle français.", en: "Thanks to my teacher, I speak French." }, accept: ["because of", "owing to", "thanks to"], hint: "grâce à is for a GOOD outcome, à cause de for a bad one. French makes you pick a side." },
