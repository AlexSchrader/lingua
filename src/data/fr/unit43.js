  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u43l2-aumomentou", type: "vocab", front: "au moment où", reading: "aumomentou", meaning: "just as", example: { jp: "Au moment où je pars, le téléphone sonne.", en: "Just as I'm leaving, the phone rings." }, accept: ["at the moment when", "just when", "the moment"], hint: "où is doing time here, not place — the moment WHERE, as French sees it." },
        { id: "fr-u43l2-unefoisque", type: "vocab", front: "une fois que", reading: "unefoisque", meaning: "once", example: { jp: "Une fois que j'ai fini, je rentre.", en: "Once I've finished, I go home." }, accept: ["as soon as", "after", "once that"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u43l3-enraisonde", type: "vocab", front: "en raison de", reading: "enraisonde", meaning: "due to", example: { jp: "Le train est en retard en raison de la neige.", en: "The train is late due to the snow." }, accept: ["owing to", "because of", "on account of"], hint: "The formal one — signs and announcements use it where speech would say à cause de." },
        ...
        { id: "fr-u43l3-pourque", type: "vocab", front: "pour que", reading: "pourque", meaning: "so that", example: { jp: "Je parle lentement pour que tu comprennes.", en: "I speak slowly so that you understand." }, accept: ["in order that", "so", "so as"], hint: "afin de + verb keeps ONE subject; pour que introduces a NEW one — and the verb after it shifts (tu comprennes, not tu comprends)." },
        ...
        { id: "fr-u43l3-sibienque", type: "vocab", front: "si bien que", reading: "sibienque", meaning: "with the result that", example: { jp: "Il a beaucoup travaillé, si bien qu'il est fatigué.", en: "He worked a lot, with the result that he's tired." }, accept: ["so that", "and so", "with the result"], hint: "The written counterpart of du coup — it states a result, never a purpose." },
      ],
    },
    {
      id: "fr-u43l4",
