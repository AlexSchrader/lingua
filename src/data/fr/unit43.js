  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u43l2-depuisque", type: "vocab", front: "depuis que", reading: "depuisque", meaning: "ever since", example: { jp: "Depuis que j'habite ici, je suis content.", en: "Since I've lived here, I've been happy." }, accept: ["since", "from the time that"], hint: "The TIME \"since\", not the reason one — depuis que counts from a moment. For a reason, Lesson 3 has car and puisque." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u43l3-puisque", type: "vocab", front: "puisque", reading: "puisque", meaning: "since (as we know)", example: { jp: "Puisque tu es là, on va manger.", en: "Since you're here, we'll eat." }, accept: ["as", "seeing that", "given that"], hint: "puisque gives a reason you both already know; parce que gives news." },
