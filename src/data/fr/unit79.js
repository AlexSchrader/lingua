  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u79l1-tutoyer", type: "vocab", front: "tutoyer", reading: "tutoyer", meaning: "to use tu with someone", example: { jp: "On peut tutoyer un collègue, mais rarement un client.", en: "You can use tu with a colleague, but rarely with a customer." }, accept: ["to say tu", "to be informal with"], hint: "French has a verb for it, because it's a real decision. English has to explain the whole thing." },
        ...
        { id: "fr-u79l1-onsetutoie", type: "vocab", front: "on se tutoie", reading: "onsetutoie", meaning: "shall we use tu?", example: { jp: "On se tutoie ? Ce sera plus simple pour travailler ensemble.", en: "Shall we use tu? It'll be easier for working together." }, accept: ["let's use tu", "we can say tu"], hint: "The standard way to propose the switch. Traditionally the older or senior person offers it." },
        { id: "fr-u79l1-steplait", type: "vocab", front: "s'il te plaît", reading: "steplait", meaning: "please (to a friend)", example: { jp: "Passe-moi le sel, s'il te plaît.", en: "Pass me the salt, please." }, accept: ["please", "please (informal)"], hint: "The tu form of s'il vous plaît (Unit 1). Same phrase, one pronoun swapped — that's the whole system." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u79l2-jeresteavotredisposition", type: "vocab", front: "je reste à votre disposition", reading: "jerestavotredisposition", meaning: "I remain at your disposal", example: { jp: "Je reste à votre disposition pour tout renseignement complémentaire.", en: "I remain at your disposal for any further information." }, accept: ["please let me know", "i'm available", "at your service"], hint: "A fixed formula. It sounds grand in English; in French it's simply what you write." },
        { id: "fr-u79l2-danslattente", type: "vocab", front: "dans l'attente de votre réponse", reading: "danslattentedevotrereponse", meaning: "looking forward to your reply", example: { jp: "Dans l'attente de votre réponse, je vous prie d'agréer mes salutations.", en: "Looking forward to your reply, please accept my regards." }, accept: ["awaiting your reply", "i look forward to hearing"], hint: "Pairs with the sign-off. French formal letters are built from blocks like this — learn them whole." },
      ],
    },
    {
      id: "fr-u79l3",
      ...
      items: [
        ...
        { id: "fr-u79l3-cacraint", type: "vocab", front: "ça craint", reading: "cacraint", meaning: "that sucks", example: { jp: "Ils ont annulé le concert ? Ça craint.", en: "They cancelled the concert? That sucks." }, accept: ["that's rubbish", "that's bad", "it's dodgy"], hint: "Also \"this place is dodgy\" — ce quartier craint. Never write it in anything official." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u79l4-catedit", type: "vocab", front: "ça te dit", reading: "catedit", meaning: "do you fancy it?", example: { jp: "On va au cinéma ce soir, ça te dit ?", en: "We're going to the cinema tonight, do you fancy it?" }, accept: ["are you up for it", "how about it", "do you feel like it"], hint: "The friend version. Literally \"does it say to you?\"" },
        ...
        { id: "fr-u79l4-coucou", type: "vocab", front: "coucou", reading: "coucou", meaning: "hi there", example: { jp: "Coucou, c'est moi ! Tu es à la maison ?", en: "Hi there, it's me! Are you home?" }, accept: ["hey", "hiya", "hello there"], hint: "Very warm and very informal — family and close friends. Never to a stranger." },
        { id: "fr-u79l4-veuillez", type: "vocab", front: "veuillez", reading: "veuillez", meaning: "please (formal command)", example: { jp: "Veuillez remplir ce dossier avant de partir.", en: "Please fill in this form before leaving." }, accept: ["kindly", "be so good as to"], hint: "The formal imperative of vouloir, used on signs and in official letters — veuillez patienter." },
