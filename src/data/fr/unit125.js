  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u125l1-renforcer", type: "vocab", front: "renforcer", reading: "renforcer", meaning: "to strengthen", example: { jp: "Ces résultats renforcent l'idée qu'il faut agir vite.", en: "These results strengthen the idea that we must act quickly." }, drill: { jp: "Ce résultat va renforcer notre idée", en: "This result will strengthen our idea" }, accept: ["to strengthen", "to reinforce", "to bolster"], hint: "From fort. To make stronger — a wall, a team, or an argument." },
        ...
        { id: "fr-u125l1-accroitre", type: "vocab", front: "accroître", reading: "accroitre", meaning: "to increase", example: { jp: "La publicité a accru l'intérêt du public pour ce produit.", en: "The advertising increased the public's interest in this product." }, drill: { jp: "La publicité peut accroître l'intérêt", en: "Advertising can increase interest" }, accept: ["to increase", "to boost", "to raise", "to grow"], hint: "A formal 'to increase'. From croître, to grow. Past participle: accru." },
        { id: "fr-u125l1-intensifier", type: "vocab", front: "intensifier", reading: "intensifier", meaning: "to intensify", example: { jp: "La police a intensifié ses contrôles après cette affaire.", en: "The police intensified their checks after this case." }, drill: { jp: "La police va intensifier ses contrôles", en: "The police will intensify their checks" }, accept: ["to intensify", "to step up", "to increase"], hint: "From intense. To make more intense or more frequent." },
        { id: "fr-u125l1-decupler", type: "vocab", front: "décupler", reading: "decupler", meaning: "to boost tenfold", example: { jp: "La colère a décuplé ses forces sur le moment.", en: "Anger boosted his strength tenfold in the moment." }, drill: { jp: "La colère peut décupler ses forces", en: "Anger can boost his strength tenfold" }, accept: ["to boost tenfold", "to multiply", "to increase greatly"], hint: "From dix, ten. Literally to multiply by ten — figuratively, hugely." },
        { id: "fr-u125l1-stimuler", type: "vocab", front: "stimuler", reading: "stimuler", meaning: "to stimulate", example: { jp: "Un bon professeur sait stimuler la curiosité de ses élèves.", en: "A good teacher knows how to stimulate his students' curiosity." }, drill: { jp: "Il faut stimuler la curiosité des élèves", en: "You have to stimulate the pupils' curiosity" }, accept: ["to stimulate", "to encourage", "to spur"], hint: "To spur into action or growth. From stimulus." },
      ],
    },
    {
      id: "fr-u125l2",
      ...
      items: [
        ...
        { id: "fr-u125l2-amoindrir", type: "vocab", front: "amoindrir", reading: "amoindrir", meaning: "to diminish", example: { jp: "Rien ne peut amoindrir le mérite de ce qu'elle a accompli.", en: "Nothing can diminish the merit of what she has achieved." }, drill: { jp: "Rien ne peut amoindrir son mérite", en: "Nothing can diminish his merit" }, accept: ["to diminish", "to lessen", "to reduce", "to weaken"], hint: "From moindre, lesser. To make smaller in importance or force." },
        { id: "fr-u125l2-sestomper", type: "vocab", front: "s'estomper", reading: "sestomper", meaning: "to fade", example: { jp: "Avec le temps, ces mauvais souvenirs se sont estompés.", en: "With time, those bad memories faded." }, drill: { jp: "Ces souvenirs vont s'estomper avec le temps", en: "These memories will fade with time" }, accept: ["to fade", "to blur", "to dim", "to die down"], hint: "To grow blurry and faint — a memory, an outline, a sound." },
        { id: "fr-u125l2-fragiliser", type: "vocab", front: "fragiliser", reading: "fragiliser", meaning: "to undermine", example: { jp: "Ce scandale a fragilisé la confiance du public.", en: "This scandal weakened the public's confidence." }, drill: { jp: "Ce scandale va fragiliser la confiance", en: "This scandal will undermine confidence" }, accept: ["to weaken", "to undermine", "to make fragile", "to destabilise"], hint: "From fragile. To make something more likely to break or fail." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u125l3-occasionner", type: "vocab", front: "occasionner", reading: "occasionner", meaning: "to cause", example: { jp: "Les travaux occasionnent beaucoup de bruit dans le quartier.", en: "The building works cause a lot of noise in the neighbourhood." }, drill: { jp: "Les travaux vont occasionner beaucoup de bruit", en: "The works will cause a lot of noise" }, accept: ["to cause", "to bring about", "to give rise to", "to lead to"], hint: "From l'occasion. A formal 'to cause', usually of trouble or expense." },
        { id: "fr-u125l3-precipiter", type: "vocab", front: "précipiter", reading: "precipiter", meaning: "to hasten", example: { jp: "Sa démission a précipité la chute du gouvernement.", en: "His resignation hastened the fall of the government." }, drill: { jp: "Sa démission peut précipiter la chute", en: "His resignation can hasten the fall" }, accept: ["to hasten", "to speed up", "to bring on", "to rush"], hint: "To make something happen sooner and faster. se précipiter = to rush." },
        ...
        { id: "fr-u125l3-aviver", type: "vocab", front: "aviver", reading: "aviver", meaning: "to rekindle", example: { jp: "Ses paroles ont avivé la colère de la foule.", en: "His words rekindled the crowd's anger." }, drill: { jp: "Ses paroles vont aviver la colère", en: "His words will rekindle the anger" }, accept: ["to rekindle", "to stir up", "to sharpen", "to revive"], hint: "From vif, lively. To make a feeling or a fire burn brighter." },
        { id: "fr-u125l3-amplifier", type: "vocab", front: "amplifier", reading: "amplifier", meaning: "to amplify", example: { jp: "Les médias amplifient souvent des incidents sans grande importance.", en: "The media often amplify incidents of no great importance." }, drill: { jp: "Les médias vont amplifier cette affaire", en: "The media will amplify this affair" }, accept: ["to amplify", "to magnify", "to blow up", "to increase"], hint: "From ample. To make larger or louder than it really is." },
      ],
    },
    {
      id: "fr-u125l4",
      ...
      items: [
        { id: "fr-u125l4-modifier", type: "vocab", front: "modifier", reading: "modifier", meaning: "to modify", example: { jp: "Il a fallu modifier le plan à la dernière minute.", en: "The plan had to be modified at the last minute." }, drill: { jp: "Elle va modifier ce plan", en: "She's going to modify this plan" }, accept: ["to modify", "to change", "to alter", "to amend"], hint: "To change in part, not completely. Noun: la modification." },
        { id: "fr-u125l4-bouleverser", type: "vocab", front: "bouleverser", reading: "bouleverser", meaning: "to turn upside down", example: { jp: "Cette nouvelle a bouleversé toute la famille.", en: "This news turned the whole family upside down." }, drill: { jp: "Cette nouvelle va bouleverser la famille", en: "This news will turn the family upside down" }, accept: ["to turn upside down", "to disrupt", "to shatter", "to overwhelm"], hint: "To upset deeply — an order of things, or someone's emotions." },
        { id: "fr-u125l4-secreuser", type: "vocab", front: "se creuser", reading: "secreuser", meaning: "to deepen", example: { jp: "L'écart entre les riches et les pauvres se creuse chaque année.", en: "The gap between rich and poor deepens every year." }, drill: { jp: "L'écart va se creuser encore", en: "The gap is going to deepen further" }, accept: ["to deepen", "to widen", "to grow", "to become more marked"], hint: "From creuser, to dig. A gap or difference growing wider. se creuser la tête = to rack one's brains." },
        { id: "fr-u125l4-decouler", type: "vocab", front: "découler", reading: "decouler", meaning: "to follow from", example: { jp: "Tous ces problèmes découlent d'une seule erreur de départ.", en: "All these problems follow from a single mistake at the start." }, drill: { jp: "Tout peut découler d'une seule erreur", en: "Everything can follow from a single mistake" }, accept: ["to follow from", "to stem from", "to result from", "to arise from"], hint: "From couler, to flow. To flow logically as a consequence. découler de." },
        { id: "fr-u125l4-leser", type: "vocab", front: "léser", reading: "leser", meaning: "to wrong", example: { jp: "Cette décision lèse les petits commerçants du centre-ville.", en: "This decision wrongs the small shopkeepers in the town centre." }, drill: { jp: "Cette décision va léser les petits commerçants", en: "This decision will wrong small shopkeepers" }, accept: ["to wrong", "to harm", "to disadvantage", "to prejudice"], hint: "To damage someone's rights or interests. Formal, often in a legal sense." },
        { id: "fr-u125l4-contrarier", type: "vocab", front: "contrarier", reading: "contrarier", meaning: "to thwart", example: { jp: "Le mauvais temps a contrarié tous nos projets de week-end.", en: "The bad weather thwarted all our weekend plans." }, drill: { jp: "Le mauvais temps peut contrarier nos projets", en: "Bad weather can thwart our plans" }, accept: ["to thwart", "to frustrate", "to upset", "to annoy"], hint: "To go against a plan, or to annoy someone. From contraire." },
      ],
    },
  ],
};
