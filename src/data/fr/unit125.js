...
export const FR_UNIT125 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "fr-u125l3-eveiller", type: "vocab", front: "éveiller", reading: "eveiller", meaning: "to arouse", example: { jp: "Cette annonce a éveillé la curiosité de beaucoup de gens.", en: "This announcement aroused the curiosity of many people." }, accept: ["to arouse", "to awaken", "to stir", "to spark"], hint: "To wake a feeling or interest. From le réveil; also s'éveiller, to awaken." },
