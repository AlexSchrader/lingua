  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u85l4-sentir", type: "vocab", front: "sentir", reading: "sentir", meaning: "to smell of", example: { jp: "Ça sent très bon ici.", en: "It smells very good here." }, accept: ["smell", "feel", "smell of", "sense"], hint: "Does both jobs: sentir une odeur (to smell something) and « ça sent bon » (it smells good)." },
