  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u85l3-resonner", type: "vocab", front: "résonner", reading: "resonner", meaning: "to reverberate", example: { jp: "Sa voix résonne dans l'escalier.", en: "Their voice echoes in the stairwell." }, accept: ["resound", "ring out", "echo around"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u85l4-gouter", type: "vocab", front: "goûter", reading: "gouter", meaning: "to sample", example: { jp: "Tu veux goûter le gâteau ?", en: "Do you want to taste the cake?" }, accept: ["try", "have a taste", "try a bit of"] },
