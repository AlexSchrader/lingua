  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u71l1-lapresse", type: "vocab", front: "la presse", reading: "lapresse", meaning: "the press", example: { jp: "La presse française est libre, mais elle n'est pas toujours d'accord avec le gouvernement.", en: "The French press is free, but it doesn't always agree with the government." }, drill: { jp: "La presse parle de ce scandale", en: "The press is talking about this scandal" }, accept: ["press", "the media", "newspapers"], hint: "The institution, not the paper — le journal is the object you hold, la presse is the whole trade." },
        { id: "fr-u71l1-laune", type: "vocab", front: "la une", reading: "laune", meaning: "the front page", example: { jp: "Cette histoire est à la une de tous les journaux depuis hier.", en: "That story has been on the front page of every newspaper since yesterday." }, drill: { jp: "Cette photo est à la une", en: "This photo is on the front page" }, accept: ["front page", "the headline", "page one"], hint: "Literally \"the one\" — page one. être à la une = to be the lead story." },
        { id: "fr-u71l1-lereportage", type: "vocab", front: "le reportage", reading: "lereportage", meaning: "the report", example: { jp: "J'ai regardé un reportage sur la vie à la campagne, et c'était vraiment intéressant.", en: "I watched a report on country life, and it was really interesting." }, drill: { jp: "Le reportage était très intéressant", en: "The report was very interesting" }, accept: ["report", "feature", "coverage"], hint: "A journalist's piece from the field — not un rapport, which is a written business report." },
        { id: "fr-u71l1-lenquete", type: "vocab", front: "l'enquête", reading: "lenquete", meaning: "the investigation", example: { jp: "L'enquête a duré deux ans, si bien que tout le monde avait oublié cette histoire.", en: "The investigation lasted two years, so everyone had forgotten that story." }, drill: { jp: "L'enquête va durer six mois", en: "The investigation is going to last six months" }, accept: ["investigation", "inquiry", "survey"], hint: "Both a police investigation and a journalistic one — and also a survey." },
        { id: "fr-u71l1-lasource", type: "vocab", front: "la source", reading: "lasource", meaning: "the source", example: { jp: "Le journaliste n'a pas donné sa source, parce qu'il ne voulait pas donner son nom.", en: "The journalist didn't give his source, because he didn't want to give their name." }, drill: { jp: "La source de cette histoire est claire", en: "The source of this story is clear" }, accept: ["source", "the origin", "spring"], hint: "Also a spring of water — the metaphor is the same in both languages." },
        { id: "fr-u71l1-leredacteur", type: "vocab", front: "le rédacteur", reading: "leredacteur", meaning: "the editor", example: { jp: "Le rédacteur a lu mon article, puis il m'a demandé de le changer.", en: "The editor read my article, then asked me to change it." }, drill: { jp: "Le rédacteur travaille tard le soir", en: "The editor works late at night" }, accept: ["editor", "the sub-editor", "copy editor"], hint: "La rédactrice for a woman. The boss of them all is le rédacteur en chef." },
      ],
    },
    {
      id: "fr-u71l2",
      ...
      items: [
        ...
        { id: "fr-u71l2-ledirect", type: "vocab", front: "le direct", reading: "ledirect", meaning: "live broadcast", example: { jp: "L'émission est en direct, donc tout le monde regarde en même temps.", en: "The programme is live, so everybody is watching at the same time." }, drill: { jp: "Le direct commence à vingt heures", en: "The live broadcast starts at eight" }, accept: ["live", "live TV", "the live show"], hint: "en direct = live. The opposite is en différé, recorded earlier." },
        ...
        { id: "fr-u71l2-labonnement", type: "vocab", front: "l'abonnement", reading: "labonnement", meaning: "the subscription", example: { jp: "J'ai pris un abonnement au journal, parce que je le lisais tous les jours.", en: "I took out a subscription to the newspaper, because I was reading it every day." }, drill: { jp: "L'abonnement coûte dix euros", en: "The subscription costs ten euros" }, accept: ["subscription", "membership", "season ticket"], hint: "Also a season ticket for transport or a gym." },
      ],
    },
    {
      id: "fr-u71l3",
      ...
      items: [
        { id: "fr-u71l3-lescenario", type: "vocab", front: "le scénario", reading: "lescenario", meaning: "the screenplay", example: { jp: "Le scénario est très bon, mais le film n'a pas eu de succès.", en: "The screenplay is very good, but the film wasn't a success." }, drill: { jp: "Le scénario me plaît beaucoup", en: "I like the screenplay a lot" }, accept: ["script", "screenplay", "scenario"], hint: "Also a scenario in the everyday sense: dans le pire des scénarios." },
        ...
        { id: "fr-u71l3-lintrigue", type: "vocab", front: "l'intrigue", reading: "lintrigue", meaning: "the plot", example: { jp: "L'intrigue est compliquée au début, puis tout devient clair à la fin.", en: "The plot is complicated at the start, then everything becomes clear at the end." }, drill: { jp: "L'intrigue devient claire à la fin", en: "The plot becomes clear at the end" }, accept: ["plot", "the storyline", "intrigue"] },
        { id: "fr-u71l3-lecrivain", type: "vocab", front: "l'écrivain", reading: "lecrivain", meaning: "the writer", example: { jp: "Cet écrivain a écrit dix livres, et pourtant peu de personnes connaissent son nom.", en: "This writer has written ten books, and yet few people know his name." }, drill: { jp: "L'écrivain habite près d'ici", en: "The writer lives near here" }, accept: ["writer", "the author", "man of letters"], hint: "Une écrivaine is now standard for a woman, though you'll still hear une femme écrivain." },
        ...
        { id: "fr-u71l3-letournage", type: "vocab", front: "le tournage", reading: "letournage", meaning: "the filming", example: { jp: "Le tournage a duré six mois, tandis que le film dure deux heures.", en: "The filming lasted six months, whereas the film lasts two hours." }, drill: { jp: "Le tournage se passe en France", en: "The filming takes place in France" }, accept: ["filming", "the shoot", "shooting"] },
      ],
    },
    {
      id: "fr-u71l4",
      ...
      items: [
        { id: "fr-u71l4-lacritique", type: "vocab", front: "la critique", reading: "lacritique", meaning: "the review", example: { jp: "J'ai lu la critique avant de voir le film, ce qui n'était pas une bonne idée.", en: "I read the review before seeing the film, which wasn't a good idea." }, drill: { jp: "La critique était plutôt bonne", en: "The review was rather good" }, accept: ["review", "criticism", "the critic"], hint: "La critique is the review; le critique (masculine) is the person who writes it." },
        { id: "fr-u71l4-lesucces", type: "vocab", front: "le succès", reading: "lesucces", meaning: "the success", example: { jp: "Ce livre a eu un grand succès, même si personne ne l'attendait.", en: "This book was a great success, although nobody was expecting it." }, drill: { jp: "Le succès arrive parfois très tard", en: "Success sometimes comes very late" }, accept: ["success", "the hit"], hint: "avoir du succès = to be a hit. The final s is silent." },
        { id: "fr-u71l4-lechec", type: "vocab", front: "l'échec", reading: "lechec", meaning: "the failure", example: { jp: "Le film a été un échec au cinéma, mais il a beaucoup de succès sur internet.", en: "The film was a failure in cinemas, but it's very successful on the internet." }, drill: { jp: "Personne n'aime l'échec", en: "Nobody likes failure" }, accept: ["failure", "the flop", "setback"], hint: "Les échecs, plural, is the game of chess — same word, different life." },
        { id: "fr-u71l4-lapublicite", type: "vocab", front: "la publicité", reading: "lapublicite", meaning: "the advert", example: { jp: "Il y a trop de publicité pendant l'émission, si bien que je change de chaîne.", en: "There are too many adverts during the programme, so I change channel." }, drill: { jp: "La publicité passe avant le film", en: "The advert comes before the film" }, accept: ["advertising", "the ad", "commercial"], hint: "Everyone shortens it to la pub." },
        { id: "fr-u71l4-lesondage", type: "vocab", front: "le sondage", reading: "lesondage", meaning: "the poll", example: { jp: "Selon ce sondage, beaucoup de Français ne regardent plus les informations.", en: "According to this poll, a lot of French people no longer watch the news." }, drill: { jp: "Le sondage donne un résultat clair", en: "The poll gives a clear result" }, accept: ["poll", "survey", "the opinion poll"] },
        { id: "fr-u71l4-ledivertissement", type: "vocab", front: "le divertissement", reading: "ledivertissement", meaning: "entertainment", example: { jp: "Pour lui, le cinéma est un divertissement ; pour moi, c'est un art.", en: "For him, cinema is entertainment; for me, it's an art." }, drill: { jp: "Le divertissement coûte souvent cher", en: "Entertainment often costs a lot" }, accept: ["entertainment", "amusement", "the entertainment"] },
      ],
    },
  ],
};
