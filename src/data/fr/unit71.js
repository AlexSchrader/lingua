  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u71l3-leromancier", type: "vocab", front: "le romancier", reading: "leromancier", meaning: "the novelist", example: { jp: "Le romancier a écrit ce livre en cinq ans, parce qu'il voulait tout comprendre.", en: "The novelist wrote this book in five years, because he wanted to understand everything." }, accept: ["novelist", "the fiction writer"], hint: "From le roman (Unit 42) — the writer of novels specifically." },
