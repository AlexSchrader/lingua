  ...
  lessons: [
    {
      ...
      cefr: "A2",
      dominantMode: "recall",
      canDo: "Describe the past as a state, not an event: j'étais fatigué, c'était un beau jour, il y avait beaucoup de monde.",
      items: [
        ...
        { id: "fr-u46l1-cetait", type: "vocab", front: "c'était", reading: "cetait", meaning: "it was", example: { jp: "C'était un beau jour.", en: "It was a lovely day." }, accept: ["that was", "it used to be", "this was"], hint: "The past of c'est, and just as common. C'était bien ! = It was good!" },
        ...
        { id: "fr-u46l1-javais", type: "vocab", front: "j'avais", reading: "javais", meaning: "I had", example: { jp: "J'avais un vélo rouge.", en: "I had a red bike." }, accept: ["i used to have", "i was having"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u46l3-jepouvais", type: "vocab", front: "je pouvais", reading: "jepouvais", meaning: "I could", example: { jp: "Je ne pouvais pas travailler.", en: "I couldn't work." }, accept: ["i was able to", "i used to be able to"], hint: "Three shapes, one letter apart: je pouvais (could, then), je pourrai (will be able), je pourrais (would be able)." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u46l4-vousparlez", type: "vocab", front: "vous parlez", reading: "vousparlez", meaning: "you speak", example: { jp: "Vous parlez très bien français.", en: "You speak French very well." }, accept: ["you talk", "you're speaking", "you are talking"], hint: "-er verbs in the present: -e, -es, -e, -ons, -ez, -ent. Four of those six sound identical out loud." },
        { id: "fr-u46l4-ilshabitent", type: "vocab", front: "ils habitent", reading: "ilshabitent", meaning: "they live", example: { jp: "Mes parents habitent à Lyon.", en: "My parents live in Lyon." }, accept: ["they're living", "they are living"], hint: "The -ent is completely silent: ils habitent sounds exactly like il habite. Only the s of ils gives it away." },
