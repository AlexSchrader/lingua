  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u82l1-lavaleur", type: "vocab", front: "la valeur", reading: "lavaleur", meaning: "the value", example: { jp: "La valeur de cette maison a doublé, ce qui étonne les voisins.", en: "The value of this house has doubled, which astonishes the neighbours." }, accept: ["value", "the worth", "values"], hint: "Also moral values in the plural: les valeurs de la République." },
        ...
        { id: "fr-u82l1-lensemble", type: "vocab", front: "l'ensemble", reading: "lensemble", meaning: "the whole", example: { jp: "L'ensemble du dossier doit être relu avant vendredi.", en: "The whole file has to be reread before Friday." }, accept: ["whole", "the set", "overall"], hint: "You met dans l'ensemble (Unit 78) — this is the noun inside it." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u82l2-ladecision", type: "vocab", front: "la décision", reading: "ladecision", meaning: "the decision", example: { jp: "La décision a été prise sans nous, ce qui a créé beaucoup de tension.", en: "The decision was made without us, which created a lot of tension." }, accept: ["decision", "the ruling"], hint: "prendre une décision — you TAKE a decision in French, never \"make\" it." },
        { id: "fr-u82l2-laresponsabilite", type: "vocab", front: "la responsabilité", reading: "laresponsabilite", meaning: "the responsibility", example: { jp: "Il a pris la responsabilité de l'échec, bien que ce ne soit pas entièrement sa faute.", en: "He took responsibility for the failure, although it wasn't entirely his fault." }, accept: ["responsibility", "the liability", "duty"] },
        ...
        { id: "fr-u82l2-loccasion", type: "vocab", front: "l'occasion", reading: "loccasion", meaning: "the opportunity", example: { jp: "C'est l'occasion de changer de travail, et elle ne se représentera pas.", en: "It's the opportunity to change jobs, and it won't come again." }, accept: ["opportunity", "the chance", "occasion"], hint: "d'occasion means second-hand: une voiture d'occasion." },
      ],
    },
    {
      id: "fr-u82l3",
      ...
      items: [
        { id: "fr-u82l3-leffort", type: "vocab", front: "l'effort", reading: "leffort", meaning: "the effort", example: { jp: "Ça demande un effort au début, mais après ça devient une habitude.", en: "It takes an effort at first, but afterwards it becomes a habit." }, accept: ["effort", "the exertion"], hint: "faire un effort. Also faire des efforts, plural, for sustained trying." },
        { id: "fr-u82l3-lemanque", type: "vocab", front: "le manque", reading: "lemanque", meaning: "the lack", example: { jp: "Le manque de sommeil explique sa fatigue et son mauvais moral.", en: "The lack of sleep explains his tiredness and his low spirits." }, accept: ["lack", "the shortage", "want"], hint: "The noun of il manque (Unit 77)." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u82l4-lachance", type: "vocab", front: "la chance", reading: "lachance", meaning: "luck", example: { jp: "J'ai eu de la chance : le train est parti cinq minutes plus tard.", en: "I was lucky: the train left five minutes later." }, accept: ["the luck", "fortune", "opportunity"], hint: "avoir de la chance = to be lucky. Bonne chance ! = good luck!" },
        { id: "fr-u82l4-lehasard", type: "vocab", front: "le hasard", reading: "lehasard", meaning: "chance", example: { jp: "C'est le hasard qui nous a réunis, pas une décision.", en: "It was chance that brought us together, not a decision." }, accept: ["coincidence", "the randomness", "luck"], hint: "par hasard = by chance. Aspirated h: le hasard, never \"l'hasard\"." },
        ...
        { id: "fr-u82l4-quotidien", type: "vocab", front: "quotidien", reading: "quotidien", meaning: "daily", example: { jp: "C'est un problème quotidien pour les gens qui prennent le bus.", en: "It's a daily problem for people who take the bus." }, accept: ["everyday", "day-to-day"], hint: "Also a noun: le quotidien is daily life — and a daily paper." },
        { id: "fr-u82l4-general", type: "vocab", front: "général", reading: "general", meaning: "general", example: { jp: "L'impression générale est bonne, même s'il reste des détails à revoir.", en: "The general impression is good, even if there are details left to review." }, accept: ["overall", "broad", "widespread"], hint: "en général = generally. Plural généraux, like most -al adjectives." },
      ],
    },
  ],
};
