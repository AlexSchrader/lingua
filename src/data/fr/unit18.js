  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u18l1-lekilo", type: "vocab", front: "le kilo", reading: "lekilo", meaning: "kilo", example: { jp: "Un kilo de pommes, s'il vous plaît.", en: "A kilo of apples, please." }, drill: { jp: "Le kilo est à deux euros", en: "A kilo is two euros" }, accept: ["the kilo", "kilogram"], hint: "Quantities take de: un kilo de pommes, une bouteille de vin." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u18l2-lorange", type: "vocab", front: "l'orange", reading: "lorange", meaning: "orange", example: { jp: "Je bois un jus d'orange le matin.", en: "I drink an orange juice in the morning." }, drill: { jp: "L'orange est sur la table", en: "The orange is on the table" }, accept: ["the orange"] },
      ],
    },
    {
      id: "fr-u18l3",
      ...
      items: [
        ...
        { id: "fr-u18l3-jetrouve", type: "vocab", front: "je trouve", reading: "jetrouve", meaning: "I find", example: { jp: "Je ne trouve pas la clé !", en: "I can't find the key!" }, drill: { jp: "Je trouve la clé dans le sac", en: "I find the key in the bag" }, accept: ["i'm finding", "i think"], hint: "Also \"I think\" for opinions: je trouve ça joli — I find that pretty." },
        { id: "fr-u18l3-laliste", type: "vocab", front: "la liste", reading: "laliste", meaning: "list", example: { jp: "Ma liste est dans le sac.", en: "My list is in the bag." }, drill: { jp: "La liste est dans le sac", en: "The list is in the bag" }, accept: ["the list"] },
