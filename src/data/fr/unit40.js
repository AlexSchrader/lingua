  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u40l1-leclavier", type: "vocab", front: "le clavier", reading: "leclavier", meaning: "the keyboard", example: { jp: "J'écris avec mon clavier.", en: "I write with my keyboard." }, accept: ["keyboard", "the keyboard"], hint: "A French keyboard is AZERTY, not QWERTY — the top row starts differently." },
        ...
        { id: "fr-u40l1-lecasque", type: "vocab", front: "le casque", reading: "lecasque", meaning: "the headphones", example: { jp: "J'écoute la musique avec mon casque.", en: "I listen to music with my headphones." }, accept: ["headphones", "helmet", "headset"], hint: "Same word as a helmet — un casque is anything you put on your head." },
      ],
    },
    {
      id: "fr-u40l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u40l4-jetelecharge", type: "vocab", front: "je télécharge", reading: "jetelecharge", meaning: "I download", example: { jp: "Je télécharge un film.", en: "I'm downloading a film." }, accept: ["i'm downloading", "i download", "i upload"], hint: "Covers both directions — télécharger is download and upload alike." },
