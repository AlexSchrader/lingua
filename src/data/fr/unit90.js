  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u90l1-empiler", type: "vocab", front: "empiler", reading: "empiler", meaning: "to pile up", example: { jp: "Je vais empiler les assiettes.", en: "I'm going to stack the plates." }, accept: ["stack", "pile", "stack up"] },
        { id: "fr-u90l1-entasser", type: "vocab", front: "entasser", reading: "entasser", meaning: "to heap up", example: { jp: "Il entasse ses vêtements sur la chaise.", en: "He heaps his clothes on the chair." }, accept: ["heap", "cram", "pile up carelessly"], hint: "empiler makes a neat stack; entasser makes a heap." },
      ],
    },
    {
      id: "fr-u90l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u90l3-net", type: "vocab", front: "net", reading: "net", meaning: "clear-cut", example: { jp: "Sa réponse est nette.", en: "Their answer is clear-cut." }, accept: ["clean", "neat", "distinct"], hint: "The t IS pronounced: « nète ». Its dominant sense is sharp and distinct; the \"clean\" sense survives mainly in fixed phrases like propre et net." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u90l4-reperer", type: "vocab", front: "repérer", reading: "reperer", meaning: "to locate", example: { jp: "J'ai repéré une bonne place.", en: "I've spotted a good place." }, accept: ["spot", "pick out", "track down"] },
