  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u90l1-empiler", type: "vocab", front: "empiler", reading: "empiler", meaning: "to pile up", example: { jp: "Je vais empiler les assiettes.", en: "I'm going to stack the plates." }, accept: ["stack", "stack up"] },
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Deal with a cluttered space: call it cluttered or clear, free it up, clear it out, sweep it — and call it spotless.",
      items: [
        ...
        { id: "fr-u90l3-net", type: "vocab", front: "net", reading: "net", meaning: "spotless", example: { jp: "Tout est net dans cette pièce.", en: "Everything is spotless in this room." }, accept: ["clean", "neat", "clear-cut"], hint: "The t IS pronounced: « nète ». Also means clear-cut — une différence nette." },
        { id: "fr-u90l3-latrace", type: "vocab", front: "la trace", reading: "latrace", meaning: "trace", example: { jp: "Il y a des traces sur le verre.", en: "There are marks on the glass." }, accept: ["mark", "trail", "smudge"] },
      ],
    },
    {
      id: "fr-u90l4",
      ...
      items: [
        ...
        { id: "fr-u90l4-reperer", type: "vocab", front: "repérer", reading: "reperer", meaning: "to locate", example: { jp: "J'ai repéré une place libre.", en: "I've spotted a free space." }, accept: ["spot", "pick out", "notice"] },
        ...
        { id: "fr-u90l4-marquer", type: "vocab", front: "marquer", reading: "marquer", meaning: "to leave a mark", example: { jp: "Je marque la page avec un papier.", en: "I mark the page with a piece of paper." }, accept: ["mark", "mark out", "score"] },
      ],
    },
  ],
};
