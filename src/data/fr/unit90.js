  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u90l3-latrace", type: "vocab", front: "la trace", reading: "latrace", meaning: "trail", example: { jp: "Il y a des traces dans la neige.", en: "There's a trail of tracks in the snow." }, accept: ["track", "tracks", "trace"] },
      ],
    },
    {
      id: "fr-u90l4",
      ...
      items: [
        ...
        { id: "fr-u90l4-marquer", type: "vocab", front: "marquer", reading: "marquer", meaning: "to leave a mark", example: { jp: "Je marque la page avec un bout de papier.", en: "I mark the page with a bit of paper." }, accept: ["mark", "mark out", "score"], hint: "Its noun la marque (a brand) comes later — same root, and the brand is literally the mark a maker leaves." },
      ],
    },
  ],
};
