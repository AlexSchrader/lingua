  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u116l1-mlapresidente", type: "vocab", front: "Madame la Présidente", reading: "madamelapresidente", meaning: "Madam President", example: { jp: "Madame la Présidente, je vous remercie de votre réponse, et je vous prie de croire à l'assurance de mon respect.", en: "Madam President, thank you for your reply, and please accept the assurance of my respect." }, accept: ["madam president", "madam chairwoman", "madam chair"], hint: "Formal address to a woman heading a body or state; the feminine of 'le Président' (Unit 39) plus 'Madame'." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u116l4-agreer", type: "vocab", front: "veuillez agréer", reading: "veuillezagreer", meaning: "please accept (formal letter close)", example: { jp: "Dans l'attente de votre réponse, veuillez agréer, Monsieur, l'assurance de mon respect.", en: "Awaiting your reply, please accept, Sir, the assurance of my respect." }, accept: ["please accept", "kindly accept", "be pleased to accept"], hint: "The opening verb of the standard French letter-closing formula: 'Veuillez agréer ... l'expression de mes salutations'. Formal imperative of agréer; extends 'veuillez' (Unit 79)." },
