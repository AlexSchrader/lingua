  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u63l1-leposte", type: "vocab", front: "le poste", reading: "leposte", meaning: "the position", example: { jp: "Il a trouvé un poste dans une grande entreprise.", en: "He found a position in a big company." }, accept: ["position", "the job", "the post"], hint: "A job position — un poste de professeur. La poste (feminine) is the post office." },
        ...
        { id: "fr-u63l1-lentretien", type: "vocab", front: "l'entretien", reading: "lentretien", meaning: "the interview", example: { jp: "Elle a un entretien important demain matin.", en: "She has an important interview tomorrow morning." }, accept: ["interview", "the meeting", "the maintenance"], hint: "A job interview — un entretien d'embauche. Also 'upkeep': l'entretien de la maison." },
      ],
    },
    {
      id: "fr-u63l2",
      ...
      items: [
        ...
        { id: "fr-u63l2-licencier", type: "vocab", front: "licencier", reading: "licencier", meaning: "to lay off", example: { jp: "Ils ont dû licencier plusieurs employés à cause de la crise.", en: "They had to lay off several employees because of the crisis." }, accept: ["to lay off", "to make redundant", "to fire"], hint: "To let staff go for economic reasons — le licenciement. Not 'to license'!" },
        { id: "fr-u63l2-demissionner", type: "vocab", front: "démissionner", reading: "demissionner", meaning: "to resign", example: { jp: "Après ce scandale, le ministre a décidé de démissionner.", en: "After this scandal, the minister decided to resign." }, accept: ["to resign", "to quit", "to step down"], hint: "To quit a job by your own choice. The noun is la démission." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u63l4-leprojet", type: "vocab", front: "le projet", reading: "leprojet", meaning: "the project", example: { jp: "Ce projet va prendre plusieurs mois de travail.", en: "This project is going to take several months of work." }, accept: ["project", "the plan"], hint: "A project or plan — avoir des projets = to have plans. un projet de loi = a bill." },
        ...
        { id: "fr-u63l4-lapromotion", type: "vocab", front: "la promotion", reading: "lapromotion", meaning: "the promotion", example: { jp: "Après cinq ans, il a enfin eu une promotion.", en: "After five years, he finally got a promotion." }, accept: ["promotion", "the raise", "the special offer"], hint: "A promotion at work. Also a special offer: en promotion = on sale." },
      ],
    },
  ],
};
