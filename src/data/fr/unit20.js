  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u20l1-leverre", type: "vocab", front: "le verre", reading: "leverre", meaning: "glass", example: { jp: "Un verre d'eau, s'il vous plaît.", en: "A glass of water, please." }, drill: { jp: "Le verre est sur la table", en: "The glass is on the table" }, accept: ["the glass"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u20l2-loeuf", type: "vocab", front: "l'œuf", reading: "loeuf", meaning: "egg", example: { jp: "Je mange un œuf au petit-déjeuner.", en: "I eat an egg for breakfast." }, drill: { jp: "L'œuf est sur la table", en: "The egg is on the table" }, accept: ["the egg"], hint: "œ again — type oeuf and it counts. The plural les œufs drops the f sound entirely." },
