  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u54l1-livrer", type: "vocab", front: "livrer", reading: "livrer", meaning: "to deliver", example: { jp: "Je vais livrer le paquet.", en: "I'm going to deliver the parcel." }, accept: ["deliver", "drop off", "hand over"], hint: "Nothing to do with le livre (a book) — livrer is what the delivery driver does." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u54l2-recuperer", type: "vocab", front: "récupérer", reading: "recuperer", meaning: "to get back", example: { jp: "Je vais récupérer mon sac.", en: "I'm going to get my bag back." }, accept: ["retrieve", "collect", "recover", "fetch"] },
        { id: "fr-u54l2-distribuer", type: "vocab", front: "distribuer", reading: "distribuer", meaning: "to hand out", example: { jp: "Je vais distribuer les papiers.", en: "I'm going to hand out the papers." }, accept: ["distribute", "give out", "pass around"] },
