  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u115l1-certainemesure", type: "vocab", front: "dans une certaine mesure", reading: "dansunecertainemesure", meaning: "to a certain extent", example: { jp: "Dans une certaine mesure, la réforme a amélioré la situation, mais elle n'a pas résolu le problème de fond.", en: "To a certain extent, the reform improved the situation, but it did not solve the underlying problem." }, accept: ["to a certain extent", "up to a point", "to some degree"], hint: "Hedges HOW MUCH of a claim you endorse — 'true, but only partly'. Contrast with u59 'dans la mesure où' (= insofar as)." },
