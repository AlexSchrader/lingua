  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u76l1-quoique", type: "vocab", front: "quoique", reading: "quoique", meaning: "although (formal)", example: { jp: "Quoiqu'il soit jeune, il dirige déjà une entreprise.", en: "Even though he's young, he already runs a company." }, accept: ["though", "for all that"], hint: "Same meaning and same subjunctive as bien que, one degree more literary. One word — quoi que in two words means \"whatever\"." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u76l4-desorteque", type: "vocab", front: "de sorte que", reading: "desorteque", meaning: "so that (result)", example: { jp: "Il a tout expliqué de sorte que personne n'ait de question.", en: "He explained everything so that nobody would have a question." }, accept: ["in such a way that", "with the result that"], hint: "Subjunctive for a purpose, indicative for a result — the same sentence means two things depending on the mood." },
