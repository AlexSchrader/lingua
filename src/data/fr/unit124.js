...
export const FR_UNIT124 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "fr-u124l4-interpreter", type: "vocab", front: "interpréter", reading: "interpreter", meaning: "to interpret", example: { jp: "Chacun interprète ce texte à sa façon, et c'est bien normal.", en: "Everyone interprets this text in their own way, and that's quite normal." }, accept: ["to interpret", "to read", "to construe", "to perform"], hint: "To give a meaning to. Also to perform a role or a piece of music." },
