  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u124l1-capter", type: "vocab", front: "capter", reading: "capter", meaning: "to pick up on", example: { jp: "Il capte tout de suite l'ambiance d'une pièce quand il entre.", en: "He picks up on the mood of a room straight away when he comes in." }, accept: ["to pick up on", "to grasp", "to catch", "to sense", "to capture"], hint: "To catch a signal, a mood, or attention. capter un regard, capter le wifi." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u124l4-decrypter", type: "vocab", front: "décrypter", reading: "decrypter", meaning: "to decipher", example: { jp: "Les experts ont mis des mois à décrypter ce vieux message.", en: "The experts took months to decipher this old message." }, accept: ["to decipher", "to decode", "to crack", "to decrypt"], hint: "To work out a hidden or coded meaning. From crypter, to encrypt." },
