  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u56l1-vraiment", type: "vocab", front: "vraiment", reading: "vraiment", meaning: "really", example: { jp: "C'est vraiment bien.", en: "That's really good." }, accept: ["truly", "genuinely", "very"], hint: "vrai (true) + -ment, the ending that turns a French adjective into an adverb — the French -ly." },
        { id: "fr-u56l1-tellement", type: "vocab", front: "tellement", reading: "tellement", meaning: "so", example: { jp: "C'est tellement cher.", en: "It's so expensive." }, accept: ["so much", "such a lot", "very"] },
        ...
        { id: "fr-u56l1-completement", type: "vocab", front: "complètement", reading: "completement", meaning: "completely", example: { jp: "Je suis complètement fatigué.", en: "I'm completely tired." }, accept: ["totally", "utterly", "entirely"] },
        { id: "fr-u56l1-absolument", type: "vocab", front: "absolument", reading: "absolument", meaning: "absolutely", example: { jp: "Je veux absolument essayer.", en: "I absolutely want to try." }, accept: ["definitely", "at all costs", "really"] },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u56l2-heureusement", type: "vocab", front: "heureusement", reading: "heureusement", meaning: "luckily", example: { jp: "Heureusement il fait beau.", en: "Luckily the weather is nice." }, accept: ["fortunately", "thankfully"] },
        ...
        { id: "fr-u56l2-probablement", type: "vocab", front: "probablement", reading: "probablement", meaning: "probably", example: { jp: "Il est probablement malade.", en: "He's probably ill." }, accept: ["likely", "most likely"] },
        { id: "fr-u56l2-surement", type: "vocab", front: "sûrement", reading: "surement", meaning: "surely", example: { jp: "C'est sûrement vrai.", en: "That's surely true." }, accept: ["certainly", "definitely", "no doubt"] },
        { id: "fr-u56l2-apparemment", type: "vocab", front: "apparemment", reading: "apparemment", meaning: "apparently", example: { jp: "Apparemment c'est fermé.", en: "Apparently it's closed." }, accept: ["seemingly", "from what I hear"] },
        { id: "fr-u56l2-evidemment", type: "vocab", front: "évidemment", reading: "evidemment", meaning: "obviously", example: { jp: "Évidemment je suis d'accord.", en: "Obviously I agree." }, accept: ["of course", "clearly", "naturally"] },
      ],
    },
    {
      id: "fr-u56l3",
      ...
      items: [
        ...
        { id: "fr-u56l3-directement", type: "vocab", front: "directement", reading: "directement", meaning: "directly", example: { jp: "Je vais directement à la gare.", en: "I'm going directly to the station." }, accept: ["straight", "right away", "straight there"] },
        { id: "fr-u56l3-doucement", type: "vocab", front: "doucement", reading: "doucement", meaning: "gently", example: { jp: "Je vais commencer doucement.", en: "I'm going to begin gently." }, accept: ["softly", "slowly", "quietly", "carefully"], hint: "From doux (mild), which you met in the weather unit." },
      ],
    },
    {
      id: "fr-u56l4",
      ...
      items: [
        ...
        { id: "fr-u56l4-denouveau", type: "vocab", front: "de nouveau", reading: "denouveau", meaning: "again", example: { jp: "Il pleut de nouveau.", en: "It's raining again." }, accept: ["once more", "yet again", "anew"], hint: "Same idea as encore, a shade more formal." },
        ...
        { id: "fr-u56l4-sansdoute", type: "vocab", front: "sans doute", reading: "sansdoute", meaning: "probably", example: { jp: "C'est sans doute vrai.", en: "It's probably true." }, accept: ["no doubt", "most likely", "presumably"], hint: "A trap: « sans doute » means PROBABLY, not \"without a doubt\". For certainty French says sans aucun doute." },
      ],
    },
  ],
};
