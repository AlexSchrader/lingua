  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u130l1-sitot", type: "vocab", front: "sitôt", reading: "sitot", meaning: "as soon as", example: { jp: "Sitôt dit, sitôt fait : le travail était terminé.", en: "No sooner said than done: the work was finished." }, accept: ["as soon as", "no sooner", "the moment"], hint: "A more literary aussitôt. sitôt dit, sitôt fait is a set phrase." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u130l3-apresent", type: "vocab", front: "à présent", reading: "apresent", meaning: "now", example: { jp: "À présent que tu es là, on peut commencer.", en: "Now that you're here, we can begin." }, accept: ["now", "at present", "these days"], hint: "A slightly more formal maintenant. à présent que = now that." },
        ...
        { id: "fr-u130l3-parmoments", type: "vocab", front: "par moments", reading: "parmoments", meaning: "at times", example: { jp: "Par moments, je me demande si j'ai fait le bon choix.", en: "At times, I wonder if I made the right choice." }, accept: ["at times", "now and then", "occasionally", "sometimes"], hint: "Every so often, on and off." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u130l4-sanscesse", type: "vocab", front: "sans cesse", reading: "sanscesse", meaning: "constantly", example: { jp: "Il se plaint sans cesse, même quand tout va bien.", en: "He complains constantly, even when everything is fine." }, accept: ["constantly", "ceaselessly", "endlessly", "all the time"], hint: "Without stopping. From cesser, to cease." },
