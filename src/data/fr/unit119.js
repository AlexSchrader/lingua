...
export const FR_UNIT119 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "fr-u119l3-deletere", type: "vocab", front: "délétère", reading: "deletere", meaning: "harmful", example: { jp: "Ce climat délétère nuit à l'équipe, de sorte que plusieurs sont partis.", en: "This toxic atmosphere harms the team, so several people left." }, drill: { jp: "Ce climat délétère nuit à l'équipe", en: "This harmful atmosphere hurts the team" }, accept: ["harmful", "toxic", "noxious", "damaging"], hint: "Deeply harmful, often of an atmosphere or influence: une ambiance délétère." },
        { id: "fr-u119l3-salutaire", type: "vocab", front: "salutaire", reading: "salutaire", meaning: "beneficial", example: { jp: "Cette crise a eu un effet salutaire, puisqu'elle a forcé un vrai changement.", en: "This crisis had a beneficial effect, since it forced a real change." }, drill: { jp: "Cette crise a été salutaire", en: "This crisis was beneficial" }, accept: ["beneficial", "salutary", "healthy", "good for one"], hint: "Beneficial, often a hard lesson that does good: un choc salutaire. From salut." },
        { id: "fr-u119l3-preoccupant", type: "vocab", front: "préoccupant", reading: "preoccupant", meaning: "worrying", example: { jp: "La situation est préoccupante, si bien que les experts demandent d'agir vite.", en: "The situation is worrying, so the experts are calling for fast action." }, drill: { jp: "Le résultat est très préoccupant", en: "The result is very worrying" }, accept: ["worrying", "concerning", "alarming", "troubling"], hint: "Cause for concern: un niveau préoccupant. From préoccuper, to worry." },
        { id: "fr-u119l3-perenne", type: "vocab", front: "pérenne", reading: "perenne", meaning: "lasting", example: { jp: "On cherche une solution pérenne, plutôt qu'une mesure qui dure un an.", en: "A lasting solution is sought, rather than a measure that lasts a year." }, drill: { jp: "On cherche un choix pérenne", en: "We're looking for a lasting choice" }, accept: ["lasting", "long-lasting", "enduring", "permanent"], hint: "Made to last over time: un financement pérenne. Noun: la pérennité." },
        { id: "fr-u119l3-chancelant", type: "vocab", front: "chancelant", reading: "chancelant", meaning: "shaky, faltering", example: { jp: "Le gouvernement paraît chancelant, si bien que personne ne lui fait plus confiance.", en: "The government looks shaky, so no one trusts it any more." }, drill: { jp: "Ce projet paraît chancelant", en: "This project looks shaky" }, accept: ["shaky", "faltering", "tottering", "wobbly", "unsteady"], hint: "On the point of falling — of a government, a voice, a régime: un pouvoir chancelant. From chanceler (to totter)." },
        { id: "fr-u119l3-redoutable", type: "vocab", front: "redoutable", reading: "redoutable", meaning: "formidable", example: { jp: "C'est un adversaire redoutable, si bien que personne ne prend le match à la légère.", en: "He's a formidable opponent, so no one takes the match lightly." }, drill: { jp: "Cet adversaire est redoutable", en: "This opponent is formidable" }, accept: ["formidable", "fearsome", "daunting", "dreaded"], hint: "To be feared, impressively so: une efficacité redoutable. From redouter." },
      ],
    },
    {
      id: "fr-u119l4",
      ...
      items: [
        { id: "fr-u119l4-preponderant", type: "vocab", front: "prépondérant", reading: "preponderant", meaning: "predominant", example: { jp: "L'argent a joué un rôle prépondérant, alors que le talent comptait moins.", en: "Money played a predominant role, whereas talent counted for less." }, drill: { jp: "L'argent joue un rôle prépondérant", en: "Money plays a predominant part" }, accept: ["predominant", "prevailing", "decisive", "leading"], hint: "Carrying the most weight: un rôle prépondérant. Feminine: prépondérante." },
        { id: "fr-u119l4-incontournable", type: "vocab", front: "incontournable", reading: "incontournable", meaning: "unavoidable", example: { jp: "Ce sujet est devenu incontournable, dès lors qu'il touche tout le monde.", en: "This topic has become unavoidable, given that it affects everyone." }, drill: { jp: "Cette question est devenue incontournable", en: "This question has become unavoidable" }, accept: ["unavoidable", "essential", "must-see", "inescapable"], hint: "Impossible to get around or ignore: une référence incontournable. Literally, un-go-around-able." },
        { id: "fr-u119l4-disproportionne", type: "vocab", front: "disproportionné", reading: "disproportionne", meaning: "disproportionate", example: { jp: "La réaction paraît disproportionnée, quand bien même la faute est réelle.", en: "The reaction seems disproportionate, even though the fault is real." }, drill: { jp: "Son prix est disproportionné", en: "Its price is disproportionate" }, accept: ["disproportionate", "out of proportion", "excessive"], hint: "Out of proportion with its cause: une peine disproportionnée." },
        { id: "fr-u119l4-derisoire", type: "vocab", front: "dérisoire", reading: "derisoire", meaning: "derisory", example: { jp: "La somme proposée est dérisoire, de sorte que l'offre a été refusée.", en: "The sum offered is derisory, so the offer was refused." }, drill: { jp: "Cette somme reste dérisoire", en: "This sum stays derisory" }, accept: ["derisory", "laughable", "paltry", "pitiful"], hint: "So small as to be laughable: un prix dérisoire. From la dérision." },
        { id: "fr-u119l4-cinglant", type: "vocab", front: "cinglant", reading: "cinglant", meaning: "scathing", example: { jp: "Il a répondu par une remarque cinglante, si bien que la salle s'est tue.", en: "He replied with a scathing remark, so the room fell silent." }, drill: { jp: "Son ton était cinglant", en: "His tone was scathing" }, accept: ["scathing", "cutting", "stinging", "biting"], hint: "Sharp and wounding, of a reply or defeat: une critique cinglante." },
        { id: "fr-u119l4-tranche", type: "vocab", front: "tranché", reading: "tranche", meaning: "clear-cut", example: { jp: "Son avis est tranché, alors que la question reste ouverte pour beaucoup.", en: "His opinion is clear-cut, whereas the question stays open for many." }, drill: { jp: "Son avis reste très tranché", en: "His opinion stays very clear-cut" }, accept: ["clear-cut", "categorical", "firm", "decided"], hint: "Sharply defined, leaving no middle ground: une position tranchée. From trancher." },
      ],
    },
  ],
};
