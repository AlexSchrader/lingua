  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u119l1-flagrant", type: "vocab", front: "flagrant", reading: "flagrant", meaning: "glaring", example: { jp: "Le contraste est flagrant entre ses paroles et ses actes.", en: "The contrast is glaring between his words and his deeds." }, accept: ["glaring", "blatant", "flagrant", "striking"], hint: "Strikingly obvious, of an error or contradiction. Legal: un flagrant délit, caught in the act." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u119l2-notable", type: "vocab", front: "notable", reading: "notable", meaning: "notable", example: { jp: "On observe une amélioration notable, sans pour autant crier victoire.", en: "A notable improvement is seen, without however claiming victory." }, accept: ["notable", "significant", "marked", "considerable"], hint: "Worth noting, of a change or difference: un progrès notable." },
      ],
    },
    {
      id: "fr-u119l3",
      ...
      items: [
        ...
        { id: "fr-u119l3-precaire", type: "vocab", front: "précaire", reading: "precaire", meaning: "precarious", example: { jp: "Beaucoup vivent dans une situation précaire, dès lors la moindre crise les fragilise.", en: "Many live in a precarious situation, so the slightest crisis weakens them." }, accept: ["precarious", "insecure", "unstable", "shaky"], hint: "Unstable, at risk of collapse: un emploi précaire. Noun: la précarité." },
