  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u132l2-dureste", type: "vocab", front: "du reste", reading: "dureste", meaning: "besides", example: { jp: "Ce détail n'a, du reste, aucune importance.", en: "This detail is, besides, of no importance." }, accept: ["besides", "moreover", "for that matter", "incidentally"], hint: "Adds an aside, close to d'ailleurs but more literary. From le reste." },
