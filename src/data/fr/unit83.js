  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u83l1-lemalentendu", type: "vocab", front: "le malentendu", reading: "lemalentendu", meaning: "the misunderstanding", example: { jp: "C'était un malentendu, personne ne voulait faire de mal à personne.", en: "It was a misunderstanding, nobody meant to hurt anyone." }, accept: ["misunderstanding", "the mix-up"], hint: "Literally \"badly heard\" — mal + entendu. The structure tells you the meaning." },
      ],
    },
    {
      id: "fr-u83l2",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u83l4-lebenefice", type: "vocab", front: "le bénéfice", reading: "lebenefice", meaning: "the profit", example: { jp: "L'entreprise a fait un bénéfice cette année, ce qui n'était pas arrivé depuis longtemps.", en: "The company made a profit this year, which hadn't happened for a long time." }, accept: ["profit", "the gain", "benefit"] },
