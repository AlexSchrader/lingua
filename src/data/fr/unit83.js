  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u83l1-lesouci", type: "vocab", front: "le souci", reading: "lesouci", meaning: "the worry", example: { jp: "Ce n'est pas un gros souci, on peut le faire en deux minutes.", en: "It isn't a big worry, we can do it in two minutes." }, accept: ["worry", "the concern", "problem"], hint: "Pas de souci ! is the everyday \"no problem\" — you'll hear it constantly." },
        { id: "fr-u83l1-linquietude", type: "vocab", front: "l'inquiétude", reading: "linquietude", meaning: "the anxiety", example: { jp: "Son inquiétude est facile à comprendre, parce qu'il attend les résultats.", en: "His anxiety is easy to understand, because he's waiting for the results." }, accept: ["anxiety", "unease", "the concern"] },
        ...
        { id: "fr-u83l1-lesoulagement", type: "vocab", front: "le soulagement", reading: "lesoulagement", meaning: "the relief", example: { jp: "Quel soulagement ! Je croyais avoir perdu toutes mes photos.", en: "What a relief! I thought I'd lost all my photos." }, accept: ["relief", "the comfort"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u83l2-ladispute", type: "vocab", front: "la dispute", reading: "ladispute", meaning: "the argument", example: { jp: "La dispute a duré dix minutes, puis tout le monde s'est calmé.", en: "The argument lasted ten minutes, then everybody calmed down." }, accept: ["argument", "the quarrel", "row"], hint: "The noun of se disputer (Unit 75). Careful: it's a row, not a debate." },
      ],
    },
    {
      id: "fr-u83l3",
      ...
      items: [
        ...
        { id: "fr-u83l3-complexe", type: "vocab", front: "complexe", reading: "complexe", meaning: "complex", example: { jp: "La procédure est complexe, si bien que beaucoup de personnes arrêtent.", en: "The procedure is complex, so a lot of people stop." }, accept: ["complicated", "intricate"] },
        ...
        { id: "fr-u83l3-recent", type: "vocab", front: "récent", reading: "recent", meaning: "recent", example: { jp: "D'après une enquête récente, le chômage baisse dans toute la région.", en: "According to a recent survey, unemployment is falling across the whole region." }, accept: ["new", "latest"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u83l4-laperte", type: "vocab", front: "la perte", reading: "laperte", meaning: "the loss", example: { jp: "La perte a été très importante, mais l'assurance a payé une partie.", en: "The loss was very large, but the insurance paid part of it." }, accept: ["loss", "the waste"], hint: "From perdre. une perte de temps = a waste of time." },
        { id: "fr-u83l4-leclassement", type: "vocab", front: "le classement", reading: "leclassement", meaning: "the ranking", example: { jp: "Cette école est la meilleure au classement, pourtant elle reste peu connue.", en: "This school is the best in the ranking, yet it remains little known." }, accept: ["ranking", "the league table", "filing"], hint: "Also the act of filing papers away — le classement des dossiers." },
      ],
    },
  ],
};
