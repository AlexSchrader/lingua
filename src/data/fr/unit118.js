  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u118l3-segarderde", type: "vocab", front: "se garder de", reading: "segarderde", meaning: "to refrain from", example: { jp: "Le ministre se garde de tout avis, tant que l'enquête n'est pas terminée.", en: "The minister refrains from any opinion as long as the investigation is not over." }, accept: ["to refrain from", "to be careful not to", "to avoid", "to hold back from", "to steer clear of"], hint: "se garder de + noun/infinitive = to deliberately avoid doing something. More cautious than 'ne pas faire'." },
      ],
    },
    {
      id: "fr-u118l4",
      ...
      items: [
        ...
        { id: "fr-u118l4-presager", type: "vocab", front: "présager", reading: "presager", meaning: "to portend, to foreshadow", example: { jp: "Ces tensions présagent une crise, si bien que les marchés commencent à baisser.", en: "These tensions foreshadow a crisis, so the markets are beginning to fall." }, accept: ["to portend", "to foreshadow", "to presage", "to herald", "to point to"], hint: "Of a sign: to announce something (usually bad) to come — présager le pire. From le présage (an omen)." },
