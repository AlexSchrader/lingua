  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u41l1-laplanete", type: "vocab", front: "la planète", reading: "laplanete", meaning: "the planet", example: { jp: "Quelle planète est près du soleil ?", en: "Which planet is near the sun?" }, accept: ["planet", "world", "the planet"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u41l4-lebois", type: "vocab", front: "le bois", reading: "lebois", meaning: "the wood", example: { jp: "Cette table est en bois.", en: "This table is made of wood." }, accept: ["wood", "the wood", "woods"], hint: "en bois = made of wood. en + a material is how French says what a thing is made of." },
