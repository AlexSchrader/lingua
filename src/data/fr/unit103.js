  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u103l1-latoile", type: "vocab", front: "la toile", reading: "latoile", meaning: "the canvas", example: { jp: "Le peintre a fini sa dernière toile.", en: "The painter finished his latest canvas." }, accept: ["canvas", "the painting", "the web"], hint: "A painting on canvas — une toile de maître. Also cloth, or the Web (la Toile)." },
        ...
        { id: "fr-u103l1-lepeintre", type: "vocab", front: "le peintre", reading: "lepeintre", meaning: "the painter", example: { jp: "Ce peintre aime beaucoup les couleurs.", en: "This painter loves colours." }, accept: ["painter"], hint: "A painter — un peintre célèbre. From peindre. Une peintre for a woman." },
      ],
    },
    {
      id: "fr-u103l2",
      ...
      items: [
        { id: "fr-u103l2-lecourant", type: "vocab", front: "le courant", reading: "lecourant", meaning: "the movement", example: { jp: "Ce courant artistique vient d'Italie.", en: "This artistic movement comes from Italy." }, accept: ["the movement", "the trend", "the current"], hint: "A trend or school of thought — un courant artistique. Also a water/electric current." },
