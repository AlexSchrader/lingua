  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u25l1-lemonde", type: "vocab", front: "le monde", reading: "lemonde", meaning: "world", example: { jp: "Tout le monde parle anglais ici.", en: "Everybody speaks English here." }, accept: ["the world"], hint: "tout le monde = everybody — literally \"all the world\"." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u25l3-jecris", type: "vocab", front: "j'écris", reading: "jecris", meaning: "I write", example: { jp: "J'écris la liste.", en: "I'm writing the list." }, accept: ["i'm writing"] },
