...
export const FR_UNIT25 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "fr-u25l3-lelivre", type: "vocab", front: "le livre", reading: "lelivre", meaning: "book", example: { jp: "Je lis un livre français.", en: "I'm reading a French book." }, drill: { jp: "Le livre est sur la table", en: "The book is on the table" }, accept: ["the book"], hint: "je lis = I read, from lire." },
        ...
        { id: "fr-u25l3-lestylo", type: "vocab", front: "le stylo", reading: "lestylo", meaning: "pen", example: { jp: "J'écris avec un stylo.", en: "I write with a pen." }, drill: { jp: "Le stylo est dans le sac", en: "The pen is in the bag" }, accept: ["the pen"], hint: "j'écris = I write, from écrire." },
