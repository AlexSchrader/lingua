  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u80l1-jemepermetsde", type: "vocab", front: "je me permets de", reading: "jemepermetsde", meaning: "I'm taking the liberty of", example: { jp: "Je me permets de vous écrire au sujet de l'annonce que j'ai vue.", en: "I'm taking the liberty of writing to you about the advert I saw." }, accept: ["may i", "if i may", "i take the liberty"], hint: "The standard opening of a cold email in French. From permettre (Unit 77)." },
        { id: "fr-u80l1-jemedemandaissi", type: "vocab", front: "je me demandais si", reading: "jemedemandaissi", meaning: "I was wondering whether", example: { jp: "Je me demandais si vous auriez un moment cette semaine.", en: "I was wondering whether you might have a moment this week." }, accept: ["i wondered if", "i was wondering if"], hint: "The imperfect does the softening — je me demande si is a real question, je me demandais si is a polite approach." },
        { id: "fr-u80l1-ceseraitpossiblede", type: "vocab", front: "ce serait possible de", reading: "ceseraitpossiblede", meaning: "would it be possible to", example: { jp: "Ce serait possible de changer la date ? Sinon, je comprends.", en: "Would it be possible to change the date? If not, I understand." }, accept: ["could we", "is there any chance"], hint: "Note the trailing sinon — offering the refusal yourself is the French politeness move." },
        { id: "fr-u80l1-auriezvous", type: "vocab", front: "auriez-vous", reading: "auriezvous", meaning: "would you have", example: { jp: "Auriez-vous un instant à me consacrer ?", en: "Would you have a moment to spare me?" }, accept: ["do you have (polite)", "might you have"], hint: "The conditional of avoir, inverted — the same two moves as pourriez-vous (Unit 79)." },
        { id: "fr-u80l1-nhesitezpasa", type: "vocab", front: "n'hésitez pas à", reading: "nhesitezpasa", meaning: "feel free to", example: { jp: "N'hésitez pas à me contacter si vous avez la moindre question.", en: "Feel free to contact me if you have the slightest question." }, accept: ["don't hesitate to", "do feel free to"], hint: "Closes almost every professional French email. Literally \"don't hesitate to\"." },
        { id: "fr-u80l1-jevousseraisreconnaissant", type: "vocab", front: "je vous serais reconnaissant", reading: "jevousseraisreconnaissant", meaning: "I would be grateful", example: { jp: "Je vous serais reconnaissant de bien vouloir me répondre avant vendredi.", en: "I would be grateful if you would reply to me before Friday." }, accept: ["i'd be grateful", "i would appreciate"], hint: "The heaviest polite request in normal use. de bien vouloir adds another cushion on top." },
      ],
    },
    {
      id: "fr-u80l2",
      ...
      items: [
        ...
        { id: "fr-u80l2-ilmesembleque", type: "vocab", front: "il me semble que", reading: "ilmesembleque", meaning: "it seems to me that", example: { jp: "Il me semble que la date est fausse, mais je peux me tromper.", en: "It seems to me that the date is wrong, but I may be mistaken." }, accept: ["i think that", "i believe", "to my mind"], hint: "How you correct someone without saying they're wrong. The trailing mais je peux me tromper is part of the move." },
        { id: "fr-u80l2-sauferreur", type: "vocab", front: "sauf erreur", reading: "sauferreur", meaning: "unless I'm mistaken", example: { jp: "Sauf erreur de ma part, le paiement n'est pas encore arrivé.", en: "Unless I'm mistaken, the payment hasn't arrived yet." }, accept: ["if i'm not mistaken", "correct me if i'm wrong"], hint: "Full form: sauf erreur de ma part. Lets you raise a problem while leaving the other person a way out." },
        { id: "fr-u80l2-malheureusement2", type: "vocab", front: "je suis au regret de", reading: "jesuisauregretde", meaning: "I regret to", example: { jp: "Je suis au regret de vous informer que votre demande a été refusée.", en: "I regret to inform you that your request has been refused." }, accept: ["i'm sorry to", "it is with regret"], hint: "The formal refusal. If a French letter opens like this, the answer is no." },
        ...
        { id: "fr-u80l2-cestdommage", type: "vocab", front: "c'est dommage", reading: "cestdommage", meaning: "that's a shame", example: { jp: "C'est dommage que tu ne puisses pas venir, on aurait été content de te voir.", en: "It's a shame you can't come, we'd have been glad to see you." }, accept: ["that's a pity", "too bad", "what a shame"], hint: "c'est dommage QUE takes the subjunctive — puisses, not peux." },
      ],
    },
    {
      id: "fr-u80l3",
      ...
      items: [
        { id: "fr-u80l3-volontiers", type: "vocab", front: "volontiers", reading: "volontiers", meaning: "gladly", example: { jp: "— Un café ? — Volontiers, merci.", en: "— A coffee? — Gladly, thank you." }, accept: ["with pleasure", "i'd love to", "willingly"], hint: "The natural one-word yes to an offer. Oui alone can sound flat." },
        { id: "fr-u80l3-avecplaisir", type: "vocab", front: "avec plaisir", reading: "avecplaisir", meaning: "with pleasure", example: { jp: "Je viendrai avec plaisir, à condition que je finisse mon travail à temps.", en: "I'll come with pleasure, provided I finish my work in time." }, accept: ["gladly", "my pleasure", "happily"] },
        ...
        { id: "fr-u80l3-bonnereception", type: "vocab", front: "bonne réception", reading: "bonnereception", meaning: "hope this reaches you well", example: { jp: "Vous trouverez le dossier en pièce jointe. Bonne réception.", en: "You'll find the file attached. Hope it reaches you safely." }, accept: ["kind regards", "hope you receive it"], hint: "Email-only, and untranslatable — it just means \"I hope this arrives\". French email has dozens of these." },
        ...
        { id: "fr-u80l3-jevousenprie", type: "vocab", front: "je vous en prie", reading: "jevousenprie", meaning: "you're welcome", example: { jp: "— Merci beaucoup. — Je vous en prie, c'est normal.", en: "— Thank you very much. — You're welcome, it's the least I could do." }, accept: ["not at all", "please do", "don't mention it"], hint: "Two jobs: the formal de rien (Unit 1), and \"please, go ahead\" when you hold a door." },
      ],
    },
    {
      id: "fr-u80l4",
      ...
      items: [
        ...
        { id: "fr-u80l4-bref", type: "vocab", front: "bref", reading: "bref", meaning: "anyway", example: { jp: "Bref, on a raté le train et on est rentrés en bus.", en: "Anyway, we missed the train and came home by bus." }, accept: ["in short", "to cut it short", "so anyway"], hint: "Cuts your own story short. Extremely common in speech, and fine in a casual email." },
        ...
        { id: "fr-u80l4-genre", type: "vocab", front: "genre", reading: "genre", meaning: "like", example: { jp: "Il est arrivé genre deux heures en retard, sans prévenir.", en: "He turned up like two hours late, without warning." }, accept: ["sort of", "kind of", "about"], hint: "The casual filler, same job as English \"like\". As a noun le genre means kind or gender." },
