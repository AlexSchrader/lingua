  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u80l1-jemepermetsde", type: "vocab", front: "je me permets de", reading: "jemepermetsde", meaning: "I'm taking the liberty of", example: { jp: "Je me permets de vous écrire parce que j'ai vu votre site.", en: "I'm taking the liberty of writing to you because I saw your website." }, accept: ["may i", "if i may", "i take the liberty"], hint: "The standard opening of a cold email in French. From permettre (Unit 77)." },
        { id: "fr-u80l1-jemedemandaissi", type: "vocab", front: "je me demandais si", reading: "jemedemandaissi", meaning: "I was wondering whether", example: { jp: "Je me demandais si vous êtes libre cette semaine.", en: "I was wondering whether you're free this week." }, accept: ["i wondered if", "i was wondering if"], hint: "The imperfect does the softening — je me demande si is a real question, je me demandais si is a polite approach." },
        { id: "fr-u80l1-ceseraitpossiblede", type: "vocab", front: "ce serait possible de", reading: "ceseraitpossiblede", meaning: "would it be possible to", example: { jp: "Ce serait possible de changer la date ? Je comprends si ce n'est pas simple.", en: "Would it be possible to change the date? I understand if it isn't easy." }, accept: ["could we", "is there any chance"], hint: "Note the trailing sinon — offering the refusal yourself is the French politeness move." },
