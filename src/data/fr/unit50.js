...
export const FR_UNIT50 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        { id: "fr-u50l2-environ", type: "vocab", front: "environ", reading: "environ", meaning: "about", example: { jp: "J'ai environ vingt euros.", en: "I have about twenty euros." }, accept: ["approximately", "thereabouts"], hint: "Goes with a number: environ vingt euros. For a quantity you can't count, à peu près is the safer choice." },
