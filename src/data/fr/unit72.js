  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u72l3-preserver", type: "vocab", front: "préserver", reading: "preserver", meaning: "to preserve", example: { jp: "Il faut préserver ces zones, sinon elles disparaîtront.", en: "These areas must be preserved, otherwise they will disappear." }, accept: ["to conserve", "to safeguard from harm", "to save"] },
      ],
    },
    {
      id: "fr-u72l4",
