  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u72l1-lelittoral", type: "vocab", front: "le littoral", reading: "lelittoral", meaning: "the coast", example: { jp: "Le littoral est protégé, donc on ne peut pas construire ici.", en: "The coast is protected, so you can't build here." }, accept: ["coast", "the coastline", "shoreline"], hint: "The formal word — la côte is the everyday one." },
        { id: "fr-u72l1-leterritoire", type: "vocab", front: "le territoire", reading: "leterritoire", meaning: "the territory", example: { jp: "Ce territoire est très grand, mais peu de gens y habitent.", en: "This territory is very big, but few people live there." }, accept: ["territory", "the area", "land"] },
        ...
        { id: "fr-u72l1-urbain", type: "vocab", front: "urbain", reading: "urbain", meaning: "urban", example: { jp: "Les transports urbains sont gratuits le week-end dans cette ville.", en: "Urban transport is free at weekends in this city." }, accept: ["city", "town", "of the city"] },
      ],
    },
    {
      id: "fr-u72l2",
      ...
      items: [
        ...
        { id: "fr-u72l2-lespece", type: "vocab", front: "l'espèce", reading: "lespece", meaning: "the species", example: { jp: "Cette espèce a disparu de la région, parce que la forêt a été détruite.", en: "This species has disappeared from the region, because the forest was destroyed." }, accept: ["species", "the kind", "sort"], hint: "Same in singular and plural: une espèce, deux espèces — but the word itself never loses its s." },
        { id: "fr-u72l2-lecosysteme", type: "vocab", front: "l'écosystème", reading: "lecosysteme", meaning: "the ecosystem", example: { jp: "L'écosystème du littoral est fragile, donc il faut le surveiller.", en: "The coastal ecosystem is fragile, so it needs watching." }, accept: ["ecosystem", "the environment"] },
        { id: "fr-u72l2-menacer", type: "vocab", front: "menacer", reading: "menacer", meaning: "to threaten", example: { jp: "Le réchauffement menace des milliers d'espèces, et personne ne sait comment les sauver.", en: "Global warming threatens thousands of species, and nobody knows how to save them." }, accept: ["to endanger", "to put at risk"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u72l3-polluer", type: "vocab", front: "polluer", reading: "polluer", meaning: "to pollute", example: { jp: "Cette usine pollue la rivière, même si elle dit le contraire.", en: "This factory pollutes the river, even though it says otherwise." }, accept: ["to contaminate", "to foul"] },
        ...
        { id: "fr-u72l3-preserver", type: "vocab", front: "préserver", reading: "preserver", meaning: "to preserve", example: { jp: "Il faut préserver ces zones, sinon elles disparaîtront.", en: "These areas must be preserved, otherwise they will disappear." }, accept: ["to conserve", "to protect", "to save"] },
      ],
    },
    {
      id: "fr-u72l4",
      ...
      items: [
        ...
        { id: "fr-u72l4-renouvelable", type: "vocab", front: "renouvelable", reading: "renouvelable", meaning: "renewable", example: { jp: "L'énergie renouvelable coûte moins cher qu'avant, du coup tout le monde s'y met.", en: "Renewable energy costs less than before, so everyone is taking it up." }, accept: ["sustainable", "replaceable"] },
        { id: "fr-u72l4-legaspillage", type: "vocab", front: "le gaspillage", reading: "legaspillage", meaning: "the waste", example: { jp: "Le gaspillage alimentaire est énorme, tandis qu'il y a des gens qui ont faim.", en: "Food waste is enormous, while there are people going hungry." }, accept: ["waste", "wastefulness", "squandering"], hint: "The ACT of wasting; les déchets (Unit 41) are the rubbish itself." },
        ...
        { id: "fr-u72l4-ledechet", type: "vocab", front: "le déchet", reading: "ledechet", meaning: "the piece of waste", example: { jp: "Chaque déchet a sa poubelle, et il faut apprendre à les reconnaître.", en: "Each piece of waste has its own bin, and you have to learn to tell them apart." }, accept: ["waste item", "rubbish", "refuse"], hint: "Usually plural (les déchets, Unit 41); the singular names one individual item." },
        { id: "fr-u72l4-lazone", type: "vocab", front: "la zone", reading: "lazone", meaning: "the zone", example: { jp: "C'est une zone protégée, si bien qu'on ne peut rien construire.", en: "It's a protected zone, so nothing can be built there." }, accept: ["zone", "the area", "district"] },
      ],
    },
  ],
};
