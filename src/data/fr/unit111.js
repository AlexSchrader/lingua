  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u111l2-recit", type: "vocab", front: "le récit", reading: "lerecit", meaning: "narrative / account", example: { jp: "Un même événement devient un récit différent selon le journal, parce que chacun raconte les faits à sa façon.", en: "A single event becomes a different narrative depending on the paper, because each one tells the facts its own way." }, accept: ["narrative", "account", "the narrative", "story", "the account"], hint: "A shaped telling of events, more than the bare facts — le récit médiatique. Masculine." },
