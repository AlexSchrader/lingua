  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u53l2-lapause", type: "vocab", front: "la pause", reading: "lapause", meaning: "pause", example: { jp: "Je vais faire une pause.", en: "I'm going to take a break." }, accept: ["break", "the break", "rest", "breather"], hint: "You MAKE a break in French — faire une pause, never « prendre »." },
