  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u38l1-lecaractere", type: "vocab", front: "le caractère", reading: "lecaractere", meaning: "character (personality)", example: { jp: "Marie a un caractère très fort.", en: "Marie has a very strong character." }, accept: ["personality", "temperament", "character", "the character"], hint: "Le caractère is what a person is LIKE. It never means a letter of the alphabet." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u38l3-courageux", type: "vocab", front: "courageux", reading: "courageux", meaning: "brave", example: { jp: "Mon père est courageux : il travaille la nuit.", en: "My father is brave: he works at night." }, accept: ["courageous", "bold", "gutsy"] },
