  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u29l1-ilfaut", type: "vocab", front: "il faut", reading: "ilfaut", meaning: "you have to", example: { jp: "Il faut manger à midi.", en: "You have to eat at noon." }, accept: ["it is necessary", "one must", "we must", "you must"], hint: "No real subject — il faut is nobody in particular, like English \"one must\". It never changes form, which makes it the easiest way to say must." },
        ...
        { id: "fr-u29l1-ondoit", type: "vocab", front: "on doit", reading: "ondoit", meaning: "we must", example: { jp: "On doit faire les courses.", en: "We have to do the shopping." }, accept: ["we have to", "one must"] },
        { id: "fr-u29l1-nousdevons", type: "vocab", front: "nous devons", reading: "nousdevons", meaning: "we must", example: { jp: "Nous devons voir le médecin.", en: "We have to see the doctor." }, accept: ["we have to"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u29l2-attends", type: "vocab", front: "attends", reading: "attends", meaning: "wait!", example: { jp: "Attends, je ne comprends pas !", en: "Wait, I don't understand!" }, accept: ["hold on", "hang on"], hint: "Not an -er verb, so it KEEPS its -s: attends, prends. Only the -er verbs lose it." },
        ...
        { id: "fr-u29l2-prends", type: "vocab", front: "prends", reading: "prends", meaning: "take!", example: { jp: "Prends le train, c'est plus rapide.", en: "Take the train, it's faster." }, accept: ["have", "get"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u29l3-prenez", type: "vocab", front: "prenez", reading: "prenez", meaning: "take! (polite)", example: { jp: "Prenez le métro, c'est plus facile.", en: "Take the metro, it's easier." }, accept: ["have", "get"] },
        { id: "fr-u29l3-allez", type: "vocab", front: "allez", reading: "allez", meaning: "go! (polite)", example: { jp: "Allez tout droit, et après à gauche.", en: "Go straight on, and then left." }, accept: ["go on", "come on"], hint: "Also a warm all-purpose nudge — allez ! is \"come on!\", \"off you go\", or \"cheer up\", depending on the voice." },
