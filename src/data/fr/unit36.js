  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u36l2-puisque", type: "vocab", front: "puisque", reading: "puisque", meaning: "seeing as", example: { jp: "Puisque c'est samedi, je ne travaille pas.", en: "Since it's Saturday, I'm not working." }, accept: ["given that", "since"], hint: "For a reason both of you already know. A brand-new reason takes parce que." },
      ],
    },
    {
      id: "fr-u36l3",
      ...
      items: [
        ...
        { id: "fr-u36l3-avantde", type: "vocab", front: "avant de", reading: "avantde", meaning: "before doing something", example: { jp: "Avant de partir, je ferme la fenêtre.", en: "Before leaving, I close the window." }, accept: ["prior to doing", "before doing"], hint: "avant takes a noun, avant de takes a verb — and that verb stays in its dictionary form." },
