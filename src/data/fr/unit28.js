  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u28l1-vousallez", type: "vocab", front: "vous allez", reading: "vousallez", meaning: "you go (polite/plural)", example: { jp: "Vous allez bien, madame ?", en: "Are you well, ma'am?" }, accept: ["you're going", "you are going"], hint: "Also the polite \"how are you\": comment allez-vous ? — literally \"how do you go?\"." },
        { id: "fr-u28l1-onva", type: "vocab", front: "on va", reading: "onva", meaning: "we go", example: { jp: "On va au marché ?", en: "Shall we go to the market?" }, accept: ["we're going", "shall we go", "one goes"], hint: "In real speech, on replaces nous almost always — on va is far more common than nous allons. It takes the il/elle form." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u28l2-nousfaisons", type: "vocab", front: "nous faisons", reading: "nousfaisons", meaning: "we do", example: { jp: "Nous faisons un gâteau pour ma mère.", en: "We're making a cake for my mother." }, accept: ["we make", "we're doing", "we're making"], hint: "Spelt fai-, said \"fuh-ZON\" — the only verb in French that does this. Nobody knows why." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u28l3-nousmangeons", type: "vocab", front: "nous mangeons", reading: "nousmangeons", meaning: "we eat", example: { jp: "Nous mangeons à midi.", en: "We eat at noon." }, accept: ["we're eating", "we are eating"], hint: "The extra e keeps the g soft: mangeons, not \"mangons\". Same trick in nous commençons." },
