  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u84l1-soulever", type: "vocab", front: "soulever", reading: "soulever", meaning: "to lift up", example: { jp: "Cette boîte est trop lourde à soulever.", en: "This box is too heavy to lift." }, accept: ["lift", "raise", "pick up", "heave"] },
        { id: "fr-u84l1-lancer", type: "vocab", front: "lancer", reading: "lancer", meaning: "to throw", example: { jp: "Il ne faut pas lancer d'objets.", en: "You mustn't throw things." }, accept: ["toss", "hurl", "launch"] },
