  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u84l3-grimper", type: "vocab", front: "grimper", reading: "grimper", meaning: "to climb", example: { jp: "Les enfants aiment grimper dans l'arbre.", en: "Children like climbing in the tree." }, accept: ["clamber", "scale", "climb up"] },
    ...
    },
    {
      ...
      cefr: "B1",
      dominantMode: "recall",
      canDo: "Name six things a hand does to something: knock, tap, scratch, stroke, pinch, twist.",
      items: [
        ...
        { id: "fr-u84l4-taper", type: "vocab", front: "taper", reading: "taper", meaning: "to tap", example: { jp: "Je tape le mot de passe.", en: "I type the password." }, accept: ["type", "bang", "hit"], hint: "Also \"to type\": taper un message. Same word for hitting a key and hitting anything else." },
        ...
        { id: "fr-u84l4-tordre", type: "vocab", front: "tordre", reading: "tordre", meaning: "to twist", example: { jp: "Le vent peut tordre les arbres.", en: "The wind can twist the trees." }, accept: ["bend", "wring", "contort"] },
      ],
    },
  ],
};
