  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u78l1-ladiminution", type: "vocab", front: "la diminution", reading: "ladiminution", meaning: "the decrease", example: { jp: "Il y a une diminution du chômage, bien que ce soit lent.", en: "There is a decrease in unemployment, although it's slow." }, accept: ["decrease", "the fall", "reduction"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u78l2-lepointdevue", type: "vocab", front: "le point de vue", reading: "lepointdevue", meaning: "the point of view", example: { jp: "De mon point de vue, la solution n'est pas bonne, mais je peux avoir tort.", en: "From my point of view, the solution isn't good, but I may be wrong." }, accept: ["viewpoint", "the perspective", "standpoint"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u78l4-laprocedure", type: "vocab", front: "la procédure", reading: "laprocedure", meaning: "the procedure", example: { jp: "La procédure est très longue, si bien que peu de personnes vont jusqu'au bout.", en: "The procedure is very long, so few people see it through." }, accept: ["procedure", "the process", "proceedings"] },
      ],
    },
  ],
};
