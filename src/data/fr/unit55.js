  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u55l1-possible", type: "vocab", front: "possible", reading: "possible", meaning: "doable", example: { jp: "Ce n'est pas possible.", en: "That's not possible." }, accept: ["possible", "feasible", "can be done"], hint: "Spelled exactly like English, said nothing like it: « po-SEEBL », with the stress at the end and no \"uh\" in the middle." },
        { id: "fr-u55l1-impossible", type: "vocab", front: "impossible", reading: "impossible", meaning: "out of the question", example: { jp: "C'est impossible pour moi.", en: "It's impossible for me." }, accept: ["impossible", "not possible", "can't be done"], hint: "The im- is nasal — « ann-po-SEEBL », not \"im\"." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u55l2-simple", type: "vocab", front: "simple", reading: "simple", meaning: "straightforward", example: { jp: "C'est très simple.", en: "It's very simple." }, accept: ["simple", "plain", "basic"], hint: "Said « SAM-pl » — the -im- is nasal and the final e is silent." },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u55l3-pareil", type: "vocab", front: "pareil", reading: "pareil", meaning: "alike", example: { jp: "C'est pareil pour moi.", en: "It's the same for me." }, accept: ["similar", "just the same", "no different"], hint: "pareil stands on its own (c'est pareil); même needs le/la in front of a noun (le même prix)." },
        ...
        { id: "fr-u55l3-seul", type: "vocab", front: "seul", reading: "seul", meaning: "alone", example: { jp: "Je suis seul ici.", en: "I'm alone here." }, accept: ["on my own", "single", "lonely", "by myself"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u55l4-agreable", type: "vocab", front: "agréable", reading: "agreable", meaning: "pleasant", example: { jp: "C'est un endroit agréable.", en: "It's a pleasant place." }, accept: ["lovely", "enjoyable", "agreeable"], hint: "Of a place or a moment. For a PERSON who is nice, French says sympa." },
