  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u95l1-eloquent", type: "vocab", front: "éloquent", reading: "eloquent", meaning: "eloquent", example: { jp: "Son silence était plus éloquent que de longs discours.", en: "His silence was more eloquent than any long speech." }, accept: ["eloquent", "telling"], hint: "Eloquent — or, of a fact or a silence, telling: un chiffre éloquent." },
        ...
        { id: "fr-u95l1-percutant", type: "vocab", front: "percutant", reading: "percutant", meaning: "hard-hitting", example: { jp: "Il a terminé son discours par une phrase percutante.", en: "He ended his speech with a hard-hitting sentence." }, accept: ["hard-hitting", "striking", "punchy"], hint: "Hard-hitting, striking — un argument percutant. From percuter, to strike." },
      ],
    },
    {
      id: "fr-u95l2",
      ...
      items: [
        { id: "fr-u95l2-lesophisme", type: "vocab", front: "le sophisme", reading: "lesophisme", meaning: "the fallacy", example: { jp: "Ce beau raisonnement n'est en fait qu'un sophisme.", en: "This fine-sounding reasoning is in fact just a fallacy." }, accept: ["fallacy", "the sophism", "the false argument"], hint: "An argument that looks valid but isn't — from the ancient Sophists." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u95l3-exagerer", type: "vocab", front: "exagérer", reading: "exagerer", meaning: "to exaggerate", example: { jp: "Tu exagères un peu : ce n'est pas si difficile.", en: "You're exaggerating a bit: it's not that hard." }, accept: ["to exaggerate", "to overdo it"], hint: "To exaggerate — also 'to go too far': là, tu exagères !" },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u95l4-insister", type: "vocab", front: "insister", reading: "insister", meaning: "to insist", example: { jp: "Elle insiste toujours sur les mêmes détails.", en: "She always insists on the same details." }, accept: ["to insist", "to stress", "to press the point"], hint: "insister sur = to stress / dwell on; insister pour = to insist on doing." },
