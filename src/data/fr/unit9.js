  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u9l1-ans", type: "vocab", front: "ans", reading: "ans", meaning: "years old", example: { jp: "Mon frère a dix ans.", en: "My brother is ten years old." }, accept: ["years", "years of age"], hint: "Never dropped the way English drops it: « j'ai douze » is not French — you must say « j'ai douze ans »." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u9l3-jefais", type: "vocab", front: "je fais", reading: "jefais", meaning: "I make", example: { jp: "Je fais un café ce matin.", en: "I'm making a coffee this morning." }, accept: ["i do", "i'm making", "i'm doing"] },
