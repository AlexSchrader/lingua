  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u49l2-sur", type: "vocab", front: "sûr", reading: "sur", meaning: "sure", example: { jp: "Je ne suis pas sûr.", en: "I'm not sure." }, accept: ["safe", "confident"], hint: "The accent matters: sûr = sure, sur = on. You already met it inside bien sûr." },
        { id: "fr-u49l2-certain", type: "vocab", front: "certain", reading: "certain", meaning: "definite", example: { jp: "Ce n'est pas certain.", en: "It's not definite." }, accept: ["certain", "settled", "for sure"], hint: "Spelled like English but said the French way — the final n is nasal and silent. sûr is how YOU feel; certain is how settled the FACT is." },
      ],
    },
    {
      id: "fr-u49l3",
