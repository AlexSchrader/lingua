  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u49l1-apprendre", type: "vocab", front: "apprendre", reading: "apprendre", meaning: "to learn", example: { jp: "Je veux apprendre le français.", en: "I want to learn French." }, accept: ["learn", "to study", "study"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u49l2-sur", type: "vocab", front: "sûr", reading: "sur", meaning: "sure", example: { jp: "Je ne suis pas sûr.", en: "I'm not sure." }, accept: ["certain", "safe"], hint: "The accent matters: sûr = sure, sur = on. You already met it inside bien sûr." },
        { id: "fr-u49l2-certain", type: "vocab", front: "certain", reading: "certain", meaning: "certain", example: { jp: "Ce n'est pas certain.", en: "It's not certain." }, accept: ["sure", "definite"] },
      ],
    },
    {
      id: "fr-u49l3",
      ...
      items: [
        ...
        { id: "fr-u49l3-preferer", type: "vocab", front: "préférer", reading: "preferer", meaning: "to prefer", example: { jp: "Je vais préférer le train.", en: "I'm going to prefer the train." }, accept: ["prefer", "like better"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u49l4-esperer", type: "vocab", front: "espérer", reading: "esperer", meaning: "to hope", example: { jp: "On peut espérer un peu.", en: "We can hope a little." }, accept: ["hope", "to hope for", "hope for"] },
        ...
        { id: "fr-u49l4-remarquer", type: "vocab", front: "remarquer", reading: "remarquer", meaning: "to notice", example: { jp: "Je vais remarquer sa nouvelle veste.", en: "I'm going to notice her new jacket." }, accept: ["notice", "spot", "observe"] },
        { id: "fr-u49l4-sembler", type: "vocab", front: "sembler", reading: "sembler", meaning: "to seem", example: { jp: "Ça peut sembler difficile.", en: "That can seem difficult." }, accept: ["seem", "appear", "look"] },
