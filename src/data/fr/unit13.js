  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u13l1-lesoleil", type: "vocab", front: "le soleil", reading: "lesoleil", meaning: "sun", example: { jp: "Il y a du soleil, il fait chaud.", en: "It's sunny, it's hot." }, accept: ["the sun", "sunshine"] },
        ...
        { id: "fr-u13l1-levent", type: "vocab", front: "le vent", reading: "levent", meaning: "wind", example: { jp: "Il y a du vent aujourd'hui.", en: "It's windy today." }, accept: ["the wind"], hint: "\"There is wind\" is how French says windy: il y a du vent." },
        { id: "fr-u13l1-lenuage", type: "vocab", front: "le nuage", reading: "lenuage", meaning: "cloud", example: { jp: "Il y a un nuage dans le ciel.", en: "There's a cloud in the sky." }, accept: ["the cloud"] },
      ],
    },
    {
      id: "fr-u13l2",
      ...
      items: [
        ...
        { id: "fr-u13l2-lamer", type: "vocab", front: "la mer", reading: "lamer", meaning: "sea", example: { jp: "En été, je vais à la mer.", en: "In summer, I go to the sea." }, accept: ["the sea", "ocean"] },
    ...
    },
    {
      ...
      items: [
        { id: "fr-u13l3-frais", type: "vocab", front: "frais", reading: "frais", meaning: "cool", example: { jp: "Ce matin, il fait frais.", en: "This morning, it's cool." }, accept: ["fresh", "chilly"], hint: "Also \"fresh\" for food — du pain frais is fresh bread." },
        ...
        { id: "fr-u13l3-sec", type: "vocab", front: "sec", reading: "sec", meaning: "dry", example: { jp: "En été, le vent est sec.", en: "In summer, the wind is dry." }, accept: ["dried"] },
        ...
        { id: "fr-u13l3-lorage", type: "vocab", front: "l'orage", reading: "lorage", meaning: "storm", example: { jp: "L'orage arrive ! Rentrons.", en: "The storm is coming! Let's go home." }, accept: ["the storm", "thunderstorm"] },
      ],
    },
  ],
};
