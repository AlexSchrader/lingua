  ...
  lessons: [
    {
      ...
      items: [
        ...
        { id: "fr-u1l1-ocirconflexe", type: "vocab", front: "allô", reading: "allo", meaning: "hello on the phone", example: { jp: "Allô, c'est Marie.", en: "Hello, it's Marie — answering the telephone" }, drill: { jp: "Allô c'est Marie", en: "Hello it's Marie" }, accept: ["hello", "hello (on the phone)", "hello on the phone"], hint: "ô is a long, closed \"oh\". allô belongs to the telephone and nowhere else — face to face it is always bonjour, which is why this card's meaning spells out the phone." },
      ],
    },
    {
      id: "fr-u1l2",
      ...
      items: [
        ...
        { id: "fr-u1l2-oe", type: "vocab", front: "l'œil", reading: "loeil", meaning: "one eye", example: { jp: "J'ai quelque chose dans l'œil.", en: "I have something in my eye — one syllable, \"luhy\"" }, drill: { jp: "J'ai quelque chose dans l'œil", en: "I have something in my eye" }, accept: ["eye", "an eye", "the eye"], hint: "œ is one letter, not two — and here you can always type it as oe: œil and oeil both pass. One eye is l'œil, said \"luhy\" in a single syllable; two are les yeux, which is completely irregular." },
      ],
    },
    {
      id: "fr-u1l3",
