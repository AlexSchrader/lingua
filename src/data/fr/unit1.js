  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u1l1-glypheaigu", type: "glyph", front: "é", reading: "e", meaning: null, example: null, hint: "The closed \"ay\" of café — and the accent is what makes the letter sound at all: chanté is \"shon-TAY\", chante is \"shont\". Type it: hold E on a phone, Option+e then e on a Mac, Alt+0233 on Windows." },
        { id: "fr-u1l1-glyphegrave", type: "glyph", front: "è", reading: "e", meaning: null, example: null, hint: "The open \"eh\" of \"bed\": très is \"treh\". One accent apart from é — é closes the mouth, è opens it. The same grave rides on à and où too, where it changes no sound at all and only separates look-alikes. Type it: hold E on a phone, Option+` then e on a Mac, Alt+0232 on Windows." },
        { id: "fr-u1l1-glyphecirc", type: "glyph", front: "ê", reading: "e", meaning: null, example: null, hint: "Sounds the same as è — open \"eh\". The hat marks a letter that fell out of the word centuries ago, usually an s: forêt was forest, hôtel was hostel. Type it: hold E on a phone, Option+i then e on a Mac, Alt+0234 on Windows." },
        { id: "fr-u1l1-glyphocirc", type: "glyph", front: "ô", reading: "o", meaning: null, example: null, hint: "A long, closed \"oh\": hôpital, bientôt. Same lost s as ê — hôpital was hospital. Type it: hold O on a phone, Option+i then o on a Mac, Alt+0244 on Windows." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u1l2-glyphcedille", type: "glyph", front: "ç", reading: "c", meaning: null, example: null, hint: "c is hard before a, o and u — without the tail, leçon would be \"luh-KON\". The cedilla forces the soft \"s\": ça, garçon, français. It never appears before e or i, where c is already soft. Type it: hold C on a phone, Option+c on a Mac, Alt+0231 on Windows." },
        { id: "fr-u1l2-glypholigature", type: "glyph", front: "œ", reading: "oe", meaning: null, example: null, hint: "One letter, not two — o and e fused, said \"uh\": sœur, cœur, l'œil. On this card you must type the real œ; inside an ordinary word oe is still accepted. Type it: hold O on a phone, Option+q on a Mac, Alt+0156 on Windows." },
