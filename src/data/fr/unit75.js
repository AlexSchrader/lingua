  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u75l3-lintegration", type: "vocab", front: "l'intégration", reading: "lintegration", meaning: "integration", example: { jp: "L'intégration prend du temps, et la langue joue un rôle très important.", en: "Integration takes time, and language plays a very important role." }, accept: ["the integration", "inclusion"] },
        ...
        { id: "fr-u75l3-lerole", type: "vocab", front: "le rôle", reading: "lerole", meaning: "the role", example: { jp: "Chacun a un rôle dans la famille, même si personne ne l'a jamais dit.", en: "Everyone has a role in the family, even if nobody ever said it." }, accept: ["role", "the part", "function"], hint: "Also an actor's part — jouer un rôle." },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u75l4-tolerant", type: "vocab", front: "tolérant", reading: "tolerant", meaning: "tolerant", example: { jp: "Cette ville est tolérante, si bien que beaucoup de personnes viennent y habiter.", en: "This city is tolerant, so a lot of people come to live here." }, accept: ["open-minded", "broad-minded"] },
