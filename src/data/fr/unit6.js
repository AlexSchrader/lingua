  ...
  lessons: [
    {
      ...
      items: [
        { id: "fr-u6l1-laville", type: "vocab", front: "la ville", reading: "laville", meaning: "city", example: { jp: "La ville est grande !", en: "The city is big!" }, drill: { jp: "La ville est très grande", en: "The city is very big" }, accept: ["the city", "town", "the town"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u6l2-lerestaurant", type: "vocab", front: "le restaurant", reading: "lerestaurant", meaning: "restaurant", example: { jp: "Il y a un restaurant ici.", en: "There's a restaurant here." }, drill: { jp: "Le restaurant est tout près", en: "The restaurant is very near" }, accept: ["the restaurant"] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fr-u6l3-pres", type: "vocab", front: "près", reading: "pres", meaning: "near", example: { jp: "Non, c'est près !", en: "No, it's close!" }, drill: { jp: "Le métro est tout près", en: "The metro is very near" }, accept: ["close", "nearby", "close by"] },
