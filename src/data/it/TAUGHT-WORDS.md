# IT — words already taught

**Generated file — do not hand-edit.** Regenerate with `npm run taught:words -- it`.
...
| slot | unit | title |
|---|---|---|
| 1 | `it-u1` | Sounds and spelling |
| 2 | `it-u2` | Greetings |
| 3 | `it-u3` | Introducing yourself |
| 4 | `it-u4` | Family |
| 5 | `it-u5` | Numbers and time |
| 6 | `it-u6` | Food and drink |
| 7 | `it-u7` | Town and places |
| 8 | `it-u8` | Colors and weather |
| 9 | `it-u9` | Days and months |
| 10 | `it-u10` | Describing things |
| 11 | `it-u11` | Body and health |
| 12 | `it-u12` | Grammar 1 — basic sentence |
| 13 | `it-u13` | Grammar 2 — verbs and particles |
| 14 | `it-u14` | Grammar 3 — past tense and agreement |
| 15 | `it-u15` | Vocabulary 1 |
| 16 | `it-u16` | Vocabulary 2 |
| 17 | `it-u17` | Vocabulary 3 |
| 18 | `it-u18` | Vocabulary 4 |
| 19 | `it-u19` | Vocabulary 5 |
| 20 | `it-u20` | Vocabulary 6 |
