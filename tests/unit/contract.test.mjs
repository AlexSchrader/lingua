...
test("LIVE_CARD_KINDS is exactly the current active set", () => {
  assert.deepEqual(
    ...
    ["build", "choice", "choice:reverse", "cloze:choice", "conjugate", "listen:choice", "listen:type", "particle:choice", "sentence:build", "speak", "teach", "trace", "type:meaning", "type:produce", "type:reading"],
