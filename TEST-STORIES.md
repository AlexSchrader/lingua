...
| **A5** | **Sound is right for the language you're studying.** Audio is off entirely under test — a green run says nothing about it. | One lesson each in Japanese and in German. | Every clip says the thing on the card, in that language's voice. | Silence · a clip that says something else · **German and Norwegian are missing 869 and 817 clips** and will simply be quiet. | |
